"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["495394"], {
458912(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_data_augmentation_kit_guide_dataaugmentation_retrieval_c_dataaugmentation_retrieval_c_md_076_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-data-augmentation-kit-guide-dataaugmentation-retrieval-c-dataaugmentation-retrieval-c-md-076.json
var site_docs_data_augmentation_kit_guide_dataaugmentation_retrieval_c_dataaugmentation_retrieval_c_md_076_namespaceObject = JSON.parse('{"id":"data-augmentation-kit-guide/dataaugmentation-retrieval-c/dataaugmentation-retrieval-c","title":"智慧化数据检索-C++","description":"场景介绍","source":"@site/docs/data-augmentation-kit-guide/dataaugmentation-retrieval-c/dataaugmentation-retrieval-c.md","sourceDirName":"data-augmentation-kit-guide/dataaugmentation-retrieval-c","slug":"/data-augmentation-kit-guide/dataaugmentation-retrieval-c/","permalink":"/harmonyos-docs-site/data-augmentation-kit-guide/dataaugmentation-retrieval-c/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"title":"智慧化数据检索-C++","sidebar_position":5,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataaugmentation-retrieval-c","kit":"application-framework","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"智慧化数据检索-ArkTS","permalink":"/harmonyos-docs-site/data-augmentation-kit-guide/dataaugmentation-retrieval/"},"next":{"title":"端侧问答模型","permalink":"/harmonyos-docs-site/data-augmentation-kit-guide/dataaugmentation-localchatmodel/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/data-augmentation-kit-guide/dataaugmentation-retrieval-c/dataaugmentation-retrieval-c.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "智慧化数据检索可用于文件整理，文件搜索等场景，例如：关键词检索、语义检索（文搜文）和跨模态检索（文搜图）。智慧化数据检索通过召回和重排两个阶段实现："
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "召回是指通过不同的策略或算法从海量数据中快速筛选出候选结果集。这些策略可针对不同的特征、模型或者数据来源，旨在尽可能覆盖各种潜在场景。ArkData提供了向量召回的能力，并支持灵活的条件过滤。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "重排是针对召回得到的候选结果集进行二次筛选，通过简单规则或者更复杂的模型（如机器学习或深度学习模型）计算各个结果的相关性分数，并重新排列顺序。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "向量检索召回",
      children: "向量检索召回"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "向量召回是通过将用户查询转化为向量（需使用嵌入模型进行向量化处理）来检索相似向量，从而实现语义相近内容的召回。向量近似的阈值在召回配置中设定。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "排序模块",
      children: "排序模块"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "排序模块包括对结果进行分档以及档内排序，使用的算法有RRF和分数融合排序。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "对结果进行分档",
      children: "对结果进行分档"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "以召回结果作为输入，基于召回的特征值或者召回分数，实现召回结果的相关性分档。档位共三个，分为高、中、低档位，供业务对最终检索结果相关性进行判断。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "对于向量召回，基于配置的一个或多个向量分数阈值对档位进行划分，当文档的向量分数大于等于某档位的阈值时，则划分至该档位。向量分数阈值是由1个或2个范围在[0,1]的数字组成。向量分数阈值有两个值时，分别表示高档位和中档位的阈值，向量分数小于中档位阈值则均为低档位；阈值有一个值时，该值表示高档位阈值，向量分数小于该值则均为低档位，无中档位。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "约束限制",
      children: "约束限制"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "当前只支持基于向量数据库的召回。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "查询词长度不超过512字符。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "接口说明",
      children: "接口说明"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: (0,jsx_runtime.jsx)(_components.code, {
            children: "find_library(aip_retrieval_ndk libnative_aip_retrieval_ndk.z.so)\ntarget_link_libraries(\n    entry\n    PUBLIC\n    libace_napi.z.so\n    ${aip_retrieval_ndk}\n    )\n"
          })
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "执行检索：使用前一步获取到的检索器，配合检索条件进行检索。"
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
