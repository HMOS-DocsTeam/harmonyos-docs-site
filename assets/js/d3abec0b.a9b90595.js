"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["323760"], {
525770(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_system_basicfun_basic_services_kit_usb_usb_dev_usb_host_dev_isochronoustransfer_isochronoustransfer_md_d3a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-system-basicfun-basic-services-kit-usb-usb-dev-usb-host-dev-isochronoustransfer-isochronoustransfer-md-d3a.json
var site_docs_system_basicfun_basic_services_kit_usb_usb_dev_usb_host_dev_isochronoustransfer_isochronoustransfer_md_d3a_namespaceObject = JSON.parse('{"id":"system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer/isochronoustransfer","title":"USB实时传输","description":"场景介绍","source":"@site/docs/system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer/isochronoustransfer.md","sourceDirName":"system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer","slug":"/system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer/","permalink":"/harmonyos-docs-site/system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"title":"USB实时传输","sidebar_position":5,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/isochronoustransfer","kit":"system/basic-services","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"USB批量传输","permalink":"/harmonyos-docs-site/system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/bulktransfer/"},"next":{"title":"USB串口通信服务开发概述","permalink":"/harmonyos-docs-site/system-basicfun/basic-services-kit/usb/usb-serial-dev/usbserial-overview/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/system-basicfun/basic-services-kit/usb/usb-dev/usb-host-dev/isochronoustransfer/isochronoustransfer.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "实时传输是通过USB协议在固定时间窗口内完成数据传输，确保数据流的时序稳定性和低延迟，但允许少量数据丢失（如视频丢帧、音频杂音）的传输模式。这种传输方式适用于USB耳机、USB音响、视频会议设备等对连续性要求高、容错性强的场景。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "环境准备",
      children: "环境准备"
      ...
      children: "主机（Host）连接设备（Device），通过usbSubmitTransfer接口进行数据传输。以下步骤描述了如何使用实时传输方式来传输数据："
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(254748)/* ["default"] */.A) + "",
        width: "102",
        height: "38"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "以下示例代码只是使用实时传输方式来传输数据的必要流程，需要放入具体的方法中执行。在实际调用时，设备开发者需要遵循设备相关协议进行调用，确保数据的正确传输和设备的兼容性。"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "主机端通过USB接口连接支持实时传输的设备（USB耳机等）。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "执行上述代码。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "log中搜索关键字transfer success，表示实时传输接口调用成功。"
      }), "\n"]
    })]
  });
}
...
254748(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
