"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["169302"], {
979284(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_system_debug_optimize_performance_analysis_kit_fault_analysis_address_sanitizer_guidelines_address_sanitizer_guidelines_md_de0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-system-debug-optimize-performance-analysis-kit-fault-analysis-address-sanitizer-guidelines-address-sanitizer-guidelines-md-de0.json
var site_docs_system_debug_optimize_performance_analysis_kit_fault_analysis_address_sanitizer_guidelines_address_sanitizer_guidelines_md_de0_namespaceObject = JSON.parse('{"id":"system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines/address-sanitizer-guidelines","title":"AddrSanitizer（地址越界）检测","description":"简介","source":"@site/docs/system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines/address-sanitizer-guidelines.md","sourceDirName":"system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines","slug":"/system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines/","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"title":"AddrSanitizer（地址越界）检测","sidebar_position":3,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/address-sanitizer-guidelines","kit":"system/debug-optimize","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"Cpp Crash（进程崩溃）检测","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/fault-analysis/crash-detection/cppcrash-guidelines/"},"next":{"title":"AppFreeze（应用冻屏）检测","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/fault-analysis/appfreeze-guidelines/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines/address-sanitizer-guidelines.md
...
const contentTitle = 'AddrSanitizer（地址越界）检测';
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["地址越界问题是指访问了不合法的地址，导致程序运行出现异常，通常表现为应用崩溃（Crash），其故障原因为释放后使用（use after free）、重复释放（double-free）、栈溢出（stack-overflow）、堆溢出（heap-overflow）等。由于应用崩溃日志信息有限且非崩溃第一现场，地址越界问题定位较为困难，一般依赖ASan、HWASan、GWP-ASan等检测工具以获取更多内存操作信息。从API13开始推荐", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-hwasan-detection",
        children: "使用HWASan检测工具"
      }), "进行地址越界问题的分析。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "常见越界类型与影响",
      children: "常见越界类型与影响"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["常见地址越界类型和影响可参看", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-address-sanitizer-catagory",
        children: "地址越界经典问题类型"
      }), "。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "地址越界检测原理",
      ...
      children: ["检测原理和使用方法可参看", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-ram-detection",
        children: "地址越界类问题检测"
      }), "。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "日志获取方式",
      ...
      children: "地址越界日志和进程崩溃日志一致，都是由Faultlogger模块进行管理，可通过以下方式获取："
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["DevEco Studio会收集设备/data/log/faultlog/faultlogger/路径下的进程崩溃故障日志到FaultLog下，根据进程名和故障和时间分类显示。获取日志的方法参见：", (0,jsx_runtime.jsx)(_components.a, {
      ...
      }), "完成地址越界事件订阅，并通过事件的", (0,jsx_runtime.jsx)(_components.a, {
        href: "/system-debug-optimize/performance-analysis-kit/hiappevent/event-subscription/system-events/address-sanitizer-events/hiappevent-watcher-address-sanitizer-events#params%E5%AD%97%E6%AE%B5%E8%AF%B4%E6%98%8E",
      ...
      children: "在运行态，日志默认都落盘至 /data/log/faultlog/faultlogger 下。在开发者选项打开的情况下，开发者可以通过hdc file recv /data/log/faultlog/faultlogger D:\\命令导出故障日志到本地，故障日志文件名格式为[检测器类型]-[bundleName]-[uid]-[happenedTime].log。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "日志规格",
      children: "日志规格"
      ...
      children: "ASan日志规格如下，标题头会展示设备信息，故障发生时间，故障进程和故障原因等。日志详细描述了越界访问的地址（0x007fffd59768）、访问大小（WRITE of size 4）、发生的线程和进程信息。通过调用栈，展现了导致此次越界的函数调用路径，列出各个调用层的地址及对应的模块和偏移，帮助开发者快速定位代码位置。日志还提供影子内存（Shadow bytes）跟踪内存状态，帮助确认访问是否合法。同时，日志列出了进程的内存空间映射，帮助分析越界地址所处的具体内存区域。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "以下为具体示例："
      ...
      children: "HWASan日志在格式上与ASan相近，也会在标题中展示设备信息、故障发生时间、故障进程及触发原因等关键信息。日志会详细记录越界访问的地址（如0x0002013c0100）和访问大小（如WRITE of size 4）。同时会记录发生时的线程和进程信息。完整的调用栈会展示触发越界的函数执行路径，列出各层地址、所属模块及偏移，便于开发者快速定位代码位置。不同于ASan的是，HWASan还会输出指针与内存块的标签（tags），并通过对比标签来辅助判断是否存在非法访问。"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      id: "memdebug日志规格",
      children: "MemDebug日志规格"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "MemDebug采用隔离区加投毒填充的机制，并复用HWASan的Tag校验的检测工具，对于Double Free类问题，其日志规格和HWASan一致。"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: "对于Use-After-Free（Write）类问题，日志在问题概述部分会有所不同。示例输出如下："
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        children: "ptrBeg was re-written after free 0x000100946540[1], 0x000100946548 5555555500000009:5555555555555555\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "其中，0x000100946540问题内存块起始地址，[1]为检测出问题的内存基于起始地址的8字节偏移数，0x000100946548为实际被修改的地址，5555555500000009:5555555555555555表示内存中的内容被修改后的实际值和预期值的对比。在该信息之后，日志还会输出对应内存块的释放堆栈和分配堆栈，调用栈的格式与HWASan日志一致，此处不再赘述。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "gwp-asan日志规格",
      children: "GWP-ASan日志规格"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "GWP-ASan的日志格式较为简洁，以下示例为典型的Use-After-Free问题日志，包含内存块的分配、释放及违规访问的调用栈信息。"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      id: "addrsanitizer聚类",
      children: "AddrSanitizer聚类"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "聚类简介",
      children: "聚类简介"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "应用程序在不同版本或同一版本的不同时间，AddrSanitizer可能因同一原因产生故障，但AddrSanitizer故障日志中的大部分信息会随版本、时间等因素变化，导致难以快速判断是否为重复问题。此外，AddrSanitizer故障信息中包含系统侧和应用侧的调用栈，这不利于开发者快速定位和排查应用侧的问题。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "因此，为避免重复分析多份故障信息，提高应用故障问题的分析效率，需要对AddrSanitizer故障信息进行聚类；同时，聚类也能帮助开发者对不同原因问题进行分类统计。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "判断多份日志是否属于同一问题，主要基于以下两个维度："
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "地址越界的故障类型。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "业务相关调用栈，过滤基础库后的栈顶前两帧。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "通过上述信息可对问题进行初步定界。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "提取聚类信息",
      children: "提取聚类信息"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              ...
              children: ["在", (0,jsx_runtime.jsx)(_components.a, {
                href: "#gwp-asan%E6%97%A5%E5%BF%97%E8%A7%84%E6%A0%BC",
                children: "GWP-ASan日志"
              }), "中，故障类型根据原始日志中包含\"at\"的行提取。可能的故障类型包括Use After Free、Double Free、Invalid (Wild) Free等，详细类型说明可参考", (0,jsx_runtime.jsx)(_components.a, {
                href: "https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-gwpasan-detection#section73731529454",
                children: "GWP-ASan异常检测类型"
              }), "。"]
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "ASan/HWASan/MemDebug"
            }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["在", (0,jsx_runtime.jsx)(_components.a, {
                href: "#asan%E6%97%A5%E5%BF%97%E8%A7%84%E6%A0%BC",
                children: "ASan"
              }), "、", (0,jsx_runtime.jsx)(_components.a, {
                href: "#hwasan%E6%97%A5%E5%BF%97%E8%A7%84%E6%A0%BC",
                children: "HWASan"
              }), "和", (0,jsx_runtime.jsx)(_components.a, {
                href: "#memdebug%E6%97%A5%E5%BF%97%E8%A7%84%E6%A0%BC",
                children: "MemDebug"
              }), "日志中，故障原因通过日志中的\"Reason\"字段提取，提取结果将作为后续聚类依据。详细字段说明可参考", (0,jsx_runtime.jsx)(_components.a, {
                ...
                children: "AddrSanitizer日志type字段说明"
              }), "。"]
            }), "\n"]
          }), "\n"]
        }), "\n"]
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: "提取故障类型作为特征后，首先使用正则匹配筛选堆栈内容。然后，为了确保聚类准确性，需要对堆栈信息进行标准化和清洗。主要规则如下："
        }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "去除易变信息：行号、相同的BuildID和绝对地址。"
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "过滤基础库栈帧："
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "保留业务相关栈帧：保留业务so路径作为关键特征。"
            }), "\n"]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "对调用栈进行标准化后，最后得到的特征栈如下："
          ...
          children: [(0,jsx_runtime.jsx)(_components.thead, {
            ...
            children: [(0,jsx_runtime.jsxs)(_components.tr, {
              children: [(0,jsx_runtime.jsx)(_components.td, {
                children: "#0 0x5b6d263a58 (/system/lib64/libclang_rt.hwasan.so+0x23a58) (BuildId: a1396c21a0290124b0e0ebd03a4cced52b1addcc)"
              }), (0,jsx_runtime.jsx)(_components.td, {
                children: "忽略（基础库）"
              })]
            }), (0,jsx_runtime.jsxs)(_components.tr, {
              children: [(0,jsx_runtime.jsx)(_components.td, {
                children: "#1 0x661be0e870 (/data/storage/el1/bundle/libs/arm64/libentry.so+0x4e870) (BuildId: 5bc0684c2c3fc90841c2498efe1af4fd4792e5a8)"
              }), (0,jsx_runtime.jsx)(_components.td, {
                children: "/data/storage/el1/bundle/libs/arm64/libentry.so+0x4e870"
              })]
            })]
          })]
        }), "\n"]
      ...
      children: "在完成标准化后，根据不同故障类型提取关键栈作为特征："
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: [(0,jsx_runtime.jsx)(_components.thead, {
            ...
            children: [(0,jsx_runtime.jsxs)(_components.tr, {
              children: [(0,jsx_runtime.jsx)(_components.td, {
                ...
                children: "过滤基础库后，取栈顶的前两帧（so名+相对偏移）"
              })]
            }), (0,jsx_runtime.jsxs)(_components.tr, {
              children: [(0,jsx_runtime.jsx)(_components.td, {
                children: "故障特征2"
      ...
      children: [(0,jsx_runtime.jsx)(_components.thead, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            ...
            children: "/data/storage/el1/bundle/libs/arm64/libsample.so+0x7ba4  /data/storage/el1/bundle/libs/arm64/libsample.so+0x849c"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "故障特征2-释放栈"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "/data/storage/el1/bundle/libs/arm64/libsample.so+0x7b9c  /data/storage/el1/bundle/libs/arm64/libsample.so+0x849c"
          })]
        })]
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "开发者可通过比对多份日志的聚类特征来归并AddrSanitizer故障，也可以对故障类型和故障特征内容计算哈希值，用于问题分类统计与自动化分析。"
    })]
  });
}
