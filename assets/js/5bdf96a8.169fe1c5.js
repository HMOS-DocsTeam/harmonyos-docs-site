"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["677239"], {
813668(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_arkui_arkts_ui_development_arkts_user_defined_capabilities_arkts_draw_arkts_user_defined_extension_drawmodifier_arkts_user_defined_extension_drawmodifier_md_5bd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-arkui-arkts-ui-development-arkts-user-defined-capabilities-arkts-draw-arkts-user-defined-extension-drawmodifier-arkts-user-defined-extension-drawmodifier-md-5bd.json
var site_docs_arkui_arkts_ui_development_arkts_user_defined_capabilities_arkts_draw_arkts_user_defined_extension_drawmodifier_arkts_user_defined_extension_drawmodifier_md_5bd_namespaceObject = JSON.parse('{"id":"arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier/arkts-user-defined-extension-drawmodifier","title":"自定义绘制修改器 (DrawModifier)","description":"概述","source":"@site/docs/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier/arkts-user-defined-extension-drawmodifier.md","sourceDirName":"arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier","slug":"/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier/","permalink":"/harmonyos-docs-site/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"title":"自定义绘制修改器 (DrawModifier)","sidebar_position":2,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-extension-drawmodifier","kit":"application-framework","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"使用画布绘制自定义图形 (Canvas)","permalink":"/harmonyos-docs-site/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-drawing-customization-on-canvas/"},"next":{"title":"自定义扩展能力概述","permalink":"/harmonyos-docs-site/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-modifier/arkts-user-defined-modifier/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-user-defined-extension-drawmodifier/arkts-user-defined-extension-drawmodifier.md
...
const contentTitle = '自定义绘制修改器 (DrawModifier)';
...
const toc = [{
  ...
  "value": "使用DrawModifier接口",
  "id": "使用drawmodifier接口",
  "level": 2
}, {
  "value": "通过drawFront、drawContent、drawBehind进行自定义绘制",
  "id": "通过drawfrontdrawcontentdrawbehind进行自定义绘制",
  "level": 2
}, {
  "value": "通过drawForeground进行自定义绘制",
  "id": "通过drawforeground进行自定义绘制",
  "level": 2
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "当某些组件本身的绘制内容不满足需求时，可使用组件自定义绘制功能，在原有组件基础上部分绘制、或者全部自行绘制，以达到预期效果。例如：独特的按钮形状、文字和图像混合的图标等。组件自定义绘制提供了自定义绘制修改器DrawModifier，来实现更自由的组件绘制。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "使用drawmodifier接口",
      children: "使用DrawModifier接口"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        children: "declare class DrawModifier {\n\n  drawBehind?(drawContext: DrawContext): void;\n\n  drawContent?(drawContext: DrawContext): void;\n\n  drawFront?(drawContext: DrawContext): void;\n\n  drawForeground?(drawContext: DrawContext): void;\n\n  drawOverlay(drawContext: DrawContext): void;\n\n  invalidate(): void;\n}\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["DrawModifier可设置遮罩层前景（drawOverlay）、前景（drawForeground）、内容前景（drawFront）、内容（drawContent）和内容背景（drawBehind）的绘制方法，开发者需要重载这些方法，并通过", (0,jsx_runtime.jsx)(_components.a, {
        href: "/arkui/arkts-ui-development/arkts-user-defined-capabilities/arkts-draw/arkts-drawing-customization-on-canvas",
        children: "Canvas"
      }), "的接口进行自定义绘制。自定义绘制层级图如下所示。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(663014)/* ["default"] */.A) + "",
        width: "900",
        height: "573"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "DrawModifier还提供主动触发重绘的方法invalidate，该接口开发者无需也无法重载，调用会触发所绑定组件的重绘。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(67401)/* ["default"] */.A) + "",
        width: "102",
        height: "38"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "每个DrawModifier实例只能设置到一个组件上，禁止进行重复设置。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "drawContent方法会替换组件原本的内容绘制函数。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "drawForeground方法从API version 20开始支持。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "drawOverlay方法从API version 23开始支持。"
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["NDK的自定义绘制能力和示例请参考", (0,jsx_runtime.jsx)(_components.a, {
      ...
      id: "通过drawfrontdrawcontentdrawbehind进行自定义绘制",
      children: "通过drawFront、drawContent、drawBehind进行自定义绘制"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "通过drawFront、drawContent、drawBehind接口，在内容前景、内容和内容背景三个层级上对Text组件进行了自定义绘制，从而按需改变组件的绘制效果。"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(723197)/* ["default"] */.A) + "",
        width: "343",
        height: "243"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "通过drawforeground进行自定义绘制",
      children: "通过drawForeground进行自定义绘制"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "通过drawForeground接口，在组件前景层级上对Column组件进行了自定义绘制，从而改变组件前景的绘制效果。"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(944604)/* ["default"] */.A) + "",
        width: "253",
        height: "272"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["从API version 12开始，通过重写DrawModifier中的", (0,jsx_runtime.jsx)(_components.a, {
        href: "/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-draw-modifier/ts-universal-attributes-draw-modifier#drawcontent",
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(802993)/* ["default"] */.A) + "",
        width: "102",
        height: "38"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["如果开发者希望这个画布进行一个预期的变换，应该使用", (0,jsx_runtime.jsx)(_components.a, {
          href: "/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas#concatmatrix12",
          children: "concatMatrix"
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(235554)/* ["default"] */.A) + "",
        width: "1229",
        height: "836"
      })
    })]
...
723197(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
/* export default */ const __rspack_default_export = (__webpack_require__.p + "assets/images/zh-cn_image_0000002583438071-6e0bf9e012d92ab0140e94259f6ba002.gif");

},
67401(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
...
802993(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
/* export default */ const __rspack_default_export = ("data:image/png;base64,");
...
663014(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
...
944604(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
...
235554(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
/* export default */ const __rspack_default_export = ("data:image/png;base64,");
