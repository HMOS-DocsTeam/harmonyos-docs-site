"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["483867"], {
71345(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_system_debug_optimize_performance_analysis_kit_hichecker_hichecker_guidelines_arkts_hichecker_guidelines_arkts_md_bb7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-system-debug-optimize-performance-analysis-kit-hichecker-hichecker-guidelines-arkts-hichecker-guidelines-arkts-md-bb7.json
var site_docs_system_debug_optimize_performance_analysis_kit_hichecker_hichecker_guidelines_arkts_hichecker_guidelines_arkts_md_bb7_namespaceObject = JSON.parse('{"id":"system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts/hichecker-guidelines-arkts","title":"使用HiChecker检测问题（ArkTS）","description":"简介","source":"@site/docs/system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts/hichecker-guidelines-arkts.md","sourceDirName":"system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts","slug":"/system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts/","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"使用HiChecker检测问题（ArkTS）","sidebar_position":1,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hichecker-guidelines-arkts","kit":"system/debug-optimize","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"使用HiTraceChain打点（C/C++）","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/hitracechain/hitracechain-guidelines-ndk/"},"next":{"title":"HiDebug能力概述","permalink":"/harmonyos-docs-site/system-debug-optimize/performance-analysis-kit/hidebug/hidebug-guidelines/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/system-debug-optimize/performance-analysis-kit/hichecker/hichecker-guidelines-arkts/hichecker-guidelines-arkts.md
...
const contentTitle = '使用HiChecker检测问题（ArkTS）';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "使用hichecker检测问题arkts",
        children: "使用HiChecker检测问题（ArkTS）"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "简介",
      children: "简介"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "HiChecker可以作为应用开发阶段使用的检测能力，用于检测代码运行过程中部分易忽略的问题，如应用线程出现耗时调用、应用进程中元能力资源泄露等问题。开发者可以通过日志记录或进程crash等形式查看具体问题并进行修改，提升应用的使用体验。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "基本概念",
      children: "基本概念"
      ...
      }), "：HiChecker使用常量来表示已有的告警规则或者检测规则，一个常量表示一种规则，可以通过HiChecker的接口控制规则的添加和删除。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "实现原理",
      children: "实现原理"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "应用程序通过HiChecker函数接口控制规则的增删查改。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "子系统有耗时调用或者Ability资源泄露时通过HiChecker通知有对应规则的事件发生，HiChecker检测条件满足时做对应的操作。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "约束与限制",
      children: "约束与限制"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "支持应用增加、删除不同的告警通知规则，目前支持记录流水日志（默认），应用崩溃两种规则。"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "相关检测条件满足时，支持Native回栈到关键触发点，暂不支持JS回栈。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "接口说明",
      children: "接口说明"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["检测模式接口由HiChecker模块提供，详细API请参考", (0,jsx_runtime.jsx)(_components.a, {
        href: "/ref/system-debug-optimize-api/performance-analysis-api/performance-analysis-arkts/js-apis-hichecker/js-apis-hichecker",
        children: "@ohos.hichecker"
      }), "。"]
      ...
      children: [(0,jsx_runtime.jsx)(_components.thead, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "hichecker.addCheckRule(rule: bigint): void"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "添加一条或多条规则到系统，系统根据添加的规则进行检测或反馈。"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "hichecker.removeCheckRule(rule: bigint): void"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "删除一条或多条规则，删除的规则后续将不再生效。"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "hichecker.containsCheckRule(rule: bigint): boolean"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "当前已添加的规则集中是否包含了某一个特定的规则。"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: "hichecker.getRule(): bigint"
          }), (0,jsx_runtime.jsx)(_components.td, {
            children: "获取当前线程规则、进程规则、告警规则的合集。"
          })]
        })]
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "在应用启动执行页面加载后，开始检测；完成业务之后，停止检测。启动检测时，开发者可以根据需求配置不同的告警规则和检测规则。检测规则当前支持检测耗时函数调用、Ability泄漏和ArkUI性能。对于检测到问题之后触发的行为可通过告警规则来配置，当前支持日志和应用退出两种。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "开发者如果期望检测耗时函数调用，并期望检测到时通过打印日志来记录，可参考如下步骤进行开发。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "新建一个ArkTS应用工程，在“Project”窗口点击“entry > src > main > ets > entryability ”，打开工程中的“EntryAbility.ets”文件；在页面执行加载后，在自己的业务中调用HiChecker的接口，添加检测规则， 示例代码如下："
