"use strict";
(self["webpackChunkharmonyos_docs_site"] = self["webpackChunkharmonyos_docs_site"] || []).push([["94603"], {
436631(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_account_kit_guide_account_quick_login_account_silent_login_account_silent_login_md_b13_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-account-kit-guide-account-quick-login-account-silent-login-account-silent-login-md-b13.json
var site_docs_account_kit_guide_account_quick_login_account_silent_login_account_silent_login_md_b13_namespaceObject = JSON.parse('{"id":"account-kit-guide/account-quick-login/account-silent-login/account-silent-login","title":"静默登录","description":"场景介绍","source":"@site/docs/account-kit-guide/account-quick-login/account-silent-login/account-silent-login.md","sourceDirName":"account-kit-guide/account-quick-login/account-silent-login","slug":"/account-kit-guide/account-quick-login/account-silent-login/","permalink":"/harmonyos-docs-site/account-kit-guide/account-quick-login/account-silent-login/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"title":"静默登录","sidebar_position":4,"original_url":"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/account-silent-login","kit":"app-services","last_updated":"2026-04-22"},"sidebar":"docs","previous":{"title":"使用自定义按钮登录","permalink":"/harmonyos-docs-site/account-kit-guide/account-quick-login/account-unionid-login/account-unionid-login-api/"},"next":{"title":"订阅华为账号的登录/登出事件","permalink":"/harmonyos-docs-site/account-kit-guide/account-quick-login/account-login-state/"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// CONCATENATED MODULE: ./docs/account-kit-guide/account-quick-login/account-silent-login/account-silent-login.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "在应用卸载重装、用户换机等场景，如登录的华为账号与应用重装、换机前一致，应用可通过Account Kit提供的静默登录方式即不需要用户点击登录/注册按钮，即可获取用户的身份标识UnionID/OpenID，完成用户的静默登录。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "约束与限制",
      children: "约束与限制"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "静默登录能力支持Phone、Tablet、PC/2in1设备。并且从5.1.0(18)版本开始，新增支持Wearable设备；从5.1.1(19)版本开始，新增支持TV设备。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "业务流程",
      children: "业务流程"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        src: (__webpack_require__(357390)/* ["default"] */.A) + "",
        width: "1151",
        height: "653"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "调用登录API阶段（序号1-3）："
        }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
            children: "用户使用华为账号登录过应用，应用卸载重装、用户换机后再进入应用时，应用传forceLogin = false等参数调用登录API。"
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["如华为账号已登录，且API调用成功，应用能获取到Authorization Code等登录结果。注意：如华为账号未登录，应用会获取到", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            ...
            children: "应用对用户身份标识UnionID/OpenID、业务登录凭证SessionId信息进行安全认证后完成静默登录。"
          }), "\n"]
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["静默登录关键接口如下表所示，具体API说明详见", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsxs)(_components.td, {
            ...
            children: ["创建账号登录请求。", (0,jsx_runtime.jsx)(_components.a, {
              href: "/ref/account-api/account-api-arkts/account-api-authentication/account-api-authentication#loginwithhuaweiidrequest",
              children: "LoginWithHuaweiIDRequest"
            }), "中的forceLogin参数用来控制当用户未登录华为账号时，是否强制拉起华为账号登录界面，静默登录场景设置为false。"]
          })]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          }), "的开发步骤a和b。应用可以通过公开的网址获取到华为账号服务器发布的公钥，对签名和ID Token中的必要信息进行验证，以证明其没有被篡改过。解析ID Token可参考", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: (0,jsx_runtime.jsx)(_components.img, {
            src: (__webpack_require__(203741)/* ["default"] */.A) + "",
            width: "102",
            height: "38"
          })
        }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
...
357390(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
/* export default */ const __rspack_default_export = (__webpack_require__.p + "assets/images/zh-cn_image_0000002552958752-ec3bf2704c8a4ef09bb715852f370093.png");

},
203741(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
