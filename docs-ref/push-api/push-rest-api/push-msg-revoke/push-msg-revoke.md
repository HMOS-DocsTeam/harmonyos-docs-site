...
title: "消息撤回"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-msg-revoke
kit: 应用服务
last_updated: "2026-04-22"
slug: push-msg-revoke
---

# 消息撤回

![](../../../images/bf180031/note_3.0-zh-cn.png) 
...
消息体最大不能超过4096Bytes（不包括Push Token），若超过请求会返回错误码[80300008](/ref/push-api/push-rest-api/push-rest-api-scenes/push-scenariozed-api-response/push-scenariozed-api-response#section80300008-消息体大小超过4096bytes不包括push-token)，单次最多携带的Push Token数不能超过1000（系统当前配置值）。
...
![](../../../images/4c54ba97/note_3.0-zh-cn.png) 
...
| 参数 | 取值描述 | 样例 |
| --- | --- | --- |
| Authorization | 鉴权方式：  ****JWT方式****  请参见[基于服务账号生成鉴权令牌](/push-kit-guide/push-server/push-jwt-token)。  ****说明：****  建议JWT令牌过期时间设置为3600秒，有效期内可以复用。  Bearer后面拼接空格，再拼接获取的鉴权信息。 | Bearer eyJraWQiOiIx---xxx.eyJhdWQiOiJodHR---xxx.QRodgXa2xeXSt4Gp---xxx |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| notifyId | 是 | Integer | 消息下发时携带的notifyId，详情请参见[notifyId](/ref/push-api/push-rest-api/push-rest-api-scenes/push-scenariozed-api-request-param/push-scenariozed-api-request-param#notification)。 |
...
1. 请登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站，查看Push服务状态是否已开通，请参见[开通推送服务](/push-kit-guide/push-preparations/push-config-setting)。
...
3. 请确保终端设备升级至HarmonyOS NEXT版本后，重新生成对应的Push Token，并使用[HarmonyOS NEXT版本的请求体参数](/ref/push-api/push-rest-api/push-rest-api-scenes/push-scenariozed-api-request-param/push-scenariozed-api-request-param)进行消息请求。
