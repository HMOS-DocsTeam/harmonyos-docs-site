...
title: "图片风控"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-image-control
kit: 应用服务
last_updated: "2026-04-22"
slug: push-image-control
---

# 图片风控

![](../../../images/6f97e8c9/note_3.0-zh-cn.png) 
...
![](../../../images/70baf93a/note_3.0-zh-cn.png) 
...
![](../../../images/5d4fa5ff/note_3.0-zh-cn.png) 
...
| 参数 | 取值描述 | 样例 |
| --- | --- | --- |
| Authorization | 鉴权方式：  ****JWT方式****：  详情参见[基于服务账号生成鉴权令牌](/push-kit-guide/push-server/push-jwt-token)。  ****说明：****  建议JWT令牌过期时间设置为3600秒，有效期内可以复用。  Bearer后面拼接空格，再拼接获取的鉴权信息。 | Bearer eyJraWQiOiIx---xxx.eyJhdWQiOiJodHR---xxx.QRodgXa2xeXSt4Gp---xxx |
...
请在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站[开通推送服务](/push-kit-guide/push-preparations/push-config-setting)。
