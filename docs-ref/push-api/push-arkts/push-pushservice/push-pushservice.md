...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-pushservice
kit: 应用服务
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[ArkTS API错误码](/ref/push-api/push-arkts/push-error-code/push-error-code)。
...
以下错误码的详细介绍请参见[ArkTS API错误码](/ref/push-api/push-arkts/push-error-code/push-error-code)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appProfileType | pushCommon.[AppProfileType](/ref/push-api/push-arkts/push-pushcommon/push-pushcommon#appprofiletype) | 是 | 绑定账号类型，分为华为账号和应用账号。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pushType | [PushType](#pushservicepushtype) | 是 | 场景化消息类型。  ****说明：****  · pushService.PushType中EMERGENCY（紧急事件消息场景）起始版本：5.0.0(12)。本场景仅为地震灾害等特殊场景使用。  · pushService.PushType中DEFAULT（通知消息场景）起始版本：5.0.2(14)。调用示例代码请参考[应用在前台时处理通知消息](/push-kit-guide/push-scenes/push-alert/push-send-alert#应用在前台时处理通知消息)中步骤3。  · IM（语音播报消息场景）调用示例代码请参考[开发步骤](/push-kit-guide/push-scenes/push-extend-noti/push-send-extend-noti#开发步骤)中步骤3。  · VoIP（应用内通话消息场景）  调用示例代码请参考[开发步骤](/push-kit-guide/push-scenes/push-voip#开发步骤)中步骤2。  · BACKGROUND（后台消息场景）  调用示例代码请参考[开发步骤](/push-kit-guide/push-scenes/push-background#开发步骤)中步骤5。 |
| ability | [Ability](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-ability/js-apis-app-ability-ability) | 是 | [UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)。 |
| onMessage | Callback&lt;pushCommon.[PushPayload](/ref/push-api/push-arkts/push-pushcommon/push-pushcommon#pushpayload)&gt; | 是 | 回调函数，返回接收场景化消息的数据。 |
...
| ability | [Ability](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-ability/js-apis-app-ability-ability) | 是 | [UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)，包含UI界面的应用组件。 |
...
![](../../../images/e7470623/note_3.0-zh-cn.png) 
...
| callee | [Callee](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability#callee) | 是 | 通用组件服务端注册和解除客户端[Caller](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability#caller)通知送信的callback接口，从[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)中获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| PushPayload | pushCommon.[PushPayload](/ref/push-api/push-arkts/push-pushcommon/push-pushcommon#pushpayload) | 是 | 分布式消息数据的参数定义。 |
