...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-servicenotification
kit: 应用服务
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 请求订阅通知授权界面[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext)。  ****说明：****  context仅支持传入UIAbilityContext。 |
...
| type | [SubscribeNotificationType](#subscribenotificationtype) | 否 | 订阅类型。****默认为SUBSCRIBE\_WITH\_TOKEN。****  ****说明：****  起始版本：5.0.0(12)。 |
...
![](../../../images/41931911/note_3.0-zh-cn.png) 
