...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| remoteNotificationInfo | pushCommon.[RemoteNotificationInfo](/ref/push-api/push-arkts/push-pushcommon/push-pushcommon#remotenotificationinfo) | 是 | 通知扩展数据。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;pushCommon.[RemoteNotificationContent](/ref/push-api/push-arkts/push-pushcommon/push-pushcommon#remotenotificationcontent)&gt; | Promise对象，返回通知扩展替换内容。 |
