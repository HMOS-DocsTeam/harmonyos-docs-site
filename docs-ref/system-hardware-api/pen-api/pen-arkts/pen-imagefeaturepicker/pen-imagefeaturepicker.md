...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-imagefeaturepicker
kit: 系统
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 否 | 否 | 色值。 |
| colorSpace | [colorSpaceManager.ColorSpace](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-colorspacemanager/js-apis-colorspacemanager#colorspace) | 否 | 否 | 色域空间。 |
