...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-instantsshapegenerator
kit: 系统
...
| [onShapeRecognized](#onshaperecognized) | 注册识别完成时的回调方法。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| shapePath | [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d) | 否 | 否 | 图形对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明) | 是 | 当前触摸点事件。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d) | 形状信息生成的Path2D对象。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| callback | Callback&lt;[ShapeInfo](#shapeinfo)&gt; | 是 | 图形识别完成时回调。 |
