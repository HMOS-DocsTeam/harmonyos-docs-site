...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| event | [TouchEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明) | 是 | 当前点信息。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [TouchPoint](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#touchpoint11) | 预测点信息。 |
