...
| 名称 | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| handwriteController | [HandwriteController](/ref/system-hardware-api/pen-api/pen-arkts/pen-handwritecontroller/pen-handwritecontroller) | 否 | 否 | 手写套件功能类实例。 |
...
| onDidScroll | [DidScrollCallback](#didscrollcallback) | 否 | 是 | 画布滚动时的回调。  ****起始版本****：6.1.0(23) |
...
![](../../../../images/774216ac/note_3.0-zh-cn.png) 
