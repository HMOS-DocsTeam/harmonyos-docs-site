...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor
kit: 系统
...
![](../../../../images/12d94f60/note_3.0-zh-cn.png) 

本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。订阅前可使用[getSingleSensor](#sensorgetsinglesensor9)接口获取该传感器的信息，获取该传感器信息成功时可正常订阅传感器，异常情况详见[getSingleSensor](#sensorgetsinglesensor9)错误码说明，具体使用方法可参考[指南开发步骤](/system-hardware/sensor-service-kit/sensor/sensor-guidelines#开发步骤)；订阅传感器数据时确保on订阅和off取消订阅成对出现。
...
以下错误码的详细介绍请参见[传感器错误码](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts-errcode/errorcode-sensor/errorcode-sensor)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。错误码和错误信息会以异常的形式抛出，调用接口时需要使用try catch对可能出现的异常进行捕获操作。
...
![](../../../../images/c83bef10/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[传感器错误码](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts-errcode/errorcode-sensor/errorcode-sensor)。错误码和错误信息会以异常的形式抛出，调用接口时需要使用try catch对可能出现的异常进行捕获操作。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)。错误码和错误信息会以异常的形式抛出，调用接口时需要使用try catch对可能出现的异常进行捕获操作。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[传感器错误码](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts-errcode/errorcode-sensor/errorcode-sensor)。错误码和错误信息会以异常的形式抛出，调用接口时需要使用try catch对可能出现的异常进行捕获操作。。
...
![](../../../../images/2a11f69c/note_3.0-zh-cn.png) 
...
![](../../../../images/0023d208/note_3.0-zh-cn.png) 
...
![](../../../../images/2a35afdb/note_3.0-zh-cn.png) 
...
![](../../../../images/f4654655/note_3.0-zh-cn.png) 
...
![](../../../../images/3ff0b58e/note_3.0-zh-cn.png) 
...
![](../../../../images/6e02b3e1/note_3.0-zh-cn.png) 
...
![](../../../../images/0e03fd1e/note_3.0-zh-cn.png) 
...
![](../../../../images/81f6f752/note_3.0-zh-cn.png) 
...
![](../../../../images/264018fd/note_3.0-zh-cn.png) 
...
![](../../../../images/081b9687/note_3.0-zh-cn.png) 
...
![](../../../../images/18581404/note_3.0-zh-cn.png) 
...
![](../../../../images/c343cfe0/note_3.0-zh-cn.png) 
...
![](../../../../images/2e02261d/note_3.0-zh-cn.png) 
...
![](../../../../images/a58b97dd/note_3.0-zh-cn.png) 
...
![](../../../../images/457a2b68/note_3.0-zh-cn.png) 
...
![](../../../../images/29d68026/note_3.0-zh-cn.png) 
...
![](../../../../images/1bdecfd3/note_3.0-zh-cn.png) 
...
![](../../../../images/14a8d38d/note_3.0-zh-cn.png) 
...
![](../../../../images/90615b0c/note_3.0-zh-cn.png) 
...
![](../../../../images/bbb6c136/note_3.0-zh-cn.png) 
...
![](../../../../images/a143384e/note_3.0-zh-cn.png) 
...
![](../../../../images/c3c50c6e/note_3.0-zh-cn.png) 
...
![](../../../../images/9c57b549/note_3.0-zh-cn.png) 
...
![](../../../../images/2a47bc14/note_3.0-zh-cn.png) 
...
![](../../../../images/2aed2d39/note_3.0-zh-cn.png) 
...
![](../../../../images/65c30daa/note_3.0-zh-cn.png) 
...
![](../../../../images/f81238f4/note_3.0-zh-cn.png) 
...
![](../../../../images/3baee5f1/note_3.0-zh-cn.png) 
...
![](../../../../images/98589331/note_3.0-zh-cn.png) 
...
![](../../../../images/60e42ed2/note_3.0-zh-cn.png) 
...
![](../../../../images/db27102c/note_3.0-zh-cn.png) 
...
![](../../../../images/46b08de5/note_3.0-zh-cn.png) 
...
![](../../../../images/8761af7d/note_3.0-zh-cn.png) 
...
![](../../../../images/18479e85/note_3.0-zh-cn.png) 
...
![](../../../../images/2c289bc1/note_3.0-zh-cn.png) 
...
![](../../../../images/f0246573/note_3.0-zh-cn.png) 
...
![](../../../../images/a7d1691b/note_3.0-zh-cn.png) 
...
![](../../../../images/d62d3200/note_3.0-zh-cn.png) 
...
![](../../../../images/5c6399a0/note_3.0-zh-cn.png) 
...
![](../../../../images/956bcf38/note_3.0-zh-cn.png) 
...
![](../../../../images/20bb4007/note_3.0-zh-cn.png) 
...
![](../../../../images/efb58ded/note_3.0-zh-cn.png) 
...
![](../../../../images/5e6e1aa7/note_3.0-zh-cn.png) 
...
![](../../../../images/40a56fbe/note_3.0-zh-cn.png) 
...
![](../../../../images/412f8725/note_3.0-zh-cn.png) 
...
![](../../../../images/6c4ebefe/note_3.0-zh-cn.png) 
...
![](../../../../images/219b1b53/note_3.0-zh-cn.png) 
...
![](../../../../images/29c6a4ed/note_3.0-zh-cn.png) 
...
![](../../../../images/08b0f2bf/note_3.0-zh-cn.png) 
...
![](../../../../images/ad91525b/note_3.0-zh-cn.png) 
...
![](../../../../images/fcf19684/note_3.0-zh-cn.png) 
...
![](../../../../images/48cb192d/note_3.0-zh-cn.png) 
...
![](../../../../images/e96adf41/note_3.0-zh-cn.png) 
...
![](../../../../images/af2f0f48/note_3.0-zh-cn.png) 
...
![](../../../../images/d8866149/note_3.0-zh-cn.png) 
...
![](../../../../images/8ef2dab3/note_3.0-zh-cn.png) 
...
![](../../../../images/e569733a/note_3.0-zh-cn.png) 
...
![](../../../../images/6b14392c/note_3.0-zh-cn.png) 
...
![](../../../../images/bdef3172/note_3.0-zh-cn.png) 
...
![](../../../../images/844b3e69/note_3.0-zh-cn.png) 
...
![](../../../../images/ab33820b/note_3.0-zh-cn.png) 
...
![](../../../../images/ca7d0326/note_3.0-zh-cn.png) 
...
![](../../../../images/ab4f7332/note_3.0-zh-cn.png) 
...
![](../../../../images/2b921d85/note_3.0-zh-cn.png) 
...
![](../../../../images/8e15129e/note_3.0-zh-cn.png) 
...
![](../../../../images/736fa7e3/note_3.0-zh-cn.png) 
...
![](../../../../images/9333e3b9/note_3.0-zh-cn.png) 
...
![](../../../../images/f8c0798e/note_3.0-zh-cn.png) 
...
![](../../../../images/c3b2aacb/note_3.0-zh-cn.png) 
...
![](../../../../images/a7c9da57/note_3.0-zh-cn.png) 
...
![](../../../../images/39e63474/note_3.0-zh-cn.png) 
...
![](../../../../images/f759514c/note_3.0-zh-cn.png) 
...
![](../../../../images/37dfb7e8/note_3.0-zh-cn.png) 
...
![](../../../../images/351fed14/note_3.0-zh-cn.png) 
...
![](../../../../images/dcf87f40/note_3.0-zh-cn.png) 
...
![](../../../../images/3ab7cb67/note_3.0-zh-cn.png) 
...
![](../../../../images/aabb5a2b/note_3.0-zh-cn.png) 
...
![](../../../../images/b94d3686/note_3.0-zh-cn.png) 
...
![](../../../../images/cd87e018/note_3.0-zh-cn.png) 
...
![](../../../../images/dc8020d1/note_3.0-zh-cn.png) 
...
![](../../../../images/b9084861/note_3.0-zh-cn.png) 
...
![](../../../../images/5e1744e0/note_3.0-zh-cn.png) 
