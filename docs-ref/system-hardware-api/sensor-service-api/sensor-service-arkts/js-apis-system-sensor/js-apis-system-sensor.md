...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-sensor
kit: 系统
...
![](../../../../images/18a131e6/note_3.0-zh-cn.png) 

- 模块维护策略：
  - 对于Lite Wearable设备类型，该模块长期维护，正常使用。
  - 对于支持该模块的其他设备类型，该模块从API version 8开始不再维护，推荐使用新接口[@ohos.sensor](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ACCELEROMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#accelerometer9)。
...
![](../../../../images/2cf7b7d7/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[ACCELEROMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#accelerometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ORIENTATION](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#orientationdeprecated)。
...
![](../../../../images/a02f3b2f/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[ORIENTATION](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#orientationdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PROXIMITY](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#proximitydeprecated)。
...
![](../../../../images/41b971d4/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[PROXIMITY](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#proximitydeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[AMBIENT\_LIGHT](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#ambient_lightdeprecated)。
...
![](../../../../images/e6733c74/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[AMBIENT\_LIGHT](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#ambient_lightdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PEDOMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#pedometerdeprecated)。
...
![](../../../../images/2459f849/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[PEDOMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#pedometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[BAROMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#barometerdeprecated-1)。
...
![](../../../../images/d09493d0/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[BAROMETER](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#barometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[HEART\_RATE](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#heart_ratedeprecated)。
...
![](../../../../images/74065600/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[HEART\_RATE](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#heart_ratedeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[WEAR\_DETECTION](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#wear_detectiondeprecated)。
...
![](../../../../images/e435e40b/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[WEAR\_DETECTION](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#wear_detectiondeprecated-2)。
...
![](../../../../images/7242f5d0/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[GYROSCOPE](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#gyroscopedeprecated)。
...
![](../../../../images/de77f7d0/note_3.0-zh-cn.png) 
...
除Lite Wearable外，从API Version8开始，推荐使用[GYROSCOPE](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor#gyroscopedeprecated-2)。
