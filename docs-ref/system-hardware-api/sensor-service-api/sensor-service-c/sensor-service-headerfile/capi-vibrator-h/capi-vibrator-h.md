...
title: "vibrator.h"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-vibrator-h
kit: 系统
last_updated: "2026-04-22"
slug: capi-vibrator-h
---
...
| [Vibrator\_Attribute](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-vibrator-vibrator-attribute/capi-vibrator-vibrator-attribute) attribute | - 振动属性，请参考VibrateAttribute。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 如果操作成功，则返回0；否则返回非零值。请参阅 [Vibrator\_ErrorCode](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-headerfile/capi-vibrator-type-h/capi-vibrator-type-h#vibrator_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Vibrator\_FileDescription](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-vibrator-vibrator-filedescription/capi-vibrator-vibrator-filedescription) fileDescription | - 自定义振动效果文件描述符，请参阅 [Vibrator\_FileDescription](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-vibrator-vibrator-filedescription/capi-vibrator-vibrator-filedescription)。 |
| [Vibrator\_Attribute](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-vibrator-vibrator-attribute/capi-vibrator-vibrator-attribute) vibrateAttribute | - 振动属性，请参阅 [Vibrator\_Attribute](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-vibrator-vibrator-attribute/capi-vibrator-vibrator-attribute)。 |
