...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-driver-devicemanager
kit: 系统
...
![](../../../../images/ffeb04de/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[驱动错误码](/ref/system-hardware-api/driver-development-api/driver-development-errcode/errorcode-devicemanager/errorcode-devicemanager)。
...
![](../../../../images/f3da6424/note_3.0-zh-cn.png) 
...
| deviceId | number | 是 | 设备ID，通过queryDevices获得。 |
| onDisconnect | AsyncCallback&lt;number&gt; | 是 | 回调函数。当绑定设备断开时，err为undefined，data为解绑的设备ID；否则为错误对象。 |
| callback | AsyncCallback&lt;{deviceId: number; remote: [rpc.IRemoteObject](/ref/ipc-api/ipc-arkts/js-apis-rpc/js-apis-rpc#iremoteobject);}&gt; | 是 | 回调函数。当绑定设备成功时，err为undefined，data包含设备ID和绑定设备驱动通信对象；否则为错误对象。 |
...
![](../../../../images/92b10a0c/note_3.0-zh-cn.png) 
...
![](../../../../images/f12c50bf/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;{deviceId: number; remote: [rpc.IRemoteObject](/ref/ipc-api/ipc-arkts/js-apis-rpc/js-apis-rpc#iremoteobject);}&gt; | Promise对象，返回一个包含设备ID和IRemoteObject的对象。 |
...
![](../../../../images/b9728e75/note_3.0-zh-cn.png) 
...
![](../../../../images/99499a7f/note_3.0-zh-cn.png) 
...
![](../../../../images/776fa9fc/note_3.0-zh-cn.png) 
...
| remote11+ | [rpc.IRemoteObject](/ref/ipc-api/ipc-arkts/js-apis-rpc/js-apis-rpc#iremoteobject) | 否 | 否 | 远程驱动程序对象。 |
