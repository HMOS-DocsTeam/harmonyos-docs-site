...
title: "驱动错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-devicemanager
kit: 系统
...
![](../../../../images/e8eadbe0/note_3.0-zh-cn.png) 
...
3. 通过[deviceManager.BusType](/ref/system-hardware-api/driver-development-api/driver-development-arkts/js-apis-driver-devicemanager/js-apis-driver-devicemanager#bustype)查询支持的枚举值。
