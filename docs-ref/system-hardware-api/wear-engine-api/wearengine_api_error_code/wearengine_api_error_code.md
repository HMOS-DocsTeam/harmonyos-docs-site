...
title: "ArkTS API错误码"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api_error_code
kit: 系统
...
![](../../../images/e4ab5e3b/note_3.0-zh-cn.png) 
...
1. 登录开发者联盟[申请接入Wear Engine服务](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wearengine_preparation/wearengine_apply)，勾选兼容选项。
2. 通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题，华为支持人员会及时处理。
...
参考[请求用户授权](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wear-engine-app-development/request_user_authorization)，确认用户已授权相关权限。
...
调用[getConnectedDevices](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#getconnecteddevices)接口重新获取设备ID。
...
1. 应用的签名证书等信息和云端不一致。
2. [randomId](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#device)错误。
...
2. 断开重连设备。
3. 在metadata中配置[clientId](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wearengine_preparation/configuration_client_id)。
