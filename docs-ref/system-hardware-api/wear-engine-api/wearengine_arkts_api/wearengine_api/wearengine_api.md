...
![](../../../../images/cf84740d/note_3.0-zh-cn.png) 

针对系统能力SystemCapability.Health.WearEngine，请先使用[canIUse()](/ref/common-basic-arkts/js-apis-syscap/js-apis-syscap#caniuse)接口判断当前设备是否支持此syscap及对应接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#context) | 是 | Context上下文，仅支持包含connectServiceExtensionAbility方法的Context（例：[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#uiabilitycontext-1)）。 |
...
以下错误码的详细介绍请参见[Wear Engine ArkTS API错误码](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。

| 错误码ID | 错误信息 |
| --- | --- |
| 401 | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified. 2. Incorrect parameter types. |
| 801 | Capability not supported. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
| [1008500001](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500001-网络错误) | Network error. The network is unavailable. |
| [1008500004](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500004-应用未申请wear-engine服务) | App has not applied for the Wear Engine service. |
| [1008500006](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500006-用户未同意隐私授权) | User privacy is not agreed. |
| [1008500007](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500007-穿戴设备侧能力不支持) | The device capability is not supported. |
| [1008500008](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
以下错误码的详细介绍请参见[Wear Engine ArkTS API错误码](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code)。
...
| 801 | Capability not supported. |
| [1008500001](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500001-网络错误) | Network error. The network is unavailable. |
| [1008500002](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500002-无绑定设备) | No device is bound. |
| [1008500003](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500003-设备未连接) | Device disconnected. |
| [1008500004](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500004-应用未申请wear-engine服务) | App has not applied for the Wear Engine service. |
| [1008500006](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500006-用户未同意隐私授权) | User privacy is not agreed. |
| [1008500008](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
...
| [1008500003](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500003-设备未连接) | Device disconnected. |
| [1008500004](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500004-应用未申请wear-engine服务) | App has not applied for the Wear Engine service. |
| [1008500005](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500005-用户未授权) | The HUAWEI ID is not authorized. |
| [1008500006](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500006-用户未同意隐私授权) | User privacy is not agreed. |
| [1008500008](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
| [1008500008](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500010-无效设备id) | Device ID is invalid. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500010-无效设备id) | Device ID is invalid. |
| [1008500012](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500012-回调函数过多) | Too many callbacks of the same type. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
| transformLocalBundleName | boolean | 否 | 是否需要将本地包名和指纹转换为兼容应用在云端存储的包名和指纹。默认值：false。  true：转换，false：不转换。  待兼容应用设置请参考[申请接入Wear Engine服务](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wearengine_preparation/wearengine_apply)。 |
...
| [1008500009](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500010-无效设备id) | Device ID is invalid. |
| [1008500011](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008500011-无效文件) | File is invalid. |
| [1008509999](/ref/system-hardware-api/wear-engine-api/wearengine_api_error_code/wearengine_api_error_code#section1008509999-内部错误) | Internal error. |
...
| fingerprint | string | 否 | 否 | [应用指纹，用于标识应用的唯一身份。](/system-hardware/wear-engine-kit-guide/wearengine_faq/wearengine_faq-9) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| file | [fs.File](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs#file) | 否 | 否 | 文件对象。 |
...
| transformLocalAppInfo | boolean | 否 | 是 | 是否需要将本地包名和指纹转换为兼容应用在云端存储的包名和指纹。默认值：false。  true：转换；false：不转换。  待兼容应用设置请参考[申请接入Wear Engine服务](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wearengine_preparation/wearengine_apply)。 |
...
| data | number[] | 否 | 否 | 数据内容，格式及含义请参考[穿戴设备传感器数据格式及样例](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wear-engine-app-development/device_sensor#穿戴设备传感器数据格式及样例)。 |
