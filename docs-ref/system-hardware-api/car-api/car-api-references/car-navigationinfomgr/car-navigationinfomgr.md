...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/car-navigationinfomgr
kit: 系统
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| naviTurnMode | number | 否 | 否 | 导航转向模式，十六进制，取值范围0~3E7，参考[naviTurnMode](/ref/system-hardware-api/car-api/car-api-references/car-appendix/car-appendix-naviturnmode/car-appendix-naviturnmode)，按照16进制的格式传递。 |
...
| trafficLane | string | 否 | 否 | 车道线，从最左边到最右边按序排列。通讯以四位为一个单元进行解析，每个单元对应一个车道线，根据需求可以传多个车道线，图标编码为枚举值，具体参考[trafficLane](/ref/system-hardware-api/car-api/car-api-references/car-appendix/car-appendix-trafficlane/car-appendix-trafficlane)。 |
...
以下错误码的详细介绍请参见[ArkTS API错误码](/ref/system-hardware-api/car-api/car-api-references/car-error-code/car-error-code)。
