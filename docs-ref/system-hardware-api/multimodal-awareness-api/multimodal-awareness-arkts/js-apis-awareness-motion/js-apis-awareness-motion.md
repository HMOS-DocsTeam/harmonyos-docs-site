...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-awareness-motion
kit: 系统
...
![](../../../../images/4c30fd5d/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[动作感知错误码](/ref/system-hardware-api/multimodal-awareness-api/multimodal-awareness-arkts-errcode/errorcode-motion/errorcode-motion)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
