...
![](../../../../images/64e2d7b6/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[设备状态感知错误码](/ref/system-hardware-api/multimodal-awareness-api/multimodal-awareness-arkts-errcode/errorcode-devicestatus/errorcode-devicestatus)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
