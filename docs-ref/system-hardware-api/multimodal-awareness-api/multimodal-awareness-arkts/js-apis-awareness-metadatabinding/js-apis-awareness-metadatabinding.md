...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-awareness-metadatabinding
kit: 系统
...
![](../../../../images/1fe88c5b/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[记忆链接错误码](/ref/system-hardware-api/multimodal-awareness-api/multimodal-awareness-arkts-errcode/errorcode-metadatabinding/errorcode-metadatabinding)。
