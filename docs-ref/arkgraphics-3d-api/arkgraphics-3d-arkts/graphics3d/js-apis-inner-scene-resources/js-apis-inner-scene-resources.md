...
![](../../../../images/c6c976c7/note_3.0-zh-cn.png) 
...
| uri | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 是 | 需要加载的资源，默认值为undefined。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| inputs | Record&lt;string, number | [Vec2](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec2) | [Vec3](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec3) | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | Image> | 是 | 否 | 着色器输入。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputs | Record&lt;string, number | [Vec2](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec2) | [Vec3](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec3) | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | Image> | 是 | 一个字符串到值的映射，用于设置shader输入。 |
...
| factor | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | 否 | 否 | 基于物理渲染（PBR）属性因子，不同属性不同含义。 |
...
| aabb | [Aabb](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#aabb) | 是 | 否 | 轴对齐边界盒。 |
...
| aabb | [Aabb](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#aabb) | 是 | 否 | 轴对齐包围盒。 |
...
| indirectDiffuseFactor | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | 否 | 否 | 间接散射系数。 |
| indirectSpecularFactor | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | 否 | 否 | 间接反射系数。 |
| environmentMapFactor | [Vec4](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec4) | 否 | 否 | 环境地图系数。 |
| environmentImage | [Image](#image) | null | 否 | 是 | 环境图片，默认为undefined。 |
| radianceImage | [Image](#image) | null | 否 | 是 | 辐射图片，默认为undefined。 |
| irradianceCoefficients | [Vec3](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#vec3)[] | 否 | 是 | 辐射系数，默认为undefined。 |
| environmentRotation23+ | [Quaternion](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene-types/js-apis-inner-scene-types#quaternion) | 否 | 是 | 环境光的旋转，默认为undefined，接收参数需为归一化后的四元数。 |
...
特效类型，继承自[SceneResource](#sceneresource-1)。由[createEffect](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene/js-apis-inner-scene#createeffect21)接口获得。
