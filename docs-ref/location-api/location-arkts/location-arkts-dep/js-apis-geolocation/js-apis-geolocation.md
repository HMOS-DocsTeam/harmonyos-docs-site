...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocation
kit: 应用服务
last_updated: "2026-04-22"
slug: js-apis-geolocation
---
...
![](../../../../images/80c97384/note_3.0-zh-cn.png) 

本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

从API Version 9开始，该接口不再维护，推荐使用新接口[geoLocationManager](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager)。
...
如果应用在后台运行时也需要访问设备位置，需要申请LOCATION类型的长时任务，这样应用在切入后台之后，系统可以继续上报位置信息。长时任务申请可参考[长时任务](/background-task-kit/continuous-task)。

应用如需使用ohos.permission.LOCATION\_IN\_BACKGROUND权限，需要在设置界面由用户手动授予，具体授权方式可参考[ohos.permission.LOCATION\_IN\_BACKGROUND权限说明](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-all-user#ohospermissionlocation_in_background)。

开发者可以在应用配置文件中声明所需要的权限，具体可参考[向用户申请授权](/system-security/access-control/app-permission-mgmt/request-app-permissions/request-user-authorization)。
...
![](../../../../images/2a46acc1/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageronlocationchange)替代。
...
![](../../../../images/65dcf9c7/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerofflocationchange)替代。
...
![](../../../../images/1e759d72/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationEnabledChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageronlocationenabledchange)替代。
...
![](../../../../images/753ae093/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationEnabledChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerofflocationenabledchange)替代。
...
![](../../../../images/f6b9b808/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.on('cachedGnssLocationsChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageroncachedgnsslocationschange)替代。
...
![](../../../../images/3d7d512b/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.off('cachedGnssLocationsChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageroffcachedgnsslocationschange)替代。
...
![](../../../../images/b79676ba/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.on('satelliteStatusChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageronsatellitestatuschange)替代。
...
![](../../../../images/a257a020/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.off('satelliteStatusChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageroffsatellitestatuschange)替代。
...
![](../../../../images/09dcaa25/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.on('nmeaMessage')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageronnmeamessage)替代。
...
![](../../../../images/bfdee836/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.off('nmeaMessage')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageroffnmeamessage)替代。
...
![](../../../../images/fe327645/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.on('gnssFenceStatusChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerongnssfencestatuschange)替代。
...
| want | [WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent) | 是 | 用于接收地理围栏事件上报（进出围栏）。 |
...
![](../../../../images/68ae9a8d/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.off('gnssFenceStatusChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageroffgnssfencestatuschange)替代。
...
![](../../../../images/e8c069b6/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation)替代。
...
![](../../../../images/5a7dbd21/note_3.0-zh-cn.png) 
...
![](../../../../images/1b89ea2e/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation-2)替代。
...
![](../../../../images/ba0e8cf6/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getLastLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetlastlocation)替代。
...
![](../../../../images/e37c79e7/note_3.0-zh-cn.png) 
...
![](../../../../images/55ef7118/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isLocationEnabled](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerislocationenabled)替代。
...
![](../../../../images/b0b78585/note_3.0-zh-cn.png) 
...
![](../../../../images/9b1d3a84/note_3.0-zh-cn.png) 
...
![](../../../../images/316229c3/note_3.0-zh-cn.png) 
...
![](../../../../images/e4a8847b/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isGeocoderAvailable](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerisgeocoderavailable)替代。
...
![](../../../../images/3a46c62e/note_3.0-zh-cn.png) 
...
![](../../../../images/2d24e7f0/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetaddressesfromlocation)替代。
...
![](../../../../images/dd339ea4/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetaddressesfromlocation-1)替代。
...
![](../../../../images/cfafcf84/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetaddressesfromlocationname)替代。
...
![](../../../../images/a7a7aa27/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetaddressesfromlocationname-1)替代。
...
![](../../../../images/c82e2e81/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcachedgnsslocationssize)替代。
...
![](../../../../images/8e338af2/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcachedgnsslocationssize-1)替代。
...
![](../../../../images/75d444ab/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerflushcachedgnsslocations)替代。
...
![](../../../../images/04b42e2a/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerflushcachedgnsslocations-1)替代。
...
![](../../../../images/d356242c/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.sendCommand](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagersendcommand)替代。
...
![](../../../../images/ef8bb623/note_3.0-zh-cn.png) 
...
![](../../../../images/1f662958/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.ReverseGeoCodeRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#reversegeocoderequest)替代。
...
![](../../../../images/23801a17/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.GeoCodeRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geocoderequest)替代。
...
![](../../../../images/500c6fc6/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.GeoAddress](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geoaddress)替代。
...
![](../../../../images/1cf2e62d/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.LocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequest)替代。
...
![](../../../../images/149c05ae/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#currentlocationrequest)替代。
...
![](../../../../images/20dfcfab/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.SatelliteStatusInfo](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#satellitestatusinfo)替代。
...
![](../../../../images/1fdb4c46/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.CachedGnssLocationsRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#cachedgnsslocationsrequest)替代。
...
![](../../../../images/1f3524b2/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.Geofence](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geofence)替代。
...
![](../../../../images/629a950b/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.GeofenceRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geofencerequest)替代。
...
![](../../../../images/4a473ad7/note_3.0-zh-cn.png) 

从API version 8开始支持。

从API version 9开始废弃，建议使用[geoLocationManager.LocationCommand](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationcommand)替代。
...
![](../../../../images/600b7a79/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.Location](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#location)替代。
...
![](../../../../images/be674ebd/note_3.0-zh-cn.png) 
...
![](../../../../images/bf32f2cd/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestPriority](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestpriority)替代。
...
![](../../../../images/aab2d6e0/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestScenario](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestscenario)替代。
...
![](../../../../images/cb56341c/note_3.0-zh-cn.png) 

从API version 9开始废弃，建议使用[位置服务错误码](/ref/location-api/location-arkts-errcode/errorcode-geolocationmanager/errorcode-geolocationmanager)替代。
