...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-location
kit: 应用服务
...
![](../../../../images/09f44fa5/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 3开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 对于Lite Wearable设备类型，该模块长期维护，正常使用。
- 对于支持该模块的其他设备类型，该模块从API Version 9开始，该接口不再维护，推荐使用新接口[geoLocationManager](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager)。
...
![](../../../../images/d8ba1622/note_3.0-zh-cn.png) 

除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation)替代。
...
![](../../../../images/51afa5e6/note_3.0-zh-cn.png) 
...
![](../../../../images/d288cb66/note_3.0-zh-cn.png) 

除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanageronlocationchange)替代。
...
![](../../../../images/9fec9568/note_3.0-zh-cn.png) 

除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagerofflocationchange)替代。
...
![](../../../../images/9a034661/note_3.0-zh-cn.png) 
...
![](../../../../images/9bcdb681/note_3.0-zh-cn.png) 

除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#currentlocationrequest)替代。
...
![](../../../../images/9d837c1f/note_3.0-zh-cn.png) 

除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.Location](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#location)替代。
...
![](../../../../images/446c05fa/note_3.0-zh-cn.png) 
...
![](../../../../images/a27f1d6a/note_3.0-zh-cn.png) 
...
![](../../../../images/c8103d98/note_3.0-zh-cn.png) 
