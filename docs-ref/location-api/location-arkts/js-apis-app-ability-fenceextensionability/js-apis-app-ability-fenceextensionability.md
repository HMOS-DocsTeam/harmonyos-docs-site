...
![](../../../images/4e7b6374/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [FenceExtensionContext](/ref/location-api/location-arkts/js-apis-app-ability-fenceextensioncontext/js-apis-app-ability-fenceextensioncontext) | 否 | 否 | 围栏服务上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transition | [geoLocationManager.GeofenceTransition](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geofencetransition12) | 是 | 地理围栏事件信息；包含地理围栏ID和具体的地理围栏事件。 |
