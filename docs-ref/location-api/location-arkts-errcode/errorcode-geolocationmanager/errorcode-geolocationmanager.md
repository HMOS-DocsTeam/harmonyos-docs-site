...
![](../../../images/97547a76/note_3.0-zh-cn.png) 
...
定位请求参数[LocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequest)、[CurrentLocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#currentlocationrequest)中的精度要求(maxAccuracy)值设定过小。

****处理步骤****

请将定位请求参数[LocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequest)、[CurrentLocationRequest](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#currentlocationrequest)中的精度要求(maxAccuracy)适当放宽，可参考如下场景建议：

- 当[scenario](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestscenario)为NAVIGATION/TRAJECTORY\_TRACKING/CAR\_HAILING，或者[priority](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestpriority)为ACCURACY时，建议设置maxAccuracy为大于10的值。
- 当[scenario](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestscenario)为DAILY\_LIFE\_SERVICE/NO\_POWER，或者[priority](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#locationrequestpriority)为LOW\_POWER/FIRST\_FIX时，建议设置maxAccuracy为大于100的值。
...
系统未提前将位置信息进行缓存的情况下，需使用[getCurrentLocation](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation)接口获取实时位置信息。
