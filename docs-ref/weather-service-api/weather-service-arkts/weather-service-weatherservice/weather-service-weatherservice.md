...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/weather-service-weatherservice
kit: 应用服务
last_updated: "2026-04-22"
slug: weather-service-weatherservice
---
...
以下错误码的详细介绍请参见天气服务[ArkTS API错误码](/ref/weather-service-api/weather-service-arkts/weather-service-error-code/weather-service-error-code)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-common/js-apis-app-ability-common#context) | 是 | 上下文，目前只支持[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)或[UIExtensionAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiextensionability/js-apis-app-ability-uiextensionability)的上下文环境。 |
| request | [WeatherRequest](#weatherrequest) | 是 | 天气数据请求体。 |
...
| icon | [resourceManager.Resource](/ref/localization-api/localization-arkts/js-apis-resource-manager/js-apis-resource-manager#resource9) | 否 | 是 | 预警图标。 |
...
| icon | [resourceManager.Resource](/ref/localization-api/localization-arkts/js-apis-resource-manager/js-apis-resource-manager#resource9) | 否 | 否 | 天气现象图标。 |
...
| icon | [resourceManager.Resource](/ref/localization-api/localization-arkts/js-apis-resource-manager/js-apis-resource-manager#resource9) | 否 | 否 | 月相图标。 |
