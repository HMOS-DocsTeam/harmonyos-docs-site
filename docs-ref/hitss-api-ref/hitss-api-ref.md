...
1. 开发应用时，在访问命令传输接口或系统级接口前，需要申请权限：ohos.permission.CALL\_TPM\_CMD，申请方式请参考：[申请使用受限权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl)。
...
![](../images/f79580f8/note_3.0-zh-cn.png) 
