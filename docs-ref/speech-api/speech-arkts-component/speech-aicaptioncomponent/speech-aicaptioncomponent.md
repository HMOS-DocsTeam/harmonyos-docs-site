...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/speech-aicaptioncomponent
kit: AI
...
| sampleRate | audio.[AudioSamplingRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosamplingrate8) | 否 | 否 | 音频采样率。  当前仅支持16000采样率。 |
| soundChannel | audio.[AudioChannel](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiochannel8) | 否 | 否 | 音频声道。  当前仅支持1个通道。 |
