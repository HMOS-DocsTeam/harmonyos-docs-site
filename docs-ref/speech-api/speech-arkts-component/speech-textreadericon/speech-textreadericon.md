...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| readState | [ReadStateCode](/ref/speech-api/speech-arkts/speech-readstatecode/speech-readstatecode) | 是 | @Link | 播报状态。  ****说明：****  ReadState使用[@Link装饰器：父子双向同步](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-component-state-management/arkts-link)。 |
