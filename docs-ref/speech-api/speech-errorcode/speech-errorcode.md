...
![](../../images/4467368a/note_3.0-zh-cn.png) 
...
1. PC端场景下，拉起朗读详情页面时，需要在初始化前设置好[setWindowStage](/ref/speech-api/speech-arkts/speech-windowmanager/speech-windowmanager#setwindowstage)。如果是其他设备类型，可以忽略此步骤。
...
需要首先调用[init](/ref/speech-api/speech-arkts/speech-textreader-api/speech-textreader-api#init)方法初始化TextReader。
