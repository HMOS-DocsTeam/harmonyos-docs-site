...
| 405 | 权限错误 | 请检查是否在AGC网站上开启了钱包服务能力，请参见[创建Wallet Kit服务](/wallet-kit-guide/wallet-preparations)。并检查申请的服务号（passTypeIdentifier）对应的卡券类型是否与调用的接口相对应。如果检查正确，请通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题。 |
