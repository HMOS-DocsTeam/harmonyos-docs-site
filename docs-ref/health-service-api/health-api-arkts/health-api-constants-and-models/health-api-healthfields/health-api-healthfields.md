...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthfields
kit: 应用服务
last_updated: "2026-04-22"
slug: health-api-healthfields
---
...
![](../../../../images/b48027ad/note_3.0-zh-cn.png) 
...
海拔详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| spo2 | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'sum' | 'count'> | 否 | 否 | 血氧饱和度聚合统计。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| bodyTemperature | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'sum' | 'last'> | 否 | 否 | 体温聚合统计。 |
...
步频详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| step | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 步数聚合统计。 |
| calorie | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 卡路里聚合统计。 |
| distance | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 距离聚合统计。 |
| climbHighAltitude | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 爬高海拔差聚合统计。 |
| isIntensity | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 中高强度聚合统计。 |
| isStand | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 站立聚合统计。 |
...
潜水深度详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
运动心率详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| bpm | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'avg' | 'sum' | 'count'> | 否 | 否 | 动态心率聚合统计。 |
...
跳跃详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
位置详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
标记点采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
踏频详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
功率详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
阻力详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| restBpm | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'sum' | 'count' | 'max' | 'min' | 'avg'> | 否 | 否 | 静息心率聚合统计。 |
...
| paceMap | [healthStore.PaceValueType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#pacevaluetype) | 否 | 是 | 每公里的配速，若未填写，默认为空。单位：秒/公里  例如  '1.0':407.945  '2.0':473.98846  '2.170':473.98846  最后不满一公里的部分，按比例换算为整公里的配速存入。 |
| partTimeMap | [healthStore.PaceValueType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#pacevaluetype) | 否 | 是 | 公制分段数据表（key：公里，value：秒），若未填写，默认为空。  其中公里保留到小数点后4位。  Value是一个累积到当前公里的时间如：  - '1.0':3.0  - '2.0':6.0  - '3.0':9.0  - '21.0975':7020.0  - '42.195':18000.0  其中，21.0975，42.195分别为半马和全马的距离（仅半马全马key值小数点后不为0）。 |

## RunningForm

跑姿详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| skinTemperature | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'sum' | 'last'> | 否 | 否 | 皮肤体温聚合统计。 |

## SkipSpeed

跳绳速度详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
睡眠状态采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
速度详情数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| stressScore | Omit&lt;[AggregateMetrics](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#aggregatemetrics), 'sum'&gt; | 否 | 否 | 压力得分聚合统计。 |

## StrokeRate

桨频采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
划水频率采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
SWOLF采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
...
水温采样数据字段列表，继承[healthStore.SequencePoint](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#sequencepoint)。
