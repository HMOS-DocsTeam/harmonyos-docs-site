...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthstore
kit: 应用服务
last_updated: "2026-04-22"
slug: health-api-healthstore
---
...
| scopes | string[] | 否 | 是 | 非数据类型权限，使用scope授权，请参见[OAuth权限](/health-service-kit-guide/health-harmonyos/health-app-dev/health-cloudsync#oauth权限)，若未填写，默认为空。  ****起始版本：**** 5.1.0(18)  ****元服务API：**** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
...
| 名称 | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| readDataTypes | [DataType](#datatype)[] | 否 | 否 | 授权成功的读数据类型，其对应权限在[应用申请权限](/health-service-kit-guide/health-harmonyos/health-preparations/health-apply)和用户授权权限的交集中。  ****元服务API：**** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| writeDataTypes | [DataType](#datatype)[] | 否 | 否 | 授权成功的写数据类型，其对应权限在[应用申请权限](/health-service-kit-guide/health-harmonyos/health-preparations/health-apply)和用户授权权限的交集中。  ****元服务API：**** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| scopes | string[] | 否 | 是 | 非数据类型权限，使用scope授权，请参见[OAuth权限](/health-service-kit-guide/health-harmonyos/health-app-dev/health-cloudsync#oauth权限)，若未填写，默认为空。  ****起始版本：**** 5.1.0(18)  ****元服务API：**** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
...
| productId | string | 是 | 是 | 生态设备的华为全场景产品ID，需与category匹配，长度小于256字节。(插入数据源时必填)  例如手动输入场景：  category: [DeviceCategory](#devicecategory).MANUAL\_INPUT  productId: '0062' |
...
| summaries | Pick&lt;K, keyof K&gt; | 否 | 否 | 统计数据，锻炼记录关联的统计数据类型参考[exerciseSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-exercisedequencehelper/health-api-exercisedequencehelper)定义的模型。 |
| details | Pick&lt;DK, keyof DK&gt; | 否 | 是 | 详情数据，锻炼记录关联的详情数据类型参考[exerciseSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-exercisedequencehelper/health-api-exercisedequencehelper)定义的模型，若未填写，默认为空。 |
...
| 名称 | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| summaries | Pick&lt;K, keyof K&gt; | 否 | 否 | 统计数据，健康记录关联的统计数据类型参考[healthSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-healthsequencehelper/health-api-healthsequencehelper)定义的模型。 |
| details | Pick&lt;DK, keyof DK&gt; | 否 | 是 | 详情数据，健康记录关联的详情数据类型参考[healthSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-healthsequencehelper/health-api-healthsequencehelper)定义的模型，若未填写，默认为空。 |
...
| 名称 | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| fields | Pick&lt;K, keyof K&gt; | 否 | 否 | 数据的字段，数据类型对应的字段参考[samplePointHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-samplepointhelper/health-api-samplepointhelper)定义的模型。 |
...
| fields | Partial&lt;Pick&lt;FK, keyof FK&gt;&gt; | 否 | 是 | 要读取的字段列表，若samplePointDataType参数为数组，fields字段不能设置，数据类型对应的字段参考[samplePointHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-samplepointhelper/health-api-samplepointhelper)定义的模型。若为空，则用于读取所有字段。 |
...
| withPartialDetails | (keyof DK)[] | 否 | 是 | 读取部分详情数据类型（若需要读取部分详情，withDetails参数不能填写），锻炼记录与健康记录关联的详情数据类型分别参考[exerciseSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-exercisedequencehelper/health-api-exercisedequencehelper)与[healthSequenceHelper](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-healthsequencehelper/health-api-healthsequencehelper)定义的模型。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| context | [common.Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#context) | 是 | 上下文，目前只支持[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)或[UIExtensionAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiextensionability/js-apis-app-ability-uiextensionability)的上下文环境。 |
...
以下错误码的详细介绍请参见[运动健康服务ArkTS API错误码](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice)。

| 错误码ID | 错误信息 |
| --- | --- |
| [401](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section401-参数不合法) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified;2. Incorrect parameter types. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [401](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section401-参数不合法) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified;2. Incorrect parameter types; 3.Parameter verification failed. |
| [1002700001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002700001-系统内部错误) | System internal error. |
| [1002700002](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002700002-数据库异常) | Database processing error. |
| [1002701001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002701001-网络错误) | Network error. The network is unavailable. |
| [1002702001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002702001-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1002702002](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002702002-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1002703001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002703001-用户隐私未同意) | User privacy is not agreed. |

![](../../../images/dee797b4/note_3.0-zh-cn.png) 
...
![](../../../images/d673558a/note_3.0-zh-cn.png) 
...
![](../../../images/1a87a59e/note_3.0-zh-cn.png) 
...
![](../../../images/e6d70948/note_3.0-zh-cn.png) 
...
![](../../../images/4ee68193/note_3.0-zh-cn.png) 
...
![](../../../images/a5c02cfa/note_3.0-zh-cn.png) 
...
![](../../../images/d9d2f103/note_3.0-zh-cn.png) 
...
![](../../../images/c54e6a90/note_3.0-zh-cn.png) 
...
![](../../../images/987ac4b7/note_3.0-zh-cn.png) 
...
![](../../../images/2594d959/note_3.0-zh-cn.png) 
...
![](../../../images/b08edd2b/note_3.0-zh-cn.png) 
...
![](../../../images/79bd1553/note_3.0-zh-cn.png) 
...
![](../../../images/3f4d18f6/note_3.0-zh-cn.png) 
...
![](../../../images/2645c2c5/note_3.0-zh-cn.png) 
...
![](../../../images/7a534bf5/note_3.0-zh-cn.png) 
...
![](../../../images/2e486f0b/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| context | [common.UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#uiabilitycontext-1) | 是 | UIAbility上下文。 |
...
以下错误码的详细介绍请参见[运动健康服务ArkTS API错误码](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice)，其他错误码请参见[华为账号服务ArkTS错误码](/ref/account-api/account-api-error-code/account-api-error-code)。
...
![](../../../images/aa150362/note_3.0-zh-cn.png) 
...
![](../../../images/0f4f10ff/note_3.0-zh-cn.png) 
...
![](../../../images/ac4a3595/note_3.0-zh-cn.png) 
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [801](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section801-该设备不支持此api) | Capability not supported. Failed to call the API due to limited device capabilities. |
| [1002700001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002700001-系统内部错误) | System internal error. |
| [1002700002](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002700002-数据库异常) | Database processing error. |
| [1002701001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002701001-网络错误) | Network error. The network is unavailable. |
| [1002702001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1002702001-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
...
![](../../../images/42803ad5/note_3.0-zh-cn.png) 
...
![](../../../images/cc968db9/note_3.0-zh-cn.png) 
...
![](../../../images/3e4a3e37/note_3.0-zh-cn.png) 
