...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthservice
kit: 应用服务
last_updated: "2026-04-22"
slug: health-api-healthservice
---
...
SampleReal&lt;K extends Record&lt;string, [healthStore.HealthValueType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthvaluetype)&gt; = Record&lt;string, [healthStore.HealthValueType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthvaluetype)&gt;>
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| dataType | [healthStore.DataType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#datatype) | 否 | 否 | 实时融合数据类型。 |
...
| sportType | number | 否 | 否 | 运动类型，参见[锻炼记录类型常量](/ref/health-service-api/health-api-arkts/health-api-constants-and-models/health-api-exercisedequencehelper/health-api-exercisedequencehelper)子数据类型id。 |
...
| [401](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section401-参数不合法) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified. |
| [1009104003](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104003-非法指令) | Illegal command. Called when workout not in stoped or idle state. |
| [1009104999](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104999-通用错误码) | System internal error. |

![](../../../images/9166cd43/note_3.0-zh-cn.png) 

上述接口调用前，需先使用[init](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoreinit)方法进行初始化。
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [1009104001](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104001-联动已开启) | Sport service busy. Workout is already started by other application. |
| [1009104002](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104002-不支持运动类型) | Unsupported sport type. |
| [1009104003](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104003-非法指令) | Illegal command. Called when workout in sporting, paused or stoped state. |
| [1009104004](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104004-权限校验异常) | Permission verification error. Application has no permission, such as Motion Permission. |
| [1009104999](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104999-通用错误码) | System internal error. |

![](../../../images/7f47269b/note_3.0-zh-cn.png) 
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [1009104003](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104003-非法指令) | Illegal command. Called when workout in ready, paused or stoped state. |
| [1009104999](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104999-通用错误码) | System internal error. |

![](../../../images/09bb966c/note_3.0-zh-cn.png) 
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [1009104003](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104003-非法指令) | Illegal command. Called when workout in ready, sporting or stoped state. |
| [1009104999](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104999-通用错误码) | System internal error. |

![](../../../images/0418fa2b/note_3.0-zh-cn.png) 
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [1009104003](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104003-非法指令) | Illegal command. Called when workout is not started. |
| [1009104999](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section1009104999-通用错误码) | System internal error. |

![](../../../images/c1f56606/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| dataType | [healthStore.DataType](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#datatype) | 是 | 联动运动数据类型。 |
...
![](../../../images/9b5e921f/note_3.0-zh-cn.png) 
...
![](../../../images/31f5197e/note_3.0-zh-cn.png) 
...
![](../../../images/4deaf426/note_3.0-zh-cn.png) 
...
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission verification failed. |
| [401](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section401-参数不合法) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified;2. Parameter verification failed. |

![](../../../images/5c3a2906/note_3.0-zh-cn.png) 
...
![](../../../images/94666016/note_3.0-zh-cn.png) 
...
![](../../../images/e518346c/note_3.0-zh-cn.png) 
...
| 错误码ID | 错误信息 |
| --- | --- |
| [201](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section201-鉴权失败) | Permission denied. |
| [14500101](/ref/health-service-api/errorcode-healthservice/errorcode-healthservice#section14500101-服务异常) | Service exception. |

![](../../../images/2c226fe7/note_3.0-zh-cn.png) 
...
![](../../../images/1646a999/note_3.0-zh-cn.png) 
...
![](../../../images/7569ab31/note_3.0-zh-cn.png) 
