...
![](../../../../../images/3af37215/note_3.0-zh-cn.png) 
...
| fit-original-size | boolean | false | 否 | [image](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-basic-comp/js-service-widget-basic-image/js-service-widget-basic-image)组件在未设置宽高的情况下是否适应图源尺寸，该属性为true时object-fit属性不生效，svg类型图源不支持该属性。  默认值：false，表示[image](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-basic-comp/js-service-widget-basic-image/js-service-widget-basic-image)组件在未设置宽高的情况下不适应图源尺寸。 |
...
![](../../../../../images/a73ab278/note_3.0-zh-cn.png) 
...
![](../../../../../images/43baa7e3/zh-cn_image_0000002552800782.jpg)
