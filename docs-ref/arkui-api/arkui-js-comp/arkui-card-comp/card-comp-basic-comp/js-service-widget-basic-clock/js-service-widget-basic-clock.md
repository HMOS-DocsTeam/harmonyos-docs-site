...
title: "clock"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-basic-clock
kit: 应用框架
...
![](../../../../../images/898b1aaf/note_3.0-zh-cn.png) 
...
![](../../../../../images/cdc32e4a/zh-cn_image_0000002583440475.png)

## 样式

除支持[通用样式](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-universal-comp-inform/js-service-widget-common-styles/js-service-widget-common-styles)之外，还支持如下样式：

| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| font-family | <string> | sans-serif | 否 | 表盘数字的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过2.1.6 自定义字体样式指定的字体，会被选中作为文本的字体。 |

![](../../../../../images/3470cf51/note_3.0-zh-cn.png) 
...
![](../../../../../images/8cf79d69/zh-cn_image_0000002552960430.png)
