...
title: "button"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-basic-button
kit: 应用框架
last_updated: "2026-04-22"
slug: js-service-widget-basic-button
---
...
![](../../../../../images/b616b6c6/note_3.0-zh-cn.png) 
...
| font-weight | number | string | normal | 否 | 按钮的字体粗细，见[text组件font-weight的样式属性](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-basic-comp/js-service-widget-basic-text/js-service-widget-basic-text#样式)。 |
| font-family | <string> | sans-serif | 否 | 按钮的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-universal-comp-inform/js-service-widget-common-customizing-font/js-service-widget-common-customizing-font)指定的字体，会被选中作为文本的字体。 |
...
![](../../../../../images/b6ccd26d/note_3.0-zh-cn.png) 
...
![](../../../../../images/eccd845e/zh-cn_image_0000002552800778.jpg)
