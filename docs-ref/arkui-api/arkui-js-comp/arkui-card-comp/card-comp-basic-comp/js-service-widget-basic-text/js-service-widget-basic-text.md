...
title: "text"
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-basic-text
kit: 应用框架
...
![](../../../../../images/cbc707a9/note_3.0-zh-cn.png) 

从API version 8 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

## 子组件

支持<[span](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-basic-comp/js-service-widget-basic-span/js-service-widget-basic-span)>。
...
| font-family | string | sans-serif | 否 | 设置文本的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-universal-comp-inform/js-service-widget-common-customizing-font/js-service-widget-common-customizing-font)指定的字体，会被选中作为文本的字体。 |
...
![](../../../../../images/01575b62/note_3.0-zh-cn.png) 
...
![](../../../../../images/0d25e00e/zh-cn_image_0000002583480433.png)
