...
![](../../../../../images/a83d862e/note_3.0-zh-cn.png) 
...
| background | <linear-gradient> | - | 仅支持设置[渐变样式](/ref/arkui-api/arkui-js-comp/arkui-card-comp/card-comp-universal-comp-inform/js-service-widget-common-gradient/js-service-widget-common-gradient)，与background-color、background-image不兼容。 |
