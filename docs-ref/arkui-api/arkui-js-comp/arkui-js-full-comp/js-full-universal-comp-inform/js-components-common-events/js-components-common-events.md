...
title: "通用事件"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-events
kit: 应用框架
last_updated: "2026-04-22"
slug: js-components-common-events
---

# 通用事件

![](../../../../../images/7c50b830/note_3.0-zh-cn.png) 
...
![](../../../../../images/8ec39c13/note_3.0-zh-cn.png) 

除上述事件外，其他事件均为非冒泡事件，如[input的change事件](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-input/js-components-basic-input#事件)，详见各个组件。
...
| 属性 | 类型 | 说明 |
| --- | --- | --- |
| dataSet6+ | Object | 组件上通过通用属性设置的[data-\*](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-attributes/js-components-common-attributes#常规属性)的自定义属性组成的集合。 |
...
| 参数名 | 参数类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| pixelMap | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 前端传入的图片资源。 |
