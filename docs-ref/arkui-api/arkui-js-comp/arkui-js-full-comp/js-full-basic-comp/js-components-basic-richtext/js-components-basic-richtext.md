...
![](../../../../../images/97266bac/note_3.0-zh-cn.png) 
...
仅支持[通用属性](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-attributes/js-components-common-attributes)中的id、style和class属性。

## 样式

仅支持[通用样式](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-styles/js-components-common-styles)中的display和visibility样式。
...
![](../../../../../images/4204e43b/note_3.0-zh-cn.png) 
