...
title: "input"
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-input
kit: 应用框架
...
![](../../../../../images/6884b825/note_3.0-zh-cn.png) 
...
| font-weight | number | string | normal | 否 | 单行输入框或者按钮的字体粗细，见[text组件font-weight的样式属性](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-text/js-components-basic-text#样式)。 |
...
1. type为text
   ...
   ![](../../../../../images/36f524c7/zh-cn_image_0000002583480191.png)
2. type为button
   ...
   ![](../../../../../images/f06edd53/zh-cn_image_0000002552800542.png)
3. type为checkbox
   ...
   ![](../../../../../images/e59e58d6/zh-cn_image_0000002583440237.png)
4. type为radio
   ...
   ![](../../../../../images/4e61008c/zh-cn_image_0000002552960192.png)
