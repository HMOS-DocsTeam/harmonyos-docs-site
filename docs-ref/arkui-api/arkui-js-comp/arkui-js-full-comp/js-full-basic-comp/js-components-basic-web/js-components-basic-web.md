...
title: "web"
sidebar_position: 28
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-web
kit: 应用框架
last_updated: "2026-04-22"
slug: js-components-basic-web
---
...
![](../../../../../images/a678e3d3/note_3.0-zh-cn.png) 
...
| error | {url: string, errorCode: number, description: string} | 加载网页出现错误时触发或打开网页出错时触发。错误码的详细介绍请参见[Webview错误码](/ref/arkweb-api/arkweb-arkts-errcode/errorcode-webview/errorcode-webview)、[通用错误码](/ref/errorcode-universal/errorcode-universal)。 |
