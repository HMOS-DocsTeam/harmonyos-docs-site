...
![](../../../../../images/3893f69f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [CanvasRenderingContext2D](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-canvas-comp/js-components-canvas-canvasrenderingcontext2d/js-components-canvas-canvasrenderingcontext2d) | 用于在画布组件上绘制矩形、文本、图片等。 |
...
![](../../../../../images/8ba21b90/zh-cn_image_0000002552960204.png)
