...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-container-list-item-group
kit: 应用框架
...
![](../../../../../images/a218abc6/note_3.0-zh-cn.png) 

从API version 4开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

<[list](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-container-comp/js-components-container-list/js-components-container-list)>的子组件，用来展示分组，宽度默认充满list组件。
...
仅支持<[list-item](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-container-comp/js-components-container-list-item/js-components-container-list-item)>。
...
![](../../../../../images/82bf255f/note_3.0-zh-cn.png) 
...
![](../../../../../images/fc954642/zh-cn_image_0000002583480183.gif)
