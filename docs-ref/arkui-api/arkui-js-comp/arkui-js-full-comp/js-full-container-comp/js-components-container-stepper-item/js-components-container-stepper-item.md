...
title: "stepper-item"
sidebar_position: 13
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-container-stepper-item
kit: 应用框架
last_updated: "2026-04-22"
slug: js-components-container-stepper-item
---

# stepper-item

![](../../../../../images/03d84268/note_3.0-zh-cn.png) 
...
| font-family | string | sans-serif | 否 | 字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-customizing-font/js-components-common-customizing-font)指定的字体，会被选中作为文本的字体。 |

![](../../../../../images/21c7514e/note_3.0-zh-cn.png) 
...
不支持[通用方法](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-methods/js-components-common-methods)。

## 示例

详见[stepper示例](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-container-comp/js-components-container-stepper/js-components-container-stepper)。
