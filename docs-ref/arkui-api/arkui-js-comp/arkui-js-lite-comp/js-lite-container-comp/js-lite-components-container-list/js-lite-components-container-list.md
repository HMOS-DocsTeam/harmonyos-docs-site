...
![](../../../../../images/9224a9c4/note_3.0-zh-cn.png) 

该组件从API version 4 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

## 子组件

仅支持<[list-item](/ref/arkui-api/arkui-js-comp/arkui-js-lite-comp/js-lite-container-comp/js-lite-components-container-list-item/js-lite-components-container-list-item)>。
...
![](../../../../../images/059bc7f4/zh-cn_image_0000002583440451.png)
