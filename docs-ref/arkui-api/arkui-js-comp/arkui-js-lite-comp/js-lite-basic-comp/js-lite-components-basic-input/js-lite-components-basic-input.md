...
title: "input"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-lite-components-basic-input
kit: 应用框架
last_updated: "2026-04-22"
slug: js-lite-components-basic-input
---
...
![](../../../../../images/d28c589b/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| type | string | button | 否 | input组件类型，可选值为button，checkbox，radio，text。  button，checkbox，radio，text不支持动态修改。可选值定义如下：  - button：定义可点击的按钮。  - checkbox：定义多选框。  - radio：定义单选按钮，允许在多个拥有相同name值的选项中选中其中一个。  - text：定义用于文字输入的文本框，仅在支持输入法功能的真机设备上，支持点击拉起文字输入界面，[UI预览](/arkui/ui-debug-optimize/ui-ide-previewer)无效果。 |
...
- 当input类型为checkbox、radio时，支持如下事件：
  ...
  | click | - | 点击动作触发该事件。 |
  | longpress | - | 长按动作触发该事件。 |
  | swipe5+ | [SwipeEvent](/ref/arkui-api/arkui-js-comp/arkui-js-lite-comp/js-lite-universal-comp-inform/js-lite-common-events/js-lite-common-events) | 组件上快速滑动后触发。 |
...
1. type为button
   ...
   ![](../../../../../images/1f1e10a5/zh-cn_image_0000002552800760.png)
2. type为checkbox
   ...
   ![](../../../../../images/3906c97d/zh-cn_image_0000002583440455.gif)
3. type为radio
   ...
   ![](../../../../../images/e00fdb9f/zh-cn_image_0000002552960410.gif)
