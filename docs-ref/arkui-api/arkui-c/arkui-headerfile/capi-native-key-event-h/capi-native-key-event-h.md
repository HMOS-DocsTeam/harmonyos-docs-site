...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_KeyEventType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-key-event-h/capi-native-key-event-h#arkui_keyeventtype) | ArkUI\_KeyEventType 按键的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_KeySourceType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-key-event-h/capi-native-key-event-h#arkui_keysourcetype) | ArkUI\_KeySourceType 当前按键的输入设备类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_KeyIntension](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-key-event-h/capi-native-key-event-h#arkui_keyintension) | ArkUI\_KeyIntension 按键对应的意图。 |
