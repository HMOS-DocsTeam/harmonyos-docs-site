...
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*pixelMap | 创建指定屏幕id的OH\_PixelmapNative对象，此处作为出参返回。 |
