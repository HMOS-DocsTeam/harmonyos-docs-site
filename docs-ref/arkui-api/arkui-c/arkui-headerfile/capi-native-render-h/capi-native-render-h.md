...
sidebar_position: 13
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-render-h
kit: 应用框架
last_updated: "2026-04-22"
slug: capi-native-render-h
---
...
提供NativeRender接口的类型定义。更多详细介绍请参考[构建渲染节点](/arkui/arkts-use-ndk/ndk-embed-render-components)。
...
****相关模块：**** [ArkUI\_RenderNodeUtils](/ref/arkui-api/arkui-c/arkui-module/capi-arkui-rendernodeutils/capi-arkui-rendernodeutils)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_RenderNode\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) | ArkUI\_RenderNodeHandle | 渲染节点指针。 |
| [ArkUI\_RenderContentModifier\*](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) | ArkUI\_RenderContentModifierHandle | 内容修改器指针。 |
| [ArkUI\_FloatProperty\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-floatpropertyhandle/capi-arkui-nativemodule-arkui-floatpropertyhandle) | ArkUI\_FloatPropertyHandle | 浮点数属性指针。 |
| [ArkUI\_Vector2Property\*](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-vector2propertyhandle/api-arkui-nativemodule-arkui-vector2propertyhandle) | ArkUI\_Vector2PropertyHandle | 二维向量属性指针。 |
| [ArkUI\_ColorProperty\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-colorpropertyhandle/capi-arkui-nativemodule-arkui-colorpropertyhandle) | ArkUI\_ColorPropertyHandle | 颜色属性指针。 |
| [ArkUI\_FloatAnimatableProperty\*](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-floatanimatablepropertyhandle/i-nativemodule-arkui-floatanimatablepropertyhandle) | ArkUI\_FloatAnimatablePropertyHandle | 可动画的浮点数属性指针。 |
| [ArkUI\_Vector2AnimatableProperty\*](/ref/arkui-api/arkui-c/arkui-struct/nativemodule-arkui-vector2animatablepropertyhandle/nativemodule-arkui-vector2animatablepropertyhandle) | ArkUI\_Vector2AnimatablePropertyHandle | 可动画的二维向量属性指针。 |
| [ArkUI\_ColorAnimatableProperty\*](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-coloranimatablepropertyhandle/i-nativemodule-arkui-coloranimatablepropertyhandle) | ArkUI\_ColorAnimatablePropertyHandle | 可动画的颜色属性指针。 |
| [ArkUI\_RectShape](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rectshapeoption/capi-arkui-nativemodule-arkui-rectshapeoption) | ArkUI\_RectShapeOption | 范围形状结构体。 |
| [ArkUI\_NodeBorderStyle](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption) | ArkUI\_NodeBorderStyleOption | 边框样式配置项。 |
| [ArkUI\_NodeBorderWidth](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderwidthoption/api-arkui-nativemodule-arkui-nodeborderwidthoption) | ArkUI\_NodeBorderWidthOption | 边框宽度配置项。 |
| [ArkUI\_NodeBorderColor](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodebordercoloroption/api-arkui-nativemodule-arkui-nodebordercoloroption) | ArkUI\_NodeBorderColorOption | 边框颜色配置项。 |
| [ArkUI\_NodeBorderRadius](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-nodeborderradiusoption/pi-arkui-nativemodule-arkui-nodeborderradiusoption) | ArkUI\_NodeBorderRadiusOption | 边框弧度配置项。 |
| [ArkUI\_CircleShape](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-circleshapeoption/capi-arkui-nativemodule-arkui-circleshapeoption) | ArkUI\_CircleShapeOption | 圆形形状配置项。 |
| [ArkUI\_RoundRectShape](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-roundrectshapeoption/capi-arkui-nativemodule-arkui-roundrectshapeoption) | ArkUI\_RoundRectShapeOption | 圆角矩形形状配置项。 |
| [ArkUI\_CommandPath](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-commandpathoption/capi-arkui-nativemodule-arkui-commandpathoption) | ArkUI\_CommandPathOption | 自定义路径配置项。 |
| [ArkUI\_RenderNodeMaskOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodemaskoption/capi-arkui-nativemodule-arkui-rendernodemaskoption) | ArkUI\_RenderNodeMaskOption | 节点遮罩配置项。 |
| [ArkUI\_RenderNodeClipOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodeclipoption/capi-arkui-nativemodule-arkui-rendernodeclipoption) | ArkUI\_RenderNodeClipOption | 节点裁剪配置项。 |
...
父节点仅支持[ArkUI\_NodeType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-node-h/capi-native-node-h#arkui_nodetype)中ARKUI\_NODE\_CUSTOM类型的节点，每个自定义节点只能挂载一个ArkUI\_RenderNodeHandle，customNode无法挂载其他ArkUI\_NodeHandle。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | 目标父节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) child | 待添加的子渲染节点。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_NOT\_CUSTOM\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点非自定义节点。  [ARKUI\_ERROR\_CODE\_CHILD\_EXISTED](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点已存在子节点。  [ARKUI\_ERROR\_CODE\_RENDER\_PARENT\_EXISTED](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标渲染节点存在父节点。  [ARKUI\_ERROR\_CODE\_RENDER\_HAS\_INVALID\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 当前渲染节点从FrameNode中获取且该FrameNode已被取消接纳为附属节点或销毁。从API version 22开始支持。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | 目标父节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) child | 移除的目标子渲染节点。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_NOT\_CUSTOM\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点非自定义节点。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) | 目标渲染节点。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标父渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) child | 目标添加子渲染节点。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点是从一个FrameNode获取的。从API version 22开始支持。  [ARKUI\_ERROR\_CODE\_RENDER\_HAS\_INVALID\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 当前渲染节点从FrameNode中获取且该FrameNode已被取消接纳为附属节点或销毁。从API version 22开始支持。 |
...
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标父渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) child | 待添加的子渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) sibling | 目标子节点，用于确定插入位置的参考兄弟渲染节点。若该节点不在node的当前子节点列表中，则将child追加到末尾。 |
| ****返回：**** |  |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标父渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) child | 目标被移除子渲染节点。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点是从一个FrameNode获取的。从API version 22开始支持。 |
...
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\* child | 用于接收子节点的渲染节点指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_RENDER\_CHILD\_NOT\_EXIST](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 未找到对应的渲染子节点。  [ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点是从一个FrameNode获取的。从API version 22开始支持。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\* child | 用于接收第一个子节点的渲染节点指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 参考节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\* sibling | 用于接收下一个兄弟节点的渲染节点指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_RENDER\_CHILD\_NOT\_EXIST](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 未找到对应的渲染子节点。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 参考节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\* sibling | 用于接收上一个兄弟节点的渲染节点指针。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标父渲染节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\*\* children | 用于存储所有子渲染节点的指针数组。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数值超出范围。  [ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点是从一个FrameNode获取的。从API version 22开始支持。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| int32\_t width | 宽度值（以像素为单位）。  默认值：0，单位：px。取值大于等于0，传入负值时返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)。 |
| int32\_t height | 高度值（以像素为单位）。  默认值：0，单位：px。取值大于等于0，传入负值时返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数超出范围。  [ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 目标节点是从一个FrameNode获取的。从API version 22开始支持。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| float radius | 半径值。  默认值：0。取值大于等于0，传入负值时返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderStyleOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption)\* borderStyle | 边框样式的指针。  结构体指针内默认值：[ARKUI\_BORDER\_STYLE\_SOLID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderStyleOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption)\*\* borderStyle | 用于接收边框样式的指针。  结构体指针内默认值：[ARKUI\_BORDER\_STYLE\_SOLID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderWidthOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderwidthoption/api-arkui-nativemodule-arkui-nodeborderwidthoption)\* borderWidth | 边框宽度的指针。  结构体指针内默认值：0。单位：px。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderWidthOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderwidthoption/api-arkui-nativemodule-arkui-nodeborderwidthoption)\*\* borderWidth | 用于接收边框宽度的指针。  结构体指针内默认值：0。单位：px。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderColorOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodebordercoloroption/api-arkui-nativemodule-arkui-nodebordercoloroption)\* borderColor | 边框颜色的指针。  结构体指针内默认值：0x00000000。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderColorOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodebordercoloroption/api-arkui-nativemodule-arkui-nodebordercoloroption)\*\* borderColor | 用于接收边框颜色的指针。  结构体指针内默认值：0x00000000。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderRadiusOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-nodeborderradiusoption/pi-arkui-nativemodule-arkui-nodeborderradiusoption)\* borderRadius | 边框半径的指针。  结构体指针内默认值：0。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_NodeBorderRadiusOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-nodeborderradiusoption/pi-arkui-nativemodule-arkui-nodeborderradiusoption)\*\* borderRadius | 用于接收边框半径的指针。  结构体指针内默认值：0。 |
...
1. 给遮罩图层增加亮度和线性颜色滤镜。
2. 在该滤镜下绘制遮罩图形。
3. 将原节点图像作为源颜色，遮罩图形为目标颜色，通过[BlendMode.SRC\_IN](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#blendmode)方式混合成Mask图像。
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_RenderNodeMaskOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodemaskoption/capi-arkui-nativemodule-arkui-rendernodemaskoption)\* mask | 遮罩配置的指针。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_RenderNodeClipOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodeclipoption/capi-arkui-nativemodule-arkui-rendernodeclipoption)\* clip | 裁剪配置的指针。 |
...
| int32\_t width | 边界的宽度（以像素为单位）。  默认值：0。取值大于等于0，传入负值时返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)。 |
| int32\_t height | 边界的高度（以像素为单位）。  默认值：0。取值大于等于0，传入负值时返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle) node | 目标渲染节点。 |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 内容修改器。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) | 内容修改器。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置浮点属性。 |
| [ArkUI\_FloatPropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-floatpropertyhandle/capi-arkui-nativemodule-arkui-floatpropertyhandle) property | 浮点属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置二维向量属性。 |
| [ArkUI\_Vector2PropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-vector2propertyhandle/api-arkui-nativemodule-arkui-vector2propertyhandle) property | 二维向量属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置颜色属性。 |
| [ArkUI\_ColorPropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-colorpropertyhandle/capi-arkui-nativemodule-arkui-colorpropertyhandle) property | 颜色属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置可动画的浮点属性。 |
| [ArkUI\_FloatAnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-floatanimatablepropertyhandle/i-nativemodule-arkui-floatanimatablepropertyhandle) property | 可动画的浮点属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置可动画的二维向量属性。 |
| [ArkUI\_Vector2AnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/nativemodule-arkui-vector2animatablepropertyhandle/nativemodule-arkui-vector2animatablepropertyhandle) property | 可动画的二维向量属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 为目标内容修改器设置可动画的颜色属性。 |
| [ArkUI\_ColorAnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-coloranimatablepropertyhandle/i-nativemodule-arkui-coloranimatablepropertyhandle) property | 可动画的颜色属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_FloatPropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-floatpropertyhandle/capi-arkui-nativemodule-arkui-floatpropertyhandle) | 浮点属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_Vector2PropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-vector2propertyhandle/api-arkui-nativemodule-arkui-vector2propertyhandle) | 二维向量属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ColorPropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-colorpropertyhandle/capi-arkui-nativemodule-arkui-colorpropertyhandle) | 颜色属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_FloatAnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-floatanimatablepropertyhandle/i-nativemodule-arkui-floatanimatablepropertyhandle) | 可动画的浮点属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_Vector2AnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/nativemodule-arkui-vector2animatablepropertyhandle/nativemodule-arkui-vector2animatablepropertyhandle) | 可动画的二维向量属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ColorAnimatablePropertyHandle](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-coloranimatablepropertyhandle/i-nativemodule-arkui-coloranimatablepropertyhandle) | 可动画的颜色属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderContentModifierHandle](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-rendercontentmodifierhandle/kui-nativemodule-arkui-rendercontentmodifierhandle) modifier | 目标内容修改器。 |
| void\* userData | 要传递给回调的自定义数据。 |
| void (callback)([ArkUI\_DrawContext](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-drawcontext/capi-arkui-nativemodule-arkui-drawcontext) context, void\* userData) | 绘制事件接收回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RectShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rectshapeoption/capi-arkui-nativemodule-arkui-rectshapeoption)\* | 指向矩形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RectShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rectshapeoption/capi-arkui-nativemodule-arkui-rectshapeoption)\* option | 指向矩形形状的指针。 |
...
| [ArkUI\_EdgeDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_edgedirection) direction | 要设置边缘值的矩形方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeBorderStyleOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption)\* | 指向节点边框样式的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeBorderStyleOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption)\* option | 指向节点边框样式的指针。 |
...
| --- | --- |
| [ArkUI\_NodeBorderStyleOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderstyleoption/api-arkui-nativemodule-arkui-nodeborderstyleoption)\* option | 指向节点边框样式的指针。 |
| [ArkUI\_BorderStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle) edgeStyle | 节点边框样式的边缘边框样式值。 |
| [ArkUI\_EdgeDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_edgedirection) direction | 边缘的方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeBorderWidthOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderwidthoption/api-arkui-nativemodule-arkui-nodeborderwidthoption)\* | 指向节点边框宽度的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeBorderWidthOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodeborderwidthoption/api-arkui-nativemodule-arkui-nodeborderwidthoption)\* option | 指向节点边框宽度的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeBorderColorOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodebordercoloroption/api-arkui-nativemodule-arkui-nodebordercoloroption)\* | 指向节点边框颜色的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeBorderColorOption](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-nodebordercoloroption/api-arkui-nativemodule-arkui-nodebordercoloroption)\* option | 指向节点边框颜色的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeBorderRadiusOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-nodeborderradiusoption/pi-arkui-nativemodule-arkui-nodeborderradiusoption)\* | 指向节点边框半径的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeBorderRadiusOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-nodeborderradiusoption/pi-arkui-nativemodule-arkui-nodeborderradiusoption)\* option | 指向节点边框半径的指针。 |
...
| [ArkUI\_CornerDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_cornerdirection) direction | 边缘的方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CircleShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-circleshapeoption/capi-arkui-nativemodule-arkui-circleshapeoption)\* | 指向圆形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CircleShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-circleshapeoption/capi-arkui-nativemodule-arkui-circleshapeoption)\* option | 指向圆形形状的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RoundRectShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-roundrectshapeoption/capi-arkui-nativemodule-arkui-roundrectshapeoption)\* | 指向圆角矩形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RoundRectShapeOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-roundrectshapeoption/capi-arkui-nativemodule-arkui-roundrectshapeoption)\* option | 指向圆角矩形形状的指针。 |
...
| [ArkUI\_CornerDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_cornerdirection) direction | 角的方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CommandPathOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-commandpathoption/capi-arkui-nativemodule-arkui-commandpathoption)\* | 指向自定义绘制路径的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CommandPathOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-commandpathoption/capi-arkui-nativemodule-arkui-commandpathoption)\* option | 指向自定义绘制路径的指针。 |
...
| --- | --- |
| [ArkUI\_CommandPathOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-commandpathoption/capi-arkui-nativemodule-arkui-commandpathoption)\* option | 指向自定义绘制路径的指针。 |
| char\* commands | 命令值。入参格式为SVG的[<path>形状标签](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-basic-svg/ts-basic-svg#基础形状)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RectShapeOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rectshapeoption/capi-arkui-nativemodule-arkui-rectshapeoption) shape | 指向矩形形状的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RenderNodeMaskOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodemaskoption/capi-arkui-nativemodule-arkui-rendernodemaskoption) | 指向渲染节点遮罩的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RoundRectShapeOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-roundrectshapeoption/capi-arkui-nativemodule-arkui-roundrectshapeoption) shape | 指向圆角矩形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CircleShapeOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-circleshapeoption/capi-arkui-nativemodule-arkui-circleshapeoption) shape | 指向圆形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RectShapeOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rectshapeoption/capi-arkui-nativemodule-arkui-rectshapeoption) shape | 指向椭圆形形状的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CommandPathOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-commandpathoption/capi-arkui-nativemodule-arkui-commandpathoption) path | 指向自定义绘制路径的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeMaskOption\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodemaskoption/capi-arkui-nativemodule-arkui-rendernodemaskoption) option | 指向渲染节点遮罩的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeMaskOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodemaskoption/capi-arkui-nativemodule-arkui-rendernodemaskoption)\* mask | 指向渲染节点遮罩的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_RenderNodeClipOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodeclipoption/capi-arkui-nativemodule-arkui-rendernodeclipoption)\* | 指向渲染节点裁剪的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RenderNodeClipOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodeclipoption/capi-arkui-nativemodule-arkui-rendernodeclipoption)\* option | 指向渲染节点裁剪的指针。 |
...
获取已被接纳为附属节点的目标节点的RenderNode。如果一个RenderNode是通过该接口获取的，调用[ArkUI\_NativeNodeAPI\_1](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativenodeapi-1/capi-arkui-nativemodule-arkui-nativenodeapi-1)的[disposeNode](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativenodeapi-1/capi-arkui-nativemodule-arkui-nativenodeapi-1#disposenode)接口主动销毁FrameNode时，需要额外调用[OH\_ArkUI\_RenderNodeUtils\_DisposeNode](#oh_arkui_rendernodeutils_disposenode)释放该RenderNode。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | ArkUI\_NodeHandle指针，指定目标节点。 |
| [ArkUI\_RenderNodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rendernodehandle/capi-arkui-nativemodule-arkui-rendernodehandle)\* renderNode | ArkUI\_RenderNodeHandle\*指针，目标节点的RenderNode。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_CAPI\_INIT\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) CAPI初始化失败。  [ARKUI\_ERROR\_CODE\_RENDER\_NOT\_ADOPTED\_NODE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 该节点未被接纳为附属节点。 |
