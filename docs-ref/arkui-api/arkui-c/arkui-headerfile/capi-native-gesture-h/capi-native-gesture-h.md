...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-gesture-h
kit: 应用框架
last_updated: "2026-04-22"
slug: capi-native-gesture-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_NativeGestureAPI\_1](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativegestureapi-1/capi-arkui-nativemodule-arkui-nativegestureapi-1) | ArkUI\_NativeGestureAPI\_1 | 手势模块接口集合。 |
| [ArkUI\_NativeGestureAPI\_2](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativegestureapi-2/capi-arkui-nativemodule-arkui-nativegestureapi-2) | - | 定义手势模块接口集合。 |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer) | ArkUI\_GestureRecognizer | 提供手势组件实例对象定义。 |
| [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo) | ArkUI\_GestureInterruptInfo | 提供手势打断数据类型对象定义。 |
| [ArkUI\_GestureEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureevent/capi-arkui-nativemodule-arkui-gestureevent) | ArkUI\_GestureEvent | 提供手势事件数据类型对象定义。 |
| [ArkUI\_GestureEventTargetInfo](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-gestureeventtargetinfo/pi-arkui-nativemodule-arkui-gestureeventtargetinfo) | ArkUI\_GestureEventTargetInfo | 提供手势事件目标信息类型对象定义。 |
| [ArkUI\_ParallelInnerGestureEvent](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-parallelinnergestureevent/arkui-nativemodule-arkui-parallelinnergestureevent) | ArkUI\_ParallelInnerGestureEvent | 提供并行内置手势事件类型对象定义。 |
| [ArkUI\_TouchRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-touchrecognizer/capi-arkui-nativemodule-arkui-touchrecognizer) | ArkUI\_TouchRecognizer | 定义触摸识别器。 |
| [ArkUI\_TouchRecognizer\*](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-touchrecognizerhandle/api-arkui-nativemodule-arkui-touchrecognizerhandle) | ArkUI\_TouchRecognizerHandle | 定义触摸识别器句柄。 |
| [ArkUI\_TouchRecognizerHandle\*](/ref/arkui-api/arkui-c/arkui-struct/rkui-nativemodule-arkui-touchrecognizerhandlearray/rkui-nativemodule-arkui-touchrecognizerhandlearray) | ArkUI\_TouchRecognizerHandleArray | 定义触摸识别器句柄数组。 |
| [ArkUI\_GestureRecognizer\*](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-gesturerecognizerhandle/i-arkui-nativemodule-arkui-gesturerecognizerhandle) | ArkUI\_GestureRecognizerHandle | 提供手势识别器句柄类型对象定义。 |
| [ArkUI\_GestureRecognizerHandle\*](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-gesturerecognizerhandlearray/ui-nativemodule-arkui-gesturerecognizerhandlearray) | ArkUI\_GestureRecognizerHandleArray | 提供手势识别器句柄类型数组对象定义。 |
...
| [float OH\_ArkUI\_SwipeGesture\_GetAngle(const ArkUI\_GestureEvent\* event)](#oh_arkui_swipegesture_getangle) | - | 快滑手势返回当前手势事件角度信息。角度计算方式：快滑手势被识别到后，连接两根手指之间的线被识别为起始线条，随着手指的滑动，手指之间的线条会发生旋转，  根据起始线条两端点和当前线条两端点的坐标，使用反正切函数分别计算其相对于水平方向的夹角，  最后arctan2(cy2-cy1,cx2-cx1)-arctan2(y2-y1,x2-x1)为旋转的角度。  以起始线条为坐标系，顺时针旋转为0到180度，逆时针旋转为-180到0度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* recognizer | 手势识别器指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo)\* event | 手势打断回调事件。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* | 被打断的手势指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureevent/capi-arkui-nativemodule-arkui-gestureevent)\* | 打断的手势事件数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo)\* info | 指向手势打断信息的指针。 |
| [ArkUI\_TouchRecognizerHandleArray](/ref/arkui-api/arkui-c/arkui-struct/rkui-nativemodule-arkui-touchrecognizerhandlearray/rkui-nativemodule-arkui-touchrecognizerhandlearray)\* recognizers | 指向触摸识别器数组的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  返回 [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 表示成功。  返回 [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 表示参数错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_TouchRecognizerHandle](/ref/arkui-api/arkui-c/arkui-struct/rkui-nativemodule-arkui-touchrecognizerhandlearray/rkui-nativemodule-arkui-touchrecognizerhandlearray) recognizer | 触摸识别器的句柄。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) | 触摸识别器对应的组件句柄。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TouchRecognizerHandle](/ref/arkui-api/arkui-c/arkui-struct/rkui-nativemodule-arkui-touchrecognizerhandlearray/rkui-nativemodule-arkui-touchrecognizerhandlearray) recognizer | 触摸识别器的句柄。 |
| [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo)\* info | 指向手势打断信息的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  返回 [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  返回 [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_GestureEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureevent/capi-arkui-nativemodule-arkui-gestureevent)\* event | 手势事件。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureEventActionType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-gesture-h/capi-native-gesture-h#arkui_gestureeventactiontype) | 手势事件类型。 |
...
| 类型 | 说明 |
| --- | --- |
| const [ArkUI\_UIInputEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-eventmodule-arkui-uiinputevent/capi-arkui-eventmodule-arkui-uiinputevent)\* | 手势事件的原始输入事件。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) | 绑定该手势的ARKUI组件。若返回Null，则表示event是无效值。 |
...
| --- | --- |
| const [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo)\* event | 手势打断回调事件。 |
| [ArkUI\_GestureRecognizerHandleArray](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-gesturerecognizerhandlearray/ui-nativemodule-arkui-gesturerecognizerhandlearray)\* responseChain | 响应链组件上的手势识别器。 |
...
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* recognizer | 手势识别器指针。 |
| [ArkUI\_GestureRecognizerState](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-gesture-h/capi-native-gesture-h#arkui_gesturerecognizerstate)\* state | 手势识别器的状态。 |
...
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* recognizer | 手势识别器指针。 |
| [ArkUI\_GestureEventTargetInfo](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-gestureeventtargetinfo/pi-arkui-nativemodule-arkui-gestureeventtargetinfo)\*\* info | 手势事件目标信息。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 参数错误。  [ARKUI\_ERROR\_CODE\_NON\_SCROLLABLE\_CONTAINER](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 非滚动类容器。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 参数错误。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_NOT\_ENOUGH](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) - 存储区大小不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ParallelInnerGestureEvent](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-parallelinnergestureevent/arkui-nativemodule-arkui-parallelinnergestureevent)\* event | 并行内置手势事件。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* | 当前手势识别器的指针。 |
...
| --- | --- |
| [ArkUI\_ParallelInnerGestureEvent](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-parallelinnergestureevent/arkui-nativemodule-arkui-parallelinnergestureevent)\* event | 并行内置手势事件。 |
| [ArkUI\_GestureRecognizerHandleArray](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-gesturerecognizerhandlearray/ui-nativemodule-arkui-gesturerecognizerhandlearray)\* array | 冲突的手势识别器数组。 |
...
| --- | --- |
| [ArkUI\_GestureRecognizer](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gesturerecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer)\* recognizer | 手势识别器指针。 |
| [ArkUI\_GestureRecognizerDisposeNotifyCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-gesture-h/capi-native-gesture-h#arkui_gesturerecognizerdisposenotifycallback) callback | 手势识别器对象析构通知回调函数。 |
| void\* userData | 用户自定义数据。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_RECOGNIZER\_TYPE\_NOT\_SUPPORTED](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 不支持手势识别器类型。 |
...
| int\* toolTypeArray | 指向输入事件的工具类型数组的指针。当设置[UI\_INPUT\_EVENT\_TOOL\_TYPE\_XXX](/ref/arkui-api/arkui-c/arkui-headerfile/capi-ui-input-event-h/capi-ui-input-event-h#anonymous2)以外的值时，设置不生效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) | 错误码。  返回 [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  返回 [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数错误。  返回 [ARKUI\_ERROR\_CODE\_RECOGNIZER\_TYPE\_NOT\_SUPPORTED](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 不支持手势识别器类型。 |
...
获取手势识别器的手势移动阈值表。仅支持对通过OH\_ArkUI\_PanGesture\_SetDistanceMap修改过的设备类型的阈值查询。默认滑动阈值可通过查询[UI\_INPUT\_EVENT\_TOOL\_TYPE\_UNKNOWN](/ref/arkui-api/arkui-c/arkui-headerfile/capi-ui-input-event-h/capi-ui-input-event-h#anonymous2)类型获得，其他未设置过的类型不会返回。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | 需要设置手势收集完成回调的节点句柄。 |
| void\* userData | 用户自定义数据。 |
| void (\*touchTestDone)([ArkUI\_GestureEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureevent/capi-arkui-nativemodule-arkui-gestureevent)\* event, [ArkUI\_GestureRecognizerHandleArray](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-gesturerecognizerhandlearray/ui-nativemodule-arkui-gesturerecognizerhandlearray) recognizers, int32\_t count, void\* userData) | 手势收集完成的回调函数。event为手势的基本信息，recognizers为手势识别器数组，count为手势识别器个数，userData为用户自定义数据。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) | 错误码。  返回 [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  返回 [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureInterruptInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gestureinterruptinfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo)\* event | 是指向手势中断信息的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 参数错误。  [ARKUI\_ERROR\_CODE\_RECOGNIZER\_TYPE\_NOT\_SUPPORTED](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 不支持手势识别器类型。 |
