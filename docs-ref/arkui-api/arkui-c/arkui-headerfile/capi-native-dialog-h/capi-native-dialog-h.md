...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_NativeDialogAPI\_1](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativedialogapi-1/capi-arkui-nativemodule-arkui-nativedialogapi-1) | ArkUI\_NativeDialogAPI\_1 | ArkUI提供的Native侧自定义弹窗接口集合。 |
| [ArkUI\_NativeDialogAPI\_2](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativedialogapi-2/capi-arkui-nativemodule-arkui-nativedialogapi-2) | ArkUI\_NativeDialogAPI\_2 | ArkUI提供的Native侧自定义弹窗接口集合。 |
| [ArkUI\_NativeDialogAPI\_3](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativedialogapi-3/capi-arkui-nativemodule-arkui-nativedialogapi-3) | ArkUI\_NativeDialogAPI\_3 | ArkUI提供的Native侧自定义弹窗接口集合。 |
| [ArkUI\_DialogDismissEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-dialogdismissevent/capi-arkui-nativemodule-arkui-dialogdismissevent) | ArkUI\_DialogDismissEvent | 定义弹窗关闭事件对象。 |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions) | ArkUI\_CustomDialogOptions | 定义自定义弹窗的内容对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_DialogDismissEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-dialogdismissevent/capi-arkui-nativemodule-arkui-dialogdismissevent)\* event | 弹窗关闭事件对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 关闭原因，异常情况返回-1。  [DIALOG\_DISMISS\_BACK\_PRESS](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-dialog-h/capi-native-dialog-h#arkui_dismissreason) 点击三键back、侧滑（左滑/右滑）、键盘ESC关闭。  [DIALOG\_DISMISS\_TOUCH\_OUTSIDE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-dialog-h/capi-native-dialog-h#arkui_dismissreason) 点击遮障层时。  [DIALOG\_DISMISS\_CLOSE\_BUTTON](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-dialog-h/capi-native-dialog-h#arkui_dismissreason) 点击关闭按钮。  [DIALOG\_DISMISS\_SLIDE\_DOWN](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-dialog-h/capi-native-dialog-h#arkui_dismissreason) 下拉关闭。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) content | 自定义弹窗的内容。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* | 自定义弹窗配置的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 自定义弹窗配置的指针。 |
...
![](../../../../images/7dae4a41/note_3.0-zh-cn.png) 
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 指向自定义弹窗options的指针。 |
...
![](../../../../images/4e3be2d9/note_3.0-zh-cn.png) 
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| int32\_t top | 弹窗上边框的样式，参数类型[ArkUI\_BorderStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)，默认值为ARKUI\_BORDER\_STYLE\_SOLID。 |
| int32\_t right | 弹窗右边框的样式，参数类型[ArkUI\_BorderStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)，默认值为ARKUI\_BORDER\_STYLE\_SOLID。 |
| int32\_t bottom | 弹窗下边框的样式，参数类型[ArkUI\_BorderStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)，默认值为ARKUI\_BORDER\_STYLE\_SOLID。 |
| int32\_t left | 弹窗左边框的样式，参数类型[ArkUI\_BorderStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_borderstyle)，默认值为ARKUI\_BORDER\_STYLE\_SOLID。 |
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| [ArkUI\_ShadowStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_shadowstyle) shadow | 弹窗的背板阴影样式，枚举值。 |
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| [const ArkUI\_AttributeItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-attributeitem/capi-arkui-nativemodule-arkui-attributeitem)\* customShadow | 弹窗的自定义阴影参数，格式与[ArkUI\_NodeAttributeType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-node-h/capi-native-node-h#arkui_nodeattributetype)中的NODE\_CUSTOM\_SHADOW属性一致。 |
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| [ArkUI\_BlurStyle](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_blurstyle) blurStyle | 弹窗的背板模糊材质，枚举值。 |
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| int32\_t alignment | 弹窗的对齐模式，参数类型[ArkUI\_Alignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_alignment)。 |
...
| --- | --- |
| [ArkUI\_CustomDialogOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customdialogoptions/capi-arkui-nativemodule-arkui-customdialogoptions)\* options | 弹窗参数。 |
| [ArkUI\_KeyboardAvoidMode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_keyboardavoidmode) keyboardAvoidMode | 键盘避让模式，枚举值。 |
...
| [ArkUI\_DialogState](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-dialog-h/capi-native-dialog-h#arkui_dialogstate)\* state | 自定义弹窗的状态。 |
