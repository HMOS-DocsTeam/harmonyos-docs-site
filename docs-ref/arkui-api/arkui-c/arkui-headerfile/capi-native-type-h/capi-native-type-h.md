...
title: "native_type.h"
sidebar_position: 14
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h
kit: 应用框架
last_updated: "2026-04-22"
slug: capi-native-type-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_Node](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node-descriptor/capi-arkui-nativemodule-arkui-node-descriptor) | ArkUI\_Node | 定义ArkUI native组件实例对象。 |
| [ArkUI\_ContextCallback](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-contextcallback/capi-arkui-nativemodule-arkui-contextcallback) | ArkUI\_ContextCallback | 事件回调类型。 |
| [ArkUI\_NumberValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-numbervalue/capi-arkui-nativemodule-arkui-numbervalue) | ArkUI\_NumberValue | ArkUI在Native侧的数字类型定义。 |
| [ARKUI\_TextPickerRangeContent](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-textpickerrangecontent/pi-arkui-nativemodule-arkui-textpickerrangecontent) | ARKUI\_TextPickerRangeContent | 定义单列滑动数据选择器支持的图片资源结构体。 |
| [ARKUI\_TextPickerCascadeRangeContent](/ref/arkui-api/arkui-c/arkui-struct/i-nativemodule-arkui-textpickercascaderangecontent/i-nativemodule-arkui-textpickercascaderangecontent) | ARKUI\_TextPickerCascadeRangeContent | 定义多列联动滑动数据选择器的结构体。 |
| [ArkUI\_ColorStop](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-colorstop/capi-arkui-nativemodule-arkui-colorstop) | ArkUI\_ColorStop | 定义渐变色结构。 |
| [ArkUI\_Rect](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rect/capi-arkui-nativemodule-arkui-rect) | ArkUI\_Rect | 定义遮罩屏蔽区域的范围结构体。 |
| [ArkUI\_IntSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-intsize/capi-arkui-nativemodule-arkui-intsize) | ArkUI\_IntSize | 尺寸类型，用于描述组件的宽高。 |
| [ArkUI\_IntOffset](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-intoffset/capi-arkui-nativemodule-arkui-intoffset) | ArkUI\_IntOffset | 位置，用于描述组件的位置。 |
| [ArkUI\_Margin](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-margin/capi-arkui-nativemodule-arkui-margin) | ArkUI\_Margin | 外边距属性，用于描述组件的外边距属性。 |
| [ArkUI\_TranslationOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-translationoptions/capi-arkui-nativemodule-arkui-translationoptions) | ArkUI\_TranslationOptions | 定义组件转场时的平移效果对象。 |
| [ArkUI\_ScaleOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-scaleoptions/capi-arkui-nativemodule-arkui-scaleoptions) | ArkUI\_ScaleOptions | 定义组件转场时的缩放效果对象。 |
| [ArkUI\_RotationOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-rotationoptions/capi-arkui-nativemodule-arkui-rotationoptions) | ArkUI\_RotationOptions | 定义组件转场时的旋转效果对象。 |
| [ArkUI\_NativeDialog](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativedialog/capi-arkui-nativemodule-arkui-nativedialog) | ArkUI\_NativeDialog | 提供ArkUI在Native侧的自定义弹窗控制器对象定义。 |
| [ArkUI\_LayoutConstraint](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-layoutconstraint/capi-arkui-nativemodule-arkui-layoutconstraint) | ArkUI\_LayoutConstraint | 布局约束，组件布局时，进行尺寸范围限制。 |
| [ArkUI\_DrawContext](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-drawcontext/capi-arkui-nativemodule-arkui-drawcontext) | ArkUI\_DrawContext | 定义组件绘制上下文类型结构。 |
| [ArkUI\_Node\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) | ArkUI\_NodeHandle | 定义ArkUI native组件实例对象指针定义。 |
| [ArkUI\_NativeDialog\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativedialog8h/capi-arkui-nativemodule-arkui-nativedialog8h) | ArkUI\_NativeDialogHandle | 定义ArkUI在Native侧的自定义弹窗控制器对象指针。 |
| [ArkUI\_GridItemSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-griditemsize/capi-arkui-nativemodule-arkui-griditemsize) | ArkUI\_GridItemSize | 定义Grid布局选项onGetIrregularSizeByIndex回调返回值结构体。 |
| [ArkUI\_GridItemRect](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-griditemrect/capi-arkui-nativemodule-arkui-griditemrect) | ArkUI\_GridItemRect | 定义Grid布局选项onGetRectByIndex回调返回值结构体。 |
| [ArkUI\_GridLayoutOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gridlayoutoptions/capi-arkui-nativemodule-arkui-gridlayoutoptions) | ArkUI\_GridLayoutOptions | 定义Grid布局选项。 |
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption) | ArkUI\_WaterFlowSectionOption | 定义[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。 |
| [ArkUI\_ListItemSwipeActionItem](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-listitemswipeactionitem/i-arkui-nativemodule-arkui-listitemswipeactionitem) | ArkUI\_ListItemSwipeActionItem | 定义ListItemSwipeActionOption方法内Item的配置信息。 |
| [ArkUI\_ListItemSwipeActionOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-listitemswipeactionoption/arkui-nativemodule-arkui-listitemswipeactionoption) | ArkUI\_ListItemSwipeActionOption | 定义ListItemSwipeActionOption方法的配置信息。 |
| [ArkUI\_Context](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-context/capi-arkui-nativemodule-arkui-context) | ArkUI\_Context | 定义ArkUI native UI的上下文实例对象。 |
| [ArkUI\_Context\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-context8h/capi-arkui-nativemodule-arkui-context8h) | ArkUI\_ContextHandle | 定义ArkUI native UI的上下文实例对象指针定义。 |
| [ArkUI\_NodeContent\*](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nodecontent8h/capi-arkui-nativemodule-arkui-nodecontent8h) | ArkUI\_NodeContentHandle | 定义ArkUI NodeContent实例在Native侧的实例对象指针定义。 |
| [ArkUI\_AlignmentRuleOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-alignmentruleoption/capi-arkui-nativemodule-arkui-alignmentruleoption) | ArkUI\_AlignmentRuleOption | 指定设置在相对容器中子组件的对齐规则。 |
| [ArkUI\_GuidelineOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-guidelineoption/capi-arkui-nativemodule-arkui-guidelineoption) | ArkUI\_GuidelineOption | guideLine参数，用于定义guideline的id、方向和位置。 |
| [ArkUI\_BarrierOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-barrieroption/capi-arkui-nativemodule-arkui-barrieroption) | ArkUI\_BarrierOption | barrier参数，用于定义barrier的id、方向和生成时所依赖的组件。 |
| [ArkUI\_ImageAnimatorFrameInfo](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-imageanimatorframeinfo/pi-arkui-nativemodule-arkui-imageanimatorframeinfo) | ArkUI\_ImageAnimatorFrameInfo | 定义图片帧信息。 |
| [ArkUI\_ListChildrenMainSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-listchildrenmainsize/capi-arkui-nativemodule-arkui-listchildrenmainsize) | ArkUI\_ListChildrenMainSize | 定义List的ChildrenMainSize类信息。 |
| [ArkUI\_ProgressLinearStyleOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-progresslinearstyleoption/arkui-nativemodule-arkui-progresslinearstyleoption) | ArkUI\_ProgressLinearStyleOption | 定义线性进度条样式。 |
| [ArkUI\_CustomProperty](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customproperty/capi-arkui-nativemodule-arkui-customproperty) | ArkUI\_CustomProperty | 定义自定义属性的CustomProperty类信息。 |
| [ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo) | ArkUI\_HostWindowInfo | 定义窗口属性的HostWindowInfo类信息。 |
| [ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo) | ArkUI\_ActiveChildrenInfo | 定义ActiveChildrenInfo类信息。 |
| [ArkUI\_CrossLanguageOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-crosslanguageoption/capi-arkui-nativemodule-arkui-crosslanguageoption) | ArkUI\_CrossLanguageOption | 定义跨语言配置项。 |
| [AbilityBase\_Want](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-abilitybase-want/capi-arkui-nativemodule-abilitybase-want) | AbilityBase\_Want | 声明元能力want结构。 |
| [ArkUI\_EmbeddedComponentOption](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-embeddedcomponentoption/i-arkui-nativemodule-arkui-embeddedcomponentoption) | ArkUI\_EmbeddedComponentOption | 为EmbeddedComponent定义参数EmbeddedComponentOption。 |
| [ArkUI\_AccessibilityState](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilitystate/capi-arkui-nativemodule-arkui-accessibilitystate) | ArkUI\_AccessibilityState | 定义组件无障碍状态。 |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue) | ArkUI\_AccessibilityValue | 定义组件无障碍信息值。 |
| [ArkUI\_SystemFontStyleEvent](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-systemfontstyleevent/capi-arkui-nativemodule-arkui-systemfontstyleevent) | ArkUI\_SystemFontStyleEvent | 系统字体变更事件定义。 |
| [ArkUI\_CustomSpanMeasureInfo](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-customspanmeasureinfo/api-arkui-nativemodule-arkui-customspanmeasureinfo) | ArkUI\_CustomSpanMeasureInfo | 自定义段落组件的测量信息。 |
| [ArkUI\_CustomSpanMetrics](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspanmetrics/capi-arkui-nativemodule-arkui-customspanmetrics) | ArkUI\_CustomSpanMetrics | 自定义段落组件的度量指标。 |
| [ArkUI\_CustomSpanDrawInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspandrawinfo/capi-arkui-nativemodule-arkui-customspandrawinfo) | ArkUI\_CustomSpanDrawInfo | 自定义段落组件的绘制信息。 |
| [ArkUI\_SwiperIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperindicator/capi-arkui-nativemodule-arkui-swiperindicator) | ArkUI\_SwiperIndicator | 定义[Swiper](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper)组件的导航指示器风格。 |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator) | ArkUI\_SwiperDigitIndicator | 定义Swiper组件的数字导航指示器风格。 |
| [ArkUI\_SwiperArrowStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperarrowstyle/capi-arkui-nativemodule-arkui-swiperarrowstyle) | ArkUI\_SwiperArrowStyle | 定义Swiper组件的导航箭头风格。 |
| [ArkUI\_StyledString\_Descriptor](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-styledstring-descriptor/i-arkui-nativemodule-arkui-styledstring-descriptor) | ArkUI\_StyledString\_Descriptor | 定义文本组件支持的属性字符串的数据对象。 |
| [ArkUI\_SnapshotOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-snapshotoptions/capi-arkui-nativemodule-arkui-snapshotoptions) | ArkUI\_SnapshotOptions | 定义截图的可选项。 |
| [ArkUI\_TextPickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-textpickerrangecontentarray/kui-nativemodule-arkui-textpickerrangecontentarray) | ArkUI\_TextPickerRangeContentArray | 定义文本选择器的数据选择列表。 |
| [ArkUI\_TextCascadePickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray) | ArkUI\_TextCascadePickerRangeContentArray | 定义多列联动数据选择器的多列联动数据选择列表。 |
| [ArkUI\_SelectionOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-selectionoptions/capi-arkui-nativemodule-arkui-selectionoptions) | ArkUI\_SelectionOptions | 定义选择操作的相关选项。 |
| [ArkUI\_VisibleAreaEventOptions](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-visibleareaeventoptions/i-arkui-nativemodule-arkui-visibleareaeventoptions) | ArkUI\_VisibleAreaEventOptions | 可见区域变化监听的参数。 |
| [ArkUI\_PositionEdges](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-positionedges/capi-arkui-nativemodule-arkui-positionedges) | ArkUI\_PositionEdges | 相对容器内容区边界的位置参数。 |
| [ArkUI\_PixelRoundPolicy](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pixelroundpolicy/capi-arkui-nativemodule-arkui-pixelroundpolicy) | ArkUI\_PixelRoundPolicy | 定义组件的像素取整策略结构体。 |
| [ArkUI\_ContentTransitionEffect](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-contenttransitioneffect/i-arkui-nativemodule-arkui-contenttransitioneffect) | ArkUI\_ContentTransitionEffect | 内容过渡效果。 |
| [ArkUI\_ShowCounterConfig](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-textshowcounterconfig/api-arkui-nativemodule-arkui-textshowcounterconfig) | ArkUI\_ShowCounterConfig | 定义文本输入框的计数器配置。 |
| [ArkUI\_TextContentBaseController](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-textcontentbasecontroller/arkui-nativemodule-arkui-textcontentbasecontroller) | ArkUI\_TextContentBaseController | 定义文本内容基础控制器。 |
| [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem) | ArkUI\_TextMenuItem | 定义文本菜单项结构体。 |
| [ArkUI\_TextMenuItemArray](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitemarray/capi-arkui-nativemodule-arkui-textmenuitemarray) | ArkUI\_TextMenuItemArray | 定义文本菜单项数组结构体。 |
| [ArkUI\_TextEditMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-texteditmenuoptions/capi-arkui-nativemodule-arkui-texteditmenuoptions) | ArkUI\_TextEditMenuOptions | 定义文本菜单扩展项结构体。 |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions) | ArkUI\_TextSelectionMenuOptions | 定义自定义文本选择菜单结构体。 |
| [ArkUI\_SelectedDragPreviewStyle](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-textselecteddragpreviewstyle/ui-nativemodule-arkui-textselecteddragpreviewstyle) | ArkUI\_SelectedDragPreviewStyle | 定义选中状态下文本拖拽预览样式。 |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions) | ArkUI\_MotionPathOptions | 定义路径动画的运动路径配置项。 |
| [ArkUI\_PickerIndicatorBackground](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-pickerindicatorbackground/arkui-nativemodule-arkui-pickerindicatorbackground) | ArkUI\_PickerIndicatorBackground | 背景样式指示器的样式参数。 |
| [ArkUI\_PickerIndicatorDivider](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-pickerindicatordivider/pi-arkui-nativemodule-arkui-pickerindicatordivider) | ArkUI\_PickerIndicatorDivider | 分割线样式指示器的样式参数。 |
| [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle) | ArkUI\_PickerIndicatorStyle | 选中项指示器的样式。 |
| [ArkUI\_TextMarqueeOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmarqueeoptions/capi-arkui-nativemodule-arkui-textmarqueeoptions) | ArkUI\_TextMarqueeOptions | 定义文本跑马灯模式配置项。 |
...
| [ArkUI\_ScrollDirection](#arkui_scrolldirection) | ArkUI\_ScrollDirection | 定义[Scroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll)组件排列方向枚举值。 |
...
| [ArkUI\_WaterFlowLayoutMode](#arkui_waterflowlayoutmode) | ArkUI\_WaterFlowLayoutMode | 定义[WaterFlow](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-waterflow/ts-container-waterflow)组件布局模式枚举值。 |
...
| [ArkUI\_ObjectFit](#arkui_objectfit) | ArkUI\_ObjectFit | 定义[Image](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-basic-components-image/ts-basic-components-image)组件的图片填充效果。 |
| [ArkUI\_ImageInterpolation](#arkui_imageinterpolation) | ArkUI\_ImageInterpolation | 定义图片插值效果。用于优化图片缩放时的锯齿问题。SVG类型图源不支持该属性。 |
...
| [ArkUI\_FinishCallbackType](#arkui_finishcallbacktype) | ArkUI\_FinishCallbackType | 在动画中定义[OH\_ArkUI\_AnimatorOption\_RegisterOnFinishCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-animate-h/capi-native-animate-h#oh_arkui_animatoroption_registeronfinishcallback)回调的类型。 |
...
| [ArkUI\_ListItemSwipeActionState](#arkui_listitemswipeactionstate) | ArkUI\_ListItemSwipeActionState | 定义[Listitem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#listitem10)组件[swipeAction](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeaction9)方法的显隐模式。 |
| [ArkUI\_ListItemSwipeEdgeEffect](#arkui_listitemswipeedgeeffect) | ArkUI\_ListItemSwipeEdgeEffect | 定义[Listitem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#listitem10)组件[swipeAction](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeaction9)方法的滚动模式。 |
...
| [ArkUI\_SwiperIndicator\* OH\_ArkUI\_SwiperIndicator\_Create(ArkUI\_SwiperIndicatorType type)](#oh_arkui_swiperindicator_create) | - | 创建[Swiper](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper)组件的导航指示器。 |
...
| [void OH\_ArkUI\_TextPickerRangeContentArray\_SetIconAtIndex(ArkUI\_TextPickerRangeContentArray\* handle, char\* icon, int32\_t index)](#oh_arkui_textpickerrangecontentarray_seticonatindex) | - | 设置TextPickerRangeContent数组指定位置的icon数据。 |
| [void OH\_ArkUI\_TextPickerRangeContentArray\_SetTextAtIndex(ArkUI\_TextPickerRangeContentArray\* handle, char\* text, int32\_t index)](#oh_arkui_textpickerrangecontentarray_settextatindex) | - | 设置TextPickerRangeContent数组指定位置的text数据。 |
...
| [void OH\_ArkUI\_TextCascadePickerRangeContentArray\_SetTextAtIndex (ArkUI\_TextCascadePickerRangeContentArray\* handle, char\* text, int32\_t index)](#oh_arkui_textcascadepickerrangecontentarray_settextatindex) | - | 设置TextCascadePickerRangeContent数组指定位置的text数据。 |
| [void OH\_ArkUI\_TextCascadePickerRangeContentArray\_SetChildAtIndex (ArkUI\_TextCascadePickerRangeContentArray\* handle, ArkUI\_TextCascadePickerRangeContentArray\* child, int32\_t index)](#oh_arkui_textcascadepickerrangecontentarray_setchildatindex) | - | 设置TextCascadePickerRangeContent数组指定位置的child数据。 |
...
| [void OH\_ArkUI\_TextMarqueeOptions\_SetFadeout(ArkUI\_TextMarqueeOptions\* option, bool fadeout)](#oh_arkui_textmarqueeoptions_setfadeout) | - | 设置文本跑马灯模式配置项是否支持文字超长时的渐隐效果。当Text内容超出显示范围时，未完全展现的文字边缘将应用渐隐效果。若两端均有文字未完全显示，则两端同时应用渐隐效果。在渐隐效果开启状态下，[NODE\_CLIP](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-node-h/capi-native-node-h#arkui_nodeattributetype)属性将自动锁定为true，不允许设置为false。 |
...
定义[Scroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll)组件排列方向枚举值。
...
定义滚动方向和[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件排列方向枚举值。
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_STICKY\_STYLE\_NONE = 0 | [ListItemGroup](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup)的[header](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)不吸顶，[footer](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)不吸底。 |
| ARKUI\_STICKY\_STYLE\_HEADER = 1 | [ListItemGroup](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup)的[header](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)吸顶，[footer](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)不吸底。 |
| ARKUI\_STICKY\_STYLE\_FOOTER = 2 | [ListItemGroup](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup)的[header](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)不吸顶，[footer](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)吸底。 |
| ARKUI\_STICKY\_STYLE\_BOTH = 3 | [ListItemGroup](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup)的[header](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)吸顶，[footer](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)吸底。 |
...
| ARKUI\_CONTENT\_CLIP\_MODE\_SAFE\_AREA = 2 | 按组件配置的[SafeArea](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-expand-safe-area/ts-universal-attributes-expand-safe-area)区域裁剪。 |
...
定义[WaterFlow](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-waterflow/ts-container-waterflow)组件布局模式枚举值。

****起始版本：**** 18

| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_WATER\_FLOW\_LAYOUT\_MODE\_ALWAYS\_TOP\_DOWN = 0 | 从上到下布局。列数切换场景需要从第一个[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)开始布局到当前显示的[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)。 |
| ARKUI\_WATER\_FLOW\_LAYOUT\_MODE\_SLIDING\_WINDOW = 1 | 移动窗口布局。列数切换场景只重新布局当前显示范围到[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)，手指向下滑动再布局从上方进入显示范围的[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)。 |
...
[Swiper](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper)组件鼠标滚轮翻页模式。
...
定义[Image](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-basic-components-image/ts-basic-components-image)组件的图片填充效果。
...
| ARKUI\_OBJECT\_FIT\_NONE\_MATRIX = 15 | 不改变图像原始大小，需要配合[NODE\_IMAGE\_IMAGE\_MATRIX](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-node-h/capi-native-node-h#arkui_nodeattributetype)使用。  ****起始版本：**** 21 |
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_ITEM\_ALIGNMENT\_AUTO = 0 | 使用[Flex](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-flex/ts-container-flex)容器中默认配置，该值为默认值。 |
...
| ARKUI\_FLEX\_ALIGNMENT\_SPACE\_BETWEEN = 6 | [Flex](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-flex/ts-container-flex)主轴方向均匀分配弹性元素，相邻元素之间距离相同，第一个元素行首对齐，最后的元素行尾对齐。 |
...
定义[Flex](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-flex/ts-container-flex)容器的主轴方向。
...
在动画中定义[OH\_ArkUI\_AnimatorOption\_RegisterOnFinishCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-animate-h/capi-native-animate-h#oh_arkui_animatoroption_registeronfinishcallback)回调的类型。
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_LIST\_ITEM\_ALIGNMENT\_START = 0 | [ListItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#listitem10)在List中，交叉轴方向首部对齐。 |
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_BARRIER\_DIRECTION\_START = 0 | 屏障在其所有[referencedId](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-relativecontainer/ts-container-relativecontainer#barrierstyle12对象说明)的最左侧，该值为默认值。 |
...
定义[Listitem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#listitem10)组件[SwipeAction](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeaction9)方法的显隐模式，默认值为ARKUI\_LIST\_ITEM\_SWIPE\_ACTION\_STATE\_COLLAPSED。
...
定义Listitem组件[swipeAction](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeaction9)方法的滚动模式，默认值为ARKUI\_LIST\_ITEM\_SWIPE\_EDGE\_EFFECT\_SPRING。
...
| ARKUI\_ANIMATION\_FILL\_MODE\_BACKWARDS = 2 | 动画将在应用于目标时立即应用第一个关键帧中定义的值，并在[delay](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-animate-h/capi-native-animate-h#oh_arkui_animateoption_setdelay)期间保留此值。 |
...
| ARKUI\_ERROR\_CODE\_PARAM\_ERROR = 100023 | 参数错误。错误码的详细介绍请参见[100023 参数错误](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node/errorcode-node#section100023-参数错误)。  ****起始版本：**** 21 |
| ARKUI\_ERROR\_CODE\_XCOMPONENT\_STATE\_INVALID = 103501 | 当前XComponent状态异常，方法调用失败。错误码的详细介绍请参见[XComponent组件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-xcomponent/errorcode-xcomponent)。  ****起始版本：**** 19 |
| ARKUI\_ERROR\_CODE\_ATTRIBUTE\_OR\_EVENT\_NOT\_SUPPORTED = 106102 | 组件不支持特定的属性或者事件。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。 |
| ARKUI\_ERROR\_CODE\_NOT\_SUPPROTED\_FOR\_ARKTS\_NODE = 106103 | 不支持对ArkTS创建的节点执行对应的操作。错误码的详细介绍请参见[106103 对应的操作不支持ArkTS创建的节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node/errorcode-node#section106103-对应的操作不支持arkts创建的节点)。 |
| ARKUI\_ERROR\_CODE\_ADAPTER\_NOT\_BOUND = 106104 | 懒加载适配器未绑定到组件上。错误码的详细介绍请参见[106104 适配器未绑定](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106104-适配器未绑定)。 |
| ERROR\_CODE\_NATIVE\_IMPL\_NODE\_ADAPTER\_EXIST = 106105 | 适配器已存在。错误码的详细介绍请参见[106105 适配器已存在](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106105-适配器已存在)。 |
| ARKUI\_ERROR\_CODE\_CHILD\_NODE\_EXIST = 106106 | 对应节点已存在子节点，无法添加适配器。错误码的详细介绍请参见[106106 子节点已存在](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106106-子节点已存在)。 |
| ARKUI\_ERROR\_CODE\_NODE\_EVENT\_PARAM\_INDEX\_OUT\_OF\_RANGE = 106107 | 组件事件中参数长度超限。错误码的详细介绍请参见[106107 参数下标越界](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106107-参数下标越界)。 |
| ARKUI\_ERROR\_CODE\_NODE\_EVENT\_PARAM\_INVALID = 106108 | 组件事件中不存在该数据。错误码的详细介绍请参见[106108 数据不存在](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106108-数据不存在)。 |
| ARKUI\_ERROR\_CODE\_NODE\_EVENT\_NO\_RETURN = 106109 | 组件事件不支持返回值。错误码的详细介绍请参见[106109 不支持返回值](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106109-不支持返回值)。 |
| ARKUI\_ERROR\_CODE\_NODE\_UNSUPPORTED\_EVENT\_TYPE = 106110 | 暂不支持该事件类型。错误码的详细介绍请参见[106110 暂不支持该事件类型](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-nodeadapter/errorcode-nodeadapter#section106110-暂不支持该事件类型)。  ****起始版本：**** 21 |
| ARKUI\_ERROR\_CODE\_NODE\_INDEX\_INVALID = 106200 | 传入的索引值非法。  错误码的详细介绍请参见[106200 传入的索引值非法](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-router/errorcode-router#section106200-传入的索引值非法)。 |
| ARKUI\_ERROR\_CODE\_GET\_INFO\_FAILED = 106201 | 查询路由导航信息失败。  错误码的详细介绍请参见[106201 查询路由导航信息失败](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-router/errorcode-router#section106201-查询路由导航信息失败)。 |
| ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR = 106202 | 传入的buffer size异常（数据过大）。  错误码的详细介绍请参见[106202 传入的buffer size异常](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-router/errorcode-router#section106202-传入的buffer-size异常)。 |
| ARKUI\_ERROR\_CODE\_NODE\_NOT\_ON\_MAIN\_TREE = 106203 | 传入的节点未挂载到组件树上。错误码的详细介绍请参见[106203 传入的节点未挂载到组件树上](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node/errorcode-node#section106203-传入的节点未挂载到组件树上)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_NODE\_ON\_INVALID\_THREAD = 106204 | 不支持在非UI线程操作传入的节点。错误码的详细介绍请参见[106204 不支持在非UI线程操作传入的节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node/errorcode-node#section106204-不支持在非ui线程操作传入的节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_FORCE\_DARK\_CONFIG\_INVALID = 106205 | 反色能力入参错误。错误码的详细介绍请参见[106205 反色能力入参错误](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-force-dark/errorcode-force-dark#section106205-反色能力入参错误)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_NODE\_IS\_ADOPTED = 106206 | 节点已被接纳为附属节点。错误码的详细介绍请参见[106206 节点已被接纳为附属节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-adopt/errorcode-adopt#section106206-节点已被接纳为附属节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_NODE\_HAS\_PARENT = 106207 | 被接纳的节点已有父节点。错误码的详细介绍请参见[106207 被接纳的附属节点已有父节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-adopt/errorcode-adopt#section106207-被接纳的附属节点已有父节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_NODE\_CAN\_NOT\_BE\_ADOPTED = 106208 | 节点无法被接纳为附属节点。错误码的详细介绍请参见[106208 节点无法被接纳为附属节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-adopt/errorcode-adopt#section106208-节点无法被接纳为附属节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_NODE\_CAN\_NOT\_ADOPT\_TO = 106209 | 节点无法接纳其他节点。错误码的详细介绍请参见[106209 节点无法接纳其他节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-adopt/errorcode-adopt#section106209-节点无法接纳其他节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_NODE\_IS\_NOT\_IN\_ADOPTED\_CHILDREN = 106210 | 节点不是被目标节点接纳的附属节点。错误码的详细介绍请参见[106210 节点不是被目标节点接纳的附属节点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-adopt/errorcode-adopt#section106210-节点不是被目标节点接纳的附属节点)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_NOT\_CUSTOM\_NODE = 106401 | 当前节点不是自定义节点。错误码的详细介绍请参见[渲染节点错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_CHILD\_EXISTED = 106402 | 当前节点已存在子节点。错误码的详细介绍请参见[渲染节点错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_RENDER\_PARENT\_EXISTED = 106403 | 当前渲染节点存在父组件。错误码的详细介绍请参见[渲染节点错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_RENDER\_CHILD\_NOT\_EXIST = 106404 | 未找到对应的渲染子节点。错误码的详细介绍请参见[渲染节点错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE = 106405 | 参数值超出范围。错误码的详细介绍请参见[渲染节点错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render)。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_RENDER\_IS\_FROM\_FRAME\_NODE = 106406 | 当前渲染节点从[ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h)中获取。错误码的详细介绍请参见[106406 当前渲染节点从FrameNode中获取](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render#section106406-当前渲染节点从framenode中获取)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_RENDER\_HAS\_INVALID\_FRAME\_NODE = 106407 | 当前渲染节点从[ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h)中获取且该[ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h)已被取消接纳为附属节点或销毁。错误码的详细介绍请参见[106407 当前渲染节点从FrameNode中获取且该FrameNode已被取消接纳为附属节点或销毁](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render#section106407-当前渲染节点从framenode中获取且该framenode已被取消接纳为附属节点或销毁)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_RENDER\_NOT\_ADOPTED\_NODE = 106408 | 当前节点不处于被接纳状态。错误码的详细介绍请参见[106408 当前节点不处于被接纳状态](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-node-render/errorcode-node-render#section106408-当前节点不处于被接纳状态)。  ****起始版本：**** 22 |
| ARKUI\_ERROR\_CODE\_FOCUS\_NON\_FOCUSABLE = 150001 | 当前节点无法获得焦点。错误码的详细介绍请参见[150001 节点无法获得焦点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-focus/errorcode-focus#section150001-节点无法获得焦点)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_FOCUS\_NON\_FOCUSABLE\_ANCESTOR = 150002 | 当前节点对应的祖先节点中存在无法获焦节点。错误码的详细介绍请参见[150002 祖先节点无法获得焦点](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-focus/errorcode-focus#section150002-祖先节点无法获得焦点)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_FOCUS\_NON\_EXISTENT = 150003 | 当前节点不存在。错误码的详细介绍请参见[150003 节点不存在](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-focus/errorcode-focus#section150003-节点不存在)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_COMPONENT\_SNAPSHOT\_TIMEOUT = 160002 | 截图超时。错误码的详细介绍请参见[截图错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-snapshot/errorcode-snapshot)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_COMPONENT\_SNAPSHOT\_MODE\_NOT\_SUPPORTED = 160003 | 截图选项不支持的色彩空间或动态范围模式。错误码的详细介绍请参见[截图错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-snapshot/errorcode-snapshot)。  ****起始版本：**** 23 |
| ARKUI\_ERROR\_CODE\_COMPONENT\_SNAPSHOT\_AUTO\_NOT\_SUPPORTED = 160004 | 离屏节点截图不支持色彩空间或动态范围模式的isAuto参数设置为true。错误码的详细介绍请参见[截图错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-snapshot/errorcode-snapshot)。  ****起始版本：**** 23 |
| ARKUI\_ERROR\_CODE\_NON\_SCROLLABLE\_CONTAINER = 180001 | 非滚动类容器。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。 |
| ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_NOT\_ENOUGH = 180002 | 存储区大小不足。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。 |
| ARKUI\_ERROR\_CODE\_NOT\_CLONED\_POINTER\_EVENT = 180003 | 该事件不是克隆事件。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_POST\_CLONED\_COMPONENT\_STATUS\_ABNORMAL = 180004 | 组件状态异常。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_CODE\_POST\_CLONED\_NO\_COMPONENT\_HIT\_TO\_RESPOND\_TO\_THE\_EVENT = 180005 | 未命中可响应事件的组件。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。  ****起始版本：**** 15 |
| ARKUI\_ERROR\_INPUT\_EVENT\_TYPE\_NOT\_SUPPORTED = 180006 | 接口不支持此输入事件类型。  ****起始版本：**** 20 |
| ARKUI\_ERROR\_CODE\_INVALID\_STYLED\_STRING = 180101 | 无效的属性字符串。错误码的详细介绍请参见[属性字符串错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-styled-string/errorcode-styled-string)。  ****起始版本：**** 14 |
| ARKUI\_ERROR\_CODE\_UI\_CONTEXT\_INVALID = 190001 | 无效的UIContext对象。错误码的详细介绍请参见[UI上下文错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-uicontext/errorcode-uicontext)。  ****起始版本：**** 18 |
| ARKUI\_ERROR\_CODE\_CALLBACK\_INVALID = 190002 | 无效的回调函数。错误码的详细介绍请参见[UI上下文错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-uicontext/errorcode-uicontext)。  ****起始版本：**** 18 |
| ARKUI\_ERROR\_CODE\_RECOGNIZER\_TYPE\_NOT\_SUPPORTED = 180102 | 不支持手势识别器类型。错误码的详细介绍请参见[交互事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-event/errorcode-event)。  ****起始版本：**** 18 |
| ARKUI\_ERROR\_CODE\_DRAG\_DROP\_OPERATION\_NOT\_ALLOWED = 190004 | 当前阶段不允许该操作。错误码的详细介绍请参见[拖拽事件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-drag-event/errorcode-drag-event)。  ****起始版本：**** 19 |
...
| ARKUI\_SCROLL\_SOURCE\_EDGE\_EFFECT = 2 | 在过界时执行[EdgeEffect.Spring](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect)边缘特效。 |
...
定义[ListItemGroup](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup)组件区域，默认值为ARKUI\_LIST\_ITEM\_GROUP\_AREA\_OUTSIDE。
...
| ARKUI\_LIST\_ITEM\_SWIPE\_AREA\_NONE = 1 | ListItemGroup没有[header](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)、[footer](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitemgroup/ts-container-listitemgroup#listitemgroupoptions对象说明)和[ListItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#listitem10)时的区域。 |
...
| ARKUI\_EXPAND = 1 | 展开。 |
| ARKUI\_LAZY\_EXPAND = 2 | 懒展开，按需展开当前节点的子节点，节点展开条件可以参考[LazyForEach：数据懒加载](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)。 |
...
定义[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)组件的状态。
...
定义[Router Page](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-router/arkts-apis-uicontext-router)（路由页面）的状态。
...
为不同响应式[断点规格](/arkui/arkts-ui-development/arkts-layout-development/arkts-build-layout/arkts-layout-development-grid-layout#栅格容器断点)指定列数。
...
[GridItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-griditem/ts-container-griditem)对齐方式枚举。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_LayoutConstraint](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-layoutconstraint/capi-arkui-nativemodule-arkui-layoutconstraint)\* | 创建布局约束的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_LayoutConstraint](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-layoutconstraint/capi-arkui-nativemodule-arkui-layoutconstraint)\* Constraint | 布局约束的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_LayoutConstraint](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-layoutconstraint/capi-arkui-nativemodule-arkui-layoutconstraint)\* | 新的布局约束指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_LayoutConstraint](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-layoutconstraint/capi-arkui-nativemodule-arkui-layoutconstraint)\* Constraint | 布局约束的指针。 |
...
获取绘制canvas指针，可以转换为图形库的[OH\_Drawing\_Canvas](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-canvas/capi-drawing-oh-drawing-canvas)指针进行绘制。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_DrawContext](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-drawcontext/capi-arkui-nativemodule-arkui-drawcontext)\* context | 绘制上下文。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_IntSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-intsize/capi-arkui-nativemodule-arkui-intsize) | 可绘制区域大小。 |
...
创建[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption)\* | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。 |
...
销毁[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息指针。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption)\* option | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption)\* option | FlowItem分组配置信息。 |
| int32\_t size | 数组长度。 |
...
获取[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息数组长度。
...
设置分组中[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)数量。
...
| int32\_t itemCount | 分组中[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)数量。 |
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息获取对应索引下的[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)数量。
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息获取对应索引下的布局栅格数。
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息获取对应索引下的分组的行间距。
...
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption)\* option | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。 |
| int32\_t index | 分组配置信息数组索引值。 |
| float marginTop | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)上外边距。 |
| float marginRight | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)右外边距。 |
| float marginBottom | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)下外边距。 |
| float marginLeft | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)左外边距。 |
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息获取对应索引下的分组的外边距。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_Margin](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-margin/capi-arkui-nativemodule-arkui-margin) | 外边距。单位：vp。 |
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息根据itemIndex获取指定FlowItem的主轴大小。如需在回调中使用自定义数据，可使用[OH\_ArkUI\_WaterFlowSectionOption\_RegisterGetItemMainSizeCallbackByIndexWithUserData](#oh_arkui_waterflowsectionoption_registergetitemmainsizecallbackbyindexwithuserdata)。
...
| [ArkUI\_WaterFlowSectionOption](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-waterflowsectionoption/pi-arkui-nativemodule-arkui-waterflowsectionoption)\* option | [FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息。 |
| int32\_t index | 分组配置信息数组索引值。 |
| callback | 根据index获取指定Item的主轴大小。itemIndex：[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)索引值。 |
...
通过[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)分组配置信息根据itemIndex获取指定Item的主轴大小。与[OH\_ArkUI\_WaterFlowSectionOption\_RegisterGetItemMainSizeCallbackByIndex](#oh_arkui_waterflowsectionoption_registergetitemmainsizecallbackbyindex)的区别在于，该接口支持传入自定义数据userData，并在回调函数中接收该数据。
...
| callback | 根据index获取指定Item的主轴大小。itemIndex：[FlowItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-flowitem/ts-container-flowitem)索引值；userData：用户自定义数据。 |
...
创建[RelativeContainer](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-relativecontainer/ts-container-relativecontainer)容器内的辅助线信息。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GuidelineOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-guidelineoption/capi-arkui-nativemodule-arkui-guidelineoption)\* | 辅助线信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GuidelineOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-guidelineoption/capi-arkui-nativemodule-arkui-guidelineoption)\* guideline | 辅助线信息。 |
...
| --- | --- |
| [ArkUI\_GuidelineOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-guidelineoption/capi-arkui-nativemodule-arkui-guidelineoption)\* guideline | 辅助线信息。 |
| [ArkUI\_Axis](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_axis) value | 方向。 |
| int32\_t index | 辅助线索引值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_Axis](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_axis) | 方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_BarrierOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-barrieroption/capi-arkui-nativemodule-arkui-barrieroption)\* | 屏障信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_BarrierOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-barrieroption/capi-arkui-nativemodule-arkui-barrieroption)\* barrierStyle | 屏障信息。 |
...
| --- | --- |
| [ArkUI\_BarrierOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-barrieroption/capi-arkui-nativemodule-arkui-barrieroption)\* barrierStyle | 屏障信息。 |
| [ArkUI\_BarrierDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_barrierdirection) value | 方向。 |
| int32\_t index | 屏障索引值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_BarrierDirection](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_barrierdirection) | 屏障的方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AlignmentRuleOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-alignmentruleoption/capi-arkui-nativemodule-arkui-alignmentruleoption)\* | 对齐规则信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AlignmentRuleOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-alignmentruleoption/capi-arkui-nativemodule-arkui-alignmentruleoption)\* option | 相对容器中子组件的对齐规则信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_HorizontalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_horizontalalignment) | 参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_HorizontalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_horizontalalignment) | 右对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_HorizontalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_horizontalalignment) | 横向居中对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_VerticalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_verticalalignment) | 顶部对齐的方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_VerticalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_verticalalignment) | 底部对齐的方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_VerticalAlignment](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_verticalalignment) | 纵向居中对齐方式。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SwiperIndicatorType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_swiperindicatortype) type | 导航指示器的类型。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SwiperIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperindicator/capi-arkui-nativemodule-arkui-swiperindicator)\* | 导航指示器对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SwiperIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperindicator/capi-arkui-nativemodule-arkui-swiperindicator)\* indicator | 导航指示器对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 如果maxDisplayCount设置范围错误, 返回错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator) \* | 数字导航指示器对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator)\* indicator | 数字导航指示器对象指针。 |
...
| --- | --- |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator) \*indicator | 数字导航指示器对象指针。 |
| [ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight) fontWeight | 字体粗细样式[ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight) | 字体粗细样式[ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight)。 |
...
| --- | --- |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator) \*indicator | 数字导航指示器对象指针。 |
| [ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight) selectedFontWeight | 字体粗细样式[ArkUI\_FontWeight](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_fontweight)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SwiperArrowStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperarrowstyle/capi-arkui-nativemodule-arkui-swiperarrowstyle) \* | 导航箭头对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SwiperArrowStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperarrowstyle/capi-arkui-nativemodule-arkui-swiperarrowstyle)\* arrowStyle | 导航箭头对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SwiperDigitIndicator](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-swiperdigitindicator/capi-arkui-nativemodule-arkui-swiperdigitindicator)\* indicator | 导航指示器对象指针。 |
| int32\_t ignoreSize | 是否忽略导航点大小。1表示忽略导航点大小，0表示不忽略，默认值0。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionItem](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-listitemswipeactionitem/i-arkui-nativemodule-arkui-listitemswipeactionitem)\* | ListItemSwipeActionItem配置项实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionItem](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-listitemswipeactionitem/i-arkui-nativemodule-arkui-listitemswipeactionitem)\* item | 要销毁的ListItemSwipeActionItem实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionItem](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-listitemswipeactionitem/i-arkui-nativemodule-arkui-listitemswipeactionitem)\* item | ListItemSwipeActionItem实例。 |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | 布局信息。 |
...
设置组件进入长距删除区后删除[ListItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem)时调用的事件。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-listitemswipeactionoption/arkui-nativemodule-arkui-listitemswipeactionoption)\* | ListItemSwipeActionOption配置项实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-listitemswipeactionoption/arkui-nativemodule-arkui-listitemswipeactionoption)\* option | 要销毁的ListItemSwipeActionOption实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListItemSwipeActionOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-listitemswipeactionoption/arkui-nativemodule-arkui-listitemswipeactionoption)\* option | ListItemSwipeActionItem实例。 |
| [ArkUI\_ListItemSwipeActionItem](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-listitemswipeactionitem/i-arkui-nativemodule-arkui-listitemswipeactionitem)\* item | 布局信息。 |
...
| --- | --- |
| [ArkUI\_ListItemSwipeActionOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-listitemswipeactionoption/arkui-nativemodule-arkui-listitemswipeactionoption)\* option | ListItemSwipeActionItem实例。 |
| [ArkUI\_ListItemSwipeEdgeEffect](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_listitemswipeedgeeffect) edgeEffect | 边缘滑动效果。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | ListItem节点对象。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 传入的节点对象类型错误。  [ARKUI\_ERROR\_CODE\_NODE\_NOT\_ON\_MAIN\_TREE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 传入的节点未挂载到组件树上。 |

![](../../../../images/2da6a59c/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AccessibilityState](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilitystate/capi-arkui-nativemodule-arkui-accessibilitystate)\* | 无障碍状态对象指针。如果对象返回空指针，表示创建失败，失败的可能原因是应用地址空间满。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityState](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilitystate/capi-arkui-nativemodule-arkui-accessibilitystate)\* state | 无障碍状态对象指针。 |
...
| --- | --- |
| [ArkUI\_AccessibilityState](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilitystate/capi-arkui-nativemodule-arkui-accessibilitystate)\* state | 无障碍状态对象指针。 |
| int32\_t checkedState | 复选框状态，参数类型[ArkUI\_AccessibilityCheckedState](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_accessibilitycheckedstate), 默认值：ARKUI\_ACCESSIBILITY\_UNCHECKED。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 复选框状态，参数类型[ArkUI\_AccessibilityCheckedState](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_accessibilitycheckedstate), 默认值：ARKUI\_ACCESSIBILITY\_UNCHECKED;  若函数参数异常，返回默认值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* | 无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 需要设置最小值的范围组件无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 需要获取最小值的范围组件无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 需要设置最大值的范围组件无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 需要设置当前值的范围组件无障碍信息对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AccessibilityValue](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-accessibilityvalue/capi-arkui-nativemodule-arkui-accessibilityvalue)\* value | 需要获取当前值的范围组件无障碍信息对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ImageAnimatorFrameInfo](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-imageanimatorframeinfo/pi-arkui-nativemodule-arkui-imageanimatorframeinfo)\* | 帧图片对象指针。 |
...
使用[ArkUI\_DrawableDescriptor](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-drawabledescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor)对象创建帧图片信息。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_DrawableDescriptor](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-drawabledescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor)\* drawable | 使用PixelMap创建的ArkUI\_DrawableDescriptor对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ImageAnimatorFrameInfo](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-imageanimatorframeinfo/pi-arkui-nativemodule-arkui-imageanimatorframeinfo)\* imageInfo | 帧图片对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ListChildrenMainSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-listchildrenmainsize/capi-arkui-nativemodule-arkui-listchildrenmainsize)\* | ListChildrenMainSize配置项实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListChildrenMainSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-listchildrenmainsize/capi-arkui-nativemodule-arkui-listchildrenmainsize)\* option | 要销毁的ListChildrenMainSize实例。 |
...
设置[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件列表项在主轴方向的默认尺寸。主轴方向为纵向时表示高度，为横向时表示宽度。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ListChildrenMainSize](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-listchildrenmainsize/capi-arkui-nativemodule-arkui-listchildrenmainsize)\* option | ListChildrenMainSize实例。 |
...
获取[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件的列表项在主轴方向的默认尺寸。主轴方向为纵向时表示高度，为横向时表示宽度。
...
| 类型 | 说明 |
| --- | --- |
| float | 列表项在主轴方向的默认尺寸值，默认为0，单位为[vp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#vp10)，option为空指针时返回-1。 |
...
调整[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件子项主轴尺寸数组的容量大小。
...
对[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件子项主轴尺寸数组进行大小调整。
...
更新[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件子项主轴尺寸数组中指定索引位置的尺寸。主轴方向为纵向时表示高度，为横向时表示宽度。
...
获取[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)组件子项主轴尺寸数组中指定索引位置的尺寸。主轴方向为纵向时表示高度，为横向时表示宽度。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CustomSpanMeasureInfo](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-customspanmeasureinfo/api-arkui-nativemodule-arkui-customspanmeasureinfo)\* | CustomSpanMeasureInfo实例。  如果返回空指针，可能是因为内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomSpanMeasureInfo](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-customspanmeasureinfo/api-arkui-nativemodule-arkui-customspanmeasureinfo)\* info | 自定义段落组件测量信息指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CustomSpanMetrics](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspanmetrics/capi-arkui-nativemodule-arkui-customspanmetrics)\* | CustomSpanMetrics实例。  如果返回空指针，可能是因为内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomSpanMetrics](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspanmetrics/capi-arkui-nativemodule-arkui-customspanmetrics)\* metrics | CustomSpanMetrics实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CustomSpanDrawInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspandrawinfo/capi-arkui-nativemodule-arkui-customspandrawinfo)\* | CustomSpanDrawInfo实例。  如果返回空指针，可能是因为内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomSpanDrawInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customspandrawinfo/capi-arkui-nativemodule-arkui-customspandrawinfo)\* info | 自定义段落组件绘制信息指针。 |
...
销毁[ArkUI\_CustomProperty](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customproperty/capi-arkui-nativemodule-arkui-customproperty)实例。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomProperty](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customproperty/capi-arkui-nativemodule-arkui-customproperty)\* handle | 要销毁的实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CustomProperty](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-customproperty/capi-arkui-nativemodule-arkui-customproperty)\* handle | 自定义属性对象指针。 |
...
获取[ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)对象中的窗口名称。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)\* info | HostWindowInfo对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| const char\* | [ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)对象中的窗口名称。 |
...
销毁[ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)对象。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)\* info | 要销毁的[ArkUI\_HostWindowInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-hostwindowinfo/capi-arkui-nativemodule-arkui-hostwindowinfo)对象。 |
...
销毁[ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)实例。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)\* handle | 要销毁的[ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)实例。 |
...
获取[ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)结构体的下标为index的子节点。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)\* handle | 要获取信息的[ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) | 下标对应的子节点指针，异常时返回nullptr。 |
...
获取[ArkUI\_ActiveChildrenInfo](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-activechildreninfo/capi-arkui-nativemodule-arkui-activechildreninfo)结构体内的节点数量。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ProgressLinearStyleOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-progresslinearstyleoption/arkui-nativemodule-arkui-progresslinearstyleoption)\* | ProgressLinearStyleOption实例。  如果返回空指针，可能是因为内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ProgressLinearStyleOption](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-progresslinearstyleoption/arkui-nativemodule-arkui-progresslinearstyleoption)\* option | 线性进度条样式信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SnapshotOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-snapshotoptions/capi-arkui-nativemodule-arkui-snapshotoptions)\* | 返回指向创建的截图选项对象的指针。如果对象返回空指针，则表示创建失败，失败的原因可能是地址空间已满。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SnapshotOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-snapshotoptions/capi-arkui-nativemodule-arkui-snapshotoptions)\* snapshotOptions | 截图选项。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SnapshotOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-snapshotoptions/capi-arkui-nativemodule-arkui-snapshotoptions)\* snapshotOptions | 截图选项指针。 |
...
| --- | --- |
| [ArkUI\_SnapshotOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-snapshotoptions/capi-arkui-nativemodule-arkui-snapshotoptions)\* snapshotOptions | 截图选项指针。 |
| int32\_t dynamicRangeMode | 指定截图使用的动态范围模式。  如果知道截图对象使用的动态范围模式，可通过dynamicRangeMode参数指定动态范围模式，并将isAuto设置为false，以达到预期的截图效果。  支持的取值为：[ArkUI\_DynamicRangeMode](#arkui_dynamicrangemode)枚举值。  默认值：ARKUI\_DYNAMIC\_RANGE\_MODE\_STANDARD  仅当isAuto设置为false，该参数设置生效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CrossLanguageOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-crosslanguageoption/capi-arkui-nativemodule-arkui-crosslanguageoption)\* | 返回跨语言实例。如果对象返回空指针，则表示创建失败，失败的原因可能是地址空间已满。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CrossLanguageOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-crosslanguageoption/capi-arkui-nativemodule-arkui-crosslanguageoption)\* option | 要销毁的跨语言配置项实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CrossLanguageOption](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-crosslanguageoption/capi-arkui-nativemodule-arkui-crosslanguageoption)\* option | 跨语言配置项实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_VisibleAreaEventOptions](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-visibleareaeventoptions/i-arkui-nativemodule-arkui-visibleareaeventoptions)\* | 可见区域变化监听的参数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_VisibleAreaEventOptions](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-visibleareaeventoptions/i-arkui-nativemodule-arkui-visibleareaeventoptions)\* option | 需要销毁的实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_VisibleAreaEventOptions](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-visibleareaeventoptions/i-arkui-nativemodule-arkui-visibleareaeventoptions)\* option | 可见区域变化监听的参数实例。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 数组大小不够。  异常原因：传入参数验证失败，参数不能为空。 |
...
创建[TextPickerRangeContent](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-textpickerrangecontentarray/kui-nativemodule-arkui-textpickerrangecontentarray)数组的对象。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextPickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-textpickerrangecontentarray/kui-nativemodule-arkui-textpickerrangecontentarray)\* | 返回指向TextPickerRangeContent空数组的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextPickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/kui-nativemodule-arkui-textpickerrangecontentarray/kui-nativemodule-arkui-textpickerrangecontentarray)\* handle | 指向TextPickerRangeContent数组的指针。 |
| char\* icon | 图标路径。 |
...
创建[TextCascadePickerRangeContent](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray)数组对象。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextCascadePickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray)\* | 返回指向TextCascadePickerRangeContent空数组的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextCascadePickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray)\* handle | 指向TextCascadePickerRangeContentHandle的指针。 |
| char\* text | 文本内容。 |
| int32\_t index | 数组位置，从0开始。 |
...
| --- | --- |
| [ArkUI\_TextCascadePickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray)\* handle | 指向TextCascadePickerRangeContentHandle的指针。 |
| [ArkUI\_TextCascadePickerRangeContentArray](/ref/arkui-api/arkui-c/arkui-struct/ivemodule-arkui-textcascadepickerrangecontentarray/ivemodule-arkui-textcascadepickerrangecontentarray)\* child | 子节点数组指针。 |
| int32\_t index | 数组位置，从0开始。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_EmbeddedComponentOption](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-embeddedcomponentoption/i-arkui-nativemodule-arkui-embeddedcomponentoption)\* | 返回指向EmbeddedComponent组件选项的对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_EmbeddedComponentOption](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-embeddedcomponentoption/i-arkui-nativemodule-arkui-embeddedcomponentoption)\* option | 要销毁的EmbeddedComponent组件选项的对象的指针。 |
...
设置EmbeddedComponent组件的[onError](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-container-embedded-component/ts-container-embedded-component#onerror)回调。EmbeddedComponent组件在运行过程中发生异常时触发本回调。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_EmbeddedComponentOption](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-embeddedcomponentoption/i-arkui-nativemodule-arkui-embeddedcomponentoption)\* option | EmbeddedComponent组件选项的对象的指针。 |
| void (\*callback)(int32\_t code, const char\* name, const char\* message) | 开发者自定义回调函数。  - code：接口调用失败返回的错误码信息。错误码的详细介绍请参考[UIExtension错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-uiextension/errorcode-uiextension)。  - name：接口调用失败返回的名称信息。  - message：接口调用失败返回的详细信息。 |
...
设置EmbeddedComponent组件的[onTerminated](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-container-embedded-component/ts-container-embedded-component#onterminated)回调。EmbeddedComponent组件正常退出时触发本回调。
...
| --- | --- |
| [ArkUI\_EmbeddedComponentOption](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-embeddedcomponentoption/i-arkui-nativemodule-arkui-embeddedcomponentoption)\* option | EmbeddedComponent组件选项的对象的指针。 |
| void (\*callback)(int32\_t code, [AbilityBase\_Want](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-abilitybase-want/capi-arkui-nativemodule-abilitybase-want)\* want) | 开发者自定义回调函数。  - code：被拉起[EmbeddedUIExtensionAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-embeddeduiextensionability/js-apis-app-ability-embeddeduiextensionability)退出时返回的结果码。若EmbeddedUIExtensionAbility通过调用[terminateSelfWithResult](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiextensioncontentsession/js-apis-app-ability-uiextensioncontentsession#terminateselfwithresult)退出，结果码为EmbeddedUIExtensionAbility设置的值。若EmbeddedUIExtensionAbility通过调用[terminateSelf](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiextensioncontentsession/js-apis-app-ability-uiextensioncontentsession#terminateself)退出，结果码为默认值"0"。  - want：被拉起EmbeddedUIExtensionAbility退出时返回的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_PositionEdges](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-positionedges/capi-arkui-nativemodule-arkui-positionedges)\* | 指向PositionEdges对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PositionEdges](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-positionedges/capi-arkui-nativemodule-arkui-positionedges)\* edges | 指向PositionEdges对象的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_PositionEdges](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-positionedges/capi-arkui-nativemodule-arkui-positionedges)\* | 指向新PositionEdges对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_PixelRoundPolicy](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pixelroundpolicy/capi-arkui-nativemodule-arkui-pixelroundpolicy)\* | 指向PixelRoundPolicy对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PixelRoundPolicy](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pixelroundpolicy/capi-arkui-nativemodule-arkui-pixelroundpolicy)\* policy | 指向要释放的PixelRoundPolicy对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PixelRoundPolicy](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pixelroundpolicy/capi-arkui-nativemodule-arkui-pixelroundpolicy)\* policy | 指向PixelRoundPolicy对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ContentTransitionEffect](/ref/arkui-api/arkui-c/arkui-struct/i-arkui-nativemodule-arkui-contenttransitioneffect/i-arkui-nativemodule-arkui-contenttransitioneffect)\* | 指向ContentTransitionEffect对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GridLayoutOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gridlayoutoptions/capi-arkui-nativemodule-arkui-gridlayoutoptions)\* | Grid布局选项。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GridLayoutOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gridlayoutoptions/capi-arkui-nativemodule-arkui-gridlayoutoptions)\* option | Grid布局选项。 |
...
| [ArkUI\_GridLayoutOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-gridlayoutoptions/capi-arkui-nativemodule-arkui-gridlayoutoptions)\* option | Grid布局选项。 |
| void\* userData | 用户自定义数据。 |
| ArkUI\_GridItemSize (\*callback)(int32\_t itemIndex, void\* userData) | 根据index获取指定Item占用的行列数。  itemIndex：GridItem索引值，取值范围来自[OH\_ArkUI\_GridLayoutOptions\_SetIrregularIndexes](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#oh_arkui_gridlayoutoptions_setirregularindexes)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ShowCounterConfig](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-textshowcounterconfig/api-arkui-nativemodule-arkui-textshowcounterconfig)\* | 指向文本输入框计数器的配置对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ShowCounterConfig](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-textshowcounterconfig/api-arkui-nativemodule-arkui-textshowcounterconfig)\* config | 销毁文本输入框计数器的配置对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ShowCounterConfig](/ref/arkui-api/arkui-c/arkui-struct/api-arkui-nativemodule-arkui-textshowcounterconfig/api-arkui-nativemodule-arkui-textshowcounterconfig)\* config | 指向文本输入框计数器的配置对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SelectionOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-selectionoptions/capi-arkui-nativemodule-arkui-selectionoptions)\* | 指向选择选项对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SelectionOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-selectionoptions/capi-arkui-nativemodule-arkui-selectionoptions)\* options | 指向待释放的选择选项对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SelectionOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-selectionoptions/capi-arkui-nativemodule-arkui-selectionoptions)\* options | 指向选择选项对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextContentBaseController](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-textcontentbasecontroller/arkui-nativemodule-arkui-textcontentbasecontroller)\* | 指向控制器对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextContentBaseController](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-textcontentbasecontroller/arkui-nativemodule-arkui-textcontentbasecontroller)\* controller | 待销毁的控制器对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextContentBaseController](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-textcontentbasecontroller/arkui-nativemodule-arkui-textcontentbasecontroller)\* controller | 待修改的配置对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextContentBaseController](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-textcontentbasecontroller/arkui-nativemodule-arkui-textcontentbasecontroller)\* controller | 待修改的配置对象指针。  通过此controller将起始索引与结束索引传递给与其绑定的输入框组件并进行滚动操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\* | 指向ArkUI\_TextMenuItem对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\* textMenuItem | 指向ArkUI\_TextMenuItem对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\* item | 指向ArkUI\_TextMenuItem对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) | 返回结果。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\* item | 指向ArkUI\_TextMenuItem对象的指针。 |
| char\* buffer | 缓冲区，由开发者创建分配内存，用于存储文本菜单项标题信息。 |
| int32\_t bufferSize | 缓冲区大小。 |
| int32\_t\* writeLength | 返回值为[ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)时表示实际写入缓冲区的长度。  返回值为[ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)时表示字符串完整写入缓冲区所需要的最小长度。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) | 返回结果。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 缓冲区大小不足。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMenuItemArray](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitemarray/capi-arkui-nativemodule-arkui-textmenuitemarray)\* items | 指向ArkUI\_TextMenuItemArray对象的指针。 |
...
| [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\*\* item | 指向ArkUI\_TextMenuItem对象的二级指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextEditMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-texteditmenuoptions/capi-arkui-nativemodule-arkui-texteditmenuoptions)\* editMenuOptions | 指向ArkUI\_TextEditMenuOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMenuItemArray](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitemarray/capi-arkui-nativemodule-arkui-textmenuitemarray)\* items | 指向ArkUI\_TextMenuItemArray对象的指针，该数组对象由系统内部创建并释放，在回调函数中开发者可以调用[OH\_ArkUI\_TextMenuItemArray\_Insert](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#oh_arkui_textmenuitemarray_insert)，[OH\_ArkUI\_TextMenuItemArray\_Erase](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#oh_arkui_textmenuitemarray_erase)进行数组修改。 |
| void\* userData | 用户自定义数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_TextMenuItem](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmenuitem/capi-arkui-nativemodule-arkui-textmenuitem)\* item | 指向ArkUI\_TextMenuItem对象的指针，表示被点击的文本菜单项。 |
...
| [ArkUI\_TextEditMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-texteditmenuoptions/capi-arkui-nativemodule-arkui-texteditmenuoptions)\* editMenuOptions | 指向ArkUI\_TextEditMenuOptions对象的指针。 |
| void\* userData | 用户自定义数据。 |
| [ArkUI\_TextCreateMenuCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textcreatemenucallback) cb | 文本菜单创建事件回调函数。 |
...
| [ArkUI\_TextEditMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-texteditmenuoptions/capi-arkui-nativemodule-arkui-texteditmenuoptions)\* editMenuOptions | 指向ArkUI\_TextEditMenuOptions对象的指针。 |
| void\* userData | 用户自定义数据。 |
| [ArkUI\_TextPrepareMenuCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textpreparemenucallback) cb | 文本菜单准备事件回调函数。 |
...
| [ArkUI\_TextEditMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-texteditmenuoptions/capi-arkui-nativemodule-arkui-texteditmenuoptions)\* editMenuOptions | 指向ArkUI\_TextEditMenuOptions对象的指针。 |
| void\* userData | 用户自定义数据。 |
| [ArkUI\_TextMenuItemClickCallback](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textmenuitemclickcallback) cb | 文本菜单项点击事件回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* selectionMenuOptions | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
...
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* selectionMenuOptions | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
| [ArkUI\_TextSpanType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textspantype) textSpanType | 自定义文本选择菜单的文本识别类型。 |
...
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* selectionMenuOptions | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
| [ArkUI\_TextSpanType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textspantype)\* spanType | 自定义文本选择菜单的文本识别类型。 |
...
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* selectionMenuOptions | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
| [ArkUI\_NodeHandle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-node8h/capi-arkui-nativemodule-arkui-node8h) node | 自定义文本选择菜单的内容节点。 |
...
| --- | --- |
| [ArkUI\_TextSelectionMenuOptions](/ref/arkui-api/arkui-c/arkui-struct/x-arkui-nativemodule-arkui-textselectionmenuoptions/x-arkui-nativemodule-arkui-textselectionmenuoptions)\* selectionMenuOptions | 指向ArkUI\_TextSelectionMenuOptions对象的指针。 |
| [ArkUI\_TextResponseType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_textresponsetype) responseType | 自定义文本选择菜单的响应类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TextMarqueeOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmarqueeoptions/capi-arkui-nativemodule-arkui-textmarqueeoptions)\* | 创建文本跑马灯模式配置项的对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMarqueeOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmarqueeoptions/capi-arkui-nativemodule-arkui-textmarqueeoptions)\* option | 需要销毁的文本跑马灯模式配置项对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TextMarqueeOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-textmarqueeoptions/capi-arkui-nativemodule-arkui-textmarqueeoptions)\* option | 文本跑马灯模式配置项。 |
...
在渐隐效果开启状态下，[NODE\_CLIP](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-node-h/capi-native-node-h#arkui_nodeattributetype)属性将自动锁定为true，不允许设置为false。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_SelectedDragPreviewStyle](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-textselecteddragpreviewstyle/ui-nativemodule-arkui-textselecteddragpreviewstyle)\* | 指向ArkUI\_SelectedDragPreviewStyle对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_SelectedDragPreviewStyle](/ref/arkui-api/arkui-c/arkui-struct/ui-nativemodule-arkui-textselecteddragpreviewstyle/ui-nativemodule-arkui-textselecteddragpreviewstyle)\* config | 指向ArkUI\_SelectedDragPreviewStyle对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。  新建的[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)对象中，路径动画的运动路径path值为空字符串，路径动画起点进度from值为0，路径动画终点进度to值为1，组件是否沿路径旋转rotatable值为false。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
...
| --- | --- |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| const char\* svgPath | 路径动画的运动路径字符串。  该路径支持使用"start"和"end"作为起点和终点的占位符，例如："Mstart.x start.y L50 50 Lend.x end.y Z"。路径字符串格式请参考[绘制路径](/arkui/ui-js-dev/ui-js-components/ui-js-svg/ui-js-components-svg-path)。若设置为空字符串，等效于未设置路径动画。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| char\* svgPathBuffer | 存储运动路径字符串的缓冲区指针。 |
| const int32\_t bufferSize | svgPathBuffer参数的缓冲区大小。 |
| int32\_t\* writeLength | 返回[ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)时，表示实际写入缓冲区的字符串长度。  返回[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)时，表示如果为入参异常，writeLength不会被赋值，如果为拷贝异常，writeLength为可容纳目标字符串的最小缓冲区大小。  返回[ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)时，表示可容纳目标字符串的最小缓冲区大小。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 缓冲区大小不足。 |
...
| --- | --- |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| const float from | 路径动画的起点进度，取值范围为[0.0, 1.0]，且需满足from小于或等于终点进度to，否则将返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)错误码。  to的含义参考[OH\_ArkUI\_MotionPathOptions\_SetTo](#oh_arkui_motionpathoptions_setto)。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) from超出[0.0, 1.0]范围，或from大于终点进度to。 |
...
| --- | --- |
| const [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| float\* from | 用于接收路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)中起点进度值的指针。 |
...
| --- | --- |
| [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| const float to | 路径动画的终点进度，取值范围为[0.0, 1.0]，且需满足to大或等于起点进度from；否则将返回[ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode)错误码。  from的含义参考[OH\_ArkUI\_MotionPathOptions\_SetFrom](#oh_arkui_motionpathoptions_setfrom)。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_PARAM\_OUT\_OF\_RANGE](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_errorcode) to超出[0.0, 1.0]范围，或to小于起点进度from。 |
...
| --- | --- |
| const [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| float\* to | 用于接收路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)中终点进度值的指针。 |
...
| --- | --- |
| const [ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)\* options | 指向路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| bool\* rotatable | 用于接收路径动画的运动路径配置项[ArkUI\_MotionPathOptions](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-motionpathoptions/capi-arkui-nativemodule-arkui-motionpathoptions)中rotatable参数值的指针，表示组件是否沿路径旋转。  true表示组件沿路径旋转；false表示组件不沿路径旋转。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PickerIndicatorType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_pickerindicatortype) type | 选择器选中项样式枚举类型。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)\* | [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)实例。如果返回空指针，表示创建失败，失败原因可是地址空间已满或类型不支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)\* style | 要销毁的[ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)实例。 |
...
设置背景样式参数，此接口仅当选择器选中项样式枚举类型为[ARKUI\_PICKER\_INDICATOR\_BACKGROUND](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_pickerindicatortype)时生效。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)\* style | 选中项指示器样式[ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)的实例。 |
| [ArkUI\_PickerIndicatorBackground](/ref/arkui-api/arkui-c/arkui-struct/arkui-nativemodule-arkui-pickerindicatorbackground/arkui-nativemodule-arkui-pickerindicatorbackground)\* background | 背景样式参数。 |
...
设置分割线样式参数，此接口仅当选择器选中项样式枚举类型为[ARKUI\_PICKER\_INDICATOR\_DIVIDER](/ref/arkui-api/arkui-c/arkui-headerfile/capi-native-type-h/capi-native-type-h#arkui_pickerindicatortype)时生效。
...
| --- | --- |
| [ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)\* style | 选中项指示器样式[ArkUI\_PickerIndicatorStyle](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-pickerindicatorstyle/capi-arkui-nativemodule-arkui-pickerindicatorstyle)的实例。 |
| [ArkUI\_PickerIndicatorDivider](/ref/arkui-api/arkui-c/arkui-struct/pi-arkui-nativemodule-arkui-pickerindicatordivider/pi-arkui-nativemodule-arkui-pickerindicatordivider)\* divider | 分割线样式参数。 |
