...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-windowmanager-windowproperties
kit: 应用框架
...
| 名称 | 描述 |
| --- | --- |
| [WindowManager\_Rect](/ref/arkui-api/arkui-c/arkui-struct/capi-windowmanager-rect/capi-windowmanager-rect) windowRect | 窗口的位置和尺寸。 |
| [WindowManager\_Rect](/ref/arkui-api/arkui-c/arkui-struct/capi-windowmanager-rect/capi-windowmanager-rect) drawableRect | 窗口内可绘制区域的尺寸。 |
| [WindowManager\_WindowType](/ref/arkui-api/arkui-c/arkui-headerfile/capi-oh-window-comm-h/capi-oh-window-comm-h#windowmanager_windowtype) type | 窗口类型。 |
