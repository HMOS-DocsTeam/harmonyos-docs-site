...
![](../../../../images/22f36aa1/note_3.0-zh-cn.png) 
...
闪控球相关参数具体可见[FloatingBallParams](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#floatingballparams)。
...
使用了无效的窗口类型，有效的窗口类型见[WindowType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowtype7)。
