...
![](../../../../images/e6f63297/note_3.0-zh-cn.png) 
...
- 传入id错误、节点已经被销毁等。
- 对不具有获焦能力的组件请求焦点。具体组件可查询[组件获焦能力说明](/arkui/arkts-ui-development/arkts-interaction-development-guide-overview/arkts-common-events-focus-event#组件获焦能力说明)。
