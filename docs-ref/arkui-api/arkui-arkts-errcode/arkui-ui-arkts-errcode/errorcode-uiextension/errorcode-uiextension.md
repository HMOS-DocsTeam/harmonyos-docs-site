...
sidebar_position: 20
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-uiextension
kit: 应用框架
...
![](../../../../images/962417b8/note_3.0-zh-cn.png) 
...
1. Want参数配置错误；
2. type类型不一致，具体请参考[EmbeddedComponent组件](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-container-embedded-component/ts-container-embedded-component#接口)；
3. 提供方应用未安装；
4. 设备类型不支持；
