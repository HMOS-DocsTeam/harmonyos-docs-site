...
![](../../../../images/2d752205/note_3.0-zh-cn.png) 
...
开发者在之前的某个地方使用该实例对象调用了[disposeNode](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativenodeapi-1/capi-arkui-nativemodule-arkui-nativenodeapi-1#disposenode)接口，例如：item.dispose()。
...
BuilderNode中，[状态管理V2](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-overview#状态管理v2)暂不支持[组件复用](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-buildernode/js-apis-arkui-buildernode#reuse12)。
...
2. 确认节点是由多线程[createNode](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativenodeapi-1/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建的。
3. 参考[多线程NDK接口调用规范](/arkui/arkts-use-ndk/ndk-build-on-multi-thread#多线程ndk接口调用规范)，将组件所在组件树中所有不可转换的Attached组件移除。
