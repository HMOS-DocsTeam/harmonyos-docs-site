...
![](../../../../images/432f1677/note_3.0-zh-cn.png) 

本模块首批接口从API version 9开始支持，后续版本的新增接口，采用上角标单独标记接口的起始版本。

在自定义组件内实现onMeasureSize, onPlaceChildren任一方法即视为实现自定义布局，推荐同时实现两种方法，具体参数说明可见对应接口参数说明。

从API version 20开始，在自定义布局的自定义组件中，子组件若设置了[LayoutPolicy](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#layoutpolicy15)对象的fixAtIdealSize属性，表示尺寸将不受父组件约束，完全按照开发者自定义的尺寸范围布局。

自定义布局内不支持使用懒加载(包含[Repeat](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)和[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach))。
...
| children | Array&lt;[Measurable](#measurable10)&gt; | 是 | 计算子组件大小后的子组件布局信息。  ****说明：****  如果没有设置子组件的布局信息，子组件会维持上一次的布局信息，当子组件从来没有设置过尺寸时，尺寸默认为0。 |
| constraint | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 是 | 自定义组件的布局约束信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidth](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#edgewidths9) | 否 | 否 | 父组件（自定义组件）边框宽度。  单位：vp。 |
| margin | [Margin](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#margin) | 否 | 否 | 父组件（自定义组件）margin信息。  单位：vp。 |
| padding | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 否 | 否 | 父组件（自定义组件）padding信息。  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#position) | 是 | 绝对位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT&lt;number&gt;](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#directionaledgestt12) | 子组件的margin信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT&lt;number&gt;](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#directionaledgestt12) | 子组件的padding信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT&lt;number&gt;](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#directionaledgestt12) | 子组件的borderWidth信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| constraint | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 是 | 约束尺寸。 |
...
![](../../../../images/7fe1e0ee/note_3.0-zh-cn.png) 
...
![](../../../../images/e3ef9e87/note_3.0-zh-cn.png) 
...
| constraint | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 是 | 父组件constraint信息。 |
...
![](../../../../images/b98b6443/note_3.0-zh-cn.png) 
...
![](../../../../images/4d684121/note_3.0-zh-cn.png) 
...
| id | string | 否 | 否 | 子组件id。 |
| constraint | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 否 | 否 | 子组件约束尺寸。 |
| borderInfo | [LayoutBorderInfo](#layoutborderinfodeprecated) | 否 | 否 | 子组件border信息。 |
| position | [Position](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#position) | 否 | 否 | 子组件位置坐标。 |
...
![](../../../../images/cac455ef/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childConstraint | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 是 | 子组件的尺寸范围的约束信息。 |
...
![](../../../../images/c2f639c3/note_3.0-zh-cn.png) 
...
![](../../../../images/038c1d2c/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidths](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#edgewidths9) | 否 | 否 | 边框宽度类型，用于描述组件边框不同方向的宽度。 |
| margin | [Margin](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#margin) | 否 | 否 | 外边距类型，用于描述组件不同方向的外边距。 |
| padding | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 否 | 否 | 内边距类型，用于描述组件不同方向的内边距。 |

## LayoutInfo(deprecated)

子组件layout信息。

![](../../../../images/3d6c680f/note_3.0-zh-cn.png) 
...
![](../../../../images/e86ff37a/zh-cn_image_0000002552800442.png)
...
![](../../../../images/1dc03d9b/zh-cn_image_0000002583440137.png)

### 示例3（获取子组件FrameNode并设置相关属性）

通过uniqueId获取子组件的[FrameNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode)，并调用FrameNode的API接口修改尺寸、背景颜色。
...
![](../../../../images/fce7cfce/zh-cn_image_0000002552960092.jpg)

### 示例4（子组件超过父组件大小约束）

在自定义布局的自定义组件中，为子组件设置了[LayoutPolicy](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#layoutpolicy15)对象的fixAtIdealSize属性。
...
![](../../../../images/5d2d4d58/zh-cn_image_0000002583480093.jpg)
