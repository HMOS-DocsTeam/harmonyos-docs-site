...
![](../../../../images/3ff2c404/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isInner | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | true：向内查询最近的，且在栈内的NavDestinationInfo的详细信息。  false：向外查询最近的，且在栈内的NavDestinationInfo的详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [NavDestinationInfo](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-observer/js-apis-arkui-observer#navdestinationinfo) | 返回NavDestinationInfo实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [NavigationInfo](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-observer/js-apis-arkui-observer#navigationinfo12) | 返回NavigationInfo实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [RouterPageInfo](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-observer/js-apis-arkui-observer#routerpageinfo) | 返回RouterPageInfo实例对象。 |
...
自定义弹窗控制器，可以控制当前自定义弹窗，具体控制能力包括关闭弹窗等，详见[promptAction.DialogController](/ref/arkui-api/arkui-arkts/ui/js-apis-promptaction/js-apis-promptaction#dialogcontroller18)。
...
| 类型 | 说明 |
| --- | --- |
| [promptAction.DialogController](/ref/arkui-api/arkui-arkts/ui/js-apis-promptaction/js-apis-promptaction#dialogcontroller18) | 表示对象类型为promptAction.DialogController实例对象。 |
