...
使用mutableBuilder封装全局@Builder，实现全局@Builder的动态切换。开发指南见[mutableBuilder：实现全局@Builder动态更新](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-extend-components/arkts-mutablebuilder)。

![](../../../../../images/870d2b42/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [MutableBuilder&lt;Args&gt;](#mutablebuilder-1) | MutableBuilder&lt;Args&gt;的实例，用于[全局@Builder](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-extend-components/arkts-builder#全局自定义构建函数)进行赋值和传递的类，实现全局@Builder的动态更新。 |
...
用于实现包装[全局@Builder](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-extend-components/arkts-builder#全局自定义构建函数)的动态切换的类，MutableBuilder继承自[WrappedBuilder](/ref/arkui-api/arkui-declarative-comp/custom-comp/arkts-extend-component-decorator/ts-universal-wrapbuilder/ts-universal-wrapbuilder#wrappedbuilder)，其模板参数Args extends Object[]应传入@Builder函数的参数类型列表。[mutableBuilder](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-extend-components/arkts-mutablebuilder)函数返回MutableBuilder对象。
