...
title: "Component3D"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-component3d
kit: 应用框架
...
![](../../../../images/b22248d1/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [Scene](/ref/arkgraphics-3d-api/arkgraphics-3d-arkts/graphics3d/js-apis-inner-scene/js-apis-inner-scene#scene-1) | 用于设置场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 3D环境资源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 自定义渲染管线的配置文件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 自定义渲染的shader文件资源。详细.shader文件格式请参考[.shader资源文件格式要求](/arkgraphics-3d/arkgraphics3d-resource/arkgraphics3d-shader-resource)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 自定义渲染用到的纹理资源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 是 | 3D渲染分辨率的宽度，当前仅支持设置Dimension.Percentage，取值范围是[0, 100%]。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 是 | 3D渲染分辨率的长度，当前仅支持设置Dimension.Percentage，取值范围是[0, 100%]。 |
