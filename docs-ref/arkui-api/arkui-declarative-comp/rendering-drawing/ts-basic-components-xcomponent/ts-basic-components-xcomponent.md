...
提供用于图形绘制和媒体数据写入的Surface，XComponent负责将其嵌入到视图中，支持应用自定义Surface位置和大小。具体指南请参考[自定义渲染 (XComponent)文档](/arkui/arkts-ui-development/arkts-add-component/napi-xcomponent-guidelines)。

![](../../../../images/4d4da121/note_3.0-zh-cn.png) 
...
| type | [XComponentType](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#xcomponenttype10) | 是 | 用于指定XComponent组件类型。 |
...
![](../../../../images/cb02040a/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [XComponentType](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#xcomponenttype10) | 否 | 否 | 用于指定XComponent组件类型。 |
| controller | [XComponentController](#xcomponentcontroller) | 否 | 否 | 给组件绑定一个控制器，通过控制器调用组件方法，仅类型为SURFACE或TEXTURE时有效。 |
| imageAIOptions | [ImageAIOptions](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-image-common/ts-image-common#imageaioptions12) | 否 | 是 | 给组件设置一个AI分析选项，通过此项可配置分析类型或绑定一个分析控制器。 |

## NativeXComponentParameters19+

定义XComponent的具体配置参数。通过这种构造参数创建的XComponent，可以将其对应的[FrameNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode)对象传递至Native侧，使用NDK接口进行Surface生命周期的相关设置和[监听组件事件](/arkui/arkts-use-ndk/arkts-add-event/ndk-listen-to-component-events)。
...
![](../../../../images/fa5edea4/note_3.0-zh-cn.png) 
...
对于TEXTURE和SURFACE类型的XComponent组件，当不设置[renderFit](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-renderfit/ts-universal-attributes-renderfit#renderfit)属性时，取默认值为RenderFit.RESIZE\_FILL。

对于SURFACE类型的XComponent组件，背景色设置为不透明的纯黑色，在API version 18之前，其[renderFit](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-renderfit/ts-universal-attributes-renderfit#renderfit18)通用属性仅支持设置为RenderFit.RESIZE\_FILL；在API version 18及之后，支持所有的RenderFit枚举值。

对于使用[ArkUI NDK接口](/arkui/arkts-use-ndk/ndk-access-the-arkts-page)创建的XComponent组件，不支持使用属性获取函数[getAttribute](/ref/arkui-api/arkui-c/arkui-struct/capi-arkui-nativemodule-arkui-nativenodeapi-1/capi-arkui-nativemodule-arkui-nativenodeapi-1#getattribute)获取其renderFit属性值。
...
![](../../../../images/9f7993ad/note_3.0-zh-cn.png) 
...
![](../../../../images/07b00daa/note_3.0-zh-cn.png) 

仅type为SURFACE时有效。

不支持[ArkUI NDK接口](/arkui/arkts-use-ndk/ndk-build-ui-overview)创建的XComponent组件。
...
![](../../../../images/322013f9/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | XComponent销毁后回调事件。 |
...
![](../../../../images/69d09249/note_3.0-zh-cn.png) 
...
![](../../../../images/4e30be4e/note_3.0-zh-cn.png) 
...
![](../../../../images/6c3833b6/note_3.0-zh-cn.png) 
...
![](../../../../images/7e04ced2/note_3.0-zh-cn.png) 
...
![](../../../../images/2d785d9c/note_3.0-zh-cn.png) 
...
当XComponent持有的Surface销毁后进行该回调，仅XComponent类型为SURFACE("surface")或TEXTURE时有效，具体可以参考指南[创建XComponent和管理Surface生命周期](/arkui/arkts-ui-development/arkts-add-component/napi-xcomponent-guidelines#创建xcomponent和管理surface生命周期)章节。
...
![](../../../../images/1b741786/note_3.0-zh-cn.png) 
...
![](../../../../images/ada666e6/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-image-common/ts-image-common#imageanalyzerconfig12) | 是 | 执行AI分析所需要的入参，用于配置AI分析功能。 |
...
![](../../../../images/c7086597/note_3.0-zh-cn.png) 
...
![](../../../../images/392fb1f4/note_3.0-zh-cn.png) 
...
返回可用于向XComponent上绘制内容的画布对象。具体绘制方法请参考[Canvas](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas)。
...
| 类型 | 说明 |
| --- | --- |
| [DrawingCanvas](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-drawingrenderingcontext/ts-drawingrenderingcontext#drawingcanvas12对象说明) | null | 可用于向XComponent区域绘制的画布对象或者空对象null。 |

![](../../../../images/12ba0580/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| canvas | [DrawingCanvas](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-drawingrenderingcontext/ts-drawingrenderingcontext#drawingcanvas12对象说明) | 是 | 之前调用lockCanvas方法返回的画布对象。 |

![](../../../../images/4f44830d/note_3.0-zh-cn.png) 
...
![](../../../../images/5ff4f410/note_3.0-zh-cn.png) 
...
![](../../../../images/82559918/note_3.0-zh-cn.png) 

surfaceWidth和surfaceHeight属性在未调用[setXComponentSurfaceRect](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-basic-components-xcomponent/ts-basic-components-xcomponent#setxcomponentsurfacerect12)也未设置[border](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-border/ts-universal-attributes-border#border)和[padding](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#padding)等属性时，其取值大小为XComponent组件的大小。

surfaceWidth和surfaceHeight属性的取值都不可超过8192px，否则会导致渲染异常。

沉浸式场景下，默认布局的SurfaceRect不包括安全区，需调用[setXComponentSurfaceRect](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-basic-components-xcomponent/ts-basic-components-xcomponent#setxcomponentsurfacerect12)接口主动设置Surface显示区域达到沉浸式效果。
...
![](../../../../images/4d39f4f9/note_3.0-zh-cn.png) 
...
![](../../../../images/162d4bd3/zh-cn_image_0000002583440063.gif)

### 示例2（在surface旋转过程中锁定）

通过setXComponentSurfaceRotation设置surface在屏幕旋转过程中锁定方向，不跟随屏幕进行旋转。

![](../../../../images/9b68421e/note_3.0-zh-cn.png) 
...
![](../../../../images/9f7538e9/zh-cn_image_0000002552960018.png)
...
![](../../../../images/79ec3815/zh-cn_image_0000002583480019.jpeg)
...
![](../../../../images/55e95685/note_3.0-zh-cn.png) 
...
![](../../../../images/99d17ee9/zh-cn_image_0000002552800370.jpeg)
