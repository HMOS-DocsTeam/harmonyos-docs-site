...
![](../../../../images/f56f5e99/note_3.0-zh-cn.png) 
...
![](../../../../images/73ba0435/note_3.0-zh-cn.png) 
...
![](../../../../images/e0c59635/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [VerticalAlign](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#verticalalign) | 是 | 子组件在垂直方向上的对齐格式。  默认值：VerticalAlign.Center |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FlexAlign](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#flexalign) | 是 | 子组件在水平方向上的对齐格式。  默认值：FlexAlign.Start |

![](../../../../images/07ed63ab/note_3.0-zh-cn.png) 

Row布局时若子组件不设置[flexShrink](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-flex-layout/ts-universal-attributes-flex-layout#flexshrink)则默认不会压缩子组件，即所有子组件主轴大小累加可超过容器主轴，此时FlexAlign.Center和FlexAlign.End会失效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isReversed | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 子组件在水平方向上的排列是否反转。  默认值：true，设置true表示子组件在水平方向上反转排列，设置false表示子组件在水平方向上正序排列。 |

![](../../../../images/5ac85ef5/note_3.0-zh-cn.png) 
...
![](../../../../images/d2a3547d/zh-cn_image_0000002583479595.png)
...
![](../../../../images/25c131fb/zh-cn_image_0000002552799946.png)
