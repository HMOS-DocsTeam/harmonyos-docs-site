...
用于画布绘制[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)、[OffscreenCanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-offscreencanvasrenderingcontext2d/ts-offscreencanvasrenderingcontext2d)、[CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern)和[Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d)的矩阵对象，可以对矩阵进行缩放、旋转和平移等变换。

Matrix2D的使用场景包括：

1. [CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)和[OffscreenCanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-offscreencanvasrenderingcontext2d/ts-offscreencanvasrenderingcontext2d)中调用[getTransform](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#gettransform)接口获取画布的图形变换矩阵Matrix2D对象，调用[setTransform](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#settransform-1)接口对后续绘制内容进行Matrix2D对象对应的图形变换。
2. [CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern)中调用[setTransform](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern#settransform)接口对[CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern)对象进行Matrix2D对象对应的图形变换。
3. [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d)中调用[addPath](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d#addpath)接口对[Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d)对象进行Matrix2D对象对应的图形变换。

![](../../../../images/deea7699/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 是 | 用来配置Matrix2D对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)。  异常值NaN和Infinity按默认值处理。  默认值：DEFAULT |
...
![](../../../../images/7e2a697e/note_3.0-zh-cn.png) 

可使用[px2vp](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#px2vp12)接口进行单位转换。
...
![](../../../../images/5dfb2326/zh-cn_image_0000002552959970.png)
...
![](../../../../images/30ab1ec4/zh-cn_image_0000002583479971.png)
...
![](../../../../images/03eae17c/zh-cn_image_0000002552800322.png)
...
![](../../../../images/fcedef8f/zh-cn_image_0000002583440017.png)
...
![](../../../../images/e891bdb3/zh-cn_image_0000002552959972.png)
...
![](../../../../images/70b6220a/zh-cn_image_0000002583479973.png)
...
![](../../../../images/2ecf8239/zh-cn_image_0000002552800324.png)
