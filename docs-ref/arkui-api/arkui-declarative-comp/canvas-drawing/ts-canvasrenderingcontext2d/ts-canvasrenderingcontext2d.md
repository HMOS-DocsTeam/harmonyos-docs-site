...
| --- | --- | --- | --- |
| settings | [RenderingContextSettings](#renderingcontextsettings) | 否 | 用来配置CanvasRenderingContext2D对象的参数，见[RenderingContextSettings](#renderingcontextsettings)。  异常值undefined和null按[RenderingContextSettings](#renderingcontextsettings)的默认值处理。 |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 否 | 用来配置CanvasRenderingContext2D对象的单位模式，配置后无法更改。  异常值undefined、NaN和Infinity按默认值处理。  默认值：DEFAULT |

****示例：****

以下示例展示了配置CanvasRenderingContext2D对象的单位模式，默认单位模式为LengthMetricsUnit.DEFAULT，对应默认单位vp，配置后无法动态更改。详细说明见[LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12)。
...
![](../../../../images/8f4e20fc/zh-cn_image_0000002552800280.png)

## 属性

![](../../../../images/8e8ebeec/note_3.0-zh-cn.png) 
...
![](../../../../images/21adea21/zh-cn_image_0000002583439975.png)
...
![](../../../../images/27e3b1e9/zh-cn_image_0000002552959930.png)
...
![](../../../../images/e0c27558/zh-cn_image_0000002583479931.png)
...
![](../../../../images/fe7d06fb/zh-cn_image_0000002552800282.png)
...
![](../../../../images/4c430aae/zh-cn_image_0000002583439977.png)
...
![](../../../../images/1827219b/zh-cn_image_0000002552959932.png)
...
从API version 20开始，支持通过该接口设置注册过的自定义字体（DevEco Studio的预览器不支持显示自定义字体）。自定义字体注册有以下两种方式。一种是通过ArkUI的异步接口this.uiContext.getFont().[registerFont](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-font/arkts-apis-uicontext-font#registerfont)注册，调用后立即绘制可能会导致自定义字体不生效。另一种是直接调用字体引擎的fontCollection.[loadFontSync](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text#loadfontsync)接口来注册自定义字体到字体引擎。在直接调用字体引擎接口注册自定义字体时，fontCollection的实例需要是text.FontCollection.getGlobalInstance()，因为组件默认会从该实例加载字体。如果使用其他实例，可能会导致自定义字体不生效。
...
![](../../../../images/e0924237/zh-cn_image_0000002583479933.jpeg)
...
![](../../../../images/8d2addc9/zh-cn_image_0000002552800284.png)
...
![](../../../../images/f178aa5d/zh-cn_image_0000002583439979.jpg)
...
![](../../../../images/974b8691/zh-cn_image_0000002552959934.png)
...
![](../../../../images/8fabe1b2/zh-cn_image_0000002583479935.gif)
...
![](../../../../images/a3da4d1a/zh-cn_image_0000002552800286.png)
...
![](../../../../images/dd0ead7c/zh-cn_image_0000002583439981.png)
...
![](../../../../images/2d36bb8d/zh-cn_image_0000002552959936.png)
...
![](../../../../images/6dcc04c7/zh-cn_image_0000002583479937.png)
...
![](../../../../images/5272e073/zh-cn_image_0000002552800288.png)
...
![](../../../../images/12e4c0c0/note_3.0-zh-cn.png) 
...
![](../../../../images/5768cb46/zh-cn_image_0000002583439983.png)
...
![](../../../../images/f9ef8245/zh-cn_image_0000002552959938.png)
...
![](../../../../images/72366a63/zh-cn_image_0000002583479939.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [FrameNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode) | 是 | 否 | 默认值：null |
...
![](../../../../images/efe2afc3/zh-cn_image_0000002552800290.png)
...
![](../../../../images/b8e9615f/note_3.0-zh-cn.png) 
...
![](../../../../images/ff19a8e3/zh-cn_image_0000002583439985.jpeg)
...
![](../../../../images/974188a6/zh-cn_image_0000002552959940.jpeg)
...
![](../../../../images/358aee89/note_3.0-zh-cn.png) 
...
![](../../../../images/108cc310/zh-cn_image_0000002583479941.jpeg)
...
![](../../../../images/46fd43c1/zh-cn_image_0000002552800292.jpeg)
...
![](../../../../images/38f98913/zh-cn_image_0000002583439987.jpg)
...
![](../../../../images/5adaad9a/zh-cn_image_0000002552959942.png)
...
![](../../../../images/22b9f159/zh-cn_image_0000002583479943.png)
...
![](../../../../images/dbd791b6/zh-cn_image_0000002552800294.png)
...
![](../../../../images/160bd9d6/zh-cn_image_0000002583439989.jpg)
...
![](../../../../images/dd45c577/zh-cn_image_0000002552959944.jpg)
...
![](../../../../images/f6837b46/zh-cn_image_0000002583479945.png)
...
![](../../../../images/4b84858d/zh-cn_image_0000002552800296.png)
...
![](../../../../images/ca24ad3f/zh-cn_image_0000002583439991.png)
...
![](../../../../images/fbebdf35/note_3.0-zh-cn.png) 
...
![](../../../../images/89d9b647/zh-cn_image_0000002552959946.png)
...
![](../../../../images/ef73b250/zh-cn_image_0000002583479947.png)
...
![](../../../../images/cff43473/zh-cn_image_0000002552800298.png)
...
![](../../../../images/0740f234/note_3.0-zh-cn.png) 
...
![](../../../../images/81549c1b/zh-cn_image_0000002583439993.png)
...
![](../../../../images/1693e527/zh-cn_image_0000002552959948.png)
...
![](../../../../images/cb1f2010/zh-cn_image_0000002583479949.png)
...
![](../../../../images/a81a15c4/zh-cn_image_0000002552800300.jpeg)
...
![](../../../../images/12da5987/zh-cn_image_0000002583439995.png)
...
![](../../../../images/e14fd809/zh-cn_image_0000002552959950.jpeg)
...
![](../../../../images/13d5f49a/zh-cn_image_0000002583479951.jpeg)
...
![](../../../../images/c18597e2/zh-cn_image_0000002552800302.jpeg)
...
![](../../../../images/71dc06fc/zh-cn_image_0000002583439997.png)
...
![](../../../../images/3ebb032c/zh-cn_image_0000002552959952.jpg)
...
![](../../../../images/1c48058c/zh-cn_image_0000002583479953.png)
...
![](../../../../images/471160ff/zh-cn_image_0000002552800304.jpg)
...
![](../../../../images/71d23d13/zh-cn_image_0000002583439999.png)
...
![](../../../../images/74e3c364/zh-cn_image_0000002552959954.png)
...
![](../../../../images/8728dec8/zh-cn_image_0000002583479955.png)
...
![](../../../../images/c0abbe0a/zh-cn_image_0000002552800306.png)
...
![](../../../../images/f61b7097/zh-cn_image_0000002583440001.png)
...
![](../../../../images/47c610a8/note_3.0-zh-cn.png) 
...
![](../../../../images/7ab50411/zh-cn_image_0000002552959956.jpg)
...
![](../../../../images/fe193295/note_3.0-zh-cn.png) 
...
![](../../../../images/41394e9d/zh-cn_image_0000002583479957.png)
...
![](../../../../images/66082fd8/zh-cn_image_0000002552800308.jpeg)
...
![](../../../../images/e01afad4/zh-cn_image_0000002583440003.png)
...
![](../../../../images/ff537b2b/zh-cn_image_0000002552959958.png)
...
![](../../../../images/0090eaa1/note_3.0-zh-cn.png) 
...
![](../../../../images/cae27798/zh-cn_image_0000002583479959.png)
...
![](../../../../images/f8cf9696/note_3.0-zh-cn.png) 
...
![](../../../../images/691db0cb/zh-cn_image_0000002552800310.png)
...
![](../../../../images/4711677b/note_3.0-zh-cn.png) 
...
![](../../../../images/f6bfa8f2/zh-cn_image_0000002583440005.png)

### createImageData

createImageData(sw: number, sh: number): ImageData

创建新的、空白的、指定大小的ImageData 对象，请参考[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同[putImageData](#putimagedata)。
...
根据一个现有的ImageData对象重新创建一个宽、高相同的ImageData对象（不会复制图像数据），请参考[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同[putImageData](#putimagedata)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata) | 是 | 现有的ImageData对象。  异常值undefined和null按width和height为0的ImageData处理。 |
...
![](../../../../images/f02abcfa/note_3.0-zh-cn.png) 
...
![](../../../../images/04c9ebba/zh-cn_image_0000002552959960.png)
...
![](../../../../images/f6dada0c/note_3.0-zh-cn.png) 
...
![](../../../../images/4fc7ea0c/zh-cn_image_0000002583479961.png)
...
![](../../../../images/335d8257/zh-cn_image_0000002552800312.png)
...
![](../../../../images/02c037e3/zh-cn_image_0000002583440007.png)
...
![](../../../../images/a533ee07/zh-cn_image_0000002552959962.png)
...
![](../../../../images/171304bc/zh-cn_image_0000002583479963.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bitmap | [ImageBitmap](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagebitmap/ts-components-canvas-imagebitmap) | 是 | 待显示的ImageBitmap对象。 |
...
![](../../../../images/4c814dce/zh-cn_image_0000002552800314.jpg)
...
![](../../../../images/0313d144/zh-cn_image_0000002583440009.png)
...
![](../../../../images/ef2051ba/note_3.0-zh-cn.png) 
...
![](../../../../images/a3ba19d3/zh-cn_image_0000002552959964.png)
...
![](../../../../images/ebb5c8f7/zh-cn_image_0000002552959964.png)
...
| 类型 | 说明 |
| --- | --- |
| [CanvasGradient](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvasgradient/ts-components-canvas-canvasgradient) | 新的CanvasGradient对象，用于在canvas上创建渐变效果。 |
...
![](../../../../images/a68c615a/zh-cn_image_0000002583439973.png)
...
![](../../../../images/d19ad025/zh-cn_image_0000002583479965.png)
...
![](../../../../images/5ee81b3a/zh-cn_image_0000002552800316.png)
...
![](../../../../images/f1355188/note_3.0-zh-cn.png) 
...
避免在'onAttach'中执行绘制方法，应保证Canvas组件已经'[onReady](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvas/ts-components-canvas-canvas#事件)'再进行绘制。
...
![](../../../../images/3549a1ec/note_3.0-zh-cn.png) 
...
![](../../../../images/e03f7215/zh-cn_image_0000002583440011.gif)

### startImageAnalyzer12+

startImageAnalyzer(config: ImageAnalyzerConfig): Promise&lt;void&gt;

配置并启动AI分析功能，使用Promise异步回调。使用前需先设置[enableAnalyzer](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvas/ts-components-canvas-canvas#enableanalyzer12)为true，启用图像AI分析能力。

该方法调用时，将截取调用时刻的画面帧进行分析，使用时需注意启动分析的时机，避免出现画面和分析内容不一致的情况。

未执行完重复调用该方法会触发错误回调。示例代码同stopImageAnalyzer。

![](../../../../images/a3527393/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-image-common/ts-image-common#imageanalyzerconfig12) | 是 | 执行AI分析所需要的入参，用于配置AI分析功能。  异常值undefined或null按无效值处理。 |
...
以下错误码的详细介绍请参见[图像AI分析错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-image-analyzer/errorcode-image-analyzer)。
...
![](../../../../images/e957e2c6/note_3.0-zh-cn.png) 
...
![](../../../../images/5dc1608a/zh-cn_image_0000002552959966.png)
...
![](../../../../images/3bdd999c/note_3.0-zh-cn.png) 

- 从该接口获取的CanvasRenderingContext2D对象不允许作为参数创建[Canvas](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvas/ts-components-canvas-canvas)组件，否则会导致应用崩溃。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| drawingContext | [DrawingRenderingContext](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-drawingrenderingcontext/ts-drawingrenderingcontext) | 是 | 一个DrawingRenderingContext类型的对象。 |
...
![](../../../../images/cf58c8be/zh-cn_image_0000002583479967.png)
...
![](../../../../images/607af1eb/zh-cn_image_0000002552800318.png)
...
![](../../../../images/b06931af/note_3.0-zh-cn.png) 
