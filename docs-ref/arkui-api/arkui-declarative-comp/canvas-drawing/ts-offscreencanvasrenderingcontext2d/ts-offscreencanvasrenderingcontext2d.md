...
![](../../../../images/76b06529/note_3.0-zh-cn.png) 

从 API version 8 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

OffscreenCanvasRenderingContext2D无法在ServiceExtensionAbility中使用，ServiceExtensionAbility中建议使用[Drawing模块](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing/arkts-apis-graphics-drawing)进行离屏绘制。

[beginPath](#beginpath)、[moveTo](#moveto)、[lineTo](#lineto)、[closePath](#closepath)、[bezierCurveTo](#beziercurveto)、[quadraticCurveTo](#quadraticcurveto)、[arc](#arc)、[arcTo](#arcto)、[ellipse](#ellipse)、[rect](#rect)和[roundRect](#roundrect20)接口只能对OffscreenCanvasRenderingContext2D中的路径生效，无法对[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)和[Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d)对象中设置的路径生效。
...
| settings | [RenderingContextSettings](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。  异常值undefined按[RenderingContextSettings](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#renderingcontextsettings)的默认值处理。  默认值：null |
...
| height | number | 是 | 离屏画布的高度，默认单位：vp  异常值NaN和Infinity按无效值处理。 |
| settings | [RenderingContextSettings](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。  异常值undefined按[RenderingContextSettings](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#renderingcontextsettings)的默认值处理。  默认值：null |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)。  异常值undefined、NaN和Infinity按默认值处理。  默认值：DEFAULT |

## 属性

![](../../../../images/505809e0/note_3.0-zh-cn.png) 
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string | number10+ | [CanvasGradient](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvasgradient/ts-components-canvas-canvasgradient) | [CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern) | 否 | 否 | - 类型为string时，表示设置填充区域的颜色，颜色格式参考[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)中string类型说明。  - 类型为number时，表示设置填充区域的颜色，不支持设置全透明色，颜色格式参考[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)中number类型说明。  - 类型为CanvasGradient时，表示渐变对象，使用[createLinearGradient](#createlineargradient)方法创建。  - 类型为CanvasPattern时，使用[createPattern](#createpattern)方法创建。  默认值：'#000000'（黑色）  异常值设置无效。 |
...
![](../../../../images/2054d899/zh-cn_image_0000002552959976.png)
...
![](../../../../images/95a32fd8/zh-cn_image_0000002583479977.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string | number10+ | [CanvasGradient](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvasgradient/ts-components-canvas-canvasgradient) | [CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern) | 否 | 否 | - 类型为string时，表示设置线条使用的颜色，颜色格式参考[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)中string类型说明。  - 类型为number时，表示设置线条使用的颜色，不支持设置全透明色，颜色格式参考[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)中number类型说明。  - 类型为CanvasGradient时，表示渐变对象，使用[createLinearGradient](#createlineargradient)方法创建。  - 类型为CanvasPattern时，使用[createPattern](#createpattern)方法创建。  默认值：'#000000'（黑色）  异常值设置无效。 |
...
![](../../../../images/f819dc91/zh-cn_image_0000002552800328.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasLineCap](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvaslinecap类型说明) | 否 | 否 | 默认值：'butt' |
...
![](../../../../images/560c17d1/zh-cn_image_0000002583440023.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasLineJoin](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvaslinejoin类型说明) | 否 | 否 | 默认值：'miter' |
...
![](../../../../images/ecc7346d/zh-cn_image_0000002552959978.png)
...
![](../../../../images/de69c569/zh-cn_image_0000002583479979.png)
...
从API version 20开始，支持通过该接口设置注册过的自定义字体（只能在主线程使用，不支持在worker线程中使用；DevEco Studio的预览器不支持显示自定义字体）。自定义字体注册有以下两种方式。一种是通过ArkUI的异步接口this.uiContext.getFont().[registerFont](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-font/arkts-apis-uicontext-font#registerfont)注册，调用后立即绘制可能会导致自定义字体不生效。另一种是直接调用字体引擎的fontCollection.[loadFontSync](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text#loadfontsync)接口来注册自定义字体到字体引擎。在直接调用字体引擎接口注册自定义字体时，fontCollection的实例需要是text.FontCollection.getGlobalInstance()，因为组件默认会从该实例加载字体。如果使用其他实例，可能会导致自定义字体不生效。
...
![](../../../../images/fcee9967/zh-cn_image_0000002552800330.jpeg)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasTextAlign](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvastextalign类型说明) | 否 | 否 | ltr布局模式下'start'和'left'一致，rtl布局模式下'start'和'right'一致。  默认值：'left' |
...
![](../../../../images/a525a303/zh-cn_image_0000002583440025.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasTextBaseline](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvastextbaseline类型说明) | 否 | 否 | 默认值：'alphabetic' |
...
![](../../../../images/9bd7f571/zh-cn_image_0000002583439979.jpg)
...
![](../../../../images/6d8da05a/zh-cn_image_0000002552959980.png)
...
![](../../../../images/3ef7c628/zh-cn_image_0000002583479981.png)
...
![](../../../../images/2203669a/zh-cn_image_0000002552800332.png)
...
![](../../../../images/5804efa5/zh-cn_image_0000002583440027.jpg)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string | 否 | 否 | 颜色格式参考[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)中string类型说明。  默认值：透明黑色 |
...
![](../../../../images/768485d6/zh-cn_image_0000002552959982.jpg)
...
![](../../../../images/4f809e88/zh-cn_image_0000002583479983.png)
...
![](../../../../images/d705508a/zh-cn_image_0000002552800334.png)
...
![](../../../../images/55693297/note_3.0-zh-cn.png) 

此示例的资源不在src > main > resource目录下，从DevEco Studio 6.0.0 Beta2版本开始，新建工程或模块时，默认创建的模块不会对非resources目录下的资源进行打包，需使能相关开关：模块的build-profile.json5中buildOption > resOptions > copyCodeResource > enable设置为true，详见resOptions中[copyCodeResource](/ide-hvigor-configuration-file/ide-hvigor-build-profile#table1476161719356)相关介绍。
...
![](../../../../images/a718fc8b/zh-cn_image_0000002583440029.png)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [ImageSmoothingQuality](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#imagesmoothingquality类型说明) | 否 | 否 | 默认值："low" |

![](../../../../images/e4925c71/note_3.0-zh-cn.png) 
...
![](../../../../images/e3918440/zh-cn_image_0000002583439985.jpeg)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasDirection](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvasdirection类型说明) | 否 | 否 | 默认值："inherit" |
...
![](../../../../images/bb7750f8/zh-cn_image_0000002552959940.jpeg)
...
![](../../../../images/74ef4cb1/note_3.0-zh-cn.png) 
...
![](../../../../images/c038c90e/zh-cn_image_0000002583479941.jpeg)
...
![](../../../../images/84d0b4b2/zh-cn_image_0000002552800292.jpeg)
...
![](../../../../images/b53c97b0/zh-cn_image_0000002583439987.jpg)
...
![](../../../../images/61864f01/zh-cn_image_0000002552959942.png)
...
![](../../../../images/a4de1346/zh-cn_image_0000002583479943.png)
...
![](../../../../images/cb75a61b/zh-cn_image_0000002552800294.png)
...
![](../../../../images/6afdc2ea/zh-cn_image_0000002552959984.png)
...
| 类型 | 说明 |
| --- | --- |
| [TextMetrics](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#textmetrics) | 文本的尺寸信息。  传入异常值undefined或null时按"undefined"或"null"计算。 |
...
![](../../../../images/f7f99be2/zh-cn_image_0000002583479985.jpg)
...
![](../../../../images/05a4d235/zh-cn_image_0000002552800336.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d) | 是 | 需要绘制的Path2D。  异常值undefined或null按无效值处理，不进行绘制。 |
...
![](../../../../images/3238a794/zh-cn_image_0000002583440031.png)
...
![](../../../../images/dec4ed42/zh-cn_image_0000002552959986.jpg)
...
![](../../../../images/102eb638/note_3.0-zh-cn.png) 
...
![](../../../../images/cce647fb/zh-cn_image_0000002583479987.png)
...
![](../../../../images/ff9bc7a4/zh-cn_image_0000002552800338.png)
...
![](../../../../images/81d80c2f/zh-cn_image_0000002583440033.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagebitmap/ts-components-canvas-imagebitmap) | 是 | 图源对象，具体参考ImageBitmap对象。  异常值undefined或null按无效值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [CanvasPattern](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvaspattern/ts-components-canvas-canvaspattern) | null | 通过指定图像和重复方式创建图片填充的模板对象。 |

****示例：****

![](../../../../images/e27b2b9f/note_3.0-zh-cn.png) 
...
![](../../../../images/748c9b58/zh-cn_image_0000002552959988.jpg)
...
![](../../../../images/a78dc9d5/zh-cn_image_0000002583479989.png)
...
![](../../../../images/8aa9a360/zh-cn_image_0000002552800340.png)
...
![](../../../../images/3db8e6a1/zh-cn_image_0000002583440035.jpeg)
...
![](../../../../images/d0f08327/zh-cn_image_0000002552959990.png)
...
![](../../../../images/8672f629/zh-cn_image_0000002552959950.jpeg)
...
![](../../../../images/af764335/zh-cn_image_0000002583479991.jpeg)
...
以下错误码的详细介绍请参见[Canvas组件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-canvas/errorcode-canvas)。
...
![](../../../../images/69bc135f/zh-cn_image_0000002552800302.jpeg)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvasfillrule类型说明) | 否 | 指定要填充对象的规则。  可选参数为："nonzero"，"evenodd"。  异常值undefined或null按默认值处理。  默认值："nonzero" |
...
![](../../../../images/c52c26c9/zh-cn_image_0000002552800342.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d) | 是 | Path2D填充路径。  异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvasfillrule类型说明) | 否 | 指定要填充对象的规则。  可选参数为："nonzero"，"evenodd"。  异常值undefined或null按默认值处理。  默认值："nonzero" |
...
![](../../../../images/501c98dd/zh-cn_image_0000002583440037.jpg)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvasfillrule类型说明) | 否 | 指定要剪切对象的规则。  可选参数为："nonzero"，"evenodd"。  异常值undefined或null按默认值处理。  默认值："nonzero" |
...
![](../../../../images/f4fbf8d4/zh-cn_image_0000002583479953.png)
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| path | [Path2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-path2d/ts-components-canvas-path2d) | 是 | Path2D剪切路径。  异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#canvasfillrule类型说明) | 否 | 指定要剪切对象的规则。  可选参数为："nonzero"，"evenodd"。  异常值undefined或null按默认值处理。  默认值："nonzero" |
...
![](../../../../images/564bc934/zh-cn_image_0000002552800304.jpg)
...
![](../../../../images/c6c9cb62/zh-cn_image_0000002583439999.png)
...
![](../../../../images/6af89a67/zh-cn_image_0000002552959954.png)
...
![](../../../../images/64dce7ba/zh-cn_image_0000002583479955.png)
...
![](../../../../images/75bf78af/zh-cn_image_0000002552959992.png)
...
![](../../../../images/4ffdef83/zh-cn_image_0000002583440001.png)
...
![](../../../../images/ceb7dbfa/note_3.0-zh-cn.png) 
...
![](../../../../images/839e45f4/zh-cn_image_0000002552959956.jpg)
...
![](../../../../images/f7167741/note_3.0-zh-cn.png) 
...
![](../../../../images/87b0e0d1/zh-cn_image_0000002583479993.png)
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| transform | [Matrix2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-matrix2d/ts-components-canvas-matrix2d) | 否 | 变换矩阵。  异常值undefined或null按无效值处理。  默认值：null |
...
![](../../../../images/fa745462/zh-cn_image_0000002552800344.jpeg)
...
| 类型 | 说明 |
| --- | --- |
| [Matrix2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-matrix2d/ts-components-canvas-matrix2d) | 当前被应用到上下文的转换矩阵。 |
...
![](../../../../images/cb4e315d/zh-cn_image_0000002583440003.png)
...
![](../../../../images/e0834d49/zh-cn_image_0000002583440039.png)
...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagebitmap/ts-components-canvas-imagebitmap) | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 图片资源，请参考ImageBitmap或PixelMap。  异常值undefined或null按无效值处理，不进行绘制。 |
...
![](../../../../images/b27333c0/note_3.0-zh-cn.png) 
...
![](../../../../images/a9fc357f/zh-cn_image_0000002552959994.png)
...
![](../../../../images/bee20f97/note_3.0-zh-cn.png) 
...
![](../../../../images/b9ca386a/zh-cn_image_0000002583479995.png)
...
![](../../../../images/5de8c839/note_3.0-zh-cn.png) 
...
![](../../../../images/21d963a2/zh-cn_image_0000002552800346.png)

### createImageData

createImageData(sw: number, sh: number): ImageData

根据当前ImageData对象重新创建一个宽、高相同的ImageData对象，请参考[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同putImageData。
...
| 类型 | 说明 |
| --- | --- |
| [ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata) | 新的ImageData对象。 |

### createImageData

createImageData(imageData: ImageData): ImageData

根据已创建的ImageData对象创建新的ImageData对象（不会复制图像数据），请参考[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同putImageData。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata) | 是 | 被复制的ImageData对象。  异常值undefined和null按width和height为0的ImageData处理。 |
...
以当前canvas指定区域内的像素创建[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)对象，该接口存在内存拷贝行为，高耗时，应避免频繁使用。
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 新的PixelMap对象。 |

****示例：****

![](../../../../images/b7ed26d5/note_3.0-zh-cn.png) 
...
![](../../../../images/6f6a2306/zh-cn_image_0000002583440041.png)

### setPixelMap

setPixelMap(value?: PixelMap): void

将当前传入[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)对象绘制在画布上。setPixelMap示例同getPixelMap。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 包含像素值的PixelMap对象。  异常值undefined和null按无效值处理，不进行绘制。  默认值：null |

### getImageData

getImageData(sx: number, sy: number, sw: number, sh: number): ImageData

以当前canvas指定区域内的像素创建[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)对象，该接口存在内存拷贝行为，高耗时，应避免频繁使用。
...
![](../../../../images/03803957/note_3.0-zh-cn.png) 
...
![](../../../../images/be541ca9/zh-cn_image_0000002583479961.png)

### putImageData

putImageData(imageData: ImageData, dx: number | string, dy: number | string): void

使用[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)数据填充新的矩形区域。
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| imageData | [ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata) | 是 | 包含像素值的ImageData对象。  异常值undefined或null按无效值处理，不进行绘制。 |
...
![](../../../../images/58a0e986/zh-cn_image_0000002552959996.png)

### putImageData

putImageData(imageData: ImageData, dx: number | string, dy: number | string, dirtyX: number | string, dirtyY: number | string, dirtyWidth?: number | string, dirtyHeight: number | string): void

使用[ImageData](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagedata/ts-components-canvas-imagedata)数据裁剪后填充至新的矩形区域。
...
![](../../../../images/46fd23c2/zh-cn_image_0000002583479997.png)
...
![](../../../../images/4355ed1d/zh-cn_image_0000002552800348.png)
...
![](../../../../images/fe8ba4b9/zh-cn_image_0000002583479963.png)
...
![](../../../../images/c0d6ea94/zh-cn_image_0000002583440043.png)
...
| 类型 | 说明 |
| --- | --- |
| [ImageBitmap](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-imagebitmap/ts-components-canvas-imagebitmap) | 存储离屏画布上渲染的像素数据。 |
...
![](../../../../images/5a9cc92c/zh-cn_image_0000002552959998.png)
...
![](../../../../images/b6bf77a5/note_3.0-zh-cn.png) 
...
![](../../../../images/ec557d50/zh-cn_image_0000002552959964.png)
...
![](../../../../images/5072fa13/zh-cn_image_0000002552959964.png)
...
| 类型 | 说明 |
| --- | --- |
| [CanvasGradient](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvasgradient/ts-components-canvas-canvasgradient) | 新的CanvasGradient对象，用于在offscreenCanvas上创建渐变效果。 |
...
![](../../../../images/121951c2/zh-cn_image_0000002583439973.png)
...
![](../../../../images/402740f3/zh-cn_image_0000002583479965.png)
...
![](../../../../images/cc92be82/zh-cn_image_0000002552800316.png)
