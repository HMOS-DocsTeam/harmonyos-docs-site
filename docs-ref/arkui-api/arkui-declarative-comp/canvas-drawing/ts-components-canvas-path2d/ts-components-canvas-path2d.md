...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 是 | 用来配置Path2D对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)。  异常值NaN和Infinity按默认值处理。  默认值：DEFAULT |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| d | string | 是 | 符合SVG路径描述规范的路径字符串，格式参考[SVG路径描述规范](/ref/arkui-api/arkui-declarative-comp/graphic-drawing/ts-drawing-components-path/ts-drawing-components-path#svg路径描述规范)，异常值按无效值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| description | string | 是 | 符合SVG路径描述规范的路径字符串，格式参考[SVG路径描述规范](/ref/arkui-api/arkui-declarative-comp/graphic-drawing/ts-drawing-components-path/ts-drawing-components-path#svg路径描述规范)，异常值按无效值处理。 |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 是 | 用来配置Path2D对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)。  异常值NaN和Infinity按默认值处理。  默认值：DEFAULT |
...
| transform | [Matrix2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-matrix2d/ts-components-canvas-matrix2d) | 否 | 新增路径的变换矩阵对象。  异常值undefined和null按无效值处理。  默认值：null |
...
![](../../../../images/ab0efd26/zh-cn_image_0000002583479999.png)
...
![](../../../../images/6e3faafe/zh-cn_image_0000002552800350.png)
...
![](../../../../images/4ebb57aa/note_3.0-zh-cn.png) 
...
![](../../../../images/c9271b10/zh-cn_image_0000002583440045.png)
...
![](../../../../images/9afac766/zh-cn_image_0000002552960000.png)
...
![](../../../../images/1d53c80b/zh-cn_image_0000002583480001.png)
...
![](../../../../images/830696b5/zh-cn_image_0000002552800352.png)
...
![](../../../../images/73fc5950/zh-cn_image_0000002583440047.png)
...
![](../../../../images/0732afce/zh-cn_image_0000002552960002.png)
...
![](../../../../images/5c5f567a/zh-cn_image_0000002583480003.png)
...
![](../../../../images/538d9b19/zh-cn_image_0000002552800354.png)
...
![](../../../../images/e1df744e/zh-cn_image_0000002552800302.jpeg)
