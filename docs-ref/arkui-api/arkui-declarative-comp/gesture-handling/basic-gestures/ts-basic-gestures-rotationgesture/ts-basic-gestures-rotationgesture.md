...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-rotationgesture
kit: 应用框架
...
![](../../../../../images/608e28e9/note_3.0-zh-cn.png) 
...
继承自[GestureInterface&lt;T&gt;](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gestureinterfacet11)，设置旋转手势事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RotationGestureHandlerOptions](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesturehandler/ts-gesturehandler#rotationgesturehandleroptions) | 否 | 旋转手势处理器配置参数。 |

## 事件

![](../../../../../images/cbbb97aa/note_3.0-zh-cn.png) 
...
![](../../../../../images/0c02a06a/zh-cn_image_0000002552959584.png)
