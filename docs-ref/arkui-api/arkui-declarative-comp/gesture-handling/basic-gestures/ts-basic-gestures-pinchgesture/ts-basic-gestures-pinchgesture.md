...
![](../../../../../images/8aa67882/note_3.0-zh-cn.png) 
...
继承自[GestureInterface&lt;T&gt;](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gestureinterfacet11)，设置捏合手势事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PinchGestureHandlerOptions](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesturehandler/ts-gesturehandler#pinchgesturehandleroptions) | 否 | 捏合手势处理器配置参数。 |

## 事件

![](../../../../../images/a5e2edd7/note_3.0-zh-cn.png) 

在[GestureEvent](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gestureevent对象说明)的fingerList元素中，手指索引编号与位置相对应，即fingerList[index]的id为index。对于先按下但未参与当前手势触发的手指，fingerList中对应的位置为空。建议开发者优先使用fingerInfos。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | Callback&lt;[GestureEvent](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gestureevent对象说明)&gt; | 是 | 手势事件回调函数。 |
...
![](../../../../../images/66f0bbfa/zh-cn_image_0000002552799934.png)
...
![](../../../../../images/6bca940a/zh-cn_image_0000002583439629.gif)
