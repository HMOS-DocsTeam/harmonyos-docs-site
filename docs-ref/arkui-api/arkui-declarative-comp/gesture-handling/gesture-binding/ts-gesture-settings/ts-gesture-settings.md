...
![](../../../../../images/e74c38d0/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 可以通过gesture、priorityGesture和parallelGesture给组件绑定手势识别，手势识别成功后可以通过事件回调通知组件。可以通过[触摸热区](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/interaction-property/touch-interactions/ts-universal-attributes-touch-target/ts-universal-attributes-touch-target)指定可识别手势的区域。gesture、priorityGesture和parallelGesture当前不支持使用三目运算符（条件? 表达式1 : 表达式2）切换手势绑定。
...
![](../../../../../images/0ac369f1/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureType](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gesturetype) | 是 | 绑定的手势类型。 |
...
![](../../../../../images/e4ead3b6/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureType](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gesturetype) | 是 | 绑定的手势对象。 |
| mask | [GestureMask](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gesturemask枚举说明) | 否 | 事件响应设置。  默认值：GestureMask.Normal |
...
![](../../../../../images/71a5d262/note_3.0-zh-cn.png) 
...
![](../../../../../images/d5889f60/zh-cn_image_0000002583439625.gif)
...
![](../../../../../images/747015e8/zh-cn_image_0000002552959580.gif)
