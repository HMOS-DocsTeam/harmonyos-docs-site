...
![](../../../../../images/b440a0f1/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (gestureInfo: [GestureInfo](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gestureinfo11对象说明), event: [BaseGestureEvent](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#basegestureevent11对象说明)) => [GestureJudgeResult](/ref/arkui-api/arkui-declarative-comp/gesture-handling/ts-gesture-common/ts-gesture-common#gesturejudgeresult11) | 是 | 自定义手势判定回调。当手势即将成功时，触发用户定义的回调获取结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| target | [EventTarget](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click#eventtarget8) | 否 | 否 | 触发手势事件的元素对象。  ****卡片能力：**** 从API version 9开始，该接口支持在ArkTS卡片中使用。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| source | [SourceType](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesture-settings/ts-gesture-settings#sourcetype枚举说明8) | 否 | 否 | 事件输入设备的类型。  ****卡片能力：**** 从API version 9开始，该接口支持在ArkTS卡片中使用。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| sourceTool9+ | [SourceTool](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesture-settings/ts-gesture-settings#sourcetool枚举说明9) | 否 | 否 | 事件输入源的类型。  ****卡片能力：**** 从API version 9开始，该接口支持在ArkTS卡片中使用。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
![](../../../../../images/620f1ad5/note_3.0-zh-cn.png) 
...
![](../../../../../images/3d3c5ba7/zh-cn_image_0000002552959586.gif)
...
![](../../../../../images/cc578317/zh-cn_image_0000002583479587.gif)
...
![](../../../../../images/8104556b/zh-cn_image_0000002552799938.gif)
