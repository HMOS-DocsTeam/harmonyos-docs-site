...
![](../../../../images/02cdadb3/note_3.0-zh-cn.png) 
...
| animationOptions | [AnimateParam](/ref/arkui-api/arkui-declarative-comp/animation/ts-explicit-animation/ts-explicit-animation#animateparam对象说明) | null | 否 | @Prop | 设置动画效果相关的参数，null表示关闭动效。 |
...
| horizontalSplitRatio | number | 否 | 是 | 主要区域与扩展区域之间的宽度比例。此字段在extra有效时生效。  默认值：[PresetSplitRatio](#presetsplitratio).LAYOUT\_3V2 |
...
| horizontalSplitRatio | number | 否 | 是 | 主要区域与扩展区域之间的宽度比例，当且仅当extra有效时此字段才生效。  默认值：[PresetSplitRatio](#presetsplitratio).LAYOUT\_3V2 |
...
![](../../../../images/75d96564/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| foldStatus | [display.FoldStatus](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#foldstatus10) | 否 | 否 | 设备的折叠状态。 |
| isHoverMode | boolean | 否 | 否 | app当前是否处于悬停态。设置为true时表示当前为悬停态，设置为false时表示当前为非悬停态。 |
| appRotation | number | 否 | 否 | 应用旋转角度。 |
| windowStatusType | [window.WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11) | 否 | 否 | 窗口模式。 |
