...
![](../../../../images/16a8bc7c/note_3.0-zh-cn.png) 
...
| direction12+ | [Direction](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#direction) | 否 | 是 | 布局方向。  默认值：Direction.Auto  值为undefined时，按默认值处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| label | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置Counter的说明文本。  默认值：' '  值为undefined时，按默认值处理。 |
...
![](../../../../images/388bd9a3/zh-cn_image_0000002583440185.gif)
...
![](../../../../images/ae3e370e/zh-cn_image_0000002552960140.gif)
...
![](../../../../images/499451ec/zh-cn_image_0000002583480141.gif)
...
![](../../../../images/b4aa98c4/zh-cn_image_0000002552800492.gif)
...
![](../../../../images/34de7f49/zh-cn_image_0000002583440187.png)
