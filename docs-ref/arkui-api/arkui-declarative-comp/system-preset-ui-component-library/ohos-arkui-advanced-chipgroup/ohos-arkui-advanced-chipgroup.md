...
![](../../../../images/43bd1535/note_3.0-zh-cn.png) 
...
![](../../../../images/ed67871f/note_3.0-zh-cn.png) 
...
| prefixSymbol | [ChipSymbolGlyphOptions](/ref/arkui-api/arkui-declarative-comp/system-preset-ui-component-library/ohos-arkui-advanced-chip/ohos-arkui-advanced-chip#chipsymbolglyphoptions12) | 否 | 是 | 前缀SymbolGlyph图标属性。  默认值：没有前缀SymbolGlyph图标。  值为undefined时，按默认值处理。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| suffixSymbol | [ChipSymbolGlyphOptions](/ref/arkui-api/arkui-declarative-comp/system-preset-ui-component-library/ohos-arkui-advanced-chip/ohos-arkui-advanced-chip#chipsymbolglyphoptions12) | 否 | 是 | 后缀SymbolGlyph图标属性。  默认值：不显示后缀SymbolGlyph图标。  值为undefined时，按默认值处理。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| suffixSymbolOptions14+ | [ChipSuffixSymbolGlyphOptions](/ref/arkui-api/arkui-declarative-comp/system-preset-ui-component-library/ohos-arkui-advanced-chip/ohos-arkui-advanced-chip#chipsuffixsymbolglyphoptions14) | 否 | 是 | 后缀Symbol图标属性。  默认值：后缀Symbol图标无功能。  值为undefined时，按默认值处理。  ****元服务API：**** 从API version 14开始，该接口支持在元服务中使用。 |
| closeOptions14+ | [CloseOptions](/ref/arkui-api/arkui-declarative-comp/system-preset-ui-component-library/ohos-arkui-advanced-chip/ohos-arkui-advanced-chip#closeoptions14) | 否 | 是 | 默认删除图标的无障碍朗读功能属性。  值为undefined时，按默认值处理。  ****元服务API：**** 从API version 14开始，该接口支持在元服务中使用。 |
...
![](../../../../images/1480f51e/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| size | [ChipSize](/ref/arkui-api/arkui-declarative-comp/system-preset-ui-component-library/ohos-arkui-advanced-chip/ohos-arkui-advanced-chip#chipsize) | [SizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#sizeoptions) | 否 | 是 | Chip尺寸，使用时需要从Chip组件引入ChipSize类型。  默认值：ChipSize.NORMAL或{ height: 0, width: 0 }  为undefined时，使用默认值。 |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Chip背景颜色。  默认值：$r('sys.color.ohos\_id\_color\_button\_normal')  为undefined时，backgroundColor走默认值。 |
| fontColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Chip文字颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary')  为undefined时，fontColor走默认值。 |
| selectedFontColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Chip激活时的文字颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary\_contrary')  为undefined时，selectedFontColor走默认值。 |
| selectedBackgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Chip激活时的背景颜色。  默认值：$r('sys.color.ohos\_id\_color\_emphasize')  为undefined时，selectedBackgroundColor走默认值。 |

![](../../../../images/f110ba97/note_3.0-zh-cn.png) 
...
| startSpace | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 左侧内边距（不支持百分比）。  默认值：16  单位：vp  为undefined时，startSpace取默认值。 |
| endSpace | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 右侧内边距（不支持百分比）。  默认值：16  单位：vp  如果为undefined，则使用默认值。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 否 | ChipGroup的上方内边距（不支持百分比）。  默认值：14  单位：vp  为undefined时，top取默认值。 |
| bottom | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 否 | ChipGroup的下方内边距（不支持百分比）。  默认值：14  单位：vp  为undefined时，bottom取默认值。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 否 | 是 | 后缀图标响应事件。  值为undefined时，无后缀图标响应事件。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| symbol | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 否 | 尾部图标的SymbolGlyphModifier配置对象，用于设置图标的显示样式、渲染模式等。 |
| action | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 否 | 否 | 尾部图标响应事件。 |
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| items | Array&lt;[IconItemOptions](#iconitemoptions) | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) |  [SymbolItemOptions](#symbolitemoptions14)> | 是 | @Require @Prop | 尾部区域显示的自定义项数组，支持IconItemOptions（Image图标）、SymbolGlyphModifier（Symbol图标）或SymbolItemOptions（Symbol图标配置）类型。 |

![](../../../../images/f6272cae/note_3.0-zh-cn.png) 

传参SymbolGlyphModifier时，不支持使用symbolEffect修改动效类型和[effectStrategy](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#effectstrategy)设置动效。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| src | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 图标图片或图片地址引用请参考[Image](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-basic-components-image/ts-basic-components-image#image-1)。 |
| size | [SizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#sizeoptions) | 否 | 是 | 图标大小，不支持百分比。  默认值：undefined |
...
![](../../../../images/f5ee6e97/zh-cn_image_0000002552800448.png)
...
![](../../../../images/edab63fa/zh-cn_image_0000002583440143.png)
...
![](../../../../images/59d67d93/zh-cn_image_0000002552960098.png)
