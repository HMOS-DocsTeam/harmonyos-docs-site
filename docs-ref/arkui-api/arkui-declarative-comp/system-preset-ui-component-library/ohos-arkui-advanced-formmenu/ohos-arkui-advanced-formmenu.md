...
title: "FormMenu"
sidebar_position: 12
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-formmenu
kit: 应用框架
...
![](../../../../images/ab012fb6/note_3.0-zh-cn.png) 

该组件从API version 12开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

该组件不支持在Wearable设备上使用。

卡片具体开发指导请参考[卡片开发指南](/form-kit/formkit-overview)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want#want) | 是 | 待发布功能组件的want信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| formBindingData | [formBindingData.FormBindingData](/ref/form-api/form-arkts/js-apis-app-form-formbindingdata/js-apis-app-form-formbindingdata#formbindingdata) | 否 | 是 | 卡片数据。 |
| callback | AsyncCallback&lt;string&gt; | 否 | 是 | 返回添加卡片是否成功的结果回调。返回为0表示卡片添加成功，非0表示卡片添加失败，失败时请参考[卡片错误码信息](/ref/form-api/form-arkts-errcode/errorcode-form/errorcode-form)进行排查。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| options | [MenuItemOptions](/ref/arkui-api/arkui-declarative-comp/menus/ts-basic-components-menuitem/ts-basic-components-menuitem#menuitemoptions对象说明) | 否 | 是 | 包含设置MenuItem的各项信息。 |

![](../../../../images/b651268a/note_3.0-zh-cn.png) 
...
![](../../../../images/26bc57e0/zh-cn_image_0000002583440163.jpeg)

****调用高级自定义控件桌面加桌结果****

左侧是formbindingdata为空加桌结果，右侧是formbindingdata为\{ data: 'share' \}的加桌结果。

![](../../../../images/6a670a3d/zh-cn_image_0000002552960118.jpeg)
