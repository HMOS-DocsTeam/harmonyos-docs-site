...
FolderStack继承于[Stack](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-stack/ts-container-stack)(层叠布局)控件，新增了[折叠屏悬停](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-folded-hover)能力，通过在FolderStack的配置项[FolderStackOptions](#folderstackoptions18对象说明)的upperItems数组上设置子组件id，使相应子组件自动避让折叠屏折痕区后移到上半屏。

![](../../../../images/ae9e48aa/note_3.0-zh-cn.png) 
...
当该组件的父组件为[if/else：条件渲染](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-ifelse)节点时，折叠屏悬停能力将会失效。
...
![](../../../../images/f8b5832d/note_3.0-zh-cn.png) 
...
![](../../../../images/1a31bb2f/note_3.0-zh-cn.png) 
...
设置子组件在容器内的对齐方式。该属性与[align](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-location/ts-universal-attributes-location#align)同时设置时，后设置的属性生效。

![](../../../../images/b5711390/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Alignment](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#alignment) | 是 | 子组件在容器内的对齐方式。  默认值：Alignment.Center  非法值：按默认值处理。 |
...
![](../../../../images/6257ce2e/note_3.0-zh-cn.png) 
...
![](../../../../images/682a0839/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 是否开启自动旋转。  默认值：true，设置true表示FolderStack在[半折叠状态](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#foldstatus11)进行布局时开启自动旋转，设置false表示关闭自动旋转。该属性不区分设备类型。  非法值：按默认值处理。 |
...
![](../../../../images/775241af/note_3.0-zh-cn.png) 
...
![](../../../../images/a113ac38/note_3.0-zh-cn.png) 
...
![](../../../../images/5eec2ae5/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| foldStatus11+ | [FoldStatus](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#foldstatus11) | 否 | 否 | 当前设备的折叠状态。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| foldStatus | [FoldStatus](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#foldstatus11) | 否 | 否 | 当前设备的折叠状态。 |
| isHoverMode | boolean | 否 | 否 | 当前是否为悬停态。设置为true时表示当前为悬停态，设置为false时表示当前为非悬停态。 |
| appRotation | [AppRotation](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#approtation12) | 否 | 否 | 当前应用方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11) | 窗口模式枚举。 |
...
![](../../../../images/5432eefd/zh-cn_image_0000002552800460.png)

****图2**** 横屏半折叠

![](../../../../images/5c65ad3e/zh-cn_image_0000002583440155.png)
...
![](../../../../images/0141ee01/zh-cn_image_0000002552960110.png)
...
![](../../../../images/3366d0f8/zh-cn_image_0000002583480111.png)
