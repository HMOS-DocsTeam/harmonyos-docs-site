...
![](../../../../images/d5cf5c5c/note_3.0-zh-cn.png) 
...
仅支持[GridItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-griditem/ts-container-griditem)子组件和自定义组件。自定义组件在Grid下使用时，建议使用GridItem作为自定义组件的顶层组件，不建议给自定义组件设置属性和事件方法。
...
![](../../../../images/b260b271/note_3.0-zh-cn.png) 
...
![](../../../../images/af6f351e/note_3.0-zh-cn.png) 

Grid组件使用通用属性[clip12+](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)和通用属性[clip18+](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip18)时默认值都为true。

设置Grid的padding后，如果子组件部分位于Grid内容区且部分位于padding区域内，则会显示；如果子组件完全位于padding区域内，则不会显示。如下图所示，GridItem1显示，而GridItem2不显示。

![](../../../../images/b53245a7/zh-cn_image_0000002583439665.png)
...
当value设置为ItemFillPolicy类型时，将根据Grid组件宽度对应[断点类型](/arkui/arkts-ui-development/arkts-layout-development/arkts-build-layout/arkts-layout-development-grid-layout#栅格容器断点)确定列数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [ItemFillPolicy](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#itemfillpolicy22) | 是 | 当前网格组件布局列的数量。 |
...
![](../../../../images/4766b923/note_3.0-zh-cn.png) 
...
- 此模式下GridItem交叉轴方向尺寸与网格一致，可以通过设置[constraintSize](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#constraintsize)中的maxWidth或maxHeight限制GridItem交叉轴方向尺寸小于网格。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 列与列的间距。  默认值：0  取值范围：[0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 行与行的间距。  默认值：0  取值范围：[0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BarState](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#barstate) | 是 | 滚动条状态。  默认值：BarState.Auto  ****说明：****  API version 9及以下版本默认值为BarState.Off，API version 10及以上版本的默认值为BarState.Auto。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Color](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#color) | number | string | 是 | 滚动条的颜色。  默认值：'#182431'（40%不透明度）  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。  string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
设置预加载的GridItem的数量，只在[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)和开启了[virtualScroll](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-repeat/ts-rendering-control-repeat#virtualscroll)开关的[Repeat](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)中生效。
...
设置Grid是否进入编辑模式，进入编辑模式可以拖拽Grid组件内部[GridItem](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-griditem/ts-container-griditem)。
...
设置是否开启鼠标框选。开启框选后，可以配合GridItem的selected属性和onSelect事件获取GridItem的选中状态，还可以通过[多态样式](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/ts-universal-attributes-polymorphic-style/ts-universal-attributes-polymorphic-style)设置GridItem的选中态样式（GridItem默认无选中态样式）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EdgeEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect) | 是 | Grid组件的边缘滑动效果，支持弹簧效果和阴影效果。  默认值：EdgeEffect.None |
...
![](../../../../images/416d228e/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alignment | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[GridItemAlignment](#griditemalignment12枚举说明)> | 是 | 设置Grid中GridItem的对齐方式。  默认值：GridItemAlignment.DEFAULT |
...
![](../../../../images/5f6fa765/note_3.0-zh-cn.png) 
...
由于拖拽检测也需要长按，且事件处理机制优先触发子组件事件，GridItem上绑定[LongPressGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-longpressgesture/ts-basic-gestures-longpressgesture#longpressgesture-1)时无法触发拖拽。如有长按和拖拽同时使用的需求可以使用通用拖拽事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnItemDragStartCallback](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#onitemdragstartcallback23) | 是 | 网格元素拖拽开始时触发的回调。  API version 22及之前版本，该参数类型为(event: ItemDragInfo, itemIndex: number) => (() => any) | void，其中event和itemIndex参数含义参考[OnItemDragStartCallback](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#onitemdragstartcallback23)。 |
...
网格滑动开始时触发。手指拖动网格或网格的滚动条触发的滑动开始时，会触发该事件。使用[Scroller](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scroller)滑动控制器触发的带动画的滑动，动画开始时会触发该事件。
...
网格滑动停止时触发。手指拖动网格或网格的滚动条触发的滑动，手指离开屏幕后滑动停止时会触发该事件。使用[Scroller](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scroller)滑动控制器触发的带动画的滑动，动画停止会触发该事件。
...
onScroll(event: (scrollOffset: number, scrollState: [ScrollState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollstate枚举说明)) => void)

网格滑动时触发。

![](../../../../images/55649945/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 12开始废弃，建议使用[onDidScroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#ondidscroll12)替代。
...
frameNode中[getEvent('Grid')](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode#geteventgrid19)方法的返回值，可用于给Grid节点设置滚动事件。

UIGridEvent继承于[UIScrollableCommonEvent](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#uiscrollablecommonevent19)。
...
![](../../../../images/e29af41d/zh-cn_image_0000002552959620.gif)

### 示例2（可滚动Grid和滚动事件）

可滚动Grid，包括所有滚动属性和事件。

GridDataSource实现了LazyForEach数据源接口[IDataSource](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-lazyforeach/ts-rendering-control-lazyforeach#idatasource)，用于通过LazyForEach给Grid提供子组件。
...
![](../../../../images/1d428fcd/zh-cn_image_0000002583479621.gif)
...
![](../../../../images/f5a272d8/zh-cn_image_0000002552799972.gif)
...
![](../../../../images/c563b907/zh-cn_image_0000002583439667.gif)
...
![](../../../../images/e06f9f62/note_3.0-zh-cn.png) 
...
![](../../../../images/1a863ae8/zh-cn_image_0000002552959622.png)

网格子组件拖拽过程中：

![](../../../../images/49e2a2b6/zh-cn_image_0000002583479623.png)

网格子组件1与子组件6拖拽交换位置后：

![](../../../../images/45970fcb/zh-cn_image_0000002552799974.png)

拖拽动画：

![](../../../../images/34d1d0bb/zh-cn_image_0000002583439669.gif)
...
![](../../../../images/52e7fdef/zh-cn_image_0000002552959624.gif)
...
![](../../../../images/597c3fae/zh-cn_image_0000002583479625.gif)
...
![](../../../../images/a040bb74/zh-cn_image_0000002552799976.png)
...
![](../../../../images/6eab050b/zh-cn_image_0000002583439671.png)

### 示例10（设置边缘渐隐）

通过[fadingEdge](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#fadingedge14)属性来设置边缘渐隐效果。
...
![](../../../../images/bc5fa1fa/zh-cn_image_0000002552959626.gif)
...
![](../../../../images/0de07fe0/zh-cn_image_0000002583479627.gif)
...
![](../../../../images/d7204b53/zh-cn_image_0000002552799978.gif)

### 示例13（设置滚动事件）

该示例通过FrameNode中的[getEvent('Grid')](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode#geteventgrid19)获取[UIGridEvent](#uigridevent19)，并为Grid设置滚动事件回调，用于事件监听方因无法直接修改页面代码而无法使用声明式接口设置回调的场景。
...
该示例通过[scrollToIndex](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scrolltoindex)接口，实现了Grid组件滚动到指定位置。
...
![](../../../../images/43347324/zh-cn_image_0000002583439673.gif)

### 示例15（实现Grid滑动选择）

该示例通过[PanGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-pangesture/ts-basic-gestures-pangesture#pangesture-1)接口，实现了Grid组件一边滑动一边选择的效果。
...
![](../../../../images/6375a769/zh-cn_image_0000002552959628.gif)

### 示例16（实现GridItem自定义拖拽）

该示例通过[gesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesture-settings/ts-gesture-settings#gesture)接口，实现了GridItem组件自定义拖拽效果。
...
![](../../../../images/191d7adb/zh-cn_image_0000002583479629.gif)

### 示例17（通过拖拽事件实现GridItem拖拽）

该示例通过[拖拽事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop)实现拖拽GridItem到Grid边缘时Grid自动滚动的功能。
...
![](../../../../images/367b5c0a/zh-cn_image_0000002552799980.gif)
...
![](../../../../images/f2f77249/zh-cn_image_0000002583439675.png)

Grid宽度属于md断点区间时显示3列。

![](../../../../images/519eb1cb/zh-cn_image_0000002552959630.png)

Grid宽度属于lg及更大的断点区间时显示5列。

![](../../../../images/707d6231/zh-cn_image_0000002583479631.png)
...
![](../../../../images/35930d16/zh-cn_image_0000002552799982.gif)

### 示例20（设置多选聚拢动画）

该示例通过打开Grid多选聚拢动画开关，实现了在GridItem上[长按弹出菜单](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/popup-property/ts-universal-attributes-menu/ts-universal-attributes-menu#bindcontextmenu8)时聚拢显示范围内被选中的GridItem。
...
![](../../../../images/a60aed47/zh-cn_image_0000002583439677.gif)
