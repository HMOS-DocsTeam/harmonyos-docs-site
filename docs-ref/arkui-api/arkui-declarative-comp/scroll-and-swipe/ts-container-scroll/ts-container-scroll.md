...
title: "Scroll"
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll
kit: 应用框架
...
![](../../../../images/92bf217d/note_3.0-zh-cn.png) 
...
- Scroll组件[通用属性clip](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)的默认值为true。
- Scroll组件的高度超出屏幕显示范围时，可以通过设置通用属性[layoutWeight](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#layoutweight)让Scroll高度适应主轴的剩余空间。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| barState | [BarState](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#barstate) | 是 | 滚动条状态。  默认值：BarState.Auto |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Color](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#color) | number | string | 是 | 滚动条的颜色。  默认值：'#66182431'  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。  string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edgeEffect | [EdgeEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect) | 是 | Scroll组件的边缘滑动效果，支持弹簧效果和阴影效果。  默认值：EdgeEffect.None |
| options11+ | [EdgeEffectOptions](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#edgeeffectoptions11对象说明) | 否 | 组件内容大小小于组件自身时，是否开启滑动效果。设置为{ alwaysEnabled: true }会开启滑动效果，{ alwaysEnabled: false }不开启。  默认值：{ alwaysEnabled: true } |
...
![](../../../../images/aa6a1ee1/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。  默认值：{ scrollForward: NestedScrollMode.SELF\_ONLY, scrollBackward: NestedScrollMode.SELF\_ONLY }  Scroll设置[enablePaging](#enablepaging11)或者[scrollSnap](#scrollsnap10)，并同时设置父组件优先的嵌套滚动时，嵌套滚动不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 摩擦系数。  默认值：非可穿戴设备为0.6，可穿戴设备为0.9。  从API version 11开始，非可穿戴设备默认值为0.7。  从API version 12开始，非可穿戴设备默认值为0.75。  取值范围：(0, +∞)，设置为小于等于0的值时，按默认值处理。 |
...
![](../../../../images/210b844c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | number | 是 | 设置Scroll组件内容的缩放比例，该参数支持[!!](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-new-binding)双向绑定变量。  默认值：1  取值范围：(0, +∞)，小于或等于0时按默认值1处理。 |
...
| [scrollBarMargin](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#scrollbarmargin20) | [onScrollStart](#onscrollstart9) | [currentOffset](#currentoffset) |
...
| [clipContent](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#clipcontent14) | - | - |
| [initialOffset](#initialoffset12) | - | - |
| [scrollable](#scrollable) | - | - |

![](../../../../images/4dfaba1f/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| snapAlign | [ScrollSnapAlign](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollsnapalign10枚举说明) | 否 | 否 | 设置Scroll组件限位滚动时的对齐方式。  ****说明：****  1.该属性默认值为ScrollSnapAlign.NONE。 |
| snapPagination | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | Array&lt;Dimension&gt; | 否 | 是 | 设置Scroll组件限位滚动时的分页点。  ****说明：****  1.当属性为Dimension时，Dimension表示每页的大小，系统按照该大小进行分页。  2.当属性为Array&lt;Dimension&gt;时，每个Dimension表示分页点，系统按照分页点进行分页。每个Dimension的范围为[0,可滑动距离]。  3.当该属性不填或者Dimension为小于等于0的输入时，按异常值，无限位滚动处理。当该属性值为Array&lt;Dimension&gt;数组时，数组中的数值必须为单调递增。  4.当输入为百分比时，实际的大小为Scroll组件的视口与百分比数值之积。 |
...
![](../../../../images/0f419e2d/note_3.0-zh-cn.png) 

不支持滚动组件通用事件中的[onWillScroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#onwillscroll12)、[onDidScroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#ondidscroll12)事件。
...
若通过onScrollFrameBegin事件和[scrollBy](#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的[EdgeEffect](#edgeeffect)为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#edgeeffect)属性需设置为EdgeEffect.None，否则抛滑List，会触发List的边缘回弹动画，导致嵌套滚动失效。
...
![](../../../../images/3a9500aa/note_3.0-zh-cn.png) 
...
![](../../../../images/f913e21a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnScrollEdgeCallback](#onscrolledgecallback18) | 是 | 滚动到的边缘位置。  当Scroll设置为水平方向滚动时，上报[Edge.Center](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge)表示水平方向起始位置，上报[Edge.Baseline](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge)表示水平方向末尾位置。由于[Edge.Center](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge)和[Edge.Baseline](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge)枚举值已经废弃，推荐使用[onReachStart](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#onreachstart11)、[onReachEnd](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#onreachend11)事件监听是否滚动到边界。 |
...
![](../../../../images/5ca3b8b8/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | 滚动开始回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | 滚动停止回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | 缩放开始回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | 缩放停止回调。 |
...
| xOffset | number | 是 | 相对于上一帧水平方向的偏移量，Scroll中的内容向左滚动时偏移量为正，向右滚动时偏移量为负。  单位vp。 |
| yOffset | number | 是 | 相对于上一帧竖直方向的偏移量，Scroll中的内容向上滚动时偏移量为正，向下滚动时偏移量为负。  单位vp。 |
| scrollState | [ScrollState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollstate枚举说明) | 是 | 当前滚动状态。 |

![](../../../../images/15933a82/note_3.0-zh-cn.png) 

若通过[onScrollFrameBegin](#onscrollframebegin9)事件和[scrollBy](#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的EdgeEffect为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#edgeeffect)属性需设置为EdgeEffect.None。
...
| yOffset | number | 是 | 相对于上一帧竖直方向的偏移量，Scroll中的内容向上滚动时偏移量为正，向下滚动时偏移量为负。  单位vp。 |
| scrollState | [ScrollState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollstate枚举说明) | 是 | 当前滚动状态。 |
| scrollSource | [ScrollSource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#scrollsource12) | 是 | 当前滚动操作的来源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| side | [Edge](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge) | 是 | 滚动到的边缘位置。 |
...
| state | [ScrollState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollstate枚举说明) | 是 | 当前滑动状态。 |
...
![](../../../../images/fded579a/note_3.0-zh-cn.png) 
...
![](../../../../images/e4edc9cb/note_3.0-zh-cn.png) 

1、Scroller控制器与滚动容器组件的绑定发生在组件创建阶段。

2、Scroller控制器与滚动容器组件绑定后才可以正常调用Scroller方法，否则根据调用接口不同会不生效或者抛异常。

3、以[aboutToAppear](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-lifecycle/ts-custom-component-lifecycle#abouttoappear)为例，aboutToAppear在创建自定义组件的新实例后，在执行其build()方法之前执行。因此如果滚动组件在自定义组件build内，在该自定义组件aboutToAppear执行时，内部滚动组件还没有创建，是不能正常调用上述Scroller方法的。

4、以[onAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#onappear)为例，组件挂载显示后触发此回调。因此在滚动组件的onAppear回调执行时，滚动组件已经创建并已经和Scroller绑定成功，是可以正常调用Scroller方法的。
...
![](../../../../images/66ae4997/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Edge](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edge) | 是 | 滚动到的边缘位置。 |
...
![](../../../../images/1b8a1715/note_3.0-zh-cn.png) 
...
| direction | [Axis](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#axis) | 否 | 设置滚动方向为水平或竖直方向。 |
...
![](../../../../images/eb0ef7fc/note_3.0-zh-cn.png) 

1. 当Scroller没有和组件绑定时，该接口会返回undefined，但是接口中没有声明，推荐使用[offset](#offset23)函数。
2. Grid、List、WaterFlow组件有懒加载机制，组件内容没有加载并布局完成时，内容总偏移量通过估算得到，估算结果可能会有误差。其中List组件可以通过[childrenMainSize](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#childrenmainsize12)属性解决估算不准确的问题，Grid与WaterFlow估算不准暂无解决方案。
...
![](../../../../images/5f0e7276/note_3.0-zh-cn.png) 

1.仅支持ArcList、Grid、List、WaterFlow组件。

2.在[LazyForEach](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-lazyforeach/ts-rendering-control-lazyforeach)、[ForEach](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-foreach/ts-rendering-control-foreach)、[Repeat](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-repeat/ts-rendering-control-repeat)刷新数据源时，需确保在数据刷新完成之后再调用此接口。

3.从API version 11开始，在List中支持[contentStartOffset](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#contentstartoffset11)和[contentEndOffset](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#contentendoffset11)。从API version 22开始，在Grid和Waterflow组件中支持设置[contentStartOffset](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#contentstartoffset22)和[contentEndOffset](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#contentendoffset22)。
...
![](../../../../images/7e2d810e/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 水平方向滚动距离，不支持百分比形式。  取值范围：(-∞, +∞) |
| dy | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 竖直方向滚动距离，不支持百分比形式。  取值范围：(-∞, +∞) |
...
![](../../../../images/579f486a/note_3.0-zh-cn.png) 
...
![](../../../../images/f83605c5/note_3.0-zh-cn.png) 
...
![](../../../../images/3a17c43b/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [RectResult](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/event-dispatch-control/ts-universal-attributes-on-child-touch-test/ts-universal-attributes-on-child-touch-test#rectresult) | 子组件的大小和相对于组件的位置。  单位：vp。 |
...
![](../../../../images/ade9923c/note_3.0-zh-cn.png) 
...
![](../../../../images/055bd4bf/note_3.0-zh-cn.png) 
...
![](../../../../images/748efc54/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [SizeResult](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-layout/ts-custom-component-layout#sizeresult10) | 滚动组件内容总大小，包括内容宽度和高度。  单位：vp |

****错误码****：

以下错误码详细介绍请参考[滚动类组件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-scroll/errorcode-scroll)。
...
| curve | [Curve](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#curve) | [ICurve](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#icurve9) | 否 | 是 | 设置滚动曲线。  默认值：Curve.Ease |
| canOverScroll | boolean | 否 | 是 | 设置滚动动画滚动到边界后，是否转换成越界回弹动画。  默认值：false  ****说明：****  仅在设置为true，且组件的edgeEffect设置为[EdgeEffect.Spring](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect)时，使用动画滚动到边界会转换为越界回弹动画，设置为false时，滚动到边界会直接停止动画，不会转换为越界回弹动画。  从API version 20开始，如果[ScrollOptions](#scrolloptions18对象说明)中的canOverScroll设置为true，表示滚动可以停留在过界位置，滚动动画过界后不会转换为回弹动画。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| extraOffset | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 滑动到指定Index的额外偏移量。如果值为正数，则向底部额外偏移；如果值为负数，则向顶部额外偏移。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| xOffset | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | 水平滚动偏移。  默认值：0 |
| yOffset | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | 垂直滚动偏移。  默认值：0 |
...
![](../../../../images/7c760532/note_3.0-zh-cn.png) 
...
frameNode中[getEvent('Scroll')](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode#geteventscroll19)方法的返回值，可用于给Scroll节点设置滚动事件。

UIScrollEvent继承于[UIScrollableCommonEvent](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scrollable-common/ts-container-scrollable-common#uiscrollablecommonevent19)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ScrollOnWillScrollCallback](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scrollonwillscrollcallback12) | undefined | 是 | onWillScroll事件的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ScrollOnScrollCallback](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scrollonscrollcallback12) | undefined | 是 | onDidScroll事件的回调函数。 |
...
![](../../../../images/302d8f98/zh-cn_image_0000002552799984.gif)
...
![](../../../../images/8d046839/zh-cn_image_0000002583439679.gif)
...
![](../../../../images/f054fe8c/zh-cn_image_0000002552959634.gif)
...
![](../../../../images/39187a94/zh-cn_image_0000002583479635.gif)
...
![](../../../../images/86cecca1/zh-cn_image_0000002552799986.gif)
...
![](../../../../images/9199d36d/zh-cn_image_0000002583439681.gif)
...
![](../../../../images/88513fae/zh-cn_image_0000002552959636.gif)
...
![](../../../../images/850b175d/zh-cn_image_0000002583479637.gif)
...
![](../../../../images/ceddfc66/zh-cn_image_0000002552799988.gif)
...
![](../../../../images/1a0f2f87/zh-cn_image_0000002583439683.gif)
...
![](../../../../images/6e15ba74/zh-cn_image_0000002552959638.gif)
...
![](../../../../images/a3b2a37f/zh-cn_image_0000002583479639.gif)

### 示例13（设置滚动事件）

该示例通过FrameNode中的[getEvent('Scroll')](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode#geteventscroll19)获取[UIScrollEvent](#uiscrollevent19)，并为Scroll设置滚动事件回调，用于事件监听方因无法直接修改页面代码而无法使用声明式接口设置回调的场景。
