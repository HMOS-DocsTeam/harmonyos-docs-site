...
![](../../../../images/81e489bd/note_3.0-zh-cn.png) 

该组件从API version 18开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

## 导入模块

![](../../../../images/9dd54532/note_3.0-zh-cn.png) 
...
![](../../../../images/32823711/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | Optional&lt;[ArcDotIndicator](#arcdotindicator) | boolean> | 是 | 弧形圆点指示器样式。  - ArcDotIndicator：弧形圆点指示器属性及功能。  - boolean：是否启用弧形圆点指示器。设置为true启用，false不启用。  默认值：true  默认类型：ArcDotIndicator |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sensitivity | Optional&lt;[CrownSensitivity](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#crownsensitivity18)&gt; | 是 | 旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM |

### effectMode

effectMode(edgeEffect: Optional&lt;EdgeEffect&gt;)

设置边缘滑动效果。 目前支持的滑动效果参见[EdgeEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect)的枚举说明。调用控制器接口时回弹不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edgeEffect | Optional&lt;[EdgeEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect)&gt; | 是 | 边缘滑动效果。  默认值：EdgeEffect.Spring |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | Optional&lt;[ArcDirection](#arcdirection-1)&gt; | 是 | 设置弧形指示器的方向。  默认值：ArcDirection.SIX\_CLOCK\_DIRECTION，6点钟方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional&lt;[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)&gt; | 是 | 设置弧形指示器中，未选中导航点的颜色。  默认值：'#A9FFFFFF' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional&lt;[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)&gt; | 是 | 设置弧形指示器中，选中导航点的颜色。  默认值：'#FF5EA1FF' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional&lt;[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)&gt; | 是 | 设置弧形指示器被长按时，弧形指示器的颜色。  默认值：'#FF404040' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional&lt;[LinearGradient](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-datapanel/ts-basic-components-datapanel#lineargradient10)&gt; | 是 | 设置弧形指示器的遮罩渐变色。  起始颜色默认值：'#00000000'  结束颜色默认值：'#FF000000' |
...
| event | [SwiperAnimationEvent](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper#swiperanimationevent10对象说明) | 是 | 动画相关信息，包括主轴方向上当前显示元素和目标元素相对ArcSwiper起始位置的位移，以及离手速度。 |
...
| event | [SwiperAnimationEvent](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper#swiperanimationevent10对象说明) | 是 | 动画相关信息，只返回主轴方向上当前显示元素相对于ArcSwiper起始位置的位移。 |
...
ArcSwiper组件结合[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)使用时，不能在onChange事件里触发子页面UI的刷新。
...
当ArcSwiper切换动效结束时触发，包括动画过程中手势中断，通过[SwiperController](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper#swipercontroller)调用finishAnimation。参数为动画结束后的index值，多列ArcSwiper时，index为最左侧组件的索引。
...
![](../../../../images/66045979/note_3.0-zh-cn.png) 
...
![](../../../../images/c46be841/zh-cn_image_0000002583479645.gif)
...
![](../../../../images/817aed48/zh-cn_image_0000002552799996.gif)
