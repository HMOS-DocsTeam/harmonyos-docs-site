...
title: "Swiper"
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper
kit: 应用框架
...
![](../../../../images/3aef0f8a/note_3.0-zh-cn.png) 

- 该组件从API version 7开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
- Swiper组件通过内置的[PanGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-pangesture/ts-basic-gestures-pangesture)拖动手势实现滑动轮播效果，将[disableSwipe](#disableswipe8)属性设为true时，会禁用该手势监听，从而阻止滑动操作。
- Swiper中复用[NodeContainer](/ref/arkui-api/arkui-declarative-comp/custom-placeholder-comp/ts-basic-components-nodecontainer/ts-basic-components-nodecontainer)时，禁止递归流程中子节点更新父节点状态变量。

## 子组件

可以包含子组件。

![](../../../../images/829957ae/note_3.0-zh-cn.png) 

- 子组件类型：系统组件和自定义组件，支持渲染控制类型（[if/else](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-ifelse)、[ForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-foreach)、[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)和[Repeat](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)）。不建议子组件中混用懒加载组件（包括LazyForEach、Repeat）和非懒加载组件，或者子组件中使用多个懒加载组件，否则可能导致懒加载组件预加载能力失效等问题。不建议在组件动画过程中对数据源进行操作，否则会导致布局出现异常。
- Swiper子组件的[visibility](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-visibility/ts-universal-attributes-visibility#visibility)属性设置为Visibility.None，且Swiper的displayCount属性设置为'auto'时，对应子组件在视窗内不占位，但不影响导航点个数；visibility属性设置为Visibility.None或者Visibility.Hidden时，对应子组件不显示，但依然会在视窗内占位。
- 当Swiper子组件设置了[offset](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-location/ts-universal-attributes-location#offset)属性时，会按照子组件的层级进行绘制，层级高的子组件会覆盖层级低的子组件。例如，Swiper包含3个子组件，其中第3个子组件设置了offset(\{ x : 100 \})，那么在横向循环滑动中，第3个子组件会覆盖第1个子组件，此时可设置第1个子组件的[zIndex](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-z-order/ts-universal-attributes-z-order#zindex)属性值大于第3个子组件，使第1个子组件层级高于第3个子组件。
- 在走焦到用户定义的子节点时，导航点、箭头会由于[焦点样式](/arkui/arkts-ui-development/arkts-interaction-development-guide-overview/arkts-common-events-focus-event#焦点样式)修改zIndex的行为被遮挡。
...
![](../../../../images/ac32dcb9/note_3.0-zh-cn.png) 

Swiper组件通用属性[clip](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)的默认值为true。
...
从API version 10开始，该属性支持[$$](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-two-way-sync)双向绑定变量。
...
![](../../../../images/5dc5bf18/note_3.0-zh-cn.png) 

设置外部绑定的导航点组件控制器后，可以和外部导航点结合使用。外部导航点支持自定义设置显示位置和大小。详细介绍可参看[Indicator](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-swiper-components-indicator/ts-swiper-components-indicator)。
...
![](../../../../images/26de774c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SwiperNestedScrollMode](#swipernestedscrollmode11枚举说明) | 是 | Swiper组件和父组件的嵌套滚动模式。  传入非法值时，按SwiperNestedScrollMode.SELF\_ONLY处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EdgeEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#edgeeffect) | 是 | 边缘滑动效果。  默认值：EdgeEffect.Spring |
...
curve默认曲线为[interpolatingSpring](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesinterpolatingspring10)，此时动画时长只受曲线自身参数影响，不再受duration的控制。不受duration控制的曲线可以查阅[插值计算](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve)模块，比如，[springMotion](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesspringmotion9)、[responsiveSpringMotion](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesresponsivespringmotion9)和interpolatingSpring类型的曲线不受duration控制。如果希望动画时长受到duration控制，需要给curve设置其他曲线。
...
设置Swiper的动画曲线，默认为弹簧插值曲线，常用曲线参考[Curve枚举说明](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#curve)，也可以通过[插值计算](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve)模块提供的接口创建自定义的插值曲线对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Curve](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#curve) | string | [ICurve](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#icurve9) | 是 | Swiper的动画曲线。  string类型来源[curves.init](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesinitdeprecated)，[curves.steps](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesstepsdeprecated)，[curves.cubicBezier](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvescubicbezierdeprecated)，[curves.spring](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesspringdeprecated)函数从API version 9开始废弃，推荐使用Curve和ICurve类型。  默认值：[interpolatingSpring](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curvesinterpolatingspring10)(-1, 1, 328, 34) |
...
![](../../../../images/6a00eb54/note_3.0-zh-cn.png) 
...
- 只在[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)和开启了virtualScroll开关的[Repeat](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)中生效，生效后超出显示及缓存范围的子节点会被释放。
...
![](../../../../images/61b42c92/note_3.0-zh-cn.png) 
...
![](../../../../images/9cc677bb/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [SwiperAutoFill](#swiperautofill10) | [ItemFillPolicy](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#itemfillpolicy22) | 是 | 视窗内显示的子元素个数。  取值范围：(0, +∞)，设置小于等于0的值时，按照1处理。 |
| swipeByGroup | boolean | 否 | 是否按组进行翻页。如果设为true，在翻页时会按组进行翻页，每组内子元素的数量为displayCount的值；如果为false，则为默认翻页行为，即按照子元素进行翻页。  默认值：false |

![](../../../../images/67a7fd24/note_3.0-zh-cn.png) 
...
![](../../../../images/59f42966/note_3.0-zh-cn.png) 
...
使用nextMargin/prevMargin接口时，不要对子组件进行[尺寸范围限制](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#constraintsize)，否则子节点主轴将不会被拉伸到预期长度，边距失去效果。

![](../../../../images/fa581a42/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 后边距。不支持设置百分比。  默认值：0 |
...
![](../../../../images/8491b82d/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 前边距。不支持设置百分比。  默认值：0 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[PageFlipMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#pageflipmode15)> | 是 | 鼠标滚轮翻页模式。  取undefined时，按取值为PageFlipMode.CONTINUOUS处理。 |

### maintainVisibleContentPosition20+

maintainVisibleContentPosition(enabled: boolean)

设置显示区域上方或前方插入或删除数据时是否保持可见内容位置不变。适用于使用单一[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)作为Swiper子节点的情况，通过LazyForEach的[onDataAdd](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-lazyforeach/ts-rendering-control-lazyforeach#ondataadd8)、[onDataDelete](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-rendering-control-lazyforeach/ts-rendering-control-lazyforeach#ondatadelete8)等接口修改数据源。其他场景下，显示区域上方或前方插入或删除数据，可见内容位置会变化。
...
![](../../../../images/21d83997/note_3.0-zh-cn.png) 
...
| AutoLinear(deprecated) | 1 | Swiper滑动一页的宽度为子组件宽度中的最大值。此枚举表现形式与[displayCount](#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](#displaycount8)说明。  ****说明****：从API version 7开始支持，从API version 10开始废弃，建议使用AUTO\_LINEAR替代。  ****卡片能力：**** 从API version 7开始，该接口支持在ArkTS卡片中使用。 |
| STRETCH10+ | 0 | Swiper滑动一页的宽度为Swiper组件自身的宽度。  ****卡片能力：**** 从API version 10开始，该接口支持在ArkTS卡片中使用。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| AUTO\_LINEAR(deprecated) | 1 | Swiper滑动一页的宽度为视窗内最左侧子组件的宽度。此枚举表现形式与[displayCount](#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](#displaycount8)说明。  ****说明****：从API version 10开始支持，从API version 12开始废弃，建议使用[Scroller.scrollTo](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll#scrollto)替代。  ****卡片能力：**** 从API version 10开始，该接口支持在ArkTS卡片中使用。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
![](../../../../images/841b1b91/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| index | number | 是 | 指定页面在Swiper中的索引值。  ****说明：****  设置的值小于0或大于最大页面索引时，取0。 |
| animationMode | [SwiperAnimationMode](#swiperanimationmode15枚举说明) | boolean | 否 | 设置翻页至指定页面时的动效模式。  默认值：SwiperAnimationMode.NO\_ANIMATION  ****说明：****  当传入true时有动效，等同于SwiperAnimationMode.DEFAULT\_ANIMATION；当传入false时无动效，等同于SwiperAnimationMode.NO\_ANIMATION。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 否 | 动画结束的回调。 |
...
与[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)和自定义组件结合使用时，由于[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)只会保留缓存范围内的自定义组件，在缓存范围外的会被删除，因此需要开发者保证通过该接口预加载的节点index在缓存范围内。

![](../../../../images/901635f7/note_3.0-zh-cn.png) 

Swiper的preloadItems需要在Swiper创建之后去调用，首次预加载推荐在Swiper的[onAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#onappear)生命周期中去控制。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indices | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)&lt;Array&lt;number&gt;&gt; | 是 | 需预加载的子节点的下标数组。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[滚动类组件错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-scroll/errorcode-scroll)错误码。
...
![](../../../../images/b586172a/note_3.0-zh-cn.png) 
...
![](../../../../images/a071b426/note_3.0-zh-cn.png) 
...
![](../../../../images/e330a175/note_3.0-zh-cn.png) 
...
设置导航点距离Swiper组件距离。由于导航点有默认交互区域，交互区域高度为32vp，所以无法让显示部分完全贴底。若想实现完全贴底，可以使用[IndicatorComponent](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-swiper-components-indicator/ts-swiper-components-indicator#indicatorcomponent)组件，更灵活地调整位置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置导航点左侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐。  设置为0时：按照0位置布局计算。  优先级：高于right属性。  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置导航点顶部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：高于bottom属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置导航点右侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐。  设置为0时：按照0位置布局计算。  优先级：低于left属性。  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围 时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：低于top属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bottom | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：低于top属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
| ignoreSize | boolean | 是 | 设置是否忽略导航点本身大小，默认false。  设为true时可以将导航点更靠近Swiper底部，使用方法可以参考[示例9演示导航点space与bottom](#示例9演示导航点space与bottom)。  说明：[数字导航点](#digitindicator10)ignoreSize属性，不生效的场景如下：  • 当[vertical](#vertical) 设置为false，且bottom > 0。  • 当[vertical](#vertical) 设置为true时：  1、bottom > 0 时。  2、bottom设为undefined。  3、isSidebarMiddle设置为false时。 |
...
在[RTL](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-state-management-environment-variables/ts-state-management-environment-variables#layoutdirection)模式下为导航点距离Swiper组件右边的距离，在[LTR](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-state-management-environment-variables/ts-state-management-environment-variables#layoutdirection)模式下为导航点距离Swiper组件左边的距离。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 是 | 设置在RTL模式下为导航点距离Swiper组件右边的距离，在LTR模式下为导航点距离Swiper组件左边的距离。  默认值：0  单位：vp  取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 是 | 设置在RTL模式下为导航点距离Swiper组件左边的距离，在LTR模式下为导航点距离Swiper组件右边的距离。  默认值：0  单位：vp  取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
![](../../../../images/76ab562a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置Swiper组件圆点导航指示器的宽，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置Swiper组件圆点导航指示器的高，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置选中Swiper组件圆点导航指示器的宽，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置选中Swiper组件圆点导航指示器的高，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置Swiper组件圆点导航指示器的颜色。  默认值：'#1A182431'，浅灰色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置选中Swiper组件圆点导航指示器的颜色。  默认值：'#007DFF'，蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| space | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 是 | 设置圆点导航点间距，不支持设置百分比。  默认值：PC/2in1设备上为10，其他设备为8。  单位：vp  取值范围：[0, +∞) |
...
![](../../../../images/d8f7b3e6/note_3.0-zh-cn.png) 

按组翻页时，数字导航点显示的子节点数量不包括占位节点。

数字导航点文本最大的字体缩放倍数[maxFontScale](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#maxfontscale12)为2。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置Swiper组件数字导航点的字体颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置选中Swiper组件数字导航点的字体颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 是 | 设置Swiper组件数字导航点的字体样式。  只支持Font中size和weight参数，family和style设置不生效。  默认值：  { size: 14, weight: FontWeight.Normal } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 是 | 设置选中Swiper组件数字导航点的字体样式。  默认值：  { size: 14, weight: FontWeight.Normal } |

![](../../../../images/7086217d/note_3.0-zh-cn.png) 
...
| backgroundSize | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置底板大小。  在导航点两侧显示：  默认值：24vp  在组件两侧显示：  默认值：32vp  不支持设置百分比。 |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置底板颜色。  在导航点两侧显示：  默认值：'#00000000'  在组件两侧显示：  默认值：'#19182431' |
| arrowSize | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置箭头大小。  在导航点两侧显示时：  默认值：18vp  在组件两侧显示时：  默认值：24vp  ****说明：****  showBackground为true时，arrowSize为backgroundSize的3/4。  不支持设置百分比。 |
| arrowColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置箭头颜色。  默认值：'#182431' |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| minSize | [VP](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#vp10) | 否 | 否 | 设置元素显示最小宽度。  默认值：0 |
...
![](../../../../images/333e679a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#callback12)<number> | 是 | 当前显示元素的索引。 |
...
![](../../../../images/e695d68b/note_3.0-zh-cn.png) 
...
![](../../../../images/9c991124/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#callback12)<number> | 是 | 当前选中元素的索引。 |

![](../../../../images/2e38edeb/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#callback12)<number> | 是 | 将要隐藏元素的索引。 |

![](../../../../images/0809bbed/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#callback12)<[ScrollState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#scrollstate枚举说明)> | 是 | 滑动状态变化的回调。 |
...
![](../../../../images/d467ead3/note_3.0-zh-cn.png) 
...
![](../../../../images/a93bafb6/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| left | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置导航点左侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐  设置为0时：按照0位置布局计算  优先级：高于right属性  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
| top | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置导航点顶部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致  设置为0时：按照0位置布局计算  优先级：高于bottom属性  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
| right | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置导航点右侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐  设置为0时：按照0位置布局计算  优先级：低于left属性  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
| bottom | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致  设置为0时：按照0位置布局计算  优先级：低于top属性  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
| size | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置导航点的直径，不支持设置百分比。  默认值：6vp |
| mask | boolean | 否 | 是 | 设置是否显示导航点蒙层样式。  true：显示导航点蒙层样式，false：不显示导航点蒙层样式。  默认值：false |
| color | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置导航点的颜色。  默认值：'#1A182431'，浅灰色。 |
| selectedColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置选中的导航点的颜色。  默认值：'#007DFF'，蓝色。 |
...
![](../../../../images/7163f37e/zh-cn_image_0000002552799990.gif)
...
![](../../../../images/821f765d/zh-cn_image_0000002583439685.gif)
...
![](../../../../images/4a4e1ec9/zh-cn_image_0000002552959640.gif)
...
![](../../../../images/e596997a/zh-cn_image_0000002583479641.gif)
...
![](../../../../images/abf7ef49/zh-cn_image_0000002552799992.gif)
...
该示例通过[onSelected](#onselected18)接口，实现了[Tabs](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs)与Swiper联动切换。
...
![](../../../../images/01bbad84/zh-cn_image_0000002583439687.gif)
...
![](../../../../images/59c0b282/zh-cn_image_0000002552959642.gif)
...
![](../../../../images/23f8f7ba/zh-cn_image_0000002583479643.gif)
...
Swiper宽度属于[sm](/arkui/arkts-ui-development/arkts-layout-development/arkts-build-layout/arkts-layout-development-grid-layout#栅格容器断点)及更小的断点区间时显示1列。

![](../../../../images/52cd3ba7/zh-cn_image_0000002552799994.jpg)

Swiper宽度属于[md](/arkui/arkts-ui-development/arkts-layout-development/arkts-build-layout/arkts-layout-development-grid-layout#栅格容器断点)断点区间时显示2列。

![](../../../../images/abedda55/zh-cn_image_0000002583439689.jpg)
...
![](../../../../images/5da1abd4/zh-cn_image_0000002552959644.gif)
