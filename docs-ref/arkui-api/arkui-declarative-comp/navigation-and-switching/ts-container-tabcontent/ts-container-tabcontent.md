...
![](../../../../images/89719217/note_3.0-zh-cn.png) 

- 该组件从API version 7开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
- 该组件默认设置了[clip](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)属性的值为true，若需要扩展内容区到组件外显示，需先关闭clip属性。

## 子组件

支持单个子组件。

![](../../../../images/f7222682/note_3.0-zh-cn.png) 

可内置系统组件和自定义组件，支持渲染控制类型（[if/else](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-ifelse)、[ForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-foreach)和[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) |  [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8)8+|  [TabBarOptions](#tabbaroptions18对象说明)18+ | 是 | TabBar上显示内容。  CustomBuilder： 构造器，内部可以传入组件（API version 8版本以上适用）。 |
...
![](../../../../images/ac290bd6/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) |  [SubTabBarStyle](#subtabbarstyle9) |[BottomTabBarStyle](#bottomtabbarstyle9) |  string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) |  [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8)|  [TabBarOptions](#tabbaroptions18对象说明) | 是 | TabBar上显示内容。  ComponentContent： 组件内容的实体封装，可以设置自定义内容。  SubTabBarStyle： 子页签样式。  BottomTabBarStyle： 底部页签和侧边页签样式，底部样式没有下划线效果。  string： 字符串类型。  Resource： 资源引用类型，引入系统资源或者应用资源中的字符串。  CustomBuilder： 构造器，内部可以传入组件。  TabBarOptions： 设置页签内的图片和文字内容。 |

![](../../../../images/fd56c980/note_3.0-zh-cn.png) 
...
![](../../../../images/1567f2a7/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon7+ | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 页签内的图片内容。未设置时不显示图片。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| text7+ | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 页签内的文字内容。未设置时不显示文字。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 页签内的文字内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 页签内的内容。  ****说明：****  1.自定义内容不支持labelStyle属性。  2.自定义内容超出页签范围，则不显示超出部分。  3.自定义内容小于页签范围，则会居中对齐。  4.自定义内容异常或无可用显示组件，则显示空白。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 页签内的内容。支持ComponentContent设置自定义内容。  ****说明：****  1.自定义内容不支持labelStyle属性。  2.自定义内容超出页签范围，则不显示超出部分。  3.自定义内容小于页签范围，则会居中对齐。  4.自定义内容异常或无可用显示组件，则显示空白。 |
...
设置选中子页签的下划线风格。与[indicator](#indicator10)相比，新增了图片格式的下划线风格，图片的显示效果参照[ImageFit.Cover](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#imagefit)。子页签的下划线风格仅在水平模式下有效。
...
![](../../../../images/5863f046/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 是 | 子页签的内边距属性。  取值范围：[0, +∞]  默认值：{left:8.0vp,right:8.0vp,top:17.0vp,bottom:18.0vp} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| padding | [LocalizedPadding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#localizedpadding12) | 是 | 子页签的内边距属性。  取值范围：[0, +∞]  默认值：{start:LengthMetrics.vp(8),end:LengthMetrics.vp(8),  top:LengthMetrics.vp(17),bottom:LengthMetrics.vp(18)} |
...
设置子页签的[id](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-component-id/ts-universal-attributes-component-id#id)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | 是 | 子页签的[id](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-component-id/ts-universal-attributes-component-id#id)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 下划线的颜色和背板颜色。  默认值：#FF007DFF |
| height | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的高度（不支持百分比设置）。  默认值：2.0  单位：vp  取值范围：[0, +∞)。 |
| width | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的宽度（不支持百分比设置）。  默认值：0.0  单位：vp  取值范围：[0, +∞)。  ****说明：****  宽度设置为0时，按页签文本宽度显示。 |
| borderRadius | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的圆角半径（不支持百分比设置）。  默认值：0.0  单位：vp  取值范围：[0, +∞)。 |
| marginTop | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线与文字的间距（不支持百分比设置）。  默认值：8.0  单位：vp  取值范围：[0, +∞)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| drawable | [DrawableDescriptor](#drawabledescriptor22) | 否 | 是 | 下划线的图源。  支持[DrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#drawabledescriptor)、[PixelMapDrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#pixelmapdrawabledescriptor12)、[LayeredDrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#layereddrawabledescriptor)和[AnimatedDrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#animateddrawabledescriptor12)类型。当传入无效图源时将显示默认的实线型下划线。 |
| height | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的高度（不支持百分比设置）。  默认值：2.0  单位：vp  取值范围：[0, +∞) |
| width | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的宽度（不支持百分比设置）。  默认值：0.0  单位：vp  取值范围：[0, +∞)  宽度设置为0时，按页签文本宽度显示。 |
| borderRadius | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线的圆角半径（不支持百分比设置）。  默认值：0.0  单位：vp  取值范围：[0, +∞) |
| marginTop | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 下划线与文字的间距（不支持百分比设置）。  默认值：8.0  单位：vp  取值范围：[0, +∞) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderRadius | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 背板的圆角半径（不支持百分比设置）。  默认值：8.0  单位：vp  取值范围：[0, +∞)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| overflow | [TextOverflow](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textoverflow) | 否 | 是 | 设置Label文本超长时的显示方式。默认值是省略号截断。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| minFontSize | number | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置Label文本最小显示字号（不支持百分比设置）。需配合maxFontSize以及maxLines或布局大小限制使用。自适应文本大小生效后，font.size不生效。默认值是0.0fp，即默认自适应文本大小不生效。  取值范围：(0, +∞)。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| maxFontSize | number | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置Label文本最大显示字号（不支持百分比设置）。需配合minFontSize以及maxLines或布局大小限制使用。自适应文本大小生效后，font.size不生效。默认值是0.0fp，即默认自适应文本大小不生效。  取值范围：[minFontSize, +∞)。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| heightAdaptivePolicy | [TextHeightAdaptivePolicy](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textheightadaptivepolicy10) | 否 | 是 | 设置Label文本自适应高度的方式。默认值是最大行数优先。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| font | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 否 | 是 | 设置Label文本字体样式。  当页签为子页签时，默认值是字体大小16.0fp、字体类型'HarmonyOS Sans'，字体风格正常，选中时字重中等，未选中时字重正常。  当页签为底部页签时，默认值是字体大小10.0fp、字体类型'HarmonyOS Sans'，字体风格正常，字重中等。  从API version 12开始，底部页签内容左右排布时默认字体大小为12.0fp。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| unselectedColor12+ | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置Label文本字体未选中时的颜色。  默认值：#99182431  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| selectedColor12+ | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置Label文本字体选中时的颜色。  默认值：#FF007DFF  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | [TabBarSymbol12+](#tabbarsymbol12对象说明) | 是 | 页签内的图片内容。 |
| text | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 页签内的文字内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | [LocalizedPadding12+](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#localizedpadding12) | 是 | 底部页签的内边距。  取值范围：[0, +∞]  默认值：{left:4.0vp,right:4.0vp,top:0.0vp,bottom:0.0vp}  使用LocalizedPadding时，支持镜像能力。  默认值：{start:LengthMetrics.vp(4),end:LengthMetrics.vp(4),  top:LengthMetrics.vp(0),bottom:LengthMetrics.vp(0)} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [VerticalAlign](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#verticalalign) | 是 | 底部页签的图片、文字在垂直方向上的对齐格式。  默认值：VerticalAlign.Center |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | 是 | 设置底部页签的[id](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-component-id/ts-universal-attributes-component-id#id)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| normal | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 否 | 页签内symbol图标普通态样式。  默认值：  fontColor：#66182431  renderingStrategy：SymbolRenderingStrategy.MULTIPLE\_OPACITY  fontSize：24vp |
| selected | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | 页签内symbol图标选中态样式。  默认值：  fontColor：#ff007dff  renderingStrategy：SymbolRenderingStrategy.MULTIPLE\_OPACITY  fontSize：24vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| unselectedColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置Label图标未选中时的颜色。  默认值：#33182431  ****说明：****  仅对svg图源生效，设置后会替换svg图片的填充颜色。 |
| selectedColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 设置Label图标选中时的颜色。  默认值：#FF007DFF  ****说明：****  仅对svg图源生效，设置后会替换svg图片的填充颜色。 |
...
![](../../../../images/50bcc14c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | TabContent将要显示的回调函数。 |
...
![](../../../../images/8775d3ae/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#voidcallback12) | 是 | TabContent将要隐藏的回调函数。 |
...
![](../../../../images/0716bee8/zh-cn_image_0000002552959686.gif)
...
![](../../../../images/da1623f0/zh-cn_image_0000002583479687.gif)
...
![](../../../../images/8d32884f/zh-cn_image_0000002552800038.jpeg)
...
![](../../../../images/cc9d81bf/zh-cn_image_0000002583439733.gif)
...
![](../../../../images/f460de0f/zh-cn_image_0000002552959688.png)
...
![](../../../../images/4e6f4297/zh-cn_image_0000002583479689.gif)
...
![](../../../../images/59fb39dd/zh-cn_image_0000002552800040.gif)
...
![](../../../../images/00966ba5/zh-cn_image_0000002583439735.gif)
...
![](../../../../images/63e34f93/zh-cn_image_0000002552959690.gif)
...
![](../../../../images/71b7e12d/zh-cn_image_0000002583479691.gif)
...
![](../../../../images/177216ea/zh-cn_image_0000002552800042.gif)
...
![](../../../../images/ad7a8112/zh-cn_image_0000002583439737.png)
