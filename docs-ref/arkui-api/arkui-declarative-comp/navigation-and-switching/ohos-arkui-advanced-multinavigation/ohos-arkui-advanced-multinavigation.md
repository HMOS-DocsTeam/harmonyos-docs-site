...
![](../../../../images/da18da13/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) | 是 | NavDestination页面的信息。 |
...
| --- | --- | --- | --- |
| info | [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) | 是 | NavDestination页面的信息。 |
| options | [NavigationOptions](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navigationoptions12) | 否 | 页面栈操作选项。仅支持其中的animated字段。 |
| policy | [SplitPolicy](#splitpolicy枚举说明) | 否 | 当前入栈页面的策略。默认值：DETAIL\_PAGE |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | NavDestination页面详细参数。 |
| onPop | base.[Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[PopInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#popinfo11)> | 否 | Callback回调，用于页面出栈时触发该回调处理返回结果。 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true  true：支持转场动画。  false：不支持转场动画。 |
| policy | [SplitPolicy](#splitpolicy枚举说明) | 否 | 当前入栈页面的策略。默认值：DETAIL\_PAGE |
...
![](../../../../images/5bb3fc3b/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) | undefined | 返回栈顶NavDestination页面的信息。 |
...
![](../../../../images/a13e7747/note_3.0-zh-cn.png) 
...
![](../../../../images/63fa3616/note_3.0-zh-cn.png) 
...
![](../../../../images/31fb4f66/note_3.0-zh-cn.png) 
...
![](../../../../images/a28a2891/note_3.0-zh-cn.png) 
...
![](../../../../images/c90b5fe4/note_3.0-zh-cn.png) 
...
![](../../../../images/bbb1d915/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) | 是 | 占位页页面信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [NavigationMode](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navigationmode9枚举说明) | 是 | 当回调触发时的NavigationMode。 |
...
![](../../../../images/b71ac63c/zh-cn_image_0000002583479675.gif)

主页跳转详情页效果演示：

![](../../../../images/30050816/zh-cn_image_0000002552800026.gif)

全屏类型页面效果演示：

![](../../../../images/4b71acdf/zh-cn_image_0000002583439721.gif)
