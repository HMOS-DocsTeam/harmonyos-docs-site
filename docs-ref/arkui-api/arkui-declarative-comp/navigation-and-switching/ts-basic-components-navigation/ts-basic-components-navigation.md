...
Navigation组件是路由导航的根视图容器，一般作为Page页面的根容器使用，其内部默认包含了标题栏、内容区和工具栏，其中内容区默认首页显示导航内容（Navigation的子组件）或非首页显示（[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)的子组件），首页和非首页通过路由进行切换。

![](../../../../images/6fd4df01/note_3.0-zh-cn.png) 

- 该组件从API version 8开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
- 该组件从API version 11开始默认支持安全区避让特性(默认值为：expandSafeArea([SafeAreaType.SYSTEM, SafeAreaType.KEYBOARD, SafeAreaType.CUTOUT], [SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM]))，开发者可以重写该属性覆盖默认行为，API version 11之前的版本需配合[expandSafeArea](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-expand-safe-area/ts-universal-attributes-expand-safe-area#expandsafearea)属性实现安全区避让。
- [NavBar](#navbar12)嵌套使用Navigation时，内层NavDestination的生命周期不和外层NavDestination以及[全模态](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/transition/ts-universal-attributes-modal-transition/ts-universal-attributes-modal-transition)的生命周期进行联动。
...
- 不建议在[aboutToAppear](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-lifecycle/ts-custom-component-lifecycle#abouttoappear)中使用栈操作，此时的页面还未构建完成，会导致白屏或跳转失败等问题。

## 子组件

可以包含子组件。

从API version 9开始，推荐与[NavRouter](/ref/arkui-api/arkui-declarative-comp/arkui-declarative-comp-dep/ts-basic-components-navrouter/ts-basic-components-navrouter)组件搭配使用。
...
创建路由导航的根视图容器，适用于使用[NavRouter](/ref/arkui-api/arkui-declarative-comp/arkui-declarative-comp-dep/ts-basic-components-navrouter/ts-basic-components-navrouter)组件进行页面路由。
...
![](../../../../images/1df85705/note_3.0-zh-cn.png) 
...
![](../../../../images/25a9dcf6/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr)10+ | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | [NavigationCommonTitle](#navigationcommontitle9)9+ | [NavigationCustomTitle](#navigationcustomtitle9)9+ | 是 | 页面标题，使用NavigationCustomTitle类型设置height高度时，[titleMode](#titlemode)属性不会生效。  字符串超长时，如果不设置副标题，先缩小再换行（2行）最后截断。如果设置副标题，先缩小最后截断。 |
...
![](../../../../images/32519633/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array&lt;[NavigationMenuItem](#navigationmenuitem)&gt; | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 页面右上角菜单。 |
...
![](../../../../images/92b11ff2/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array&lt;[NavigationMenuItem](#navigationmenuitem)&gt; | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 页面右上角菜单。 |
...
![](../../../../images/cbe933ad/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array&lt;[ToolbarItem](#toolbaritem10)&gt; | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 工具栏内容，使用Array&lt;[ToolbarItem](#toolbaritem10)&gt;设置的工具栏有如下特性：  工具栏所有选项均分底部工具栏，在每个均分内容区布局文本和图标。  竖屏模式最多支持显示5个图标，多余的图标会被放入自动生成的更多图标。横屏模式时，如果为[Split](#navigationmode9枚举说明)模式，仍按照竖屏模式显示，如果为[Stack](#navigationmode9枚举说明)模式需配合menus属性的Array&lt;[NavigationMenuItem](#navigationmenuitem)&gt;使用，底部工具栏会自动隐藏，同时底部工具栏所有选项移动至页面右上角菜单。  使用[CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8)写法为用户自定义工具栏选项，不具备以上功能。 |
...
从API version 18开始，该参数支持[!!](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-new-binding)双向绑定变量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 导航页宽度。  默认值：240  单位：vp  undefined：行为不做处理，导航页宽度与默认值保持一致。 |
...
![](../../../../images/0751fee9/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | [SymbolGlyphModifier12+](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 是 | 标题栏中返回键图标。 |
...
![](../../../../images/a012f5ff/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | string | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 是 | 标题栏中返回键图标。 |
| accessibilityText | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 返回键无障碍播报内容。  默认值：系统语言是中文时为“返回”，系统语言是英文时为“back”。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [[Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10), [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10)] | 是 | 导航页最小和最大宽度。设置异常值时按默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 是 | 导航页内容区最小宽度。  默认值：360  单位：vp  undefined：行为不做处理，导航页内容区最小宽度与默认值保持一致。  Auto模式断点计算：默认600vp，minNavBarWidth(240vp) + minContentWidth (360vp) |
...
![](../../../../images/ad764f4b/note_3.0-zh-cn.png) 
...
- 组件想要扩展到非安全区域内，需隐藏或者设置标题栏和工具栏为[STACK](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#barstyle12枚举说明)模式。
...
![](../../../../images/43a99d25/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[SystemBarStyle](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#systembarstyle12)> | 是 | 系统状态栏样式。 |
...
![](../../../../images/ef4e47a1/note_3.0-zh-cn.png) 

1. 使用该接口需要先设置Navigation的通用属性[id](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-component-id/ts-universal-attributes-component-id#id)，否则该接口无效。
2. 该接口需要配合NavDestination的[recoverable](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#recoverable14)接口使用。
3. 恢复的过程中不可序列化的信息，例如不可序列化的参数与用户设置的onPop等，会被丢弃，无法恢复。
4. 当应用退到后台，因系统资源不足等原因被系统终止后，如果某页面已配置为可恢复，当应用再次被唤醒至前台时，系统将自动恢复该页面。详细说明请参考[UIAbility备份恢复](/ability-kit/stage-model-development/stage-model-application-components/uiability/ability-recover-guideline)，详细使用请参考[示例18](#示例18设置navigation可恢复)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| recoverable | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | Navigation是否可恢复，默认为不可恢复。  true：路由栈可恢复；false：路由栈不可恢复。  传入参数非法时，按false处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 是否开启拖拽条，默认为无拖拽条样式。  true：有拖拽条样式；false：无拖拽条样式。  传入参数非法时，按false处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 是否开启单双栏切换动效。  true：开启单双栏切换动效；false：关闭单双栏切换动效。  传入参数非法时，按true处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| placeholder | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent#componentcontent-1) | 是 | 设置Navigation双栏模式下右侧的默认占位页。 |
...
设置是否启用[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)页面[onHidden](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onhidden10)、[onShown](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onshown10)生命周期与全模态的联动触发。

![](../../../../images/26d4fde5/note_3.0-zh-cn.png) 
...
![](../../../../images/81287cd3/note_3.0-zh-cn.png) 
...
![](../../../../images/7519055f/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | object | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 工具栏内容。 |
...
![](../../../../images/b3cf3c61/note_3.0-zh-cn.png) 
...
![](../../../../images/c609fd0f/note_3.0-zh-cn.png) 
...
![](../../../../images/5ad03cc8/note_3.0-zh-cn.png) 
...
![](../../../../images/79e488a0/note_3.0-zh-cn.png) 
...
![](../../../../images/70724ff9/note_3.0-zh-cn.png) 
...
![](../../../../images/f1a8801f/note_3.0-zh-cn.png) 
...
将路由栈内指定navDestinationId的NavDestination页面删除。navDestinationId可以在NavDestination的[onReady](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onready11)回调中获取，也可以在[NavDestinationInfo](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-observer/js-apis-arkui-observer#navdestinationinfo)中获取。
...
![](../../../../images/d0c79ab7/note_3.0-zh-cn.png) 
...
![](../../../../images/f851b3c9/note_3.0-zh-cn.png) 
...
![](../../../../images/937d6820/note_3.0-zh-cn.png) 
...
| mode | [NavDestinationMode](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#navdestinationmode枚举说明11) | 否 | 是 | NavDestination的模式，如果是根视图(NavBar)，则返回值为undefined。 |
...
![](../../../../images/dbf5b2dc/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavDestinationContext](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#navdestinationcontext11) | [NavBar](#navbar12) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavDestinationContext](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#navdestinationcontext11) | [NavBar](#navbar12) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) |[NavBar](#navbar12) | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavPathInfo](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathinfo10) |[NavBar](#navbar12) | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
| pathStack | [NavPathStack](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathstack10) | 是 | 页面栈。 |
| operation | [NavigationOperation](#navigationoperation11枚举说明) | 是 | 当前页面跳转类型。 |
| isAnimated | boolean | 是 | 页面跳转是否有动画。  true：页面跳转有动画。  false：页面跳转没有动画。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | string | [Resource14+](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 否 | API version 9：显示菜单栏单个选项的文本。  从API version 10开始，不显示菜单栏单个选项的文本。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| icon | string | [Resource14+](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 菜单栏单个选项的图标资源路径。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| symbolIcon12+ | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | 菜单栏单个选项的symbol资源（优先级高于icon）。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| activeSymbolIcon12+ | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/universal-attributes-attribute-symbolglyphmodifier/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | 工具栏单个选项处于ACTIVE态时的symbol资源（优先级高于activeIcon）。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| Free | 0 | 当内容为满一屏的可滚动组件时，标题随着内容向上滚动而缩小（子标题的大小不变、淡出）。向下滚动内容到顶时则恢复原样。  ****说明：****  标题随着内容滚动大小联动的动效在title设置为ResourceStr和NavigationCommonTitle时生效，设置成其余自定义节点类型时字体样式无法变化，下拉时只影响标题栏偏移。  可滚动组件不满一屏时，如果想使用联动效果，就要使用滚动组件提供的[edgeEffect](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list#edgeeffect)接口将options参数设置为true。未滚动状态，标题栏高度与Full模式一致；滚动时，标题栏的最小高度与Mini模式一致。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| main | string | [Resource14+](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 否 | 设置主标题。 |
| sub | string | [Resource14+](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 否 | 设置副标题。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| builder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | 否 | 设置标题栏内容。 |
| height | [TitleHeight](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#titleheight9) | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 否 | 设置标题栏高度。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 分割线的颜色。  默认值：#33000000，灰色。 |
| startMargin | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 分割线与侧边栏顶端的距离。  默认值：0  单位：vp  取值范围：[0, +∞) |
| endMargin | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 分割线与侧边栏底端的距离。  默认值：0  单位：vp  取值范围：[0, +∞) |
...
![](../../../../images/afcbae7c/note_3.0-zh-cn.png) 
...
| SAFE\_AREA\_PADDING14+ | 2 | 将指定该模式的标题栏或工具栏设置为[组件级安全区](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#safeareapadding14)。  ****元服务API：**** 从API version 14开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 标题栏背景颜色，不设置时为系统默认颜色。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyle | [BlurStyle](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#blurstyle9) | 否 | 是 | 标题栏背景模糊样式，不设置时关闭背景模糊效果。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyleOptions19+ | [BackgroundBlurStyleOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundblurstyleoptions10对象说明) | 否 | 是 | 标题栏背景模糊选项。  ****说明：****  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。  ****元服务API：**** 从API version 19开始，该接口支持在元服务中使用。 |
| backgroundEffect19+ | [BackgroundEffectOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundeffectoptions11) | 否 | 是 | 设置标题栏背景属性包括：模糊半径，亮度，饱和度，颜色等。  ****说明：****  不建议与backgroundBlurStyleOptions同时使用。  ****元服务API：**** 从API version 19开始，该接口支持在元服务中使用。 |
| barStyle12+ | [BarStyle](#barstyle12枚举说明) | 否 | 是 | 设置标题栏布局方式。  默认值：BarStyle.STANDARD  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| paddingStart12+ | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 标题栏起始端内间距。  仅支持以下任一场景：  1. 显示返回图标，即[hideBackButton](#hidebackbutton)为false；  2. 使用非自定义标题，即[标题value](#title)类型为ResourceStr或NavigationCommonTitle。  默认值：  LengthMetrics.resource($r('sys.float.margin\_left'))。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| paddingEnd12+ | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 标题栏结束端内间距。  仅支持以下任一场景：  1. 使用非自定义菜单，即[菜单value](#menus)为Array&lt;NavigationMenuItem&gt;；  2. 没有右上角菜单，且使用非自定义标题，即[标题value](#title)类型为ResourceStr或NavigationCommonTitle。  默认值：  LengthMetrics.resource($r('sys.float.margin\_right'))  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| mainTitleModifier13+ | [TextModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 主标题属性修改器。  1. 通过Modifier设置的属性会覆盖系统默认的属性（如果Modifier设置了fontSize，maxFontSize，minFontSize任一属性，则系统设置的大小相关属性不生效，以开发者的设置为准）；  2. 不设该属性或者设置了异常值，则恢复系统默认设置；  3. [Free](#navigationtitlemode枚举说明)模式下设置字体大小时，原有滑动改变标题大小的效果失效。  ****元服务API：**** 从API version 13开始，该接口支持在元服务中使用。 |
| subTitleModifier13+ | [TextModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 子标题属性修改器。  1. 通过Modifier设置的属性会覆盖系统默认的属性（如果Modifier设置了fontSize，maxFontSize，minFontSize任一属性，则系统设置的大小相关属性不生效，以开发者的设置为准）；  2. 不设该属性或者设置了异常值，则恢复系统默认设置。  ****元服务API：**** 从API version 13开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 工具栏背景颜色，不设置时为系统默认颜色。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyle | [BlurStyle](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#blurstyle9) | 否 | 是 | 工具栏背景模糊样式，不设置时关闭背景模糊效果。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyleOptions19+ | [BackgroundBlurStyleOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundblurstyleoptions10对象说明) | 否 | 是 | 工具栏背景模糊选项。  ****说明：****  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。  ****元服务API：**** 从API version 19开始，该接口支持在元服务中使用。 |
| backgroundEffect19+ | [BackgroundEffectOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundeffectoptions11) | 否 | 是 | 设置工具栏背景属性包括：模糊半径，亮度，饱和度，颜色等。  ****说明：****  不建议与backgroundBlurStyleOptions同时使用。  ****元服务API：**** 从API version 19开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundBlurStyle | [BlurStyle](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#blurstyle9) | 否 | 是 | 更多图标的菜单背景模糊样式，不设置时关闭背景模糊效果。 |
| backgroundBlurStyleOptions | [BackgroundBlurStyleOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundblurstyleoptions10对象说明) | 否 | 是 | 更多图标的菜单背景模糊选项。  ****说明：****  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。 |
| backgroundEffect | [BackgroundEffectOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundeffectoptions11) | 否 | 是 | 设置更多图标的菜单背景属性包括：模糊半径，亮度，饱和度，颜色等。  ****说明：****  不建议与backgroundBlurStyleOptions同时使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [SystemBarStyle](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#systembarstyle12) | 状态栏文字颜色。  默认值：'#0xE5FFFFFF' |
...
![](../../../../images/a9399b1c/zh-cn_image_0000002583439707.png)
...
在src/main目录下的[module.json5配置文件](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的module字段里配置"routerMap": "$profile:router\_map"，并在src/main/resources/base/profile目录下新增router\_map.json。router\_map.json示例如下。
...
![](../../../../images/1916f78f/zh-cn_image_0000002552959662.gif)

### 示例3（设置可交互转场动画）

该示例主要演示设置每个[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)子页面的自定义转场动画及可交互转场动画。
...
![](../../../../images/424f7c69/zh-cn_image_0000002583479663.gif)
...
![](../../../../images/0e001546/zh-cn_image_0000002552800014.gif)

### 示例5（设置背景颜色和模糊效果）

该示例主要演示设置Navigation主页的标题栏、工具栏和[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)页面的标题栏的背景颜色和背景模糊效果。
...
![](../../../../images/caa39429/zh-cn_image_0000002583439709.gif)
...
![](../../../../images/2834ab0d/zh-cn_image_0000002552959664.gif)
...
2. [NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)通过[onReady](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onready11)事件能够拿到对应的[NavPathInfo](#navpathinfo10)和所属的[NavPathStack](#navpathstack10)。
...
![](../../../../images/ab8a02ef/zh-cn_image_0000002583479665.gif)

### 示例8（NavDestination生命周期时序）

该示例演示[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)的[onAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#onappear)，[onDisAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#ondisappear)，[onShown](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onshown10)，[onHidden](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onhidden10)，[onWillAppear](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onwillappear12)，[onWillDisappear](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onwilldisappear12)，[onWillShow](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onwillshow12)，[onWillHide](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onwillhide12)接口的生命周期时序。
...
![](../../../../images/4eebab44/zh-cn_image_0000002552800016.gif)
...
![](../../../../images/90a5362b/zh-cn_image_0000002583439711.gif)
...
![](../../../../images/616afce3/zh-cn_image_0000002552959666.gif)

### 示例11（使用Symbol组件）

该示例主要演示Navigation和[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)如何使用Symbol组件。
...
![](../../../../images/8102b2db/zh-cn_image_0000002583479667.gif)

### 示例12（设置自定义标题栏边距）

该示例主要演示Navigation和[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)如何设置自定义标题栏边距，如何通过TextModifier修改主副标题文本样式。
...
![](../../../../images/bf64630f/zh-cn_image_0000002552800018.gif)
...
![](../../../../images/482cd090/zh-cn_image_0000002583439713.gif)
...
此示例在运行前需要在工程配置文件[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的abilities字段里配置"orientation": "auto\_rotation"。
...
![](../../../../images/f9dfb302/zh-cn_image_0000002552959668.gif)
...
在工程配置文件[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的abilities字段里配置"orientation": "landscape"（该工程配置仅方便演示在横屏模式下的Navigation工具栏自适应能力，实际配置可自行设置为"auto\_rotation"）。
...
![](../../../../images/48bcae7e/zh-cn_image_0000002583479669.gif)

### 示例16（Navigation使用NavDestination作为导航页）

该示例展示了Navigation组件通过配置[homeDestination](#navigation20)参数，实现以[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)作为根导航页的效果。
...
![](../../../../images/6f63a695/zh-cn_image_0000002552800020.gif)

### 示例17（使用新增导航控制器方法）

该示例通过设置[setInterception](#setinterception12)方法来实现路由拦截功能，并在[NavDestinationContext](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#navdestinationcontext11)中获取mode。
...
在src/main目录下的工程配置文件[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的module字段里配置"routerMap": "$profile:router\_map"。
...
![](../../../../images/796a432e/zh-cn_image_0000002583439715.gif)

### 示例18（设置Navigation可恢复）

该示例演示如何使用[recoverable](#recoverable14)配置Navigation可恢复，需要开发者在应用模块初始化时启用[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)的备份恢复功能，可参考[UIAbility备份恢复](/ability-kit/stage-model-development/stage-model-application-components/uiability/ability-recover-guideline)。
...
在src/main目录下[module.json5配置文件](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的module字段里配置"routerMap": "$profile:router\_map"，并在src/main/resources/base/profile目录下新增router\_map.json文件。示例如下：
...
![](../../../../images/d1bf9d20/note_3.0-zh-cn.png) 
...
![](../../../../images/caeb9931/zh-cn_image_0000002552959670.gif)
