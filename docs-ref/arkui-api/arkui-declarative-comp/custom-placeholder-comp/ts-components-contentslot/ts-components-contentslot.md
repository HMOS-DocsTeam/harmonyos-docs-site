...
title: "ContentSlot"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-components-contentslot
kit: 应用框架
...
![](../../../../images/d518e12f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [Content](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-content/js-apis-arkui-content) | 定义ComponentContent和NodeContent的基类。 |
