...
title: "Repeat"
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-repeat
kit: 应用框架
...
![](../../../../images/5f97f288/note_3.0-zh-cn.png) 

本模块首批接口从API version 12开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

Repeat基于数组类型数据来进行循环渲染，一般与滚动容器组件配合使用。

本文档仅为API参数说明。组件描述和使用说明见[Repeat开发者指南](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)。
...
![](../../../../images/22bf30c1/note_3.0-zh-cn.png) 
...
除支持[拖拽排序](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/interaction-property/ts-universal-attributes-drag-sorting/ts-universal-attributes-drag-sorting)属性外，还支持以下属性。
...
![](../../../../images/4687dc44/note_3.0-zh-cn.png) 
...
![](../../../../images/08404a29/note_3.0-zh-cn.png) 
...
![](../../../../images/b8bc5912/note_3.0-zh-cn.png) 
...
![](../../../../images/c772bc6c/note_3.0-zh-cn.png) 
...
![](../../../../images/7b75dcb7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| repeatItem | [RepeatItem](#repeatitemt)<T> | 否 | 将item和index结合到一起的一个状态变量。  缺省时默认忽略该参数，请勿在闭包函数的实现中使用该参数，否则会编译报错。 |
...
![](../../../../images/7c849842/note_3.0-zh-cn.png) 
