...
![](../../../../images/08b4fc68/note_3.0-zh-cn.png) 
...
![](../../../../images/c3a91ff8/note_3.0-zh-cn.png) 

该组件重写了通用属性[backgroundColor](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundcolor)，直接添加在Progress组件上，设置进度条的底色。如需设置整个Progress组件的背景色，需要在外层容器上添加backgroundColor，并用该容器包裹Progress组件。
...
从API version 10开始支持利用[LinearGradient](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-datapanel/ts-basic-components-datapanel#lineargradient10)设置Ring样式的渐变色。Ring类型不建议设置透明度，如需设置透明度，建议使用[DataPanel](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-datapanel/ts-basic-components-datapanel)。

从API version 23开始支持利用[LinearGradient](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-datapanel/ts-basic-components-datapanel#lineargradient10)设置Linear样式和Capsule样式的渐变色。API version 22及之前版本利用LinearGradient设置Linear样式和Capsule样式的渐变色时，会以默认主题色显示。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier&lt;ProgressConfiguration&gt;](#progressconfiguration12) | 是 | 在progress组件上，定制内容区的方法。  modifier： 内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
![](../../../../images/1fe03af5/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isPrivacySensitiveMode | [Optional&lt;boolean&gt;](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt) | 是 | 设置隐私敏感，隐私模式下进度清零，文字将被遮罩。true：打开隐私敏感；false：关闭隐私敏感。  默认值：false  ****说明：****  设置null表示不敏感。 |

## ProgressConfiguration12+

进度条配置。继承自[CommonConfiguration](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-content-modifier/ts-universal-attributes-content-modifier#commonconfigurationt)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| enableScanEffect | boolean | 否 | 是 | 扫光效果的开关。仅支持[Linear、Ring、Capsule](#progresstype8枚举说明)类型的进度条。  true：表示开启扫光效果。  false：表示关闭扫光效果。  默认值：false |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。  默认值：4.0vp  超出取值范围按默认值处理。 |
| scaleCount | number | 否 | 是 | 设置环形进度条总刻度数。  默认值：120vp  取值范围：[2, min(width, height)/scaleWidth/2/π]，超出取值范围时，样式显示为环形无刻度进度条。默认情况下宽高最小为77vp。 |
| scaleWidth | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置环形进度条刻度粗细（不支持百分比设置）。刻度粗细大于进度条宽度时，为系统默认粗细。  默认值：2.0vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 内描边颜色。  默认值：  API version 10：'#33006cde'  API version 11及以上：'#33007dff' |
| borderWidth | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 内描边宽度（不支持百分比设置）。  默认值：1vp |
| content | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 文本内容，应用可自定义。  从API version 20开始，支持Resource类型。 |
| font | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 否 | 是 | 文本样式。  默认值：  文本大小（不支持百分比设置）：12fp  其他文本参数跟随[Text](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text)组件的主题值。 |
| fontColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 文本颜色。  默认值：'#ff182431' |
...
| borderRadius18+ | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | Capsule进度条圆角半径（不支持百分比设置）。  取值范围：[0, height/2]。默认值：height / 2。  设置非法数值时，按照默认值处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。当宽度大于等于半径时，宽度默认修改为半径值的二分之一。  默认值：4.0vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。  默认值：4.0vp |
| strokeRadius | [PX](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#px10) | [VP](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#vp10) | [LPX](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#lpx10) | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 设置线性进度条的圆角半径。  取值范围[0, strokeWidth / 2]。默认值：strokeWidth / 2。 |
...
![](../../../../images/e9163521/zh-cn_image_0000002583479913.png)
...
![](../../../../images/4c0af268/zh-cn_image_0000002552800264.png)
...
![](../../../../images/b19ae55f/zh-cn_image_0000002583439959.gif)
...
![](../../../../images/e89c6d0d/zh-cn_image_0000002552959914.png)
...
![](../../../../images/2bc2be44/zh-cn_image_0000002583479915.gif)
...
![](../../../../images/1d6a1306/zh-cn_image_0000002552800266.gif)
...
![](../../../../images/3c6ee28d/zh-cn_image_0000002583439961.gif)
...
![](../../../../images/d6e0f0bb/zh-cn_image_0000002552959916.png)
...
![](../../../../images/dd4189aa/zh-cn_image_0000002583479917.png)
