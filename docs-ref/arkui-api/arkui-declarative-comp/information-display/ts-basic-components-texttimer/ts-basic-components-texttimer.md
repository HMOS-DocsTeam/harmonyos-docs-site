...
![](../../../../images/4ad0e6b7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 字体颜色。  Wearable设备上默认值为：'#c5ffffff'，显示白色。  其他设备上默认值：'#e6182431'，显示黑色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 字体大小。value为Length中的number类型时，单位为fp。字体大小默认为16fp。value为Length中的string类型时，设置值为非数字开头的字符串时，按0fp处理；设置值为数字开头的字符串时，如果数字后内容包含除[像素单位](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units)外的字符（如字母、特殊符号等），则取值字符串开头的数字部分，单位为fp。例如设置值为"abc"时取值为0fp，设置值为"10vp"时取值为10vp，设置值为"10vp11abc"时取值为10fp。不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontstyle) | 是 | 字体样式，例如斜体的字体样式。  默认值：FontStyle.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 字体列表。默认字体为'HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和[注册自定义字体](/ref/arkui-api/arkui-arkts/ui/js-apis-font/js-apis-font)。  卡片当前仅支持'HarmonyOS Sans'字体。 |
...
![](../../../../images/2c8ef7eb/note_3.0-zh-cn.png) 
...
![](../../../../images/cd172f9a/zh-cn_image_0000002583479921.gif)
...
![](../../../../images/be251594/zh-cn_image_0000002552800272.png)
...
![](../../../../images/5df32cf7/zh-cn_image_0000002583439967.gif)
...
![](../../../../images/754c84ac/zh-cn_image_0000002552959922.gif)
...
![](../../../../images/c0ccce78/zh-cn_image_0000002583479923.png)
