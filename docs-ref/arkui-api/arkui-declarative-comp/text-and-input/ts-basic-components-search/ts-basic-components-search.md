...
![](../../../../images/324b6fe4/note_3.0-zh-cn.png) 
...
![](../../../../images/8c7cd3f1/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value8+ | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置当前显示的搜索文本内容。  从API version 10开始，该参数支持[$$](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-two-way-sync)双向绑定变量。  从API version 18开始，该参数支持[!!](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-new-binding#系统组件参数双向绑定)双向绑定变量。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。  从API version 20开始，支持Resource类型。 |
| placeholder8+ | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置无输入时的提示文本。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| icon8+ | string | 否 | 是 | 设置搜索图标路径，默认使用系统搜索图标。  ****说明：****  icon的数据源支持[使用相对路径显示图片](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-basic-components-image/ts-basic-components-image#示例25使用相对路径显示图片)和网络图片。  - 支持的图片格式包括png、jpg、bmp、svg、gif、pixelmap和heif。  - 支持Base64字符串。格式data:image/[png|jpeg|bmp|webp|heif];base64,[base64 data], 其中[base64 data]为Base64字符串数据。  如果与属性searchIcon同时设置，则searchIcon优先。  ****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 搜索框末尾搜索按钮文本内容。  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | placeholder文本颜色。  默认值：'#99182431'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 否 | placeholder文本样式。 |

![](../../../../images/9858470c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 否 | 搜索框内输入文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAlign](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textalign) | 是 | 文本在搜索框中的对齐方式。  默认值：TextAlign.Start |

![](../../../../images/83717dcc/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [IconOptions](#iconoptions10对象说明) | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#symbolglyphmodifier12) | 是 | 左侧搜索图标样式。  浅色模式默认值：  {  size: '16vp',  color: '#99000000',  src: ' '  }  深色模式默认值：  {  size: '16vp',  color: '#99ffffff',  src: ' '  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 输入文本的字体颜色。  默认值：'#FF182431'  Wearable设备上默认值为：'#dbffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CaretStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#caretstyle10) | 是 | 光标样式。  默认值：  {  width: '2.0vp',  color: '#007DFF'  } |

![](../../../../images/f4b0f0a3/note_3.0-zh-cn.png) 
...
![](../../../../images/b0e42e1b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EnterKeyType](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#enterkeytype枚举说明) | 是 | 输入法回车键类型。  默认值：EnterKeyType.Search |
...
![](../../../../images/ff63deda/note_3.0-zh-cn.png) 
...
![](../../../../images/26030e9c/note_3.0-zh-cn.png) 
...
![](../../../../images/8116daaf/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[ColorMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#colormetrics12)> | 是 | 设置分割线颜色。  默认使用系统的主题色：浅色模式下为0x33000000，显示为浅黑色，深色模式下为0x33FFFFFF，显示为浅白色。 |
...
![](../../../../images/12ecde1e/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| size | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 图标尺寸，不支持百分比。 |
| color | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 图标颜色。 |
| src | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 图标/图片源。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontSize | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 文本按钮字体大小，不支持百分比。****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
| fontColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 文本按钮字体颜色。****元服务API：**** 从API version 11开始，该接口支持在元服务中使用。 |
...
| --- | --- | --- | --- | --- |
| style | [CancelButtonStyle](#cancelbuttonstyle10枚举说明) | 否 | 是 | 右侧清除按钮显示状态。 |
| icon | [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#symbolglyphmodifier12) | 否 | 是 | 右侧清除按钮Symbol图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnPasteCallback](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onpastecallback18) | 是 | 粘贴回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnTextSelectionChangeCallback](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ontextselectionchangecallback18) | 是 | 文本选择变化回调或光标位置变化回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContentScrollCallback](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#oncontentscrollcallback18) | 是 | 文本内容滚动回调。 |
...
![](../../../../images/a35bd2a0/note_3.0-zh-cn.png) 
...
![](../../../../images/3f295608/note_3.0-zh-cn.png) 
...
| options | [SelectionOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#selectionoptions12对象说明) | 否 | 选中文字时的配置。  默认值：MenuPolicy.DEFAULT。 |

![](../../../../images/ba5df381/note_3.0-zh-cn.png) 
...
![](../../../../images/4fe76a77/zh-cn_image_0000002583479795.gif)
...
![](../../../../images/13500adb/zh-cn_image_0000002552800146.gif)
...
![](../../../../images/7bf6acae/zh-cn_image_0000002583439841.gif)
...
![](../../../../images/32f68d44/zh-cn_image_0000002552959796.gif)
...
![](../../../../images/f714cd29/zh-cn_image_0000002583479797.png)
...
![](../../../../images/cf204c87/zh-cn_image_0000002552800148.png)
...
![](../../../../images/8794771e/zh-cn_image_0000002583439843.gif)
...
![](../../../../images/b28f0cc0/zh-cn_image_0000002552959798.png)
...
![](../../../../images/73df1af1/zh-cn_image_0000002583479799.png)
...
![](../../../../images/69b8e62e/zh-cn_image_0000002552800150.png)
...
![](../../../../images/51ff6eae/zh-cn_image_0000002583439845.png)
...
![](../../../../images/4a11a9fd/zh-cn_image_0000002552959800.gif)
...
![](../../../../images/4c1b99c1/zh-cn_image_0000002583479801.gif)

### 示例14（设置默认获焦并拉起软键盘）

该示例通过[defaultFocus](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/interaction-property/ts-universal-attributes-focus/ts-universal-attributes-focus#defaultfocus9)（从API version 9开始）、[enableKeyboardOnFocus](#enablekeyboardonfocus10)（从API version 10开始）属性展示如何设置默认获焦并拉起软键盘。
...
![](../../../../images/347dfb97/zh-cn_image_0000002552800152.gif)
...
![](../../../../images/9f5efd21/zh-cn_image_0000002583439847.gif)
...
![](../../../../images/93a318cf/zh-cn_image_0000002552959802.gif)
...
![](../../../../images/1adf91d4/zh-cn_image_0000002583479803.png)
...
![](../../../../images/072f2656/zh-cn_image_0000002552800154.gif)
...
![](../../../../images/1ffe43ea/zh-cn_image_0000002583439849.png) ![](../../../../images/1bab9050/zh-cn_image_0000002552959804.png)
...
![](../../../../images/e7c4b796/zh-cn_image_0000002583479805.png)
...
![](../../../../images/166cd70c/zh-cn_image_0000002552800156.png)
...
![](../../../../images/7e021a5b/zh-cn_image_0000002583439851.jpg)
...
![](../../../../images/ac173d50/zh-cn_image_0000002552959806.jpg)
...
![](../../../../images/25b203ed/zh-cn_image_0000002583479807.gif)
...
![](../../../../images/558eb9c6/zh-cn_image_0000002552800158.gif)
...
![](../../../../images/b6353cc1/zh-cn_image_0000002583439853.png)
...
![](../../../../images/2d94cb9a/zh-cn_image_0000002552959808.gif)
...
![](../../../../images/a2312308/zh-cn_image_0000002583479809.png)
...
![](../../../../images/b057c789/zh-cn_image_0000002552800160.gif)
