...
![](../../../../images/8a34b088/note_3.0-zh-cn.png) 

该组件从API version 7开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

该组件仅支持单文本样式，若需实现富文本样式，建议使用[RichEditor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor)组件。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| placeholder | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置无输入时的提示文本。 |
| text | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 设置输入框当前的文本内容。  建议通过onChange事件将状态变量与文本实时绑定，  避免组件刷新时TextInput中的文本内容异常。  从API version 10开始，该参数支持[$$](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-two-way-sync)双向绑定变量。  从API version 18开始，该参数支持[!!](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-new-binding#系统组件参数双向绑定)双向绑定变量。 |
...
![](../../../../images/72a86bf5/note_3.0-zh-cn.png) 

默认情况下，通用属性[padding](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#padding)的默认值为：
...
当输入框设置padding为0时，可设置[borderRadius](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-border/ts-universal-attributes-border#borderradius)为0避免光标被截断。当光标在文本框边缘显示异常时，请检查是否是padding、borderRadius属性影响造成。

从API version 10开始，单行输入框可设置.width('auto')使组件宽度自适应文本宽度，自适应时组件宽度受constraintSize属性以及父容器传递的最大最小宽度限制，其余使用方式参考[尺寸设置](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size)。
...
![](../../../../images/7d2b9682/note_3.0-zh-cn.png) 

密码填充服务需要特定的输入框类型。如何使用密码填充服务参考[快速适配](/system-security/passwordvault/passwordvault-apps/passwordvault-quick-adaptation)。

设置[密码模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#密码模式)时，装饰线[decoration](#decoration12)、下划线[showUnderline](#showunderline10)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | placeholder文本颜色。  默认值：跟随主题。  Wearable设备上默认值为：'#99ffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#font) | 否 | placeholder文本样式。  Wearable设备上默认值为：18fp |

![](../../../../images/d7730846/note_3.0-zh-cn.png) 

可以使用[loadFontSync](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text#loadfontsync)注册自定义字体。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 输入框光标颜色。  默认值：'#007DFF' |

![](../../../../images/077e1f27/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 字体颜色。  Wearable设备上默认值为：'#dbffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 字体大小。fontSize为number类型时，使用fp单位。字体默认大小16fp。不支持设置百分比字符串。  Wearable设备上默认值为：18fp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontstyle) | 是 | 字体样式。  默认值：FontStyle.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontweight) | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 文本的字体粗细，number类型取值[100, 900]，取值间隔为100，默认为400，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 字体列表。默认字体'HarmonyOS Sans'。  使用多个字体时，请用逗号','分隔，字体的优先级按顺序生效。例如：'Arial,HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和自定义字体。  卡片当前仅支持'HarmonyOS Sans'字体。 |

![](../../../../images/27779b65/note_3.0-zh-cn.png) 

推荐使用[loadFontSync](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text#loadfontsync)注册自定义字体。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 正则表达式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CopyOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#copyoptions9) | 是 | 输入的文本是否可复制。  默认值：CopyOptions.LocalDevice，支持设备内复制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputStyle](#textinputstyle9枚举说明) | [TextContentStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textcontentstyle10) | 是 | 输入框为默认风格或内联输入风格。  默认值：TextInputStyle.Default |
...
可通过[align](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-location/ts-universal-attributes-location#align)属性控制文本段落在垂直方向上的位置。此组件中不可使用align属性控制文本段落在水平方向上的位置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAlign](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textalign) | 是 | 文本在输入框中的水平对齐方式。  默认值：TextAlign.Start |

![](../../../../images/3ce8109f/note_3.0-zh-cn.png) 

textAlign只能调整文本整体的布局，不影响字符的显示顺序。若需要调整字符的显示顺序，请参考[镜像状态字符对齐](/arkui/arkts-ui-development/arkts-internationalization#镜像状态字符对齐)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | [TextDirection](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#textdirection22) | undefined | 是 | 文本排版方向。  设置为undefined时，按照TextDirection.DEFAULT处理，表现为文本排版方向遵循组件布局方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 文本选中底板颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CaretStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#caretstyle10) | 是 | 光标的风格。 |

![](../../../../images/ac17c841/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 文本输入时，文本框的显示单位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | undefined | 否 | 错误状态下提示的错误文本或者不显示错误状态。  默认不显示错误状态。  Wearable设备上字体大小为：13fp，对齐方式为：居中对齐  ****说明：****  从API version 12开始，value支持Resource类型。 |
...
![](../../../../images/c05f6591/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BarState](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#barstate) | 是 | 内联输入风格编辑态时滚动条的显示模式。  默认值：BarState.Auto |
...
当设置自定义键盘时，可以通过绑定[onKeyPreIme](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-key/ts-universal-events-key#onkeypreime12)事件规避物理键盘的输入。

从API version 23开始，自定义键盘可以通过[setCustomKeyboardContinueFeature](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#setcustomkeyboardcontinuefeature23)开启接续，在切换至其他自定义键盘时，会直接切换，不会触发键盘关闭和拉起动画。

![](../../../../images/c8a98841/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent#componentcontent-1)22+ | undefined22+ | 是 | 自定义键盘。设定值为undefined时，关闭自定义键盘。 |
| options12+ | [KeyboardOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor#keyboardoptions12) | 否 | 设置自定义键盘是否支持避让功能。 |
...
需要[CopyOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#copyoptions9)为CopyOptions.LocalDevice或CopyOptions.CROSS\_DEVICE时，本功能生效。
...
具体使用指导请参考[为应用添加自动生成高强度密码的建议](/system-security/passwordvault/passwordvault-apps/passwordvault-autofill/passwordvault-custom-strong-password-rules)。
...
设置右侧清除按钮样式，仅支持图片类型的图标。不支持[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)。示例请参考[示例4（设置右侧清除按钮样式）](#示例4设置右侧清除按钮样式)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CancelButtonOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-search/ts-basic-components-search#cancelbuttonoptions12对象说明) | 是 | 右侧清除按钮样式选项。  默认值：  {  style: CancelButtonStyle.INPUT  }  Wearable设备上默认值为：28vp |

### selectAll11+

selectAll(value: boolean)

设置初始状态时，是否全选文本。不支持[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)。
...
| options | [InputCounterOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#inputcounteroptions11对象说明) | 否 | 计数器的配置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | [UnderlineColor](#underlinecolor12对象说明) | undefined | 是 | 设置下划线颜色。  当设置下划线颜色模式时，修改下划线颜色。当只设定非特殊状态下的颜色，可以直接输入ResourceColor。设定值为undefined、null、无效值时，所有下划线恢复为默认值。  默认值：主题配置的下划线颜色。主题配置的默认下划线颜色为'#33182431'。 |
...
![](../../../../images/68b96831/note_3.0-zh-cn.png) 

- 特殊字符字体高度远超出同行的其他字符高度时，文本框出现截断、遮挡、内容相对位置发生变化等不符合预期的显示异常，需要开发者调整组件高度、行高等属性，修改对应的页面布局。
- 设置[密码模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#密码模式)时，通过该接口设置行高[lineHeight](#lineheight12)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 文本的文本行高。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextDecorationOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#textdecorationoptions12对象说明) | 是 | 文本装饰线对象。  默认值：{  type: TextDecorationType.None,  color: Color.Black,  style: TextDecorationStyle.SOLID  } |

![](../../../../images/a34d03e6/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 文本字符间距。  单位：[fp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units) |
...
Font Feature当前支持的属性见[fontFeature属性列表](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#fontfeature12)。

设置Font Feature属性，Font Feature是OpenType字体的高级排版能力，如支持连字、数字等宽等特性，一般用在自定义字体中，其能力需要字体本身支持。

更多Font Feature能力介绍可参考`https://www.w3.org/TR/css-fonts-3/#font-feature-settings-prop和https://sparanoid.com/lab/opentype-features/`。

![](../../../../images/1ee80c86/note_3.0-zh-cn.png) 

设置[密码模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#密码模式)时，不支持通过fontFeature设置文本样式。

### wordBreak12+

wordBreak(value: WordBreak)

设置文本断行规则。该属性在组件设置[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)时样式生效，但对placeholder文本无效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [WordBreak](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#wordbreak11) | 是 | 内联输入风格编辑态时断行规则。  默认值：WordBreak.BREAK\_WORD |

![](../../../../images/ea915937/note_3.0-zh-cn.png) 
...
设置文本超长时的显示方式。仅在[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)的编辑态、非编辑态下支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextOverflow](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textoverflow) | 是 | 文本超长时的显示方式。  [内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)非编辑态下默认值：TextOverflow.Ellipsis  内联模式编辑态下默认值：TextOverflow.Clip |

![](../../../../images/a79ec0cd/note_3.0-zh-cn.png) 

TextInput组件不支持设置TextOverflow.MARQUEE模式，当设置为TextOverflow.MARQUEE模式时，[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)非编辑态下显示为TextOverflow.Ellipsis，内联模式编辑态下以及非内联模式下显示为TextOverflow.Clip。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 是 | 首行文本缩进。  默认值：0 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 文本最小显示字号。  单位：[fp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 文本最大显示字号。  单位：[fp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units) |
...
![](../../../../images/778e8a9f/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextHeightAdaptivePolicy](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#textheightadaptivepolicy10) | 是 | 文本自适应高度的方式。  默认值：TextHeightAdaptivePolicy.MAX\_LINES\_FIRST |
...
当[输入框的类型](#inputtype枚举说明)设置为Password、NEW\_PASSWORD和NUMBER\_PASSWORD模式时，密码保护功能才能生效。非密码输入模式则不会触发该功能。

[密码模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#密码模式)时，由于输入框后端的状态和前端应用侧的状态管理变量会不一致，可能导致末尾图标的状态异常。建议在[onSecurityStateChange](#onsecuritystatechange12)上增加状态同步。参考[示例1（设置与获取光标位置）](#示例1设置与获取光标位置)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [LineBreakStrategy](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#linebreakstrategy12) | 是 | 文本的折行规则。  默认值：LineBreakStrategy.GREEDY  ****说明：****  仅设置[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)时该属性生效。 |
...
![](../../../../images/51e5dd7f/note_3.0-zh-cn.png) 
...
开启触控反馈时，需要在工程的[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中配置requestPermissions字段以开启振动权限，配置如下：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AutoCapitalizationMode](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#autocapitalizationmode20枚举说明) | 是 | 自动大小写模式，默认状态无效。 |

### keyboardAppearance15+

keyboardAppearance(appearance: Optional&lt;KeyboardAppearance&gt;)

设置输入框拉起的键盘样式，需要输入法适配后生效。具体参考[输入法应用沉浸模式](/ime-kit/inputmethod-immersive-mode-guide)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appearance | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[KeyboardAppearance](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#keyboardappearance15枚举说明)> | 是 | 键盘样式。  默认值：KeyboardAppearance.NONE\_IMMERSIVE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12)> | 是 | 文本描边的宽度。当LengthMetrics的单位为px时，  若设置值小于0，显示实心字；若大于0，显示空心字。  默认值为0，不做描边处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)> | 是 | 描边颜色。默认值为字体颜色，设置异常值时取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| halfLeading | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 设置文本是否垂直居中。  true表示将行间距平分至行的顶部与底部，false则不平分。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)> | 是 | 文本最小的字体缩放倍数，支持undefined类型。  取值范围：[0, 1]  ****说明：****  设置的值小于0时，按值为0处理。设置的值大于1，按值为1处理。异常值默认不生效。  使用前需在工程中配置[configuration.json](/development-fundamentals/application-configuration-file-stage/app-configuration-file#configuration标签)文件和[app.json5](/development-fundamentals/application-configuration-file-stage/app-configuration-file)文件，具体详见[示例18设置最小字体范围与最大字体范围](#示例18设置最小字体范围与最大字体范围)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)> | 是 | 文本最大的字体缩放倍数，支持undefined类型。  取值范围：[1, +∞)  ****说明：****  设置的值小于1时，按值为1处理。异常值默认不生效。  当设置maxFontScale属性后，showError最多放大到2倍。  使用前需在工程中配置[configuration.json](/development-fundamentals/application-configuration-file-stage/app-configuration-file#configuration标签)文件和[app.json5](/development-fundamentals/application-configuration-file-stage/app-configuration-file)文件，具体详见[示例18设置最小字体范围与最大字体范围](#示例18设置最小字体范围与最大字体范围)。 |

### cancelButton18+

cancelButton(symbolOptions: CancelButtonSymbolOptions)

设置右侧清除按钮样式，仅支持symbol图标。不支持[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)。示例请参考[示例15（设置symbol类型清除按钮）](#示例15设置symbol类型清除按钮)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| symbolOptions | [CancelButtonSymbolOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-search/ts-basic-components-search#cancelbuttonsymboloptions12对象说明) | 是 | 右侧清除按钮样式。  默认值：  {  style: CancelButtonStyle.INPUT  } |

### ellipsisMode18+

ellipsisMode(mode: Optional&lt;EllipsisMode&gt;)

设置省略位置。ellipsisMode属性仅在[内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)下生效，需要配合overflow设置为TextOverflow.Ellipsis使用，单独设置ellipsisMode属性不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[EllipsisMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#ellipsismode11)> | 是 | 省略位置。  默认值：EllipsisMode.END |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 是否启用自动填充动效。  true表示启用，false表示不启用。  默认值：true  ****说明：****  启用之后，仅输入模式[InputType](#inputtype枚举说明)设置为Password、NEW\_PASSWORD或NUMBER\_PASSWORD的输入框在进行自动填充时动效可生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 是否开启中文与西文的自动间距。  true为开启自动间距，false为不开启。  默认值：false |
...
![](../../../../images/3f350839/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SelectedDragPreviewStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#selecteddragpreviewstyle23对象说明) | undefined | 是 | 文本拖拽时的背板样式。  设置为undefined时：背板颜色跟随主题，浅色模式显示白色，深色模式显示黑色。 |
...
| Inline | 内联输入风格。文本选中底板高度与输入框高度相同。  内联输入是在有明显的编辑态/非编辑态的区分场景下使用，例如：文件列表视图中的重命名。  不支持showError属性。  [内联模式](/arkui/arkts-ui-development/arkts-use-text/arkts-common-components-text-input#内联模式)下，不支持拖入文本。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onIconSrc | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 密码输入模式时，能够切换密码可见时显示的图标。  string格式可用于加载网络图片和本地图片。 |
| offIconSrc | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | 是 | 密码输入模式时，能够切换密码不可见时显示的图标。  string格式可用于加载网络图片和本地图片。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [EditableTextOnChangeCallback](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#editabletextonchangecallback12) | 是 | 当前输入文本内容变化时的回调。 |
...
![](../../../../images/53c28170/note_3.0-zh-cn.png) 
...
![](../../../../images/40f25f42/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[InsertValue](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#insertvalue12对象说明), boolean&gt; | 是 | 在将要输入时调用的回调。  在返回true时，表示正常插入，返回false时，表示不插入。  在预上屏和候选词操作时，该回调不触发。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[InsertValue](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#insertvalue12对象说明)&gt; | 是 | 在输入完成时调用的回调。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[DeleteValue](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#deletevalue12对象说明), boolean&gt; | 是 | 在将要删除时调用的回调。  在返回true时，表示正常删除，返回false时，表示不删除。  在预上屏删除操作时，该回调不触发。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[DeleteValue](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#deletevalue12对象说明)&gt; | 是 | 在删除完成时调用的回调。  仅支持系统输入法输入的场景。 |

![](../../../../images/b3f26b46/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[EditableTextChangeValue](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#editabletextchangevalue15), boolean&gt; | 是 | 在文本内容将要发生变化时的回调。  返回true时，表示正常修改。返回false时，表示拦截此次触发。 |
...
从API version 22开始，调用[IMEClient](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#imeclient20对象说明)的[setExtraConfig](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#setextraconfig22)方法可以设置输入法扩展信息。在绑定输入法成功后，输入法会收到扩展信息，输入法可以依据此信息实现自定义功能。

IMEClient仅在onWillAttachIME执行期间有效，不可进行异步调用。

![](../../../../images/2544df21/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[IMEClient](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#imeclient20对象说明)&gt; | 是 | 在输入框将要绑定输入法前触发该回调。 |

## TextInputController8+

TextInput组件的控制器继承自[TextContentControllerBase](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#textcontentcontrollerbase)，涉及的接口有[getTextContentRect](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#gettextcontentrect)、[getTextContentLineCount](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#gettextcontentlinecount)、[getCaretOffset](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#getcaretoffset11)、[addText](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#addtext15)、[deleteText](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#deletetext15)、[getSelection](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#getselection15)、[clearPreviewText](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#clearpreviewtext17)、[setStyledPlaceholder](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#setstyledplaceholder22)、[deleteBackward](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#deletebackward23)。
...
| options12+ | [SelectionOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#selectionoptions12对象说明) | 否 | 选中文字时的配置。  默认值：MenuPolicy.DEFAULT  从API version 12开始，该接口中的options参数支持在元服务中使用。 |

![](../../../../images/d73ec910/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| typing | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | undefined | 否 | 是 | 键入时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
| normal | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | undefined | 否 | 是 | 非特殊状态时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
| error | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | undefined | 否 | 是 | 错误时下划线颜色。不填写、undefined、null、无效值时恢复默认。此选项会修改showCounter属性中达到最大字符数时的颜色。 |
| disable | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | undefined | 否 | 是 | 禁用时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
...
| event | [PasteEvent](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor#pasteevent11) | 是 | 用户自定义的粘贴事件。 |
...
![](../../../../images/7483211b/zh-cn_image_0000002583439807.gif)
...
![](../../../../images/2171d9a6/zh-cn_image_0000002552959762.png)

### 示例3（设置自定义键盘）

该示例通过[customKeyboard](#customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8)和[ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent#componentcontent-1)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](#customkeyboard10)属性新增了入参类型[ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent#componentcontent-1)。
...
![](../../../../images/9bacdb40/zh-cn_image_0000002583479763.gif)
...
![](../../../../images/93ad65ee/zh-cn_image_0000002552800114.png)
...
![](../../../../images/1ce59f25/zh-cn_image_0000002583439809.jpg)
...
![](../../../../images/ddff73a6/zh-cn_image_0000002552959764.png)
...
![](../../../../images/9d171a3b/zh-cn_image_0000002583479765.png)
...
![](../../../../images/37f24ae2/zh-cn_image_0000002552800116.png)
...
![](../../../../images/b4f6facb/zh-cn_image_0000002583439811.png)

### 示例10（自定义键盘避让）

该示例通过[customKeyboard](#customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor#keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
![](../../../../images/6a53d4f9/zh-cn_image_0000002552959766.gif)
...
![](../../../../images/ebd002a7/zh-cn_image_0000002583479767.png)
...
![](../../../../images/d2cae745/zh-cn_image_0000002552800118.gif)
...
![](../../../../images/52a273ed/zh-cn_image_0000002583439813.png)

### 示例14（文本扩展自定义菜单）

从API version 12开始，该示例通过[editMenuOptions](#editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
![](../../../../images/81933d30/zh-cn_image_0000002552959768.png)
...
![](../../../../images/4ff655e1/zh-cn_image_0000002583479769.jpg)
...
![](../../../../images/dac2c284/zh-cn_image_0000002552800120.png)
...
![](../../../../images/6d62d8d4/zh-cn_image_0000002583439815.png)
...
![](../../../../images/e00614bb/zh-cn_image_0000002552800122.png)
...
![](../../../../images/ed49ee67/zh-cn_image_0000002583439817.png)
...
![](../../../../images/f6d749ce/zh-cn_image_0000002552959772.png)
...
![](../../../../images/2cc4e721/zh-cn_image_0000002583479773.gif)

### 示例23（设置placeholder富文本样式）

从API version 22开始，该示例通过[setStyledPlaceholder](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#setstyledplaceholder22)接口设置placeholder富文本样式。
...
![](../../../../images/9346227a/zh-cn_image_0000002552800124.jpg)

### 示例24（设置输入法扩展信息）

从API version 22开始，该示例通过[IMEClient](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#imeclient20对象说明)的setExtraConfig设置输入法扩展信息。
...
![](../../../../images/f1750733/zh-cn_image_0000002583439819.gif)
...
![](../../../../images/c34a2166/zh-cn_image_0000002552959774.gif)
...
![](../../../../images/e678b57e/zh-cn_image_0000002583479775.gif)
...
![](../../../../images/dcd2bc8f/zh-cn_image_0000002552800126.png)

### 示例29（删除文本框内的最后一个字符）

该示例通过调用[deleteBackward](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#deletebackward23)接口删除文本框内最后一个字符。

从API version 23开始，新增[deleteBackward](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#deletebackward23)接口。
...
![](../../../../images/0ae7b2ef/zh-cn_image_0000002583439821.gif)
...
![](../../../../images/6e046609/zh-cn_image_0000002552959776.png)

### 示例31（将指定范围的文字滚动到可视区内）

本示例通过[scrollToVisible](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-attributes-text-style/ts-universal-attributes-text-style#scrolltovisible23)将可视区外的文本滚动到可视区内。
...
![](../../../../images/e05cb69c/zh-cn_image_0000002583479777.gif)
