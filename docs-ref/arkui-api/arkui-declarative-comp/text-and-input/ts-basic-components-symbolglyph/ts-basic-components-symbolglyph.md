...
title: "SymbolGlyph"
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-symbolglyph
kit: 应用框架
...
![](../../../../images/e6f8bf94/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 否 | SymbolGlyph组件的资源名，如 $r('sys.symbol.ohos\_wifi')。 |

![](../../../../images/8e3c19a5/note_3.0-zh-cn.png) 
...
![](../../../../images/a336624b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array&lt;[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)&gt; | 是 | SymbolGlyph组件颜色。  默认值：不同渲染策略下默认值不同。 |
...
![](../../../../images/8fc1fedd/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | SymbolGlyph组件大小。  默认值：16fp  单位：[fp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units)  不支持设置百分比字符串。 |
...
![](../../../../images/930e0d95/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontweight) | string | 是 | SymbolGlyph组件粗细。  默认值：FontWeight.Normal |
...
![](../../../../images/dc4513e6/note_3.0-zh-cn.png) 
...
![](../../../../images/5e6c4075/zh-cn_image_0000002552959816.png)
...
![](../../../../images/0efb6758/note_3.0-zh-cn.png) 
...
![](../../../../images/8f1d2741/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)> | 是 | SymbolGlyph组件最小的字体缩放倍数。  取值范围：[0, 1]  设置为0，缩放最小。  ****说明：****  设置的值小于0时，按值为0处理。设置的值大于1，按值为1处理。异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)> | 是 | SymbolGlyph组件最大的字体缩放倍数。  取值范围：[1, +∞)  ****说明：****  设置的值小于1时，按值为1处理，异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shader | Array&lt;[ShaderStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#shaderstyle20) | undefined> | [ShaderStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#shaderstyle20) | 是 | 径向渐变或线性渐变或纯色。  传入ShaderStyle时，覆盖所有层；传入数组时，数据项是ShaderStyle，则应用该层；数组项是undefined，则该层使用SymbolGlyph默认颜色，未设置的层也应用默认颜色。根据传入的参数区分处理径向渐变[RadialGradientStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#radialgradientstyle20)或线性渐变[LinearGradientStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#lineargradientstyle20)或纯色[ColorShaderStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#colorshaderstyle20)，最终设置到SymbolGlyph组件上显示为渐变色效果。  ****说明：****  单位：[vp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units)  中心点请按百分比使用。如果使用的是非百分比（例如10PX），效果等同于设置1000%。  半径建议使用百分比。  百分比是基于图标大小的百分比，建议取值范围[0, 1)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shadow | [Optional](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-custom-property/ts-universal-attributes-custom-property#optionalt)<[ShadowOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-image-effect/ts-universal-attributes-image-effect#shadowoptions对象说明)> | 是 | SymbolGlyph组件的阴影效果。  单位：[vp](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-pixel-units/ts-pixel-units)  默认值：{  radius：0,  color：Color.Black,  offsetX：0,  offsetY：0  }  不支持fill、type属性和color中的ColoringStrategy枚举值。 |
...
![](../../../../images/0260fc0d/zh-cn_image_0000002583439863.gif)
...
![](../../../../images/7618cc39/zh-cn_image_0000002552959818.gif)
...
![](../../../../images/1cea208f/zh-cn_image_0000002583479819.jpeg)
