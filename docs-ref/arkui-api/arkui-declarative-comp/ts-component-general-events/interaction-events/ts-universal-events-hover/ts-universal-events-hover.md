...
![](../../../../../images/4bea5258/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x15+ | number | 否 | 是 | 鼠标光标或手写笔位置在当前组件为基准的[组件坐标系](/arkui/arkui-glossary#组件坐标系)中的X坐标。  单位：vp  取值范围：[0, +∞)  ****元服务API：**** 从API version 15开始，该接口支持在元服务中使用。 |
| y15+ | number | 否 | 是 | 鼠标光标或手写笔位置在当前组件为基准的[组件坐标系](/arkui/arkui-glossary#组件坐标系)中的Y坐标。  单位：vp  取值范围：[0, +∞)  ****元服务API：**** 从API version 15开始，该接口支持在元服务中使用。 |
...
| globalDisplayX20+ | number | 否 | 是 | 鼠标光标或手写笔位置在[全局坐标系](/arkui/window-manager/window-terminology#全局坐标系)中的X坐标。  单位：vp  取值范围：[0, +∞)  ****元服务API：**** 从API version 20开始，该接口支持在元服务中使用。 |
| globalDisplayY20+ | number | 否 | 是 | 鼠标光标或手写笔位置在[全局坐标系](/arkui/window-manager/window-terminology#全局坐标系)中的Y坐标。  单位：vp  取值范围：[0, +∞)  ****元服务API：**** 从API version 20开始，该接口支持在元服务中使用。 |
...
![](../../../../../images/d210f96f/zh-cn_image_0000002583439515.png)

手写笔悬浮时改变文本内容与背景颜色：

![](../../../../../images/35f80c86/zh-cn_image_0000002552959470.png)
...
![](../../../../../images/534b34d0/zh-cn_image_0000002583479471.png)
