...
title: "ArcSlider"
sidebar_position: 15
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcslider
kit: 应用框架
last_updated: "2026-04-22"
slug: ohos-arkui-advanced-arcslider
---
...
![](../../../../images/31a9073b/note_3.0-zh-cn.png) 
...
| digitalCrownSensitivity | [CrownSensitivity](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#crownsensitivity18) | 否 | 是 | 设置旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM  ****装饰器类型：**** @Trace |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明) | 是 | 获得TouchEvent对象。 |
...
| digitalCrownSensitivity | [CrownSensitivity](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#crownsensitivity18) | 否 | 是 | 设置旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM |
...
![](../../../../images/4330e88a/zh-cn_image_0000002583479733.gif)
