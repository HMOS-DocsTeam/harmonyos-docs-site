...
![](../../../../../images/27a4bfaf/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| level | [ClickEffectLevel](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#clickeffectlevel10) | 否 | 否 | 设置当前组件的点击回弹效果。  默认值：ClickEffectLevel.LIGHT  ****说明：****  当level为undefined或者null时， ClickEffect采用ClickEffectLevel.LIGHT对应的回弹效果，缩放比参照scale说明。 |
...
![](../../../../../images/b031c47b/zh-cn_image_0000002583479525.gif)
