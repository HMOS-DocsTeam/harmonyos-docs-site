...
title: "组件内容模糊"
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style
kit: 应用框架
last_updated: "2026-04-22"
slug: ts-universal-attributes-foreground-blur-style
---
...
![](../../../../../images/ee7bff10/note_3.0-zh-cn.png) 
...
![](../../../../../images/76f60f69/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlurStyle](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#blurstyle9) | 是 | 内容模糊样式。 |
...
![](../../../../../images/fef9917b/note_3.0-zh-cn.png) 

foregroundBlurStyle接口为实时模糊接口，每帧执行实时渲染，性能负载较大。当模糊内容与模糊半径均无需变动时，推荐采用静态模糊接口[blur](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-effectkit/js-apis-effectkit#blur)。最佳实践请参考：[图像模糊动效优化-使用场景](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-fuzzy-scene-performance-optimization#section4945532519)。
...
![](../../../../../images/886d9797/zh-cn_image_0000002583439569.png)
