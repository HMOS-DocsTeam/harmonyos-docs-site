...
设置组件由缩放大小或位移变化引起的运动过程中的动态模糊效果。需要与动画的[AnimateParam](/ref/arkui-api/arkui-declarative-comp/animation/ts-explicit-animation/ts-explicit-animation#animateparam对象说明)的onFinish参数配合使用。

![](../../../../../images/ecf50028/note_3.0-zh-cn.png) 
...
![](../../../../../images/141db3a8/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| motionBlur | Optional&lt;[MotionBlurOptions](#motionbluroptions对象说明)&gt; | 是 | 定义运动模糊参数。  当motionBlur的值为undefined时，维持之前取值。 |
...
![](../../../../../images/25d6fa86/zh-cn_image_0000002552959524.gif)
