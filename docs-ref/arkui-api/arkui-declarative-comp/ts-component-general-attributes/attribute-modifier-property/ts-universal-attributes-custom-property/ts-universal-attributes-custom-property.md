...
![](../../../../../images/44c858af/note_3.0-zh-cn.png) 
...
设置组件的自定义属性。[自定义组件](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-create-custom-components)不支持设置自定义属性。
...
在[Column](/ref/arkui-api/arkui-declarative-comp/rows-columns-and-stacking/ts-container-column/ts-container-column)组件上设置自定义属性，并在其对应的[FrameNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode#framenode-1)上获取所设置的自定义属性。
