...
设置组件的响应热区。在ArkUI开发框架中，处理触屏事件和鼠标事件时，会在事件触发前进行按压点与组件响应热区的[触摸测试](/arkui/arkts-ui-development/arkts-interaction-development-guide-overview/arkts-interaction-basic-principles#触摸测试)，以收集需响应事件的组件。基于测试结果，框架会分发相应的事件。影响[点击事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click)、[触摸事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch)、[拖拽事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop)、[鼠标事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-mouse-key/ts-universal-mouse-key)、[轴事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-axis/ts-universal-events-axis)、[悬浮事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-hover/ts-universal-events-hover)、[无障碍悬浮事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/accessibility-related/ts-universal-accessibility-hover-event/ts-universal-accessibility-hover-event)和[手势事件](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesture-settings/ts-gesture-settings)的分发。

![](../../../../../../images/f41e880d/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 触摸点相对于组件左上角的x轴坐标。  默认值：0vp |
| y | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 触摸点相对于组件左上角的y轴坐标。  默认值：0vp |
| width | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 触摸热区的宽度。  默认值：'100%' |
| height | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 否 | 是 | 触摸热区的高度。  默认值：'100%' |

![](../../../../../../images/d0e7165c/note_3.0-zh-cn.png) 
...
- 百分比相对于组件自身宽高进行计算。
- 当父组件设置[clip](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)(true)时，子组件的响应会受到父组件触摸热区的影响，不在父组件触摸热区内的子组件无法响应手势和事件。
...
![](../../../../../../images/b1efe0f5/note_3.0-zh-cn.png) 

- 当父组件设置[clip](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-sharp-clipping/ts-universal-attributes-sharp-clipping#clip12)为true时，子组件的响应会受到父组件触摸热区的影响，不在父组件触摸热区内的子组件无法响应手势和事件。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| tool | [ResponseRegionSupportedTool](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#responseregionsupportedtool22) | 否 | 是 | 触摸热区适用的输入工具类型。  默认值：ResponseRegionSupportedTool.ALL |
| x | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 触摸点相对于组件左上角的x轴坐标。  默认值：LengthMetrics.vp(0) |
| y | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 触摸点相对于组件左上角的y轴坐标。  默认值：LengthMetrics.vp(0) |
| width | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | string | 否 | 是 | 触摸热区的宽度。  默认值：LengthMetrics.percent(1) |
| height | [LengthMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetrics12) | string | 否 | 是 | 触摸热区的高度。  默认值：LengthMetrics.percent(1) |
...
![](../../../../../../images/3e627ed0/zh-cn_image_0000002583479543.gif)
...
![](../../../../../../images/e3c87c28/zh-cn_image_0000002552799894.gif)

### 示例3（设置鼠标的触摸热区以响应点击事件）

该示例通过[mouseResponseRegion](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/interaction-property/touch-interactions/ts-universal-attributes-touch-target/ts-universal-attributes-touch-target#mouseresponseregion10)设置鼠标的触摸热区以响应点击事件。
...
![](../../../../../../images/885abcd1/zh-cn_image_0000002583439589.gif)
