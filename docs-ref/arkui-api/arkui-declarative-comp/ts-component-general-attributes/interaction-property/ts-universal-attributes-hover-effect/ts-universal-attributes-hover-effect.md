...
![](../../../../../images/246115dc/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [HoverEffect](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#hovereffect8) | 是 | 设置当前组件悬浮态下的悬浮效果。 |
...
![](../../../../../images/c25aae35/zh-cn_image_0000002552959542.gif)
