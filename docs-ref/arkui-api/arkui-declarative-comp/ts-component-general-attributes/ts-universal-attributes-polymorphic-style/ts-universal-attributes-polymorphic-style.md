...
![](../../../../images/7c266de5/note_3.0-zh-cn.png) 

- 从API version 8开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
- 从API version 11开始支持另一种写法[attributeModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier)，可根据开发者需要动态设置属性。
- 多态样式仅支持[通用属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-component-general-attributes)。如果多态样式不生效，则该属性可能为组件的私有属性，例如：fontColor、[TextInput](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput)组件的[backgroundColor](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundcolor18)等。此时，可以通过attributeModifier动态设置组件属性来解决此问题。
...
- 多态样式的焦点态只有在[焦点激活态](/arkui/arkts-ui-development/arkts-interaction-development-guide-overview/arkts-common-events-focus-event#基础概念)开启时生效。
...
![](../../../../images/5fee4eda/note_3.0-zh-cn.png) 
...
- 当前多态样式的选中状态样式依赖组件选中属性值，可以使用[点击事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click)修改属性值，或使用属性自带[$$](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-syntactic-sugar/arkts-two-way-sync)双向绑定功能。
...
![](../../../../images/784875c7/zh-cn_image_0000002583439591.gif)
...
![](../../../../images/19ce8b49/zh-cn_image_0000002552959546.gif)
...
![](../../../../images/958b64a9/zh-cn_image_0000002583479547.gif)
