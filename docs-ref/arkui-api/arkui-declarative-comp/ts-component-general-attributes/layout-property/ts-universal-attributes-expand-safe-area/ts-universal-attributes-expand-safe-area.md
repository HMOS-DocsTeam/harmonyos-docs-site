...
![](../../../../../images/581a4da3/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[SafeAreaType](#safeareatype)> | 否 | 配置扩展安全区域的类型。未添加[Metadata](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-metadata/js-apis-bundlemanager-metadata)配置项时，页面不避让挖孔，CUTOUT类型不生效。  默认值：[SafeAreaType.SYSTEM, SafeAreaType.CUTOUT, SafeAreaType.KEYBOARD]  非法值：按默认值处理。 |
| edges | Array <[SafeAreaEdge](#safeareaedge)> | 否 | 配置扩展安全区域的边缘。  默认值：[SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM, SafeAreaEdge.START, SafeAreaEdge.END]  非法值：按默认值处理。  扩展至所有避让区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-e/arkts-apis-uicontext-e#keyboardavoidmode11) | 是 | 配置虚拟键盘抬起时页面的避让模式。  默认值：KeyboardAvoidMode.OFFSET，键盘抬起时默认避让模式为上抬。  setKeyboardAvoidMode传入异常值时，该属性设置不生效。 |

![](../../../../../images/fea4b686/note_3.0-zh-cn.png) 
...
| 名称 | 说明 |
| --- | --- |
| [KeyboardAvoidMode](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-e/arkts-apis-uicontext-e#keyboardavoidmode11) | 返回虚拟键盘抬起时的页面避让模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[LayoutSafeAreaType](#layoutsafeareatype12)> | 否 | 扩展布局安全区域的类型。  默认值：[LayoutSafeAreaType.SYSTEM]，扩展至所有安全区域，比如：状态栏，导航栏和组件级安全区（[safeAreaPadding](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#safeareapadding14)）。  非法值：按默认值处理。 |
| edges | Array <[LayoutSafeAreaEdge](#layoutsafeareaedge12)> | 否 | 扩展布局安全区的边缘，并且支持镜像能力。  默认值：[LayoutSafeAreaEdge.ALL]，扩展组件所有边缘。  非法值：按默认值处理。 |
...
![](../../../../../images/1c5c1e91/note_3.0-zh-cn.png) 

忽略布局安全区边缘的组件，如果其宽度或高度设置了[LayoutPolicy.matchParent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#layoutpolicy15)，其大小和位置都会改变，否则仅改变其位置。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| SYSTEM | 0 | 设置后，组件的布局范围可扩展至组件级安全区（[safeAreaPadding](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#safeareapadding14)）和页面级安全区（状态栏、导航栏、挖孔区）。 |
...
![](../../../../../images/1236cb1c/zh-cn_image_0000002552959496.png)
...
![](../../../../../images/0c512cba/zh-cn_image_0000002583479497.png)
...
![](../../../../../images/0b8104a8/zh-cn_image_0000002552799848.gif)
...
![](../../../../../images/ca404a54/zh-cn_image_0000002583439543.gif)
...
![](../../../../../images/08737ef0/zh-cn_image_0000002552959498.gif)
...
![](../../../../../images/f24b0da3/zh-cn_image_0000002583479499.gif)
...
![](../../../../../images/7d0f0f98/zh-cn_image_0000002552799850.png)
...
![](../../../../../images/e918a67c/zh-cn_image_0000002583439545.jpg)

### 示例9（ignoreLayoutSafeArea配合LayoutPolicy.matchParent延伸组件布局范围）

该示例利用[ignoreLayoutSafeArea](#ignorelayoutsafearea20)和[LayoutPolicy.matchParent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#layoutpolicy15)同时改变组件大小和位置。相比未使用该属性，配置ignoreLayoutSafeArea后，Row组件基于Stack内容区、Stack组件级安全区，取其右下部分并撑满可用空间。
...
![](../../../../../images/e62451c5/zh-cn_image_0000002552959500.jpg)
...
![](../../../../../images/b0761b78/zh-cn_image_0000002583479501.jpg)
