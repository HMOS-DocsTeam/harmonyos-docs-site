...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-mediaquery
kit: 应用框架
...
![](../../../../images/ce60e102/note_3.0-zh-cn.png) 

- 从API version 7 开始，该接口不再维护，推荐使用新接口[@ohos.mediaquery](/ref/arkui-api/arkui-arkts/ui/js-apis-mediaquery/js-apis-mediaquery)。
...
| 类型 | 说明 |
| --- | --- |
| [MediaQueryList](/ref/arkui-api/arkui-arkts/arkui-arkts-dep/js-apis-system-mediaquery/js-apis-system-mediaquery#mediaquerylist) | 表示创建MediaQueryList对象的属性，详情见下表说明。 |
