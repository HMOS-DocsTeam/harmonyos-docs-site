...
![](../../../../images/8044ca2a/note_3.0-zh-cn.png) 
...
从API version9开始，推荐使用[bundleManager.getBundleInfoForSelf](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager#bundlemanagergetbundleinfoforself)。
...
从API version 7开始，推荐使用[@ohos.ability.featureAbility](/ref/ability-api/ability-arkts/fa-model/js-apis-ability-featureability/js-apis-ability-featureability)。
...
从API version 7开始，推荐使用[@ohos.window (窗口)](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window/arkts-apis-window)。
