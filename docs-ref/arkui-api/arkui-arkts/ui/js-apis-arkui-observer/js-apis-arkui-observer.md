...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-observer
kit: 应用框架
...
提供UI组件行为变化的无感监听能力。推荐使用[UIObserver](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uiobserver/arkts-apis-uicontext-uiobserver)进行组件监听。

![](../../../../images/fa93377d/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| navigationId | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 包含NavDestination组件的Navigation组件的id。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| name | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | NavDestination组件的名称。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| mode15+ | [NavDestinationMode](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#navdestinationmode枚举说明11) | 否 | 是 | NavDestination类型。  ****元服务API：**** 从API version 15开始，该接口支持在元服务中使用。 |
| uniqueId15+ | number | 否 | 是 | NavDestination组件的uniqueId。  ****元服务API：**** 从API version 15开始，该接口支持在元服务中使用。 |
| size23+ | [Size](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#size) | 否 | 是 | NavDestination组件的大小，单位是vp。  ****元服务API：**** 从API version 23开始，该接口支持在元服务中使用。 |
...
| pathStack | [NavPathStack](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathstack10) | 否 | 否 | Navigation组件的导航控制器。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| uniqueId20+ | number | 否 | 是 | Navigation组件的uniqueId，可以通过[queryNavigationInfo](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-api/ts-custom-component-api#querynavigationinfo12)获取。  ****元服务API：**** 从API version 20开始，该接口支持在元服务中使用。 |
...
| axis20+ | [Axis](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#axis) | 否 | 是 | 滚动组件的滚动方向。  ****元服务API：**** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 否 | 否 | 触发生命周期的routerPage页面对应的上下文信息。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| size23+ | [Size](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#size) | 否 | 是 | routerPage页面的大小，单位是vp。  ****元服务API：**** 从API version 23开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 否 | 否 | 屏幕像素密度变化时页面对应的上下文信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 否 | 否 | 触发页面切换的Navigation对应的上下文信息。 |
| from | [NavDestinationInfo](#navdestinationinfo) | [NavBar](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navbar12) | 否 | 否 | 页面切换的源页面。 |
| to | [NavDestinationInfo](#navdestinationinfo) | [NavBar](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navbar12) | 否 | 否 | 页面切换的目的页面。 |
| operation | [NavigationOperation](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navigationoperation11枚举说明) | 否 | 否 | 页面切换操作类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| navigationId | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 指定需要监听的Navigation的ID。 |
...
| lastIndex22+ | number | 否 | 是 | 最近一次聚焦的TabsContent组件的下标索引。索引从0开始。仅在[on('tabChange')](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uiobserver/arkts-apis-uicontext-uiobserver#ontabchange22)的回调函数中存在。  ****元服务API：**** 从API version 22开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| widthBreakpoint | [WidthBreakpoint](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#widthbreakpoint13) | 是 | 否 | 窗口宽度所在的布局断点枚举。 |
| heightBreakpoint | [HeightBreakpoint](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#heightbreakpoint13) | 是 | 否 | 窗口高度所在的布局断点枚举。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即NavDestination组件的状态变化。 |
| options | { navigationId: [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) } | 是 | 指定监听的Navigation的id。 |
| callback | Callback&lt;[NavDestinationInfo](#navdestinationinfo)&gt; | 是 | 回调函数。返回当前的NavDestination组件状态。 |
...
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 是 | 上下文信息，用以指定监听页面的范围。 |
...
| context | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 是 | 上下文信息，用以指定监听页面的范围。 |
...
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 是 | 上下文信息，用以指定监听页面切换事件的范围。 |
...
监听TabContent页面的切换事件。相比[on('tabChange')](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uiobserver/arkts-apis-uicontext-uiobserver#ontabchange22)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
...
监听指定Tabs组件id的TabContent页面切换事件。相比[on('tabChange')](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uiobserver/arkts-apis-uicontext-uiobserver#ontabchange22)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
