...
![](../../../../../images/7171381e/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 11开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 不建议对[BuilderNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-buildernode/js-apis-arkui-buildernode)中的RenderNode进行修改操作。BuilderNode中持有的[FrameNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-framenode/js-apis-arkui-framenode)仅用于将该BuilderNode作为子节点挂载到其他FrameNode上，对该FrameNode或对应的RenderNode进行属性设置与子节点操作可能会产生未定义行为，包括但不限于显示异常、事件异常、稳定性问题等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#size) | 是 | 将要设置的RenderNode的大小。 |
...
| 类型 | 说明 |
| --- | --- |
| [Size](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#size) | 获取当前RenderNode的大小，默认值宽度和高度为0。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#position) | 是 | 将要设置的RenderNode的位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#position) | 获取当前RenderNode的位置，默认位置为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| frame | [Frame](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#frame) | 是 | 将要设置的RenderNode的大小和位置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pivot | [Pivot](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#pivot) | 是 | 将要设置的RenderNode的轴心。 |
...
| 类型 | 说明 |
| --- | --- |
| [Pivot](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#pivot) | 获取当前RenderNode的轴心，默认值为{ x: 0.5, y: 0.5}。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Scale](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#scale) | 是 | 将要设置的RenderNode的缩放比例。 |
...
| 类型 | 说明 |
| --- | --- |
| [Scale](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#scale) | 获取当前RenderNode的比例，默认值为{ x: 1, y: 1 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| translation | [Translation](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#translation) | 是 | 将要设置的RenderNode的平移量。 |
...
| 类型 | 说明 |
| --- | --- |
| [Translation](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#translation) | 获取当前RenderNode的平移量，默认值为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotation | [Rotation](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#rotation) | 是 | 将要设置的RenderNode的旋转角度。 |
...
| 类型 | 说明 |
| --- | --- |
| [Rotation](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#rotation) | 当前RenderNode的旋转角度。默认值为{ x: 0, y: 0, z: 0}。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transform | [Matrix4](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#matrix4) | 是 | 将要设置的RenderNode的变换矩阵。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix4](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#matrix4) | 当前RenderNode的变换矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | [Offset](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#offset) | 是 | 将要设置的RenderNode的阴影偏移。 |
...
| 类型 | 说明 |
| --- | --- |
| [Offset](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#offset) | 当前RenderNode的阴影偏移，默认值为{ x: 0, y: 0 }。 |
...
![](../../../../../images/ef16f616/zh-cn_image_0000002552959456.jpg)
...
![](../../../../../images/6d31e1ca/zh-cn_image_0000002583479457.jpg)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [DrawContext](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#drawcontext) | 是 | 图形绘制上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<[BorderStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#borderstyle)> | 是 | RenderNode的边框样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<[BorderStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#borderstyle)> | RenderNode的边框样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<number> | 是 | RenderNode的边框宽度，单位为vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<number> | RenderNode的边框宽度，默认所有边框宽度为0vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<number> | 是 | RenderNode的边框颜色。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#edgest12)<number> | RenderNode的边框颜色，默认所有边框颜色为0XFF000000。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| radius | [BorderRadiuses](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#borderradiuses12) | 是 | RenderNode的边框圆角，单位为vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [BorderRadiuses](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#borderradiuses12) | RenderNode的边框圆角，默认所有边框圆角为0vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shapeMask | [ShapeMask](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#shapemask12) | 是 | RenderNode的遮罩。 |
...
| 类型 | 说明 |
| --- | --- |
| [ShapeMask](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#shapemask12) | RenderNode的边框遮罩。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shapeClip | [ShapeClip](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#shapeclip12) | 是 | RenderNode的裁剪形状。 |
...
| 类型 | 说明 |
| --- | --- |
| [ShapeClip](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#shapeclip12) | RenderNode的裁剪形状。 |
...
![](../../../../../images/f41eb979/zh-cn_image_0000002552799808.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 是 | 设置RenderNode各个属性使用的单位。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetricsUnit](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#lengthmetricsunit12) | 获取RenderNode各个属性使用的单位，默认值为LengthMetricsUnit.DEFAULT。 |
...
![](../../../../../images/a480cfe7/zh-cn_image_0000002583439503.gif)
