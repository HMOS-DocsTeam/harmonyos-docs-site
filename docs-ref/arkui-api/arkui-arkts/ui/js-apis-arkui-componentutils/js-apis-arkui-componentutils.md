...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-componentutils
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-arkui-componentutils
---
...
![](../../../../images/754a7663/note_3.0-zh-cn.png) 
...
![](../../../../images/eb72fab2/note_3.0-zh-cn.png) 

- 从API version 10开始支持，从API version 18开始废弃，建议使用[getRectangleById](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-componentutils/arkts-apis-uicontext-componentutils#getrectanglebyid)替代。getRectangleById需先通过[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[getComponentUtils](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getcomponentutils)方法获取[ComponentUtils](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-componentutils/arkts-apis-uicontext-componentutils)对象，然后通过该对象进行调用。
- 从API version 10开始，可以通过使用[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[getComponentUtils](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getcomponentutils)方法获取当前UI上下文关联的[ComponentUtils](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-componentutils/arkts-apis-uicontext-componentutils)对象。在目标组件布局完成后，通过该接口能够获取组件坐标和尺寸信息。建议在[布局回调](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-inspector/js-apis-arkui-inspector)中使用该接口。如果组件动态创建但未挂载组件树，则无法通过该接口获取正常的组件信息。因为组件在未挂载组件树的情况下，一般未经过UI框架正常的测量与布局，此时请确保组件正常挂载组件树后再尝试获取组件信息。
...
以下错误码的详细介绍请参见[接口调用异常错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-internal/errorcode-internal)。
...
推荐通过使用[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[getComponentUtils](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getcomponentutils)方法获取当前UI上下文关联的ComponentUtils对象。
...
![](../../../../images/60ef5295/zh-cn_image_0000002583479401.gif)
