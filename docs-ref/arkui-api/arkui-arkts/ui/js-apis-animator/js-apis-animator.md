...
![](../../../../images/07e81b53/note_3.0-zh-cn.png) 
...
- 自定义组件中通常会持有一个由[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)接口返回的[AnimatorResult](#animatorresult)对象，以确保动画对象在动画过程中不被析构，该对象通过回调捕获了自定义组件对象，因此需要在自定义组件销毁时的[aboutToDisappear](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-lifecycle/ts-custom-component-lifecycle#abouttodisappear)生命周期中释放动画对象，以避免因循环依赖导致内存泄漏。详细示例可参考：[基于ArkTS扩展的声明式开发范式](#基于arkts扩展的声明式开发范式)。
...
![](../../../../images/84c9fd96/note_3.0-zh-cn.png) 

- 从API version 9开始支持，从API version 18开始废弃，建议使用[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)替代。
- 从API version 10开始，可以通过使用[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)来明确UI的执行上下文。
...
![](../../../../images/e8fe8753/note_3.0-zh-cn.png) 

推荐通过使用[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)接口明确UI上下文。
...
![](../../../../images/ffcd2bbe/note_3.0-zh-cn.png) 
...
![](../../../../images/8d911d08/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参考[通用错误码](/ref/errorcode-universal/errorcode-universal)和[接口调用异常错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-ui-arkts-errcode/errorcode-internal/errorcode-internal)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rateRange | [ExpectedFrameRateRange](/ref/arkui-api/arkui-declarative-comp/animation/ts-explicit-animation/ts-explicit-animation#expectedframeraterange11) | 是 | 设置期望的帧率范围。 |

![](../../../../images/199a885e/note_3.0-zh-cn.png) 
...
![](../../../../images/0bb33ccb/note_3.0-zh-cn.png) 
...
fill(fillMode: [FillMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fillmode)): SimpleAnimatorOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillMode | [FillMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fillmode) | 是 | 设置animator动画填充方式，影响动画delay期间和结束时的表现。  默认值：FillMode.Forwards |
...
direction(direction: [PlayMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#playmode)): SimpleAnimatorOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | [PlayMode](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#playmode) | 是 | 设置animator动画播放方向。  默认值：PlayMode.Normal |
...
![](../../../../images/2db19a9f/zh-cn_image_0000002583439443.gif)

### 基于ArkTS扩展的声明式开发范式

![](../../../../images/c3aa687e/note_3.0-zh-cn.png) 
...
![](../../../../images/c9209e52/zh-cn_image_0000002552959398.gif)
...
![](../../../../images/8f6f8670/zh-cn_image_0000002583479399.gif)
