...
![](../../../../../images/83d5529b/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本Class首批接口从API version 10开始支持。
- 以下API需先使用UIContext中的[getFont()](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getfont)方法获取到Font对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [font.FontOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-font/js-apis-font#fontoptions) | 是 | 注册的自定义字体信息。  ****说明：****  设置注册字体文件的路径，读取系统沙箱路径内的资源时，建议使用file://路径前缀的字符串，需要确保沙箱目录路径下的文件存在并且有可读权限。 |
...
| 类型 | 说明 |
| --- | --- |
| [font.FontInfo](/ref/arkui-api/arkui-arkts/ui/js-apis-font/js-apis-font#fontinfo10) | 字体的详细信息。  如果查询不到字体，返回undefined。 |
