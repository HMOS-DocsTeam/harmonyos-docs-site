...
title: "Class (Router)"
sidebar_position: 17
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-router
kit: 应用框架
...
![](../../../../../images/c8638ad5/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本Class首批接口从API version 10开始支持。
- 以下API需先使用UIContext中的[getRouter()](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getrouter)方法获取到Router对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routeroptions) | 是 | 跳转页面描述信息。 |
...
| --- | --- | --- | --- |
| options | [router.RouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routeroptions) | 是 | 跳转页面描述信息。 |
| mode | [router.RouterMode](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routermode9) | 是 | 跳转页面使用的模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routeroptions) | 是 | 替换页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.NamedRouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#namedrouteroptions10) | 是 | 跳转页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.NamedRouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#namedrouteroptions10) | 是 | 替换页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routeroptions) | 否 | 返回页面描述信息，其中参数url指路由跳转时返回到指定url的页面，如果页面栈中没有对应url的页面，则不响应该操作；如果栈中存在对应url的页面，则返回至index最大的同名页面。  如果url未设置，则返回上一页，页面不会重新构建，页面栈里面的page不会回收，出栈后会被回收。 |
...
![](../../../../../images/7fa30a55/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| router.[RouterState](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routerstate) | 页面状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| router.[RouterState](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routerstate) | undefined | 返回页面状态信息。索引不存在时返回undefined。 |
...
getStateByUrl(url: string): Array&lt;router.[RouterState](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routerstate)&gt;
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;router.[RouterState](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#routerstate)&gt; | 页面状态信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.EnableAlertOptions](/ref/arkui-api/arkui-arkts/ui/js-apis-router/js-apis-router#enablealertoptions) | 是 | 文本弹窗信息描述。 |
