...
![](../../../../../images/b4aeeee2/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本Class首批接口从API version 14开始支持。
- MarqueeDynamicSyncScene继承自[DynamicSyncScene](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-dynamicsyncscene/arkts-apis-uicontext-dynamicsyncscene)，对应[Marquee](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-marquee/ts-basic-components-marquee)的动态帧率场景。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [MarqueeDynamicSyncSceneType](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-e/arkts-apis-uicontext-e#marqueedynamicsyncscenetype14) | 是 | 否 | Marquee的动态帧率场景。 |
