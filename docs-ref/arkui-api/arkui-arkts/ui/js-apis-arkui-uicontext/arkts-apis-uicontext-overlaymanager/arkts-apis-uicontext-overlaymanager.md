...
![](../../../../../images/68d6f269/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本Class首批接口从API version 12开始支持。
- 以下API需先使用UIContext中的[getOverlayManager()](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getoverlaymanager12)方法获取到OverlayManager对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 在OverlayManager的指定节点上添加此content。  ****说明：****  新增的节点默认处于页面居中，按层级堆叠。 |
...
![](../../../../../images/a6c7f733/zh-cn_image_0000002583439457.gif)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 在OverlayManager的指定节点上添加此content。  ****说明：****  新增的节点默认处于页面居中位置，按层级堆叠。 |
| levelOrder | [LevelOrder](/ref/arkui-api/arkui-arkts/ui/js-apis-promptaction/js-apis-promptaction#levelorder18) | 否 | 新增浮层节点的显示顺序。  ****说明：****  - 默认值：LevelOrder.clamp(0) |
...
![](../../../../../images/fb6f7de2/zh-cn_image_0000002552959412.gif)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 在OverlayManager上删除此content。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 在OverlayManager上显示此content。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-componentcontent/js-apis-arkui-componentcontent) | 是 | 在OverlayManager上隐藏此content。 |
