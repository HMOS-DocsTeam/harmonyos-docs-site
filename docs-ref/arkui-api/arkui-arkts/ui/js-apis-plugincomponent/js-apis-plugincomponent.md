...
sidebar_position: 20
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-plugincomponent
kit: 应用框架
...
![](../../../../images/962d73db/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want) | 否 | 否 | 组件使用方Ability信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want) | 否 | 否 | 组件提供方Ability信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want) | 是 | Push请求发送方相关信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want) | 是 | request请求发送方相关信息。 |
| name | string | 是 | 模板名称。 |
| data | [KVObject](#kvobject) | 是 | 数据。 |
