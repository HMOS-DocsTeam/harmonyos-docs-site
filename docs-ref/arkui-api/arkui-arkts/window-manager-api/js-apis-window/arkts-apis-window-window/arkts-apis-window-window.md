...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window
kit: 应用框架
...
下列API示例中都需先使用[getLastWindow()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-f/arkts-apis-window-f#windowgetlastwindow9)、[createWindow()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-f/arkts-apis-window-f#windowcreatewindow9)、[findWindow()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-f/arkts-apis-window-f#windowfindwindow9)中的任一方法获取到Window实例（windowClass），再通过此实例调用对应方法。

![](../../../../../images/fbfa8c49/note_3.0-zh-cn.png) 
...
![](../../../../../images/a0bf8c68/note_3.0-zh-cn.png) 

调用该接口前，建议先通过[loadContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-windowstage/arkts-apis-window-windowstage#loadcontent9)方法或者[setUIContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setuicontent9-1)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会一直显示启动界面；如果系统窗口、应用子窗口、模态窗和全局悬浮窗没有完成页面加载，直接调用该接口，窗口会处于前台，但不可见。
...
以下错误码的详细介绍请参见[窗口错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-window/errorcode-window)。
...
![](../../../../../images/2946fe86/note_3.0-zh-cn.png) 

调用该接口前，建议优先通过[loadContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-windowstage/arkts-apis-window-windowstage#loadcontent9)方法或者[setUIContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setuicontent9-1)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会一直显示启动界面；如果系统窗口、应用子窗口、模态窗和全局悬浮窗没有完成页面加载，直接调用该接口，窗口会处于前台，但不可见。
...
![](../../../../../images/493082cf/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ShowWindowOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#showwindowoptions20) | 是 | 显示子窗口或系统窗口时的参数。 |
...
![](../../../../../images/558a38a1/note_3.0-zh-cn.png) 
...
- 在[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，窗口相对于屏幕左上顶点移动；在非自由窗口状态下，窗口相对于父窗口左上顶点移动。
- 若需在非自由窗口状态下实现相对于屏幕左上顶点的移动，请使用[moveWindowToGlobal()](#movewindowtoglobal15)。
- 该方法对非自由窗口状态下的主窗口无效。
- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，若主窗口或子窗口的标题栏移出屏幕可视区域，系统将自动回弹窗口，确保标题栏保持可见。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[窗口错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-window/errorcode-window)。
...
![](../../../../../images/5a7f172b/note_3.0-zh-cn.png) 
...
| 窗口类型 | [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态 | 非自由窗口状态 |
| --- | --- | --- |
| 主窗口 | 相对于屏幕移动 | 调用不生效不报错 |
| 应用子窗口/模态窗 | 相对于屏幕移动 | 相对于主窗口移动 |
| 系统窗口/全局悬浮窗 | 相对于屏幕移动 | 相对于屏幕移动 |

![](../../../../../images/ebe8d4fb/note_3.0-zh-cn.png) 
...
![](../../../../../images/1f8c7959/note_3.0-zh-cn.png) 
...
| moveConfiguration | [MoveConfiguration](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#moveconfiguration15) | 否 | 窗口移动选项，未设置将默认保持为当前屏幕。 |
...
![](../../../../../images/bfef1a88/note_3.0-zh-cn.png) 

- 主窗处于自由悬浮窗口模式时，在非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下调用不生效不报错。
- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，若主窗口或子窗口的标题栏移出屏幕可视区域，系统将自动回弹窗口，确保标题栏保持可见。
...
![](../../../../../images/7e115782/note_3.0-zh-cn.png) 
...
基于[全局坐标系](/arkui/window-manager/window-terminology#全局坐标系)移动窗口位置，使用Promise异步回调。

该接口仅在窗口为自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING，窗口模式可通过[getWindowStatus()](#getwindowstatus12)获取）时调用生效，在其他窗口模式下调用返回错误码1300010错误码。

![](../../../../../images/eb20e7a5/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [Position](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#position20) | 返回转换后的坐标。 |
...
窗口存在大小限制[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)，具体尺寸限制范围可以通过[getWindowLimits](#getwindowlimits11)接口进行查询。
...
![](../../../../../images/ef6b1da0/note_3.0-zh-cn.png) 

- 主窗口处于自由悬浮窗口模式时，在非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下调用不报错不生效。
...
![](../../../../../images/3ebf3b4a/note_3.0-zh-cn.png) 
...
![](../../../../../images/f8977914/note_3.0-zh-cn.png) 

- 在非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，主窗口调用不生效。
...
| 类型 | 说明 |
| --- | --- |
| [WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties) | 当前窗口属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowDensityInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowdensityinfo15) | 当前窗口的显示大小缩放系数信息。当返回值为[-1, -1, -1]时，表示当前设备不支持使用该接口。 |
...
| 类型 | 说明 |
| --- | --- |
| [Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 四元组分别表示距离屏幕左上角的x坐标、距离屏幕左上角的y坐标、缩放后的窗口宽度和缩放后的窗口高度。 |
...
- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11)）下，仅存在固定态软键盘（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
- 主窗口在非自由窗口状态的自由悬浮窗口模式下，仅存在系统栏（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
...
- 在[onWindowStageCreate()](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability#onwindowstagecreate)方法中，获取应用启动时的初始布局避让区域时可调用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7) | 是 | 表示避让区域类型。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7) | 窗口内容避让区域。 |
...
- 主窗口在非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11)）下，仅存在系统栏（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
- 主窗口在其余场景下，仅当在非自由悬浮窗口模式下或设备类型为Phone和Tablet，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
- 子窗口在非自由窗口状态或非自由悬浮窗口模式下，仅当窗口的位置和大小与主窗口一致时，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7) | 是 | 表示避让区域类型。不支持获取软键盘类型的避让区域，传入TYPE\_KEYBOARD时，返回1300016错误码。 |
...
获取悬浮窗、模态窗或WindowType为系统类型的窗口是否可以获取窗口内容的避让区[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)。
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。
...
从HarmonyOS 5.0.2开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错，切换到非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态时生效；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用。
...
从HarmonyOS 5.0.2开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyFramePolicy | [KeyFramePolicy](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyframepolicy20) | 是 | 用于设置拖拽的关键帧策略。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[KeyFramePolicy](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyframepolicy20)&gt; | Promise对象，返回实际生效的关键帧策略。 |
...
从HarmonyOS 5.0.0开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | [SpecificSystemBar](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-t/arkts-apis-window-t#specificsystembar11) | 是 | 设置窗口全屏模式时，显示或隐藏的系统栏类型。 |
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用。

****参数：****

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| systemBarProperties | [SystemBarProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#systembarproperties) | 是 | 状态栏的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [SystemBarProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#systembarproperties) | 当前状态栏属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ColorMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#colormetrics12) | 是 | 要设置的状态栏颜色值。 |
...
| 类型 | 说明 |
| --- | --- |
| [StatusBarProperty](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#statusbarproperty18) | 当前状态栏属性，如状态栏颜色。 |
...
- 设备支持sensor旋转且未处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态：立即生效。
- 设备支持sensor旋转且处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态：调用不生效不报错，切换到非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态后生效。
- 其他情况：不生效不报错。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [Orientation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#orientation9) | 是 | 窗口显示方向的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [Orientation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#orientation9) | 窗口显示方向的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 返回UIContext实例对象。 |
...
| storage | [LocalStorage](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-application-state-management/arkts-localstorage) | 是 | 页面级UI状态存储单元，这里用于为加载到窗口的页面内容传递状态属性。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
根据指定路由页面名称为当前窗口加载[命名路由](/arkui/arkts-ui-development/arkts-set-navigation-routing/arkts-routing#命名路由)页面，通过LocalStorage传递状态属性至加载页面，使用callback异步回调。
...
根据指定路由页面名称为当前窗口加载[命名路由](/arkui/arkts-ui-development/arkts-set-navigation-routing/arkts-routing#命名路由)页面，使用callback异步回调。
...
根据指定路由页面名称为当前窗口加载[命名路由](/arkui/arkts-ui-development/arkts-set-navigation-routing/arkts-routing#命名路由)页面，通过LocalStorage传递状态属性至加载页面，使用Promise异步回调。
...
| --- | --- | --- | --- |
| name | string | 是 | 命名路由页面的名称。 |
| storage | [LocalStorage](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-application-state-management/arkts-localstorage) | 否 | 页面级UI状态存储单元，这里用于为加载到窗口的页面内容传递状态属性，默认值为空。 |
...
| callback | Callback&lt;[Size](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#size7)&gt; | 是 | 回调函数。返回当前的窗口尺寸。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowSizeChange'，即窗口尺寸变化事件。 |
| callback | Callback&lt;[Size](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#size7)&gt; | 否 | 回调函数。返回当前的窗口尺寸。如果传入参数，则关闭该监听。如果未传入参数，则关闭窗口尺寸变化的监听。 |
...
- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11)）下触发回调时，仅存在固定态软键盘（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
- 主窗口在非自由窗口状态的自由悬浮窗口模式下触发回调时，仅存在系统栏（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
...
常见的触发避让区回调的场景如下：应用窗口在全屏模式、悬浮模式、分屏模式之间的切换；应用窗口旋转；可折叠设备在屏幕折叠状态发生变化；应用窗口在多设备之间的流转。实现沉浸式布局可参考[开发应用沉浸式效果](/arkui/arkts-ui-development/arkts-layout-development/arkts-develop-apply-immersive-effects)。
...
| callback | Callback&lt;[AvoidAreaOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidareaoptions12)&gt; | 是 | 回调函数。返回当前避让区以及避让区类型。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'avoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback&lt;[AvoidAreaOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidareaoptions12)&gt; | 否 | 回调函数。返回当前避让区以及避让区类型。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有系统避让区变化的监听。 |
...
开启固定态软键盘高度变化的监听。当软键盘从本窗口唤出且与窗口有重叠区域时，通知键盘高度变化。从API version 10开始，有关将软键盘设置为固定态或悬浮态的方法，请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
关闭固定态软键盘高度变化的监听，使应用程序不再接收键盘高度变化的通知。从API version 10开始，有关将软键盘设置为固定态或悬浮态的方法，请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
改变软键盘为固定态或者悬浮态方法详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
| callback | Callback&lt;[KeyboardInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyboardinfo18)&gt; | 是 | 回调函数。返回软键盘窗口信息。 |
...
关闭固定态软键盘即将开始显示的监听。改变输入法窗口为固定态或者悬浮态方法详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardWillShow'，即固定态软键盘即将开始显示的事件。 |
| callback | Callback&lt;[KeyboardInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyboardinfo18)&gt; | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘即将开始显示的监听。 |
...
关闭固定态软键盘即将开始隐藏的监听。改变输入法窗口为固定态切换至悬浮态方法详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardWillHide'，即固定态软键盘即将开始隐藏的事件。 |
| callback | Callback&lt;[KeyboardInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyboardinfo18)&gt; | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘即将开始隐藏的监听。 |
...
关闭固定态软键盘显示动画完成的监听。改变输入法窗口为固定态或者悬浮态方法详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardDidShow'，即固定态软键盘显示动画完成事件。 |
| callback | Callback&lt;[KeyboardInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyboardinfo18)&gt; | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘显示动画完成的监听。 |
...
关闭固定态软键盘隐藏动画完成的监听。改变输入法窗口为固定态切换至悬浮态方法详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardDidHide'，即固定态软键盘隐藏动画完成事件。 |
| callback | Callback&lt;[KeyboardInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#keyboardinfo18)&gt; | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘隐藏动画完成的监听。 |
...
| callback | Callback&lt;[ScreenshotEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#screenshoteventtype20)&gt; | 是 | 回调函数。返回触发的截屏事件类型。 |
...
| callback | Callback&lt;[ScreenshotEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#screenshoteventtype20)&gt; | 否 | 回调函数。返回触发的截屏事件类型。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口截图事件的监听。 |
...
| callback | Callback&lt;[WindowEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windoweventtype10)&gt; | 是 | 回调函数。返回当前的窗口生命周期状态。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowEvent'，即窗口生命周期变化事件。 |
| callback | Callback&lt;[WindowEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windoweventtype10)&gt; | 否 | 回调函数。返回当前的窗口生命周期状态。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口生命周期变化的监听。 |
...
- 非主窗口的阴影区域（可分别通过[setWindowShadowEnabled](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setwindowshadowenabled20)和[setWindowShadowRadius](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setwindowshadowradius17)设置是否显示阴影以及对应的阴影半径）被挡住也算遮挡，此时肉眼所见虽是完全可见，但实际返回的是部分可见。
- 上层窗口带有透明效果时（包括完全不透明之外的所有透明程度）不会遮挡下层窗口，此时下层窗口是可见的。
- 窗口通过[setWindowMask](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setwindowmask12)接口设置异形窗口蒙层时，不会影响窗口可见状态计算，窗口仍可见，即使掩码全部设置为0，窗口依然按照其原本矩形大小参与可见状态计算。
...
| callback | Callback&lt;[OcclusionState](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#occlusionstate22)&gt; | 是 | 窗口可见性变化时的回调函数。详情见[可见性状态](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#occlusionstate22)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'occlusionStateChanged'，即窗口可见性变化事件。 |
| callback | Callback&lt;[OcclusionState](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#occlusionstate22)&gt; | 否 | 若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口可见性变化的监听。 |
...
应用注册帧率变化监听后，只有当客户端UI内容发生重绘时（如页面切换、和可响应组件交互、设置背景色和透明度等），才会触发注册的回调。但当同时使用该接口和[postFrameCallback](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#postframecallback12)、[postDelayedFrameCallback](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#postdelayedframecallback12)、[displaySync.on('frame')](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-displaysync/js-apis-graphics-displaysync#onframe)中的任意一个时，即使无UI内容重绘，也可能触发回调。
...
| callback | Callback&lt;[FrameMetrics](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#framemetrics22)&gt; | 是 | 窗口帧率指标变化时的回调函数。详情见帧率指标[FrameMetrics](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#framemetrics22)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件类型，固定为'frameMetricsMeasured'，即窗口帧率指标变化事件。 |
| callback | Callback&lt;[FrameMetrics](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#framemetrics22)&gt; | 否 | 若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口帧率指标变化的监听。 |
...
开启窗口模式变化的监听，当窗口windowStatus发生变化时进行通知（此时窗口属性可能还没有更新，如果需要在收到windowStatus变化通知时能够立即获取到变化后的窗口大小、位置，建议使用[on('windowStatusDidChange')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onwindowstatusdidchange20)）。

使用当前接口开启监听后，在调用maximize、recover方法时会收到多次回调，如需获取去重后的回调，可使用[on('windowStatusDidChange')](#onwindowstatusdidchange20)。

![](../../../../../images/5c3cd5da/note_3.0-zh-cn.png) 

在[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，应用的[targetAPIVersion](/development-fundamentals/application-configuration-file-stage/app-configuration-file#配置文件标签)设置小于14时，在窗口最大化状态（窗口铺满整个屏幕，2in1设备会有dock栏和状态栏，Tablet设备会有状态栏）时返回值对应为WindowStatusType::FULL\_SCREEN。应用的[targetAPIVersion](/development-fundamentals/application-configuration-file-stage/app-configuration-file#配置文件标签)设置大于等于14时，在窗口最大化状态（窗口铺满整个屏幕，2in1设备会有dock栏和状态栏，Tablet设备会有状态栏）时返回值对应为WindowStatusType::MAXIMIZE。
...
| callback | Callback&lt;[WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11)&gt; | 是 | 回调函数。返回当前的窗口模式。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowStatusChange'，即窗口模式变化事件。 |
| callback | Callback&lt;[WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11)&gt; | 否 | 回调函数。返回当前的窗口模式。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有窗口模式变化的监听。 |
...
开启窗口模式变化的监听，当窗口windowStatus发生变化后进行通知（此时窗口[Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7)属性已经完成更新）。
...
| callback | Callback&lt;[TitleButtonRect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#titlebuttonrect11)&gt; | 是 | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowTitleButtonRectChange'，即标题栏上的最小化、最大化、关闭按钮矩形区域变化事件。 |
| callback | Callback&lt;[TitleButtonRect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#titlebuttonrect11)&gt; | 否 | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有标题栏上的最小化、最大化、关闭按钮矩形区域变化的监听。 |
...
| callback | Callback&lt;[RectChangeOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rectchangeoptions12)&gt; | 是 | 回调函数。返回当前窗口矩形变化值及变化原因。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowRectChange'，即窗口矩形变化事件。 |
| callback | Callback&lt;[RectChangeOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rectchangeoptions12)&gt; | 否 | 回调函数。返回当前的窗口矩形及变化原因。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有窗口矩形变化的监听。 |
...
开启[全局坐标系](/arkui/window-manager/window-terminology#全局坐标系)下窗口矩形（窗口位置及窗口大小）变化的监听事件。
...
关闭[全局坐标系](/arkui/window-manager/window-terminology#全局坐标系)下窗口矩形（窗口位置及窗口大小）变化的监听事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'rectChangeInGlobalDisplay'，即全局坐标系下窗口矩形变化事件。 |
| callback | Callback&lt;[RectChangeOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rectchangeoptions12)&gt; | 否 | 回调函数。返回当前的窗口矩形及变化原因。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有全局坐标系下窗口矩形变化的监听。 |
...
该接口触发的回调函数是异步执行。子窗口的同步关闭事件监听参考[on('subWindowClose')](#onsubwindowclose12)方法。主窗口的同步关闭事件监听参考[on('windowStageClose')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-windowstage/arkts-apis-window-windowstage#onwindowstageclose14)方法。
...
在HarmonyOS 6.1.0之前，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。

从HarmonyOS 6.1.0开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态后生效；在不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效。
...
开启窗口旋转变化的监听。[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)中窗口旋转事件类型为窗口即将旋转时，必须返回[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19)。窗口旋转事件类型为窗口旋转结束时返回[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19)不生效。

该函数只允许在主线程注册。同一个窗口多次注册同类型回调函数，只生效最新注册的同类型回调函数返回值。系统提供了超时保护机制，若20ms内窗口未返回[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19)，系统不处理该返回值。
...
针对非PC/2in1且支持sensor旋转但不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备：可正常调用且立即生效。

针对非PC/2in1且支持sensor旋转，支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备：当处于非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态时可正常调用该接口且立即生效；当处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态时，调用该接口时不生效也不报错，切换到非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下生效。
...
| callback | RotationChangeCallback&lt;[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19), [RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19) | void> | 是 | 回调函数。返回窗口旋转信息[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)，应用返回当前窗口变化结果[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [ColorSpace](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#colorspace8) | 是 | 设置色域模式。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorSpace](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#colorspace8) | 当前色域模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | string | [ColorMetrics](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-graphics/js-apis-arkui-graphics#colormetrics12)18+ | 是 | 需要设置的背景色，为十六进制RGB或ARGB颜色，不区分大小写，例如'#00FF00'或'#FF00FF00'。  从API version 18开始，此参数支持ColorMetrics类型。 |
...
****设备行为差异：**** 在HarmonyOS 6.1.0之前，该接口在2in1设备中可正常调用，在其他设备中返回801错误码；从HarmonyOS 6.1.0开始，该接口在2in1和Tablet设备中可正常调用，在Tablet设备时仅在开启[自由多窗模式](/arkui/window-manager/window-terminology#自由多窗模式)下生效，在其他设备中返回801错误码。
...
![](../../../../../images/8436ea96/note_3.0-zh-cn.png) 
...
![](../../../../../images/bd0e5a39/note_3.0-zh-cn.png) 
...
从API version 22开始，调用[createVirtualScreen](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#displaycreatevirtualscreen16)接口创建虚拟屏，并设置supportsFocus配置项为false时，位于该虚拟屏的窗口无法调用该接口修改窗口的可获焦能力，如果调用，会抛出1300002错误码。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isFocusable | boolean | 是 | 窗口是否可获焦。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考[不可获焦窗口中输入框与输入法交互指南](/ime-kit/use-inputmethod-in-not-focusable-window)。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 是 | 回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | Promise对象。返回当前窗口截图。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 返回当前窗口截图。 |
...
![](../../../../../images/6c8b2357/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ratio | number | 是 | 窗口内容布局（不含边框和标题栏等装饰）的宽高比。该参数为浮点数，受窗口最大最小尺寸限制，比例值下限为最小宽度/最大高度，上限为最大宽度/最小高度。窗口最大最小尺寸由[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)和系统限制的交集决定，系统限制优先级高于[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)。ratio的有效范围会随[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)变化而变化。如果先设置了[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)，后设置的ratio与其冲突，会返回错误码；如果先设置了ratio，后设置的[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)与其冲突，窗口的宽高比可能会不跟随设置的宽高比（ratio）。 |
...
![](../../../../../images/405a443c/note_3.0-zh-cn.png) 
...
![](../../../../../images/1646c34c/note_3.0-zh-cn.png) 
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错。

****参数：****

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| presentation | [MaximizePresentation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#maximizepresentation12) | 否 | 主窗口或子窗口最大化时的布局枚举。默认值window.MaximizePresentation.ENTER\_IMMERSIVE，即默认最大化时进入全屏模式。 |
...
将当前窗口的主窗口恢复到前台显示，如果主窗口已处于前台，则会抬升主窗层级。此接口仅适用于类型为[TYPE\_FLOAT](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowtype7)的窗口，并且需在窗口触发过[DOWN](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#touchtype)事件后才能调用。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| wantParameters | Record&lt;string, Object&gt; | 否 | 拉起窗口时会给主窗传递的自定义参数，主窗会在触发[onNewWant](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-abilitylifecyclecallback/js-apis-app-ability-abilitylifecyclecallback#onnewwant12)回调时收到。默认值为空，代表不向主窗传入任何自定义参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11) | 当前窗口尺寸限制。 |
...
错误码详情请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[窗口错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-window/errorcode-window)。
...
![](../../../../../images/ee152e55/note_3.0-zh-cn.png) 

- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，处于自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING）的窗口在尺寸变化时受[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)约束。触发场景包括：应用主动改变窗口大小（如调用[resize()](#resize9)）；系统调节窗口大小（如分辨率变化、显示大小缩放系数变化）；用户拖拽缩放窗口。
- 非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，主窗口尺寸不受[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)约束，其他类型窗口仍受[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)约束。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowLimits | [WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11) | 是 | 目标窗口的尺寸限制，单位为px或vp。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)&gt; | Promise对象。返回设置后的尺寸限制，为入参与系统尺寸限制的交集。 |
...
![](../../../../../images/63d87348/note_3.0-zh-cn.png) 
...
从HarmonyOS 5.1.1开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。

从HarmonyOS 6.1.0开始，该接口在Phone、Tablet、PC/2in1设备可正常调用，在其他设备调用返回801错误码。主窗在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态后生效。
...
| --- | --- | --- | --- |
| windowLimits | [WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11) | 是 | 目标窗口的尺寸限制，单位为px或vp。 |
| isForcible | boolean | 是 | 是否强制设置窗口的尺寸限制。  入参[windowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)的单位为vp时：无论设置true还是false，都按照false处理，窗口宽高的最小值和最大值都取决于系统限制。  入参[windowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)的单位为px时：设置为true，表示窗口宽高最小值以系统限制值和40vp两者中的低数值为准，窗口宽高的最大值仍取决于系统限制；设置为false，表示窗口宽高的最小值和最大值都取决于系统限制。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WindowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)&gt; | Promise对象。返回设置后的窗口尺寸限制。  入参[windowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)的单位为vp时，返回入参与系统默认窗口尺寸限制的交集。  入参[windowLimits](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowlimits11)的单位为px时，isForcible为false则返回入参与系统默认窗口尺寸限制的交集；isForcible为true则返回入参与[系统限制的最小值与40vp两者中的低数值，系统限制的最大值]的交集。 |
...
异形窗口蒙层设置不会影响窗口可见状态(可通过[on('windowVisibilityChange')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onwindowvisibilitychange11)或[on('occlusionStateChanged')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onocclusionstatechanged22)监听）计算。即使掩码全部设置为0，窗口仍可见，窗口依然按照其原本矩形大小参与可见状态计算。
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态后生效；在不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回1300002或801错误码。
...
| modalityType | [ModalityType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#modalitytype14) | 是 | 子窗口模态类型。 |
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态后生效；在不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备调用不报错不生效。
...
从HarmonyOS 5.1.0开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。

****参数：****

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dectorStyle | [DecorButtonStyle](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#decorbuttonstyle14) | 是 | 要设置的装饰栏按钮样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [DecorButtonStyle](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#decorbuttonstyle14) | 返回当前窗口装饰栏上的按钮样式，窗口装饰按钮区域位于窗口的右上角。 |
...
****设备行为差异：**** 该接口在支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不生效也不报错。
...
| 类型 | 说明 |
| --- | --- |
| [TitleButtonRect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#titlebuttonrect11) | 标题栏上的最小化、最大化、关闭按钮矩形区域，该区域位置坐标相对窗口右上角。 |
...
![](../../../../../images/a7a8b323/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11) | 当前窗口模式。 |
...
判断当前窗口是否已获焦。为获取准确的获焦状态，需要在[WindowEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windoweventtype10)生命周期处于WINDOW\_ACTIVE之后调用。
...
****设备行为差异：**** 该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回undefined。
...
| options | [SubWindowOptions](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#subwindowoptions11) | 是 | 子窗口参数。decorEnabled为true时，子窗口为非[沉浸式布局](/arkui/window-manager/window-terminology#沉浸式布局)；decorEnabled为false时，子窗口为沉浸式布局。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Window](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window)&gt; | Promise对象。返回当前Window下创建的子窗口对象。 |
...
从HarmonyOS 6.1.0开始，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。
...
| 类型 | 说明 |
| --- | --- |
| [Window](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window) | 子窗口的父窗口对象。 |
...
此接口只对应用主窗口生效，且需要在module.json5配置文件中[abilities](/development-fundamentals/application-configuration-file-stage/module-configuration-file#abilities标签)标签中配置preferMultiWindowOrientation属性为"landscape\_auto"。
...
[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，对系统窗口、应用主窗口、应用子窗口、全局悬浮窗和模态窗口生效。非自由窗口状态下，仅对系统窗口、应用子窗口、全局悬浮窗和模态窗口生效，应用主窗口调用该接口返回801或1300004错误码。

仅在[onTouch](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明)事件（其中，事件类型必须为TouchType.Down）的回调方法中调用此接口才会有移动效果，成功调用此接口后，窗口将跟随鼠标或触摸点移动。

在点击拖拽场景下，若不期望在按下时触发拖拽事件，则可以在事件类型为[TouchType.Move](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#touchtype)（需要保证当前行为已经触发TouchType.Down事件）时调用此接口，触发移动效果。
...
仅在[onTouch](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明)事件（其中，事件类型必须为TouchType.Down）的回调方法中调用此接口才会有移动效果，成功调用此接口后，窗口将跟随鼠标移动。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offsetX | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的x轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口宽度为非法参数，窗口宽度可以在窗口属性[WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties)中获取。 |
| offsetY | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的y轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口高度为非法参数，窗口高度可以在窗口属性[WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties)中获取。 |
...
设置当前窗口是否能接收[拖拽事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#dragevent7)，使用Promise异步回调。
...
获取当前窗口是否能接收[拖拽事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#dragevent7)的状态。
...
在HarmonyOS 6.0.0之前，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。
...
获取当前窗口是否为激活态。为准确获取激活态，需要在[WindowEventType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windoweventtype10)生命周期处于WINDOW\_ACTIVE之后调用。
...
在HarmonyOS 6.1.0之前，该接口在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备（Phone设备除外，在Phone设备上调用该接口会返回801错误码）上可正常调用；在支持并不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用不报错不生效；在不支持自由窗口的设备中返回801错误码。

从HarmonyOS 6.1.0开始，该接口在Phone、Tablet、2in1设备上可调用且不报错（当设备处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态时可正常调用此接口并生效；当设备不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态时调用此接口不生效不报错，设备切换到自由窗口状态时生效）；在其他设备中调用返回801错误码。
...
| anchor | [WindowAnchor](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowanchor20) | 否 | 一级子窗与主窗保持相对位置不变时的窗口锚点枚举。该参数仅在enabled为true时生效，默认值为window.WindowAnchor.TopStart，即默认锚点为窗口左上角。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transitionType | [WindowTransitionType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowtransitiontype20) | 是 | 本次转场动画场景。当前只支持销毁场景。 |
| animation | [TransitionAnimation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#transitionanimation20) | 是 | 本次转场动画配置。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionAnimation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#transitionanimation20) | undefined | 对应场景下的转场动画配置。当未使用过[setWindowTransitionAnimation](#setwindowtransitionanimation20)接口时，返回undefined。 |
...
通过该接口改变子窗口的显示层级时，不会发生焦点切换。推荐使用[shiftAppWindowFocus()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-f/arkts-apis-window-f#windowshiftappwindowfocus11)进行焦点切换。
...
查询当前窗口是否为[自由窗口](/arkui/window-manager/window-terminology#自由窗口)模式。
...
窗口方向指窗口所在屏幕的方向，以窗口模块对横竖屏的定义方式表示，窗口的方向分别用0、1、2和3表示竖屏、反向横屏、反向竖屏和横屏四个方向，其对横竖屏的定义与[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)和枚举类[Orientation](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#orientation9)中对横竖屏的定义一致，如Orientation设置为LANDSCAPE时，窗口方向为横屏。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [RotationInfoType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#rotationinfotype23) | 是 | 待转换的值的类型。 |
| to | [RotationInfoType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#rotationinfotype23) | 是 | 目标值的类型。 |
| value | number | 是 | 待转换的值。该参数为整数，浮点数输入将向下取整，取值范围为[0, 3]，范围外为非法参数（抛出错误码[401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败)）。 |
...
![](../../../../../images/6af96349/note_3.0-zh-cn.png) 
...
![](../../../../../images/b9896fc5/note_3.0-zh-cn.png) 
...
![](../../../../../images/b354f415/note_3.0-zh-cn.png) 
...
![](../../../../../images/cc6f07ee/note_3.0-zh-cn.png) 
...
![](../../../../../images/9c6fcb36/note_3.0-zh-cn.png) 
...
![](../../../../../images/ec51f58a/note_3.0-zh-cn.png) 
...
![](../../../../../images/fe240f73/note_3.0-zh-cn.png) 
...
![](../../../../../images/7a0a2c40/note_3.0-zh-cn.png) 
...
![](../../../../../images/a39e9b4a/note_3.0-zh-cn.png) 
...
![](../../../../../images/876dc8f4/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | number | 是 | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码[401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败)）。 |
| height | number | 是 | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码[401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败)）。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
![](../../../../../images/0685bdc5/note_3.0-zh-cn.png) 
...
![](../../../../../images/3808ccad/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties)&gt; | 是 | 回调函数。返回当前窗口属性。 |
...
![](../../../../../images/ec332827/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties)&gt; | Promise对象。返回当前窗口属性。 |
...
getAvoidArea(type: [AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7), callback: AsyncCallback<[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)>): void

获取当前窗口内容规避的区域；如系统栏区域、刘海屏区域、手势区域、软键盘区域等与窗口内容重叠时，需要窗口内容避让的区域。

主窗口/子窗口：

- [自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING）下，仅存在固定态软键盘（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
- 主窗口在非自由窗口状态的自由悬浮窗口模式下，仅存在系统栏（[AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
- 主窗口在其余场景下，仅当在非自由悬浮窗口模式下或设备类型为Phone和Tablet，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
- 子窗口在非自由窗口状态或非自由悬浮窗口模式下，仅当窗口的位置和大小与主窗口一致时，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
...
![](../../../../../images/178e4569/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7) | 是 | 表示避让区类型。 |
| callback | AsyncCallback&lt;[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)&gt; | 是 | 回调函数。返回窗口内容避让区域。 |
...
getAvoidArea(type: [AvoidAreaType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#avoidareatype7)): Promise<[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)>
...
![](../../../../../images/de1967a9/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)&gt; | Promise对象。返回窗口内容避让区域。 |
...
![](../../../../../images/339a7cca/note_3.0-zh-cn.png) 
...
![](../../../../../images/752a96f4/note_3.0-zh-cn.png) 
...
![](../../../../../images/d964c1e1/note_3.0-zh-cn.png) 
...
![](../../../../../images/fbc3020c/note_3.0-zh-cn.png) 
...
![](../../../../../images/6ea16ae7/note_3.0-zh-cn.png) 
...
![](../../../../../images/8fdd2509/note_3.0-zh-cn.png) 
...
![](../../../../../images/4877ecdf/note_3.0-zh-cn.png) 
...
![](../../../../../images/1c6b4435/note_3.0-zh-cn.png) 
...
![](../../../../../images/3ba242f9/note_3.0-zh-cn.png) 
...
![](../../../../../images/63f96104/note_3.0-zh-cn.png) 
...
![](../../../../../images/157885d8/note_3.0-zh-cn.png) 
...
![](../../../../../images/541ee058/note_3.0-zh-cn.png) 
...
![](../../../../../images/a05beda4/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)&gt; | 是 | 回调函数。返回当前避让区。 |
...
![](../../../../../images/68657f8f/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'systemAvoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback&lt;[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)&gt; | 否 | 回调函数。返回当前避让区。若传入参数，则关闭该监听。若未传入参数，则关闭所有系统避让区变化的监听。 |
...
![](../../../../../images/44b085f2/note_3.0-zh-cn.png) 
...
![](../../../../../images/e8b69314/note_3.0-zh-cn.png) 
...
![](../../../../../images/f32542dd/note_3.0-zh-cn.png) 
...
![](../../../../../images/69cb3f95/note_3.0-zh-cn.png) 
...
![](../../../../../images/ad3094e0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[ColorSpace](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#colorspace8)&gt; | 是 | 回调函数。当获取成功，err为undefined，data为当前色域模式。 |
...
![](../../../../../images/a04039cb/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ColorSpace](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#colorspace8)&gt; | Promise对象。返回当前色域模式。 |
...
![](../../../../../images/b470b677/note_3.0-zh-cn.png) 
...
![](../../../../../images/893b2cff/note_3.0-zh-cn.png) 
...
![](../../../../../images/3dcfe541/note_3.0-zh-cn.png) 
...
![](../../../../../images/f4b76513/note_3.0-zh-cn.png) 
...
![](../../../../../images/09c1ce4e/note_3.0-zh-cn.png) 
...
![](../../../../../images/cd2c23a3/note_3.0-zh-cn.png) 
...
![](../../../../../images/f20008f5/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isFocusable | boolean | 是 | 点击时是否支持切换焦点窗口。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考[不可获焦窗口中输入框与输入法交互指南](/ime-kit/use-inputmethod-in-not-focusable-window)。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
![](../../../../../images/c7b97689/note_3.0-zh-cn.png) 
...
![](../../../../../images/b5d20455/note_3.0-zh-cn.png) 
...
![](../../../../../images/b41934df/note_3.0-zh-cn.png) 
...
![](../../../../../images/eddb6660/note_3.0-zh-cn.png) 
...
![](../../../../../images/098d3163/note_3.0-zh-cn.png) 
...
![](../../../../../images/db991208/note_3.0-zh-cn.png) 
...
![](../../../../../images/941b2d13/note_3.0-zh-cn.png) 
...
![](../../../../../images/b98eb07f/note_3.0-zh-cn.png) 
...
![](../../../../../images/aa845f7b/note_3.0-zh-cn.png) 
