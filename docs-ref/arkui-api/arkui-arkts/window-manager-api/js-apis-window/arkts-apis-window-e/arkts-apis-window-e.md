...
title: "Enums"
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-e
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-window-e
---

# Enums

![](../../../../../images/56a05674/note_3.0-zh-cn.png) 
...
窗口内容做[沉浸式布局](/arkui/window-manager/window-terminology#沉浸式布局)适配时，需要按照AvoidAreaType对应的[AvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#avoidarea7)做窗口内容避让。
...
| MAXIMIZE | 2 | 表示APP窗口最大化模式，[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，窗口铺满整个屏幕，不需要hover就可以显示dock栏、状态栏和标题栏。非[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态下，不存在该状态。 |
...
物理像素单位和虚拟像素单位换算可使用[px2vp](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#px2vp12)和[vp2px](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#vp2px12)。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| LINEAR | 0 | 表示动画从头到尾的速度都是相同的。  使用该曲线类型时[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中duration必填。  使用该曲线类型时[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中param选填，且不生效。 |
| INTERPOLATION\_SPRING | 1 | 表示插值器弹簧曲线，一条从0到1的动画曲线，实际动画值根据曲线进行插值计算。动画时间由曲线参数决定，不受[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中的duration参数控制。  使用该曲线类型时[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中duration选填，且不生效。  使用该曲线类型时[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中param必填。 |
| CUBIC\_BEZIER | 2 | 表示贝塞尔曲线。  使用该曲线类型时[WindowAnimationConfig](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowanimationconfig20)中的param和duration为必填项。 |
...
| APPLICATION\_MODALITY | 1 | 除其父级窗口外还需要该应用其他实例的窗口不响应用户操作时，可选此参数。  ****设备行为差异：**** 该枚举在支持并处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备及不支持[自由窗口](/arkui/window-manager/window-terminology#自由窗口)状态的设备上调用返回801错误码。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| WINDOW\_ORIENTATION | 0 | 窗口所在屏幕的显示方向，以窗口模块对横竖屏的定义方式表示。  开发者在使用时，需要注意该方向表示[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)中的orientation参数。 |
| DISPLAY\_ORIENTATION | 1 | 屏幕显示方向，以屏幕模块对横竖屏的定义方式表示。  开发者在使用时，需要注意该方向表示[display](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#display)对象的orientation属性。 |
| DISPLAY\_ROTATION | 2 | 设备的屏幕顺时针旋转角度。  开发者在使用时，需要注意该方向表示[display](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#display)对象的rotation属性。 |
