...
![](../../../../../images/2aaae296/note_3.0-zh-cn.png) 
...
动画曲线参数。不同曲线类型[WindowAnimationCurve](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowanimationcurve20)，对应的WindowAnimationCurveParam参数含义不同。
...
开发者在使用时，回调函数参数类型为[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)，返回值类型为[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19) | void。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | T | 是 | 回调函数调用时系统传入[RotationChangeInfo](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeinfo19)类型的参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| U | 回调函数需要返回[RotationChangeResult](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rotationchangeresult19) | void类型的返回值。 |
