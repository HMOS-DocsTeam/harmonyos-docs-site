...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-display
---
...
![](../../../../images/b15bd162/note_3.0-zh-cn.png) 
...
![](../../../../images/7642bf05/note_3.0-zh-cn.png) 
...
![](../../../../images/3d9a96db/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 是 | 屏幕ID。该参数仅支持整数输入，该参数大于等于0。需要确保displayId准确才能成功获取到对应结果。可以通过[WindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#windowproperties)的displayId属性获取到准确的displayId作为入参。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[屏幕错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-display/errorcode-display)。
...
以下错误码的详细介绍请参见[屏幕错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-display/errorcode-display)。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)、[屏幕错误码](/ref/arkui-api/arkui-arkts-errcode/arkui-graphics-images-arkts-errcode/errorcode-display/errorcode-display)。
...
![](../../../../images/cbc2ae35/note_3.0-zh-cn.png) 
...
![](../../../../images/59a7a330/note_3.0-zh-cn.png) 
...
![](../../../../images/34f7f159/note_3.0-zh-cn.png) 
...
![](../../../../images/438fbe2e/note_3.0-zh-cn.png) 
...
| colorSpaces11+ | Array&lt;[colorSpaceManager.ColorSpace](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-colorspacemanager/js-apis-colorspacemanager)&gt; | 是 | 否 | 显示设备支持的所有色域类型。  ****系统能力：**** SystemCapability.WindowManager.WindowManager.Core  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| hdrFormats11+ | Array&lt;[hdrCapability.HDRFormat](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-hdrcapability/js-apis-hdrcapability#hdrformat)&gt; | 是 | 否 | 显示设备支持的所有HDR格式。  ****系统能力：**** SystemCapability.WindowManager.WindowManager.Core  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
