...
| districtSelectResult | [sceneMap.DistrictSelectResult](/ref/map-api/map-arkts/map-scenemap/map-scenemap#districtselectresult) | 否 | 否 | 返回区划选择的结果。 |
...
该接口功能依赖Map Kit，参见[selectDistrict](/ref/map-api/map-arkts/map-scenemap/map-scenemap#selectdistrict)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[DistrictSelectResult](#districtselectresult)&gt; | 是 | 回调函数。callback返回区划选择请求的结果。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [FunctionalInputController](#functionalinputcontroller) | [FunctionalInput](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-functionalinput/scenario-fusion-functionalinput)组件控制器。 |
