...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scenario-fusion-functionalbuttoncomponentmanager
kit: 应用服务
...
![](../../../images/d483fac4/note_3.0-zh-cn.png) 
...
![](../../../images/a029d84a/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| openType | [OpenType](#opentype) | 否 | 否 | 按钮功能场景类型。默认值：functionalButtonComponentManager.OpenType.GET\_PHONE\_NUMBER。  ****元服务API：**** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| label | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 按钮展示文字。默认值：空字符串。  ****元服务API：**** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| appParam | [AppParam](#appparam) | 否 | 是 | 需打开APP的信息。例如：{bundleName: "xxx", abilityName: "xxx"}。  bundleName：包名。  abilityName：Ability名称。  ****元服务API：**** 从版本4.1.0(11)开始，该接口支持在元服务中使用。  ****说明：****  openType为“functionalButtonComponentManager.OpenType.LAUNCH\_APP”时必填。 |
...
| buttonModifier | [ButtonModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 设置Button的属性，如设置按钮的样式，颜色等。  ****起始版本：**** 5.1.0(18)  ****元服务API：**** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
| textModifier | [TextModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 设置文本的属性，如设置文本颜色，字体大小，字重等。  ****起始版本：**** 5.1.0(18)  ****元服务API：**** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
| loadingProgressModifier | [LoadingProgressModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 设置加载动效的属性，如设置加载动效的样式，颜色，定制内容区等。  ****起始版本：**** 5.1.0(18)  ****元服务API：**** 从版本5.1.0(18)开始，该接口支持在元服务中使用。  ****说明：****  使用loadingProgressModifier时，需配合styleOption设置loading为true才能生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | string | 否 | 是 | 账号用户的临时登录凭证（Authorization Code）。  ****说明：****  可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](/account-kit-guide/account-get-user-info/account-get-phone/account-get-phonenumber#服务端开发)”章节。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| bundleName | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 包名。 |
| abilityName | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | Ability名称。默认值：EntryAbility。 |
...
在调用此接口前，应用需要先调用[requestPermissionsFromUser](/ref/ability-api/ability-arkts/both-models/js-apis-abilityaccessctrl/js-apis-abilityaccessctrl#requestpermissionsfromuser9)，如果用户在首次弹窗授权时已授权，调用当前接口将无法拉起弹窗。

![](../../../images/fac50fce/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| permissionResult | Array&lt;abilityAccessCtrl.[GrantStatus](/ref/ability-api/ability-arkts/both-models/js-apis-abilityaccessctrl/js-apis-abilityaccessctrl#grantstatus)&gt; | 否 | 否 | 权限设置结果。 |

## RequestSubscribeMessageResult

该接口定义请求订阅消息的返回体。

![](../../../images/020b0a37/note_3.0-zh-cn.png) 
...
![](../../../images/d0c813ec/note_3.0-zh-cn.png) 
...
该接口功能依赖Account Kit，参见[createAuthorizationWithHuaweiIDRequest](/ref/account-api/account-api-arkts/account-api-authentication/account-api-authentication#createauthorizationwithhuaweiidrequest)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[GetPhoneNumberResult](#getphonenumberresult)&gt; | 是 | 回调函数。当获取电话号码成功，err为undefined，data为获取到的账号用户的临时登录凭证（Authorization Code）；否则为错误对象。  ****说明：****  可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](/account-kit-guide/account-get-user-info/account-get-phone/account-get-phonenumber#服务端开发)”章节。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [FunctionalButtonController](#functionalbuttoncontroller) | [FunctionalButton](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-functionalbutton/scenario-fusion-functionalbutton#functionalbutton)组件控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[GetRealtimePhoneNumberResult](#getrealtimephonenumberresult)&gt; | 是 | 回调函数。当获取实时电话号码成功，err为undefined，data为获取到的账号用户的临时登录凭证（Authorization Code）；否则为错误对象。  ****说明：****  可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](/account-kit-guide/account-get-user-info/account-get-phone/account-get-phonenumber#服务端开发)”章节。 |
...
该接口功能依赖Ability Kit，参见[startAbility](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#startability)。
...
![](../../../images/0bc043da/note_3.0-zh-cn.png) 
...
该接口功能依赖Ability Kit，参见[startAbilityForResult](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#startabilityforresult)。
...
该接口功能依赖Account Kit，参见[chooseAddress](/ref/account-api/account-api-arkts/account-choose-address/account-choose-address#chooseaddress)。
...
该接口功能依赖Account Kit，参见[selectInvoiceTitle](/ref/account-api/account-api-arkts/account-api-invoiceassistant/account-api-invoiceassistant#selectinvoicetitle)。
...
该接口功能依赖Account Kit，参见[createAuthorizationWithHuaweiIDRequest](/ref/account-api/account-api-arkts/account-api-authentication/account-api-authentication#createauthorizationwithhuaweiidrequest)，[AuthenticationController](/ref/account-api/account-api-arkts/account-api-authentication/account-api-authentication#authenticationcontroller)，[executeRequest](/ref/account-api/account-api-arkts/account-api-authentication/account-api-authentication#executerequest)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| verifyToken | string | 是 | 验证成功的idToken，三方应用拉起华为账号客户端人脸验证页面时传入此Token，供华为账号客户端校验验证结果，参见[FacialRecognitionVerificationRequest](/ref/account-api/account-api-arkts/account-api-realname/account-api-realname#facialrecognitionverificationrequest)。 |
...
该接口功能依赖Map Kit，参见[chooseLocation](/ref/map-api/map-arkts/map-scenemap/map-scenemap#chooselocation)。
...
该接口功能依赖Ability Kit，参见[requestPermissionOnSetting](/ref/ability-api/ability-arkts/both-models/js-apis-abilityaccessctrl/js-apis-abilityaccessctrl#requestpermissiononsetting12)。
...
![](../../../images/2abedb26/note_3.0-zh-cn.png) 
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10004](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-error-code/scenario-fusion-error-code#section10004-系统内部异常) | Internal error. |
| [10008](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-error-code/scenario-fusion-error-code#section10008-调用方非元服务) | Not atomic service. |
...
![](../../../images/ca3134a4/note_3.0-zh-cn.png) 
...
| --- | --- |
| [10004](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-error-code/scenario-fusion-error-code#section10004-系统内部异常) | Internal error. |
| [10006](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-error-code/scenario-fusion-error-code#section10006-获取分享数据失败) | Failed to get data. |
| [10008](/ref/scenario-fusion-api/scenario-fusion-kit-arkts-components/scenario-fusion-error-code/scenario-fusion-error-code#section10008-调用方非元服务) | Not atomic service. |
...
![](../../../images/e8ad3bc0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonType](/ref/arkui-api/arkui-declarative-comp/buttons-and-selections/ts-basic-components-button/ts-basic-components-button#buttontype枚举说明) | 是 | 描述按钮显示样式。  默认值：ButtonType.Capsule |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置字体颜色。  默认值：#ffffff |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置字体大小，[Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length)为number类型时，使用fp单位。  字体默认大小16fp。不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | number | [FontWeight](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontweight) | 是 | 设置文本的字体粗细，number类型取值[100, 900]，取值间隔为100，默认为400，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"，"bolder"，"lighter"，"regular"，"medium"，"normal"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#fontstyle) | 是 | 设置字体样式。  默认值：FontStyle.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 设置字体列表。默认字体'HarmonyOS Sans'，当前支持'[HarmonyOS Sans](https://developer.huawei.com/consumer/cn/doc/design-guides/font-0000001828772001#section51091561209)'字体和[注册自定义字体](/ref/arkui-api/arkui-arkts/ui/js-apis-font/js-apis-font)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置组件自身的宽度，缺省时使用元素自身内容需要的宽度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置组件自身的高度，缺省时使用元素自身内容需要的高度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#sizeoptions) | 是 | 设置高宽尺寸。举例：  {  width: 20,  height: 50  }  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ConstraintSizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#constraintsizeoptions) | 是 | 设置约束尺寸，组件布局时，进行尺寸范围限制。constraintSize的优先级高于width和height。取值结果参考[constraintSize取值对width/height影响](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#constraintsize)。  默认值：  {  minWidth: 0,  maxWidth: Infinity,  minHeight: 0,  maxHeight: Infinity  }  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 是 | 设置内边距属性。  参数为Length类型时，四个方向内边距同时生效。  默认值：{left: 16, right: 16}  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 是 | 设置外边距属性。  参数为Length类型时，四个方向外边距同时生效。  默认值：0  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置组件的背景色。  默认值：#ff007dff |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 是 | 图片地址，支持网络图片资源和本地图片资源地址，不支持svg类型的图片。 |
| repeat | [ImageRepeat](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#imagerepeat) | 否 | 设置背景图的重复样式，默认不重复。当设置的背景图片为透明底色图片，且同时设置了backgroundColor时，二者叠加显示，背景颜色在最底部。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#sizeoptions) | [ImageSize](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#imagesize) | 是 | 设置背景图像的高度和宽度。当输入为{width: Length, height: Length}对象时，如果只设置一个属性，则第二个属性保持图片原始宽高比进行调整。默认保持原图的比例不变。  width和height取值范围： [0, +∞)  默认值：ImageSize.Auto  ****说明：****  设置为小于0的值时，按值为0显示。当设置了height未设置width时，width根据图片原始宽高比进行调整。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#position) | [Alignment](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#alignment) | 是 | 设置背景图像在组件中显示位置，即相对于组件左上角的坐标，单位vp。  默认值：  {  x: 0,  y: 0  }  x和y值设置百分比时，偏移量是相对组件自身宽高计算的。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 元素的不透明度，取值范围为0到1，默认值：1，1表示不透明，0表示完全透明，达到隐藏组件效果，但是在布局中占位。  ****说明：****  子组件可以继承父组件的此属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderOptions](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#borderoptions) | 是 | 统一边框样式设置接口。  - width：设置边框宽度。  - color：设置边框颜色。  - radius：设置边框圆角半径。  - style：设置边框样式。  ****说明：****  边框宽度默认值为0，即不显示边框。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderStyle](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#borderstyle) | [EdgeStyles](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#edgestyles9) | 是 | 设置元素的边框样式。  默认值：BorderStyle.Solid |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [EdgeWidths](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#edgewidths9) | 是 | 设置元素的边框宽度，不支持百分比。  默认值：1，单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | [EdgeColors](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#edgecolors9) | 是 | 设置元素的边框颜色。  默认值：#000000 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [BorderRadiuses](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#borderradiuses9) | 是 | 设置元素的边框圆角半径，不支持百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderImageOption](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-border-image/ts-universal-attributes-border-image#borderimageoption对象说明) | 是 | 图片边框或者渐变色边框设置接口。  该接口支持在ArkTS卡片中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScaleOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/visual-effect-property/ts-universal-attributes-transformation/ts-universal-attributes-transformation#scaleoptions对象说明) | 是 | 可以分别设置X轴、Y轴、Z轴的缩放比例，默认值为1.0，同时可以通过centerX和centerY设置缩放的中心点。  默认值：  {  x: 1.0,  y: 1.0,  z: 1.0,  centerX:'0.5',  centerY:'0.5'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Alignment](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#alignment) | 是 | 设置元素内容的对齐方式，只有当设置的width和height大小超过元素本身内容大小时生效。  默认值：Alignment.Center |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#position) | 是 | 设置元素在位置定位时的锚点，以元素顶部起点作为基准点进行偏移，单位vp。  默认值：  {  x: 0,  y: 1  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 是 | 设置图标颜色。默认值：#FFFFFF  ****说明：****  设置为异常值时，按值为'#ff666666'显示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置图标自身的宽度。默认值：20，单位：vp。  取值范围：(-∞, +∞)  填写为负数时，宽度不超过按钮大小；填写正数时，宽度不受限于按钮大小，请合理填写数值。  ****说明：****  [LoadingProgress](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-loadingprogress/ts-basic-components-loadingprogress)图标始终保持正方形，在显示时边长会取loadingWidth和[loadingHeight](#loadingheight)中的最小值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | 是 | 设置图标自身的高度。默认值：20，单位：vp。  取值范围：(-∞, +∞)  填写为负数时，高度不超过按钮大小。填写正数时，高度不受限于按钮大小，请合理填写数值。  ****说明：****  [LoadingProgress](/ref/arkui-api/arkui-declarative-comp/information-display/ts-basic-components-loadingprogress/ts-basic-components-loadingprogress)图标始终保持正方形，在显示时边长会取[loadingWidth](#loadingwidth)和loadingHeight中的最小值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 是 | 设置图标内边距属性。单位：vp。  默认值：0  取值范围：(-∞, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#length) | [Padding](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#padding) | 是 | 设置图标外边距属性。单位：vp。  默认值：{left: -2, right: 2}  取值范围：(-∞, +∞) |
...
![](../../../images/8addbf5c/zh-cn_image_0000002583480911.png)
