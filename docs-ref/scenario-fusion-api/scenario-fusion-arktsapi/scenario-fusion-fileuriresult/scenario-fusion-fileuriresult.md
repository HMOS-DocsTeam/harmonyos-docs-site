...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scenario-fusion-fileuriresult
kit: 应用服务
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[FileUriResult](#fileuriresult)&gt;&gt; | Promise对象，返回[FileUriResult](#fileuriresult)对象数组。 |
