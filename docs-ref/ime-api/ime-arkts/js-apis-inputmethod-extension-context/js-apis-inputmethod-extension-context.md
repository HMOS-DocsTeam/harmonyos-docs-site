...
![](../../../images/b306b23d/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 用于指定目标应用的Want类型信息，包括ability名称、bundle名称等。 |
...
以下错误码的详细介绍请参见[输入法框架错误码](/ref/ime-api/ime-arkts-errcode/errorcode-inputmethod-framework/errorcode-inputmethod-framework)，[元能力子系统错误码](/ref/ability-api/ability-arkts-errcode/errorcode-ability/errorcode-ability)，[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)。
