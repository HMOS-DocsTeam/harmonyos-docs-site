...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputmethod
kit: 应用框架
...
![](../../../images/9281303f/note_3.0-zh-cn.png) 
...
| enabledState20+ | [EnabledState](/ref/ime-api/ime-arkts/js-apis-inputmethod/js-apis-inputmethod#enabledstate15) | 是 | 是 | 非必填。  - 当InputMethodProperty用于切换、查询等接口的入参时，开发者可不填写此字段，通过name和id即可唯一指定一个输入法扩展  - 当InputMethodProperty作为查询接口的返回值时（如[getCurrentInputMethod](#inputmethodgetcurrentinputmethod9)），此字段表示该输入法启用状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname) | 系统输入法设置界面Ability的ElementName。 |
...
![](../../../images/820fdb78/note_3.0-zh-cn.png) 
...
![](../../../images/c735207b/note_3.0-zh-cn.png) 
...
![](../../../images/7b05a5fc/note_3.0-zh-cn.png) 
...
![](../../../images/9ce16914/note_3.0-zh-cn.png) 
...
![](../../../images/81a0ceb0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype) | 是 | 目标输入法子类型。 |
...
![](../../../images/393d41c9/note_3.0-zh-cn.png) 
...
![](../../../images/72671f8a/note_3.0-zh-cn.png) 
...
![](../../../images/e4f23a13/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype) | 返回当前输入法子类型对象。 |
...
![](../../../images/184d0f9e/note_3.0-zh-cn.png) 
...
| inputMethodSubtype | [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype) | 是 | 目标输入法子类型。 |
...
![](../../../images/05099114/note_3.0-zh-cn.png) 
...
![](../../../images/2a58350f/note_3.0-zh-cn.png) 
...
![](../../../images/36ba935f/note_3.0-zh-cn.png) 
...
![](../../../images/d636fef5/note_3.0-zh-cn.png) 
...
![](../../../images/031344aa/note_3.0-zh-cn.png) 
...
| windowId | number | 否 | 是 | 编辑框所在的窗口Id，该参数应为整数。  推荐使用[getWindowProperties](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#getwindowproperties9)方法获取窗口id属性。 |
...
![](../../../images/9f0447a3/note_3.0-zh-cn.png) 
...
![](../../../images/91d99dae/note_3.0-zh-cn.png) 
...
![](../../../images/32ca8695/note_3.0-zh-cn.png) 
...
![](../../../images/2b1b2c9a/note_3.0-zh-cn.png) 

需要先调用此接口，完成自绘控件与输入法的绑定，才能使用以下功能：显示/隐藏键盘、更新光标信息、更改编辑框选中范围、保存配置信息、监听处理由输入法应用发送的信息或命令等。

当自绘控件所在窗口通过[setWindowFocusable](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setwindowfocusable9)设置为不可获焦窗口时，系统将无法保证自绘输入控件与输入法正常交互。若开发者希望在不可获焦窗口中绘制输入框，建议参考[不可获焦窗口中输入框与输入法交互指南](/ime-kit/use-inputmethod-in-not-focusable-window)。
...
![](../../../images/63638ef8/note_3.0-zh-cn.png) 
...
![](../../../images/3c3341d2/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[输入法框架错误码](/ref/ime-api/ime-arkts-errcode/errorcode-inputmethod-framework/errorcode-inputmethod-framework)和[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../images/8ec62a19/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 是 | UIContext实例对象。 |
| textConfig | [TextConfig](#textconfig10) | 是 | 编辑框的配置信息。 |
...
![](../../../images/0755daf0/note_3.0-zh-cn.png) 
...
![](../../../images/b7e0624e/note_3.0-zh-cn.png) 
...
![](../../../images/9f7e1cad/note_3.0-zh-cn.png) 
...
![](../../../images/d8dc89ba/note_3.0-zh-cn.png) 
...
![](../../../images/5b227f25/note_3.0-zh-cn.png) 
...
![](../../../images/207d1699/note_3.0-zh-cn.png) 
...
![](../../../images/b30872ac/note_3.0-zh-cn.png) 
...
![](../../../images/167edb06/note_3.0-zh-cn.png) 
...
![](../../../images/075ffb5d/note_3.0-zh-cn.png) 
...
![](../../../images/46d39384/note_3.0-zh-cn.png) 
...
![](../../../images/d9bdfd03/note_3.0-zh-cn.png) 
...
![](../../../images/3e73e2ff/note_3.0-zh-cn.png) 
...
![](../../../images/db870d2d/note_3.0-zh-cn.png) 
...
![](../../../images/ed0cab2e/note_3.0-zh-cn.png) 
...
![](../../../images/621adbf2/note_3.0-zh-cn.png) 
...
![](../../../images/21570951/note_3.0-zh-cn.png) 
...
![](../../../images/6ff91173/note_3.0-zh-cn.png) 
...
![](../../../images/bd43f728/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[Range](#range10)&gt; | 是 | 回调函数，返回需要选中的文本范围。  根据传入的文本范围，开发者在回调函数中编辑框中相应文本。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'selectByRange'。 |
| callback | Callback&lt;[Range](#range10)&gt; | 否 | 取消订阅的回调函数，需要与on接口传入的保持一致。  参数不填写时，取消订阅type对应的所有回调事件。 |
...
| callback | Callback&lt;[Movement](#movement10)&gt; | 是 | 回调函数，返回光标移动的方向。  根据传入的光标移动方向，选中编辑框中相应文本。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'selectByMovement'。 |
| callback | Callback&lt;[Movement](#movement10)&gt; | 否 | 取消订阅的回调函数，需要与on接口传入的保持一致。  参数不填写时，取消订阅type对应的所有回调事件。 |
...
![](../../../images/b8089abb/note_3.0-zh-cn.png) 
...
![](../../../images/a456687a/note_3.0-zh-cn.png) 
...
| callback | (inputMethodProperty: [InputMethodProperty](#inputmethodproperty8), inputMethodSubtype: [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)) => void | 是 | 回调函数，返回输入法属性对象及子类型对象。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'imeChange'。 |
| callback | (inputMethodProperty: [InputMethodProperty](#inputmethodproperty8), inputMethodSubtype: [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)) => void | 否 | 回调函数，返回取消订阅的输入法属性对象及子类型对象。 |
...
| callback | AsyncCallback&lt;Array&lt;[InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)&gt;&gt; | 是 | 回调函数，返回指定输入法应用的所有子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)&gt;&gt; | Promise对象，返回指定输入法应用的所有子类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)&gt;&gt; | 是 | 回调函数，返回当前输入法应用的所有子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype#inputmethodsubtype)&gt;&gt; | Promise对象，返回当前输入法应用的所有子类型。 |
...
![](../../../images/fb4ca0f5/note_3.0-zh-cn.png) 
...
![](../../../images/49d954b7/note_3.0-zh-cn.png) 
...
![](../../../images/c30b30ce/note_3.0-zh-cn.png) 
...
![](../../../images/dceab90e/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 18开始废弃，建议使用[InputMethodListDialog](/ref/ime-api/ime-arkts/js-apis-inputmethodlist/js-apis-inputmethodlist#inputmethodlistdialog)替代。
...
![](../../../images/23ef2511/note_3.0-zh-cn.png) 
...
![](../../../images/11687a8a/note_3.0-zh-cn.png) 
...
![](../../../images/5a777ba6/note_3.0-zh-cn.png) 
...
![](../../../images/b53abe5b/note_3.0-zh-cn.png) 

从API version 8开始支持，从API version 9开始废弃，建议使用[InputMethodListDialog](/ref/ime-api/ime-arkts/js-apis-inputmethodlist/js-apis-inputmethodlist#inputmethodlistdialog)替代。
...
![](../../../images/f65f41fc/note_3.0-zh-cn.png) 
