...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputmethodengine
kit: 应用框架
...
![](../../../images/decc9a75/note_3.0-zh-cn.png) 
...
![](../../../images/ce95fefd/note_3.0-zh-cn.png) 
...
![](../../../images/7abc8bba/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [window.Size](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#size7) | 是 | 当前面板大小。 |
| keyboardArea | [KeyboardArea](#keyboardarea15) | 否 | 当前面板中可作为键盘区域的大小。 |

## InputMethodEngine(deprecated)

![](../../../images/6f2f1f0c/note_3.0-zh-cn.png) 
...
![](../../../images/fdfd0aa4/note_3.0-zh-cn.png) 
...
![](../../../images/d10d8993/note_3.0-zh-cn.png) 
...
![](../../../images/243a6323/note_3.0-zh-cn.png) 
...
![](../../../images/5dd0c67d/note_3.0-zh-cn.png) 
...
| callback | (inputMethodSubtype: [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype)) => void | 是 | 回调函数，返回设置的输入法子类型。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'setSubtype'。 |
| callback | (inputMethodSubtype: [InputMethodSubtype](/ref/ime-api/ime-arkts/js-apis-inputmethod-subtype/js-apis-inputmethod-subtype)) => void | 否 | 取消订阅的回调函数。参数不填写时，取消订阅type对应的所有回调事件。 |
...
以下错误码的详细介绍请参见[输入法框架错误码](/ref/ime-api/ime-arkts-errcode/errorcode-inputmethod-framework/errorcode-inputmethod-framework)。
...
创建输入法面板，仅支持输入法应用在[InputMethodExtensionAbility](/ref/ime-api/ime-arkts/js-apis-inputmethod-extension-ability/js-apis-inputmethod-extension-ability#inputmethodextensionability)类中调用。使用callback异步回调。

![](../../../images/ccf7b0b8/note_3.0-zh-cn.png) 

单个输入法应用仅允许创建一个[软键盘类型](#paneltype10)和一个[状态栏类型](#paneltype10)的面板。

输入法面板不支持创建子窗口。例如：不支持使用[window.createWindow](/arkui/window-manager/application-window-fa#设置应用子窗口)、[bindContextMenu](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/popup-property/ts-universal-attributes-menu/ts-universal-attributes-menu#bindcontextmenu8)、[CustomDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ts-methods-custom-dialog-box/ts-methods-custom-dialog-box)等接口创建子窗口弹窗。建议开发者采用非子窗的替代方案，如[弹出框](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ohos-arkui-advanced-dialog/ohos-arkui-advanced-dialog)、[bindMenu](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/popup-property/ts-universal-attributes-menu/ts-universal-attributes-menu#bindmenu)或设置showInSubwindow为false。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctx | [BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext) | 是 | 当前输入法应用上下文信息。 |
| info | [PanelInfo](#panelinfo10) | 是 | 输入法面板信息。 |
| callback | AsyncCallback&lt;[Panel](#panel10)&gt; | 是 | 回调函数。当输入法面板创建成功，返回当前创建的输入法面板对象。 |

****错误码：****

以下错误码的详细介绍请参见[输入法框架错误码](/ref/ime-api/ime-arkts-errcode/errorcode-inputmethod-framework/errorcode-inputmethod-framework)，[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)。
...
创建输入法面板，仅支持输入法应用在[InputMethodExtensionAbility](/ref/ime-api/ime-arkts/js-apis-inputmethod-extension-ability/js-apis-inputmethod-extension-ability#inputmethodextensionability)类中调用。使用promise异步回调。

![](../../../images/b30721fb/note_3.0-zh-cn.png) 
...
| callback | (event: [InputKeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent#keyevent)) => boolean | 是 | 回调函数，入参为按键事件信息，返回值类型为布尔类型。  - 入参按键事件信息的数据类型为[InputKeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent#keyevent)。  - 若按键事件被事件订阅者消费，则callback应返回true，否则返回false。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'keyEvent'。 |
| callback | (event: [InputKeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent#keyevent)) => boolean | 否 | 取消订阅的回调函数。参数不填写时，取消订阅type对应的所有回调事件。 |
...
| storage | [LocalStorage](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-state-management/ts-state-management#localstorage9) | 是 | 存储单元，为应用程序范围内的可变和不可变状态属性提供存储。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。当面板页面内容加载成功，err为undefined，否则err为错误对象。 |
...
| storage | [LocalStorage](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-state-management/ts-state-management#localstorage9) | 是 | 存储单元，为应用程序范围内的可变状态属性和非可变状态属性提供存储。 |
...
![](../../../images/21b20fce/note_3.0-zh-cn.png) 
...
![](../../../images/8d1e3c4b/note_3.0-zh-cn.png) 
...
![](../../../images/d5f91d7c/note_3.0-zh-cn.png) 
...
![](../../../images/694b054f/note_3.0-zh-cn.png) 
...
![](../../../images/f1382499/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputRegion | Array&lt;[window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7)&gt; | 是 | 面板内接收输入事件的区域。  - 数组大小限制为[1, 4]。  - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
...
![](../../../images/5dbfe09e/note_3.0-zh-cn.png) 
...
- 从API version 12-14开始支持，此接口回调函数中仅包含[window.Size](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#size7)类型的必选参数。
...
![](../../../images/0b4bc3d4/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[输入法框架错误码](/ref/ime-api/ime-arkts-errcode/errorcode-inputmethod-framework/errorcode-inputmethod-framework)。
...
![](../../../images/85af107a/note_3.0-zh-cn.png) 
...
![](../../../images/9f955ca4/note_3.0-zh-cn.png) 
...
![](../../../images/ff7d2825/note_3.0-zh-cn.png) 
...
![](../../../images/c55b3585/note_3.0-zh-cn.png) 
...
![](../../../images/41e47a94/note_3.0-zh-cn.png) 
...
![](../../../images/c8720c7c/note_3.0-zh-cn.png) 
...
![](../../../images/465aaa90/note_3.0-zh-cn.png) 

输入法应用调用该接口向编辑框发送扩展编辑操作，编辑框监听相应事件[on('handleExtendAction')](/ref/ime-api/ime-arkts/js-apis-inputmethod/js-apis-inputmethod#onhandleextendaction10)，从而进一步做出处理。

编辑框响应[ExtendAction](#extendaction10)的PASTE命令时，需要编辑框应用申请[ohos.permission.READ\_PASTEBOARD](/system-security/access-control/app-permission-mgmt/app-permissions/restricted-permissions#ohospermissionread_pasteboard)权限。
...
![](../../../images/949306b7/note_3.0-zh-cn.png) 
...
![](../../../images/3a8cc4b0/note_3.0-zh-cn.png) 
...
![](../../../images/2f383363/note_3.0-zh-cn.png) 
...
![](../../../images/f77743f2/note_3.0-zh-cn.png) 
...
![](../../../images/72609b94/note_3.0-zh-cn.png) 
...
![](../../../images/fb3ec60c/note_3.0-zh-cn.png) 
...
![](../../../images/9f74bfec/note_3.0-zh-cn.png) 
...
![](../../../images/72e010f8/caution_3.0-zh-cn.png) 
...
![](../../../images/5726445a/caution_3.0-zh-cn.png) 
...
| extraConfig22+ | [InputMethodExtraConfig](/ref/ime-api/ime-arkts/js-apis-inputmethod-extraconfig/js-apis-inputmethod-extraconfig#inputmethodextraconfig) | 是 | 是 | 输入法扩展信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| keyCode | number | 是 | 否 | 按键的键值。键码值说明参考[KeyCode](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keycode/js-apis-keycode#keycode)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| landscapeRect | [window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 否 | 否 | 横屏状态时输入法面板窗口的位置大小。 |
| portraitRect | [window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 否 | 否 | 竖屏状态时输入法面板窗口的位置大小。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| landscapeRect | [window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 否 | 是 | 横屏状态时输入法面板窗口的位置大小。  - 当fullScreenMode不填写或值为false时，此属性为必选。 |
| portraitRect | [window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 否 | 是 | 竖屏状态时，输入法面板窗口的位置大小。  - 当fullScreenMode不填写或值为false时，此属性为必选。 |
| landscapeAvoidY | number | 否 | 是 | 横屏状态时，面板中的避让线距离面板顶部的距离，单位px。默认值为0。  - 应用内其他系统组件会对避让线以下的输入法面板区域进行避让。  - 面板为固定态时，避让线到屏幕底部的高度不能超过屏幕高度的70%。 |
| landscapeInputRegion | Array&lt;[window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7)&gt; | 否 | 是 | 横屏状态时，面板接收输入事件的区域。  - 数组大小限制为[1, 4]。默认值为横屏时的面板大小。  - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
| portraitAvoidY | number | 否 | 是 | 竖屏状态时，面板中的避让线距离面板顶部的距离，单位px。默认值为0。  - 应用内其他系统组件会对避让线以下的输入法面板区域进行避让。  - 面板为固定态时，避让线到屏幕底部的高度不能超过屏幕高度的70%。 |
| portraitInputRegion | Array&lt;[window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7)&gt; | 否 | 是 | 竖屏状态时，面板接收输入事件的区域。  - 数组大小限制为[1, 4]。默认值为竖屏时的面板大小。  - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rect | [window.Rect](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-i/arkts-apis-window-i#rect7) | 否 | 否 | 窗口矩形区域。 |
| status | [window.WindowStatusType](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-e/arkts-apis-window-e#windowstatustype11) | 否 | 否 | 窗口模式类型。 |
...
![](../../../images/c1caa7aa/note_3.0-zh-cn.png) 
...
![](../../../images/1bdccc6b/note_3.0-zh-cn.png) 
...
![](../../../images/9f80399f/note_3.0-zh-cn.png) 
...
![](../../../images/f38804e8/note_3.0-zh-cn.png) 
...
![](../../../images/cc79042e/note_3.0-zh-cn.png) 
...
![](../../../images/8fc9012a/note_3.0-zh-cn.png) 
...
![](../../../images/d196ade1/note_3.0-zh-cn.png) 
...
![](../../../images/61c8f2b2/note_3.0-zh-cn.png) 
...
![](../../../images/18eebb0d/note_3.0-zh-cn.png) 
...
![](../../../images/da7a81d9/note_3.0-zh-cn.png) 
...
![](../../../images/445ede63/note_3.0-zh-cn.png) 
...
![](../../../images/40610854/note_3.0-zh-cn.png) 
...
![](../../../images/9fa6d3b2/note_3.0-zh-cn.png) 
...
![](../../../images/7916a146/note_3.0-zh-cn.png) 
...
![](../../../images/8c391c14/note_3.0-zh-cn.png) 
