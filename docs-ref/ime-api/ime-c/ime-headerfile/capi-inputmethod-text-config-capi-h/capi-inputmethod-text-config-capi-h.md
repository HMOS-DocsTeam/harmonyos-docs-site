...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) | InputMethod\_TextConfig | 输入框的配置信息。 |

### 函数

| 名称 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig \*OH\_TextConfig\_Create(void)](#oh_textconfig_create) | 创建一个新的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例。 |
| [void OH\_TextConfig\_Destroy(InputMethod\_TextConfig \*config)](#oh_textconfig_destroy) | 销毁一个[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例。 |
...
创建一个新的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例。
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \* | 如果创建成功，返回一个指向新创建的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。  如果创建失败，对象返回NULL，可能的失败原因有应用地址空间满。 |
...
销毁一个[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例。
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 表示指向即将被销毁的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 指向即将被设置值的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
| [InputMethod\_TextInputType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_textinputtype) inputType | 输入框的输入类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 指向即将被设置值的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
| [InputMethod\_EnterKeyType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_enterkeytype) enterKeyType | 回车键功能类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_errorcode) | [InputMethod\_ErrorCode](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_errorcode)：  IME\_ERR\_OK = 0：表示成功。  IME\_ERR\_NULL\_POINTER = 12802000：非预期的空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 指向即将被获取值的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
| [InputMethod\_TextInputType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_textinputtype) \*inputType | 表示指向[InputMethod\_TextInputType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_textinputtype)实例的指针。 输入框的输入类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 指向即将被获取值的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
| [InputMethod\_EnterKeyType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_enterkeytype) \*enterKeyType | 表示指向[InputMethod\_EnterKeyType](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_enterkeytype)实例的指针。 输入框的回车键功能类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 指向即将被获取值的[InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig)实例的指针。 |
| [InputMethod\_CursorInfo](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-cursorinfo/capi-inputmethod-inputmethod-cursorinfo) \*\*cursorInfo | 光标信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textconfig/capi-inputmethod-inputmethod-textconfig) \*config | 表示文本配置信息。 |
| [InputMethod\_TextAvoidInfo](/ref/ime-api/ime-c/ime-struct/capi-inputmethod-inputmethod-textavoidinfo/capi-inputmethod-inputmethod-textavoidinfo) \*\*avoidInfo | 输入框避让信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_errorcode) | [InputMethod\_ErrorCode](/ref/ime-api/ime-c/ime-headerfile/capi-inputmethod-types-capi-h/capi-inputmethod-types-capi-h#inputmethod_errorcode)：  IME\_ERR\_OK = 0：表示成功。  IME\_ERR\_PARAMCHECK = 401：参数检查失败。  IME\_ERR\_NULL\_POINTER = 12802000：非预期的空指针。 |
