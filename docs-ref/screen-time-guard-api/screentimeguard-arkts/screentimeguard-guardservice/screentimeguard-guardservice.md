...
| ****名称**** | ****值**** | ****说明**** |
| --- | --- | --- |
| INTERNAL\_ERROR | [1019000001](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000001-内部错误) | 内部错误。 |
| USER\_NOT\_AUTHORIZED | [1019000002](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000002-用户未授权) | 用户未授权。 |
| USER\_CANCELED | [1019000003](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000003-用户取消) | 用户取消。 |
| STRATEGIES\_EXCEED\_LIMIT | [1019000004](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000004-策略数量超限) | 策略数量超限。 |
| STRATEGY\_NAME\_ALREADY\_EXIST | [1019000005](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000005-策略名称重复) | 策略名称重复。 |
| NONEXISTENT\_STRATEGY | [1019000006](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000006-策略不存在) | 策略不存在。 |
| STRATEGY\_ALREADY\_EXECUTED | [1019000007](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000007-策略重复执行) | 策略重复执行。 |
| STRATEGY\_NOT\_STARTED | [1019000008](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000008-策略未执行) | 策略未执行。 |
| INVALID\_PARAM | [1019000009](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-error-code/screentimeguard-error-code#section1019000009-参数检查失败) | 无效参数。  ****起始版本：**** 6.0.2(22) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)的上下文环境。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| guardStrategy | [GuardStrategy](#guardstrategy) | 是 | 管控策略。  ****说明****：  添加管控策略时策略数量的上限为50条。 |
...
| INCLUSIVE\_DURATION\_TYPE | 3 | 共享时长策略类型，表示策略关联的所有应用共享同一可用时长配额，超额后所有应用均受时长限制，从调用[startGuardStrategy](#startguardstrategy)接口成功后开始计时。如果为此类型，则[TimeStrategy](#timestrategy)接口中的startTime、endTime非必填，totalDuration必填，RestrictionType只支持TRUSTLIST\_TYPE。  ****起始版本：**** 6.0.2(22) |
...
| guardStrategy | [GuardStrategy](#guardstrategy) | 是 | 新的时间管控策略。  ****说明****：  如想修改策略名称，可以在guardStrategy的name属性中传入新名称。但不能是已存在的名称，如果名称已存在则返回401错误码。 |
...
| restrictionType | [RestrictionType](#restrictiontype) | 是 | 限制类型  TRUSTLIST\_TYPE表示对appInfo外的应用进行限制，BLOCKLIST\_TYPE表示对appInfo内的应用进行限制。 |
