...
title: "ArkTS API错误码"
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/screentimeguard-error-code
kit: 应用服务
...
![](../../../images/9c8bf211/note_3.0-zh-cn.png) 
...
1、先使用[策略查询接口（queryGuardStrategies）](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#queryguardstrategies)获取应用名下有哪些策略。
