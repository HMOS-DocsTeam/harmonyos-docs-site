...
title: "数据类型说明"
sidebar_position: 17
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-server-data-model
kit: 应用服务
last_updated: "2026-04-22"
slug: iap-server-data-model
---
...
| applicationId | 是 | String | 应用ID，获取方式参见[配置应用身份信息](/iap-kit-guide/iap-preparations/iap-config-app-identity-info)。 |
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| applicationId | 是 | String | APP ID，获取方式参见[配置应用身份信息](/iap-kit-guide/iap-preparations/iap-config-app-identity-info)。 |
| productId | 是 | String | 商品ID。 |
...
| applicationUserName | 否 | String | 用户账户相关联的混淆字符串，唯一标识用户，传递优惠ID场景，可以传递该字段，若传递了本字段则需在[PurchaseParameter](/ref/iap-api/iap-arkts/iap-iap/iap-iap#purchaseparameter)请求参数中传递一个相同的applicationUserName。 |
