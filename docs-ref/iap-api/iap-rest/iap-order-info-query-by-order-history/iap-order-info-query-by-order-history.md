...
![](../../../images/a8b6196d/note_3.0-zh-cn.png) 
...
| jwsPurchaseOrderList | 否 | List&lt;String&gt; | 已购订单相关状态信息的JWS格式数据的数组。  可参见[返回结果验签](/ref/iap-api/iap-rest/iap-verifying-signature/iap-verifying-signature)处理，验签通过后解码获取相关订单状态信息，具体请参见[PurchaseOrderPayload](/ref/iap-api/iap-rest/iap-server-data-model/iap-server-data-model#purchaseorderpayload)说明。 |
