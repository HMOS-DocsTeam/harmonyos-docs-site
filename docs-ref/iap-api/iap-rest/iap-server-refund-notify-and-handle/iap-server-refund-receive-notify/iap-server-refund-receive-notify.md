...
如果开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)申请支付服务时提前[配置通知接收地址](/iap-kit-guide/iap-preparations/iap-basic-preparation/iap-set-necessary-parameters#配置订单订阅通知接收地址)，并且通知版本设置为v3，用户申请对已支付订单进行退款时，IAP服务器会调用此接口通知已配置的服务器。
...
![](../../../../images/a3c12650/zh-cn_image_0000002583440945.png)
...
![](../../../../images/0f551a22/note_3.0-zh-cn.png) 
...
| refundOrders | 是 | List&lt;[RefundOrder](#refundorder)&gt; | 退款申请工单下的订单号，当前仅游戏应用场景支持多笔订单。 |
