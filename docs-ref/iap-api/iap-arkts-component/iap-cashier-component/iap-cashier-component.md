...
CashierComponent需要配合[cashierComponentManager](/ref/iap-api/iap-arkts-component/iap-cashier-component-manager/iap-cashier-component-manager)一起使用，用于实现iap嵌入式收银台功能。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| params | [iap.PurchaseParameter](/ref/iap-api/iap-arkts/iap-iap/iap-iap#purchaseparameter) | 是 | @Require  @Prop | CashierComponent组件参数。  ****说明：****  该参数必须是@State装饰的局部变量。 |
| displayOptions | [cashierComponentManager.CashierDisplayOptions](/ref/iap-api/iap-arkts-component/iap-cashier-component-manager/iap-cashier-component-manager#cashierdisplayoptions) | 否 | - | CashierComponent组件的配置参数。 |
| purchaseListener | [cashierComponentManager.CashierListener](/ref/iap-api/iap-arkts-component/iap-cashier-component-manager/iap-cashier-component-manager#cashierlistener) | 是 | - | CashierComponent用来接收组件的成功失败的回调事件。 |
