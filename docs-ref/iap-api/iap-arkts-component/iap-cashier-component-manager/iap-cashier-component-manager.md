...
[CashierComponent](/ref/iap-api/iap-arkts-component/iap-cashier-component/iap-cashier-component#cashiercomponent)组件的监听，用来回调组件调用的成功、失败事件。
...
| purchaseResult | [iap.CreatePurchaseResult](/ref/iap-api/iap-arkts/iap-iap/iap-iap#createpurchaseresult) | 是 | 支付成功回调获取到的[iap.CreatePurchaseResult](/ref/iap-api/iap-arkts/iap-iap/iap-iap#createpurchaseresult)对象。 |
...
| error | [BusinessError&lt;void&gt;](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#businesserror) | 是 | 支付失败回调获取到的[iap.CreatePurchaseResult](/ref/iap-api/iap-arkts/iap-iap/iap-iap#createpurchaseresult)对象。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 收银台背景颜色。 |
