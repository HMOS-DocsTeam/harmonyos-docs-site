...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[uniformTypeDescriptor.UniformDataType](/ref/arkdata-api/arkdata-arkts/js-apis-data-uniformtypedescriptor/js-apis-data-uniformtypedescriptor#uniformdatatype)&gt; | 返回对应铃声类型支持的文件类型。 |

****错误码：****

以下错误码的详细介绍请参见铃声服务[ArkTS API错误码](/ref/ringtone-api/ringtone-arkts/ringtone-error-code/ringtone-error-code)。
...
| --- | --- | --- | --- |
| ringtoneType | [RingtoneType](#ringtonetype) | 是 | 待查询的铃声类型。 |
| dataType | [uniformTypeDescriptor.UniformDataType](/ref/arkdata-api/arkdata-arkts/js-apis-data-uniformtypedescriptor/js-apis-data-uniformtypedescriptor#uniformdatatype) | 是 | 待查询的文件类型。 |
