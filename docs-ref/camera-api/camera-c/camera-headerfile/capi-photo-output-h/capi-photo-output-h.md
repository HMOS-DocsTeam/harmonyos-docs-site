...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-photo-output-h
kit: 媒体
last_updated: "2026-04-22"
slug: capi-photo-output-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks) | PhotoOutput\_Callbacks | 拍照输出的回调。 |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput) | Camera\_PhotoOutput | 拍照输出对象。  可以使用[OH\_CameraManager\_CreatePhotoOutput](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_createphotooutput)方法创建指针。 |

### 函数

| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_PhotoOutput\_OnFrameStart)(Camera\_PhotoOutput\* photoOutput)](#oh_photooutput_onframestart) | OH\_PhotoOutput\_OnFrameStart | 在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧启动回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnFrameShutter)(Camera\_PhotoOutput\* photoOutput, Camera\_FrameShutterInfo\* info)](#oh_photooutput_onframeshutter) | OH\_PhotoOutput\_OnFrameShutter | 在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧快门回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnFrameEnd)(Camera\_PhotoOutput\* photoOutput, int32\_t frameCount)](#oh_photooutput_onframeend) | OH\_PhotoOutput\_OnFrameEnd | 在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧结束回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnError)(Camera\_PhotoOutput\* photoOutput, Camera\_ErrorCode errorCode)](#oh_photooutput_onerror) | OH\_PhotoOutput\_OnError | 在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出错误回调。 |
...
| [Camera\_ErrorCode OH\_PhotoOutput\_Capture(Camera\_PhotoOutput\* photoOutput)](#oh_photooutput_capture) | - | 拍摄照片。  必须在[OH\_PreviewOutput\_Release](/ref/camera-api/camera-c/camera-headerfile/capi-preview-output-h/capi-preview-output-h#oh_previewoutput_release)之前调用，否则会导致无法拍照。 |
...
在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧启动回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
...
在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧快门回调。
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_FrameShutterInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-frameshutterinfo/capi-oh-camera-camera-frameshutterinfo)\* info | 回调传递的帧快门回调信息。 |
...
在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出帧结束回调。
...
在[PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)中被调用的拍照输出错误回调。
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) errorCode | 拍照输出的错误码。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_CaptureStartInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-capturestartinfo/capi-oh-camera-camera-capturestartinfo)\* Info | 回调传递的拍照开始信息。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
| [OH\_PhotoNative](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-oh-photonative/capi-oh-camera-oh-photonative)\* photo | 回调传递的OH\_PhotoNative。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递回调的拍照输出实例。 |
| [OH\_MediaAsset](/ref/media-library-api/media-library-c/media-library-struct/capi-mediaassetmanager-oh-mediaasset/capi-mediaassetmanager-oh-mediaasset)\* photoAsset | 回调传递的媒体资源。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)\* callback | 要注册的拍照输出更改事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [PhotoOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-photooutput-callbacks/capi-oh-camera-photooutput-callbacks)\* callback | 要注销的拍照输出更改事件回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于获取照片旋转角度的拍照输出实例。 |
| int deviceDegree | 当前设备旋转角度。 |
| [Camera\_ImageRotation](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_imagerotation)\* imageRotation | 照片旋转角度的结果。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_CaptureStartWithInfo](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_capturestartwithinfo) callback | 要注销的拍照开始事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_CaptureEnd](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_captureend) callback | 要注册的拍照结束事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_CaptureEnd](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_captureend) callback | 要注销的拍照结束事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_OnFrameShutterEnd](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_onframeshutterend) callback | 要注册的拍照曝光结束事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_OnFrameShutterEnd](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_onframeshutterend) callback | 要注销的拍照曝光结束事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_CaptureReady](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_captureready) callback | 要注册的拍照就绪事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_CaptureReady](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_captureready) callback | 要注销的拍照就绪事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_EstimatedCaptureDuration](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_estimatedcaptureduration) callback | 要注册的预计拍照时间事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_EstimatedCaptureDuration](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_estimatedcaptureduration) callback | 要注销的预计拍照时间事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_PhotoAvailable](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_photoavailable) callback | 要注册的输出照片可用回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_PhotoAvailable](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_photoavailable) callback | 要注销的输出照片可用回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_PhotoAssetAvailable](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_photoassetavailable) callback | 要注册的输出照片资源可用回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例。 |
| [OH\_PhotoOutput\_PhotoAssetAvailable](/ref/camera-api/camera-c/camera-headerfile/capi-photo-output-h/capi-photo-output-h#oh_photooutput_photoassetavailable) callback | 要注销的输出照片资源可用回调。 |
...
必须在[OH\_PreviewOutput\_Release](/ref/camera-api/camera-c/camera-headerfile/capi-preview-output-h/capi-preview-output-h#oh_previewoutput_release)之前调用，否则会导致无法拍照。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于捕获拍照的拍照输出实例。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_RUNNING：捕获会话未运行。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于捕获拍照的拍照输出实例。 |
| [Camera\_PhotoCaptureSetting](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photocapturesetting/capi-oh-camera-camera-photocapturesetting) setting | 用于捕获拍照的[Camera\_PhotoCaptureSetting](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photocapturesetting/capi-oh-camera-camera-photocapturesetting)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 要释放的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例，用于检查是否支持镜像。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 拍照输出实例，用于确认是否启用镜像拍照。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 传递当前配置文件的拍照输出实例。 |
| [Camera\_Profile](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-profile/capi-oh-camera-camera-profile)\*\* profile | 如果方法调用成功，将记录照片输出配置文件。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Profile](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-profile/capi-oh-camera-camera-profile)\* profile | 要被删除的照片配置文件实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于检查是否支持动态照片的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于启用或禁用动态照片的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于获取是否支持拍照画质优先策略的拍照输出实例。 |
| [Camera\_PhotoQualityPrioritization](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_photoqualityprioritization) qualityPrioritization | 要检查的拍照画质优先策略。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\* photoOutput | 用于设置拍照画质优先策略的拍照输出实例。 |
| [Camera\_PhotoQualityPrioritization](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_photoqualityprioritization) qualityPrioritization | 要设置的拍照画质优先策略。 |
