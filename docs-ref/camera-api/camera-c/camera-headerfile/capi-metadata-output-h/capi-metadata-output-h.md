...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks) | MetadataOutput\_Callbacks | 元数据输出的回调。 |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput) | Camera\_MetadataOutput | 元数据输出对象。  可以使用[OH\_CameraManager\_CreateMetadataOutput](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_createmetadataoutput)方法创建指针。 |

### 函数

| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_MetadataOutput\_OnMetadataObjectAvailable)(Camera\_MetadataOutput\* metadataOutput, Camera\_MetadataObject\* metadataObject, uint32\_t size)](#oh_metadataoutput_onmetadataobjectavailable) | OH\_MetadataOutput\_OnMetadataObjectAvailable | 在[MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)中被调用的元数据输出元数据对象可用回调。 |
| [typedef void (\*OH\_MetadataOutput\_OnError)(Camera\_MetadataOutput\* metadataOutput, Camera\_ErrorCode errorCode)](#oh_metadataoutput_onerror) | OH\_MetadataOutput\_OnError | 在[MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)中被调用的元数据输出错误回调。 |
...
在[MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)中被调用的元数据输出元数据对象可用回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 传递回调的元数据输出实例。 |
| [Camera\_MetadataObject](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataobject/capi-oh-camera-camera-metadataobject)\* metadataObject | 回调传递的元数据实例信息。 |
...
在[MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)中被调用的元数据输出错误回调。
...
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 传递回调的元数据输出实例。 |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) errorCode | 元数据输出的错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 元数据输出实例。 |
| [MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)\* callback | 要注册的元数据输出回调。 |
...
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 元数据输出实例。 |
| [MetadataOutput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-metadataoutput-callbacks/capi-oh-camera-metadataoutput-callbacks)\* callback | 要注销的元数据输出回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 要启动的元数据输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 要停止的元数据输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 要释放的元数据输出实例。 |
...
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 元数据输出实例。 |
| [Camera\_MetadataObjectType](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_metadataobjecttype)\* types | 用于添加到Camera\_MetadataOutput实例的元数据对象类型数组。 |
...
| --- | --- |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\* metadataOutput | 元数据输出实例。 |
| [Camera\_MetadataObjectType](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_metadataobjecttype)\* types | 从Camera\_MetadataOutput实例移除的元数据对象类型数组。 |
| uint32\_t size | 元数据对象类型数组长度。 |
