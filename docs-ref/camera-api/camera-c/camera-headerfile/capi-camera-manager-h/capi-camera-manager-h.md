...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-manager-h
kit: 媒体
last_updated: "2026-04-22"
slug: capi-camera-manager-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CameraManager\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-cameramanager-callbacks/capi-oh-camera-cameramanager-callbacks) | CameraManager\_Callbacks | 相机设备状态的回调。 |

### 函数

| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_CameraManager\_StatusCallback)(Camera\_Manager\* cameraManager, Camera\_StatusInfo\* status)](#oh_cameramanager_statuscallback) | OH\_CameraManager\_StatusCallback | 在[CameraManager\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-cameramanager-callbacks/capi-oh-camera-cameramanager-callbacks)中被调用的相机管理器状态回调。 |
...
在[CameraManager\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-cameramanager-callbacks/capi-oh-camera-cameramanager-callbacks)中被调用的相机管理器状态回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_StatusInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-statusinfo/capi-oh-camera-camera-statusinfo)\* status | 每个相机设备的状态信息。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_TorchStatusInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-torchstatusinfo/capi-oh-camera-camera-torchstatusinfo)\* status | 手电筒的状态信息。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_FoldStatusInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-foldstatusinfo/capi-oh-camera-camera-foldstatusinfo)\* foldStatusInfo | 设备的折叠状态信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [CameraManager\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-cameramanager-callbacks/capi-oh-camera-cameramanager-callbacks)\* callback | 要注册的相机设备状态回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [CameraManager\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-cameramanager-callbacks/capi-oh-camera-cameramanager-callbacks)\* callback | 要注销的相机设备状态回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [OH\_CameraManager\_TorchStatusCallback](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_torchstatuscallback) torchStatusCallback | 要注册的手电筒状态变化回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [OH\_CameraManager\_TorchStatusCallback](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_torchstatuscallback) torchStatusCallback | 要注销的手电筒状态变化回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [OH\_CameraManager\_OnFoldStatusInfoChange](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_onfoldstatusinfochange) foldStatusInfoCallback | 要注册的折叠状态信息变更事件回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [OH\_CameraManager\_OnFoldStatusInfoChange](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_onfoldstatusinfochange) foldStatusInfoCallback | 要注销的折叠状态信息变更事件回调。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\*\* cameras | 如果方法调用成功，将记录支持的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* cameras | 要删除的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 要查询的Camera\_Device。 |
| [Camera\_OutputCapability](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-outputcapability/capi-oh-camera-camera-outputcapability)\*\* cameraOutputCapability | 如果方法调用成功，将记录支持的Camera\_OutputCapability。 |
...
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 要查询的Camera\_Device。 |
| [Camera\_SceneMode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_scenemode) sceneMode | 指定相机模式。 |
| [Camera\_OutputCapability](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-outputcapability/capi-oh-camera-camera-outputcapability)\*\* cameraOutputCapability | 如果方法调用成功，将记录支持的Camera\_OutputCapability列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_OutputCapability](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-outputcapability/capi-oh-camera-camera-outputcapability)\* cameraOutputCapability | 要删除的Camera\_OutputCapability。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_CaptureSession](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-capturesession/capi-oh-camera-camera-capturesession)\*\* captureSession | 如果方法调用成功，将创建Camera\_CaptureSession。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 用于创建Camera\_Input实例的Camera\_Device。 |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\*\* cameraInput | 如果方法调用成功，将创建Camera\_Input实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_Position](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_position) position | 用于创建Camera\_Input实例的相机位置。 |
| [Camera\_Type](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_type) type | 用于创建Camera\_Input实例的相机类型。 |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\*\* cameraInput | 如果方法调用成功，将创建Camera\_Input实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Profile](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-profile/capi-oh-camera-camera-profile)\* profile | 用于创建Camera\_PreviewOutput实例的相机流配置文件。 |
| const char\* surfaceId | 用于创建Camera\_PreviewOutput实例的surfaceId。 |
| [Camera\_PreviewOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-previewoutput/capi-oh-camera-camera-previewoutput)\*\* previewOutput | 如果方法调用成功，将创建Camera\_PreviewOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Profile](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-profile/capi-oh-camera-camera-profile)\* profile | 用于创建Camera\_PhotoOutput实例的相机流配置文件。 |
| const char\* surfaceId | 用于创建Camera\_PhotoOutput实例的surfaceId。 |
| [Camera\_PhotoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-photooutput/capi-oh-camera-camera-photooutput)\*\* photoOutput | 如果方法调用成功，将创建Camera\_PhotoOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_VideoProfile](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-videoprofile/capi-oh-camera-camera-videoprofile)\* profile | 用于创建Camera\_VideoOutput实例的录像配置文件。 |
| const char\* surfaceId | 用于创建Camera\_VideoOutput实例的surfaceId。 |
| [Camera\_VideoOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-videooutput/capi-oh-camera-camera-videooutput)\*\* videoOutput | 如果方法调用成功，将创建Camera\_VideoOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_MetadataObjectType](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_metadataobjecttype)\* profile | 用于创建Camera\_MetadataOutput实例的元数据对象类型。 |
| [Camera\_MetadataOutput](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-metadataoutput/capi-oh-camera-camera-metadataoutput)\*\* metadataOutput | 如果方法调用成功，将创建Camera\_MetadataOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_MetadataObjectType](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_metadataobjecttype)\* metadataObjectTypes | 用于创建Camera\_MetadataOutput实例的元数据对象类型数组。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 要查询的Camera\_Device。 |
| [Camera\_SceneMode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_scenemode)\*\* sceneModes | 如果方法调用成功，将记录支持的场景模式列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_SceneMode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_scenemode)\* sceneModes | 要删除的场景模式列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_TorchMode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_torchmode) torchMode | 要检查的相机手电筒模式。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_TorchMode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_torchmode) torchMode | 要设置的相机手电筒模式。 |
...
获取指定[Camera\_Position](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_position)和[Camera\_Type](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_type)的相机镜头，如果该接口返回值为CAMERA\_SERVICE\_FATAL\_ERROR，表示当前设备未查询到该镜头。
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_Position](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_position) position | 要查询的相机位置。 |
| [Camera\_Type](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_type) type | 要查询的相机类型。 |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 要查询的Camera\_Device。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_DeviceQueryInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-devicequeryinfo/capi-oh-camera-camera-devicequeryinfo)\* deviceQueryInfo | 相机设备的查询信息实例。 |
| uint32\_t\* cameraSize | 查询的所支持的Camera\_Device列表大小。 |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\*\* cameras | 查询的所支持的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* cameras | 待删除的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-manager/capi-oh-camera-camera-manager)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-device/capi-oh-camera-camera-device)\* camera | 用于查询的Camera\_Device相机设备列表，推荐设置为包含[OH\_CameraManager\_GetCameraDevice](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_getcameradevice)获取的前置与后置两个相机设备的相机设备列表。 |
| uint32\_t deviceSize | 用于查询的相机设备列表长度, 必须设置为2（表示前置与后置两个用于并发的相机设备）。 |
| [Camera\_ConcurrentInfo](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-concurrentinfo/capi-oh-camera-camera-concurrentinfo)\*\* cameraConcurrentInfo | 查询到的相机并发能力数组Camera\_ConcurrentInfo，作为入参应当默认设置为空。  如果相机支持并发，cameraConcurrentInfo会被赋值为查询到的相机并发能力数组Camera\_ConcurrentInfo。  如果相机不支持并发，不会对cameraConcurrentInfo进行更改，并且返回错误码[Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode).CAMERA\_SERVICE\_FATAL\_ERROR。 |
| uint32\_t\* infoSize | 查询到的相机并发能力数组长度，作为入参应当默认设置为0。  如果相机支持并发，infoSize会被赋值为查询到的相机并发能力数组长度。  如果相机不支持并发，不会对infoSize进行更改，并且返回错误码[Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode).CAMERA\_SERVICE\_FATAL\_ERROR。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常，或者相机不支持并发。 |
