...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CameraInput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camerainput-callbacks/capi-oh-camera-camerainput-callbacks) | CameraInput\_Callbacks | 相机输入错误事件的回调。 |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input) | Camera\_Input | 相机输入对象。可以使用[OH\_CameraManager\_CreateCameraInput](/ref/camera-api/camera-c/camera-headerfile/capi-camera-manager-h/capi-camera-manager-h#oh_cameramanager_createcamerainput)方法创建指针。 |

### 函数

| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_CameraInput\_OnError)(const Camera\_Input\* cameraInput, Camera\_ErrorCode errorCode)](#oh_camerainput_onerror) | OH\_CameraInput\_OnError | 在[CameraInput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camerainput-callbacks/capi-oh-camera-camerainput-callbacks)中被调用的相机输入错误回调。 |
...
| [Camera\_ErrorCode OH\_CameraInput\_Release(Camera\_Input\* cameraInput)](#oh_camerainput_release) | - | 释放相机输入实例。  和[OH\_CameraInput\_Close](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_close)只需要调用其中一个，调用之后无须再调用[OH\_CameraInput\_Close](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_close)。 |
...
在[CameraInput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camerainput-callbacks/capi-oh-camera-camerainput-callbacks)中被调用的相机输入错误回调。
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | 传递回调的Camera\_Input。 |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) errorCode | 相机输入的Camera\_ErrorCode。 |

****参考：****

[CAMERA\_CONFLICT\_CAMERA](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode)

[CAMERA\_DEVICE\_DISABLED](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode)

[CAMERA\_DEVICE\_PREEMPTED](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode)
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | Camera\_Input实例。 |
| [CameraInput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camerainput-callbacks/capi-oh-camera-camerainput-callbacks)\* callback | 要注册的相机输入更改事件回调。 |
...
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | Camera\_Input实例。 |
| [CameraInput\_Callbacks](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camerainput-callbacks/capi-oh-camera-camerainput-callbacks)\* callback | 要注销的相机输入更改事件回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | 要打开的Camera\_Input实例。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_CONFLICT\_CAMERA：因冲突而无法使用相机。  CAMERA\_DEVICE\_DISABLED：由于安全原因禁用了相机。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | 要打开的Camera\_Input实例。 |
| [Camera\_ConcurrentType](/ref/camera-api/camera-c/camera-headerfile/capi-camera-h/capi-camera-h#camera_concurrenttype) type | 指定并发类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | 要关闭的Camera\_Input实例。 |
...
和[OH\_CameraInput\_Close](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_close)只需要调用其中一个，调用之后无须再调用[OH\_CameraInput\_Close](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_close)。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | 要释放的Camera\_Input实例。 |
...
| [Camera\_OcclusionDetectionResult](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-occlusiondetectionresult/capi-oh-camera-camera-occlusiondetectionresult) occlusionDetectionResult | 相机镜头遮挡、脏污检测结果。 |
...
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | Camera\_Input实例。 |
| [OH\_CameraInput\_OnOcclusionDetectionCallback](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_onocclusiondetectioncallback) occlusionDetectionCallback | 要注册的相机镜头遮挡、脏污检测事件回调。 |
...
| --- | --- |
| [Camera\_Input](/ref/camera-api/camera-c/camera-struct/capi-oh-camera-camera-input/capi-oh-camera-camera-input)\* cameraInput | Camera\_Input实例。 |
| [OH\_CameraInput\_OnOcclusionDetectionCallback](/ref/camera-api/camera-c/camera-headerfile/capi-camera-input-h/capi-camera-input-h#oh_camerainput_onocclusiondetectioncallback) occlusionDetectionCallback | 要注销的相机镜头遮挡、脏污检测事件回调。 |
