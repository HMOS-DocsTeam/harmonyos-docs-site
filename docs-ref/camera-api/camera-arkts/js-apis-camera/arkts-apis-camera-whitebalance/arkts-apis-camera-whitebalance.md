...
WhiteBalance 继承自 [WhiteBalanceQuery](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-whitebalancequery/arkts-apis-camera-whitebalancequery)。

提供了处理设备白平衡的相关功能，包括获取和设置白平衡模式以及白平衡值。

![](../../../../images/fddea365/note_3.0-zh-cn.png) 
...
设置白平衡模式。设置之前需要先检查设备是否支持指定的白平衡模式，具体方法请参考[isWhiteBalanceModeSupported](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-whitebalancequery/arkts-apis-camera-whitebalancequery#iswhitebalancemodesupported20)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WhiteBalanceMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#whitebalancemode20) | 是 | 白平衡模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [WhiteBalanceMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#whitebalancemode20) | 获取当前白平衡模式。若接口调用失败，返回undefined。 |
...
设置之前需要先检查设备支持的白平衡值范围，具体方法请参考[getWhiteBalanceRange](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-whitebalancequery/arkts-apis-camera-whitebalancequery#getwhitebalancerange20)。
