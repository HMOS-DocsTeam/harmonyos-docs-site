...
sidebar_position: 30
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-videooutput
kit: 媒体
...
录像会话中使用的输出信息，继承[CameraOutput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-cameraoutput/arkts-apis-camera-cameraoutput)。

![](../../../../images/ebdd335e/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。当启动录制成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
![](../../../../images/81bb8fc5/note_3.0-zh-cn.png) 
...
![](../../../../images/38fd7ef1/note_3.0-zh-cn.png) 
...
![](../../../../images/29d0b1f7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'error'，videoOutput创建成功后可监听。录像接口调用出现错误时触发该事件并返回对应错误码，比如调用[start](#start-1)，[CameraOutput.release](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-cameraoutput/arkts-apis-camera-cameraoutput#release-1)接口时出现错误返回对应错误信息。 |
...
![](../../../../images/2ac69ed1/note_3.0-zh-cn.png) 
...
接口调用前，先调用[getActiveFrameRate](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-videooutput/arkts-apis-camera-videooutput#getactiveframerate12)接口查询当前VideoSession的帧率，若下发的帧率与当前帧率相等，则下发的帧率不会生效。
...
| 类型 | 说明 |
| --- | --- |
| [VideoProfile](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#videoprofile) | 当前生效的配置信息 |
...
- 启用/关闭录像镜像后，需要通过[getVideoRotation](#getvideorotation12)获取录像旋转角度以及[updateRotation](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avrecorder/arkts-apis-media-avrecorder#updaterotation12)更新旋转角度。
...
| 类型 | 说明 |
| --- | --- |
| [ImageRotation](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#imagerotation) | 返回录像旋转角度。若接口调用失败，返回undefined。 |
