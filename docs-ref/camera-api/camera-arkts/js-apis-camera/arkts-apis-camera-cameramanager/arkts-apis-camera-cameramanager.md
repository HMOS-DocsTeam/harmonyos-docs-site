...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-cameramanager
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-camera-cameramanager
---

# Interface (CameraManager)

相机管理器类，使用前需要通过[getCameraManager](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-f/arkts-apis-camera-f#cameragetcameramanager)接口获取相机管理实例。

![](../../../../images/c282c747/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice)&gt; | 相机设备列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 是 | 相机设备，通过[getSupportedCameras](#getsupportedcameras)接口获取。传参异常时，会返回错误码[7400101](/ref/camera-api/camera-arkts-errcode/errorcode-camera/errorcode-camera#section7400101-无效入参)。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Array&lt;[SceneMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#scenemode11)&gt; | 相机支持的模式列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 是 | 相机设备，通过 [getSupportedCameras](#getsupportedcameras) 接口获取。 |
| mode | [SceneMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#scenemode11) | 是 | 相机模式，通过 [getSupportedSceneModes](#getsupportedscenemodes11) 接口获取。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [CameraOutputCapability](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameraoutputcapability) | 相机输出能力。 |
...
![](../../../../images/9208b205/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 是 | 相机设备信息，通过[getSupportedCameras](#getsupportedcameras)接口获取。 |
| mode | [SceneMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#scenemode11) | 是 | 相机模式，通过[getSupportedSceneModes](#getsupportedscenemodes11)接口获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 是 | CameraDevice对象，通过 [getSupportedCameras](#getsupportedcameras) 接口获取。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [CameraInput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-camerainput/arkts-apis-camera-camerainput) | 返回CameraInput实例。接口调用失败会返回相应错误码，错误码类型为[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraposition) | 是 | 相机位置，首先通过 [getSupportedCameras](#getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备位置信息。 |
| type | [CameraType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameratype) | 是 | 相机类型，首先通过 [getSupportedCameras](#getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备类型信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#profile) | 是 | 支持的预览配置信息，通过[getSupportedOutputCapability](#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[XComponent](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-basic-components-xcomponent/ts-basic-components-xcomponent)或者[ImageReceiver](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagereceiver/arkts-apis-image-imagereceiver)组件获取的surfaceId。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [PreviewOutput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-previewoutput/arkts-apis-camera-previewoutput) | PreviewOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
创建无配置信息的预览输出对象，同步返回结果。该接口需配合[preconfig](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-photosession/arkts-apis-camera-photosession#preconfig12)一起使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#profile) | 否 | 支持的拍照配置信息，通过[getSupportedOutputCapability](#getsupportedoutputcapability11)接口获取。  API version 11时，该参数必填；从API version 12开始，如果使用[preconfig](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-photosession/arkts-apis-camera-photosession#preconfig12)进行预配置，传入profile参数会覆盖preconfig的预配置参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [PhotoOutput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-photooutput/arkts-apis-camera-photooutput) | PhotoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [VideoProfile](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#videoprofile) | 是 | 支持的录像配置信息，通过[getSupportedOutputCapability](#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[AVRecorder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avrecorder/arkts-apis-media-avrecorder)获取的surfaceId。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [VideoOutput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-videooutput/arkts-apis-camera-videooutput) | VideoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
创建无配置信息的录像输出对象，同步返回结果。该接口需配合[preconfig](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-videosession/arkts-apis-camera-videosession#preconfig12)功能一起使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataObjectTypes | Array&lt;[MetadataObjectType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#metadataobjecttype)&gt; | 是 | metadata流类型信息，通过[getSupportedOutputCapability](#getsupportedoutputcapability11)接口获取。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [MetadataOutput](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-metadataoutput/arkts-apis-camera-metadataoutput) | MetadataOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [SceneMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#scenemode11) | 是 | 相机支持的模式。如果传入的参数异常（如超出范围、传入null或未定义等），实际接口不会生效。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [T](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-session/arkts-apis-camera-session) | Session实例。接口调用失败会返回相应的错误码，错误码类型为[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
...
![](../../../../images/5cf9ad95/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[CameraStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#camerastatusinfo)&gt; | 是 | 回调函数，用于获取镜头状态变化信息。 |
...
| callback | AsyncCallback&lt;[CameraStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#camerastatusinfo)&gt; | 否 | 回调函数，如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
![](../../../../images/462579b3/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[FoldStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#foldstatusinfo12)&gt; | 是 | 回调函数。返回折叠设备折叠信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'foldStatusChange'。表示折叠设备折叠状态发生变化。 |
| callback | AsyncCallback&lt;[FoldStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#foldstatusinfo12)&gt; | 否 | 回调函数，返回折叠设备折叠信息。如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [TorchMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#torchmode11) | 是 | 手电筒模式。传参为null或者undefined，作为0处理，手电筒关闭。 |
...
| 类型 | 说明 |
| --- | --- |
| [TorchMode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#torchmode11) | 返回设备当前手电筒模式。 |
...
![](../../../../images/8be768fc/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[TorchStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#torchstatusinfo11)&gt; | 是 | 回调函数，用于获取手电筒状态变化信息。 |
...
| callback | AsyncCallback&lt;[TorchStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#torchstatusinfo11)&gt; | 否 | 回调函数，如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
获取指定[CameraPosition](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraposition)和[CameraType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameratype)的相机镜头，如果该接口返回结果为undefined，表示当前设备未查询到该镜头。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraposition) | 是 | 需要得到的CameraDevice对象对应的CameraPosition条件。 |
| type | [CameraType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameratype) | 是 | 需要得到的CameraDevice对象对应的CameraType条件。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 根据相机位置和相机类型查询的对应相机。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraposition) | 是 | 相机的位置。 |
| types | Array&lt;[CameraType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameratype)&gt; | 是 | 相机类型数组。 |
| connectType | [ConnectionType](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#connectiontype) | 是 | 相机的连接类型。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Array&lt;[CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice)&gt; | 根据相机位置、相机类型数组和连接类型查询符合条件的相机列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameras | Array&lt;[CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice)&gt; | 是 | 一组CameraDevice相机设备，并得到与这一组CameraDevice对应的并发信息，推荐设置为由[getCameraDevice](#getcameradevice18)获取的前置与后置两个用于并发的相机设备。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Array&lt;[CameraConcurrentInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameraconcurrentinfo18)&gt; | 一组CameraDevice相机设备对象对应的并发信息，与CameraDevice相机设备一一对应。 |
...
![](../../../../images/383972f9/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#cameradevice) | 是 | 相机设备，通过 [getSupportedCameras](#getsupportedcameras) 接口获取。传参异常时，会返回错误码。 |
...
![](../../../../images/bf87f1ca/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#profile) | 是 | 支持的拍照配置信息，通过[getSupportedOutputCapability](#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[ImageReceiver](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagereceiver/arkts-apis-image-imagereceiver)获取的surfaceId。 |
...
![](../../../../images/72f236b0/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [CaptureSession](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-capturesession/arkts-apis-camera-capturesession) | CaptureSession实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-e/arkts-apis-camera-e#cameraerrorcode)。 |
