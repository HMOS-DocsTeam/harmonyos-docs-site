...
title: "Enums"
sidebar_position: 37
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-e
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-camera-e
---

# Enums

![](../../../../images/8afda49c/note_3.0-zh-cn.png) 
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| NORMAL\_PHOTO | 1 | 普通拍照模式。详情见[PhotoSession](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-photosession/arkts-apis-camera-photosession)。 |
| NORMAL\_VIDEO | 2 | 普通录像模式。详情见[VideoSession](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-videosession/arkts-apis-camera-videosession)。 |
| SECURE\_PHOTO12+ | 12 | 安全相机模式。详情见[SecureSession](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-securesession/arkts-apis-camera-securesession)。 |
...
| EXPOSURE\_MODE\_AUTO | 1 | 自动曝光模式。支持曝光区域中心点设置，可以使用[AutoExposure.setMeteringPoint](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-autoexposure/arkts-apis-camera-autoexposure#setmeteringpoint11)接口设置曝光区域中心点。  设置该模式后，仅设置后的首次拍照生效。 |
...
| FOCUS\_MODE\_AUTO | 2 | 自动对焦。支持对焦点设置，可以使用[Focus.setFocusPoint](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-focus/arkts-apis-camera-focus#setfocuspoint11)设置对焦点，根据对焦点执行一次自动对焦。 |
