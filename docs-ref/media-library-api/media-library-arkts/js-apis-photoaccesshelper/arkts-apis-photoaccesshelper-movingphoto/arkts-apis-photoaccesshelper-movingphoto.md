...
![](../../../../images/fec6034b/note_3.0-zh-cn.png) 
...
- 通过picker的方式调用该接口来请求动态照片对象并读取内容，不需要申请'ohos.permission.READ\_IMAGEVIDEO'权限，详情请参考[开发指南](/medialibrary-kit/movingphoto/photoaccesshelper-movingphoto)。
...
- 通过picker调用接口请求动态照片对象并读取内容，不需要申请'ohos.permission.READ\_IMAGEVIDEO'权限，详情请参考[开发指南](/medialibrary-kit/movingphoto/photoaccesshelper-movingphoto)。
- 对于本应用保存到媒体库的动态照片资源，应用无需额外申请'ohos.permission.READ\_IMAGEVIDEO'权限即可访问。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceType | [ResourceType](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-e/arkts-apis-photoaccesshelper-e#resourcetype11) | 是 | 所请求动态照片内容的资源类型。 |
...
- 使用picker调用该接口请求动态照片对象并读取内容时，不需要申请'ohos.permission.READ\_IMAGEVIDEO'权限，详情请参考[开发指南](/medialibrary-kit/movingphoto/photoaccesshelper-movingphoto)。
- 对于本应用保存到媒体库的动态照片资源，应用无需额外申请'ohos.permission.READ\_IMAGEVIDEO'权限即可访问。
