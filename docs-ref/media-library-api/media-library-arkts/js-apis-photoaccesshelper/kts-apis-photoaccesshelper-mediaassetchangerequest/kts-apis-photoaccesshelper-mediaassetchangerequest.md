...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/kts-apis-photoaccesshelper-mediaassetchangerequest
kit: 媒体
...
MediaAssetChangeRequest implements [MediaChangeRequest](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-i/arkts-apis-photoaccesshelper-i#mediachangerequest11).

资产变更请求。

![](../../../../images/23cd9e1a/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| comment23+ | string | 是 | 否 | 用于[MediaChangeRequest](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-i/arkts-apis-photoaccesshelper-i#mediachangerequest11)类型校验。  如果类（如MediaAssetChangeRequest）对象可以访问，就说明该类是MediaChangeRequest的实现类。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| asset | [PhotoAsset](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoasset/arkts-apis-photoaccesshelper-photoasset) | 是 | 需要变更的资产。 |
...
指定待创建资产的数据来源，可参考[@ohos.file.fileuri (文件URI)](/ref/core-file-api/core-file-arkts/js-apis-file-fileuri/js-apis-file-fileuri)。
...
| 类型 | 说明 |
| --- | --- |
| [MediaAssetChangeRequest](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/kts-apis-photoaccesshelper-mediaassetchangerequest/kts-apis-photoaccesshelper-mediaassetchangerequest) | 返回创建资产的变更请求。 |
...
| --- | --- | --- | --- |
| context | [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 传入Ability实例的上下文。 |
| photoType | [PhotoType](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-e/arkts-apis-photoaccesshelper-e#phototype) | 是 | 待创建的文件类型，IMAGE或者VIDEO类型。 |
| extension | string | 是 | 文件扩展名，例如：'jpg'。 |
| options | [CreateOptions](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-i/arkts-apis-photoaccesshelper-i#createoptions) | 否 | 创建选项，例如：{title: 'testPhoto'}。  文件名中不允许出现非法英文字符，包括： . .. \ / : \* ? " ' ` < > | { } [ ] |
...
| --- | --- | --- | --- |
| context | [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 传入Ability实例的上下文。 |
| assets | Array&lt;[PhotoAsset](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoasset/arkts-apis-photoaccesshelper-photoasset)&gt; | 是 | 待删除的媒体文件数组，数组中元素个数不超过300个。 |
...
![](../../../../images/9788209a/caution_3.0-zh-cn.png) 

对于创建资产的变更请求，在调用接口[applyChanges](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoaccesshelper/arkts-apis-photoaccesshelper-photoaccesshelper#applychanges11)的提交生效之前，该接口会返回null。
...
| 类型 | 说明 |
| --- | --- |
| [PhotoAsset](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoasset/arkts-apis-photoaccesshelper-photoasset) | 返回当前资产变更请求中的资产。 |
...
![](../../../../images/c4c505b8/caution_3.0-zh-cn.png) 
...
通过文件URI从应用沙箱添加资源，待添加资源的数据来源可参考[@ohos.file.fileuri (文件URI)](/ref/core-file-api/core-file-arkts/js-apis-file-fileuri/js-apis-file-fileuri)。

![](../../../../images/4aeaf520/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [ResourceType](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-e/arkts-apis-photoaccesshelper-e#resourcetype11) | 是 | 待添加资源的类型。 |
...
![](../../../../images/c0b3c3f4/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageFileType | [ImageFileType](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-e/arkts-apis-photoaccesshelper-e#imagefiletype13) | 是 | 需要保存的类型。 |
