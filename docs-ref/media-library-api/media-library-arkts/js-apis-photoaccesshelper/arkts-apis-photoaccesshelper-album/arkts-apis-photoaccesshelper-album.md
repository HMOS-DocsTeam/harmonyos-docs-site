...
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-album
kit: 媒体
...
Album extends [AbsAlbum](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-absalbum/arkts-apis-photoaccesshelper-absalbum).

实体相册。

![](../../../../images/61a1ccc4/note_3.0-zh-cn.png) 
...
![](../../../../images/6026bbd7/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.addAssets](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/kts-apis-photoaccesshelper-mediaalbumchangerequest/kts-apis-photoaccesshelper-mediaalbumchangerequest#addassets11)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array&lt;[PhotoAsset](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoasset/arkts-apis-photoaccesshelper-photoasset)&gt; | 是 | 待添加到相册中的图片或视频数组。 |
...
![](../../../../images/500a3e8d/note_3.0-zh-cn.png) 
...
![](../../../../images/b2244e00/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.removeAssets](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/kts-apis-photoaccesshelper-mediaalbumchangerequest/kts-apis-photoaccesshelper-mediaalbumchangerequest#removeassets11)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array&lt;[PhotoAsset](/ref/media-library-api/media-library-arkts/js-apis-photoaccesshelper/arkts-apis-photoaccesshelper-photoasset/arkts-apis-photoaccesshelper-photoasset)&gt; | 是 | 相册中待移除的图片或视频数组。 |
...
![](../../../../images/c9e285e5/note_3.0-zh-cn.png) 
