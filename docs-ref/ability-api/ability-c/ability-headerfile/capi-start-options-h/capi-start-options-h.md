...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-start-options-h
kit: 应用框架
...
提供应用启动参数数据结构[AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions)以及设置和获取相关函数。
...
****相关模块：**** [AbilityRuntime](/ref/ability-api/ability-c/ability-module/capi-abilityruntime/capi-abilityruntime)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) | AbilityRuntime\_StartOptions | StartOptions数据结构。 |
...
创建[AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions)对象。
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions)\* | 返回指针类型AbilityRuntime\_StartOptions对象。 |
...
销毁[AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions)对象。
...
| 参数项 | 描述 |
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) \*\*startOptions | 需要销毁的AbilityRuntime\_StartOptions对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) \*startOptions | AbilityRuntime\_StartOptions对象。 |
| [AbilityRuntime\_WindowMode](/ref/ability-api/ability-c/ability-headerfile/capi-context-constant-h/capi-context-constant-h#abilityruntime_windowmode) windowMode | 启动Ability时的窗口模式。取值范围参见AbilityRuntime\_WindowMode。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空或者WindowMode无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) \*startOptions | StartOptions结构体。 |
| [AbilityRuntime\_StartVisibility](/ref/ability-api/ability-c/ability-headerfile/capi-context-constant-h/capi-context-constant-h#abilityruntime_startvisibility) startVisibility | 需要设置的显示模式。取值范围参见AbilityRuntime\_StartVisibility。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示设置成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或startVisibility取值不在枚举类AbilityRuntime\_StartVisibility中。 |
...
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) \*startOptions | StartOptions结构体。 |
| [AbilityRuntime\_StartVisibility](/ref/ability-api/ability-c/ability-headerfile/capi-context-constant-h/capi-context-constant-h#abilityruntime_startvisibility) &startVisibility | 获取到的显示模式。取值范围参见AbilityRuntime\_StartVisibility。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示获取成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或startVisibility未被设置。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或者startWindowIcon为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或者startWindowIcon没有设置为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或者StartWindowBackgroundColor没有置为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示startOptions为空，或者startWindowBackgroundColor没有置为空指针。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_INTERNAL时，表示开发者无法恢复的内部错误，比如内部调用malloc错误，或者字符串拷贝函数出错。 |
...
| --- | --- |
| [AbilityRuntime\_StartOptions](/ref/ability-api/ability-c/ability-struct/capi-abilityruntime-startoptions/capi-abilityruntime-startoptions) \*startOptions | AbilityRuntime\_StartOptions对象。 |
| [AbilityRuntime\_SupportedWindowMode](/ref/ability-api/ability-c/ability-headerfile/capi-context-constant-h/capi-context-constant-h#abilityruntime_supportedwindowmode) \*supportedWindowModes | 启动Ability时的组件所支持的窗口模式。取值范围参见AbilityRuntime\_SupportedWindowMode。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions或者SupportedWindowModes为空，或者Size为0。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](/ref/ability-api/ability-c/ability-headerfile/capi-ability-runtime-common-h/capi-ability-runtime-common-h#abilityruntime_errorcode) | 在返回ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR时，表示接口调用成功。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID时，表示StartOptions为空，或者SupportWindowMode没有置为空指针。  在返回ABILITY\_RUNTIME\_ERROR\_CODE\_INTERNAL时，表示开发者无法恢复的内部错误，比如内部调用malloc错误。 |
