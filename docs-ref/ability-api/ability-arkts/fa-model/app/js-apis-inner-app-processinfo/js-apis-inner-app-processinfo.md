...
定义进程信息，可以通过[getProcessInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context#contextgetprocessinfo7)获取当前Ability运行的进程信息。

![](../../../../../images/070fb7a4/note_3.0-zh-cn.png) 
