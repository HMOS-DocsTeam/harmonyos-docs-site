...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-app-context
kit: 应用框架
...
![](../../../../../images/dcbc0663/note_3.0-zh-cn.png) 
...
Context对象是在featureAbility中创建实例，并通过featureAbility的[getContext](/ref/ability-api/ability-arkts/fa-model/js-apis-ability-featureability/js-apis-ability-featureability#featureabilitygetcontext)接口返回，因此在使用Context时，必须导入@ohos.ability.featureAbility库。示例如下：
...
示例代码中出现的getBundleInfo相关描述可参考对应[文档](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[ApplicationInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-applicationinfo/js-apis-bundlemanager-applicationinfo)&gt; | 是 | 回调函数，返回当前应用程序的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ApplicationInfo](/ref/ability-api/ability-arkts/ability-arkts-dep/bundle/js-apis-bundle-applicationinfo/js-apis-bundle-applicationinfo)&gt; | Promise对象，返回当前应用程序的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[bundle.DisplayOrientation](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager#displayorientation)&gt; | 是 | 回调函数，返回屏幕显示方向。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[bundle.DisplayOrientation](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager#displayorientation)&gt; | Promise对象，返回屏幕显示方向。 |
...
![](../../../../../images/dde1ab5b/note_3.0-zh-cn.png) 
...
![](../../../../../images/f63e526b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [bundle.DisplayOrientation](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager#displayorientation) | 是 | 指示当前能力的新方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [bundle.DisplayOrientation](/ref/ability-api/ability-arkts/both-models/js-apis-bundlemanager/js-apis-bundlemanager#displayorientation) | 是 | 表示屏幕显示方向。 |
...
![](../../../../../images/322f1105/note_3.0-zh-cn.png) 
...
![](../../../../../images/5b13d810/note_3.0-zh-cn.png) 
...
![](../../../../../images/31e915a7/note_3.0-zh-cn.png) 
...
![](../../../../../images/33f3a654/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[ProcessInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-processinfo/js-apis-inner-app-processinfo)&gt; | 是 | 回调函数，返回当前进程的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ProcessInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-processinfo/js-apis-inner-app-processinfo)&gt; | Promise对象，返回当前进程的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname)&gt; | 是 | 回调函数，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname)&gt; | Promise对象，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[HapModuleInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-hapmoduleinfo/js-apis-bundlemanager-hapmoduleinfo)&gt; | 是 | 回调函数，返回应用的ModuleInfo对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[HapModuleInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-hapmoduleinfo/js-apis-bundlemanager-hapmoduleinfo)&gt; | Promise对象，返回应用的ModuleInfo对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AppVersionInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-appversioninfo/js-apis-inner-app-appversioninfo)&gt; | 是 | 回调函数，返回应用版本信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AppVersionInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-appversioninfo/js-apis-inner-app-appversioninfo)&gt; | Promise对象，返回应用版本信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AbilityInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-abilityinfo/js-apis-bundlemanager-abilityinfo)&gt; | 是 | 回调函数，返回当前归属Ability详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AbilityInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-abilityinfo/js-apis-bundlemanager-abilityinfo)&gt; | Promise对象，返回当前归属Ability详细信息。 |
