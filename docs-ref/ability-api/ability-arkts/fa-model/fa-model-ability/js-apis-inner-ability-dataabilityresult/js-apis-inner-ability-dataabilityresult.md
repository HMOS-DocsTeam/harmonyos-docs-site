...
定义DataAbility数据操作结果，通过[executeBatch](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-dataabilityhelper/js-apis-inner-ability-dataabilityhelper#dataabilityhelperexecutebatch)操作数据库时，操作结果使用DataAbilityResult对象返回。

![](../../../../../images/7e1df657/note_3.0-zh-cn.png) 
