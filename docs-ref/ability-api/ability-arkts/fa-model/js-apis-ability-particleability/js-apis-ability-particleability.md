...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-ability-particleability
kit: 应用框架
...
![](../../../../images/08c5d94b/note_3.0-zh-cn.png) 
...
![](../../../../images/e4d43a7a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-startabilityparameter/js-apis-inner-ability-startabilityparameter) | 是 | 表示启动的ability。 |
...
![](../../../../images/7c3c8300/note_3.0-zh-cn.png) 
...
![](../../../../images/7fa414f6/note_3.0-zh-cn.png) 
...
![](../../../../images/48ecb8c8/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.startBackgroundRunning](/ref/background-tasks-api/background-tasks-arkts/js-apis-resourceschedule-backgroundtaskmanager/js-apis-resourceschedule-backgroundtaskmanager#backgroundtaskmanagerstartbackgroundrunning)替代。
...
| request | [NotificationRequest](/ref/notification-api/notification-arkts/notification-arkts-dep/js-apis-notification/js-apis-notification#notificationrequest) | 是 | 通知参数，用于显示通知栏的信息。 |
...
![](../../../../images/1cd0976e/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.startBackgroundRunning](/ref/background-tasks-api/background-tasks-arkts/js-apis-resourceschedule-backgroundtaskmanager/js-apis-resourceschedule-backgroundtaskmanager#backgroundtaskmanagerstartbackgroundrunning-1)替代。
...
![](../../../../images/7b750911/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.stopBackgroundRunning](/ref/background-tasks-api/background-tasks-arkts/js-apis-resourceschedule-backgroundtaskmanager/js-apis-resourceschedule-backgroundtaskmanager#backgroundtaskmanagerstopbackgroundrunning)替代。
...
![](../../../../images/5c85898d/note_3.0-zh-cn.png) 

从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.stopBackgroundRunning](/ref/background-tasks-api/background-tasks-arkts/js-apis-resourceschedule-backgroundtaskmanager/js-apis-resourceschedule-backgroundtaskmanager#backgroundtaskmanagerstopbackgroundrunning-1)替代。
...
![](../../../../images/55a9837a/note_3.0-zh-cn.png) 
...
| options | [ConnectOptions](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-connectoptions/js-apis-inner-ability-connectoptions) | 是 | 连接回调方法。 |
