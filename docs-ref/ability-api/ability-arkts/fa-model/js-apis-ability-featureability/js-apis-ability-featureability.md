...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-ability-featureability
kit: 应用框架
...
![](../../../../images/0f6dba82/note_3.0-zh-cn.png) 
...
![](../../../../images/dcd88d78/note_3.0-zh-cn.png) 

组件启动规则详见：[组件启动规则（FA模型）](/ability-kit/fa-model-development/fa-model-application-components/component-startup-rules-fa)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-startabilityparameter/js-apis-inner-ability-startabilityparameter) | 是 | 表示被启动的Ability。 |
...
![](../../../../images/ad934793/note_3.0-zh-cn.png) 
...
![](../../../../images/3d511988/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [DataAbilityHelper](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-dataabilityhelper/js-apis-inner-ability-dataabilityhelper) | 用来协助其他Ability访问DataAbility的工具类。 |
...
![](../../../../images/e6b0aa0a/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-startabilityparameter/js-apis-inner-ability-startabilityparameter) | 是 | 表示被启动的Ability。 |
| callback | AsyncCallback&lt;[AbilityResult](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-abilityresult/js-apis-inner-ability-abilityresult)&gt; | 是 | 回调函数。当启动Ability成功，err为undefined，data为ability的启动结果；否则为错误对象。 |
...
![](../../../../images/eca78b62/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AbilityResult](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-abilityresult/js-apis-inner-ability-abilityresult)&gt; | Promise对象，返回启动Ability的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [AbilityResult](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-abilityresult/js-apis-inner-ability-abilityresult) | 是 | 表示停止Ability之后返回的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want)&gt; | 是 | 回调函数，当获取要拉起的Ability对应的Want成功，err为undefined，data为当前Ability对应的Want；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want)&gt; | Promise对象，返回want信息。 |
...
![](../../../../images/19dff8f7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want) | 是 | 表示被连接的ServiceAbility。 |
| options | [ConnectOptions](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-connectoptions/js-apis-inner-ability-connectoptions) | 是 | 表示连接回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[window.Window](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window)&gt; | 是 | 回调函数。当获取窗口成功，err为undefined，data为当前Ability对应的窗口；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[window.Window](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window)&gt; | Promise对象，返回当前Ability对应的窗口。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_Context](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context) | Context模块。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AppVersionInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-appversioninfo/js-apis-inner-app-appversioninfo) | 应用版本信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessInfo](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-processinfo/js-apis-inner-app-processinfo) | 进程信息。 |
