...
定义异常监听，可以作为[errorManager.on('error')](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-errormanager/js-apis-app-ability-errormanager#errormanageronerror)的入参监听当前应用发生的异常。

![](../../../../../images/00e99a5d/note_3.0-zh-cn.png) 
