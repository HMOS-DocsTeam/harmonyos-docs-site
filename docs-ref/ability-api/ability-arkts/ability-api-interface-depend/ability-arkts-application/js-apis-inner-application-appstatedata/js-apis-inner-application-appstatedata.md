...
定义应用状态信息，使用接口[on](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-appmanager/js-apis-app-ability-appmanager#appmanageronapplicationstate14)注册应用状态变化监听后，当应用、进程或组件的状态变化时，系统通过[ApplicationStateObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver)的[onForegroundApplicationChanged](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver#applicationstateobserveronforegroundapplicationchanged)等方法回调给开发者。

![](../../../../../images/9bcec13e/note_3.0-zh-cn.png) 
