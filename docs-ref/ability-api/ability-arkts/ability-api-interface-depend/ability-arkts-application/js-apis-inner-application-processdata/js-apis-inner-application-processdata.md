...
title: "ProcessData"
sidebar_position: 25
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-processdata
kit: 应用框架
...
进程数据的对象定义。使用接口[appManager.on('applicationState')](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-appmanager/js-apis-app-ability-appmanager#appmanageronapplicationstate14)注册生命周期变化监听后，当应用或组件的生命周期变化时，系统通过[ApplicationStateObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver)的[onProcessCreated](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver#applicationstateobserveronprocesscreated)等方法回调给开发者。

![](../../../../../images/2303356f/note_3.0-zh-cn.png) 
