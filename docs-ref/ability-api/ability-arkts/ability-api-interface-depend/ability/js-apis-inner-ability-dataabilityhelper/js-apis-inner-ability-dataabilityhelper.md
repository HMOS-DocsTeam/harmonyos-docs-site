...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-ability-dataabilityhelper
kit: 应用框架
...
可以通过[acquireDataAbilityHelper](/ref/ability-api/ability-arkts/fa-model/js-apis-ability-featureability/js-apis-ability-featureability#featureabilityacquiredataabilityhelper7)接口获取DataAbilityHelper对象。

![](../../../../../images/d61359c6/note_3.0-zh-cn.png) 
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#valuesbucket), callback: AsyncCallback&lt;number&gt;): void
...
| valuesBucket | [rdb.ValuesBucket](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#valuesbucket) | 是 | 表示要插入的数据记录。如果此参数为空，将插入一个空行。 |
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#valuesbucket)): Promise&lt;number&gt;
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示要插入数据的uri。 |
| valuesBuckets | Array&lt;[rdb.ValuesBucket](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#valuesbucket)&gt; | 是 | 表示要插入的数据记录数组。 |
...
| valuesBucket | [rdb.ValuesBucket](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#valuesbucket) | 是 | 表示要更新的数据。 |
| predicates | dataAbility.DataAbilityPredicates | 是 | 表示筛选条件。当此参数为null时，应定义处理逻辑。 |
...
| callback | AsyncCallback&lt;[ResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-resultset/arkts-apis-data-relationalstore-resultset)&gt; | 是 | 回调函数，返回查询结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-resultset/arkts-apis-data-relationalstore-resultset)&gt; | Promise对象，返回查询结果。 |
...
| extras | [PacMap](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-dataabilityhelper/js-apis-inner-ability-dataabilityhelper#pacmap) | 是 | 表示扩展的键值对参数。 |
| callback | AsyncCallback&lt;[PacMap](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-dataabilityhelper/js-apis-inner-ability-dataabilityhelper#pacmap)&gt; | 是 | 回调函数，返回扩展的键值对参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[PacMap](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability/js-apis-inner-ability-dataabilityhelper/js-apis-inner-ability-dataabilityhelper#pacmap)&gt; | Promise对象，返回扩展的键值对参数。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示待处理的DataAbility。例：'dataability:///com.example.xxx.xxxx'。 |
| operations | Array&lt;[DataAbilityOperation](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-dataabilityoperation/js-apis-inner-ability-dataabilityoperation)&gt; | 是 | 表示数据操作数组，其中可以包含对数据库的多个不同操作。 |
| callback | AsyncCallback&lt;Array&lt;[DataAbilityResult](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-dataabilityresult/js-apis-inner-ability-dataabilityresult)&gt;&gt; | 是 | 回调函数，在DataAbilityResult数组中返回每个操作的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[DataAbilityResult](/ref/ability-api/ability-arkts/fa-model/fa-model-ability/js-apis-inner-ability-dataabilityresult/js-apis-inner-ability-dataabilityresult)&gt;&gt; | Promise对象，在DataAbilityResult数组中返回每个操作的结果。 |
