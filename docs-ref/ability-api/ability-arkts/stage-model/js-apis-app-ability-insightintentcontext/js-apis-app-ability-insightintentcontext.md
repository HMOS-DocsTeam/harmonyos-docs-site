...
本模块提供意图执行上下文，是[意图执行基类](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentexecutor/js-apis-app-ability-insightintentexecutor)和[@InsightIntentEntry的意图执行基类](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintententryexecutor/js-apis-app-ability-insightintententryexecutor)的属性，为意图执行提供基础能力，例如启动本应用内的[UIAbility组件](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)。

![](../../../../images/514f6b4a/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| instanceId23+ | number | 否 | 否 | 意图实例唯一ID。用于通过[insightIntentProvider.sendExecuteResult接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentprovider/js-apis-app-ability-insightintentprovider#insightintentprovidersendexecuteresult)和[insightIntentProvider.sendIntentResult接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentprovider/js-apis-app-ability-insightintentprovider#insightintentprovidersendintentresult)返回指定意图的执行结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 启动UIAbility组件的want信息。 |
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_ABILITY\_FOREGROUND](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#executemode)的意图。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| returnMode | [insightIntent.ReturnMode](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#returnmode23) | 是 | 意图执行结果的返回形式。 |
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_EXTENSION\_ABILITY](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#executemode)的意图。
