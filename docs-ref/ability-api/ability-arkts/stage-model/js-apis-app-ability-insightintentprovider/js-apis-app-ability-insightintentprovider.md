...
![](../../../../images/ef6decf1/note_3.0-zh-cn.png) 
...
如果意图提供方需要在业务处理的特定流程中主动发送意图执行结果，可以先通过[setReturnModeForUIAbilityForeground接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#insightintentcontextsetreturnmodeforuiabilityforeground23)或[setReturnModeForUIExtensionAbility接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#insightintentcontextsetreturnmodeforuiextensionability23)将意图执行结果返回形式[ReturnMode](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#returnmode23)设置为FUNCTION，然后调用该接口发送意图执行结果，适用于[配置类意图](/ability-kit/stage-model-development/insight-intent/insight-intent-development/insight-intent-config-development)。使用Promise异步回调。

意图执行结果返回形式[ReturnMode](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#returnmode23)设置为FUNCTION后，应用将无需再通过[onExecuteInUIAbilityForegroundMode接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentexecutor/js-apis-app-ability-insightintentexecutor#onexecuteinuiabilityforegroundmode)或[onExecuteInUIExtensionAbility接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentexecutor/js-apis-app-ability-insightintentexecutor#onexecuteinuiextensionability)的返回值返回意图执行结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| [instanceId](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#属性) | number | 是 | 意图实例唯一ID。 |
| result | [insightIntent.ExecuteResult](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#executeresult) | 是 | 返回意图执行结果，表示本次意图执行返回给系统入口的数据。 |
...
如果意图提供方需要在业务处理的特定流程中主动发送意图执行结果，可以先通过[setReturnModeForUIAbilityForeground接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#insightintentcontextsetreturnmodeforuiabilityforeground23)或[setReturnModeForUIExtensionAbility接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#insightintentcontextsetreturnmodeforuiextensionability23)将意图执行结果返回形式[ReturnMode](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#returnmode23)设置为FUNCTION，然后调用该接口发送意图执行结果。适用于[@InsightIntentEntry](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentdecorator/js-apis-app-ability-insightintentdecorator#insightintententry)修饰的[装饰器类意图](/ability-kit/stage-model-development/insight-intent/insight-intent-development/insight-intent-decorator-development)。使用Promise异步回调。

意图执行结果返回形式[ReturnMode](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#returnmode23)设置为FUNCTION后，应用将无需再通过[onExecute接口](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintententryexecutor/js-apis-app-ability-insightintententryexecutor#onexecute)的返回值返回意图执行结果。
...
| --- | --- | --- | --- |
| [instanceId](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintentcontext/js-apis-app-ability-insightintentcontext#属性) | number | 是 | 意图实例唯一ID。 |
| result | [insightIntent.IntentResult&lt;T&gt;](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-insightintent/js-apis-app-ability-insightintent#intentresultt20) | 是 | 返回意图执行结果，表示本次意图执行返回给系统入口的数据。 |
