...
子进程的启动配置选项。通过[childProcessManager](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-childprocessmanager/js-apis-app-ability-childprocessmanager)启动子进程时，可以通过ChildProcessOptions配置子进程启动选项。

![](../../../../images/cfb43561/note_3.0-zh-cn.png) 
