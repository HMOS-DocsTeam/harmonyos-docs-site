...
![](../../../../images/96bc685d/note_3.0-zh-cn.png) 
...
![](../../../../images/f75ad6fd/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 表示发起方请求弹框时传入的want信息。 |
...
![](../../../../images/42969e70/note_3.0-zh-cn.png) 
...
| want10+ | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 否 | 是 | 表示Want类型信息，如ability名称，包名等。 |
