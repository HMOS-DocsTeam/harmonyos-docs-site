...
![](../../../../images/54c94bdd/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[ohos.screenLockFileManager错误码](/ref/ability-api/ability-arkts-errcode/errorcode-screenlockfilemanager/errorcode-screenlockfilemanager)。
