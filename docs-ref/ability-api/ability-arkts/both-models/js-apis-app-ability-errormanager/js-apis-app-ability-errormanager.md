...
sidebar_position: 11
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-errormanager
kit: 应用框架
...
![](../../../../images/59d65e6d/note_3.0-zh-cn.png) 
...
| observer | [ErrorObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-errorobserver/js-apis-inner-application-errorobserver) | 是 | 错误观测器。 |
...
| observer | [LoopObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-loopobserver/js-apis-inner-application-loopobserver) | 是 | 注册主线程消息处理耗时监听器。 |
...
![](../../../../images/fa48a991/caution_3.0-zh-cn.png) 

如果该回调函数执行时间超过1s，可能导致[AppRecovery](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-apprecovery/js-apis-app-ability-apprecovery)功能不可用。通过解析hilog日志中的begin与Freeze callback execution completed两者的时间差可以计算回调函数执行时长，如果超过1秒，可以尝试采用异步处理、减少阻塞操作、优化数据结构等方法优化回调逻辑，降低执行时长。
...
| observer | [LoopObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-loopobserver/js-apis-inner-application-loopobserver) | 否 | 应用主线程观测器标志。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ErrorObserver.default](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-errorobserver/js-apis-inner-application-errorobserver) | ErrorObserver模块。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_LoopObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-loopobserver/js-apis-inner-application-loopobserver) | LoopObserver模块。 |
...
| CUSTOM | 3 | 表示用户通过[napi\_create\_ark\_runtime](/ref/napi/napi#napi_create_ark_runtime)从本机代码创建的虚拟机实例。 |
