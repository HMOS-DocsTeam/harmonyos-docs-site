...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-appmanager
kit: 应用框架
...
![](../../../../images/06a98163/note_3.0-zh-cn.png) 
...
![](../../../../images/da22446e/note_3.0-zh-cn.png) 
...
![](../../../../images/350b03fe/note_3.0-zh-cn.png) 
...
![](../../../../images/44f00619/note_3.0-zh-cn.png) 
...
![](../../../../images/fd3c20f4/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[ProcessInformation](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-processinformation/js-apis-inner-application-processinformation)&gt;&gt; | 是 | 回调函数。当接口调用成功，err为undefined，data为当前应用运行进程的信息；否则为错误对象。可进行错误处理或其他自定义处理。 |
...
| observer | [ApplicationStateObserver](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver) | 是 | 应用状态监听器，用于监听应用的生命周期变化。 |
...
![](../../../../images/8e46f106/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [\_AbilityStateData.default](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitystatedata/js-apis-inner-application-abilitystatedata) | Ability状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AppStateData.default](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-appstatedata/js-apis-inner-application-appstatedata) | 应用状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ApplicationStateObserver.default](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-applicationstateobserver/js-apis-inner-application-applicationstateobserver) | 应用状态监听器。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessInformation](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-processinformation/js-apis-inner-application-processinformation) | 进程信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessData.default](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-processdata/js-apis-inner-application-processdata) | 进程数据。 |
