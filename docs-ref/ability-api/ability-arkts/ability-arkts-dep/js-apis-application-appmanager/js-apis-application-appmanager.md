...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-application-appmanager
kit: 应用框架
...
![](../../../../images/694d4c03/note_3.0-zh-cn.png) 

本模块首批接口从API version 8 开始支持，从API version 9废弃，替换模块为[@ohos.app.ability.appManager](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-appmanager/js-apis-app-ability-appmanager)。后续版本的新增接口，采用上角标单独标记接口的起始版本。
...
![](../../../../images/19d5de1f/note_3.0-zh-cn.png) 
...
![](../../../../images/e124dabb/note_3.0-zh-cn.png) 
...
从 API Version 9 开始废弃，建议使用[appManager.getRunningProcessInformation](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-appmanager/js-apis-app-ability-appmanager#appmanagergetrunningprocessinformation)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[ProcessRunningInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-processrunninginfo/js-apis-inner-application-processrunninginfo)&gt;&gt; | Promise对象，返回有关运行进程的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[ProcessRunningInfo](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-processrunninginfo/js-apis-inner-application-processrunninginfo)&gt;&gt; | 是 | 回调函数，返回有关运行进程的信息。 |
