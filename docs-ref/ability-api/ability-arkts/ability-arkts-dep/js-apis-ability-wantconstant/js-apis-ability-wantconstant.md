...
![](../../../../images/3b39ef0d/note_3.0-zh-cn.png) 

本模块首批接口从API version 6开始支持，从API version 9废弃，替换模块为[@ohos.app.ability.wantConstant](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantconstant/js-apis-app-ability-wantconstant)。后续版本的新增接口，采用上角标单独标记接口的起始版本。
...
| FLAG\_ABILITY\_CLEAR\_MISSION | 0x00008000 | 指示清除其他任务的操作。可以为传递给 ****FeatureAbility**** 中[startAbility](/ref/ability-api/ability-arkts/fa-model/js-apis-ability-featureability/js-apis-ability-featureability#featureabilitystartability)方法的****Want****设置此标志，并且必须与****FLAG\_ABILITY\_NEW\_MISSION****一起使用。 |
