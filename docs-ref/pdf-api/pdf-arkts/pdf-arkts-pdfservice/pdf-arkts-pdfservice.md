...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice
kit: 应用服务
...
![](../../../images/a97df0e4/note_3.0-zh-cn.png) 
...
| ****参数名**** | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bookmark | [Bookmark](#bookmark) | 是 | Bookmark类型。 |
...
![](../../../images/b798e36b/note_3.0-zh-cn.png) 
...
| highlightMode | [HighlightMode](#highlightmode) | 否 | 是 | 高亮模式类型。  说明：目前只支持表单注释类型，返回值-1。 |
...
| textAlignment | [AlignmentType](#alignmenttype) | 否 | 是 | 对齐类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| vertexes | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | 按顺序描述多边形的PdfPoint类型的数组。 |
| lineColor | number | 否 | 是 | 线框颜色，取值范围0x000000 ~ 0xFFFFFF。  (例如：0xFF0000代表蓝色，0x0000FF代表红色) |
| fillColor | number | 否 | 是 | 填充颜色，取值范围0x000000 ~ 0xFFFFFF。  (例如：0xFF0000代表蓝色，0x0000FF代表红色) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| vertexes | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | 按顺序描述折线的PdfPoint类型的数组。 |
| lineColor | number | 否 | 是 | 线框颜色，取值范围0x000000~0xFFFFFF。  (例如：0xFF0000代表蓝色，0x0000FF代表红色) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| quadPoints | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | 高亮区域的PdfPoint数组。  每个链接标注有4\*n个点，每组4个点分别是：  第1个点：矩形左上角的点。  第2个点：矩形的右上点。  第3个点：矩形左下角的点。  第4个点：矩形的右下角点。  说明：传参和取值会有差异，底层对数据做了处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| quadPoints | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | 下划线区域的PdfPoint数组。  每个链接标注有4\*n个点，每组4个点分别是：  第1个点：矩形左上角的点。  第2个点：矩形的右上点。  第3个点：矩形左下角的点。  第4个点：矩形的右下角点。  说明：传参和取值会有差异，底层对数据做了处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| quadPoints | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | 删除线区域的PdfPoint数组。  每个链接标注有4\*n个点，每组4个点分别是：  第1个点：矩形左上角的点。  第2个点：矩形的右上点。  第3个点：矩形左下角的点。  第4个点：矩形的右下角点。  说明：传参和取值会有差异，底层对数据做了处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| inkPoints | Array&lt;[PdfPoint](#pdfpoint)&gt; | 否 | 否 | PdfPoint数组按顺序描述墨迹批注  每个链接标注有4\*n个点，每组4个点分别是：  第1个点：矩形左上角的点。  第2个点：矩形的右上点。  第3个点：矩形左下角的点。  第4个点：矩形的右下角点。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[PdfAnnotation](#pdfannotation)&gt; | 文档批注数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 当前页的image.PixelMap类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 当前页PixelMap。 |
...
![](../../../images/ef7e0d9c/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[GraphicsObject](#graphicsobject)&gt; | 所有图形对象数组。 |
...
删除指定的[GraphicsObject](#graphicsobject)类型对象。
...
![](../../../images/01143d15/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [GraphicsObjectType](#graphicsobjecttype) | 否 | 否 | 获取当前图形对象的类型,type是枚举值。 |
...
| charRects | Array&lt;[PdfRect](#pdfrect)&gt; | 否 | 否 | 获取字符的区域。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 使用一种特殊的语法来表示直接在内容流内的小图像数据。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontInfo | [FontInfo](#fontinfo) | 否 | 是 | 字体信息，默认字体：HarmonyOS\_Sans。 |
