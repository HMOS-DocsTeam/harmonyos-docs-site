...
SystemSoundPlayer需要和[@ohos.multimedia.systemSoundManager](/ref/audio-api/audio-arkts/js-apis-systemsoundmanager/js-apis-systemsoundmanager)配合使用，才能完成管理系统音效的功能。

![](../../../../images/c238b9c3/note_3.0-zh-cn.png) 
...
系统音效播放器提供了拍照和录制视频音效的播放功能。在调用SystemSoundPlayer的接口前，需要先通过[createSystemSoundPlayer](/ref/audio-api/audio-arkts/js-apis-systemsoundmanager/js-apis-systemsoundmanager#systemsoundmanagercreatesystemsoundplayer)创建系统音效播放器对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| soundType | [systemSoundManager.SystemSoundType](/ref/audio-api/audio-arkts/js-apis-systemsoundmanager/js-apis-systemsoundmanager#systemsoundtype) | 是 | 系统音效类型。 |
