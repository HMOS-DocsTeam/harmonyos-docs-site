...
在使用AudioStreamManager的接口之前，需先通过[getStreamManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getstreammanager9)获取AudioStreamManager实例。

![](../../../../images/455c7851/note_3.0-zh-cn.png) 
...
![](../../../../images/43611c15/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioRendererChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererchangeinfoarray9)&gt; | 是 | 回调函数。当获取当前音频渲染器的信息成功，err为undefined，data为获取到的当前音频渲染器的信息；否则为错误对象。 |
...
![](../../../../images/eda5a99d/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioRendererChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererchangeinfoarray9)&gt; | Promise对象，返回当前音频渲染器信息。 |
...
![](../../../../images/c519151d/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererchangeinfoarray9) | 返回当前音频渲染器信息。 |
...
![](../../../../images/d65dab11/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioCapturerChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiocapturerchangeinfoarray9)&gt; | 是 | 回调函数。当获取当前音频采集器的信息成功，err为undefined，data为获取到的当前音频采集器的信息；否则为错误对象。 |
...
![](../../../../images/8fc6b79f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioCapturerChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiocapturerchangeinfoarray9)&gt; | Promise对象，返回当前音频采集器信息。 |
...
![](../../../../images/27550b42/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AudioCapturerChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiocapturerchangeinfoarray9) | 返回当前音频采集器信息。 |
...
![](../../../../images/c301d187/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[AudioRendererChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererchangeinfoarray9)&gt; | 是 | 回调函数，返回当前音频渲染器信息。 |
...
![](../../../../images/7139f4d6/note_3.0-zh-cn.png) 
...
| callback18+ | Callback&lt;[AudioRendererChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererchangeinfoarray9)&gt; | 否 | 回调函数，返回当前音频渲染器信息。 |
...
![](../../../../images/697d1f53/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[AudioCapturerChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiocapturerchangeinfoarray9)&gt; | 是 | 回调函数，返回当前音频采集器信息。 |
...
![](../../../../images/5eada137/note_3.0-zh-cn.png) 
...
| callback18+ | Callback&lt;[AudioCapturerChangeInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiocapturerchangeinfoarray9)&gt; | 否 | 回调函数，返回当前音频采集器信息。 |
...
![](../../../../images/7d54058d/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[isStreamActive](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiostreammanager/arkts-apis-audio-audiostreammanager#isstreamactive20)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| volumeType | [AudioVolumeType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiovolumetype) | 是 | 音频流类型。 |
...
![](../../../../images/ef67c7ec/note_3.0-zh-cn.png) 
...
![](../../../../images/a0cb5501/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[isStreamActive](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiostreammanager/arkts-apis-audio-audiostreammanager#isstreamactive20)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 音频流使用类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| usage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 音频流使用类型。 |
| callback | AsyncCallback&lt;[AudioEffectInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiostreammanager/arkts-apis-audio-audiostreammanager#getaudioeffectinfoarray10)&gt; | 是 | 回调函数。当获取当前音效模式的信息成功，err为undefined，data为获取到的当前音效模式的信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioEffectInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiostreammanager/arkts-apis-audio-audiostreammanager#getaudioeffectinfoarray10)&gt; | Promise对象，返回当前音效模式的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioEffectInfoArray](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiostreammanager/arkts-apis-audio-audiostreammanager#getaudioeffectinfoarray10) | 返回当前音效模式的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceType | [SourceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#sourcetype8) | 是 | 音源类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AudioLoopbackMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackmode20) | 是 | 音频返听模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| capturerInfo | [AudioCapturerInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerinfo8) | 是 | 音频采集器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceType | [SourceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#sourcetype8) | 是 | 表示音源类型。 |
