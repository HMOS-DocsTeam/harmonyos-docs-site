...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiorenderer
kit: 媒体
...
在使用AudioRenderer的接口之前，需先通过[createAudioRenderer](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-f/arkts-apis-audio-f#audiocreateaudiorenderer8)获取AudioRenderer实例。

![](../../../../images/cf1cd2e0/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state8+ | [AudioState](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiostate8) | 是 | 否 | 音频渲染器的状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8)&gt; | 是 | 回调函数。当获取音频渲染器的信息成功，err为undefined，data为获取到的音频渲染器的信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8)&gt; | Promise对象，返回音频渲染器信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8) | 返回音频渲染器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioStreamInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreaminfo8)&gt; | 是 | 回调函数。当获取音频流信息成功，err为undefined，data为获取到的音频流信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioStreamInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreaminfo8)&gt; | Promise对象，返回音频流信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioStreamInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreaminfo8) | 返回音频流信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AudioEffectMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioeffectmode10) | 是 | 音效模式。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。当设置当前音效模式成功，err为undefined，否则为错误对象。 |

****错误码：****

以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[Audio错误码](/ref/audio-api/audio-arkts-errcode/errorcode-audio/errorcode-audio)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioEffectMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioeffectmode10)&gt; | 是 | 回调函数。当获取当前音效模式成功，err为undefined，data为获取到的当前音效模式；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioEffectMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioeffectmode10)&gt; | Promise对象，返回当前音效模式。 |
...
清空缓冲区（[AudioState](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiostate8)为STATE\_RUNNING、STATE\_PAUSED、STATE\_STOPPED状态下可用）。使用Promise异步回调。
...
以下错误码的详细介绍请参见[Audio错误码](/ref/audio-api/audio-arkts-errcode/errorcode-audio/errorcode-audio)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioTimestampInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiotimestampinfo19)&gt; | Promise对象，返回音频流时间戳和当前数据帧位置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioTimestampInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiotimestampinfo19) | 返回音频流时间戳和当前数据帧位置信息。 |
...
![](../../../../images/db83eba4/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AudioLatencyType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiolatencytype23) | 是 | 获取的时延类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [InterruptMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#interruptmode9) | 是 | 焦点模型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数。当获取音频流输出设备信息成功，err为undefined，data为获取到的音频流输出设备信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | Promise对象，返回音频流的输出设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) | 返回音频流的输出设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ChannelBlendMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#channelblendmode11) | 是 | 声道混合模式类型。 |
...
![](../../../../images/77ea5698/note_3.0-zh-cn.png) 

- 本接口仅适用于[StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage)为语音消息、VoIP语音通话或者VoIP视频通话的场景，支持听筒、扬声器和系统默认设备。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [DeviceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#devicetype) | 是 | 设备类型。  仅支持以下设备：EARPIECE（听筒）、SPEAKER（扬声器）和DEFAULT（系统默认设备）。 |
...
调用此方法后，如果AudioRenderer对象获取焦点失败或发生中断事件（如被其他音频打断等），会收到[InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)。建议应用根据InterruptEvent的信息进行进一步处理。更多信息请参阅文档[音频焦点介绍](/audio-kit/audio-session/audio-playback-concurrency)。
...
| callback | Callback&lt;[InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)&gt; | 是 | 回调函数，返回中断事件信息。 |
...
| callback | Callback&lt;[InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)&gt; | 否 | 回调函数，返回中断事件信息。 |
...
| callback | Callback&lt;[AudioState](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiostate8)&gt; | 是 | 回调函数，返回当前音频的状态。 |
...
| callback | Callback&lt;[AudioState](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiostate8)&gt; | 否 | 回调函数，返回当前音频的状态。 |
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数，返回当前音频流的输出设备描述信息。 |
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 否 | 回调函数，返回当前音频流的输出设备描述信息。 |
...
| callback | Callback&lt;[AudioStreamDeviceChangeInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreamdevicechangeinfo11)&gt; | 是 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。 |
...
| callback | Callback&lt;[AudioStreamDeviceChangeInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreamdevicechangeinfo11)&gt; | 否 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。 |
...
| callback | [AudioRendererWriteDataCallback](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererwritedatacallback12) | 是 | 回调函数，入参代表应用接收待写入的数据缓冲区。  API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果[AudioDataCallbackResult](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiodatacallbackresult12)。 |
...
| callback | [AudioRendererWriteDataCallback](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiorendererwritedatacallback12) | 否 | 回调函数，入参代表应用接收待写入的数据缓冲区。  API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果[AudioDataCallbackResult](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiodatacallbackresult12)。 |
...
![](../../../../images/dbe6a2e2/note_3.0-zh-cn.png) 
...
![](../../../../images/3fc5ade3/note_3.0-zh-cn.png) 
...
![](../../../../images/bdee388c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rate | [AudioRendererRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiorendererrate8) | 是 | 渲染的速率。 |
...
![](../../../../images/2cd13461/note_3.0-zh-cn.png) 
...
![](../../../../images/03b52033/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioRendererRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiorendererrate8)&gt; | 是 | 回调函数。当获取当前渲染速率成功，err为undefined，data为获取到的当前渲染速率；否则为错误对象。 |
...
![](../../../../images/cc6abd6c/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioRendererRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiorendererrate8)&gt; | Promise对象，返回渲染速率。 |
...
![](../../../../images/d1b71819/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiorendererrate8) | 返回渲染速率。 |
...
![](../../../../images/67e1360d/note_3.0-zh-cn.png) 

- 该接口仅支持类型为[STREAM\_USAGE\_MUSIC](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage)、[STREAM\_USAGE\_MOVIE](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage)或[STREAM\_USAGE\_AUDIOBOOK](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage)的音频流。
- 该接口不支持高清通路的响度设置。
...
| --- | --- |
| 6800101 | Parameter verification failed. |
| 6800104 | Operation is not supported on this renderer, e.g. the stream usage of this renderer is not one of [STREAM\_USAGE\_MUSIC](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage),  [STREAM\_USAGE\_MOVIE](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage), or [STREAM\_USAGE\_AUDIOBOOK](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage), or this renderer is routed through the high-resolution playback path. |
