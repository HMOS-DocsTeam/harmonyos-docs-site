...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiosessionmanager
kit: 媒体
...
在使用AudioSessionManager的接口之前，需先通过[getSessionManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getsessionmanager12)获取AudioSessionManager实例。

![](../../../../images/e7d97a6e/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [AudioSessionStrategy](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessionstrategy12) | 是 | 音频会话策略。 |
...
| callback | Callback&lt;[AudioSessionDeactivatedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessiondeactivatedevent12)&gt; | 是 | 回调函数，返回音频会话停用原因。 |
...
| callback | Callback&lt;[AudioSessionDeactivatedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessiondeactivatedevent12)&gt; | 否 | 回调函数，返回音频会话停用原因。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scene | [AudioSessionScene](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosessionscene20) | 是 | 音频会话场景。 |
...
| callback | Callback&lt;[AudioSessionStateChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessionstatechangedevent20)&gt; | 是 | 回调函数，返回音频会话变更提示信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'audioSessionStateChanged'，当音频会话状态变更时，触发该事件。 |
| callback | Callback&lt;[AudioSessionStateChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessionstatechangedevent20)&gt; | 否 | 回调函数，返回音频会话变更提示信息。 |
...
![](../../../../images/05b06269/note_3.0-zh-cn.png) 

- 本接口适用于以下情况：当设置的[AudioSessionScene](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosessionscene20)为VoIP场景时，激活AudioSession后立即生效。若[AudioSessionScene](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosessionscene20)为非VoIP场景，激活AudioSession时不会生效，仅在启动播放的[StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage)为语音消息、VoIP语音通话或VoIP视频通话时才生效。支持听筒、扬声器和系统默认设备。
...
| callback | Callback&lt;[CurrentOutputDeviceChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#currentoutputdevicechangedevent20)&gt; | 是 | 回调函数，返回当前输出设备信息。 |
...
| callback | Callback&lt;[CurrentOutputDeviceChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#currentoutputdevicechangedevent20)&gt; | 否 | 回调函数，用于返回当前输出设备变化的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceUsage | [DeviceUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#deviceusage12) | 是 | 音频设备类型（根据用途分类）。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) | 返回设备列表。 |
...
| callback | Callback&lt;[DeviceChangeAction](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#devicechangeaction)&gt; | 否 | 回调函数，返回可选设备更新详情。 |
...
![](../../../../images/de37db1c/note_3.0-zh-cn.png) 

- 本接口不适用于VoIP通话录音，即[SourceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#sourcetype8)为SOURCE\_TYPE\_VOICE\_COMMUNICATION的场景不适用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputAudioDevice | [AudioDeviceDescriptor](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiodevicedescriptor) | 是 | 媒体输入设备。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptor](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiodevicedescriptor) | 媒体输入设备信息。 |
...
![](../../../../images/43b4f8ef/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| category | [BluetoothAndNearlinkPreferredRecordCategory](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#bluetoothandnearlinkpreferredrecordcategory21) | 是 | 在使用蓝牙或星闪进行录音时，应用程序的设备偏好分类。 |
...
| 类型 | 说明 |
| --- | --- |
| [BluetoothAndNearlinkPreferredRecordCategory](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#bluetoothandnearlinkpreferredrecordcategory21) | 在使用蓝牙或星闪进行录音时，应用程序的设备偏好分类。 |
...
| callback | Callback&lt;[CurrentInputDeviceChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#currentinputdevicechangedevent21)&gt; | 是 | 回调函数，返回当前输入设备信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'currentInputDeviceChanged'，当前输入设备发生变化时，触发该事件。 |
| callback | Callback&lt;[CurrentInputDeviceChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#currentinputdevicechangedevent21)&gt; | 否 | 回调函数，用于返回当前输入设备变化的信息。 |
...
如果启用此功能，当订阅音频会话状态更改事件后静音建议和取消静音建议提示将通过[AudioSessionStateChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiosessionstatechangedevent20)回调发送。收到静音建议表示其他应用程序开始播放音频，且播放的音频和本应用的音频不能混音。

此功能仅支持已设置[AudioSessionScene](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosessionscene20)并激活模式模式为CONCURRENCY\_MIX\_WITH\_OTHERS的音频会话使用。并且仅在激活音频会话期间生效一次，每次激活音频会话前都必须重新启用。

详细说明请参考[启用混音播放下静音建议通知](/audio-kit/audio-session/audio-session-management#启用混音播放下静音建议通知)。
...
| 错误码ID | 错误信息 |
| --- | --- |
| 6800103 | Function is called without setting [AudioSessionScene](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosessionscene20) or called after audio session activation. |
