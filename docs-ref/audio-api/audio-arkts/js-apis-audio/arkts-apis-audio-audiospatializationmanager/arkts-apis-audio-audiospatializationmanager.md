...
在使用AudioSpatializationManager的接口之前，需先通过[getSpatializationManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getspatializationmanager18)获取AudioSpatializationManager实例。

![](../../../../images/e558cef4/note_3.0-zh-cn.png) 
