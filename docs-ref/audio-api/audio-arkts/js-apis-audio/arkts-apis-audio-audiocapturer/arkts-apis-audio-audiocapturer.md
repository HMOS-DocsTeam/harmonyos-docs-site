...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiocapturer
kit: 媒体
...
在使用AudioCapturer的接口之前，需先通过[createAudioCapturer](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-f/arkts-apis-audio-f#audiocreateaudiocapturer8)获取AudioCapturer实例。

![](../../../../images/f7b7147c/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state8+ | [AudioState](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiostate8) | 是 | 否 | 音频采集器状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioCapturerInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerinfo8)&gt; | 是 | 回调函数。当获取音频采集器信息成功，err为undefined，data为获取到的音频采集器信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioCapturerInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerinfo8)&gt; | Promise对象，返回音频采集器信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioCapturerInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerinfo8) | 返回音频采集器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AudioStreamInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiostreaminfo8)&gt; | 是 | 回调函数。当获取音频采集器流信息成功，err为undefined，data为获取到的音频采集器流信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) | 同步接口，返回设备属性数组类型数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioCapturerChangeInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerchangeinfo9) | 同步接口，返回描述音频采集器更改信息。 |
...
调用此方法后，如果AudioCapturer对象获取焦点失败或发生中断事件（如被其他音频打断等），会收到[InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)。建议应用根据InterruptEvent的信息进行进一步处理。更多信息请参阅文档[音频焦点介绍](/audio-kit/audio-session/audio-playback-concurrency)。
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) &gt; | 是 | 回调函数，返回变化后的音频输入设备信息。 |
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) &gt; | 否 | 回调函数，返回音频输入设备信息。 |
...
| callback | Callback&lt;[AudioCapturerChangeInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerchangeinfo9)&gt; | 是 | 回调函数，录音流配置或状态变化时返回监听的录音流当前配置和状态信息。 |
...
| callback | Callback&lt;[AudioCapturerChangeInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerchangeinfo9)&gt; | 否 | 回调函数，返回取消监听的录音流配置或状态变化。 |
...
设置当前录制音频流是否启用[静音打断模式](/audio-kit/audio-recording/using-audiocapturer-for-recording#设置静音打断模式)。使用Promise异步回调。
...
![](../../../../images/2de8ca71/note_3.0-zh-cn.png) 
...
![](../../../../images/13d3d273/note_3.0-zh-cn.png) 
