...
sidebar_position: 11
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiovolumemanager
kit: 媒体
...
在使用AudioVolumeManager的接口之前，需先通过[getVolumeManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getvolumemanager9)获取AudioVolumeManager实例。

![](../../../../images/588f3a5d/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[AudioVolumeGroupManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumegroupmanager/arkts-apis-audio-audiovolumegroupmanager)&gt; | 是 | 回调函数。当获取音频组音量管理器实例成功，err为undefined，data为获取到的音频组音量管理器实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt; [AudioVolumeGroupManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumegroupmanager/arkts-apis-audio-audiovolumegroupmanager) &gt; | Promise对象，返回音频组音量管理器实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioVolumeGroupManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumegroupmanager/arkts-apis-audio-audiovolumegroupmanager) | 音频组音量管理器实例。 |
...
![](../../../../images/8f5f3d40/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[on('streamVolumeChange')](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#onstreamvolumechange20)替代。
...
| callback | Callback&lt;[VolumeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#volumeevent9)&gt; | 是 | 回调函数，返回变化后的音量信息。 |
...
![](../../../../images/536be81b/note_3.0-zh-cn.png) 

从API version 12开始支持，从API version 20开始废弃，建议使用[off('streamVolumeChange')](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#offstreamvolumechange20)替代。
...
| callback | Callback&lt;[VolumeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#volumeevent9)&gt; | 否 | 回调函数，返回变化后的音量信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 需要获取音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 需要获取的最小音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 需要获取的最大音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 检查是否为静音的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 音频流。 |
...
| callback | Callback&lt;[StreamVolumeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#streamvolumeevent20)&gt; | 是 | 回调函数，返回变化后的音量信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'volumeChange'，当取消监听系统音量变化事件时，触发该事件。 |
| callback | Callback&lt;[StreamVolumeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#streamvolumeevent20)&gt; | 否 | 回调函数，返回变化后的音量信息。 |
