...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioroutingmanager
kit: 媒体
...
在使用AudioRoutingManager的接口之前，需先通过[getRoutingManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getroutingmanager9)获取AudioRoutingManager实例。

![](../../../../images/7eb60b1b/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[DeviceBlockStatusInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#deviceblockstatusinfo13)&gt; | 是 | 回调函数，返回麦克风被堵塞状态和设备信息。 |
...
| callback | Callback&lt;[DeviceBlockStatusInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#deviceblockstatusinfo13)&gt; | 否 | 回调函数，返回麦克风被堵塞状态和设备信息。 |
...
推荐使用AVSession提供的[设备切换组件](/avsession-kit/distributed-avsession/using-switch-call-devices)，实现通话设备切换。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [CommunicationDeviceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#communicationdevicetype9) | 是 | 音频设备类型。 |
...
推荐开发者使用AVSession提供的[设备切换组件](/avsession-kit/distributed-avsession/using-switch-call-devices)，实现通话设备切换。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [CommunicationDeviceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#communicationdevicetype9) | 是 | 活跃音频设备类型。 |
| active | boolean | 是 | 是否设置设备为激活状态。true表示激活，false表示未激活。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rendererInfo | [AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8) | 是 | 音频渲染器信息。 |
| callback | AsyncCallback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数。当获取优先级最高的输出设备成功，err为undefined，data为获取到的优先级最高的输出设备信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | Promise对象，返回优先级最高的输出设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) | 返回优先级最高的输出设备信息。 |
...
| rendererInfo | [AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8) | 是 | 音频渲染器信息。 |
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数，返回优先级最高的输出设备信息。 |
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 否 | 回调函数，返回优先级最高的输出设备信息。 |
...
| callback | AsyncCallback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数。当获取优先级最高的输入设备成功，err为undefined，data为获取到的优先级最高的输入设备信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | Promise对象，返回优先级最高的输入设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors) | 返回优先级最高的输入设备信息。 |
...
| capturerInfo | [AudioCapturerInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiocapturerinfo8) | 是 | 音频采集器信息。 |
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 是 | 回调函数，返回优先级最高的输入设备信息。 |
...
| callback | Callback&lt;[AudioDeviceDescriptors](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-t/arkts-apis-audio-t#audiodevicedescriptors)&gt; | 否 | 回调函数，返回优先级最高的输入设备信息。 |
