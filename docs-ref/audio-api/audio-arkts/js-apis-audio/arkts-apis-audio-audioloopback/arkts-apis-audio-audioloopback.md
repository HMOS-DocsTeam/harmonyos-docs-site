...
sidebar_position: 12
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audioloopback
kit: 媒体
...
在使用AudioLoopback的接口之前，需先通过[audio.createAudioLoopback](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-f/arkts-apis-audio-f#audiocreateaudioloopback20)获取AudioLoopback实例。
...
![](../../../../images/21c0aa22/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AudioLoopbackStatus](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackstatus20)&gt; | Promise对象，返回音频返听状态。 |
...
| callback | Callback&lt;[AudioLoopbackStatus](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackstatus20)&gt; | 是 | 回调函数，返回当前音频返听的状态。 |
...
| callback | Callback&lt;[AudioLoopbackStatus](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackstatus20)&gt; | 否 | 回调函数，返回当前音频返听的状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| preset | [AudioLoopbackReverbPreset](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackreverbpreset21) | 是 | 混响模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioLoopbackReverbPreset](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackreverbpreset21) | 返回当前音频返听器的混响模式。  在没有被修改的情况下，默认的混响模式是THEATER。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| preset | [AudioLoopbackEqualizerPreset](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackequalizerpreset21) | 是 | 均衡器类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioLoopbackEqualizerPreset](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioloopbackequalizerpreset21) | 返回当前音频返听器的均衡器类型。  在没有被修改的情况下，默认的均衡器类型是FULL。 |
