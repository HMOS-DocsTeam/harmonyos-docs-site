...
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-audiovolumegroupmanager
kit: 媒体
...
在使用AudioVolumeGroupManager的接口之前，需先通过[getVolumeGroupManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getvolumegroupmanager9)获取AudioVolumeGroupManager实例。

![](../../../../images/940b723a/note_3.0-zh-cn.png) 
...
![](../../../../images/c9f92f78/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[getVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getvolumebystream20)替代。
...
![](../../../../images/de66d14b/note_3.0-zh-cn.png) 
...
![](../../../../images/857eaac0/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[getVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getvolumebystream20)替代。
...
![](../../../../images/17703ff0/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[getMinVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getminvolumebystream20)替代。
...
![](../../../../images/99688879/note_3.0-zh-cn.png) 
...
![](../../../../images/822125fd/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[getMinVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getminvolumebystream20)替代。
...
![](../../../../images/57158faf/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[getMaxVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getmaxvolumebystream20)替代。
...
![](../../../../images/93ad75fb/note_3.0-zh-cn.png) 
...
![](../../../../images/13aa930c/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[getMaxVolumeByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getmaxvolumebystream20)替代。
...
![](../../../../images/6d936e3f/note_3.0-zh-cn.png) 

从API version 9开始支持，从API version 20开始废弃，建议使用[isSystemMutedForStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#issystemmutedforstream20)替代。
...
![](../../../../images/3d11354f/note_3.0-zh-cn.png) 
...
![](../../../../images/05fbe7f1/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[isSystemMutedForStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#issystemmutedforstream20)替代。
...
| 类型 | 说明 |
| --- | --- |
| [AudioRingMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioringmode) | 返回系统的铃声模式。 |
...
监听铃声模式变化事件（当[AudioRingMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioringmode)发生变化时触发）。使用callback异步回调。
...
| callback | Callback&lt;[AudioRingMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioringmode)&gt; | 是 | 回调函数，返回变化后的铃音模式。 |
...
| callback | Callback&lt;[AudioRingMode](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audioringmode)&gt; | 否 | 回调函数，返回变化后的铃音模式。 |
...
| callback | Callback&lt;[MicStateChangeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#micstatechangeevent9)&gt; | 是 | 回调函数，返回变更后的麦克风状态。 |
...
| callback | Callback&lt;[MicStateChangeEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#micstatechangeevent9)&gt; | 否 | 回调函数，返回变更后的麦克风状态。 |
...
![](../../../../images/5e5034eb/note_3.0-zh-cn.png) 

从API version 10开始支持，从API version 20开始废弃，建议使用[getVolumeInUnitOfDbByStream](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager#getvolumeinunitofdbbystream20)替代。
...
| device | [DeviceType](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#devicetype) | 是 | 设备类型。 |
...
![](../../../../images/b48a648f/note_3.0-zh-cn.png) 
...
![](../../../../images/cd34ea9a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputDevice | [AudioDeviceDescriptor](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiodevicedescriptor) | 是 | 获取最大电平值的设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| outputDevice | [AudioDeviceDescriptor](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiodevicedescriptor) | 是 | 获取最大电平值的设备信息。 |
...
![](../../../../images/f86c05ee/note_3.0-zh-cn.png) 
...
![](../../../../images/80922aba/note_3.0-zh-cn.png) 
