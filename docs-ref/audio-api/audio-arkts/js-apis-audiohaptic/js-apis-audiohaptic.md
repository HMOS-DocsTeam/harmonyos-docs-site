...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-audiohaptic
kit: 媒体
...
![](../../../images/f945a55a/note_3.0-zh-cn.png) 
...
| AUDIO\_LATENCY\_MODE\_FAST | 1 | 低时延模式。该模式适用于比较短的音频文件，音频文件过长时可能被截断，该特性与[SoundPool](/ref/media-api/media-arkts/media-multimedia-arkts/js-apis-inner-multimedia-soundpool/js-apis-inner-multimedia-soundpool#soundpool)一致。 |
...
![](../../../images/a07e26af/caution_3.0-zh-cn.png) 
...
![](../../../images/857fd5ee/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| audioUri | string | 是 | 音频资源的Uri。  - 对普通时延模式，音频资源格式和路径格式的支持可参考[AVPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avplayer/arkts-apis-media-avplayer)。  - 对低时延模式，音频资源格式支持可参考[SoundPool](/ref/media-api/media-arkts/media-multimedia-arkts/js-apis-inner-multimedia-soundpool/js-apis-inner-multimedia-soundpool#soundpool)，路径格式需满足[fileIo.open](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs#fileioopen)的要求。  - 对两种时延模式，均建议传入文件的绝对路径。 |
| hapticUri | string | 是 | 振动资源的Uri。  振动资源格式支持可参考[HapticFileDescriptor](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-vibrator/js-apis-vibrator#hapticfiledescriptor10)，路径格式需满足[fileIo.open](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs#fileioopen)的要求。  建议传入文件的绝对路径。 |
...
![](../../../images/b7a4e279/caution_3.0-zh-cn.png) 
...
![](../../../images/52081065/caution_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| id | number | 是 | 已注册资源的source id。 |
| usage | [audio.StreamUsage](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#streamusage) | 是 | 音频流使用类型。 |
...
![](../../../images/14054099/caution_3.0-zh-cn.png) 
...
![](../../../images/143100da/caution_3.0-zh-cn.png) 
...
| callback | Callback&lt;[audio.InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)&gt; | 是 | 回调函数，返回中断事件信息。 |
...
| callback | Callback&lt;[audio.InterruptEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#interruptevent9)&gt; | 否 | 回调函数，返回中断事件信息。 |
