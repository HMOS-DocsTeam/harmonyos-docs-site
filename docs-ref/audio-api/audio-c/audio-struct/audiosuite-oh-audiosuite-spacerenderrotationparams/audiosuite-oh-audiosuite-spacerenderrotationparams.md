...
| [OH\_AudioSuite\_SurroundDirection](/ref/audio-api/audio-c/audio-headerfile/capi-native-audio-suite-base-h/capi-native-audio-suite-base-h#oh_audiosuite_surrounddirection) surroundDirection | 单周环绕方向。取值范围为[0, 1]。 |
