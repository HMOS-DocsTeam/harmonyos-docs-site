...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-dlppermission
kit: 系统
...
![](../../../../images/da55bf44/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[DLP服务错误码](/ref/system-security-api/data-protection-api/data-protection-arkts-errcode/errorcode-dlp/errorcode-dlp)。
...
以下错误码的详细介绍请参见[DLP服务错误码](/ref/system-security-api/data-protection-api/data-protection-arkts-errcode/errorcode-dlp/errorcode-dlp)。
...
![](../../../../images/fbc2bd4b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | 当前窗口UIAbility上下文。 |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 请求对象。 |
...
![](../../../../images/f31c8c24/note_3.0-zh-cn.png) 

该接口由[MDM](/system-basicfun/mdm-kit/mdm-kit-intro)配置使能，且使能场景为企业设备。其他设备（如消费者终端设备）无需关注该接口，如若调用该接口，则返回值为false。
...
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 否 | 否 | 表示打开DLP权限管理应用并退出后返回的数据。 |
...
![](../../../../images/3addfed6/note_3.0-zh-cn.png) 
...
![](../../../../images/75b2ac1f/note_3.0-zh-cn.png) 
...
| everyoneAccessList | Array&lt;[DLPFileAccess](/ref/system-security-api/data-protection-api/data-protection-arkts/js-apis-dlppermission/js-apis-dlppermission#dlpfileaccess)&gt; | 否 | 是 | 表示授予所有人的权限，默认为空。 |
...
| dlpFileAccess | [DLPFileAccess](/ref/system-security-api/data-protection-api/data-protection-arkts/js-apis-dlppermission/js-apis-dlppermission#dlpfileaccess) | 否 | 否 | 表示被授予的权限。 |
...
![](../../../../images/59abaa86/note_3.0-zh-cn.png) 
...
![](../../../../images/add72e2d/note_3.0-zh-cn.png) 
...
![](../../../../images/3f8086b2/note_3.0-zh-cn.png) 
...
![](../../../../images/0578cacb/note_3.0-zh-cn.png) 
...
![](../../../../images/6d4ffb1e/note_3.0-zh-cn.png) 
