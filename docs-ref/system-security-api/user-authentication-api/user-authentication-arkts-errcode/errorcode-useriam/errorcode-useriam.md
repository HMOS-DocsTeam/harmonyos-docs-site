...
title: "用户认证错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-useriam
kit: 系统
last_updated: "2026-04-22"
slug: errorcode-useriam
---

# 用户认证错误码

![](../../../../images/8005a853/note_3.0-zh-cn.png) 
...
1. 传入的认证类型参数不支持，例如调用userAuth模块的[getAvailableStatus](/ref/system-security-api/user-authentication-api/user-authentication-arkts/js-apis-useriam-userauth/js-apis-useriam-userauth#userauthgetavailablestatus9)接口时传入的参数不是FACE或FINGERPRINT类型，则会返回12500005错误码。
...
例如调用userAuth模块的[getAvailableStatus](/ref/system-security-api/user-authentication-api/user-authentication-arkts/js-apis-useriam-userauth/js-apis-useriam-userauth#userauthgetavailablestatus9)接口，传入的authType参数为FACE，但是当前的设备没有录入人脸凭据，则会返回12500010错误码。调用start接口发起人脸认证，但是目前的设备没有录入人脸凭据，则会返回12500010错误码。
