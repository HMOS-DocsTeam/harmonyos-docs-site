...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth
kit: 系统
...
![](../../../../images/fb3b52e3/note_3.0-zh-cn.png) 
...
![](../../../../images/e7ad5f10/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[用户认证错误码](/ref/system-security-api/user-authentication-api/user-authentication-arkts-errcode/errorcode-useriam/errorcode-useriam)。
...
| authTrustLevel | [AuthTrustLevel](#authtrustlevel8) | 否 | 否 | 期望达到的认证可信等级。典型操作需要的身份认证可信等级，以及身份认证可信等级的划分请参见[认证可信等级划分原则](/system-security/user-authentication-kit/user-authentication-overview#生物认证可信等级划分原则)。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
![](../../../../images/8ad57e34/note_3.0-zh-cn.png) 

在PC/2in1设备上，应用如果使用模应用弹窗方式发起认证（即配置用户界面参数[widgetParam](#widgetparam10)时传入了有效的uiContext），收到认证结果后，若需弹出其他窗口，应先获取控件弹窗释放的标志消息，通过[on('authTip')](#onauthtip20)接口订阅控件释放消息（authTipInfo.tipCode = UserAuthTipCode.WIDGET\_RELEASED）。
...
![](../../../../images/3508f61b/note_3.0-zh-cn.png) 
...
![](../../../../images/1980a94b/note_3.0-zh-cn.png) 
...
![](../../../../images/a7a6d30c/note_3.0-zh-cn.png) 
...
![](../../../../images/775c12ab/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[用户认证错误码](/ref/system-security-api/user-authentication-api/user-authentication-arkts-errcode/errorcode-useriam/errorcode-useriam)。
...
![](../../../../images/47d406ec/note_3.0-zh-cn.png) 
...
![](../../../../images/bbbc4d28/note_3.0-zh-cn.png) 
...
![](../../../../images/2136f0a5/note_3.0-zh-cn.png) 
...
![](../../../../images/f44f517c/note_3.0-zh-cn.png) 
...
![](../../../../images/00ef24f2/note_3.0-zh-cn.png) 
...
![](../../../../images/dfcf1e5a/note_3.0-zh-cn.png) 
...
![](../../../../images/bfba4bc7/note_3.0-zh-cn.png) 
...
![](../../../../images/5221ef82/note_3.0-zh-cn.png) 
...
![](../../../../images/800246a0/note_3.0-zh-cn.png) 
...
![](../../../../images/49df1d8f/note_3.0-zh-cn.png) 
...
![](../../../../images/9fe88a5c/note_3.0-zh-cn.png) 
...
![](../../../../images/068c4554/note_3.0-zh-cn.png) 
...
![](../../../../images/312d2e88/note_3.0-zh-cn.png) 
...
![](../../../../images/09b5c350/note_3.0-zh-cn.png) 
...
![](../../../../images/a6b51799/note_3.0-zh-cn.png) 
...
![](../../../../images/37490a0a/caution_3.0-zh-cn.png) 
...
![](../../../../images/64724219/note_3.0-zh-cn.png) 
...
![](../../../../images/2cd12184/note_3.0-zh-cn.png) 
...
![](../../../../images/d07a5501/note_3.0-zh-cn.png) 
...
![](../../../../images/19afba06/note_3.0-zh-cn.png) 
...
![](../../../../images/1b200e30/note_3.0-zh-cn.png) 
...
![](../../../../images/e89a5e1e/note_3.0-zh-cn.png) 
...
![](../../../../images/3d774a06/note_3.0-zh-cn.png) 
...
![](../../../../images/37b3051d/note_3.0-zh-cn.png) 
...
![](../../../../images/5e017f9e/note_3.0-zh-cn.png) 
...
![](../../../../images/5b342844/note_3.0-zh-cn.png) 
...
![](../../../../images/b4694485/note_3.0-zh-cn.png) 
...
![](../../../../images/e09ac849/note_3.0-zh-cn.png) 
...
典型场景及举例可参考[认证可信等级划分原则](/system-security/user-authentication-kit/user-authentication-overview#生物认证可信等级划分原则)。
...
![](../../../../images/5f58c53d/note_3.0-zh-cn.png) 
...
![](../../../../images/e50e7057/note_3.0-zh-cn.png) 
...
![](../../../../images/cfacb436/note_3.0-zh-cn.png) 
...
![](../../../../images/beb69239/note_3.0-zh-cn.png) 
...
![](../../../../images/edccc9bf/note_3.0-zh-cn.png) 
...
![](../../../../images/da0b4163/note_3.0-zh-cn.png) 
...
![](../../../../images/8921afe3/note_3.0-zh-cn.png) 
