...
title: "FIDO"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api
kit: 系统
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#context) | 是 | ability的context。 |
...
以下错误码的详细介绍请参见[FIDO免密认证错误码](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-error-code/onlineauthentication-error-code-fido/onlineauthentication-error-code-fido)。
