...
title: "IFAA"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/onlineauthentication-ifaa-api
kit: 系统
...
以下错误码的详细介绍请参见[IFAA免密认证错误码](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-error-code/onlineauthentication-error-code-ifaa/onlineauthentication-error-code-ifaa)。
