...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework
kit: 系统
...
![](../../../../images/8e529511/note_3.0-zh-cn.png) 
...
![](../../../../images/4e83d2d5/note_3.0-zh-cn.png) 
...
![](../../../../images/8859fba5/note_3.0-zh-cn.png) 
...
![](../../../../images/dd785337/note_3.0-zh-cn.png) 
...
![](../../../../images/11a60d19/note_3.0-zh-cn.png) 
...
| aad | [DataBlob](#datablob) | 否 | 否 | 指明加解密参数aad，长度为0~INT\_MAX字节，常用为16字节。 |
...
![](../../../../images/54967955/note_3.0-zh-cn.png) 
...
![](../../../../images/1fcf8051/note_3.0-zh-cn.png) 
...
适用于[ChaCha20算法](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-spec/crypto-sym-encrypt-decrypt-spec#chacha20)Poly1305模式。
...
![](../../../../images/004f9b8d/note_3.0-zh-cn.png) 
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| COMMON\_PARAMS\_SPEC | 0 | 表示公私钥中包含的公共参数。使用此类型的参数可以调用[generateKeyPair](#generatekeypair10)随机生成密钥对。 |
| PRIVATE\_KEY\_SPEC | 1 | 表示私钥中包含的参数。使用此类型的参数可以调用[generatePriKey](#generateprikey10)生成指定的私钥。 |
| PUBLIC\_KEY\_SPEC | 2 | 表示公钥中包含的参数。使用此类型的参数可以调用[generatePubKey](#generatepubkey10)生成指定的公钥。 |
| KEY\_PAIR\_SPEC | 3 | 表示公私钥中包含的全量参数。使用此类型的参数可以调用[generateKeyPair](#generatekeypair10)生成指定的密钥对。 |

## CipherSpecItem10+

表示加解密参数的枚举。这些参数支持通过[setCipherSpec](#setcipherspec10)接口设置，通过[getCipherSpec](#getcipherspec10)接口获取。

当前只支持RSA算法和SM2算法，从API version 11开始，增加对SM2\_MD\_NAME\_STR参数的支持，详细规格请参考[加解密规格](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-spec/crypto-asym-encrypt-decrypt-spec)。
...
当前只支持RSA算法和SM2算法，从API version 11开始，增加对SM2\_USER\_ID\_UINT8ARR参数的支持，详细规格请参考[签名验签规格](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-overview)。
...
![](../../../../images/cc698fa6/note_3.0-zh-cn.png) 
...
![](../../../../images/21dab80c/note_3.0-zh-cn.png) 
...
![](../../../../images/f899095b/note_3.0-zh-cn.png) 
...
![](../../../../images/ba509067/note_3.0-zh-cn.png) 
...
![](../../../../images/1259491a/note_3.0-zh-cn.png) 
...
![](../../../../images/0866e3c3/note_3.0-zh-cn.png) 
...
![](../../../../images/19412a36/note_3.0-zh-cn.png) 
...
![](../../../../images/efaee39c/note_3.0-zh-cn.png) 
...
![](../../../../images/b0a2c00b/note_3.0-zh-cn.png) 
...
![](../../../../images/b7aecfef/note_3.0-zh-cn.png) 
...
![](../../../../images/bd16b4f8/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[crypto framework错误码](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts-errcode/errorcode-crypto-framework/errorcode-crypto-framework)。
...
![](../../../../images/9863fd5a/note_3.0-zh-cn.png) 
...
![](../../../../images/29e6a7b2/note_3.0-zh-cn.png) 
...
![](../../../../images/7012abf9/note_3.0-zh-cn.png) 
...
支持的规格详见[对称密钥生成和转换规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-sym-key-generation-conversion-spec)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 待生成对称密钥生成器的算法名称。  具体取值详见[对称密钥生成和转换规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-sym-key-generation-conversion-spec)一节中的“字符串参数”。 |
...
![](../../../../images/4fda09aa/note_3.0-zh-cn.png) 
...
![](../../../../images/b5f56aaf/note_3.0-zh-cn.png) 
...
![](../../../../images/8d1cbc13/note_3.0-zh-cn.png) 
...
![](../../../../images/a66373f2/note_3.0-zh-cn.png) 
...
支持的规格详见[非对称密钥生成和转换规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 非对称密钥生成支持的算法名。详见[非对称密钥生成和转换规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec)中的字符串参数。 |
...
![](../../../../images/642ae959/note_3.0-zh-cn.png) 
...
![](../../../../images/f89a8779/note_3.0-zh-cn.png) 
...
![](../../../../images/9c5b53eb/note_3.0-zh-cn.png) 
...
![](../../../../images/d93bea89/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| asyKeySpec | [AsyKeySpec](#asykeyspec10) | 是 | 密钥参数。非对称密钥生成器根据指定的这些参数生成公/私钥。  支持的规格详见[非对称密钥生成和转换规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec)。 |
...
当使用[COMMON\_PARAMS\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到随机生成的密钥对；当使用[KEY\_PAIR\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到各项数据与密钥参数一致的密钥对。
...
使用[PRIVATE\_KEY\_SPEC](#asykeyspectype10)类型密钥参数创建密钥生成器，生成指定私钥。使用[KEY\_PAIR\_SPEC](#asykeyspectype10)类型密钥参数创建密钥生成器，从生成的密钥对中获取指定私钥。
...
当使用[PRIVATE\_KEY\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到指定的私钥；当使用[KEY\_PAIR\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以从生成的密钥对中获取指定的私钥。
...
当使用[PUBLIC\_KEY\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到指定的公钥；当使用[KEY\_PAIR\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以从生成的密钥对中获取指定的公钥。
...
当使用[PUBLIC\_KEY\_SPEC](#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到指定的公钥；使用[KEY\_PAIR\_SPEC](#asykeyspectype10)类型的密钥参数时，可以从生成的密钥对中获取指定的公钥。
...
根据椭圆曲线相应的NID（Name Identifier）字符串名称生成相应的非对称公共密钥参数。详见[ECC密钥生成规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec#ecc)和[SM2密钥生成规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec#sm2)。
...
![](../../../../images/d6283e49/note_3.0-zh-cn.png) 
...
根据素数P的长度和私钥长度（bit位数）生成DH公共密钥参数。详见[DH密钥生成规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-asym-key-generation-conversion-spec#dh)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transformation | string | 是 | 待生成Cipher的算法名称（含密钥长度）、加密模式以及填充方法的组合。  支持的规格详见[对称密钥加解密算法规格](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-spec/crypto-sym-encrypt-decrypt-spec)和[非对称密钥加解密算法规格](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-spec/crypto-asym-encrypt-decrypt-spec)。 |

![](../../../../images/6bfc15ad/note_3.0-zh-cn.png) 
...
完整的加解密流程示例可参考[开发指南](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encryption-decryption-overview)。
...
![](../../../../images/8acdac32/note_3.0-zh-cn.png) 
...
2. 根据数据量，可以不调用update（即init完成后直接调用doFinal）或多次调用update。
   ...
   AES使用多次update操作的示例代码详见[使用AES对称密钥分段加解密](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-dev/crypto-aes-sym-encrypt-decrypt-gcm-by-segment)。
...
![](../../../../images/60b8de28/note_3.0-zh-cn.png) 
...
![](../../../../images/b8d74ca9/note_3.0-zh-cn.png) 

1. 对称加解密中，调用doFinal标志着一次加解密流程已经完成，即[Cipher](#cipher)实例的状态被清除，因此当后续开启新一轮加解密流程时，需要重新调用init()并传入完整的参数列表进行初始化
...
4. 非对称加解密时多次doFinal操作的示例代码详见[使用RSA非对称密钥分段加解密](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-dev/crypto-rsa-asym-encrypt-decrypt-by-segment)，SM2和RSA的操作类似。
...
更多加解密流程的完整示例请参考[加解密开发指导](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-dev/crypto-aes-sym-encrypt-decrypt-gcm)。
...
![](../../../../images/a1d79cdd/note_3.0-zh-cn.png) 
...
此外，更多加解密流程的完整示例可参考[加解密开发指导](/system-security/crypto-architecture-kit/crypto-encryption-decryption/crypto-encrypt-decrypt-dev/crypto-aes-sym-encrypt-decrypt-gcm)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定签名算法：RSA、ECC、DSA、SM210+或Ed2551911+。使用RSA PKCS1模式时需设置摘要；使用RSA PSS模式时需设置摘要和掩码摘要。签名时，通过设置OnlySign参数可传入数据摘要仅作签名。  支持的规格详见[签名验签规格](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-overview)。 |
...
Sign类，使用Sign方法之前需要创建该类的实例进行操作，通过[createSign(algName: string): Sign](#cryptoframeworkcreatesign)方法构造此实例。按序调用本类中的init、update、sign方法完成签名操作。签名操作的示例代码详见[签名验签开发指导](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1)。
...
![](../../../../images/25ebac8b/note_3.0-zh-cn.png) 
...
签名使用多次update操作的示例代码详见[使用RSA密钥对分段签名验签](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1-by-segment)，其余算法操作类似。
...
![](../../../../images/37cff51e/note_3.0-zh-cn.png) 
...
![](../../../../images/41619f94/note_3.0-zh-cn.png) 

根据数据量，可以不调用updateSync（即[initSync](#initsync12-1)完成后直接调用[signSync](#signsync12)）或多次调用updateSync。

算法库目前没有对updateSync（单次或累计）的数据量设置大小限制，建议对于大数据量的签名操作，采用多次updateSync的方式传入数据，避免一次性申请过大内存。

签名使用多次updateSync操作的示例代码详见[使用RSA密钥对分段签名验签](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1-by-segment)，其余算法操作类似。
...
此外，更多签名验签的完整示例可参考[签名验签开发指导](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定签名算法：RSA、ECC、DSA、SM210+或Ed2551911+。使用RSA PKCS1模式时需设置摘要；使用RSA PSS模式时需设置摘要和掩码摘要。使用RSA算法验签时，设置Recover参数可支持验签恢复。  支持的规格详见[签名验签规格](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-overview)。 |
...
Verify类，使用Verify方法之前需要创建该类的实例进行操作，通过[createVerify(algName: string): Verify](#cryptoframeworkcreateverify)方法构造此实例。按序调用本类中的init、update、verify方法完成签名操作。验签操作的示例代码详见[签名验签开发指导](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1)。
...
![](../../../../images/6895e049/note_3.0-zh-cn.png) 
...
验签使用多次update操作的示例代码详见[使用RSA密钥对分段签名验签](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1-by-segment)，其余算法操作类似。
...
![](../../../../images/26c20d8f/note_3.0-zh-cn.png) 
...
![](../../../../images/4ce962e0/note_3.0-zh-cn.png) 

根据数据量，可以不调用updateSync（即[initSync](#initsync12-2)完成后直接调用[verifySync](#verifysync12)）或多次调用updateSync。

算法库目前没有对updateSync（单次或累计）的数据量设置大小限制，建议对于大数据量的验签操作，采用多次updateSync的方式传入数据，避免一次性申请过大内存。

验签使用多次updateSync操作的示例代码详见[使用RSA密钥对分段签名验签](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1-by-segment)，其余算法操作类似。
...
更多示例请参见[签名验签开发指导](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-rsa-sign-sig-verify-pkcs1)。
...
![](../../../../images/025c62b2/note_3.0-zh-cn.png) 
...
![](../../../../images/854e00f2/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定密钥协商算法：目前仅支持ECC，从API version 11开始，增加支持X25519和DH。  支持的规格详见[密钥协商规格](/system-security/crypto-architecture-kit/crypto-key-agreement/crypto-key-agreement-overview)。 |
...
支持的规格详见[MD消息摘要算法规格](/system-security/crypto-architecture-kit/crypto-generate-message/crypto-generate-message-digest-overview#支持的算法与规格)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定摘要算法，支持算法请参考[MD消息摘要算法规格](/system-security/crypto-architecture-kit/crypto-generate-message/crypto-generate-message-digest-overview#支持的算法与规格)。 |
...
![](../../../../images/a3c0650f/note_3.0-zh-cn.png) 

Md算法多次调用update更新的代码示例详见开发指导[分段摘要算法](/system-security/crypto-architecture-kit/crypto-generate-message/crypto-generate-message-digest-dev/crypto-generate-message-digest#分段摘要算法)。
...
![](../../../../images/dcdd3119/note_3.0-zh-cn.png) 
...
![](../../../../images/dabe5c8c/note_3.0-zh-cn.png) 

Md算法多次调用updateSync更新的代码示例详见开发指导[分段摘要算法](/system-security/crypto-architecture-kit/crypto-generate-message/crypto-generate-message-digest-dev/crypto-generate-message-digest#分段摘要算法)。
...
支持的规格详见[HMAC消息认证码算法规格](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-mac-overview)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定摘要算法，支持算法请参考[HMAC消息认证码算法规格](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-mac-overview)。 |
...
支持的规格详见[MAC消息认证码算法规格](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-mac-overview)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| macSpec | [MacSpec](#macspec18) | 是 | 根据消息验证码的不同算法，指定入参结构体，支持算法请参考[MAC消息认证码算法规格](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-mac-overview)。 |
...
![](../../../../images/8d60f0b4/note_3.0-zh-cn.png) 

建议通过[HMAC密钥生成规格](/system-security/crypto-architecture-kit/crypto-key-generation-conversion/crypto-key-generation-conversion-spec/crypto-sym-key-generation-conversion-spec#hmac)创建对称密钥生成器，调用[generateSymKey](#generatesymkey)随机生成对称密钥或调用[convertKey](#convertkey)传入与密钥规格长度一致的二进制密钥数据生成密钥。
...
![](../../../../images/3984cdb5/note_3.0-zh-cn.png) 

HMAC算法多次调用update更新的代码示例详见[消息认证码计算](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-hmac#分段hmac)。
...
![](../../../../images/83de76b3/note_3.0-zh-cn.png) 
...
![](../../../../images/61501204/note_3.0-zh-cn.png) 

HMAC算法多次调用updateSync更新的代码示例详见[消息认证码计算](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-hmac#分段hmac)。
...
此外，更多HMAC的完整示例可参考开发指导中[消息认证码计算](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-hmac#分段hmac)。
...
此外，更多HMAC的完整示例可参考开发指导[消息认证码计算](/system-security/crypto-architecture-kit/crypto-compute-mac/crypto-compute-hmac#分段hmac)。
...
| 类型 | 说明 |
| --- | --- |
| [Random](#random) | 返回由输入算法指定生成的[Random](#random)对象。  支持的规格详见框架概述[随机数算法规格](/system-security/crypto-architecture-kit/crypto-compute-rand/crypto-generate-random-number#支持的算法与规格)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定密钥派生算法（包含HMAC配套的散列函数）：目前支持PBKDF2、HKDF算法、SCRYPT算法，如"PBKDF2|SHA256", "HKDF|SHA256", "SCRYPT"。  支持的规格详见[密钥派生函数规格](/system-security/crypto-architecture-kit/crypto-key-derivation/crypto-key-derivation-overview)。 |
