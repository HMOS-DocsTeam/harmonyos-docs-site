...
![](../../../../../images/b982d467/note_3.0-zh-cn.png) 
...
1. 开通可信应用服务，请参考“[开通Device Security服务](/system-security/device-security-kit-guide/devicesecurity-prepare/devicesecurity-deviceverify-activateservice)”。
2. 申请位置权限，请参考开发指南中安全地理位置[开发步骤](/system-security/device-security-kit-guide/devicesecurity-taas-dev/devicesecurity-taas-securelocation#开发步骤)。
...
创建证明密钥成功后再进行初始化证明会话，请参考“[开通Device Security服务](/system-security/device-security-kit-guide/devicesecurity-prepare/devicesecurity-deviceverify-activateservice)”。
