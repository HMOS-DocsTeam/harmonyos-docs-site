...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-antifraudpicker-api
kit: 系统
last_updated: "2026-04-22"
slug: devicesecurity-antifraudpicker-api
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 应用上下文。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AntifraudMessageResult](#antifraudmessageresult)&gt; | Promise对象，返回诈骗消息结果。 |

****错误码：****

以下错误码的详细介绍请参见[ArkTS API错误码](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-arktsapi-errcode/devicesecurity-arktsapi-errcode-antifraudpicker/devicesecurity-arktsapi-errcode-antifraudpicker) ****。****
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AntifraudCallLogResult](#antifraudcalllogresult)&gt; | Promise对象，返回诈骗通话记录结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AntifraudAppResult](#antifraudappresult)&gt; | Promise对象，返回诈骗应用结果。 |
