...
| [OH\_CM\_Blob](/ref/system-security-api/device-certificate-api/device-certificate-c/device-certificate-struct/capi-certmanagertype-oh-cm-blob/capi-certmanagertype-oh-cm-blob) credData | 表示凭据二进制数据，最大长度为20480字节。 |
| [OH\_CM\_CertificatePurpose](/ref/system-security-api/device-certificate-api/device-certificate-c/device-certificate-headerfile/capi-cm-native-type-h/capi-cm-native-type-h#oh_cm_certificatepurpose) certPurpose | 表示证书凭据的用途。 |
