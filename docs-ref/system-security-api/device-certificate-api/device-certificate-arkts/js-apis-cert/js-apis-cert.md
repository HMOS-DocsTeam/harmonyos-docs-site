...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert
kit: 系统
...
证书算法库框架提供证书相关接口。其中，依赖加解密算法库框架的基础算法能力的部分，详细接口说明可参考[cryptoFramework API参考](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework)。

![](../../../../images/f62350eb/note_3.0-zh-cn.png) 
...
![](../../../../images/a881a683/note_3.0-zh-cn.png) 
...
| subjectAlternativeNames12+ | Array&lt;[GeneralName](#generalname12)&gt; | 否 | 是 | 指定证书主体名称。 |
...
| trustAnchors | Array&lt;[X509TrustAnchor](#x509trustanchor11)&gt; | 否 | 否 | 表示信任锚列表。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
| trustSystemCa20+ | boolean | 否 | 是 | 表示是否使用系统预置CA证书校验证书链。true表示使用；false表示不使用。  ****元服务API：**** 从API version 20开始，该接口支持在元服务中使用。 |
| allowDownloadIntermediateCa23+ | boolean | 否 | 是 | 表示是否允许尝试从网络下载缺失的中间CA证书。  true表示允许；false表示不允许。默认值为false。  下载地址将从证书AIA扩展中获取，仅支持http，如需使用网络下载，需申请ohos.permission.INTERNET权限。配置方式请参见[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。  ****元服务API：**** 从API version 23开始，该接口支持在元服务中使用。 |
| certCRLs | Array&lt;[CertCRLCollection](#certcrlcollection11)&gt; | 否 | 是 | 表示需要校验证书是否在证书吊销列表中。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| keyUsage12+ | Array&lt;[KeyUsageType](#keyusagetype12)&gt; | 否 | 是 | 表示需要校验证书中的密钥用途。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| encryptionAlgorithm | [PbesEncryptionAlgorithm](#pbesencryptionalgorithm21) | 否 | 是 | 表示PBES加密算法类型。默认为AES\_256\_CBC。 |
...
| rsaSignaturePadding22+ | [CmsRsaSignaturePadding](#cmsrsasignaturepadding22) | 否 | 是 | RSA 签名填充方式。默认值为：PKCS1\_PADDING。  当设置为 PKCS1\_PSS\_PADDING 时，mdName 必须为 "SHA256"、"SHA384" 或 "SHA512"。  ****说明****：仅当签名者私钥类型为RSA时有效。  ****元服务API：**** 从API version 22开始，该接口支持在元服务中使用。 |
...
![](../../../../images/bd0ebf0e/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| trustCerts | Array&lt;[X509Cert](#x509cert)&gt; | 否 | 否 | 信任证书。  ****说明****：需要配置所有签名者的信任证书。 |
...
以下错误码的详细介绍请参见[证书错误码](/ref/system-security-api/device-certificate-api/device-certificate-arkts-errcode/errorcode-cert/errorcode-cert)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [cryptoFramework.PubKey](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#pubkey) | 是 | 用于验签的公钥对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [cryptoFramework.PubKey](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#pubkey) | X509证书公钥对象：仅用于X509Cert的verify接口。 |
...
![](../../../../images/09a5d7cf/note_3.0-zh-cn.png) 
...
![](../../../../images/ee217ba6/note_3.0-zh-cn.png) 
...
![](../../../../images/d59f3c97/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| encodingType | [EncodingType](#encodingtype12) | 否 | 编码类型。设置参数表示获取UTF8格式编码；不设置默认获取ASCII格式编码。  API 12后支持设置此参数。 |
...
![](../../../../images/1cb85a90/note_3.0-zh-cn.png) 
...
![](../../../../images/24f9f1c0/note_3.0-zh-cn.png) 
...
![](../../../../images/4b73de74/note_3.0-zh-cn.png) 
...
![](../../../../images/352ee42b/note_3.0-zh-cn.png) 
...
![](../../../../images/3ff13cf1/note_3.0-zh-cn.png) 
...
![](../../../../images/071a4cb1/note_3.0-zh-cn.png) 
...
![](../../../../images/ba70f0d6/note_3.0-zh-cn.png) 
...
![](../../../../images/b8faa937/note_3.0-zh-cn.png) 
...
![](../../../../images/3f5a22a8/note_3.0-zh-cn.png) 
...
![](../../../../images/80cd7013/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [cryptoFramework.PubKey](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#pubkey) | 是 | 表示用于验签的公钥对象。 |
...
![](../../../../images/53ae022c/note_3.0-zh-cn.png) 
...
![](../../../../images/287d5675/note_3.0-zh-cn.png) 
...
![](../../../../images/c9c8683e/note_3.0-zh-cn.png) 
...
![](../../../../images/7508e935/note_3.0-zh-cn.png) 
...
![](../../../../images/15392348/note_3.0-zh-cn.png) 
...
![](../../../../images/d6a5f87a/note_3.0-zh-cn.png) 
...
![](../../../../images/d7e8fb6d/note_3.0-zh-cn.png) 
...
![](../../../../images/79f11bba/note_3.0-zh-cn.png) 
...
![](../../../../images/3965a6aa/note_3.0-zh-cn.png) 
...
![](../../../../images/211c32cd/note_3.0-zh-cn.png) 
...
![](../../../../images/7f1366e1/note_3.0-zh-cn.png) 
...
![](../../../../images/f0dbe704/note_3.0-zh-cn.png) 
...
![](../../../../images/ac686eb8/note_3.0-zh-cn.png) 
...
![](../../../../images/89e50c21/note_3.0-zh-cn.png) 
...
![](../../../../images/f1928d81/note_3.0-zh-cn.png) 
...
由于端侧系统时间不可信，证书链校验不包含对证书有效时间的校验。如果需要检查证书的时间有效性，可使用X509证书的[checkValidityWithDate](#checkvaliditywithdate)方法进行检查。详见[证书规格](/system-security/device-certificate-kit/certificate-framework/certificate-framework-overview#证书规格)。
...
![](../../../../images/7a54b44c/note_3.0-zh-cn.png) 
...
![](../../../../images/38a056dd/note_3.0-zh-cn.png) 
...
![](../../../../images/d16c45a6/note_3.0-zh-cn.png) 
...
![](../../../../images/718d96f7/note_3.0-zh-cn.png) 
...
![](../../../../images/dd63abc9/note_3.0-zh-cn.png) 
...
![](../../../../images/2b4a4d16/note_3.0-zh-cn.png) 
...
![](../../../../images/d7364c3d/note_3.0-zh-cn.png) 
...
![](../../../../images/a725f288/note_3.0-zh-cn.png) 
...
![](../../../../images/2ee620dc/note_3.0-zh-cn.png) 
...
![](../../../../images/0171f36e/note_3.0-zh-cn.png) 
...
![](../../../../images/86a702a5/note_3.0-zh-cn.png) 
