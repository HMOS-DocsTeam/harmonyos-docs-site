...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) | OH\_PictureNative | Picture结构体类型，用于执行picture相关操作。 |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) | OH\_AuxiliaryPictureNative | AuxiliaryPicture结构体类型，用于执行AuxiliaryPicture相关操作。 |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) | OH\_AuxiliaryPictureInfo | AuxiliaryPictureInfo结构体类型，用于执行AuxiliaryPictureInfo相关操作。 |
| [OH\_ComposeOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-composeoptions/capi-image-nativemodule-oh-composeoptions) | OH\_ComposeOptions | OH\_ComposeOptions是native层封装的合成HDR选项参数结构体，用于设置合成选项参数。用于指定合成HDR所用的参数，例如目标像素格式。 |
...
| [Image\_ErrorCode OH\_AuxiliaryPictureNative\_Create(uint8\_t \*data, size\_t dataLength, Image\_Size \*size, Image\_AuxiliaryPictureType type, OH\_AuxiliaryPictureNative \*\*auxiliaryPicture)](#oh_auxiliarypicturenative_create) | 创建OH\_AuxiliaryPictureNative指针。该接口仅支持传入[像素格式](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format)为BGRA\_8888的连续像素数据，会创建出RGBA\_8888的辅助图。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ComposeOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-composeoptions/capi-image-nativemodule-oh-composeoptions) \*\*options | 被操作的OH\_ComposeOptions指针。 |
...
| --- | --- |
| [OH\_ComposeOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-composeoptions/capi-image-nativemodule-oh-composeoptions) \*options | 被操作的OH\_ComposeOptions指针。 |
| [PIXEL\_FORMAT](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format) desiredPixelFormat | 被设置的像素格式，支持RGBA\_1010102、YCBCR\_P010和YCRCB\_P010格式。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误，例如options为nullptr或传入了不支持的desiredPixelFormat。 |
...
| --- | --- |
| [OH\_ComposeOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-composeoptions/capi-image-nativemodule-oh-composeoptions) \*options | 被操作的OH\_ComposeOptions指针。 |
| [PIXEL\_FORMAT](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format) \*desiredPixelFormat | 合成选项中的像素格式。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*mainPixelmap | 主图的OH\_PixelmapNative指针。 |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*\*picture | 被创建的OH\_PictureNative指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*mainPixelmap | 获取的OH\_PixelmapNative指针。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*hdrPixelmap | 获取的hdr图OH\_PixelmapNative指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_UNSUPPORTED\_OPERATION：操作不支持，例如picture对象中不包含增益图。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [OH\_ComposeOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-composeoptions/capi-image-nativemodule-oh-composeoptions) \*options | 合成选项OH\_ComposeOptions指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*hdrPixelmap | 获取的HDR图OH\_PixelmapNative指针。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*gainmapPixelmap | 获取的增益图OH\_PixelmapNative指针。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [Image\_AuxiliaryPictureType](/ref/image-api/image-c/image-headerfile/capi-picture-native-h/capi-picture-native-h#image_auxiliarypicturetype) type | 辅助图的类型。 |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 设置的OH\_AuxiliaryPictureNative指针。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [Image\_AuxiliaryPictureType](/ref/image-api/image-c/image-headerfile/capi-picture-native-h/capi-picture-native-h#image_auxiliarypicturetype) type | 辅助图类型。 |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*\*auxiliaryPicture | 获取的OH\_AuxiliaryPictureNative指针。 |
...
| --- | --- |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [Image\_MetadataType](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_metadatatype) metadataType | 元数据类型。 |
| [OH\_PictureMetadata](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturemetadata/capi-image-nativemodule-oh-picturemetadata) \*\*metadata | 主图的元数据。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_UNSUPPORTED\_METADATA：不支持的元数据类型。 |
...
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 被操作的OH\_PictureNative指针。 |
| [Image\_MetadataType](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_metadatatype) metadataType | 元数据类型。 |
| [OH\_PictureMetadata](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturemetadata/capi-image-nativemodule-oh-picturemetadata) \*metadata | 将设置的元数据。 |
...
创建OH\_AuxiliaryPictureNative指针。该接口仅支持传入[像素格式](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format)为BGRA\_8888的连续像素数据，会创建出RGBA\_8888的辅助图。
...
| [Image\_Size](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-size/capi-image-nativemodule-image-size) \*size | 辅助图尺寸。 |
| [Image\_AuxiliaryPictureType](/ref/image-api/image-c/image-headerfile/capi-picture-native-h/capi-picture-native-h#image_auxiliarypicturetype) type | 辅助图类型。 |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*\*auxiliaryPicture | 被创建的OH\_AuxiliaryPictureNative指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 被操作的OH\_AuxiliaryPictureNative指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_ALLOC\_FAILED：内存分配失败。  IMAGE\_COPY\_FAILED：内存拷贝失败。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 被操作的OH\_AuxiliaryPictureNative指针。 |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*\*info | 辅助图信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 将操作的OH\_AuxiliaryPictureNative指针。 |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将要设置的辅助图信息。 |
...
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 将操作的OH\_AuxiliaryPictureNative指针。 |
| [Image\_MetadataType](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_metadatatype) metadataType | 元数据类型。 |
| [OH\_PictureMetadata](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturemetadata/capi-image-nativemodule-oh-picturemetadata) \*\*metadata | 获取的元数据。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_UNSUPPORTED\_METADATA：不支持的元数据类型，或者元数据类型与辅助图片类型不匹配。 |
...
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*auxiliaryPicture | 将操作的OH\_AuxiliaryPictureNative指针。 |
| [Image\_MetadataType](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_metadatatype) metadataType | 元数据类型。 |
| [OH\_PictureMetadata](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturemetadata/capi-image-nativemodule-oh-picturemetadata) \*metadata | 将要设置的元数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AuxiliaryPictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypicturenative/capi-image-nativemodule-oh-auxiliarypicturenative) \*picture | 将操作的OH\_AuxiliaryPictureNative指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*\*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [Image\_AuxiliaryPictureType](/ref/image-api/image-c/image-headerfile/capi-picture-native-h/capi-picture-native-h#image_auxiliarypicturetype) \*type | 获取的辅助图类型。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [Image\_AuxiliaryPictureType](/ref/image-api/image-c/image-headerfile/capi-picture-native-h/capi-picture-native-h#image_auxiliarypicturetype) type | 将要设置的辅助图类型。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [Image\_Size](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-size/capi-image-nativemodule-image-size) \*size | 获取的图片尺寸。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [Image\_Size](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-size/capi-image-nativemodule-image-size) \*size | 将要设置的图片尺寸。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [PIXEL\_FORMAT](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format) \*pixelFormat | 获取的像素格式。 |
...
| --- | --- |
| [OH\_AuxiliaryPictureInfo](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-auxiliarypictureinfo/capi-image-nativemodule-oh-auxiliarypictureinfo) \*info | 将操作的OH\_AuxiliaryPictureInfo指针。 |
| [PIXEL\_FORMAT](/ref/image-api/image-c/image-headerfile/capi-pixelmap-native-h/capi-pixelmap-native-h#pixel_format) pixelFormat | 将要设置的像素格式。 |
