...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) | OH\_ImagePackerNative | ImagePacker结构体类型，用于执行ImagePacker相关操作。 |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) | OH\_PackingOptions | OH\_PackingOptions是native层封装的图像编码选项结构体，不可直接操作，而是采用函数调用方式创建、释放结构体以及操作具体字段。 |
| [OH\_PackingOptionsForSequence](/ref/image-api/image-c/image-struct/pi-image-nativemodule-oh-packingoptionsforsequence/pi-image-nativemodule-oh-packingoptionsforsequence) | OH\_PackingOptionsForSequence | OH\_PackingOptionsForSequence是native层封装的图像序列编码选项结构体，不可直接操作，而是采用函数调用方式创建、释放结构体以及操作具体字段。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*\*options | 用于操作的PackingOptions指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 被操作的OH\_PackingOptions指针。 |
| [Image\_MimeType](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-string/capi-image-nativemodule-image-string) \*format | 图像格式。可传入一个空指针和零大小，系统将分配内存，但必须在使用后释放内存。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 编码参数指针。 |
| [Image\_MimeType](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-string/capi-image-nativemodule-image-string) \*format | 编码参数中的 MIME 类型的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_PACKER\_INVALID\_PARAMETER：options或format为空。 |
...
| --- | --- |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 被操作的OH\_PackingOptions指针。 |
| [Image\_MimeType](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-string/capi-image-nativemodule-image-string) \*format | 图像格式。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PackingOptionsForSequence](/ref/image-api/image-c/image-struct/pi-image-nativemodule-oh-packingoptionsforsequence/pi-image-nativemodule-oh-packingoptionsforsequence) \*\*options | 用于操作的OH\_PackingOptionsForSequence指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) \*\*imagePacker | 被操作的OH\_ImagePackerNative指针。 |
...
| --- | --- |
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) \*imagePacker | 被操作的OH\_ImagePackerNative指针。 |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 编码选项参数。 |
| [OH\_ImageSourceNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagesourcenative/capi-image-nativemodule-oh-imagesourcenative) \*imageSource | 用于编码的image source指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_DECODE\_FAILED：解码失败。  IMAGE\_ALLOC\_FAILED：申请内存失败。  IMAGE\_TOO\_LARGE：数据或图片过大。  IMAGE\_UNKNOWN\_ERROR：未知错误。 |
...
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) \*imagePacker | 被操作的OH\_ImagePackerNative指针。 |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 编码选项参数。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*pixelmap | 用于编码的Pixelmap指针。 |
| uint8\_t \*outData | 用于存储打包图像输出数据的缓冲区。 |
| size\_t \*size | 用于存储打包图像输出数据的缓冲区大小。 |
...
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) \*imagePacker | 被操作的OH\_ImagePackerNative指针。 |
| [OH\_PackingOptions](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-packingoptions/capi-image-nativemodule-oh-packingoptions) \*options | 编码选项参数。 |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 用于编码的Picture指针。 |
| uint8\_t \*outData | 用于存储打包图像输出数据的缓冲区。 |
| size\_t \*size | 用于存储打包图像输出数据的缓冲区大小。 |
...
| --- | --- |
| [OH\_ImagePackerNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-imagepackernative/capi-image-nativemodule-oh-imagepackernative) \*imagePacker | 被操作的OH\_ImagePackerNative指针。 |
| [OH\_PackingOptionsForSequence](/ref/image-api/image-c/image-struct/pi-image-nativemodule-oh-packingoptionsforsequence/pi-image-nativemodule-oh-packingoptionsforsequence) \*options | 编码选项参数 [OH\_PackingOptionsForSequence](/ref/image-api/image-c/image-struct/pi-image-nativemodule-oh-packingoptionsforsequence/pi-image-nativemodule-oh-packingoptionsforsequence)。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*\*pixelmapSequence | 用于编码的Pixelmap序列指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：执行成功。  IMAGE\_BAD\_PARAMETER：参数错误。  IMAGE\_DECODE\_FAILED：解码失败。  IMAGE\_UNKNOWN\_ERROR：未知错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Image\_MimeType](/ref/image-api/image-c/image-struct/capi-image-nativemodule-image-string/capi-image-nativemodule-image-string) \*\*supportedFormats | 支持编码的图片格式。 |
| size\_t \*length | 数组长度。 |
...
| 类型 | 说明 |
| --- | --- |
| [Image\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#image_errorcode) | IMAGE\_SUCCESS：操作成功。  IMAGE\_PACKER\_INVALID\_PARAMETER：参数异常，supportedFormats或length为空。 |
