...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) | OH\_ImageEffect | 定义效果器结构类型。 |

### 函数

| 名称 | 描述 |
| --- | --- |
| [OH\_ImageEffect \*OH\_ImageEffect\_Create(const char \*name)](#oh_imageeffect_create) | 创建OH\_ImageEffect实例，调用[OH\_ImageEffect\_Release](/ref/image-api/image-c/image-headerfile/capi-image-effect-h/capi-image-effect-h#oh_imageeffect_release)进行资源释放。 |
...
创建OH\_ImageEffect实例，调用[OH\_ImageEffect\_Release](/ref/image-api/image-c/image-headerfile/capi-image-effect-h/capi-image-effect-h#oh_imageeffect_release)进行资源释放。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \* | 返回一个指向OH\_ImageEffect实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \* | 返回一个指向OH\_EffectFilter实例的指针，滤镜名无效时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \* | 返回一个指向OH\_EffectFilter实例的指针，参数无效时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \* | 返回一个指向OH\_EffectFilter实例的指针，替换失败时返回空指针。 |
...
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| const char \*key | 配置参数。 |
| [const ImageEffect\_Any](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-any/capi-imageeffect-imageeffect-any) \*value | 配置参数值。 |
...
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*pixelmap | 指向OH\_PixelmapNative实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_PARAM\_ERROR：如果参数异常导致方法调用失败。 |
...
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| [OH\_NativeBuffer](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-oh-nativebuffer-oh-nativebuffer/capi-oh-nativebuffer-oh-nativebuffer) \*nativeBuffer | 指向OH\_NativeBuffer实例的指针。 |
...
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| [OH\_NativeBuffer](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-oh-nativebuffer-oh-nativebuffer/capi-oh-nativebuffer-oh-nativebuffer) \*nativeBuffer | 指向OH\_NativeBuffer实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH\_NativeBuffer对象上。 |
...
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 指向OH\_PictureNative实例的指针。 |
...
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | 效果器指针。 |
| [OH\_PictureNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-picturenative/capi-image-nativemodule-oh-picturenative) \*picture | 指向OH\_PictureNative实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH\_PictureNative对象上。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \*imageEffect | OH\_ImageEffect结构体实例指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针或参数超出有效范围。  EFFECT\_PARAM\_ERROR：参数缺失或参数错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_INPUT\_OUTPUT\_NOT\_SUPPORTED：待处理输入、输出图像数据类型不一致。  EFFECT\_COLOR\_SPACE\_NOT\_MATCH：输入、输出图像色彩空间不匹配。  EFFECT\_ALLOCATE\_MEMORY\_FAILED：内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_ImageEffect](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-imageeffect/capi-imageeffect-oh-imageeffect) \* | 反序列化成功时返回OH\_ImageEffect实例，否则返回空指针。 |
