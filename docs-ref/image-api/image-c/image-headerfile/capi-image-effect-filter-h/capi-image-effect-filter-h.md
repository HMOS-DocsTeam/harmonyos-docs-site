...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ImageEffect\_DataValue](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-datavalue/capi-imageeffect-imageeffect-datavalue) | ImageEffect\_DataValue | 数据值联合体。 |
| [ImageEffect\_Any](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-any/capi-imageeffect-imageeffect-any) | ImageEffect\_Any | 参数结构体。 |
| [ImageEffect\_FilterNames](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-filternames/capi-imageeffect-imageeffect-filternames) | ImageEffect\_FilterNames | 滤镜名信息。 |
| [ImageEffect\_FilterDelegate](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-filterdelegate/capi-imageeffect-imageeffect-filterdelegate) | ImageEffect\_FilterDelegate | 自定义滤镜回调函数结构体。 |
| [ImageEffect\_Region](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-region/capi-imageeffect-imageeffect-region) | ImageEffect\_Region | 图像区域结构体。 |
| [ImageEffect\_Size](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-size/capi-imageeffect-imageeffect-size) | ImageEffect\_Size | 图像尺寸结构体。 |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) | OH\_EffectFilter | 定义滤镜结构类型。 |
| [OH\_EffectFilterInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilterinfo/capi-imageeffect-oh-effectfilterinfo) | OH\_EffectFilterInfo | 定义滤镜信息结构体。 |
| [OH\_EffectBufferInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectbufferinfo/capi-imageeffect-oh-effectbufferinfo) | OH\_EffectBufferInfo | 定义图像信息。 |
...
| 名称 | 描述 |
| --- | --- |
| OH\_EFFECT\_BRIGHTNESS\_FILTER "Brightness" | 亮度滤镜，对应的参数为OH\_EFFECT\_FILTER\_INTENSITY\_KEY，参数类型为[EFFECT\_DATA\_TYPE\_FLOAT](#imageeffect_datatype)。  ****起始版本：**** 12  ****系统能力：**** SystemCapability.Multimedia.ImageEffect.Core |
| OH\_EFFECT\_CONTRAST\_FILTER "Contrast" | 对比度滤镜，对应的参数为OH\_EFFECT\_FILTER\_INTENSITY\_KEY，参数类型为[EFFECT\_DATA\_TYPE\_FLOAT](#imageeffect_datatype)。  ****起始版本：**** 12  ****系统能力：**** SystemCapability.Multimedia.ImageEffect.Core |
| OH\_EFFECT\_CROP\_FILTER "Crop" | 裁剪滤镜，对应的参数为OH\_EFFECT\_FILTER\_REGION\_KEY，参数类型为[EFFECT\_DATA\_TYPE\_PTR](#imageeffect_datatype)，参数值为结构体 [ImageEffect\_Region](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-region/capi-imageeffect-imageeffect-region)。  ****起始版本：**** 12  ****系统能力：**** SystemCapability.Multimedia.ImageEffect.Core |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilterInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilterinfo/capi-imageeffect-oh-effectfilterinfo) \* | 返回一个指向OH\_EffectFilterInfo实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilterInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilterinfo/capi-imageeffect-oh-effectfilterinfo) \*info | 滤镜信息指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectBufferInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectbufferinfo/capi-imageeffect-oh-effectbufferinfo) \* | 返回一个指向OH\_EffectBufferInfo实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectBufferInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectbufferinfo/capi-imageeffect-oh-effectbufferinfo) \*info | 图像信息指针。 |
| void \*addr | 图像虚拟内存地址。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectBufferInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectbufferinfo/capi-imageeffect-oh-effectbufferinfo) \*info | OH\_EffectBufferInfo结构体实例指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：参数缺失。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \*filter | 滤镜指针。 |
| const char \*key | 滤镜参数。 |
| [const ImageEffect\_Any](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-any/capi-imageeffect-imageeffect-any) \*value | 滤镜参数值。 |
...
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \*filter | 滤镜指针。 |
| [OH\_EffectBufferInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectbufferinfo/capi-imageeffect-oh-effectbufferinfo) \*info | 图像信息OH\_EffectBufferInfo指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \* | 执行成功时返回OH\_EffectFilter实例，否则返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \* | 返回一个指向OH\_EffectFilter实例的指针，创建失败时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_KEY\_ERROR：参数无效。  EFFECT\_PARAM\_ERROR：参数值无效。 |
...
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \*filter | 滤镜指针。 |
| const char \*key | 滤镜参数，例如：OH\_EFFECT\_FILTER\_INTENSITY\_KEY。 |
| [ImageEffect\_Any](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-any/capi-imageeffect-imageeffect-any) \*value | 滤镜参数值。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_KEY\_ERROR：参数无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const OH\_EffectFilterInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilterinfo/capi-imageeffect-oh-effectfilterinfo) \*info | 滤镜信息指针OH\_EffectFilterInfo。 |
| [const ImageEffect\_FilterDelegate](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-filterdelegate/capi-imageeffect-imageeffect-filterdelegate) \*delegate | 自定义滤镜回调函数ImageEffect\_FilterDelegate。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_FilterNames](/ref/image-api/image-c/image-struct/capi-imageeffect-imageeffect-filternames/capi-imageeffect-imageeffect-filternames) \* | 滤镜名列表。 |
...
| --- | --- |
| const char \*name | 滤镜名。 |
| [OH\_EffectFilterInfo](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilterinfo/capi-imageeffect-oh-effectfilterinfo) \*info | 滤镜信息指针OH\_EffectFilterInfo。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](/ref/image-api/image-c/image-headerfile/capi-image-effect-errors-h/capi-image-effect-errors-h#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针或其他无效值。 |
...
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \*filter | 滤镜指针。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*inputPixelmap | 输入图像。 |
| [OH\_PixelmapNative](/ref/image-api/image-c/image-struct/capi-image-nativemodule-oh-pixelmapnative/capi-image-nativemodule-oh-pixelmapnative) \*outputPixelmap | 输出图像。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilter](/ref/image-api/image-c/image-struct/capi-imageeffect-oh-effectfilter/capi-imageeffect-oh-effectfilter) \*filter | OH\_EffectFilter结构体实例指针。 |
