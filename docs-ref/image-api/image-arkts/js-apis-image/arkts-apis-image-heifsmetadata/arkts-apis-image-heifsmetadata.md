...
![](../../../../images/7e902485/note_3.0-zh-cn.png) 
...
创建一个空的[HeifsMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-heifsmetadata/arkts-apis-image-heifsmetadata)实例。
...
| 类型 | 说明 |
| --- | --- |
| [HeifsMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-heifsmetadata/arkts-apis-image-heifsmetadata) | 返回HeifsMetadata的空实例。 |
...
要查询的属性的具体信息请参考[HeifsPropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#heifspropertykey23)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[HeifsMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-heifsmetadata/arkts-apis-image-heifsmetadata)&gt; | Promise对象，成功返回Heifs元数据实例。 |
