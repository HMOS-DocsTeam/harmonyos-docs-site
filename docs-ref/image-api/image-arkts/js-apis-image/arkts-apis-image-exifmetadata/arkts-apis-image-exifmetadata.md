...
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-exifmetadata
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-image-exifmetadata
---
...
![](../../../../images/986472ea/note_3.0-zh-cn.png) 
...
各属性详细取值，请参考[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7)。
...
| orientation | [Orientation](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#orientation23) | 否 | 是 | 图像方向。 |
...
创建一个空的[ExifMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-exifmetadata/arkts-apis-image-exifmetadata)实例。
...
| 类型 | 说明 |
| --- | --- |
| [ExifMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-exifmetadata/arkts-apis-image-exifmetadata) | 返回ExifMetadata的空实例。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ExifMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-exifmetadata/arkts-apis-image-exifmetadata)&gt; | Promise对象，成功返回Exif元数据实例。 |
