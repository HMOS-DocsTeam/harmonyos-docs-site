...
AuxiliaryPicture类，用于读取或写入图像的辅助图数据以及获取图像的辅助图信息。目前支持的辅助图类型可参考[AuxiliaryPictureType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#auxiliarypicturetype13)。

在调用AuxiliaryPicture的方法前，需要通过[image.createAuxiliaryPicture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreateauxiliarypicture13)或Picture的[getAuxiliaryPicture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-picture/arkts-apis-image-picture#getauxiliarypicture13)创建一个AuxiliaryPicture实例。

由于图片占用内存较大，所以当AuxiliaryPicture对象使用完成后，应主动调用[release](#release13)方法及时释放对象。释放时应确保该实例的所有异步方法均执行完成，且后续不再使用该对象。

![](../../../../images/de3c3d1a/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AuxiliaryPictureType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#auxiliarypicturetype13) | 操作成功，返回辅助图的类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataType | [MetadataType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#metadatatype13) | 是 | 元数据的类型，用于设置对应的元数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataType | [MetadataType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#metadatatype13) | 是 | 元数据类型，用于获取对应类型的元数据。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Metadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-metadata/arkts-apis-image-metadata)&gt; | Promise对象，返回元数据的Promise对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [AuxiliaryPictureInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#auxiliarypictureinfo13) | 返回辅助图图像信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [AuxiliaryPictureInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#auxiliarypictureinfo13) | 是 | 辅助图的图像信息。 |
