...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-imagepacker
kit: 媒体
...
在调用ImagePacker的方法前，需要先通过[image.createImagePacker](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreateimagepacker)构建一个ImagePacker实例。
...
![](../../../../images/afbfc41c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [ImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagesource/arkts-apis-image-imagesource) | 是 | 编码的ImageSource。 |
| options | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
![](../../../../images/684135ce/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 编码的PixelMap源。 |
| options | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| picture | [Picture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-picture/arkts-apis-image-picture) | 是 | 编码的Picture对象。 |
| options | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmapSequence | Array&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 是 | 待编码的PixelMap序列。 |
| options | [PackingOptionsForSequence](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoptionsforsequence18) | 是 | 动图编码参数。 |
...
![](../../../../images/c45fda65/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 编码的PixelMap资源。 |
| fd | number | 是 | 文件描述符。 |
| options | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
![](../../../../images/d4235ce1/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| picture | [Picture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-picture/arkts-apis-image-picture) | 是 | 编码的Picture资源。 |
| fd | number | 是 | 文件描述符。 |
| options | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
![](../../../../images/379a03d1/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| source | [ImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagesource/arkts-apis-image-imagesource) | 是 | 编码的ImageSource。 |
| option | [PackingOption](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#packingoption) | 是 | 设置编码参数。 |
...
![](../../../../images/65f29037/note_3.0-zh-cn.png) 
...
![](../../../../images/f92f95e1/note_3.0-zh-cn.png) 

从API version 8开始支持，从API version 13开始废弃，建议使用[packToData](#packtodata13)代替。

![](../../../../images/01610eb7/caution_3.0-zh-cn.png) 
...
![](../../../../images/cb908c9c/note_3.0-zh-cn.png) 

从API version 8开始支持，从API version 13开始废弃，建议使用[packToData](#packtodata13)代替。

![](../../../../images/483fda97/caution_3.0-zh-cn.png) 
