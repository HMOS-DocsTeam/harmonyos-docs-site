...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 同步返回PixelMap对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [HdrComposeOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#hdrcomposeoptions23) | 否 | 合成HDR的选项。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | undefined> | Promise对象，返回PixelMap或undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | null | 返回Pixelmap对象，如果没有则返回null。 |
...
| auxiliaryPicture | [AuxiliaryPicture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-auxiliarypicture/arkts-apis-image-auxiliarypicture) | 是 | 辅助图对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [AuxiliaryPicture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-auxiliarypicture/arkts-apis-image-auxiliarypicture) | null | 返回AuxiliaryPicture对象，如果没有则返回null。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataType | [MetadataType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#metadatatype13) | 是 | 元数据类型。 |
| metadata | [Metadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-metadata/arkts-apis-image-metadata) | 是 | 元数据对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Metadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-metadata/arkts-apis-image-metadata)&gt; | Promise对象。返回元数据。 |
