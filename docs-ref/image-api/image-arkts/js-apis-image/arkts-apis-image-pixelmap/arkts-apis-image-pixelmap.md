...
sidebar_position: 14
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap
kit: 媒体
...
图像像素类，用于读取或写入图像数据以及获取图像信息。在调用PixelMap的方法前，需要先通过[image.createPixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreatepixelmap8)创建一个PixelMap实例。目前PixelMap序列化大小最大128MB，超过会送显失败。大小计算方式为（宽\*高\*[每像素占用字节数](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#pixelmapformat7)）。

从API version 11开始，PixelMap支持通过[Worker](/ref/arkts-api/arkts-arkts/js-apis-worker/js-apis-worker)跨线程调用。当PixelMap通过[Worker](/ref/arkts-api/arkts-arkts/js-apis-worker/js-apis-worker)跨线程后，原线程的PixelMap的所有接口均不能调用，否则将报错501 服务器不具备完成请求的功能。

在调用PixelMap的方法前，可以通过[image.createPixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreatepixelmap8)传入像素数据创建一个PixelMap对象，也可以通过[ImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagesource/arkts-apis-image-imagesource)进行图片解码创建PixelMap对象。

开发元服务请通过[ImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-imagesource/arkts-apis-image-imagesource)构建PixelMap对象。

图片使用的内存往往较大，在PixelMap对象使用完成后，应主动调用[release](#release7)方法及时释放内存。释放时应确保该对象的所有异步方法均执行完成，且后续不再使用该对象。

![](../../../../images/cc47b48d/note_3.0-zh-cn.png) 
...
固定按照BGRA\_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| area | [PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7) | 是 | 区域大小，根据区域读取。 |
...
固定按照BGRA\_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定，使用callback形式返回。
...
固定按照BGRA\_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定，同步返回结果。
...
固定按照BGRA\_8888格式，读取[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| area | [PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7) | 是 | 区域，根据区域写入。 |
...
固定按照BGRA\_8888格式，读取[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定，使用callback形式返回。
...
固定按照BGRA\_8888格式，读取[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#positionarea7).region指定，同步返回结果。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo)&gt; | Promise对象，返回图像像素信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo)&gt; | 是 | 回调函数。当获取图像像素信息成功，err为undefined，data为获取到的图像像素信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo) | 图像像素信息。 |
...
![](../../../../images/bef103e7/note_3.0-zh-cn.png) 
...
![](../../../../images/7e1734ea/note_3.0-zh-cn.png) 
...
![](../../../../images/d5e04ac5/note_3.0-zh-cn.png) 
...
![](../../../../images/b6dd59e4/note_3.0-zh-cn.png) 
...
| x | number | 是 | 宽度的缩放倍数。 |
| y | number | 是 | 高度的缩放倍数。 |
| level | [AntiAliasingLevel](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#antialiasinglevel12) | 是 | 采用的缩放算法。 |
...
![](../../../../images/19df356a/note_3.0-zh-cn.png) 
...
| x | number | 是 | 宽度的缩放倍数。 |
| y | number | 是 | 高度的缩放倍数。 |
| level | [AntiAliasingLevel](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#antialiasinglevel12) | 否 | 采用的缩放算法，默认值为AntiAliasingLevel.NONE。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#region8) | 是 | 裁剪的区域。取值范围不能超过图片的宽和高（单位：像素）。 |
| x | number | 是 | 宽度的缩放倍数。不能为0。 |
| y | number | 是 | 高度的缩放倍数。不能为0。 |
| level | [AntiAliasingLevel](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#antialiasinglevel12) | 否 | 采用的缩放算法。默认值是AntiAliasingLevel.NONE。 |
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 成功则同步返回PixelMap对象，失败则抛出异常。 |
...
![](../../../../images/4686edbe/note_3.0-zh-cn.png) 
...
![](../../../../images/b83dadfd/note_3.0-zh-cn.png) 
...
![](../../../../images/db809ff7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#region8) | 是 | 裁剪的尺寸。取值范围不能超过图片的宽高。 |
...
| 类型 | 说明 |
| --- | --- |
| [colorSpaceManager.ColorSpaceManager](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-colorspacemanager/js-apis-colorspacemanager#colorspacemanager) | 图像广色域信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [colorSpaceManager.ColorSpaceManager](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-colorspacemanager/js-apis-colorspacemanager#colorspacemanager) | 是 | 图像广色域信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| targetColorSpace | [colorSpaceManager.ColorSpaceManager](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-colorspacemanager/js-apis-colorspacemanager#colorspacemanager) | 是 | 目标色彩空间，支持SRGB、DCI\_P3、DISPLAY\_P3、ADOBE\_RGB\_1998。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [HdrMetadataKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#hdrmetadatakey12) | 是 | HDR元数据的关键字，可用于查询对应值。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [HdrMetadataValue](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-t/arkts-apis-image-t#hdrmetadatavalue12) | 返回元数据的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [HdrMetadataKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#hdrmetadatakey12) | 是 | HDR元数据的关键字，用于设置对应值。 |
| value | [HdrMetadataValue](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-t/arkts-apis-image-t#hdrmetadatavalue12) | 是 | 元数据的值。 |
...
创建DMA\_ALLOC内存的PixelMap方法请参考: [系统默认的内存分配方式](/image-kit/image-arkts-dev/image-decoding-arts/image-allocator-type#系统默认的内存分配方式)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sequence | [rpc.MessageSequence](/ref/ipc-api/ipc-arkts/js-apis-rpc/js-apis-rpc#messagesequence9) | 是 | 新创建的MessageSequence。 |
...
从MessageSequence中获取PixelMap，如需使用同步方式创建PixelMap可使用：[createPixelMapFromParcel](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreatepixelmapfromparcel11)。
...
![](../../../../images/c877b8c3/caution_3.0-zh-cn.png) 
...
![](../../../../images/88a00d46/caution_3.0-zh-cn.png) 
...
![](../../../../images/64799796/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| targetPixelFormat | [PixelMapFormat](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#pixelmapformat7) | 是 | 目标像素格式，用于YUV和RGB类型互转，或者ASTC\_4x4类型转为RGBA\_8888类型。目前仅支持NV12/NV21与RGB888/RGBA8888/RGB565/BGRA8888/RGBAF16互转，YCRCB\_P010/YCBCR\_P010与RGBA1010102互转，ASTC\_4x4转为RGBA\_8888。 |
...
![](../../../../images/dc0527ca/caution_3.0-zh-cn.png) 
