...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-imagesource
kit: 媒体
...
在调用ImageSource的方法前，需要先通过[image.createImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreateimagesource)构建一个ImageSource实例。

ImageSource的所有方法均不支持并发调用。

由于图片占用内存较大，所以当ImageSource实例使用完成后，应主动调用[release](#release)方法及时释放内存。释放时应确保该实例的所有异步方法均执行完成，且后续不再使用该实例。

![](../../../../images/0dd26c13/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| supportedFormats | Array&lt;string&gt; | 是 | 否 | 支持的图片格式，包括：png、jpeg、bmp、gif、webp、dng、heic12+、wbmp23+、heifs23+、tiff23+。部分格式的解码能力依赖于具体的设备硬件，建议在调用前使用[image.getImageSourceSupportedFormats20+](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagegetimagesourcesupportedformats20)接口，动态查询当前设备上的解码能力。 |
...
| callback | AsyncCallback&lt;[ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo)&gt; | 是 | 回调函数。当获取图片信息成功，err为undefined，data为获取到的图片信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo)&gt; | Promise对象，返回获取到的图片信息。 |
...
![](../../../../images/fe40df33/note_3.0-zh-cn.png) 

该方法为同步方法，调用时会阻塞当前线程，不建议在主线程中调用，否则可能导致应用卡顿、掉帧或响应延迟。具体场景参考[耗时任务并发场景简介](/arkts/arkts-concurrency/multithread-develop-guide/time-consuming-task/time-consuming-task-overview)。
...
| 类型 | 说明 |
| --- | --- |
| [ImageInfo](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imageinfo) | 同步返回获取到的图片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7) | 是 | 图片属性名。 |
| options | [ImagePropertyOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imagepropertyoptions11) | 否 | 图片属性，包括图片序号与默认属性值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | Array&lt;[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7)&gt; | 是 | 图片属性名的数组。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;Record&lt;[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7), string | null>> | Promise对象，返回图片属性值，如获取失败则返回null。 |
...
![](../../../../images/0e18f6e6/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| string | 返回图片Exif中指定属性键的值（如获取失败则返回属性默认值），各个数据值作用请参考[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7)。 |
...
![](../../../../images/720dd935/note_3.0-zh-cn.png) 
...
![](../../../../images/5ff52f53/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| records | Record&lt;[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7), string | null> | 是 | 包含图片属性名和属性值的数组。 |
...
![](../../../../images/2ef5c687/note_3.0-zh-cn.png) 

- 调用该接口修改属性会改变属性字节长度，建议通过传入文件描述符来创建[image.createImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreateimagesource7)实例或通过传入的uri创建[image.createImageSource](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-f/arkts-apis-image-f#imagecreateimagesource)实例。
...
![](../../../../images/795cc7ff/note_3.0-zh-cn.png) 

读取DNG格式图片时，该接口对部分propertyKeys有特殊处理。以下字段的字符串取值请参考[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7)中的值：
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ImageMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imagemetadata23)&gt; | Promise对象，返回ImageMetadata对象，其中含有图片属性名对应的metadata对象，通过ImageMetadata中的metadata对象可以获取图片属性值。 |
...
![](../../../../images/f439b3ee/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageMetadata | [ImageMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#imagemetadata23) | 是 | 图像的元数据集。若imageMetadata中的属性值都为空，则清空所有Exif元数据。 |
...
由于图片占用内存较大，所以当Picture对象使用完成后，应主动调用[release](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-picture/arkts-apis-image-picture#release13)方法，及时释放内存。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DecodingOptionsForPicture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#decodingoptionsforpicture13) | 否 | 解码参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Picture](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-picture/arkts-apis-image-picture)&gt; | Promise对象，返回Picture。 |
...
从API version 15开始，推荐使用[createPixelMapUsingAllocator](#createpixelmapusingallocator15)，该接口可以指定输出pixelMap的内存类型[AllocatorType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#allocatortype15)，详情请参考[图片解码内存优化(ArkTS)](/image-kit/image-arkts-dev/image-decoding-arts/image-allocator-type)。

![](../../../../images/a739ecf2/note_3.0-zh-cn.png) 

- 该方法为非线程安全的方法，不支持在同一个ImageSource实例上并发调用。
- 由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#release7)方法，及时释放内存。
- 释放时应确保该对象的所有异步方法均执行完成，且后续不再使用该对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DecodingOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#decodingoptions7) | 否 | 解码参数。 |
...
![](../../../../images/17552fcb/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 是 | 回调函数，当创建PixelMap对象成功，err为undefined，data为获取到的PixelMap对象；否则为错误对象。 |
...
![](../../../../images/e29c3e9b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DecodingOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#decodingoptions7) | 是 | 解码参数。 |
| callback | AsyncCallback&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 是 | 回调函数，当创建PixelMap对象成功，err为undefined，data为获取到的PixelMap对象；否则为错误对象。 |
...
![](../../../../images/d3059251/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 用于同步返回创建结果。 |
...
![](../../../../images/d3e26aab/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt;&gt; | 异步返回PixelMap数组。 |
...
![](../../../../images/b1c42362/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt;&gt; | 是 | 回调函数，当创建PixelMap对象数组成功，err为undefined，data为获取到的PixelMap对象数组；否则为错误对象。 |
...
![](../../../../images/2b1fe93f/note_3.0-zh-cn.png) 
...
使用指定的分配器根据图像解码参数异步创建PixelMap对象。使用Promise异步回调。接口使用详情请参考[图片解码内存优化(ArkTS)](/image-kit/image-arkts-dev/image-decoding-arts/image-allocator-type)。

![](../../../../images/27b73247/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| options | [DecodingOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#decodingoptions7) | 否 | 解码参数。 |
| allocatorType | [AllocatorType](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#allocatortype15) | 否 | 用于图像解码的内存类型。默认值为AllocatorType.AUTO。 |
...
根据指定的分配器同步创建一个基于图像解码参数的PixelMap对象。接口使用详情请参考[图片解码内存优化(ArkTS)](/image-kit/image-arkts-dev/image-decoding-arts/image-allocator-type)。

由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#release7)方法，及时释放内存。

释放时应确保该对象的所有异步方法均执行完成，且后续不再使用该对象。

![](../../../../images/34bd26be/note_3.0-zh-cn.png) 
...
![](../../../../images/2f89b4f9/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| key | string | 是 | 图片属性名。 |
| options | [GetImagePropertyOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#getimagepropertyoptionsdeprecated) | 否 | 图片属性，包括图片序号与默认属性值。 |
...
![](../../../../images/bd4f15ac/note_3.0-zh-cn.png) 
...
![](../../../../images/46d7ed89/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| key | string | 是 | 图片属性名。 |
| options | [GetImagePropertyOptions](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-i/arkts-apis-image-i#getimagepropertyoptionsdeprecated) | 是 | 图片属性，包括图片序号与默认属性值。 |
| callback | AsyncCallback&lt;string&gt; | 是 | 回调函数，当获取图片属性值成功，err为undefined，data为获取到的图片属性值；否则为错误对象。 |
...
![](../../../../images/8e61f425/note_3.0-zh-cn.png) 
...
![](../../../../images/c1cf252c/note_3.0-zh-cn.png) 
