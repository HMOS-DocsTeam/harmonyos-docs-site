...
![](../../../../images/b57a5f9f/note_3.0-zh-cn.png) 
...
| xmageWatermarkMode | number | 否 | 是 | XMAGE水印模式。具体取值请参考[Constants](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-c/arkts-apis-image-c)。 |
...
| xmageColorMode | [XmageColorMode](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#xmagecolormode23) | 否 | 是 | XMAGE颜色模式。 |
...
| focusMode | [FocusMode](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#focusmode23) | 否 | 是 | 镜头对焦控制策略，决定相机如何调整焦距。 |

## createInstance

static createInstance(): MakerNoteHuaweiMetadata

返回[MakerNoteHuaweiMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-makernotehuaweimetadata/arkts-apis-image-makernotehuaweimetadata)的空实例。
...
| 类型 | 说明 |
| --- | --- |
| [MakerNoteHuaweiMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-makernotehuaweimetadata/arkts-apis-image-makernotehuaweimetadata) | 返回MakerNoteHuaweiMetadata的空实例。 |
...
要查询的属性的具体信息请参考[PropertyKey](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-e/arkts-apis-image-e#propertykey7)。
...
对[MakerNoteHuaweiMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-makernotehuaweimetadata/arkts-apis-image-makernotehuaweimetadata)元数据进行克隆。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MakerNoteHuaweiMetadata](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-makernotehuaweimetadata/arkts-apis-image-makernotehuaweimetadata)&gt; | Promise对象，当成功获取元数据时返回MakerNoteHuaweiMetadata元数据实例。 |
