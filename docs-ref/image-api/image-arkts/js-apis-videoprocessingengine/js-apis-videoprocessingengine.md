...
![](../../../images/0a530e16/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[视频处理引擎错误码](/ref/image-api/image-arkts-errcode/errorcode-videoprocessingengine/errorcode-videoprocessingengine)
...
以下错误码的详细介绍请参见[视频处理引擎错误码](/ref/image-api/image-arkts-errcode/errorcode-videoprocessingengine/errorcode-videoprocessingengine)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceImage | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 输入图像，内存类型需为DMA内存，具体情况请参考[PixelMap的内存类型介绍](/image-kit/image-arkts-dev/image-decoding-arts/image-allocator-type#内存类型介绍)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 异步方法返回PixelMap的Promise实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 成功同步返回PixelMap对象。 |
