...
通用事件仅支持[onAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#onappear)、[onDisAppear](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-events-show-hide/ts-universal-events-show-hide#ondisappear)、[onBlur](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-focus-event/ts-universal-focus-event#onblur)、[onFocus](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-focus-event/ts-universal-focus-event#onfocus)、[onDragEnd](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondragend10)、[onDragEnter](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondragenter)、[onDragStart](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondragstart)、[onDragMove](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondragmove)、[onDragLeave](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondragleave)、[onDrop](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-drag-drop/ts-universal-events-drag-drop#ondrop)、[onHover](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-hover/ts-universal-events-hover#onhover)、[onMouse](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-mouse-key/ts-universal-mouse-key#onmouse)、[onKeyEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-key/ts-universal-events-key#onkeyevent)、[onTouch](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#ontouch)、[onVisibleAreaChange](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/component-change/ts-universal-component-visible-area-change-event/ts-universal-component-visible-area-change-event#onvisibleareachange)。

![](../../../../images/348aa19c/note_3.0-zh-cn.png) 
...
网页触发alert()告警弹窗时触发回调。若不调用[handleCancel](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handlecancel)或[handleConfirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handleconfirm)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnAlertEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onalertevent12), boolean&gt; | 是 | 网页触发alert()告警弹窗时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
![](../../../../images/43c05729/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnBeforeUnloadEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onbeforeunloadevent12), boolean&gt; | 是 | 即将完成页面刷新或关闭当前页面时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终是否离开当前页面。当回调返回false时，函数中绘制的自定义弹窗无效。 |
...
网页调用confirm()告警时触发此回调。若不调用[handleCancel](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handlecancel)或[handleConfirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handleconfirm)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnConfirmEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onconfirmevent12), boolean&gt; | 是 | 网页调用confirm()告警时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
网页调用prompt()告警时触发此回调。若不调用[handleCancel](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handlecancel)或[handlePromptConfirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-jsresult/arkts-basic-components-web-jsresult#handlepromptconfirm9)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPromptEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpromptevent12), boolean&gt; | 是 | 网页调用prompt()告警时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认、取消和输入），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终处理结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnConsoleEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onconsoleevent12), boolean&gt; | 是 | 网页收到JavaScript控制台消息时触发。  返回值boolean。当返回true时，该条消息将不会再打印至hilog日志，返回false时仍会打印至hilog日志。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnDownloadStartEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#ondownloadstartevent12)&gt; | 是 | 开始下载时触发。 |
...
网页加载遇到错误时触发该回调。主资源与子资源出错都会回调该接口，可以通过[isMainFrame](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourcerequest/arkts-basic-components-web-webresourcerequest#ismainframe)来判断是否是主资源报错。出于性能考虑，建议此回调中尽量执行简单逻辑。在无网络的情况下，触发此回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnErrorReceiveEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onerrorreceiveevent12)&gt; | 是 | 网页收到 Web 资源加载错误时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnHttpErrorReceiveEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onhttperrorreceiveevent12)&gt; | 是 | 网页收到加载资源返回HTTP错误码时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPageBeginEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpagebeginevent12)&gt; | 是 | 网页加载开始时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPageEndEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpageendevent12)&gt; | 是 | 网页加载结束时触发。 |
...
![](../../../../images/fae2cd53/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnLoadStartedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onloadstartedevent20)&gt; | 是 | 网页加载开始时触发。 |
...
![](../../../../images/58c19eee/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnLoadFinishedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onloadfinishedevent20)&gt; | 是 | 网页加载结束时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnProgressChangeEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onprogresschangeevent12)&gt; | 是 | 页面加载进度变化时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnTitleReceiveEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#ontitlereceiveevent12)&gt; | 是 | 页面文档标题发生变更时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnRefreshAccessedHistoryEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onrefreshaccessedhistoryevent12)&gt; | 是 | 在导航完成时触发。 |
...
应用处理该回调时，可以调用绑定的webviewController相关接口来恢复页面。例如[refresh](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#refresh)、[loadUrl](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#loadurl)等。

组件生命周期回调详情可参考[Web组件的生命周期](/arkweb/web-event-sequence)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnRenderExitedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onrenderexitedevent12)&gt; | 是 | 渲染过程退出时触发。 |
...
应用可以通过WebviewController接口[terminateRenderProcess](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#terminaterenderprocess12)来终止关联的渲染进程，这可能会影响同一渲染进程的其他Web组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessNotRespondingCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onrenderprocessnotrespondingcallback12) | 是 | 渲染进程无响应时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessRespondingCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onrenderprocessrespondingcallback12) | 是 | 渲染进程由无响应状态变回正常运行状态时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnShowFileSelectorEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onshowfileselectorevent12), boolean&gt; | 是 | 用于通知Web组件文件选择的结果。  返回值boolean。当返回值为true时，用户可以调用系统提供的弹窗能力。当返回值为false时，函数中绘制的自定义弹窗无效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnResourceLoadEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onresourceloadevent12)&gt; | 是 | 加载url时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnScaleChangeEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onscalechangeevent12)&gt; | 是 | 当页面显示比例发生变化时，触发该回调。 |
...
当Web组件加载URL之前触发该回调，用于拦截URL并返回响应数据。onInterceptRequest可拦截所有跳转请求并返回响应数据，但无法访问POST请求体（Body）内容，且不支持分片缓冲（buffer）类型数据获取。此类场景需改用[WebSchemeHandler](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webschemehandler/arkts-apis-webview-webschemehandler)实现，依据具体业务需求进行判断。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnInterceptRequestEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#oninterceptrequestevent12), [WebResourceResponse](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourceresponse/arkts-basic-components-web-webresourceresponse)&gt; | 是 | 当Web组件加载url之前触发。  返回值[WebResourceResponse](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourceresponse/arkts-basic-components-web-webresourceresponse)。返回响应数据则按照响应数据加载，无响应数据则返回null表示按照原来的方式加载。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnHttpAuthRequestEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onhttpauthrequestevent12), boolean&gt; | 是 | 当浏览器需要用户的凭据时触发。  返回值boolean。返回true表示http auth认证成功，返回false表示http auth认证失败。 |
...
如果需要支持子资源，请使用[OnSslErrorEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onsslerrorevent12)接口。

![](../../../../images/08989e3b/note_3.0-zh-cn.png) 

- 主资源：浏览器加载网页的入口文件，通常是HTML文档。
- 子资源：主资源中引用的依赖文件，由主资源解析过程中遇到特定标签时触发加载。
- 应用程序需要调用[handler.handleCancel()](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-sslerrorhandler/arkts-basic-components-web-sslerrorhandler#handlecancel9)或[handler.handleConfirm()](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-sslerrorhandler/arkts-basic-components-web-sslerrorhandler#handleconfirm9)处理该回调，如果没有处理该回调则默认取消资源加载。handleConfirm()或者handleCancel()的行为可能会被记录下来，以便为将来的SSL错误做出响应。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnSslErrorEventReceiveEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onsslerroreventreceiveevent12)&gt; | 是 | 当网页收到SSL错误时触发。 |
...
通知用户加载资源（主资源+子资源）时发生SSL错误，如果只想处理主资源的SSL错误，请用[isMainFrame](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourcerequest/arkts-basic-components-web-webresourcerequest#ismainframe)字段进行区分。

![](../../../../images/606e61ea/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSslErrorEventCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onsslerroreventcallback12) | 是 | 通知用户加载资源时发生SSL错误。 |
...
![](../../../../images/d6b97636/note_3.0-zh-cn.png) 

- Web组件有三种响应方式：[ClientAuthenticationHandler.confirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/s-basic-components-web-clientauthenticationhandler/s-basic-components-web-clientauthenticationhandler#confirm10)（继续）、[ClientAuthenticationHandler.cancel](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/s-basic-components-web-clientauthenticationhandler/s-basic-components-web-clientauthenticationhandler#cancel9)（取消）或[ClientAuthenticationHandler.ignore](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/s-basic-components-web-clientauthenticationhandler/s-basic-components-web-clientauthenticationhandler#ignore9)（忽略）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnClientAuthenticationEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onclientauthenticationevent12)&gt; | 是 | 当需要用户提供的SSL客户端证书时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnVerifyPinCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onverifypincallback22) | 是 | 当需要用户进行PIN码认证时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPermissionRequestEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpermissionrequestevent12)&gt; | 是 | 通知收到获取权限请求触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnContextMenuShowEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#oncontextmenushowevent12), boolean&gt; | 是 | 调用时触发的回调，以允许自定义显示上下文菜单。  返回值boolean。返回true表示触发自定义菜单，返回false表示触发的自定义菜单无效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContextMenuHideCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#oncontextmenuhidecallback11) | 是 | 菜单相关回调。 |
...
![](../../../../images/326a6e00/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnScrollEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onscrollevent12)&gt; | 是 | 当页面滚动到指定位置时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnGeolocationShowEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#ongeolocationshowevent12)&gt; | 是 | 回调函数，请求显示地理位置权限时触发，返回地理位置信息请求对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFullScreenEnterCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onfullscreenentercallback12) | 是 | Web组件进入全屏时的回调信息。 |
...
若不调用[setWebController](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-controllerhandler/arkts-basic-components-web-controllerhandler#setwebcontroller9)接口，会造成render进程阻塞。

如果没有创建新窗口，调用[setWebController](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-controllerhandler/arkts-basic-components-web-controllerhandler#setwebcontroller9)接口时设置成null，通知Web没有创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnWindowNewEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onwindownewevent12)&gt; | 是 | 网页要求用户创建窗口时触发的回调。 |
...
在启用[multiWindowAccess](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#multiwindowaccess9)的情况下，通知用户新建窗口请求。

![](../../../../images/92ed177f/note_3.0-zh-cn.png) 

- 若不调用[setWebController](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-controllerhandler/arkts-basic-components-web-controllerhandler#setwebcontroller9)接口，会造成render进程阻塞。
- 若未创建新窗口，调用[setWebController](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-controllerhandler/arkts-basic-components-web-controllerhandler#setwebcontroller9)接口并设置成null，通知Web未创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnWindowNewExtEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onwindownewextevent23)&gt; | 是 | 网页要求用户创建窗口时触发的回调。 |
...
![](../../../../images/3880d7ce/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnSearchResultReceiveEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onsearchresultreceiveevent12)&gt; | 是 | 通知调用方网页页内查找的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnDataResubmittedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#ondataresubmittedevent12)&gt; | 是 | 网页表单可以重新提交时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPageVisibleEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpagevisibleevent12)&gt; | 是 | 旧页面不再呈现，新页面即将可见时触发的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event:[KeyEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-key/ts-universal-events-key#keyevent对象说明)) => boolean | 是 | 触发的KeyEvent事件。  返回值为boolean类型，true表示将该KeyEvent传入Webview内核，false表示不将该KeyEvent传入Webview内核。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnTouchIconUrlReceivedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#ontouchiconurlreceivedevent12)&gt; | 是 | 接收到的apple-touch-icon url地址时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnFaviconReceivedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onfaviconreceivedevent12)&gt; | 是 | 当前页面接收到新的favicon时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnAudioStateChangedEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onaudiostatechangedevent12)&gt; | 是 | 网页上的音频播放状态发生改变时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnFirstContentfulPaintEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onfirstcontentfulpaintevent12)&gt; | 是 | 网页首次内容绘制回调函数。 |
...
onFirstMeaningfulPaint(callback: [OnFirstMeaningfulPaintCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onfirstmeaningfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFirstMeaningfulPaintCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onfirstmeaningfulpaintcallback12) | 是 | 网页绘制页面主要内容度量信息的回调。 |
...
onLargestContentfulPaint(callback: [OnLargestContentfulPaintCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onlargestcontentfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnLargestContentfulPaintCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onlargestcontentfulpaintcallback12) | 是 | 网页绘制页面最大内容度量信息的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnLoadInterceptEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onloadinterceptevent12), boolean&gt; | 是 | 导航触发时的回调包括iframe导航，在回调中可以选择允许或者取消此次导航。  返回值为boolean类型。返回true表示取消此次导航，false表示允许此次导航。  返回undefined或null时为false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnScreenCaptureRequestEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onscreencapturerequestevent12)&gt; | 是 | 通知收到屏幕捕获请求。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnOverScrollEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onoverscrollevent12)&gt; | 是 | 网页过度滚动时触发。 |
...
因该回调调用时网页还未加载，无法在回调中使用有关操作网页的接口，例如[zoomIn](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#zoomin)、[zoomOut](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#zoomout)等，可以使用[loadUrl](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#loadurl)、[getWebId](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#getwebid)等操作网页不相关的接口。

组件生命周期详情可参考[Web组件的生命周期](/arkweb/web-event-sequence)。
...
onNavigationEntryCommitted(callback: [OnNavigationEntryCommittedCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onnavigationentrycommittedcallback11))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNavigationEntryCommittedCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onnavigationentrycommittedcallback11) | 是 | 网页跳转提交时触发的回调。 |
...
![](../../../../images/23255162/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSafeBrowsingCheckResultCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onsafebrowsingcheckresultcallback11) | 是 | 收到网站安全风险检查结果时触发的回调。 |
...
![](../../../../images/0af9a1d2/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedDataInfo](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#nativeembeddatainfo11)) => void | 是 | 同层标签生命周期变化时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedTouchInfo](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#nativeembedtouchinfo11)) => void | 是 | 手指触摸到同层标签时触发该回调。 |
...
![](../../../../images/cd0c2b19/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnIntelligentTrackingPreventionCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onintelligenttrackingpreventioncallback12) | 是 | 智能防跟踪功能使能时，当追踪者cookie被拦截时触发的回调。 |
...
![](../../../../images/d9ea3e06/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideUrlLoadingCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onoverrideurlloadingcallback12) | 是 | onOverrideUrlLoading的回调。  返回值boolean。返回true表示中止加载URL，返回false表示继续在Web中加载URL。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnViewportFitChangedCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onviewportfitchangedcallback12) | 是 | 网页meta中viewport-fit配置项更改时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [WebKeyboardCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#webkeyboardcallback12) | 是 | 拦截网页拉起软键盘回调。 |
...
当网页中同层标签（例如<embed>标签或<object>标签）在视口内的可见性发生变化时，将触发该回调。同层标签默认不可见，若在页面首次加载时已可见，则会上报；若不可见，则不会上报。同层标签全部不可见才视为不可见，部分可见或全部可见则视为可见。若要获取因同层标签CSS属性（包括visibility、display以及尺寸变化）导致的可见状态变化，需配置[nativeEmbedOptions](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#nativeembedoptions16)，并将[EmbedOptions](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#embedoptions16)中的supportCssDisplayChange参数设为true。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedVisibilityChangeCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onnativeembedvisibilitychangecallback12) | 是 | 同层标签可见性变化时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [MouseInfoCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#mouseinfocallback20) | 是 | 当鼠标/触摸板点击到同层标签时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedObjectParamChangeCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onnativeembedobjectparamchangecallback21) | 是 | 增加、修改或删除同层渲染object标签内嵌param元素时触发此回调。 |
...
![](../../../../images/b1548f46/note_3.0-zh-cn.png) 

该功能需通过调用[setErrorPageEnabled](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#seterrorpageenabled20)接口启用默认错误页后，才会生效。

通过[errorPageEvent.error.getErrorCode()](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourceerror/arkts-basic-components-web-webresourceerror#geterrorcode)获取的错误码大于0代表http协议错误，小于0代表网络错误。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideErrorPageCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onoverrideerrorpagecallback20) | 是 | 网页加载遇到错误时触发。 |
...
![](../../../../images/c2512c3b/note_3.0-zh-cn.png) 
...
![](../../../../images/fe2a2116/note_3.0-zh-cn.png) 
...
![](../../../../images/da6cd721/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event?: { data:string | [WebResourceRequest](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-webresourcerequest/arkts-basic-components-web-webresourcerequest) }) => boolean | 是 | url的相关信息。  返回值：boolean，true表示阻止此次加载，false表示允许此次加载。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPdfLoadEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpdfloadevent20)&gt; | 是 | 当PDF加载成功或失败时，会触发回调，通知用户PDF页面加载状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[OnPdfScrollEvent](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-i/arkts-basic-components-web-i#onpdfscrollevent20)&gt; | 是 | 当PDF滚动到垂直方向底部时，会触发回调，通知用户PDF页面已滚动到底。 |
...
![](../../../../images/cdc6cbb7/note_3.0-zh-cn.png) 

- 需配合[blankScreenDetectionConfig](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#blankscreendetectionconfig22)使用。否则，默认关闭白屏检测功能，不会返回检测到白屏时的回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnDetectBlankScreenCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#ondetectblankscreencallback22) | 是 | Web组件检测到白屏时的回调函数。 |
...
应用处理该回调时，可以调用绑定的WebViewController接口来恢复页面。例如[refresh](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#refresh)、[loadUrl](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#loadurl)等。

详情可参考[Web组件的生命周期](/arkweb/web-event-sequence)。

![](../../../../images/557338f6/note_3.0-zh-cn.png) 
...
可以通过startCamera，stopCamera，closeCamera这三个接口来切换摄像头的状态。这三个接口分别对应开启，暂停，停止摄像头功能。示例使用场景详见[startCamera](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#startcamera12)。

![](../../../../images/19d519f1/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnCameraCaptureStateChangeCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#oncameracapturestatechangecallback23) | 是 | 回调函数。当摄像头捕获状态改变时触发该回调，返回原来的状态和改变后的状态。 |
...
可以通过resumeMicrophone，pauseMicrophone，stopMicrophone这三个接口来切换麦克风的状态。这三个接口功能分别对应解除暂停，暂停，停止麦克风。示例使用场景详见[网页中麦克风的使用](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#resumemicrophone23)。

![](../../../../images/b2f5d467/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnMicrophoneCaptureStateChangeCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onmicrophonecapturestatechangecallback23) | 是 | 回调函数。当麦克风捕获状态改变时触发该回调，返回原来的状态和改变后的状态。 |
...
![](../../../../images/0ea94116/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [TextSelectionChangeCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#textselectionchangecallback23) | 是 | 回调函数，所选区域文本内容改变时触发。 |
...
![](../../../../images/5cf8984c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFirstScreenPaintCallback](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-t/arkts-basic-components-web-t#onfirstscreenpaintcallback23) | 是 | 回调函数，设置Web组件的检测到首屏渲染。 |
