...
title: "Webview错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-webview
kit: 应用框架
...
![](../../../images/57ebcb16/note_3.0-zh-cn.png) 
...
使用的错误码不在[WebNetErrorList](/ref/arkweb-api/arkweb-arkts/arkts-apis-neterrorlist/arkts-apis-neterrorlist#webneterrorlist)范围内，或者调用didFail接口时使用了NET\_OK错误码。

****处理步骤****

检查使用的错误码是否在[WebNetErrorList](/ref/arkweb-api/arkweb-arkts/arkts-apis-neterrorlist/arkts-apis-neterrorlist#webneterrorlist)范围内，或者调用didFail时是否使用了NET\_OK错误码。
