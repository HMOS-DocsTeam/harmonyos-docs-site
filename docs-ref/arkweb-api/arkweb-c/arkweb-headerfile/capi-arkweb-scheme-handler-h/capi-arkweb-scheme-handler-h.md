...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkweb-scheme-handler-h
kit: 应用框架
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkWeb\_SchemeHandler\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler) | ArkWeb\_SchemeHandler | 该类用于拦截指定scheme的请求。 |
| [ArkWeb\_ResourceHandler\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcehandler/capi-web-arkweb-resourcehandler) | ArkWeb\_ResourceHandler | 用于被拦截的URL请求。可以通过ArkWeb\_ResourceHandler发送自定义请求头以及自定义请求体。 |
| [ArkWeb\_Response\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response) | ArkWeb\_Response | 为被拦截的请求构造一个ArkWeb\_Response。 |
| [ArkWeb\_ResourceRequest\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest) | ArkWeb\_ResourceRequest | 对应内核的一个请求，可以通过OH\_ArkWebResourceRequest\_系列接口获取请求的URL、method、post data以及其他信息。如通过[OH\_ArkWebResourceRequest\_GetUrl](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-scheme-handler-h/capi-arkweb-scheme-handler-h#oh_arkwebresourcerequest_geturl)获取请求的URL。 |
| [ArkWeb\_RequestHeaderList\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-requestheaderlist/capi-web-arkweb-requestheaderlist) | ArkWeb\_RequestHeaderList | 请求头列表。 |
| [ArkWeb\_HttpBodyStream\_](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream) | ArkWeb\_HttpBodyStream | 请求的上传数据。使用OH\_ArkWebHttpBodyStream\_接口来读取上传的数据。 |
...
| [typedef void (\*ArkWeb\_OnRequestStop)(const ArkWeb\_SchemeHandler\* schemeHandler,const ArkWeb\_ResourceRequest\* resourceRequest)](#arkweb_onrequeststop) | ArkWeb\_OnRequestStop | 请求完成时的回调函数。这将在IO线程上被调用。  应该使用ArkWeb\_ResourceRequest\_Destroy销毁resourceRequest，  并使用ArkWeb\_ResourceHandler\_Destroy销毁在ArkWeb\_OnRequestStart中接收到的ArkWeb\_ResourceHandler。 |
...
| [int32\_t OH\_ArkWebHttpBodyStream\_SetReadCallback(ArkWeb\_HttpBodyStream\* httpBodyStream,ArkWeb\_HttpBodyStreamReadCallback readCallback)](#oh_arkwebhttpbodystream_setreadcallback) | - | 为OH\_ArkWebHttpBodyStream\_Read设置回调函数。OH\_ArkWebHttpBodyStream\_Read的结果将通过readCallback通知给调用者。  该回调函数将在与OH\_ArkWebHttpBodyStream\_Read相同的线程中运行。 |
| [int32\_t OH\_ArkWebHttpBodyStream\_SetAsyncReadCallback(ArkWeb\_HttpBodyStream\* httpBodyStream,ArkWeb\_HttpBodyStreamReadCallback readCallback)](#oh_arkwebhttpbodystream_setasyncreadcallback) | - | 为OH\_ArkWebHttpBodyStream\_AsyncRead设置回调函数。OH\_ArkWebHttpBodyStream\_AsyncRead的结果将通过readCallback通知给开发者。  该回调函数将在与OH\_ArkWebHttpBodyStream\_AsyncRead相同的线程中运行。 |
...
| [void OH\_ArkWebHttpBodyStream\_AsyncRead(const ArkWeb\_HttpBodyStream\* httpBodyStream, uint8\_t\* buffer, int bufLen)](#oh_arkwebhttpbodystream_asyncread) | - | 将请求的上传数据读取到buffer。buffer的大小必须大于bufLen。数据将从工作线程读取到buffer，因此在回调函数返回之前，不应在其他线程中使用buffer，以避免并发问题。 |
...
| [int32\_t OH\_ArkWeb\_RegisterCustomSchemes(const char\* scheme, int32\_t option)](#oh_arkweb_registercustomschemes) | - | 将custom scheme注册到ArkWeb。对于内置的HTTP、HTTPS、FILE、FTP、ABOUT和DATA协议，不应调用此函数。  此函数应在主线程上调用并且需要在内核初始化之前调用。 |
| [bool OH\_ArkWebServiceWorker\_SetSchemeHandler(const char\* scheme, ArkWeb\_SchemeHandler\* schemeHandler)](#oh_arkwebserviceworker_setschemehandler) | - | 为指定scheme设置一个ArkWeb\_SchemeHandler以拦截ServiceWorker触发的该scheme类型的请求。应该在创建BrowserContext之后设置SchemeHandler。  可以使用WebviewController.initializeWebEngine来初始化BrowserContext而无需创建ArkWeb。 |
| [bool OH\_ArkWeb\_SetSchemeHandler(const char\* scheme, const char\* webTag, ArkWeb\_SchemeHandler\* schemeHandler)](#oh_arkweb_setschemehandler) | - | 为指定scheme设置一个ArkWeb\_SchemeHandler以拦截该scheme类型的请求。应该在创建BrowserContext之后设置SchemeHandler。  可以使用WebviewController.initializeWebEngine来初始化BrowserContext而无需创建ArkWeb。 |
...
![](../../../../images/d325f6ce/note_3.0-zh-cn.png) 
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| [ArkWeb\_ResourceRequest](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest)\* resourceRequest | 通过该对象获取请求的信息。 |
| const [ArkWeb\_ResourceHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcehandler/capi-web-arkweb-resourcehandler)\* resourceHandler | 请求的ArkWeb\_ResourceHandler。如果intercept设置为false，则不应使用它。 |
...
| --- | --- |
| const [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| const [ArkWeb\_ResourceRequest](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest)\* resourceRequest | ArkWeb\_ResourceRequest。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_HttpBodyStream](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
...
| --- | --- |
| const [ArkWeb\_HttpBodyStream](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
| [ArkWeb\_NetError](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h#arkweb_neterror) result | 成功时返回ARKWEB\_NET\_OK，否则请参考[arkweb\_net\_error\_list.h](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_RequestHeaderList](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-requestheaderlist/capi-web-arkweb-requestheaderlist)\* requestHeaderList | 将被销毁的ArkWeb\_RequestHeaderList。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_RequestHeaderList](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-requestheaderlist/capi-web-arkweb-requestheaderlist)\* requestHeaderList | 请求头的列表。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_ResourceRequest](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest)\* resourceRequest | ArkWeb\_ResourceRequest。 |
...
| --- | --- |
| const [ArkWeb\_ResourceRequest](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest)\* resourceRequest | ArkWeb\_ResourceRequest。 |
| [ArkWeb\_HttpBodyStream](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream)\*\* httpBodyStream | 请求的上传数据。此函数将为httpBodyStream分配内存，调用者必须使用OH\_ArkWebResourceRequest\_DestroyHttpBodyStream释放httpBodyStream。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_HttpBodyStream](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream)\* httpBodyStream | 待销毁的httpBodyStream。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 请求的资源类型。如果resourceRequest无效，则为-1，表示请求对象为空或已失效。其他值参考[ArkWeb\_ResourceType](#arkweb_resourcetype)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_HttpBodyStream](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-httpbodystream/capi-web-arkweb-httpbodystream)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
...
| --- | --- |
| const [ArkWeb\_ResourceRequest](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcerequest/capi-web-arkweb-resourcerequest)\* resourceRequest | ArkWeb\_ResourceRequest。 |
| [ArkWeb\_RequestHeaderList](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-requestheaderlist/capi-web-arkweb-requestheaderlist)\*\* requestHeaderList | 请求的请求头列表。 |
...
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | 该scheme的拦截器ArkWeb\_SchemeHandler。只有通过ServiceWorker触发的请求才会通过这个schemeHandler进行通知。 |
...
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | 该scheme的拦截器ArkWeb\_SchemeHandler。只有从指定web触发的请求才会通过这个schemeHandler进行通知。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\*\* schemeHandler | 返回创建的ArkWeb\_SchemeHandler。在不需要时使用[OH\_ArkWeb\_DestroySchemeHandler](#oh_arkweb_destroyschemehandler)销毁它。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | 待销毁的ArkWeb\_SchemeHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| void\* userData | 要设置的用户数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-schemehandler/capi-web-arkweb-schemehandler)\* schemeHandler | 该scheme的SchemeHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\*\* response | 返回创建的ArkWeb\_Response。在不需要时使用OH\_ArkWeb\_DestroyResponse进行销毁。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\* response | 待销毁的ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\* response | ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\* response | ArkWeb\_Response。 |
| char\*\* url | 解析后的URL。 |
...
| --- | --- |
| [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\* response | ArkWeb\_Response。 |
| [ArkWeb\_NetError](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h#arkweb_neterror) errorCode | 失败请求的错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWeb\_NetError](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h#arkweb_neterror) | ArkWeb\_Response的错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcehandler/capi-web-arkweb-resourcehandler)\* resourceHandler | ArkWeb\_ResourceHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcehandler/capi-web-arkweb-resourcehandler)\* resourceHandler | 该请求的ArkWeb\_ResourceHandler。 |
| const [ArkWeb\_Response](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-response/capi-web-arkweb-response)\* response | 该拦截请求的ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-resourcehandler/capi-web-arkweb-resourcehandler)\* resourceHandler | 用于被拦截的URL请求。可以通过ArkWeb\_ResourceHandler发送自定义请求头以及自定义请求体。 |
| [ArkWeb\_NetError](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h#arkweb_neterror) errorCode | 该请求的错误码。请参考[arkweb\_net\_error\_list.h](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-net-error-list-h/capi-arkweb-net-error-list-h)。 |
