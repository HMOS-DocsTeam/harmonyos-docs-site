...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-web-webnativemessagingextensionability
kit: 应用框架
...
![](../../../images/921d40d6/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [WebNativeMessagingExtensionContext](/ref/arkweb-api/arkweb-arkts/arkts-apis-web-webnativemessagingextensioncontext/arkts-apis-web-webnativemessagingextensioncontext) | 否 | 否 | Web原生消息通信上下文。 |
