...
sidebar_position: 11
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-proxyconfig
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-webview-proxyconfig
---
...
![](../../../../images/8e234600/note_3.0-zh-cn.png) 
...
| schemeFilter | [ProxySchemeFilter](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#proxyschemefilter15) | 否 | 与schemeFilter匹配的URL会使用代理。  默认值：MATCH\_ALL\_SCHEMES。  传入undefined或null会抛出异常错误码401。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemeFilter | [ProxySchemeFilter](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#proxyschemefilter15) | 否 | 与schemeFilter匹配的URL会直接与服务器相连。  默认值：MATCH\_ALL\_SCHEMES。  传入undefined或null会抛出异常错误码401。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[ProxyRule](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-proxyrule/arkts-apis-webview-proxyrule)&gt; | 代理规则。 |
