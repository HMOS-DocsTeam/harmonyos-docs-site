...
title: "Enums"
sidebar_position: 34
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-e
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-webview-e
---

# Enums

![](../../../../images/5908d683/note_3.0-zh-cn.png) 

本模块首批接口从API version 9开始支持，后续版本的新增接口，则采用上角标单独标记接口的起始版本。

## WebHitTestType

[getLastHitTest](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#getlasthittest18)接口用于指示光标节点。
...
[WebMessagePort](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageport/arkts-apis-webview-webmessageport)接口所支持的数据类型。
...
[runJavaScriptExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#runjavascriptext10)接口脚本执行后返回的结果的类型。
...
[OfflineResourceMap](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#offlineresourcemap12)对象对应的本地离线资源的接口类型。
...
Scroll滚动类型，用于[setScrollable](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#setscrollable12)。
...
[handleStatusChanged](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-nativemediaplayerhandler/arkts-apis-webview-nativemediaplayerhandler#handlestatuschanged12) 接口参数， 用于表示播放器的播放状态。
...
| ERR\_KEY\_NOT\_MATCH | -4 | 未匹配到key值，对于[setBlanklessLoadingWithKey](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#setblanklessloadingwithkey20)需与[getBlanklessInfoWithKey](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#getblanklessinfowithkey20)配套使用并且key值一致，否则返回该错误码。 |
| ERR\_SIGNIFICANT\_CHANGE | -5 | 当相似度较低时，系统会判定为跳变太大，[setBlanklessLoadingWithKey](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#setblanklessloadingwithkey20)接口不会成功启用插帧。 |
| ERR\_DURATION\_OUT\_OF\_RANGE23+ | -6 | 在[BlanklessLoadingParam](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessloadingparam23)设置的插帧持续时间超出范围。  ****模型约束：**** 此接口仅可在Stage模型下使用。 |
| ERR\_EXPIRATION\_TIME\_OUT\_OF\_RANGE23+ | -7 | 在[BlanklessLoadingParam](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessloadingparam23)设置的历史帧失效时间超出范围。  ****模型约束：**** 此接口仅可在Stage模型下使用。 |
