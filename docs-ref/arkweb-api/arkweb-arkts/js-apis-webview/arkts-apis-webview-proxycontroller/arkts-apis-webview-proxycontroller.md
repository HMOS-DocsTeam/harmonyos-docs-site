...
![](../../../../images/894bba0f/note_3.0-zh-cn.png) 
...
设置应用中所有Web使用的代理配置，与[insertBypassRule](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-proxyconfig/arkts-apis-webview-proxyconfig#insertbypassrule15)中插入的bypass规则匹配的URL将不会使用代理，而是直接向URL指定的源地址发起请求。代理设置成功后，不保证网络连接后会立即使用新的代理设置，在加载页面之前请等待监听器触发，这个监听器将在UI线程上被调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| proxyConfig | [ProxyConfig](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-proxyconfig/arkts-apis-webview-proxyconfig) | 是 | 对代理的配置。 |
| callback | [OnProxyConfigChangeCallback](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#onproxyconfigchangecallback15) | 是 | 代理设置成功的回调。 |

****错误码：****

以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)说明文档。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnProxyConfigChangeCallback](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#onproxyconfigchangecallback15) | 是 | 代理配置变更的回调。 |
