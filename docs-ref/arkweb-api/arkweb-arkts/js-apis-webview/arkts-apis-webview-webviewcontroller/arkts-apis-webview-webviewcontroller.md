...
![](../../../../images/fa6df1b9/note_3.0-zh-cn.png) 
...
![](../../../../images/af97f234/note_3.0-zh-cn.png) 
...
Web组件销毁后会解绑WebViewController，之后调用WebviewController的非静态方法会抛出[17100001](/ref/arkweb-api/arkweb-arkts-errcode/errorcode-webview/errorcode-webview#section17100001-webviewcontroller没有和具体的web组件关联)异常，应注意调用时机和捕获异常，防止进程异常退出。
...
![](../../../../images/1f86f8a4/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| secureDnsMode | [SecureDnsMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#securednsmode10) | 是 | 使用HTTPDNS的模式。 |
...
设置是否启用网页调试功能。详情请参考[DevTools工具](/arkweb/web-debugging/web-debugging-with-devtools)。
...
| headers | Array&lt;[WebHeader](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#webheader)&gt; | 否 | URL的附加HTTP请求头。  默认值： []。  传入undefined或null会抛出异常错误码401。 |

****错误码：****

以下错误码的详细介绍请参见[Webview错误码](/ref/arkweb-api/arkweb-arkts-errcode/errorcode-webview/errorcode-webview)、[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
3.通过沙箱路径加载本地文件，可以参考[web](/arkweb/web-manage-loading-browsing/web-page-loading-with-web-components#加载本地页面)加载沙箱路径的示例代码。
...
![](../../../../images/4ab96a93/note_3.0-zh-cn.png) 
...
![](../../../../images/34d5361c/note_3.0-zh-cn.png) 
...
示例请参考[前端页面调用应用侧函数](/arkweb/web-use-frontend-page-js/web-in-page-app-function-invoking)。

![](../../../../images/91ca8306/note_3.0-zh-cn.png) 
...
更多示例，请参考[前端页面调用应用侧函数](/arkweb/web-use-frontend-page-js/web-in-page-app-function-invoking)。
...
![](../../../../images/817985f2/note_3.0-zh-cn.png) 
...
![](../../../../images/f7677e34/note_3.0-zh-cn.png) 
...
![](../../../../images/b453e89f/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[JsMessageExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-jsmessageext/arkts-apis-webview-jsmessageext)&gt; | 是 | 回调执行JavaScript脚本结果。 |
...
![](../../../../images/c6eabfeb/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[JsMessageExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-jsmessageext/arkts-apis-webview-jsmessageext)&gt; | Promise实例，返回脚本执行的结果。 |
...
删除通过[registerJavaScriptProxy](#registerjavascriptproxy)或者[javaScriptProxy](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#javascriptproxy)注册到window上的指定name的应用侧JavaScript对象。删除操作在页面下次（重新）加载后生效。
...
调整当前网页的缩放比例，[zoomAccess](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#zoomaccess)需为true。
...
异步查找网页中所有匹配关键字'searchString'的内容并高亮，结果通过[onSearchResultReceive](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onsearchresultreceive9)异步返回。
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[WebMessagePort](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageport/arkts-apis-webview-webmessageport)&gt; | web消息端口列表。 |
...
完整示例代码参考[onMessageEventExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageport/arkts-apis-webview-webmessageport#onmessageeventext10)。
...
| ports | Array&lt;[WebMessagePort](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageport/arkts-apis-webview-webmessageport)&gt; | 是 | 要发送的消息端口。 |
...
默认User-Agent定义与使用场景请参考[User-Agent开发指导](/arkweb/web-set-attributes-events/web-default-useragent)
...
获取当前网页的页面高度。具体使用详情请参考[获取网页内容高度](/arkweb/web-render-layout/web-getpage-height)。
...
![](../../../../images/5af8fcb0/note_3.0-zh-cn.png) 
...
![](../../../../images/05f27b2d/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| image.[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 页面favicon图标的PixelMap对象。 |
...
![](../../../../images/1571ae02/note_3.0-zh-cn.png) 
...
![](../../../../images/211ce46a/note_3.0-zh-cn.png) 
...
![](../../../../images/ba34e36c/note_3.0-zh-cn.png) 

[onLoadIntercept](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onloadintercept10)在加载开始的时候触发，该时刻还未生成历史节点，所以在onLoadIntercept中调用getBackForwardEntries拿到的历史栈不包括当前正在加载中的跳转。
...
| 类型 | 说明 |
| --- | --- |
| [BackForwardList](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-backforwardlist/arkts-apis-webview-backforwardlist) | 当前Webview的历史信息列表。 |
...
1.对文件的操作需要导入文件管理模块，详情请参考[文件管理](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)。
...
对Web内核赋予自定义协议url的跨域请求与fetch请求的权限。当Web在跨域fetch自定义协议url时，该fetch请求可被[onInterceptRequest](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#oninterceptrequest9)事件接口所拦截，从而开发者可以进一步处理该请求。建议在任何Web组件初始化之前调用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemes | Array&lt;[WebCustomScheme](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#webcustomscheme)&gt; | 是 | 自定义协议配置，最多支持同时配置10个自定义协议。 |
...
获取当前网站的证书信息。使用Web组件加载https网站，会进行SSL证书校验，该接口会通过Promise异步返回当前网站的X509格式证书（X509Cert证书类型定义见[X509Cert](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#x509cert)定义），便于开发者展示网站证书信息。
...
获取当前网站的证书信息。使用Web组件加载https网站，会进行SSL证书校验，该接口会通过AsyncCallback异步返回当前网站的X509格式证书（X509Cert证书类型定义见[X509Cert定义](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert)），便于开发者展示网站证书信息。
...
![](../../../../images/82fc5df5/note_3.0-zh-cn.png) 
...
| additionalHeaders | Array&lt;[WebHeader](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#webheader)&gt; | 否 | url的附加HTTP请求头。  默认值： [] |
| prefetchOptions | [PrefetchOptions](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-prefetchoptions/arkts-apis-webview-prefetchoptions) | 否 | 用来自定义预取行为的相关选项。 |
...
![](../../../../images/74251c64/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [RequestInfo](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#requestinfo12) | 是 | 预获取请求的信息。 |
| additionalHeaders | Array&lt;[WebHeader](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#webheader)&gt; | 否 | 预获取请求的附加HTTP请求头。  传入undefined或null会抛出异常错误码401。 |
...
![](../../../../images/00bb964e/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [WebDownloadDelegate](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webdownloaddelegate/arkts-apis-webview-webdownloaddelegate) | 是 | 用来接收下载进度的委托。 |
...
默认User-Agent定义与使用场景，及相关User-Agent接口定义优先级请参考[User-Agent开发指导](/arkweb/web-set-attributes-events/web-default-useragent)。
...
![](../../../../images/31b6e86f/note_3.0-zh-cn.png) 
...
![](../../../../images/c142fe7f/note_3.0-zh-cn.png) 
...
![](../../../../images/f098a49c/note_3.0-zh-cn.png) 
...
![](../../../../images/a16e898d/note_3.0-zh-cn.png) 
...
当Web组件使能广告过滤功能后，默认所有页面都是开启广告过滤的，支持通过[addAdsBlockDisallowedList](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-adsblockmanager/arkts-apis-webview-adsblockmanager#addadsblockdisallowedlist12)指定域名禁用广告过滤。
...
![](../../../../images/5a23dd29/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [RenderProcessMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#renderprocessmode12) | 是 | 渲染子进程模式。  可以先调用[getRenderProcessMode()](#getrenderprocessmode12)查看当前设备的ArkWeb渲染子进程模式，枚举值0为单子进程模式，枚举值1为多子进程模式。  手机默认为单渲染子进程模式，平板和PC/2in1默认为多渲染子进程模式。  如果传入RenderProcessMode枚举值之外的非法数字，则默认识别为多渲染子进程模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [RenderProcessMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#renderprocessmode12) | 渲染子进程模式类型。  调用getRenderProcessMode()获取当前设备的ArkWeb渲染子进程模式，枚举值0为单子进程模式，枚举值1为多子进程模式。  如果获取的值不在RenderProcessMode枚举值范围内，则默认为多渲染子进程模式。 |
...
| 类型 | 说明 |
| --- | --- |
| print.[PrintDocumentAdapter](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/data-file-processing-arkts/js-apis-print/js-apis-print#printdocumentadapter11) | 返回打印文档的适配器。 |
...
| 类型 | 说明 |
| --- | --- |
| [SecurityLevel](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#securitylevel11) | 当前网页的安全级别，具体值为NONE、SECURE、WARNING、DANGEROUS。 |
...
| type | [ScrollType](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#scrolltype12) | 否 | 网页可触发的滚动类型，支持缺省配置。  - enable为false时，表示禁止ScrollType类型的滚动，当ScrollType缺省时表示禁止所有类型网页滚动。  - enable为true时，ScrollType缺省与否，都表示允许所有类型的网页滚动。  传入null或undefined时会抛出异常错误码401。 |
...
设置是否打印网页背景，该接口与[PrintAttributes](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/data-file-processing-arkts/js-apis-print/js-apis-print#printattributes11)打印参数配置不一致时，本接口设置优先级高于打印参数。
...
通过[registerJavaScriptProxy](#registerjavascriptproxy)或者[javaScriptProxy](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#javascriptproxy)注入JavaScript对象到window对象中。该接口可以获取最后一次调用注入的对象的frame的url。
...
| 类型 | 说明 |
| --- | --- |
| [MediaPlaybackState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#mediaplaybackstate12) | 当前网页的播放状态，具体值为NONE、PLAYING、PAUSED、STOPPED。 |
...
为当前Web组件设置[WebSchemeHandler](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webschemehandler/arkts-apis-webview-webschemehandler), [WebSchemeHandler](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webschemehandler/arkts-apis-webview-webschemehandler)类用于拦截指定scheme的请求。
...
| handler | [WebSchemeHandler](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webschemehandler/arkts-apis-webview-webschemehandler) | 是 | 拦截此协议的拦截器。 |
...
开启当前网页摄像头捕获。使用摄像头功能前请在module.json5中添加权限: ohos.permission.CAMERA，具体权限的添加方法请参考[在配置文件中声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions#在配置文件中声明权限)。
...
| cacheOptions | [CacheOptions](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#cacheoptions12) | 是 | 用于控制字节码缓存更新。 |
...
1. 首先，在EntryAbility中将[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)存到[localStorage](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-application-state-management/arkts-localstorage)中。
...
3. 编写用于生成字节码缓存的组件，本例中的本地Javascript资源内容通过文件读取接口读取rawfile目录下的本地文件。
   ...
   JavaScript资源的获取方式也可通过[网络请求](/ref/system-network-api/network-api/network-api-arkts/js-apis-http/js-apis-http)的方式获取，但此方法获取到的HTTP响应头非标准HTTP响应头格式，需额外将响应头转换成标准HTTP响应头格式后使用。如通过网络请求获取到的响应头是e-tag，则需要将其转换成E-Tag后使用。
4. 编写业务用组件代码。
...
注册回调函数，开启[应用接管网页媒体播放功能](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#enablenativemediaplayer12)后，当网页中有播放媒体时，触发注册的回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [CreateNativeMediaPlayerCallback](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#createnativemediaplayercallback12) | 是 | 接管网页媒体播放的回调函数。 |
...
![](../../../../images/861de75c/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [SnapshotInfo](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#snapshotinfo12) | 是 | 全量绘制结果入参。 |
| callback | AsyncCallback&lt;[SnapshotResult](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#snapshotresult12)&gt; | 是 | 全量绘制回调结果。 |
...
injectOfflineResources(resourceMaps: Array<[OfflineResourceMap](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#offlineresourcemap12)>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceMaps | Array&lt;[OfflineResourceMap](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#offlineresourcemap12)&gt; | 是 | 本地离线资源配置对象，单次调用最大支持注入30个资源，单个资源最大支持10Mb。 |
...
![](../../../../images/792366a1/note_3.0-zh-cn.png) 
...
设置一个路径列表，当file协议访问该路径列表中的资源时，允许跨域访问本地文件，也允许跨域访问其他在线资源。此外，当设置了路径列表时，file协议仅允许访问路径列表中的资源（[fileAccess](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#fileaccess)的行为将会被此接口行为覆盖）。

setPathAllowingUniversalAccess放开目录的跨域访问限制是一个高风险操作。基于最小权限原则，当前el1，el2放开的路径是固定的，路径列表中的路径应符合以下任一路径格式：

1.应用文件目录的子目录（应用文件目录通过Ability Kit中的[Context.filesDir](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#属性)获取），例如：

- /data/storage/el2/base/files/example
- /data/storage/el2/base/haps/entry/files/example

2.应用资源目录及其子目录（应用资源目录通过Ability Kit中的[Context.resourceDir](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#属性)获取），例如：

- /data/storage/el1/bundle/entry/resources/resfile
- /data/storage/el1/bundle/entry/resources/resfile/example

3.从API version 21开始，还包括了应用缓存目录及其子目录（应用缓存目录通过Ability Kit中的[Context.cacheDir](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#属性)获取），例如：

- /data/storage/el2/base/cache
- /data/storage/el2/base/haps/entry/cache/example
- 设置的目录路径中，不允许包含cache/web，否则会抛出异常码401。如果设置目录路径是cache，cache/web也不允许访问。

4.从API version 21开始，还包括了应用临时目录及其子目录（应用临时目录通过Ability Kit中的[Context.tempDir](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context#属性)获取），例如：

- /data/storage/el2/base/temp
- /data/storage/el2/base/haps/entry/temp/example

当路径列表中有其中一个路径不满足以上条件之一，则会抛出异常码401，并且设置路径列表失败。当设置的路径列表为空，则file协议可访问范围以[fileAccess](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#fileaccess)的行为为准。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| features | [BackForwardCacheSupportedFeatures](/ref/arkweb-api/arkweb-arkts/js-apis-webview/kts-apis-webview-backforwardcachesupportedfeatures/kts-apis-webview-backforwardcachesupportedfeatures) | 是 | 允许使用特定的页面进入前进后退缓存中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [BackForwardCacheOptions](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-backforwardcacheoptions/arkts-apis-webview-backforwardcacheoptions) | 是 | 用来控制Web组件前进后退缓存相关选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| level | [PressureLevel](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#pressurelevel14) | 是 | 需要清理内存的内存等级。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configuration | [PdfConfiguration](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#pdfconfiguration14) | 是 | 生成PDF所需参数。 |
| callback | AsyncCallback&lt;[PdfData](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-pdfdata/arkts-apis-webview-pdfdata)&gt; | 是 | 回调返回网页PDF数据流。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[PdfData](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-pdfdata/arkts-apis-webview-pdfdata)&gt; | Promise实例，返回网页数据流。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#scrolloffset13) | 网页当前的滚动偏移量（包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#scrolloffset13) | 网页当前的滚动偏移量（不包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [HitTestValue](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#hittestvalue) | 点击区域的元素信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20) | WebViewController与Web组件的绑定状态。 |
...
| callback | Callback&lt;[ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20)&gt; | 是 | WebViewController绑定状态改变时的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 表示注册WebViewController绑定状态事件，固定为"controllerAttachStateChange"。 |
| callback | Callback&lt;[ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20)&gt; | 否 | WebViewController绑定状态发生改变时的回调函数，默认情况下不填写回调函数。如果填写了Callback，将仅取消注册该特定的回调。如果不填写Callback，将取消注册所有回调。  传入null或undefined时会抛出异常错误码401。 |
...
异步等待WebViewController与Web组件绑定完成，绑定完成或超时触发回调，通过Promise方式返回当前[ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20)状态。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20)&gt; | Promise实例，返回当前[ControllerAttachState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#controllerattachstate20)状态。 |
...
- 当指定了端口port时，ArkWeb会启动一个tcp socket监听。这时可以无线调试网页。详情请参考[无线调试](/arkweb/web-debugging/web-debugging-with-devtools#无线调试)。
...
![](../../../../images/5b0541db/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [WebHitTestType](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webhittesttype) | 被点击区域的元素类型。 |
...
![](../../../../images/0ea0e678/note_3.0-zh-cn.png) 
...
![](../../../../images/6738a93e/note_3.0-zh-cn.png) 
...
- 该接口高度设置为0时，Web网页内容可恢复，键盘弹起避让模式将使用[keyboardAvoidMode()](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#keyboardavoidmode12)声明的模式。
...
在当前接口设置为true时如果页面加载发生错误将触发[onOverrideErrorPage](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onoverrideerrorpage20)回调，可在该回调接口中设置自定义的错误展示页面。
...
获取页面首屏加载预测信息（详细说明见[BlanklessInfo](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessinfo20)），并开始本次加载过渡帧生成，应用根据此信息确定是否需要启用无白屏加载。必须与[setBlanklessLoadingWithKey](#setblanklessloadingwithkey20)接口配套使用，并且必须在触发加载页面的接口之前或在onLoadIntercept中调用。需在WebViewController与Web组件绑定后才能使用。

![](../../../../images/21402584/note_3.0-zh-cn.png) 
...
- 如果发现快照相似度（即[BlanklessInfo](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessinfo20)中的similarity）极低，请确认key值是否传递正确。
...
- 请在module.json5中添加权限: ohos.permission.INTERNET和ohos.permission.GET\_NETWORK\_INFO，具体权限的添加方法请参考[在配置文件中声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions#在配置文件中声明权限)。
...
| 类型 | 说明 |
| --- | --- |
| [BlanklessInfo](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessinfo20) | 页面首屏加载预测信息，主要包括首屏相似度预测值，首屏加载耗时预测值，应用需根据此信息来决策是否启用无白屏加载插帧。 |
...
![](../../../../images/dc401103/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [WebBlanklessErrorCode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webblanklesserrorcode20) | 返回接口调用是否成功，具体见[WebBlanklessErrorCode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webblanklesserrorcode20)定义。 |
...
![](../../../../images/5360f004/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| key | string | 是 | 唯一标识本页面的key值。必须与getBlanklessInfoWithKey接口的key值相同。  合法取值范围：非空，长度不超过2048个字符。  非法值设置行为：返回错误码WebBlanklessErrorCode，方案不生效。 |
| param | [BlanklessLoadingParam](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-i/arkts-apis-webview-i#blanklessloadingparam23) | 是 | 白屏插帧加载的各项参数设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [WebBlanklessErrorCode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webblanklesserrorcode20) | 返回接口调用结果。 |
...
![](../../../../images/e9464129/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keys | Array&lt;string&gt; | 否 | 清除Blankless优化方案页面的key值列表，key值为[getBlanklessInfoWithKey](#getblanklessinfowithkey20)中指定过的。  默认值：所有Blankless优化方案缓存的页面key列表。  合法取值范围：长度不超过2048，key列表长度&lt;=100。key和加载页面时输入给ArkWeb的相同。  非法值设置行为：传入undefined/null会抛出异常错误码401；key长度超过2048时该key不生效；长度超过100时，取前100个；当为空时，使用默认值。 |
...
设置Web组件的销毁模式。当Web组件销毁时，销毁模式会影响Web内核资源释放的时机，例如JavaScript运行上下文、渲染上下文等。默认值：[WebDestroyMode.NORMAL\_MODE](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webdestroymode20)（普通模式），由系统决定销毁时机。应用可设置[WebDestroyMode.FAST\_MODE](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webdestroymode20)（快速模式），以立即销毁资源，从而提升特定场景的性能。

![](../../../../images/ae87b1a5/note_3.0-zh-cn.png) 

[WebDestroyMode.FAST\_MODE](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webdestroymode20)（快速模式）会改变Web组件销毁时机，应用需关注依赖Web组件销毁时机的错误实现，例如：Web组件销毁后仍调用WebviewController的未定义行为，与[WebDestroyMode.NORMAL\_MODE](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webdestroymode20)（普通模式）相比，销毁时机提前，有更高的几率触发未关联绑定的异常（17100001），建议应用捕捉异常，或者通过[getAttachState](#getattachstate20)方法查询是否绑定状态，来避免稳定性问题。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebDestroyMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webdestroymode20) | 是 | 设置Web组件的销毁模式。  默认值：WebDestroyMode.NORMAL\_MODE |
...
在Web页面场景，设置全局滚动条模式。不显式调用时，默认为[ScrollbarMode.OVERLAY\_LAYOUT\_SCROLLBAR](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#scrollbarmode23) （非常驻滚动条）。

![](../../../../images/e4214161/note_3.0-zh-cn.png) 

- 根据滚动条模式，改变当前应用所有web滚动条模式为常驻滚动条或非常驻滚动条。
- 若[forceDisplayScrollBar](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-attributes/arkts-basic-components-web-attributes#forcedisplayscrollbar14)接口与当前接口同时设置，forceDisplayScrollBar接口设置不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollbarMode | [ScrollbarMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#scrollbarmode23) | 是 | 滚动条模式。 |
...
![](../../../../images/fa7e4486/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| engineVersion | [ArkWebEngineVersion](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#arkwebengineversion20) | 是 | ArkWeb内核版本。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWebEngineVersion](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#arkwebengineversion20) | 返回由[ArkWebEngineVersion](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#arkwebengineversion20)所定义的当前使用的ArkWeb内核版本。 |
...
| 类型 | 说明 |
| --- | --- |
| [SiteIsolationMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#siteisolationmode21) | 站点隔离模式类型。  getSiteIsolationMode()查询当前生效的站点隔离模式。 |
...
对于仅加载可信网页的第三方应用，可以关闭此功能，以提升性能并减少内存占用，同时减少跨域访问的拦截。默认值根据不同的设备而定，PC/Table采用严格站点隔离[SiteIsolationMode.STRICT](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#siteisolationmode21)，Phone默认部分站点隔离[SiteIsolationMode.PARTIAL](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#siteisolationmode21)。[坚盾守护模式](/arkweb/web-manage-cyber-security-privacy/web-secure-shield-mode)下采用严格站点隔离。

![](../../../../images/218ab670/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [SiteIsolationMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#siteisolationmode21) | 是 | 设置站点隔离模式。  默认值取决于设备类型和设备模式：PC/Tablet默认严格站点隔离，Phone默认部分站点隔离；坚盾守护模式默认严格站点隔离。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebSoftKeyboardBehaviorMode](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#websoftkeyboardbehaviormode22) | 是 | Web软键盘自动控制模式。 |
...
恢复当前网页麦克风捕获。使用麦克风功能前请在module.json5中添加权限: ohos.permission.MICROPHONE，具体权限的添加方法请参考[在配置文件中声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions#在配置文件中声明权限)。
