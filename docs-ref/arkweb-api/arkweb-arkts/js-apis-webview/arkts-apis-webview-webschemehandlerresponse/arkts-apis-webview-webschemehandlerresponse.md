...
![](../../../../images/dc573014/note_3.0-zh-cn.png) 
...
风险提示：如果想获取URL来做JavascriptProxy通信接口认证，请使用[getLastJavascriptProxyCallingFrameUrl12+](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#getlastjavascriptproxycallingframeurl12)
...
| 类型 | 说明 |
| --- | --- |
| [WebNetErrorList](/ref/arkweb-api/arkweb-arkts/arkts-apis-neterrorlist/arkts-apis-neterrorlist#webneterrorlist) | 获取Response的网络错误码。 |
