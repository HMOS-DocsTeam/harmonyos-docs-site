...
sidebar_position: 31
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-nativemediaplayerhandler
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-webview-nativemediaplayerhandler
---

# Interface (NativeMediaPlayerHandler)

[CreateNativeMediaPlayerCallback](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#createnativemediaplayercallback12)回调函数的参数。应用通过该对象，将播放器的状态报告给ArkWeb内核。

![](../../../../images/793498c0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| status | [PlaybackStatus](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#playbackstatus12) | 是 | 播放器的播放状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [NetworkState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#networkstate12) | 是 | 播放器的网络状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [ReadyState](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#readystate12) | 是 | 播放器的缓存状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| error | [MediaError](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#mediaerror12) | 是 | 错误类型。 |
