...
通过WebMessagePort可以进行消息的发送以及接收，发送[WebMessageType](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webmessagetype10)/[WebMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#webmessage)类型消息给HTML5侧。

![](../../../../images/6ae9ce23/note_3.0-zh-cn.png) 
...
发送[WebMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#webmessage)类型消息给HTML5侧，必须先调用[onMessageEvent](#onmessageevent)，否则会发送失败。完整示例代码参考[postMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#postmessage)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | [WebMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#webmessage) | 是 | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#webmessage)类型消息。完整示例代码参考[postMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#postmessage)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (result: [WebMessage](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-t/arkts-apis-webview-t#webmessage)) => void | 是 | 接收到的消息。 |
...
发送[WebMessageType](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webmessagetype10)类型消息给HTML5侧，必须先调用[onMessageEventExt](#onmessageeventext10)，否则会发送失败。完整示例代码参考[onMessageEventExt](#onmessageeventext10)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | [WebMessageExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageext/arkts-apis-webview-webmessageext) | 是 | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessageType](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-e/arkts-apis-webview-e#webmessagetype10)类型消息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (result: [WebMessageExt](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webmessageext/arkts-apis-webview-webmessageext)) => void | 是 | 接收到的消息。 |
...
不需要发送消息时关闭该消息端口。在使用close前，请先使用[createWebMessagePorts](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller#createwebmessageports)创建消息端口。
