...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-adsblockmanager
kit: 应用框架
...
![](../../../../images/4b9591a9/note_3.0-zh-cn.png) 
...
![](../../../../images/aaf3d1a9/note_3.0-zh-cn.png) 
...
![](../../../../images/66ce59cb/note_3.0-zh-cn.png) 
...
![](../../../../images/f2be238d/note_3.0-zh-cn.png) 

此接口设置的域名不会持久化，应用重启需要重新设置。

广告过滤特性会使用后缀匹配的方式判断domainSuffix和当前站点的url是否能匹配，例如，当前Web组件打开的网站是`https://www.example.com，设置的DisallowedList中有'example.com'或者'www.example.com'，后缀匹配成功，此网站将禁用广告过滤，访问'https://m.example.com'也将禁用广告过滤`。
...
![](../../../../images/88ef5ab8/note_3.0-zh-cn.png) 
...
![](../../../../images/6eabdc41/note_3.0-zh-cn.png) 
...
![](../../../../images/c4f88daa/note_3.0-zh-cn.png) 
...
![](../../../../images/8871cdab/note_3.0-zh-cn.png) 
...
![](../../../../images/e3d85cb2/note_3.0-zh-cn.png) 
...
![](../../../../images/8c24c78a/note_3.0-zh-cn.png) 
...
![](../../../../images/d7e83f49/note_3.0-zh-cn.png) 
...
![](../../../../images/80990b60/note_3.0-zh-cn.png) 
...
![](../../../../images/9b531316/note_3.0-zh-cn.png) 
