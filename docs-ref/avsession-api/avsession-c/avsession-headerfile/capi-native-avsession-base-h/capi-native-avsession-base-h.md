...
| CATEGORY\_REMOTE = 1 | 远程类别。表示媒体正在远程设备上展示，应用需要一个[OH\_AVCastController](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avcastcontroller/capi-ohavsession-oh-avcastcontroller)来控制远程播放。 |
