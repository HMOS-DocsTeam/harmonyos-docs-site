...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession) | OH\_AVSession | 定义播控会话对象。播控会话对象可以使用[OH\_AVSession\_Create](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsession_create)方法创建。 |
| [OH\_AVCastController](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avcastcontroller/capi-ohavsession-oh-avcastcontroller) | OH\_AVCastController | 声明投播控制器对象。投播控制器对象可以使用[OH\_AVSession\_CreateAVCastController](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsession_createavcastcontroller)方法创建。 |
...
| [AVSession\_ErrCode OH\_AVSession\_AcquireSession(const char\* sessionTag, const char\* bundleName, const char\* abilityName, OH\_AVSession\*\* avsession)](#oh_avsession_acquiresession) | - | 获取已经存在的媒体会话对象。当不再使用媒体会话对象时，调用[OH\_AVSession\_Destroy](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsession_destroy)进行释放。 |
| [AVSession\_ErrCode OH\_AVSession\_CreateAVCastController(OH\_AVSession\* avsession, OH\_AVCastController\*\* avcastcontroller)](#oh_avsession_createavcastcontroller) | - | 创建投播控制器对象。当投播控制器对象不再使用时，调用[OH\_AVCastController\_Destroy](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avcastcontroller-h/capi-native-avcastcontroller-h#oh_avcastcontroller_destroy)进行释放。 |
...
| 参数项 | 描述 |
| --- | --- |
| [AVSession\_Type](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_type) sessionType | 会话类型[AVSession\_Type](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_type)。 |
| const char\* sessionTag | 会话标签。 |
| const char\* bundleName | 创建会话的包名。 |
| const char\* abilityName | 创建会话的ability名。 |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\*\* avsession | 返回的媒体会话对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：服务器内部错误。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数sessionType无效。  2. 参数sessionTag为nullptr。  3. 参数bundleName为nullptr。  4. 参数abilityName为nullptr。  5. 参数avsession为nullptr。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：参数avsession为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：参数avsession为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_Type](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_type)\* sessionType | 返回的会话类型。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数sessionType为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数sessionId为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVMetadata](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatastruct/capi-ohavsession-oh-avmetadatastruct)\* avmetadata | 设置媒体元数据信息。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数avmetadata为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_PlaybackState](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_playbackstate) playbackState | 播放状态。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数playbackState是无效的。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_PlaybackPosition](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-avsession-playbackposition/capi-ohavsession-avsession-playbackposition)\* playbackPosition | 播放位置对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数playbackPosition为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_LoopMode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_loopmode) loopMode | 循环模式。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数loopMode是无效的。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_CODE\_SESSION\_NOT\_EXIST：会话不存在。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：参数avsession为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_ControlCommand](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_controlcommand) command | 播控的控制命令。 |
| [OH\_AVSessionCallback\_OnCommand](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_oncommand) callback | 控制命令的回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_CODE\_COMMAND\_INVALID：控制命令无效。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数callback为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OnFastForward](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_onfastforward) callback | 快进命令的回调。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数callback为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OnRewind](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_onrewind) callback | 快退命令的回调。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OnSeek](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_onseek) callback | 跳转命令的回调。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OnSetLoopMode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_onsetloopmode) callback | 设置循环模式命令的回调。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OnToggleFavorite](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_ontogglefavorite) callback | 设置收藏命令的回调。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVSessionCallback\_OutputDeviceChange](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsessioncallback_outputdevicechange) callback | 设置设备变化的回调。 |
...
获取已经存在的媒体会话对象。当不再使用媒体会话对象时，调用[OH\_AVSession\_Destroy](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsession_destroy)进行释放。
...
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\*\* avsession | 用于接收OH\_AVSession的变量指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_CODE\_SESSION\_NOT\_EXIST：会话不存在。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数sessionTag无效。  2. 参数bundleName无效。  3. 参数abilityName无效。  4. 参数avsession为nullptr。 |
...
创建投播控制器对象。当投播控制器对象不再使用时，调用[OH\_AVCastController\_Destroy](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avcastcontroller-h/capi-native-avcastcontroller-h#oh_avcastcontroller_destroy)进行释放。
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [OH\_AVCastController](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avcastcontroller/capi-ohavsession-oh-avcastcontroller)\*\* avcastcontroller | 指向用于接收投播控制器OH\_AVCastController的变量的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_CODE\_SESSION\_NOT\_EXIST：会话不存在。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数avcastcontroller为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_OutputDeviceInfo](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-avsession-outputdeviceinfo/capi-ohavsession-avsession-outputdeviceinfo)\*\* outputDeviceInfo | 指向用于接收输出设备信息AVSession\_OutputDeviceInfo的变量的指针。不可以单独释放outputDeviceInfo指针。当不再使用outputDeviceInfo时，调用[OH\_AVSession\_ReleaseOutputDevice](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h#oh_avsession_releaseoutputdevice)进行释放。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_SERVICE\_EXCEPTION：会话服务异常。  AV\_SESSION\_ERR\_CODE\_SESSION\_NOT\_EXIST：会话不存在。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数outputDeviceInfo为nullptr。 |
...
| --- | --- |
| [OH\_AVSession](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avsession/capi-ohavsession-oh-avsession)\* avsession | 媒体会话对象。 |
| [AVSession\_OutputDeviceInfo](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-avsession-outputdeviceinfo/capi-ohavsession-avsession-outputdeviceinfo) \*outputDeviceInfo | 应当释放的输出设备。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数avsession为nullptr。  2. 参数outputDeviceInfo为nullptr。 |
