...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVMetadataBuilderStruct](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct) | OH\_AVMetadataBuilder | 会话元数据构造器。构造器用于构造会话元数据。 |
| [OH\_AVMetadataStruct](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatastruct/capi-ohavsession-oh-avmetadatastruct) | OH\_AVMetadata | 会话元数据。资源设置的avmetadata的实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVMetadataBuilder](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct)\*\* builder | 该引用指向创建的构造器实例。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数builder为nullptr。  AVMETADATA\_ERROR\_NO\_MEMORY：内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVMetadataBuilder](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct)\* builder | 指向元数据构造器的实例。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数builder为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数assetId为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数title为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数artist为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数author为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数album为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数writer为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数composer为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数mediaImageUri为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数subtitle为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数description为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数lyric为nullptr。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct)\* builder | 指向元数据构造器的实例。 |
| [AVMetadata\_SkipIntervals](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avmetadata_skipintervals) intervals | 跳转的时间间隔。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数intervals为nullptr。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct)\* builder | 指向元数据构造器的实例。 |
| uint32\_t filter | 此会话支持的协议。如果没有设置，默认为[AVSession\_ProtocolType](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-base-h/capi-native-avsession-base-h#avsession_protocoltype).TYPE\_CAST\_PLUS\_STREAM。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数filter是无效的。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatabuilderstruct/capi-ohavsession-oh-avmetadatabuilderstruct)\* builder | 指向元数据构造器的实例。 |
| [OH\_AVMetadata](/ref/avsession-api/avsession-c/avsession-struct/capi-ohavsession-oh-avmetadatastruct/capi-ohavsession-oh-avmetadatastruct)\*\* avMetadata | 指向元数据的指针对象。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_NO\_MEMORY：内存不足。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数avMetadata为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-errors-h/capi-native-avsession-errors-h#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数avMetadata为nullptr。 |
