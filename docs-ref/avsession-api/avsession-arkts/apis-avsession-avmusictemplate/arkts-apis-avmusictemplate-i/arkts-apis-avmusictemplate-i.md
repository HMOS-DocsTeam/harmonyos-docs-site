...
title: "Interfaces (其他)"
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-avmusictemplate-i
---

# Interfaces (其他)

![](../../../../images/027e1890/note_3.0-zh-cn.png) 
...
| tabIcon | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 标签页的图标（接入模板时在主界面的标签页中必填）。 |
...
| memberMediaType | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 否 | 合集的媒体资源类型。 |
...
| mediaType | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 否 | 媒体资源的类型。 |
| parentId | string | 否 | 否 | 父节点的媒体资源ID。 |
| parentMediaType | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 否 | 父节点的媒体资源类型。 |
| title | string | 否 | 否 | 媒体资源的标题。 |
| desc | string | 否 | 是 | 媒体资源的描述。 |
| imageUrl | string | 否 | 否 | 媒体资源的封面图片URL。 |
| playState | [PlaybackState](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#playbackstate) | 否 | 否 | 媒体资源的播放状态。 |
...
| type | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 否 | 媒体资源类型。 |
| subEntityType | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 是 | 子节点的媒体资源类型。 |
| sort | [Sort](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#sort) | 否 | 是 | 查询到的列表数据排序。 |
...
| memberMediaType | [EntityType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#entitytype) | 否 | 否 | 媒体资源类型。 |
| elements | [MediaEntity](#mediaentity)[] | 否 | 否 | 查询数据内容（根据类型传递相应的结构数据）。 |
| sort | [Sort](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#sort) | 否 | 是 | 数据排序。 |
...
| downloadStatus | [DownloadStatus](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#downloadstatus) | 否 | 是 | 歌曲下载状态。 |
...
| settingType | [SettingType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#settingtype) | 否 | 是 | 设置项的类型。 |
| settingValue | string | boolean | [SettingContent](#settingcontent)[] | [WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent#wantagent) | 否 | 是 | 设置项的值。  - 当settingType类型是SettingType.SWITCH时，本值数据类型是boolean。  - 当settingType类型是SettingType.LIST时，本值数据类型是SettingContent数组。  - 当settingType类型是SettingType.JUMP时，本值数据类型是string。 |
...
| imageTags | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)[] | 否 | 是 | 设置内容的标签描述的数组。 |
...
| icon | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 与二维码关联的应用图标，用于应用登录的二维码应显示目标应用的图标。 |
| content | string | 否 | 否 | 二维码的内容。 |
| codeData | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 二维码图片。 |
...
| dialogType | [DialogType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#dialogtype) | 否 | 否 | 对话框的类型。 |
...
| buttonType | [ButtonType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#buttontype) | 否 | 否 | 按钮的类型。 |
...
| diagramData | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 会员购买图片。 |
| diagramContent | string | 否 | 否 | 会员购买图片的内容。 |
| memberPurchaseType | [MemberPurchaseType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-e/arkts-apis-avmusictemplate-e#memberpurchasetype) | 否 | 否 | 会员购买类型。 |
