...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-avmusictemplate
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-avmusictemplate-avmusictemplate
---

# Class (AVMusicTemplate)

调用[avMusicTemplate.createAVMusicTemplate](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-f/arkts-apis-avmusictemplate-f#avmusictemplatecreateavmusictemplate)获取实例后，可获取其ID，启动音频模板界面，并配置数据获取方法。随后，同步数据给模板控制方，以完成后续操作。

![](../../../../images/4d17686f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[OperResult](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#operresult)&gt; | Promise对象，返回启动音频模板界面的操作结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMainTabsEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymaintabsevent) | 是 | 回调函数，返回查询主标签事件。 |

****错误码：****

以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[音频模板错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avmusictemplate/errorcode-avmusictemplate)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMainTabsEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymaintabsevent) | 否 | 查询主标签事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaTabContentEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediatabcontentevent) | 是 | 回调函数，返回查询媒体标签页内容的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaTabContentEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediatabcontentevent) | 否 | 查询媒体标签页内容的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediaentityevent) | 是 | 回调函数，返回查询媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediaentityevent) | 否 | 查询媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycompilationevent) | 是 | 回调函数，返回查询合集的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycompilationevent) | 否 | 查询合集的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryPlaylistEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryplaylistevent) | 是 | 回调函数，返回查询播放列表的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryPlaylistEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryplaylistevent) | 否 | 查询播放列表的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCurrentSingleEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycurrentsingleevent) | 是 | 回调函数，返回查询当前单曲的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCurrentSingleEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycurrentsingleevent) | 否 | 查询当前单曲的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationByKeywordEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycompilationbykeywordevent) | 是 | 回调函数，返回按关键字查询合集的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationByKeywordEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycompilationbykeywordevent) | 否 | 按关键字查询合集的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityByKeywordEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediaentitybykeywordevent) | 是 | 回调函数，返回按关键字查询媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityByKeywordEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymediaentitybykeywordevent) | 否 | 按关键字查询媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryRecommendMediaEntityListEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryrecommendmediaentitylistevent) | 是 | 回调函数，返回查询推荐媒体列表的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryRecommendMediaEntityListEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryrecommendmediaentitylistevent) | 否 | 查询推荐媒体列表的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryHotWordsEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryhotwordsevent) | 是 | 回调函数，返回查询热词的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryHotWordsEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#queryhotwordsevent) | 否 | 查询热词的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QuerySearchHistoryEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querysearchhistoryevent) | 是 | 回调函数，返回查询搜索历史的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QuerySearchHistoryEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querysearchhistoryevent) | 否 | 查询搜索历史的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClearSearchHistoryEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#clearsearchhistoryevent) | 是 | 回调函数，返回清除搜索历史的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClearSearchHistoryEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#clearsearchhistoryevent) | 否 | 清除搜索历史的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [LoginEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#loginevent) | 是 | 回调函数，返回登录事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [LoginEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#loginevent) | 否 | 登录事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [RequestDialogInfoEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#requestdialoginfoevent) | 是 | 回调函数，返回请求对话框信息的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [RequestDialogInfoEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#requestdialoginfoevent) | 否 | 请求对话框信息的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [HandleMemberPurchaseEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#handlememberpurchaseevent) | 是 | 回调函数，返回处理购买会员的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [HandleMemberPurchaseEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#handlememberpurchaseevent) | 否 | 处理购买会员的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMemberPurchaseEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymemberpurchaseevent) | 是 | 回调函数，返回查询购买会员的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMemberPurchaseEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querymemberpurchaseevent) | 否 | 查询购买会员的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCustomContentEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycustomcontentevent) | 是 | 回调函数，返回查询自定义内容的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCustomContentEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#querycustomcontentevent) | 否 | 查询自定义内容的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DownloadMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#downloadmediaentityevent) | 是 | 回调函数，返回下载媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DownloadMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#downloadmediaentityevent) | 否 | 下载媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SettingsChangeEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#settingschangeevent) | 是 | 回调函数，返回设置改变的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SettingsChangeEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#settingschangeevent) | 否 | 设置改变的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ProblemAndAdviceEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#problemandadviceevent) | 是 | 回调函数，返回问题与建议的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ProblemAndAdviceEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#problemandadviceevent) | 否 | 处理问题与建议的回调。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayForSearchEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#playforsearchevent) | 是 | 回调函数，返回搜播的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayForSearchEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#playforsearchevent) | 否 | 搜播的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ExecuteActionEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#executeactionevent) | 是 | 回调函数，返回执行操作的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ExecuteActionEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#executeactionevent) | 否 | 执行操作的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#playmediaentityevent) | 是 | 回调函数，返回播放媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#playmediaentityevent) | 否 | 播放媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [FavoriteMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#favoritemediaentityevent) | 是 | 回调函数，返回收藏媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [FavoriteMediaEntityEvent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#favoritemediaentityevent) | 否 | 收藏媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| userInfo | [UserInfo](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#userinfo) | 是 | 用户信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [DialogControlType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#dialogcontroltype) | 是 | 对话框控制类型。 |
| dialogInfo | [DialogInfo](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#dialoginfo) | 是 | 对话框信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| single | [Single](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#single) | 是 | 当前单曲。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| entities | [MediaEntity](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#mediaentity)[] | 是 | 媒体实体的数组。 |
...
| tabContent | [MediaTabContent](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#mediatabcontent) | 是 | 媒体标签页内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| playlist | [PageMediaEntity](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#pagemediaentity) | 是 | 分页媒体实体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| single | [MediaEntity](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#mediaentity) | 是 | 媒体实体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| actionType | [ActionType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#actiontype) | 是 | 操作类型。 |
| customType | [CustomType](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-t/arkts-apis-avmusictemplate-t#customtype) | 是 | 自定义类型。 |
| customElement | [CustomElement](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#customelement) | 是 | 自定义元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| settingItems | [SettingItem](/ref/avsession-api/avsession-arkts/apis-avsession-avmusictemplate/arkts-apis-avmusictemplate-i/arkts-apis-avmusictemplate-i#settingitem)[] | 是 | 设置项数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent#wantagent) | 是 | 能力信息。 |
