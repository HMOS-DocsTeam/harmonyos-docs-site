...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-avsessioncontroller
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-avsession-avsessioncontroller
---
...
![](../../../../images/e1d593f7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)&gt; | 是 | 回调函数，返回远端播放状态。 |

****错误码：****

以下错误码的详细介绍请参见[媒体会话管理错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avsession/errorcode-avsession)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)&gt; | Promise对象,返回远端播放状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10)&gt; | Promise对象，返回会话元数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10)&gt; | 是 | 回调函数，返回会话元数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt;&gt; | Promise对象。返回播放列表队列。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt;&gt; | 是 | 回调函数，返回播放列表队列。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[媒体会话管理错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avsession/errorcode-avsession)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)&gt; | Promise对象，返回播放设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)&gt; | 是 | 回调函数，返回播放设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [KeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent) | 是 | 按键事件。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent)&gt; | Promise对象，返回在[setLaunchAbility](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#setlaunchability10)保存的对象，包括应用的相关属性信息，如bundleName，abilityName，deviceId等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent)&gt; | 是 | 回调函数。返回在[setLaunchAbility](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#setlaunchability10)保存的对象，包括应用的相关属性信息，如bundleName，abilityName，deviceId等。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[AVControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcontrolcommandtype10)&gt;&gt; | Promise对象。返回有效命令的集合。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[AVControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcontrolcommandtype10)&gt;&gt; | 是 | 回调函数，返回有效命令的集合。 |
...
![](../../../../images/2ee4d9f9/note_3.0-zh-cn.png) 

媒体控制方在使用sendControlCommand命令前，需要确保控制对应的媒体会话注册了对应的监听，注册媒体会话相关监听的方法请参见接口[on('play')](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#onplay10)、[on('pause')](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#onpause10)等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| command | [AVControlCommand](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcontrolcommand10) | 是 | 会话的相关命令和命令相关参数。 |
...
![](../../../../images/62f2d96e/note_3.0-zh-cn.png) 
...
![](../../../../images/c21b4b12/note_3.0-zh-cn.png) 

参数args支持的数据类型有：字符串、数字、布尔、对象、数组和文件描述符等，详细介绍请参见[@ohos.app.ability.Want (Want)](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)。
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[媒体会话管理错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avsession/errorcode-avsession)。
...
![](../../../../images/bd6636b0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| extraEvent | string | 是 | 远端分布式事件类型。可获取的事件类型来自于[setExtras](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#setextras10)。  对Wearable设备类型，额外提供以下预设的事件类型：  'AUDIO\_GET\_VOLUME'：获取远端设备音量。  'AUDIO\_GET\_AVAILABLE\_DEVICES'：获取远端所有可连接设备。  'AUDIO\_GET\_PREFERRED\_OUTPUT\_DEVICE\_FOR\_RENDERER\_INFO'：获取远端实际发声设备。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ExtraInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#extrainfo18)&gt; | Promise对象，返回远端分布式媒体提供方设置的自定义媒体数据包。  参数ExtraInfo支持的数据类型有：字符串、数字、布尔、对象、数组和文件描述符等，详细介绍请参见[@ohos.app.ability.Want (Want)](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [DesktopLyricState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#desktoplyricstate23) | 是 | 桌面歌词状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[DesktopLyricState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#desktoplyricstate23)&gt; | Promise对象。返回桌面歌词状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[DesktopLyricState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#desktoplyricstate23)&gt; | 是 | 回调函数。返回桌面歌词状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[DesktopLyricState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#desktoplyricstate23)&gt; | 否 | 回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。  该参数为可选参数，若不填写该参数，则认为取消所有桌面歌词状态变更事件监听。 |
...
| callback | (data: [AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10)) => void | 是 | 回调函数，参数data是需要更新的元数据。只包含需要更新的元数据属性，不代表当前全量的元数据。 |
...
| callback | (data: [AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10)) => void | 否 | 回调函数，参数data是需要更新的元数据。只包含需要更新的元数据属性，并不代表当前全量的元数据。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (state: [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)) => void | 是 | 回调函数，参数state是需要更新的播放状态。只包含需要更新的播放状态属性，并不代表当前全量的播放状态。 |
...
| callback | (state: [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)) => void | 否 | 回调函数，参数state是需要更新的播放状态。只包含需要更新的播放状态属性，并不代表当前全量的播放状态。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;[CallMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#callmetadata11)&gt; | 是 | 回调函数，参数callmetadata是变化后的通话元数据。 |
...
| callback | Callback&lt;[CallMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#callmetadata11)&gt; | 否 | 回调函数，参数calldata是变化后的通话原数据。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;[AVCallState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcallstate11)&gt; | 是 | 回调函数，参数callstate是变化后的通话状态。 |
...
| callback | Callback&lt;[AVCallState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcallstate11)&gt; | 否 | 回调函数，参数callstate是变化后的通话状态。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (commands: Array&lt;[AVControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcontrolcommandtype10)&gt;) =&gt; void | 是 | 回调函数。参数commands是有效命令的集合。 |
...
| callback | (commands: Array&lt;[AVControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcontrolcommandtype10)&gt;) =&gt; void | 否 | 回调函数。参数commands是有效命令的集合。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (state: [ConnectionState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#connectionstate10), device: [OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)) => void | 是 | 回调函数，参数device是设备相关信息。 |
...
| callback | (state: [ConnectionState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#connectionstate10), device: [OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)) => void | 否 | 回调函数，参数device是设备相关信息。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
on(type: 'queueItemsChange', callback: (items: Array<[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)>) => void): void
...
| callback | (items: Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt;) =&gt; void | 是 | 回调函数，items为变化的播放列表。 |
...
off(type: 'queueItemsChange', callback?: (items: Array<[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)>) => void): void
...
| callback | (items: Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt;) =&gt; void | 否 | 回调函数，参数items是变化的播放列表。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10) | 当前会话的播放状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10) | 会话元数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVCallState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcallstate11)&gt; | Promise对象，返回通话状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVCallState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcallstate11)&gt; | 是 | 回调函数，返回通话状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[CallMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#callmetadata11)&gt; | Promise对象，返回会话元数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[CallMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#callmetadata11)&gt; | 是 | 回调函数，返回会话元数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 当前会话播放列表队列。 |
...
| 类型 | 说明 |
| --- | --- |
| [OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10) | 当前输出设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[AVControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcontrolcommandtype10)&gt; | 会话支持的有效命令的集合。 |
