...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-avsession
kit: 媒体
last_updated: "2026-04-22"
slug: arkts-apis-avsession-avsession
---

# Interface (AVSession)

调用[avSession.createAVSession](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-f/arkts-apis-avsession-f#avsessioncreateavsession10)后，返回会话的实例，可以获得会话ID，完成设置元数据，播放状态信息等操作。

![](../../../../images/1335f9da/note_3.0-zh-cn.png) 
...
| sessionType10+ | [AVSessionType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avsessiontype10) | 是 | 否 | AVSession会话类型。  ****元服务API：**** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [AVMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avmetadata10) | 是 | 会话元数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [CallMetadata](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#callmetadata11) | 是 | 通话会话元数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [AVCallState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcallstate11) | 是 | 通话状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10) | 是 | 会话播放状态，包括状态、倍数、循环模式等信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ability | [WantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent) | 是 | 应用的相关属性信息，如bundleName，abilityName，deviceId等。 |
...
![](../../../../images/2a6dd038/note_3.0-zh-cn.png) 

参数args支持的数据类型有：字符串、数字、布尔值、对象、数组和文件描述符等，详细介绍请参见[@ohos.app.ability.Want(Want)](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[媒体会话管理错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avsession/errorcode-avsession)。
...
![](../../../../images/980e1b60/note_3.0-zh-cn.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 是 | 播放列表单项的队列，用以表示播放列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| extras | {[key: string]: Object} | 是 | 需要传递的自定义媒体数据包键值对。  ****说明：**** 参数extras支持的数据类型有：字符串、数字、布尔值、对象、数组和文件描述符等，详细介绍请参见[@ohos.app.ability.Want(Want)](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVSessionController](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsessioncontroller/arkts-apis-avsession-avsessioncontroller)&gt; | Promise对象。返回会话控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVSessionController](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsessioncontroller/arkts-apis-avsession-avsessioncontroller)&gt; | 是 | 回调函数。返回会话控制器。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVCastController](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avcastcontroller/arkts-apis-avsession-avcastcontroller)&gt; | Promise对象。返回投播控制器实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVCastController](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avcastcontroller/arkts-apis-avsession-avcastcontroller)&gt; | 是 | 回调函数，返回投播控制器实例。 |
...
应用将通过回调接收控制器发送的[CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)&gt; | 是 | 回调函数。当监听事件注册成功，err为undefined，否则为错误对象。 |
...
应用将通过回调接收控制器发送的快进时间参数，以及对应的[CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | TwoParamCallback&lt;number, [CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)&gt; | 是 | 回调函数。用于处理'fastForward'操作。 |
...
应用将通过回调接收控制器发送的快退时间参数，以及对应的[CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | TwoParamCallback&lt;number, [CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)&gt; | 是 | 回调函数。用于处理'rewind'操作。 |
...
| callback | (mode: [LoopMode](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#loopmode10)) => void | 是 | 回调函数。参数mode是循环模式。 |
...
| callback | Callback&lt;[LoopMode](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#loopmode10)&gt; | 是 | 回调函数。参数表示目标循环模式。 |
...
| callback | (event: [KeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent)) => void | 是 | 回调函数。参数event是按键事件。 |
...
设置播放设备变化的监听事件。应用接入[multimedia.avCastPicker (投播组件)](/ref/avsession-api/avsession-comp/ohos-multimedia-avcastpicker/ohos-multimedia-avcastpicker)，当用户通过组件切换设备时，会收到设备切换的回调。
...
| callback | (state: [ConnectionState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#connectionstate10), device: [OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)) => void | 是 | 回调函数，参数device是设备相关信息。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (command :string, args:{[key: string]: Object}) => void | 是 | 回调函数，command为变化的自定义控制命令名，args为自定义控制命令的参数，参数内容与[sendCommonCommand](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsessioncontroller/arkts-apis-avsession-avsessioncontroller#sendcommoncommand10)方法设置的参数内容完全一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;[CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)&gt; | 否 | 回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | TwoParamCallback&lt;number, [CommandInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#commandinfo22)&gt; | 否 | 回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (mode: [LoopMode](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#loopmode10)) => void | 否 | 回调函数，参数mode是循环模式。  - 当监听事件取消成功，err为undefined，否则返回错误对象。  - 该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;[LoopMode](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#loopmode10)&gt; | 否 | 回调函数，参数表示目标循环模式。  - 当监听事件取消成功，err为undefined，否则返回错误对象。  - 该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (event: [KeyEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keyevent/js-apis-keyevent)) => void | 否 | 回调函数，参数event是按键事件。  当监听事件取消成功，err为undefined，否则返回错误对象。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | (state: [ConnectionState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#connectionstate10), device: [OutputDeviceInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#outputdeviceinfo10)) => void | 否 | 回调函数，参数device是设备相关信息。  当监听事件取消成功，err为undefined，否则返回错误对象。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;[CastDisplayInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#castdisplayinfo12)&gt; | 是 | 回调函数。参数是扩展屏投播显示设备信息。 |
...
| callback | Callback&lt;[CastDisplayInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#castdisplayinfo12)&gt; | 否 | 回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[CastDisplayInfo](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#castdisplayinfo12)&gt;&gt; | Promise对象，返回当前系统中所有支持扩展屏投播的显示设备。 |
...
![](../../../../images/b5582548/note_3.0-zh-cn.png) 
...
![](../../../../images/3de44950/note_3.0-zh-cn.png) 
