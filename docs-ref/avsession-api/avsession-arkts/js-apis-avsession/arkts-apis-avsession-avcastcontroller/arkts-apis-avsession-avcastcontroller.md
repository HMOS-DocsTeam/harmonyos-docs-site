...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avsession-avcastcontroller
kit: 媒体
...
在投播建立后，调用[avSession.getAVCastController](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#getavcastcontroller10)后，返回会话控制器实例。控制器可查看会话ID，并可完成对会话发送命令及事件，获取会话元数据，播放状态信息等操作。

![](../../../../images/ec4fc9bd/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[DecoderType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#decodertype19)&gt;&gt; | Promise对象。返回远端设备所支持的解码能力列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| decoderType | [DecoderType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#decodertype19) | 是 | 设备所支持的解码格式。  设备所支持的解码格式包括：  'OH\_AVCODEC\_MIMETYPE\_VIDEO\_AVC'：VIDEO AVC，  'OH\_AVCODEC\_MIMETYPE\_VIDEO\_HEVC'：VIDEO HEVC，  'OH\_AVCODEC\_MIMETYPE\_AUDIO\_VIVID'：AUDIO AV3A。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ResolutionLevel](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-e/arkts-apis-avsession-e#resolutionlevel19)&gt; | Promise对象。返回远端设备推荐的分辨率。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[hdrCapability.HDRFormat](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-hdrcapability/js-apis-hdrcapability#hdrformat)&gt;&gt; | Promise对象。返回远端设备所支持的HDR能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| command | [AVCastControlCommand](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avcastcontrolcommand10) | 是 | 会话的相关命令和命令相关参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| item | [AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10) | 是 | 播放列表中单项的相关属性。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。当命令发送成功，err为undefined，否则返回错误对象。 |
...
![](../../../../images/89395da4/note_3.0-zh-cn.png) 
...
![](../../../../images/51793f13/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 是 | 回调函数。当命令发送成功，err为undefined，否则返回错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | Promise对象，返回当前的播放资源，否则返回错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[AVCastControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcastcontrolcommandtype10)&gt;&gt; | 是 | 回调函数。返回当前支持的命令。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[AVCastControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcastcontrolcommandtype10)&gt;&gt; | Promise对象，返回当前支持的命令。 |
...
| callback | (state: [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)) => void | 是 | 回调函数，参数state是变化后的播放状态。 |
...
| callback | (state: [AVPlaybackState](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avplaybackstate10)) => void | 否 | 回调函数，参数state是变化后的播放状态。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 是 | 回调函数，参数AVQueueItem是当前正在播放的媒体内容。 |
...
| callback | Callback&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 是 | 回调函数，参数AVQueueItem是当前正在播放的媒体内容。当监听事件注册成功，err为undefined，否则返回错误对象。 |
...
| callback | Callback&lt;[AVQueueItem](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-i/arkts-apis-avsession-i#avqueueitem10)&gt; | 否 | 回调函数，参数AVQueueItem是当前正在播放的媒体内容。当监听事件取消成功，err为undefined，否则返回错误对象。该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
| callback | Callback&lt;Array&lt;[AVCastControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcastcontrolcommandtype10)&gt;&gt; | 是 | 回调函数。参数commands是有效命令的集合。 |
...
| callback | Callback&lt;Array&lt;[AVCastControlCommandType](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#avcastcontrolcommandtype10)&gt;&gt; | 否 | 回调函数。参数commands是有效命令的集合。  该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)、[Media错误码](/ref/media-api/media-arkts-errcode/errorcode-media/errorcode-media)以及[媒体会话管理错误码](/ref/avsession-api/avsession-arkts-errcode/errorcode-avsession/errorcode-avsession)。
...
| callback | [KeyRequestCallback](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#keyrequestcallback12) | 是 | 回调函数，媒体资源及许可证请求数据。 |
...
| callback | [KeyRequestCallback](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-t/arkts-apis-avsession-t#keyrequestcallback12) | 否 | 回调函数。当监听事件取消成功，err为undefined，否则返回错误对象。该参数为可选参数，若不填写该参数，则认为取消所有相关会话的事件监听。 |
