...
title: "媒体会话管理错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-avsession
kit: 媒体
last_updated: "2026-04-22"
slug: errorcode-avsession
---

# 媒体会话管理错误码

![](../../../images/58e7abfb/note_3.0-zh-cn.png) 
...
调用[enableDesktopLyric](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-avsession/arkts-apis-avsession-avsession#enabledesktoplyric23)接口启用桌面歌词功能。
...
建议使用[isDesktopLyricSupported](/ref/avsession-api/avsession-arkts/js-apis-avsession/arkts-apis-avsession-f/arkts-apis-avsession-f#avsessionisdesktoplyricsupported23)接口查询当前设备是否支持桌面歌词功能。
