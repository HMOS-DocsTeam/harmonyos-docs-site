...
LoginWithHuaweiIDButton需要配合[loginComponentManager](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager)一起使用，用于实现华为账号登录功能。LoginWithHuaweiIDButton组件文本内容默认支持多语言。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| params | [LoginWithHuaweiIDButtonParams](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager#loginwithhuaweiidbuttonparams) | 是 | - | LoginWithHuaweiIDButton组件参数。 |
| controller | [LoginWithHuaweiIDButtonController](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager#loginwithhuaweiidbuttoncontroller) | 是 | - | LoginWithHuaweiIDButton组件控制器用来接收组件的点击事件。 |
