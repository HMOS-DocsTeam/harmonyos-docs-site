...
LoginPanel需要配合[loginComponentManager](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager)一起使用，用于实现华为账号登录功能。LoginPanel内的按钮文本默认支持多语言。
...
| params | [LoginPanelParams](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager#loginpanelparams) | 是 | - | LoginPanel组件参数。 |
| controller | [LoginPanelController](/ref/account-api/account-arkts-component/account-api-component-manager/account-api-component-manager#loginpanelcontroller) | 是 | - | LoginPanel组件控制器用来接收组件的点击事件。 |
