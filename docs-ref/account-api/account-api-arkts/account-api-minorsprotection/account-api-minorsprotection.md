...
| ****名称**** | ****值**** | ****说明**** |
| --- | --- | --- |
| MINORS\_MODE\_NOT\_ENABLED | [1009900002](/ref/account-api/account-api-error-code/account-api-error-code#section1009900002-未成年人模式未开启) | 未成年人模式未开启。 |
| USER\_CANCELED | [1009900003](/ref/account-api/account-api-error-code/account-api-error-code#section1009900003-用户取消操作) | 用户取消操作。 |
| MINORS\_MODE\_ALREADY\_ON | [1009900005](/ref/account-api/account-api-error-code/account-api-error-code#section1009900005-未成年人模式已经开启) | 未成年人模式已经开启。 |
| MINORS\_MODE\_ALREADY\_OFF | [1009900006](/ref/account-api/account-api-error-code/account-api-error-code#section1009900006-未成年人模式已经关闭) | 未成年人模式已经关闭。 |
| UNSUPPORTED\_ACCOUNT | [1009900007](/ref/account-api/account-api-error-code/account-api-error-code#section1009900007-不支持的账号) | 不支持的账号。 |
| SERVICE\_NOT\_AVAILABLE | [1009900011](/ref/account-api/account-api-error-code/account-api-error-code#section1009900011-服务不可用) | 服务不可用。 |
...
| [1001502009](/ref/account-api/account-api-error-code/account-api-error-code#section1001502009-内部错误) | Internal error. |
| [1009900002](/ref/account-api/account-api-error-code/account-api-error-code#section1009900002-未成年人模式未开启) | The minors mode is not enabled. |
...
| [401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败) | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types. |
| [1001502009](/ref/account-api/account-api-error-code/account-api-error-code#section1001502009-内部错误) | Internal error. |
| [1009900003](/ref/account-api/account-api-error-code/account-api-error-code#section1009900003-用户取消操作) | The user canceled the operation. |
| [1009900005](/ref/account-api/account-api-error-code/account-api-error-code#section1009900005-未成年人模式已经开启) | The minors mode is already on. |
| [1009900007](/ref/account-api/account-api-error-code/account-api-error-code#section1009900007-不支持的账号) | Unsupported HUAWEI ID. |
| [1009900011](/ref/account-api/account-api-error-code/account-api-error-code#section1009900011-服务不可用) | Service not available. |
...
| [1001502009](/ref/account-api/account-api-error-code/account-api-error-code#section1001502009-内部错误) | Internal error. |
| [1009900003](/ref/account-api/account-api-error-code/account-api-error-code#section1009900003-用户取消操作) | The user canceled the operation. |
| [1009900006](/ref/account-api/account-api-error-code/account-api-error-code#section1009900006-未成年人模式已经关闭) | The minors mode is already off. |
| [1009900011](/ref/account-api/account-api-error-code/account-api-error-code#section1009900011-服务不可用) | Service not available. |
