...
![](../../../../images/f39890a8/caution_3.0-zh-cn.png) 
...
![](../../../../images/9c0e544b/note_3.0-zh-cn.png) 
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access\_token | 是 | String | 通过[获取用户级凭证](/ref/account-api/account-api-rest/account-api-obtain-token/account-api-obtain-user-token/account-api-obtain-user-token)获取的Access Token。  ****说明：****  本场景下Access Token只能使用一次，再次使用会报“access forbidden”错误。 |
...
![](../../../../images/c951327a/note_3.0-zh-cn.png) 
