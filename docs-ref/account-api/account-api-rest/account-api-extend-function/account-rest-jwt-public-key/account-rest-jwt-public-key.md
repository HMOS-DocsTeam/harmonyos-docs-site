...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-rest-jwt-public-key
kit: 应用服务
last_updated: "2026-04-22"
slug: account-rest-jwt-public-key
---

# 获取验证ID Token的JWT公钥信息

![](../../../../images/60090952/caution_3.0-zh-cn.png) 
...
![](../../../../images/092a14c5/note_3.0-zh-cn.png) 

- JWT公钥信息每天0点进行刷新。
- PS256与RS256算法的JWT公钥信息一致。具体如何通过JWT公钥解析验证ID Token，详见[服务端解析与验证](/account-kit-guide/account-faq/account-faq-12#服务端解析与验证) 。
