...
![](../../../../images/85e2260e/caution_3.0-zh-cn.png) 
...
获取应用级凭证，访问被应用级权限管控的资源，例如[通过OpenID获取UnionID](/ref/account-api/account-api-rest/account-api-extend-function/account-api-get-unionid/account-api-get-unionid)。
