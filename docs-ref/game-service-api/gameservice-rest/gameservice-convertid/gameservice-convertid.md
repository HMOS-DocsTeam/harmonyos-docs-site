...
- ****接口URL****：&lt;`https://jos-open-api.cloud.huawei.com/gameservice/api/gbClientApi&gt;`
  ...
  ![](../../../images/0076586c/note_3.0-zh-cn.png) 
...
| gamePlayerId | 是 | String | HarmonyOS 5.0及以上游戏的玩家标识，通过调用[unionLogin](/ref/game-service-api/gameservice-arkts/gameservice-gameplayer/gameservice-gameplayer#gameplayerunionlogin)接口返回。 |
