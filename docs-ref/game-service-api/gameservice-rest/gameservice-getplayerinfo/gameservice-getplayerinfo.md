...
- ****接口URL****：&lt;`https://jos-open-api.cloud.huawei.com/gameservice/api/gbClientApi&gt;`
  ...
  ![](../../../images/dc32110d/note_3.0-zh-cn.png) 
...
| accessToken | 是 | String | 游戏调用华为账号的[获取用户级凭证](/ref/account-api/account-api-rest/account-api-obtain-token/account-api-obtain-user-token/account-api-obtain-user-token)接口获取到的Access Token。 |
