...
![](../../../../images/119f18c9/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[电话子系统错误码](/ref/system-network-api/telephony-api/telephony-arkts-errcode/errorcode-telephony/errorcode-telephony)。
...
| --- | --- | --- | --- |
| context | [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 应用上下文。 |
| predicates | [dataSharePredicates.DataSharePredicates](/ref/arkdata-api/arkdata-arkts/js-apis-data-datasharepredicates/js-apis-data-datasharepredicates) | 是 | 查询语句。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| cardType | [VCardType](#vcardtype) | 否 | 是 | VCard版本类型 (默认值为VERSION\_21)。 |
