...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Telephony\_NetworkState](/ref/system-network-api/telephony-api/telephony-c/telephony-struct/capi-telephony-telephony-networkstate/capi-telephony-telephony-networkstate) | Telephony\_NetworkState | 网络状态信息。 |
