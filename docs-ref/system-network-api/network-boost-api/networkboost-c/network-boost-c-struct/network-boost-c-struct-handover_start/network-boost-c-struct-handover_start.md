...
| [NetworkBoost\_DataSpeedAction](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-struct/network-boost-c-struct-data_speed_action/network-boost-c-struct-data_speed_action) [dataSpeedAction](#dataspeedaction) | 老链路的发包建议。 |
