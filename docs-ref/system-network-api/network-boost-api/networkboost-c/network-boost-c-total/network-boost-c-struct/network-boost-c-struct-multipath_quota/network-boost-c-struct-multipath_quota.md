...
| 名称 | 描述 |
| --- | --- |
| [NetworkBoost\_MultiPathQuotaInfo](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-total/network-boost-c-struct/network-boost-c-struct-multipath_quotainfo/network-boost-c-struct-multipath_quotainfo) [used](#used) | 应用已使用配额信息。 |
| [NetworkBoost\_MultiPathQuotaInfo](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-total/network-boost-c-struct/network-boost-c-struct-multipath_quotainfo/network-boost-c-struct-multipath_quotainfo) [remaining](#remaining) | 应用剩余使用配额信息。 |
