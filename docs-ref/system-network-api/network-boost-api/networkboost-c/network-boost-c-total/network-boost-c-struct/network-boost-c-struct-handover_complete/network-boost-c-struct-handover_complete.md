...
| [NetworkBoost\_DataSpeedAction](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-total/network-boost-c-struct/network-boost-c-struct-data_speed_action/network-boost-c-struct-data_speed_action) [oldDataSpeedAction](#olddataspeedaction) | 老链路发包建议。 |
| bool [pathTypeChanged](#pathtypechanged) | 新老链路类型是否发生变更。true表示发生变化，如Wi-Fi&lt;-&gt;蜂窝。false表示没有发生变化。 |
| [NetworkBoost\_NetHandle](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-total/network-boost-c-struct/network-boost-c-struct-net_handle/network-boost-c-struct-net_handle) [newNetHandle](#newnethandle) | 新链路的NetHandle信息。 |
...
| [NetworkBoost\_DataSpeedAction](/ref/system-network-api/network-boost-api/networkboost-c/network-boost-c-total/network-boost-c-struct/network-boost-c-struct-data_speed_action/network-boost-c-struct-data_speed_action) [newDataSpeedAction](#newdataspeedaction) | 新链路发包建议。 |
