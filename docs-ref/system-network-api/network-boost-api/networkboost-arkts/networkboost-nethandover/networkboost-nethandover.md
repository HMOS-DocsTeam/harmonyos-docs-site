...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/networkboost-nethandover
kit: 系统
last_updated: "2026-04-22"
slug: networkboost-nethandover
---
...
涉及错误码均为通用错误码，[通用错误码详细描述查看](/ref/errorcode-universal/errorcode-universal)。
...
| newNetHandle | [connection.NetHandle](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#nethandle) | 否 | 是 | 新链路的NetHandle信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dataSpeedSimpleAction | [netQuality.DataSpeedSimpleAction](/ref/system-network-api/network-boost-api/networkboost-arkts/networkboost-netquality/networkboost-netquality#dataspeedsimpleaction) | 否 | 否 | 应用发包策略的简单建议。 |
| linkUpBandwidth | [netQuality.RateBps](/ref/system-network-api/network-boost-api/networkboost-arkts/networkboost-netquality/networkboost-netquality#ratebps) | 否 | 否 | 老链路上行带宽。 |
| linkDownBandwidth | [netQuality.RateBps](/ref/system-network-api/network-boost-api/networkboost-arkts/networkboost-netquality/networkboost-netquality#ratebps) | 否 | 否 | 老链路下行带宽。 |
...
| netHandle | [connection.NetHandle](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#nethandle) | 否 | 否 | 多网链路的netHandle。 |
| pathState | [PathState](#pathstate) | 否 | 否 | 多网链路状态。 |
| pathType | [netQuality.PathType](/ref/system-network-api/network-boost-api/networkboost-arkts/networkboost-netquality/networkboost-netquality#pathtype) | 否 | 否 | 多网链路类型。 |
