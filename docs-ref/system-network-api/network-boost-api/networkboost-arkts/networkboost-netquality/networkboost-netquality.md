...
| callback | Callback&lt;Array&lt;[NetworkQos](#networkqos)&gt;&gt; | 是 | 回调函数，返回网络Qos变化的详细信息。 |
...
| callback | Callback&lt;Array&lt;[NetworkQos](#networkqos)&gt;&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;Array&lt;[NetworkScene](#networkscene)&gt;&gt; | 是 | 回调函数，返回网络场景变化的详细信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"netSceneChange"字符串，表示网络场景变化事件。 |
| callback | Callback&lt;Array&lt;[NetworkScene](#networkscene)&gt;&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
