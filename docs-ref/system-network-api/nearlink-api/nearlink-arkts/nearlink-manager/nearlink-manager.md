...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-manager
kit: 系统
last_updated: "2026-04-22"
slug: nearlink-manager
---
...
| preState | [PairingState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#pairingstate) | 否 | 否 | 本次上报之前的配对状态。 |
| state | [PairingState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#pairingstate) | 否 | 否 | 当前配对状态。 |
...
| preState | [ConnectionState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#connectionstate) | 否 | 否 | 本次上报之前的连接状态。 |
| state | [ConnectionState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#connectionstate) | 否 | 否 | 当前连接状态。 |
...
| state | [AcbState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#acbstate) | 否 | 否 | 当前逻辑链路连接状态。 |
