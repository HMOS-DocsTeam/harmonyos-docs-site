...
![](../../../../images/6e9f69df/note_3.0-zh-cn.png) 
...
在设备已配对的情况下再调用[startPairing](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-remote-device/nearlink-remote-device#startpairing)发起配对，会返回该错误码。
