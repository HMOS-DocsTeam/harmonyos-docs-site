...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-data-transfer-api
kit: 系统
last_updated: "2026-04-22"
slug: nearlink-data-transfer-api
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uuid | string | 是 | 可填写16字节星闪服务UUID，或填写2字节支持数传的星闪标准服务UUID。UUID格式参考“[星闪标准服务标识](/system-network/nearlink-kit-guide/nearlink-faq#星闪标准服务uuid的格式)”。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uuid | string | 是 | 可填写16字节星闪服务UUID，或填写2字节支持数传的星闪标准服务UUID。UUID格式参考“[星闪标准服务](/system-network/nearlink-kit-guide/nearlink-faq#星闪标准服务uuid的格式)”。 |
...
| 类型 | 说明 |
| --- | --- |
| [ConnectionState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#connectionstate) | 和远端设备的星闪端口通道连接状态。 |
...
| uuid | string | 否 | 否 | 星闪服务UUID，例如：37bea880-fc70-11ea-b720-000000004386。UUID格式参考[星闪标准服务UUID](/system-network/nearlink-kit-guide/nearlink-faq#星闪标准服务uuid的格式)。 |
...
| state | [ConnectionState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-constant/nearlink-constant#connectionstate) | 否 | 否 | 与远端设备的连接状态。 |
