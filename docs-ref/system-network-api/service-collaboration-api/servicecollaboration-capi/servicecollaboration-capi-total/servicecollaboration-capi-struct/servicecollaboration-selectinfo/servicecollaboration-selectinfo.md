...
使用[HMS\_ServiceCollaboration\_StartCollaboration](/ref/system-network-api/service-collaboration-api/servicecollaboration-capi/servicecollaboration-capi-model/servicecollaboration-capi-module/servicecollaboration-capi-module#hms_servicecollaboration_startcollaboration)触发跨设备互通时，被选择的设备信息。
...
| 名称 | 描述 |
| --- | --- |
| [ServiceCollaborationFilterType](/ref/system-network-api/service-collaboration-api/servicecollaboration-capi/servicecollaboration-capi-model/servicecollaboration-capi-module/servicecollaboration-capi-module#servicecollaborationfiltertype-1) [serviceFilterType](#servicefiltertype) | 开发者期望的设备能力类型。 |
