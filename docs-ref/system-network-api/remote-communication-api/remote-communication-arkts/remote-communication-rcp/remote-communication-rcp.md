...
![](../../../../images/7fd90abd/note_3.0-zh-cn.png) 
...
错误码的详细介绍请参见[API错误码](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code)。

| 错误码ID | 错误信息 |
| --- | --- |
| [401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败) | Parameter error. |
| [1007900994](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900994-会话数达到限制) | Sessions number reached limit. |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Response](#response)&gt; | Promise对象。此拦截器对下一个拦截器做拦截、修改、透传等操作后，返回此拦截器提供的[Response](#response)对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| identifier | string | 否 | cookie仓库标识。只能包含大写字母、小写字母和下划线。  传入undefined、null或空字符串时默认为'default'。  传入其他字符时抛出[1007900401](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900401-接口参数错误)错误。  具有同样标识的cookie仓库共享cookie信息（即具有同样标识的cookie仓库实例使用起来如同同一个实例）。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900401](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900401-接口参数错误) | Parameter error. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cookies | [ResponseCookie](#responsecookie) | [ResponseCookie](#responsecookie)[] | 是 | 传入cookie仓库的cookie。cookie仓库里实际会存如下7项数据：domain、httpOnly、path、isSecure、expires、name和value。当两个cookie的name、domain、path三项完全相同时，视为同一个cookie。  path默认为'/'。  domain不设置或者设置为空字符串时抛出[1007900401](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900401-接口参数错误)错误。  maxAge会转化为expires。maxAge和expires都设置时，使用maxAge。  expires应是符合[RFC 7231](https://www.rfc-editor.org/rfc/rfc7231.html)协议，并且是GMT时间的字符串，精确到秒，例如：'Wed, 21 Oct 2025 07:28:00 GMT'。当expires字段传入无效字符串时抛出[1007900401](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900401-接口参数错误)错误。  系统会不定期清除expires过期的cookie。传入空数组时，仅将cookie仓库中现有的cookie存储到本地。 |
...
| --- | --- |
| [1007900401](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900401-接口参数错误) | Parameter error. |
| [1007900999](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900999-内部错误) | Internal Error. |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ResponseCookie](#responsecookie)[]&gt; | Promise对象，返回[ResponseCookie](#responsecookie)列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ResponseCookie](#responsecookie)[]&gt; | Promise对象，返回匹配url的cookie列表。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败) | 当开发者设置TLS最小版本大于最大版本时，系统将抛出该参数错误码。表示Parameter error. |
...
请求的地址类型，链接到@[ohos.url](/ref/arkts-api/arkts-arkts/js-apis-url/js-apis-url)中的URL。
...
提供 x509 证书类型，链接到@[ohos.security.cert](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert)中的X509Cert。
...
文件系统中的文件，链接到@[ohos.file.fs](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)中的File。
...
可以随机访问的文件，链接到@[ohos.file.fs](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)中的RandomAccessFile。
...
提供数据流的形式，链接到@[ohos.file.fs](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)中的Stream。
...
| 类型 | 说明 |
| --- | --- |
| [TargetFile](#targetfile) | 回调函数，返回[TargetFile](#targetfile)对象。 |
| Promise&lt;[TargetFile](#targetfile)&gt; | Promise对象，返回[TargetFile](#targetfile)对象，表示下载数据的存放位置。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900990](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900990-内存不足) | Out of memory. |
...
返回默认的JSON反序列化结果，如需要定制JSON反序列化方式，请参考[JSON解析与生成](/ref/arkts-api/arkts-arkts/js-apis-json/js-apis-json)。
...
根据解析配置对[toString](#tostring)方法返回的字符串进行JSON解析，并返回解析后的结果。详情请参阅[JSON解析与生成](/ref/arkts-api/arkts-arkts/js-apis-json/js-apis-json)的详细介绍。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [json.ParseOptions](/ref/arkts-api/arkts-arkts/js-apis-json/js-apis-json#parseoptions) | 是 | 解析配置项。支持定义处理BigInt的模式。 |
...
![](../../../../images/d6266357/note_3.0-zh-cn.png) 
...
![](../../../../images/5a822848/note_3.0-zh-cn.png) 
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900985](/ref/system-network-api/remote-communication-api/remote-communication-error-code/remote-communication-error-code#section1007900985-文件系统io错误) | File system IO error. |
