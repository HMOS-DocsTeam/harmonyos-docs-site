...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/nNpBHWCvT1KmGHSygOA3vg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260423T145440Z&HW-CC-Expire=86400&HW-CC-Sign=ECBD03AE2F10E443AEDE98678FDDEBDE867D24860D4BBF56312695D995162342) 
...
当请求数据量超大时推荐使用[OnDataReceive](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#ondatareceive)。
...
可能是因为[StaticDnsRule](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#staticdnsrule)或者[DynamicDnsRule](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#dynamicdnsrule)传入的IP地址格式不正确。

****处理步骤****

确认[StaticDnsRule](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#staticdnsrule)或者[DynamicDnsRule](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#dynamicdnsrule)传入参数格式是否正确可用。
...
通过使用[PathPreference](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#pathpreference)的'cellular'模式拉起蜂窝数据连接时，因为条件不满足而导致激活蜂窝超时。
...
URPC请求超出开发者配置的[UrpcConnectConfiguration](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-urpcapi/remote-communication-urpcapi#urpcconnectconfiguration)时长。
...
排查[UrpcStub](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-urpcapi/remote-communication-urpcapi#urpcstub)类的声明和使用是否正确。
