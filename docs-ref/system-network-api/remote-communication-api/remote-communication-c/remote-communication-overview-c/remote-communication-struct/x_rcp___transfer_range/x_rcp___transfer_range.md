...
链式存储。指向下一个[Rcp\_TransferRange](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-overview-c/remote-communication-struct/x_rcp___transfer_range/x_rcp___transfer_range)。
