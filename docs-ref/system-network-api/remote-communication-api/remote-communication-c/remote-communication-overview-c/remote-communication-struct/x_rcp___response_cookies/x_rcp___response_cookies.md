...
| struct [Rcp\_ResponseCookies](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-overview-c/remote-communication-struct/x_rcp___response_cookies/x_rcp___response_cookies) \* [next](#next) | 链式存储。指向下一个[Rcp\_ResponseCookies](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-overview-c/remote-communication-struct/x_rcp___response_cookies/x_rcp___response_cookies)的指针。 |
...
链式存储。指向下一个[Rcp\_ResponseCookies](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-overview-c/remote-communication-struct/x_rcp___response_cookies/x_rcp___response_cookies)的指针。
