...
| [Rcp\_IpAddress](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-overview-c/remote-communication-struct/x_rcp___ip_address/x_rcp___ip_address) \* [ipAddresses](#ipaddresses) | 表示[Rcp\_StaticDnsRuleItem.host](#host)对应的IP地址。 |
