...
| struct [Rcp\_IpAddress](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___ip_address/x_rcp___ip_address) \* [next](#next) | 链式存储。指向下一个[Rcp\_IpAddress](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___ip_address/x_rcp___ip_address)。 |
...
链式存储。指向下一个[Rcp\_IpAddress](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___ip_address/x_rcp___ip_address)。
