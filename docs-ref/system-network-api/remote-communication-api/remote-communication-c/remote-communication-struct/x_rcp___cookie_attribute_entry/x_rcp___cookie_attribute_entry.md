...
| struct [Rcp\_CookieAttributeEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___cookie_attribute_entry/x_rcp___cookie_attribute_entry) \* [next](#next) | 链式存储。指向下一个[Rcp\_CookieAttributeEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___cookie_attribute_entry/x_rcp___cookie_attribute_entry)的指针。 |
...
链式存储。指向下一个[Rcp\_CookieAttributeEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___cookie_attribute_entry/x_rcp___cookie_attribute_entry)的指针。
