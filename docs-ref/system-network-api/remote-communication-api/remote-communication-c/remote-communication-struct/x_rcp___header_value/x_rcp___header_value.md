...
| struct [Rcp\_HeaderValue](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_value/x_rcp___header_value) \* [next](#next) | 链式存储。指向下一个[Rcp\_HeaderValue](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_value/x_rcp___header_value)。 |
...
链式存储。指向下一个[Rcp\_HeaderValue](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_value/x_rcp___header_value)。
