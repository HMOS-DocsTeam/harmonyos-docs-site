...
| [Rcp\_HeaderValue](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_value/x_rcp___header_value) \* [value](#value) | 值。 |
| struct [Rcp\_HeaderEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_entry/x_rcp___header_entry) \* [next](#next) | 链式存储。指向下一个键值对[Rcp\_HeaderEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_entry/x_rcp___header_entry)。 |
...
链式存储。指向下一个键值对[Rcp\_HeaderEntry](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___header_entry/x_rcp___header_entry)。
