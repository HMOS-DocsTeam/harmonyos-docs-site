...
| [Rcp\_ContentOrPathOrCallback](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___content_or_path_or_callback/x_rcp___content_or_path_or_callback)[contentOrPathOrCb](#contentorpathorcb) | 多部分表单数据内容。 |
