...
| [Rcp\_Timeout](/ref/system-network-api/remote-communication-api/remote-communication-c/remote-communication-struct/x_rcp___timeout/x_rcp___timeout)[timeout](#timeout) | 超时配置。如果未设置此选项，将应用默认超时。 |
