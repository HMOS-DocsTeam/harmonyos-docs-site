...
![](../../../../images/4eaf10b6/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AbilityConstant.CollaborateResult](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-abilityconstant/js-apis-app-ability-abilityconstant#collaborateresult18) | 协同方应用是否接受协同。 |
