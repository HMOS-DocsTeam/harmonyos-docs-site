...
![](../../../../images/90c68949/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参考[增强连接错误码](/ref/system-network-api/distributed-service-api/distributed-service-arkts-errcode/errorcode-link-enhance/errorcode-link-enhance)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | string | 是 | 连接的目标设备的deviceId，即对端设备的BLE MAC地址。BLE MAC的获取方法，请参考[查找设备](/system-network/connectivity-kit/bluetooth/bluetooth-ble/ble-development-guide)。 |
...
| reason | number | 否 | 否 | 连接成功返回0，连接失败返回错误码：  - 32390200：表示客户端连接超时。  - 32390201：表示服务端服务未启动。  - 32390300：表示内部错误。  更多关于错误码的详细介绍请参考[增强连接错误码](/ref/system-network-api/distributed-service-api/distributed-service-arkts-errcode/errorcode-link-enhance/errorcode-link-enhance)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [ArrayBuffer](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/arraybuffer-object) | 是 | 需要发送的数据，最大发送长度为1024字节。 |
...
| callback | Callback&lt;[ArrayBuffer](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/arraybuffer-object)&gt; | 是 | 注册的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'dataReceived'，收到数据时，触发该事件。 |
| callback | Callback&lt;[ArrayBuffer](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/arraybuffer-object)&gt; | 否 | 注册的回调函数。 |
