...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager
kit: 系统
...
![](../../../../images/d43b4975/note_3.0-zh-cn.png) 
...
以下的错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[设备管理错误码](/ref/system-network-api/distributed-service-api/distributed-service-arkts-errcode/errorcode-device-manager/errorcode-device-manager)。
