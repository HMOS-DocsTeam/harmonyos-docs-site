...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-proxychannelmanager
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-proxychannelmanager
---
...
![](../../../../images/f3b67bb2/note_3.0-zh-cn.png) 
...
1. 需要申请ohos.permission.ACCESS\_BLUETOOTH权限。如何配置和申请权限，具体操作请参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)和[向用户申请授权](/system-security/access-control/app-permission-mgmt/request-app-permissions/request-user-authorization)。
...
以下错误码的详细介绍请参考[代理通道管理错误码](/ref/system-network-api/distributed-service-api/distributed-service-arkts-errcode/errorcode-proxychannelmanager/errorcode-proxychannelmanager)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
