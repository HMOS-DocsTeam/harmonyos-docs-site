...
sidebar_position: 12
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-netfirewall
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-net-netfirewall
---
...
![](../../../../images/f0347e90/note_3.0-zh-cn.png) 
...
![](../../../../images/cc6146ce/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)、[网络连接管理错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-connection/errorcode-net-connection)和[防火墙错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-netfirewall/errorcode-net-netfirewall)。
...
![](../../../../images/0724e6f2/note_3.0-zh-cn.png) 
...
| localIps | Array&lt;[NetFirewallIpParams](#netfirewallipparams)&gt; | 否 | 是 | 本地IP地址。当type=RULE\_IP时有效，否则将被忽略，最多10个。 |
| remoteIps | Array&lt;[NetFirewallIpParams](#netfirewallipparams)&gt; | 否 | 是 | 远端IP地址。当type=RULE\_IP时有效，否则将被忽略，最多10个。 |
| protocol | number | 否 | 是 | 协议，包含TCP：6，UDP：17。当type=RULE\_IP时有效。 |
| localPorts | Array&lt;[NetFirewallPortParams](#netfirewallportparams)&gt; | 否 | 是 | 本地端口。当type=RULE\_IP时有效，否则将被忽略，最多10个。 |
| remotePorts | Array&lt;[NetFirewallPortParams](#netfirewallportparams)&gt; | 否 | 是 | 远端端口。当type=RULE\_IP时有效，否则将被忽略。最多10个。 |
| domains | Array&lt;[NetFirewallDomainParams](#netfirewalldomainparams)&gt; | 否 | 是 | 域名列表，当type=RULE\_DOMAIN时有效，否则将被忽略，目前不支持中文域名。 |
| dns | [NetFirewallDnsParams](#netfirewalldnsparams) | 否 | 是 | DNS：当type=RULE\_DNS时有效，否则将被忽略。当type=RULE\_DNS时，该字段不能为空。 |
...
![](../../../../images/5ced12ee/note_3.0-zh-cn.png) 

[getNetFirewallRules](#netfirewallgetnetfirewallrules)接口，仅支持ORDER\_BY\_RULE\_NAME字段。
...
![](../../../../images/9da42c6d/note_3.0-zh-cn.png) 

当[addNetFirewallRule](#netfirewalladdnetfirewallrule)的入参rule.type配置为RULE\_DNS时，该字段不能为空。
