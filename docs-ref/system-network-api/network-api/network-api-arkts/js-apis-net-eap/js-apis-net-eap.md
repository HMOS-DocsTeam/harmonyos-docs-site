...
sidebar_position: 14
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-eap
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-net-eap
---
...
![](../../../../images/2a5374f7/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[扩展认证错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-eap/errorcode-net-eap)。
...
![](../../../../images/714793f1/note_3.0-zh-cn.png) 
