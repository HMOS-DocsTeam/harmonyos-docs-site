...
sidebar_position: 15
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vpnextensionability
kit: 系统
...
![](../../../../images/a14c4835/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [VpnExtensionContext](/ref/system-network-api/network-api/network-api-arkts/js-apis-inner-application-vpnextensioncontext/js-apis-inner-application-vpnextensioncontext) | 否 | 否 | VpnExtension的上下文环境，继承自ExtensionContext。 |
...
![](../../../../images/1989eeb7/note_3.0-zh-cn.png) 
