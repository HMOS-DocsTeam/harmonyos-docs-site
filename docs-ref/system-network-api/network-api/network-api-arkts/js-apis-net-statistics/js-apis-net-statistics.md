...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-statistics
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-net-statistics
---
...
![](../../../../images/fb6e9873/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍参见[流量管理错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-statistics/errorcode-net-statistics)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
以下错误码的详细介绍参见[流量管理错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-statistics/errorcode-net-statistics)。
...
![](../../../../images/aabdb24e/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [connection.NetBearType](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#netbeartype) | 枚举网络类型。 |
