...
sidebar_position: 11
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-websocket
kit: 系统
...
![](../../../../images/3040e0a7/note_3.0-zh-cn.png) 
...
![](../../../../images/bb58497c/note_3.0-zh-cn.png) 
...
![](../../../../images/d1d0e703/caution_3.0-zh-cn.png) 
...
以下错误码的详细介绍参见[webSocket错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-websocket/errorcode-net-websocket)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../../images/68136931/note_3.0-zh-cn.png) 
...
![](../../../../images/485c4d3d/caution_3.0-zh-cn.png) 
...
![](../../../../images/d9aa3cc3/note_3.0-zh-cn.png) 
...
![](../../../../images/0ff54205/caution_3.0-zh-cn.png) 
...
以下错误码的详细介绍参见[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../../images/2453223f/note_3.0-zh-cn.png) 
...
![](../../../../images/aab12b27/note_3.0-zh-cn.png) 
...
![](../../../../images/2d74da8a/note_3.0-zh-cn.png) 
...
![](../../../../images/b680bc7d/note_3.0-zh-cn.png) 
...
![](../../../../images/9551cff8/note_3.0-zh-cn.png) 
...
![](../../../../images/ea938118/note_3.0-zh-cn.png) 
...
![](../../../../images/86392ca1/note_3.0-zh-cn.png) 
...
![](../../../../images/80e00104/note_3.0-zh-cn.png) 
...
![](../../../../images/f3274706/note_3.0-zh-cn.png) 
...
![](../../../../images/be3be47d/note_3.0-zh-cn.png) 
...
![](../../../../images/549c87e4/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[webSocket错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-websocket/errorcode-net-websocket)。
...
![](../../../../images/a809ffec/note_3.0-zh-cn.png) 
...
![](../../../../images/df4628c6/note_3.0-zh-cn.png) 
...
![](../../../../images/44ec9006/note_3.0-zh-cn.png) 
...
![](../../../../images/acdbd63f/note_3.0-zh-cn.png) 
...
![](../../../../images/48d37ca9/note_3.0-zh-cn.png) 
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 是 | 回调函数。 |
...
![](../../../../images/d11eb98a/note_3.0-zh-cn.png) 
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 否 | 回调函数。默认值：200。 |
...
| pingInterval21+ | number | 否 | 是 | 自定义[心跳检测](/system-network/network-kit/network-kit-data-transmission/websocket-connection#场景介绍)时间，默认为30s。每pingInterval周期会发起心跳检测，设置为0则表示关闭心跳检测。最大值：30000s，最小值：0s。 |
...
| 'system' | 使用系统默认网络代理。 |
| 'no-proxy' | 不使用网络代理。 |
| [HttpProxy](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#httpproxy10) | 使用指定的网络代理。 |
