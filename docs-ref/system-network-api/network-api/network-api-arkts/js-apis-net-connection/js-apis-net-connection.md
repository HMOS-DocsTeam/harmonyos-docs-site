...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-connection
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-net-connection
---
...
![](../../../../images/4e828b04/note_3.0-zh-cn.png) 
...
![](../../../../images/c079bb28/note_3.0-zh-cn.png) 
...
![](../../../../images/91935c14/note_3.0-zh-cn.png) 

- 系统默认使用的网络，该网络的capabilities必须具备[NET\_CAPABILITY\_INTERNET](#netcap)且不是VPN类型的网络。
...
以下错误码的详细介绍请参见[网络连接管理错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-connection/errorcode-net-connection)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../../images/134b0324/note_3.0-zh-cn.png) 
...
![](../../../../images/3368a601/note_3.0-zh-cn.png) 
...
![](../../../../images/a8aca883/note_3.0-zh-cn.png) 

若需使用本接口所配置的代理信息，则需在[HttpRequestOptions](/ref/system-network-api/network-api/network-api-arkts/js-apis-http/js-apis-http#httprequestoptions)字段中将usingProxy设置为true以启用代理转发。本接口仅负责配置代理规则，不校验代理服务的有效性。
...
![](../../../../images/a405151a/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[网络连接管理错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-connection/errorcode-net-connection)。
...
![](../../../../images/750f6225/note_3.0-zh-cn.png) 
...
![](../../../../images/484a09e1/note_3.0-zh-cn.png) 
...
![](../../../../images/fb4366fe/note_3.0-zh-cn.png) 
...
![](../../../../images/26b72226/note_3.0-zh-cn.png) 
...
| option | [QueryOptions](#queryoptions23) | 否 | 需要查询的IP类型，默认值为FAMILY\_TYPE\_ALL。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| family | [FamilyType](#familytype23) | 否 | 是 | 需要查询的具体IP地址类型，默认值为FAMILY\_TYPE\_ALL。 |
...
![](../../../../images/fd3ffec1/note_3.0-zh-cn.png) 
...
![](../../../../images/ac23084b/note_3.0-zh-cn.png) 
...
![](../../../../images/86691cb0/note_3.0-zh-cn.png) 
...
![](../../../../images/79ef1e93/note_3.0-zh-cn.png) 
...
![](../../../../images/b8b13401/caution_3.0-zh-cn.png) 
...
![](../../../../images/c3e21fcf/note_3.0-zh-cn.png) 
...
![](../../../../images/4744400d/note_3.0-zh-cn.png) 
...
![](../../../../images/219043fa/note_3.0-zh-cn.png) 
...
![](../../../../images/385f761b/note_3.0-zh-cn.png) 
...
![](../../../../images/f9c9b718/note_3.0-zh-cn.png) 
...
![](../../../../images/6f589730/note_3.0-zh-cn.png) 
...
![](../../../../images/5ba12450/note_3.0-zh-cn.png) 
...
![](../../../../images/e8609f30/note_3.0-zh-cn.png) 
...
| flag | [ConversionProcess](#conversionprocess23) | 否 | 转换流程参数，默认值为NO\_CONFIGURATION。 |
...
![](../../../../images/34023c7e/note_3.0-zh-cn.png) 
...
![](../../../../images/6c9ef095/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socketParam | [TCPSocket](/ref/system-network-api/network-api/network-api-arkts/js-apis-socket/js-apis-socket#tcpsocket) | [UDPSocket](/ref/system-network-api/network-api/network-api-arkts/js-apis-socket/js-apis-socket#udpsocket) | 是 | 待绑定的TCPSocket或UDPSocket对象。 |
...
![](../../../../images/7c527e7a/caution_3.0-zh-cn.png) 
...
定义一个HTTP请求，可以通过[http.createHttp](/ref/system-network-api/network-api/network-api-arkts/js-apis-http/js-apis-http#httpcreatehttp)创建。
...
定义一个TCPSocket对象，可以通过[socket.constructTCPSocketInstance](/ref/system-network-api/network-api/network-api-arkts/js-apis-socket/js-apis-socket#socketconstructtcpsocketinstance)创建。
...
定义一个UDPSocket对象，可以通过[socket.constructUDPSocketInstance](/ref/system-network-api/network-api/network-api-arkts/js-apis-socket/js-apis-socket#socketconstructudpsocketinstance)创建。
