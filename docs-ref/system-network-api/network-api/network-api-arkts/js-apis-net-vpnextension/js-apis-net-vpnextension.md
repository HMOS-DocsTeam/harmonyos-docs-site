...
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-vpnextension
kit: 系统
...
![](../../../../images/b43a6b46/note_3.0-zh-cn.png) 

本模块首批接口从 API version 11 开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

以下模块不支持在VpnExtensionAbility中引用，可能会导致程序异常退出。

- [@ohos.contact (联系人)](/ref/contacts-api/contacts-arkts/js-apis-contact/js-apis-contact)
- [@ohos.geolocation](/ref/location-api/location-arkts/location-arkts-dep/js-apis-geolocation/js-apis-geolocation)、[@ohos.geoLocationManager (位置服务)](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager)
...
- [@ohos.telephony.call (拨打电话)](/ref/system-network-api/telephony-api/telephony-arkts/js-apis-call/js-apis-call)
- [@ohos.telephony.sim (SIM卡管理)](/ref/system-network-api/telephony-api/telephony-arkts/js-apis-sim/js-apis-sim)
- [@ohos.telephony.sms (短信服务)](/ref/system-network-api/telephony-api/telephony-arkts/js-apis-sms/js-apis-sms)
...
| 类型 | 说明 |
| --- | --- |
| [\_VpnExtensionContext](/ref/system-network-api/network-api/network-api-arkts/js-apis-inner-application-vpnextensioncontext/js-apis-inner-application-vpnextensioncontext) | VPN扩展的上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 指示要启动的信息。  ****说明：**** 从API version 22开始，支持在VPN首次启动时传递want中的parameters字段。 |
...
以下错误码的详细介绍请参见[元能力子系统错误码](/ref/ability-api/ability-arkts-errcode/errorcode-ability/errorcode-ability)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../../images/5d476a69/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [VpnExtensionContext](/ref/system-network-api/network-api/network-api-arkts/js-apis-inner-application-vpnextensioncontext/js-apis-inner-application-vpnextensioncontext) | 是 | 指定 context。 |
...
![](../../../../images/c73e436b/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[VPN错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-vpn/errorcode-net-vpn)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socketFd | number | 是 | 指定保护的 socketfd，该文件描述符通过[getSocketFd](/ref/system-network-api/network-api/network-api-arkts/js-apis-socket/js-apis-socket#getsocketfd10-1)获取。 |
...
以下错误码的详细介绍请参见[VPN错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-vpn/errorcode-net-vpn)。
...
![](../../../../images/974b5256/caution_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| addresses | Array&lt;[LinkAddress](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#linkaddress)&gt; | 否 | 否 | VPN虚拟网卡的IP地址。API version 23之前，最多支持64个IP地址；从API version 23开始，最多支持2000个IP地址。 |
| vpnId20+ | string | 否 | 是 | VPN唯一标识。 |
| routes | Array&lt;[RouteInfo](/ref/system-network-api/network-api/network-api-arkts/js-apis-net-connection/js-apis-net-connection#routeinfo)&gt; | 否 | 是 | VPN虚拟网卡的路由信息（API version 23前最多可配置1024条路由；从API version 23开始最多可配置10000条路由）。 |
