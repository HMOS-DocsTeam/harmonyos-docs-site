...
![](../../../../images/f68648b1/note_3.0-zh-cn.png) 

- 从API Version 6开始，该接口不再维护，推荐使用新接口[@ohos.net.http](/ref/system-network-api/network-api/network-api-arkts/js-apis-http/js-apis-http)。
...
![](../../../../images/0051cba1/note_3.0-zh-cn.png) 
