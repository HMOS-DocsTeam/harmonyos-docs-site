...
title: "net_ssl_c.h"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h
kit: 系统
last_updated: "2026-04-22"
slug: capi-net-ssl-c-h
---
...
| 参数项 | 描述 |
| --- | --- |
| [const struct NetStack\_CertBlob](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-netstack-certblob/capi-netstack-netstack-certblob) \*cert | 用户传入的待校验证书。 |
| [const struct NetStack\_CertBlob](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-netstack-certblob/capi-netstack-netstack-certblob) \*caCert | 用户指定的证书，若为空则以系统预置证书进行校验。 |
...
| [NetStack\_CertificatePinning](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-netstack-certificatepinning/capi-netstack-netstack-certificatepinning) \*pin | 证书锁定信息的结构体。 |
...
| --- | --- |
| const char \*hostname | 主机名。 |
| [NetStack\_Certificates](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-netstack-certificates/capi-netstack-netstack-certificates) \*certs | 证书信息的结构体。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetStack\_Certificates](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-netstack-certificates/capi-netstack-netstack-certificates) \*certs | 证书信息。 |
