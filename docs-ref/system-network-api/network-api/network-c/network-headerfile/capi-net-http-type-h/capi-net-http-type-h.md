...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Http\_Buffer](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-buffer/capi-netstack-http-buffer) | Http\_Buffer | HTTP缓存结构体。 |
| [Http\_HeaderValue](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-headervalue/capi-netstack-http-headervalue) | Http\_HeaderValue | 请求或者响应的标头映射的值类型。 |
| [Http\_HeaderEntry](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-headerentry/capi-netstack-http-headerentry) | Http\_HeaderEntry | 请求或者响应的标头的所有键值对。 |
| [Http\_ClientCert](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-clientcert/capi-netstack-http-clientcert) | Http\_ClientCert | 发送到服务端的客户端证书配置，服务端将通过客户端证书校验客户端身份。 |
| [Http\_CustomProxy](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-customproxy/capi-netstack-http-customproxy) | Http\_CustomProxy | 用户自定义代理配置。 |
| [Http\_Proxy](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-proxy/capi-netstack-http-proxy) | Http\_Proxy | 代理配置结构体。 |
| [Http\_PerformanceTiming](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-performancetiming/capi-netstack-http-performancetiming) | Http\_PerformanceTiming | HTTP响应时间信息，会在[Http\_Response.performanceTiming](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-response/capi-netstack-http-response#成员变量)中收集。 |
| [Http\_RequestOptions](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-requestoptions/capi-netstack-http-requestoptions) | Http\_RequestOptions | 定义HTTP请求配置的结构体。 |
| [Http\_Response](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-response/capi-netstack-http-response) | Http\_Response | 定义HTTP响应的结构体。 |
| [Http\_Request](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-request/capi-netstack-http-request) | Http\_Request | HTTP请求结构体。 |
| [Http\_EventsHandler](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-eventshandler/capi-netstack-http-eventshandler) | Http\_EventsHandler | 监听不同HTTP事件的回调函数。 |
| [Http\_Headers](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-headers/capi-netstack-http-headers) | Http\_Headers | HTTP请求或者是响应中的标头。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Http\_Headers](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-headers/capi-netstack-http-headers) \*headers | 接收到的请求头，指向Http\_Headers的指针，参考[Http\_Headers](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-headers/capi-netstack-http-headers)。 |
