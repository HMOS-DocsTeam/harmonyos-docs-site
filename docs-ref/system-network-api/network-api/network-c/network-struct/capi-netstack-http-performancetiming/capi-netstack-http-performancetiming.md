...
HTTP响应时间信息，会在[Http\_Response](/ref/system-network-api/network-api/network-c/network-struct/capi-netstack-http-response/capi-netstack-http-response#成员变量)中收集。
