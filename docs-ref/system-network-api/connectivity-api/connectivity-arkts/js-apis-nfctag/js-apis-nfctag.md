...
后台读卡是指不需要打开应用程序，电子设备通过NFC读取标签卡片后，根据标签卡片的类型匹配到一个或多个应用程序。如果仅匹配到一个，则直接拉起应用程序的读卡页面；如果是多个则弹出应用选择器，让用户选择指定的读卡应用。后台读卡不涉及tag相关接口，示例参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide#后台读取标签)。

前台读卡是指提前打开应用程序，并进入对应的NFC读卡页面后读卡，只会把读到的标签卡片信息分发给前台应用程序。

![](../../../../images/23cfb86d/note_3.0-zh-cn.png) 

1. 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
2. 调用本模块接口和常量时请使用canIUse("SystemCapability.Communication.NFC.Tag")判断设备是否支持NFC能力，否则可能导致应用运行稳定性问题，参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
3. 导入tag模块编辑器报错，在某个具体设备型号上能力可能超出工程默认设备定义的能力集范围，如需要使用此部分能力需额外配置自定义syscap，参考[syscap开发指南](/ref/syscap/syscap#syscap开发指导)。
...
getNfcATag(tagInfo: [TagInfo](#taginfo)): [NfcATag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcatag)

获取NFC A类型Tag对象，通过该对象可访问NfcA技术类型的Tag。

![](../../../../images/dceeeeeb/note_3.0-zh-cn.png) 
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NfcATag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcatag) | NFC A类型Tag对象。 |

## tag.getNfcA9+

getNfcA(tagInfo: [TagInfo](#taginfo)): [NfcATag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcatag)
...
以下错误码的详细介绍请参见[NFC错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-nfc/errorcode-nfc)。
...
getNfcBTag(tagInfo: [TagInfo](#taginfo)): [NfcBTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcbtag)

获取NFC B类型Tag对象，通过该对象可访问NfcB技术类型的Tag。

![](../../../../images/01d53144/note_3.0-zh-cn.png) 
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NfcBTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcbtag) | NFC B类型Tag对象。 |

## tag.getNfcB9+

getNfcB(tagInfo: [TagInfo](#taginfo)): [NfcBTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcbtag)
...
getNfcFTag(tagInfo: [TagInfo](#taginfo)): [NfcFTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcftag)

获取NFC F类型Tag对象，通过该对象可访问NfcF技术类型的Tag。

![](../../../../images/35e83217/note_3.0-zh-cn.png) 
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NfcFTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcftag) | NFC F类型Tag对象。 |

## tag.getNfcF9+

getNfcF(tagInfo: [TagInfo](#taginfo)): [NfcFTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcftag)
...
getNfcVTag(tagInfo: [TagInfo](#taginfo)): [NfcVTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcvtag)

获取NFC V类型Tag对象，通过该对象可访问NfcV技术类型的Tag。

![](../../../../images/59f3ea9c/note_3.0-zh-cn.png) 
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NfcVTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcvtag) | NFC V类型Tag对象。 |

## tag.getNfcV9+

getNfcV(tagInfo: [TagInfo](#taginfo)): [NfcVTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcvtag)
...
getIsoDep(tagInfo: [TagInfo](#taginfo)): [IsoDepTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#isodeptag9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [IsoDepTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#isodeptag9) | IsoDep类型Tag对象，通过该对象访问IsoDep类型的相关接口。 |
...
getNdef(tagInfo: [TagInfo](#taginfo)): [NdefTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndeftag9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NdefTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndeftag9) | NDEF类型Tag对象，通过该对象访问NDEF类型的相关接口。 |
...
getMifareClassic(tagInfo: [TagInfo](#taginfo)): [MifareClassicTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareclassictag9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [MifareClassicTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareclassictag9) | MIFARE Classic类型Tag对象，通过该对象访问MIFARE Classic类型的相关接口。 |
...
getMifareUltralight(tagInfo: [TagInfo](#taginfo)): [MifareUltralightTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareultralighttag9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [MifareUltralightTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareultralighttag9) | MIFARE Ultralight类型Tag对象，通过该对象访问MIFARE Ultralight类型的相关接口。 |
...
getNdefFormatable(tagInfo: [TagInfo](#taginfo)): [NdefFormatableTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefformatabletag9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NdefFormatableTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefformatabletag9) | NDEF Formatable类型Tag对象，通过该对象访问NDEF Formatable类型的相关接口。 |
...
getBarcodeTag(tagInfo: [TagInfo](#taginfo)): [BarcodeTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#barcodetag18)
...
| 类型 | 说明 |
| --- | --- |
| [BarcodeTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#barcodetag18) | BarcodeTag类型Tag对象。 |
...
getTagInfo(want: [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want#want)): [TagInfo](#taginfo)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want#want) | 是 | 分发Ability时，在系统onCreate入口函数的参数中获取。 |
...
registerForegroundDispatch(elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname), discTech: number[], callback: AsyncCallback<[TagInfo](#taginfo)>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。 |
...
unregisterForegroundDispatch(elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname)): void
...
on(type: 'readerMode', elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname), discTech: number[], callback: AsyncCallback<[TagInfo](#taginfo)>): void
...
off(type: 'readerMode', elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname), callback?: AsyncCallback<[TagInfo](#taginfo)>): void
...
| elementName | [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值）。 |
...
messageToBytes(ndefMessage: [NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9)): number[]
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ndefMessage | [NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9) | 是 | NDEF消息数据对象。 |
...
createNdefMessage(data: number[]): [NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9) | NDEF标签的Message，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
createNdefMessage(ndefRecords: NdefRecord[]): [NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9)
...
| ****参数名**** | ****类型**** | ****必填**** | ****说明**** |
| --- | --- | --- | --- |
| ndefRecords | [NdefRecord](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#ndefrecord9)[] | 是 | NDEF标签的Record列表，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcATag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcatag) | NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcBTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcbtag) | NfcBTag 提供 NFC-B(ISO 14443-3B)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcFTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcftag) | NfcFTag 提供对 NFC-F(JIS 6319-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcVTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#nfcvtag) | NfcVTag 提供对 NFC-V(ISO 15693)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_IsoDepTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#isodeptag9) | IsoDepTag 提供 ISO-DEP(ISO 14443-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndeftag9) | 提供对已格式化为NDEF的NFC标签的数据和操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_MifareClassicTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareclassictag9) | MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_MifareUltralightTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#mifareultralighttag9) | MifareUltralightTag 提供对MIFARE Ultralight属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefFormatableTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefformatabletag9) | NdefFormatableTag为NDEF Formattable的标签提供格式化操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_BarcodeTag](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#barcodetag18) | 提供对条形码标签的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefMessage](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech#ndefmessage9) | 获取NDEF消息中的所有记录。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession#tagsession) | TagSession是所有[NFC Tag技术类型](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech)的基类， 提供建立连接和发送数据等共同接口。 |
