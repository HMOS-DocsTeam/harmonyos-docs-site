...
sidebar_position: 19
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-wifimanager
---
...
![](../../../../images/254a5b3c/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
...
![](../../../../images/0559b47a/note_3.0-zh-cn.png) 
...
![](../../../../images/6e551440/note_3.0-zh-cn.png) 
...
![](../../../../images/79bdbfea/note_3.0-zh-cn.png) 
...
![](../../../../images/a3b35bcc/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[WifiScanInfo](#wifiscaninfo)&gt; | 返回扫描到的热点列表。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的bssid为真实设备地址，否则为随机设备地址。 |
...
| eapConfig10+ | [WifiEapConfig](#wifieapconfig10) | 否 | 是 | 可扩展身份验证协议配置。只有securityType为WIFI\_SEC\_TYPE\_EAP时需要填写。 |
| wapiConfig12+ | [WifiWapiConfig](#wifiwapiconfig12) | 否 | 是 | WAPI身份验证协议配置。只有securityType为WIFI\_SEC\_TYPE\_WAPI\_CERT或WIFI\_SEC\_TYPE\_WAPI\_PSK时需要填写。 |
...
| phase2Method | [Phase2Method](#phase2method10) | 否 | 否 | 第二阶段认证方式。只有eapMethod为EAP\_PEAP或EAP\_TTLS时需要填写。 |
...
![](../../../../images/08eaf3c4/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
...
![](../../../../images/0082522d/note_3.0-zh-cn.png) 
...
![](../../../../images/f1f17ed3/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WifiP2pGroupInfo](#wifip2pgroupinfo)&gt; | Promise对象。表示当前组信息。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[WifiP2pGroupInfo](#wifip2pgroupinfo)&gt; | 是 | 回调函数。当操作成功时，err为0，data表示当前组信息。如果error为非0，表示处理出现错误。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[WifiP2pDevice[]](#wifip2pdevice)&gt; | Promise对象。表示对端设备列表信息。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[WifiP2pDevice[]](#wifip2pdevice)&gt; | 是 | 回调函数。当操作成功时，err为0，data表示对端设备列表信息。如果err为非0，表示处理出现错误。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
...
![](../../../../images/13cf61d2/note_3.0-zh-cn.png) 
...
| callback | Callback&lt;[WifiP2pDevice[]](#wifip2pdevice)&gt; | 是 | 状态改变回调函数。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填"p2pPeerDeviceChange"字符串。 |
| callback | Callback&lt;[WifiP2pDevice[]](#wifip2pdevice)&gt; | 否 | 状态改变回调函数。如果callback不填，将取消注册该事件关联的所有回调函数。如果应用申请了ohos.permission.GET\_WIFI\_PEERS\_MAC权限，则返回结果中的deviceAddress为真实设备地址，否则为随机设备地址。 |
