...
本模块提供了蓝牙[Profile](/system-network/connectivity-kit/terminology#profile)、设备类型相关的常量定义。

![](../../../../images/d0e62e30/note_3.0-zh-cn.png) 
...
枚举，表示蓝牙[Profile](/system-network/connectivity-kit/terminology#profile)协议的标识。

****系统能力****：SystemCapability.Communication.Bluetooth.Core

| 名称 | 值 | 说明 |
| --- | --- | --- |
| PROFILE\_A2DP\_SOURCE | 1 | [A2DP Source](/system-network/connectivity-kit/terminology#a2dp-source) Profile，负责发送音频数据端使用的协议。 |
| PROFILE\_HANDSFREE\_AUDIO\_GATEWAY | 4 | [HFP Ag](/system-network/connectivity-kit/terminology#hfp-ag) Profile，负责通话音频网关使用的协议。 |
| PROFILE\_HID\_HOST | 6 | [HID Host](/system-network/connectivity-kit/terminology#hid-host) Profile，负责与[HID Device](/system-network/connectivity-kit/terminology#hid-device)建立通信并处理数据交互的协议。 |
| PROFILE\_PAN\_NETWORK | 7 | [NAP](/system-network/connectivity-kit/terminology#nap) Profile，负责提供网络共享端使用的协议。 |
...
枚举，由蓝牙技术联盟（[Bluetooth Special Interest Group](/system-network/connectivity-kit/terminology#bluetooth-sig)）定义，使用通用唯一标识（Universally Unique Identifier，[UUID](/system-network/connectivity-kit/terminology#uuid)）表示不同的蓝牙协议Profile。
