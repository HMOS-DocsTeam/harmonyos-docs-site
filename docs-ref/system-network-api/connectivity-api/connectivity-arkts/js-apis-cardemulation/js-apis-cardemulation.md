...
sidebar_position: 15
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cardemulation
kit: 系统
...
![](../../../../images/156fa990/note_3.0-zh-cn.png) 
...
![](../../../../images/b4ab6328/caution_3.0-zh-cn.png) 
...
4. 轻量级智能穿戴产品不同于其他设备，仅支持[FA模型](/ability-kit/ability-terminology#fa模型)，属性配置和接口调用方式与其他设备有所区别，详见示例。
...
![](../../../../images/153417b6/note_3.0-zh-cn.png) 
...
![](../../../../images/942c5100/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname) | 是 | 所属应用声明NFC卡模拟能力的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。 |
...
![](../../../../images/8b1f4df4/note_3.0-zh-cn.png) 
...
start(elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname), aidList: string[]): void
...
![](../../../../images/1d575238/note_3.0-zh-cn.png) 
...
stop(elementName: [ElementName](/ref/ability-api/ability-arkts/ability-api-interface-depend/bundlemanager/js-apis-bundlemanager-elementname/js-apis-bundlemanager-elementname)): void
...
![](../../../../images/f80e4fd7/note_3.0-zh-cn.png) 
