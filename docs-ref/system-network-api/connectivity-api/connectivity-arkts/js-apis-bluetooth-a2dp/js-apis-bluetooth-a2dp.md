...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-bluetooth-a2dp
---

# @ohos.bluetooth.a2dp (蓝牙a2dp模块)

本模块提供基于增强音频分发协议（Advanced Audio Distribution Profile，[A2DP](/system-network/connectivity-kit/terminology#a2dp)）的蓝牙媒体音频能力，支持获取媒体播放状态和连接状态等方法。

![](../../../../images/d94091d8/note_3.0-zh-cn.png) 
...
创建蓝牙媒体[A2DP Source](/system-network/connectivity-kit/terminology#a2dp-source)实例。通过该实例可以使用本端作为A2DP Source设备的方法，如：获取和其他设备间的蓝牙媒体音频播放状态。
...
该实例表示蓝牙媒体音频中的[A2DP Source](/system-network/connectivity-kit/terminology#a2dp-source)角色。

- 该类继承于[BaseProfile](#baseprofile)，因此可以使用其父类中的方法。
- 使用该类的方法前，需通过[createA2dpSrcProfile](#a2dpcreatea2dpsrcprofile)方法构造该类的实例。
- 和该实例角色相对应的是[A2DP Sink](/system-network/connectivity-kit/terminology#a2dp-sink)。
