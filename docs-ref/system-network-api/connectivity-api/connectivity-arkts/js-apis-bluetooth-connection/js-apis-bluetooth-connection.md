...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-connection
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-bluetooth-connection
---
...
![](../../../../images/57bcb78f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileConnectionState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate) | 蓝牙设备的Profile协议连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileid) | 蓝牙Profile协议的枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| [constant.ProfileUuids](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileuuids12) | 蓝牙Profile协议的UUID。 |
...
| 类型 | 说明 |
| --- | --- |
| [constant.MajorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorclass) | 蓝牙设备的主要类型。 |

## MajorMinorClass

type MajorMinorClass = constant.MajorMinorClass

蓝牙设备的子类型，在[MajorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorclass)基础上进一步细分的类型。蓝牙标准协议字段。

****系统能力****：SystemCapability.Communication.Bluetooth.Core

| 类型 | 说明 |
| --- | --- |
| [constant.MajorMinorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorminorclass) | 蓝牙设备的子类型。 |
...
- 若开发者不知道目标设备的[地址类型](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-common/js-apis-bluetooth-common#bluetoothaddresstype)，建议调用此接口发起配对。
...
- 若开发者已知目标设备的MAC地址及[地址类型](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-common/js-apis-bluetooth-common#bluetoothaddresstype)，建议调用此接口发起配对。
- 蓝牙配对状态通过[on('bondStateChange')](#connectiononbondstatechange)的回调结果获取。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | [BluetoothAddress](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-common/js-apis-bluetooth-common#bluetoothaddress) | 是 | 需要配对的对端蓝牙设备地址信息，包括地址与地址类型。 |
...
| callback | AsyncCallback&lt;Array&lt;[ProfileUuids](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileuuids12)&gt;&gt; | 是 | 回调函数。当获取UUID成功，err为undefined，获取到的是Profile协议能力集合；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[ProfileUuids](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileuuids12)&gt;&gt; | Promise对象，返回支持的Profile协议能力集合。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;string&gt; | 已配对蓝牙设备的地址集合。  基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。  - 已配对的地址不会变更。  - 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。  - 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。  - 若要持久化保存该地址，可使用[access.addPersistentDeviceId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#accessaddpersistentdeviceid16)方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profileId | [ProfileId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileid) | 否 | 表示Profile协议的枚举值。如果携带ProfileId，则返回指定Profile协议的连接状态。如果未携带ProfileId，则检查所有支持的Profile连接状态，按如下优先级顺序检查并返回：  - 存在已连接的Profile协议，则返回[STATE\_CONNECTED](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate)。  - 存在正在连接的Profile协议，则返回[STATE\_CONNECTING](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate)。  - 存在正在断连的Profile协议，则返回[STATE\_DISCONNECTING](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate)。  - 以上条件均不满足，则返回[STATE\_DISCONNECTED](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate)。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [ProfileConnectionState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate) | Profile协议的连接状态。 |
...
![](../../../../images/c341c1fc/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ScanMode](#scanmode) | 是 | 蓝牙扫描模式。当扫描模式为SCAN\_MODE\_GENERAL\_DISCOVERABLE时，超出duration持续时间(不为0)，扫描模式会重新设置为SCAN\_MODE\_CONNECTABLE。 |
...
| callback | Callback&lt;Array&lt;string&gt;&gt; | 是 | 指定订阅的回调函数，会携带扫描到的设备地址集合。  基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。  - 已配对的地址不会变更。  - 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。  - 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。  - 若要持久化保存该地址，可使用[access.addPersistentDeviceId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#accessaddpersistentdeviceid16)方法。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| majorClass | [MajorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorclass) | 否 | 否 | 主要类型。是蓝牙标准协议中定义的类型字段。 |
| majorMinorClass | [MajorMinorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorminorclass) | 否 | 否 | 子类型，是在主要类型上基础上进一步细分的类型。是蓝牙标准协议中定义的类型字段。 |
| classOfDevice | number | 否 | 否 | 设备类型。是蓝牙标准协议中定义的类型字段，包含了[MajorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorclass)、[MajorMinorClass](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#majorminorclass)和支持的主要服务这三种设备信息。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| USER\_REMOVED | 0 | 用户主动移除设备。若配对状态[BondState](#bondstate)是已配对，也表示配对成功。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| deviceId | string | 否 | 否 | 扫描到的设备地址。  基于信息安全考虑，此处获取的设备地址为虚拟MAC地址。  - 已配对的地址不会变更。  - 若该设备重启蓝牙开关，重新获取到的虚拟地址会立即变更。  - 若取消配对，蓝牙子系统会根据该地址的实际使用情况，决策后续变更时机；若其他应用正在使用该地址，则不会立刻变更。  - 若要持久化保存该地址，可使用[access.addPersistentDeviceId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#accessaddpersistentdeviceid16)方法。 |
