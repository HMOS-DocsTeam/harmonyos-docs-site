...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-tagsession
kit: 系统
...
![](../../../../../images/c5795ee4/note_3.0-zh-cn.png) 

本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

![](../../../../../images/27f1b1e6/caution_3.0-zh-cn.png) 
...
TagSession是所有[nfcTag技术类型](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-nfctech/js-apis-nfctech)的基类， 提供建立连接和发送数据等共同接口。

需要通过其子类来访问以下接口。在下面的示例中 统一用 getXXX()表示获取子类实例的方法。

具体使用时,请根据实际采用的nfcTag技术，选择对应的方法，具体请参见[nfcTag](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag)文档。
...
![](../../../../../images/f2b547bd/note_3.0-zh-cn.png) 

从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getTagInfo](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#taggettaginfo9)替代。
...
![](../../../../../images/ecef32e8/note_3.0-zh-cn.png) 
...
![](../../../../../images/d5266b0f/note_3.0-zh-cn.png) 
...
![](../../../../../images/c62b8f3d/note_3.0-zh-cn.png) 
...
![](../../../../../images/01dc9f00/note_3.0-zh-cn.png) 
...
![](../../../../../images/14d0083c/note_3.0-zh-cn.png) 
...
![](../../../../../images/fb4eacd3/note_3.0-zh-cn.png) 
...
![](../../../../../images/32870189/note_3.0-zh-cn.png) 
...
![](../../../../../images/3594c566/note_3.0-zh-cn.png) 
