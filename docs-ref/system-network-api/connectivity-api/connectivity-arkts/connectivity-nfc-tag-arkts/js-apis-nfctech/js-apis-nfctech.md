...
![](../../../../../images/93f3d75c/note_3.0-zh-cn.png) 

本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

![](../../../../../images/6d206c05/caution_3.0-zh-cn.png) 

导入tag模块编辑器报错，在某个具体设备型号上能力可能超出工程默认设备定义的能力集范围，如需要使用此部分能力需额外配置自定义syscap，参考[syscap开发指南](/ref/syscap/syscap#syscap开发指导)。
...
NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问，继承自[TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession)。

TagSession是所有NFC Tag技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession)。

NfcATag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
NfcBTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
NfcFTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
NfcVTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
IsoDepTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
getNdefRecords(): [tag.NdefRecord](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#ndefrecord9)[]
...
| ****类型**** | ****说明**** |
| --- | --- |
| [tag.NdefRecord](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#ndefrecord9)[] | NDEF标签的Record列表，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
NdefTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。

以下是NdefTag的独有接口。

### NdefTag.getNdefTagType9+

getNdefTagType(): [tag.NfcForumType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#nfcforumtype9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [tag.NfcForumType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#nfcforumtype9) | NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。 |
...
| ****类型**** | ****说明**** |
| --- | --- |
| [NdefMessage](#ndefmessage9) | NDEF标签的Message，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
getNdefTagTypeString(type: [tag.NfcForumType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#nfcforumtype9)): string
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [tag.NfcForumType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#nfcforumtype9) | 是 | NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。 |
...
MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问，继承自[TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession)。

TagSession是所有NFC Tag技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession)。

MifareClassicTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
getType(): [tag.MifareClassicType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareclassictype9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [tag.MifareClassicType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareclassictype9) | MifareClassic标签的类型。 |
...
获取标签的存储空间大小，具体请参见[MifareClassicSize](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareclassicsize9)。
...
| ****类型**** | ****说明**** |
| --- | --- |
| number | 标签的大小，单位为字节，请参见[MifareClassicSize](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareclassicsize9)。 |
...
MifareUltralightTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
getType(): [tag.MifareUltralightType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareultralighttype9)
...
| ****类型**** | ****说明**** |
| --- | --- |
| [tag.MifareUltralightType](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#mifareultralighttype9) | MIFARE Ultralight标签的类型。 |
...
TagSession是所有NFC Tag 技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](/ref/system-network-api/connectivity-api/connectivity-arkts/connectivity-nfc-tag-arkts/js-apis-tagsession/js-apis-tagsession)。

NdefFormatableTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
...
BarcodeTag获取方式请参考[nfc-tag开发指南](/system-network/connectivity-kit/nfc/nfc-tag-access-guide)。
