...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-bluetooth
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-system-bluetooth
---

# @system.bluetooth (蓝牙)

![](../../../../images/471577b4/note_3.0-zh-cn.png) 

- 从API Version 7 开始，该接口不再维护，推荐使用[@ohos.bluetooth.ble](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-ble/js-apis-bluetooth-ble)等相关profile接口。
