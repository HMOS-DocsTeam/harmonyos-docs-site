...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| OH\_AI\_TensorHandleArray | [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) | 张量数组结构体，用于存储张量数组指针和张量数组长度。 |
| OH\_AI\_ShapeInfo | [OH\_AI\_ShapeInfo](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-shapeinfo/capi-mindspore-oh-ai-shapeinfo) | 形状维度大小，预留最大维度是32，当前实际支持的最大维度是8。 |
| OH\_AI\_CallBackParam | [OH\_AI\_CallBackParam](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-callbackparam/capi-mindspore-oh-ai-callbackparam) | 回调函数中传入的算子信息。 |
| void \* | [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) | 指向模型对象的指针。 |
| void \* | [OH\_AI\_TrainCfgHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-traincfghandle/capi-mindspore-oh-ai-traincfghandle) | 指向训练配置对象的指针。 |

### 函数

| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef bool (\*OH\_AI\_KernelCallBack)(const OH\_AI\_TensorHandleArray inputs, const OH\_AI\_TensorHandleArray outputs,const OH\_AI\_CallBackParam kernel\_Info)](#oh_ai_kernelcallback) | OH\_AI\_KernelCallBack | 回调函数指针。  该函数指针是用于设置[OH\_AI\_ModelPredict](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelpredict)函数参数中的两个回调函数。  该指针指向的函数需要包含三个参数，其中inputs和outputs对应了算子的输入和输出张量，kernel\_Info表示当前算子的信息。  可以通过回调函数监控算子执行的情况，例如统计算子的执行时间，校验算子的正确性等等。 |
...
| [OH\_AI\_API OH\_AI\_Status OH\_AI\_ModelBuild(OH\_AI\_ModelHandle model, const void \*model\_data, size\_t data\_size,OH\_AI\_ModelType model\_type, const OH\_AI\_ContextHandle model\_context)](#oh_ai_modelbuild) | - | 从内存缓冲区加载并编译MindSpore Lite模型。  注意，同一个[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)对象仅能传递给[OH\_AI\_ModelBuild](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuild)或者[OH\_AI\_ModelBuildFromFile](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuildfromfile)一次，如果多次调用该函数需要创建多个不同的[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)。 |
| [OH\_AI\_API OH\_AI\_Status OH\_AI\_ModelBuildFromFile(OH\_AI\_ModelHandle model, const char \*model\_path,OH\_AI\_ModelType model\_type, const OH\_AI\_ContextHandle model\_context)](#oh_ai_modelbuildfromfile) | - | 通过模型文件加载并编译MindSpore Lite模型。  注意，同一个[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)对象仅能传递给[OH\_AI\_ModelBuild](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuild)或者[OH\_AI\_ModelBuildFromFile](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuildfromfile)一次，如果多次调用该函数需要创建多个不同的[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)。 |
...
该函数指针是用于设置[OH\_AI\_ModelPredict](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelpredict)函数参数中的两个回调函数。
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) inputs | 模型输入对应的张量数组结构体。 |
| const [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) outputs | 模型输出对应的张量数组结构体。 |
| const [OH\_AI\_CallBackParam](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-callbackparam/capi-mindspore-oh-ai-callbackparam) kernel\_Info | 当前算子的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) | 模型对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) \*model | 模型对象指针。 |
...
注意，同一个[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)对象仅能传递给[OH\_AI\_ModelBuild](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuild)或者[OH\_AI\_ModelBuildFromFile](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_modelbuildfromfile)一次，如果多次调用该函数需要创建多个不同的[OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)。
...
| [OH\_AI\_ModelType](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_modeltype) model\_type | 模型文件类型，具体见[OH\_AI\_ModelType](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_modeltype)。 |
| const [OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle) model\_context | 模型运行时的上下文环境，具体见 [OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_Status](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-status-h/capi-status-h#oh_ai_status) | 枚举类型的状态码[OH\_AI\_Status](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-status-h/capi-status-h#oh_ai_status)，若成功返回OH\_AI\_STATUS\_SUCCESS，失败则返回具体错误码。 |
...
| [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) model | 模型对象指针。 |
| [const OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) inputs | 模型输入对应的张量数组结构体。 |
| [OH\_AI\_ShapeInfo](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-shapeinfo/capi-mindspore-oh-ai-shapeinfo) \*shape\_infos | 输入形状信息数组，按模型输入顺序排列的由形状信息组成的数组，模型会按顺序依次调整张量形状。 |
...
| [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) model | 模型对象指针。 |
| [const OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) inputs | 模型输入对应的张量数组结构体。 |
| [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) \*outputs | 模型输出对应的张量数组结构体的指针。 |
| [const OH\_AI\_KernelCallBack](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_kernelcallback) before | 模型推理前执行的回调函数。 |
| [const OH\_AI\_KernelCallBack](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-model-h/capi-model-h#oh_ai_kernelcallback) after | 模型推理后执行的回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) model | 模型对象指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) | 模型输入对应的张量数组结构体。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) | 模型输出对应的张量数组结构体。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TensorHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandle/capi-mindspore-oh-ai-tensorhandle) | tensor\_name所对应的输入张量的张量指针，如果输入中没有该张量则返回空。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TensorHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandle/capi-mindspore-oh-ai-tensorhandle) | tensor\_name所对应的输出张量的张量指针，如果输出中没有该张量则返回空。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TrainCfgHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-traincfghandle/capi-mindspore-oh-ai-traincfghandle) | 训练配置对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AI\_TrainCfgHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-traincfghandle/capi-mindspore-oh-ai-traincfghandle) \*train\_cfg | 训练配置对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_OptimizationLevel](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_optimizationlevel) | 优化等级。 |
...
| --- | --- |
| [OH\_AI\_TrainCfgHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-traincfghandle/capi-mindspore-oh-ai-traincfghandle) train\_cfg | 训练配置对象指针。 |
| [OH\_AI\_OptimizationLevel](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_optimizationlevel) level | 优化等级。 |
...
| [OH\_AI\_ModelType](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_modeltype) model\_type | 模型文件类型，具体见[OH\_AI\_ModelType](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_modeltype)。 |
| const [OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle) model\_context | 模型运行时的上下文环境，具体见 [OH\_AI\_ContextHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-contexthandle/capi-mindspore-oh-ai-contexthandle)。 |
| const [OH\_AI\_TrainCfgHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-traincfghandle/capi-mindspore-oh-ai-traincfghandle) train\_cfg | 训练配置对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_AI\_API [OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) | 模型的所有权重Tensor。 |
...
| --- | --- |
| [OH\_AI\_ModelHandle](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-modelhandle/capi-mindspore-oh-ai-modelhandle) model | 模型对象指针。 |
| [const OH\_AI\_TensorHandleArray](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-struct/capi-mindspore-oh-ai-tensorhandlearray/capi-mindspore-oh-ai-tensorhandlearray) new\_weights | 要更新的权重Tensor。 |
...
| [OH\_AI\_QuantizationType](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-headerfile/capi-types-h/capi-types-h#oh_ai_quantizationtype) quantization\_type | 量化类型。 |
