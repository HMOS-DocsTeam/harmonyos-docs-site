...
title: "资源管理错误码"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-resource-manager
kit: 应用框架
last_updated: "2026-04-22"
slug: errorcode-resource-manager
---

# 资源管理错误码

![](../../../images/508d1796/note_3.0-zh-cn.png) 
...
1. 排查是否为以下场景：[HAR开启混淆](/development-fundamentals/application-package-fundamentals/application-package-dev/har-package#混淆配置)、中间码HAR、字节码HAR、跨HAP/HSP包。这四种场景推荐使用[getStringByName()](/ref/localization-api/localization-arkts/js-apis-resource-manager/js-apis-resource-manager#getstringbyname9)等方法通过名称获取资源。
2. 检查传入参数的资源id是否已有。
