...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sendable-resource-manager
kit: 应用框架
...
Resource对象通过转换为SendableResource对象后，可以被[Sendable类](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable)持有。Sendable类在跨线程传输后，取出持有的SendableResource对象转为Resource对象，作为参数获取资源。

![](../../../images/3879b4df/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [\_Resource](/ref/localization-api/localization-arkts/localization-global-arkts/js-apis-resource/js-apis-resource#resource-1) | 表示Resource资源信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_SendableResource](/ref/localization-api/localization-arkts/localization-global-arkts/js-apis-sendableresource/js-apis-sendableresource#sendableresource-1) | 表示SendableResource资源信息。 |
