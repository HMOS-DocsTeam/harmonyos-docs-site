...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n
kit: 应用框架
...
本模块提供系统相关的以及增强的[国际化](/localization-kit/i18n-l10n)能力，包括区域管理、电话号码处理、日历等，相关接口为[ECMA 402](https://dev.ecma-international.org/publications-and-standards/standards/ecma-402/)标准中未定义的补充接口。[Intl模块](/ref/localization-api/localization-arkts/js-apis-intl/js-apis-intl)提供了ECMA 402标准定义的基础国际化接口，与本模块共同使用可提供完整地国际化能力。接口中使用的名词定义如下：
...
![](../../../images/acd31d09/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 国家地区，要求是[合法的国家地区码](/localization-kit/i18n/i18n-locale-culture#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 |
...
以下错误码的详细介绍请参见[ohos.i18n错误码](/ref/localization-api/localization-arkts-errcode/errorcode-i18n/errorcode-i18n)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../images/ee808517/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | 语言，要求是[合法的语言ID](/localization-kit/i18n/i18n-locale-culture#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 |
| sentenceCase | boolean | 否 | true表示按照首字母大写的格式显示文本，false表示按照区域默认的大小写格式显示文本。默认值：true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](/localization-kit/i18n/i18n-locale-culture#实现原理)。 |
...
![](../../../images/4c1c5f51/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](/localization-kit/i18n/i18n-locale-culture#实现原理)，例如zh。 |
| region | string | 否 | [合法的国家地区码](/localization-kit/i18n/i18n-locale-culture#实现原理)，例如CN。  默认值：SIM卡国家地区。 |
...
![](../../../images/3d1b4f06/note_3.0-zh-cn.png) 
...
获取系统当前设置的语言。若要监听系统语言变化，可以监听[公共事件](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/process-thread-communi-arkts/commoneventmanager-definitions/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](/localization-kit/i18n/i18n-language-user-preferences/i18n-system-language-region#开发步骤)。
...
获取系统当前设置的国家地区。若要监听系统地区变化，可以监听[公共事件](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/process-thread-communi-arkts/commoneventmanager-definitions/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](/localization-kit/i18n/i18n-language-user-preferences/i18n-system-language-region#开发步骤)。
...
获取系统当前设置的区域对象。若要监听系统区域变化，可以监听[公共事件](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/process-thread-communi-arkts/commoneventmanager-definitions/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](/localization-kit/i18n/i18n-language-user-preferences/i18n-system-language-region#开发步骤)。
...
判断系统时制是否为24小时制。若要监听系统时制变化，可以监听[公共事件](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/process-thread-communi-arkts/commoneventmanager-definitions/commoneventmanager-definitions#common_event_time_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_TIME\_CHANGED，具体可参考[用户偏好](/localization-kit/i18n/i18n-language-user-preferences/i18n-user-preferences#开发步骤)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](/localization-kit/i18n/i18n-locale-culture#实现原理)或'default'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 否 | [合法的语言ID](/localization-kit/i18n/i18n-locale-culture#实现原理)。默认值：系统语言。 |
...
以下错误码的详细介绍请参见[ohos.i18n错误码](/ref/localization-api/localization-arkts-errcode/errorcode-i18n/errorcode-i18n)。

| 错误码ID | 错误信息 |
| --- | --- |
| 890001 | Invalid parameter. Possible causes: Parameter verification failed. |

![](../../../images/d35a5e1b/note_3.0-zh-cn.png) 
...
判断语言是否为镜像语言。在镜像语言下，UI界面需要[镜像显示](/localization-kit/i18n/i18n-ui-design#界面镜像)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，例如zh-Hans-CN。 |
| type | string | 否 | 表示历法，取值包括：buddhist, chinese, coptic, ethiopic, hebrew, gregory, indian, islamic\_civil, islamic\_tbla, islamic\_umalqura, japanese, persian。  默认值：区域默认的历法。不同取值代表的含义和使用场景请参考[设置日历和历法](/localization-kit/i18n/i18n-calendar)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，例如zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| field | string | 是 | 指定的日历属性，目前支持的属性值有 year, month, week\_of\_year, week\_of\_month, date, day\_of\_year, day\_of\_week, day\_of\_week\_in\_month, hour, hour\_of\_day, minute, second, millisecond。  各取值代表的含义请参考[get](#get8)。 |
...
![](../../../images/9a625f0d/note_3.0-zh-cn.png) 
...
![](../../../images/8f7af7a0/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。  生成的[BreakIterator](#breakiterator8)将按照指定区域的规则计算可换行点的位置。 |
...
![](../../../images/885a895b/note_3.0-zh-cn.png) 
...
获取时区跳变规则，时区的跳变逻辑参考[夏令时跳变](/localization-kit/i18n/i18n-time-zone-dst/i18n-dst-transition)。
...
| locale | string | 是 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，如：zh-Hans-CN。 |
| style | string | 否 | 格式化使用的风格，取值包括：'long', 'short', 'narrow'。默认值：short。  不同取值显示效果请参考[数字与度量衡国际化](/localization-kit/i18n/i18n-numbers-weights-measures)。 |
...
| locale | string | 否 | [表示区域ID的字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。如：zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | 待匹配的[区域ID字符串](/localization-kit/i18n/i18n-locale-culture#实现原理)，如：zh-Hans-CN。 |
...
| path | string | 是 | 待处理的路径，如：/data/out/tmp。 |
| delimiter | string | 否 | 路径分隔符，默认值：/。 |
| locale | [intl.Locale](/ref/localization-api/localization-arkts/js-apis-intl/js-apis-intl#localedeprecated) | 否 | 区域对象，默认值：系统区域对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#styledstring) | 格式化后的富文本对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| year | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定年的文本样式。默认值：StyledString默认的文本样式。 |
| month | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定月的文本样式。默认值：StyledString默认的文本样式。 |
| day | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定日的文本样式。默认值：StyledString默认的文本样式。 |
| hour | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时的文本样式。默认值：StyledString默认的文本样式。 |
| minute | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定分的文本样式。默认值：StyledString默认的文本样式。 |
| second | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定秒的文本样式。默认值：StyledString默认的文本样式。 |
| dayPeriod | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时段的文本样式。默认值：StyledString默认的文本样式。 |
| weekday | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定星期的文本样式。默认值：StyledString默认的文本样式。 |
| era | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定纪元的文本样式。默认值：StyledString默认的文本样式。 |
| timeZoneName | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时区名称的文本样式。默认值：StyledString默认的文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [intl.NumberFormat](/ref/localization-api/localization-arkts/js-apis-intl/js-apis-intl#numberformat) | [SimpleNumberFormat](#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| integer | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定整数部分的文本样式。默认值：StyledString默认的文本样式。 |
| decimal | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定小数点的文本样式。默认值：StyledString默认的文本样式。 |
| fraction | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定小数部分的文本样式。默认值：StyledString默认的文本样式。 |
| unit | [TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle) | 否 | 是 | 指定单位部分的文本样式。默认值：StyledString默认的文本样式。 |
