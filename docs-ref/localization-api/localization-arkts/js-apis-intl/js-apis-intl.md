...
[I18N模块](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n)提供其他非ECMA 402定义的国际化接口，与本模块共同使用可提供完整的国际化支持能力。

![](../../../images/b17c64db/note_3.0-zh-cn.png) 
...
| calendar | string | 否 | 否 | 区域的日历信息，取值包括：  "buddhist", "chinese", "coptic","dangi", "ethioaa", "ethiopic", "gregory", "hebrew", "indian", "islamic", "islamic-umalqura", "islamic-tbla", "islamic-civil", "islamic-rgsa", "iso8601", "japanese", "persian", "roc", "islamicc"。  不同取值表示的含义请参考[设置日历和历法表1](/localization-kit/i18n/i18n-calendar)。 |
...
从API version 8开始支持，从API version 20开始废弃，建议使用[i18n.System.getSystemLocaleInstance](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n#getsystemlocaleinstance20)替代。
...
![](../../../images/a6569d45/note_3.0-zh-cn.png) 

- calendar：不同取值的含义请参考[设置日历和历法表1](/localization-kit/i18n/i18n-calendar)。
...
![](../../../images/14c34925/note_3.0-zh-cn.png) 
...
![](../../../images/387a5eb1/note_3.0-zh-cn.png) 
