...
title: "raw_file.h"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-raw-file-h
kit: 应用框架
last_updated: "2026-04-22"
slug: capi-raw-file-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [RawFileDescriptor](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor/capi-rawfile-rawfiledescriptor) | RawFileDescriptor | 提供rawfile文件描述符信息。RawFileDescriptor是[OH\_ResourceManager\_GetRawFileDescriptor](#oh_resourcemanager_getrawfiledescriptor)的输出参数，涵盖了rawfile文件的文件描述符以及在HAP包中的起始位置和长度。 |
| [RawFileDescriptor64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor64/capi-rawfile-rawfiledescriptor64) | RawFileDescriptor64 | 提供较大rawfile文件描述符信息。RawFileDescriptor64是[OH\_ResourceManager\_GetRawFileDescriptor64](#oh_resourcemanager_getrawfiledescriptor64)的输出参数，涵盖了rawfile文件的文件描述符以及在HAP包中的起始位置和长度。 |
| [RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) | RawFile | 提供对rawfile的访问功能。 |
| [RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) | RawFile64 | 提供对较大rawfile的访问功能。 |
...
| [void OH\_ResourceManager\_CloseRawFile(RawFile \*rawFile)](#oh_resourcemanager_closerawfile) | 关闭已打开的[RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) 以及释放所有相关联的资源。 |
...
| [void OH\_ResourceManager\_CloseRawFile64(RawFile64 \*rawFile)](#oh_resourcemanager_closerawfile64) | 关闭已打开的[RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) 以及释放所有相关联的资源。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) \*rawFile | 表示指向[RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) \*rawFile | 表示指向[RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile)的指针。 |
...
关闭已打开的[RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) 以及释放所有相关联的资源。
...
****替代接口：**** [OH\_ResourceManager\_GetRawFileDescriptorData](/ref/localization-api/localization-c/localization-headerfile/capi-raw-file-h/capi-raw-file-h#oh_resourcemanager_getrawfiledescriptordata)
...
| --- | --- |
| [const RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile) \*rawFile | 表示指向[RawFile](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile/capi-rawfile-rawfile)的指针。 |
| [RawFileDescriptor](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor/capi-rawfile-rawfiledescriptor) \*descriptor | 显示rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
****替代接口：**** [OH\_ResourceManager\_ReleaseRawFileDescriptorData](/ref/localization-api/localization-c/localization-headerfile/capi-raw-file-h/capi-raw-file-h#oh_resourcemanager_releaserawfiledescriptordata)

****参数：****

| 参数项 | 描述 |
| --- | --- |
| [const RawFileDescriptor](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor/capi-rawfile-rawfiledescriptor) &descriptor | 包含rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) \*rawFile | 表示指向[RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64)的指针。 |
| void \*buf | 用于接收读取数据的缓冲区指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) \*rawFile | 表示指向[RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64)的指针。 |
...
关闭已打开的[RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) 以及释放所有相关联的资源。
...
[OH\_ResourceManager\_OpenRawFile64](/ref/localization-api/localization-c/localization-headerfile/capi-raw-file-manager-h/capi-raw-file-manager-h#oh_resourcemanager_openrawfile64)
...
| --- | --- |
| [const RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64) \*rawFile | 表示指向[RawFile64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfile64/capi-rawfile-rawfile64)的指针。 |
| [RawFileDescriptor64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor64/capi-rawfile-rawfiledescriptor64) \*descriptor | 显示rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFileDescriptor64](/ref/localization-api/localization-c/localization-struct/capi-rawfile-rawfiledescriptor64/capi-rawfile-rawfiledescriptor64) \*descriptor | 包含rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
