...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ResourceManager\_Configuration](/ref/localization-api/localization-c/localization-struct/capi-resourcemanager-resourcemanager-configuration/capi-resourcemanager-resourcemanager-configuration) | ResourceManager\_Configuration | 设备状态的枚举。 |
