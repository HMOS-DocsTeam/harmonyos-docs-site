...
- value: 该导出接口额外支持Sendable TypedArray（[Int8Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-int8array/arkts-apis-arkts-collections-int8array)、[Uint8Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-uint8array/arkts-apis-arkts-collections-uint8array)、[Int16Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-int16array/arkts-apis-arkts-collections-int16array)、[Uint16Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-uint16array/arkts-apis-arkts-collections-uint16array)、[Int32Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-int32array/arkts-apis-arkts-collections-int32array)、[Uint32Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-uint32array/arkts-apis-arkts-collections-uint32array)、[Uint8ClampedArray](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-uint8clampedarray/arkts-apis-arkts-collections-uint8clampedarray)、[Float32Array](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-float32array/arkts-apis-arkts-collections-float32array)）类型。
...
有关Sendable特性的介绍，详见[Sendable开发指导](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable)。
...
创建基础运行时环境，一个进程最多创建64个，并满足与[Worker](/arkts/arkts-concurrency/multithread-concurrency/worker-introduction)创建的子线程总数不超过80个。
...
- [in] js\_object：ArkTS对象。
- [in] native\_object：将被包裹在ArkTS对象中的native实例。
- [in] finalize\_cb：[可选]ArkTS对象被销毁时调用的回调函数，详情请参见[napi\_finalize回调函数说明](#napi_finalize回调函数说明)。
...
- [in] str：指向外部字符串的指针。
- [in] length：字符串长度。
- [in] finalize\_callback：[可选]字符串对象被销毁时调用的回调函数，详情请参见[napi\_finalize\_callback回调函数说明](#napi_finalize_callback回调函数说明)。
- [in] finalize\_hint：[可选]上下文提示，会传递给回调函数。
...
1. 只能为[Sendable对象](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable支持的数据类型)创建napi\_sendable\_ref。
