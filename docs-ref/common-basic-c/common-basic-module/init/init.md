...
title: "Init"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/init
kit: 公共基础能力
...
| 名称 | 描述 |
| --- | --- |
| [syscap\_ndk.h](/ref/common-basic-c/common-basic-headerfile/syscap__ndk_8h/syscap__ndk_8h) | 查询单个系统能力是否被支持的API。  ****引用文件****：<syscap\_ndk.h>  ****库****：libdeviceinfo\_ndk.z.so |
