...
| 名称 | 描述 |
| --- | --- |
| [JSVM\_Value](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-value--8h/capi-jsvm-jsvm-value--8h) namedPropertyData | 命名属性回调使用的数据。 |
| [JSVM\_Value](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-value--8h/capi-jsvm-jsvm-value--8h) indexedPropertyData | 索引属性回调使用的数据。 |
