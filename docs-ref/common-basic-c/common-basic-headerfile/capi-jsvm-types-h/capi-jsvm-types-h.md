...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [JSVM\_CallbackStruct](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-callbackstruct/capi-jsvm-jsvm-callbackstruct) | JSVM\_CallbackStruct | 用户提供的native回调函数的指针和数据，这些函数通过JSVM-API接口暴露给JavaScript。 |
| [JSVM\_HeapStatistics](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-heapstatistics/capi-jsvm-jsvm-heapstatistics) | JSVM\_HeapStatistics | 用于保存有关JavaScript堆内存使用情况的统计信息。 |
| [JSVM\_InitOptions](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-initoptions/capi-jsvm-jsvm-initoptions) | JSVM\_InitOptions | 初始化选项，用于初始化JavaScript虚拟机。 |
| [JSVM\_CreateVMOptions](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-createvmoptions/capi-jsvm-jsvm-createvmoptions) | JSVM\_CreateVMOptions | 创建JavaScript虚拟机的选项。 |
| [JSVM\_VMInfo](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-vminfo/capi-jsvm-jsvm-vminfo) | JSVM\_VMInfo | JavaScript虚拟机信息。 |
| [JSVM\_PropertyDescriptor](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-propertydescriptor/capi-jsvm-jsvm-propertydescriptor) | JSVM\_PropertyDescriptor | 属性描述符。 |
| [JSVM\_ExtendedErrorInfo](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-extendederrorinfo/capi-jsvm-jsvm-extendederrorinfo) | JSVM\_ExtendedErrorInfo | 扩展的异常信息。 |
| [JSVM\_TypeTag](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-typetag/capi-jsvm-jsvm-typetag) | JSVM\_TypeTag | 类型标记，存储为两个无符号64位整数的128位值。作为一个UUID，通过它，JavaScript对象可以是"tagged"，以确保它们的类型保持不变。 |
| [JSVM\_PropertyHandlerConfigurationStruct](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-propertyhandlerconfigurationstruct/capi-jsvm-jsvm-propertyhandlerconfigurationstruct) | JSVM\_PropertyHandlerConfigurationStruct | 当执行对象的getter、setter、deleter和enumerator操作时，该结构体中对应的函数回调将会触发。 |
| [JSVM\_ScriptOrigin](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-scriptorigin/capi-jsvm-jsvm-scriptorigin) | JSVM\_ScriptOrigin | 某段JavaScript代码的原始信息，如sourceMap路径、源文件名、源文件中的起始行/列号等。 |
| [JSVM\_CompileOptions](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-compileoptions/capi-jsvm-jsvm-compileoptions) | JSVM\_CompileOptions | 对应JSVM的编译选项，包含内容和ID。 |
| [JSVM\_CodeCache](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-codecache/capi-jsvm-jsvm-codecache) | JSVM\_CodeCache | 对应JSVM代码缓存的地址与大小。 |
| [JSVM\_PropertyHandler](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-propertyhandler/capi-jsvm-jsvm-propertyhandler) | JSVM\_PropertyHandler | 包含将class作为函数进行调用时所触发的回调函数的函数指针和访问实例对象属性时触发的回调函数的函数指针集。 |
| [JSVM\_DefineClassOptions](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-defineclassoptions/capi-jsvm-jsvm-defineclassoptions) | JSVM\_DefineClassOptions | 定义Class的选项。 |
| [JSVM\_VM\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-vm--8h/capi-jsvm-jsvm-vm--8h) | JSVM\_VM | 表示JavaScript虚拟机实例。 |
| [JSVM\_VMScope\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-vmscope--8h/capi-jsvm-jsvm-vmscope--8h) | JSVM\_VMScope | 表示JavaScript虚拟机作用域。 |
| [JSVM\_EnvScope\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-envscope--8h/capi-jsvm-jsvm-envscope--8h) | JSVM\_EnvScope | 表示用于控制附加到当前虚拟机实例的环境。只有当线程通过OH\_JSVM\_OpenEnvScope进入该环境的JSVM\_EnvScope后，该环境才对线程的虚拟机实例可用。 |
| [JSVM\_Script\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-script--8h/capi-jsvm-jsvm-script--8h) | JSVM\_Script | 表示一段JavaScript代码。 |
| [JSVM\_Env\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-env--8h/capi-jsvm-jsvm-env--8h) | JSVM\_Env | 表示虚拟机特定状态的上下文环境，需要在调用native函数时作为参数传递，并且传递给后续任何的JSVM-API嵌套调用。 |
| [JSVM\_CpuProfiler\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-cpuprofiler--8h/capi-jsvm-jsvm-cpuprofiler--8h) | JSVM\_CpuProfiler | 表示一个JavaScript CPU时间性能分析器。 |
| [JSVM\_Value\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-value--8h/capi-jsvm-jsvm-value--8h) | JSVM\_Value | 表示JavaScript值。 |
| [JSVM\_Data\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-data--8h/capi-jsvm-jsvm-data--8h) | JSVM\_Data | 表示一个 JavaScript Data。 |
| [JSVM\_Ref\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-ref--8h/capi-jsvm-jsvm-ref--8h) | JSVM\_Ref | 表示JavaScript值的引用。 |
| [JSVM\_HandleScope\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-handlescope--8h/capi-jsvm-jsvm-handlescope--8h) | JSVM\_HandleScope | 表示JavaScript值的作用域，用于控制和修改在特定范围内创建的对象的生命周期。通常，JSVM-API值是在JSVM\_HandleScope的上下文中创建的。当从JavaScript调用native方法时，将存在默认JSVM\_HandleScope。如果用户没有显式创建新的JSVM\_HandleScope，将在默认JSVM\_HandleScope中创建JSVM-API值。对于native方法执行之外的任何代码调用（例如，在libuv回调调用期间），模块需要在调用任何可能导致创建JavaScript值的函数之前创建一个作用域。JSVM\_HandleScope是使用OH\_JSVM\_OpenHandleScope创建的，并使用OH\_JSVM\_CloseHandleScope销毁的。关闭作用域代表向GC指示在JSVM\_HandleScope作用域的生命周期内创建的所有JSVM\_Value将不再从当前堆的栈帧中引用。 |
| [JSVM\_EscapableHandleScope\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-escapablehandlescope--8h/capi-jsvm-jsvm-escapablehandlescope--8h) | JSVM\_EscapableHandleScope | 表示一种特殊类型的handle scope，用于将在特定handle scope内创建的值返回到父作用域。 |
| [JSVM\_CallbackInfo\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-callbackinfo--8h/capi-jsvm-jsvm-callbackinfo--8h) | JSVM\_CallbackInfo | 表示传递给回调函数的不透明数据类型。可用于获取调用该函数的上下文的附加信息。 |
| [JSVM\_Deferred\_\_\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-deferred--8h/capi-jsvm-jsvm-deferred--8h) | JSVM\_Deferred | 表示Promise延迟对象。 |
| [JSVM\_PropertyHandlerConfigurationStruct\*](/ref/common-basic-c/common-basic-struct/api-jsvm-jsvm-propertyhandlerconfigurationstruct8h/api-jsvm-jsvm-propertyhandlerconfigurationstruct8h) | JSVM\_PropertyHandlerCfg | 包含属性监听回调的结构的指针类型。 |
| [JSVM\_CallbackStruct\*](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-callbackstruct8h/capi-jsvm-jsvm-callbackstruct8h) | JSVM\_Callback | 用户提供的native函数的函数指针类型，这些函数通过JSVM-API接口暴露给JavaScript。 |
| [JSVM\_CompileProfile](/ref/common-basic-c/common-basic-struct/capi-jsvm-jsvm-compileprofile/capi-jsvm-jsvm-compileprofile) | JSVM\_CompileProfile | 与JSVM\_COMPILE\_COMPILE\_PROFILE一起传递的编译采样文件。 |
