...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/reader-book-parser
kit: 应用服务
...
本模块提供书籍解析的能力，支持对txt、epub、mobi、azw、azw3格式的书籍文件进行解析。通过提前导入到[应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)中的书籍文件，初始化[BookParserHandler](#bookparserhandler)。将书籍基本信息、[书脊](/reader-kit-guide/reader-introduction#基本概念)内容列表、目录列表和章节内容解析出来。
...
| bookCharset | string | 否 | 是 | 书籍内容的字符集，根据书籍编码格式决定，例如："utf-8"。具体支持格式可参考[TextEncoder](/ref/arkts-api/arkts-arkts/js-apis-util/js-apis-util#textencoder)定义。（预留字段，暂不支持。） |
...
![](../../../images/3eabcdd0/note_3.0-zh-cn.png) 
...
书籍资源请求回调接口，在排版引擎渲染界面时调用，需配合ReaderComponentController的注册接口[on('resourceRequest')](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#onresourcerequest)使用。如果有自定义背景及字体资源，需要在此返回对应资源。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | 是 | 本地书籍文件路径（仅支持当前应用下的[应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)）。 |
...
| [1017000999](/ref/reader-api/reader-error-code/reader-error-code#section1017000999) | Other error. |
| [1017010003](/ref/reader-api/reader-error-code/reader-error-code#section1017010003) | Book file format is unexpected. |
| [1017010004](/ref/reader-api/reader-error-code/reader-error-code#section1017010004) | File is not exist. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1017000001](/ref/reader-api/reader-error-code/reader-error-code#section1017000001) | Book parser is not initialized. |
| [1017000999](/ref/reader-api/reader-error-code/reader-error-code#section1017000999) | Other error. |
| [1017010002](/ref/reader-api/reader-error-code/reader-error-code#section1017010002) | Invalid request. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败) | Parameter error. Possible causes: 1.Incorrect parameter types; 2. Parameter out of range. |
| [1017000001](/ref/reader-api/reader-error-code/reader-error-code#section1017000001) | Book parser is not initialized. |
| [1017000999](/ref/reader-api/reader-error-code/reader-error-code#section1017000999) | Other error. |
| [1017010001](/ref/reader-api/reader-error-code/reader-error-code#section1017010001) | Invalid spine item. |
| [1017010002](/ref/reader-api/reader-error-code/reader-error-code#section1017010002) | Invalid request. |
...
![](../../../images/4e0fd924/note_3.0-zh-cn.png) 

开发者通过此接口可获取书封资源。同时排版引擎获取书籍里的图片等资源时，会优先调用该方法，如果获取不到资源会继续调用[on('resourceRequest')](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#onresourcerequest)获取资源。
...
![](../../../images/7dbbe5aa/note_3.0-zh-cn.png) 
