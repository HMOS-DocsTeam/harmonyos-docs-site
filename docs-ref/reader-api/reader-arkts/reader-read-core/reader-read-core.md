...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/reader-read-core
kit: 应用服务
...
| resourceIndex | number | 否 | 否 | 书脊内容节点索引[SpineItem](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#spineitem).index。 |
...
| fontPath | string | 否 | 否 | 字体文件本地路径。  支持两种存放路径：  - 工程目录resources/rawfile文件夹。适合预置字体场景。  - [应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)。适合在线下载字体场景。 |
...
| themeBgImg | string | 否 | 否 | 主题背景图路径，用于阅读页背景的绘制。  支持两种存放路径：  - 工程目录resources/rawfile文件夹。适合预置背景图场景。  - [应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)。适合在线下载背景图场景。 |
| flipMode | string | 否 | 否 | 翻页方式。  - '0'：仿真。  - '1'：横滑。  默认值为0。 |
| scaledDensity | number | 否 | 否 | 系统显示文本的缩放因子，该值通过[display.getDefaultDisplaySync().scaledDensity](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#displaygetdefaultdisplaysync9)字段获取。  在智慧多窗等场景，文本缩放因子发生变化时，开发者需要调用ReaderComponentController组件控制器的[setPageConfig](#setpageconfig)接口更新该属性。 |
| viewPortWidth | number | 否 | 否 | 排版视口宽度，单位：px。 |
| viewPortHeight | number | 否 | 否 | 排版视口高度，单位：px。 |

## ReaderComponentController

[ReadPageComponent](/ref/reader-api/reader-api-component/reader-api-readpagecomponent/reader-api-readpagecomponent#readpagecomponent)组件控制器，需要配合ReadPageComponent组件一起使用。
...
![](../../../images/c023d3cc/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | 当前应用上下文。 |
...
| [1016910004](/ref/reader-api/reader-error-code/reader-error-code#section1016910004) | Invalid caller. |
...
![](../../../images/1f86ba88/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bookParserHandler | bookParser.[BookParserHandler](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#bookparserhandler) | 是 | 书籍解析器。 |
...
| --- | --- |
| [401](/ref/errorcode-universal/errorcode-universal#section401-参数检查失败) | Parameter error. |
| [1016900002](/ref/reader-api/reader-error-code/reader-error-code#section1016900002) | Read Page Component is not initialized. |
| [1016900003](/ref/reader-api/reader-error-code/reader-error-code#section1016900003) | Invalid request. |
| [1016900999](/ref/reader-api/reader-error-code/reader-error-code#section1016900999) | Other error. |
...
![](../../../images/fa48519b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spineIndex | number | 是 | 内容资源索引[SpineItem](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#spineitem).index。 |
...
| [1016900003](/ref/reader-api/reader-error-code/reader-error-code#section1016900003) | Invalid request. |
| [1016900999](/ref/reader-api/reader-error-code/reader-error-code#section1016900999) | Other error. |
| [1016910001](/ref/reader-api/reader-error-code/reader-error-code#section1016910001) | Invalid spine item. |
| [1016910002](/ref/reader-api/reader-error-code/reader-error-code#section1016910002) | Unexpected spine item resource data. |
| [1016910003](/ref/reader-api/reader-error-code/reader-error-code#section1016910003) | Spine item resource data out of range. |
...
触发[ReadPageComponent](/ref/reader-api/reader-api-component/reader-api-readpagecomponent/reader-api-readpagecomponent#readpagecomponent)组件进行翻页。
...
![](../../../images/96e89616/note_3.0-zh-cn.png) 
...
| callback | bookParser.[CallbackRes](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#callbackres)<string, ArrayBuffer> | 是 | 回调函数，string：请求资源路径。ArrayBuffer：请求资源对应的二进制数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为“resourceRequest”。 |
| callback | bookParser.[CallbackRes](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#callbackres)<string, ArrayBuffer> | 否 | 回调函数，需要传[on('resourceRequest')](#onresourcerequest)注册时的回调函数，若不传则注销所有的回调函数。 |
