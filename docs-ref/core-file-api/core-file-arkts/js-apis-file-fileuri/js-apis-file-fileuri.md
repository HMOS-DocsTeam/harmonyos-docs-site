...
该模块提供通过PATH获取文件统一资源标识符（Uniform Resource Identifier，URI），后续可通过使用[@ohos.file.fs](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)进行相关open、read、write等操作，实现文件分享。

![](../../../images/9b9d2060/note_3.0-zh-cn.png) 
