...
![](../../../images/d776b78d/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[基础文件IO错误码](/ref/core-file-api/core-file-arkts-errcode/errorcode-filemanagement/errorcode-filemanagement#基础文件io错误码)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
