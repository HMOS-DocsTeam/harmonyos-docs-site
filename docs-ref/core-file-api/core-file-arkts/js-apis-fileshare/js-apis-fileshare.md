...
该模块提供文件分享能力，提供系统应用将公共目录文件统一资源标识符（Uniform Resource Identifier，URI）以读写权限授权给其他应用的接口，授权后应用可通过[@ohos.file.fs](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs)的相关接口进行相关open、read、write等操作，实现文件分享。

![](../../../images/e196a0b1/note_3.0-zh-cn.png) 
...
![](../../../images/e0da62e6/note_3.0-zh-cn.png) 
...
![](../../../images/65b62a80/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[文件管理错误码](/ref/core-file-api/core-file-arkts-errcode/errorcode-filemanagement/errorcode-filemanagement)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
![](../../../images/03479a7b/note_3.0-zh-cn.png) 
...
![](../../../images/666cb749/note_3.0-zh-cn.png) 
...
![](../../../images/d71210fe/note_3.0-zh-cn.png) 
