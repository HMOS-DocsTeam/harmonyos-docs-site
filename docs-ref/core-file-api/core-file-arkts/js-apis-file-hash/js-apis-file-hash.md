...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-hash
kit: 应用框架
...
![](../../../images/7ff26f94/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[基础文件IO错误码](/ref/core-file-api/core-file-arkts-errcode/errorcode-filemanagement/errorcode-filemanagement#基础文件io错误码)。
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[基础文件IO错误码](/ref/core-file-api/core-file-arkts-errcode/errorcode-filemanagement/errorcode-filemanagement#基础文件io错误码)。
