...
![](../../../../images/8048cd82/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本模块从API version 9开始废弃，建议使用[@ohos.file.statvfs](/ref/core-file-api/core-file-arkts/js-apis-file-statvfs/js-apis-file-statvfs)替代。
