...
title: "Media错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-media
kit: 媒体
last_updated: "2026-04-22"
slug: errorcode-media
---

# Media错误码

![](../../../images/6cabf2a6/note_3.0-zh-cn.png) 
...
支持的规格请根据实际使用的模块功能，参考[Media Kit简介](/media-kit/media-kit-intro)中对应模块的规格介绍。
...
2. 如果不需要拦截，则参考[明文HTTP访问权限配置说明](/system-network/network-kit/network-kit-data-transmission/http-request#明文http访问权限配置说明)对域名权限进行配置。
...
若没有通过[PlaybackStrategy](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-i/arkts-apis-media-i#playbackstrategy12)使能超分，则每次调用超分相关接口时会返回该错误码。
