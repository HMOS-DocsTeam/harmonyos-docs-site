...
| 名称 | 描述 |
| --- | --- |
| int32\_t audioSampleRate | 音频采样率，支持列表请查阅Audio Kit的[AudioSamplingRate](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiosamplingrate8)。 |
| int32\_t audioChannels | 音频声道数。 |
| [OH\_AudioCaptureSourceType](/ref/media-api/media-c/media-headerfile/capi-native-avscreen-capture-base-h/capi-native-avscreen-capture-base-h#oh_audiocapturesourcetype) audioSource | 音频源。 |
