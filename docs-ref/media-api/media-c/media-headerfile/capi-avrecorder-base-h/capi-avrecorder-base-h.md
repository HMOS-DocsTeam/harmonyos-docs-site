...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVRecorder\_Profile](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-profile/capi-avrecorder-oh-avrecorder-profile) | OH\_AVRecorder\_Profile | 定义音视频录制的详细参数。 |
| [OH\_AVRecorder](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder/capi-avrecorder-oh-avrecorder) | OH\_AVRecorder | 初始化AVRecorder。 |
| [OH\_AVRecorder\_Location](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-location/capi-avrecorder-oh-avrecorder-location) | OH\_AVRecorder\_Location | 提供媒体资源的地理位置信息。 |
| [OH\_AVRecorder\_MetadataTemplate](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-metadatatemplate/capi-avrecorder-oh-avrecorder-metadatatemplate) | OH\_AVRecorder\_MetadataTemplate | 定义元数据的基本模板。 |
| [OH\_AVRecorder\_Metadata](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-metadata/capi-avrecorder-oh-avrecorder-metadata) | OH\_AVRecorder\_Metadata | 元数据信息数据结构。 |
| [OH\_AVRecorder\_Config](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-config/capi-avrecorder-oh-avrecorder-config) | OH\_AVRecorder\_Config | 提供媒体AVRecorder的配置定义。 |
| [OH\_AVRecorder\_Range](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-range/capi-avrecorder-oh-avrecorder-range) | OH\_AVRecorder\_Range | 表示类型的范围。 |
| [OH\_AVRecorder\_EncoderInfo](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder-encoderinfo/capi-avrecorder-oh-avrecorder-encoderinfo) | OH\_AVRecorder\_EncoderInfo | 提供编码器信息。 |
...
| 枚举项 | 描述 |
| --- | --- |
| AVRECORDER\_IDLE = 0 | 空闲状态。此时可以调用[OH\_AVRecorder\_Prepare](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_prepare)方法设置录制参数，进入AVRECORDER\_PREPARED状态。 |
| AVRECORDER\_PREPARED = 1 | 准备状态。参数设置完成，此时可以调用[OH\_AVRecorder\_Start](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_start)方法开始录制，进入AVRECORDER\_STARTED状态。 |
| AVRECORDER\_STARTED = 2 | 启动状态。正在录制，此时可以调用[OH\_AVRecorder\_Pause](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_pause)方法暂停录制，进入AVRECORDER\_PAUSED状态。  也可以调用[OH\_AVRecorder\_Stop](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_stop)方法结束录制，进入AVRECORDER\_STOPPED状态。 |
| AVRECORDER\_PAUSED = 3 | 暂停状态。此时可以调用[OH\_AVRecorder\_Resume](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_resume)方法继续录制，进入AVRECORDER\_STARTED状态。  也可以调用[OH\_AVRecorder\_Stop](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_stop)方法结束录制，进入AVRECORDER\_STOPPED状态。 |
| AVRECORDER\_STOPPED = 4 | 停止状态。此时可以调用[OH\_AVRecorder\_Prepare](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_prepare)方法设置录制参数，重新进入AVRECORDER\_PREPARED状态。 |
| AVRECORDER\_RELEASED = 5 | 释放状态。录制资源释放，此时不能再进行任何操作。在任何其他状态下，均可以通过调用[OH\_AVRecorder\_Release](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_release)方法进入AVRECORDER\_RELEASED状态。 |
| AVRECORDER\_ERROR = 6 | 错误状态。当AVRecorder实例发生不可逆错误，会转换至当前状态。  切换至AVRECORDER\_ERROR状态时会伴随[OH\_AVRecorder\_OnError](#oh_avrecorder_onerror)事件，该事件会上报详细错误原因。  在AVRECORDER\_ERROR状态时，用户需要调用[OH\_AVRecorder\_Reset](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_reset)方法重置AVRecorder实例，或者调用[OH\_AVRecorder\_Release](/ref/media-api/media-c/media-headerfile/capi-avrecorder-h/capi-avrecorder-h#oh_avrecorder_release)方法释放资源。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVRecorder](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder/capi-avrecorder-oh-avrecorder) \*recorder | OH\_AVRecorder实例的指针。 |
...
| --- | --- |
| [OH\_AVRecorder](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder/capi-avrecorder-oh-avrecorder) \*recorder | OH\_AVRecorder实例的指针。 |
| int32\_t errorCode | 错误码，详细说明请参见[OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode)。 |
...
| --- | --- |
| [OH\_AVRecorder](/ref/media-api/media-c/media-struct/capi-avrecorder-oh-avrecorder/capi-avrecorder-oh-avrecorder) \*recorder | OH\_AVRecorder实例的指针。 |
| [OH\_MediaAsset](/ref/media-library-api/media-library-c/media-library-struct/capi-mediaassetmanager-oh-mediaasset/capi-mediaassetmanager-oh-mediaasset) \*asset | OH\_MediaAsset实例的指针。 |
| void \*userData | 用户特定数据的指针。 |
