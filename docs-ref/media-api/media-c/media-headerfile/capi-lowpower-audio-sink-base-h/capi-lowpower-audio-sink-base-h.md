...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_LowPowerAudioSink](/ref/media-api/media-c/media-struct/capi-lowpoweraudiosink-oh-lowpoweraudiosink/capi-lowpoweraudiosink-oh-lowpoweraudiosink) | OH\_LowPowerAudioSink | LowPowerAudioSink的声明。 |
| [OH\_LowPowerAudioSinkCallback](/ref/media-api/media-c/media-struct/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback) | OH\_LowPowerAudioSinkCallback | 包含了LowPowerAudioSink回调函数指针的集合。  应用需注册此实例结构体到[OH\_LowPowerAudioSink](/ref/media-api/media-c/media-struct/capi-lowpoweraudiosink-oh-lowpoweraudiosink/capi-lowpoweraudiosink-oh-lowpoweraudiosink)实例中，并对回调上报的信息进行处理，保证LowPowerAudioSink的正常运行。 |
...
| [typedef void (\*OH\_LowPowerAudioSink\_OnEos)(OH\_LowPowerAudioSink\* sink, void\* userData)](#oh_lowpoweraudiosink_oneos) | OH\_LowPowerAudioSink\_OnEos | LowPowerAudioSink播放完成时调用该方法，包含在[OH\_LowPowerAudioSinkCallback](/ref/media-api/media-c/media-struct/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback)中。 |
...
| [OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode) errCode | 发生错误时上报的错误码。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](/ref/media-api/media-c/media-struct/capi-lowpoweraudiosink-oh-lowpoweraudiosink/capi-lowpoweraudiosink-oh-lowpoweraudiosink)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| [OH\_AVSamplesBuffer](/ref/media-api/media-c/media-struct/capi-avsinkbase-oh-avsamplesbuffer/capi-avsinkbase-oh-avsamplesbuffer)\* samples | 即将写入的AVSamplesBuffer实例。 |
| void\* userData | 用户自定义数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](/ref/media-api/media-c/media-struct/capi-lowpoweraudiosink-oh-lowpoweraudiosink/capi-lowpoweraudiosink-oh-lowpoweraudiosink)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| [OH\_AudioInterrupt\_ForceType](/ref/audio-api/audio-c/audio-headerfile/capi-native-audiostream-base-h/capi-native-audiostream-base-h#oh_audiointerrupt_forcetype) type | 音频打断类型。 |
| [OH\_AudioInterrupt\_Hint](/ref/audio-api/audio-c/audio-headerfile/capi-native-audiostream-base-h/capi-native-audiostream-base-h#oh_audiointerrupt_hint) hint | 音频打断提示类型。 |
| void\* userData | 用户自定义数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](/ref/media-api/media-c/media-struct/capi-lowpoweraudiosink-oh-lowpoweraudiosink/capi-lowpoweraudiosink-oh-lowpoweraudiosink)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| [OH\_AudioStream\_DeviceChangeReason](/ref/audio-api/audio-c/audio-headerfile/capi-native-audiostream-base-h/capi-native-audiostream-base-h#oh_audiostream_devicechangereason) reason | 输出设备发生变化的原因。 |
| void\* userData | 用户自定义数据。 |
...
LowPowerAudioSink播放完成时调用该方法，包含在[OH\_LowPowerAudioSinkCallback](/ref/media-api/media-c/media-struct/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback/api-lowpoweraudiosink-oh-lowpoweraudiosinkcallback)中。
