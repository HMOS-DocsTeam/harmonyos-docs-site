...
title: "Functions"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-f
kit: 媒体
...
![](../../../../images/d1939d2e/note_3.0-zh-cn.png) 
...
![](../../../../images/14c4ba85/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avplayer/arkts-apis-media-avplayer)&gt; | 是 | 回调函数。异步返回AVPlayer实例，失败时返回null。可用于音视频播放。 |
...
![](../../../../images/5e1697b9/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avplayer/arkts-apis-media-avplayer)&gt; | Promise对象。成功时异步返回AVPlayer实例，可用于音视频播放。失败时返回null。 |
...
![](../../../../images/58fec1ae/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVRecorder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avrecorder/arkts-apis-media-avrecorder)&gt; | 是 | 回调函数，返回AVRecorder实例，可用于录制音视频媒体。失败时返回null。 |
...
![](../../../../images/54199f9a/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVRecorder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avrecorder/arkts-apis-media-avrecorder)&gt; | Promise对象，返回AVRecorder实例，可用于录制音视频媒体。失败时返回null。 |
...
![](../../../../images/746582f1/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVTranscoder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avtranscoder/arkts-apis-media-avtranscoder)&gt; | Promise对象。异步返回AVTranscoder实例，失败时返回null。可用于视频转码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVMetadataExtractor](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avmetadataextractor/arkts-apis-media-avmetadataextractor)&gt; | 是 | 回调函数。当创建AVMetadataExtractor实例成功，err为undefined，data为获取到的AVMetadataExtractor实例，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVMetadataExtractor](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avmetadataextractor/arkts-apis-media-avmetadataextractor)&gt; | Promise对象。异步返回元数据获取类对象（AVMetadataExtractor）。 |
...
![](../../../../images/4ca39666/note_3.0-zh-cn.png) 
...
| audioRenderInfo | [audio.AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8) | 是 | 音频播放参数信息。其中audioRenderInfo中的参数usage取值为STREAM\_USAGE\_UNKNOWN，STREAM\_USAGE\_MUSIC，STREAM\_USAGE\_MOVIE，STREAM\_USAGE\_AUDIOBOOK时，SoundPool播放短音时为混音模式，不会打断其他音频播放。SoundPool支持将rendererFlags设置为1用于低时延通路播放。 |
| callback | AsyncCallback&lt;[SoundPool](/ref/media-api/media-arkts/media-multimedia-arkts/js-apis-inner-multimedia-soundpool/js-apis-inner-multimedia-soundpool)&gt; | 是 | 回调函数。异步返回SoundPool实例，失败时返回null。用于音频池实例的加载播放功能。 |
...
![](../../../../images/afec5911/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| maxStreams | number | 是 | soundPool实例的最大播放的流数，设置范围为1-32的正整数。 |
| audioRenderInfo | [audio.AudioRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#audiorendererinfo8) | 是 | 音频播放参数信息 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[SoundPool](/ref/media-api/media-arkts/media-multimedia-arkts/js-apis-inner-multimedia-soundpool/js-apis-inner-multimedia-soundpool)&gt; | Promise对象。异步返回SoundPool实例，失败时返回null。用于音频池实例的加载播放功能。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVScreenCaptureRecorder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avscreencapturerecorder/arkts-apis-media-avscreencapturerecorder)&gt; | Promise对象，返回AVScreenCaptureRecorder实例，失败时返回null。可用于进行屏幕录制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[AVImageGenerator](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avimagegenerator/arkts-apis-media-avimagegenerator)&gt; | 是 | 回调函数。异步返回AVImageGenerator实例，失败时返回null。可用于获取视频缩略图。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AVImageGenerator](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avimagegenerator/arkts-apis-media-avimagegenerator)&gt; | Promise对象。异步返回AVImageGenerator实例，失败时返回null。可用于获取视频缩略图。 |
...
| 类型 | 说明 |
| --- | --- |
| [MediaSource](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-mediasource/arkts-apis-media-mediasource) | MediaSource返回值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streams | Array&lt;[MediaStream](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-i/arkts-apis-media-i#mediastream19)&gt; | 是 | 可设置MediaStream数组，支持的流媒体格式：HTTP-FLV。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [MediaSource](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-mediasource/arkts-apis-media-mediasource) | 返回MediaSource，用于媒体资源设置。 |
...
![](../../../../images/092dd207/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AudioPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-audioplayer/arkts-apis-media-audioplayer) | 返回AudioPlayer类实例，失败时返回null。可用于音频播放、暂停、停止等操作。 |
...
![](../../../../images/227511e8/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[VideoPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-videoplayer/arkts-apis-media-videoplayer)&gt; | 是 | 回调函数。创建VideoPlayer实例成功时，err为undefined，data为获取到的VideoPlayer实例，否则为错误对象。 |
...
![](../../../../images/7203f345/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[VideoPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-videoplayer/arkts-apis-media-videoplayer)&gt; | Promise对象。异步返回VideoPlayer实例，失败时返回null。可用于管理和播放视频媒体。 |
...
![](../../../../images/7b27250f/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [AudioRecorder](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-audiorecorder/arkts-apis-media-audiorecorder) | 返回AudioRecorder类实例，失败时返回null。可用于录制音频媒体。 |
