...
视频缩略图获取类，用于从视频资源中获取缩略图。在调用AVImageGenerator的方法前，需要先通过[createAVImageGenerator()](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-f/arkts-apis-media-f#mediacreateavimagegenerator12)构建一个AVImageGenerator实例。

获取视频缩略图的demo可参考：[获取视频缩略图开发指导](/media-kit/media-kit-dev--arkts/media-info-arkts/avimagegenerator)。

![](../../../../images/089ab9f9/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 是 | 回调函数。获取缩略图成功时，err为undefined，data为PixelMap实例，否则为错误对象。 |
...
| queryMode | [AVImageQueryOptions](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-e/arkts-apis-media-e#avimagequeryoptions12) | 是 | 需要获取的缩略图时间点与视频帧的对应关系。 |
| outputSize | [OutputSize](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-i/arkts-apis-media-i#outputsize20) | 否 | 定义帧的输出大小。默认按原图大小显示。 |
