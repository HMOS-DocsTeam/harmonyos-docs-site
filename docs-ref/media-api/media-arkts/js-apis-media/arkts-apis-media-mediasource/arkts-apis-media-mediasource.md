...
媒体数据信息。来源于[createMediaSourceWithUrl](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-f/arkts-apis-media-f#mediacreatemediasourcewithurl12)。

![](../../../../images/d65c90fd/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mimeType | [AVMimeTypes](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-e/arkts-apis-media-e#avmimetypes12) | 是 | 媒体MIME类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceLoader | [MediaSourceLoader](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-i/arkts-apis-media-i#mediasourceloader18) | 是 | 应用实现的媒体数据获取接口，方便播放器获取数据。 |
