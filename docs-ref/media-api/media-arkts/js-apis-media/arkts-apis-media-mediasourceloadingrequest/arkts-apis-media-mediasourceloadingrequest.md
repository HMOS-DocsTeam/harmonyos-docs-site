...
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-mediasourceloadingrequest
kit: 媒体
...
![](../../../../images/c13f5dde/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uuid | number | 是 | 资源句柄的标识。来源是[SourceOpenCallback](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-t/arkts-apis-media-t#sourceopencallback18)。 |
...
| --- | --- | --- | --- |
| uuid | number | 是 | 资源句柄的标识。来源是[SourceOpenCallback](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-t/arkts-apis-media-t#sourceopencallback18)。 |
| state | [LoadingRequestError](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-e/arkts-apis-media-e#loadingrequesterror18) | 是 | 请求的状态。 |
