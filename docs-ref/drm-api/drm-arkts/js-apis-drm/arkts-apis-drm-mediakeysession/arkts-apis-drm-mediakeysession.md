...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-mediakeysession
kit: 媒体
...
支持媒体密钥管理。在调用MediaKeySession方法之前，必须使用[createMediaKeySession](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#createmediakeysession)获取一个MediaKeySession实例。

![](../../../../images/eb5749ce/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mimeType | string | 是 | 媒体类型，DRM解决方案名称，可通过[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported-1)查询。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MediaKeyRequest](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-i/arkts-apis-drm-i#mediakeyrequest)&gt; | Promise对象，媒体密钥请求。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContentProtectionLevel](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#contentprotectionlevel) | 返回当前会话内容保护级别。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mimeType | string | 是 | 媒体类型，支持的媒体类型取决于DRM解决方案，可通过[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported-1)查询。 |
...
| callback | (eventInfo: [EventInfo](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-i/arkts-apis-drm-i#eventinfo)) => void | 是 | 回调函数，返回事件信息。 |
