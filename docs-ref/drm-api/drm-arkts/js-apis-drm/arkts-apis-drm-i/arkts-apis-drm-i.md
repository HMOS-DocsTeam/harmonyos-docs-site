...
![](../../../../images/c226eb71/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| mediaKeyRequestType | [MediaKeyRequestType](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#mediakeyrequesttype) | 否 | 否 | 媒体密钥请求类型。 |
