...
title: "Functions"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-f
kit: 媒体
...
![](../../../../images/445346a6/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem) | MediaKeySystem实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | string | 是 | DRM解决方案名称。建议先调用[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported)判断是否是支持的解决方案名称。 |
...
| --- | --- | --- | --- |
| name | string | 是 | DRM解决方案名称。建议先调用[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported)判断是否是支持的解决方案名称。 |
| mimeType | string | 是 | 媒体类型，支持的媒体类型取决于DRM解决方案。建议先调用[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported-1)判断是否是DRM解决方案支持的类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | string | 是 | DRM解决方案名称，支持的解决方案名称可通过[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported)判断。 |
