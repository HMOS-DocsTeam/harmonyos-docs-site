...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-mediakeysystem
kit: 媒体
...
支持MediaKeySystem实例管理、设备证书申请与处理、会话创建、离线媒体密钥管理、获取DRM度量记录、设备属性等。在调用MediaKeySystem方法之前，必须使用[createMediaKeySystem](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmcreatemediakeysystem)创建一个MediaKeySystem实例。

![](../../../../images/d6b1d53b/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configName | string | 是 | 配置属性名，不能为空，属性名参考[PreDefinedConfigName](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#predefinedconfigname)，具体支持的属性名由设备上DRM解决方案决定。 |
| value | string | 是 | 配置属性值。 |

****错误码：****

以下错误码的详细介绍请参见[通用错误码说明文档](/ref/errorcode-universal/errorcode-universal)和[DRM错误码](/ref/drm-api/drm-arkts-errcode/errorcode-drm/errorcode-drm)。
...
以下错误码的详细介绍请参见[DRM错误码](/ref/drm-api/drm-arkts-errcode/errorcode-drm/errorcode-drm)。
...
| 类型 | 说明 |
| --- | --- |
| [ContentProtectionLevel](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#contentprotectionlevel) | 返回设备支持的最大内容保护级别。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ProvisionRequest](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-i/arkts-apis-drm-i#provisionrequest)&gt; | Promise对象，mediaKeySystem设备证书的请求。设备上如果已存在设备证书，会返回失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [CertificateStatus](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#certificatestatus) | 设备证书状态值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 事件类型，通过[createMediaKeySystem](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmcreatemediakeysystem)成功创建MediaKeySystem实例后可监听，需要设备证书时触发该事件。 |
| callback | (eventInfo: [EventInfo](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-i/arkts-apis-drm-i#eventinfo)) => void | 是 | 回调函数，返回事件信息。只要有该事件返回就证明需请求设备证书。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件类型，通过[createMediaKeySystem](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmcreatemediakeysystem)成功创建MediaKeySystem实例后可监听。 |
| callback | (eventInfo: [EventInfo](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-i/arkts-apis-drm-i#eventinfo)) => void | 否 | 回调函数，返回事件信息。可选。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| level | [ContentProtectionLevel](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#contentprotectionlevel) | 是 | 内容保护级别。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession) | MediaKeySession实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [OfflineMediaKeyStatus](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-e/arkts-apis-drm-e#offlinemediakeystatus) | 离线媒体密钥状态值。 |
