...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DRM\_MediaKeyRequestInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeyrequestinfo/capi-drm-drm-mediakeyrequestinfo) | DRM\_MediaKeyRequestInfo | 媒体密钥请求信息。 |
| [DRM\_MediaKeyRequest](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeyrequest/capi-drm-drm-mediakeyrequest) | DRM\_MediaKeyRequest | 媒体密钥请求。 |
| [DRM\_Statistics](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-statistics/capi-drm-drm-statistics) | DRM\_Statistics | MediaKeySystem的度量信息。 |
| [DRM\_OfflineMediakeyIdArray](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-offlinemediakeyidarray/capi-drm-drm-offlinemediakeyidarray) | DRM\_OfflineMediakeyIdArray | 离线媒体密钥ID数组。 |
| [DRM\_KeysInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-keysinfo/capi-drm-drm-keysinfo) | DRM\_KeysInfo | 媒体密钥信息。 |
| [DRM\_MediaKeyStatus](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeystatus/capi-drm-drm-mediakeystatus) | DRM\_MediaKeyStatus | 媒体密钥状态。 |
| [DRM\_PsshInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-psshinfo/capi-drm-drm-psshinfo) | DRM\_PsshInfo | DRM内容保护系统专用头（Protection System Specific Header）信息。 |
| [DRM\_MediaKeySystemInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeysysteminfo/capi-drm-drm-mediakeysysteminfo) | DRM\_MediaKeySystemInfo | 加密媒体内容的DRM信息。 |
| [DRM\_MediaKeySystemDescription](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeysystemdescription/capi-drm-drm-mediakeysystemdescription) | DRM\_MediaKeySystemDescription | DRM解决方案名称及其UUID的列表。 |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) | MediaKeySystem | MediaKeySystem结构。 |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) | MediaKeySession | MediaKeySession结构。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_MediaKeySystemInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeysysteminfo/capi-drm-drm-mediakeysysteminfo) \*mediaKeySystemInfo | 从媒体源获取的DRM信息。 |
