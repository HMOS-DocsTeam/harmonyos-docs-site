...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [MediaKeySession\_Callback](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession-callback/capi-drm-mediakeysession-callback) | MediaKeySession\_Callback | MediaKeySession\_Callback结构体，用于监听密钥过期、密钥更改等事件，不返回媒体密钥会话实例，适用于单媒体密钥会话解密场景。 |
| [OH\_MediaKeySession\_Callback](/ref/drm-api/drm-c/drm-struct/capi-drm-oh-mediakeysession-callback/capi-drm-oh-mediakeysession-callback) | OH\_MediaKeySession\_Callback | OH\_MediaKeySession\_Callback结构体，用于监听密钥过期、密钥更改等事件，返回媒体密钥会话实例，适用于多个媒体密钥会话的解密场景。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | 错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_KeysInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-keysinfo/capi-drm-drm-keysinfo) \*keysInfo | 密钥信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：参数检查失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*mediaKeySession | 会话实例。 |
| [DRM\_EventType](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_eventtype) eventType | 事件类型。 |
| uint8\_t \*info | 事件信息。 |
| int32\_t infoLen | 事件信息长度。 |
| char \*extra | 增量信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*mediaKeySession | 媒体密钥会话实例。 |
| [DRM\_KeysInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-keysinfo/capi-drm-drm-keysinfo) \*keysInfo | 密钥信息。 |
| bool newKeysAvailable | 新密钥是否可用，true表示可用，false表示不可用。 |
...
| [DRM\_MediaKeyRequestInfo](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeyrequestinfo/capi-drm-drm-mediakeyrequestinfo) \*info | 媒体密钥请求信息。 |
| [DRM\_MediaKeyRequest](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeyrequest/capi-drm-drm-mediakeyrequest) \*mediaKeyRequest | 媒体密钥请求。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或输入参数info为空指针，或输入参数mediaKeyRequest为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*mediaKeySession | MediaKeySession实例。 |
| [DRM\_MediaKeyStatus](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeystatus/capi-drm-drm-mediakeystatus) \*mediaKeyStatus | 媒体密钥状态。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或输入参数mediaKeyStatus为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误或设备上的DRM解决方案不支持离线媒体密钥释放，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误或设备上的DRM解决方案不支持离线媒体密钥释放，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或输入参数contentProtectionLevel为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*mediaKeySession | MediaKeySession实例。 |
| [MediaKeySession\_Callback](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession-callback/capi-drm-mediakeysession-callback) \*callback | MediaKeySession的回调。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySession为空指针或无效，或输入参数callback为空指针。 |
...
| --- | --- |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*mediaKeySession | MediaKeySession实例。 |
| [OH\_MediaKeySession\_Callback](/ref/drm-api/drm-c/drm-struct/capi-drm-oh-mediakeysession-callback/capi-drm-oh-mediakeysession-callback) \*callback | MediaKeySession的回调。 |
