...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_EventType](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_eventtype) eventType | 事件类型。 |
| uint8\_t \*info | 事件信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_EventType](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_eventtype) eventType | 事件类型。 |
| uint8\_t \*info | 事件信息。 |
| int32\_t infoLen | 事件信息长度。 |
| char \*extra | 增量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_MediaKeySystemDescription](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-mediakeysystemdescription/capi-drm-drm-mediakeysystemdescription) \*descs | DRM解决方案名称和唯一标识的列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：可能原因：  1.输入参数descs为空指针或输入参数count为空指针。  2.输入参数descs长度不足。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| const char \*name | DRM解决方案名称。 |
| const char \*mimeType | 媒体类型，支持的媒体类型取决于DRM解决方案，如：video/avc、video/hev。 |
| [DRM\_ContentProtectionLevel](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_contentprotectionlevel) contentProtectionLevel | 内容保护级别。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：可能原因：  1.输入参数name为空指针或长度为0。  2.输入参数mediaKeySystem为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。  DRM\_ERR\_SERVICE\_DIED：服务死亡。  DRM\_ERR\_MAX\_SYSTEM\_NUM\_REACHED：已创建的MediaKeySystem数量达到最大限制(64个)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，或输入参数value为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，或输入参数value为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，输入参数value为空指针，或valueLen为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_Statistics](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-statistics/capi-drm-drm-statistics) \*statistics | 度量记录。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数statistics为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数contentProtectionLevel为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_ContentProtectionLevel](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_contentprotectionlevel) \*level | 内容保护级别。 |
| [MediaKeySession](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysession/capi-drm-mediakeysession) \*\*mediaKeySession | MediaKeySession实例。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数level超出合理范围，或mediaKeySession为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。  DRM\_ERR\_SERVICE\_DIED：服务死亡。  DRM\_ERR\_MAX\_SESSION\_NUM\_REACHED：当前MediaKeySystem已创建的MediaKeySession数量达到最大限制(64个)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数response为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_OfflineMediakeyIdArray](/ref/drm-api/drm-c/drm-struct/capi-drm-drm-offlinemediakeyidarray/capi-drm-drm-offlinemediakeyidarray) \*offlineMediaKeyIds | 离线媒体密钥的媒体密钥标识列表。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数offlineMediaKeyIds为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| [DRM\_OfflineMediaKeyStatus](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_offlinemediakeystatus) \*status | 媒体密钥状态。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数offlineMediaKeyId为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](/ref/drm-api/drm-c/drm-struct/capi-drm-mediakeysystem/capi-drm-mediakeysystem) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_CertificateStatus](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-common-h/capi-native-drm-common-h#drm_certificatestatus) \*certStatus | 设备DRM证书状态值。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数certStatus为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](/ref/drm-api/drm-c/drm-headerfile/capi-native-drm-err-h/capi-native-drm-err-h#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
