...
![](../../../images/298cb553/caution_3.0-zh-cn.png) 

此接口参数uri的具体使用方式参见用户文件uri介绍中的[文档类URI的使用方式](/core-file-kit/user-files/user-file-uri-intro#文档类uri)。
...
以下错误码的详细介绍请参见[ArkTS API错误码](/ref/file-manager-service-api/filemanagerservice-arkts/filemanagerservice-arkts-errorcode/filemanagerservice-arkts-errorcode)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileType | string | 是 | 文件类型对应的UTD-ID，详见[图标格式说明](/ref/file-manager-service-api/filemanagerservice-iconformat/filemanagerservice-iconformat) |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 文件图标的Base64编码或资源对象 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)> | 文件图标的Base64编码或资源对象。使用Promise异步回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| linkUri | string | 是 | 快捷方式文件的URI，调用方对该文件需要有读权限。具体使用方式参见用户文件URI介绍中的[文档类URI的使用方式](/core-file-kit/user-files/user-file-uri-intro#文档类uri)，快捷方式文件URI的后缀必须为“.hlink”。 |
