...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-card-recognition
kit: AI
last_updated: "2026-04-22"
slug: vision-card-recognition
---
...
![](../../../images/244d3776/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| supportType | [CardType](#cardtype) | 是 | - | 表示需要识别的卡证类型。当前仅支持中国大陆地区相关卡证的识别。  ****元服务API：**** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| cardSide | [CardSide](#cardside) | 否 | - | 表示需要识别的卡证页面。默认值：DEFAULT。  ****元服务API：**** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
| callback(deprecated) | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[CallbackParam](#callbackparamdeprecated)> | 是 | - | 卡证识别结果的返回。callback和onResult参数同时配置时只有callback生效。  ****元服务API：**** 从版本5.0.0(12)开始，该接口支持在元服务中使用。  ****说明：****  从5.1.1(19)开始废弃。建议使用onResult替代。 |
| onResult | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[CardRecognitionResult](#cardrecognitionresult)> | 是 | - | 卡证识别结果的返回。callback和onResult参数同时配置时只有callback生效。  ****元服务API：**** 从版本5.1.1(19)开始，该接口支持在元服务中使用。  ****起始版本：**** 5.1.1(19) |
...
![](../../../images/d7ba611c/note_3.0-zh-cn.png) 
...
| cardType | [CardType](#cardtype) | 否 | 是 | 卡证类型。默认值：CARD\_AUTO。 |
