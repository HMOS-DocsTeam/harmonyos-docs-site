...
![](../../../images/0e328194/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 菜单内容。 |
| action | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<string | [Subject](#subject)[]> | 否 | 否 | 菜单结果回调，包含文字选中结果和抠图结果。 |
...
| image | [PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 主体识别的图片。 |
...
这是视觉图像控制器，用于控制交互。继承自[ImageAnalyzerController](/ref/arkui-api/arkui-declarative-comp/images-and-videos/ts-image-common/ts-image-common#imageanalyzercontroller12)类。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Subject](#subject)[] | null> | Promise对象，返回当前选中的主体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| point | [visionBase.Point](/ref/core-vision-api/core-vision-arkts/core-vision-vision-base-api/core-vision-vision-base-api#section1465431712919) | 是 | 相对于图片左上角位置点位（px）。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Subject](#subject) | null> | Promise对象，point点位所在的主体。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | null> | Promise对象，对应id列表组装成的图片。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ImageAnalyzerUIStatus](#imageanalyzeruistatus)&gt; | Promise对象，当前图片分析UI状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;boolean&gt; | Promise对象，返回是否开启视觉搜索。true表示开启视觉搜索，false表示关闭视觉搜索。在文字选择或主体识别状态时拉起会返回false。  ****说明：****  视觉搜索若在[Swiper](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper)容器切换图场景下无法生效，则需要在图片切换的[onAnimationStart](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper#onanimationstart9)中置空一下当前选中图片的index，再由[onAnimationEnd](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-swiper/ts-container-swiper#onanimationend9)时将当前选中index置成当前index，以此实现overlay跟随图片变动而变动。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[AIButtonStatus](#aibuttonstatus)> | 是 | callback回调函数。接收AIButton展示状态。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[AIButtonStatus](#aibuttonstatus)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[ImageAnalyzerVisibility](#imageanalyzervisibility)> | 是 | callback回调函数。接收AI识图控件可见状态。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[ImageAnalyzerVisibility](#imageanalyzervisibility)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<string> | 是 | callback回调函数。接收文字分析结果。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<string> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<string> | 是 | callback回调函数。接收文字选中结果。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[Subject](#subject)[]> | 是 | callback回调函数。接收主体分析结果， 返回所有主体信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[Subject](#subject)[]> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[Subject](#subject)[]> | 是 | callback回调函数。接收选中的主体信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)> | 是 | callback回调函数。接收图片搜索事件信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<void> | 是 | callback回调函数。接收光标移入图片内文字区域事件信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<void> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<void> | 是 | callback回调函数。接收光标移出图片内文字区域事件信息。 |
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 是 | callback回调函数。接收AI识图异常场景信息。 |

****错误码：****

以下错误码的详细介绍请参见[ArkTS API错误码](/ref/vision-api/vision-error-code/vision-error-code)。
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
