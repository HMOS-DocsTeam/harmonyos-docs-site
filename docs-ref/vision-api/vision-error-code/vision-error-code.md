...
![](../../images/c30ade6d/note_3.0-zh-cn.png) 
...
检查输入参数是否符合[InteractiveLivenessConfig](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#interactivelivenessconfig)要求，过一段时间重试，并做好相关的逻辑判断。
