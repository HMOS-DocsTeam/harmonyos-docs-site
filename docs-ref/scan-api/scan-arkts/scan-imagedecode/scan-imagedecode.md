...
推荐使用[picker](/medialibrary-kit/photoaccesshelper-photoviewpicker)获取图片路径。
...
| options | scanBarcode.[ScanOptions](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanoptions) | 否 | 启动图片识码参数。 |

****返回值：****

| ****类型**** | ****说明**** |
| --- | --- |
| Promise&lt;Array&lt;scanBarcode.[ScanResult](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanresult)&gt;&gt; | Promise对象，返回识码结果对象。 |
...
| --- | --- | --- | --- |
| inputImage | [InputImage](#inputimage) | 是 | 待识别的图片信息。 |
| options | scanBarcode.[ScanOptions](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanoptions) | 是 | 启动图片识码参数。 |
| callback | AsyncCallback&lt;Array&lt;scanBarcode.[ScanResult](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanresult)&gt;&gt; | 是 | 回调函数，当图片识码成功，err为undefined，data为获取到的识码结果Array&lt;scanBarcode.[ScanResult](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanresult)&gt;，否则为错误对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scanResults | Array&lt;scanBarcode.[ScanResult](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanresult)&gt; | 否 | 否 | 扫码结果。 |
| zoomValue | number | 否 | 否 | 相机可变焦距比，通过[setZoomRatio](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-zoom/arkts-apis-camera-zoom#setzoomratio11)控制相机实现变焦功能。  ****说明：****  1. 使用Camera Kit [getZoomRatio](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-zoom/arkts-apis-camera-zoom#getzoomratio11)接口获取相机当前变焦比zoomRatio。  2. 使用Camera Kit [setZoomRatio](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-zoom/arkts-apis-camera-zoom#setzoomratio11)接口设置targetRatio，目标值为zoomRatio \* zoomValue。 |
...
| options | scanBarcode.[ScanOptions](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanoptions) | 否 | 启动图像数据识码参数。 |
...
![](../../../images/089e8ba7/note_3.0-zh-cn.png) 
