...
| 名称 | 描述 |
| --- | --- |
| [OH\_Drawing\_FontWeight](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_fontweight) weight | 计算支柱时使用的字体粗细。 |
| [OH\_Drawing\_FontStyle](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_fontstyle) style | 计算支柱时使用的字体格式。 |
