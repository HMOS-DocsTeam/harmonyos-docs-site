...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h
kit: 图形
last_updated: "2026-04-22"
slug: capi-native-display-soloist-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DisplaySoloist\_ExpectedRateRange](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/ivedisplaysoloist-displaysoloist-expectedraterange/ivedisplaysoloist-displaysoloist-expectedraterange) | DisplaySoloist\_ExpectedRateRange | 提供期望帧率范围结构体。 |
| [OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist) | OH\_DisplaySoloist | 提供OH\_DisplaySoloist结构体声明。 |
...
| 类型 | 说明 |
| --- | --- |
| OH\_DisplaySoloist\* | 返回一个指向[OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist)实例的指针，如果返回空表示执行失败，可能的原因是内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist)\* displaySoloist | 一个指向[OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist)实例的指针。 |
...
| --- | --- |
| [OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist)\* displaySoloist | 一个指向[OH\_DisplaySoloist](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-nativedisplaysoloist-oh-displaysoloist/capi-nativedisplaysoloist-oh-displaysoloist)实例的指针。 |
| [DisplaySoloist\_ExpectedRateRange](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/ivedisplaysoloist-displaysoloist-expectedraterange/ivedisplaysoloist-displaysoloist-expectedraterange)\* range | 一个指向期望帧率范围[DisplaySoloist\_ExpectedRateRange](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/ivedisplaysoloist-displaysoloist-expectedraterange/ivedisplaysoloist-displaysoloist-expectedraterange)实例的指针。 |
