...
sidebar_position: 20
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-mask-filter-h
kit: 图形
last_updated: "2026-04-22"
slug: capi-drawing-mask-filter-h
---
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_MaskFilter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-maskfilter/capi-drawing-oh-drawing-maskfilter)\* | 返回创建的蒙版滤波器对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_MaskFilter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-maskfilter/capi-drawing-oh-drawing-maskfilter)\* maskFilter | 表示指向蒙版滤波器对象的指针。 |
