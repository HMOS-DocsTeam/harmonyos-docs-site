...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-colorspace/capi-drawing-oh-drawing-colorspace)\* | 函数返回一个指针，指针指向创建的颜色空间对象[OH\_Drawing\_ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-colorspace/capi-drawing-oh-drawing-colorspace)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-colorspace/capi-drawing-oh-drawing-colorspace)\* colorSpace | 指向颜色空间对象[OH\_Drawing\_ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-drawing-colorspace/capi-drawing-oh-drawing-colorspace)的指针。 |
