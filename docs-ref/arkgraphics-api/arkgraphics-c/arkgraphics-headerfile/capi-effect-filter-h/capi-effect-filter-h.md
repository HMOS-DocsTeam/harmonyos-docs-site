...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNative](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-pixelmapnative/capi-drawing-oh-pixelmapnative)\* pixelmap | 创建滤镜的位图。 |
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\*\* filter | 用来接收滤镜的二级指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [EffectErrorCode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecterrorcode) | 返回结果参见状态码[EffectErrorCode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecterrorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\* filter | 被释放的对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\* filter | 滤镜指针。 |
...
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\* filter | 滤镜指针。 |
| float radius | 毛玻璃效果的模糊半径，单位为像素。 |
| [EffectTileMode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecttilemode) tileMode | 着色器效果平铺模式，支持可选的具体模式可见[EffectTileMode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecttilemode)枚举。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [EffectErrorCode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecterrorcode) | 返回结果参见状态码[EffectErrorCode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-effect-types-h/capi-effect-types-h#effecterrorcode)。  操作成功则返回EFFECT\_SUCCESS。  无效参数则返回EFFECT\_BAD\_PARAMETER。 |
...
| --- | --- |
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\* filter | 滤镜指针。 |
| [OH\_Filter\_ColorMatrix](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter-colormatrix/capi-effectkit-oh-filter-colormatrix)\* matrix | 用来创建滤镜的自定义矩阵[OH\_Filter\_ColorMatrix](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter-colormatrix/capi-effectkit-oh-filter-colormatrix)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-effectkit-oh-filter/capi-effectkit-oh-filter)\* filter | 用来创建位图的滤镜指针。 |
| [OH\_PixelmapNative](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-struct/capi-drawing-oh-pixelmapnative/capi-drawing-oh-pixelmapnative)\*\* pixelmap | 用来接收位图的二级指针。 |
