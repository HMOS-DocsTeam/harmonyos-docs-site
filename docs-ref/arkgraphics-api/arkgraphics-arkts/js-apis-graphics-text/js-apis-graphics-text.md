...
![](../../../images/b218c304/note_3.0-zh-cn.png) 
...
![](../../../images/c9efd056/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 需要查询的字体文件的路径，应为 "file:// + 字体文件绝对路径" 或 $rawfile("工程中resources/rawfile目录下的文件名称")。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fontURL | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 需要检查的字体文件的路径，应为 "file:// + 字体文件绝对路径" 或 "rawfile/目录or文件名"。 |
...
| BREAK\_HYPHEN18+ | 3 | 每行末尾单词尝试通过连字符“-”进行断行，若无法添加连字符“-”，则跟BREAK\_WORD保持一致。  使用此断词策略时，需与[TextStyle](#textstyle)中locale属性配合使用，通过locale定义语言环境共同作用影响断词效果。 |
...
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 否 | 是 | 装饰线颜色，默认为跟随文本颜色。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 否 | 是 | 字体阴影的颜色，默认为黑色Color(255, 0, 0, 0)。 |
| point | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 否 | 是 | 字体阴影基于当前文本的偏移位置，横、纵坐标要大于等于零。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 否 | 否 | 矩形框的颜色。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| FONT\_SIZE | 0 | 以字号大小作为缩放基数。最终行高为[TextStyle](#textstyle).fontSize \* [TextStyle](#textstyle).heightScale。 |
| FONT\_HEIGHT | 1 | 以字形高度作为缩放基数。最终行高为塑形后字形高度 \* [TextStyle](#textstyle).heightScale。 |
...
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 否 | 是 | 文字颜色，默认为白色。 |
...
| badgeType20+ | [TextBadgeType](#textbadgetype20) | 否 | 是 | 设置文本排版时是否使能上标或下标。TEXT\_SUPERSCRIPT表示使能上标，TEXT\_SUBSCRIPT表示使能下标，默认值为TEXT\_BADGE\_NONE表示不使能。 |
| lineHeightMaximum21+ | number | 否 | 是 | 行高上限。若同时应用行高缩放，行高上限在[TextStyle](#textstyle).heightScale大于0时生效。取值为正数浮点数，默认值为Number.MAX\_VALUE。 |
| lineHeightMinimum21+ | number | 否 | 是 | 行高下限。若同时应用行高缩放，行高下限在[TextStyle](#textstyle).heightScale大于0时生效。取值范围为非负浮点数，默认值为0。 |
| lineHeightStyle21+ | [LineHeightStyle](#lineheightstyle21) | 否 | 是 | 行高缩放基数样式。默认为FONT\_SIZE。 |
...
| path | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 需要导入的字体文件的路径，应为 "file:// + 字体文件绝对路径" 或 "rawfile/目录or文件名"。 |
...
| path | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 需要加载的字体文件的路径，支持两种格式： "file:// + 字体文件绝对路径" 或 "rawfile/目录or文件名"。 |
...
| path | string | [Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource) | 是 | 需要加载的字体文件的路径，支持两种格式： "file:// + 字体文件绝对路径" 或 $rawfile("字体文件路径")。 |
...
| wordBreak | [WordBreak](#wordbreak) | 否 | 是 | 断词类型，默认为BREAK\_WORD。  ****元服务API：**** 从API version 22开始，该接口支持在元服务中使用。 |
...
| lineSpacing21+ | number | 否 | 是 | 行间距，默认值为0。lineSpacing不受[TextStyle](#textstyle)中lineHeightMaximum和lineHeightMinimum限制。尾行默认添加行间距，可通过设置[TextStyle](#textstyle).textHeightBehavior为DISABLE\_ALL或DISABLE\_LAST\_ASCENT禁用尾行行间距。  ****元服务API：**** 从API version 22开始，该接口支持在元服务中使用。 |
...
![](../../../images/74e94c1a/zh-cn_image_0000002583480893.png)

![](../../../images/4fdb9093/note_3.0-zh-cn.png) 

示意图展示了后三种对齐方式，前三种对齐方式类似，比较位置是文本基线，即绿色线条部分。

![](../../../images/4309d3e4/zh-cn_image_0000002552801244.png)
...
![](../../../images/02723e77/note_3.0-zh-cn.png) 

示意图展示了点击按钮后layout接口示例代码的运行结果。

![](../../../images/e5d3654c/zh-cn_image_0000002583440939.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| canvas | [drawing.Canvas](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas) | 是 | 绘制的目标画布。 |
...
| --- | --- | --- | --- |
| canvas | [drawing.Canvas](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas) | 是 | 绘制的目标画布。 |
| path | [drawing.Path](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-path/arkts-apis-graphics-drawing-path) | 是 | 确认文字位置的路径。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [common2D.Color](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color) | 是 | 更新后的字体色。 |
...
| fontMetrics | [drawing.FontMetrics](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-i/arkts-apis-graphics-drawing-i#fontmetrics) | 否 | 否 | 字体度量信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rect | [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 否 | 否 | 矩形区域信息。 |
...
![](../../../images/ef72fe11/note_3.0-zh-cn.png) 
...
![](../../../images/49a4e56f/note_3.0-zh-cn.png) 
...
![](../../../images/48c84d2f/zh-cn_image_0000002552960894.png)

示意图展示了字符串为" a b "的排版边界。

![](../../../images/4e84108e/zh-cn_image_0000002583480895.png)

示意图展示了字符串为"j"或"E"的排版边界。

![](../../../images/c22e54c4/zh-cn_image_0000002552801246.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| canvas | [drawing.Canvas](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas) | 是 | 绘制的目标canvas。 |
| x | number | 是 | 绘制的左上角位置的横坐标，浮点数。 |
| y | number | 是 | 绘制的左上角位置的纵坐标，浮点数。 |
...
![](../../../images/293d28c1/note_3.0-zh-cn.png) 

示意图展示了字符串为" a b "的排版边界。

![](../../../images/69f5a9ea/zh-cn_image_0000002583480895.png)

示意图展示了字符串为"j"或"E"的排版边界。

![](../../../images/078ed843/zh-cn_image_0000002552801246.png)
...
![](../../../images/5b76da9f/note_3.0-zh-cn.png) 

示意图展示了字符串为" a b "的图像边界。

![](../../../images/7157596c/zh-cn_image_0000002583440941.png)

示意图展示了字符串为"j"或"E"的图像边界。

![](../../../images/6020509c/zh-cn_image_0000002552960896.png)
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 文本行的图像边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| point | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 要查找索引的位置。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 该排版单元中每个字形相对于每行的字形位置。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 该排版单元中每个字形相对于其索引的偏移量。 |
...
| 类型 | 说明 |
| --- | --- |
| [drawing.Font](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-font/arkts-apis-graphics-drawing-font) | 该排版单元的字体属性对象实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| canvas | [drawing.Canvas](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-canvas/arkts-apis-graphics-drawing-canvas) | 是 | 绘制的目标 canvas。 |
| x | number | 是 | 绘制的左上角位置的横坐标，浮点数。 |
| y | number | 是 | 绘制的左上角位置的纵坐标。浮点数。 |
...
![](../../../images/37183a47/note_3.0-zh-cn.png) 

示意图展示了字符串为" a b "的图像边界。

![](../../../images/8aa68b69/zh-cn_image_0000002583440941.png)

示意图展示了字符串为"j"或"E"的图像边界。

![](../../../images/06434c39/zh-cn_image_0000002552960896.png)
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 该排版单元的图像边界。 |
...
![](../../../images/b59b6c5a/note_3.0-zh-cn.png) 

示意图展示了字符串为" a b "的排版边界。

![](../../../images/b2bf2442/zh-cn_image_0000002583480895.png)

示意图展示了字符串为"j"或"E"的排版边界。

![](../../../images/a5531454/zh-cn_image_0000002552801246.png)
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 返回该排版单元中每个字形相对于水平方向的字形宽度数组。其中，[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)中的x值代表每个字形相对于水平方向的字形宽度，y值为保留字段，默认返回0。 |
...
![](../../../images/e312dbc3/zh-cn_image_0000002583480897.png)

alignment为LEFT，location为100，文本为"abccccccccc/tdef"：

![](../../../images/eacc2e29/zh-cn_image_0000002552801248.png)

alignment为RIGHT，location为100，文本为"aabcdef/tg hi/tjkl/tmno/tp qr"：

![](../../../images/d3e6a597/zh-cn_image_0000002583440943.png)
