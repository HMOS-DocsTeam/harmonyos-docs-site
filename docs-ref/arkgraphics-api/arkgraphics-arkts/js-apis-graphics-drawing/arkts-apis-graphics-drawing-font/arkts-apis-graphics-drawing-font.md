...
title: "Class (Font)"
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-font
kit: 图形
...
![](../../../../images/67d82ef4/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [FontHinting](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#fonthinting12) | 返回字型轮廓效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [FontEdging](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#fontedging12) | 返回字型边缘效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| typeface | [Typeface](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-typeface/arkts-apis-graphics-drawing-typeface) | 是 | 字体样式，包括字体名称、粗细、斜体等属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [Typeface](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-typeface/arkts-apis-graphics-drawing-typeface) | 字体。 |
...
| 类型 | 说明 |
| --- | --- |
| [FontMetrics](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-i/arkts-apis-graphics-drawing-i#fontmetrics) | FontMetrics属性。 |
...
![](../../../../images/b332632f/note_3.0-zh-cn.png) 

此接口用于测量原始字符串的文本宽度，若想测量排版后的文本宽度，建议使用[measure.measureText](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-measureutils/arkts-apis-uicontext-measureutils#measuretext12)替代。
...
| --- | --- | --- | --- |
| text | string | 是 | 文本内容。 |
| encoding | [TextEncoding](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#textencoding) | 是 | 编码格式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edging | [FontEdging](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#fontedging12) | 是 | 字型边缘效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hinting | [FontHinting](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#fonthinting12) | 是 | 字型轮廓效果。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect)&gt; | 返回字形边界矩形数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-path/arkts-apis-graphics-drawing-path) | 返回获取到的文本的路径轮廓。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-path/arkts-apis-graphics-drawing-path) | 返回指定字形的路径轮廓。 |
