...
![](../../../../images/34b4e680/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| flags12+ | [FontMetricsFlags](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#fontmetricsflags12) | 否 | 是 | 表明哪些字体度量标志有效。 |
