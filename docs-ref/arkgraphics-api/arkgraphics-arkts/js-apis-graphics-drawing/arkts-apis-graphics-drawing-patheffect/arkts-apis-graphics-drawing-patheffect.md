...
![](../../../../images/50f2caef/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [PathEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-patheffect/arkts-apis-graphics-drawing-patheffect) | 返回创建的路径效果对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-path/arkts-apis-graphics-drawing-path) | 是 | 通过该路径生成一个图形，用来填充每个虚线段。 |
| advance | number | 是 | 虚线段的步长，该参数为大于0的浮点数，否则会抛错误码。 |
| phase | number | 是 | 表示虚线段内图形在虚线步长范围内的偏移量，该参数为浮点数，效果为先对偏移量取绝对值，然后对步长取模。 |
| style | [PathDashStyle](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#pathdashstyle18) | 是 | 指定虚线效果的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| firstPathEffect | [PathEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-patheffect/arkts-apis-graphics-drawing-patheffect) | 是 | 表示第一个路径效果。 |
| secondPathEffect | [PathEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-patheffect/arkts-apis-graphics-drawing-patheffect) | 是 | 表示第二个路径效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| outer | [PathEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-patheffect/arkts-apis-graphics-drawing-patheffect) | 是 | 组合路径效果中外部路径效果。 |
| inner | [PathEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-patheffect/arkts-apis-graphics-drawing-patheffect) | 是 | 组合路径效果中内部路径效果。 |
