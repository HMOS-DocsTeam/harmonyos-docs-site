...
![](../../../../images/30d93dd7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dstShaderEffect | [ShaderEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-shadereffect/arkts-apis-graphics-drawing-shadereffect) | 是 | 在混合模式中作为目标色的着色器。 |
| srcShaderEffect | [ShaderEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-shadereffect/arkts-apis-graphics-drawing-shadereffect) | 是 | 在混合模式中作为源色的着色器。 |
| blendMode | [BlendMode](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#blendmode) | 是 | 混合模式。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [ShaderEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-shadereffect/arkts-apis-graphics-drawing-shadereffect) | 返回创建的着色器对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 进行采样的图片对象。 |
| tileX | [TileMode](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#tilemode12) | 是 | 水平方向的平铺模式。 |
| tileY | [TileMode](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#tilemode12) | 是 | 竖直方向的平铺模式。 |
| samplingOptions | [SamplingOptions](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-samplingoptions/arkts-apis-graphics-drawing-samplingoptions) | 是 | 图片采样参数。 |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | null | 否 | 可选参数，对图片施加的矩阵变换，如果为空，则不施加任何变换。 |
...
| 类型 | 说明 |
| --- | --- |
| [ShaderEffect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-shadereffect/arkts-apis-graphics-drawing-shadereffect) | 返回具有单一颜色的着色器对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| startPt | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 表示渐变的起点。 |
| endPt | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 表示渐变的终点。 |
| colors | Array&lt;number&gt; | 是 | 表示在两个点之间分布的颜色数组，数组中的值为32位（ARGB）无符号整数。 |
| mode | [TileMode](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#tilemode12) | 是 | 着色器效果平铺模式。 |
...
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | null | 否 | 矩阵对象，用于对着色器做矩阵变换。默认为null，表示单位矩阵。 |

![](../../../../images/95f8092a/zh-cn_image_0000002552801216.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| centerPt | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 表示渐变的圆心。 |
...
![](../../../../images/2af563de/zh-cn_image_0000002583440911.png)
...
![](../../../../images/180ce22b/zh-cn_image_0000002552960866.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| startPt | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 表示渐变的起始圆的圆心。 |
| startRadius | number | 是 | 表示渐变的起始圆的半径，小于0时无效。该参数为浮点数。 |
| endPt | [common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12) | 是 | 表示渐变的结束圆的圆心。 |
...
![](../../../../images/d061f87f/zh-cn_image_0000002583480867.png)
