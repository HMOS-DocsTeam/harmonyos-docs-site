...
![](../../../../images/7d6bc2c6/zh-cn_image_0000002583440909.png)
...
![](../../../../images/20ccf73f/zh-cn_image_0000002552960864.png)

![](../../../../images/95ae536a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 被拷贝的矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 表示矩阵对象，位于乘法表达式右侧。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | Array&lt;number&gt; | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 用于更新的数组或矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrixA | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 用于运算的矩阵A。 |
| matrixB | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 用于运算的矩阵B。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 用于运算的矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 另一个矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-matrix/arkts-apis-graphics-drawing-matrix) | 是 | 矩阵对象，用于存储获取到的逆矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 是 | 源点数组。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 源点数组经矩阵变换后的点数组。 |
...
![](../../../../images/1ae9a0bf/zh-cn_image_0000002583480865.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dst | [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 是 | 目标矩形对象，用于存储源矩形经矩阵变换后的图形的外接矩形。 |
| src | [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 是 | 源矩形对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 是 | 源矩形。 |
| dst | [common2D.Rect](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#rect) | 是 | 目标矩形。 |
| scaleToFit | [ScaleToFit](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-e/arkts-apis-graphics-drawing-e#scaletofit12) | 是 | 源矩形到目标矩形的映射方式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 是 | 源点数组，长度必须为count。 |
| dst | Array&lt;[common2D.Point](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#point12)&gt; | 是 | 目标点数组，长度必须为count。 |
