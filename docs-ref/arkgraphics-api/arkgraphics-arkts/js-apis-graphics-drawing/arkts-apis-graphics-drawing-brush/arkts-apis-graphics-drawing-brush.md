...
title: "Class (Brush)"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-brush
kit: 图形
...
![](../../../../images/5ed7b296/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| brush | [Brush](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-brush/arkts-apis-graphics-drawing-brush) | 是 | 待复制的画刷对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Color4f](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-common2d/js-apis-graphics-common2d#color4f20) | 返回画刷的颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [ImageFilter](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-imagefilter/arkts-apis-graphics-drawing-imagefilter) | null | 是 | 图像滤波器，null表示清空图像滤波器效果。 |
