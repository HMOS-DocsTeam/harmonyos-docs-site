...
![](../../../images/dc4aa230/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | image模块创建的PixelMap实例。可通过图片解码或直接创建获得，具体可见[Image Kit简介](/image-kit/image-overview)。 |
...
![](../../../images/fc12f1c7/zh-cn_image_0000002552801208.png)
...
![](../../../images/94f41ce7/zh-cn_image_0000002552801208.png)
...
![](../../../images/753fba1f/zh-cn_image_0000002583440903.png)
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[Color](#color) | null> | Color数组，即图像占比前colorCount的颜色值数组，按占比排序。  - 当实际读取的特征色个数小于colorCount时，数组大小为实际特征色个数。  - 取色失败或取色个数小于1返回[null]。 |
...
![](../../../images/063f261b/zh-cn_image_0000002552960858.png)
...
![](../../../images/602a7ae8/zh-cn_image_0000002583480859.png)
...
![](../../../images/1d4134b4/zh-cn_image_0000002552801210.png)
...
![](../../../images/f30ac0e4/note_3.0-zh-cn.png) 

该接口为静态模糊接口，为静态图像提供模糊化效果，如果要对组件进行实时渲染的模糊，可以使用[动态模糊](/arkui/arkts-ui-development/arkts-use-animation/arkts-animation-effects/arkts-blur-effect)。
...
![](../../../images/7000a4ac/zh-cn_image_0000002583440905.png)
...
![](../../../images/98ecfda6/note_3.0-zh-cn.png) 
...
![](../../../images/214b882e/zh-cn_image_0000002552960860.png)
...
![](../../../images/20714739/zh-cn_image_0000002583480861.png)
...
![](../../../images/0cab1eae/zh-cn_image_0000002552801212.png)
...
![](../../../images/4ed8ad85/zh-cn_image_0000002583440907.png)
...
![](../../../images/45c416a9/zh-cn_image_0000002552960862.png)
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | Promise对象。返回已添加链表效果的源图像的image.PixelMap。 |
...
![](../../../images/f7b89a1e/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 已添加效果的源图像的image.PixelMap。 |
