...
| --- | --- | --- | --- | --- | --- |
| mapOptions | [mapCommon.MapOptions](/ref/map-api/map-arkts/map-common/map-common#mapoptions) | 否 | 否 | NA | 地图初始化参数。 |
| mapCallback | AsyncCallback&lt;[map.MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)&gt; | 否 | 否 | NA | 回调函数，当地图初始化成功，err为undefined，data为获取到的[map.MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)；否则为错误对象。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| markerDelegate | [map.MarkerDelegate](/ref/map-api/map-arkts/map-map/map-map-markerdelegate/map-map-markerdelegate) | 是 | 用于表示代理对象的标记。 |
