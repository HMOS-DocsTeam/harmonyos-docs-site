...
title: "navi（路径规划）"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-navi-api
kit: 应用服务
...
![](../../../images/c0daa936/note_3.0-zh-cn.png) 
...
![](../../../images/9f18ca9e/note_3.0-zh-cn.png) 
...
![](../../../images/32de2069/note_3.0-zh-cn.png) 
...
![](../../../images/810a3f6d/note_3.0-zh-cn.png) 
...
![](../../../images/201ee569/note_3.0-zh-cn.png) 
...
![](../../../images/4c42335b/note_3.0-zh-cn.png) 
...
![](../../../images/31fa64ae/note_3.0-zh-cn.png) 
...
![](../../../images/c9cee47f/note_3.0-zh-cn.png) 
...
![](../../../images/bc016416/note_3.0-zh-cn.png) 
...
![](../../../images/41f51f41/note_3.0-zh-cn.png) 
...
![](../../../images/adcb52e1/note_3.0-zh-cn.png) 
...
![](../../../images/7e73e224/note_3.0-zh-cn.png) 
...
![](../../../images/f1dbc77f/note_3.0-zh-cn.png) 
...
![](../../../images/5a5b646c/note_3.0-zh-cn.png) 
...
![](../../../images/53741b97/note_3.0-zh-cn.png) 
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| origins | Array&lt;[RouteCoordinate](#routecoordinate)&gt; | 否 | 否 | 道路绑定的起点坐标列表。  坐标点的数量不能超过31个，相邻两个点之间的距离应大于1米。 |
| destination | [RouteCoordinate](#routecoordinate) | 否 | 否 | 目的地。  ****说明：****  若未设置途经点起点和目的地坐标不能相同。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| waypoints | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 是 | 途经点。最多可以输入5个途经点，异常值不处理。 |
...
| overviewPolyline | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 是 | 表示该路线的编码后的折线经纬度。 |
...
| startLocation | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 出发地的经纬度。 |
| startAddress | string | 否 | 是 | startLocation对应的地址详情。 |
| endLocation | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 目的地的经纬度。 |
...
| startLocation | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 出发地的经纬度。 |
| endLocation | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 目的地的经纬度。 |
| polyline | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 否 | 此路段的一系列坐标点（包含起点和终点坐标）。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| northeast | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 东北角的位置。 |
| southwest | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 西南角的位置。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 途经点的经纬度。 |
...
| polyline | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 否 | 路段的形状坐标。 |
...
| destinations | Array&lt;[RouteCoordinate](#routecoordinate)&gt; | 否 | 否 | 终点的经纬度，不能超过100个。  ****说明：****  1. 驾车路线只能在直线距离2000公里内规划；步行路线只能在直线距离150公里内规划；骑行路线只能在直线距离500公里内规划。  2. 起点的数量乘以终点的数量不能超过100。 |
...
| polyline | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)[] | 否 | 是 | 路线的形状坐标。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 否 | 否 | 地点。 |
...
| polyline | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)[] | 否 | 否 | 路线的形状坐标。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| points | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 否 | 道路贴合点集合，集合个数取值范围：[1,100]，且相邻两个点距离需小于等于500米。 |
