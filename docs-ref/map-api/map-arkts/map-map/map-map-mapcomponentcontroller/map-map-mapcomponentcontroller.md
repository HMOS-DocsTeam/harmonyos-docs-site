...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller
kit: 应用服务
...
![](../../../../images/c3f381f4/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| update | [CameraUpdate](/ref/map-api/map-arkts/map-map/map-map-cameraupdate/map-map-cameraupdate) | 是 | 相机状态将要发生的变化，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| update | [CameraUpdate](/ref/map-api/map-arkts/map-map/map-map-cameraupdate/map-map-cameraupdate) | 是 | 相机状态将要发生的变化，异常值返回401错误码。 |
| duration | number | 否 | 动画的持续时间，单位：ms，默认值为250，取值范围：大于0，异常值按默认值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[AnimateResult](/ref/map-api/map-arkts/map-map/map-map-animateresult/map-map-animateresult)&gt; | Promise对象，返回[AnimateResult](/ref/map-api/map-arkts/map-map/map-map-animateresult/map-map-animateresult)。 |
...
在指定的持续时间内以动画的形式更新相机状态，并更新指定的marker。使用Promise异步回调。相机移动过程中不能被打断，否则[AnimateResult](/ref/map-api/map-arkts/map-map/map-map-animateresult/map-map-animateresult)的参数isCanceled返回值为true。
...
| --- | --- | --- | --- |
| update | [CameraUpdate](/ref/map-api/map-arkts/map-map/map-map-cameraupdate/map-map-cameraupdate) | 是 | 相机状态将要发生的变化，异常值不处理。 |
| marker | [Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker) | 是 | 标记，异常值不处理。 |
...
| --- | --- | --- | --- |
| update | [CameraUpdate](/ref/map-api/map-arkts/map-map/map-map-cameraupdate/map-map-cameraupdate) | 是 | 相机状态将要发生的变化，异常值返回401错误码。 |
| markers | Array&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 一组标记。  ****说明：****  一组标记的位置必须相同，否则会返回401错误码。 |
| duration | number | 是 | 动画的持续时间，单位：ms，默认值为250，取值范围：大于0，异常值按默认值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CameraPosition](/ref/map-api/map-arkts/map-common/map-common#cameraposition) | 相机的当前状态信息。 |
...
指定一个[mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds)来约束相机目标，使用户移动地图时，相机目标不会移出此边界。当设置新的边界时，新边界将覆盖之前设置的边界。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | 约束相机目标的边界，异常值不处理。  ****说明：****  西南角纬度大于东北角纬度时不生效。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](/ref/map-api/map-arkts/map-common/map-common#mappoint) | 是 | 屏幕坐标点，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| location | [geoLocationManager.Location](/ref/location-api/location-arkts/js-apis-geolocationmanager/js-apis-geolocationmanager#location) | 是 | 用户的位置，异常值不处理。  ****说明：****  location参数需使用WGS84坐标系。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| style | [mapCommon.MyLocationStyle](/ref/map-api/map-arkts/map-common/map-common#mylocationstyle) | 是 | 用户的位置样式，异常值不处理。  ****说明：****  如果displayType使用FOLLOW\_ROTATE需应用申请传感器权限：ohos.permission.ACCELEROMETER，具体可参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| alignment | [mapCommon.LogoAlignment](/ref/map-api/map-arkts/map-common/map-common#logoalignment) | 是 | 地图Logo的对齐方式，异常值不处理。 |
...
![](../../../../images/0ac4a48e/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](/ref/map-api/map-arkts/map-common/map-common#padding) | 是 | 地图边界与Logo之间的间距，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| options | [mapCommon.MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions) | 是 | 标记的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | Promise对象，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| options | [mapCommon.MapCircleOptions](/ref/map-api/map-arkts/map-common/map-common#mapcircleoptions) | 是 | 圆的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)&gt; | Promise对象，返回[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolylineOptions](/ref/map-api/map-arkts/map-common/map-common#mappolylineoptions) | 是 | 折线的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)&gt; | Promise对象，返回[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolygonOptions](/ref/map-api/map-arkts/map-common/map-common#mappolygonoptions) | 是 | 多边形的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)&gt; | Promise对象，返回[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.PointAnnotationParams](/ref/map-api/map-arkts/map-common/map-common#pointannotationparams) | 是 | 点注释的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)&gt; | Promise对象，返回[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.BubbleParams](/ref/map-api/map-arkts/map-common/map-common#bubbleparams) | 是 | 气泡的属性设置。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)&gt; | Promise对象，返回[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](/ref/map-api/map-arkts/map-common/map-common#padding) | 否 | 地图和边界的距离，异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [Projection](/ref/map-api/map-arkts/map-map/map-map-projection/map-map-projection) | [Projection](/ref/map-api/map-arkts/map-map/map-map-projection/map-map-projection)对象。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| customMapStyleOptions | [mapCommon.CustomMapStyleOptions](/ref/map-api/map-arkts/map-common/map-common#custommapstyleoptions) | 是 | 自定义样式参数，异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.DayNightMode](/ref/map-api/map-arkts/map-common/map-common#daynightmode) | 日间夜间模式。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| mode | [mapCommon.DayNightMode](/ref/map-api/map-arkts/map-common/map-common#daynightmode) | 是 | 日间夜间模式，异常值不处理。 |
...
| ****类型**** | ****说明**** |
| --- | --- |
| [mapCommon.MapType](/ref/map-api/map-arkts/map-common/map-common#maptype) | 查询地图的类型。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| mapType | [mapCommon.MapType](/ref/map-api/map-arkts/map-common/map-common#maptype) | 是 | 地图类型，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](/ref/map-api/map-arkts/map-common/map-common#mappoint) | 是 | 比例尺位置，异常值不处理。  ****说明：****  比例尺在穿戴设备上默认处于左右居中位置，接口传入的positionX值在穿戴设备上不显示效果。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](/ref/map-api/map-arkts/map-common/map-common#mappoint) | 是 | 设置指南针位置，即指南针左上角相对地图组件左上角的偏移量，单位：px，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.ClusterOverlayParams](/ref/map-api/map-arkts/map-common/map-common#clusteroverlayparams) | 是 | 聚合图层参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ClusterOverlay](/ref/map-api/map-arkts/map-map/map-map-clusteroverlay/map-map-clusteroverlay)&gt; | Promise对象，返回[ClusterOverlay](/ref/map-api/map-arkts/map-map/map-map-clusteroverlay/map-map-clusteroverlay)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.ImageOverlayParams](/ref/map-api/map-arkts/map-common/map-common#imageoverlayparams) | 是 | 覆盖物参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)&gt; | Promise对象，返回[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | Promise对象，返回[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.BuildingOverlayParams](/ref/map-api/map-arkts/map-common/map-common#buildingoverlayparams) | 是 | 3D建筑相关属性。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[BuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay)&gt; | Promise对象，返回[BuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.TraceOverlayParams](/ref/map-api/map-arkts/map-common/map-common#traceoverlayparams) | 是 | 动态轨迹参数。 |
| markers | Array&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 动态轨迹的图片数组，异常值不处理。  ****说明：****  一组标记的位置必须相同。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)&gt; | Promise对象，返回[TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.MapArcParams](/ref/map-api/map-arkts/map-common/map-common#maparcparams) | 是 | 弧线的相关属性。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| MapArc | 返回[MapArc](/ref/map-api/map-arkts/map-map/map-map-maparc/map-map-maparc)。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| types | Array&lt;[mapCommon.MapElementType](/ref/map-api/map-arkts/map-common/map-common#mapelementtype)&gt; | 是 | 四类地图元素的显示顺序，默认顺序为[1, 2, 3, 4]。  入参的长度必须是4，且必须是[mapCommon.MapElementType](/ref/map-api/map-arkts/map-common/map-common#mapelementtype)的4个取值，如果不满足，则返回错误码401。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.HeatmapParams](/ref/map-api/map-arkts/map-common/map-common#heatmapparams) | 是 | 添加热力图的参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Heatmap](/ref/map-api/map-arkts/map-map/map-map-heatmap/map-map-heatmap)&gt; | Promise对象，返回[Heatmap](/ref/map-api/map-arkts/map-map/map-map-heatmap/map-map-heatmap)，热力图覆盖物。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.MvtOverlayParams](/ref/map-api/map-arkts/map-common/map-common#mvtoverlayparams) | 是 | 矢量图层的参数。  ****说明：****  使用在线下载方式添加矢量图层时（即使用[mapCommon.MvtOverlayParams](/ref/map-api/map-arkts/map-common/map-common#mvtoverlayparams)中[mapCommon.MvtSource](/ref/map-api/map-arkts/map-common/map-common#mvtsource)参数的tileUrl方式），需要申请访问网络的权限：ohos.permission.INTERNET。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [MvtOverlay](/ref/map-api/map-arkts/map-map/map-map-mvtoverlay/map-map-mvtoverlay) | 矢量图层管理对象。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.FlowFieldOverlayParams](/ref/map-api/map-arkts/map-common/map-common#flowfieldoverlayparams) | 是 | 流场图层的参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[FlowFieldOverlay](/ref/map-api/map-arkts/map-map/map-map-flowfieldoverlay/map-map-flowfieldoverlay)&gt; | Promise对象，返回流场图层的管理对象。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.MassPointOverlayParams](/ref/map-api/map-arkts/map-common/map-common#masspointoverlayparams) | 是 | 海量点图层的参数。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[MassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-masspointoverlay/map-map-masspointoverlay)&gt; | Promise对象，返回海量点的管理对象。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| language | string | 是 | 地图语言，异常值不处理。语种取值请参见[地图组件支持语言](/map-kit-guide/map-appendix/map-language#地图组件支持语言)列表。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 地图语言。语种取值请参见[地图组件支持语言](/map-kit-guide/map-appendix/map-language#地图组件支持语言)列表。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| isBelow | boolean | 是 | 我的位置图层是否位于覆盖物之下，异常值不处理。  - true：我的位置图层位于覆盖物之下  - false：我的位置图层位于覆盖物之上  ****说明：****  该接口对[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)、[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)、[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)、[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)、[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)、[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)、[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)、[MapArc](/ref/map-api/map-arkts/map-map/map-map-maparc/map-map-maparc)、[TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)、底图[Poi](/ref/map-api/map-arkts/map-common/map-common#poi)生效。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| params | [mapCommon.TileOverlayParams](/ref/map-api/map-arkts/map-common/map-common#tileoverlayparams) | [mapCommon.TileOverlayOptions](/ref/map-api/map-arkts/map-common/map-common#tileoverlayoptions) | 是 | 瓦片图层参数。  ****说明：****  从6.0.0(20)版本开始，params属性支持[mapCommon.TileOverlayOptions](/ref/map-api/map-arkts/map-common/map-common#tileoverlayoptions)类型。 |
...
建议使用[MapEventManager.on(type: 'cameraChange')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncamerachange)。
...
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。 |
...
建议使用[MapEventManager.off(type: 'cameraChange')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcamerachange)。
...
建议使用[MapEventManager.on(type: 'cameraIdle')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncameraidle)。
...
建议使用[MapEventManager.off(type: 'cameraIdle')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcameraidle)。
...
建议使用[MapEventManager.on(type: 'cameraMoveCancel')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncameramovecancel)。
...
建议使用[MapEventManager.off(type: 'cameraMoveCancel')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcameramovecancel)。
...
建议使用[MapEventManager.on(type: 'cameraMove')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncameramove)。
...
建议使用[MapEventManager.off(type: 'cameraMove')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcameramove)。
...
建议使用[MapEventManager.on(type: 'cameraMoveStart')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncameramovestart)。
...
建议使用[MapEventManager.off(type: 'cameraMoveStart')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcameramovestart)。
...
建议使用[MapEventManager.on(type: 'mapClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmapclick)。
...
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)。 |
...
建议使用[MapEventManager.off(type: 'mapClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmapclick)。
...
建议使用[MapEventManager.on(type: 'mapLoad')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmapload)。
...
建议使用[MapEventManager.off(type: 'mapLoad')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmapload)。
...
建议使用[MapEventManager.on(type: 'mapLongClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmaplongclick)。
...
建议使用[MapEventManager.off(type: 'mapLongClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmaplongclick)。
...
建议使用[MapEventManager.on(type: 'myLocationButtonClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmylocationbuttonclick)。
...
建议使用[MapEventManager.off(type: 'myLocationButtonClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmylocationbuttonclick)。
...
建议使用[MapEventManager.on(type: 'myLocationClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmylocationclick)。
...
建议使用[MapEventManager.off(type: 'myLocationClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmylocationclick)。
...
建议使用[MapEventManager.on(type: 'poiClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onpoiclick)。
...
| callback | Callback&lt;[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)&gt; | 是 | 回调函数，返回[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)。 |
...
建议使用[MapEventManager.off(type: 'poiClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offpoiclick)。
...
建议使用[MapEventManager.on(type: 'markerClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerclick)。
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)。 |
...
建议使用[MapEventManager.off(type: 'markerClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmarkerclick)。
...
建议使用[MapEventManager.on(type: 'markerDragStart')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdragstart)。
...
建议使用[MapEventManager.off(type: 'markerDragStart')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmarkerdragstart)。
...
建议使用[MapEventManager.on(type: 'markerDrag')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdrag)。
...
建议使用[MapEventManager.off(type: 'markerDrag')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmarkerdrag)。
...
建议使用[MapEventManager.on(type: 'markerDragEnd')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdragend)。
...
建议使用[MapEventManager.off(type: 'markerDragEnd')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offmarkerdragend)。
...
建议使用[MapEventManager.on(type: 'circleClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oncircleclick)。
...
| callback | Callback&lt;[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)&gt; | 是 | 回调函数，返回[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)。 |
...
建议使用[MapEventManager.off(type: 'circleClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offcircleclick)。
...
建议使用[MapEventManager.on(type: 'polylineClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onpolylineclick)。
...
| callback | Callback&lt;[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)&gt; | 是 | 回调函数，返回[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)。 |
...
建议使用[MapEventManager.off(type: 'polylineClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offpolylineclick)。
...
建议使用[MapEventManager.on(type: 'polygonClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onpolygonclick)。
...
| callback | Callback&lt;[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)&gt; | 是 | 回调函数，返回[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)。 |
...
建议使用[MapEventManager.off(type: 'polygonClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offpolygonclick)。
...
建议使用[MapEventManager.on(type: 'infoWindowClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oninfowindowclick)。
...
建议使用[MapEventManager.off(type: 'infoWindowClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offinfowindowclick)。
...
建议使用[MapEventManager.on(type: 'infoWindowClose')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#oninfowindowclose)。
...
建议使用[MapEventManager.off(type: 'infoWindowClose')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offinfowindowclose)。
...
建议使用[MapEventManager.on(type: 'pointAnnotationClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onpointannotationclick)。
...
| callback | Callback&lt;[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)&gt; | 是 | 回调函数，返回[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)。 |
...
建议使用[MapEventManager.off(type: 'pointAnnotationClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offpointannotationclick)。
...
建议使用[MapEventManager.on(type: 'bubbleClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onbubbleclick)。
...
| callback | Callback&lt;[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)&gt; | 是 | 回调函数，返回[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)。 |
...
建议使用[MapEventManager.off(type: 'bubbleClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offbubbleclick)。
...
建议使用[MapEventManager.on(type: 'imageOverlayClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onimageoverlayclick)。
...
| callback | Callback&lt;[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)&gt; | 是 | 回调函数，返回[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)。 |
...
建议使用[MapEventManager.off(type: 'imageOverlayClick')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offimageoverlayclick)。
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback&lt;[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)&gt; | 否 | 回调函数，返回[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)，当不填时清除所有监听回调。 |
...
建议使用[MapEventManager.on(type: 'error')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onerror)。
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 是 | 回调函数，监听异常事件的回调。 |
...
建议使用[MapEventManager.off(type: 'error')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#offerror)。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| buildingId | string | 是 | 建筑物的ID。从[on('indoorMapEnter')](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onindoormapenter)方法的回调函数中获得，异常值不处理。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](/ref/map-api/map-arkts/map-common/map-common#mappoint) | 是 | 设置楼层调节控件的位置，单位：px，异常值不处理。 |
