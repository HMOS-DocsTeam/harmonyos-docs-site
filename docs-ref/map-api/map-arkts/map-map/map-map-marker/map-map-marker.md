...
title: "Marker"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-marker
kit: 应用服务
...
标记，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addMarker](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmarker)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 标记的位置。 |
...
![](../../../../images/5ebdaaf6/zh-cn_image_0000002552960900.png)
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| latLng | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 是 | 标记的位置坐标，异常值不处理。 |
...
设置标记的动画，不支持[FontSizeAnimation](/ref/map-api/map-arkts/map-map/map-map-fontsizeanimation/map-map-fontsizeanimation)。
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| animation | [Animation](/ref/map-api/map-arkts/map-map/map-map-animation/map-map-animation) | 是 | 动画，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| iconBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 是 | 自定义组件，异常值不处理。 |
