...
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-pointannotation
kit: 应用服务
...
点注释，继承[BasePriorityOverlay](/ref/map-api/map-arkts/map-map/map-map-basepriorityoverlay/map-map-basepriorityoverlay)。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addPointAnnotation](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addpointannotation)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 点注释的锚点坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.Text](/ref/map-api/map-arkts/map-common/map-common#text) | 获取点注释第一标题的属性。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| text | [mapCommon.Text](/ref/map-api/map-arkts/map-common/map-common#text) | 是 | 第一标题属性（除content），异常值不处理。  ****说明：****  约束条件：fontSize、strokeWidth大于等于0。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| animation | [FontSizeAnimation](/ref/map-api/map-arkts/map-map/map-map-fontsizeanimation/map-map-fontsizeanimation) | 是 | 点注释的标题动画。 |
