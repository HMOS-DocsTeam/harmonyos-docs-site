...
![](../../../../images/6d91a176/note_3.0-zh-cn.png) 
...
| locations | Array&lt;[mapCommon.CoordinateLatLng](/ref/map-api/map-arkts/map-common/map-common#coordinatelatlng)&gt; | 是 | 输入坐标系和坐标。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[mapCommon.CoordinateLatLng](/ref/map-api/map-arkts/map-common/map-common#coordinatelatlng)&gt;&gt; | Promise对象，返回修正后的坐标系和坐标。 |
