...
title: "Animation"
sidebar_position: 14
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-animation
kit: 应用服务
...
![](../../../../images/cbebb74f/note_3.0-zh-cn.png) 

动画持续时间默认值为250ms；动画执行完成后的状态，默认值为默认值为[AnimationFillMode](/ref/map-api/map-arkts/map-map/map-map-animationfillmode/map-map-animationfillmode).FORWARDS；动画插值器，默认值为[Curve](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curve).Linear；动画重复执行的次数，默认值为0；重复执行的模式，默认值为[AnimationRepeatMode](/ref/map-api/map-arkts/map-map/map-map-animationrepeatmode/map-map-animationrepeatmode).RESTART。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| fillMode | [AnimationFillMode](/ref/map-api/map-arkts/map-map/map-map-animationfillmode/map-map-animationfillmode) | 是 | 动画执行完成后的状态。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| curve | [Curves.Curve](/ref/arkui-api/arkui-arkts/ui/js-apis-curve/js-apis-curve#curve) | 是 | 动画插值器。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| repeatMode | [AnimationRepeatMode](/ref/map-api/map-arkts/map-map/map-map-animationrepeatmode/map-map-animationrepeatmode) | 是 | 重复执行的模式。 |
