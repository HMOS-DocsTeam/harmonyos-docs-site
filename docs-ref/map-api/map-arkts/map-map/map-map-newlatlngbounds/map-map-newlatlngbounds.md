...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | 地图显示经纬度范围。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | 地图显示经纬度范围，异常值返回401错误码。 |
| padding | [mapCommon.Padding](/ref/map-api/map-arkts/map-common/map-common#padding) | 是 | 地图区域和边界之间的距离，单位：px，异常值返回401错误码。  ****说明：****  - 地图组件高度减去padding的top值和bottom值，结果需要大于等于100px。  - 地图组件宽度减去padding的left值和right值，结果需要大于等于100px。 |
