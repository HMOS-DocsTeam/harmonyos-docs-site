...
title: "ImageOverlay"
sidebar_position: 23
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-imageoverlay
kit: 应用服务
...
图片覆盖物。继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 获取覆盖物的矩形区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 覆盖物的位置。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | 覆盖物的矩形区域。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| position | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 是 | 覆盖物的位置。 |
