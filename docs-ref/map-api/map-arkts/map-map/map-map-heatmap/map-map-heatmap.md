...
title: "Heatmap"
sidebar_position: 34
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-heatmap
kit: 应用服务
...
热力图管理对象。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addHeatmap](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addheatmap)方法时会返回该类型的实例。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| data | [mapCommon.WeightedLatLng](/ref/map-api/map-arkts/map-common/map-common#weightedlatlng)[] | 是 | 热力图数据（建议数据量小于10000条），异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.WeightedLatLng](/ref/map-api/map-arkts/map-common/map-common#weightedlatlng)[] | 热力图数据。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| radiusUnit | [mapCommon.RadiusUnit](/ref/map-api/map-arkts/map-common/map-common#radiusunit) | 是 | 热力图半径单位。异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.RadiusUnit](/ref/map-api/map-arkts/map-common/map-common#radiusunit) | 热力图半径单位。 |
