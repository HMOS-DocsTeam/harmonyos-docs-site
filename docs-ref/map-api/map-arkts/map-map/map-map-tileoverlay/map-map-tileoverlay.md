...
瓦片图层，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。瓦片图层是一种基于[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)实现的地图覆盖层，用于展示自定义瓦片图片。

![](../../../../images/bab8545b/note_3.0-zh-cn.png) 
