...
sidebar_position: 22
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-clusteroverlay
kit: 应用服务
...
| callback | Callback&lt;Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;&gt; | 是 | 回调函数，返回Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;。 |
...
| callback | Callback&lt;Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;&gt; | 是 | 回调函数，返回Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;，监听聚合图层的聚合点点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'click'：监听聚合图层的聚合点点击事件。 |
| callback | Callback&lt;Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;&gt; | 否 | 回调函数，返回Array&lt;[mapCommon.ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem)&gt;，取消监听聚合图层的聚合点点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[MarkerClusterInfo](/ref/map-api/map-arkts/map-map/map-map-markerclusterinfo/map-map-markerclusterinfo)&gt; | 是 | 回调函数，返回Callback&lt;[MarkerClusterInfo](/ref/map-api/map-arkts/map-map/map-map-markerclusterinfo/map-map-markerclusterinfo)&gt;，监听聚合图层的标记点击事件。  MarkerClusterInfo包括：  - marker：聚合图层的标记。  - clusterItems：聚合节点数组。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClusterClick'：聚合图层的标记点击监听事件。 |
| callback | Callback&lt;[MarkerClusterInfo](/ref/map-api/map-arkts/map-map/map-map-markerclusterinfo/map-map-markerclusterinfo)&gt; | 否 | 回调函数，返回Callback&lt;[MarkerClusterInfo](/ref/map-api/map-arkts/map-map/map-map-markerclusterinfo/map-map-markerclusterinfo)&gt;，取消监听聚合图层的标记点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。  MarkerClusterInfo包括：  - marker：聚合图层的标记。  - clusterItems：聚合节点数组。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| item | mapCommon.[ClusterItem](/ref/map-api/map-arkts/map-common/map-common#clusteritem) | 是 | 待聚合节点。 |
