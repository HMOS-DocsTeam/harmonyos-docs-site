...
title: "MapPolyline"
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mappolyline
kit: 应用服务
...
折线，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addPolyline](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addpolyline)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](/ref/map-api/map-arkts/map-common/map-common#capstyle) | 折线的末尾端点样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.JointType](/ref/map-api/map-arkts/map-common/map-common#jointtype) | 折线除起始和结束顶点之外的所有顶点的节点类型属性。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[mapCommon.PatternItem](/ref/map-api/map-arkts/map-common/map-common#patternitem)&gt; | 折线的样式属性。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 折线的顶点坐标属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](/ref/map-api/map-arkts/map-common/map-common#capstyle) | 折线的起始端点样式。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| endCap | [mapCommon.CapStyle](/ref/map-api/map-arkts/map-common/map-common#capstyle) | 是 | 折线的末尾端点样式，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| jointType | [mapCommon.JointType](/ref/map-api/map-arkts/map-common/map-common#jointtype) | 是 | 节点类型，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| patterns | Array&lt;[mapCommon.PatternItem](/ref/map-api/map-arkts/map-common/map-common#patternitem)&gt; | 是 | [PatternItem](/ref/map-api/map-arkts/map-common/map-common#patternitem)对象的集合，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| points | Array&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 折线顶点的集合。默认情况下，折线不闭合；要形成闭合的折线，起点和终点必须相同，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| startCap | [mapCommon.CapStyle](/ref/map-api/map-arkts/map-common/map-common#capstyle) | 是 | 折线的起始端点样式，异常值不处理。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| customTexture | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片。 |
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| customTexture | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片，异常值不处理。 |
