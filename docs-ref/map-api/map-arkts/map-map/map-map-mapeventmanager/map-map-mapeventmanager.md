...
sidebar_position: 30
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager
kit: 应用服务
...
| --- | --- | --- | --- |
| type | string | 是 | 'cameraChange'：监听地图相机状态变化事件。 |
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，取消监听地图相机状态变化事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，监听地图点击事件。 |
...
off(type: 'mapClick', callback?: Callback<[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapClick'：监听地图点击事件。 |
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，取消监听地图点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，监听地图长按事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapLongClick'：监听地图长按事件。 |
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，取消监听地图长按事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 是 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，监听我的位置点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'myLocationClick'：监听我的位置点击事件。 |
| callback | Callback&lt;[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)&gt; | 否 | 回调函数，返回[mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng)，取消监听我的位置点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)&gt; | 是 | 回调函数，返回[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)，监听POI点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'poiClick'：监听POI点击事件。 |
| callback | Callback&lt;[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)&gt; | 否 | 回调函数，返回[mapCommon.Poi](/ref/map-api/map-arkts/map-common/map-common#poi)，取消监听POI点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听标记点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClick'：监听标记点击事件。 |
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听标记点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听标记开始拖拽事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDragStart'：监听标记开始拖拽事件。 |
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听标记开始拖拽事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听标记拖拽事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDrag'：监听标记拖拽事件。 |
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听标记拖拽事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听标记拖拽结束事件。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听标记拖拽结束事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)&gt; | 是 | 回调函数，返回[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)，监听圆点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'circleClick'：监听圆点击事件。 |
| callback | Callback&lt;[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)&gt; | 否 | 回调函数，返回[MapCircle](/ref/map-api/map-arkts/map-map/map-map-mapcircle/map-map-mapcircle)，取消监听圆点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)&gt; | 是 | 回调函数，返回[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)，监听折线点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'polylineClick'：监听折线点击事件。 |
| callback | Callback&lt;[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)&gt; | 否 | 回调函数，返回[MapPolyline](/ref/map-api/map-arkts/map-map/map-map-mappolyline/map-map-mappolyline)，取消监听折线点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)&gt; | 是 | 回调函数，返回[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)，监听多边形点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'polygonClick'：监听多边形点击事件。 |
| callback | Callback&lt;[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)&gt; | 否 | 回调函数，返回[MapPolygon](/ref/map-api/map-arkts/map-map/map-map-mappolygon/map-map-mappolygon)，取消监听多边形点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听信息窗点击事件。 |
...
off(type: 'infoWindowClick', callback?: Callback<[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClick'：监听信息窗点击事件。 |
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听信息窗点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 是 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，监听信息窗关闭事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClose'：监听信息窗关闭事件。 |
| callback | Callback&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 否 | 回调函数，返回[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)，取消监听信息窗关闭事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)&gt; | 是 | 回调函数，返回[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)，监听点注释点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'pointAnnotationClick'：监听点注释点击事件。 |
| callback | Callback&lt;[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)&gt; | 否 | 回调函数，返回[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)，取消监听点注释点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)&gt; | 是 | 回调函数，返回[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)，监听气泡点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'bubbleClick'：监听气泡点击事件。 |
| callback | Callback&lt;[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)&gt; | 否 | 回调函数，返回[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)，取消监听气泡点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)&gt; | 是 | 回调函数，返回[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)，监听覆盖物点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback&lt;[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)&gt; | 否 | 回调函数，返回[ImageOverlay](/ref/map-api/map-arkts/map-map/map-map-imageoverlay/map-map-imageoverlay)，取消监听覆盖物点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 是 | 回调函数，返回[ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback)，监听异常事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'error'：监听异常事件。 |
| callback | [ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback) | 否 | 回调函数，返回[ErrorCallback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#errorcallback)，取消监听异常事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback&lt;[IndoorMapInfo](/ref/map-api/map-arkts/map-map/map-map-indoormapinfo/map-map-indoormapinfo)&gt; | 是 | 回调函数，返回[IndoorMapInfo](/ref/map-api/map-arkts/map-map/map-map-indoormapinfo/map-map-indoormapinfo)，监听室内图进入事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'indoorMapEnter'：监听室内图进入事件。 |
| callback | Callback&lt;[IndoorMapInfo](/ref/map-api/map-arkts/map-map/map-map-indoormapinfo/map-map-indoormapinfo)&gt; | 否 | 回调函数，返回[IndoorMapInfo](/ref/map-api/map-arkts/map-map/map-map-indoormapinfo/map-map-indoormapinfo)，取消监听室内图进入事件。 |
...
| callback | [MassPointOverlayCallback](/ref/map-api/map-arkts/map-map/map-map-masspointoverlaycallback/map-map-masspointoverlaycallback) | 是 | 回调函数，无返回结果的回调函数，监听海量点图层点击事件。 |
...
| callback | [MassPointOverlayCallback](/ref/map-api/map-arkts/map-map/map-map-masspointoverlaycallback/map-map-masspointoverlaycallback) | 否 | 回调函数，无返回结果的回调函数，取消监听海量点图层点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
