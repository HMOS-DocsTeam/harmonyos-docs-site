...
title: "MvtOverlay"
sidebar_position: 35
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mvtoverlay
kit: 应用服务
...
矢量图层的管理对象。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addMvtOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmvtoverlay)方法时会返回该类型的实例，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| layers | [mapCommon.MvtLayer](/ref/map-api/map-arkts/map-common/map-common#mvtlayer)[] | 是 | 矢量图层，建议矢量图层少于2000层，确保矢量图层的流畅度。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| addedLayers | [mapCommon.MvtLayer](/ref/map-api/map-arkts/map-common/map-common#mvtlayer)[] | 是 | 矢量图层。 |
