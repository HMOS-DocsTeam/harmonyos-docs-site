...
具有优先级控制的覆盖物基础类，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。[PointAnnotation](/ref/map-api/map-arkts/map-map/map-map-pointannotation/map-map-pointannotation)和[Bubble](/ref/map-api/map-arkts/map-map/map-map-bubble/map-map-bubble)继承该基础类。
...
设置覆盖物的动画。仅支持[AlphaAnimation](/ref/map-api/map-arkts/map-map/map-map-alphaanimation/map-map-alphaanimation)、[ScaleAnimation](/ref/map-api/map-arkts/map-map/map-map-scaleanimation/map-map-scaleanimation)和[AnimationSet](/ref/map-api/map-arkts/map-map/map-map-animationset/map-map-animationset)。
...
| 参数名 | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| animation | [Animation](/ref/map-api/map-arkts/map-map/map-map-animation/map-map-animation) | 是 | 动画。 |
