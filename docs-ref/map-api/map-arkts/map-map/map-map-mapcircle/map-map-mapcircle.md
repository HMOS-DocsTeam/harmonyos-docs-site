...
title: "MapCircle"
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcircle
kit: 应用服务
...
更新和查询圆的接口，继承[BaseOverlay](/ref/map-api/map-arkts/map-map/map-map-baseoverlay/map-map-baseoverlay)。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addCircle](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addcircle)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| mapCommon.[LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 获取圆心经纬度。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[mapCommon.PatternItem](/ref/map-api/map-arkts/map-common/map-common#patternitem)&gt; | 圆的边框样式。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| center | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 是 | 圆心经纬度坐标。  圆的中心点纬度在[-85.051119, 85.051119]范围内才能画出圆。若圆中心点纬度为-85.051119或85.051119时，能画出半径为1米的圆。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| patterns | Array&lt;[mapCommon.PatternItem](/ref/map-api/map-arkts/map-common/map-common#patternitem)&gt; | 是 | 圆的边框样式。 |
