...
sidebar_position: 37
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-masspointoverlay
kit: 应用服务
...
海量点的管理对象。在调用map.[MapComponentController](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller)类的[addMassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmasspointoverlay)方法时会返回该类型的实例。
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| items | [mapCommon.MassPointItem](/ref/map-api/map-arkts/map-common/map-common#masspointitem)[] | 是 | 海量点列表（建议数据量小于100000条）。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.MassPointItem](/ref/map-api/map-arkts/map-common/map-common#masspointitem)[] | 海量点列表。 |
