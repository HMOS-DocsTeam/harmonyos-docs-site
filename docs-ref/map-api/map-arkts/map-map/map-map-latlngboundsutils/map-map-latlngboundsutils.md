...
sidebar_position: 13
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-latlngboundsutils
kit: 应用服务
last_updated: "2026-04-22"
slug: map-map-latlngboundsutils
---
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | LatLngBounds对象。 |
| position | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 是 | 用于判断的位置坐标。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| src | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | LatLngBounds对象。 |
| target | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 是 | 目标区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 中心经纬度坐标。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| position | [mapCommon.LatLng](/ref/map-api/map-arkts/map-common/map-common#latlng) | 是 | 位置坐标。 |
| bounds | [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 否 | LatLngBounds对象。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLngBounds](/ref/map-api/map-arkts/map-common/map-common#latlngbounds) | 包含指定位置的LatLngBounds对象。 |
