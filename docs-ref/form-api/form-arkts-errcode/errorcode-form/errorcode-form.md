...
title: "卡片错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-form
kit: 应用框架
...
![](../../../images/b7627506/note_3.0-zh-cn.png) 
...
检查当前卡片对应互动卡片配置项[sceneAnimationParams](/form-kit/arkts-ui/arkts-ui-widget-configuration#sceneanimationparams标签)是否正确。
...
检查入参卡片尺寸是否在[FormDimension](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formdimension)和[supportDimensions](/form-kit/arkts-ui/arkts-ui-widget-configuration#配置文件字段说明)配置列表。
...
检查[半模态卡片编辑页](/form-kit/arkts-ui/arkts-ui-widget/arkts-ui-widget-edit/x-ui-widget-event-formeditextensionability-overview#半模态卡片编辑)是否已打开。
...
4. 空参数错误，比如传入空字符串（''）。
5. 参数格式错误。
6. 参数值错误。输入参数需要与[app.json5](/development-fundamentals/application-configuration-file-stage/app-configuration-file)和[配置ArkTS卡片的配置文件](/form-kit/arkts-ui/arkts-ui-widget-configuration)中对应的配置保持一致。
