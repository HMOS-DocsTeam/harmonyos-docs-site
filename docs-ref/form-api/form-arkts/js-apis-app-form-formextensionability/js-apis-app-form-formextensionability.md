...
![](../../../images/02f23e5a/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 当前卡片相关的Want类型信息，其中Want中的parameters为自定义取值，取值可以包含[卡片参数枚举](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formparam)中的一个或多个，如卡片ID、卡片名称、卡片样式等。这些卡片信息必须作为持久数据进行管理，以便后续更新和删除卡片。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [formBindingData.FormBindingData](/ref/form-api/form-arkts/js-apis-app-form-formbindingdata/js-apis-app-form-formbindingdata#formbindingdata) | formBindingData.FormBindingData对象，卡片要显示的数据。 |
...
卡片提供方接收携带参数的更新卡片的通知接口。获取最新数据后调用formProvider的[updateForm](/ref/form-api/form-arkts/js-apis-app-form-formprovider/js-apis-app-form-formprovider#formproviderupdateform)接口刷新卡片数据。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| newConfig | [Configuration](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-configuration/js-apis-app-ability-configuration) | 是 | 表示需要更新的配置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | want表示获取卡片状态的描述。描述包括Bundle名称、能力名称、模块名称、卡片名称等。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| [formInfo.FormState](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formstate) | formInfo.FormState枚举，表示卡片当前的状态。 |
...
| newFormLocation | [formInfo.FormLocation](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formlocation20) | 是 | 卡片最新位置的枚举值。 |
...
| newDimension | [formInfo.FormDimension](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formdimension) | 是 | 卡片尺寸，例如 Dimension\_1\_2，表示 1 x 2 卡片。 |
| newRect | [formInfo.Rect](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#rect20) | 是 | 卡片位置信息，包括卡片左上角顶点的xy坐标和卡片的宽高。 |
