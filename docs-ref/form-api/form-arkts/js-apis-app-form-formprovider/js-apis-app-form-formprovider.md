...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-form-formprovider
kit: 应用框架
...
![](../../../images/ddf31727/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[卡片错误码](/ref/form-api/form-arkts-errcode/errorcode-form/errorcode-form)。
...
![](../../../images/0f5fe16f/note_3.0-zh-cn.png) 
...
| formBindingData | [formBindingData.FormBindingData](/ref/form-api/form-arkts/js-apis-app-form-formbindingdata/js-apis-app-form-formbindingdata#formbindingdata) | 是 | 用于更新的数据。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
![](../../../images/e9febc7d/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[formInfo.FormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo)&gt;&gt; | 是 | 回调函数。返回查询到的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [formInfo.FormInfoFilter](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#forminfofilter) | 是 | 卡片信息过滤器。 |
| callback | AsyncCallback&lt;Array&lt;[formInfo.FormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo)&gt;&gt; | 是 | 回调函数。返回查询到符合条件的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [formInfo.FormInfoFilter](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#forminfofilter) | 否 | 卡片信息过滤器, 默认为空，不进行过滤。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[formInfo.FormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo)&gt;&gt; | Promise对象。返回查询到符合条件的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 打开卡片管理页面的请求中的want参数，需包含以下字段。  bundleName: 卡片所属应用的包名。  abilityName: 卡片所属的ability名称。  parameters:  - ohos.extra.param.key.form\_dimension: [卡片尺寸](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#formdimension)。  - ohos.extra.param.key.form\_name: 卡片名称。  - ohos.extra.param.key.module\_name: 卡片所属的模块名称。 |

![](../../../images/79b1957c/note_3.0-zh-cn.png) 

如果parameters参数没有填完整或者指定的卡片不存在，就会默认展示[form\_config.json](/form-kit/arkts-ui/arkts-ui-widget-configuration#卡片配置)中配置的默认卡片。

****错误码：****

以下错误码的详细介绍请参见[卡片错误码](/ref/form-api/form-arkts-errcode/errorcode-form/errorcode-form)。
...
![](../../../images/c32f7474/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[formInfo.FormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#forminfo)&gt; | Promise对象。返回查询到符合条件的卡片信息。 |
...
![](../../../images/05d3e6a4/note_3.0-zh-cn.png) 
...
卡片提供方发起互动卡片动效请求，只针对[场景动效类型互动卡片](/form-kit/arkts-ui/arkts-ui-widget-configuration#sceneanimationparams标签)生效，使用Promise异步回调。

![](../../../images/57b6ffd3/note_3.0-zh-cn.png) 

1. 该接口在省电模式场景下不可使用，会报16501000错误码。
2. 当设备热档位进入HOT场景并且没有点击事件的场景下，该接口会报16501000错误码；当热档位进入OVERHEATED时，任何情况下都会报16501000错误码。热档位信息具体可参考[热档位信息](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/device-management-arkts/js-apis-thermal/js-apis-thermal#thermallevel)。
...
| overflowInfo | [formInfo.OverflowInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#overflowinfo20) | 是 | 动效请求参数信息。 |
...
卡片提供方发起取消互动卡片动效请求，只针对[场景动效类型互动卡片](/form-kit/arkts-ui/arkts-ui-widget-configuration#sceneanimationparams标签)生效，使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[formInfo.Rect](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#rect20)&gt; | Promise对象，返回卡片相对屏幕左上角的位置信息和卡片尺寸信息，单位vp。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[formInfo.RunningFormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#runningforminfo20)&gt; | Promise对象。返回符合条件的卡片信息，包括卡片名称、尺寸等。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[formInfo.RunningFormInfo](/ref/form-api/form-arkts/js-apis-app-form-forminfo/js-apis-app-form-forminfo#runningforminfo20)&gt;&gt; | Promise对象。返回符合条件的卡片信息。 |
...
对于当前应用程序相同moduleName、abilityName、formName的卡片，多次加桌后会每张卡片会有不同的卡片id。卡片提供方可以通过本接口批量更新不同的卡片id但moduleName、abilityName、formName相同的卡片。在应用主进程通过本接口通知FormExtension进程进行批量更新，仅支持在[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)中调用，使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)的上下文，做校验使用。 |
| moduleName | string | 是 | 指定卡片的moduleName。 |
| abilityName | string | 是 | 指定卡片的abilityName。 |
| formName | string | 是 | 指定卡片在[form\_config.json](/form-kit/arkts-ui/arkts-ui-widget-configuration#配置文件字段说明)中配置的卡片名称。 |
...
在应用主进程通过本接口可以通知FormExtension进程批量更新当前应用程序下已经加桌的所有卡片，仅支持在[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)中调用，使用Promise异步回调。
