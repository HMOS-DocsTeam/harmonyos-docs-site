...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-application-formprovider
kit: 应用框架
...
![](../../../images/04df8481/note_3.0-zh-cn.png) 

本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

从API version 9 开始废弃，建议使用[formProvider](/ref/form-api/form-arkts/js-apis-app-form-formprovider/js-apis-app-form-formprovider)替代。
...
| formBindingData | [formBindingData.FormBindingData](/ref/form-api/form-arkts-dep/js-apis-application-formbindingdata/js-apis-application-formbindingdata#formbindingdata) | 是 | 用于更新的数据。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
