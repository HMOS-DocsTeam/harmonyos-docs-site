...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api
kit: AI
...
| --- | --- | --- | --- | --- |
| word | string | 否 | 否 | 词语。 |
| wordTag | string | 否 | 否 | 词性。词性分类参考[wordTag](/ref/natural-language-api/natural-language-arkts/natural-language-word-tag-api/natural-language-word-tag-api)。 |
...
| jsonObject | string | 否 | 否 | 实体的其他字段。详情参考[jsonObject](/ref/natural-language-api/natural-language-arkts/natural-language-json-object-api/natural-language-json-object-api)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | 输入待分析的文本内容。相关规格参考[约束与限制](/natural-language-kit-guide/natural-language-introduction#约束与限制)。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[WordSegment](#wordsegment)&gt;&gt; | Promise对象，返回分词结果的集合。 |

****错误码：****

以下错误码的详细介绍请参见[Natural Language Kit错误码](/ref/natural-language-api/natural-language-error-code/natural-language-error-code)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | 输入的字符串。相关规格参考[约束与限制](/natural-language-kit-guide/natural-language-introduction#约束与限制)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[Entity](#entity)&gt;&gt; | Promise对象，返回实体的结果集合。 |
...
![](../../../images/649a2fe0/note_3.0-zh-cn.png) 
