...
| DEVELOPER\_DEFINED\_ICON = -100 | 自定义光标，开发者可使用[OH\_Input\_SetCustomCursor](/ref/system-basicfun-api/input-api/input-c/input-headerfile/capi-oh-input-manager-h/capi-oh-input-manager-h#oh_input_setcustomcursor)设置自定义光标，不支持使用[OH\_Input\_SetPointerStyle](/ref/system-basicfun-api/input-api/input-c/input-headerfile/capi-oh-input-manager-h/capi-oh-input-manager-h#oh_input_setpointerstyle)直接设置。 | 自定义光标样式，通过接口设置。 |
