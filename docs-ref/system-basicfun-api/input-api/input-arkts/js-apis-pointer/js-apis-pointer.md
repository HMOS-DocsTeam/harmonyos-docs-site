...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-pointer
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-pointer
---
...
![](../../../../images/b587ea0c/note_3.0-zh-cn.png) 
...
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 自定义光标资源。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 自定义光标。最小限制为资源图本身的最小限制。最大限制为256 x 256px。 |
...
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。 |
| cursor | [CustomCursor](/ref/system-basicfun-api/input-api/input-arkts/js-apis-pointer/js-apis-pointer#customcursor15) | 是 | 自定义光标资源。 |
| config | [CursorConfig](/ref/system-basicfun-api/input-api/input-arkts/js-apis-pointer/js-apis-pointer#cursorconfig15) | 是 | 自定义光标配置，用于配置是否根据系统设置调整光标大小。如果CursorConfig中followSystem设置为true，则光标大小的可调整范围为：[光标资源图大小，256×256]。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[鼠标光标错误码](/ref/system-basicfun-api/input-api/input-arkts-errcode/errorcode-pointer/errorcode-pointer)。
