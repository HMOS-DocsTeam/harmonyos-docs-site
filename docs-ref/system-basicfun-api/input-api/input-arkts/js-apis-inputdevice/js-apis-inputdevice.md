...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputdevice
kit: 系统
...
![](../../../../images/65512af7/note_3.0-zh-cn.png) 
...
![](../../../../images/13625c0a/note_3.0-zh-cn.png) 
...
![](../../../../images/d93798c2/note_3.0-zh-cn.png) 
...
![](../../../../images/12bd7a55/note_3.0-zh-cn.png) 
...
![](../../../../images/3ed1acc8/note_3.0-zh-cn.png) 
...
| --- | --- | --- | --- |
| deviceId | number | 是 | 输入设备的唯一标识，同一个物理设备反复插拔或重启，设备ID可能会发生变化。 |
| keys | Array[<KeyCode>](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keycode/js-apis-keycode#keycode) | 是 | 需要查询的键值，最多支持5个按键查询。 |
...
| --- | --- | --- | --- |
| deviceId | number | 是 | 输入设备的唯一标识，同一个物理设备反复插拔或重启，设备ID可能会发生变化。 |
| keys | Array[<KeyCode>](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keycode/js-apis-keycode#keycode) | 是 | 需要查询的键值，最多支持查询5个按键。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[输入设备错误码](/ref/system-basicfun-api/input-api/input-arkts-errcode/errorcode-inputdevice/errorcode-inputdevice)。
