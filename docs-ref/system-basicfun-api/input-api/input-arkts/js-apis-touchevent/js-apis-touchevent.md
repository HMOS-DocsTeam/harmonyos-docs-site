...
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-touchevent
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-touchevent
---

# @ohos.multimodalInput.touchEvent (触屏输入事件)

设备上报的触屏输入事件，继承自[InputEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputevent/js-apis-inputevent)。

![](../../../../images/b878692d/note_3.0-zh-cn.png) 
