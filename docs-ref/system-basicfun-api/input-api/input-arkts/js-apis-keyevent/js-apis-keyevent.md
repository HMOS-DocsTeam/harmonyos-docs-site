...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keyevent
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-keyevent
---

# @ohos.multimodalInput.keyEvent (按键输入事件)

设备上报的按键事件，继承自[InputEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputevent/js-apis-inputevent)。

![](../../../../images/e67ea6bf/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | [KeyCode](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keycode/js-apis-keycode#keycode) | 否 | 否 | 键值。 |
