...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-mouseevent
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-mouseevent
---

# @ohos.multimodalInput.mouseEvent (鼠标输入事件)

设备上报的鼠标事件，继承自[InputEvent](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputevent/js-apis-inputevent)。

![](../../../../images/7aa8a64c/note_3.0-zh-cn.png) 
...
| pressedKeys | [KeyCode](/ref/system-basicfun-api/input-api/input-arkts/js-apis-keycode/js-apis-keycode#keycode)[] | 否 | 否 | 当前处于按下状态的键值列表。 |
