...
title: "上传下载错误码"
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-request
kit: 系统
last_updated: "2026-04-22"
slug: errorcode-request
---

# 上传下载错误码

![](../../../../images/7f057097/note_3.0-zh-cn.png) 
...
该错误码表示文件操作异常，可能原因是文件权限不足。具体原因可参考[BusinessError](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#businesserror)中的错误信息message。
