...
![](../../../../../images/ed447f87/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | ****必填**** | ****说明**** |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want#want) | 是 | 表示调用打印页面需要参数。 |
