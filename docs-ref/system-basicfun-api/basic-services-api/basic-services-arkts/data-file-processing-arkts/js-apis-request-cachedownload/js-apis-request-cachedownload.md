...
![](../../../../../images/4c96adc4/note_3.0-zh-cn.png) 
...
| message | string | 是 | 否 | 返回[通用错误码](/ref/errorcode-universal/errorcode-universal)或[HTTP错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-http/errorcode-net-http)。 |
...
![](../../../../../images/b204a968/note_3.0-zh-cn.png) 
