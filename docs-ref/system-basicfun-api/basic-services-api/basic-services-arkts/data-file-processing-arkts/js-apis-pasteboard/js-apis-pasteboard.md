...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-pasteboard
kit: 系统
...
![](../../../../../images/29b5d78a/note_3.0-zh-cn.png) 
...
![](../../../../../images/cde8fed7/note_3.0-zh-cn.png) 
...
![](../../../../../images/d334974d/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | Want内容。 |
...
![](../../../../../images/b90943c6/note_3.0-zh-cn.png) 
...
![](../../../../../images/8e2eb1c4/note_3.0-zh-cn.png) 
...
![](../../../../../images/5a42b5a4/note_3.0-zh-cn.png) 
...
![](../../../../../images/b3d4bdfc/note_3.0-zh-cn.png) 
...
![](../../../../../images/e8631722/note_3.0-zh-cn.png) 
...
![](../../../../../images/294f176b/note_3.0-zh-cn.png) 
...
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 否 | Want内容。 |
| mimeType | string | 是 | 否 | 默认数据类型。 |
| plainText | string | 是 | 否 | 纯文本内容。 |
| uri | string | 是 | 否 | URI内容。 |
| pixelMap9+ | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 否 | PixelMap内容。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和见[剪贴板错误码](/ref/system-basicfun-api/basic-services-api/basic-services-arkts-errcode/errorcode-pasteboard/errorcode-pasteboard)。
...
![](../../../../../images/62d09f30/note_3.0-zh-cn.png) 
...
![](../../../../../images/3412bed0/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | Want对象内容。剪贴板内容对象中没有Want内容时，默认返回为undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | PixelMap内容。剪贴板内容对象中没有PixelMap内容时，默认返回为undefined。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[剪贴板错误码](/ref/system-basicfun-api/basic-services-api/basic-services-arkts-errcode/errorcode-pasteboard/errorcode-pasteboard)。
...
![](../../../../../images/13c1f68e/note_3.0-zh-cn.png) 
...
![](../../../../../images/ca869715/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | Want对象内容。 |
...
![](../../../../../images/a0d9218b/note_3.0-zh-cn.png) 
...
![](../../../../../images/3432941f/note_3.0-zh-cn.png) 
...
![](../../../../../images/7acf38ba/note_3.0-zh-cn.png) 
...
![](../../../../../images/ebff4585/note_3.0-zh-cn.png) 
...
![](../../../../../images/23bc0348/note_3.0-zh-cn.png) 
...
![](../../../../../images/7e2d29ba/note_3.0-zh-cn.png) 
...
![](../../../../../images/3e3c694b/note_3.0-zh-cn.png) 
...
![](../../../../../images/fd1b4cc5/note_3.0-zh-cn.png) 
...
![](../../../../../images/d08fc055/note_3.0-zh-cn.png) 
...
![](../../../../../images/a46a0f37/note_3.0-zh-cn.png) 
...
![](../../../../../images/c5d17ae0/note_3.0-zh-cn.png) 
...
![](../../../../../images/8579485a/note_3.0-zh-cn.png) 
...
![](../../../../../images/4b85b699/note_3.0-zh-cn.png) 
...
![](../../../../../images/6cf668df/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[剪贴板错误码](/ref/system-basicfun-api/basic-services-api/basic-services-arkts-errcode/errorcode-pasteboard/errorcode-pasteboard)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[unifiedDataChannel.UnifiedData](/ref/arkdata-api/arkdata-arkts/js-apis-data-unifieddatachannel/js-apis-data-unifieddatachannel#unifieddata)&gt; | Promise对象，返回系统剪贴板数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [unifiedDataChannel.UnifiedData](/ref/arkdata-api/arkdata-arkts/js-apis-data-unifieddatachannel/js-apis-data-unifieddatachannel#unifieddata) | 返回系统剪贴板数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [unifiedDataChannel.UnifiedData](/ref/arkdata-api/arkdata-arkts/js-apis-data-unifieddatachannel/js-apis-data-unifieddatachannel#unifieddata) | 是 | 需要写入剪贴板中的数据。 |
