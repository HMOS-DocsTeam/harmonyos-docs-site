...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-request
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-system-request
---
...
![](../../../../../images/7428cf49/note_3.0-zh-cn.png) 

- 从API Version 9开始所有接口不再维护，推荐使用新接口[@ohos.request](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/data-file-processing-arkts/js-apis-request/js-apis-request)。
...
![](../../../../../images/02f8afdc/note_3.0-zh-cn.png) 

从API version 3 开始支持，从API version 9 开始废弃，建议使用[request.uploadFile](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/data-file-processing-arkts/js-apis-request/js-apis-request#requestuploadfile9)替代。
...
![](../../../../../images/bbdeb93c/note_3.0-zh-cn.png) 

从API version 3 开始支持，从API version 9 开始废弃，建议使用[UploadConfig](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/data-file-processing-arkts/js-apis-request/js-apis-request#uploadconfig)替代。
...
![](../../../../../images/2677aabe/note_3.0-zh-cn.png) 
