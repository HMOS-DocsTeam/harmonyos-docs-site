...
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-device
kit: 系统
last_updated: "2026-04-22"
slug: js-apis-system-device
---
...
![](../../../../../images/28f73e42/note_3.0-zh-cn.png) 

- 模块维护策略

  - 对于Lite Wearable设备类型，该模块长期维护，正常使用。

  - 对于支持该模块的其他设备类型，该模块从API Version 6开始不再维护，推荐使用新接口[@ohos.deviceInfo](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/device-management-arkts/js-apis-device-info/js-apis-device-info)进行设备信息查询。
...
![](../../../../../images/d5a49b98/note_3.0-zh-cn.png) 
