...
![](../../../../../images/27ec6f3a/note_3.0-zh-cn.png) 
...
![](../../../../../images/407d80ec/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 说明 |
| --- | --- | --- | --- |
| deviceType | string | 是 | 设备类型。详细请参考[deviceTypes标签](/development-fundamentals/application-configuration-file-stage/module-configuration-file#devicetypes标签)。  ****元服务API****：从API version 11开始，该接口支持在元服务中使用。  示例：phone |
...
| hardwareProfile(deprecated) | string | 是 | 硬件Profile。  ****说明****：  从API version 6 开始支持，从API version 9 开始废弃，建议使用[系统能力SystemCapability](/ref/syscap/syscap)替代。  示例：default |
