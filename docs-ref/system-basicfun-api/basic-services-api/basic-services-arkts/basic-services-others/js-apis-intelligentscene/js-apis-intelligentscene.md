...
![](../../../../../images/20bc755d/note_3.0-zh-cn.png) 
...
以下错误码详细介绍请参考[情景模式错误码](/ref/system-basicfun-api/basic-services-api/basic-services-arkts-errcode/errorcode-intelligentscene/errorcode-intelligentscene)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
