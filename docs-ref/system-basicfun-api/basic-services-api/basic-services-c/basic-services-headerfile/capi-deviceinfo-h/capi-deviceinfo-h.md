...
title: "deviceinfo.h"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-deviceinfo-h
kit: 系统
last_updated: "2026-04-22"
slug: capi-deviceinfo-h
---
...
****相关模块：**** [DeviceInfo](/ref/system-basicfun-api/basic-services-api/basic-services-c/basic-services-module/capi-deviceinfo/capi-deviceinfo)
...
| 类型 | 说明 |
| --- | --- |
| const char\* | ISV发行版系统版本号。  如果没有指定ISV，它将返回与[OH\_GetOSFullName](#oh_getosfullname)相同的值。 |
...
| 类型 | 说明 |
| --- | --- |
| int | ISV发行版系统api版本。  如果没有指定ISV，它将返回与[OH\_GetOSFullName](#oh_getosfullname)相同的值。 |
...
| 类型 | 说明 |
| --- | --- |
| const char | ISV发行版系统类型。  如果没有指定ISV，它将返回与[OH\_GetOsReleaseType](#oh_getosreleasetype)相同的值。 |
