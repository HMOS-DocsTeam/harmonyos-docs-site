...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ffrt\_function\_header\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-function-header-t/capi-ffrt-ffrt-function-header-t) | ffrt\_function\_header\_t | 任务执行体。 |
| [ffrt\_dependence\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-dependence-t/capi-ffrt-ffrt-dependence-t) | ffrt\_dependence\_t | 依赖数据结构。 |
| [ffrt\_deps\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-deps-t/capi-ffrt-ffrt-deps-t) | ffrt\_deps\_t | 依赖结构定义。 |
| [ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t) | ffrt\_task\_attr\_t | 并行任务属性结构。 |
| [ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t) | ffrt\_queue\_attr\_t | 串行队列属性结构。 |
| [ffrt\_condattr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-condattr-t/capi-ffrt-ffrt-condattr-t) | ffrt\_condattr\_t | FFRT条件变量属性结构。 |
| [ffrt\_mutexattr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-mutexattr-t/capi-ffrt-ffrt-mutexattr-t) | ffrt\_mutexattr\_t | FFRT锁属性结构。 |
| [ffrt\_rwlockattr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-rwlockattr-t/capi-ffrt-ffrt-rwlockattr-t) | ffrt\_rwlockattr\_t | FFRT读写锁属性结构。 |
| [ffrt\_mutex\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-mutex-t/capi-ffrt-ffrt-mutex-t) | ffrt\_mutex\_t | FFRT互斥锁结构。 |
| [ffrt\_rwlock\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-rwlock-t/capi-ffrt-ffrt-rwlock-t) | ffrt\_rwlock\_t | FFRT读写锁结构。 |
| [ffrt\_cond\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-cond-t/capi-ffrt-ffrt-cond-t) | ffrt\_cond\_t | FFRT条件变量结构。 |
| void\* | [ffrt\_task\_handle\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-handle-t/capi-ffrt-ffrt-task-handle-t) | 并行任务句柄。 |
| [ffrt\_fiber\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-fiber-t/capi-ffrt-ffrt-fiber-t) | ffrt\_fiber\_t | 纤程结构。 |
