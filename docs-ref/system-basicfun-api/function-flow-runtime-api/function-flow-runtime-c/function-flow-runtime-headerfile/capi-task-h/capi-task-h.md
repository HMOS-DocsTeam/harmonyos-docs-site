...
| [FFRT\_C\_API void ffrt\_task\_attr\_set\_delay(ffrt\_task\_attr\_t\* attr, uint64\_t delay\_us)](#ffrt_task_attr_set_delay) | 设置任务延迟时间。  设置任务的调度延迟后，任务的输入输出依赖关系不再生效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性指针。 |
...
| --- | --- |
| [ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性指针。 |
| [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) qos | 任务QoS。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) | 返回任务的QoS，默认返回ffrt\_qos\_default。 |
...
| --- | --- |
| [ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性指针。 |
| [ffrt\_queue\_priority\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#ffrt_queue_priority_t) priority | 任务优先级。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_queue\_priority\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#ffrt_queue_priority_t) | 返回任务优先级。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) qos | 当前任务待更新的QoS。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) | 返回任务QoS。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_function\_kind\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#ffrt_function_kind_t) kind | 函数执行结构类型，支持通用和队列函数执行结构类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_function\_header\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-function-header-t/capi-ffrt-ffrt-function-header-t)\* f | 任务执行体封装的指针。 |
| [const ffrt\_deps\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-deps-t/capi-ffrt-ffrt-deps-t)\* in\_deps | 输入依赖指针。 |
| [const ffrt\_deps\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-deps-t/capi-ffrt-ffrt-deps-t)\* out\_deps | 输出依赖指针。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_task\_handle\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-handle-t/capi-ffrt-ffrt-task-handle-t) | 提交任务成功返回非空任务句柄，  提交任务失败返回空指针。 |
...
[ffrt\_submit\_base](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-task-h/capi-task-h#ffrt_submit_base)
...
[ffrt\_submit\_h\_base](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-task-h/capi-task-h#ffrt_submit_h_base)
...
| 参数项 | 描述 |
| --- | --- |
| [const ffrt\_deps\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-deps-t/capi-ffrt-ffrt-deps-t)\* deps | 依赖的指针。 |
