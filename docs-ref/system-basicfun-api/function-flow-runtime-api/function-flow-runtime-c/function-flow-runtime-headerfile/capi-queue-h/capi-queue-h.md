...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) | 队列句柄。 |
...
| [FFRT\_C\_API void ffrt\_queue\_attr\_set\_callback(ffrt\_queue\_attr\_t\* attr, ffrt\_function\_header\_t\* f)](#ffrt_queue_attr_set_callback) | 设置串行队列超时回调方法。  不建议在f中调用exit函数，可能导致未定义行为。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 队列属性指针。 |
...
| --- | --- |
| [ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 队列属性指针。 |
| [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) qos | QoS属性值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 队列属性指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_qos\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#变量) | 返回队列的QoS属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 串行队列属性指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 串行队列属性指针。 |
...
| --- | --- |
| [ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 串行队列属性指针。 |
| [ffrt\_function\_header\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-function-header-t/capi-ffrt-ffrt-function-header-t)\* f | 超时回调方法执行体。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_function\_header\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-function-header-t/capi-ffrt-ffrt-function-header-t)\* | 返回串行队列超时回调方法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_queue\_type\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-queue-h/capi-queue-h#ffrt_queue_type_t) type | 队列类型。 |
| const char\* name | 队列名字。 |
| [const ffrt\_queue\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-attr-t/capi-ffrt-ffrt-queue-attr-t)\* attr | 队列属性。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) | 创建队列成功返回非空队列句柄，  创建队列失败返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) queue | 队列句柄。 |
...
| --- | --- |
| [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) queue | 队列句柄。 |
| [ffrt\_function\_header\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-function-header-t/capi-ffrt-ffrt-function-header-t)\* f | 任务的执行体。 |
| [const ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_task\_handle\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-handle-t/capi-ffrt-ffrt-task-handle-t) | 提交成功返回非空任务句柄，  提交失败返回空指针。 |
...
| --- | --- |
| [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) queue | 队列句柄。 |
| [ffrt\_function\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-type-def-h/capi-type-def-h#ffrt_function_t) func | 指定的任务函数。 |
| void\* arg | 传递给任务函数的参数。 |
| [const ffrt\_task\_attr\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-attr-t/capi-ffrt-ffrt-task-attr-t)\* attr | 任务属性。 |

****参考：****

[ffrt\_queue\_submit](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-queue-h/capi-queue-h#ffrt_queue_submit)
...
[ffrt\_queue\_submit\_h](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-headerfile/capi-queue-h/capi-queue-h#ffrt_queue_submit_h)
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_task\_handle\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-task-handle-t/capi-ffrt-ffrt-task-handle-t) handle | 任务句柄。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_queue\_t](/ref/system-basicfun-api/function-flow-runtime-api/function-flow-runtime-c/function-flow-runtime-struct/capi-ffrt-ffrt-queue-t/capi-ffrt-ffrt-queue-t) | 返回主线程队列句柄。 |
