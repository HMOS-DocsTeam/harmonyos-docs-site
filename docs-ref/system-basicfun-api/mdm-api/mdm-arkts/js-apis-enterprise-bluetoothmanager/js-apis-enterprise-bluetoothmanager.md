...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager
kit: 系统
...
![](../../../../images/67e89c08/note_3.0-zh-cn.png) 
...
全局通用限制类策略由restrictions统一提供，若要全局禁用蓝牙，请参考[@ohos.enterprise.restrictions（限制类策略）](/ref/system-basicfun-api/mdm-api/mdm-arkts/js-apis-enterprise-restrictions/js-apis-enterprise-restrictions)。
...
1. 已经通过[setDisallowedPolicy](/ref/system-basicfun-api/mdm-api/mdm-arkts/js-apis-enterprise-restrictions/js-apis-enterprise-restrictions#restrictionssetdisallowedpolicy)接口禁用了蓝牙。通过[setDisallowedPolicy](/ref/system-basicfun-api/mdm-api/mdm-arkts/js-apis-enterprise-restrictions/js-apis-enterprise-restrictions#restrictionssetdisallowedpolicy)接口启用蓝牙后，可解除冲突。
...
| state | [access.BluetoothState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#bluetoothstate) | 否 | 否 | 表示设备的蓝牙状态。 |
| connectionState | [constant.ProfileConnectionState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-constant/js-apis-bluetooth-constant#profileconnectionstate) | 否 | 否 | 表示设备的蓝牙连接状态。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| GATT | 0 | [GATT协议](/system-network/connectivity-kit/terminology#gatt)。 |
| SPP | 1 | [SPP协议](/system-network/connectivity-kit/terminology#spp)。 |
| OPP | 2 | [OPP协议](/system-network/connectivity-kit/terminology#opp)。 |
