...
title: "ArkTS API错误码"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/statusbar-extension-error-code
kit: 系统
last_updated: "2026-04-22"
slug: statusbar-extension-error-code
---

# ArkTS API错误码

![](../../../../images/c0196912/note_3.0-zh-cn.png) 
...
![](../../../../images/3480284e/note_3.0-zh-cn.png) 
...
- [StatusBarItem](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/statusbar-extension-manager/statusbar-extension-manager#statusbarmanagerstatusbaritem)中配置的hoverTips字符串长度为0或者大于128。
- 调用[updateStatusBarHoverTips](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/statusbar-extension-manager/statusbar-extension-manager#statusbarmanagerupdatestatusbarhovertips)方法时传入的字符串长度为0或者大于128。
...
当前传入的某个一级菜单项既不包含[menuAction](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/statusbar-extension-manager/statusbar-extension-manager#statusbarmanagerstatusbarmenuitem)，也不包含[subMenu](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/statusbar-extension-manager/statusbar-extension-manager#statusbarmanagerstatusbarmenuitem)。
...
- 调用[addCustomCategory](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanageraddcustomcategory)方法时传入的字符串长度大于512或者内容为空。
- 调用[updateCustomCategory](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanagerupdatecustomcategory)方法时传入的字符串长度大于512或者内容为空。
- 调用[addQuickTask](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanageraddquicktask)方法时传入的字符串长度大于512或者内容为空。
- 调用[updateQuickTask](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanagerupdatequicktask)方法时传入的字符串长度大于512或者内容为空。
...
- 调用[addQuickTask](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanageraddquicktask)方法时传入的parameters参数的数组大小超过64。
- 调用[updateQuickTask](/ref/system-basicfun-api/status-bar-extension-api/statusbar-extension-arkts/desktop-quickbar-extension-manager/desktop-quickbar-extension-manager#quickbarmanagerupdatequicktask)方法时传入的parameters参数的数组大小超过64。
