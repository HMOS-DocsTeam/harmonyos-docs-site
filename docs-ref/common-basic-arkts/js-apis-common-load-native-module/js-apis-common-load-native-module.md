...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-common-load-native-module
kit: 公共基础能力
...
![](../../images/1a1ab4a5/note_3.0-zh-cn.png) 
...
![](../../images/684918db/note_3.0-zh-cn.png) 
...
1.在加载本地so库时，配置模块级oh-package.json5文件的dependencies项。配置说明见[模块级oh-package.json5](/ide-ohpm-cli/ide-oh-package-json5#zh-cn_topic_0000001792256137_oh-packagejson5-字段说明)。
...
2.在模块级build-profile.json5中进行配置。配置说明见[模块级build-profile.json5文件](/ide-hvigor-configuration-file/ide-hvigor-build-profile)。
