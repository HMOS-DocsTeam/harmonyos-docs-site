...
sidebar_position: 16
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-cencinfo-h
kit: 媒体
last_updated: "2026-04-22"
slug: capi-native-cencinfo-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DrmSubsample](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-drmsubsample/capi-multimedia-drm-drmsubsample) | DrmSubsample | Subsample结构类型定义。 |
| [OH\_AVBuffer](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-core-oh-avbuffer/capi-core-oh-avbuffer) | OH\_AVBuffer | AVBuffer结构。 |
| [OH\_AVCencInfo](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-oh-avcencinfo/capi-multimedia-drm-oh-avcencinfo) | OH\_AVCencInfo | AVCencInfo结构。 |
...
| [OH\_AVErrCode OH\_AVCencInfo\_Destroy(OH\_AVCencInfo \*cencInfo)](#oh_avcencinfo_destroy) | 销毁OH\_AVCencInfo实例并释放内部资源。  同一个实例只能销毁一次。在再次创建实例之前，不应使用该实例。建议在实例销毁成功后立即将实例指针设置为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVCencInfo](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-oh-avcencinfo/capi-multimedia-drm-oh-avcencinfo) \* | 返回新创建的OH\_AVCencInfo对象。如果返回nullptr，则表示创建对象失败。  可能失败的原因：应用程序地址空间已满，或者对象中的数据初始化失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCencInfo](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-oh-avcencinfo/capi-multimedia-drm-oh-avcencinfo) \*cencInfo | 指向OH\_AVCencInfo实例的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：cencInfo为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：cencInfo为空、keyId为空、keyIdLen != DRM\_KEY\_ID\_SIZE、iv是空、ivLen != DRM\_KEY\_IV\_SIZE、keyId拷贝失败，或者iv拷贝失败。 |
...
| [DrmSubsample](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-drmsubsample/capi-multimedia-drm-drmsubsample) \*subsamples | Subsample内容集。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：cencInfo为空、subsampleCount > DRM\_KEY\_MAX\_SUB\_SAMPLE\_NUM，或者subsamples为空。 |
...
| --- | --- |
| [OH\_AVCencInfo](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-multimedia-drm-oh-avcencinfo/capi-multimedia-drm-oh-avcencinfo) \*cencInfo | 指向OH\_AVCencInfo实例的指针。 |
| [OH\_AVBuffer](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-core-oh-avbuffer/capi-core-oh-avbuffer) \*buffer | 携带数据的帧buffer。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：cencInfo为空、buffer为空、buffer->buffer\_为空，或者buffer->buffer\_->meta\_为空。 |
