...
对应的开发指南及样例可参考[媒体数据解析](/avcodec-kit/file-muxing-demuxing/audio-video-demuxer)。
...
| 名称 | 描述 |
| --- | --- |
| [native\_cencinfo.h](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-cencinfo-h/capi-native-cencinfo-h) | 声明用于设置解密参数的Native API。 |
