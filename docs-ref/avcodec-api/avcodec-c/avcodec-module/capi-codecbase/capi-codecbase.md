...
| 名称 | 描述 |
| --- | --- |
| [avcodec\_audio\_channel\_layout.h](/ref/avcodec-api/avcodec-c/avcodec-arkts-dep/avcodec-headerfile-arkts-dep/capi-avcodec-audio-channel-layout-h/capi-avcodec-audio-channel-layout-h) | 音频编解码声道布局枚举的声明。 |
| [native\_avcodec\_base.h](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h) | 声明用于音视频封装、解封装、编解码基础功能的Native API。 |
...
使用以下key的主要接口是[OH\_AVFormat](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-core-oh-avformat/capi-core-oh-avformat)，通过以下key可以进行参数配置或查询。
...
| OH\_MD\_KEY\_PROFILE | 编码档次，值类型为int32\_t，请参见[OH\_AVCProfile](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_avcprofile)，[OH\_HEVCProfile](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_hevcprofile)，[OH\_AACProfile](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_aacprofile)。该键是可选的。 |
...
| OH\_MD\_KEY\_PIXEL\_FORMAT | 视频像素格式的键，值类型为int32\_t，请参见[OH\_AVPixelFormat](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avformat-h/capi-native-avformat-h#oh_avpixelformat)。 |
...
| OH\_MD\_KEY\_COLOR\_PRIMARIES | 视频色域的键，值类型为int32\_t，请参见[OH\_ColorPrimary](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_colorprimary)，遵循H.273标准Table2。该键是可选的。 |
| OH\_MD\_KEY\_TRANSFER\_CHARACTERISTICS | 视频传递函数的键，值类型为int32\_t，请参见[OH\_TransferCharacteristic](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_transfercharacteristic)，遵循H.273标准Table3。该键是可选的。 |
| OH\_MD\_KEY\_MATRIX\_COEFFICIENTS | 视频矩阵系数的键，值类型为int32\_t，请参见[OH\_MatrixCoefficient](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_matrixcoefficient)，遵循H.273标准Table4。该键是可选的。 |
...
| OH\_MD\_KEY\_VIDEO\_ENCODE\_BITRATE\_MODE | 视频编码码率模式，值类型为int32\_t，请参见[OH\_BitrateMode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_bitratemode)。该键是可选的。 |
...
| OH\_MD\_KEY\_VIDEO\_ENCODER\_TEMPORAL\_GOP\_REFERENCE\_MODE | 描述图片组内参考模式的键，值类型为int32\_t，请参见[OH\_TemporalGopReferenceMode](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_temporalgopreferencemode)，只在使能分层编码时生效。该键是可选的且只用于视频编码，在Configure阶段使用。 |
...
| OH\_MD\_KEY\_VIDEO\_PER\_FRAME\_IS\_LTR | 当前[OH\_AVBuffer](/ref/avcodec-api/avcodec-c/avcodec-struct/capi-core-oh-avbuffer/capi-core-oh-avbuffer)中输出的码流对应的帧是否为长期参考帧（LTR）的键，值类型为int32\_t，1表示是长期参考帧（LTR），0表示不是长期参考帧（LTR）。该键是可选的且只用于视频编码，默认值为0。 |
...
| OH\_MD\_KEY\_MAX\_BITRATE | 描述SQR码控模式的最大码率，使用[OH\_AVCapability\_GetEncoderBitrateRange](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcapability-h/capi-native-avcapability-h#oh_avcapability_getencoderbitraterange)方法获取取值范围（同OH\_MD\_KEY\_BITRATE），单位bps，值类型为int64\_t。该键值是可选的且只用于视频编码。 |
...
| OH\_MD\_KEY\_CHANNEL\_LAYOUT | 所需编码通道布局的键。值类型为int64\_t，此键仅适用于编码器。请参见[OH\_AudioChannelLayout](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-audio-channel-layout-h/capi-native-audio-channel-layout-h#oh_audiochannellayout)。 |
...
| OH\_MD\_KEY\_TRACK\_TYPE | 轨道媒体类型的键，值类型为int32\_t，请参见[OH\_MediaType](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcodec-base-h/capi-native-avcodec-base-h#oh_mediatype)。该键是可选的。 |
