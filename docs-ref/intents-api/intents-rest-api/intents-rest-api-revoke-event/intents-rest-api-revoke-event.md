...
title: "事件撤销"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-rest-api-revoke-event
kit: AI
last_updated: "2026-04-22"
slug: intents-rest-api-revoke-event
---
...
| Authorization | 是 | String | 应用级AccessToken，前面需要加上Bearer，通过调用Oauth2.0的接口获得，接口请求`https://oauth-login.cloud.huawei.com/oauth2/v3/token`。 |
