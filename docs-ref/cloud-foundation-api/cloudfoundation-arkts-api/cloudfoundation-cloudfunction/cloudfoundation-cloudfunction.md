...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudfunction
kit: 应用服务
...
| callback | AsyncCallback&lt;[FunctionResult](#functionresult)&gt; | 是 | 回调函数。当调用云函数成功，err为undefined，data为获取到的FunctionResult；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[FunctionResult](#functionresult)&gt; | Promise对象，返回函数调用结果。 |
