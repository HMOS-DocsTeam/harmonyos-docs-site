...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent
kit: 应用服务
last_updated: "2026-04-22"
slug: js-apis-inner-notification-notificationcontent
---
...
![](../../../../images/67b538d4/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| contentType(deprecated) | [notification.ContentType](/ref/notification-api/notification-arkts/notification-arkts-dep/js-apis-notification/js-apis-notification#contenttype) | 否 | 是 | 通知内容类型。  从API version 7开始支持，从API version 11开始废弃，建议使用notificationContentType替代。 |
| notificationContentType11+ | [notificationManager.ContentType](/ref/notification-api/notification-arkts/js-apis-notificationmanager/js-apis-notificationmanager#contenttype) | 否 | 是 | 通知内容类型。 |
...
| lockscreenPicture12+ | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 通知在锁屏界面显示的图片，默认为空。当前仅支持实况窗类型通知。图标像素的总字节数不超过192KB（图标像素的总字节数通过[getPixelBytesNumber](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#getpixelbytesnumber7)获取），建议图标像素长宽为128\*128。实际显示效果依赖于设备能力和通知中心UI样式。 |

## NotificationLongTextContent

描述长文本通知。继承自[NotificationBasicContent](#notificationbasiccontent)。

![](../../../../images/78c50ddf/note_3.0-zh-cn.png) 
...
![](../../../../images/325eb414/note_3.0-zh-cn.png) 
...
![](../../../../images/33180728/note_3.0-zh-cn.png) 
...
| briefText | string | 否 | 否 | 通知概要内容，是对通知内容的总结（不可为空字符串，大小不超过1024字节，超出部分会被截断）。 |
| expandedTitle | string | 否 | 否 | 通知展开时的标题（不可为空字符串，大小不超过1024字节，超出部分会被截断）。 |
| picture | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 通知的图片内容（图像像素的总字节数不能超过2MB）。 |
...
| icon | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 是 | 胶囊图片。图标像素的总字节数不超过192KB（图标像素的总字节数通过[getPixelBytesNumber](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#getpixelbytesnumber7)获取），建议图标像素长宽为128\*128。实际显示效果依赖于设备能力和通知中心UI样式。 |
...
| icons | Array&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | 否 | 是 | 按钮图片（最多支持3个）。图标像素的总字节数不超过192KB（图标像素的总字节数通过[getPixelBytesNumber](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#getpixelbytesnumber7)获取），建议图标像素长宽为128\*128。实际显示效果依赖于设备能力和通知中心UI样式。 |
| iconsResource12+ | Array&lt;[Resource](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resource)&gt; | 否 | 是 | 按钮资源（最多支持3个）。 |
