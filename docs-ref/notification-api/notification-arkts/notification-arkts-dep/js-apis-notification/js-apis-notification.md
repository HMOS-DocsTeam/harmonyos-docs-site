...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-notification
kit: 应用服务
last_updated: "2026-04-22"
slug: js-apis-notification
---
...
![](../../../../images/2c334c12/note_3.0-zh-cn.png) 

从API version 9开始，该模块不再维护，建议使用[@ohos.notificationManager](/ref/notification-api/notification-arkts/js-apis-notificationmanager/js-apis-notificationmanager)替代。
...
![](../../../../images/99ef5551/note_3.0-zh-cn.png) 

从 API version 7开始支持，从API version 9开始废弃。建议使用[notificationManager.BundleOption](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcommondef/js-apis-inner-notification-notificationcommondef#bundleoption)替代。
...
![](../../../../images/e9104b2a/note_3.0-zh-cn.png) 
...
| wantAgent | [WantAgent](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-wantagent/js-apis-wantagent) | 是 | 是 | 点击按钮时触发的WantAgent。 |
...
| briefText | string | 是 | 是 | 通知概要内容，是对通知内容的总结。 |
| expandedTitle | string | 是 | 是 | 通知展开时的标题。 |
| picture | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 是 | 通知的图片内容。 |
...
| wantAgent | [WantAgent](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-wantagent/js-apis-wantagent) | 是 | 是 | WantAgent封装了应用的行为意图，点击通知时触发该行为。 |
...
| smallIcon | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 是 | 通知小图标。可选字段，大小不超过30KB。 |
| largeIcon | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 是 | 通知大图标。可选字段，大小不超过30KB。 |
...
| notificationFlags8+ | [NotificationFlags](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationflags/js-apis-inner-notification-notificationflags) | 是 | 否 | 获取NotificationFlags。 |
| removalWantAgent9+ | [WantAgent](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-wantagent/js-apis-wantagent) | 是 | 是 | 当移除通知时，通知将被重定向到的WantAgent实例。 |
