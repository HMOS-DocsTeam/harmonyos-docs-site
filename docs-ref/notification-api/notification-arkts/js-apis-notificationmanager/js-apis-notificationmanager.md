...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-notificationmanager
kit: 应用服务
last_updated: "2026-04-22"
slug: js-apis-notificationmanager
---
...
![](../../../images/cd7eb524/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [NotificationRequest](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#notificationrequest-1) | 是 | 设置发布通知的内容和相关配置信息。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。当发布通知成功，err为undefined，否则为错误对象。 |

****错误码：****

以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)、[通知错误码](/ref/notification-api/notification-arkts-errcode/errorcode-notification/errorcode-notification)、[HTTP错误码](/ref/system-network-api/network-api/network-arkts-errcode/errorcode-net-http/errorcode-net-http)。
...
以下错误码的详细介绍请参见[通知错误码](/ref/notification-api/notification-arkts-errcode/errorcode-notification/errorcode-notification)。
...
| callback | AsyncCallback&lt;[NotificationSlot](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationslot/js-apis-inner-notification-notificationslot)&gt; | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[NotificationSlot](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationslot/js-apis-inner-notification-notificationslot)&gt; | Promise对象，返回通知渠道对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[NotificationSlot](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationslot/js-apis-inner-notification-notificationslot)&gt;&gt; | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot数组，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[NotificationSlot](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationslot/js-apis-inner-notification-notificationslot)&gt;&gt; | Promise对象，返回通知渠道对象。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)、[通知错误码](/ref/notification-api/notification-arkts-errcode/errorcode-notification/errorcode-notification)、[包管理子系统通用错误码](/ref/ability-api/ability-arkts-errcode/errorcode-bundle/errorcode-bundle)。
...
以下错误码的详细介绍请参见[通知错误码](/ref/notification-api/notification-arkts-errcode/errorcode-notification/errorcode-notification)、[包管理子系统通用错误码](/ref/ability-api/ability-arkts-errcode/errorcode-bundle/errorcode-bundle)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;[NotificationRequest](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#notificationrequest-1)&gt;&gt; | 是 | 回调函数。当获取未删除的通知列表成功，err为undefined，data为获取到的通知列表，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[NotificationRequest](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#notificationrequest-1)&gt;&gt; | Promise对象，返回当前应用的通知列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| groupName | string | 是 | 通知组名称，此名称需要在发布通知时通过[NotificationRequest](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#notificationrequest-1)对象指定。 |
...
在使用[通知模板](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationtemplate/js-apis-inner-notification-notificationtemplate)发布通知前，可以通过该接口查询是否支持对应的通知模板。使用callback异步回调。
...
在使用[通知模板](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationtemplate/js-apis-inner-notification-notificationtemplate)发布通知前，可以通过该接口查询是否支持对应的通知模板。使用Promise异步回调。
...
![](../../../images/78cce525/note_3.0-zh-cn.png) 

- 仅当应用界面加载完成后（即调用[loadContent](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiextensioncontentsession/js-apis-app-ability-uiextensioncontentsession#loadcontent)成功），方可使用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | 通知弹窗绑定Ability的上下文。 |
...
![](../../../images/dc6b606d/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | 通知弹窗绑定的Ability上下文。 |
...
![](../../../images/0b4a17bd/note_3.0-zh-cn.png) 
...
![](../../../images/d4566d7b/note_3.0-zh-cn.png) 
...
| LIVE\_VIEW11+ | 4 | 实况窗。不支持三方应用直接创建该渠道类型通知，可以由系统代理创建后，三方应用发布同ID的通知来更新指定内容，更新时默认无提示音。该类型对应[SlotLevel](#slotlevel)为LEVEL\_DEFAULT。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationActionButton](/ref/notification-api/notification-arkts/notification/s-apis-inner-notification-notificationactionbutton/s-apis-inner-notification-notificationactionbutton) | 通知中显示的操作按钮。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationBasicContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationbasiccontent) | 描述普通文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationcontent-1) | 描述通知内容。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationLongTextContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationlongtextcontent) | 描述长文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationMultiLineContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationmultilinecontent) | 描述多行文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationPictureContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationpicturecontent) | 附有图片的通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationSystemLiveViewContent](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationsystemliveviewcontent) | 系统实况窗通知内容。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationRequest](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#notificationrequest-1) | 通知请求。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_DistributedOptions](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationrequest/js-apis-inner-notification-notificationrequest#distributedoptions8) | 分布式选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationSlot](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationslot/js-apis-inner-notification-notificationslot) | 通知渠道。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationTemplate](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationtemplate/js-apis-inner-notification-notificationtemplate) | 通知模板。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationUserInput](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationuserinput/js-apis-inner-notification-notificationuserinput) | 保存用户输入的通知消息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationCapsule](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationcapsule11) | 通知胶囊。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationButton](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationbutton11) | 通知按钮。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationTime](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationtime11) | 描述通知计时信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationProgress](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationcontent/js-apis-inner-notification-notificationcontent#notificationprogress11) | 描述通知进度。 |
