...
title: "通知错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-notification
kit: 应用服务
last_updated: "2026-04-22"
slug: errorcode-notification
---

# 通知错误码

![](../../../images/c8ef5532/note_3.0-zh-cn.png) 
...
该应用受到[企业设备管理](/system-basicfun/mdm-kit/mdm-kit-intro)的权限管控，应用无法主动退出权限管控名单。
...
应用未设置或未正确设置[NotificationSubscriberExtensionAbility](/ref/notification-api/notification-arkts/js-apis-notificationsubscriberextensionability/js-apis-notificationsubscriberextensionability)。
