...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-backgroundprocessmanager
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-backgroundprocessmanager
---
...
![](../../../images/f50bfa50/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 需要被压制子进程的进程号，[OH\_Ability\_StartNativeChildProcess](/ref/ability-api/ability-c/ability-headerfile/capi-native-child-process-h/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 子进程的进程号，[OH\_Ability\_StartNativeChildProcess](/ref/ability-api/ability-c/ability-headerfile/capi-native-child-process-h/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
...
以下错误码的详细介绍请参见[backgroundProcessManager错误码](/ref/background-tasks-api/background-tasks-arkts-errcode/errorcode-backgroundprocessmanager/errorcode-backgroundprocessmanager)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
