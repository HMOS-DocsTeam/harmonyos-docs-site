...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-resourceschedule-workscheduler
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-resourceschedule-workscheduler
---

# @ohos.resourceschedule.workScheduler (延迟任务调度)

本模块提供延迟任务注册、取消、查询的能力。在开发过程中，对于实时性要求不高的任务，可以调用本模块接口注册延迟任务，在系统空闲时根据性能、功耗、热等情况进行调度执行。开发指导请参考[延迟任务开发指南](/background-task-kit/work-scheduler)。

![](../../../images/e0bd4ef1/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[workScheduler错误码](/ref/background-tasks-api/background-tasks-arkts-errcode/errorcode-workscheduler/errorcode-workscheduler)。
...
![](../../../images/de5746b2/note_3.0-zh-cn.png) 
...
![](../../../images/450e9fb7/note_3.0-zh-cn.png) 
