...
![](../../../images/868addcb/note_3.0-zh-cn.png) 
...
1. 申请通知使能权限弹窗[notificationManager.requestEnableNotification](/ref/notification-api/notification-arkts/js-apis-notificationmanager/js-apis-notificationmanager#notificationmanagerrequestenablenotification10)。
2. 通知设置里开启应用通知开关。
...
1. 首先，确认是否[申请了代理提醒的使用权限](/background-task-kit/agent-powered-reminder#约束与限制)。
