...
![](../../../images/aaad24f7/note_3.0-zh-cn.png) 
...
1. 检查 [hdsDrawable.getHdsLayeredIcons](/ref/ui-design-api/ui-design-arkts/ui-design-hdsdrawable/ui-design-hdsdrawable#hdsdrawablegethdslayeredicons)， [hdsDrawable.getHdsIcons](/ref/ui-design-api/ui-design-arkts/ui-design-hdsdrawable/ui-design-hdsdrawable#hdsdrawablegethdsicons)的调用是否在对应返回结果后再执行，或者使用单次处理的API接口进行处理。
