...
| layeredDrawableDescriptor | [LayeredDrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#layereddrawabledescriptor) | 是 | 需要处理的分层图标数据对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 接口处理完成后返回的图标数据对象，格式为PixelMap。 |
...
![](../../../images/e24c5b90/zh-cn_image_0000002552800868.png)
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)&gt; | Promise对象，接口处理完成后返回的图标数据对象，格式为PixelMap。 |
...
![](../../../images/8476ced2/zh-cn_image_0000002552800868.png)
...
| --- | --- | --- | --- |
| bundleName | string | 是 | 与应用绑定，为应用Bundle名称。 |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 单层图标数据对象。 |
| size | number | 是 | 接口处理完成后输出的图标对象为正方形，该值表示输出对象的正方形边长，包含描边区域，取值范围：大于0，单位：vp。 |
| mask | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 图标蒙版信息，用于图标剪切处理。 |
| hasBorder | boolean | 否 | 是否描边，true：描边，false：不描边，默认false，在线主题场景不支持设置描边。 |
...
![](../../../images/2b621e24/zh-cn_image_0000002583440563.png)
...
![](../../../images/868f4318/zh-cn_image_0000002583440563.png)
...
![](../../../images/34d25684/zh-cn_image_0000002552800868.png)
...
![](../../../images/74db5c0a/zh-cn_image_0000002583440563.png)
...
| layeredDrawableDescriptor | [LayeredDrawableDescriptor](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-drawabledescriptor/js-apis-arkui-drawabledescriptor#layereddrawabledescriptor) | 否 | 否 | 需要处理的分层图标数据对象。 |
...
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 是 | 否 | 接口处理完成后返回的图标数据对象，格式为PixelMap。 |
...
| --- | --- | --- | --- | --- |
| bundleName | string | 否 | 否 | 应用Bundle名称。 |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 单层图标数据对象。 |
