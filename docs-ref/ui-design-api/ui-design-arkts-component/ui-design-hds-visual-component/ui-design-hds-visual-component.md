...
![](../../../images/105d9cf5/note_3.0-zh-cn.png) 
...
| frameRateRange | hdsEffect.[ExpectedFrameRateRange](/ref/ui-design-api/ui-design-arkts/ui-design-hdseffect/ui-design-hdseffect#expectedframeraterange) | 否 | 视效场景帧率配置。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| backgroundMaskColors | Array&lt;[ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor)&gt; | 否 | 否 | 背景蒙层颜色数组。 |
| firstEdgeFlowLight | hdsEffect.[EdgeFlowLightParam](/ref/ui-design-api/ui-design-arkts/ui-design-hdseffect/ui-design-hdseffect#edgeflowlightparam) | 否 | 否 | 第一条流光参数配置。 |
| secondEdgeFlowLight | hdsEffect.[EdgeFlowLightParam](/ref/ui-design-api/ui-design-arkts/ui-design-hdseffect/ui-design-hdseffect#edgeflowlightparam) | 否 | 否 | 第二条流光参数配置。 |
...
![](../../../images/7606415a/zh-cn_image_0000002583440577.gif)
