...
sidebar_position: 9
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitemcard
kit: 应用框架
last_updated: "2026-04-22"
slug: ui-design-hdslistitemcard
---
...
![](../../../images/39a06ea4/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| customBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | 是 | A区（列表左侧）自定义内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | A区（列表左侧）自定义内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| customBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | 是 | C区（列表右侧）自定义内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | C区（列表右侧）自定义内容。 |
...
| cardHeight | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项的高度，目前不支持使用Percentage设置。 |
| cardWidth | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项的宽度，目前不支持使用Percentage设置。 |
| cardBackgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | HdsListItemCard列表项的背景颜色。 |
| cardBorderRadius | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项的边框圆角。 |
| cardPrefixMargin | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项距离屏幕左侧的边距。 |
| cardSuffixMargin | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项距离屏幕右侧的边距。 |
| hoverBorderRadius | [Dimension](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#dimension10) | 否 | 是 | HdsListItemCard列表项在悬浮状态下的边框圆角。 |
...
![](../../../images/8ac445c0/note_3.0-zh-cn.png) 
...
| customBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | 是 | B区（列表中间）自定义内容。 |

![](../../../images/085324c7/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| accessibilityText | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 列表的无障碍文本属性。当组件不包含文本属性时，屏幕朗读选中此组件时不播报，使用者无法清楚地知道当前选中了什么组件。为了解决此场景，开发人员可为不包含文字信息的组件设置无障碍文本，当屏幕朗读选中此组件时播报无障碍文本的内容，帮助屏幕朗读的使用者清楚地知道自己选中了什么组件。  默认值：""。 |
...
| accessibilityLevel | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 无障碍重要性，用于控制当前项是否可被无障碍辅助服务所识别。  支持的值为：  "auto"：当前组件会转换"yes"。  "yes"：当前组件可被无障碍辅助服务所识别。  "no"：当前组件不可被无障碍辅助服务所识别。  "no-hide-descendants"：当前组件及其所有子组件不可被无障碍辅助服务所识别。  默认值："auto"。 |
...
| accessibilityRole | [AccessibilityRoleType](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/ts-universal-attributes-accessibility/ts-universal-attributes-accessibility#accessibilityroletype18枚举说明) | 否 | 是 | 设置无障碍节点的组件类型。特定组件类型有特定的朗读方式，可以根据应用诉求，修改组件类型，用于控制无障碍模式下对组件的朗读方式和朗读内容。不设置的时候，默认使用节点自身的组件类型。  ****起始版本：**** 6.1.0(23) |
| onAccessibilityActionIntercept | [AccessibilityActionInterceptCallback](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/accessibility-related/ts-universal-accessibility-event/ts-universal-accessibility-event#accessibilityactioninterceptcallback20) | 否 | 是 | 注册onAccessibilityActionIntercept回调。该回调会在无障碍控制操作触发前调用，由注册方决定是否拦截该次无障碍动作，对不支持Click的组件注册也无法触发回调。  ****起始版本：**** 6.1.0(23) |

![](../../../images/d67436e9/note_3.0-zh-cn.png) 
...
| modifier | [ImageModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | Image属性样式修改器。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| iconSize | [IconSize](#iconsize) | 否 | 是 | A区（列表左侧）Icon样式。  默认值：[IconSize](#iconsize).SYSTEM\_ICON。 |
...
| badgeColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Badge背板颜色。  显示信息标记时默认值：$r('sys.color.warning')。  不显示信息标记时默认值：$r('sys.color.comp\_background\_emphasize')。 |
| textColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Badge中数字颜色。  默认值：$r('sys.color.font\_on\_primary')。 |
...
| selectColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 选择类元素被选中后的背板颜色。 |
...
| selectColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | ToggleButton被选中后的背板颜色。  默认值：#00000000。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| text | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | Text资源类型。 |
| modifier | [TextModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | Text属性样式修改器。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 对应元素的颜色修改。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| text | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | Button内部的text文本内容。 |
| textColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | Button内部的text文本颜色。  TV上默认值为$r('sys.color.font\_primary')，其他设备上默认值为$r('sys.color.font\_emphasize')。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| arrowColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | C区（列表右侧）箭头的颜色。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 否 | 下拉按钮本身的文本内容。 |
| valueColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 下拉按钮本身的文本颜色。  默认值：$r('sys.color.font\_secondary')。 |
| arrowColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 下拉按钮箭头的颜色。  默认值：$r('sys.color.icon\_secondary')。 |
| optionValues | Array&lt;[ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr)&gt; | 否 | 否 | 下拉选项内容。 |
| optionSymbol | Array&lt;[SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier)&gt; | 否 | 否 | 下拉选项Symbol图片。 |
...
| [SymbolGlyphModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | SymbolGlyph属性样式修改器。 |
...
| --- | --- |
| [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 字符串类型。 |
| image.[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | PixelMap类型。 |
...
![](../../../images/b7fbbd78/note_3.0-zh-cn.png) 
...
![](../../../images/90eabf4d/zh-cn_image_0000002552800882.jpg)
