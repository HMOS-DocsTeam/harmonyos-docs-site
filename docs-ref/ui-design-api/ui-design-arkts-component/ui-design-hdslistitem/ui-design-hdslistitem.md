...
title: "HdsListItem"
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem
kit: 应用框架
last_updated: "2026-04-22"
slug: ui-design-hdslistitem
---
...
| 参数名 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| customItemBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | @BuilderParam | 自定义列表卡片项内容。 |
| hdsListItemCard | [HdsListItemCardOptions](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdslistitemcard/ui-design-hdslistitemcard#hdslistitemcardoptions) | 否 | - | 列表卡片项内容。 |
| swipeActionOptions | [HdsSwipeActionOptions](#hdsswipeactionoptions) | [SwipeActionOptions](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeactionoptions9对象说明) | 否 | - | 动效横滑内容展示。  HdsSwipeActionOptions是HdsListItem封装后的横滑动效类型，SwipeActionOptions支持用户自定义使用ListItem的横滑动效类型。 |
| listItemModifier | [ListItemModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | - | ListItem属性样式修改器。  ****起始版本：**** 6.0.1(21) |
| menuStyle | [MenuStyle](#menustyle) | 否 | @Prop | ListItem预览菜单样式。  ****起始版本：**** 6.1.0(23) |
| menuBuilder | [CustomBuilder](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#custombuilder8) | 否 | @BuilderParam | 自定义弹出菜单内容。  ****起始版本：**** 6.1.0(23) |
| isSelected | boolean | 否 | @Prop | ListItem是否被选中。  true：被选中。  false：未选中。  默认值：false。  ****起始版本：**** 6.1.0(23) |

![](../../../images/a9cbb43d/note_3.0-zh-cn.png) 
...
| deleteTriggerType | [SwipeDeleteTriggerType](#swipedeletetriggertype) | 否 | 是 | 配置横滑删除的触发类型。  默认值：SwipeDeleteTriggerType.NORMAL\_TRIGGER。  ****起始版本：**** 6.1.0(23) |
...
| accessibilityText | [ResourceStr](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcestr) | 否 | 是 | 图标的无障碍文本属性。  当组件不包含文本属性时，屏幕朗读选中此组件时不播报，使用者无法清楚地知道当前选中了什么组件。为了解决此场景，开发人员可为不包含文字信息的组件设置无障碍文本，当屏幕朗读选中此组件时播报无障碍文本的内容，帮助屏幕朗读的使用者清楚地知道自己选中了什么组件。  默认值：""。 |
...
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 图标背景色。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 删除按钮图标背景色。 |
| iconColor | [ResourceColor](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#resourcecolor) | 否 | 是 | 删除按钮图标颜色。 |
...
| [ImageOptions](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdslistitemcard/ui-design-hdslistitemcard#accessibilitygroupoptions) | image资源类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| responseType | [ResponseType](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-appendix-enums/ts-appendix-enums#responsetype8) | 否 | 是 | 预览菜单响应类型。 |
| menuOptions | [ContextMenuOptions](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/popup-property/ts-universal-attributes-menu/ts-universal-attributes-menu#contextmenuoptions10) | 否 | 是 | 预览菜单选项信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [SwipeActionState](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-listitem/ts-container-listitem#swipeactionstate11枚举说明) | 是 | 列表项滑动的状态。  - state为SwipeActionState.COLLAPSED时，表示收起状态，此时操作项处于隐藏状态。  - state为SwipeActionState.EXPANDED时，表示展开状态，此时操作项处于显示状态。  - state为SwipeActionState.ACTIONING时，表示长距离状态，当HdsListItem进入长距删除区后，删除HdsListItem的状态。 |
...
![](../../../images/d8ae4596/zh-cn_image_0000002583480531.gif)
