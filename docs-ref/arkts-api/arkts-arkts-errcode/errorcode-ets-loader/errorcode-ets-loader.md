...
title: "编译工具链错误码"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-ets-loader
kit: 应用框架
...
![](../../../images/62d1d19d/note_3.0-zh-cn.png) 
...
2. 有关Kit API的更多详细信息，请参考[开发说明](/ref/development-intro-api/development-intro-api)。
...
请参考[Es2abc编译器错误码](/ref/arkts-api/arkts-arkts-errcode/errorcode-es2abc/errorcode-es2abc)进行处理。
