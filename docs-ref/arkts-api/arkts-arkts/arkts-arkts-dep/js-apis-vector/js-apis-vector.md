...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vector
kit: 应用框架
...
Vector和[ArrayList](/ref/arkts-api/arkts-arkts/js-apis-arraylist/js-apis-arraylist)相似，都是基于数组实现，但Vector提供了更多操作数组的接口。它们都可以动态调整容量，但Vector每次扩容增加1倍，ArrayList只扩容0.5倍。
...
![](../../../../images/e321752d/note_3.0-zh-cn.png) 

本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

API version 9开始，该接口不再维护，推荐使用接口['@ohos.util.ArrayList'](/ref/arkts-api/arkts-arkts/js-apis-arraylist/js-apis-arraylist)。
