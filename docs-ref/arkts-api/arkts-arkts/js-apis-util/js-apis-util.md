...
sidebar_position: 12
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-util
kit: 应用框架
...
![](../../../images/b95507c2/note_3.0-zh-cn.png) 
...
![](../../../images/ac8a81a7/note_3.0-zh-cn.png) 
...
![](../../../images/82d82b3b/note_3.0-zh-cn.png) 
...
![](../../../images/c466bfeb/note_3.0-zh-cn.png) 
...
![](../../../images/aea0f24c/note_3.0-zh-cn.png) 
...
![](../../../images/c7bccd58/note_3.0-zh-cn.png) 
...
![](../../../images/20594601/note_3.0-zh-cn.png) 
...
![](../../../images/6167d5cd/note_3.0-zh-cn.png) 
...
![](../../../images/84c4ab60/note_3.0-zh-cn.png) 
...
![](../../../images/141e7b64/note_3.0-zh-cn.png) 
...
![](../../../images/9d8bafba/note_3.0-zh-cn.png) 
...
![](../../../images/458f20a1/note_3.0-zh-cn.png) 
...
![](../../../images/c2ac20e5/note_3.0-zh-cn.png) 
...
![](../../../images/dd7599a6/note_3.0-zh-cn.png) 
...
![](../../../images/8ce10b66/note_3.0-zh-cn.png) 
...
![](../../../images/903d8780/note_3.0-zh-cn.png) 
...
![](../../../images/a6c0f26d/note_3.0-zh-cn.png) 
...
![](../../../images/6b0fb2a9/note_3.0-zh-cn.png) 

若此回调方法在[clear9+](#clear9)、[updateCapacity9+](#updatecapacity9)接口调用之后触发执行，传入的key和value参数类型为MapIterator，可参照示例二进行后续操作。
...
| options12+ | [Type](#type10) | 否 | 从API version 12开始支持该参数，表示对应的编码格式。  此参数可选，可选值为：util.Type.BASIC和util.Type.BASIC\_URL\_SAFE，默认值为：util.Type.BASIC。  util.Type.BASIC表示Base64编码。  util.Type.BASIC\_URL\_SAFE表示Base64URL编码。 |
...
| options10+ | [Type](#type10) | 否 | 从API version 10开始支持该参数，表示对应的编码格式。  此参数可选，可选值为：util.Type.BASIC，util.Type.MIME，util.Type.BASIC\_URL\_SAFE 和util.Type.MIME\_URL\_SAFE，默认值为：util.Type.BASIC。  - 当参数取值为util.Type.BASIC，表示Base64编码，返回值没有回车符、换行符。  - 当参数取值为util.Type.MIME，表示使用Base64编码。如果返回值超过76个字符，则会在每76个字符处进行换行，并以'\r\n'结束每行。如果返回值少于76个字符，则会抛出异常。  - 当参数取值为util.Type.BASIC\_URL\_SAFE，表示Base64URL编码，返回值没有回车符、换行符。  - 当参数取值为util.Type.MIME\_URL\_SAFE，表示Base64URL编码，返回值每一行不超过76个字符，而且每行以'\r\n'符结束。 |
...
| options10+ | [Type](#type10) | 否 | 从API version 10开始支持该参数，表示对应的编码格式。  此参数可选，可选值为：util.Type.BASIC，util.Type.MIME，util.Type.BASIC\_URL\_SAFE和util.Type.MIME\_URL\_SAFE，默认值为：util.Type.BASIC。  - 当参数取值为util.Type.BASIC，表示Base64编码，返回值没有回车符、换行符。  - 当参数取值为util.Type.MIME，表示Base64编码，返回值每一行不超过76个字符，而且每行以'\r\n'符结束。  - 当参数取值为util.Type.BASIC\_URL\_SAFE，表示Base64URL编码，返回值没有回车符、换行符。  - 当参数取值为util.Type.MIME\_URL\_SAFE，表示Base64URL编码，返回值每一行不超过76个字符，而且每行以'\r\n'符结束。 |
...
![](../../../images/213f353f/note_3.0-zh-cn.png) 
...
![](../../../images/4545db66/note_3.0-zh-cn.png) 
...
![](../../../images/8e7b52f9/note_3.0-zh-cn.png) 
...
![](../../../images/7f3c970d/note_3.0-zh-cn.png) 
...
![](../../../images/3ebfe36c/note_3.0-zh-cn.png) 
...
![](../../../images/fe1f1775/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| obj | [AutoFinalizer&lt;T&gt;](#autofinalizert22) | 是 | 实现了AutoFinalizer接口的对象，其onFinalization方法会在该对象被回收时调用。 |
...
![](../../../images/0d7a01f4/note_3.0-zh-cn.png) 
...
![](../../../images/6ae16c49/note_3.0-zh-cn.png) 
...
![](../../../images/003ffa43/note_3.0-zh-cn.png) 
...
![](../../../images/3121f2b2/note_3.0-zh-cn.png) 
...
![](../../../images/98cf870b/note_3.0-zh-cn.png) 
...
![](../../../images/9b7dd0bd/note_3.0-zh-cn.png) 
...
![](../../../images/b9266a67/note_3.0-zh-cn.png) 
...
![](../../../images/069a359f/note_3.0-zh-cn.png) 
...
![](../../../images/0c41ed66/note_3.0-zh-cn.png) 
...
![](../../../images/5ea60bc1/note_3.0-zh-cn.png) 
...
![](../../../images/b6b3cb7b/note_3.0-zh-cn.png) 
...
![](../../../images/51c55655/note_3.0-zh-cn.png) 
...
![](../../../images/3ebd757b/note_3.0-zh-cn.png) 
...
![](../../../images/37fd4170/note_3.0-zh-cn.png) 
...
![](../../../images/ca168999/note_3.0-zh-cn.png) 
...
![](../../../images/4c5d8146/note_3.0-zh-cn.png) 
...
![](../../../images/7dee6435/note_3.0-zh-cn.png) 
...
![](../../../images/3ff1b0e4/note_3.0-zh-cn.png) 
...
![](../../../images/83146983/note_3.0-zh-cn.png) 
...
![](../../../images/8c519975/note_3.0-zh-cn.png) 
...
![](../../../images/e76dcb07/note_3.0-zh-cn.png) 
...
![](../../../images/0b1bf7c9/note_3.0-zh-cn.png) 

从API version 8开始支持，从API version 9开始废弃，建议使用[LRUCache.[Symbol.iterator]9+](#symboliterator9)替代。
...
![](../../../images/fd8478a1/note_3.0-zh-cn.png) 
...
![](../../../images/109944a0/note_3.0-zh-cn.png) 
...
![](../../../images/6af7a2e0/note_3.0-zh-cn.png) 
...
![](../../../images/08df6bf1/note_3.0-zh-cn.png) 
...
![](../../../images/5613367c/note_3.0-zh-cn.png) 
...
![](../../../images/ffa0ca58/note_3.0-zh-cn.png) 
...
![](../../../images/b6f94b0d/note_3.0-zh-cn.png) 
...
![](../../../images/f4ce6f45/note_3.0-zh-cn.png) 
...
![](../../../images/b775d247/note_3.0-zh-cn.png) 
...
![](../../../images/7f53b31b/note_3.0-zh-cn.png) 
...
![](../../../images/4b2aabfa/note_3.0-zh-cn.png) 
...
![](../../../images/9c4c9d5f/note_3.0-zh-cn.png) 
...
![](../../../images/54e7f5b8/note_3.0-zh-cn.png) 
...
![](../../../images/51a26363/note_3.0-zh-cn.png) 
...
![](../../../images/2d866a34/note_3.0-zh-cn.png) 
...
![](../../../images/bce7f217/note_3.0-zh-cn.png) 
...
![](../../../images/ebb7e9ee/note_3.0-zh-cn.png) 
...
![](../../../images/39f1ce8e/note_3.0-zh-cn.png) 
...
![](../../../images/ee138bcf/note_3.0-zh-cn.png) 
...
![](../../../images/9474fe26/note_3.0-zh-cn.png) 
...
![](../../../images/5532e5e6/note_3.0-zh-cn.png) 
