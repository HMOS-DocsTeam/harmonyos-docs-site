...
LinkedList和[List](/ref/arkts-api/arkts-arkts/js-apis-list/js-apis-list)相比，LinkedList是双向链表，可以快速地在头尾进行增删，而List是单向链表，无法双向操作。

LinkedList和[ArrayList](/ref/arkts-api/arkts-arkts/js-apis-arraylist/js-apis-arraylist)相比，LinkedList插入数据效率高于ArrayList，而ArrayList查询效率高于LinkedList。

![](../../../images/849fa150/caution_3.0-zh-cn.png) 
...
![](../../../images/de908329/note_3.0-zh-cn.png) 
