...
TreeSet基于[TreeMap](/ref/arkts-api/arkts-arkts/js-apis-treemap/js-apis-treemap)实现，在TreeSet中，只对value对象进行处理。TreeSet可用于存储一系列值的集合，元素中value唯一且有序。

TreeSet和[HashSet](/ref/arkts-api/arkts-arkts/js-apis-hashset/js-apis-hashset)中的元素都不允许重复。HashSet中的数据无序存放，而TreeSet是有序存放。HashSet允许插入null值，但TreeSet不建议插入null值，可能会影响排序结果。
...
![](../../../images/fa80f6cc/note_3.0-zh-cn.png) 
