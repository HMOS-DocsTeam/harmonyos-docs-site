...
Deque和[Queue](/ref/arkts-api/arkts-arkts/js-apis-queue/js-apis-queue)相比，Deque允许在两端执行插入和删除操作，Queue只能在头部删除元素，尾部插入元素。

与[ArrayList](/ref/arkts-api/arkts-arkts/js-apis-arraylist/js-apis-arraylist)相比，它们都支持在两端插入和删除元素，但Deque不支持中间插入。Deque在头部插入删除元素的效率高于ArrayList，而ArrayList随机访问元素的效率高于Deque。
...
![](../../../images/89100bfe/note_3.0-zh-cn.png) 
