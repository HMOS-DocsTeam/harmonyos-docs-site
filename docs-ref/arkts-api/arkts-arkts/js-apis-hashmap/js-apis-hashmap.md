...
sidebar_position: 15
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hashmap
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-hashmap
---
...
HashMap和[TreeMap](/ref/arkts-api/arkts-arkts/js-apis-treemap/js-apis-treemap)相比，HashMap依据键的hashCode存取数据，访问速度较快。而TreeMap是有序存储和访问，效率较低。

[HashSet](/ref/arkts-api/arkts-arkts/js-apis-hashset/js-apis-hashset)基于HashMap实现。HashMap的输入参数由key、value两个值组成。在HashSet中，只对value对象进行处理。
...
![](../../../images/c9b46d67/note_3.0-zh-cn.png) 
