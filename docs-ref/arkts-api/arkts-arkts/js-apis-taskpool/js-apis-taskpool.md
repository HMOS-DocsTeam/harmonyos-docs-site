...
任务池API返回错误码。如需了解各错误码的详细信息，请参阅文档[语言基础类库错误码](/ref/arkts-api/arkts-arkts-errcode/errorcode-utils/errorcode-utils)。

请查阅[TaskPool注意事项](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#taskpool注意事项)，了解使用TaskPool时的相关注意点。
...
![](../../../images/98648802/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | Function | 是 | 执行的逻辑需要传入一个函数，该函数必须使用[@Concurrent装饰器](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#concurrent装饰器)装饰。支持的函数返回值类型请参考[序列化支持类型](#序列化支持类型)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | (...args: A) => R | Promise&lt;R&gt; | 是 | 执行的逻辑需要传入函数，必须使用[@Concurrent装饰器](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#concurrent装饰器)装饰，支持的函数返回值类型请参考[序列化支持类型](#序列化支持类型)。 |
...
以下错误码的详细介绍，请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[语言基础类库错误码](/ref/arkts-api/arkts-arkts-errcode/errorcode-utils/errorcode-utils)。
...
| 类型 | 说明 |
| --- | --- |
| boolean | 如果被检查函数标注了[@Concurrent装饰器](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#concurrent装饰器)，则返回true，否则返回false。 |
...
![](../../../images/ba4fc096/note_3.0-zh-cn.png) 
...
表示所创建任务（Task）执行时的优先级。工作线程优先级跟随任务优先级更新，对应关系参考[QoS等级定义](/coding/thread-scheduling/qos-guidelines#qos等级定义)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | Function | 是 | 执行的逻辑需要传入函数，必须使用[@Concurrent装饰器](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#concurrent装饰器)装饰，支持的函数返回值类型请参考[序列化支持类型](#序列化支持类型)。 |
...
![](../../../images/db7af3aa/note_3.0-zh-cn.png) 
...
![](../../../images/5383e47b/note_3.0-zh-cn.png) 
...
![](../../../images/b272e8f1/note_3.0-zh-cn.png) 

需搭配[@Sendable装饰器](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable装饰器)使用，否则会抛异常。建议开发者使用该装饰器以避免异常。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cloneList | Object[] | ArrayBuffer[] | 是 | - 传入数组的类型必须为[Sendable支持的数据类型](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable支持的数据类型)或ArrayBuffer。  - 所有传入cloneList的对象持有的[Sendable class](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable-class)实例或ArrayBuffer类型对象，在线程间传输的行为都会变成拷贝传递，即修改传输后的对象不会对原有对象产生任何影响。 |
...
![](../../../images/67c37c7c/note_3.0-zh-cn.png) 
...
![](../../../images/8a373b74/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | Function | 是 | 需要传入使用[@Concurrent装饰器](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction#concurrent装饰器)装饰的函数。支持的返回值类型请参考[序列化支持类型](#序列化支持类型)。 |
...
![](../../../images/020268ea/note_3.0-zh-cn.png) 
...
![](../../../images/da886e2a/note_3.0-zh-cn.png) 
...
![](../../../images/2626bf5a/note_3.0-zh-cn.png) 
...
![](../../../images/5004ea6e/note_3.0-zh-cn.png) 
...
![](../../../images/601b5975/note_3.0-zh-cn.png) 
...
序列化支持类型参考[线程间通信对象概述](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/serializable-overview)里的介绍。
