...
![](../../../../images/9da312db/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint32Array> | 是 | 用于测试的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint32Array> | 是 | 用于元素过滤的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint32Array> | 是 | 用于元素查找的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayforeachcallback)<number, Uint32Array> | 是 | 用于对每个元素执行的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraymapcallback)<number, Uint32Array> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayreducecallback)<number, number, Uint32Array> | 是 | 归约函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayreducecallback)<U, number, Uint32Array> | 是 | 归约函数。 |
...
![](../../../../images/8eb0615a/note_3.0-zh-cn.png) 
