...
一种线性数据结构，底层基于[ArkTS ArrayBuffer](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-arraybuffer/arkts-apis-arkts-collections-arraybuffer)实现。

![](../../../../images/87861593/note_3.0-zh-cn.png) 
...
以下错误码详细介绍请参考[通用错误码](/ref/errorcode-universal/errorcode-universal)和[语言基础类库错误码](/ref/arkts-api/arkts-arkts-errcode/errorcode-utils/errorcode-utils)。
...
| mapFn | [TypedArrayFromMapFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayfrommapfn)<T, number> | 是 | 映射函数。 |
...
| mapFn | [TypedArrayFromMapFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayfrommapfn)<number, number> | 否 | 映射函数。如果省略，则不对元素进行加工处理。 |
...
以下错误码详细介绍请参考[语言基础类库错误码](/ref/arkts-api/arkts-arkts-errcode/errorcode-utils/errorcode-utils)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint8ClampedArray> | 是 | 用于测试的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint8ClampedArray> | 是 | 用于元素过滤的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Uint8ClampedArray> | 是 | 用于元素查找的断言函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayforeachcallback)<number, Uint8ClampedArray> | 是 | 用于对每个元素执行的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraymapcallback)<number, Uint8ClampedArray> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayreducecallback)<number, number, Uint8ClampedArray> | 是 | 归约函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarrayreducecallback)<U, number, Uint8ClampedArray> | 是 | 归约函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| compareFn | [TypedArrayCompareFn](/ref/arkts-api/arkts-arkts/js-apis-arkts-collections/arkts-apis-arkts-collections-types/arkts-apis-arkts-collections-types#typedarraycomparefn)<number> | 否 | 用于确定元素顺序的函数。默认使用升序排序。 |
...
![](../../../../images/59fc7ef1/note_3.0-zh-cn.png) 
