...
title: "Class (Map)"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-map
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-arkts-collections-map
---
...
![](../../../../images/412e2177/note_3.0-zh-cn.png) 
...
K和V类型都需为[Sendable支持的数据类型](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable支持的数据类型)。
...
![](../../../../images/2a0612a9/note_3.0-zh-cn.png) 
