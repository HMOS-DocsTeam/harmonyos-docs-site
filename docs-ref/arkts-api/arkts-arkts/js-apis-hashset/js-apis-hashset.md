...
sidebar_position: 16
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hashset
kit: 应用框架
...
HashSet基于[HashMap](/ref/arkts-api/arkts-arkts/js-apis-hashmap/js-apis-hashmap)实现。在HashSet中，仅处理value对象。

HashSet和[TreeSet](/ref/arkts-api/arkts-arkts/js-apis-treeset/js-apis-treeset)相比，HashSet中的数据按Hash值排序，因此元素的插入顺序与遍历时的顺序可能不一致，而TreeSet则是按照元素的自然排序或者自定义比较器进行有序存储。它们集合中的元素都不允许重复，HashSet允许插入null值，TreeSet不建议插入null值，会影响排序结果。
...
![](../../../images/a6e3e712/note_3.0-zh-cn.png) 
