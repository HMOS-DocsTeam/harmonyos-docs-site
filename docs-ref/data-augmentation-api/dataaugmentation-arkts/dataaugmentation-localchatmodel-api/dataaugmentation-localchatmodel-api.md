...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataaugmentation-localchatmodel-api
kit: 应用框架
...
![](../../../images/d630d06c/note_3.0-zh-cn.png) 
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1021900001](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-error-code/dataaugmentation-error-code#section1021900001-调用端侧问答模型超时) | A timeout occurs when the local chat model is called. |
| [1021900002](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-error-code/dataaugmentation-error-code#section1021900002-端侧问答模型加载失败) | A loading failure occurs when the local chat model is called. |
| [1021900003](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-error-code/dataaugmentation-error-code#section1021900003-端侧问答模型请求失败) | A request failure occurs when the local chat model is called. |
| [1021900004](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-error-code/dataaugmentation-error-code#section1021900004-端侧问答模型繁忙) | The local chat model is busy. |
| [1021900005](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-error-code/dataaugmentation-error-code#section1021900005-某些参数不满足指定的约束条件) | Some parameters do not meet the specified constraints. |
