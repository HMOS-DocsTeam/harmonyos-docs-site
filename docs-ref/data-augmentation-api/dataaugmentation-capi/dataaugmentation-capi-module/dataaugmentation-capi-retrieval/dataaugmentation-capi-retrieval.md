...
| 名称 | 描述 |
| --- | --- |
| [aip\_retrieval.h](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-header-struct/dataaugmentation-aip-retrieval/dataaugmentation-aip-retrieval) | 提供知识检索相关的接口。 |
| [aip\_retrieval\_condition.h](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-header-struct/dataaugmentation-aip-retrieval-condition/dataaugmentation-aip-retrieval-condition) | 提供与检索条件相关的接口。 |
| [aip\_retrieval\_condition\_vector.h](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-header-struct/dataaugmentation-aip-retrieval-condition-vector/dataaugmentation-aip-retrieval-condition-vector) | 提供与向量条件相关的接口。 |
| [aip\_retrieval\_query.h](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-header-struct/dataaugmentation-aip-retrieval-query/dataaugmentation-aip-retrieval-query) | 提供与检索查询相关的接口。 |
| [aip\_retrieval\_record.h](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-header-struct/dataaugmentation-aip-retrieval-record/dataaugmentation-aip-retrieval-record) | 提供与检索结果相关的接口。 |
...
| int [OH\_Retrieval\_SetDbConfig](#oh_retrieval_setdbconfig) ([OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig) \*dbConfig, [OH\_Rdb\_ConfigV2](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-rdb-configv2/capi-rdb-oh-rdb-configv2)\*rdbConfig) | 设置[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)中的数据库配置。 |
...
[OH\_Retrieval\_Config](#oh_retrieval_config)、[Retrieval\_Channel\_Type](#retrieval_channel_type)、[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Condition](#oh_retrieval_condition)、[OH\_Retrieval\_SubCondition](#oh_retrieval_subcondition)、[OH\_Retrieval\_VectorCondition](#oh_retrieval_vectorcondition)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Config](#oh_retrieval_config)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Retriever](#oh_retrieval_retriever)、[OH\_Retrieval\_Config](#oh_retrieval_config)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Condition](#oh_retrieval_condition)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateCondition](#oh_retrieval_createcondition)
...
[OH\_Retrieval\_Config](#oh_retrieval_config)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateConfig](#oh_retrieval_createconfig)
...
[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateDbConfig](#oh_retrieval_createdbconfig)
...
[OH\_Retrieval\_Query](#oh_retrieval_query)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateQuery](#oh_retrieval_createquery)
...
[OH\_Retrieval\_Record](#oh_retrieval_record)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_Retrieve](#oh_retrieval_retrieve)
...
[OH\_Retrieval\_Retriever](#oh_retrieval_retriever)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateRetriever](#oh_retrieval_createretriever)
...
[OH\_Retrieval\_SubCondition](#oh_retrieval_subcondition)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_VectorCondition](#oh_retrieval_vectorcondition)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)、[OH\_Retrieval\_CreateVectorCondition](#oh_retrieval_createvectorcondition)
...
[OH\_Retrieval\_RecordItem](#oh_retrieval_recorditem)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Record](#oh_retrieval_record)、[OH\_Retrieval\_RecordItem](#oh_retrieval_recorditem)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Record](#oh_retrieval_record)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Retriever](#oh_retrieval_retriever)、[OH\_Retrieval\_Query](#oh_retrieval_query)、[OH\_Retrieval\_Condition](#oh_retrieval_condition)、[OH\_Retrieval\_Callback](#oh_retrieval_callback)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
| --- | --- |
| dbConfig | 表示指向[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)实例的指针。 |
| rdbConfig | 表示指向数据库配置实例的指针，可能是[OH\_Rdb\_ConfigV2](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-rdb-configv2/capi-rdb-oh-rdb-configv2)实例。 |
...
[OH\_Retrieval\_DbConfig](#oh_retrieval_dbconfig)、[OH\_Rdb\_ConfigV2](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-rdb-configv2/capi-rdb-oh-rdb-configv2)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_Query](#oh_retrieval_query)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
...
[OH\_Retrieval\_VectorCondition](#oh_retrieval_vectorcondition)、[OH\_Aip\_ErrCode](/ref/data-augmentation-api/dataaugmentation-capi/dataaugmentation-capi-module/dataaugmentation-capi-aip/dataaugmentation-capi-aip#oh_aip_errcode-1)
