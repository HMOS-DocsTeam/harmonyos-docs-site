...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/vcW05XtlT0uJzddmWVNp3g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260423T145334Z&HW-CC-Expire=86400&HW-CC-Sign=D0CBBC7D98F7BC56DE3942387E26A197CB75F29D999EB8CBF43CE13836221C93) 
...
1. 请开发者重新调用[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)。
2. 多次重试均失败则需请开发者优化[streamChat](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamchat)中使用的大语言模型及相应实现。
...
开发者在[streamChat](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamchat)中请求大语言模型时失败。
...
开发者在[streamChat](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamchat)中请求大语言模型时大语言模型繁忙。
...
开发者在[streamChat](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamchat)中的某一次大语言模型请求时，累计转发给rag的响应数据长度超出范围8192字节。
...
[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)未关闭，重复创建[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)。

****处理步骤****

如果[Config](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#config)没有变化，可以使用之前的[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)继续对话，否则，请先使用[close](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#close)接口关闭旧的[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)，再使用新的[Config](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#config)调用[createRagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#createragsession)接口创建新的[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)进行对话。
...
前一次[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)回答期间重新调用了[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)开启新一轮问答。

****处理步骤****

如果开发者希望保留前一次回答结果，请等待前一次[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)结束，再重新调用[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)进行新一轮问答。
...
调用[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)的接口时，[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)已关闭。

****处理步骤****

调用[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)的接口前请确认存在打开的[RagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#ragsession)。
...
用户已取消[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)。

****可能原因****

调用[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)接口过程中，用户主动取消了本次[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)。

****处理步骤****

请用户按需取消[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)。
...
请开发者尝试重试[streamRun](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#streamrun)。
...
开发者调用[createRagSession](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#createragsession)时传入的[Config](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#config)不满足约束条件。

****处理步骤****

请开发者查阅API参考中对各类型的描述，结合实际业务需要配置正确[Config](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#config)。
...
1. 使用rag能力前请确认已配置[知识加工](/data-augmentation-kit-guide/data-augmentation-knowledge-processing)schema。
...
1. 确保主键数量不超过算法允许的限制。
2. 修正[Config](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-rag-api/dataaugmentation-rag-api#config)后重试。
...
1. 参照[知识源配置](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgesourceconfig)类型，正确配置rdbSource字段。
...
1. 参考开发步骤中的[知识schema配置示例](/data-augmentation-kit-guide/data-augmentation-knowledge-processing#开发步骤)，将knowledge\_schema.json放到指定的entry/src/main/resources/rawfile/arkdata/knowledge目录下。
...
1. 参#fig照[知识schema规格及约束限制](/data-augmentation-kit-guide/data-augmentation-knowledge-processing#约束限制)修改其中内容。
