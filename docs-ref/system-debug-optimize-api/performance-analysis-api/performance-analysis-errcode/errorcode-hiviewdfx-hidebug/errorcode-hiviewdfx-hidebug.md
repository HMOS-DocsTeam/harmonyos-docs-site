...
title: "HiDebug错误码"
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-hiviewdfx-hidebug
kit: 系统
last_updated: "2026-04-22"
slug: errorcode-hiviewdfx-hidebug
---

# HiDebug错误码

![](../../../../images/4f9ee36b/note_3.0-zh-cn.png) 
...
![](../../../../images/c21cf627/note_3.0-zh-cn.png) 
...
建议重启设备后重试。若重试后依然失败，请[导出日志信息](/ide-log-and-fault-analysis/ide-setup-hilog#section2114542680)请通过“华为开发者联盟官网”->“支持”，[在线提单](https://developer.huawei.com/consumer/cn/support/)方式获取支持。
...
建议开发者重试。若重试后依然失败，请通过[日志分析](/ide-log-and-fault-analysis/ide-setup-hilog)过滤error级别日志辅助问题定位。若依然无法解决，请通过“华为开发者联盟官网”->“支持”，[在线提单](https://developer.huawei.com/consumer/cn/support/)方式获取支持。
