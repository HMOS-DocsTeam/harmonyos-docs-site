...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-perftest
kit: 系统
...
![](../../../../images/b0623cb7/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 20开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 本模块接口在[单元测试框架](/ut/arkxtest-guidelines/unittest-guidelines)中使用。
- 本模块接口不支持并发调用。
...
![](../../../../images/1c8f5728/note_3.0-zh-cn.png) 
...
![](../../../../images/6d64473c/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[perftest错误码](/ref/system-debug-optimize-api/test-api/test-arkts-errcode/errorcode-perftest/errorcode-perftest)。
