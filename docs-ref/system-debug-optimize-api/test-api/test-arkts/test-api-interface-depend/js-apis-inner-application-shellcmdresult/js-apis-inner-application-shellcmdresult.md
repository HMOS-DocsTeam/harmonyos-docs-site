...
![](../../../../../images/8b004a60/note_3.0-zh-cn.png) 
...
通过abilityDelegator中的[executeShellCommand](/ref/system-debug-optimize-api/test-api/test-arkts/test-api-interface-depend/js-apis-inner-application-abilitydelegator/js-apis-inner-application-abilitydelegator#executeshellcommand)方法来获取。
