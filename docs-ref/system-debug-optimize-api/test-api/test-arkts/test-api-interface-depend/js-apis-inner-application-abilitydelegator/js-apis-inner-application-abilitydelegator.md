...
AbilityDelegator模块可以通过[AbilityMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitymonitor/js-apis-inner-application-abilitymonitor)实例来监听和管理[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)生命周期的变化。例如获取UIAbility当前状态（如是否已创建/是否在前台等）、查询当前获焦的UIAbility、等待UIAbility进入某个生命周期节点（如等待UIAbility进入onForeground）、启动指定UIAbility、设置超时机制等功能。

AbilityDelegator可以通过[getAbilityDelegator](/ref/system-debug-optimize-api/test-api/test-arkts/js-apis-app-ability-abilitydelegatorregistry/js-apis-app-ability-abilitydelegatorregistry#abilitydelegatorregistrygetabilitydelegator)方法获取。

![](../../../../../images/f2c0f9f4/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitor | [AbilityMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitymonitor/js-apis-inner-application-abilitymonitor) | 是 | [AbilityMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitymonitor/js-apis-inner-application-abilitymonitor)实例。 |
...
| --- | --- | --- | --- |
| monitor | [AbilityMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitymonitor/js-apis-inner-application-abilitymonitor) | 是 | [AbilityMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitymonitor/js-apis-inner-application-abilitymonitor)实例。 |
| callback | AsyncCallback&lt;[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)&gt; | 是 | 回调函数。当等待与AbilityMonitor实例匹配的Ability到达OnCreate生命周期成功，err为undefined，data为获取到的Ability实例，否则为错误对象。 |
...
| callback | AsyncCallback&lt;[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)&gt; | 是 | 表示指定的回调方法。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)&gt; | Promise对象，返回Ability实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 应用[Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ability | [UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability) | 是 | 指定Ability对象。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| number | 指定ability的生命周期状态。状态枚举值使用[AbilityLifecycleState](/ref/system-debug-optimize-api/test-api/test-arkts/js-apis-app-ability-abilitydelegatorregistry/js-apis-app-ability-abilitydelegatorregistry#abilitylifecyclestate)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)&gt; | 是 | 回调函数。当获取当前应用顶部Ability成功，err为undefined，data为获取到的Ability实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[UIAbility](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability)&gt; | Promise对象，返回前应用顶部Ability。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want) | 是 | 启动Ability参数。 |
...
| callback | AsyncCallback&lt;[ShellCmdResult](/ref/system-debug-optimize-api/test-api/test-arkts/test-api-interface-depend/js-apis-inner-application-shellcmdresult/js-apis-inner-application-shellcmdresult#shellcmdresult-1)&gt; | 是 | 回调函数。当执行指定的shell命令成功，err为undefined，data为获取到的执行结果；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ShellCmdResult](/ref/system-debug-optimize-api/test-api/test-arkts/test-api-interface-depend/js-apis-inner-application-shellcmdresult/js-apis-inner-application-shellcmdresult#shellcmdresult-1)&gt; | Promise对象，返回Shell命令执行结果[ShellCmdResult](/ref/system-debug-optimize-api/test-api/test-arkts/test-api-interface-depend/js-apis-inner-application-shellcmdresult/js-apis-inner-application-shellcmdresult#shellcmdresult-1)对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitor | [AbilityStageMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitystagemonitor/js-apis-inner-application-abilitystagemonitor) | 是 | [AbilityStageMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitystagemonitor/js-apis-inner-application-abilitystagemonitor) 实例。 |
...
| --- | --- | --- | --- |
| monitor | [AbilityStageMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitystagemonitor/js-apis-inner-application-abilitystagemonitor) | 是 | [AbilityStageMonitor](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-abilitystagemonitor/js-apis-inner-application-abilitystagemonitor) 实例。 |
| callback | AsyncCallback&lt;AbilityStage&gt; | 是 | 回调函数。当等待并返回与给定AbilityStageMonitor中设置的条件匹配的AbilityStage对象的操作成功，err为undefined，data为获取到的[AbilityStage](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-abilitystage/js-apis-app-ability-abilitystage)对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;AbilityStage&gt; | Promise对象，返回[AbilityStage](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-abilitystage/js-apis-app-ability-abilitystage)对象。 |
