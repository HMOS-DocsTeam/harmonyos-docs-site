...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api
kit: AI
last_updated: "2026-04-22"
slug: core-vision-vision-base-api
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 待识别的图片。 |
...
| scene | [SceneMode](#scenemode) | 否 | 是 | 请求的场景模式。  该参数为预留字段，暂未实现。 |
...
请参见[ObjectDetection.destroy](/ref/core-vision-api/core-vision-arkts/core-vision-object-detection-api/core-vision-object-detection-api#destroy)
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadStartData](#downloadstartdata)> | 是 | Callback回调返回是哪个资源开始下载。 |

****错误码：****

以下错误码的详细介绍请参见[Core Vision Kit错误码](/ref/core-vision-api/core-vision-error-code/core-vision-error-code)。
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadCompleteData](#downloadcompletedata)> | 是 | Callback回调返回完成下载的资源标识符及版本。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadCancelData](#downloadcanceldata)> | 是 | Callback回调返回是哪个资源取消下载。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadStatusData](#downloadstatusdata)> | 是 | Callback回调返回下载状态信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadProgressData](#downloadprogressdata)> | 是 | Callback回调返回下载进度信息。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadStartData](#downloadstartdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadCompleteData](#downloadcompletedata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadCancelData](#downloadcanceldata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadStatusData](#downloadstatusdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#callback)<[DownloadProgressData](#downloadprogressdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
