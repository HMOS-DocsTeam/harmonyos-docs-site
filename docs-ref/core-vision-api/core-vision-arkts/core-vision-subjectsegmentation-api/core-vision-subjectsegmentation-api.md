...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 待识别的图片。  具体规格请参考[约束与限制](/core-vision-kit-guide/core-vision-introduction#约束与限制)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| foregroundImage | [image.PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap) | 否 | 否 | 显著性主体前景图。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| subjectCount | number | 否 | 否 | 表示主体个数，取决于[SegmentationConfig](#segmentationconfig)中maxCount参数的限制。 |
| fullSubject | [SubjectResult](#subjectresult) | 否 | 否 | 默认输出的整张图的所有显著性主体信息。 |
| subjectDetails | Array&lt;[SubjectResult](#subjectresult)&gt; | 否 | 是 | 每个主体的显著性主体信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[SegmentationResult](#segmentationresult)&gt; | 返回显著性主体的结果。 |
