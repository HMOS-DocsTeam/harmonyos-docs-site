...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| boundingBox | visionBase.[BoundingBox](/ref/core-vision-api/core-vision-arkts/core-vision-vision-base-api/core-vision-vision-base-api#boundingbox) | 否 | 否 | visionObject的边界框。 |
...
多目标检测的结果类。继承自visionBase基类的[Response](/ref/core-vision-api/core-vision-arkts/core-vision-vision-base-api/core-vision-vision-base-api#response)。
...
定义多目标识别的接口和基本结构。继承自[visionBase.Analyzer](/ref/core-vision-api/core-vision-arkts/core-vision-vision-base-api/core-vision-vision-base-api#analyzer)类。它有以下功能函数：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | visionBase.[Request](/ref/core-vision-api/core-vision-arkts/core-vision-vision-base-api/core-vision-vision-base-api#request) | 是 | 图片实例。多目标识别接口仅支持传入一张图片，不支持传入多张图片。  具体规格请参考[约束与限制](/core-vision-kit-guide/core-vision-introduction#约束与限制)。 |

****返回值：****

| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ObjectDetectionResponse](#objectdetectionresponse)&gt; | 返回多目标识别的结果。 |
