...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-promotionservice
kit: 应用服务
last_updated: "2026-04-22"
slug: payment-promotionservice
---
...
| sign | string | 否 | 否 | 签名，使用除了sign字段以外的其他字段计算签名值。可参考[签名规则](/ref/payment-api/payment-rest/payment-rest-overview/payment-rest-overview#签名规则)。 |
...
| ****名称**** | ****类型**** | 只读 | 可选 | ****说明**** |
| --- | --- | --- | --- | --- |
| couponCategory | [CouponCategory](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#couponcategory) | 否 | 否 | 优惠券品类枚举类型。 |
| couponCode | string | 否 | 否 | 券码。 |
| batchNo | string | 否 | 否 | 批次号。 |
| couponType | [CouponType](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#coupontype) | 否 | 否 | 券类型。 |
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| context | [UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext) | 是 | UI上下文对象。 |
...
| 类型 | ****说明**** |
| --- | --- |
| Promise&lt;[UserAction](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#useraction)&gt; | Promise对象。返回[UserAction](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#useraction)的Promise对象。 |
...
| orderContext | [OrderContext](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#ordercontext) | 是 | 用户订单上下文。 |

****返回值****：

| 类型 | ****说明**** |
| --- | --- |
| Promise&lt;[CouponDetail](/ref/payment-api/payment-arkts/payment-promotionservice/payment-promotionservice#coupondetail)[]&gt; | Promise对象。返回CouponDetail数组的Promise对象。 |
