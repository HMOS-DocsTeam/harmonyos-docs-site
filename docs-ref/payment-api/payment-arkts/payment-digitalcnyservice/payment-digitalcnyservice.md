...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-digitalcnyservice
kit: 应用服务
...
| acqAgtInstnId | string | 否 | 是 | 受理服务机构的金融机构编码（[通过受理服务机构入网](/payment-kit-guide/payment-preparations/payment-digital-cny-pay-preparations)的商户，此项必填）。若未填写，默认为空。 |
...
![](../../../images/8be840cd/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****说明**** |
| --- | --- | --- | --- |
| context | common.[Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | 上下文，不传会报401参数错误。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[EcnyPayResult](#ecnypayresult)&gt; | Promise对象。返回支付结果信息。 |
