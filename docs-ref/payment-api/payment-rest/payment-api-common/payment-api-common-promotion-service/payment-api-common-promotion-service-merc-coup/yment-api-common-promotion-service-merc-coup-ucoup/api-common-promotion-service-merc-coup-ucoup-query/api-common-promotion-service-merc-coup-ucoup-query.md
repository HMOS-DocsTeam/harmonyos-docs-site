...
title: "查询用户优惠券列表"
sidebar_position: 6
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/api-common-promotion-service-merc-coup-ucoup-query
kit: 应用服务
last_updated: "2026-04-22"
slug: api-common-promotion-service-merc-coup-ucoup-query
---
...
| coupons | 否 | List&lt;[CouponInfo](/ref/payment-api/payment-model/payment-model#couponinfo)&gt; | 给用户呈现的优惠券信息，返回信息不包含展现信息中的详情信息(富文本)。 |
