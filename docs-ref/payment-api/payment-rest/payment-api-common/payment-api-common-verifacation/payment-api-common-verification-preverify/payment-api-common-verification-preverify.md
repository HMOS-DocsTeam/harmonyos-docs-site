...
| openId | 是 | String | 用户对外展示的ID（获取方式请参见[获取用户信息](/ref/account-api/account-api-rest/account-api-get-user-info/account-api-get-user-info-overview/account-api-get-user-info-overview)）。长度范围为1-512。  ****说明：**** 入参中的实名信息，必须和 openId用户下的实名信息保持一致。 |
