...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| realNameAuthId | 是 | String | 实名信息授权ID。[应用端接口](/ref/payment-api/payment-arkts/payment-realnameservice/payment-realnameservice#realnameservicestartrealnameauth)用户授权实名信息时返回的授权ID，长度范围为1-10。 |
