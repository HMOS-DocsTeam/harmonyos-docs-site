...
title: "预下单"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-combined-app-prepay
kit: 应用服务
...
开发者接入合单支付，首先需要调用该接口获取到预支付ID（prepayId），用prepayId构建[orderStr](/ref/payment-api/payment-model/payment-model#orderstr)参数返回给客户端调用支付接口拉起华为支付收银台。
...
| subOrders | 是 | List&lt;[SubMercOrder](/ref/payment-api/payment-model/payment-model#submercorder)&gt; | 合单支付子订单信息。 |
...
****resultCode****非400000的错误码请看[公共错误码说明](/ref/payment-api/payment-rest/payment-error-code-rest/payment-error-code-rest#公共错误码说明)。
