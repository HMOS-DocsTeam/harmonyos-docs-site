...
![](../../../../../images/de37998b/note_3.0-zh-cn.png) 
...
| billDownloadParam | 否 | [BillDownloadParam](/ref/payment-api/payment-model/payment-model#billdownloadparam) | 账单下载请求信息。有生成账单数据时返回。 |
...
| 400000 | BILL\_SWITCH\_NOT\_TURN\_ON | 账单开关没有打开 | 请检查并[打开账单开关](/ref/payment-api/payment-rest/payment-agent-merc/payment-partner-bill/payment-partner-agent-query-trade-bill/payment-partner-agent-query-trade-bill#功能介绍)。 |
