...
![](../../../../../../images/c2ec906a/note_3.0-zh-cn.png) 
...
| promotionDetail | 否 | List&lt;[PromotionItem](/ref/payment-api/payment-model/payment-model#promotionitem)&gt; | 营销信息。  ****说明：**** 当用户支付时参与过营销活动，此字段才会返回。 |
