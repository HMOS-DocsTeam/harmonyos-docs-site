...
![](../../../images/793bb2ab/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | ****装饰器类型**** | 说明 |
| --- | --- | --- | --- | --- |
| adParam | advertising.[AdRequestParams](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adrequestparams) | 是 | - | 广告请求参数。 |
| adOptions | advertising.[AdOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adoptions) | 是 | - | 广告配置参数。 |
| displayOptions | advertising.[AdDisplayOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#addisplayoptions) | 是 | - | 广告展示参数。 |
| interactionListener | advertising.[AdInteractionListener](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adinteractionlistener) | 是 | - | 广告状态变化回调。 |
...
![](../../../images/6776cdb4/zh-cn_image_0000002583478765.png)
