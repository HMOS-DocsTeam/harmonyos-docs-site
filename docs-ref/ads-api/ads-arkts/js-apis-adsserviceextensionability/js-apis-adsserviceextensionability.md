...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-adsserviceextensionability
kit: 应用服务
...
![](../../../images/2cf3a160/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| respData | Map&lt;string, Array&lt;advertising.[Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement)&gt;&gt; | 是 | 广告请求回调数据。 |
