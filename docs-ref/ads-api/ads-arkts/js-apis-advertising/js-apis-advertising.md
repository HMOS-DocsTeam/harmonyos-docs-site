...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising
kit: 应用服务
...
![](../../../images/34eecd30/note_3.0-zh-cn.png) 
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| ad | [Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement) | 是 | 广告对象。 |
| options | [AdDisplayOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#addisplayoptions) | 是 | 广告展示参数。 |
| context | common.[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 否 | UIAbility的上下文环境，不设置从api: [@ohos.app.ability.common](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-common/js-apis-app-ability-common)中获取。 |

****错误码：****

以下错误码的详细介绍请参见[广告服务框架错误码参考](/ref/ads-api/ads-arkts-errcode/errorcode-ads/errorcode-ads)。
...
![](../../../images/25cfb2c1/note_3.0-zh-cn.png) 
...
其中context的获取方式参见[各类context的获取方式](/ability-kit/stage-model-development/stage-model-application-components/application-context-stage#context的获取方式)。
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| adParams | [AdRequestParams](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adrequestparams)[] | 是 | 广告请求参数。  ****说明：**** 该接口体的adId参数可以为空。 |
| adOptions | [AdOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adoptions) | 是 | 广告配置参数。 |
...
| listener | [MultiSlotsAdLoadListener](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#multislotsadloadlistener) | 是 | 请求广告回调监听。 |
| context | common.[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | UIAbility的上下文环境。 |
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | web\_webview.[WebviewController](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller) | 是 | Web组件控制器。 |
| context | common.[UIAbilityContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext) | 是 | UIAbility的上下文环境。 |
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| context | common.[Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context) | 是 | ability或application的上下文环境。 |
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| adParam | [AdRequestParams](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adrequestparams) | 是 | 广告请求参数。 |
| adOptions | [AdOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adoptions) | 是 | 广告配置参数。 |
| listener | [AdLoadListener](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adloadlistener) | 是 | 请求广告回调监听。 |
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| adParams | [AdRequestParams](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adrequestparams)[] | 是 | 广告请求参数。 |
| adOptions | [AdOptions](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adoptions) | 是 | 广告配置参数。 |
| listener | [MultiSlotsAdLoadListener](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#multislotsadloadlistener) | 是 | 请求广告回调监听。 |
...
| 名称 | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| ads | Array&lt;[Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement)&gt; | 是 | 广告数据。 |
...
| ****参数名**** | ****类型**** | 必填 | 说明 |
| --- | --- | --- | --- |
| adsMap | Map&lt;string, Array&lt;[Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement)&gt;&gt; | 是 | 广告数据。 |
...
| ad | [Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement) | 是 | 发生状态变化的广告内容。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| adId | string | 是 | 广告位ID。  说明：[getAdRequestBody](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisinggetadrequestbody12)接口可以不传该参数。 |
