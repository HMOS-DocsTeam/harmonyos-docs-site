...
[HMS\_HiAISingleOpExecutor\_CreateConvolution](/ref/cann-api/hiai-foundation-c/cannkit-index/cannkit/cannkit#hms_hiaisingleopexecutor_createconvolution)输入参数。
...
| [HiAI\_SingleOpDescriptor](/ref/cann-api/hiai-foundation-c/cannkit-index/cannkit/cannkit#hiai_singleopdescriptor) \* [opDesc](#opdesc) | 指向卷积算子对应的[HiAI\_SingleOpDescriptor](/ref/cann-api/hiai-foundation-c/cannkit-index/cannkit/cannkit#hiai_singleopdescriptor)对象的指针。该值不能为空指针，否则接口调用失败。 |
