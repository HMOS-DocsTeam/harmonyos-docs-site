...
- CallerInfoQueryExtensionAbility支持在[HAP](/development-fundamentals/application-package-fundamentals/application-package-dev/hap-package)和[HAR](/development-fundamentals/application-package-fundamentals/application-package-dev/har-package)中使用。
...
![](../../../images/f65adf1e/note_3.0-zh-cn.png) 

由于调用onQueryCallerInfo方法时，系统先创建应用的AbilityStage实例，请勿在AbilityStage中添加过于复杂耗时的逻辑，避免调用超时。

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [CallerInfoQueryExtensionContext](/ref/call-api/call-arkts/callservicekit-callerinfoquery-extension-context/callservicekit-callerinfoquery-extension-context) | 否 | 否 | [CallerInfoQueryExtensionContext](/ref/call-api/call-arkts/callservicekit-callerinfoquery-extension-context/callservicekit-callerinfoquery-extension-context#callerinfoqueryextensioncontext)的上下文环境，继承自[ExtensionContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-extensioncontext/js-apis-inner-application-extensioncontext)。 |
