...
| 名称 | 描述 |
| --- | --- |
| [game\_controller\_type.h](/ref/game-controller-api/game-controller-c/game-controller-headerfile-and-struct/game-controller-headerfile/capi-game-controller-type/capi-game-controller-type) | 定义GameController模块的通用枚举类型。 |
| [game\_device.h](/ref/game-controller-api/game-controller-c/game-controller-headerfile-and-struct/game-controller-headerfile/capi-game-device/capi-game-device) | 定义游戏设备的接口。 |
| [game\_device\_event.h](/ref/game-controller-api/game-controller-c/game-controller-headerfile-and-struct/game-controller-headerfile/capi-game-device-event/capi-game-device-event) | 定义游戏设备事件的接口。 |
| [game\_pad.h](/ref/game-controller-api/game-controller-c/game-controller-headerfile-and-struct/game-controller-headerfile/capi-game-pad/capi-game-pad) | 定义游戏手柄的接口。 |
| [game\_pad\_event.h](/ref/game-controller-api/game-controller-c/game-controller-headerfile-and-struct/game-controller-headerfile/capi-game-pad-event/capi-game-pad-event) | 定义游戏手柄事件的接口。 |
...
| 名称 | 描述 |
| --- | --- |
| [GameController\_ErrorCode](#gamecontroller_errorcode) {  GAME\_CONTROLLER\_SUCCESS = 0,  GAME\_CONTROLLER\_PARAM\_ERROR = 401,  GAME\_CONTROLLER\_MULTIMODAL\_INPUT\_ERROR = 32200001,  GAME\_CONTROLLER\_NO\_MEMORY = 32200002  } | 游戏控制器错误码。 |
| [GameDevice\_StatusChangedType](#gamedevice_statuschangedtype) {  OFFLINE = 0,  ONLINE = 1  } | 设备的状态变化类型。 |
| [GameDevice\_DeviceType](#gamedevice_devicetype) {  UNKNOWN = 0,  GAME\_PAD = 1  } | 设备类型。 |
| [GamePad\_AxisSourceType](#gamepad_axissourcetype) {  DPAD = 0,  LEFT\_THUMBSTICK = 1,  RIGHT\_THUMBSTICK = 2,  LEFT\_TRIGGER = 3,  RIGHT\_TRIGGER = 4  } | 手柄轴事件来源类型。 |
| [GamePad\_Button\_ActionType](#gamepad_button_actiontype) {  DOWN = 0,  UP = 1  } | 手柄按键动作类型。 |
