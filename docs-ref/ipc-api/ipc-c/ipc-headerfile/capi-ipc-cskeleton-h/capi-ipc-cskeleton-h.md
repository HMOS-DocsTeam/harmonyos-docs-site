...
****相关模块：**** [OHIPCSkeleton](/ref/ipc-api/ipc-c/ipc-module/capi-ohipcskeleton/capi-ohipcskeleton)
...
| [OH\_IPC\_MemAllocator](/ref/ipc-api/ipc-c/ipc-headerfile/capi-ipc-cparcel-h/capi-ipc-cparcel-h#oh_ipc_memallocator) allocator | allocator 用户指定的用来分配identity的内存分配器，不能为空。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int | 成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](/ref/ipc-api/ipc-c/ipc-headerfile/capi-ipc-error-code-h/capi-ipc-error-code-h#oh_ipc_errorcode)；  参数错误返回[OH\_IPC\_ErrorCode#OH\_IPC\_CHECK\_PARAM\_ERROR](/ref/ipc-api/ipc-c/ipc-headerfile/capi-ipc-error-code-h/capi-ipc-error-code-h#oh_ipc_errorcode)；  内存分配失败返回[OH\_IPC\_ErrorCode#OH\_IPC\_MEM\_ALLOCATOR\_ERROR](/ref/ipc-api/ipc-c/ipc-headerfile/capi-ipc-error-code-h/capi-ipc-error-code-h#oh_ipc_errorcode)；  其它情况返回[OH\_IPC\_ErrorCode#OH\_IPC\_INNER\_ERROR](/ref/ipc-api/ipc-c/ipc-headerfile/capi-ipc-error-code-h/capi-ipc-error-code-h#oh_ipc_errorcode)。 |
