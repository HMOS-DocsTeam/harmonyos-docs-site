...
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-privacymanager
kit: 应用服务
...
![](../../../images/06ac58cb/note_3.0-zh-cn.png) 
...
| name | string | 是 | 是 | 用户协议的名称，当[AppPrivacyLinkType](#appprivacylinktype)为USER\_AGREEMENT\_LINK时非可选。  ****起始版本：**** 5.0.2(14) |
