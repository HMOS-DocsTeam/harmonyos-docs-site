...
title: "ArkTS API错误码"
sidebar_position: 10
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-error-code
kit: 应用服务
last_updated: "2026-04-22"
slug: store-error-code
---

# ArkTS API错误码

![](../../../images/0208a190/note_3.0-zh-cn.png) 
...
2. 调用[appInfoManager.selectDynamicIcon](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerselectdynamicicon)重新设置动态图标。
