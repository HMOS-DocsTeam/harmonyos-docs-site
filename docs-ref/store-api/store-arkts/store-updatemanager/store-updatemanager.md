...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-updatemanager
kit: 应用服务
...
![](../../../images/762a69e2/note_3.0-zh-cn.png) 
...
| checkUpdateResult | [CheckUpdateResult](#checkupdateresult) | 是 | 是 | 检查结果。  ****说明：**** 仅在RequestErrorCode为NEED\_UPGRADE或NO\_UPGRADE时不为空。 |
...
![](../../../images/81dc0acb/note_3.0-zh-cn.png) 
