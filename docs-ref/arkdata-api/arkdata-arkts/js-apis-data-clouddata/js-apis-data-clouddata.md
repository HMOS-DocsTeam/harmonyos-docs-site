...
![](../../../images/51a28543/note_3.0-zh-cn.png) 
...
| param | Array&lt;[commonType.ValueType](/ref/arkdata-api/arkdata-arkts/js-apis-data-commontype/js-apis-data-commontype#valuetype)&gt; | 否 | 策略参数。当前仅支持设置网络策略，默认支持WIFI和蜂窝网络策略。 |
