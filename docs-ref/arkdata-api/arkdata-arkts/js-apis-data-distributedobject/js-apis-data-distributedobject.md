...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-distributedobject
kit: 应用框架
...
![](../../../images/f39a3750/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 应用的上下文。  FA模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context)。  Stage模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext)。 |
...
| primaryKey | [commonType.ValuesBucket](/ref/arkdata-api/arkdata-arkts/js-apis-data-commontype/js-apis-data-commontype#valuesbucket) | 否 | 否 | 待绑定资产在所属的数据库中的主键。 |
...
以下错误码的详细介绍请参见[通用错误码](/ref/errorcode-universal/errorcode-universal)和[分布式数据对象错误码](/ref/arkdata-api/arkdata-arkts-errcode/errorcode-distributed-dataobject/errorcode-distributed-dataobject)。
...
![](../../../images/04e09456/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assetKey | string | 是 | 分布式对象中资产类型数据对应的属性名。  ****使用约束：****  （1）提供的assetKey对应的文件必须已存在且类型为资产[Asset](/ref/arkdata-api/arkdata-arkts/js-apis-data-commontype/js-apis-data-commontype#asset)，才可进行正确的设置资产。若assetKey对应文件不存在或文件存在但类型不是资产类型，可能会出现资产设置错误。  （2）在协同或接续场景下需要双端满足assetKey对应的文件存在且为资产类型，才可将设置的资产同步到对端设备。 |
...
以下错误码的详细介绍请参见[分布式数据对象错误码](/ref/arkdata-api/arkdata-arkts-errcode/errorcode-distributed-dataobject/errorcode-distributed-dataobject)。
...
![](../../../images/c1dfeebf/caution_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assetsKey | string | 是 | 分布式对象中资产数组类型数据对应的属性名。  ****使用约束：****  （1）提供的assetsKey对应的文件已存在且类型必须为资产[Asset](/ref/arkdata-api/arkdata-arkts/js-apis-data-commontype/js-apis-data-commontype#asset)，才可进行正确的设置资产。若assetsKey对应文件不存在或文件存在但类型不是资产类型，可能会出现资产设置错误。  （2）在协同或接续场景下需要双端满足assetsKey对应的文件存在且为资产类型，才可将设置的资产数组同步到对端设备。 |
...
![](../../../images/113e828a/note_3.0-zh-cn.png) 
...
![](../../../images/653d3811/note_3.0-zh-cn.png) 
...
![](../../../images/28379af4/note_3.0-zh-cn.png) 
...
![](../../../images/4a446f2b/note_3.0-zh-cn.png) 
...
![](../../../images/9e64c412/note_3.0-zh-cn.png) 
...
![](../../../images/c4fad1e3/note_3.0-zh-cn.png) 
