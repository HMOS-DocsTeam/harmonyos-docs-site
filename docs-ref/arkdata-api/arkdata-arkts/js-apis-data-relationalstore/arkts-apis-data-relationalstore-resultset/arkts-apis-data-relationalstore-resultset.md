...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-resultset
kit: 应用框架
last_updated: "2026-04-22"
slug: arkts-apis-data-relationalstore-resultset
---
...
下列API示例中，都需先使用[query](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#query)、[querySql](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#querysql)、[remoteQuery](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#remotequery-1)、[queryLockedRow](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#querylockedrow12)等query类方法中任一方法获取到ResultSet实例，再通过此实例调用对应方法。

![](../../../../images/f50d77ff/note_3.0-zh-cn.png) 
...
以下错误码的详细介绍请参见[关系型数据库错误码](/ref/arkdata-api/arkdata-arkts-errcode/errorcode-data-rdb/errorcode-data-rdb)。其中，14800011错误码处理可参考[数据库备份与恢复](/arkdata/data-reliability-security/data-backup-and-restore)。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ColumnType](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-e/arkts-apis-data-relationalstore-e#columntype18)&gt; | Promise对象。返回指定列的数据类型。当结果集中包含重名列时，通过列名获取的结果会不符合预期。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColumnType](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-e/arkts-apis-data-relationalstore-e#columntype18) | 返回指定列的数据类型。当结果集中包含重名列时，通过列名获取的结果会不符合预期。 |
...
获取当前行中指定列的值，如果值类型是ValueType中指定的任意类型，返回指定类型的值，否则返回14800000。如果值类型为INTEGER，值大于 Number.MAX\_SAFE\_INTEGER 或小于 Number.MIN\_SAFE\_INTEGER 且不希望丢失精度，建议使用[getString](#getstring)接口获取。
...
| 类型 | 说明 |
| --- | --- |
| [ValueType](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#valuetype) | 表示允许的数据字段类型。 |
...
以Long形式获取当前行中指定列的值，如果当前列的数据类型为INTEGER、DOUBLE、TEXT、BLOB类型，会转成Long类型返回指定值，如果该列内容为空时，会返回0，其他类型则返回14800000。如果当前列的数据类型为INTEGER，值大于 Number.MAX\_SAFE\_INTEGER 或小于 Number.MIN\_SAFE\_INTEGER 且不希望丢失精度，建议使用[getString](#getstring)接口获取。如果当前列的数据类型为DOUBLE且不希望丢失精度，建议使用[getDouble](#getdouble)接口获取。
...
| 类型 | 说明 |
| --- | --- |
| number | 以Long形式返回指定列的值。  该接口支持的精度范围是：Number.MIN\_SAFE\_INTEGER ~ Number.MAX\_SAFE\_INTEGER，若超出该范围，建议对于DOUBLE类型的值使用[getDouble](#getdouble)，对于INTEGER类型的值使用[getString](#getstring)。 |
...
以[Asset](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-i/arkts-apis-data-relationalstore-i#asset10)形式获取当前行中指定列的值，如果当前列的数据类型为Asset类型，会以Asset类型返回指定值，如果当前列中的值为null时，会返回null，其他类型则返回14800000。
...
| 类型 | 说明 |
| --- | --- |
| [Asset](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-i/arkts-apis-data-relationalstore-i#asset10) | 以Asset形式返回指定列的值。 |
...
以[Assets](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#assets10)形式获取当前行中指定列的值，如果当前列的数据类型为Assets类型，会以Assets类型返回指定值，如果当前列中的值为null时，会返回null，其他类型则返回14800000。
...
| 类型 | 说明 |
| --- | --- |
| [Assets](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#assets10) | 以Assets形式返回指定列的值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ValuesBucket](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#valuesbucket) | 返回指定行的值。当结果集中包含重名列时，返回值会不符合预期，建议使用[getCurrentRowData](#getcurrentrowdata23)接口获取。 |
...
从结果集中获取指定数量的数据，使用Promise异步回调。禁止与[ResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-resultset/arkts-apis-data-relationalstore-resultset)的其他接口并发调用，否则获取的数据可能非预期。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[ValuesBucket](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#valuesbucket)&gt;&gt; | 返回maxCount条数据，剩余数据不足maxCount条则返回剩余数据，返回空数组时代表已经遍历到结果集的末尾。当结果集中包含重名列时，返回值会不符合预期，建议使用[getRowsData](#getrowsdata23)接口获取。 |
...
| 类型 | 说明 |
| --- | --- |
| [RowData](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#rowdata23) | 返回当前行所有列的值。支持获取包含重名列的值。 |
...
从指定位置position开始，最多获取maxCount行数据。使用Promise异步回调。禁止与[ResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-resultset/arkts-apis-data-relationalstore-resultset)的其他接口并发调用，否则获取的数据可能非预期。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[RowsData](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#rowsdata23)&gt; | 返回maxCount条数据，剩余数据不足maxCount条则返回剩余数据，返回空数组时代表已经遍历到结果集的末尾。支持获取包含重名列的值。 |
...
| 类型 | 说明 |
| --- | --- |
| [sendableRelationalStore.ValuesBucket](/ref/arkdata-api/arkdata-arkts/js-apis-data-sendablerelationalstore/js-apis-data-sendablerelationalstore#valuesbucket) | 当前行数据的sendable形式，用于跨线程传递。 |
