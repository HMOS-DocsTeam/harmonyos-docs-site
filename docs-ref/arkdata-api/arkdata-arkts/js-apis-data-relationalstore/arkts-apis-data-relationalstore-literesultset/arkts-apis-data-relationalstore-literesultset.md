...
下列API示例中，都需先使用[queryWithoutRowCount](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#querywithoutrowcount23)、[querySqlWithoutRowCount](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore#querysqlwithoutrowcount23)等query类方法中任一方法获取到LiteResultSet实例，再通过此实例调用对应方法。

![](../../../../images/08730f95/note_3.0-zh-cn.png) 
...
如果值类型为INTEGER，值大于Number.MAX\_SAFE\_INTEGER或小于Number.MIN\_SAFE\_INTEGER时，如果不希望丢失精度，建议使用[getString](#getstring23)接口获取。
...
| 类型 | 说明 |
| --- | --- |
| [ValueType](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#valuetype) | 允许返回的数据字段类型。 |
...
如果当前列的数据类型为INTEGER，值大于Number.MAX\_SAFE\_INTEGER 或小于Number.MIN\_SAFE\_INTEGER时，如果不希望丢失精度，建议使用[getString](#getstring23)接口获取。
...
| 类型 | 说明 |
| --- | --- |
| number | 以Long形式返回指定列的值。  该接口支持的精度范围是：Number.MIN\_SAFE\_INTEGER ~ Number.MAX\_SAFE\_INTEGER，若超出该范围，建议对于DOUBLE类型的值使用[getDouble](#getdouble23)，对于INTEGER类型的值使用[getString](#getstring23)。 |
...
以[Asset](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-i/arkts-apis-data-relationalstore-i#asset10)形式获取当前行中指定列的值。
...
以[Assets](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-t/arkts-apis-data-relationalstore-t#assets10)形式获取当前行中指定列的值。
...
从结果集中获取指定数量的数据，使用Promise异步回调。禁止与[LiteResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-literesultset/arkts-apis-data-relationalstore-literesultset)的其他接口并发调用，否则获取的数据可能非预期。
...
从指定位置position开始，最多获取maxCount行数据。使用Promise异步回调。禁止与[LiteResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-literesultset/arkts-apis-data-relationalstore-literesultset)的其他接口并发调用，否则获取的数据可能非预期。
