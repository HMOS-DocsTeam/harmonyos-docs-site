...
![](../../../images/57faac1b/note_3.0-zh-cn.png) 
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext) | 否 | 否 | 应用的上下文。  FA模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context)。  Stage模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext)。  从API version 10开始，context的参数类型为[BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext)。 |
...
![](../../../images/cce51ef9/note_3.0-zh-cn.png) 
...
| kvStoreType | [KVStoreType](#kvstoretype) | 否 | 是 | 设置要创建的数据库类型，默认为DEVICE\_COLLABORATION，即多设备协同数据库。  ****系统能力：**** SystemCapability.DistributedDataManager.KVStore.Core |
...
| type | number | 否 | 否 | 表示指定节点对应的数据类型，取值为[ValueType](#valuetype)对应的枚举值。暂不支持BYTE\_ARRAY，使用此类型会导致[getKVStore](#getkvstore)失败。 |
...
在获取已有的分布式键值数据库时，如果数据库文件无法打开（例如文件头损坏），将触发自动重建逻辑，并返回新创建的分布式键值数据库实例。建议对重要且无法重新生成的数据使用备份恢复功能，以防止数据丢失。有关备份恢复的使用方法，请参阅[数据库备份与恢复](/arkdata/data-reliability-security/data-backup-and-restore)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| storeId | string | 是 | 数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)，且只能包含字母数字或下划线\_。 |
...
以下错误码的详细介绍请参见[分布式键值数据库错误码](/ref/arkdata-api/arkdata-arkts-errcode/errorcode-distributedkvstore/errorcode-distributedkvstore)和[通用错误码](/ref/errorcode-universal/errorcode-universal)。
...
获取已有的分布式键值数据库时，如果数据库文件无法打开（如文件头损坏），将触发自动重建逻辑，并返回新创建的分布式键值数据库实例。建议对重要且无法重新生成的数据使用备份恢复功能，防止数据丢失。备份恢复的使用方法详见[数据库备份与恢复](/arkdata/data-reliability-security/data-backup-and-restore)。
...
| storeId | string | 是 | 要关闭的数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)，且只能包含字母数字或下划线\_。 |
...
| --- | --- | --- | --- |
| appId | string | 是 | 应用的BundleName，不可为空且长度不大于256字符。 |
| storeId | string | 是 | 要删除的数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)，且只能包含字母数字或下划线\_。 |
...
![](../../../images/d268ac39/note_3.0-zh-cn.png) 
...
![](../../../images/13d37e72/note_3.0-zh-cn.png) 

使用equalTo时需要结合[Schema](#schema)使用。

使用Schema创建数据库请参见[通过键值型数据库实现数据持久化](/arkdata/app-data-persistence/data-persistence-by-kv-store#开发步骤)中使用getKVStore()方法创建并获取键值数据库示例。
...
![](../../../images/1250308c/note_3.0-zh-cn.png) 
...
![](../../../images/e33cc626/note_3.0-zh-cn.png) 
...
![](../../../images/4fa3607f/note_3.0-zh-cn.png) 
...
![](../../../images/7b7141ac/note_3.0-zh-cn.png) 
...
![](../../../images/fb1d57b3/note_3.0-zh-cn.png) 
...
![](../../../images/6745d9f6/note_3.0-zh-cn.png) 
...
![](../../../images/dd87a79f/note_3.0-zh-cn.png) 
...
![](../../../images/10afdc85/note_3.0-zh-cn.png) 
...
![](../../../images/f8303c5e/note_3.0-zh-cn.png) 
...
![](../../../images/0d0d95c8/note_3.0-zh-cn.png) 
...
![](../../../images/952f2920/note_3.0-zh-cn.png) 
...
![](../../../images/9e739d3d/note_3.0-zh-cn.png) 
...
![](../../../images/9e60467c/note_3.0-zh-cn.png) 
...
![](../../../images/4e089fab/note_3.0-zh-cn.png) 
...
![](../../../images/ec541655/note_3.0-zh-cn.png) 
...
![](../../../images/7cf6d4ff/note_3.0-zh-cn.png) 

其中deviceId为[DeviceBasicInfo](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#devicebasicinfo)中的networkId，通过调用[deviceManager.getAvailableDeviceListSync](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要添加数据的Key，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
| value | Uint8Array | string | number | boolean | 是 | 要添加数据的value，支持Uint8Array、number 、 string 、boolean，Uint8Array、string 的长度不大于[MAX\_VALUE\_LENGTH](#constants)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要删除数据的Key，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
![](../../../images/b692e767/note_3.0-zh-cn.png) 
...
![](../../../images/ed4d8dc7/note_3.0-zh-cn.png) 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要查询数据的Key，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| file | string | 是 | 备份数据库的指定名称，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| file | string | 是 | 指定的数据库文件名称，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| files | Array&lt;string&gt; | 是 | 删除备份文件所指定的名称，不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
以下错误码的详细介绍请参见[分布式键值数据库错误码](/ref/arkdata-api/arkdata-arkts-errcode/errorcode-distributedkvstore/errorcode-distributedkvstore)。
...
![](../../../images/44a89f33/note_3.0-zh-cn.png) 
...
![](../../../images/4c2f7dd8/note_3.0-zh-cn.png) 
...
在手动同步方式下，触发数据库端端同步。关于键值型数据库的端端同步方式说明，请见[键值型数据库跨设备数据同步](/arkdata/distributed-data-sync/data-sync-of-kv-store)。

![](../../../images/3e0f10a9/note_3.0-zh-cn.png) 

其中deviceIds为[DeviceBasicInfo](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#devicebasicinfo)中的networkId, 通过调用[deviceManager.getAvailableDeviceListSync](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
在手动同步方式下，触发数据库端端同步，此方法为同步方法。关于键值型数据库的端端同步方式说明，请见[键值型数据库跨设备数据同步](/arkdata/distributed-data-sync/data-sync-of-kv-store)。

![](../../../images/985e1d5a/note_3.0-zh-cn.png) 
...
![](../../../images/2cd6ffcd/note_3.0-zh-cn.png) 

其中deviceId通过调用[deviceManager.getAvailableDeviceListSync](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
| key | string | 是 | 表示要查询Key值的键, 不能为空且长度不大于[MAX\_KEY\_LENGTH](#constants)。 |
...
![](../../../images/4dd122e4/note_3.0-zh-cn.png) 
...
![](../../../images/699c265c/note_3.0-zh-cn.png) 
...
![](../../../images/369c3c1c/note_3.0-zh-cn.png) 
...
![](../../../images/34e252fa/note_3.0-zh-cn.png) 
...
![](../../../images/139d4327/note_3.0-zh-cn.png) 
...
![](../../../images/89059992/note_3.0-zh-cn.png) 
...
![](../../../images/78e8845f/note_3.0-zh-cn.png) 
...
![](../../../images/817478e4/note_3.0-zh-cn.png) 
...
![](../../../images/f724837c/note_3.0-zh-cn.png) 
...
![](../../../images/d9f2033c/note_3.0-zh-cn.png) 
...
![](../../../images/66fbc787/note_3.0-zh-cn.png) 
...
![](../../../images/54fc6c15/note_3.0-zh-cn.png) 
