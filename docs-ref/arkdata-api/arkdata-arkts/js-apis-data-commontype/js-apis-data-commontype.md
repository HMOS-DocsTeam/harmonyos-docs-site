...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-commontype
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-data-commontype
---
...
![](../../../images/3f56324d/note_3.0-zh-cn.png) 
...
记录资产附件（文件、图片、视频等类型文件）的相关信息，相关示例见[在跨端迁移中使用分布式数据对象迁移数据](/arkdata/distributed-data-sync/data-sync-of-distributed-data-object#在跨端迁移中使用分布式数据对象迁移数据)的示例代码。
...
| status | [AssetStatus](#assetstatus) | 否 | 是 | 资产的状态，默认值为ASSET\_NORMAL。 |
