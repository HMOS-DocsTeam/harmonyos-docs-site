...
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-storage
kit: 应用框架
last_updated: "2026-04-22"
slug: js-apis-system-storage
---

# @system.storage (数据存储)

![](../../../../images/0fe3174c/note_3.0-zh-cn.png) 

- 模块维护策略：

  - 对于Lite Wearable设备类型，该模块长期维护，可正常使用。
  - 对于支持该模块的其他设备类型，该模块从API version 6开始不再维护，可以使用模块[@ohos.data.storage](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-storage/js-apis-data-storage)。在API version 9后，推荐使用新模块[@ohos.data.preferences](/ref/arkdata-api/arkdata-arkts/js-apis-data-preferences/js-apis-data-preferences)。
