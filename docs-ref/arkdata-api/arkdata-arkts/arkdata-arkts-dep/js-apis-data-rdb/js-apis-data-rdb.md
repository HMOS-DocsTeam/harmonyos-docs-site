...
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-rdb
kit: 应用框架
...
![](../../../../images/f6b56ae0/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 从API version 9开始，该接口不再维护，推荐使用新接口[@ohos.data.relationalStore](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore/arkts-apis-data-relationalstore)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 应用的上下文。  FA模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context)。  Stage模型的应用Context定义见[Context](/ref/ability-api/ability-arkts/fa-model/app/js-apis-inner-app-context/js-apis-inner-app-context)。 |
...
![](../../../../images/d317c7b3/note_3.0-zh-cn.png) 
...
| callback | AsyncCallback&lt;[ResultSet](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/data-rdb/js-apis-data-resultset/js-apis-data-resultset)&gt; | 是 | 指定callback回调函数。如果操作成功，则返回ResultSet对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ResultSet](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/data-rdb/js-apis-data-resultset/js-apis-data-resultset)&gt; | Promise对象。如果操作成功，则返回ResultSet对象。 |
...
![](../../../../images/8d9f9c95/note_3.0-zh-cn.png) 
...
![](../../../../images/37960654/note_3.0-zh-cn.png) 
