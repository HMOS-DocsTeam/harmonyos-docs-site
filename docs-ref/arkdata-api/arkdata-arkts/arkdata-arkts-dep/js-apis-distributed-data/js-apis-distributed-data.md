...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributed-data
kit: 应用框架
...
![](../../../../images/6f0bb211/note_3.0-zh-cn.png) 

- 从API Version 9开始，该接口不再维护，推荐使用新接口[@ohos.data.distributedKVStore](/ref/arkdata-api/arkdata-arkts/js-apis-distributedkvstore/js-apis-distributedkvstore)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| storeId | string | 是 | 数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)。 |
...
| storeId | string | 是 | 要关闭的数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)。 |
...
| --- | --- | --- | --- |
| appId | string | 是 | 所调用数据库方的包名。 |
| storeId | string | 是 | 要删除的数据库唯一标识符，长度不大于[MAX\_STORE\_ID\_LENGTH](#constants)。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
| kvStoreType | [KVStoreType](#kvstoretype) | 否 | 设置要创建的数据库类型，默认为DEVICE\_COLLABORATION，即多设备协同数据库。  ****系统能力：**** SystemCapability.DistributedDataManager.KVStore.Core |
...
![](../../../../images/6a3be252/note_3.0-zh-cn.png) 
...
![](../../../../images/036f4d32/note_3.0-zh-cn.png) 
...
![](../../../../images/57abf688/note_3.0-zh-cn.png) 
...
![](../../../../images/6a5513a2/note_3.0-zh-cn.png) 
...
![](../../../../images/bdc4b01f/note_3.0-zh-cn.png) 
...
![](../../../../images/dd4c7fe7/note_3.0-zh-cn.png) 
...
![](../../../../images/ae753838/note_3.0-zh-cn.png) 
...
![](../../../../images/f6c397d6/note_3.0-zh-cn.png) 
...
![](../../../../images/0ff18df6/note_3.0-zh-cn.png) 
...
![](../../../../images/f726f640/note_3.0-zh-cn.png) 
...
![](../../../../images/51d88296/note_3.0-zh-cn.png) 
...
![](../../../../images/b022becb/note_3.0-zh-cn.png) 
...
![](../../../../images/42542403/note_3.0-zh-cn.png) 
...
![](../../../../images/4661a776/note_3.0-zh-cn.png) 
...
![](../../../../images/bfbab5ca/note_3.0-zh-cn.png) 
...
![](../../../../images/d97cbaf6/note_3.0-zh-cn.png) 
...
![](../../../../images/6e5a8d73/note_3.0-zh-cn.png) 
...
![](../../../../images/3417a5dc/note_3.0-zh-cn.png) 
...
![](../../../../images/094eac2c/note_3.0-zh-cn.png) 
