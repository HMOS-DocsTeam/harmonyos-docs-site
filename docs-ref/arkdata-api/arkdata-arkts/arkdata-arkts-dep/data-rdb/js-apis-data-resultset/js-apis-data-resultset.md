...
title: "resultSet (结果集)"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-resultset
kit: 应用框架
...
![](../../../../../images/327cc6ce/note_3.0-zh-cn.png) 

本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

从API Version 9开始，该接口不再维护，推荐使用新接口[@ohos.data.relationalStore#ResultSet](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-resultset/arkts-apis-data-relationalstore-resultset)。
...
需要通过[RdbStore.query()](/ref/arkdata-api/arkdata-arkts/arkdata-arkts-dep/js-apis-data-rdb/js-apis-data-rdb#query)获取resultSet对象。
...
| 类型 | 说明 |
| --- | --- |
| number | 以Long形式返回指定列的值。  该接口支持的数据范围是：Number.MIN\_SAFE\_INTEGER ~ Number.MAX\_SAFE\_INTEGER，若超出该范围，建议使用[getDouble](#getdouble)。 |
