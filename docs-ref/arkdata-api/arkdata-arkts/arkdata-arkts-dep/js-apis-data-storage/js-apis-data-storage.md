...
sidebar_position: 3
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-storage
kit: 应用框架
...
![](../../../../images/b566449a/note_3.0-zh-cn.png) 

- 本模块首批接口从API version 6开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
- 从API version 9开始，该接口不再维护，推荐使用新接口[@ohos.data.preferences](/ref/arkdata-api/arkdata-arkts/js-apis-data-preferences/js-apis-data-preferences)。
