...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) | Data\_Asset | 表示资产附件类型的数据。  提供资产附件的信息。 |
...
| [Data\_Asset \*OH\_Data\_Asset\_CreateOne(void)](#oh_data_asset_createone) | 创建一个[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)类型实例。 |
| [int OH\_Data\_Asset\_DestroyOne(Data\_Asset \*asset)](#oh_data_asset_destroyone) | 销毁[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) 对象并回收该对象占用的内存。 |
| [Data\_Asset \*\*OH\_Data\_Asset\_CreateMultiple(uint32\_t count)](#oh_data_asset_createmultiple) | 创建指定数量的[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)类型实例。 |
| [int OH\_Data\_Asset\_DestroyMultiple(Data\_Asset \*\*assets, uint32\_t count)](#oh_data_asset_destroymultiple) | 销毁多个[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) 对象并回收该对象占用的内存。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) \*asset | 表示指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回特定的错误码值。详细信息可以查看[OH\_Rdb\_ErrCode](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-relational-store-error-code-h/capi-relational-store-error-code-h#oh_rdb_errcode)。  返回RDB\_OK表示成功。  返回RDB\_E\_INVALID\_ARGS表示无效参数。 |
...
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) \*asset | 表示指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)实例的指针。 |
| [Data\_AssetStatus](#data_assetstatus) status | 表示需要设置的状态码。详细信息可以查看[Data\_AssetStatus](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-data-asset-h/capi-data-asset-h#data_assetstatus)。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回特定的错误码值。详细信息可以查看[OH\_Rdb\_ErrCode](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-relational-store-error-code-h/capi-relational-store-error-code-h#oh_rdb_errcode)。  返回RDB\_ERR表示函数执行异常。  返回RDB\_OK表示成功。  返回RDB\_E\_INVALID\_ARGS表示无效参数。 |
...
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) \*asset | 表示指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)实例的指针。 |
| [Data\_AssetStatus](#data_assetstatus) \*status | 参数是输出参数，资产类型数据的状态码会以[Data\_AssetStatus](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-data-asset-h/capi-data-asset-h#data_assetstatus)形式写入该变量。 |
...
创建一个[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)类型实例。
...
| 类型 | 说明 |
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) | 创建成功则返回一个指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)结构体实例的指针，否则返回NULL。  使用完成后，必须通过[OH\_Data\_Asset\_DestroyOne](#oh_data_asset_destroyone)接口释放内存。 |
...
销毁[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) 对象并回收该对象占用的内存。
...
| 类型 | 说明 |
| --- | --- |
| int | 返回操作是否成功，成功时返回RDB\_OK，出错时返回对应的错误码。详细信息可以查看[OH\_Rdb\_ErrCode](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-relational-store-error-code-h/capi-relational-store-error-code-h#oh_rdb_errcode)。 |
...
创建指定数量的[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)类型实例。
...
| 类型 | 说明 |
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) | 创建成功则返回一个指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)结构体实例的指针，否则返回NULL。  使用完成后，必须通过[OH\_Data\_Asset\_DestroyMultiple](#oh_data_asset_destroymultiple)接口释放内存。 |
...
销毁多个[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) 对象并回收该对象占用的内存。
...
| 参数项 | 描述 |
| --- | --- |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) \*\*assets | 表示指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)实例的指针。 |
| uint32\_t count | 代表需要销毁的[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)类型对象的数量。 |
