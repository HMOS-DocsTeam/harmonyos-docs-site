...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) | OH\_Preferences | 定义Preferences对象类型。 |
...
| [OH\_Preferences \*OH\_Preferences\_Open(OH\_PreferencesOption \*option, int \*errCode)](#oh_preferences_open) | - | 打开一个Preferences实例对象并创建指向它的指针。  当不再需要使用指针时，请使用[OH\_Preferences\_Close](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferences_close)关闭实例对象。 |
...
| [int OH\_Preferences\_SetValue(OH\_Preferences \*preference, const char \*key, OH\_PreferencesValue \*value)](#oh_preferences_setvalue) | - | 在Preferences对象中设置值[OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue)。 |
...
| [int OH\_Preferences\_Flush(OH\_Preferences \*preference)](#oh_preferences_flush) | - | 将[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)对象的缓存保存到xml文件中。 |
| [int OH\_Preferences\_ClearCache(OH\_Preferences \*preference)](#oh_preferences_clearcache) | - | 清除[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)对象缓存中的所有值。 |
...
| const [OH\_PreferencesPair](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencespair/capi-preferences-oh-preferencespair) \*pairs | 发生变更的KV数据的指针。 |
...
当不再需要使用指针时，请使用[OH\_Preferences\_Close](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferences_close)关闭实例对象。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PreferencesOption](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesoption/capi-preferences-oh-preferencesoption) \*option | 指向Preferences配置选项[OH\_PreferencesOption](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesoption/capi-preferences-oh-preferencesoption)的指针。 |
| int \*errCode | 该参数作为出参使用，表示指向返回错误码的指针，详见[OH\_Preferences\_ErrCode](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-err-code-h/capi-oh-preferences-err-code-h#oh_preferences_errcode)。  若错误码为PREFERENCES\_OK，表示操作成功。  若错误码为PREFERENCES\_ERROR\_INVALID\_PARAM，表示参数不合法。  若错误码为PREFERENCES\_ERROR\_NOT\_SUPPORTED，表示系统能力不支持。  若错误码为PREFERENCES\_ERROR\_DELETE\_FILE，表示删除文件失败。  若错误码为PREFERENCES\_ERROR\_STORAGE，表示存储异常。  若错误码为PREFERENCES\_ERROR\_MALLOC，表示内存分配失败。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) | 当操作成功时，返回指向打开的Preferences对象[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例对象的指针，失败返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向需要关闭的Preferences[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例对象的指针。 |

****返回：****

| 类型 | 说明 |
| --- | --- |
| int | 返回执行的错误码，详见[OH\_Preferences\_ErrCode](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-err-code-h/capi-oh-preferences-err-code-h#oh_preferences_errcode)。  若错误码为PREFERENCES\_OK，表示操作成功。  若错误码为PREFERENCES\_ERROR\_INVALID\_PARAM，表示参数不合法。  若错误码为PREFERENCES\_ERROR\_STORAGE，表示存储异常。  若错误码为PREFERENCES\_ERROR\_MALLOC，表示内存分配失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向目标Preferences[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例对象的指针。 |
...
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向目标Preferences[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例对象的指针。 |
| void \*context | 应用上下文的指针。 |
| [OH\_PreferencesDataObserver](#oh_preferencesdataobserver) observer | 订阅数据变更关联的回调函数[OH\_PreferencesDataObserver](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferencesdataobserver)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Preferences\_StorageType](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-option-h/capi-oh-preferences-option-h#preferences_storagetype) type | 要校验是否支持的存储模式。 |
...
在Preferences对象中设置值[OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue)。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向目标[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例的指针。 |
| const char \*key | 指向需要设置的Key的指针。 |
| [OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue) \*value | 指向需要设置的[OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue)值的指针。 |
...
| [OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue) \*\*value | 指向获取到的[OH\_PreferencesValue](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencesvalue/capi-preferences-oh-preferencesvalue)值的二级指针。 |
...
| --- | --- |
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向目标[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例的指针。 |
| [OH\_PreferencesPair](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferencespair/capi-preferences-oh-preferencespair) \*\*pairs | 指向要获取的KV数据的指针。当不再需要此KV数据时，用户需要调用[OH\_Preferences\_FreeString](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferences_freestring)释放内存。 |
...
将[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)对象的缓存保存到xml文件中。
...
清除[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)对象缓存中的所有值。
...
| [OH\_PreferencesDataObserver](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferencesdataobserver) observer | 要注册的[OH\_PreferencesDataObserver](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferencesdataobserver)回调函数。 |
...
| [OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences) \*preference | 指向目标[OH\_Preferences](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-preferences-oh-preferences/capi-preferences-oh-preferences)实例的指针。 |
| void \*context | 指向数据观察者上下文的指针。 |
| [OH\_PreferencesDataObserver](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferencesdataobserver) observer | 要取消注册的[OH\_PreferencesDataObserver](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-preferences-h/capi-oh-preferences-h#oh_preferencesdataobserver)回调函数。 |
