...
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-data-values-h
kit: 应用框架
last_updated: "2026-04-22"
slug: capi-oh-data-values-h
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) | OH\_Data\_Values | 定义OH\_Data\_Values结构类型。 |

### 函数

| 名称 | 描述 |
| --- | --- |
| [OH\_Data\_Values \*OH\_Values\_Create(void)](#oh_values_create) | 创建[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例，用于储存多条键值对数据。 |
| [int OH\_Values\_Destroy(OH\_Data\_Values \*values)](#oh_values_destroy) | 销毁[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)对象。 |
...
创建[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例，用于储存多条键值对数据。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) | 执行成功时返回指向[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例的指针，否则返回nullptr。  使用完成后，必须通过[OH\_Values\_Destroy](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-data-values-h/capi-oh-data-values-h#oh_values_destroy)接口释放内存。 |
...
销毁[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)对象。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) \*values | 表示指向[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例的指针。 |
...
| --- | --- |
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) \*values | 表示指向[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例的指针。 |
| const [OH\_Data\_Value](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-value/capi-rdb-oh-data-value) \*val | 表示指向[OH\_Data\_Value](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-value/capi-rdb-oh-data-value)对象的指针。 |
...
| size\_t length | 该参数为输入参数，表示开发者传入的[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)对象数组元素的个数。 |
...
| [OH\_ColumnType](/ref/arkdata-api/arkdata-c/arkdata-headerfile/capi-oh-data-value-h/capi-oh-data-value-h#oh_columntype) \*type | 一个输出参数，表示数据类型。 |
...
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) \*values | 表示指向[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例的指针。 |
| int index | 表示values中目标数据的从零开始的索引。 |
| [OH\_Data\_Value](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-value/capi-rdb-oh-data-value) \*\*val | 一个输出参数，表示指向[OH\_Data\_Value](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-value/capi-rdb-oh-data-value)实例的指针。  无需申请内存和释放内存。 |
...
| [OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values) \*values | 表示指向[OH\_Data\_Values](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-oh-data-values/capi-rdb-oh-data-values)实例的指针。 |
| int index | 表示values中目标数据的从零开始的索引。 |
| [Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset) \*\*val | 表示指向[Data\_Asset](/ref/arkdata-api/arkdata-c/arkdata-struct/capi-rdb-data-asset/capi-rdb-data-asset)对象的指针。  使用时需要申请数据内存。  此函数仅填充数据，否则执行失败。 |
