...
title: "ArkTS API错误码"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/liveview-error-code
kit: 应用服务
last_updated: "2026-04-22"
slug: liveview-error-code
---

# ArkTS API错误码

![](../../../images/01b68904/note_3.0-zh-cn.png) 
...
请更换[实况窗id](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)。
...
1. 检查[创建实况窗](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstartliveview)是否成功。
2. 若创建成功，检查端侧通知中心实况窗是否存在。若不存在，请停止调用此[实况窗id](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)的接口。
...
当应用调用[liveViewManager.stopLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstopliveview)函数结束实况窗后，在应用设置的keepTime内实况窗仍保留在通知中心。此时调用[liveViewManager.updateLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerupdateliveview)或[liveViewManager.stopLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstopliveview)更新或结束同一id的实况窗。

****处理步骤****

应用调用[liveViewManager.stopLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstopliveview)结束实况窗并设置keepTime，实况窗保留在通知中心期间，请勿复用该[实况窗id](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)调用更新、结束接口。
...
请修改序列号[sequence](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)后重新更新或结束实况窗。
