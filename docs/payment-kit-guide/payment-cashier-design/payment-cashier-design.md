...
![](../../images/26b878dd/zh-cn_image_0000002552959072.png)

## 定义收银台页面容器

定义收银台页面容器用于展示支付收银台。UX规范要求以半模态弹窗展示收银台，使用说明可参考[半模态转场](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/transition/ts-universal-attributes-sheet-transition/ts-universal-attributes-sheet-transition#示例1不同高度的半模态弹窗)。
...
![](../../images/3e0956c3/zh-cn_image_0000002552959072.png)
...
![](../../images/87cee7e9/zh-cn_image_0000002583479073.png)
...
![](../../images/ac277c2e/zh-cn_image_0000002552799424.png)
...
![](../../images/61fb801e/zh-cn_image_0000002583439119.png)
