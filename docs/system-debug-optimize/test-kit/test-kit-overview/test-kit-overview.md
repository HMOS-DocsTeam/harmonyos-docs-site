...
- 单元测试能力：提供自动化测试的基础接口和运行机制，具体使用方法请参考[单元测试框架使用指导](/ut/arkxtest-guidelines/unittest-guidelines)，主要能力如下：
...
- UI测试能力：提供UI自动化测试能力，测试脚本需基于单元测试框架开发，具体使用方法请参考[UI测试框架使用指导](/ut/arkxtest-guidelines/uitest-guidelines)，主要能力如下：
...
- 性能测试能力：提供白盒性能自动化测试能力，测试脚本需基于单元测试框架开发，具体使用方法请参考[白盒性能测试框架使用指导](/ut/arkxtest-guidelines/perftest-guideline)，主要能力如下：
