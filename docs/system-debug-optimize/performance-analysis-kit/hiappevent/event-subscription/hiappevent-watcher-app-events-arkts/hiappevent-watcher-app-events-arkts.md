...
API接口使用说明，包括参数使用限制和具体取值范围。请参考[@ohos.hiviewdfx.hiAppEvent](/ref/system-debug-optimize-api/performance-analysis-api/performance-analysis-arkts/js-apis-hiviewdfx-hiappevent/js-apis-hiviewdfx-hiappevent)。
...
![](../../../../../images/0526403f/note_3.0-zh-cn.png) 
...
![](../../../../../images/09d58b69/note_3.0-zh-cn.png) 
