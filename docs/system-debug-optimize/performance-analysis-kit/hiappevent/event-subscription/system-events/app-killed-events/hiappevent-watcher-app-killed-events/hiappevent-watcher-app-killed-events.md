...
- [订阅应用终止事件（ArkTS）](/system-debug-optimize/performance-analysis-kit/hiappevent/event-subscription/system-events/app-killed-events/hiappevent-watcher-app-killed-events-arkts)
- [订阅应用终止事件（C/C++）](/system-debug-optimize/performance-analysis-kit/hiappevent/event-subscription/system-events/app-killed-events/hiappevent-watcher-app-killed-events-ndk)

![](../../../../../../../images/74f5f539/note_3.0-zh-cn.png) 

应用终止事件支持在[应用分身](/development-fundamentals/application-typical-scenarios/app-clone)场景下使用 HiAppEvent 进行订阅，支持在元服务场景下使用 HiAppEvent 进行订阅，从 API version 22 开始支持在[输入法应用](/ime-kit/inputmethod-application-guide)场景下使用 HiAppEvent 进行订阅。
