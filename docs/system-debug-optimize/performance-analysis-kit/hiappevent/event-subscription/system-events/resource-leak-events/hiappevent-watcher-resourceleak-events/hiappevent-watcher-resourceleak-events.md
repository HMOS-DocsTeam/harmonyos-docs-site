...
![](../../../../../../../images/6477c657/note_3.0-zh-cn.png) 

资源泄漏事件支持在[应用分身](/development-fundamentals/application-typical-scenarios/app-clone)场景下使用 HiAppEvent 进行订阅，支持在元服务场景下使用 HiAppEvent 进行订阅，从 API version 22 开始支持在[输入法应用](/ime-kit/inputmethod-application-guide)场景下使用 HiAppEvent 进行订阅。

## 检测原理

检测原理详见[Resource Leak（资源泄漏检测）](/system-debug-optimize/performance-analysis-kit/fault-analysis/resource-leak-guidelines)。
...
![](../../../../../../../images/615d5fba/caution_3.0-zh-cn.png) 
...
![](../../../../../../../images/816a7e22/caution_3.0-zh-cn.png) 
