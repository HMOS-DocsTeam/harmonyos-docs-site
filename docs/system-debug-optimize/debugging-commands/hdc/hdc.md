...
![](../../../images/f23ba90c/zh-cn_image_0000002552798852.png)

![](../../../images/43b9fb72/note_3.0-zh-cn.png) 
...
hdc支持USB和无线两种连接调试方式。在设备的设置>系统>开发者选项中开启或关闭调试开关 ，无需重启设备即可生效。如果设备未启用“开发者选项”，可参考[开发者选项](/ide-debug-app/ide-developer-mode#section530763213432)进行启用。具体调试连接方式及操作步骤请参考[USB连接场景](#usb连接场景)和[TCP连接场景](#tcp连接场景)。
...
![](../../../images/1f1a0db7/note_3.0-zh-cn.png) 
...
| 命令 | 说明 |
| --- | --- |
| [aa](/system-debug-optimize/debugging-commands/aa-tool) | 应用调试工具 |
| [bm](/system-debug-optimize/debugging-commands/bm-tool) | 包管理工具 |
| [cem](/system-debug-optimize/debugging-commands/cem-tool) | 公共事件管理工具 |
| [anm](/system-debug-optimize/debugging-commands/anm-tool) | 通知管理工具 |
| [edm](/system-debug-optimize/debugging-commands/edm-tool) | 企业设备管理工具 |
| [param](/system-debug-optimize/debugging-commands/param-tool) | 操作系统参数管理工具 |
| [power-shell](/system-debug-optimize/debugging-commands/power-shell) | 设备电源状态转换工具 |
| [atm](/system-debug-optimize/debugging-commands/atm-tool) | 程序访问控制管理工具 |
| [hilog](/system-debug-optimize/debugging-commands/hilog) | 日志管理工具 |
| [hidumper](/system-debug-optimize/debugging-commands/hidumper-tool/hidumper) | 系统信息导出工具 |
| [hitrace](/system-debug-optimize/debugging-commands/hitrace) | 系统打点及采集工具 |
| [hiperf](/system-debug-optimize/debugging-commands/hiperf) | 性能分析工具 |
| [uinput](/system-debug-optimize/debugging-commands/uinput) | 模拟操作工具 |
| [mediatool](/system-debug-optimize/debugging-commands/command-line-utilities/mediatool) | 媒体资源库工具 |
| [devicedebug](/system-debug-optimize/debugging-commands/command-line-utilities/devicedebug-tool) | 调试应用发送信号工具 |
| [rawheap-translator](/system-debug-optimize/debugging-commands/command-line-utilities/rawheap-translator) | rawheap文件解析工具 |
| [UItest](/ut/arkxtest-guidelines/uitest-guidelines) | UI测试框架 |
| [HiSmartPerf Device daemon](/test-service/indev_cmd/smartperf-guidelines#section17658386337) | HiSmartPerf Device-daemon端工具命令 |
| [wukong](/test-service/indev_cmd/wukong-guidelines) | wukong稳定性工具 |
...
![](../../../images/95cc1867/caution_3.0-zh-cn.png) 
...
![](../../../images/22bd44ee/note_3.0-zh-cn.png) 
...
![](../../../images/ec4b3260/note_3.0-zh-cn.png) 
...
![](../../../images/330bdf1f/caution_3.0-zh-cn.png) 
...
4. 查看已连接设备，执行以下命令：
   ...
   ![](../../../images/77415a00/note_3.0-zh-cn.png) 
...
![](../../../images/29156cd7/zh-cn_image_0000002583438547.png)
...
![](../../../images/e33ba8ea/note_3.0-zh-cn.png) 
...
![](../../../images/df6298c8/note_3.0-zh-cn.png) 
...
![](../../../images/494b3cd7/caution_3.0-zh-cn.png) 
...
![](../../../images/a67a93a3/note_3.0-zh-cn.png) 
...
| 参数 | 说明 |
| --- | --- |
| -b bundlename | 3.1.0e版本新增参数。指定可调试应用包名，在可调试应用数据目录内，以非交互式模式执行命令。  [命令行方式访问应用沙箱](/ide-debug-app/ide-device-file-explorer#section48216711204)。  此参数当前仅支持以非交互式模式执行命令，不支持缺省command参数执行命令进入交互式shell会话。  未配置此参数时，默认执行路径为系统根目录。 |
| command | 需要在设备上执行的单次命令，不同类型或版本的系统支持的command命令有所差异，可以通过hdc shell ls /system/bin查阅支持的命令列表。当前大多数命令都是由[toybox](/system-debug-optimize/debugging-commands/command-line-utilities/toybox)提供，可通过 hdc shell toybox --help 获取命令帮助。  缺省该参数，hdc将会启动一个交互式的shell会话，开发者可以在命令提示符下输入命令，比如 ls、cd、pwd 等。 |

![](../../../images/ea7848c7/note_3.0-zh-cn.png) 
...
应用安装功能在设备端集成bm模块[安装命令（install）](/system-debug-optimize/debugging-commands/bm-tool#安装命令install)，简化了安装流程，开发者可以在电脑端直接执行命令完成应用安装。命令格式如下：
...
| 参数名 | 说明 |
| --- | --- |
| src | 应用安装包的文件路径。支持安装[HAP](/development-fundamentals/application-package-fundamentals/application-package-dev/hap-package)、应用内[HSP](/development-fundamentals/application-package-fundamentals/application-package-dev/in-app-hsp)。从API version 22开始，支持安装[APP包](/development-fundamentals/application-package-glossary#app)。 |
...
| -u | 可选参数，指定[用户](/system-debug-optimize/debugging-commands/bm-tool#userid)，默认在当前活跃用户下安装应用。 |
| -p | 可选参数，指定待安装的HAP/HSP路径，多HAP/HSP应用可指定多HAP/HSP所在文件夹路径。从API version 22开始，支持指定待安装的APP路径，也可指定只存在一个APP的文件夹路径。 |
| -h | 可选参数，显示bm模块[安装命令（install）](/system-debug-optimize/debugging-commands/bm-tool#安装命令install)帮助信息。 |
...
![](../../../images/76c0fdb4/caution_3.0-zh-cn.png) 
...
应用卸载功能在设备端集成bm模块[卸载命令（uninstall）](/system-debug-optimize/debugging-commands/bm-tool#卸载命令uninstall)，简化了卸载流程，开发者可以在电脑端直接执行命令完成应用卸载。命令格式如下：
...
| -h | 可选参数，bm模块[卸载命令（uninstall）](/system-debug-optimize/debugging-commands/bm-tool#卸载命令uninstall)帮助信息。 |
...
| --- | --- |
| SOURCE | 本地待传输的文件路径。 |
| DEST | 远程目标文件路径。  从API version 21开始，媒体库文件支持通过hdc进行部分操作（低版本使用会提示[Fail]Error opening file: ...）。  媒体库文件路径：/mnt/data/<uid>/media\_fuse/Photo/目录及其子目录，<uid>为当前用户的id。  通过hdc对媒体库操作指导参见[mediatool](/system-debug-optimize/debugging-commands/command-line-utilities/mediatool#hdc命令)。 |
| -a | 保留文件修改时间戳。 |
...
| -b | 3.1.0e版本新增参数（低版本使用会提示[Fail]Unknown file option: -b），用于指定可调试应用包名。  使用方法可参考[通过命令往应用沙箱目录中发送文件](/ide-debug-app/ide-device-file-explorer#section48216711204)。 |
...
| --- | --- |
| SOURCE | 本地待接收的文件路径。 |
| DEST | 远程待传输的文件路径。  从API version 21开始，媒体库文件支持通过hdc进行部分操作（低版本使用会提示[Fail]Error opening file: ...）。  媒体库文件路径：/mnt/data/<uid>/media\_fuse/Photo/目录及其子目录，<uid>为当前用户的id。  媒体库操作更多信息参见[mediatool](/system-debug-optimize/debugging-commands/command-line-utilities/mediatool#hdc命令)。 |
| -a | 保留文件修改时间戳。 |
| -sync | 只传输文件mtime有更新的文件。  mtime（modified timestamp）：修改后的时间戳。 |
| -z | 通过LZ4格式压缩传输，此功能未开放，请勿使用。 |
| -m | 文件传输时同步文件DAC权限，uid，gid，MAC权限。  DAC（Discretionary Access Control）：自主访问控制，  uid（User identifier）：用户标识符（或用户ID），  gid（Group identifier）：组标识符（或组ID），  MAC（Mandatory Access Control）：强制访问控制（或非自主访问控制）。 |
| -cwd | 修改工作目录。  用于在文件传输时，切换SOURCE到指定path。例如，初始接收文件目录为/data/，如果使用-cwd "/user/"，实际接收文件目录为/user/。 |
| -b | 3.1.0e版本新增参数，用于传输指定的可调试应用进程应用数据目录下的文件。  使用方法可参考[从沙箱目录中下载文件到本地计算机](/ide-debug-app/ide-device-file-explorer#section48216711204)。 |
...
![](../../../images/62eb050c/note_3.0-zh-cn.png) 
...
![](../../../images/01adabc0/note_3.0-zh-cn.png) 
...
![](../../../images/0814c396/note_3.0-zh-cn.png) 
...
![](../../../images/3971a0db/note_3.0-zh-cn.png) 
...
![](../../../images/1ee752f8/note_3.0-zh-cn.png) 
...
![](../../../images/c9c51dc5/note_3.0-zh-cn.png) 
...
![](../../../images/a07b9ee3/note_3.0-zh-cn.png) 
...
![](../../../images/8c894b29/note_3.0-zh-cn.png) 
...
![](../../../images/b2a63ec1/note_3.0-zh-cn.png) 
...
![](../../../images/eee04a23/note_3.0-zh-cn.png) 
...
![](../../../images/51aa260f/caution_3.0-zh-cn.png) 
...
![](../../../images/8464e527/caution_3.0-zh-cn.png) 
...
![](../../../images/61f6fc4c/zh-cn_image_0000002552958502.png)
...
![](../../../images/6f174918/zh-cn_image_0000002583478503.png)
...
![](../../../images/b2187cbc/note_3.0-zh-cn.png) 
...
3. 场景三：确定命令指定的应用已启动。
   ...
   - 如果未挂载相应的资源目录，可以通过手动点击应用或使用aa相关命令启动应用。
     ...
     更多详细用法请参考[aa命令介绍](/system-debug-optimize/debugging-commands/aa-tool)。
