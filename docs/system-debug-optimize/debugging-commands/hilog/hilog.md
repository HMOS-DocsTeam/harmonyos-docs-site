...
- 使用DevEco Studio工具在线查看日志，参考：[日志分析](/ide-log-and-fault-analysis/ide-setup-hilog)。
...
- 日志保存位置：设备data/log/hilog目录下，可以导出日志进行查看。导出及解析工具参考：[hilogtool](/system-debug-optimize/debugging-commands/hilog-tool)。
...
![](../../../images/86d6ccd8/note_3.0-zh-cn.png) 

日志级别：I表示Info级别，其余级别参考[日志等级](/ref/system-debug-optimize-api/performance-analysis-api/performance-analysis-c/performance-analysis-headerfile/capi-log-h/capi-log-h#loglevel)首字母。
...
![](../../../images/3c6dc03d/note_3.0-zh-cn.png) 
...
![](../../../images/8ec2c520/note_3.0-zh-cn.png) 
...
![](../../../images/7a0cd76c/note_3.0-zh-cn.png) 
