...
- 支持运行在Linux平台的工具：下载最新的[Command Line Tools](/system-debug-optimize/debugging-commands/command-line-tools-overview)，可以在SDK库openHarmony/toolchains/lib中找到，文件名为binary-sign-tool。
