...
- 显示匹配name的系统参数信息，命令格式如下：
  ...
  ****示例****
  ...
  ![](../../../images/e0b09ab4/zh-cn_image_0000002583478523.png)

  ![](../../../images/cfccb3ec/zh-cn_image_0000002552798874.png)

  ![](../../../images/063d627e/zh-cn_image_0000002583438569.png)
...
- 获取指定name系统参数的值，命令格式如下：
  ...
  ****示例****
  ...
  ![](../../../images/87ead443/zh-cn_image_0000002552958524.png)
...
- 设置指定name系统参数的值为value，命令格式如下：
  ...
  ****示例****
  ...
  ![](../../../images/9930b22b/zh-cn_image_0000002583478525.png)
...
- 同步等待指定name系统参数与指定值value匹配，命令格式如下：
  ...
  ****示例****
  ...
  ![](../../../images/ae4706ef/zh-cn_image_0000002552798876.png)
...
- 保存persist(可持久化)参数到工作空间，命令格式如下：
  ...
  ****示例****
  ...
  ![](../../../images/4a8df2e5/zh-cn_image_0000002583438571.png)
