...
restool是一种应用工程资源编译工具，通过编译资源文件创建资源索引、解析资源，开发者可以调用[资源管理接口](/ref/localization-api/localization-arkts/js-apis-resource-manager/js-apis-resource-manager)获取到对应资源。restool工具保存在sdk安装目录下的toolchains子目录。
...
在DevEco Studio配置[纹理压缩](/ide-hvigor-configuration-file/ide-hvigor-build-profile#section2095319147103)的编译配置参数，编译后会在模块的build\default\intermediates\res\default下生成restool的纹理压缩配置文件opt-compression.json，文件结构如下：
...
应用配置文件[module.json（Stage模型）](/development-fundamentals/application-configuration-file-stage/module-configuration-file)或[config.json（FA模型）](/development-fundamentals/application-configuration-file-fa/application-configuration-file-overview-fa)的路径存在冲突。
...
缺少应用配置文件[module.json（Stage模型）](/development-fundamentals/application-configuration-file-stage/module-configuration-file)或[config.json（FA模型）](/development-fundamentals/application-configuration-file-fa/application-configuration-file-overview-fa)的路径。
...
应用配置文件[module.json（Stage模型）](/development-fundamentals/application-configuration-file-stage/module-configuration-file)或[config.json（FA模型）](/development-fundamentals/application-configuration-file-fa/application-configuration-file-overview-fa)中指定的模块类型错误，取值不在["entry", "har", "shared", "feature"]范围内。
...
2. 应用配置文件[module.json（Stage模型）](/development-fundamentals/application-configuration-file-stage/module-configuration-file)或[config.json（FA模型）](/development-fundamentals/application-configuration-file-fa/application-configuration-file-overview-fa)中name指定的模块名称错误。
...
检查资源文件的类型是否正确，可参考[资源分类与访问-资源分类](/resource-categories-and-access#资源分类)中关于各类资源文件的说明。
...
检查限定词目录名称是否准确，限定词目录命名规则可参考[资源分类与访问-限定词目录](/resource-categories-and-access#资源目录)。
...
检查限定词目录下是否仅包含[资源组目录](/resource-categories-and-access#资源组目录)：element，media和profile。
...
字符串或[单复数](/localization-kit/l10n/l10n-translation/l10n-singular-plural)资源的可翻译属性attr下的翻译状态属性priority配置错误，不在["code","translate","LT","customer"]范围内。

****处理步骤****

检查翻译状态priority的值是否准确，可参考[资源可翻译特性](/resource-categories-and-access#资源可翻译特性)中关于priority的说明。
...
检查element资源的类型是否准确，可参考[资源组目录](/resource-categories-and-access#资源组目录)中关于element资源的说明。
...
检查单复数的类别是否准确，可参考[支持单复数](/localization-kit/l10n/l10n-translation/l10n-singular-plural)中关于单复数类别的说明。
...
检查单复数资源声明的类别是否重复，可参考[支持单复数](/localization-kit/l10n/l10n-translation/l10n-singular-plural)中关于单复数类别的说明。
...
检查单复数资源是否包含other类别的声明，可参考[支持单复数](/localization-kit/l10n/l10n-translation/l10n-singular-plural)中关于单复数类别的说明。
