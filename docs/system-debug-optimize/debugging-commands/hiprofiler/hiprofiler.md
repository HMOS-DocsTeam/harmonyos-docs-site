...
整体架构包括PC端和设备端。主体部分是PC端的数据展示页面和设备端的性能调优服务。PC端和设备端服务采用C/S模型，PC端的调优数据在[DevEco Studio](/ide-software-install)和[Smartperf](https://gitcode.com/openharmony/developtools_smartperf_host/releases)网页中展示。设备端程序运行在系统环境中，包含多个部分，其中hiprofilerd进程负责与DevEco通信，作为调优服务。设备端还包括命令行工具hiprofiler\_cmd和数据采集进程hiprofiler\_plugins。调优服务控制数据采集进程获取调优数据，数据最终流向DevEco Studio，整个过程可抽象为生产者-消费者模型。目前已完成多个插件，包括nativehook、CPU、ftrace、GPU、hiperf、xpower和memory数据采集，实现了CPU、GPU、内存和能耗等多维度调优。
...
![](../../../images/7500c50b/zh-cn_image_0000002552798856.png)
...
![](../../../images/cc5a0d82/caution_3.0-zh-cn.png) 
...
![](../../../images/a4fa4b6b/caution_3.0-zh-cn.png) 

[应用加密](/system-security/code-protect)后只能回native栈，不能回JS栈。
...
![](../../../images/69069f06/zh-cn_image_0000002583438551.png)

开启dwarf回栈和跨语言回栈（可以展示出native -> js ->native的栈）：

![](../../../images/bdd01f2a/zh-cn_image_0000002552958506.png)

开启统计模式，在此模式下，栈数据会周期性展示：

![](../../../images/71270954/zh-cn_image_0000002583478507.png)

开启非统计模式，在此模式下，栈数据不会周期性展示：

![](../../../images/f8152b6d/zh-cn_image_0000002552798858.png)
...
![](../../../images/eec38fb5/zh-cn_image_0000002583438553.png)
...
![](../../../images/1768aaee/caution_3.0-zh-cn.png) 
...
![](../../../images/ebf87962/zh-cn_image_0000002552958508.png)

通过DevEco Studio 的工具获得内存的数据：

![](../../../images/839f0089/zh-cn_image_0000002583478509.png)
...
![](../../../images/55ad1aae/zh-cn_image_0000002552798860.png)
...
![](../../../images/30da0534/zh-cn_image_0000002583438555.png)
...
![](../../../images/c4e114e6/zh-cn_image_0000002552958510.png)
...
![](../../../images/c342dc1a/zh-cn_image_0000002583478511.png)
...
![](../../../images/ed3d132d/zh-cn_image_0000002552798862.png)
...
![](../../../images/3acc623c/caution_3.0-zh-cn.png) 
...
![](../../../images/e0ae5b89/zh-cn_image_0000002583438557.png)
...
[网络诊断：NetWork分析](/ide-profiler-network)
...
从API version 23开始支持抓取指定进程创建[napi\_ref](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-life-cycle#napi_ref)的调用栈，不会抓取创建弱引用的调用栈。
...
![](../../../images/b8799794/note_3.0-zh-cn.png) 
...
4.命令行方式获取的trace文件，可以通过DevEco Profiler[离线导入](/ide-insight-session-snapshot/ide-snapshot-basic-operations#section6760173514388)文件功能进行解析。导入的单个文件大小不超过1.5G。
...
![](../../../images/56d02ee2/zh-cn_image_0000002552958512.png)
