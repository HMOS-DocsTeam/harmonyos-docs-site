...
| buildVersion | String | 标识App中的[buildVersion](/development-fundamentals/application-configuration-file-stage/app-configuration-file#配置文件标签)信息。 | 从API version 23开始支持。 |
...
| isModuleAbcCompressed | boolean | 标识[modules.abc](/ide-hvigor/ide-compile-build)文件是否为压缩状态。true表示压缩状态，false表示非压缩状态。 | NA |
