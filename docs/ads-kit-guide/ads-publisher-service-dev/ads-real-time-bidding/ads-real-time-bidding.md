...
开发者需要在广告请求参数[AdRequestParams](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adrequestparams)中添加实时竞价相关参数。
...
开发者需要在广告请求成功后的回调AdLoadListener.[onAdLoadSuccess](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#onadloadsuccess)或MultiSlotsAdLoadListener.[onAdLoadSuccess](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#onadloadsuccess)中，处理广告返回的实时竞价结果[Advertisement](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisement).biddingInfo。

实时竞价结果信息如下所示：

![](../../../images/a794d5fd/note_3.0-zh-cn.png) 

回传竞价结果，需要申请使用Internet网络权限[ohos.permission.INTERNET](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-all#ohospermissioninternet)。详细申请权限流程请参考[开发准备](/ads-kit-guide/development-preparation)。
