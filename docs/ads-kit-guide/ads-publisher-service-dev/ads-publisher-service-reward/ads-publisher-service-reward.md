...
![](../../../images/52b7b1d5/zh-cn_image_0000002583438811.png)
...
| [showAd](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisingshowad)(ad: Advertisement, options: AdDisplayOptions, context?: common.UIAbilityContext): void | 展示广告，通过AdDisplayOptions进行广告展示参数设置。  说明：为了保证广告能正确展示，该接口必须和请求广告接口配套使用。 |
...
2. 获取OAID。
   ...
   ![](../../../images/52920f1c/note_3.0-zh-cn.png) 

   使用以下示例中提供的测试广告位时，必须先获取OAID信息。
3. 请求单广告位广告。

   需要先创建一个AdLoader对象，通过AdLoader的[loadAd](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#loadad)方法请求广告，最后通过[AdLoadListener](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#adloadlistener)，来监听广告的加载状态。
...
2. 事件订阅。
   ...
   在订阅到公共事件后，可以从[CommonEventData](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/process-thread-communi-arkts/commonevent/js-apis-inner-commonevent-commoneventdata/js-apis-inner-commonevent-commoneventdata)的parameters参数中获取激励广告页面变化状态和奖励信息。
...
2. 展示广告。
   ...
   开发者需要调用[showAd](/ref/ads-api/ads-arkts/js-apis-advertising/js-apis-advertising#advertisingshowad)方法来展示广告，ads为[请求广告](#请求广告)返回的广告信息，在每次展示广告前需要注册[事件订阅](#事件订阅)中定义的监听器。
...
![](../../../images/5c1ff7b8/zh-cn_image_0000002552958766.png)
...
![](../../../images/1d5c78dc/note_3.0-zh-cn.png) 
...
1. 设置激励广告的奖励配置。
   ...
   ![](../../../images/af975647/zh-cn_image_0000002583478767.png)
2. （可选）设置自定义数据customData和userId。

   您在[展示广告第2点](/ads-kit-guide/ads-publisher-service-dev/ads-publisher-service-reward#展示广告)之前可以设置自定义数据customData和userId。示例代码如下所示：
   ...
   ![](../../../images/4cd28907/note_3.0-zh-cn.png) 
...
5. 获取公钥列表。
   ...
   ![](../../../images/b9fe6010/zh-cn_image_0000002552799118.png)

   通过点击上图所示的“获取密钥”按钮弹出如下所示的弹框，获取“开发者ID”和“密钥”。

   ![](../../../images/1c09cda9/zh-cn_image_0000002583438813.png)
