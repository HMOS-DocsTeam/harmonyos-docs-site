...
- 目标应用接收时，可便捷的处理图片内容。例如：将一张图片分享给畅连，发送给畅连好友。
  ...
  ![](../../../../images/7d0172b6/zh-cn_image_0000002583479181.png)
...
2. 构造分享数据。
   ...
   ![](../../../../images/ebdc990a/note_3.0-zh-cn.png) 

   沙箱路径可通过[fileUri.getUriFromPath](/ref/core-file-api/core-file-arkts/js-apis-file-fileuri/js-apis-file-fileuri#fileurigeturifrompath)方法获取文件URI。
3. 额外增加一条数据。
