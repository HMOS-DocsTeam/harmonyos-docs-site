...
从分享详情页返回分享面板时，可通过设置resultCode值为特定的[ShareAbilityResultCode](/ref/share-api/share-arkts/share-system-share/share-system-share#shareabilityresultcode)，以告知分享面板做出不同的处理，具体处理方式如下：
