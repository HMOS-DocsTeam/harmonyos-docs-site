...
通过意图框架服务，目标应用可以将联系人信息共享到分享推荐区。参考：[习惯推荐-接入方案](/intents-kit-guide/intents-habit-rec/intents-habit-rec-access-programme)。

![](../../../../images/410013b7/note_3.0-zh-cn.png) 

该示例代码无法直接运行，需要申请意图框架白名单。参见：[Intents Kit接入流程](/intents-kit-guide/intents-access-flow)。
