...
1. 首先排查是否是分享API使用不当导致抛出异常，具体参考[分享服务API](/ref/share-api/share-arkts/share-system-share/share-system-share)和[错误码](/ref/share-api/share-arkts/share-error-code/share-error-code)，找到问题后修改代码。
