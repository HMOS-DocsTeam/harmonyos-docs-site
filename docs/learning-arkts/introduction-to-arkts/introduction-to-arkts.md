...
如需详细了解ArkTS语言，请参阅[ArkTS具体指南](/arkts/arkts-overview)和[DevEco Studio](/ide-tools-overview)。
...
![](../../images/3a09e808/note_3.0-zh-cn.png) 
...
更多的使用动态import的业务场景和使用实例见[动态import](/arkts/arkts-runtime/arkts-runtime-module/arkts-dynamic-import)。
...
- 方式三：导入Kit包含的所有模块的接口能力。例如：
  ...
  ![](../../images/e4487adf/note_3.0-zh-cn.png) 
...
![](../../images/daf27174/caution_3.0-zh-cn.png) 

应用开发中，在[release模式下构建](/ide-hvigor-configuration/ide-hvigor-build-har#section19788284410)源码HAR，并同时[开启混淆](/arkts/arkts-compilation-tool-chain/arkts-arkguard/source-obfuscation)时，由于编译产物为JS文件，而在JS中没有注解的实现机制，因此会在编译过程中被移除，导致无法通过注解实现AOP插桩。

为避免因此引起的功能异常，禁止在JS HAR(编译产物中存在JS的HAR包)中使用注解。

如果需要在release模式并且开启混淆的情况下构建含有注解的HAR包，可以构建[字节码HAR](/ide-hvigor-configuration/ide-hvigor-build-har#section16598338112415)。
...
- 以上类型的数组
  ...
  ![](../../images/068d3ec4/note_3.0-zh-cn.png) 
...
- 以上常量组成的数组
  ...
  ![](../../images/76d9432d/note_3.0-zh-cn.png) 
...
![](../../images/854ea09b/note_3.0-zh-cn.png) 
...
[MVVM代码示例](/arkui/arkts-ui-development/arkts-state-management/arkts-mvvm#代码示例)提供了一个完整的基于ArkUI的应用程序，以展示其GUI编程功能。

有关ArkUI功能的更多详细信息，请参见ArkUI[基本语法概述](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-basic-syntax-overview)。
