...
本节罗列了ArkTS不支持或部分支持的TypeScript特性。完整的列表以及详细的代码示例和重构建议，请参考[约束说明](#约束说明)。更多案例请参考[适配指导案例](/learning-arkts/typescript-to-arkts-migration/arkts-more-cases)。
...
![](../../../images/63d264b2/caution_3.0-zh-cn.png) 
