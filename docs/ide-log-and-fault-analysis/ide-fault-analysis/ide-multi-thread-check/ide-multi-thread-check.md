...
- ****方式一****
  ...
  ![](../../../images/6976d91d/zh-cn_image_0000002561753747.png)
...
- ****方式三****
  ...
  通过调用[setMultithreadingDetectionEnabled接口](/ref/arkts-api/arkts-arkts/js-apis-util/js-apis-util#setmultithreadingdetectionenabled23)开启。

### 使用方舟多线程检测

1. 运行或调试当前应用。
2. 当程序出现多线程安全问题时，会弹出Crash log信息，点击信息中的链接即可跳转至引起多线程安全问题的代码处。关于多线程安全问题的分析方法请参考[使用Node-API接口产生的异常日志/崩溃分析](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-about-crash)。

   ![](../../../images/5c5735ad/zh-cn_image_0000002561753751.png)
...
- 方式一
  ...
  ![](../../../images/a9221042/zh-cn_image_0000002530753806.png)
...
![](../../../images/1cb93922/zh-cn_image_0000002530753810.png)
