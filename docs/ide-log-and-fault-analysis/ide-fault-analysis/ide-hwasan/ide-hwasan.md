...
HWASan（Hardware-Assisted Address Sanitizer）是一款类似于[ASan](/ide-log-and-fault-analysis/ide-fault-analysis/ide-asan)的内存错误检测工具。 与ASan相比，HWASan使用的内存减少很多，因而更适合用于整个系统的检测。关于HWASan的检测原理请参考[HWASan检测原理](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-address-sanitizer-principle#section187526511146)。
...
1. 点击****Run > Edit Configurations > Diagnostics****，勾选****Hardware-Assisted Address Sanitizer****开启C++源码检测插桩。
   ...
   ![](../../../images/2456592b/zh-cn_image_0000002561833227.png)
...
1. 修改工程目录下的AppScope/app.json5文件，添加HWASan配置开关。
   ...
   ![](../../../images/9206f318/zh-cn_image_0000002561753241.png)
...
1. 运行或调试当前应用。
2. 当程序出现内存错误时，弹出HWASan log信息，点击信息中的链接即可跳转至引起内存错误的代码处。日志中各字段的说明请参考[HWASan日志规格](/system-debug-optimize/performance-analysis-kit/fault-analysis/address-sanitizer-guidelines#hwasan日志规格)，异常检测类型请参考[HWASan异常检测类型](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-hwasan-detection#section207321025115510)。

   ![](../../../images/36eda5cf/zh-cn_image_0000002530913298.png)
3. 如果是release应用，本地无工程代码，可以使用AnalyzeStackTrace功能，提供要解析堆栈的so，解析结果为源码地址。

   ![](../../../images/ae743fd3/zh-cn_image_0000002530753308.png)
