...
本页面提供应用图标和名称的配置指导。应用图标分为单层图标和分层图标。单层图标包含一个图片，分层图标包含前景图和背景图。图标规范详见[图标资源规范](https://developer.huawei.com/consumer/cn/doc/design-guides/application-icon-0000001953444009#section634668113212)，图标和名称配置约束详见[图标和名称配置](/ability-kit/stage-model-development/stage-model-application-components/application-component-configuration-stage#应用图标和名称配置)。
...
![](../../../images/884db1a5/zh-cn_image_0000002552957480.png)
...
![](../../../images/fd7a95ff/note_3.0-zh-cn.png) 
...
- ****方式一：配置app.json5****
  ...
  2. 在“AppScope\resources\base\media”文件夹下app\_layered\_image.json分层图标资源文件中，配置分层图标的前景资源与背景资源信息。
     ...
     ```
  3. 在[app.json5配置文件](/development-fundamentals/application-configuration-file-stage/app-configuration-file)中引用分层图标资源文件。示例如下：
...
![](../../../images/e24f81fd/note_3.0-zh-cn.png) 
