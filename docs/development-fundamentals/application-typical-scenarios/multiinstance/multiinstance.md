...
- 多实例的应用图标相同。
- 各实例共享[应用文件目录](/core-file-kit/app-file/app-sandbox-directory#应用文件目录与应用文件路径)下的文件数据。
...
1. 应用多实例的配置方法。
   ...
   在工程项目中对App/app.json5配置文件配置[multiAppMode](/development-fundamentals/application-configuration-file-stage/app-configuration-file#multiappmode标签)字段。具体配置如下：
