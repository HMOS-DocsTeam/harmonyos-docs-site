...
开发者使用[native\_avsession.h](/ref/avsession-api/avsession-c/avsession-headerfile/capi-native-avsession-h/capi-native-avsession-h)实现媒体会话，需要添加对应的头文件。
...
4. 注册播控命令事件监听，便于响应用户通过媒体会话控制方，例如播控中心下发的播控命令。
   ...
   ![](../../../images/3e898c7e/note_3.0-zh-cn.png) 
