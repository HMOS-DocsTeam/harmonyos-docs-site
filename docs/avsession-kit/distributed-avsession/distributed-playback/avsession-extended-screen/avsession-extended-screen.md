...
![](../../../../images/315dfe87/zh-cn_image_0000002583478555.png)
...
1. UIAbility A创建AVSession, 获取可用扩展屏投播设备并注册监听。
   ...
   ![](../../../../images/d1129c4a/note_3.0-zh-cn.png) 

   获取的屏幕信息CastDisplayInfo中包含屏幕ID，屏幕名称、状态以及分辨率宽度、高度基础属性，其中屏幕id 值同于[Display](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#display)的id，如需要获取更详细的信息可参考[Display获取设备信息说明](/ref/arkui-api/arkui-arkts/display-manager-api/js-apis-display/js-apis-display#displaygetalldisplays9)。
