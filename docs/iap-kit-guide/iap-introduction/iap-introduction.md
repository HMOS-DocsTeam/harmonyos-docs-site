...
![](../../images/fd7eedd0/note_3.0-zh-cn.png) 

[华为IAP范围覆盖](/iap-kit-guide/iap-appendix/iap-appendix-coverage)中的国家/地区（不包括中国境内（香港特别行政区、澳门特别行政区、中国台湾除外））仅支持Wearable设备。
...
| IAP Kit提供的能力 | 支持设备 |
| --- | --- |
| [IAP嵌入式收银台组件](/ref/iap-api/iap-arkts-component/iap-cashier-component/iap-cashier-component) | TV |

在TV设备拉起支付收银台页面为扫码支付页，参考示例如下：

![](../../images/af4c7a98/zh-cn_image_0000002583478921.png)
