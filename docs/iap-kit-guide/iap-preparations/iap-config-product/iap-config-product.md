...
- 如为自动续期订阅商品设置促销，包含[推介促销](/iap-kit-guide/iap-purchases/iap-subscription/iap-subscription-functions#提供优惠)（新用户促销）、[优惠促销](/iap-kit-guide/iap-purchases/iap-subscription/iap-subscription-functions#提供优惠)（自定义人群促销）和[挽留促销](/iap-kit-guide/iap-purchases/iap-subscription/iap-subscription-functions#提供优惠)（退订挽留促销，****即将开放****），具体操作请参见[设置促销价格](https://developer.huawei.com/consumer/cn/doc/app/promotion-renewal-0000001959074897#section128611895910)。
...
![](../../../images/94ae04c5/note_3.0-zh-cn.png) 
