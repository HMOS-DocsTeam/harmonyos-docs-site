...
在工程“AppScope/app.json5”下的****bundleName****需要与开发者在应用开发准备中[创建应用](/application-dev-overview#section13566816173114)时的包名保持一致。
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)平台，在“开发与服务”中选择目标项目，通过“项目设置 > 常规 > 应用”获取目标应用的****Client ID****。
   ...
   ![](../../../images/f2040b19/note_3.0-zh-cn.png) 
   ...
   ![](../../../images/193f31ce/zh-cn_image_0000002583438969.png)
