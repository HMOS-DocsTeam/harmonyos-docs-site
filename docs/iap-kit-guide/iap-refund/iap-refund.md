...
![](../../images/7cd816d4/note_3.0-zh-cn.png) 
...
1. 开发者登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，选择“APP”。 在应用列表中点击待处理退款订单的应用。
   ...
   ![](../../images/b018c83d/zh-cn_image_0000002583478939.png)
2. 在“运营”页签下，点击“产品运营 > 退款管理”，查看用户提交的退款申请，处理退款订单。

   ![](../../images/ef72f83f/zh-cn_image_0000002552799290.png)
3. 审核或查询退款订单。

   ****同意退款****：如果开发者同意退款，可在 “退款金额“下输入可退款金额，点击“同意”。在弹窗中点击“确认”，即可完成退款。

   ![](../../images/5b01f496/zh-cn_image_0000002583438985.png)

   ****驳回退款****：开发者不同意退款，可点击“驳回”，输入驳回原因，点击“确认”。

   ![](../../images/5ebe7d50/zh-cn_image_0000002552958940.png)

   ****退款详情页面审核退款****：开发者也可以在退款详情页面审核退款，输入退款金额后选择“同意”或“驳回”，点击提交，完成审核。

   ![](../../images/43be45be/zh-cn_image_0000002583478941.png)

   ****查询退款订单****：点击“已完成”页签，开发者可以查看所有已处理的退款订单。

   ![](../../images/258fc72f/zh-cn_image_0000002552799292.png)
...
![](../../images/6df30f9f/note_3.0-zh-cn.png) 
...
1. 在“手机设置 > 华为账号 > 付款与账单 > 购买记录”中点击待退款的订单，跳转至详情页面，点击“对订单有疑问”。
   ...
   ![](../../images/f310a6fa/zh-cn_image_0000002583438987.png)![](../../images/0aa774e3/zh-cn_image_0000002552958942.png)
2. 在“对订单有疑问”页面，点击“申请退款”，选择退款原因后，提交退款申请，提交后等待应用审核。

   ![](../../images/7e5cec23/zh-cn_image_0000002583478943.png)![](../../images/fec2686b/zh-cn_image_0000002552799294.png)

   用户提交退款后，可点击“查看退款记录”，在“退款记录”查看所有退款订单的退款状态。

   ![](../../images/a6690c58/zh-cn_image_0000002583438989.png)![](../../images/fe3e2ac4/zh-cn_image_0000002552958944.png)

## 应用内接入退款入口

![](../../images/09e0f253/note_3.0-zh-cn.png) 
...
用户发起退款后，应用客户端向IAP Kit发送[createRefundRequest](/ref/iap-api/iap-arkts/iap-iap/iap-iap#iapcreaterefundrequest)请求拉起退款页面，请求中需携带待退款的订单号（purchaseOrderId）。
