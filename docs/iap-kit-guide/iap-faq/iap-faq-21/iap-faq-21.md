...
支持开发者在创建订单/订阅订单时通过传入的[PurchaseParameter](/ref/iap-api/iap-arkts/iap-iap/iap-iap#purchaseparameter)设置developerPayload字段。developerPayload一般用于识别已支付的购买订单是由哪个应用账号发起的购买，并将此购买订单的相关权益正确发放给对应的应用账号。
