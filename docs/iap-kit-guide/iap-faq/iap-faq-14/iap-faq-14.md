...
![](../../../images/f6aca5d0/note_3.0-zh-cn.png) 
...
1. 查看服务器证书。
   ...
   ![](../../../images/36435484/zh-cn_image_0000002583478947.png)
2. 导出服务器证书链至文件中。

   依次点击“服务器证书 > 导出 > Base64 编码 ASCII，证书链（\*.pem;\*.crt） > 保存”，如下图所示：

   ![](../../../images/bd99272a/zh-cn_image_0000002552799298.png)
3. 导出的证书链文件，使用文本编辑器打开.crt文件，可以看到与下图格式相似的PEM格式的证书内容，从上到下依次为“服务器证书 > 中间证书 > 根证书”，将已经拼接好的证书链返回给IAP服务器。

   ![](../../../images/9351b625/zh-cn_image_0000002583438993.png)
