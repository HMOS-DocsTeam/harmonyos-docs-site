...
语言基础类库提供ConvertXML类，将XML文本转换为JavaScript对象，输入为待转换的XML字符串及转换选项，输出为转换后的JavaScript对象。具体转换选项可见[API参考@ohos.convertxml](/ref/arkts-api/arkts-arkts/js-apis-convertxml/js-apis-convertxml)。
...
1. 引入所需的模块。
   ...
   ```
2. 输入待转换的XML，设置转换选项。支持的转换选项及含义，请参见[ConvertOptions](/ref/arkts-api/arkts-arkts/js-apis-convertxml/js-apis-convertxml#convertoptions)。

   ![](../../../../images/ee16f34f/note_3.0-zh-cn.png) 
