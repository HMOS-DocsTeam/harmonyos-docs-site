...
Buffer模块各接口使用详见：[@ohos.buffer](/ref/arkts-api/arkts-arkts/js-apis-buffer/js-apis-buffer)。
...
FastBuffer模块各接口使用详见：[@ohos.fastbuffer](/ref/arkts-api/arkts-arkts/js-apis-fastbuffer/js-apis-fastbuffer)。
