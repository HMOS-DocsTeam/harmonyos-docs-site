...
![](../../../../images/b9e79b21/zh-cn_image_0000002583477529.png)
...
![](../../../../images/129a72ea/zh-cn_image_0000002552797880.png)
...
ArkTS提供了TaskPool和Worker两种并发能力供开发者选择，各自的运作机制和注意事项请见[TaskPool简介](/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction)和[Worker简介](/arkts/arkts-concurrency/multithread-concurrency/worker-introduction)，两者之间实现的特点和适用场景也存在差异，请见[TaskPool和Worker的对比](/arkts/arkts-concurrency/multithread-concurrency/taskpool-vs-worker)。
