...
![](../../../images/38a6addc/note_3.0-zh-cn.png) 

当Promise被reject且未通过catch方法处理时，会触发globalUnhandledRejectionDetected事件。可使用[errorManager.on('globalUnhandledRejectionDetected')](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-errormanager/js-apis-app-ability-errormanager#errormanageronglobalunhandledrejectiondetected18)接口监听该事件，以全局捕获未处理的Promise reject。
