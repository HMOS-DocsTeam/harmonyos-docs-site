...
并且，由于ArkGuard混淆工具仅支持基础混淆能力，开发者不应只依赖ArkGuard来保证应用的安全性，对于源码安全有高要求的开发者，应考虑使用[应用加密](/system-security/code-protect)、第三方安全加固等安全措施来保护代码。

## 混淆机制及流程

下图为应用编译的简要流程图：

![](../../../../images/8eeedceb/zh-cn_image_0000002552797898.png)

开发者可以在模块的build-profile.json5配置文件中开启混淆功能，详细参考[字节码混淆开启指南](/arkts/arkts-compilation-tool-chain/arkts-arkguard-bytecode/bytecode-obfuscation-guide)，从而在编译打包的过程中自动对abc进行混淆处理。
...
![](../../../../images/ac10b0ab/caution_3.0-zh-cn.png) 
...
![](../../../../images/839ce40c/caution_3.0-zh-cn.png) 
...
![](../../../../images/6e391b3b/caution_3.0-zh-cn.png) 
...
控制字节码混淆是否输出调试信息，开启后会生成混淆日志，请参考[混淆效果](/arkts/arkts-compilation-tool-chain/arkts-arkguard-bytecode/bytecode-obfuscation-guide#查看混淆效果)，默认不开启。
...
![](../../../../images/f6df73a1/caution_3.0-zh-cn.png) 
