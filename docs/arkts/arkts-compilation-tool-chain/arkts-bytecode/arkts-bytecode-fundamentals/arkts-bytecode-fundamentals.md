...
- 本文中所有采用代码形式描述的内容均遵循[ArkTS语言规范](/learning-arkts/introduction-to-arkts)。
...
![](../../../../images/f228f372/caution_3.0-zh-cn.png) 
...
![](../../../../images/0533896e/caution_3.0-zh-cn.png) 
...
![](../../../../images/26810463/caution_3.0-zh-cn.png) 
...
共享词法环境是一类特殊的词法环境。与一般词法环境的区别在于，共享词法环境中的每个词法变量都是[sendable对象](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable)。方舟编译器通过共享词法环境实现词法变量在多线程中共享。
...
| 0x07fb | PREF\_IMM16\_ID16\_ID16\_IMM16\_V8 | callruntime.definesendableclass RRRR, @AAAA, @BBBB, +CCCC, vDD | R：方舟运行时内部使用的16位保留数字  A：[sendable class](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable-class)的构造函数的method id  B：literal id  C：方法A的形参数量  D：父类 | 使用索引B对应的字面量数组和父类D，创建一个A类的对象，并将其存放到acc中。 |
...
| 0x08fb | PREF\_IMM16 | callruntime.ldsendableclass +AAAA | A：词法环境层级 | 将A个层次外的词法环境的[sendable class](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable-class)存放到acc中。 |
...
| 0x09fb | PREF\_IMM8 | callruntime.ldsendableexternalmodulevar +AA | A：槽位号 | 将槽位号为A的外部模块变量存放到acc中。此指令仅出现在sendable class和[sendable function](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable#sendable-function)中。 |
...
| 0x15fb | PREF\_IMM8 | callruntime.ldlazymodulevar +AA | A：槽位号 | 将槽位号为A的外部模块变量存放到acc中。此指令仅适用于通过[lazy import](/arkts/arkts-runtime/arkts-runtime-module/arkts-lazy-import)导入的模块变量。 |
