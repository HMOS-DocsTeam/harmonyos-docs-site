...
具体参考：[napi\_load\_module\_with\_info](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-load-module-with-info)。

## napi\_load\_module

在主线程内加载hap/hsp/har/native模块，参数传递简便。加载场景有限制，例如无法在子线程中使用该接口。

具体参考：[napi\_load\_module](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-load-module)。
