...
应用开发的有些场景中，如果希望根据条件导入模块或者按需导入模块，可以使用动态import代替[静态import](/learning-arkts/introduction-to-arkts#导入)。下面是可能会需要动态import的场景：
...
![](../../../../images/d2637eaa/note_3.0-zh-cn.png) 
...
![](../../../../images/e29afd98/zh-cn_image_0000002583477541.png)

HAR之间的依赖关系转移至HAP/HSP后：

![](../../../../images/eb2dfe93/zh-cn_image_0000002552797892.png)
...
- 如果引用了其他工程模块、远程包或集成HSP，需确保在[工程级build-profile.json5文件](/ide-hvigor-configuration-file/ide-hvigor-build-profile-app)中的****useNormalizedOHMUrl****配置一致，同时设置为true或false，否则可能导致运行错误：****Cannot find dynamic-import module library****。

****使用实例****

下面的实例通过在单向依赖HAP->HAR1->HAR2->HAR3之上增加依赖HAR2->HAR1、HAR3->HAR1，形成了循环依赖。

![](../../../../images/85fb5905/zh-cn_image_0000002583477541.png)
