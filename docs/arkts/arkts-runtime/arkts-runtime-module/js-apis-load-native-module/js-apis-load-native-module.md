...
[loadNativeModule接口](/ref/common-basic-arkts/js-apis-common-load-native-module/js-apis-common-load-native-module)用于同步动态加载Native模块，目的是按需加载所需要的模块。使用该接口会增加加载so文件的时间，开发者需评估其对功能的影响。
...
![](../../../../images/b79772b0/note_3.0-zh-cn.png) 
