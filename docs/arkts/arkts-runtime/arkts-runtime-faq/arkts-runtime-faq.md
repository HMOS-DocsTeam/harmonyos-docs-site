...
![](../../../images/e308ba73/note_3.0-zh-cn.png) 
...
1. 使用[errorManager.on()](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-errormanager/js-apis-app-ability-errormanager#errormanageronerror)捕获到Async函数产生的unhandledrejection事件，再通过编写errorManager.on()注册的回调函数，来进行异常处理操作。
...
![](../../../images/21c3f344/caution_3.0-zh-cn.png) 
...
![](../../../images/a81c2923/zh-cn_image_0000002583437589.png)
...
![](../../../images/cf967247/note_3.0-zh-cn.png) 
