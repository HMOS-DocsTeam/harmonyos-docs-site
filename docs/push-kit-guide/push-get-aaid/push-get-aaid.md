...
| 接口名 | 描述 |
| --- | --- |
| [getAAID](/ref/push-api/push-arkts/push-aaid-api/push-aaid-api#aaidgetaaid-1)(): Promise&lt;string&gt; | 获取AAID，使用Promise异步返回结果。 |
| [deleteAAID](/ref/push-api/push-arkts/push-aaid-api/push-aaid-api#aaiddeleteaaid-1)(): Promise&lt;void&gt; | 删除AAID，使用Promise异步返回结果。 |
...
1. 导入AAID模块及相关公共模块。
   ...
   ```
2. 调用AAID.[getAAID](/ref/push-api/push-arkts/push-aaid-api/push-aaid-api#aaidgetaaid-1)()方法获取AAID信息。
