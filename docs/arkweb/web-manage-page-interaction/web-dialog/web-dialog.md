...
当前，ArkWeb暂未提供默认的应用弹框。如果需要网页的弹框能够正常使用，应用需要通过[onAlert](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onalert)、[onConfirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onconfirm)和[onPrompt](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onprompt9)接口自定义弹框功能。
...
应用可以通过[onAlert](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onalert)事件监听网页alert方法，并创建合适的弹框。

- 用[AlertDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ts-methods-alert-dialog-box/ts-methods-alert-dialog-box)创建弹框。
  ...
  ```
- 用[CustomDialog-AlertDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ohos-arkui-advanced-dialog/ohos-arkui-advanced-dialog#alertdialog)创建弹框。
  ...
  ![](../../../images/d9be15d4/zh-cn_image_0000002583438267.gif)
...
应用可以通过[onConfirm](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onconfirm)事件监听网页confirm方法，并创建合适的弹框。
...
- 用[AlertDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ts-methods-alert-dialog-box/ts-methods-alert-dialog-box)创建弹框。
  ...
  ```
- 用[CustomDialog-ConfirmDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ohos-arkui-advanced-dialog/ohos-arkui-advanced-dialog#confirmdialog)创建弹框。
  ...
  ![](../../../images/4059159d/zh-cn_image_0000002552958222.gif)
...
应用可以通过[onPrompt](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#onprompt9)事件监听网页prompt方法，并创建合适的弹框。

- 用[CustomDialog-CustomContentDialog](/ref/arkui-api/arkui-declarative-comp/dialog-boxes/ohos-arkui-advanced-dialog/ohos-arkui-advanced-dialog#customcontentdialog12)创建弹框。
...
![](../../../images/00734817/zh-cn_image_0000002583478223.gif)
