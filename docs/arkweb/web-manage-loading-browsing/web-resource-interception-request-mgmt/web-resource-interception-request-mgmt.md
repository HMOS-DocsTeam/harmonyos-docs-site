...
Web组件支持在应用拦截到页面请求后自定义响应请求能力。开发者通过[onInterceptRequest()](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web-events/arkts-basic-components-web-events#oninterceptrequest9)接口来实现自定义资源请求响应。自定义请求能力可以用于开发者自定义Web页面响应、自定义文件资源响应等场景。
...
- 被拦截后的页面
  ...
  ![](../../../images/2ecb6635/zh-cn_image_0000002583478227.png)
...
- 被拦截后的页面
  ...
  ![](../../../images/760ed1e8/zh-cn_image_0000002552798578.png)
