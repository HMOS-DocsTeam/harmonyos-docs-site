...
![](../../../images/2314facd/zh-cn_image_0000002552798576.png)

![](../../../images/358affbb/note_3.0-zh-cn.png) 

- 如果需要评估调试版本（未上架应用市场）应用的兼容性，先开启开发者选项，然后开启坚盾守护模式。
- 可以采用Device Security Kit提供的[查询设备安全模式(C/C++)能力](/system-security/device-security-kit-guide/devicesecurity-securitymode)，判断坚盾守护模式是否开启。
