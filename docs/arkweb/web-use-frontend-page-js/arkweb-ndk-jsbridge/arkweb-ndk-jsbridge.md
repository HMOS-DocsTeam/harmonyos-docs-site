...
应用使用ArkTS、C++语言混合开发，或本身应用架构较贴近于小程序架构，自带C++侧环境，推荐使用ArkWeb在Native侧提供的[ArkWeb\_ControllerAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi)、[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)实现JSBridge功能。

![](../../../images/cb50c93b/zh-cn_image_0000002552798564.png)
...
![](../../../images/8838b387/zh-cn_image_0000002583438259.png)
...
另外针对同步接口[registerJavaScriptProxyEx](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#registerjavascriptproxyex)和异步接口[registerAsyncJavaScriptProxyEx](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#registerasyncjavascriptproxyex)，新增了参数[permission](#前端页面调用应用侧函数)字段，用于调用权限控制。
...
在ArkWeb Native侧，需要先获取API结构体，才能调用结构体里的Native API。ArkWeb Native侧API通过函数[OH\_ArkWeb\_GetNativeAPI](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-interface-h/capi-arkweb-interface-h#oh_arkweb_getnativeapi)获取，根据入参type不同，可分别获取[ArkWeb\_ControllerAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi)、[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)结构体。其中，[ArkWeb\_ControllerAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi)对应ArkTS侧[web\_webview.WebviewController API](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller)，[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)对应ArkTS侧[ArkWeb组件API](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web/arkts-basic-components-web)。
...
通过[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)注册组件生命周期回调，调用接口前，建议通过[ARKWEB\_MEMBER\_MISSING](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-type-h/capi-arkweb-type-h#宏定义)校验该函数结构体中是否存在对应函数指针，以避免SDK与设备ROM不匹配导致crash问题。
...
通过[registerJavaScriptProxyEx](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#registerjavascriptproxyex)将应用侧函数注册至前端页面，注册后在下次加载或者重新加载后生效。
...
使用[runJavaScript](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#runjavascript)调用前端页面函数。
...
ArkWeb Native侧需要先获取API结构体，才能调用结构体里的Native API。ArkWeb Native侧API通过函数[OH\_ArkWeb\_GetNativeAPI](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-interface-h/capi-arkweb-interface-h#oh_arkweb_getnativeapi)获取，根据入参type不同，可分别获取[ArkWeb\_ControllerAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi)、[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)函数指针结构体。其中，[ArkWeb\_ControllerAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi)对应ArkTS侧[web\_webview.WebviewController API](/ref/arkweb-api/arkweb-arkts/js-apis-webview/arkts-apis-webview-webviewcontroller/arkts-apis-webview-webviewcontroller)，[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)对应ArkTS侧[ArkWeb组件API](/ref/arkweb-api/arkweb-comp/ts-basic-components-web/arkts-basic-components-web/arkts-basic-components-web)。
...
通过[ArkWeb\_ComponentAPI](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-componentapi/capi-web-arkweb-componentapi)注册组件生命周期回调，在调用接口前建议通过[ARKWEB\_MEMBER\_MISSING](/ref/arkweb-api/arkweb-c/arkweb-headerfile/capi-arkweb-type-h/capi-arkweb-type-h#宏定义)校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致crash问题。
...
通过[registerJavaScriptProxy](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#registerjavascriptproxy)将应用侧函数注册至前端页面，注册后在下次加载或者重新加载后生效。
...
通过[runJavaScript](/ref/arkweb-api/arkweb-c/arkweb-struct/capi-web-arkweb-controllerapi/capi-web-arkweb-controllerapi#runjavascript)调用前端页面函数。
