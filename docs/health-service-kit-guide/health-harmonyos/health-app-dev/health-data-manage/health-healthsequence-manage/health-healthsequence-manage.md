...
| 接口名 | 描述 |
| --- | --- |
| [saveData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoresavedata-2)(healthSequence: [HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)[] | [HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)): Promise&lt;void&gt; | 保存健康记录，入参为单个[HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)或[HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)数组。 |
| [readData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstorereaddata-2)&lt;T extends [HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)&gt;(request: [HealthSequenceReadRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequencereadrequest)): Promise&lt;T[]&gt; | 查询健康记录，通过[HealthSequenceReadRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequencereadrequest)设置查询条件，可按数据类型，字段、时间范围等条件查询。 |
| [deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-5)(healthSequence: [HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence) | [HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)[]): Promise&lt;void&gt; | 删除健康记录，按入参删除指定的健康记录，可传入单个[HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)或[HealthSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequence)数组。 |
| [deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-2)(request: [HealthSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequencedeleterequest) | [HealthSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequencedeleterequest)[]): Promise&lt;void&gt; | 删除健康记录，按[HealthSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthsequencedeleterequest)删除，可设置数据类型、时间范围、数据源等删除条件。 |
...
3. 创建健康记录。
   ...
   ```
4. 调用[saveData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoresavedata-2)方法执行保存数据请求，并处理返回结果。
...
2. 创建查询健康记录请求。
   ...
   ```
3. 调用[readData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstorereaddata-2)方法执行查询请求，并处理返回结果。
...
2. 查询待删除健康记录。
   ...
   const healthSequences = await healthStore.readData(healthSequenceReadRequest);
   ```
3. 调用[deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-5)方法执行删除请求，并处理返回结果。
...
2. 创建删除健康记录请求。
   ...
   ```
3. 调用[deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-2)方法执行删除请求，并处理返回结果。
