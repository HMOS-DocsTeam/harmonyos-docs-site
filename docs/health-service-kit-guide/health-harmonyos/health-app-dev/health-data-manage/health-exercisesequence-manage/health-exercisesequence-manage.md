...
| 接口名 | 描述 |
| --- | --- |
| [saveData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoresavedata-1)(exerciseSequence: [ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)[] | [ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)): Promise&lt;void&gt; | 保存锻炼记录，入参为单个[ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)或[ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)数组。 |
| [readData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstorereaddata-1)&lt;T extends [ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)&gt;(request: [ExerciseSequenceReadRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequencereadrequest)): Promise&lt;T[]&gt; | 查询锻炼记录，通过[ExerciseSequenceReadRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequencereadrequest)设置查询条件，可按数据类型，字段、时间范围等条件查询。 |
| [deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-4)(exerciseSequence: [ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence) | [ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)[]): Promise&lt;void&gt; | 删除锻炼记录，按入参删除指定的锻炼记录，可传入单个[ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)或[ExerciseSequence](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequence)数组。 |
| [deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-1)(request: [ExerciseSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequencedeleterequest) | [ExerciseSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequencedeleterequest)[]): Promise&lt;void&gt; | 删除锻炼记录，按[ExerciseSequenceDeleteRequest](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#exercisesequencedeleterequest)删除，可设置数据类型、时间范围、数据源等删除条件。 |
...
3. 创建锻炼记录。
   ...
   ```
4. 调用[saveData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoresavedata-1)方法执行保存数据请求，并处理返回结果。
...
2. 创建查询请求。
   ...
   ```
3. 调用[readData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstorereaddata-1)方法执行查询请求，并处理返回结果。
...
2. 查询待删除的锻炼记录。
   ...
   const runningSequences = await healthStore.readData<healthStore.exerciseSequenceHelper.running.Model>(sequenceReadRequest);
   ```
3. 调用[deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-4)方法执行删除请求，并处理返回结果。
...
2. 创建删除请求。
   ...
   ```
3. 调用[deleteData](/ref/health-service-api/health-api-arkts/health-api-healthstore/health-api-healthstore#healthstoredeletedata-1)方法执行删除请求，并处理返回结果。
