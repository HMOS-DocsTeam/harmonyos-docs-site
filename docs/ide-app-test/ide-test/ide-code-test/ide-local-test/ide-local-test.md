...
![](../../../../images/e89b48d6/note_3.0-zh-cn.png) 
...
1. 在工程目录下打开待测试模块（支持HAP、HAR、HSP模块）下的ets文件，将光标置于代码中任意位置，单击****右键 > Show Context Actions**** ****> Create Local Test****或快捷键****Alt+Enter********（macOS为Option+Enter） > Create Local Test****创建测试类。
   ...
   ![](../../../../images/7ad1fa9c/zh-cn_image_0000002561833569.png)
2. 在弹出的Create Local Test窗口，输入或选择如下参数。
   ...
   ![](../../../../images/1cf30248/zh-cn_image_0000002561753591.png)
3. DevEco Studio在test目录下自动生成对应的测试类。在测试类中，DevEco Studio会生成对应方法的用例模板，具体测试代码需要开发者根据业务逻辑进行开发，具体请参考[单元测试框架](/ut/arkxtest-guidelines/unittest-guidelines)。

   ![](../../../../images/fe68564d/note_3.0-zh-cn.png) 
...
![](../../../../images/8d709aca/zh-cn_image_0000002530753656.png)

也可以通过如下方式，执行Local Test：

- 在工具栏主菜单单击****Run > Run'测试名称'****。
- 在DevEco Studio的右上角，选择一项测试任务的配置，然后单击右侧的![](../../../../images/25edbe4e/zh-cn_image_0000002530913656.png)按钮，执行Local Test。

  ![](../../../../images/33bf6f29/zh-cn_image_0000002561753609.png)

执行完测试任务后，查看测试结果。

![](../../../../images/2b4fb6f6/zh-cn_image_0000002530753644.png)
...
![](../../../../images/f8ded182/zh-cn_image_0000002530753642.png)

在断点命中时，下方将出现Debug窗口。开发者可在该窗口中进行断点管理与基础调试能力的可视化操作，在断点命中时可查看当前线程的变量和堆栈信息。

![](../../../../images/d8be5c1c/zh-cn_image_0000002530753666.png)

断点命中时，在代码编辑器窗口单击右键，在弹出的菜单中将出现调试模式特有功能，如计算表达式、添加变量监视等。

![](../../../../images/732011ab/zh-cn_image_0000002561833587.png)

在跳出所有断点后，测试结束，与运行模式相同，在测试窗口查看测试结果。

![](../../../../images/5e2714e5/zh-cn_image_0000002561753599.png)
...
- 方式一：在工程目录中，选中文件，单击****右键 > Run '测试文件名称' with Coverage****，以覆盖率统计模式执行测试任务。
  ...
  ![](../../../../images/570f9539/zh-cn_image_0000002530913648.png)

- 方式二：在DevEco Studio的右上角，选择测试任务，然后单击右侧的![](../../../../images/8726074e/zh-cn_image_0000002561753581.png)按钮，执行测试。

  ![](../../../../images/9ae7aa68/zh-cn_image_0000002530913666.png)

启动测试后，进行编译构建，底部将出现Cover窗口，构建结束后自动拉起Cover窗口，测试任务结束后，窗口中会打印测试报告的路径。

![](../../../../images/f71ec403/zh-cn_image_0000002530913638.png)

点击链接可打开报告，查看代码覆盖率详情，关于覆盖率的计算方式请参考[查看覆盖率报告](/ide-app-test/ide-test/ide-ui-test#section10394362109)。

![](../../../../images/0080a5ad/zh-cn_image_0000002561833561.png)

在Cover窗口中，单击rerun按钮可以按照之前的设置，重新执行覆盖率用例。

![](../../../../images/9a9c8a27/zh-cn_image_0000002530753648.png)
...
2. 在****Run/Debug Configurations****界面，单击****+****按钮，在弹出的下拉菜单中，单击****Local Test****。
   ...
   ![](../../../../images/45c5ced4/zh-cn_image_0000002530913632.png)
3. 根据实际情况，配置Local Test的运行参数。 然后单击****OK****，完成配置。

   ![](../../../../images/aac912a8/zh-cn_image_0000002561753575.png)
...
- coverage：是否生成覆盖率报告，缺省默认是true，在&lt;module-path&gt;/.test/default/outputs/test/reports路径下生成两份报告，一份是html格式（index.html），一份是json格式（coverageReport.json），具体参考[查看覆盖率报告](/ide-app-test/ide-test/ide-ui-test#section10394362109)。
- scope：格式为\{suiteName\}#\{methodName\}或\{suiteName\}，分别表示测试用例级别或测试套件级别的测试，缺省默认是执行当前模块的所有用例。

![](../../../../images/7f02803f/note_3.0-zh-cn.png) 
