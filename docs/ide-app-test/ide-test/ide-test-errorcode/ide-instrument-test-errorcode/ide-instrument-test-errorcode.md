...
title: "仪器测试错误码"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-instrument-test-errorcode
...
- 在运行配置窗口修改Method name。
  ...
  ![](../../../../images/8d55f19b/zh-cn_image_0000002530912706.png)
...
![](../../../../images/a68fa01e/zh-cn_image_0000002561832635.png)
...
![](../../../../images/ecede0d5/zh-cn_image_0000002561752657.png)
...
![](../../../../images/e79379a2/zh-cn_image_0000002530752714.png)
...
检查hap/hsp包是否已签名，如果未签名，请参考[配置调试签名](/ide-signing)。
...
1. 参考[使用本地真机运行应用](/ide-run-device)连接设备，并打开开发者选项中的USB调试。
2. 移除多余的设备，确保只连接一个设备。
