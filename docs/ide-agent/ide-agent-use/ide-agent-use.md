...
1. 点击界面右上方![](../../images/8e90dca4/zh-cn_image_0000002530913180.png "点击放大")按钮；或者点击界面右上方****Settings****![](../../images/268df10d/zh-cn_image_0000002561833109.png)按钮，选择****Agent****；或者在输入框左下角下拉框选择****Create Agent****，进入配置页面。

   ![](../../images/aef0543f/zh-cn_image_0000002544361586.png "点击放大")
2. 点击![](../../images/b72decfc/zh-cn_image_0000002561753133.png "点击放大")按钮，填写自定义Agent的相关信息。点击****Add****，将创建自定义Agent。
   - ****Name****：必填，自定义Agent的名称。
   - ****Prompt Description****：可选，自定义Agent的提示词。
   - ****MCP Tools****：可选，添加MCP工具，具体请参考[MCP配置](/ide-agent/ide-agent-mcp)。
   ...
   - ****Select Model****：必填，选择需要使用的模型，具体请参考[模型（Model）配置](/ide-agent/ide-agent-model)。

   ![](../../images/7f7182ee/zh-cn_image_0000002530753184.png "点击放大")
3. 在****All Agents****下展示所有智能体。

   ![](../../images/b5088784/zh-cn_image_0000002575106855.png)
4. 设置自动执行开关和白名单列表。
   ...
   ![](../../images/c678c0ff/zh-cn_image_0000002530913186.png "点击放大")
...
6. 点击置灰的三方模型会跳转到Service Provider配置界面（如****deepseek-chat****），填写****API Key****字段即可添加模型。
   ...
   ![](../../images/73120ef0/zh-cn_image_0000002544201944.png "点击放大")
...
1. Agent配置完成后，可以通过如下两种方式开启调用：
   ...
   ![](../../images/c96ef4d9/zh-cn_image_0000002561753131.png)
2. 选择自定义Agent后，在右侧可以切换模型，默认使用配置Agent时添加的模型。

   ![](../../images/3fce9ca4/zh-cn_image_0000002530913190.png "点击放大")
3. 根据业务需要，进行智能问答、代码生成、代码智能解读等，CodeGenie将会调用自定义Agent和选择的模型生成内容。

   ![](../../images/0c05afc0/zh-cn_image_0000002561833103.png "点击放大")
