...
![](../../images/2acf9391/note_3.0-zh-cn.png) 
...
1. 点击界面右上方![](../../images/b11375ef/zh-cn_image_0000002561752687.png)按钮，或者点击界面右上方****Settings****![](../../images/4559cc5b/zh-cn_image_0000002530752736.png)按钮，选择****Rules****，进入配置页面。

   ![](../../images/ea77fa2b/zh-cn_image_0000002575092879.png)
2. 选择规则长度限制，包括****Quality first****、****Token efficiency first****，默认为Token efficiency first。DevEco Studio 6.1.0 Beta2版本新增。
   ...
   ![](../../images/61d16540/zh-cn_image_0000002574933315.png)
3. 以有网络为例，点击![](../../images/d65ae90d/zh-cn_image_0000002530752750.png)图标导入规则文件。无网络时操作界面可能存在差异，以实际为准。

   ![](../../images/4c62e0dd/zh-cn_image_0000002530912740.png)
4. 选择和管理规则文件。Global Rules列表全量展示了默认规则（Default rule）、自定义规则（Custom rule）和无规则（No rules），当前仅支持选择其中一个规则。若选择No rules，则全局规则不生效。
   - 将鼠标悬停在默认规则上，点击![](../../images/85e50895/zh-cn_image_0000002530752734.png)编辑图标，开发者可查看具体规则内容。
   - 将鼠标悬停在自定义规则上，会出现编辑和删除按钮，方便开发者管理自定义规则。

   ![](../../images/5fdd3f8c/zh-cn_image_0000002530752752.png)

## Project Rules配置

1. 点击界面右上方![](../../images/9a76dcc9/zh-cn_image_0000002561832647.png)按钮，或者点击界面右上方****Settings****![](../../images/a2d3ffda/zh-cn_image_0000002530752738.png)按钮，选择****Rules****，进入配置页面。
2. 创建或导入Rule文件。
   ...
   ![](../../images/fcbdbd2f/zh-cn_image_0000002530752726.png)
3. 管理规则文件。将鼠标悬停在工程文件上，会出现编辑和删除按钮，方便开发者管理工程规则文件。

   ![](../../images/7daf6207/zh-cn_image_0000002561752681.png)
