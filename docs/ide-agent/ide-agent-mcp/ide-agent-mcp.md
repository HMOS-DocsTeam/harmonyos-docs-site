...
1. 点击界面右上方![](../../images/18eba94f/zh-cn_image_0000002561752883.png "点击放大")按钮，或者点击界面右上方****Settings****![](../../images/0b626b58/zh-cn_image_0000002530912934.png)按钮，选择****MCP****，进入配置页面。

   ![](../../images/aaca4cf5/zh-cn_image_0000002575045063.png "点击放大")
2. 添加MCP工具。点击![](../../images/365b3ae8/zh-cn_image_0000002561832863.png "点击放大")按钮或****Add Manually****手动添加，点击****MCP Market****或****Add from MCP Market****从MCP市场添加。

   ![](../../images/3e1f750a/zh-cn_image_0000002544364856.png "点击放大")

   - ****手动添加****：在编辑框中填写MCP工具的配置信息，填写完成后点击****Add****。

     ![](../../images/9b58582f/note_3.0-zh-cn.png) 

     MCP Server支持三种通信方式：Stdio 、Server-Sent Events (SSE) 和Streamable HTTP。

     Stdio方式支持配置cmd、args和env字段，SSE和Streamable HTTP方式支持配置url字段。

     ![](../../images/75a255e4/zh-cn_image_0000002544205206.png "点击放大")
   - ****从MCP市场添加****：在搜索框中搜索目标MCP工具，点击![](../../images/30ffcd65/zh-cn_image_0000002530912938.png "点击放大")按钮添加。

     ![](../../images/0035f2e6/zh-cn_image_0000002574885083.png "点击放大")
3. 在****MCP Tools****列表中，展示所有MCP工具信息，包括名称、连接状态、启用状态。同时，将鼠标悬浮在工具上会显示三个操作按钮：刷新、编辑和删除，方便开发者管理工具。

   ![](../../images/62c654f1/zh-cn_image_0000002575045065.png "点击放大")
