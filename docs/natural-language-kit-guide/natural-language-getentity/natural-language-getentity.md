...
2. 配置输入文本框。
   ...
   ```
3. 配置按钮，调用实体抽取[textProcessing.getEntity](/ref/natural-language-api/natural-language-arkts/natural-language-text-processing-api/natural-language-text-processing-api#textprocessinggetentity)接口。
