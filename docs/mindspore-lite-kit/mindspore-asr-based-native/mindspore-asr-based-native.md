...
开发者可以使用[MindSpore](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-module/capi-mindspore/capi-mindspore)，在UI代码中集成MindSpore Lite能力，快速部署AI算法，进行AI模型推理，实现语音识别的应用。
...
调用[@ohos.multimedia.media](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media/arkts-apis-media)、[@ohos.multimedia.audio](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio/arkts-apis-audio)，实现播放音频的功能。
...
在 entry/src/main/cpp/mslite\_napi.cpp，调用[MindSpore](/ref/mindspore-lite-api/mindspore-lite-c/mindspore-lite-module/capi-mindspore/capi-mindspore)，依次对3个模型进行推理，推理代码流程如下。
