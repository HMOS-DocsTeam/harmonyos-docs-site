...
1. 开发者首先将原始模型（如：ONNX、CAFFE等）用MindSpore Lite模型转换工具，生成后缀为.ms的模型文件。MindSpore Lite Kit所支持的ONNX算子，可查询[MindSpore Lite Kit算子支持列表](/mindspore-lite-kit/mindspore-lite-appendix/mindspore-lite-supported-operators)，以确保模型转换成功。
2. 然后在代码中调用MindSpore Lite推理引擎接口，执行[模型推理](/mindspore-lite-kit/deployment/mindspore-lite-guidelines)。
...
![](../../images/6af346be/note_3.0-zh-cn.png) 
...
![](../../images/4bd8e0b9/note_3.0-zh-cn.png) 
