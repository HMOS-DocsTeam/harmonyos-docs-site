...
1. 点击页面右侧菜单栏CodeGenie图标完成登录后，可以通过如下三种方式进入页面生成窗口：
   ...
   ![](../images/92917511/zh-cn_image_0000002530753720.png)
2. 可以通过如下方式生成页面：
   - 在对话框输入页面主题要求，点击![](../images/09f57661/zh-cn_image_0000002530753724.png)图标，等待生成页面；
   ...
   ![](../images/dc40d25e/zh-cn_image_0000002561753659.png)
3. 对生成的页面进行预览，预览时支持切换亮色和暗色模式；点击历史对话中的****Back to Current Session****回退到之前的页面；点击****Generate**** ****UI files****查看生成的UI文件内容；新增和修改页面/页面中的关键信息，通过多轮对话完善页面。
   ...
   ![](../images/80e15ab0/zh-cn_image_0000002530913714.png)
4. 点击****Save to Project****，在弹窗中设置页面名称及指定页面所保存的模块。

   ![](../images/fd94a654/zh-cn_image_0000002561833639.png)
5. 点击****Next****将生成的代码文件及资源保存至工程中。弹窗中绿色文件为新增，蓝色文件表示该文件存在更改，点击****Finish****完成添加。

   ![](../images/3501aa73/zh-cn_image_0000002561753661.png)
