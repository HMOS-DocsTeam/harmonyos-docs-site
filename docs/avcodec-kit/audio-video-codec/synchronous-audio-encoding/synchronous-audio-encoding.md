...
支持的编码能力请参考[AVCodec支持的格式](/avcodec-kit/avcodec-support-formats#音频编码)。

****适用场景****

通常推荐使用异步模式，异步模式请参考[音频编码](/avcodec-kit/audio-video-codec/audio-encoding)。若需要主动请求buffer去编码PCM，则可以使用同步模式。

- 音频录制

  通过录制传入PCM，然后编码成对应格式的码流，最后封装成所需格式的文件。具体封装方法请参考[媒体数据封装](/avcodec-kit/file-muxing-demuxing/audio-video-muxer)。
- 音频编辑

  编辑PCM后导出音频文件的场景，需要编码成对应音频格式，最后封装成所需格式的文件。具体封装方法请参考[媒体数据封装](/avcodec-kit/file-muxing-demuxing/audio-video-muxer)。

![](../../../images/e1f8ed14/note_3.0-zh-cn.png) 
...
![](../../../images/750651a0/zh-cn_image_0000002583478543.png)
...
![](../../../images/bf2cf300/note_3.0-zh-cn.png) 
...
3. 调用OH\_AudioCodec\_Configure配置编码器。
   ...
   ![](../../../images/96ecbd09/zh-cn_image_0000002583438587.png)

   各音频编码类型参数范围说明：

   ![](../../../images/8c9d9858/zh-cn_image_0000002552958542.png)
...
6. 调用OH\_AudioCodec\_Destroy()销毁编码器实例，释放资源。
   ...
   ![](../../../images/fb123afa/note_3.0-zh-cn.png) 
