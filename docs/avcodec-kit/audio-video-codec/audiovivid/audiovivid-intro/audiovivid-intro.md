...
Audio Vivid端到端播放包括调用系统编解码能力进行[解封装](/avcodec-kit/audio-video-codec/audiovivid/audiovivid-avdemuxer)、[解码](/avcodec-kit/audio-video-codec/audiovivid/audiovivid-audiodecoder)，以及调用系统播放能力进行[渲染播放](/avcodec-kit/audio-video-codec/audiovivid/audiovivid-audiorenderer)两个部分。
