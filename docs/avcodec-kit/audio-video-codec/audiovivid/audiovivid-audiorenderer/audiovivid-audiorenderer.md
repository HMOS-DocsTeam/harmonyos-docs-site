...
在获取到解码后的Audio Vivid的PCM数据和元数据之后，可以调用OHAudio的相关播放接口，进行Audio Vivid格式音源的渲染播放。详细的API说明请参考[OHAudio API参考](/ref/audio-api/audio-c/audio-module/capi-ohaudio/capi-ohaudio)。
