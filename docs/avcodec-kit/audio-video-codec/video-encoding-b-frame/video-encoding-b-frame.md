...
- ****支持的平台****：该能力与平台能力有关，可以通过[OH\_AVCapability\_IsFeatureSupported](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcapability-h/capi-native-avcapability-h#oh_avcapability_isfeaturesupported)接口查询系统支持情况。
- ****支持的API版本****：API20及以后。
- ****支持的编码器****：该能力与编码器能力有关，可以通过[OH\_AVCodec\_GetCapabilityByCategory](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avcapability-h/capi-native-avcapability-h#oh_avcodec_getcapabilitybycategory)接口查询支持情况。
...
基础编码功能请参考[视频编码](/avcodec-kit/audio-video-codec/video-encoding)开发指南，下面仅针对B帧编码做具体说明。
...
2. 在配置阶段，配置使能B帧编码特性的参数。
   ...
   ![](../../../images/4fd3b054/caution_3.0-zh-cn.png) 
