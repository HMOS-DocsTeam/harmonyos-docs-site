...
当前支持的编码能力请参考[AVCodec支持的格式](/avcodec-kit/avcodec-support-formats#音频编码)。

****适用场景****

- 音频录制

  通过录制传入PCM，然后编码出对应格式的码流，最后[封装](/avcodec-kit/file-muxing-demuxing/audio-video-muxer)为所需格式的音频文件。
- 音频编辑

  编辑PCM后导出音频文件的场景，需要编码成对应音频格式后再[封装](/avcodec-kit/file-muxing-demuxing/audio-video-muxer)成文件。

![](../../../images/2ff9f0a5/note_3.0-zh-cn.png) 
...
![](../../../images/01f2e761/zh-cn_image_0000002552798892.png)
...
![](../../../images/183def08/note_3.0-zh-cn.png) 
...
3. 调用OH\_AudioCodec\_RegisterCallback()注册回调函数。
   ...
   ![](../../../images/af3503fa/caution_3.0-zh-cn.png) 
...
4. 调用OH\_AudioCodec\_Configure设置编码器。
   ...
   ![](../../../images/eecc2afd/zh-cn_image_0000002583438587.png)

   各音频编码类型参数范围说明：

   ![](../../../images/516999c1/zh-cn_image_0000002552958542.png)
...
3. 调用OH\_AudioCodec\_PushInputBuffer()，写入待编码的数据。需开发者填充完整的输入数据后调用。
   ...
   ![](../../../images/cda9650a/note_3.0-zh-cn.png) 
...
8. 调用OH\_AudioCodec\_Destroy()销毁编码器实例，释放资源。
   ...
   ![](../../../images/52ad3519/note_3.0-zh-cn.png) 
