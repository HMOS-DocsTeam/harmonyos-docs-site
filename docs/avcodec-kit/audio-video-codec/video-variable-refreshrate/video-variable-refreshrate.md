...
![](../../../images/09844eb3/zh-cn_image_0000002552958552.png)
...
基础解码功能请参考[视频解码开发指南](/avcodec-kit/audio-video-codec/video-decoding)，下面仅针对于基础视频解码过程中存在的区别做具体说明。

1. 解码器配置阶段，添加视频可变帧率使能开关。

   示例中的变量说明如下：

   • videoDec：视频解码器实例的指针。创建方式参考[Surface模式下创建解码器实例对象](/avcodec-kit/audio-video-codec/video-decoding#surface模式)。
