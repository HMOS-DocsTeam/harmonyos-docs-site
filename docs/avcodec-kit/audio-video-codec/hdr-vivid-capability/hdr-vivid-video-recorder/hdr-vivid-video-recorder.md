...
![](../../../../images/ed3103ed/note_3.0-zh-cn.png) 
...
![](../../../../images/df5f2f37/note_3.0-zh-cn.png) 
...
3. 配置异步回调函数。
   ...
   具体可参考：[视频编码Surface模式](/avcodec-kit/audio-video-codec/video-encoding#surface模式)中的“步骤3：调用OH\_VideoEncoder\_RegisterCallback()设置回调函数”。
4. 配置编码器。
...
5. 获取surface，并设置给相机。
   ...
   具体可参考：[视频编码Surface模式](/avcodec-kit/audio-video-codec/video-encoding#surface模式)中的“步骤6：获取surface”。
6. 调用OH\_VideoEncoder\_Start()启动编码器。

   具体可参考：[视频编码Surface模式](/avcodec-kit/audio-video-codec/video-encoding#surface模式)中的“步骤8：调用OH\_VideoEncoder\_Start()启动编码器”。
...
![](../../../../images/31670410/note_3.0-zh-cn.png) 
