...
- 媒体基础能力（Media Foundation）：提供媒体数据处理的公共基础类型，包括[AVBuffer](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avbuffer-h/capi-native-avbuffer-h)、[AVFormat](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-avformat-h/capi-native-avformat-h)等。
...
- 视频编解码
  ...
  ![](../../images/faa4fc2f/zh-cn_image_0000002583478539.png)

  具体开发指导请参考[视频解码Surface模式](/avcodec-kit/audio-video-codec/video-decoding#surface模式)、[视频编码Surface模式](/avcodec-kit/audio-video-codec/video-encoding#surface模式)。
- 音频编解码
  ...
  ![](../../images/b1e9e090/zh-cn_image_0000002552798890.png)

  具体开发指导请参考[音频解码](/avcodec-kit/audio-video-codec/audio-decoding)、[音频编码](/avcodec-kit/audio-video-codec/audio-encoding)。
- 文件解析封装
  ...
  ![](../../images/a778abd3/zh-cn_image_0000002583438585.png)

  具体开发指导请参考[媒体数据解析](/avcodec-kit/file-muxing-demuxing/audio-video-demuxer)、[媒体数据封装](/avcodec-kit/file-muxing-demuxing/audio-video-muxer)。
...
- 媒体数据解析支持模拟器，具体规格参考[解封装格式](/avcodec-kit/avcodec-support-formats#媒体数据解析)。
- 媒体数据封装支持模拟器，具体规格参考[封装格式](/avcodec-kit/avcodec-support-formats#媒体数据封装)。
- 视频编解码仅软件解码支持模拟器（h265格式除外），具体规格参考[视频解码](/avcodec-kit/avcodec-support-formats#视频解码)。
- 音频编解码支持模拟器，具体规格参考[音频编解码](/avcodec-kit/avcodec-support-formats#音频解码)。
