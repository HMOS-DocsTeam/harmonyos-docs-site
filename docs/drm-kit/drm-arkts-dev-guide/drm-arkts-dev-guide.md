...
详细的API说明请参考[@ohos.multimedia.drm(数字版权保护)](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm/arkts-apis-drm)。
...
2. 导入BusinessError模块抛出Drm Kit接口的错误码。
   ...
   ```
3. （可选）调用[getMediaKeySystems](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmgetmediakeysystems12)，获取设备支持的DRM解决方案名称和唯一标识的列表。
...
4. （可选）调用[isMediaKeySystemSupported](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmismediakeysystemsupported)，查询设备是否支持对应DRM解决方案名称、媒体类型、安全保护级别的DRM解决方案。
...
5. 调用[createMediaKeySystem](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-f/arkts-apis-drm-f#drmcreatemediakeysystem)，创建MediaKeySystem实例。
...
6. （可选）调用[on('keySystemRequired')](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#onkeysystemrequired)，设置MediaKeySystem状态监听事件。
   ...
   ```
7. （可选）调用[getCertificateStatus](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#getcertificatestatus)，获取设备DRM证书状态。

   ```
   let certificateStatus: drm.CertificateStatus = mediaKeySystem.getCertificateStatus();
   ```
8. （可选）调用[generateKeySystemRequest](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#generatekeysystemrequest)和[processKeySystemResponse](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#processkeysystemresponse)，生成设备DRM证书请求与处理设备DRM证书响应。
   ...
   ```
9. 调用[createMediaKeySession](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#createmediakeysession)，创建MediaKeySession实例。
...
10. （可选）设置MediaKeySession状态监听事件。
    ...
    - 使用[on('keyRequired')](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#onkeyrequired)接口监听媒体密钥请求事件，此时建议完成媒体密钥请求与处理流程。
      ...
      ```
    - 使用[on('keyExpired')](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#onkeyexpired)接口监听媒体密钥过期事件。
      ...
      ```
    - 使用[on('expirationUpdate')](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#onexpirationupdate)接口监听媒体密钥有效期更新事件。
      ...
      ```
    - 使用[on('keysChange')](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#onkeyschange)接口监听媒体密钥变换事件。
      ...
      ```
11. （可选）调用[requireSecureDecoderModule](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#requiresecuredecodermodule)，查询是否需要安全解码。
    ...
    ```
12. 调用[generateMediaKeyRequest](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#generatemediakeyrequest)和[processMediaKeyResponse](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#processmediakeyresponse)，生成媒体密钥请求与处理媒体密钥响应。
    ...
    ```
13. （可选）调用[restoreOfflineMediaKey](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#restoreofflinemediakeys)，恢复离线媒体密钥。
    ...
    ```
14. （可选）调用[checkMediaKeyStatus](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysession/arkts-apis-drm-mediakeysession#checkmediakeystatus)，检查媒体密钥状态。
    ...
    ```
15. （可选）调用[getOfflineMediaKeyIds](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#getofflinemediakeyids)获取离线媒体密钥标识列表，调用[getOfflineMediaKeyStatus](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#getofflinemediakeystatus)获取离线媒体密钥状态，调用[clearOfflineMediaKeys](/ref/drm-api/drm-arkts/js-apis-drm/arkts-apis-drm-mediakeysystem/arkts-apis-drm-mediakeysystem#clearofflinemediakeys)删除离线媒体密钥。
