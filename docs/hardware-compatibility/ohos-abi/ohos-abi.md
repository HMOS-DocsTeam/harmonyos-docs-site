...
当前通过[DevEco Studio构建NDK工程](/build-with-ndk/build-with-ndk-ide)时，不支持armeabi-v7a编译环境。如需要在HarmonyOS中使用该编译环境，需要通过[CMake方式构建](/build-with-ndk/build-with-ndk-cmake)。
