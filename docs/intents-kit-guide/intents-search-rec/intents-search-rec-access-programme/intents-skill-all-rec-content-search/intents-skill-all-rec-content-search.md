...
![](../../../../images/02dfc277/zh-cn_image_0000002552959324.png)
...
构建意图对象，并且调用[insightIntent.shareIntent](/ref/intents-api/intents-arkts-api/intents-arkts-api-insightintent/intents-arkts-api-insightintent#insightintentshareintent-1)，实现意图共享。可同时构建多个PlayMusic或PlayMusicList的意图对象。
