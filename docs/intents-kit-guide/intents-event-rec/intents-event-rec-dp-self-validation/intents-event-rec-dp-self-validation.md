...
title: "开发者测试"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/intents-event-rec-dp-self-validation
kit: ai
...
1. 事件共享：开发者登录应用即可[获取云侧事件捐赠的SID](/intents-kit-guide/intents-event-rec/intents-event-rec-access-programme#获取sid)，然后触发事件推送，将事件内容同步到华为云，具体操作可参考[开发者指南-事件推荐方案章节](/intents-kit-guide/intents-event-rec/intents-event-rec-access-programme)。
