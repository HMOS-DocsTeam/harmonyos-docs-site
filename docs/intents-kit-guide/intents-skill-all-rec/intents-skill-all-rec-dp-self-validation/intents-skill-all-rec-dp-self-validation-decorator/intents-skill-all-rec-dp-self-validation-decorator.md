...
1. 登录&lt;`https://developer.huawei.com/consumer/cn/&gt;` ，通过“管理中心 > 生态服务 > 智慧服务 > 小艺开放平台（原HarmonyOS服务开放平台） > 意图框架”，点击“立即体验”进入意图注册入口，需使用与应用上架相同的账号登录。
   ...
   ![](../../../../images/c2ba6a72/zh-cn_image_0000002552959320.png)

   ![](../../../../images/36a79b87/zh-cn_image_0000002583479321.png)
2. 点击注册意图新增意图集。

   ![](../../../../images/f97c590b/zh-cn_image_0000002552799682.png)

   1. 点击新增注册意图，填写注册信息进行创建。

      ![](../../../../images/07c1b024/zh-cn_image_0000002583439377.png)
   ...
   2. 编辑意图集基本信息。
      ...
      ![](../../../../images/fca4c2ff/zh-cn_image_0000002552959332.png)
...
3. 添加意图。
   ...
   1. 切换至意图页签并添加意图。
      ...
      ![](../../../../images/039fb8af/zh-cn_image_0000002583479333.png)
   2. 选择自定义意图并填入意图信息（根据接入方案进行填入）并确定。

      ![](../../../../images/fdbd7e53/zh-cn_image_0000002552799684.png)
   3. 展开已创建的意图，并填入自定义输入、输出参数，点击保存。

      ![](../../../../images/2bf66481/zh-cn_image_0000002583439379.png)
4. 添加意图使用样本（意图样本用于提升模型对意图识别的准确率）。

   1. 意图使用样本可通过新增/批量导入进行上传。
   2. 若无需添加意图使用样本，打开是否已提供线下样本开关即可。

      ![](../../../../images/3e378b83/zh-cn_image_0000002552959334.png)
5. 添加账号至真机测试用户组。

   1. 切换至测试页签，点击编辑用户组。

      ![](../../../../images/f37a2be7/zh-cn_image_0000002583479335.png)
   2. 点击新增组，输入新用户组名称（名称自定义）。

      ![](../../../../images/d9e023c3/zh-cn_image_0000002552799686.png)
   3. 选择已新增用户组，点击查看进入。

      ![](../../../../images/2efc568e/zh-cn_image_0000002583439381.png)
   4. 点击添加用户，选择账号类型为邮箱/手机号码，填入后点击确定（测试用户须为该项目团队下的成员）。

      ![](../../../../images/8c8c3b5d/zh-cn_image_0000002552959336.png)
   5. 返回测试页签，选择所创建的真机测试用户组进行保存，点击开始测试准备，开发者即可通过HarmonyOS 6.0.0(20)版本及以上的设备在小艺进行端到端测试。

      ![](../../../../images/6d924dee/zh-cn_image_0000002583479337.png)
