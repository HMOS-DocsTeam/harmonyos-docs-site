...
1. 账号登录：
   ...
   1. 通过“&lt;`https://developer.huawei.com/consumer/cn/&gt;` > 管理中心 > 生态服务 > 智慧服务 > 小艺开放平台（原HarmonyOS服务开放平台） > 意图框架”，进入意图注册入口。
      ...
      ![](../../../images/259879b3/zh-cn_image_0000002552799690.png)
   2. 点击“立即体验”即可进入意图注册入口。

      ![](../../../images/5656bc1e/zh-cn_image_0000002583439385.png)
2. 注册意图集

   1. 如图，点击“注册意图”。

      ![](../../../images/43ff19f4/zh-cn_image_0000002552959340.png)
   2. 选择“MCP协议”并填写基本信息创建意图集。
      ...
      ![](../../../images/129594a6/zh-cn_image_0000002583479341.png)
3. 编辑：创建后自动进入”插件编辑“页面。
   ...
   1. 编辑基本信息：
      ...
      ![](../../../images/df0f8124/zh-cn_image_0000002552799692.png)
4. 工具检查：保存后切换至"工具"页签。若基本信息配置无误，工具列表中会根据基本信息内容自动生成1条/多条信息。

   ![](../../../images/f66b6842/zh-cn_image_0000002583439387.png)

   1. 出现工具列表：请检查工具入参，参数是否重复或者缺失，参数类型是否正确。若一切无误，则配置成功。

      ![](../../../images/4b04d557/zh-cn_image_0000002552959342.png)
...
5. 审核：切换至“发布”页签，点击“提交审核”。
   ...
   1. 选择发布渠道，点击确定，提交审核。
      ...
      3. 插件市场：开发者上架MCP server，可供开发者自己开发的智能体调用，也可供平台上其他开发者开发智能体时调用（回到开发者源头平台去开服）。
         ...
         ![](../../../images/417d1665/zh-cn_image_0000002583479343.png)
