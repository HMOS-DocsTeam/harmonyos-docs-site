...
目前系统模板仅支持进度条模板，通知模板[NotificationTemplate](/ref/notification-api/notification-arkts/notification/js-apis-inner-notification-notificationtemplate/js-apis-inner-notification-notificationtemplate)中的data参数为用户自定义数据，用于显示与模块相关的数据。

## 接口说明

[isSupportTemplate()](/ref/notification-api/notification-arkts/js-apis-notificationmanager/js-apis-notificationmanager#notificationmanagerissupporttemplate)是查询模板是否支持接口，目前仅支持进度条模板。
...
2. 查询系统是否支持进度条模板，查询结果为支持downloadTemplate模板类通知。
   ...
   ![](../../../images/1fa51b20/note_3.0-zh-cn.png) 
