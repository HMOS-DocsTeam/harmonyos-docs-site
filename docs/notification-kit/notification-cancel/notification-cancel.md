...
通知取消接口如下。接口详情参见[@ohos.notificationManager (NotificationManager模块)](/ref/notification-api/notification-arkts/js-apis-notificationmanager/js-apis-notificationmanager)。
...
2. 发布通知。
   ...
   参考[发布文本类型通知](/notification-kit/publish-notification/text-notification)。
3. 取消通知。
