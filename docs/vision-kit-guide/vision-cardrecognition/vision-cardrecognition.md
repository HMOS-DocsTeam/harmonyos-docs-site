...
从5.1.1(19)开始，[CardRecognition](/ref/vision-api/vision-component/vision-card-recognition/vision-card-recognition#cardrecognition)接口中的callback参数废弃，请使用onResult代替。
...
![](../../images/9f2a7c65/zh-cn_image_0000002552799704.png)
...
以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](/ref/vision-api/vision-component/vision-card-recognition/vision-card-recognition)。

| 接口名 | 描述 |
| --- | --- |
| [CardRecognition](/ref/vision-api/vision-component/vision-card-recognition/vision-card-recognition#cardrecognition) | 卡证识别控件 |
| [CardRecognitionResult](/ref/vision-api/vision-component/vision-card-recognition/vision-card-recognition#cardrecognitionresult) | 卡证识别结果 |
