...
![](../../images/79efff19/zh-cn_image_0000002552799704.png)
...
以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](/ref/vision-api/vision-component/vision-document-scanner/vision-document-scanner)。

| 接口名 | 描述 |
| --- | --- |
| [DocumentScanner](/ref/vision-api/vision-component/vision-document-scanner/vision-document-scanner#documentscanner) | 文档扫描控件 |
| [DocumentScannerResultCallback](/ref/vision-api/vision-component/vision-document-scanner/vision-document-scanner#documentscannerresultcallback) | 文档扫描结果 |
