...
![](../../images/ef7d94c3/note_3.0-zh-cn.png) 
...
![](../../images/8dd29384/zh-cn_image_0000002552959352.png)

****图2**** 活体检测示意图

![](../../images/d2d71a29/zh-cn_image_0000002583479353.png)
...
以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness)。

| 接口名 | 描述 |
| --- | --- |
| [startLivenessDetection](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#startlivenessdetection)(config: InteractiveLivenessConfig): Promise&lt;boolean&gt; | 跳转到人脸活体检测页面的入口 |
| [getInteractiveLivenessResult](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#getinteractivelivenessresult)(): Promise&lt;InteractiveLivenessResult&gt; | 获取人脸活体检测的结果。使用Promise异步回调 |
...
1. 将实现人脸活体检测相关的类添加至工程。
   ...
   ```
2. 在module.json5文件中添加CAMERA权限，其中reason，abilities标签必填，配置方式参见[requestPermissions标签说明](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions#在配置文件中声明权限)。
...
6. 触发CAMERA权限校验。
   ...
   ```
7. 配置人脸活体检测控件的配置项[InteractiveLivenessConfig](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#interactivelivenessconfig)，用于跳转到人脸活体检测控件。

   配置中具体的参数可参考[API文档](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness)。
   ...
   ```
8. 调用interactiveLiveness的[startLivenessDetection](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#startlivenessdetection)接口，判断跳转到人脸活体检测控件是否成功。
   ...
   ```
9. 检测结束后回到当前界面，可调用interactiveLiveness的[getInteractiveLivenessResult](/ref/vision-api/vision-arkts/vision-interactive-liveness/vision-interactive-liveness#getinteractivelivenessresult)接口，验证人脸活体检测的结果。
