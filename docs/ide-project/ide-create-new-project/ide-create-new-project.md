...
title: "创建一个新的工程"
sidebar_position: 4
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-create-new-project
kit: devtools/setup
...
![](../../images/83ba1a4f/note_3.0-zh-cn.png) 

在运行DevEco Studio工程时，建议每一个运行窗口有2GB以上的可用内存空间。

## 创建和配置新工程

DevEco Studio提供了基础的工程模板资源，不同模板支持的设备类型、API Version可能不同，在创建新工程前，请提前了解各模板的相关信息，具体请参考[工程模板介绍](/ide-project/ide-template)。
...
2. 根据工程创建向导，选择创建Application或[Atomic Service](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomic-service-create-project)。再选择需要的Ability工程模板，然后单击****Next****。
   ...
   ![](../../images/8183f3fd/note_3.0-zh-cn.png) 
...
3. 在工程配置页面，需要根据向导配置工程的基本信息。
   ...
   - ****Module name****： 模块的名称。
   - ****Device type：****该工程模板支持的设备类型。设备类型说明请参考[deviceTypes标签](/development-fundamentals/application-configuration-file-stage/module-configuration-file#devicetypes标签)。
   - ****C++ Standard：****C++标准库，取值包括：Toolchain Default、C++11、C++14。

   ![](../../images/58969c26/zh-cn_image_0000002530913214.png)
...
2. 单击Sync Now进行同步。在Sync Check弹窗中点击****Yes****，同意将module.json5/config.json文件中的phone切换为OpenHarmony支持的default类型，并删除在OpenHarmony不适用的其他设备类型，同步成功无其他报错则工程创建完成。
   ...
   ![](../../images/c095ca3e/zh-cn_image_0000002561753155.png)

![](../../images/49a32228/note_3.0-zh-cn.png) 
