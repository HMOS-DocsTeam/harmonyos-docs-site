...
title: "添加Page"
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-add-page
kit: devtools/setup
...
1. 在Stage工程中选中ets文件夹下的pages，单击鼠标右键，选择****New > Page****，当前提供如下Page类型：
   ...
   ![](../../../images/5b5681ba/zh-cn_image_0000002563315237.png)

   ![](../../../images/7512f2af/note_3.0-zh-cn.png) 

   API 10工程中仅支持创建Page，展示基础的Hello World功能；如需使用场景化Page模板，请将工程切换为API 11及以上后进行开发。
2. 输入Page name（由大小写字母、数字和下划线组成），单击****Finish****完成添加。

   ![](../../../images/bfa9e7d7/zh-cn_image_0000002530753248.png "点击放大")
