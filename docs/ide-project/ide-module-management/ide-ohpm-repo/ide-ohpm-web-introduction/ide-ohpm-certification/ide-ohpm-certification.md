...
使用ohpm发布包时，需要先在配置文件.ohpmrc文件中配置publish\_id和key\_path。publish\_id对应发布码，key\_path对应私钥的地址，其详细发布流程见[使用命令行工具发布](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-quickstart#zh-cn_topic_0000001792256157_使用命令行工具发布)。认证管理主要是管理私钥对应的公钥信息，在用户使用ohpm发布包时进行校验。认证管理页面效果如下图所示：

![](../../../../../images/f698e94b/zh-cn_image_0000002530751476.png "点击放大")

1. 点击新增，弹出添加公钥面板，可以添加公钥信息。一个用户最多可以添加十条公钥信息，因此可以通过配置不同的公钥信息实现多人共享该用户使用ohpm进行发布包操作。页面效果如下图所示：

   ![](../../../../../images/f01e4e85/zh-cn_image_0000002561751425.png "点击放大")
2. 点击如何生成公钥，可查看公钥生成的说明，页面效果如下图所示：

   ![](../../../../../images/5204dabb/zh-cn_image_0000002530911462.png "点击放大")
3. 点击删除，可以删除已经存在的公钥信息，页面效果如下图所示：

   ![](../../../../../images/d36e5404/zh-cn_image_0000002561831399.png "点击放大")
...
![](../../../../../images/48e6d99d/zh-cn_image_0000002530751488.png "点击放大")

1. 点击生成只读Token，ohpm-repo将自动生成一个专用于ohpm客户端进行包信息查询（info）和安装包（install）操作的认证Token，页面效果如下图所示：

   ![](../../../../../images/1d9e8b14/zh-cn_image_0000002530751466.png "点击放大")
2. 点击生成读写Token，ohpm-repo将自动生成一个专用于ohpm客户端进行包信息查询（info）、安装包（install）、发布包（publish）、下架包（unpublish）和版本标记（dist-tags）操作的认证Token。页面效果如下图所示：
   ...
   ![](../../../../../images/969b56df/zh-cn_image_0000002530911472.png "点击放大")
3. 点击AccessToken指南，即刻显示使用教程，指导如何有效使用和配置AccessToken。页面效果如下图所示：

   ![](../../../../../images/c82a7e26/zh-cn_image_0000002561751415.png "点击放大")
4. 点击删除，删除对应的Token。页面效果如下图所示：

   ![](../../../../../images/1af51d40/zh-cn_image_0000002561831389.png "点击放大")
5. AccessToken的使用：
