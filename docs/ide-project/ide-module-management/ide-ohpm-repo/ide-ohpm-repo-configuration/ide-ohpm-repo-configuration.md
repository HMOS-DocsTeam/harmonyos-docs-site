...
![](../../../../images/ceeb3fa0/note_3.0-zh-cn.png) 
...
![](../../../../images/6ff131ed/caution_3.0-zh-cn.png) 
...
![](../../../../images/fcfffec9/note_3.0-zh-cn.png) 
...
![](../../../../images/400118d2/caution_3.0-zh-cn.png) 
...
![](../../../../images/c9bf41d4/note_3.0-zh-cn.png) 
...
![](../../../../images/303b0f25/caution_3.0-zh-cn.png) 
...
- config: 插件配置，具体为：
  ...
  - server: 仓库内容的下载地址，当[listen](#zh-cn_topic_0000001745376470_listen)的host为0.0.0.0且本机存在多个网络接口时，****必须配置****。
    ...
    - 当配置项[listen](#zh-cn_topic_0000001745376470_listen)的host为0.0.0.0时，如果本机仅存在一个网络接口，则server中的host默认为本机网络接口的ipv4地址；如果本机存在多个网络接口，则server中的host默认为本机获取到的第一个网络接口的ipv4地址，建议手动修改host为指定的本机ip/域名，例如listen为0.0.0.0:8088，故server需配置为`http://<本机ip/域名>:8088`；
    - 如果需要通过反向代理来访问ohpm-repo服务，则该字段须配置为反向代理服务器的域名地址，且需要配置[use\_reverse\_proxy](#section1074004784011)值为true。

![](../../../../images/09f0c754/caution_3.0-zh-cn.png) 
...
![](../../../../images/0ad84da1/caution_3.0-zh-cn.png) 
...
![](../../../../images/35eb2582/note_3.0-zh-cn.png) 
...
ohpm-repo从5.1.3版本开始支持自定义元数据规则校验，可以对oh-package.json5中部分字段开发定制化的校验规则。自定义元数据规则校验插件开发流程见[自定义元数据规则校验插件说明文档](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-appendix/ide-custom-metadata-rule-validation/ide-custom-metadata-rule-validation-config)。
...
![](../../../../images/b3d3b71c/caution_3.0-zh-cn.png) 
