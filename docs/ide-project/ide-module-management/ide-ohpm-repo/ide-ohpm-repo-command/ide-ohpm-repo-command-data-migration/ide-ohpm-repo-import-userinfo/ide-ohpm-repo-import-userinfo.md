...
已成功执行[export\_userinfo 命令](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-command/ide-ohpm-repo-command-data-migration/ide-ohpm-repo-export-userinfo)。
...
必须在import\_userinfo命令后面配置&lt;zip\_file&gt;参数，指定执行[export\_userinfo 命令](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-command/ide-ohpm-repo-command-data-migration/ide-ohpm-repo-export-userinfo)导出的zip文件。
