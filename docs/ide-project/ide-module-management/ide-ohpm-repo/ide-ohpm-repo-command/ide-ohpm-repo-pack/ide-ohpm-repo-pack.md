...
用于打包ohpm-repo部署目录[deploy\_root](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-configuration#zh-cn_topic_0000001745376470_关于-deploy_root)下的conf ，db和meta目录。
...
必须在pack命令后面配置&lt;deploy\_root&gt;参数，指定待打包的[ohpm-repo私仓部署目录](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-configuration#zh-cn_topic_0000001745376470_关于-deploy_root)。
...
![](../../../../../images/a995ba6a/zh-cn_image_0000002530911278.png "点击放大")
