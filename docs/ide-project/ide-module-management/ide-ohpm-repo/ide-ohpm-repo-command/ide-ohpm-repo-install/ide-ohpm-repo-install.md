...
![](../../../../../images/46374946/note_3.0-zh-cn.png) 

执行install成功后，会在&lt;deploy\_root&gt;/conf中生成一个运行时配置文件config.yaml，作为后续命令的配置文件，其中&lt;deploy\_root&gt;为[ohpm-repo部署目录](/ide-project/ide-module-management/ide-ohpm-repo/ide-ohpm-repo-configuration#zh-cn_topic_0000001745376470_关于-deploy_root)。
...
![](../../../../../images/c8126af7/caution_3.0-zh-cn.png) 
...
![](../../../../../images/6045d834/zh-cn_image_0000002530911294.png "点击放大")

## 注意

安装成功后，必须根据给出的提示信息刷新环境变量，针对Windows系统和Linux/Mac系统，有不同处理方式：

![](../../../../../images/91e5b046/note_3.0-zh-cn.png) 
