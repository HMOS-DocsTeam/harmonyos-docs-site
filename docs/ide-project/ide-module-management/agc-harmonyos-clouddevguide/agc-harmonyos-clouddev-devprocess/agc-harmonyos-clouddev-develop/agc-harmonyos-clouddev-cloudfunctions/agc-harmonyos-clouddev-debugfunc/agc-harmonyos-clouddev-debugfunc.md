...
- 请确保您已登录。
- 如果您的工程有代码逻辑涉及云函数调用云数据库，您需在调试前先[将整个云工程部署到AGC云端](/ide-project/ide-module-management/agc-harmonyos-clouddevguide/agc-harmonyos-clouddev-devprocess/agc-harmonyos-clouddev-deploy)，否则云端将没有相关数据及环境变量。
...
1. 右击“my-cloud-function”函数目录，选择“Debug 'my-cloud-function'”。
   ...
   ![](../../../../../../../images/0323a46c/note_3.0-zh-cn.png) 
...
5. 在弹出的“Cloud Functions Requestor”面板，配置触发事件参数。
   ...
   ![](../../../../../../../images/dd294b76/zh-cn_image_0000002179338412.png)
6. （可选）点击“Save”，可保存当前触发事件。

   ![](../../../../../../../images/882a9492/zh-cn_image_0000002179498072.png)

   点击右上角![](../../../../../../../images/e76839eb/zh-cn_image_0000002179498132.png)可展开保存的触发事件，后续可直接点击“Load”加载事件。对于不需要保存的触发事件，也可以点击“Delete”删除。

   ![](../../../../../../../images/f6e19a0b/zh-cn_image_0000002278063192.png)
7. 点击“Trigger”， 将会触发执行用户函数代码。执行结果将展示在“Result”框内，“cloudfunctions”窗口同时打印调试日志。

   ![](../../../../../../../images/19439efb/note_3.0-zh-cn.png) 

   “Result”框右侧的“Logs”面板仅用于在[通过远程调用方式调试函数](#section123191549587)时查看日志。

   ![](../../../../../../../images/3952bc84/zh-cn_image_0000002503613920.png)
8. （可选）如[配置了环境变量](#li15793566149)，可将变量信息传入到函数执行环境中，用于函数运行时读取。
   ...
   ![](../../../../../../../images/ad9a684a/zh-cn_image_0000002503615754.png)
9. 点击菜单栏![](../../../../../../../images/ae3643ae/zh-cn_image_0000002179338396.png)，可停止调试。
10. 根据调试结果修改函数代码后，点击![](../../../../../../../images/985deeb8/zh-cn_image_0000002179338420.png)重新以Debug模式启动调试，直至没有问题。
...
1. 参考[部署函数](/ide-project/ide-module-management/agc-harmonyos-clouddevguide/agc-harmonyos-clouddev-devprocess/agc-harmonyos-clouddev-develop/agc-harmonyos-clouddev-cloudfunctions/agc-harmonyos-clouddev-deployfunc)将需要调试的函数部署至AGC云端。
2. （可选）如函数代码涉及访问环境变量，需在AGC Portal函数列表中点击函数名称，为函数配置环境变量的值，供函数在运行时读取和使用。

   ![](../../../../../../../images/408ab1b2/zh-cn_image_0000002214858729.png)
3. 在菜单栏选择“View > Tool Windows > Cloud Functions Requestor”，使用事件模拟器（Cloud Functions Requestor）触发函数调用。

   ![](../../../../../../../images/dc6412bb/zh-cn_image_0000002179498140.png)
4. 在弹出的“Cloud Functions Requestor”面板，配置触发事件参数。
   ...
   ![](../../../../../../../images/ae658be4/zh-cn_image_0000002179338388.png)
5. 点击“Trigger”， 将会触发执行用户函数代码，执行结果将展示在“Result”框内。

   ![](../../../../../../../images/82693920/zh-cn_image_0000002214704345.png)
6. 点击“Logs”页签，可查看打印的日志定位问题。修改函数代码、重新部署函数后再次执行远程调用，直至没有问题。

   ![](../../../../../../../images/a391c654/zh-cn_image_0000002535303613.png)
7. 参考步骤1~5，完成其他函数的调试。
...
1. 在菜单栏选择“Run > Edit Configurations”。
   ...
   ![](../../../../../../../images/8f855236/zh-cn_image_0000002179498096.png)
2. 在“Run/Debug Configurations”窗口，点击![](../../../../../../../images/05d74af8/zh-cn_image_0000002214858773.png)，选择“Cloud Functions”，新增一个Run/Debug配置。

   ![](../../../../../../../images/cb4e6769/zh-cn_image_0000002214704341.png)
3. 自定义Run/Debug配置，完成后点击“Run”或“Debug”即可立即按当前自定义配置启动本地调试。

   如当前暂不使用自定义配置，可点击“OK”保存配置。后续有需要时再选择自定义配置，分别点击![](../../../../../../../images/225bb98b/zh-cn_image_0000002179338416.png)或![](../../../../../../../images/d0a74ed2/zh-cn_image_0000002214704373.png)进行Run或Debug。

   ![](../../../../../../../images/cc07f36a/zh-cn_image_0000002214704377.png)
   ...
   - Environment variables：函数运行的环境变量，为key-value形式。
     ...
     ![](../../../../../../../images/a38b4608/zh-cn_image_0000002179338424.png)
