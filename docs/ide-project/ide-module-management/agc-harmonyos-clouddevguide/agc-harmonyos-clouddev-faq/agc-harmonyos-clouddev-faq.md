...
title: "FAQ"
sidebar_position: 7
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/agc-harmonyos-clouddev-faq
kit: devtools/setup
...
![](../../../../images/65c0e0b1/zh-cn_image_0000002313987669.png)
...
![](../../../../images/92e61f96/zh-cn_image_0000002179338656.png)
...
- [将云存储的安全策略配置为始终可读写](/ide-project/ide-module-management/agc-harmonyos-clouddevguide/agc-harmonyos-clouddev-template/agc-harmonyos-clouddev-emptyability#li1693311281068)
- 参考[AuthProvider](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudcommon/cloudfoundation-cloudcommon#authprovider)获取用户凭据
...
![](../../../../images/90bfe984/zh-cn_image_0000002179338664.png)
...
出现此错误，是因为APP操作者的角色权限不足，请检查[操作的对象类型的权限配置](/ide-project/ide-module-management/agc-harmonyos-clouddevguide/agc-harmonyos-clouddev-devprocess/agc-harmonyos-clouddev-develop/agc-harmonyos-clouddev-clouddb/agc-harmonyos-clouddev-objecttype#li01856582915)。
...
![](../../../../images/69016d41/zh-cn_image_0000002214858977.png)
...
![](../../../../images/3d9e3f7e/zh-cn_image_0000002279650126.png)

****解决措施****

出现此错误，是因为网络连接SSL/TLS握手失败。建议检查[DevEco Studio Proxy代理配置](/ide-appendix/ide-environment-config#section10369436568)或本地网络防火墙/安全配置。
...
![](../../../../images/57b591f1/zh-cn_image_0000002279546734.png)

****解决措施****

出现此错误，是因为端云一体化开发的云侧工程是通过npm管理依赖，同步时需要通过npm去下载对应依赖。请参考[配置NPM代理](/ide-appendix/ide-environment-config#section197296441787)检查npm代理和网络情况。
...
![](../../../../images/f2e4258c/zh-cn_image_0000002214704601.png)
...
- app日志提示“"state":65”
  ...
  ![](../../../../images/f9f518e8/zh-cn_image_0000002179498352.png)
- upload进程的日志提示“403 Forbidden”（通过设置“No filters”模式、过滤“C01C50”关键字查找）

  ![](../../../../images/b6320c6d/zh-cn_image_0000002214858989.png)
