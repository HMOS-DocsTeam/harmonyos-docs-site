...
title: "生成单层图标"
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-apply-generated-icon
kit: devtools/setup
...
![](../../images/cee879b3/note_3.0-zh-cn.png) 
...
1. 在工程中选中模块或文件，右键单击****New > Image Asset****，进入图标配置页面。
   ...
   ![](../../images/570a7fde/zh-cn_image_0000002530752764.png "点击放大")

   ![](../../images/432d25d7/note_3.0-zh-cn.png) 
...
2. 需要根据向导配置图标样式、大小等基本信息。
   ...
   ![](../../images/36e28671/zh-cn_image_0000002561832681.png)
   ...
   ![](../../images/3373d5a4/zh-cn_image_0000002561752703.png)
3. 点击****Next****，确认图标的存储路径和相应的尺寸信息，图标将默认存放在****resources**** 目录下。点击****Finish****完成图标生成。
   ...
   ![](../../images/aa4aabd6/zh-cn_image_0000002561752701.png)
4. 如需配置桌面或设置页面出现的应用图标，可将module.json5文件中icon字段修改为新生成的图标名称；如需修改启动页的icon图标，可将module.json5文件中startWindowIcon字段修改为新生成的图标名称。

   ![](../../images/1b14717c/note_3.0-zh-cn.png) 

   - 当上述字段配置了新生成的图标名称后，系统会根据当前设备状态优先从相匹配的限定词目录，即步骤3生成的不同尺寸的图标文件中寻找资源。具体请参考[资源匹配](/resource-categories-and-access)。
