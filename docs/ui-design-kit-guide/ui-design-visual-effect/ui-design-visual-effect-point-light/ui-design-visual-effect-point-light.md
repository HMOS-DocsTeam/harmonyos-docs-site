...
从6.0.0(20) Beta1版本开始，新增支持[点光源效果](/ref/ui-design-api/ui-design-arkts/ui-design-hdseffect/ui-design-hdseffect#pointlight)。
...
2. 创建点光源发光效果。如果需要发光，配置sourceType属性；如果需要被照亮，配置illuminatedType属性。
   ...
   ![](../../../images/9a8b2671/zh-cn_image_0000002552798702.png)
