...
[HdsTabs](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdstabs/ui-design-hdstabs)容器组件扩展支持页签栏设置直接模糊和渐变模糊效果。

- 直接模糊

  ![](../../../images/08ba6539/zh-cn_image_0000002552958342.png)
- 渐变模糊

  ![](../../../images/3b40fb0a/zh-cn_image_0000002583478343.jpg)
...
2. 创建Hds一级容器组件，设置HdsTabs组件的barBackgroundStyle样式，可以自定义模糊的颜色和高度，实现渐变模糊。
   ...
   ![](../../../images/f410bb1f/note_3.0-zh-cn.png) 
