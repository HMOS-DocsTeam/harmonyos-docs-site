...
[HdsTabs](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdstabs/ui-design-hdstabs)容器组件扩展支持出血图标样式。当应用开发者需要tabBar内的页签高度超出tabBar时，可以通过设置对应页签的属性，添加出血效果的自定义组件，图标超出容器部分最大高度为4vp。

![](../../../images/98f47935/zh-cn_image_0000002552798694.png)
