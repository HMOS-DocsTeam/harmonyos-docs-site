...
[HdsActionBar](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdsactionbar/ui-design-hdsactionbar)组件支持多个按钮的样式。当应用开发者需要多个按钮并且没有主按钮，没有展开和收缩的动效时，可以通过设置左按钮和右按钮配置样式。

![](../../../images/36cad40f/zh-cn_image_0000002552958348.png)
