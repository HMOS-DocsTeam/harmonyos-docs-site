...
适用于图标为单层资源，且图标展示风格要与华为HarmonyOS Design System设计风格一致的应用场景，典型应用场景可参考分层图标[场景介绍](/ui-design-kit-guide/ui-design-icon-process/ui-design-layered-process#场景介绍)。
...
![](../../../images/c0d0c516/zh-cn_image_0000002552958332.png)
...
2. 将图标处理的相关类添加至工程。
   ...
   ```
3. 简单配置页面的布局，调用[单层图标接口](/ref/ui-design-api/ui-design-arkts/ui-design-hdsdrawable/ui-design-hdsdrawable#hdsdrawablegethdsicon)获取处理后的图标信息，也可以调用[异步批量处理接口](/ref/ui-design-api/ui-design-arkts/ui-design-hdsdrawable/ui-design-hdsdrawable#hdsdrawablegethdsicons)。
