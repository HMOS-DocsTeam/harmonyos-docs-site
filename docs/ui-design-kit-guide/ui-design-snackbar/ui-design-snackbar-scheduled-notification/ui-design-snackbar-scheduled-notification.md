...
[HdsSnackBar](/ref/ui-design-api/ui-design-arkts-component/ui-design-hdssnackbar/ui-design-hdssnackbar)支持定时通知弹窗。当应用开发者需要定时通知提醒弹窗时，可以通过HdsSnackBar的show方法显示HdsSnackBar弹窗，设置duration是大于0的时间表示弹窗是定时消失的，默认定时时间是5000ms。

![](../../../images/ef19acf5/zh-cn_image_0000002552798698.gif)
