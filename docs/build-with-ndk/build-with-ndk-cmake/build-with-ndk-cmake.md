...
1. 将NDK自带的CMake编译工具添加到环境变量中。
   ...
   - 配置 windows 下的环境变量
     ...
     ![](../../images/86ab1e51/zh-cn_image_0000002583479357.png)

     打开命令框，输入cmake.exe -version，命令行正确回显cmake的版本号，说明环境变量配置完成。

     ![](../../images/86dba567/zh-cn_image_0000002552799708.png)
2. 查看CMake默认路径。
...
![](../../images/10f4afcd/caution_3.0-zh-cn.png) 
...
![](../../images/82198c2a/zh-cn_image_0000002583439403.png)

这里使用的是cmake .. -G "Ninja" 引号里面跟的参数就是上图查看的环境所支持的生成器，这里ndk中自带的生成器是Ninja。

![](../../images/25390174/zh-cn_image_0000002552959358.png)
