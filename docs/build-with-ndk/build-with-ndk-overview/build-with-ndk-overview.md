...
- 从源码构建
  ...
  - 可以使用DevEco Studio提供的C++应用模板，[用DevEco Studio来编译构建](/build-with-ndk/build-with-ndk-ide)
  - 也可以[使用命令行CMake来编译构建](/build-with-ndk/build-with-ndk-cmake)
- [使用预构建库构建](/build-with-ndk/build-with-ndk-prebuilts)
