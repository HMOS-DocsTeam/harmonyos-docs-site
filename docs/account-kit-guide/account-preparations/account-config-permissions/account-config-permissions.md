...
请参考“[应用开发准备](/application-dev-overview)”章节，创建应用、使用DevEco Studio创建应用工程。

![](../../../images/67acd382/note_3.0-zh-cn.png) 
...
![](../../../images/fea3e5ee/note_3.0-zh-cn.png) 

华为账号一键登录、获取您的手机号、获取收货地址权限，仅支持企业开发者申请，不支持个人开发者申请。个人开发者可使用[华为账号登录](/account-kit-guide/account-quick-login/account-unionid-login/account-unionid-login-button)或[静默登录](/account-kit-guide/account-quick-login/account-silent-login)实现登录。
...
1. 在 AppGallery Connect（简称AGC）的[开发与服务](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html#/myProject)中，选择相应的项目，然后选择需要申请对应权限的HarmonyOS应用。
   ...
   ![](../../../images/5b6ff111/zh-cn_image_0000002583438787.png)
2. 在“开放能力管理”中，选择想要申请的账号权限，并点击“申请”。

   ![](../../../images/2251827e/note_3.0-zh-cn.png) 

   权限申请入口目前仅对企业开发者开放，个人开发者不可见。

   图示仅为示例，不同应用类型展示不同权限，请以实际页面显示为准。

   ![](../../../images/cacb1ce6/zh-cn_image_0000002552958742.png)
3. 点击申请后，请根据应用实际情况填写“申请原因”。

   ![](../../../images/a35882af/zh-cn_image_0000002583478743.png)

   ![](../../../images/5b76dd47/note_3.0-zh-cn.png) 
...
4. 提交申请成功后，自动跳转到互动中心，提示等待审核。
   ...
   ![](../../../images/d6ba9858/note_3.0-zh-cn.png) 
...
5. 权限申请通过后最迟在25小时后生效。
   ...
   ****图1**** 修改前
   ...
   ![](../../../images/afc24ac6/zh-cn_image_0000002552799094.png)

   ****图2**** 修改后

   ![](../../../images/6e612adc/zh-cn_image_0000002583438789.png)
