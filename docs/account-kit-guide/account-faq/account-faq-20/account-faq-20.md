...
2. 检查module type为entry的模块下module.json5中的client\_id配置的值是否正确，请参考[配置Client ID](/account-kit-guide/account-preparations/account-client-id)。
3. 请使用手动签名方式配置签名，请参考[配置签名和指纹](/account-kit-guide/account-preparations/account-sign-fingerprints)。
