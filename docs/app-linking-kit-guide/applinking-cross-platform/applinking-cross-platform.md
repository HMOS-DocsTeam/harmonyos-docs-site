...
已[开通App Linking服务](/app-linking-kit-guide/applinking-preparations/applinking-enable-applinking)。

## 开发流程

| 角色 | 操作步骤 |
| --- | --- |
| 云端开发 | [开通App Linking服务](/app-linking-kit-guide/applinking-preparations/applinking-enable-applinking)。 |
...
3. 在左侧导航栏中选择“增长 > App Linking > 聚合链接”，选择“链接前缀”页签，点击“添加链接前缀”。
   ...
   ![](../../images/f67c8855/zh-cn_image_0000002583478807.png)
4. 在AGC提供的免费域名（例如中国站点的域名：drcn.agconnect.link）前再设置一个前缀字符串，前缀字符串仅支持小写字母和数字，且必须确保此前缀唯一。设置完成后点击“下一步”。

   ![](../../images/8b0f1d2a/zh-cn_image_0000002552799158.png)
5. 等待域名地址验证通过后，页面将显示完整域名。

   ![](../../images/96f13a42/zh-cn_image_0000002583438853.png)
...
3. 在左侧导航栏中选择“增长 > App Linking > 聚合链接”，选择“网址允许清单”页签，点击“添加允许清单规则”。
   ...
   ![](../../images/cb643511/zh-cn_image_0000002552958808.png)
4. 使用正则表达式设置允许清单规则，设置完成后点击右上角的“发布”。

   ![](../../images/79ab9612/zh-cn_image_0000002583478809.png)
...
3. 在左侧导航栏中选择“增长 > App Linking > 聚合链接”，选择“聚合链接”页签，点击“创建聚合链接”。
   ...
   ![](../../images/3933bd7f/zh-cn_image_0000002552799160.png)
4. 设置短链接，完成后点击“下一步”。

   ![](../../images/d77e33a2/zh-cn_image_0000002583438855.png)
...
5. 设置深度链接，完成后点击“下一步”。
   ...
   ![](../../images/256323da/zh-cn_image_0000002552958810.png)
...
6. 设置聚合链接在HarmonyOS系统的链接行为，完成后点击“下一步”。
   ...
   ![](../../images/e4e87278/zh-cn_image_0000002583478811.png)
...
7. （可选）在“设置跟踪参数”页面，设置广告跟踪参数，可用于广告、流量跟踪。
   ...
   ![](../../images/80c6e95c/zh-cn_image_0000002552799162.png)
...
8. （可选）设置社交分享标识，可用于社交软件之间的分享，设置完成后点击“下一步”。
   ...
   ![](../../images/46ea220d/note_3.0-zh-cn.png) 
   ...
   ![](../../images/6b2a04cb/zh-cn_image_0000002583438857.png)
...
9. （可选）设置预览页，可以将用户引导至合适的目标位置。
   ...
   ![](../../images/5b0ffe44/zh-cn_image_0000002552958812.png)
...
- 点击网址中的二维码图标，或对应操作栏下方的“二维码下载”，可以下载该聚合链接的二维码图片。
  ...
  ![](../../images/45883f87/zh-cn_image_0000002583478813.png)

  点击对应操作栏下方的“链接详情”，可以查看该聚合链接的详情，包括深度链接地址、HarmonyOS应用包名、短链接地址等。

  ![](../../images/ce8f4860/zh-cn_image_0000002552799164.png)
...
4. 选择“聚合链接”页签，对已创建的聚合链接进行归档。
   ...
   - 单条归档：在聚合链接列表，选择待归档聚合链接对应“操作”列下方的“归档”。
     ...
     ![](../../images/d9d83651/zh-cn_image_0000002583438859.png)
   - 批量归档：在列表，勾选多条待归档，选择右上角“批量操作”的下拉选项中的“归档”。

     ![](../../images/aaa8f6a1/zh-cn_image_0000002552958814.png)

   ![](../../images/60d625f6/note_3.0-zh-cn.png) 

   可以通过时间筛选，选择查看“7天内已归档”的聚合链接。还可以点击“操作”列下方的“撤销归档”，将已归档的聚合链接恢复原状。

### 在module.json5中配置聚合链接

在HarmonyOS应用的[module.json5文件](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中进行如下配置，用于接收聚合链接，以获取聚合链接中传递的数据。

- "entities"列表中必须包含"entity.system.browsable"。
- "actions"列表中必须包含"ohos.want.action.viewData"。
- "uris"列表中必须包含"scheme"为"https"且"host"为域名地址的元素，可选属性包含"path"、"pathStartWith"和"pathRegex"，具体请参见“[uris标签说明](/ability-kit/stage-model-development/inter-app-redirection/directional-redirection/app-uri-config#uris标签说明)”。
- "domainVerify"设置为true，表示开启域名校验开关。

![](../../images/c405c9da/note_3.0-zh-cn.png) 
...
在HarmonyOS应用的Ability（如EntryAbility）的[onCreate()](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability#oncreate)或者[onNewWant()](/ref/ability-api/ability-arkts/stage-model/js-apis-app-ability-uiability/js-apis-app-ability-uiability#onnewwant)生命周期回调中添加如下代码，以处理传入的链接。
...
若要根据链接参数启动UIAbility的指定页面组件，请参考“[启动UIAbility的指定页面](/ability-kit/stage-model-development/stage-model-application-components/uiability/uiability-intra-device-interaction#启动uiability的指定页面)”。
...
拉起方应用可以调用[UIAbilityContext.openLink()](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#openlink12)接口，并将appLinkingOnly参数设为false或者不传，以App Linking优先的方式打开应用。
...
3. 在“entry/src/main/ets/pages/Index.ets”文件中，使用[UIAbilityContext.openLink()](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#openlink12)接口配置聚合链接。
