...
![](../../../images/7af0d51d/zh-cn_image_0000002552799454.png)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [addWatermark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addwatermark)(info: WatermarkInfo, startIndex: number, endIndex: number, oddPages: boolean, evenPages: boolean): void | 插入水印到PDF文档。如果插入的是图片，支持的图片格式参考[ImageFormat](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#imageformat)，文本字符无限制。 |
| [removeWatermark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#removewatermark)(): boolean | 删除PDF文档水印。 |

![](../../../images/f531564d/caution_3.0-zh-cn.png) 

[addWatermark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addwatermark)方法属于耗时业务，需要遍历每一页去添加水印，添加页面较多时建议放到线程里去处理。
