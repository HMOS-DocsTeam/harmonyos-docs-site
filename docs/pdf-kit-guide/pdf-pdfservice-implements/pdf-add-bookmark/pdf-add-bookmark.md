...
![](../../../images/8d5df463/zh-cn_image_0000002552959102.png)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [createBookmark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#createbookmark)(): Bookmark | 创建PDF文档书签。 |
| [getRootBookmark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#getrootbookmark)(): Bookmark | 获取PDF文档第一个根书签。 |
| [insertBookmark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#insertbookmark)(bookmark: Bookmark, parent: Bookmark, position: number): boolean | 插入PDF文档书签。 |
| [setBookmarkInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#setbookmarkinfo)(info: BookmarkInfo): void | 设置书签信息。 |
| [removeBookmark](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#removebookmark)(bookmark: Bookmark): boolean | 移除PDF文档书签。 |
| [setDestInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#setdestinfo)(info: DestInfo): void | 设置书签的跳转信息。 |
| [getBookmarkInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#getbookmarkinfo)(): BookmarkInfo | 获取书签信息。 |
