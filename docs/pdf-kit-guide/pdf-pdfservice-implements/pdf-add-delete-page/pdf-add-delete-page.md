...
| 接口名 | 描述 |
| --- | --- |
| [insertBlankPage](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#insertblankpage)(index: number, width: number, height: number): PdfPage | 在指定位置插入空白PDF页。 |
| [getPage](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#getpage)(index: number): PdfPage | 获取指定页的对象。 |
| [insertPageFromDocument](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#insertpagefromdocument)(document: PdfDocument, fromIndex: number, pageCount: number, index: number): PdfPage | 将其他文档的页添加到当前文档。 |
| [deletePage](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#deletepage)(index: number, count: number): void | 删除指定的PDF页。 |
