...
对PDF文档[添加内容](/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-txt-img-annot)、[页眉页脚](/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-headerfooter)、[水印](/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-watermark)、[背景图片](/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-background)或[书签](/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-bookmark)等操作前，需要打开文档，并且在文档操作完成后，保存PDF文档。
...
| 接口名 | 描述 |
| --- | --- |
| [loadDocument](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#loaddocument)(path: string, password?: string, onProgress?: (progress: number) => number): ParseResult | 加载指定文档路径。 |
| [saveDocument](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#savedocument)(path: string, onProgress?: (progress: number) => number): boolean | 保存文档。 |
