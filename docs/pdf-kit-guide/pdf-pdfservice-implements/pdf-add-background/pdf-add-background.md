...
![](../../../images/5058de05/zh-cn_image_0000002583439149.png)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [addBackground](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addbackground)(info: BackgroundInfo, startIndex: number, endIndex: number, oddPages: boolean, evenPages: boolean): void | 插入PDF文档背景。 |
| [removeBackground](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#removebackground)(): boolean | 删除PDF文档背景。 |

![](../../../images/94fb7141/caution_3.0-zh-cn.png) 

[addBackground](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addbackground)方法属于耗时业务，需要遍历每一页去添加背景，添加页面较多时建议放到线程里去处理。
