...
| 接口名 | 描述 |
| --- | --- |
| [isEncrypted](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#isencrypted)(path: string): boolean | 判断当前文档是否已加密。 |
| [removeSecurity](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#removesecurity)(): boolean | 删除文档加密锁。 |
