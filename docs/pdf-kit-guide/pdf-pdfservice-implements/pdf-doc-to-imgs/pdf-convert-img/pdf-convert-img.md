...
当前支持的图片格式请参考[ImageFormat](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#imageformat)。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [convertToImage](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#converttoimage)(path: string, format: ImageFormat, onProgress?: (progress: number) => number): boolean | 转换PDF文档为图片。 |
