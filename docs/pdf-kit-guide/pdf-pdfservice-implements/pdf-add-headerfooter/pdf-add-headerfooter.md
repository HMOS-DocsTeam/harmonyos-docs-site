...
PDF Kit支持对指定页面添加、删除页眉页脚。页眉页脚信息包含文字、日期和页码等相关内容，并可设置字体大小、颜色和间距等相关样式，具体属性参考[HeaderFooterInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#headerfooterinfo)。如下图：

![](../../../images/319799bd/zh-cn_image_0000002583479103.jpg)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [addHeaderFooter](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addheaderfooter)(info: HeaderFooterInfo, startIndex: number, endIndex: number, oddPages: boolean, evenPages: boolean): void | 插入PDF文档页眉页脚。 |
| [removeHeaderFooter](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#removeheaderfooter)(): boolean | 删除PDF文档页眉页脚。 |

![](../../../images/8d39150e/caution_3.0-zh-cn.png) 

[addHeaderFooter](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addheaderfooter)方法属于耗时业务，需要遍历每一页去添加页眉页脚，添加页面较多时建议放到线程里去处理。
