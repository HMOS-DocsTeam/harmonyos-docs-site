...
- 添加、修改、删除批注。
  ...
  通过索引指定PDF页面添加批注，并对批注在页面中的位置，字体、批注边框等设置，批注提供了多种风格样式，包括：文本批注[TextAnnotationInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#textannotationinfo)、下划线批注[LineAnnotationInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#lineannotationinfo)、高亮批注[HighlightAnnotationInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#highlightannotationinfo)、删除线批注[StrikethroughAnnotationInfo](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#strikethroughannotationinfo)等共13种。

![](../../../images/4f6f3941/zh-cn_image_0000002583439147.png)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [addTextObject](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addtextobject)(text: string, x: number, y: number, style: TextStyle): void | 添加文本内容，只可按行添加。 |
| [addImageObject](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addimageobject)(path: string, x: number, y: number, width: number, height: number): void | 在PDF文档的页面中添加图片。 |
| [deleteGraphicsObject](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#deletegraphicsobject)(object: GraphicsObject): void | 删除指定的GraphicsObject。 |
| [addAnnotation](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfservice/pdf-arkts-pdfservice#addannotation)(annotationInfo: PdfAnnotationInfo): PdfAnnotation | 在当前页添加批注。 |
