...
调用[getPagePixelMap](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfviewmanage/pdf-arkts-pdfviewmanage#getpagepixelmap)方法，将指定PDF缩略图转化为图片。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [getPagePixelMap](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfviewmanage/pdf-arkts-pdfviewmanage#getpagepixelmap)(pageIndex: number, isSync?: boolean): Promise&lt;image.PixelMap&gt; | 获取对应PDF页面的缩略图，使用Promise异步回调。 |
