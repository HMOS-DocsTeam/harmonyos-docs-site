...
| 接口名 | 描述 |
| --- | --- |
| [enableAnnotation](/ref/pdf-api/pdf-arkts/pdf-arkts-pdfviewmanage/pdf-arkts-pdfviewmanage#enableannotation)(annotationType: SupportedAnnotationType, color?: number): void | 在常用操作之间切换并添加批注。 |
