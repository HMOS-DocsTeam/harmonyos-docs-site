...
在可访问网络的电脑上下载安装DevEco Studio，并下载所需的模拟器镜像，具体可参考[创建模拟器](/ide-run-emulator/ide-emulator-management/ide-emulator-create)。

例如在Windows电脑下载手机镜像，并指定镜像下载路径为D:\Sdk，实际完整的镜像路径是D:\Sdk\system-image\HarmonyOS-xxx\phone\_all\_x86。

![](../../images/e29d2704/note_3.0-zh-cn.png) 

如未指定镜像下载路径，默认路径请参考[创建模拟器](/ide-run-emulator/ide-emulator-management/ide-emulator-create)。
...
2. 在无网络电脑上创建模拟器，注意创建时将镜像路径更改为上个步骤的路径，如D:\No-network\Sdk，具体可参考[创建模拟器](/ide-run-emulator/ide-emulator-management/ide-emulator-create)，创建成功后即可使用模拟器。

   ![](../../images/e66a4e5a/zh-cn_image_0000002530751070.png)
