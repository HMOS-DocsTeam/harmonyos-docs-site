...
如遇到因Kit能力不支持导致的应用闪退问题，可以尝试使用[动态引入Kit](/arkts/arkts-runtime/arkts-runtime-module/arkts-dynamic-import#动态import实现方案介绍)的方式规避此异常问题。
...
| NPU | 部分AI相关Kit暂不支持，详情参考[AI Kit简介](/harmony-agent-framework-kit-guide/hmaf-introduction) |
| 生物识别 | 不支持指纹、人脸认证等 |
