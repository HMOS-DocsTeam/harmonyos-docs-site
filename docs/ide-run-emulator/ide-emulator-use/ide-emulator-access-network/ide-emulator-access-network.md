...
模拟器访问互联网实际上利用的是本地计算机的以太网或者WLAN，与本地计算机共享同一网络资源。如果无法连接网络，请确认本地网络访问是否受到了限制（如使用公司内网）。如果网络访问受到限制，则需要在模拟器上配置网络代理，请参考[网络代理设置](/ide-run-emulator/ide-emulator-use/ide-emulator-more-features#section206461549731)。
...
![](../../../images/07d4ecdf/note_3.0-zh-cn.png) 
...
![](../../../images/f38e126d/zh-cn_image_0000002530911062.png)
