...
当应用需要支持自定义字体时，开发者可通过[ReaderSetting](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#readersetting)的fontPath属性，实现对阅读内容字体的实时修改。

自定义字体文件支持两种存放路径：

- 工程目录resources/rawfile文件夹。
- [应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)。

## 业务流程

![](../../../../images/5fddc602/zh-cn_image_0000002583439189.png)
...
| [on('resourceRequest')](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#onresourcerequest) | 注册资源请求回调，如果设置了自定义背景，字体时，排版引擎会通过此接口获取对应的资源ArrayBuffer。 |
| [off('resourceRequest')](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#offresourcerequest) | 注销资源请求回调接口，可在页面销毁时调用。 |

## 开发准备

- 进行自定义字体之前，请先确保已经“[构建阅读器](/reader-kit-guide/reader-content/reader-read-page)”。
...
2. 定义字体文件存放路径：
   ...
   - 若资源放在项目resources/rawfile/fonts文件夹下。
     ...
     ```
   - 若资源放在[应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)下。
