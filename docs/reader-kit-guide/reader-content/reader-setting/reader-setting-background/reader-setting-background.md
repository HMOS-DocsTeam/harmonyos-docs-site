...
当应用需要支持自定义背景时，开发者可通过[ReaderSetting](/ref/reader-api/reader-arkts/reader-read-core/reader-read-core#readersetting)的themeColor及themeBgImg属性，实现对阅读内容自定义背景色及背景图片的实时修改。
...
![](../../../../images/f05c7425/zh-cn_image_0000002552959144.png)
...
- 进行自定义背景之前，请先确保已经“[构建阅读器](/reader-kit-guide/reader-content/reader-read-page)”。
