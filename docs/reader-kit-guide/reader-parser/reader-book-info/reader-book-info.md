...
在导入本地书籍到书架时，开发者需通过[DocumentViewPicker](/ref/core-file-api/core-file-arkts/js-apis-file-picker/js-apis-file-picker#documentviewpicker)先将书籍文件导入到[应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)，然后利用解析能力获取书籍信息，包括书封、书名及作者等，以完成书架内容的展示。

## 业务流程

![](../../../images/676ac735/zh-cn_image_0000002552959142.png)
...
| [getBookInfo](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#getbookinfo)(): BookInfo | 获取书籍信息。 |
| [getResourceContent](/ref/reader-api/reader-arkts/reader-book-parser/reader-book-parser#getresourcecontent)(spineIndex: number, filePath: string): ArrayBuffer | 获取书籍内容资源。 |
...
1. 导入相关模块。
   ...
   ```
2. 通过提前导入到[应用沙箱目录](/core-file-kit/app-file/app-sandbox-directory)中的书籍文件，初始化书籍解析器。
