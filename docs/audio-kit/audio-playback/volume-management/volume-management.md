...
![](../../../images/771d833e/note_3.0-zh-cn.png) 
...
管理系统音量的接口由AudioVolumeManager提供，在使用之前，需要使用[getVolumeManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getvolumemanager9)获取AudioVolumeManager实例。
...
使用[AudioVolumeManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiovolumemanager/arkts-apis-audio-audiovolumemanager)获取指定流类型的音量信息。
...
系统提供了ArkTS组件AVVolumePanel（音量面板），应用可以创建该组件，具体样例和介绍请查看参考文档：[avVolumePanel](/ref/audio-api/audio-comp/ohos-multimedia-avvolumepanel/ohos-multimedia-avvolumepanel)。

## 应用音量

管理应用音量的接口由AudioVolumeManager提供，在使用之前，需要使用[getVolumeManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiomanager/arkts-apis-audio-audiomanager#getvolumemanager9)获取AudioVolumeManager实例。

当[音量模式](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-e/arkts-apis-audio-e#audiovolumemode19)设置为APP\_INDIVIDUAL时，可通过下面示例接口设置、查询应用音量。
...
管理音频流音量的接口是AVPlayer或AudioRenderer的setVolume()方法，使用[AVPlayer](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-f/arkts-apis-media-f#mediacreateavplayer9)设置音频流音量的示例代码如下：
...
使用[AudioRenderer](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-f/arkts-apis-audio-f#audiocreateaudiorenderer8)的[setVolume](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiorenderer/arkts-apis-audio-audiorenderer#setvolume9)和[getVolume](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiorenderer/arkts-apis-audio-audiorenderer#getvolume12)接口分别完成音频流音量的设置和获取。
