...
本模块提供音频输出设备管理能力，包括查询设备信息和监听连接状态变化。具体API说明请参考文档[AudioRoutingManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audioroutingmanager/arkts-apis-audio-audioroutingmanager)。
...
使用[getDevices](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audioroutingmanager/arkts-apis-audio-audioroutingmanager#getdevices9)方法可以获取当前所有输出设备的信息。
...
![](../../../images/31f488eb/note_3.0-zh-cn.png) 

监听设备连接状态变化可以监听到全部的设备连接状态变化，不建议作为应用处理自动暂停的依据。应用如需处理自动暂停相关业务，可参考[音频流输出设备变更原因](/audio-kit/audio-device/audio-output-device-change#音频流输出设备变更原因)。
...
使用[getPreferOutputDeviceForRendererInfo](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audioroutingmanager/arkts-apis-audio-audioroutingmanager#getpreferoutputdeviceforrendererinfo10)方法, 可以获取当前最高优先级的输出设备。

![](../../../images/c5d8bbbc/note_3.0-zh-cn.png) 
...
应用使用播放器的SDK播放音频流，不持有[AudioRenderer](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiorenderer/arkts-apis-audio-audiorenderer)对象，因此无法灵活控制播放设备的选择和状态监听。从API version 20开始，AudioSession不仅增加了焦点管理功能，还提供了音频输出设备管理功能，包括设置默认输出设备和监听设备变化。请参考以下文档获取更多信息：

- ArkTS API：[AudioSessionManager](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiosessionmanager/arkts-apis-audio-audiosessionmanager)
- C API：[native\_audio\_session\_manager.h](/ref/audio-api/audio-c/audio-headerfile/capi-native-audio-session-manager-h/capi-native-audio-session-manager-h)
...
[setDefaultOutputDevice](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiosessionmanager/arkts-apis-audio-audiosessionmanager#setdefaultoutputdevice20)可以用于设置本机默认输出设备。

![](../../../images/ce1d75c2/note_3.0-zh-cn.png) 
...
应用可以通过[getDefaultOutputDevice](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiosessionmanager/arkts-apis-audio-audiosessionmanager#getdefaultoutputdevice20)查询本机默认输出设备类型。

![](../../../images/ad8a0871/note_3.0-zh-cn.png) 

本接口用于查询通过[setDefaultOutputDevice](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-audiosessionmanager/arkts-apis-audio-audiosessionmanager#setdefaultoutputdevice20)接口设置的输出设备。
...
应用可以通过注册[CurrentOutputDeviceChangedEvent](/ref/audio-api/audio-arkts/js-apis-audio/arkts-apis-audio-i/arkts-apis-audio-i#currentoutputdevicechangedevent20)监听输出设备的连接状态变化。

![](../../../images/418de60b/note_3.0-zh-cn.png) 
