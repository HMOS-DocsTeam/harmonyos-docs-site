...
OHAudio的开发指南请参考：[推荐使用OHAudio开发音频录制功能(C/C++)](/audio-kit/audio-recording/using-ohaudio-for-recording)。

考虑到一些接入HarmonyOS较早的应用开发者，这里提供了一份OpenSL ES接口切换到OHAudio的对照参考：[从OpenSL ES切换到OHAudio(C/C++)](/audio-kit/not-recommended/replace-opensles-by-ohaudio)，便于开发者能够更快的在新版本切换到使用新接口。
