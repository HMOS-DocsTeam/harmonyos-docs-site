...
| 接口名 | 描述 |
| --- | --- |
| [deleteToTrash](/ref/file-manager-service-api/filemanagerservice-arkts/filemanagerservice-arkts-filemanagerservice/filemanagerservice-arkts-filemanagerservice#filemanagerservicedeletetotrash)(uri: string): Promise&lt;string&gt; | 删除指定文件到回收站，并返回文件删除到回收站后的uri。使用Promise异步回调。 |
