...
获取设备位姿支持部分Phone、部分Tablet设备。请参考[硬件要求](/ar-engine-kit-guide/arengine-preparations#硬件要求)判断设备是否支持运动跟踪及平面识别特性（[ARENGINE\_FEATURE\_TYPE\_SLAM](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arengine/arengine-api-arengine#arfeaturetype)）。

## 接口说明

获取设备位姿可以通过[ARCamera](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arengine/arengine-api-arengine#arcamera)相机对象获取，以下接口为获取设备位姿接口。详细接口和说明，请参考[AR Engine API参考](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arengine/arengine-api-arengine)。

| 接口名 | 描述 |
| --- | --- |
| [ARCamera.getPose](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arengine/arengine-api-arengine#arcameragetpose) | 获取摄像机在世界空间中的位姿信息。 |
...
调用[ARViewCallback](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arviewcontroller/arengine-api-arviewcontroller#arviewcallback)，使用其中的[onFrameUpdate](/ref/ar-engine-api/arengine-arkts-api/arengine-api-arviewcontroller/arengine-api-arviewcontroller#arviewcallbackonframeupdate)方法获取AR会话对象arSession，之后通过AR会话对象arSession获取每一帧对应的设备位姿信息。
