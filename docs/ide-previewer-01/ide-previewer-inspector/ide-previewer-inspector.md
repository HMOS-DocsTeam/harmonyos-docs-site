...
DevEco Studio提供HarmonyOS应用/元服务的UI预览界面与源代码文件间的双向预览功能，支持ets文件与预览器界面的双向预览。使用双向预览功能时，需要在预览器界面单击![](../../images/839d4f02/zh-cn_image_0000002561832897.png)图标打开双向预览功能。

![](../../images/10d153ed/note_3.0-zh-cn.png) 

不支持服务卡片的双向预览功能。

![](../../images/18fe53fd/zh-cn_image_0000002561752913.png "点击放大")
