...
title: "预览数据模拟"
sidebar_position: 8
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-previewer-mock
...
![](../../images/ecf74b8a/note_3.0-zh-cn.png) 
...
![](../../images/517c72d7/note_3.0-zh-cn.png) 
...
![](../../images/3b9f3423/note_3.0-zh-cn.png) 
...
1. 在src/mock目录下新建一个ArkTS文件，在这个文件内定义目标模块的Mock实现。
   ...
   ![](../../images/aee116fb/note_3.0-zh-cn.png) 
...
1. 在src/mock目录下新建一个ArkTS文件，在这个文件内定义目标模块的Mock实现。
   ...
   ![](../../images/65840ad4/note_3.0-zh-cn.png) 
