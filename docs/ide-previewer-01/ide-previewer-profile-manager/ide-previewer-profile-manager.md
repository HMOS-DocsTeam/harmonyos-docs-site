...
定义设备后，可以在Previewer右上角，单击![](../../images/fb293c23/zh-cn_image_0000002561832605.png "点击放大")按钮，打开Profile管理器，切换预览设备。

![](../../images/d9b9ea8e/zh-cn_image_0000002530912682.png)

同时，Profile Manager还支持多设备预览功能，具体请参考[查看多端设备预览效果](/ide-previewer-01/ide-previewer-multi-profile)。

下面以自定义一款Phone设备为例，介绍设备Profile Manager的使用方法。

1. 在预览器界面，打开Profile Manager界面。

   ![](../../images/2fc7c27f/zh-cn_image_0000002530912680.png)
2. 在Profile Manager界面，单击****+ New Profile****按钮，添加设备。

   ![](../../images/e3b23e2a/zh-cn_image_0000002561832603.png)
3. 在****Create Profile****界面，填写新增设备的信息，如****Profile ID****（设备型号）、****Device type****（设备类型）、****Resolution****（分辨率）和****Language and region****（语言和区域）等。其中Device type只能选择module.json5中deviceTypes字段已定义的设备。
   ...
   ![](../../images/24644e1e/zh-cn_image_0000002561752621.png)
