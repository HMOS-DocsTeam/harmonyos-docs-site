...
title: "代码阅读"
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-editer-overview
...
![](../../images/c9cc5b05/zh-cn_image_0000002530913498.png)
...
![](../../images/6b8d762e/zh-cn_image_0000002561833421.gif)
...
![](../../images/80da6957/zh-cn_image_0000002530753534.png)
...
![](../../images/8ff1f5e5/zh-cn_image_0000002561753485.png)
...
1. 在****File > Settings >Editor > Code Style****（macOS为****DevEco Studio > Preferences/Settings > Editor > Code Style****），单击“Formatter”，勾选“Turn formatter on/off with markers in code comments”。
   ...
   ![](../../images/12ac6af5/zh-cn_image_0000002530913514.png)
2. 在不需要进行格式化操作的代码块前增加“//@formatter:off”，并在该代码块的最后增加“//@formatter:on”，即表示对该范围的代码块不需要进行格式化操作。

   ![](../../images/629f7ef0/zh-cn_image_0000002561753423.png)

若工程已配置code-linter.json5文件，选中code-linter.json5文件右键选择****Apply CodeLinter Style Rules****，代码格式化规则将与已配置的code-linter.json5文件中相关规则保持一致。code-linter.json5文件配置请参考[配置代码检查规则](/ide-code-edit/ide-code-check/ide-code-linter#section19310459444)。

![](../../images/01ce3b40/zh-cn_image_0000002530913568.png)

## 代码折叠

支持对代码块的快速折叠和展开，既可以单击编辑器左侧边栏的折叠和展开按钮对代码块进行折叠和展开操作，还可以对选中的代码块单击鼠标右键选择折叠方式，包括折叠、递归折叠、全部折叠等操作。

![](../../images/520c5bc7/zh-cn_image_0000002530913546.gif)

## 代码快速注释

支持对选择的代码块进行快速注释，使用快捷键****Ctrl+/****（macOS为****Command+/****）进行快速注释。对于已注释的代码块，再次使用快捷键****Ctrl+/****（macOS为****Command+/****）取消注释。

![](../../images/876fec23/zh-cn_image_0000002530913518.gif)

## 代码结构树

使用快捷键****Alt + 7 / Ctrl + F12****（macOS为****Command+7****）打开代码结构树，快速查看文件代码的结构树，包括全局变量和函数，类成员变量和方法等，并可以跳转到对应代码行。

![](../../images/3c15f249/zh-cn_image_0000002530913556.png)

## 代码引用查找

提供Find Usages代码引用查找功能，帮助开发者快速查看某个对象（变量、函数或者类等）被引用的地方，用于后续的代码重构，可以极大的提升开发者的开发效率。

使用方法：在要查找的对象上，单击鼠标****右键 > Find Usages****或使用快捷键****Alt +F7****（macOS为****Option +**** ****F7****）。可点击![](../../images/ecde46c6/zh-cn_image_0000002561753431.png)图标查看变量赋值位置，点击![](../../images/f1f9bd6f/zh-cn_image_0000002561753429.png)图标查看变量引用情况。

![](../../images/bcbc9027/zh-cn_image_0000002561753439.png)

## 函数注释生成

DevEco Studio支持在函数定义处，快速生成对应的注释。在函数定义的代码块前，输入****“/\*\*”+回车键****，快速生成注释信息。

![](../../images/5a88a0b0/note_3.0-zh-cn.png) 

C++文件同时支持使用****“//!”+回车********键****快速生成注释。

![](../../images/6ac5419f/zh-cn_image_0000002561833507.gif)
...
![](../../images/080fa0b7/zh-cn_image_0000002530753588.png)
...
![](../../images/4aa826d9/note_3.0-zh-cn.png) 

DevEco Studio集成了离线版API参考类文档，最新版本请参考官网[HarmonyOS API参考](/ref/development-intro-api/development-intro-api)。

![](../../images/4f4ee581/zh-cn_image_0000002561753437.gif "点击放大")
...
![](../../images/032d3aec/zh-cn_image_0000002561753455.png)
...
![](../../images/f4b76124/zh-cn_image_0000002561753513.gif)
...
![](../../images/b33befa3/zh-cn_image_0000002561753495.png)
...
1. 在菜单栏点击****Tools > API Change Assistant****，编辑区下方的API Change Assistant页签中，支持按模块查看API变更情况，选择需要对比的SDK版本号范围，点击****Start Scan****开始扫描。同时，有进度条提示扫描进度。
   ...
   ![](../../images/7f462804/note_3.0-zh-cn.png) 
   ...
   ![](../../images/2fd7764f/zh-cn_image_0000002561833511.png)
2. 点击扫描结果中的代码地址，跳转到相应的代码编写位置；点击蓝色高亮的变更描述，跳转至版本说明文档中查看详情；修改完后可点击![](../../images/eebe4c57/zh-cn_image_0000002530913512.png)图标，标注已修改。同时，可通过如下入口搜索或筛选API变更扫描结果、导出扫描结果数据等。
   ...
   ![](../../images/e2b42207/note_3.0-zh-cn.png) 

   通过Quick Ask打开CodeGenie后，仅支持使用HarmonyOS Ask智能体进行快速问答。

   ![](../../images/34599d5d/zh-cn_image_0000002530913554.png "点击放大")
...
1. 在菜单栏点击****Tools > API Change Assistant****，编辑区下方的API Change Assistant页签中，支持按模块查看API变更情况，选择需要对比的SDK版本号范围，点击****Start Scan****开始扫描。
   ...
   ![](../../images/990ee921/note_3.0-zh-cn.png) 

   API变更查询以选择的起始版本为基线，查询当前工程中所使用的API是否存在行为变更。如选择的SDK版本为5.0.0(12) Release 到 6.0.0(20) Release，查询的是5.0.1(13) Beta3到6.0.0(20) Release版本相比5.0.0(12) Release的API变更。

   ![](../../images/eb78145a/zh-cn_image_0000002530753536.png)
2. 点击Code Location中的代码地址，跳转到相应的代码编写位置；如需更多指导，可点击Guidance link中的链接，跳转至版本说明文档中查看详情。

   ![](../../images/0af105b8/zh-cn_image_0000002561753433.png)
3. 点击****Export****，选择API变更的存放位置后导出变更数据；点击****Scan Again****可重新进行扫描。通过右侧****Settings****按钮，可以设置在扫描API时，可使用的最大堆内存的大小，默认值为3072MB，当工程代码量较大导致扫描缓慢时，可以调整该参数。
   ...
   ![](../../images/1d5a1c32/zh-cn_image_0000002530913578.png)

## 父/子类快速跳转

编辑器支持快速跳转至当前接口、类、方法、属性的子类/父类。点击代码编辑区域左侧的Gutter Icons（装订线图标）可以跳转到对应的父/子接口或类。如有多个继承关系，在弹窗的文件列表中选择需要查看的接口/类即可。

- ![](../../images/380041a6/zh-cn_image_0000002530913550.png)Implemented：支持跳转到对应的实现类或子接口及其对应的属性/方法。
- ![](../../images/8f2b723f/zh-cn_image_0000002561753531.png)Implementing：支持跳转到对应的父接口或父接口的属性/方法。
- ![](../../images/117d1d74/zh-cn_image_0000002561753427.png)Overridden：支持跳转到对应的子类或子类的属性/方法。
- ![](../../images/6d743304/zh-cn_image_0000002561833485.png)Overriding：支持跳转到对应的父类或父类的属性/方法。

![](../../images/ab993bc8/zh-cn_image_0000002561833457.png "点击放大")
...
![](../../images/fe97eb54/zh-cn_image_0000002530913570.png)
...
![](../../images/15217c74/zh-cn_image_0000002561753507.png)
...
![](../../images/359465c8/zh-cn_image_0000002530913544.gif)
