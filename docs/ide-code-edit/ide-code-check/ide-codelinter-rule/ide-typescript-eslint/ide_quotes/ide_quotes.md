...
![](../../../../../images/400186ab/note_3.0-zh-cn.png) 

- 该规则默认检查字符串是否正确使用双引号。如需修改请参考[选项](#section182418564158)。
- 该规则建议在对.ts文件进行检查时使用。如需检查.ets文件，建议使用[@hw-stylistic/quotes](/ide-code-edit/ide-code-check/ide-codelinter-rule/ide-hw-stylistic/ide-quotes-stylistic)。
