...
![](../../../../../images/968434b2/note_3.0-zh-cn.png) 

- 该规则默认要求函数名和括号间有空格。如需修改请参考[选项](#section182418564158)。
- 该规则建议在对.ts文件进行检查时使用。如需检查.ets文件，建议使用[@hw-stylistic/space-before-function-paren](/ide-code-edit/ide-code-check/ide-codelinter-rule/ide-hw-stylistic/ide-space-before-function-paren-stylistic)。
