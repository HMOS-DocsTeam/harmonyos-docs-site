...
1. 如需开启编译报错智能分析和自动修复，进入****File > Settings****（macOS为********DevEco Studio > Preferences/Settings********） ****> CodeGenie********> General****页面，勾选****Enable AI**** ****auto-fix for build errors****和****Allow AI to modify local files for auto-fix****。
   ...
   ![](../images/b4bc7ec5/zh-cn_image_0000002530913422.png)
2. 当ArkTS工程出现构建报错时，点击报错信息后方****Add To Chat****图标，CodeGenie将自动引用构建报错信息。
   ...
   ![](../images/81f98d45/zh-cn_image_0000002561753363.png)
3. CodeGenie提供的修复方案被自动应用到代码中。
   - DevEco Studio 6.1.0 Beta2之前版本：
     ...
     - 点击右侧对话框中的****Accept All********/Reject All****按钮，接受或拒绝所有文件的修改；将鼠标悬浮在文件路径上，点击![](../images/587c505a/zh-cn_image_0000002530753428.png)可接受或拒绝该文件的修改。
   - DevEco Studio 6.1.0 Beta2及之后版本：
     - 点击右侧对话框中的****Accept All********/Reject All****按钮，接受或拒绝所有文件的修改；将鼠标悬浮在文件路径上，点击![](../images/c7b19e10/zh-cn_image_0000002530913420.png)可接受或拒绝该文件的修改。

   ![](../images/cfb54898/zh-cn_image_0000002530753426.png)
4. 点击****Run****编译验证，所需时间见提示，时间单位是秒。
   ...
   ![](../images/9b1adc00/zh-cn_image_0000002561833345.png)
