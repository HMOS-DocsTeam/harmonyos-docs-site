...
| DevEco Studio | DevEco Studio NEXT Developer Beta3及之后版本 | 请参考：[DevEco Studio使用指南](/ide-tools-overview)。 |
...
本章节从[创建新工程](/ide-project/ide-create-new-project)开始，指导开发者接入“备份恢复框架”，已经创建工程的开发者可以跳过本节。
...
![](../../../../../images/8abd1caf/caution_3.0-zh-cn.png) 
...
1. 在****entry/src/main/ets/****目录下，点击 ****New > Directory**** 创建****backupExtension****目录。
   ...
   ![](../../../../../images/7cd19732/zh-cn_image_0000002583438313.png)
2. 点击****entry/src/main/ets/backupExtension/****目录，点击 ****New > File**** 创建****BackupExtension.ets****文件。

   ![](../../../../../images/dafcdcd3/zh-cn_image_0000002552958268.png)
3. 参考示例代码实现BackupExtensionAbility，应用的数据转换和迁移逻辑，请在指定位置填充实现。
   ...
   ![](../../../../../images/2aac9349/caution_3.0-zh-cn.png) 
...
![](../../../../../images/b919a70f/caution_3.0-zh-cn.png) 

****extensionAbilities需要配置在entry内的module.json5才能正常访问。****

以下步骤以空工程为例，介绍如何配置[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file#extensionabilities标签)文件：
