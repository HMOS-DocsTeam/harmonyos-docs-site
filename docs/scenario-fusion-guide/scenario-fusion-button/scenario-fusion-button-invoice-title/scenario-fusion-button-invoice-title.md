...
运行示例代码单击“选择发票抬头”按钮，拉起选择发票抬头页面可选择已保存发票，也可单击“管理发票抬头”进入新增企业/个人发票抬头页面（完整场景请参考[获取发票抬头](/account-kit-guide/account-get-user-info/account-select-invoice-title)）。

## 前提条件

参见[开发前提](/account-kit-guide/account-get-user-info/account-select-invoice-title#开发前提)。
...
2. 在容器中声明FunctionalButton，指定Button的openType，并设置对应的回调函数，代码如下：
   ...
   ![](../../../images/1470316a/note_3.0-zh-cn.png) 
