...
运行示例代码单击“选择收货地址”按钮，拉起选择地址页面选择已保存的地址，也可单击“管理/新增收货地址”进入添加收货地址页面（完整场景可参考[获取收货地址](/account-kit-guide/account-get-user-info/account-choose-address-dev)）。

## 前提条件

参见[开发前提](/account-kit-guide/account-get-user-info/account-choose-address-dev#开发前提)。
...
2. 在容器中声明FunctionalButton，指定Button的openType，并设置对应的回调函数，代码如下：
   ...
   ![](../../../images/14d6b84f/note_3.0-zh-cn.png) 
