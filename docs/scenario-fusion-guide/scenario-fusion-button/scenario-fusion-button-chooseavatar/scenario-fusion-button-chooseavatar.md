...
运行示例代码单击头像按钮，拉起选择头像页面来设置头像（完整场景可参考[获取头像昵称](/account-kit-guide/account-get-user-info/account-get-avatar-nickname)）。

## 前提条件

参见[开发前提](/account-kit-guide/account-get-user-info/account-get-avatar-nickname#开发前提)。
...
2. 在容器中声明FunctionalButton，指定Button的openType，并设置对应的回调函数，代码如下：
   ...
   ![](../../../images/a2408b93/note_3.0-zh-cn.png) 
