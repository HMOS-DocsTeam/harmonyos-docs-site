...
![](../../../images/d44957d1/note_3.0-zh-cn.png) 

剪贴板数据源推荐场景目前仅支持中文姓名和中文地址。

![](../../../images/8832d9c0/zh-cn_image_0000002552799506.png)

示例二：根据用户输入，智能关联设备上历史表单输入、华为账号等信息提供输入建议，一键填充。

![](../../../images/8dd8c81d/zh-cn_image_0000002583439201.png)

## 填写收货地址场景

示例一：智能识别剪贴板内容，一键复制，一键填充。

![](../../../images/665490b3/note_3.0-zh-cn.png) 

剪贴板数据源推荐场景目前仅支持中文姓名和中文地址。

![](../../../images/ff62bd0d/zh-cn_image_0000002552959156.png)

示例二：根据用户输入，智能关联设备上历史表单输入、华为账号等信息提供输入建议，一键填充。

![](../../../images/d5cf8def/zh-cn_image_0000002583479157.png)
...
![](../../../images/5d909460/note_3.0-zh-cn.png) 
...
- 若在页面中也提供了弹窗提醒填充建议的功能，为避免弹窗冲突，建议将对应输入组件的[enableAutoFill](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#enableautofill11)属性设置为"false"以关闭智能填充功能。
