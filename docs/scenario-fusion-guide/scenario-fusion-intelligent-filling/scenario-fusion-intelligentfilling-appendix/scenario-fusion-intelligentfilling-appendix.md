...
![](../../../images/7c56b916/note_3.0-zh-cn.png) 
...
![](../../../images/05c24399/note_3.0-zh-cn.png) 

- ID\_CARD\_NUMBER目前只支持身份证号的推荐、填充，不支持其他类型的证件，可参考[动态修改ContentType值](/scenario-fusion-guide/scenario-fusion-intelligent-filling/scenario-fusion-intelligentfilling-amend)动态配置输入框的ContentType。
- 请在收集使用用户敏感个人信息的表单界面告知目的以及必要性。
...
![](../../../images/9c8d32a4/note_3.0-zh-cn.png) 
