...
![](../../../images/3e42fcf6/note_3.0-zh-cn.png) 

- 需要在module.json5文件中设置模糊位置权限：[ohos.permission.APPROXIMATELY\_LOCATION](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-all-user#ohospermissionapproximately_location)。
- 所在地区地址选择器需要[开通地图服务](/map-kit-guide/map-config-agc#开通地图服务)。
- 需要[配置签名和指纹](/account-kit-guide/account-preparations/account-sign-fingerprints)。

## 效果图

地址表单中的所在地区能根据详细地址内容自动补全，当补全内容不符合预期时，可通过地址选择器进行修改。

![](../../../images/034236cc/zh-cn_image_0000002583439203.png)
...
![](../../../images/dcfde43c/note_3.0-zh-cn.png) 
