...
- 用户关注服务号失败，则会出现错误提示。
  ...
  ![](../../../images/39fcba89/zh-cn_image_0000002583439191.png) ![](../../../images/99a2ef88/zh-cn_image_0000002552959146.png)
...
以下是关注组件的接口说明，更多接口及使用方法请参见[atomicService（融合场景化API）](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-atomicservice/scenario-fusion-atomicservice)。

| 接口名 | 描述 |
| --- | --- |
| [showFollowComponent](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-atomicservice/scenario-fusion-atomicservice#showfollowcomponent)(ctx: [UIContext](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-api/ts-custom-component-api#uicontext), params: [FollowComponentParams](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-atomicservice/scenario-fusion-atomicservice#followcomponentparams), callback: [FollowComponentCallback](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-atomicservice/scenario-fusion-atomicservice#followcomponentcallback)): Promise&lt;void&gt; | 调用该方法展示关注组件。 |
