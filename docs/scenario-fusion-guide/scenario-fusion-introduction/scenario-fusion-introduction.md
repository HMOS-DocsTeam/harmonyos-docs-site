...
| 场景化API | 请参见[支持的国家/地区](/scenario-fusion-guide/scenario-fusion-appendix/scenario-fusion-appendix-support-regions)。 |
...
- 本kit支持模拟器开发，通用差异可参考[模拟器与真机的差异](/ide-run-emulator/ide-emulator-overview/ide-emulator-specification#section1227613205203)。
