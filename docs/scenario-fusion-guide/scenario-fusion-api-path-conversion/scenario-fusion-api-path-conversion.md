...
以下是获取转换文件uri信息的接口说明，更多接口及使用方法请参见[fileUriService（文件路径转换API）](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-fileuriresult/scenario-fusion-fileuriresult)。

| 接口名 | 描述 |
| --- | --- |
| [convertFileUris](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-fileuriresult/scenario-fusion-fileuriresult#convertfileuris)(sourceFileUris: Array&lt;string&gt;): Promise&lt;Array&lt;[FileUriResult](/ref/scenario-fusion-api/scenario-fusion-arktsapi/scenario-fusion-fileuriresult/scenario-fusion-fileuriresult#fileuriresult)&gt;&gt; | 获取转换文件uri信息的请求对象。 |
