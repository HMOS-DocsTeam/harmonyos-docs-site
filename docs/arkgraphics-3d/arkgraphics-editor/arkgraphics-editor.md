...
3. 点击Plugins窗口的顶部设置按钮，选择Install Plugin from Disk...。
   ...
   ![](../../images/589968d2/zh-cn_image_0000002583438749.png)
4. 选择下载的插件，进行安装。
...
6. 前往[下载中心](https://developer.huawei.com/consumer/cn/download/)下载最新版本ArkGraphics Editor编辑器，并进行安装。
   ...
   ![](../../images/fec445bb/note_3.0-zh-cn.png) 
   ...
   ![](../../images/5fcb77d7/zh-cn_image_0000002552958704.png)

## 创建使用3D编辑器资源的工程

1. 创建一个新工程或在已有工程下，右键工程名，选择New，选择Ark Graphics Editor Project。

   ![](../../images/e89d3aef/zh-cn_image_0000002583478705.png)
2. 输入3D资源工程名。

   ![](../../images/9e02b41b/zh-cn_image_0000002552799056.png)
3. 双击default.scene，可显示创建的3D场景资源。

   ![](../../images/c451472b/zh-cn_image_0000002583438751.png)
4. 点击右下角Editor，可打开编辑器编辑3D资源，编辑保存后，可显示编辑后的资源。

   ![](../../images/76d612af/zh-cn_image_0000002552958706.png)
5. 修改复制资源脚本文件。
...
7. 完成以上操作后，可在真机运行工程，观察3D资源加载效果。
   ...
   ![](../../images/4a226e43/note_3.0-zh-cn.png) 
