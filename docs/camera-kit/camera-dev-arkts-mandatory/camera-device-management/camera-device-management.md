...
1. 导入camera接口，接口中提供了相机相关的属性和方法，导入方法如下。
   ...
   ```
2. 通过[getCameraManager](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-f/arkts-apis-camera-f#cameragetcameramanager)方法，获取cameraManager对象。
   ...
   ![](../../../images/282e4bf1/note_3.0-zh-cn.png) 
...
通过注册cameraStatus事件，通过回调返回监听结果，callback返回CameraStatusInfo参数，参数的具体内容可参考相机管理器回调接口实例[CameraStatusInfo](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-i/arkts-apis-camera-i#camerastatusinfo)。
