...
在参考以下示例前，建议开发者查看[分段式拍照(ArkTS)](/camera-kit/camera-dev-arkts/camera-deferred-capture)的具体章节，了解[设备输入](/camera-kit/camera-dev-arkts-mandatory/camera-device-input)、[会话管理](/camera-kit/camera-dev-arkts-mandatory/camera-session-management)、[拍照](/camera-kit/camera-dev-arkts/camera-shooting)等单个流程。

## 开发流程

在获取到相机支持的输出流能力后，开始创建拍照流，开发流程如下。

![](../../../images/8c26de2e/zh-cn_image_0000002552798918.png)
