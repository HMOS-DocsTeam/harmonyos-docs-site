...
[Worker](/arkts/arkts-concurrency/multithread-concurrency/worker-introduction)主要作用是为应用程序提供一个多线程的运行环境，可满足应用程序在执行过程中与主线程分离，在后台线程中运行一个脚本进行耗时操作，极大避免类似计算密集型或高延迟的任务阻塞主线程的运行。
...
![](../../../images/192a829a/zh-cn_image_0000002552798920.png)

使用Worker：

![](../../../images/0f904677/zh-cn_image_0000002583438615.png)
