...
详细的API说明请参考[@ohos.multimedia.cameraPicker (相机选择器)](/ref/camera-api/camera-arkts/js-apis-camerapicker/js-apis-camerapicker)。
...
1. 导入相关接口，导入方法如下。
   ...
   ```
2. 配置[PickerProfile](/ref/camera-api/camera-arkts/js-apis-camerapicker/js-apis-camerapicker#pickerprofile)。

   ![](../../../images/419f47cd/note_3.0-zh-cn.png) 
   ...
   fileIo接口调用方法请参考：[createRandomAccessFileSync](/ref/core-file-api/core-file-arkts/js-apis-file-fs/js-apis-file-fs#fileiocreaterandomaccessfilesync10)和[getUriFromPath](/ref/core-file-api/core-file-arkts/js-apis-file-fileuri/js-apis-file-fileuri#fileurigeturifrompath)。
