...
当前示例提供完整的HDR Vivid录像开发步骤，方便开发者实现录制HDR Vivid视频的功能。更多HDR Vivid的开发指导，请参考[使用HDR Vivid特性开发媒体应用](/multimedia-hdr-vivid)。

在参考以下示例前，建议开发者查看[相机开发指导(ArkTS)](/camera-kit/camera-dev-arkts-mandatory/camera-device-management)的具体章节，了解[设备输入](/camera-kit/camera-dev-arkts-mandatory/camera-device-input)、[会话管理](/camera-kit/camera-dev-arkts-mandatory/camera-session-management)、[录像](/camera-kit/camera-dev-arkts/camera-recording)等单个流程。
...
2. 获取预览、录像的配置项。
   ...
   HDR录像的输出格式需要设置成10bit的CAMERA\_FORMAT\_YCRCB\_P010。具体参考[setColorSpace](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-colormanagement/arkts-apis-camera-colormanagement#setcolorspace12)。

   ![](../../../images/cbfe425f/note_3.0-zh-cn.png) 
...
6. 设置色彩空间。
   ...
   如果是SDR录像色彩空间需要设置为BT709\_LIMIT，如果是HDR录像色彩空间需要设置为BT2020\_HLG\_LIMIT。具体参考[setColorSpace](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-colormanagement/arkts-apis-camera-colormanagement#setcolorspace12)。建议在提交会话配置之前调用[setColorSpace](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-colormanagement/arkts-apis-camera-colormanagement#setcolorspace12)。
...
7. 实现HDR录像。
   ...
   ![](../../../images/6fae5cb0/note_3.0-zh-cn.png) 
