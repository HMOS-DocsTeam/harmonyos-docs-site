...
在参考以下示例前，建议开发者查看[相机开发指导(ArkTS)](/camera-kit/camera-dev-arkts-mandatory/camera-device-management)的具体章节，了解[相机管理](/camera-kit/camera-dev-arkts-mandatory/camera-device-management)、[设备输入](/camera-kit/camera-dev-arkts-mandatory/camera-device-input)、[会话管理](/camera-kit/camera-dev-arkts-mandatory/camera-session-management)等单个操作。

## 开发流程

相机应用从后台切换至前台启动恢复的调用流程建议如下：

![](../../../images/a4cbd722/zh-cn_image_0000002552958570.png)
