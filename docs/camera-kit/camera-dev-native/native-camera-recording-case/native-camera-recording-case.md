...
当前示例提供完整的录像流程及其接口调用顺序的介绍。对于单个流程（如[设备输入](/camera-kit/camera-dev-native-mandatory/native-camera-device-input)、[会话管理](/camera-kit/camera-dev-native-mandatory/native-camera-session-management)、[录像](/camera-kit/camera-dev-native/native-camera-recording)）的介绍请参考具体章节。

## 开发流程

在获取到相机支持的输出流能力后，开始创建录像流，开发流程如下。

![](../../../images/ccc37766/zh-cn_image_0000002552798934.png)
