...
![](../../images/b0269a32/note_3.0-zh-cn.png) 

项目创建功能只支持2022.3至2025.1的PyCharm版本。2024.3版本由于pycharm自身原因，只能选择单设备模板进行创建。

****3.安装hdc****

请参考[调试工具-hdc](/system-debug-optimize/debugging-commands/hdc)中环境准备章节来安装和配置hdc环境。
...
![](../../images/a0b5f7d3/caution_3.0-zh-cn.png) 
...
![](../../images/788f628b/zh-cn_image_0000002524503481.jpg "点击放大")
...
![](../../images/e8b230c7/note_3.0-zh-cn.png) 

在6.0及以后的版本中，DevEco Testing Hypium插件在下载包中的名称由“DevEcoTesting-Hypium”修改为“hypium-pycharm-plugin”。

![](../../images/13b69df4/zh-cn_image_0000002524503499.png "点击放大")

安装完成后在Plugins界面可以看到DevEcoTesting-Hypium插件。

![](../../images/0c14f1d2/zh-cn_image_0000002492503710.png)
...
![](../../images/4a4bd303/zh-cn_image_0000002524623423.png "点击放大")

****Ⅰ. 项目文件区域****

在项目文件区域右键点击项目目录或者文件，选择 DevEco Testing Hypium，弹出对应的功能菜单。

![](../../images/4c060f15/zh-cn_image_0000002524623427.png)
...
![](../../images/33b5c614/caution_3.0-zh-cn.png) 
...
![](../../images/baeaac1a/zh-cn_image_0000002558763237.png)
...
![](../../images/196540f3/zh-cn_image_0000002492343770.png "点击放大")
...
![](../../images/ba0f67d6/zh-cn_image_0000002492503742.png "点击放大")

****执行结果报告展示功能****

使用“一键执行当前用例”功能完成测试用例执行后，插件将在控制台旁边自动生成执行结果标签。点击该标签，即可查看本次用例执行过程中各步骤的截图。

![](../../images/07a9d6e1/zh-cn_image_0000002524623411.png "点击放大")

****Ⅳ. 设置面板区****

打开PyCharm设置面板，选中左侧的DevEco Testing Hypium选项，可以进入DevEco Testing Hypium的设置面板，如下图所示。

![](../../images/6416c090/zh-cn_image_0000002524623405.png)
...
![](../../images/c60790e9/zh-cn_image_0000002524623425.png)

点击左侧的DevEco Testing Hypium，可以创建Hypium用例模板工程。共有两种类型的Hypium模板工程，分别对应单设备和双设备的测试场景。

![](../../images/360992a6/zh-cn_image_0000002524623429.jpg "点击放大")
...
![](../../images/c3d48675/zh-cn_image_0000002492503754.png)
...
[HypiumProjectTemplate.zip](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260420144409.91208270398374383371124549269383:20260426002008:2800:5294C2A8554178E14218BA0B686CC32D4868D5E988819408B84C4CF7D72A0A72.zip?needInitFileName=true)
...
![](../../images/b82ba801/note_3.0-zh-cn.png) 
...
![](../../images/fa55fbae/note_3.0-zh-cn.png) 
...
![](../../images/d3594f4a/zh-cn_image_0000002524623459.png "点击放大")
...
![](../../images/21981969/caution_3.0-zh-cn.png) 
...
![](../../images/2108a019/zh-cn_image_0000002524623441.png "点击放大")
...
![](../../images/ee57887d/caution_3.0-zh-cn.png) 
...
![](../../images/48df24bc/caution_3.0-zh-cn.png) 
...
![](../../images/006ec5a0/zh-cn_image_0000002492503760.png "点击放大")
...
![](../../images/9cf821e2/zh-cn_image_0000002524503477.png "点击放大")
...
![](../../images/5df4b0bf/zh-cn_image_0000002524623447.png "点击放大")

1. 截取红框中图片保存到为template.jpeg（文件名根据需要定义）。
2. 调用driver.touch\_image，传入template.jpeg图片的路径。

![](../../images/ef7f21cc/caution_3.0-zh-cn.png) 
...
![](../../images/552ec3cb/caution_3.0-zh-cn.png) 
...
![](../../images/2da81cfb/zh-cn_image_0000002524503469.png "点击放大")

用户可以通过 UiViewer 工具的控件查看模式获取控件的比例坐标。

![](../../images/fa99acb4/zh-cn_image_0000002492343782.png "点击放大")
