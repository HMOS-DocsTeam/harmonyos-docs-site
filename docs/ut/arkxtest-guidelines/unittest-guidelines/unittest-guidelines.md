...
![](../../../images/250104d0/zh-cn_image_0000002581217681.png)

## 单元测试框架发布方式

单元测试框架以ohpm包独立发布，版本信息详见[服务组件官网](https://ohpm.openharmony.cn/#/cn/detail/@ohos%2Fhypium)。开发者下载DevEco Studio后，在应用工程中的[oh-package.json5](/ide-ohpm-cli/ide-oh-package-json5)文件中devDependencies节点中配置版本号即可使用对应版本框架功能。
...
测试脚本基于DevEco Studio编写，请下载[DevEco Studio](https://developer.huawei.com/consumer/cn/download/)并完成[hdc配置](/system-debug-optimize/debugging-commands/hdc#环境准备)。

### 新建测试脚本

参考[DevEco Studio指导](/ide-app-test/ide-test/ide-code-test/ide-instrument-test#section36049271219)创建ArkTS测试用例。
...
下面给出测试类级别即测试文件执行示例，其他请参考[运行模式](/ide-app-test/ide-test/ide-code-test/ide-instrument-test#section1574003717165)。

![](../../../images/5a679812/zh-cn_image_0000002550777586.png)

- 查看测试结果

测试执行后可直接在DevEco Studio中查看测试结果。

![](../../../images/0c36d6cd/zh-cn_image_0000002581377645.png)

- 查看测试用例覆盖率

执行测试用例后可以查看测试用例覆盖率，具体操作请参考[覆盖率统计模式](/ide-app-test/ide-test/ide-code-test/ide-instrument-test#section1989615417457)章节内的内容。
...
以下是单元测试过程中的常用命令，其他aa test命令及含义说明参考[命令指南说明](/system-debug-optimize/debugging-commands/aa-tool)。
...
![](../../../images/8ee19862/note_3.0-zh-cn.png) 
...
2. 命令行执行完成后，框架会打印如下相关日志信息。
   ...
   ![](../../../images/9e37dfa4/note_3.0-zh-cn.png) 
...
![](../../../images/9e5ea03c/note_3.0-zh-cn.png) 

仅支持Mock应用工程中自定义对象，不支持Mock系统API对象。如需Mock系统API，请参考[系统模块Mock指南](/ide-app-test/ide-test/ide-test-mock#section8353132513310)。
...
![](../../../images/940e7efa/note_3.0-zh-cn.png) 
...
![](../../../images/1a7a5c48/note_3.0-zh-cn.png) 
...
![](../../../images/f878cd8d/note_3.0-zh-cn.png) 
