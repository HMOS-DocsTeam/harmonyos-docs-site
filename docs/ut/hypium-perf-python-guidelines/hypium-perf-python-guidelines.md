...
Hypium基本API接口功能介绍，请参考指导：[Hypium框架-API使用方法](/ut/hypium-python-guidelines#section1141818121333)。

测试服务执行测试脚本详情介绍，请参考指导：[场景化性能测试](/test-service/deveco-testing/specialized-testing#section8642101711299)。
...
参考指导：[应用UI测试-安装指导](/ut/hypium-python-guidelines)。

****安装hypium\_perf****

1）打开DevEco Testing客户端-专项测试-场景化性能测试卡片，点击获取安装包，打开安装包目录，如下图。

![](../../images/5e2f348c/zh-cn_image_0000002492343740.png)
...
![](../../images/933d8212/caution_3.0-zh-cn.png) 
...
![](../../images/39232db3/zh-cn_image_0000002492343738.png "点击放大")

2）填写工程项目名称，选择工程存放路径，点击开始生成按钮。

![](../../images/24f9a99f/zh-cn_image_0000002524503435.png "点击放大")

3）在步骤2中填写的项目路径下，将自动生成用例模板。

![](../../images/db90f064/zh-cn_image_0000002492343728.png)

![](../../images/261cdca5/caution_3.0-zh-cn.png) 
...
![](../../images/69eee6e2/caution_3.0-zh-cn.png) 
...
![](../../images/eb105bdc/caution_3.0-zh-cn.png) 
...
![](../../images/b1523fe5/zh-cn_image_0000002492343724.png)
...
![](../../images/5161e897/caution_3.0-zh-cn.png) 
...
![](../../images/5b819d39/notice_3.0-zh-cn.png) 
...
![](../../images/c311bcc9/zh-cn_image_0000002524503433.png "点击放大")
...
![](../../images/5dde2d66/zh-cn_image_0000002492343730.png "点击放大")
...
![](../../images/07cc4cc5/zh-cn_image_0000002492343726.png "点击放大")

****方法二：****在json文件配置，并在main.py的cmd命令参数中指定json文件。

![](../../images/9014dc02/zh-cn_image_0000002492343736.png "点击放大")
...
![](../../images/0d95ed33/note_3.0-zh-cn.png) 
...
性能脚本本地调试验证成功后，可在DevEco Testing创建性能测试任务，请查看文档：[场景化性能测试-任务创建](/test-service/deveco-testing/specialized-testing#section8642101711299)。
