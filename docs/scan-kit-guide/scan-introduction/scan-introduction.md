...
![](../../images/b829d3bb/note_3.0-zh-cn.png) 
...
- 默认界面扫码能力和自定义界面扫码能力仅支持Phone、Tablet、Wearable（从6.1.0(23)版本开始支持带后置相机的Wearable，可以通过[cameraManager.getSupportedCameras](/ref/camera-api/camera-arkts/js-apis-camera/arkts-apis-camera-cameramanager/arkts-apis-camera-cameramanager#getsupportedcameras)接口查询是否带后置相机）。
...
| 默认界面扫码能力 | 从6.1.0(23)版本开始，标题支持根据[ScanOptions](/ref/scan-api/scan-arkts/scan-scanbarcode-api/scan-scanbarcode-api#scanoptions)的scanTypes进行动态显示；从6.0.0(20)版本开始，支持悬浮屏、分屏场景；相册扫码只支持单码识别；不支持界面UX添加自定义设置。 |
