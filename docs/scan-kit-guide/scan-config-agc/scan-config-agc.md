...
1. 参考“[应用开发准备](/application-dev-overview)”完成基本准备工作。
2. （****仅针对“扫码直达”必选****）接入[App Linking](/app-linking-kit-guide/app-linking-startupapp)，您需要完成以下步骤：
