...
3. 当码图位置不在扫码框范围内时，在[customScan.start](/ref/scan-api/scan-arkts/scan-customscan-api/scan-customscan-api#customscanstart-1)的callback回调中执行[customScan.rescan](/ref/scan-api/scan-arkts/scan-customscan-api/scan-customscan-api#customscanrescan)接口，即可继续扫码。
