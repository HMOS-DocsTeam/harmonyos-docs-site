...
[XComponent](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-basic-components-xcomponent/ts-basic-components-xcomponent)的宽高比与自定义界面扫码接口中[ViewControl](/ref/scan-api/scan-arkts/scan-customscan-api/scan-customscan-api#viewcontrol)的宽高比不一致，导致自定义界面扫码预览画面出现拉伸。
