...
若开发者要[通过Push Kit更新实况窗](/live-view-kit-guide/liveview-scenes/liveview-update-by-push)，需要设置默认数据处理位置为“中国”。
...
4. 在“是否已启用”栏勾选“中国”，并在“是否设为默认”栏将中国设置为默认数据处理位置。
   ...
   ![](../../../images/43df1bae/zh-cn_image_0000002552958970.png)
5. 设置完成后，点击“保存”。

![](../../../images/70a1cabf/note_3.0-zh-cn.png) 
