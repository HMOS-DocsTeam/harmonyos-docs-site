...
2. 选择开发者的应用，点击实况窗-调测设备管理，根据[Push Token](/push-kit-guide/push-preparations/push-get-token)添加调测设备后即可进行接入调测。

   ![](../../../images/20be76e8/zh-cn_image_0000002552799326.png)

   ![](../../../images/bbc7cd08/zh-cn_image_0000002583439021.png)
