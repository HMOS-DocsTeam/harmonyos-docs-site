...
开发者可以通过[liveViewManager](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager)模块构建本地实况窗，完成实况窗的整个生命周期流程（包括创建、更新与结束）。请注意，只有应用在前台运行，即用户实际使用应用并且产生了服务合约的情况下，开发者才可以创建实况窗；与此同时，本地更新或结束实况窗依赖于开发者的应用进程，所以我们更推荐开发者在本地创建实况窗后使用Push Kit更新或结束实况窗。

![](../../../images/6990e07c/note_3.0-zh-cn.png) 
...
在项目中导入[liveViewManager](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager)，并新建实况窗控制类（例如LiveViewController），构造isLiveViewEnabled()方法，用于校验实况窗开关（设置>应用和元服务>应用名>实况窗）是否打开。打开实况窗开关是创建实况窗的前提条件。示例代码如下：
...
调用[liveViewManager.startLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstartliveview)创建实况窗，该API接口传入参数为实况窗实例（liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)）。

### 进度可视化模板

进度可视化模板适用于打车、外卖等场景。

![](../../../images/1f7bcff6/zh-cn_image_0000002552799330.png)
...
![](../../../images/f5a855d5/zh-cn_image_0000002583439025.png)

![](../../../images/5db21c90/zh-cn_image_0000002552958980.png)
...
![](../../../images/d8a5ff7c/zh-cn_image_0000002583478981.png)
...
![](../../../images/30419a89/zh-cn_image_0000002552799332.png)

![](../../../images/c9cbe907/zh-cn_image_0000002583439027.png)
...
![](../../../images/e8d4dc3c/zh-cn_image_0000002552958982.png)
...
![](../../../images/da771343/zh-cn_image_0000002583478983.gif)
...
![](../../../images/203a332b/zh-cn_image_0000002552799334.png)
...
![](../../../images/8d9680e0/zh-cn_image_0000002583439029.png)
...
![](../../../images/ad01a24a/note_3.0-zh-cn.png) 
...
![](../../../images/82de5703/zh-cn_image_0000002552958984.png)

![](../../../images/8889e0a2/note_3.0-zh-cn.png) 

胶囊形态各模板参数固定，与创建实况窗时的模板类型无关。可创建的胶囊类型有：文本胶囊、计时器胶囊、进度胶囊，详情请参见[CapsuleData](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#capsuledata)。

除了实况窗卡片形态，开发者还需考虑实况窗胶囊形态的展示效果。若开发者创建实况窗时还想同步创建实况窗胶囊，则需在liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)（结构体）中携带胶囊所需的参数liveViewData.[capsule](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewdata)（不同胶囊类型携带不同的参数）。示例代码如下：
...
![](../../../images/17cd4501/zh-cn_image_0000002583478985.png)

外屏实况窗适用于在小折叠屏的外屏显示实况窗的简要信息，方便用户可以在折叠状态便捷查看。

若开发者创建实况窗时需要同步创建，则需在liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)（结构体）中携带外屏所需的参数liveViewData.[external](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewdata)。示例代码如下：
...
开发者若需要使用实况窗计时器，则需在liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)（结构体）中配置[timer](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)字段，并在当前支持的字段中使用占位符：****$\{placeholder.timer\}****。

例如：固定区的文本内容中使用占位符，系统将替代占位符为实况窗计时器。

![](../../../images/b164a4a0/zh-cn_image_0000002552799336.png)
...
请调用wantAgent.[getWantAgent](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-wantagent/js-apis-app-ability-wantagent#wantagentgetwantagent-1)()构造点击动作字段所需的参数值，当前实况窗支持的点击动作如下：

- 点击实况窗的默认动作：在liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)（结构体）中携带胶囊所需的参数liveViewData.primary.[clickAction](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#primarydata)字段。
- 点击辅助区的跳转动作：在liveViewManager.[LiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveview)（结构体）中携带胶囊所需的参数liveViewData.primary.extensionData.[clickAction](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#extensiondata)字段。

## 本地更新和结束实况窗

调用[liveViewManager.isLiveViewEnabled](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerisliveviewenabled)()确认实况窗开关打开后，调用liveViewManager的[updateLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerupdateliveview)更新实况窗，调用[stopLiveView](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager#liveviewmanagerstopliveview)结束实况窗。更新时需要修改请求体中对应的参数。示例代码如下：
...
更详细的参数请参考[Live View Kit ArkTS API参考](/ref/live-view-api/liveview-arkts/liveview-liveviewmanager/liveview-liveviewmanager)。

![](../../../images/623727c9/note_3.0-zh-cn.png) 

以上是应用在本地创建、更新和结束实况窗通知的全部流程。此外，应用也可以通过Push Kit实现远程[创建、更新和结束实况窗消息](/push-kit-guide/push-scenes/push-update-liveview)。
