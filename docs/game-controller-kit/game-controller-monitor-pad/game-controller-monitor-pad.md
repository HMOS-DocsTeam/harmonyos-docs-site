...
![](../../images/d07de85e/note_3.0-zh-cn.png) 

须先完成[监听设备上下线](/game-controller-kit/game-controller-monitor-device)功能的开发后，才能进行游戏手柄轴事件和按键事件的监听注册。
...
![](../../images/fea1a3c3/zh-cn_image_0000002552799234.png)

## 接口说明

接口详细介绍请参考[API参考](/ref/game-controller-api/game-controller-c/game-controller-module/capi-game-controller/capi-game-controller)。
