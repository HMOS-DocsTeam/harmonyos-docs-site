...
| ****适用设备**** | 通用 |
| ****应用形态适用性**** | 卡片 |
| ****说明**** | [卡片的配置文件](/form-kit/arkts-ui/arkts-ui-widget-configuration) |
...
| ****适用设备**** | 通用 |
| ****应用形态适用性**** | 卡片 |
| ****说明**** | [FormLinkOptions类型说明](/ref/arkui-api/arkui-declarative-comp/service-widgets/ts-container-formlink/ts-container-formlink) |
...
| ****适用设备**** | 通用 |
| ****应用形态适用性**** | 卡片 |
| ****说明**** | [卡片支持的页面能力](/form-kit/arkts-ui/arkts-ui-widget/arkts-ui-widget-page/arkts-ui-widget-page-overview) |
