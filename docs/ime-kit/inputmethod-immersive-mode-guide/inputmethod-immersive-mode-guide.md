...
![](../../images/c1e5dead/zh-cn_image_0000002552958318.png)
...
1. 前台应用[设置编辑框沉浸模式](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textarea/ts-basic-components-textarea#keyboardappearance15)。示例代码如下。
   ...
   ```
2. 输入法应用[订阅编辑框属性变化事件](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#oneditorattributechanged10)，通过回调参数EditorAttribute中的immersiveMode字段感知前台应用期望的沉浸模式。示例代码如下。
   ...
   ```
3. 输入法应用[设置沉浸模式](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#setimmersivemode15)。
   ...
   设置沉浸模式，示例代码如下。setImmersiveMode接口需使用[createPanel](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#createpanel10)获取到Panel实例后，通过实例调用。
