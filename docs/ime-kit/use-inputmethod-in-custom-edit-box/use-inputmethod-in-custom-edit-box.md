...
在输入法框架中，可以通过[getController](/ref/ime-api/ime-arkts/js-apis-inputmethod/js-apis-inputmethod#inputmethodgetcontroller9)方法获取到[InputMethodController](/ref/ime-api/ime-arkts/js-apis-inputmethod/js-apis-inputmethod#inputmethodcontroller)实例来绑定输入法并监听输入法应用的各种操作，比如插入、删除、选择、光标移动等。这样就可以在自绘编辑框中使用输入法，并实现更加灵活和自由的编辑操作。
...
![](../../images/153a7a81/zh-cn_image_0000002583478317.png)
