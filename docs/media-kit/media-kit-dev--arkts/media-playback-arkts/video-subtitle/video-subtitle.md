...
1. 调用[addSubtitleFromFd](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avplayer/arkts-apis-media-avplayer#addsubtitlefromfd12)，使用视频播放的AVPlayer实例设置外挂字幕资源。
   ...
   ```
2. 调用[on('subtitleUpdate')](/ref/media-api/media-arkts/js-apis-media/arkts-apis-media-avplayer/arkts-apis-media-avplayer#onsubtitleupdate12)接口，注册字幕回调函数。
