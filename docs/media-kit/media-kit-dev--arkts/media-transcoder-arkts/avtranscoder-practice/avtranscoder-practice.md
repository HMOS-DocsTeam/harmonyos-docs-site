...
- ****码率转换****
  ...
  ![](../../../../images/1c377003/zh-cn_image_0000002552798948.png)

  分辨率和帧率的系数由以下经验公式计算可得。

  ![](../../../../images/8d4717a0/zh-cn_image_0000002583438643.png)

  ![](../../../../images/02b8f32e/zh-cn_image_0000002552958598.png)
...
具体如何使用转码能力对视频进行转码，可以参见文档：[用AVTranscoder实现视频转码](/media-kit/media-kit-dev--arkts/media-transcoder-arkts/using-avtranscoder-for-transcodering)。

## 使用异步线程的方式进行转码

本示例使用的是worker线程的方式来实现异步线程进行转码，worker线程的详细使用方式，可以参见文档:

- [Worker线程使用说明](/ref/arkts-api/arkts-arkts/js-apis-worker/js-apis-worker)
- [Worker简介](/arkts/arkts-concurrency/multithread-concurrency/worker-introduction)
