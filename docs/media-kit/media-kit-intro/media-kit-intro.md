...
详细流媒体开发流程请参考[流媒体播放开发指导](/media-kit/media-kit-dev--arkts/media-playback-arkts/streaming-media-playback-development-guide)。
...
![](../../images/e9a01bfe/zh-cn_image_0000002583478593.png)
...
![](../../images/6e9c698e/zh-cn_image_0000002552798944.png)
...
1. 应用从XComponent组件获取窗口SurfaceID，获取方式参考[XComponent](/ref/arkui-api/arkui-declarative-comp/rendering-drawing/ts-basic-components-xcomponent/ts-basic-components-xcomponent)。
...
![](../../images/524f1b12/note_3.0-zh-cn.png) 
...
![](../../images/45d2b9fe/zh-cn_image_0000002583438639.png)
...
![](../../images/431cda09/zh-cn_image_0000002552958594.png)
...
![](../../images/27b7dfe0/zh-cn_image_0000002583478595.png)
...
支持的音视频源参考[媒体数据解析](/avcodec-kit/file-muxing-demuxing/audio-video-demuxer)。
...
支持的视频源参考[视频解码](/avcodec-kit/audio-video-codec/video-decoding)。
...
- 支持转码时降低视频分辨率。
  ...
  目标视频宽、高不能大于源视频宽、高，且不能设置为奇数，详情请参考[设置正确的视频宽高](/avcodec-kit/audio-video-codec/obtain-supported-codecs#设置正确的视频宽高)。
- 支持的源视频格式：

  当前转码支持的源视频格式依赖于系统解码器和解封装支持的格式，详细情况请参考[AVCodec支持的格式](/avcodec-kit/avcodec-support-formats#媒体数据解析)。
- 支持的目标视频格式：
...
- 通用差异：请参见[模拟器与真机的差异](/ide-run-emulator/ide-emulator-overview/ide-emulator-specification#section18112195514315)。
