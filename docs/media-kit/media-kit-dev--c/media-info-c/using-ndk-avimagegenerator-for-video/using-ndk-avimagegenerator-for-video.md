...
（可选）开发者可以使用[OH\_AVMetadataExtractor\_FetchMetadata()](/ref/media-api/media-c/media-headerfile/capi-avmetadata-extractor-h/capi-avmetadata-extractor-h#oh_avmetadataextractor_fetchmetadata)获取媒体资源时长信息[OH\_AVMETADATA\_EXTRACTOR\_DURATION](/ref/media-api/media-c/media-headerfile/capi-avmetadata-extractor-base-h/capi-avmetadata-extractor-base-h#变量)，进而选择获取视频帧的时间。使用需引入如下头文件。
...
开发者通过引入[avimage\_generator.h](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-h/capi-avimage-generator-h)、[avimage\_generator\_base.h](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-base-h/capi-avimage-generator-base-h)和[native\_averrors.h](/ref/avcodec-api/avcodec-c/avcodec-headerfile/capi-native-averrors-h/capi-native-averrors-h)头文件，使用获取视频帧相关API。

详细的API说明请参考[AVImageGenerator API参考](/ref/media-api/media-c/media-module/capi-avimagegenerator/capi-avimagegenerator)。

1. 使用[OH\_AVImageGenerator\_Create()](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-h/capi-avimage-generator-h#oh_avimagegenerator_create)创建实例。
   ...
   ```
2. 设置视频资源的文件描述符：调用[OH\_AVImageGenerator\_SetFDSource()](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-h/capi-avimage-generator-h#oh_avimagegenerator_setfdsource)。
...
3. （可选）获取媒体资源时长信息，并指定获取视频帧的时间。
   ...
   ```
4. 获取指定时间的视频帧：调用[OH\_AVImageGenerator\_FetchFrameByTime()](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-h/capi-avimage-generator-h#oh_avimagegenerator_fetchframebytime)，可以获取到一个OH\_PixelmapNative对象，该对象可用于图片显示。
   ...
   ```
5. 释放资源：调用[OH\_AVImageGenerator\_Release()](/ref/media-api/media-c/media-headerfile/capi-avimage-generator-h/capi-avimage-generator-h#oh_avimagegenerator_release)销毁实例，释放资源。
