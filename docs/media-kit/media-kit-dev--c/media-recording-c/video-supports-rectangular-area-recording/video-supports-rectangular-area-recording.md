...
![](../../../../images/419b06af/note_3.0-zh-cn.png) 
...
调用[OH\_AVScreenCapture\_SetCaptureArea()](/ref/media-api/media-c/media-headerfile/capi-native-avscreen-capture-h/capi-native-avscreen-capture-h#oh_avscreencapture_setcapturearea)接口传入希望录制的矩形区域。

示例中的变量说明如下：

- capture：指向[OH\_AVScreenCapture](/ref/media-api/media-c/media-struct/capi-avscreencapture-oh-avscreencapture/capi-avscreencapture-oh-avscreencapture)实例的指针。
...
![](../../../../images/f7f9f112/caution_3.0-zh-cn.png) 
