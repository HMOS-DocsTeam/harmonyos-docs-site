...
调用者可以调用本模块提供的[C API接口](/ref/media-api/media-c/media-module/capi-videoprocessing/capi-videoprocessing)，实现HDRVivid标准动态元数据生成。

该能力常用于视频编辑中，如下图所示：

![](../../../../images/211e8d7f/zh-cn_image_0000002583478603.png)
...
- 格式类型组合一：
  ...
  | 参数 | 数据输入格式 |
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_PQ\_LIMIT |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_VIVID |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_YCBCR\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_YCRCB\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
- 格式类型组合二：

  | 参数 | 数据输入格式 |
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_HLG\_LIMIT |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_VIVID |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_YCBCR\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_YCRCB\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
- 格式类型组合三：
  ...
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_HLG\_LIMIT |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_HLG |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_YCBCR\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_YCRCB\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
- 格式类型组合四：
  ...
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_PQ\_LIMIT |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_HDR10 |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_YCBCR\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_YCRCB\_P010,  NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
- 格式类型组合五（从API version 23 开始支持）：

  | 参数 | 数据输入格式 |
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_PQ\_FULL |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_VIVID |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
- 格式类型组合六（从API version 23 开始支持）：

  | 参数 | 数据输入格式 |
  | --- | --- |
  | [ColorSpace](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_colorspace) | OH\_COLORSPACE\_BT2020\_HLG\_FULL |
  | [MetadataType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_metadatatype) | OH\_VIDEO\_HDR\_VIVID |
  | [pixelFormat](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-buffer-common-h/capi-buffer-common-h#oh_nativebuffer_format) | NATIVEBUFFER\_PIXEL\_FMT\_RGBA\_1010102 |
...
8. 设置Surface。
   ...
   ![](../../../../images/2e7d3202/note_3.0-zh-cn.png) 
   ...
   ```
9. 调用[OH\_VideoProcessing\_Start()](/ref/media-api/media-c/media-headerfile/capi-video-processing-h/capi-video-processing-h#oh_videoprocessing_start)启动动态元数据生成处理。

   ```
   // 开始动态元数据生成转换处理
   ret = OH_VideoProcessing_Start(videoProcessor);
   ```
10. 调用[OH\_VideoProcessing\_Stop()](/ref/media-api/media-c/media-headerfile/capi-video-processing-h/capi-video-processing-h#oh_videoprocessing_stop)停止动态元数据生成处理。
