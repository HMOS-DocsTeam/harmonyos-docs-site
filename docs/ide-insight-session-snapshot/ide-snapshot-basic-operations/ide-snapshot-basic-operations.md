...
1. 创建Snapshot场景调优分析任务，操作方法可参考[性能问题定位：深度录制](/ide-profiler-introduction/deep-recording)。
2. 设置Snapshot泳道。

   单击任务左上角的![](../../images/997ab613/zh-cn_image_0000002561753311.png "点击放大")进行泳道的筛选，再次单击此按钮可关闭设置并生效。
3. 单击ArkTS Snapshot泳道的“options”下拉列表，可以设置是否需要抓取基础类型number的数据。默认不抓取。

   ![](../../images/fd319ba5/zh-cn_image_0000002561833297.png)
4. 开始录制后可观察Memory泳道的内存使用情况，在需要定位的时刻单击任务左上角的![](../../images/fa1a763d/zh-cn_image_0000002530913368.png "点击放大")启动一次快照。

   “ArkTS Snapshot”泳道的紫色区块表示一次快照完成。

   ![](../../images/0d8e31ca/note_3.0-zh-cn.png) 

   - 在任务录制过程中，单击分析窗口左上角的![](../../images/5bdcb6e5/zh-cn_image_0000002530753366.png "点击放大")可启动内存回收机制。
   - 当方舟虚拟机的调优对象的某个程序/进程占用的部分内存空间在后续的操作中不再被该对象访问时，内存回收机制会自动将这部分空间归还给系统，降低程序错误概率，减少不必要的内存损耗。

   ![](../../images/60c110b0/zh-cn_image_0000002561753281.png "点击放大")
   ...
   - 带![](../../images/b6194df0/zh-cn_image_0000002561753279.png "点击放大")标识的对象，表示其为全局对象，可以通过全局window对象直接访问。

   ![](../../images/0e574768/zh-cn_image_0000002530753358.png "点击放大")

   ![](../../images/e485d69c/note_3.0-zh-cn.png) 
...
- Module：模块信息。
- Class：属性名称。
- Path：编译后的源码路径。支持通过点击属性名称旁边的![](../../images/30325c2a/zh-cn_image_0000002530753336.png)图标直接跳转至工程中的代码位置，方便开发者快速调试。

![](../../images/e4ef851f/zh-cn_image_0000002561753257.png "点击放大")

若应用编译模式是release，且启用了源码混淆，方舟应用对象将展示混淆后的数据。支持在Attributes页签查看当前所选应用对象的源码信息。

![](../../images/098485a4/zh-cn_image_0000002530913346.png "点击放大")

![](../../images/f0b4ea27/note_3.0-zh-cn.png) 
...
![](../../images/5ce7aa60/zh-cn_image_0000002561833277.png "点击放大")
...
![](../../images/d0c6571c/zh-cn_image_0000002530913334.png "点击放大")
...
![](../../images/a35d3c1d/zh-cn_image_0000002530753348.png "点击放大")
...
![](../../images/ccdf6dee/zh-cn_image_0000002561753293.png "点击放大")

目前支持单根路径搜索、指定数量的根路径搜索和展示所有根路径三种搜索模式，默认为单根搜索。

![](../../images/6bbd5929/zh-cn_image_0000002530913328.png "点击放大")

设置完搜索模式后点击OK，右侧more区域会自动跳转至Shortest Paths页面展示搜索结果。

![](../../images/acea4d17/zh-cn_image_0000002530753354.png "点击放大")
...
![](../../images/797475d0/zh-cn_image_0000002530753370.png "点击放大")
...
![](../../images/15b522d9/zh-cn_image_0000002530753362.png "点击放大")

设置完搜索模式后点击OK，底部页签会自动跳转至Graph页面展示搜索结果，红色标示的是中心节点，线段展示连接的两个节点之间的引用关系。

![](../../images/3304c8ab/zh-cn_image_0000002561753263.png "点击放大")
...
![](../../images/24abc4e7/zh-cn_image_0000002561753265.png "点击放大")
...
![](../../images/e1f942e5/zh-cn_image_0000002530753346.png "点击放大")
...
![](../../images/61a00bc3/zh-cn_image_0000002530753340.png "点击放大")

## 解析内存对象

从DevEco Studio 6.1.0 Beta2开始，DevEco Profiler支持导入[代码混淆产物nameCache](/ide-log-and-fault-analysis/ide-fault-analysis/ide-exception-stack-parsing-principle#section19215122372720)文件和[ArkTS调试产物sourceMap](/ide-log-and-fault-analysis/ide-fault-analysis/ide-exception-stack-parsing-principle#section666114451518)文件，还原文件名称和文件路径。

以nameCache文件为例，文件导入前，Class为d8，

![](../../images/5b057bf4/zh-cn_image_0000002561753285.png "点击放大")

点击工具栏![](../../images/51029627/zh-cn_image_0000002530913326.png)按钮，导入nameCache文件，Class显示为文件名称MyAbilityStage。

![](../../images/088ceb0e/zh-cn_image_0000002530753368.png "点击放大")
