...
![](../../images/2b854be9/zh-cn_image_0000002583478607.gif)
...
2. 创建参数列表。
   ...
   ```
3. 调用[replacePhotoPickerPreview()](/ref/media-library-api/media-library-comp/ohos-file-photopickercomponent/ohos-file-photopickercomponent#replacephotopickerpreview15)替换图片/视频。
...
![](../../images/406b7027/zh-cn_image_0000002552798958.gif)
...
2. 创建参数列表。
   ...
   @State replaceUrl: string = ''; // 原图编辑后的沙箱URI
   ```
3. 调用[saveTrustedPhotoAssets()](/ref/media-library-api/media-library-comp/ohos-file-photopickercomponent/ohos-file-photopickercomponent#savetrustedphotoassets15)保存图片/视频到图库。
   ...
   该接口使用依赖[pickerController.replacePhotoPickerPreview](/ref/media-library-api/media-library-comp/ohos-file-photopickercomponent/ohos-file-photopickercomponent#replacephotopickerpreview15)，需要先执行[pickerController.replacePhotoPickerPreview](/ref/media-library-api/media-library-comp/ohos-file-photopickercomponent/ohos-file-photopickercomponent#replacephotopickerpreview15)后才能执行[pickerController.saveTrustedPhotoAssets](/ref/media-library-api/media-library-comp/ohos-file-photopickercomponent/ohos-file-photopickercomponent#savetrustedphotoassets15)。
