...
开发者通过引入[media\_asset\_manager\_capi.h](/ref/media-library-api/media-library-c/media-library-headerfile/capi-media-asset-manager-capi-h/capi-media-asset-manager-capi-h)和[media\_asset\_base\_capi.h](/ref/media-library-api/media-library-c/media-library-headerfile/capi-media-asset-base-capi-h/capi-media-asset-base-capi-h)头文件，使用MediaAssetManager相关API。

详细的API说明请参考[MediaAssetManager API](/ref/media-library-api/media-library-c/media-library-module/capi-mediaassetmanager/capi-mediaassetmanager)。

![](../../../images/66813e34/note_3.0-zh-cn.png) 

开发前，需要参考[开发准备](/medialibrary-kit/restricted-open-capabilities/photoaccesshelper-preparation)，申请ohos.permission.READ\_IMAGEVIDEO权限。
