...
1. 新建一个Native C++工程。
   ...
   ![](../../../images/0d128c38/zh-cn_image_0000002583478995.png)
2. 获取设备的位置信息，需要有位置权限，位置权限申请的方法和步骤见[申请位置权限开发指导](/location-kit/location-preparation/location-permission-guidelines)。
