...
支持的设备中Wearable设备支持以下[支持的国家/地区](/location-kit/location-kit-appendix#支持的国家地区)，其他设备仅支持中国境内（不包含中国香港、中国澳门、中国台湾）。
...
本Kit支持模拟器，但与真机存在差异，详情请参见[模拟器与真机的差异](/ide-run-emulator/ide-emulator-overview/ide-emulator-specification)。
