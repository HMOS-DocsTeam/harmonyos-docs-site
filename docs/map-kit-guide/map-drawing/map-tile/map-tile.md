...
![](../../../images/dec64fd8/zh-cn_image_0000002552959044.jpg "点击放大")

## 接口说明

瓦片图层功能主要由[TileOverlayParams](/ref/map-api/map-arkts/map-common/map-common#tileoverlayparams)、[TileOverlayOptions](/ref/map-api/map-arkts/map-common/map-common#tileoverlayoptions)、[addTileOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addtileoverlay)和[TileOverlay](/ref/map-api/map-arkts/map-map/map-map-tileoverlay/map-map-tileoverlay)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-tileoverlay/map-map-tileoverlay)。

| 接口名 | 描述 |
| --- | --- |
| [TileOverlayParams](/ref/map-api/map-arkts/map-common/map-common#tileoverlayparams) | 瓦片图层参数。 |
| [TileOverlayOptions](/ref/map-api/map-arkts/map-common/map-common#tileoverlayoptions) | 瓦片图层参数。 |
| [addTileOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addtileoverlay)(params: [mapCommon.TileOverlayParams](/ref/map-api/map-arkts/map-common/map-common#tileoverlayparams) | [mapCommon.TileOverlayOptions](/ref/map-api/map-arkts/map-common/map-common#tileoverlayoptions)): [TileOverlay](/ref/map-api/map-arkts/map-map/map-map-tileoverlay/map-map-tileoverlay) | 为地图增加瓦片图层。 |
| [TileOverlay](/ref/map-api/map-arkts/map-map/map-map-tileoverlay/map-map-tileoverlay) | 瓦片图层，支持更新和查询相关属性。 |
