...
![](../../../images/e85fa708/zh-cn_image_0000002583479043.gif "点击放大")

## 接口说明

添加3D建筑功能主要由[BuildingOverlayParams](/ref/map-api/map-arkts/map-common/map-common#buildingoverlayparams)、[addBuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addbuildingoverlay)和[BuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay)。

| 接口名 | 描述 |
| --- | --- |
| [BuildingOverlayParams](/ref/map-api/map-arkts/map-common/map-common#buildingoverlayparams) | 3D建筑参数。 |
| [addBuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addbuildingoverlay)(params: [mapCommon.BuildingOverlayParams](/ref/map-api/map-arkts/map-common/map-common#buildingoverlayparams)): Promise&lt;[BuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay)&gt; | 在地图上添加3D建筑。 |
| [BuildingOverlay](/ref/map-api/map-arkts/map-map/map-map-buildingoverlay/map-map-buildingoverlay) | 3D建筑，支持更新和查询相关属性。 |
