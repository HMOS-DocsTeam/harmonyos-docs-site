...
![](../../../images/ebf2abb6/zh-cn_image_0000002552799378.jpg "点击放大")

## 接口说明

添加标记功能主要由[MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions)、[addMarker](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmarker)和[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)。

| 接口名 | 描述 |
| --- | --- |
| [MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions) | 标记参数。 |
| [addMarker](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmarker)(options: [mapCommon.MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions)): Promise&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt; | 在地图上添加标记。 |
| [Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker) | 标记，支持更新和查询相关属性。 |
...
1. 导入相关模块。
   ...
   ```
2. 添加标记，在callback方法中创建初始化参数并新建[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)。
   ...
   ![](../../../images/a3e22830/zh-cn_image_0000002583439073.jpg "点击放大")
...
通过在[MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions)中将icon属性设置为自定义图标的资源，可将默认标记图标修改成自定义图标。
...
![](../../../images/9a0703e3/zh-cn_image_0000002552959028.jpg "点击放大")

### 控制Marker文字显隐

通过[setAnnotationVisible](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker#setannotationvisible)方法可以控制Marker文字显隐，还可以通过[isAnnotationVisible](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker#isannotationvisible)方法来获取Marker文字显隐的状态。
...
![](../../../images/2dc26c50/zh-cn_image_0000002583479029.jpg "点击放大")

****图2**** 隐藏Marker文字之后

![](../../../images/7f5ed3da/zh-cn_image_0000002552799380.jpg "点击放大")

### 碰撞检测

通过在[MarkerOptions](/ref/map-api/map-arkts/map-common/map-common#markeroptions)中设置collisionRule属性，可以设置标记的冲突处理规则。
...
![](../../../images/1d55193a/zh-cn_image_0000002583439075.gif "点击放大")
...
1. 将[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)的拖拽属性设置为true。
2. 调用[on(type: 'markerDragStart' , callback: Callback&lt;Marker&gt;)](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdragstart)方法监听标记是否开始拖拽。
3. 调用[on(type: 'markerDrag' , callback: Callback&lt;Marker&gt;)](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdrag)，监听标记拖动过程。
4. 调用[on(type: 'markerDragEnd' , callback: Callback&lt;Marker&gt;)](/ref/map-api/map-arkts/map-map/map-map-mapeventmanager/map-map-mapeventmanager#onmarkerdragend)，监听标记拖动结束事件。
...
![](../../../images/fa236a53/zh-cn_image_0000002552959030.jpg "点击放大")
...
![](../../../images/f6e8e778/zh-cn_image_0000002583479031.jpg "点击放大")
...
| [TranslateAnimation](/ref/map-api/map-arkts/map-map/map-map-translateanimation/map-map-translateanimation) | 控制平移的动画类。 |
| [PlayImageAnimation](/ref/map-api/map-arkts/map-map/map-map-playimageanimation/map-map-playimageanimation) | 控制多张图片的动画类。 |
| [AnimationSet](/ref/map-api/map-arkts/map-map/map-map-animationset/map-map-animationset) | 动画集合。 |
...
![](../../../images/f0c2fa1a/zh-cn_image_0000002552799382.gif "点击放大")
...
![](../../../images/671ff2ca/zh-cn_image_0000002583439077.gif "点击放大")
...
![](../../../images/ab85019f/zh-cn_image_0000002552959032.jpg "点击放大")
