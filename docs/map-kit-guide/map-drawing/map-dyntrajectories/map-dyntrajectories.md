...
![](../../../images/f30dfacf/zh-cn_image_0000002552799394.gif "点击放大")

## 接口说明

绘制动态轨迹功能主要由[TraceOverlayParams](/ref/map-api/map-arkts/map-common/map-common#traceoverlayparams)、[addTraceOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addtraceoverlay)、[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)和[TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)。

| 接口名 | 描述 |
| --- | --- |
| [TraceOverlayParams](/ref/map-api/map-arkts/map-common/map-common#traceoverlayparams) | 动态轨迹参数。 |
| [addTraceOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addtraceoverlay)(params: [mapCommon.TraceOverlayParams](/ref/map-api/map-arkts/map-common/map-common#traceoverlayparams), markers?: Array&lt;[Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker)&gt;): Promise&lt;[TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay)&gt; | 绘制动态轨迹。 |
| [Marker](/ref/map-api/map-arkts/map-map/map-map-marker/map-map-marker) | 动态轨迹的一组标记。 |
| [TraceOverlay](/ref/map-api/map-arkts/map-map/map-map-traceoverlay/map-map-traceoverlay) | 动态轨迹，支持暂停和删除等功能。 |
