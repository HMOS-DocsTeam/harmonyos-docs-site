...
![](../../../images/7632be8b/zh-cn_image_0000002552959046.jpg "点击放大")

## 接口说明

海量点图层功能主要由[MassPointOverlayParams](/ref/map-api/map-arkts/map-common/map-common#masspointoverlayparams)、[addMassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmasspointoverlay)、[MassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-masspointoverlay/map-map-masspointoverlay)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-masspointoverlay/map-map-masspointoverlay)。

| 接口名 | 描述 |
| --- | --- |
| [MassPointOverlayParams](/ref/map-api/map-arkts/map-common/map-common#masspointoverlayparams) | 海量点参数。 |
| [addMassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#addmasspointoverlay)(params: mapCommon.[MassPointOverlayParams](/ref/map-api/map-arkts/map-common/map-common#masspointoverlayparams)): Promise&lt;[MassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-masspointoverlay/map-map-masspointoverlay)&gt; | 新增海量点。 |
| [MassPointOverlay](/ref/map-api/map-arkts/map-map/map-map-masspointoverlay/map-map-masspointoverlay) | 海量点管理对象。 |
