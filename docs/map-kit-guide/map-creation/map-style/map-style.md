...
![](../../../images/4c5d3e65/zh-cn_image_0000002583439059.jpg "点击放大")

## 接口说明

自定义样式功能主要由[CustomMapStyleOptions](/ref/map-api/map-arkts/map-common/map-common#custommapstyleoptions)、[setCustomMapStyle](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#setcustommapstyle)提供，更多接口及使用方法请参见[接口文档](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#setcustommapstyle)。

| 接口名 | 描述 |
| --- | --- |
| [CustomMapStyleOptions](/ref/map-api/map-arkts/map-common/map-common#custommapstyleoptions) | 自定义样式参数。 |
| [setCustomMapStyle](/ref/map-api/map-arkts/map-map/map-map-mapcomponentcontroller/map-map-mapcomponentcontroller#setcustommapstyle)(customMapStyleOptions: [mapCommon.CustomMapStyleOptions](/ref/map-api/map-arkts/map-common/map-common#custommapstyleoptions)): Promise&lt;void&gt; | 将地图样式修改为自定义样式。 |
...
2. 创建样式ID。
   ...
   ![](../../../images/a590dd28/zh-cn_image_0000002552959014.png)

   b.点击“Create map”创建自定义样式。

   ![](../../../images/d6c7bcfd/zh-cn_image_0000002583479015.png)

   c.导入JSON样式文件，点击“Import”。

   ![](../../../images/4e8eb999/zh-cn_image_0000002552799366.png)

   d.在编辑器里修改样式。

   ![](../../../images/ac21f555/zh-cn_image_0000002583439061.png)

   e.点击“SAVE”生成预览ID，预览ID在编辑样式时会重新生成，您可以通过预览ID测试样式效果。点击“PUBLISH”发布生成样式ID，样式ID是唯一ID，一旦发布生效不会变化。

   ![](../../../images/9760162a/zh-cn_image_0000002552959016.png)

   ![](../../../images/673c35da/zh-cn_image_0000002583479017.png)
3. Map Kit提供两种方法设置样式ID：
   ...
   - 在初始化地图时设置样式ID
     ...
     ![](../../../images/e099c749/zh-cn_image_0000002552799368.jpg "点击放大")
...
2. 设置样式内容。
   ...
   ![](../../../images/ff0b579c/zh-cn_image_0000002583439063.jpg "点击放大")
...
![](../../../images/af83b7c3/note_3.0-zh-cn.png) 
