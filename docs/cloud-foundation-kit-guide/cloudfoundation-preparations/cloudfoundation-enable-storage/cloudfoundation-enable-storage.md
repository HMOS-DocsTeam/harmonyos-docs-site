...
3. 选择“云开发（Serverless） > 云存储”，进入云存储页面，点击“立即开通”。
   ...
   ![](../../../images/c36045b8/zh-cn_image_0000002583478841.png)
4. 在引导界面输入存储实例名称并设置默认数据处理位置。

   ![](../../../images/2720d8c2/zh-cn_image_0000002552799192.png)
...
5. 点击“下一步”，进入默认安全策略展示界面。
   ...
   ![](../../../images/7a94cb4f/zh-cn_image_0000002583438887.png)

   ![](../../../images/98cbc132/note_3.0-zh-cn.png) 
...
7. 如果开发者已启用多个数据处理位置，当需要在不同的数据处理位置管理云存储时，可在云存储页面选择“数据处理位置”下拉选项进行切换。
   ...
   ![](../../../images/c5f929b1/zh-cn_image_0000002552958842.png)
