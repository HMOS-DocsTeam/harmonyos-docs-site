...
- ****跳链安装预加载****：适用于被分享用户安装应用后首次打开，应用详情页加载提速场景，可与安装预加载、周期性预加载结合使用。在应用安装过程中，预加载结合App Linking Kit的延迟链接功能，可提前将用户之前点击的详情页数据缓存到本地。当用户首次打开应用时，即可直接跳转到相应的详情页，并即时加载本地缓存的数据呈现内容。
  ...
  ![](../../../images/3bd1708d/note_3.0-zh-cn.png) 
...
![](../../../images/6b3893f1/zh-cn_image_0000002583478865.jpg)
...
![](../../../images/f7f6ffc4/zh-cn_image_0000002552799216.png)
...
![](../../../images/d5d15046/zh-cn_image_0000002583438911.png)
