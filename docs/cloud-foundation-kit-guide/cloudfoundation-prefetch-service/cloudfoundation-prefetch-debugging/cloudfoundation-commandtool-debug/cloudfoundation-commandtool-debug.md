...
- 设置HAP包的“Build Mode”为“debug”，且已[申请调试证书](https://developer.huawei.com/consumer/cn/doc/app/agc-help-debug-cert-0000002283256797)。
  ...
  ![](../../../../images/5161fb7e/zh-cn_image_0000002552958872.png)

## 切换shell环境

prefetch\_test\_tool命令行工具基于hdc shell调试，需要切换到hdc shell命令环境。

1. PC连接调试设备。连接方式请根据实际情况选择，详情请参见[设备连接管理](/system-debug-optimize/debugging-commands/hdc#设备连接管理)。
2. 打开DevEco Studio，菜单栏选择“View > Tool Windows > Terminal”进入Terminal窗口。

   ![](../../../../images/5706aa5d/zh-cn_image_0000002583478873.png)
3. 输入hdc shell，切换到hdc shell命令环境。切换过程中如果出现报错，请参见[常见问题](/system-debug-optimize/debugging-commands/hdc#常见问题)排查解决。

   ![](../../../../images/17516022/zh-cn_image_0000002552799224.png)
...
- 输入cf\_prefetch help，获取命令行工具的使用说明。
  ...
  ![](../../../../images/b4c80b59/zh-cn_image_0000002583438919.png)
- 输入cf\_prefetch getcache -h，获取getcache命令支持的参数信息。

  ![](../../../../images/c25368cf/zh-cn_image_0000002552958874.png)
- 输入cf\_prefetch getcache -m &lt;bundlename&gt;，立即向云侧请求获取一次周期性预加载数据。

  ![](../../../../images/29155ada/zh-cn_image_0000002583478875.png)

  ![](../../../../images/c9348f17/note_3.0-zh-cn.png) 
...
- 链路不通，例如无网络情况；或周期性预加载配置不正确。
  ...
  ![](../../../../images/8c3662f9/zh-cn_image_0000002552799226.png)
- 命令行工具内部错误。

  ![](../../../../images/9b965fed/zh-cn_image_0000002583438921.png)
- HAP包非debug调试模式。

  ![](../../../../images/9e24f1a9/zh-cn_image_0000002552958876.png)
- 应用包名输入错误。

  ![](../../../../images/057e1335/zh-cn_image_0000002583478877.png)
