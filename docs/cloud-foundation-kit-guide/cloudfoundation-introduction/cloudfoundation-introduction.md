...
DevEco Studio中还提供了[端云一体化开发](/ide-project/ide-module-management/agc-harmonyos-clouddevguide/agc-harmonyos-clouddev-overview)的开发体验，开发者可以基于统一的技术栈，高效、协同地完成端、云代码的编写、调试、编译和部署，极大提高构建HarmonyOS应用和元服务的效率。
...
![](../../images/c34d5733/zh-cn_image_0000002552799188.jpg)
...
![](../../images/281df27c/zh-cn_image_0000002583438883.jpg)
...
![](../../images/cb90d0a7/zh-cn_image_0000002552958838.jpg)
...
![](../../images/6dd7e985/zh-cn_image_0000002583478839.jpg)
...
请参见[支持的国家/地区](/cloud-foundation-kit-guide/cloudfoundation-appendix/cloudfoundation-supported-regions)。

### 支持的签名方式

支持[关联注册应用进行自动签名](/ide-signing#section20943184413328)（DevEco Studio 6.0.0 Beta5及以上版本）和[手动签名](/ide-signing#section297715173233)两种方式。
...
- 仅云函数、云数据库、云存储服务支持模拟器。关于如何使用模拟器调试，请参见[使用模拟器调试](/cloud-foundation-kit-guide/cloudfoundation-emulator)。
