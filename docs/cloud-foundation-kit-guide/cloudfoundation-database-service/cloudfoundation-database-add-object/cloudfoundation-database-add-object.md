...
已[开通云数据库服务](/cloud-foundation-kit-guide/cloudfoundation-preparations/cloudfoundation-enable-database)。
...
4. 点击“新增”，创建新的对象类型。
   ...
   ![](../../../images/7d75b050/zh-cn_image_0000002552799212.png)
5. 输入“对象类型名”为“BookInfo”后，点击“下一步”。

   ![](../../../images/4812c814/zh-cn_image_0000002583438907.png)
...
7. 点击“+”新增索引，设置“索引名”为“bookName”，点击“下一步”。
   ...
   ![](../../../images/8a1e8214/zh-cn_image_0000002552958862.png)
...
10. 勾选创建的BookInfo对象类型，点击“导出”。若不勾选对象类型，默认导出所有对象类型。
    ...
    ![](../../../images/476965b6/zh-cn_image_0000002583478863.png)
11. 导出“json格式”文件，点击“确定”。后续[引入对象类型文件](/cloud-foundation-kit-guide/cloudfoundation-database-service/cloudfoundation-database-add-file)时，需要使用此文件。

    ![](../../../images/3b25e8e8/zh-cn_image_0000002552799214.png)
