...
调用[StorageBucket.getDownloadURL](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudstorage/cloudfoundation-cloudstorage#getdownloadurl)接口获取云侧文件的下载地址。
