...
调用[StorageBucket.getMetadata](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudstorage/cloudfoundation-cloudstorage#getmetadata)获取指定云侧文件的元数据信息。
