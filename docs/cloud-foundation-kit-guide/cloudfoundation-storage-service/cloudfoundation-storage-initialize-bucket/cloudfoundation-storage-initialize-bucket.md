...
已[开通云存储服务](/cloud-foundation-kit-guide/cloudfoundation-preparations/cloudfoundation-enable-storage)。

## 操作步骤

调用[cloudStorage.bucket](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudstorage/cloudfoundation-cloudstorage#bucket)初始化一个存储实例。支持使用两种方式初始化实例：
...
- 使用指定的实例
  ...
  ![](../../../images/cc53eb51/caution_3.0-zh-cn.png) 
