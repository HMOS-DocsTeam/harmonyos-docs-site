...
调用[StorageBucket.setMetadata](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudstorage/cloudfoundation-cloudstorage#setmetadata)可以设置云侧文档的元数据信息。
