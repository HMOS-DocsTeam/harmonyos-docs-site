...
调用[StorageBucket.list](/ref/cloud-foundation-api/cloudfoundation-arkts-api/cloudfoundation-cloudstorage/cloudfoundation-cloudstorage#list)可以获取云侧指定目录的文件列表。
