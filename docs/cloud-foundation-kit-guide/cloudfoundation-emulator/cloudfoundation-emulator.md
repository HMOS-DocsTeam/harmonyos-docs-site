...
1. 获取调试凭据。
   ...
   3. 通过设置“No filters”模式、过滤“clouddevelopproxy.debugToken”关键字，查找日志中打印的调试凭据，并复制该调试凭据。
      ...
      ![](../../images/a464fa02/note_3.0-zh-cn.png) 

      如日志中查找不到调试凭据，请排查应用是否使用了错误的签名方式。当前Cloud Foundation Kit支持[关联注册应用进行自动签名](/ide-signing#section20943184413328)和[手动签名](/ide-signing#section297715173233)两种方式，请修改后再重试。

      ![](../../images/84a0257b/zh-cn_image_0000002552799228.png)
