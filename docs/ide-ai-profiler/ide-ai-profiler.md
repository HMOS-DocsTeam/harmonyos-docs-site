...
1. 首次使用请先根据界面提示完成CodeGenie授权登录。当前支持如下两种开启方式：
   ...
   ****方式一：****若Launch、Frame、Allocation、Snapshot模板已录制完成，点击****Session****窗口中该条会话上的![](../images/82f47b9a/zh-cn_image_0000002561832823.png "点击放大")图标，即可开始智慧调优分析。录制方法具体请参考[性能问题定位：深度录制](/ide-profiler-introduction/deep-recording)。

   ![](../images/2c49627a/zh-cn_image_0000002561832825.png)

   ****方式二：****切换至****Assistant****窗口，点击****Create Session****开始录制调优任务；或点击****Open File****按钮导入已有的调优数据文件，当前支持导入的文件类型包括.insight、.heapsnapshot、.rawheap。

   ![](../images/e06fbd00/zh-cn_image_0000002561752851.png)
2. 对于方式二，在****Assistant****页面，点击****Create Session****按钮，从****Launch****、****Frame****、****Snapshot****、****Allocation****中选择一个分析模板。

   ![](../images/cf246478/zh-cn_image_0000002561832833.png)

   ![](../images/8bc4262a/note_3.0-zh-cn.png) 

   使用Snapshot模板对堆快照问题进行分析时，支持在对话框中选择单个Snapshot分析，或选择两个Snapshot进行对比分析。

   ![](../images/4087fdd4/zh-cn_image_0000002530752910.png)
3. 以Allocation为例，录制新的调优任务或导入本地已有的调优数据模板文件。

   ![](../images/e2e9c728/zh-cn_image_0000002561752843.png)
4. 等待AI完成初步分析。左键点击高亮的泳道名称，点击****Analyze****进一步分析该阶段的具体内存信息，点击****View Lane****在右侧查看具体的泳道信息。

   ![](../images/4db3bad7/zh-cn_image_0000002530912904.png)
5. 点击****Analyze****后，逐步深入挖掘当前异常场景，找到影响性能的可能原因。

   ![](../images/d9617867/zh-cn_image_0000002561752855.png)
