...
- 方案1：可以在OMG命令中加入--op\_name\_map参数，参考[OMG参数](/cann-kit-guide/cannkit-model-conversion/cannkit-offline-model-conversion/cannkit-overall-parameter)中op\_name\_map参数设置。
- 方案2：可以在原始网络proto模型文件中将输出算子类型指定为SSDDetectionOutput等算子类型，如下图所示。

  ****图1**** 输出算子类型修改前（左）和修改后（右）

  ![](../../../images/4c2e838b/zh-cn_image_0000002552799644.png)
