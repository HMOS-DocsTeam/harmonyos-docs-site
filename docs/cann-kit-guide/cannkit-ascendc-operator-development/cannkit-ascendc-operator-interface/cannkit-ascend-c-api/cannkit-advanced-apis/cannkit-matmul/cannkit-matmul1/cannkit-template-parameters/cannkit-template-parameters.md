...
![](../../../../../../../../images/dfe72f82/zh-cn_image_0000002583479287.png)
...
- A\_TYPE、B\_TYPE、C\_TYPE类型信息通过[使用说明](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul1/cannkit-matmul-usage-description)表1来定义。
...
| ISTRANS | 是否开启使能矩阵转置的功能。当前不支持转置，只支持设为false。  false为不开启使能矩阵转置的功能，通过[SetTensorA](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul1/cannkit-settensora)和[SetTensorB](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul1/cannkit-settensorb)不能设置A、B矩阵是否转置。Matmul会认为A矩阵形状为[M, K]，B矩阵形状为[K, N]。  默认为false不使能转置。 |
...
| IterateOrder | Matmul做矩阵运算的循环迭代顺序，与[TCubeTiling结构体](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul-tiling-class/cannkit-tcubetiling-structure)表1中的iterateOrder参数含义相同。当ScheduleType参数取值为ScheduleType::OUTER\_PRODUCT或1时，本参数生效。参数取值如下。  - ORDER\_M = 0, // 先往M轴方向偏移再往N轴方向偏移  - ORDER\_N, // 先往N轴方向偏移再往M轴方向偏移  - UNDEF, // 当前无效  ****说明：**** MDL模板使用时，若IterateOrder取值ORDER\_M，[TCubeTiling结构体](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul-tiling-class/cannkit-tcubetiling-structure)表1中的stepN需要大于1，IterateOrder取值ORDER\_N时，TCubeTiling结构中的stepM需要大于1。 | Norm、MDL |
...
| iterateOrder | IterateOrder | Matmul做矩阵运算的循环迭代顺序，与[TCubeTiling结构体](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul-tiling-class/cannkit-tcubetiling-structure)表1中的iterateOrder参数含义相同。当ScheduleType参数取值为ScheduleType::OUTER\_PRODUCT或1时，本参数生效。参数取值如下。  - ORDER\_M = 0, // 先往M轴方向偏移再往N轴方向偏移  - ORDER\_N, // 先往N轴方向偏移再往M轴方向偏移  - UNDEF, // 当前无效  ****说明：**** MDL模板使用时，若IterateOrder取值ORDER\_M，[TCubeTiling结构体](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-advanced-apis/cannkit-matmul/cannkit-matmul-tiling-class/cannkit-tcubetiling-structure)表1中的stepN需要大于1，IterateOrder取值ORDER\_N时，TCubeTiling结构中的stepM需要大于1。 |
