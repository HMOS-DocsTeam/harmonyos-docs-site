...
- ****GM****->****VECIN/VECOUT****
  ...
  ****配置示例1：****
  ...
  - blockLen+leftPadding+rightPadding不满足32字节对齐时，框架会填充一些假数据dummy，保证左右填充的数据和blockLen、假数据为32字节对齐。leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](../../../../../../../images/c7a10df8/zh-cn_image_0000002583479279.png)
  ...
  ****配置示例2：****
  ...
  - blockLen+leftPadding+rightPadding不满足32字节对齐，leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](../../../../../../../images/96f594e9/zh-cn_image_0000002552799630.png)
- ****VECIN/VECOUT****->****GM****
  ...
  ![](../../../../../../../images/bbac6bd4/zh-cn_image_0000002583439325.png)
  ...
  ![](../../../../../../../images/b4259ec9/zh-cn_image_0000002552959280.png)
- ****VECIN/VECOUT->TSCM****
  ...
  ![](../../../../../../../images/8481abfb/zh-cn_image_0000002583479281.png)
