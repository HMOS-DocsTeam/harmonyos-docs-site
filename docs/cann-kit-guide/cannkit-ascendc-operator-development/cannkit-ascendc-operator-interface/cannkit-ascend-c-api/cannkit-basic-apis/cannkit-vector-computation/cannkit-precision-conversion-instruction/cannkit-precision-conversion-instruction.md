...
- half共16bit，包括1bit符号位（S），5bit指数位（E）和10bit尾数位（M）。
  ...
  ![](../../../../../../../images/9cb471c8/zh-cn_image_0000002583479271.png)
...
- float共32bit，包括1bit符号位（S），8bit指数位（E）和23bit尾数位（M）。
  ...
  ![](../../../../../../../images/86d7039b/zh-cn_image_0000002552799622.png)
...
- bfloat16\_t共16bit，包括1bit符号位（S），8bit指数位（E）和7bit尾数位（M）。
  ...
  ![](../../../../../../../images/1c403560/zh-cn_image_0000002583439317.png)

  上图中S = 0，E = 127，M = 2-1 + 2-2，最终表示的结果为1.75。

****二进制的舍入规则和十进制类似，具体如下。****

![](../../../../../../../images/bae12635/zh-cn_image_0000002552959272.png)
...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| dstLocal | 输出 | 目的操作数。  类型为[LocalTensor](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-data-type-definition/cannkit-localtensor)，支持的TPosition为VECIN/VECCALC/VECOUT。  LocalTensor的起始地址需要32字节对齐。 |
| srcLocal | 输入 | 源操作数。  类型为[LocalTensor](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-data-type-definition/cannkit-localtensor)，支持的TPosition为VECIN/VECCALC/VECOUT。  LocalTensor的起始地址需要32字节对齐。 |
