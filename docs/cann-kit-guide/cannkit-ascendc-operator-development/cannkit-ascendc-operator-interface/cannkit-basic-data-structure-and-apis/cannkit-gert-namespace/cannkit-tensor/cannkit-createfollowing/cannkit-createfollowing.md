...
| --- | --- | --- |
| shape\_size | 输入 | 元素个数。 |
| dt | 输入 | 数据类型，[DataType](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-basic-data-structure-and-apis/cannkit-ge-namespace/cannkit-ge-datatype)类型。 |
