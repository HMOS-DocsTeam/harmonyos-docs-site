...
关于graphStatus的定义，请参见[ge::graphStatus](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-basic-data-structure-and-apis/cannkit-ge-namespace/cannkit-gegraphstatus)。
