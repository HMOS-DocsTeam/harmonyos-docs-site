...
| 数据排布格式(format) | 数据的物理排布格式，定义了解读数据的维度。  详细请参见[数据排布格式](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-custom-operator-development/cannkit-featured-topics/cannkit-tensor-basics/cannkit-data-layout-format)。 |
