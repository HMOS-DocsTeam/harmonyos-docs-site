...
![](../../../../../../images/8911e806/note_3.0-zh-cn.png) 

- 不同类型的AI处理器，存储单元大小不同，开发者可通过[GetCoreMemSize](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-host-api/cannkit-platformascendc/cannkit-getcorememsize)接口获取。
