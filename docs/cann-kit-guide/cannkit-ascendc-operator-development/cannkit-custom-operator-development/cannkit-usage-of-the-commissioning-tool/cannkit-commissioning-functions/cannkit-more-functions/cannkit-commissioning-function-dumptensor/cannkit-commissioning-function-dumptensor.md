...
![](../../../../../../../images/c5c0e514/note_3.0-zh-cn.png) 
...
2. simulator调测场景执行如下命令，使能Dump开关。
   ...
   --dump-mode取normal，开启通用打印Tensor模式，其他参数参考[NPU调测参数](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-custom-operator-development/cannkit-featured-topics/cannkit-commissioning-tool-parameter/cannkit-cli-parameters#npu调测参数)按需配置。
