...
![](../../../../../../images/e7023f43/note_3.0-zh-cn.png) 
...
2. 执行如下命令进行CAModel性能仿真，仅提供关键参数项示例，其他参数请参考[Simulator仿真参数](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-custom-operator-development/cannkit-featured-topics/cannkit-commissioning-tool-parameter/cannkit-cli-parameters#simulator仿真参数)按需设置。
...
![](../../../../../../images/32be4f80/note_3.0-zh-cn.png) 
...
3. 在CAModel仿真结果trace图上查看打点结果。
   ...
   ****图1**** 仿真打点示意图
   ...
   ![](../../../../../../images/9fc20a44/zh-cn_image_0000002583439295.png)
