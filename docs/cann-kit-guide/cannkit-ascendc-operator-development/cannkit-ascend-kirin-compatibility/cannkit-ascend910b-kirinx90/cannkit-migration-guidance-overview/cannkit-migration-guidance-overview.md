...
Ascend910B/Ascend910C和KirinX90/Kirin9030之间的ASC API详细能力差异，见[《Ascend C算子接口》](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-ascend-c-apis)。本节当前重点描述主要的差异和兼容适配方案，其它情况可类比参考。
...
由于AI处理器架构版本区别，Ascend910B/Ascend910C和KirinX90/Kirin9030 主要差异请参见下表。具体影响的API，详见[基础API迁移指导](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascend-kirin-compatibility/cannkit-ascend910b-kirinx90/cannkit-basic-api/cannkit-basic-l2cache)和[高阶API迁移指导](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascend-kirin-compatibility/cannkit-ascend910b-kirinx90/cannkit-adv-api)。
