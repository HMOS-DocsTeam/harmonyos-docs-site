...
![](../../../../images/16ae52b8/zh-cn_image_0000002552959292.png "点击放大")
...
2. 建议开发者使用如下接口或编程方式。
   ...
   - 兼容的API。
   - 若涉及特定领域扩展特性，在Device侧用[NPU\_ARCH编译宏](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascend-kirin-compatibility/cannkit-ascend910b-kirinx90/cannkit-migration-guidance-overview)进行隔离，在Host侧用[SocVersion](/cann-kit-guide/cannkit-ascendc-operator-development/cannkit-ascendc-operator-interface/cannkit-ascend-c-api/cannkit-host-api/cannkit-platformascendc/cannkit-getsocversion)进行隔离。
