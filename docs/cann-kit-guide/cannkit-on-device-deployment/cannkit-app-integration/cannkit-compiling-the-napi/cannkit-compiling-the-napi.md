...
按需引用[NNCore](/ref/neural-network-runtime-api/neural-network-runtime-c/neural-network-runtime-module/capi-neuralnetworkruntime/capi-neuralnetworkruntime)和[CANN Kit](/ref/cann-api/hiai-foundation-c/cannkit-total/cannkit-files/cannkit-hiai-aipp-param-8h/cannkit-hiai-aipp-param-8h)的头文件。
