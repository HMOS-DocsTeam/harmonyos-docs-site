...
.om是标准IR算子构建的OM模型文件，其中quant8\_8.om是量化生成的OM模型文件，所有模型可通过[Netron工具](/cann-kit-guide/cannkit-appendixes/cannkit-visualization-tool-usage)可视化。
...
![](../../../images/9add48cc/note_3.0-zh-cn.png) 
