...
| 类型 | 说明 |
| --- | --- |
| [Product](/ide-build-expanding/ide-hvigor-apis/ide-hvigor-api#section1553414254713) | 当前构建指定的product对象 |
...
![](../../../images/afe1ee9f/note_3.0-zh-cn.png) 
...
![](../../../images/f3b3d34e/note_3.0-zh-cn.png) 
...
| 类型 | 说明 |
| --- | --- |
| [SdkDetails](/ide-build-expanding/ide-hvigor-apis/ide-hvigor-api#section1463642114714) | SDK相关的信息 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (target: [Target](/ide-build-expanding/ide-hvigor-apis/ide-hvigor-api#section12392182963714)) => void | 是 | 入参类型为Target，返回类型为void的函数 |
...
![](../../../images/6a826fcb/note_3.0-zh-cn.png) 
...
![](../../../images/7adfcdd0/note_3.0-zh-cn.png) 
