...
获取根项目的节点对象。在[nodesInitialized和之后的阶段](/ide-hvigor/ide-hvigor-life-cycle#section746253616316)才能使用，否则会报错。
...
![](../../../images/161693fe/note_3.0-zh-cn.png) 

此API写在[hvigorconfig.ts文件](/ide-hvigor/ide-hvigor-life-cycle#section810245135914)中才会生效，在构建生命周期的初始化阶段被执行。
...
![](../../../images/22cc8b4d/note_3.0-zh-cn.png) 
...
![](../../../images/6f80f675/note_3.0-zh-cn.png) 
...
![](../../../images/495e628a/note_3.0-zh-cn.png) 
...
从DevEco Studio 6.0.0 Beta3版本开始，支持排除工程中不存在的模块，具体请参考[通过Hvigor执行ohpm install](/ide-build-optimized/ide-hvigor-experimental-properties#section11663628141317)。
...
![](../../../images/89265444/note_3.0-zh-cn.png) 
...
HarmonyOS应用工程级配置中的Product信息接口。在调用Product的接口前，可以先通过OhosAppContext的[getCurrentProduct](/ide-build-expanding/ide-hvigor-apis/ide-build-expanding-context#section962214395515)方法来获取本对象。
...
![](../../../images/74be71e6/note_3.0-zh-cn.png) 
...
![](../../../images/8dd4c8aa/note_3.0-zh-cn.png) 

依赖其他模块的任务时，建议将任务注册操作放在[hook-nodesEvaluated](/ide-hvigor/ide-hvigor-life-cycle#section746253616316)中，否则注册时其他模块的任务可能还未被初始化，导致当前任务无法注册。
...
![](../../../images/fefe8d93/note_3.0-zh-cn.png) 
...
应用工程使用的SDK相关的信息。在调用SdkDetails的接口前，可以先通过OhosAppContext的[getSdkDetails](/ide-build-expanding/ide-hvigor-apis/ide-build-expanding-context#section085712212299)方法来获取本对象。
