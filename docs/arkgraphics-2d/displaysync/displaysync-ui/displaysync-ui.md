...
如果开发者需要以独立的帧率绘制更新操作UI界面时，可以通过DisplaySync来实现。应用中绘制内容的帧率可以使用DisplaySync实例来控制，具体请查阅[@ohos.graphics.displaySync (可变帧率)](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-displaysync/js-apis-graphics-displaysync)。
...
4. 通过DisplaySync实例设置帧率和注册订阅函数。
   ...
   ![](../../../images/3504e135/note_3.0-zh-cn.png) 
...
5. 开始每帧回调。
   ...
   ![](../../../images/7e2df8fc/note_3.0-zh-cn.png) 
