...
通过[RenderNode](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-rendernode/js-apis-arkui-rendernode)获取可直接上屏显示的Canvas画布。
...
2. 添加自定义RenderNode。
   ...
   ```
3. 添加自定义[NodeController](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-nodecontroller/js-apis-arkui-nodecontroller)。
   ...
   ```
4. 重写自定义RenderNode的[draw()](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-rendernode/js-apis-arkui-rendernode#draw)函数，获取Canvas进行自定义的绘制操作，即本章下文中的内容。
...
5. 重写自定义RenderNode的[draw()](/ref/arkui-api/arkui-arkts/ui/ui-interface-arkui/js-apis-arkui-rendernode/js-apis-arkui-rendernode#draw)函数，在其中获取离屏Canvas进行绘制：
