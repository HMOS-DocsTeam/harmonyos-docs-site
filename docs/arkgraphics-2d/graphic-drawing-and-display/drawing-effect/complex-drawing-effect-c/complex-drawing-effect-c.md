...
可以使用OH\_Drawing\_BrushSetBlendMode()接口将混合模式应用于画刷中，使用OH\_Drawing\_PenSetBlendMode()接口将混合模式应用于画笔中。这两个接口都需要接受一个参数OH\_Drawing\_BlendMode，即混合模式的类型，具体可参考[OH\_Drawing\_BlendMode](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-types-h/capi-drawing-types-h#oh_drawing_blendmode)。
...
![](../../../../images/553df4a7/zh-cn_image_0000002583438695.png)
...
着色器相关接口和具体参数的说明请见[drawing\_shader\_effect](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-shader-effect-h/capi-drawing-shader-effect-h)。
...
![](../../../../images/a19743ef/zh-cn_image_0000002552799002.png)
...
![](../../../../images/11c9a560/zh-cn_image_0000002583438697.png)
...
![](../../../../images/5d06954c/zh-cn_image_0000002552958652.png)
...
滤波器相关接口和具体参数的说明请见[drawing\_filter.h](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-filter-h/capi-drawing-filter-h)。

### 颜色滤波器效果

颜色滤波器可基于画笔或画刷实现，颜色滤波器的相关接口和具体参数的说明请见[drawing\_color\_filter.h](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-color-filter-h/capi-drawing-color-filter-h)。
...
图像滤波器可基于画笔或画刷来实现，图像滤波器的相关接口和具体参数的说明请见[drawing\_image\_filter.h](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-image-filter-h/capi-drawing-image-filter-h)。
...
蒙版滤波器可基于画笔或画刷实现，蒙版滤波器的相关接口和具体参数的说明请见[drawing\_mask\_filter.h](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-mask-filter-h/capi-drawing-mask-filter-h)。

可使用OH\_Drawing\_MaskFilterCreateBlur()接口创建想要设置具有模糊效果的蒙版滤波器。接口接受3个参数，分别为：

- blurType：用于指定要应用的模糊类型，详细分类请参考[OH\_Drawing\_BlurType](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-mask-filter-h/capi-drawing-mask-filter-h#oh_drawing_blurtype)。
