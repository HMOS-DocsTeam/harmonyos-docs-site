...
详细的接口说明请参考[native\_image](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-module/capi-oh-nativeimage/capi-oh-nativeimage)。
...
1. ****初始化EGL环境****。
   ...
   这里提供初始化EGL环境的代码示例。XComponent模块的详细使用方法，请参阅[XComponent开发指导](/arkui/arkts-ui-development/arkts-add-component/napi-xcomponent-guidelines)。
