...
详细的接口说明请参考[native\_window](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-module/capi-nativewindow/capi-nativewindow)。
...
1. 获取OHNativeWindow实例。
   ...
   可通过[OH\_NativeXComponent\_Callback](/ref/arkui-api/arkui-c/arkui-struct/ent-native-xcomponent-oh-nativexcomponent-callback/ent-native-xcomponent-oh-nativexcomponent-callback)接口获取OHNativeWindow。代码示例如下。关于XComponent模块的使用方法，详见[XComponent开发指导](/arkui/arkts-ui-development/arkts-add-component/napi-xcomponent-guidelines)。
