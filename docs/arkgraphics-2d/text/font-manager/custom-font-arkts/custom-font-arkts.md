...
自定义字体注册和使用的常用接口如下表所示，详细接口说明请见[@ohos.graphics.text (文本模块)](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text)。
...
![](../../../../images/4e2c5754/zh-cn_image_0000002583438717.png)

![](../../../../images/0ad57e47/zh-cn_image_0000002552958672.png)
