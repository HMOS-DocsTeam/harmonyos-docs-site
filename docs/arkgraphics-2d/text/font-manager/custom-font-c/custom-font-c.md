...
注册使用自定义字体的相关接口如下所示，详细接口说明请参考[Drawing](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-module/capi-drawing/capi-drawing)。
...
3. 创建字体管理器，建议优先使用OH\_Drawing\_CreateSharedFontCollection()创建可共享的字体集对象。
   ...
   ![](../../../../images/1bbd981d/note_3.0-zh-cn.png) 
...
4. 设置自定义字体的字体家族名和字体文件所在的沙箱路径。
   ...
   ![](../../../../images/529486fa/note_3.0-zh-cn.png) 
