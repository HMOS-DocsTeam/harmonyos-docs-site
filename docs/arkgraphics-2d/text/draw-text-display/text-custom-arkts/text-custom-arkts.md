...
文本塑形中常用接口如下表所示，详细接口说明参考[@ohos.graphics.text (文本模块)](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-text/js-apis-graphics-text#paragraph)和[@ohos.graphics.drawing (drawing TextBlob)](/ref/arkgraphics-api/arkgraphics-arkts/js-apis-graphics-drawing/arkts-apis-graphics-drawing-textblob/arkts-apis-graphics-drawing-textblob)。
...
![](../../../../images/1ceeba82/zh-cn_image_0000002552799040.png)
