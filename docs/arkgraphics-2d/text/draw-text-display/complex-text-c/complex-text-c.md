...
画布Canvas对象具体可见[画布的获取与绘制结果的显示](/arkgraphics-2d/graphic-drawing-and-display/canvas-get-result-draw/canvas-get-result-draw-c)。
...
![](../../../../images/10c4b13c/zh-cn_image_0000002552958690.png)
...
![](../../../../images/adf575e5/zh-cn_image_0000002552799044.png)
...
![](../../../../images/3dff5c80/zh-cn_image_0000002583438739.png)
...
![](../../../../images/656a10a8/zh-cn_image_0000002552958694.png)
...
![](../../../../images/527ec077/zh-cn_image_0000002583478695.png)
...
![](../../../../images/e2c3819b/zh-cn_image_0000002552799046.png)
...
****渐变色****是一种在文字设计中广泛应用的视觉效果，通过在文字的不同部分应用不同的颜色，从而创造出从一种颜色平滑过渡到另一种颜色的效果。可以通过着色器实现文字渐变的效果，着色器的更多介绍请参考[着色器效果](/arkgraphics-2d/graphic-drawing-and-display/drawing-effect/complex-drawing-effect-c#着色器效果)。
...
![](../../../../images/f73af948/zh-cn_image_0000002583478697.png)
...
![](../../../../images/65c24892/zh-cn_image_0000002552799034.jpg)
...
![](../../../../images/9e3297a7/zh-cn_image_0000002583478685.jpg)
...
| 接口定义 | 描述 |
| --- | --- |
| void OH\_Drawing\_SetTextHighContrast(OH\_Drawing\_TextHighContrast action) | 设置文字渲染高对比度模式。模式具体可参考[OH\_Drawing\_TextHighContrast](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-global-h/capi-drawing-text-global-h#oh_drawing_texthighcontrast)。 |
...
| 接口定义 | 描述 |
| --- | --- |
| [OH\_Drawing\_ErrorCode OH\_Drawing\_SetTextStyleAttributeDouble(OH\_Drawing\_TextStyle\* style, OH\_Drawing\_TextStyleAttributeId id, double value)](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_settextstyleattributedouble) | 传入id为OH\_Drawing\_TextStyleAttributeId::TEXT\_STYLE\_ATTR\_D\_LINE\_HEIGHT\_MAXIMUM，设置行高上限。 |
...
| 接口定义 | 描述 |
| --- | --- |
| [void OH\_Drawing\_SetTextStyleFontHeight(OH\_Drawing\_TextStyle\* style, double fontHeight)](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_settextstylefontheight) | 使能行高缩放。 |
| [OH\_Drawing\_ErrorCode OH\_Drawing\_SetTextStyleAttributeInt(OH\_Drawing\_TextStyle\* style, OH\_Drawing\_TextStyleAttributeId id)](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_settextstyleattributeint) | 传入id为OH\_Drawing\_TextStyleAttributeId::TEXT\_STYLE\_ATTR\_I\_LINE\_HEIGHT\_STYLE，使能行高缩放样式。 |
...
| 接口定义 | 描述 |
| --- | --- |
| [OH\_Drawing\_ErrorCode OH\_Drawing\_SetTypographyStyleAttributeDouble(OH\_Drawing\_TypographyStyle\* style, OH\_Drawing\_TypographyStyleAttributeId id, double value)](/ref/arkgraphics-api/arkgraphics-c/arkgraphics-headerfile/capi-drawing-text-typography-h/capi-drawing-text-typography-h#oh_drawing_settypographystyleattributedouble) | 传入id为OH\_Drawing\_TypographyStyleAttributeId::TYPOGRAPHY\_STYLE\_ATTR\_D\_LINE\_SPACING，设置行间距。 |
...
![](../../../../images/078fa06b/zh-cn_image_0000002552958698.png)
