...
title: "工具概述"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-codegenie
...
![](../images/6d0dab33/zh-cn_image_0000002561833547.png)
...
1. 在DevEco Studio菜单栏，点击****File > Settings****（macOS为****DevEco Studio > Preferences********/********Settings****）****> Plugins****，点击![](../images/ebe54fe0/zh-cn_image_0000002530753624.png) ****> Install Plugin from Disk…****安装本地插件。

   ![](../images/9139ec2c/zh-cn_image_0000002530753626.png)
2. 在弹出的文件选择窗口中，选择****未解压的插件********包****的存放位置，点击****OK****确认安装插件。

   ![](../images/9a8d9de4/zh-cn_image_0000002561753567.png)
3. 点击****Restart IDE****，重新启动DevEco Studio。

   ![](../images/deac2136/zh-cn_image_0000002561753563.png)
4. 在DevEco Studio右侧边栏点击****CodeGenie****，完成登录并开始体验。

![](../images/1b0e5447/note_3.0-zh-cn.png) 
