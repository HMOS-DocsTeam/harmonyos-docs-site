...
![](../../../../../images/cc44462c/note_3.0-zh-cn.png) 
...
2. 构造接口参数并调用startAbilityByType接口。
   ...
   ![](../../../../../images/26f9b9c8/zh-cn_image_0000002552797856.png)

## 目标方开发步骤

1. 在module.json5中配置[uris](/development-fundamentals/application-configuration-file-stage/module-configuration-file#skills标签)，步骤如下：
...
2. 解析参数并做对应处理。
   ...
   应用可根据[linkFeature](/development-fundamentals/application-configuration-file-stage/module-configuration-file#skills标签)中定义的特性功能，比如路线规划、导航和位置搜索，结合接收到的uri和参数开发不同的样式页面。
