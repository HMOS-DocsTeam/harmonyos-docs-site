...
2. 构造接口参数并调用startAbilityByType接口。
   ...
   ![](../../../../../images/164c5fa0/zh-cn_image_0000002552797858.png)
...
2. 解析面板传过来的参数并做对应处理。
   ...
   应用可根据[linkFeature](/development-fundamentals/application-configuration-file-stage/module-configuration-file#skills标签)中定义的特性功能，比如转账汇款和信用卡还款，结合接收到的uri开发不同的样式页面。
