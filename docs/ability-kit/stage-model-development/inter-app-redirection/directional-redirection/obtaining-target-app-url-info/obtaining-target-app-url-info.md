...
开发者在使用[UIAbilityContext.openLink](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#openlink12)接口拉起目标应用时，需要传入目标应用的URL信息。本章节主要介绍如何获取目标应用的URL信息。

假设目标应用的UIAbility的[module.json5](/development-fundamentals/application-configuration-file-stage/module-configuration-file)配置信息如下：
...
开发者需要先获取[hdc工具](/system-debug-optimize/debugging-commands/hdc)。

## 操作步骤

1. 使用[bm工具](/system-debug-optimize/debugging-commands/bm-tool)获取目标应用的bundleName。
...
2. 根据bundleName获取目标应用的Mission ID。
   ...
   1. 使用[aa工具](/system-debug-optimize/debugging-commands/aa-tool)，获取目标应用的abilityName。
...
4. 根据获取到的配置信息拼接生成URL信息。
   ...
   ![](../../../../../images/91ddfd18/note_3.0-zh-cn.png) 
...
5. 使用Deep Linking方式拉起目标应用。
   ...
   以下为通过[UIAbilityContext.openLink](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#openlink12)接口拉起目标应用的完整示例。

   ![](../../../../../images/30174ece/note_3.0-zh-cn.png) 
...
6. 调试验证。
   ...
   ****图1**** 拉起目标应用演示
   ...
   ![](../../../../../images/36aa5a70/zh-cn_image_0000002583477503.gif)
