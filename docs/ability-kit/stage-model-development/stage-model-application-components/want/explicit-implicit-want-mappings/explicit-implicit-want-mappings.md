...
在启动目标应用组件时，会通过显式[Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)或者隐式[Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)进行目标应用组件的匹配，这里说的匹配规则就是调用方传入的[want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)参数中设置的参数如何与目标应用组件声明的配置文件进行匹配。

## 显式Want匹配原理

显式[Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)匹配原理如下表所示。
...
隐式[Want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)匹配原理如下表所示。
...
- 待匹配应用组件的skills配置，声明其具备的能力（[module.json5配置文件](/development-fundamentals/application-configuration-file-stage/module-configuration-file)中的[skills标签](/development-fundamentals/application-configuration-file-stage/module-configuration-file#skills标签)参数）。
...
![](../../../../../images/b285360e/zh-cn_image_0000002583477495.png)
...
![](../../../../../images/a07243ff/zh-cn_image_0000002552797846.png)
...
![](../../../../../images/99052cca/zh-cn_image_0000002583437541.png)
...
![](../../../../../images/e3565eb8/zh-cn_image_0000002552957496.png)
...
![](../../../../../images/9c49907d/note_3.0-zh-cn.png) 
...
![](../../../../../images/1cea3c91/zh-cn_image_0000002583477497.png)

### type匹配规则

![](../../../../../images/e5c296a3/note_3.0-zh-cn.png) 
...
![](../../../../../images/aa5d102f/note_3.0-zh-cn.png) 
...
![](../../../../../images/fdb71c61/zh-cn_image_0000002552797848.png)

![](../../../../../images/f3391592/zh-cn_image_0000002583437543.png)
