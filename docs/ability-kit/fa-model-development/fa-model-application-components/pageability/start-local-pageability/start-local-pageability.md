...
如下示例通过startAbility显式启动PageAbility。启动Ability的参数包含want，关于want的说明详见[对象间信息传递载体Want](/ability-kit/fa-model-development/fa-model-application-components/want-fa)，相应的，隐式启动与显式启动也不在此赘述。
