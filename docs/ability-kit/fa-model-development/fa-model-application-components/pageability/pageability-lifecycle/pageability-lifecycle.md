...
![](../../../../../images/1382f9be/zh-cn_image_0000002583437557.png)
...
![](../../../../../images/42186120/zh-cn_image_0000002552957512.png)

![](../../../../../images/0b069504/note_3.0-zh-cn.png) 
...
1. 在app.ets文件中实现Ability生命周期回调。
   ...
   ```
2. Index.ets页面提供一个"terminateSelf"按钮，点击后调用[featureAbility.terminateSelf](/ref/ability-api/ability-arkts/fa-model/js-apis-ability-featureability/js-apis-ability-featureability#featureabilityterminateself7-1)接口关闭Ability，从而触发onDestroy生命周期回调。
