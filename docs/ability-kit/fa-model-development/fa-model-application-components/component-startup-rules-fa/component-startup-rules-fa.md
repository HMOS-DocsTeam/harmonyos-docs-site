...
- ****跨应用启动组件，需校验目标组件Visible****
  ...
  - 组件visible配置参考[abilities对象的内部结构](/development-fundamentals/application-configuration-file-fa/module-structure#abilities对象的内部结构)的visible属性。
- ****位于后台的应用，启动组件需校验BACKGROUND权限****

  ![](../../../../images/59b57c5c/note_3.0-zh-cn.png) 
...
- ****跨应用启动[FA模型](/ability-kit/ability-terminology#fa模型)的ServiceAbility组件或DataAbility组件，对端应用需配置关联启动****
...
![](../../../../images/1c2f02c3/note_3.0-zh-cn.png) 
...
![](../../../../images/76550c22/zh-cn_image_0000002552797864.png)
...
![](../../../../images/3a3d8671/zh-cn_image_0000002583437559.png)
