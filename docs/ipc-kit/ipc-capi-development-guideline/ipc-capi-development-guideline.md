...
IPC CAPI接口不直接提供获取通信代理对象的能力，该功能由[Ability Kit](/ability-kit/abilitykit-overview)提供。

![](../../images/18e8b888/zh-cn_image_0000002583478319.png)

进程间IPC通道的建立，请参考[Native子进程开发指导（C/C++）](/ability-kit/native-childprocess-development/capi-nativechildprocess-development-guideline)。本文重点介绍IPC CAPI的使用。
...
详细的接口说明请参考[IPCKit](/ref/ipc-api/ipc-c/ipc-module/capi-ipckit/capi-ipckit)。
