...
UDMF标准化数据定义包括[标准化数据类型](/arkdata/uniform-data-definition/uniform-data-type-descriptors)和[标准化数据结构](/arkdata/uniform-data-definition/uniform-data-structure)。
...
![](../../../images/e926c3a4/zh-cn_image_0000002552957520.png)
