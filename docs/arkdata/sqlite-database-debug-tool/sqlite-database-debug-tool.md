...
![](../../images/21768be6/note_3.0-zh-cn.png) 

- 从HarmonyOS 6.0.0开始，支持使用SQLite调试工具。
- 开发者也可以通过DevEco Studio调试数据库，具体操作方式请参考[访问应用数据库](/ide-debug-app/ide-database-inspector)。

## 环境要求

- 开发者在使用本工具前需开启[开发者模式](/ide-debug-app/ide-developer-mode#section530763213432)，且需要获取[hdc工具](/system-debug-optimize/debugging-commands/hdc)，执行hdc shell。
- 连接设备。
