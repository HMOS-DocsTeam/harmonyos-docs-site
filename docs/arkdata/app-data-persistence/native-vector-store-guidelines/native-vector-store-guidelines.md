...
详情见[规格限制](/arkdata/app-data-persistence/data-persistence-by-vector-store#规格限制)。
...
3. 获取到OH\_Rdb\_Store后，建表并插入数据。
   ...
   ![](../../../images/2c8bfc58/note_3.0-zh-cn.png) 
...
5. 获取到OH\_Rdb\_Store后，查询数据。
   ...
   ![](../../../images/6238d8e9/note_3.0-zh-cn.png) 
...
7. ‌使用向量索引进行查询，提升查询效率。
   ...
   ****表3**** 扩展语法参数(parameter)
   ...
   ![](../../../images/a6bb8c90/note_3.0-zh-cn.png) 
