...
- [应用间配置共享](/arkdata/cross-app-data-share/one-to-many-data-share/share-config)
...
[通过标准化数据通路实现数据共享](/arkdata/cross-app-data-share/many-to-many-data-share/unified-data-channels)
