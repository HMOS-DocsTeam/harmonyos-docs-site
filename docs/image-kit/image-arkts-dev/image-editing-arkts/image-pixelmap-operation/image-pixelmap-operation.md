...
![](../../../../images/8b604958/zh-cn_image_0000002583438635.png)

## 开发步骤

位图操作相关API的详细介绍请参见[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。

1. 完成[图片解码](/image-kit/image-arkts-dev/image-decoding-arts/image-decoding)，获取PixelMap位图对象。
...
3. 读取并修改目标区域像素数据，写回原图。
   ...
   ![](../../../../images/c4fe98b0/note_3.0-zh-cn.png) 
...
![](../../../../images/6fb80a46/note_3.0-zh-cn.png) 

- 该方法仅可实现PixelMap基本内容的复制，不支持复制色域和HDR元数据。如果不需要改变新PixelMap的像素格式，请使用[clone](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#clone18)或[cloneSync](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap#clonesync18)。
...
![](../../../../images/8b7b3800/note_3.0-zh-cn.png) 

该方法仅支持以下像素格式的PixelMap：RGBA\_8888、BGRA\_8888、RGBA\_F16。

1. 完成[图片解码](/image-kit/image-arkts-dev/image-decoding-arts/image-decoding)，获取两张宽度相同且像素格式相同的PixelMap位图对象。
