...
![](../../../../images/237d6142/note_3.0-zh-cn.png) 
...
- 部分接口（如：[OH\_ImagePackerNative\_GetSupportedFormats](/ref/image-api/image-c/image-headerfile/capi-image-packer-native-h/capi-image-packer-native-h#oh_imagepackernative_getsupportedformats)）在API version 20以后才支持，需要开发者在进行开发时选择合适的API版本。
