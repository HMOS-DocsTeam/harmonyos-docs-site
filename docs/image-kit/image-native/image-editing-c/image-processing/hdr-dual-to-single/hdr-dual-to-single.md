...
调用者可以调用本模块提供的[C API接口](/ref/image-api/image-c/image-module/capi-imageprocessing/capi-imageprocessing)，实现将双层HDR图片转换为单层HDR图片。

该能力常用于图片分享中，如下图所示：

![](../../../../../images/30770068/zh-cn_image_0000002583438637.png)
