...
调用者可以调用本模块提供的[C API接口](/ref/image-api/image-c/image-module/capi-imageprocessing/capi-imageprocessing)，实现Decompose单层HDR图片转双层HDR图片。

该能力常用于图片分享中，如下图所示：

![](../../../../../images/4d85c56c/zh-cn_image_0000002552798942.png)
