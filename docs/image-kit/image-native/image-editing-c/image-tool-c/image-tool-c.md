...
系统目前仅支持对部分Exif信息的查看和修改，具体支持的范围请参见：[变量](/ref/image-api/image-c/image-headerfile/capi-image-common-h/capi-image-common-h#变量)里的OHOS\_IMAGE\_PROPERTY\_XXX类型。需要注意的是，DNG格式图片仅支持读取Exif信息，不支持修改。
...
Exif信息的读取与编辑相关C API接口的详细介绍请参见[OH\_ImageSourceNative\_GetImageProperty()](/ref/image-api/image-c/image-headerfile/capi-image-source-native-h/capi-image-source-native-h#oh_imagesourcenative_getimageproperty)和[OH\_ImageSourceNative\_ModifyImageProperty()](/ref/image-api/image-c/image-headerfile/capi-image-source-native-h/capi-image-source-native-h#oh_imagesourcenative_modifyimageproperty)。
...
![](../../../../images/3cf91aab/note_3.0-zh-cn.png) 
...
6. 在成功创建ImageSource对象后，读取、编辑Exif信息。
   ...
   ![](../../../../images/ece1b0de/note_3.0-zh-cn.png) 

   创建ImageSource对象可参考[图片解码](/image-kit/image-native/image-decoding-c/image-source-c)。
