...
![](../../../../images/1b8627e9/note_3.0-zh-cn.png) 

部分接口（如：[OH\_ImageSourceNative\_GetSupportedFormats](/ref/image-api/image-c/image-headerfile/capi-image-source-native-h/capi-image-source-native-h#oh_imagesourcenative_getsupportedformats)）在API version 20以后才支持，需要开发者在进行开发时选择合适的API版本。
