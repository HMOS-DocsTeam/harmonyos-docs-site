...
详细接口说明可参考[接口文档](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacedatatransfer/enterprisespace-spacedatatransfer#policypush)。

| 接口名 | 描述 |
| --- | --- |
| [policyPush](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacedatatransfer/enterprisespace-spacedatatransfer#policypush)(policyContext: string): void | 配置空间互传单双通策略。 |
...
1. 导入Enterprise Space Kit模块。
   ...
   ```
2. 调用[policyPush](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacedatatransfer/enterprisespace-spacedatatransfer#policypush)接口，配置空间互传单双通策略，并且查看打印信息。
