...
详细接口说明可参考[接口文档](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacemanager/enterprisespace-spacemanager#subscribeevent)。

| 接口名 | 描述 |
| --- | --- |
| [subscribeEvent](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacemanager/enterprisespace-spacemanager#subscribeevent)(eventId: [EventType](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacemanager/enterprisespace-spacemanager#eventtype)[], callback: AsyncCallback&lt;[EventData](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacemanager/enterprisespace-spacemanager#eventdata)&gt;): number | 订阅空间事件，在相关事件触发时，通知应用侧。使用callback异步回调。 |
...
1. 导入Enterprise Space Kit模块和相关依赖模块。
   ...
   ```
2. 调用[subscribeEvent](/ref/enterprise-space-api/enterprisespace-arkts/enterprisespace-spacemanager/enterprisespace-spacemanager#subscribeevent)接口，设置订阅空间事件，并查看打印信息。
