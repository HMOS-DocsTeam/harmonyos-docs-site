...
- 扩展外设驱动客户端：查询驱动并绑定驱动，自定义驱动与设备之间的通信方式以及数据处理方式等，即[带UI界面基础驱动](/system-hardware/driver-development-kit/development-of-basic-drivers/externaldevice-guidelines)。
- 扩展外设驱动：基于DDK能力开发的专业专用扩展外设驱动或扩展外设增强驱动，即[无UI界面基础驱动](/system-hardware/driver-development-kit/development-of-basic-drivers/driverextensionability)。
...
![](../../../images/2c306dab/zh-cn_image_0000002583438517.png)
...
![](../../../images/3ecab72d/zh-cn_image_0000002552958472.png)

用户使用扩展外设驱动客户端时，扩展外设驱动客户端与扩展外设驱动的绑定流程如图3所示。

****图3**** 扩展外设驱动客户端与扩展外设驱动绑定的时序图

![](../../../images/c91154ea/zh-cn_image_0000002583478473.png)
...
| 名称 | 作用 |
| --- | --- |
| PerformanceAnalysisKit | 引入[hilog](/ref/system-debug-optimize-api/performance-analysis-api/performance-analysis-arkts/js-apis-hilog/js-apis-hilog)用于日志打印。 |
| BasicServicesKit | 引入[BusinessError](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/basic-services-others/js-apis-base/js-apis-base#businesserror)用于捕获错误信息。 |
| IPCKit | 引入[rpc](/ref/ipc-api/ipc-arkts/js-apis-rpc/js-apis-rpc)用于驱动与客户端IPC（Inter-Process Communication）通信。 |
| AbilityKit | 引入[@ohos.application.Want (Want)](/ref/ability-api/ability-arkts/ability-arkts-dep/js-apis-application-want/js-apis-application-want)用于生命周期管理。 |
