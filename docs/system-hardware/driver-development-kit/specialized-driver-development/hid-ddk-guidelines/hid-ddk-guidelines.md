...
![](../../../../images/cb7ccfef/zh-cn_image_0000002583438519.png)
...
详细的接口说明请参考[HidDdk](/ref/system-hardware-api/driver-development-api/driver-development-c/driver-development-module/capi-hidddk/capi-hidddk)。
...
1. 创建设备。
   ...
   使用 ****hid\_ddk\_api.h**** 的 ****OH\_Hid\_CreateDevice**** 接口创建HID设备，成功返回设备deviceId，失败返回[Hid\_DdkErrCode](/ref/system-hardware-api/driver-development-api/driver-development-c/driver-development-headerfile/capi-hid-ddk-types-h/capi-hid-ddk-types-h#hid_ddkerrcode)。
