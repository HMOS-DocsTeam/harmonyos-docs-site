...
在打包应用时，请在DevEco Studio中，点击右上角![](../../../images/2bfe0b2e/zh-cn_image_0000002583438511.png)图标，将编译模式修改为“release”，然后点击右下角的“Apply”即可。

![](../../../images/ac3bdba3/zh-cn_image_0000002552958466.png)
...
1. 在[skills](/development-fundamentals/application-configuration-file-stage/module-configuration-file#skills标签)中配置导航信息服务的actions。

   ![](../../../images/f1a5c9b5/note_3.0-zh-cn.png) 
...
- name取值为hiCarCapability时，代表适配了HiCar的能力。对应的value值根据不同的业务场景取值如下：
  ...
  关于指令的更多详情请查阅[CommandType](/ref/system-hardware-api/car-api/car-api-references/car-navigationinfomgr/car-navigationinfomgr#commandtype)。
