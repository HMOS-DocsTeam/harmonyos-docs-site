...
![](../../../../images/0e8aff18/zh-cn_image_0000002583478469.png)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [accessibilityTextHint](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/ts-universal-attributes-accessibility/ts-universal-attributes-accessibility#accessibilitytexthint12)(value: string): T | 设置辅助功能文本提示。 |
...
1. 能力配置。
   ...
   碰一碰地址流转场景下，metadata的name取值为carHopCapability，value取值应为****carHopAddress****，具体配置请参考[配置能力](/system-hardware/car-kit-guide/car-preparations#配置能力)。示例代码如下所示：
