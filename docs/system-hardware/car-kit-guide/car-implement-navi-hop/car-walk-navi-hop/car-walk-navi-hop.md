...
![](../../../../images/91ba96f6/zh-cn_image_0000002552798820.png)
...
![](../../../../images/6b3cd8b4/zh-cn_image_0000002583438515.png)

## 开发步骤

1. 能力配置。

   请参考[配置能力](/system-hardware/car-kit-guide/car-preparations#配置能力)进行配置。下车步行导航流转场景下，metadata的name取值为carHopCapability，value取值应为****getOffCarNavi****。示例代码如下所示：
