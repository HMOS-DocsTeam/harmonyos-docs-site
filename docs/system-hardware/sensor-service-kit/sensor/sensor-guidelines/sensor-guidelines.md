...
详细的接口介绍请参考[@ohos.sensor (传感器)](/ref/system-hardware-api/sensor-service-api/sensor-service-arkts/js-apis-sensor/js-apis-sensor)。
...
1. 新建一个工程。
   ...
   ![](../../../../images/abb90d03/zh-cn_image_0000002552798830.png)
...
5. 查询设备支持的所有传感器的参数，如果获取不到某个传感器则代表该传感器在此设备上不存在或不可用，如果订阅没查到的传感器时需要处理异常。
   ...
   ![](../../../../images/a61c737f/zh-cn_image_0000002583438525.png)
...
6. 注册监听。可以通过on()和once()两种接口监听传感器的调用结果。
   ...
   ![](../../../../images/85dd6dbd/zh-cn_image_0000002552958480.png)
   ...
   ![](../../../../images/fc873b3e/zh-cn_image_0000002583478481.png)
7. 取消持续监听。
