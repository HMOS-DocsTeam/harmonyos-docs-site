...
详细的接口介绍请参考[Sensor](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-module/capi-sensor/capi-sensor)。
...
| OH\_Sensor\_CreateInfos(uint32\_t count) | 用给定的数字创建一个实例数组，请参考[Sensor\_Info](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-sensor-sensor-info/capi-sensor-sensor-info)。 |
| OH\_Sensor\_DestroyInfos(Sensor\_Info \*\*sensors, uint32\_t count) | 销毁实例数组并回收内存，请参考[Sensor\_Info](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-struct/capi-sensor-sensor-info/capi-sensor-sensor-info)。 |
...
1. 新建一个Native C++工程。
   ...
   ![](../../../../images/f2917ca7/zh-cn_image_0000002552798832.png)
2. 配置加速度传感器权限，具体配置方式请参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。
