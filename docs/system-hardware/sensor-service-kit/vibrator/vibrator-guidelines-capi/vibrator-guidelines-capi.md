...
详细的接口介绍请参考[Vibrator](/ref/system-hardware-api/sensor-service-api/sensor-service-c/sensor-service-module/capi-vibrator/capi-vibrator)。
...
1. 新建一个Native C++工程。
   ...
   ![](../../../../images/9fa02b35/zh-cn_image_0000002583478483.png)
2. 控制设备上的振动器，需要申请权限ohos.permission.VIBRATE。具体配置方式请参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。
