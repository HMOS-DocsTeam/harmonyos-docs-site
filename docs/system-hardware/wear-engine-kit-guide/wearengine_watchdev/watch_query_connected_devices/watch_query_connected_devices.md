...
1. 调用[getDeviceClient](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#wearenginegetdeviceclient)方法，获取[DeviceClient](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#deviceclient)对象。
