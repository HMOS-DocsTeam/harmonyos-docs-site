...
2. 构造当服务连接断开时执行的回调函数。
   ...
   ```
3. 调用[wearEngine](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api)中的[on](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#wearengineon)方法，订阅监听应用与Wear Engine服务的断联事件。
   ...
   ```
4. 调用[wearEngine](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api)中的[off](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#wearengineoff)方法，取消监听应用与Wear Engine服务的断联事件。需要传入订阅监听时的同一个回调函数对象。
...
1. 在使用Wear Engine服务前，请导入WearEngine与相关模块。
   ...
   import { BusinessError } from '@kit.BasicServicesKit';
   ```
2. 调用[wearEngine](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api)中的[destroy](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#wearenginedestroy)方法，断开应用与Wear Engine服务的连接。
