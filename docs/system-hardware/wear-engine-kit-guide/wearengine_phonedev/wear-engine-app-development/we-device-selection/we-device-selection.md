...
获取到的设备[Device](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#device)类中，包含有[DeviceCategory](/ref/system-hardware-api/wear-engine-api/wearengine_arkts_api/wearengine_api/wearengine_api#devicecategory)字段，表明了当前设备的类型，可根据设备的类型挑选目标设备。
...
获取到的设备中包含了查询能力集的方法，可参考[穿戴设备信息查询](/system-hardware/wear-engine-kit-guide/wearengine_phonedev/wear-engine-app-development/query_device_info)章节。
