...
![](../../../../images/58847bd9/zh-cn_image_0000002552958476.png)
...
| 类名 | 接口名 | 说明 |
| --- | --- | --- |
| [imageFeaturePicker](/ref/system-hardware-api/pen-api/pen-arkts/pen-imagefeaturepicker/pen-imagefeaturepicker) | [pickForResult](/ref/system-hardware-api/pen-api/pen-arkts/pen-imagefeaturepicker/pen-imagefeaturepicker#pickforresult) | 启动取色器。此API用于启动取色器，在取色器移动时不显示色值。 |
