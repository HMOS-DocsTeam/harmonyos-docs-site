...
![](../../../../images/cbc84bd8/zh-cn_image_0000002583438523.png)

## 接口说明

| 类名 | 接口名 | 描述 |
| --- | --- | --- |
| [PointPredictor](/ref/system-hardware-api/pen-api/pen-arkts/pen-pointpredictor/pen-pointpredictor) | [getPredictionPoint](/ref/system-hardware-api/pen-api/pen-arkts/pen-pointpredictor/pen-pointpredictor#getpredictionpoint)(event: [TouchEvent](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#touchevent对象说明)): [TouchPoint](/ref/arkui-api/arkui-declarative-comp/common-definitions/ts-types/ts-types#touchpoint11) | 获取预测点 |
