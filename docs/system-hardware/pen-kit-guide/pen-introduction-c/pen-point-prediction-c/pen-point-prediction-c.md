...
![](../../../../images/cebc0b71/zh-cn_image_0000002583438523.png)
...
报点预测功能的历史点，通常需要在自定义渲染（XComponent）上注册触摸事件回调获得，请参考[自定义渲染开发指南](/arkui/arkts-ui-development/arkts-add-component/napi-xcomponent-guidelines)，获得历史触摸点。
...
[native\_handwrite\_api.h](/ref/system-hardware-api/pen-api/pen-c-api/pen-headerfile-and-struct/pen-headerfile/pen-handwrite-headerfile-declare/pen-handwrite-headerfile-declare)提供HMS\_HandWrite\_GetPredictPoint()接口获取预测点。
