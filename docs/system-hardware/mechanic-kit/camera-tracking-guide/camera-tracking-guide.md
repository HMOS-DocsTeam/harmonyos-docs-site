...
机械体设备控制器API的接口使用指导请参见[MechanicManager API参考](/ref/system-hardware-api/mechanic-kit-api/mechanic-arkts/js-apis-mechanicmanager/js-apis-mechanicmanager)。
...
3. 请将SDK更新到API 20或以上版本，具体操作参见[更新指南](/ide-software-install)。
