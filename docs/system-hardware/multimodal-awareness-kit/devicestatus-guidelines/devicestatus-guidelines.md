...
详细的接口介绍请参考[@ohos.multimodalAwareness.deviceStatus (设备状态感知)](/ref/system-hardware-api/multimodal-awareness-api/multimodal-awareness-arkts/js-apis-awareness-devicestatus/js-apis-awareness-devicestatus)。
