...
详细的接口介绍请参考[@ohos.multimodalAwareness.userStatus (用户状态感知)](/ref/system-hardware-api/multimodal-awareness-api/multimodal-awareness-arkts/js-apis-awareness-userstatus/js-apis-awareness-userstatus)。
