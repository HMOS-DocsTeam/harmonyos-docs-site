...
![](../../images/af5db9f4/note_3.0-zh-cn.png) 
...
启动模式分为![](../../images/1368c735/zh-cn_image_0000002530912822.png "点击放大")自动启动和![](../../images/f7cbdfd2/zh-cn_image_0000002561832753.png "点击放大")手动启动，可点击图标切换两种不同模式：
...
1. 创建Launch场景调优分析任务并录制相关数据，操作方法可参考[性能问题定位：深度录制](/ide-profiler-introduction/deep-recording)，或在会话区选择****Open File****，导入历史数据。

   ![](../../images/c87985a5/note_3.0-zh-cn.png) 

   - 在任务分析窗口中，可通过[快捷键](/ide-profiler-appendix/ide-shortcut-key)缩放时间轴、移动时间轴、添加时间标签等。
   - Launch分析支持离线符号解析能力，请参见[离线符号解析](/ide-insight-session-time#section186881175012)。
   - Launch分析支持动效场景调优，请参见[支持动效场景调优](/ide-lag-and-frame-loss/ide-insight-session-frame#section258014238619)。

   Launch分析任务支持在录制前单击![](../../images/48a44b23/zh-cn_image_0000002561832759.png "点击放大")指定要录制的泳道。“Launch”泳道显示启动生命周期各阶段的耗时分布情况。
2. 单击“Launch”泳道上的单个阶段，或框选多个阶段，在下方的“Details”页签中，可查看到所选阶段的耗时统计情况。

   展开各阶段的统计信息折叠表，可以看到各个任务的具体耗时信息。单击跳转按钮，可直接跳转至相关线程打点任务中。

   ![](../../images/e5a62444/zh-cn_image_0000002530912832.png "点击放大")
3. 切换到“Load ETS Files”页签，从DevEco Studio 6.0.0 Beta1版本开始，支持查看冷启动过程中ETS文件的加载情况。各字段含义如下：
   ...
   ![](../../images/dcfcb805/zh-cn_image_0000002530912836.png "点击放大")
4. 切换到“TOP Redundant”页签，可查看冷启动过程中TOP 100冗余ETS加载文件信息。若File Name字段显示为蓝色，双击可快速跳转至对应工程源文件。

   ![](../../images/a1bb7519/zh-cn_image_0000002561832751.png "点击放大")

![](../../images/b0125d5b/note_3.0-zh-cn.png) 
...
2. 单击单个静态资源库色块，或框选多个静态资源库，下方的“Details”区域展示所选对象的耗时统计信息。
   ...
   ![](../../images/955a85ae/zh-cn_image_0000002530752842.png "点击放大")
...
2. 单击单个进程色块，或框选多个进程，下方的“Details”区域展示所选对象的运行情况统计信息。
   ...
   ![](../../images/db273b3d/zh-cn_image_0000002530752828.png "点击放大")
...
2. 单击单个切片色块，或框选多个切片，可查看所选对象的详情。
   ...
   ![](../../images/0e5003cd/zh-cn_image_0000002561832755.png "点击放大")
