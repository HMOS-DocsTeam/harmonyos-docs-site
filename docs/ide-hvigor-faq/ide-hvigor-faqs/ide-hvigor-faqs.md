...
title: "编译构建常见问题"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-faqs
kit: devtools/build
...
- 在执行hvigor构建的过程中，通过减少内存中的缓存数据、减少线程数量，可以减少编译过程中的内存占用。
  ...
  ![](../../images/586a0d1d/note_3.0-zh-cn.png) 
...
- 如果以上修改没有取得明显的效果，可以使用非并行的模式来执行编译。
  - 在菜单栏点击“File > Settings（macOS为DevEco Studio > Preferences/Settings） > Build, Execution, Deployment > Build Tools > Hvigor”，取消勾选“Execute tasks in parallel mode (may require larger heap size)”。
    ...
    ![](../../images/3e6716fa/zh-cn_image_0000002561833405.png)
  ...
  ![](../../images/4ed00644/note_3.0-zh-cn.png) 
...
- ****场景一：****
  ...
  ****处理措施****
  ...
  1. 确保XXX是当前的HvigorNode里存在的任务。
     ...
     ![](../../images/75dbb827/zh-cn_image_0000002561753579.png)
  2. 确保getTaskByName的使用位置是在[Hvigor的配置阶段](/ide-hvigor/ide-hvigor-life-cycle#section746253616316)及之后的生命周期里，包括beforeNodeEvaluate、afterNodeEvaluate、nodesEvaluated、taskGraphResolved、buildFinished。
- ****场景二：****
...
- ****场景八：****
  ...
  ****问题确认****
  ...
  ![](../../images/e7a1659d/zh-cn_image_0000002561833453.png)
...
![](../../images/01f864b5/zh-cn_image_0000002530913588.png)
...
![](../../images/df170a94/zh-cn_image_0000002530913436.png)
...
![](../../images/4b4e1eaa/zh-cn_image_0000002561833395.png)
...
![](../../images/22527016/zh-cn_image_0000002561753545.png)
...
![](../../images/f2f5529f/zh-cn_image_0000002561753493.png)

2.编译工具根据设置的Build Mode选项生成debug标识，如图所示，可以通过此处进行设置。

![](../../images/54f0252f/zh-cn_image_0000002530913508.png)
...
![](../../images/780f151e/zh-cn_image_0000002530753618.png)
...
![](../../images/2bf7e6e9/zh-cn_image_0000002530913606.png)
...
- ****场景一：****
  ...
  ****处理措施****
  ...
  1. 在对应cpp目录下新建types/libxxx目录，并在该目录下新增index.d.ts用于声明native的类型符号；新增oh-package.json5配置文件用于校验工具的模块查询。
     ...
     ![](../../images/8ab979d1/zh-cn_image_0000002530753632.png)

     ![](../../images/21a9dad5/zh-cn_image_0000002561753499.png)
  2. 在native引用的模块内的oh-package.json5中添加native模块的本地依赖，并根据提示点击****Sync Now****同步工程，下图以entry模块引用native模块为例。

     ![](../../images/8fe673e9/zh-cn_image_0000002561753377.png)
...
- 场景二：
  ...
  ****问题现象****
  ...
  ![](../../images/71a1322c/zh-cn_image_0000002530913592.png)
...
- 场景三：
  ...
  ****问题现象****
  ...
  ![](../../images/2f6ca109/zh-cn_image_0000002530913538.png)

  代码中这样引用

  ![](../../images/90b247d2/zh-cn_image_0000002561753487.png)这样引用会找不到模块，导致报错。

  ****处理措施****

  修改引用方式，改为推荐的引用方式

  ![](../../images/c3be87fc/zh-cn_image_0000002561753379.png)
- 场景四：
  ...
  ****问题现象****
  ...
  ![](../../images/b3c5ebdc/zh-cn_image_0000002530753476.png)

  被引用模块的 oh\_package.json5 中配置了错误的types字段。

  该字段优先于main字段。 如果 types 字段配置的不存在，就会报错模块找不到。

  ![](../../images/80a9d631/zh-cn_image_0000002561753543.png)
...
- 场景七：
  ...
  ****问题现象****
  ...
  ![](../../images/5ef2df20/zh-cn_image_0000002530753616.png)
  ...
  ****解决措施****
  ...
  1. 通过在build目录中搜索'rollup\_plugin\_ignore\_empty\_module\_placeholder'，找到报错的中间文件，并根据中间文件找到对应工程文件。
     ...
     ![](../../images/6ad5bd2d/zh-cn_image_0000002530753462.png)

     在输入栏中输入rollup\_plugin\_ignore\_empty\_module\_placeholder，找到问题模块的中间文件。

     ![](../../images/64afa037/zh-cn_image_0000002530753638.png)
  2. 在引用类型文件中通过添加type显式声明符号类型引用：
     ...
     ![](../../images/199d947f/zh-cn_image_0000002530913604.png)
  3. 同时排查是否从d.ts/d.ets中引用值类型符号，禁止在声明文件中声明值变量。

     ![](../../images/dcf05680/zh-cn_image_0000002561833401.png)
...
- 方法2：新增x.js对应的声明文件(.d.ts)，并在引用时不指定后缀。
  ...
  ![](../../images/26b79d19/zh-cn_image_0000002530913584.png)
...
![](../../images/7cf4651b/zh-cn_image_0000002530913510.png)

****处理措施****

该问题是由于file1为当前工程外的代码：

![](../../images/3a467dc2/zh-cn_image_0000002561753503.png)
...
- ****场景一：****
  ...
  ****问题现象****
  ...
  ![](../../images/20b080dc/zh-cn_image_0000002561833415.png)

  ****问题确认****
  1. 进入上面报黄色的源码文件中，可以看到依赖有红色告警信息。

     ![](../../images/bb90ef25/zh-cn_image_0000002561833413.png "点击放大")
  2. 进入包下的oh-package.json5文件，查看依赖配置为devDependencies。

     ![](../../images/50b462ef/zh-cn_image_0000002561753569.png)
...
- ****场景二：****
  ...
  ****问题现象****
  ...
  ![](../../images/16bc77b2/zh-cn_image_0000002530753458.png)
...
- ****场景三：****
  ...
  ****问题现象****
  ...
  ![](../../images/50679772/zh-cn_image_0000002561753419.png)

  ![](../../images/3201dcbb/zh-cn_image_0000002561753391.png)![](../../images/467ed852/zh-cn_image_0000002530913626.png)****处理措施****
...
- ****场景五：****
  ...
  ****问题现象****
  ...
  ![](../../images/163d5404/zh-cn_image_0000002561833367.png "点击放大")

  ****问题确认****

  1. 排查yyy所在模块是否为[字节码har](/ide-hvigor-configuration/ide-hvigor-build-har#section16598338112415)，查看工程级build-profile.json5的useNormalizedOHMUrl是否为true（缺省默认值为false），如果为true则默认构建字节码har。
  ...
  ****处理措施****
  ...
  - 将xxx依赖配置到yyy模块oh\_package.json5的dependencies中。
    ...
    ![](../../images/9c3967a5/zh-cn_image_0000002530753636.png "点击放大")
...
- ****场景六：****
  ...
  ![](../../images/f21bb8b1/zh-cn_image_0000002561753449.png)
- ****场景七：****
  ...
  ****问题现象：****
  ...
  ![](../../images/25c29b37/zh-cn_image_0000002530913528.png)
  ...
  ****处理措施****
  ...
  ![](../../images/a106bce5/zh-cn_image_0000002530913504.png)
...
![](../../images/ed0c5cf5/zh-cn_image_0000002530753594.png)
...
![](../../images/585f9f51/zh-cn_image_0000002561753461.png)
...
![](../../images/47fbcd51/zh-cn_image_0000002530753464.png)
...
1. 下载并安装JDK 17版本。
2. 修改JAVA\_HOME环境变量，取值修改为JDK 17。如果是Linux系统，可参考使用命令行方式构建元服务或应用的[配置JDK章节](/ide-command-line-building-app#section195447475220)。
...
![](../../images/a6eac44a/zh-cn_image_0000002561753497.png)
...
2. 然后在config.json中重新引用该字符串资源。
   ...
   ![](../../images/6d78a722/zh-cn_image_0000002561833409.png)
...
![](../../images/40a72c9c/zh-cn_image_0000002561833537.png)
...
1. 在模块下的****resources > base > element****下，点击右键选择****New > Element Resource File****创建资源文件。
   ...
   ![](../../images/2003fa9c/zh-cn_image_0000002561833373.png)
2. 在弹出的对话框中，“File name”开发者可自定义，如color；“Root element”请选择****color。****

   ![](../../images/1495cd21/zh-cn_image_0000002561753527.png)

   创建完成后，color.json文件如下图所示：

   ![](../../images/f0df62da/zh-cn_image_0000002530913428.png)
3. 将[2](#li124901748185712)创建的color.json文件拷贝至模块的****ohosTest > resources > base > element****目录下。

   ![](../../images/70a25969/zh-cn_image_0000002561833349.png)
4. 在模块的****src > main > module.json5****文件的abilities数组中，添加startWindowIcon和startWindowBackground字段（若缺少任一字段，将出现ERROR: Schema validate failed报错）。其中，startWindowIcon字段索引模块下****resources > base > media****中的图标资源，startWindowBackground字段索引****resources > base > element**** ****> color.json****中的color。
   ...
   ![](../../images/afdd6dc8/zh-cn_image_0000002561833385.png)
...
- keyword：标识当前报错字段的可选配属性，当前报错中包括'required'、'oneOf'、'enum'、'propertyNames'。
  ...
  - oneOf：表示当前配置不符合oneOf要求。通过instancePath已经确认报错出现在abilities标签，在DevEco Studio中，按住Ctrl点击"abilities"跳转到对应的module.json文件，可以查看到必须配置以下两组中的一组。根据对比排查，可识别到因拼写错误导致"name"属性未配置。
    ...
    ![](../../images/1092412c/zh-cn_image_0000002561753561.png)
...
![](../../images/dda632e4/zh-cn_image_0000002530913532.png)

****报错原因****

密钥库(p12)密码错误。

![](../../images/dcf699df/caution_3.0-zh-cn.png) 
...
![](../../images/8af7dae0/zh-cn_image_0000002530753454.png)
...
![](../../images/2090553c/zh-cn_image_0000002561833403.png)
...
- Module: (xxx) and Module: (xxx) are entry, please check deviceType or distroFilter of the module.
  ...
  ![](../../images/5ec137f6/zh-cn_image_0000002561753395.png)
- Module: (xxx) and Module: (xxx) have the same moduleName, please check deviceType or distroFilter of the module.

  ![](../../images/1a36fd05/zh-cn_image_0000002530913520.png)
- Module: (xxx) and Module: (xxx) have the same packageName, please check deviceType or distroFilter of the module.

  ![](../../images/8a80212a/zh-cn_image_0000002561753469.png)
- Module: (xxx) and Module: (xxx) have the same ability name.

  ![](../../images/70f5d643/zh-cn_image_0000002561753463.png)

****解决措施****

出现该问题的原因是打包时工程未满足HAP唯一性校验逻辑，请根据[HAP唯一性校验逻辑](/ide-hvigor-configuration/ide-hvigor-verification-rule)修改工程，满足校验逻辑即可正常打包。
...
![](../../images/f1d25729/zh-cn_image_0000002530913558.png)

****解决措施****

请删除报错模块下的.cxx文件夹，然后选中需要构建的模块，执行****Make Module**** ****$\{moduleName\}****完成单独构建，避免同时构建多个模块。

![](../../images/26802501/zh-cn_image_0000002561753407.png)
...
4. 将定义的三方so声明给目标。
   ...
   ![](../../images/d29a02f8/zh-cn_image_0000002530913548.png)
...
![](../../images/d2f23467/zh-cn_image_0000002561753459.png)
...
![](../../images/39f05996/zh-cn_image_0000002530913618.png)
...
![](../../images/eb3be22c/zh-cn_image_0000002530913564.png)

****解决措施****

出现该告警说明当前工程存在不符合ArkTS语法规范的写法，请根据ERROR报错中括号内的语法规则如(arkts-no-var)，查看[从TypeScript到ArkTS的适配规则](/learning-arkts/typescript-to-arkts-migration/typescript-to-arkts-migration-guide#使用let而非var)中对应的说明，修改为ArkTS规范写法。
...
![](../../images/8f01b7ab/zh-cn_image_0000002561753411.png "点击放大")

出现编译报错“ninja: error: mkdir(xxx): No such file or directory”，示例如下：

![](../../images/e3abaeb6/zh-cn_image_0000002561833411.png "点击放大")
...
- 方法二：根据object file实际路径长度计算CMAKE\_OBJECT\_PATH\_MAX大小。
  ...
  - 总路径长度 = object file directory长度 + object file长度，object file directory、object file如下图所示，两个长度之和为297字符，以实际为准
    ...
    ![](../../images/32c2e501/zh-cn_image_0000002561833517.png "点击放大")
...
![](../../images/322a85f0/zh-cn_image_0000002530913466.png "点击放大")

出现编译报错“(is the command line too long?)”，示例如下：

![](../../images/11d7a3fb/zh-cn_image_0000002530913560.png)
...
- 方法二：根据object file实际路径长度计算CMAKE\_OBJECT\_PATH\_MAX大小。
  ...
  - 总路径长度 = object file directory长度 + object file长度，object file directory、object file如下图所示，两个长度之和为297字符，以实际为准
    ...
    ![](../../images/1ee7cfea/zh-cn_image_0000002530913620.png "点击放大")
  - object file中目录部分长度：示例中“\_\_/\_\_/\_\_/\_\_/\_\_/third-party/rn/ReactCommon/react/renderer/textlayoutmanager”长度为74字符，以实际为准
  - cmake哈希值字符数：cmake将长路径转换为哈希值时哈希值的长度，固定为32
...
![](../../images/1cd14485/zh-cn_image_0000002530913622.png "点击放大")
...
![](../../images/ee7d6c4d/zh-cn_image_0000002530913432.png "点击放大")
...
![](../../images/1b500678/zh-cn_image_0000002530753580.png)![](../../images/ac33b91b/zh-cn_image_0000002561753573.png)
...
![](../../images/c2dd951e/zh-cn_image_0000002530753582.png)
...
![](../../images/257e075d/zh-cn_image_0000002561753477.png)****问题确认****
...
![](../../images/f31d8914/zh-cn_image_0000002561753481.png "点击放大")
...
![](../../images/b0d9fa2c/zh-cn_image_0000002561833419.png "点击放大")
...
![](../../images/11a52d76/zh-cn_image_0000002530913566.png "点击放大")
...
![](../../images/01a59bcd/zh-cn_image_0000002561753399.png)
...
![](../../images/0adc91a6/zh-cn_image_0000002530753578.png)
...
[useNormalizedOHMUrl](/ide-hvigor-configuration-file/ide-hvigor-build-profile-app#section13181758123312) 为true的时候ohmurl使用的是新的拼接和解析方式，不能和旧的ohmurl混用，会导致运行时无法识别。
...
示例如下，详细内容可参考[oh-package.json5文件](/ide-ohpm-cli/ide-oh-package-json5)和[添加依赖项](/ide-hvigor-configuration/ide-hvigor-dependencies)。
...
![](../../images/03b48e93/zh-cn_image_0000002561833527.png "点击放大")
...
![](../../images/78dc03d9/zh-cn_image_0000002561833369.png)
...
![](../../images/e9d69ed5/zh-cn_image_0000002561753489.png)
...
![](../../images/4004da4a/zh-cn_image_0000002561753525.png)
...
![](../../images/1d2ff9d2/zh-cn_image_0000002561753471.png "点击放大")
...
![](../../images/694bf78a/zh-cn_image_0000002561833423.png)
...
![](../../images/562c643a/zh-cn_image_0000002530913474.png)
...
- 方法一：点击编辑器窗口上方的Sync Now。
  ...
  ![](../../images/bdaa5382/zh-cn_image_0000002561753401.png)
- 方法二：点击工具栏****File > Sync and Refresh Project****。

  ![](../../images/93f4f577/zh-cn_image_0000002561833425.png)
- 方法三：如果方法1、2无法解决问题，可以手动删除工程目录下的.hvigor目录后重启执行Sync。

  ![](../../images/9c1c61e1/zh-cn_image_0000002530913438.png)
