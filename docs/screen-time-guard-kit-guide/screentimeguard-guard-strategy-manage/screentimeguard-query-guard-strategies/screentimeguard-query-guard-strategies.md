...
![](../../../images/dae4d4a5/zh-cn_image_0000002552959170.png)
...
| 接口名 | 描述 |
| --- | --- |
| [queryGuardStrategies](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#queryguardstrategies)(): Promise&lt;[GuardStrategy](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#guardstrategy)[]&gt; | 查询该应用下的所有管控策略。 |

## 开发前提

查询管控策略需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
