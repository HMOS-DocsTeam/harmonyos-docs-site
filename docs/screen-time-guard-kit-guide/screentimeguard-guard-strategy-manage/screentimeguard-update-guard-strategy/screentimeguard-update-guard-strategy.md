...
![](../../../images/1ed50e3b/zh-cn_image_0000002583439215.png)
...
![](../../../images/32fbc841/note_3.0-zh-cn.png) 
...
| 接口名 | 描述 |
| --- | --- |
| [updateGuardStrategy](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#updateguardstrategy)(strategyName: string, guardStrategy: [GuardStrategy](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#guardstrategy)): Promise&lt;void&gt; | 修改屏幕时间管控策略。 |

## 开发前提

修改管控策略需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
