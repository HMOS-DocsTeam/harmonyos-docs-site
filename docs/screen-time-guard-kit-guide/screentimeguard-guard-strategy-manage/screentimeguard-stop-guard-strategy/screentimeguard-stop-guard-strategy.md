...
![](../../../images/d81d771a/zh-cn_image_0000002583479173.png)

## 业务流程

![](../../../images/898542f9/zh-cn_image_0000002552799524.png)
...
| 接口名 | 描述 |
| --- | --- |
| [stopGuardStrategy](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#stopguardstrategy)(strategyName: string): Promise&lt;void&gt; | 根据策略名称，停止其管控策略。 |
| [onStop](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-timeguardextensionability/screentimeguard-timeguardextensionability#onstop)(strategyName: string): Promise&lt;void&gt; | 在策略结束时执行特定逻辑。 |

## 开发前提

停止管控策略需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
