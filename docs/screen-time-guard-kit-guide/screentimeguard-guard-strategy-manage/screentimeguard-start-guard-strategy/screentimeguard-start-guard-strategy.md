...
![](../../../images/f173e277/zh-cn_image_0000002583439217.png)

## 业务流程

![](../../../images/a714b330/zh-cn_image_0000002552959172.png)
...
| 接口名 | 描述 |
| --- | --- |
| [startGuardStrategy](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#startguardstrategy)(strategyName: string): Promise&lt;void&gt; | 根据策略名称，启动其管控策略。 |
| [onStart](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-timeguardextensionability/screentimeguard-timeguardextensionability#onstart)(strategyName: string): Promise&lt;void&gt; | 在策略启动时执行特定逻辑。 |

## 开发前提

启动管控策略需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
