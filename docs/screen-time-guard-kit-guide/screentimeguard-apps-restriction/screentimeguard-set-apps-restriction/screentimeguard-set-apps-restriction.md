...
![](../../../images/df81efaf/zh-cn_image_0000002552959174.png)
...
| 接口名 | 描述 |
| --- | --- |
| [setAppsRestriction](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#setappsrestriction)(appInfo: [AppInfo](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#appinfo), restrictionType: [RestrictionType](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#restrictiontype)): Promise&lt;void&gt; | 根据传入的应用token数组和限制类型（禁用/允许清单），确定是否限制对应应用的访问。 |

![](../../../images/3e43323d/note_3.0-zh-cn.png) 
...
设置应用访问限制需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
