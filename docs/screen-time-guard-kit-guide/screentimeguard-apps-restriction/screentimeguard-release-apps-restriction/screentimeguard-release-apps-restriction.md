...
![](../../../images/29c49fd1/zh-cn_image_0000002583479175.png)
...
| 接口名 | 描述 |
| --- | --- |
| [releaseAppsRestriction](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#releaseappsrestriction)(appInfo: [AppInfo](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#appinfo), restrictionType: [RestrictionType](/ref/screen-time-guard-api/screentimeguard-arkts/screentimeguard-guardservice/screentimeguard-guardservice#restrictiontype)): Promise&lt;void&gt; | 根据传入的应用token数组和限制类型（允许/禁用清单），解除对应应用的访问限制。 |

![](../../../images/87ba7c71/note_3.0-zh-cn.png) 
...
解除应用访问限制需要申请用户授权，请先参考[请求用户授权](/screen-time-guard-kit-guide/screentimeguard-interface-call-auth/screentimeguard-request-user-auth)章节完成用户授权。
