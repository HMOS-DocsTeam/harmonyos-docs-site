...
![](../../../images/b8cca1e8/note_3.0-zh-cn.png) 

需要完成网络权限的申请，参见：[开发准备](/data-augmentation-kit-guide/dataaugmentation-rag/data-augmentation-rag-development#开发准备)。
...
Config.ets主要负责RagSession创建时入参的组装。详细配置方法及含义可参见[智慧化数据检索](/data-augmentation-kit-guide/dataaugmentation-retrieval)。
