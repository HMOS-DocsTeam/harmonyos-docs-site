...
知识加工关键接口[common.BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext)如下表所示，具体API说明详见[API参考](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api)。

| 接口名 | 描述 |
| --- | --- |
| [getKnowledgeProcessor](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#getknowledgeprocessor)(context: [common.BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext), config: [KnowledgeProcessorConfig](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgeprocessorconfig)): Promise&lt;[KnowledgeProcessor](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgeprocessor)&gt; | 获取知识加工对象，进行获取知识加工状态等操作。 |
| [getStatus](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#getstatus)(): Promise&lt;[ProcessorStatus](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#processorstatus)&gt; | 获取知识加工状态。 |
| [startProcess](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#startprocess)(option: [KnowledgeProcessConfig](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgeprocessconfig)): Promise&lt;void&gt; | 根据入参的配置，启动知识加工。 |
| [stopProcess](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#stopprocess)(): Promise&lt;void&gt; | 停止当前知识加工。 |
| [cleanKnowledgeData](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#cleanknowledgedata)(context: [common.BaseContext](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-basecontext/js-apis-inner-application-basecontext), config: [KnowledgeProcessorConfig](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgeprocessorconfig)): Promise&lt;void&gt; | 清理知识库，根据入参中的知识加工配置获取对应知识库信息，将知识库进行清理。 |
| [getRdbStore](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-f/arkts-apis-data-relationalstore-f#relationalstoregetrdbstore-1)(context: [Context](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-context/js-apis-inner-application-context), config: [StoreConfig](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-i/arkts-apis-data-relationalstore-i#storeconfig)): Promise&lt;[RdbStore](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-rdbstore/arkts-apis-data-relationalstore-rdbstore)&gt; | 创建或打开已有的关系型数据库，按照步骤2配置开库参数后，调用该接口可触发知识加工。 |
...
2. 配置数据源库[开库参数](/ref/arkdata-api/arkdata-arkts/js-apis-data-relationalstore/arkts-apis-data-relationalstore-i/arkts-apis-data-relationalstore-i#storeconfig)，根据业务需要预置数据。下文是示例代码片段，仅供参考，具体实现方式请根据业务需要调整。
   ...
   ![](../../images/c4073875/caution_3.0-zh-cn.png) 
   ...
   ```
3. 可根据业务需要，调用[getStatus()](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#getstatus)接口，查询当前的知识加工状态。
   ...
   ```
4. 可根据业务需要，调用[startProcess](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#startprocess)(option: [KnowledgeProcessConfig](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#knowledgeprocessconfig))接口，启动知识加工。
   ...
   ```
5. 可根据业务需要，调用[stopProcess](/ref/data-augmentation-api/dataaugmentation-arkts/dataaugmentation-knowledgeprocessor-api/dataaugmentation-knowledgeprocessor-api#stopprocess)()接口，停止知识加工。
