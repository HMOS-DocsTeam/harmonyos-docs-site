...
交通卡的更新可以用在更新卡片有效期等卡内数据的场景，其过程分为：卡片展示、生成更新业务订单和发起更新三个步骤，整体流程如下图，相关接口定义请参照[钱包服务API](/ref/wallet-api/wallet-arkts/wallet-wallettransitcard/wallet-wallettransitcard)。

![](../../../images/a7ffacbd/zh-cn_image_0000002583439251.png)
...
- 开发者的app可调用[updateTransitCard](/ref/wallet-api/wallet-arkts/wallet-wallettransitcard/wallet-wallettransitcard#updatetransitcard)接口发起更新处理过程。如更新过程出现异常导致失败，开发者的app会收到相应的错误码，可参考[ArkTS API错误码](/ref/wallet-api/wallet-arkts/wallet-error-code/wallet-error-code)。
