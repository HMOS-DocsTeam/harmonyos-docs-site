...
请先参考“[应用开发准备](/application-dev-overview)”完成基本准备工作和指纹配置，再继续以下开发活动。
...
2. 点击进入对应的项目，在左侧“项目设置”页签，上侧导航选择“开放能力管理”，打开华为钱包的开关。用于钱包对车钥匙管理台向钱包服务器发起http/https请求时的权限控制。关闭状态下，开发者服务器将访问不了钱包服务器。
   ...
   ![](../../images/b2707e8b/zh-cn_image_0000002552799546.png)
3. 在“项目设置”页签，左侧导航选择“盈利 > 华为钱包”，点击“申请Wallet Kit服务”，进入申请Wallet Kit服务。

   ![](../../images/8fc8b027/zh-cn_image_0000002583439241.png)
4. 点击“产品接入华为钱包服务”的“点击申请”按钮。

   ![](../../images/0ff3d541/zh-cn_image_0000002552959196.png)
5. 各业务场景对应的参数有差异，具体参数请参考各业务的Wallet Kit服务基本信息。

   ![](../../images/1b789ccf/zh-cn_image_0000002583479197.png)

   | Wallet Kit服务参数名称 | 参数值 |
   | --- | --- |
   | 服务类型 | 分为卡、票、券、钥匙等，暂时只支持车钥匙，交通卡服务接入请参考[接入交通卡](/wallet-kit-guide/wallet-transport/wallet-transport-overview)。 |
   ...
   ****公钥生成方式：****
   ...
   ![](../../images/52d9b2d4/zh-cn_image_0000002552799548.png)
6. 点击“下一步”，进入NFC参数设置页面，各业务场景对应的参数有差异，具体参数请参考各业务的NFC参数。

   ![](../../images/c306300d/zh-cn_image_0000002583439243.png)
