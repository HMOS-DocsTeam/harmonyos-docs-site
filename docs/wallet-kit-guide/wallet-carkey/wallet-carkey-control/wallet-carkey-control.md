...
![](../../../images/21a3633f/zh-cn_image_0000002583439249.png)

典型的交互流程如下:

- 通过[queryICCEConnectionState](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#queryicceconnectionstate)接口检查车控蓝牙的连接状态，如果未连接则使用[startICCEConnection](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#starticceconnection)主动连接。
- 通过[registerICCEListener](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#registericcelistener)注册监听，接收华为钱包发送的消息。
- 车主APP可以通过[sendICCERKEMessage](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#sendiccerkemessage)接口发送车控指令。
- 用户退出数字钥匙车控页面，通过[unregisterICCEListener](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#unregistericcelistener)接口取消监听。

## 开发步骤

1. 车主APP使用[创建Wallet Kit服务](/wallet-kit-guide/wallet-preparations)时注册的服务号和[申请钥匙卡片](/ref/wallet-api/wallet-rest-api/wallet-rest-api-carkey/wallet-rest-api-carkey#申请钥匙卡片)时定义的卡券唯一标识，通过[queryICCEConnectionState](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#queryicceconnectionstate)判断车钥匙的蓝牙链路状态。
   ...
   ```
2. 如果[queryICCEConnectionState](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#queryicceconnectionstate)接口返回连接状态connectionState为未配对0时，需要调用[startICCEConnection](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#starticceconnection)主动创建蓝牙链接。
   ...
   ```
3. 车主APP通过[registerICCEListener](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#registericcelistener)注册监听华为钱包发送的消息。
   ...
   ```
4. 车主APP通过[sendICCERKEMessage](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#sendiccerkemessage)接口发送车控指令。
   ...
   ```
5. 用户退出数字钥匙车控页面，车主APP通过[unregisterICCEListener](/ref/wallet-api/wallet-arkts/wallet-walletpass/wallet-walletpass#unregistericcelistener)接口取消监听。
