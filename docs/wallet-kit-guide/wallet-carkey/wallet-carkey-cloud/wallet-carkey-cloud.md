...
在[创建Wallet Kit服务](/wallet-kit-guide/wallet-preparations)的配置参数里填写。
...
| 用户公钥 | 按照[创建Wallet Kit服务](/wallet-kit-guide/wallet-preparations)步骤5提供的生成方式，并将生成的公钥内容粘贴在此处。 |
...
![](../../../images/5655a60a/note_3.0-zh-cn.png) 
...
![](../../../images/d637cf84/note_3.0-zh-cn.png) 
