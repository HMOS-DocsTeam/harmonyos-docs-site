...
富文本控件[RichEditor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor)已集成跨设备互通能力。在平板或2in1设备上，用户可通过其右键菜单调用手机的相机、扫描及图库（访问图片）功能。
...
添加[RichEditor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor)富文本组件，即可在富文本组件中右键中选择其他设备进行导入，通过onWillChange属性对回传的照片进行处理。
...
![](../../../images/5e7b91d8/zh-cn_image_0000002552798790.png)

2.选择想要使用的能力。

![](../../../images/fb0e7fda/zh-cn_image_0000002583438485.png)

3.等待对端设备拍照回传。

![](../../../images/e74afa65/zh-cn_image_0000002552958440.png)

4.图片回传后，在光标后面已嵌入一张图片。

![](../../../images/221a18cd/zh-cn_image_0000002583478441.png)
