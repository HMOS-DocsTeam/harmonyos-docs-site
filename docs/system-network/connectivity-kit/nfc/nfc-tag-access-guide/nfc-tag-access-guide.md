...
NFC标签读写完整的JS API说明以及实例代码请参考：[NFC标签接口](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag)。
...
1. 在配置文件module.json5中，不需要静态声明过滤读取NFC标签的技术类型，而是通过[tag.registerForegroundDispatch](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#tagregisterforegrounddispatch10)或者[tag.on](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#tagon11)来完成动态注册。
...
4. 当应用页面切换到后台时，需要显式调用[tag.unregisterForegroundDispatch](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#tagunregisterforegrounddispatch10)或者[tag.off](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-nfctag/js-apis-nfctag#tagoff11)来取消注册，退出前台读卡优先功能。
...
![](../../../../images/cc6cd2c3/caution_3.0-zh-cn.png) 

- 从API version 9之后的应用开发新增支持[Stage模型](/ability-kit/ability-terminology#stage模型)，作为目前主推并长期演进的模型。
- NFC标签读写示例代码的提供，全部按照[Stage模型](/ability-kit/ability-terminology#stage模型)来说明。
...
![](../../../../images/8f9f85fc/note_3.0-zh-cn.png) 
