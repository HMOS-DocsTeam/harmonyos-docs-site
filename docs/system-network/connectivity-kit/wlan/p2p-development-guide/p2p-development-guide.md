...
完整的JS API说明以及示例代码请参考：[P2P接口](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager)。
...
5. 示例代码：
   ...
   ```
6. 错误码请参见[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
...
6. 示例代码：
   ...
   ```
7. 错误码请参见[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
...
2. 开启设备的Wi-Fi。
3. 需要SystemCapability.Communication.WiFi.P2P系统能力。
4. 通过[wifiP2pLinkedInfo.connectState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager#p2pconnectstate)获取P2P连接状态，确保连接状态为CONNECTED。
5. 通过[wifiP2pGroupInfo.goIpAddress](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager#wifip2pgroupinfo)获取群组IP地址，以便Socket通信。
6. Socket通信请参考[使用Socket访问网络](/system-network/network-kit/network-kit-data-transmission/socket-connection)。
