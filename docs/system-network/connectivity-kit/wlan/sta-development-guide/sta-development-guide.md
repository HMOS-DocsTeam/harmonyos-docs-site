...
完整的JS API说明以及示例代码请参考：[STA接口](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager)。
...
5. 示例代码：
   ...
   ```
6. Wi-Fi连接状态值，详情请参考[ConnState](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager#connstate)。
7. 错误码详情请参见[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
