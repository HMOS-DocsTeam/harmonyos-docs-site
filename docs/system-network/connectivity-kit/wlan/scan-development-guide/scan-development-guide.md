...
完整的JS API说明以及示例代码请参考：[SCAN接口](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-wifimanager/js-apis-wifimanager)。
...
5. 示例代码：
   ...
   ![](../../../../images/97bb5db4/note_3.0-zh-cn.png) 
   ...
   ```
6. 错误码详情请参见[WIFI错误码](/ref/system-network-api/connectivity-api/connectivity-arkts-errcode/errorcode-wifi/errorcode-wifi)。
