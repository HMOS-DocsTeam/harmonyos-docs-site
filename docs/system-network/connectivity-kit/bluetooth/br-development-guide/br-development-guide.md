...
通过订阅开关状态变化事件，可以获取实时的蓝牙开关状态。蓝牙开启或者关闭过程中，涉及多种蓝牙状态的跃迁。其中[STATE\_OFF](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#bluetoothstate)表示蓝牙已关闭，此状态下，应用不可以使用蓝牙其他功能；[STATE\_ON](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#bluetoothstate)表示蓝牙已打开，此状态下，应用可以使用蓝牙其他功能。
...
![](../../../../images/40653b58/zh-cn_image_0000002552798770.png)
...
![](../../../../images/518ecac9/zh-cn_image_0000002583438465.png)
