...
NetConnection常用接口如下表所示，详细的接口说明请参考[net\_connection.h](/ref/system-network-api/network-api/network-c/network-headerfile/capi-net-connection-h/capi-net-connection-h)。
...
6. 配置CMakeLists.txt，本模块需要用到的共享库是libnet\_connection.so，在工程自动生成的CMakeLists.txt中的target\_link\_libraries中添加此共享库。
   ...
   ![](../../../../images/29ca22b9/caution_3.0-zh-cn.png) 

   如图所示，在add\_library中的entry是工程自动生成的modname。若要做修改，需和步骤3中.nm\_modname保持一致。

   ![](../../../../images/57454cca/zh-cn_image_0000002552798776.png)
...
2. 运行工程，设备上会弹出以下所示图片。
   ...
   ![](../../../../images/61abc0dc/zh-cn_image_0000002583438471.png)
3. 点击GetDefaultNet按钮，控制台会打印日志。

   ![](../../../../images/9651dd63/zh-cn_image_0000002552958426.png)
4. 点击codeNumber按钮，控制台会打印相应的响应状态码。

   ![](../../../../images/1e443c09/zh-cn_image_0000002583478427.png)
