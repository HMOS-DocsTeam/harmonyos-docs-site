...
WebSocket常用接口如下表所示，详细的接口说明请参考[net\_websocket.h](/ref/system-network-api/network-api/network-c/network-headerfile/capi-net-websocket-h/capi-net-websocket-h)。
...
ConnectWebsocket函数接收一个WebSocket URL并尝试连接，连接成功返回true，否则返回false。在创建代表WebSocket客户端的WebSocket结构体指针前，需要定义以下回调函数：连接开启时的onOpen回调、接收普通消息的onMessage回调、接收错误消息的onError回调、接收关闭消息的onClose回调。在示例代码中，还调用了[OH\_WebSocketClient\_Send](/ref/system-network-api/network-api/network-c/network-headerfile/capi-net-websocket-h/capi-net-websocket-h#oh_websocketclient_send)、[OH\_WebSocketClient\_Close](/ref/system-network-api/network-api/network-c/network-headerfile/capi-net-websocket-h/capi-net-websocket-h#oh_websocketclient_close)等函数向服务器发送消息，主动关闭WebSocket连接。
...
![](../../../../images/2319ba29/zh-cn_image_0000002552798774.png)
...
![](../../../../images/b43919e9/zh-cn_image_0000002583438469.jpg)
...
![](../../../../images/e4532922/zh-cn_image_0000002552958424.jpg)

![](../../../../images/54cef8cb/zh-cn_image_0000002583478425.png)
