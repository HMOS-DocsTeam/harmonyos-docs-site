...
通过[网络质量评估](/system-network/network-boost-kit-guide/networkboost-netqualityguide/networkboost-qoscallback)和[网络场景识别](/system-network/network-boost-kit-guide/networkboost-netqualityguide/networkboost-scenecallback)章节，弱网感知判决可归纳为3种方式获取：
