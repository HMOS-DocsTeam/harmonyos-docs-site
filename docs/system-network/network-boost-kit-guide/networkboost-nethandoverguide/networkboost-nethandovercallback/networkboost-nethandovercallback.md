...
具体API说明详见[接口文档](/ref/system-network-api/network-boost-api/networkboost-arkts/networkboost-nethandover/networkboost-nethandover#nethandoveron-handoverchange)。
