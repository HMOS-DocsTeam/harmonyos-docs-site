...
通过[网络质量评估（C++）](/system-network/network-boost-kit-guide/networkboost-netqualityguide-c/networkboost-qoscallback-c)和[网络场景识别（C++）](/system-network/network-boost-kit-guide/networkboost-netqualityguide-c/networkboost-scenecallback-c)章节，弱网感知判决可归纳为3种方式获取：
