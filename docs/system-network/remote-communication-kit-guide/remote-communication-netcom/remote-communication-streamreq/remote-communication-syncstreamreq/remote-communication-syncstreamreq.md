...
具体API说明详见[接口文档](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#networkinputqueue)。
...
具体API说明详见[接口文档](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#uploadfromstream)。

| 接口名 | 描述 |
| --- | --- |
| uploadFromStream(url: [URLOrString](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#urlorstring), uploadFrom: [UploadFromStream](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#uploadfromstream-2)): Promise&lt;[Response](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#response)&gt; | 从流中上传。 |
| downloadToStream(url: [URLOrString](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#urlorstring), downloadTo: [DownloadToStream](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#downloadtostream-2)): Promise&lt;[Response](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#response)&gt; | 下载到流中。 |
