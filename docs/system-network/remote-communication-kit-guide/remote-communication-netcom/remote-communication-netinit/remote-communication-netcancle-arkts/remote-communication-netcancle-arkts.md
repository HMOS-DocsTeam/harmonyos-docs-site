...
具体API说明详见[接口文档](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#cancel)。

| 接口名 | 描述 |
| --- | --- |
| cancel(requestToCancel?: [Request](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#request)| [Request](/ref/system-network-api/remote-communication-api/remote-communication-arkts/remote-communication-rcp/remote-communication-rcp#request)[]): void | - 取消指定网络请求：传入需要取消的请求，返回值为空。  - 取消所有网络请求：无需传入参数，直接调用，返回值为空。 |
