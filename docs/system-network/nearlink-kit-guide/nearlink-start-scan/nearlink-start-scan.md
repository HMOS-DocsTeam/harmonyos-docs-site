...
| 接口名 | 描述 |
| --- | --- |
| [startScan](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-scan/nearlink-scan#startscan)(filters: Array&lt;ScanFilters&gt;, options?: ScanOptions): Promise&lt;void&gt; | 启动星闪扫描。 |
| [stopScan](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-scan/nearlink-scan#stopscan)(): Promise&lt;void&gt; | 停止星闪扫描。 |
| [on](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-scan/nearlink-scan#on-devicefound)(type: 'deviceFound', callback: Callback&lt;Array&lt;ScanResults&gt;&gt;): void | 订阅扫描结果。 |
| [off](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-scan/nearlink-scan#off-devicefound)(type: 'deviceFound', callback?: Callback&lt;Array&lt;ScanResults&gt;&gt;): void | 取消订阅扫描结果。 |
...
4. 配置扫描参数，扫描过滤器配置期望的设备名称、地址等信息。
   ...
   ![](../../../images/248124a1/caution_3.0-zh-cn.png) 
