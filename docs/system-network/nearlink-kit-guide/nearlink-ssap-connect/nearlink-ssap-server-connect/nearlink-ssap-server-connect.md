...
![](../../../../images/9bb4f1f1/caution_3.0-zh-cn.png) 

建立SSAP连接后，SSAP服务端广播会自动停止。后续如果服务端期望被客户端发现，可参见[发送星闪广播](/system-network/nearlink-kit-guide/nearlink-send-advertising)，重新发起广播。
...
| 接口名 | 描述 |
| --- | --- |
| [createServer](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#createserver)(): Server | 创建ssap服务端实例。 |
| [addService](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#addservice)(service: Service): void | 服务端添加服务。 |
| [on](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#onconnectionstatechange)(type: 'connectionStateChange', callback: Callback&lt;ConnectionChangeState&gt;): void | 订阅连接状态变化事件。 |
| [on](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#on-propertyread)(type: 'propertyRead', callback: Callback&lt;PropertyReadRequest&gt;): void | 订阅客户端的读请求事件。 |
| [sendResponse](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#sendresponse)(response: ServerResponse): void | 回复客户端读/写请求。 |
| [notifyPropertyChanged](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-ssap/nearlink-ssap#notifypropertychanged)(address: string, property: Property): Promise&lt;void&gt; | 通知客户端property值更新。 |
