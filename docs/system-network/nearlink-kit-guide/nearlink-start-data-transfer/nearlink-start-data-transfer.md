...
![](../../../images/c1f7f5cc/note_3.0-zh-cn.png) 

1. 数据传输通道不保证链路加密。如需加密数传，需先进行配对流程，通过[startPairing](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-remote-device/nearlink-remote-device#startpairing)接口发起。
2. 链路是否加密可通过[getAcbState](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-remote-device/nearlink-remote-device#getacbstate)接口查询，ENCRYPTED状态表示链路已加密。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [createPort](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-data-transfer-api/nearlink-data-transfer-api#createport)(uuid: string): void | 注册端口服务。 |
| [connect](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-data-transfer-api/nearlink-data-transfer-api#connect)(params: ConnectionParams): Promise&lt;void&gt; | 连接远端设备，建立端口通道。 |
| [writeData](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-data-transfer-api/nearlink-data-transfer-api#writedata)(params: DataParams): Promise&lt;void&gt; | 通过设备地址和UUID向远端设备发数据。 |
| [on](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-data-transfer-api/nearlink-data-transfer-api#onconnectionstatechanged)(type: 'connectionStateChanged', callback: Callback&lt;ConnectionResult&gt;): void | 订阅端口通道连接状态变更事件。 |
| [on](/ref/system-network-api/nearlink-api/nearlink-arkts/nearlink-data-transfer-api/nearlink-data-transfer-api#onreaddata)(type: 'readData', callback: Callback&lt;DataParams&gt;): void | 订阅端口通道数据接收事件。 |
