...
![](../../../images/c47326e2/note_3.0-zh-cn.png) 

为了保证应用的运行效率，大部分API调用都是异步的，对于异步调用的API均提供了callback和Promise两种方式，以下示例均采用callback函数，更多方式可以查阅[API参考](/ref/system-network-api/telephony-api/telephony-arkts/js-apis-call/js-apis-call)。
...
observer模块为开发者提供订阅和取消订阅通话业务状态的功能。具体API说明详见[接口文档](/ref/system-network-api/telephony-api/telephony-arkts/js-apis-observer/js-apis-observer)。
