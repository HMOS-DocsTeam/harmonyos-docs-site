...
2. 导入abilityAccessCtrl模块，用于获取权限申请的能力。
   ...
   ```
3. 分布式数据同步权限的授权方式为user\_grant，因此需要调用[requestPermissionsFromUser()](/ref/ability-api/ability-arkts/both-models/js-apis-abilityaccessctrl/js-apis-abilityaccessctrl#requestpermissionsfromuser9)接口，以动态弹窗的方式向用户申请授权。
...
发现周边同局域网或者开启蓝牙的设备。详细信息参见：[startDiscovering](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#startdiscovering)。
...
设备绑定。详细信息参见：[bindTarget](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#bindtarget)。
...
设备信息查询。详细信息参见：[getAvailableDeviceListSync](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#getavailabledevicelistsync)。
...
设备上下线监听。详细信息参见：[on('deviceStateChange')](/ref/system-network-api/distributed-service-api/distributed-service-arkts/js-apis-distributeddevicemanager/js-apis-distributeddevicemanager#ondevicestatechange)。
