...
![](../../../images/8d73330b/note_3.0-zh-cn.png) 
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --odm\_r2\_project\_root 参数。当存在overrideDependencyMap配置，且其配置项对应的配置文件内存在相对路径的依赖配置时，ohpm会基于工程根路径解析和查询相对路径，详情参见[odm\_r2\_project\_root](/ide-ohpm-cli/ide-ohpmrc#section136621053184912)。
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --resolve\_conflict\_strict 参数，ohpm会按照严格模式处理依赖版本冲突，详情参见[resolve\_conflict\_strict](/ide-ohpm-cli/ide-ohpmrc#section1942983310492)。
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --resolve\_conflict 参数，ohpm会自动处理依赖版本冲突，详情参见[resolve\_conflict](/ide-ohpm-cli/ide-ohpmrc#section368717475562)。
...
![](../../../images/99b1e1d8/zh-cn_image_0000002530913590.png "点击放大")
...
![](../../../images/37f0d9c8/caution_3.0-zh-cn.png) 
