...
![](../../../images/09f113fc/note_3.0-zh-cn.png) 

配置文件中信息以键值对&lt;key&gt; = &lt;value&gt;形式存在。

## 功能描述

ohpm 从命令行和 .ohpmrc 文件中获取其配置设置。有关更多 .ohpmrc 文件信息和可用配置选项，请参阅 [ohpmrc](/ide-ohpm-cli/ide-ohpmrc) 章节。

![](../../../images/b0b7a113/caution_3.0-zh-cn.png) 

ohpm config 仅支持配置项字段（默认项字段请查阅 [ohpmrc](/ide-ohpm-cli/ide-ohpmrc#zh-cn_topic_0000001792216397_默认配置项) 章节），且仅支持修改****用户级目录****下的 .ohpmrc 文件。
...
生成的加密结果可以配置到项目级或用户级 .ohpmrc 文件中，用于[敏感配置项](/ide-ohpm-cli/ide-ohpmrc#section18322038185010)。
