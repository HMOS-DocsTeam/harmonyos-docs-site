...
sidebar_position: 1
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-config-errorcode
kit: devtools/cli
...
以下划线开头键名受保护（如\_auth=readWriteToken），不允许访问。详情可参考[如何配置AccessToken](/ide-ohpm-cli/ide-ohpmrc#section613915915011)。
