...
sidebar_position: 15
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-convert-errorcode
kit: devtools/cli
...
检查npm包中package.json配置文件字段存在，且取值符合要求。具体字段说明请参考[oh-package.json5](/ide-ohpm-cli/ide-oh-package-json5#zh-cn_topic_0000001792256137_oh-packagejson5-字段说明)。
