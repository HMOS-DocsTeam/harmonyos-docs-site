...
sidebar_position: 5
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-publish-errorcode
kit: devtools/cli
...
确保导入的依赖项在oh-package.json5文件的 "dependencies" 或 "dynamicDependencies" 中声明，具体可参考[ensure\_dependency\_include](/ide-ohpm-cli/ide-ohpmrc#section1291814578276)。
