...
![](../../../images/95566807/zh-cn_image_0000002492343756.png "点击放大")
...
测试执行前需先构建测试包，用户利用python的setuptools工具在工程（测试工程构建参考[应用UI测试（基于Python）](/ut/hypium-python-guidelines)）根目录下构建setup-regression.py、MANIFEST.in文件，setup-regression.py文件中声明用例，MANIFEST.in文件中声明脚本执行过程中需要用到的aw包、config文件夹下的配置文件及其他的资源文件。
...
![](../../../images/4132d911/caution_3.0-zh-cn.png) 
...
![](../../../images/18b56446/caution_3.0-zh-cn.png) 
...
![](../../../images/9bfaf370/notice_3.0-zh-cn.png) 
...
![](../../../images/6dab9154/zh-cn_image_0000002524503447.png)

![](../../../images/e69ed6b2/zh-cn_image_0000002492343754.png "点击放大")
...
![](../../../images/d2b419b5/zh-cn_image_0000002492343752.png "点击放大")
...
![](../../../images/8fa678f6/zh-cn_image_0000002538035122.png "点击放大")
...
![](../../../images/21d94d76/zh-cn_image_0000002492343750.jpg "点击放大")

****查看报告****

测试完成后，将自动跳转到报告界面。

![](../../../images/52feb148/zh-cn_image_0000002492343758.png "点击放大")
...
![](../../../images/b7255e93/note_3.0-zh-cn.png) 
