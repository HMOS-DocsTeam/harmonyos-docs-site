...
![](../../../images/a5149e83/zh-cn_image_0000002503713790.png "点击放大")
...
![](../../../images/233e3eb2/zh-cn_image_0000002524503459.png "点击放大")

性能基础质量测试支持选择已安装的应用，或选择待测应用的安装包后进行测试。

![](../../../images/fec244ea/note_3.0-zh-cn.png) 
...
![](../../../images/cf4ec4ba/zh-cn_image_0000002492343774.png "点击放大")

（2）安装新的应用

点击按钮，在弹窗中选择应用安装包，支持.hap、.zip格式安装包。

![](../../../images/b494d0ac/zh-cn_image_0000002524623413.png "点击放大")

![](../../../images/80602f2d/zh-cn_image_0000002492343792.png "点击放大")

****启动测试次数****

执行冷启动操作的次数，自动化测试过程中会重复执行应用冷启动和退出操作，用来评估应用启动的性能。

![](../../../images/151f5465/zh-cn_image_0000002492503686.png)

****遍历时长****

应用内点击、滑动等操作的总执行时长，用户可根据需求自定义遍历时长，默认为1小时，最大支持120分钟。

![](../../../images/df55aad4/zh-cn_image_0000002524503423.png "点击放大")

****高级配置****

![](../../../images/66b49820/zh-cn_image_0000002524503461.png)
...
![](../../../images/edeefb0d/zh-cn_image_0000002535546833.png "点击放大")
...
![](../../../images/560e1fdf/zh-cn_image_0000002492343780.png "点击放大")
...
![](../../../images/1679675d/zh-cn_image_0000002524503443.png "点击放大")
...
- 导出IDE体检文件：支持生成体检文件导入到DevEco Studio中进行问题分析定位。详细操作指导请查看[导入DevEco Testing的检测报告进行诊断](/ide-app-test/ide-app-analyzer#section19550112715455)。
...
![](../../../images/16c4087a/zh-cn_image_0000002492503740.png "点击放大")

![](../../../images/4fa5832c/zh-cn_image_0000002492343768.png "点击放大")
...
![](../../../images/f703c21b/zh-cn_image_0000002492503764.png "点击放大")
...
![](../../../images/eb50653a/zh-cn_image_0000002492503770.png "点击放大")
...
![](../../../images/786f77af/zh-cn_image_0000002503552638.png "点击放大")
...
![](../../../images/b6ca9737/zh-cn_image_0000002503712596.png "点击放大")
...
![](../../../images/06dd0429/zh-cn_image_0000002492343720.png "点击放大")
...
![](../../../images/b88b320f/zh-cn_image_0000002524623399.png "点击放大")

用户可查看步骤执行全过程的图片和视频，如下所示：

![](../../../images/c69ee01f/zh-cn_image_0000002492503752.png "点击放大")
...
![](../../../images/07dc9a7f/zh-cn_image_0000002492343718.png "点击放大")

![](../../../images/0f283a73/note_3.0-zh-cn.png) 
...
应用的设计、开发及测试过程中推荐参考[应用性能体验建议](/performance-experience-suggestions/performance-overview)。

****服务使用场景****

支持一键式测试应用的关键场景和核心路径的性能体验。通过任务报告，用户可查看关键场景上的多维度性能指标表现，精准识别性能体验问题。

![](../../../images/fce3f11a/caution_3.0-zh-cn.png) 

****场景化性能测试的性能指标检测能力********与性能基础质量测试一致；详情请查看[性能基础质量测试](#section12324184817324)。****

****脚本写作****

请参考[自定义性能脚本测试（基于Python)](/ut/hypium-perf-python-guidelines)。

****任务创建：****

打开DevEco Testing客户端-专项测试-场景化性能测试卡片，在任务创建界面按需配置任务参数，点击创建任务后开始测试。

![](../../../images/ac7a2c27/zh-cn_image_0000002492352024.png "点击放大")
...
![](../../../images/30d850be/zh-cn_image_0000002524511721.png)
...
![](../../../images/3a0bb5e1/zh-cn_image_0000002492511990.png)

![](../../../images/5dd5a558/zh-cn_image_0000002524631695.png)

****高级配置****

![](../../../images/13710ca9/zh-cn_image_0000002492352026.png "点击放大")
...
![](../../../images/3f6e52ec/zh-cn_image_0000002524511723.png "点击放大")
...
![](../../../images/58294b01/zh-cn_image_0000002492511992.png "点击放大")
...
![](../../../images/ee287909/zh-cn_image_0000002524631697.png "点击放大")
...
![](../../../images/4d84e6ba/zh-cn_image_0000002492352028.png)

展开后呈现问题的详细信息：

![](../../../images/004c636f/zh-cn_image_0000002524511725.png "点击放大")
...
![](../../../images/91811825/zh-cn_image_0000002492511994.png "点击放大")
...
![](../../../images/6e9189ef/zh-cn_image_0000002524631699.png "点击放大")
...
![](../../../images/4185ebde/zh-cn_image_0000002492352030.png "点击放大")

操作前&操作后：展示该步骤操作前后的信息，用户可以通过前后截图了解操作的场景。

指标项：展示每轮的指标检测结果信息，如果测试值超标，字体标红显示，支持点击查看问题详情。若不涉及，则显示“-”。

维测数据：点击![](../../../images/4465a85b/zh-cn_image_0000002524511727.png "点击放大") 按钮，自动打开该操作的数据文件夹，汇总当前操作的trace、视频、图片等维测数据，协助用户进行问题定位。若该步骤所有测试数据都达到标准，则不会出现该按钮。

对于超标的检测结果，可以通过点击超标项，查看该步骤的详细信息，展示内容如下图所示（以滑动占位符加载指数详情为例）：

![](../../../images/bb4418fb/zh-cn_image_0000002492511996.png "点击放大")
...
![](../../../images/45bcde92/zh-cn_image_0000002524631701.png "点击放大")

测试步骤执行全过程的图片和视频如下：

![](../../../images/80a8bdf0/zh-cn_image_0000002492352032.png "点击放大")

****perfdata********数据****

可使用[DevEco Studio](https://developer.huawei.com/consumer/cn/download/deveco-studio) 5.0.3.300及以上版本中的场景化调优工具DevEco Profiler打开及查看该文件，内含步骤执行过程中的trace打点和调用栈信息，也可使用压缩软件解压为单个的trace文件和调用栈文件，解压后的文件可使用[SmartPerf](https://gitcode.com/openharmony/developtools_smartperf_host)工具打开。

![](../../../images/c1a2edea/zh-cn_image_0000002524511729.png "点击放大")

![](../../../images/645ca88c/note_3.0-zh-cn.png) 
...
![](../../../images/6cf753b5/zh-cn_image_0000002538034024.png "点击放大")
...
![](../../../images/0c3a5882/note_3.0-zh-cn.png) 

****稳定性基础质量测试最佳测试时长建议设置为8********小时****。

****控件黑名单****

![](../../../images/2c485c5c/zh-cn_image_0000002538194210.png "点击放大")
...
![](../../../images/4ec75e94/zh-cn_image_0000002568914377.png "点击放大")

![](../../../images/a35886d8/note_3.0-zh-cn.png) 

****1、关于控件黑名单中“XPath”信息也可以通过探索测试报告中的遍历地图获取****：

![](../../../images/09f606fc/zh-cn_image_0000002569034393.png "点击放大")
...
![](../../../images/45e5048c/zh-cn_image_0000002524503425.png "点击放大")
...
![](../../../images/cb872246/zh-cn_image_0000002524503497.png "点击放大")

测试概览中，包含结果统计及检测规则，可直观查看本次任务中，测试项检测结果。

![](../../../images/df825940/zh-cn_image_0000002492503702.png "点击放大")

检测不通过或检测异常的规则项，点击查看详情即可查看异常问题详情，包含检测项概览、测试截图、问题列表。

![](../../../images/df81e77b/zh-cn_image_0000002492503694.png "点击放大")

点击查看按钮，支持查看测试过程中的日志，用户可结合问题描述及日志详情进一步分析。

![](../../../images/4634e5f2/note_3.0-zh-cn.png) 

更多测试服务详情，请前往DevEco Testing客户端->专项测试->稳定性基础质量测试->任务创建页->测试指南中查询。

更多应用稳定性体验优化建议及问题定位，请查阅：[应用稳定性体验建议](/experience-suggestions-stability) 及 [CppCrash故障定位指导](https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c25-0000002324993158)
...
![](../../../images/3bca5ca6/zh-cn_image_0000002524623373.png)
...
![](../../../images/8a9f52e3/zh-cn_image_0000002492503718.png "点击放大")

等待测试环境初始化完成后，待测应用启动，自动跳转至监控页面，并启动监控，在手工测试场景准备好后，点击右上角的开始图标按钮，出现“开始采集”标识线，开始统计分析数据。

![](../../../images/95065816/zh-cn_image_0000002524503453.png "点击放大")

开始采集后，点击开始图标右侧的“记录”图标，可标识场景，并提示“场景开始”。待测场景结束后，再次点击，完成标识场景。概览中单独计算被标识的场景数据。

![](../../../images/16a96635/zh-cn_image_0000002524503491.png "点击放大")

在测试过程中，可随时点击“采集 trace”按钮，采集连续30 秒的 trace 信息，单次任务只保留最近10 个 trace 文件。

![](../../../images/b5b22836/zh-cn_image_0000002524503479.jpg "点击放大")

结束采集。

![](../../../images/9f3cd9f5/zh-cn_image_0000002492503708.jpg "点击放大")
...
![](../../../images/f1134494/zh-cn_image_0000002524503401.png "点击放大")
...
![](../../../images/5ea812a5/zh-cn_image_0000002492503700.png "点击放大")

![](../../../images/1f2bc244/note_3.0-zh-cn.png) 
...
![](../../../images/e5b348b2/zh-cn_image_0000002524503465.png "点击放大")

对于检测不通过及检测异常的规则项，点击查看详情即可查看异常问题详情，包含检测项概览、测试截图、问题列表。对于异常问题，可根据测试截图、问题描述，针对性优化异常问题。

![](../../../images/57d0b72f/zh-cn_image_0000002524503505.png "点击放大")

![](../../../images/3d2b748b/note_3.0-zh-cn.png) 
...
![](../../../images/048c7d49/zh-cn_image_0000002492352192.png "点击放大")

在测试报告中，包含执行结果、问题统计及检测规则。用户可直观查看本次任务中的测试项检测结果。

对于检测不通过的规则项，点击查看详情即可查看异常问题详情，包含执行设备信息、执行过程信息和问题列表；问题列表中有序号、问题描述和修复指南。

![](../../../images/d1ce624b/zh-cn_image_0000002524511907.png "点击放大")

![](../../../images/3eadd326/note_3.0-zh-cn.png) 
...
![](../../../images/2478bc91/zh-cn_image_0000002492343802.png "点击放大")

检测不通过的规则项，点击查看按钮查看问题详情，包含执行设备信息、执行过程信息、测试截图、问题列表等。![](../../../images/a690bcba/zh-cn_image_0000002524623463.png "点击放大")

![](../../../images/f70bb1e3/note_3.0-zh-cn.png) 
...
![](../../../images/c1c45ddf/zh-cn_image_0000002524623477.png "点击放大")

检测不通过的规则项，点击查看按钮查看问题详情，包含执行设备信息、执行过程信息、测试截图、问题列表等。

![](../../../images/57701780/zh-cn_image_0000002524623445.png "点击放大")

![](../../../images/dca9cfcb/note_3.0-zh-cn.png) 
