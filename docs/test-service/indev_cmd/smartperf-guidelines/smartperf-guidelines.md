...
![](../../../images/1dfebf0b/zh-cn_image_0000002581377647.png)

## 约束与限制

1. Device daemon端从API version 9开始预置使用。
2. Device daemon端执行需连接硬件设备，Device hap端需在有屏幕设备使用。
3. Device daemon端执行前需完成[hdc环境配置](/system-debug-optimize/debugging-commands/hdc)，并进入shell环境拉起daemon进程。
...
4. Device hap端从API version 20开始支持自动拉起Device daemon端的功能。
   ...
   ![](../../../images/f3118e3a/note_3.0-zh-cn.png) 
...
- 设置包名并采集1次应用的线程数量。
  ...
  ![](../../../images/51b2262c/note_3.0-zh-cn.png) 
...
- 设置包名并采集2次整机CPU大中小核频率、各核使用率以及进程CPU使用率、负载。
  ...
  ![](../../../images/32c2ef1b/note_3.0-zh-cn.png) 
...
- 设置进程ID并采集2次整机CPU大中小核频率、各核使用率以及进程CPU使用率、负载。
  ...
  ![](../../../images/1b59143f/note_3.0-zh-cn.png) 
...
- 设置包名并采集1次整机和指定应用进程内存。
  ...
  ![](../../../images/7566c228/note_3.0-zh-cn.png) 
...
- 设置进程ID并采集1次整机和指定应用进程内存。
  ...
  ![](../../../images/d6c03367/note_3.0-zh-cn.png) 
...
- 采集1整机和指定应用cpu指令数。
  ...
  ![](../../../images/eebf29ee/note_3.0-zh-cn.png) 
...
- 采集2次截图。
  ...
  ![](../../../images/0ce650bd/note_3.0-zh-cn.png) 
...
- 设置包名并采集5次指定应用帧率。
  ...
  ![](../../../images/4ad0d2bb/note_3.0-zh-cn.png) 
...
- 设置进程ID采集5次指定应用帧率。
  ...
  ![](../../../images/28b144a1/note_3.0-zh-cn.png) 
...
- 采集10次指定图层帧率。
  ...
  ![](../../../images/57ebb515/note_3.0-zh-cn.png) 
...
- 全量采集示例2，设置包名并采集指定应用信息，包括cpu、gpu、温度、功耗、fps、内存信息、DDR信息、网络速率、屏幕截图。
  ...
  ![](../../../images/6bc19c9f/note_3.0-zh-cn.png) 
...
- 全量采集示例3，设置进程ID并采集指定应用信息，包括cpu、gpu、温度、功耗、fps、内存信息、DDR信息、网络速率、屏幕截图。
  ...
  ![](../../../images/23ac454b/note_3.0-zh-cn.png) 
...
- 启停采集并打印整机CPU大中小核频率、各核使用率。
  ...
  ![](../../../images/c310b6b0/note_3.0-zh-cn.png) 
...
![](../../../images/aa2f9d8b/note_3.0-zh-cn.png) 
...
![](../../../images/0108dc63/note_3.0-zh-cn.png) 
...
- 获取屏幕分辨率。
  ...
  ![](../../../images/c34ff9ba/note_3.0-zh-cn.png) 
...
- 启动一个进程来监听start和stop命令的socket消息
  ...
  ![](../../../images/ad48d6af/note_3.0-zh-cn.png) 
...
- 清除SP\_daemon进程ID
  ...
  ![](../../../images/ce911a53/note_3.0-zh-cn.png) 
...
- 采集当前界面fps。
  ...
  ![](../../../images/63464552/note_3.0-zh-cn.png) 
...
- 采集当前界面fps（分段采集）。
  ...
  ![](../../../images/90751a85/note_3.0-zh-cn.png) 
...
- 获取电池电量。
  ...
  ![](../../../images/0ac62761/note_3.0-zh-cn.png) 
