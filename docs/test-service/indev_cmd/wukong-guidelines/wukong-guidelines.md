...
![](../../../images/3ad31c7e/zh-cn_image_0000002550617950.png)
...
2. 所有命令执行前需完成[hdc环境配置](/system-debug-optimize/debugging-commands/hdc)，并进入shell模式。
...
![](../../../images/8295671c/note_3.0-zh-cn.png) 
...
- 设置允许测试和禁止测试的ability
  ...
  ![](../../../images/3fdf9fcb/note_3.0-zh-cn.png) 
...
2. 故障注入统计（Input Message Statistics）
   ...
   | 类型 | 描述 |
   | --- | --- |
   | type | 事件或控件注入的类型，事件注入类型范围请参考[随机测试命令参数](#随机测试)，控件注入类型范围请参考[ArkTS组件](/ref/arkui-api/arkui-declarative-comp/arkui-declarative-comp)。 |
...
4. 故障统计（Exception Message Statistics）
   ...
   ![](../../../images/92222035/note_3.0-zh-cn.png) 
