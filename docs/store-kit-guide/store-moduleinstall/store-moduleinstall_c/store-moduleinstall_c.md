...
产品特性按需分发场景提供以下C接口，具体API说明详见[ModuleInstall](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall)。
...
需要开发者引入[module\_install.h](/ref/store-api/store-c/store-c-h/store-c-module_install/store-c-module_install)头文件后，才可以使用按需分发相关API。
...
在使用按需分发能力之前，需要调用[HMS\_ModuleInstall\_GetInstalledModule](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getinstalledmodule)接口查询按需分发的模块是否安装，接口调用成功后，可以通过[HMS\_ModuleInstall\_GetInstalledModuleName](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getinstalledmodulename)、[HMS\_ModuleInstall\_GetInstalledModuleType](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getinstalledmoduletype)、[HMS\_ModuleInstall\_GetModuleInstallStatus](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getmoduleinstallstatus)接口分别获取模块名称、模块类型、模块安装状态信息。
...
应用可以通过[HMS\_ModuleInstall\_FetchModules](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_fetchmodules)按需加载模块，接口调用成功之后可以通过[HMS\_ModuleInstall\_GetFetchModulesRequestCode](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulesrequestcode)、[HMS\_ModuleInstall\_GetFetchModulesTaskStatus](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulestaskstatus)、[HMS\_ModuleInstall\_GetFetchModulesTaskId](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulestaskid)、[HMS\_ModuleInstall\_GetFetchModulesDesc](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulesdesc)、[HMS\_ModuleInstall\_GetFetchModules](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodules)、[HMS\_ModuleInstall\_GetFetchModulesTotalSize](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulestotalsize)、[HMS\_ModuleInstall\_GetFetchModulesDownloadedSize](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulesdownloadedsize)接口获取模块下载相关信息。
...
如果需要取消下载，应用可以调用[HMS\_ModuleInstall\_CancelTask](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_canceltask)接口取消下载任务，其中taskId是调用[HMS\_ModuleInstall\_GetFetchModulesTaskId](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulestaskid)接口返回的taskId。
...
如果调用[HMS\_ModuleInstall\_GetFetchModulesRequestCode](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_getfetchmodulesrequestcode)接口返回DOWNLOAD\_WAIT\_WIFI时，需要调用[HMS\_ModuleInstall\_ShowCellularDataConfirmation](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_showcellulardataconfirmation)接口展示流量弹窗。
...
应用可以通过[HMS\_ModuleInstall\_CreateStatusCallback](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_createstatuscallback)初始化下载进度回调。
...
应用可以通过[HMS\_ModuleInstall\_On](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_on)接口监听下载进度。
...
应用可以通过[HMS\_ModuleInstall\_Off](/ref/store-api/store-c/store-c-module/store-c-moduleinstall/store-c-moduleinstall#hms_moduleinstall_off)接口取消下载进度监听。
