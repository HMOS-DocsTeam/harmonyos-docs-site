...
1. [checkPinShortcutPermitted](/ref/store-api/store-arkts/store-productviewmanager/store-productviewmanager#productviewmanagercheckpinshortcutpermitted)校验快捷方式是否允许加桌接口：
   ...
   - 自定义快捷方式图标大小超过100KB。
   - 不支持为其他应用添加快捷方式。
2. [requestNewPinShortcut](/ref/store-api/store-arkts/store-productviewmanager/store-productviewmanager#productviewmanagerrequestnewpinshortcut)创建快捷方式加桌接口：
