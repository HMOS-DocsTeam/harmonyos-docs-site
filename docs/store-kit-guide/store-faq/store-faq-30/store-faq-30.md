...
可以卸载指定模块后重新调用[fetchModules](/ref/store-api/store-arkts/store-moduleinstallmanager/store-moduleinstallmanager#moduleinstallmanagerfetchmodules)接口发起按需加载请求。
