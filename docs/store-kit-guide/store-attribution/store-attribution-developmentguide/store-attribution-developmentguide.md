...
![](../../../images/0ebe1004/note_3.0-zh-cn.png) 
...
应用归因服务场景提供以下接口，具体API说明详见[接口文档](/ref/store-api/store-arkts/store-attributionmanager/store-attributionmanager)。
...
1. 导入相关模块。
   ...
   ```
2. 构造参数[AdSourceInfo](/ref/store-api/store-arkts/store-attributionmanager/store-attributionmanager#adsourceinfo)。
   ...
   ```
3. 调用[attributionManager.registerSource](/ref/store-api/store-arkts/store-attributionmanager/store-attributionmanager#attributionmanagerregistersource)方法登记归因来源信息。
...
1. 导入相关模块。
   ...
   import { BusinessError,deviceInfo } from '@kit.BasicServicesKit';
   ```
2. 构造参数[AdTriggerInfo](/ref/store-api/store-arkts/store-attributionmanager/store-attributionmanager#adtriggerinfo)。
   ...
   ```
3. 调用[attributionManager.registerTrigger](/ref/store-api/store-arkts/store-attributionmanager/store-attributionmanager#attributionmanagerregistertrigger)方法登记转化信息。
