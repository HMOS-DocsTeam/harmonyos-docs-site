...
1. 判断当前登录的华为账号所在的服务地是否支持数字商品服务应用内支付。
   ...
   在使用应用内支付之前，应用需要向IAP Kit发送[queryEnvironmentStatus](/ref/iap-api/iap-arkts/iap-iap/iap-iap#iapqueryenvironmentstatus)请求，以此判断用户当前登录的华为账号所在服务地是否在IAP Kit支持结算的国家/地区中。

   ![](../../../../images/114c773d/note_3.0-zh-cn.png) 
...
2. 查询商品信息。
   ...
   通过[queryProducts](/ref/iap-api/iap-arkts/iap-iap/iap-iap#iapqueryproducts)来获取在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)上配置的商品信息。发起请求时，需在请求参数[QueryProductsParameter](/ref/iap-api/iap-arkts/iap-iap/iap-iap#queryproductsparameter)中携带相关的商品ID，并根据实际配置指定其productType，订阅型商品指定其productType为[iap.ProductType.AUTORENEWABLE](/ref/iap-api/iap-arkts/iap-iap/iap-iap#producttype)。
   ...
   ![](../../../../images/697ea451/note_3.0-zh-cn.png) 

   [queryProducts](/ref/iap-api/iap-arkts/iap-iap/iap-iap#iapqueryproducts)每次只能查询一种类型的商品，单次查询请勿超过200条。
