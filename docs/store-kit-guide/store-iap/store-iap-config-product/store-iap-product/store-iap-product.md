...
数字商品服务为接入应用内购买的应用提供了[展示数字商品](/store-kit-guide/store-iap/store-iap-distribute/store-iap-distribute-query)、[购买数字商品](/store-kit-guide/store-iap/store-iap-distribute/store-iap-distribute-purchase)、[发放数字商品权益](/store-kit-guide/store-iap/store-iap-distribute/store-iap-distribute-delivering)的功能。
...
![](../../../../images/d7e17e45/zh-cn_image_0000002552958770.png)
...
当前自动续期订阅商品的续费周期可选值有1周、30天、31天、1个月、2个月、3个月、6个月和12个月，具体配置方法请参见[配置数字商品](/store-kit-guide/store-iap/store-iap-config-product/store-iap-product-agc)。
...
![](../../../../images/43c1cbd2/zh-cn_image_0000002583478771.png)
...
数字商品服务为接入订阅型商品购买能力的应用提供[跳转到订阅页或订阅详情页](/ref/iap-api/iap-arkts/iap-iap/iap-iap#iapshowmanagedsubscriptions)的能力，让用户管理订阅，包括查看订阅、取消订阅、切换订阅、恢复订阅等。

![](../../../../images/c3cbc857/zh-cn_image_0000002552799122.png)
...
![](../../../../images/e0058986/note_3.0-zh-cn.png) 
...
促销具体配置方法请参见[配置数字商品](/store-kit-guide/store-iap/store-iap-config-product/store-iap-product-agc)。
...
如果开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)申请支付服务时提前配置了通知接收地址，用户购买自动续期订阅商品后，数字商品服务器会在订阅场景的某些关键事件发生时调用此接口通知配置的服务器，具体请参见[服务端关键事件通知](/ref/iap-api/iap-rest/iap-key-event-notifications/iap-key-event-notifications)。主要涉及的场景如下：
