...
![](../../../images/d250232b/note_3.0-zh-cn.png) 
...
![](../../../images/8d690ee8/zh-cn_image_0000002583438839.png)
...
图标管理服务提供以下接口，具体API说明详见[接口文档](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager)。

| 接口名 | 描述 |
| --- | --- |
| [queryDynamicIcons](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerquerydynamicicons)(): Promise&lt;[DynamicIconInfo](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#dynamiciconinfo)[]&gt; | 查询动态图标信息接口，用于查询动态图标信息。 |
| [selectDynamicIcon](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerselectdynamicicon)(iconId: string): Promise&lt;void&gt; | 切换动态图标接口，用于切换动态图标。 |
| [disableDynamicIcon](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerdisabledynamicicon)(): Promise&lt;void&gt; | 禁用动态图标接口，用于停止动态图标，恢复默认图标。 |

![](../../../images/2758d1c0/note_3.0-zh-cn.png) 
...
1. 导入appInfoManager模块及相关公共模块。
   ...
   ```
2. 调用[queryDynamicIcons](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerquerydynamicicons)方法查询动态图标信息。
...
1. 导入appInfoManager模块及相关公共模块。
   ...
   import { BusinessError } from '@kit.BasicServicesKit';
   ```
2. 调用[selectDynamicIcon](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerselectdynamicicon)方法切换动态图标。
...
1. 导入appInfoManager模块及相关公共模块。
   ...
   import { BusinessError } from '@kit.BasicServicesKit';
   ```
2. 调用[disableDynamicIcon](/ref/store-api/store-arkts/appgallery-appinfomanager/appgallery-appinfomanager#appinfomanagerdisabledynamicicon)方法恢复默认图标。
