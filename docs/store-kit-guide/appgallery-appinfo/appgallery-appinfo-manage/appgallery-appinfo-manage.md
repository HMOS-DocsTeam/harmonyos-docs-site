...
![](../../../images/c24965b9/zh-cn_image_0000002583438837.png)

![](../../../images/c04d8133/note_3.0-zh-cn.png) 
...
1. 在图标管理页面点击“新增图标”按钮，进入创建图标页面。
   ...
   ![](../../../images/0ae193a6/zh-cn_image_0000002552958792.png)
2. 输入图标ID、图标名称，选择设备类型，上传图标文件，点击“保存”或者“提交”按钮，将图标保存为草稿状态或提交审核。

![](../../../images/58eb49bb/note_3.0-zh-cn.png) 
...
1. 在图标管理页面选择一个草稿或审核不通过的图标，点击“编辑”按钮，或选择一个审核通过的图标，点击“更新”按钮，进入图标编辑页面。
   ...
   ![](../../../images/de817c5b/zh-cn_image_0000002583478793.png)
2. 输入图标ID、图标名称，选择设备类型，上传图标文件，点击“保存”或者“提交”按钮，将图标保存为草稿状态或提交审核。

![](../../../images/b40378e5/note_3.0-zh-cn.png) 
...
1. 在图标管理页面选择一个图标，点击“删除”按钮，再点击提示框中的“确认”按钮，就可以删除指定图标。
   ...
   ![](../../../images/57603f48/zh-cn_image_0000002552799144.png)

![](../../../images/6c72f716/note_3.0-zh-cn.png) 
