...
![](../../../../images/25b89e47/caution_3.0-zh-cn.png) 
...
- ****生命周期和内存管理****：在使用Node-API处理ArrayBuffer时，需注意，void\*类型的buffer数据段生命周期由引擎管理，[不允许用户自己delete，否则会double free](/coding/using-napi-interaction-with-cpp/napi-guidelines#防止重复释放获取的buffer)。
