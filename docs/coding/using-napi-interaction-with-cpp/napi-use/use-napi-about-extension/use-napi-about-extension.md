...
[扩展能力](/coding/using-napi-interaction-with-cpp/napi-data-types-interfaces#扩展能力)接口进一步扩展了Node-API的功能，提供了一些额外的接口，用于在Node-API模块中与ArkTS进行更灵活的交互和定制，这些接口可以用于创建自定义ArkTS对象等场景。
...
| napi\_load\_module\_with\_info | 用于在Node-API中进行模块的加载，当模块加载出来之后，可以使用函数napi\_get\_property获取模块导出的变量，也可以使用napi\_get\_named\_property获取模块导出的函数，该函数可以在[新创建的ArkTS基础运行时环境](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-ark-runtime)中使用。 |
...
[使用Node-API接口在主线程中进行模块加载](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-load-module)

****napi\_load\_module\_with\_info****

[使用Node-API接口进行模块加载](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-load-module-with-info)
...
![](../../../../images/289b7ef3/caution_3.0-zh-cn.png) 
...
![](../../../../images/440ebc92/zh-cn_image_0000002583479371.png)
...
[使用扩展的Node-API接口在异步线程中运行和停止事件循环](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-event-loop)
...
[使用Node-API接口从异步线程向ArkTS线程投递指定优先级和入队方式的的任务](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-call-threadsafe-function-with-priority)
...
[使用扩展的Node-API接口创建、切换和销毁上下文环境](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-about-context)
...
[使用扩展的Node-API接口创建和销毁临界区作用域及访问字符串内容](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-about-critical)
...
[使用扩展的Node-API接口创建、销毁和使用强引用对象](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-about-strong-reference)
...
[使用扩展的Node-API接口创建、销毁和使用Sendable强引用](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-about-sendable-reference)
...
[使用扩展的Node-API接口抛出ArkTS异常](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-error)
