...
[生命周期管理](/coding/using-napi-interaction-with-cpp/napi-guidelines#生命周期管理)

关于典型错误使用方法的代码部分也可参考下面链接:

[典型错误场景](/coding/using-napi-interaction-with-cpp/napi-questions/napi-faq-about-stability#napi_open_handle_scope与napi_close_handle_scope进行生命周期相关开发典型错误场景)
...
![](../../../../images/5d415423/note_3.0-zh-cn.png) 
