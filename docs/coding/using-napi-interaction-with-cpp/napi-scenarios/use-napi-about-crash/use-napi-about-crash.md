...
以下维测手段多数依赖于ArkTS运行时的多线程检测能力，因此建议在调试前启用此功能。启用方法参考文档[分析CppCrash（进程崩溃）](/ide-log-and-fault-analysis/ide-fault-analysis/ide-multi-thread-check)。
...
![](../../../../images/3a0538c1/caution_3.0-zh-cn.png) 
...
![](../../../../images/36b7cd95/caution_3.0-zh-cn.png) 
