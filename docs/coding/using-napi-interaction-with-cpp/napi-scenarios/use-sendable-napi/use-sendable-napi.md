...
通过napi\_wrap\_sendable将[Sendable](/arkts/arkts-concurrency/interthread-communication/interthread-communication-object/sendable-object/arkts-sendable) ArkTS对象与Native的C++对象绑定，后续操作时再通过napi\_unwrap\_sendable将ArkTS对象绑定的C++对象取出，并对其进行操作。
