...
1. 排查是否存在多线程安全问题（概率较大）。
   ...
   ![](../../../../images/b9976c4d/zh-cn_image_0000002552799724.png)
...
上面提到，C++线程都是抛任务到ArkTS线程，进而执行ArkTS方法。关于线程安全，可参考[使用Node-API接口进行线程安全开发](/coding/using-napi-interaction-with-cpp/napi-scenarios/use-napi-thread-safety)。
...
- 可参考文档：
  ...
  [napi\_create\_reference、napi\_delete\_reference](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-life-cycle)
...
[使用Node-API接口注册和使用环境清理钩子](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-cleanuphook)
...
[使用Node-API接口进行生命周期相关开发](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-life-cycle#napi_open_handle_scopenapi_close_handle_scope)。
