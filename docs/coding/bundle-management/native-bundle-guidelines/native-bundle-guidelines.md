...
常用接口如下表所示，具体API说明详见[Native\_Bundle](/ref/ability-api/ability-c/ability-module/capi-native-bundle/capi-native-bundle)。

| 接口名 | 描述 |
| --- | --- |
| [OH\_NativeBundle\_GetCurrentApplicationInfo](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getcurrentapplicationinfo) | 获取应用自身相关信息。 |
| [OH\_NativeBundle\_GetAppId](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getappid) | 获取自身应用的appId信息。 |
| [OH\_NativeBundle\_GetAppIdentifier](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getappidentifier) | 获取自身应用的appIdentifier信息。 |
| [OH\_NativeBundle\_GetMainElementName](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getmainelementname) | 获取自身应用入口的信息。 |
| [OH\_NativeBundle\_GetCompatibleDeviceType](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getcompatibledevicetype) | 获取自身应用适用的设备类型。 |
| [OH\_NativeBundle\_IsDebugMode](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_isdebugmode) | 查询当前应用的调试模式。从API version 20开始支持。 |
| [OH\_NativeBundle\_GetModuleMetadata](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getmodulemetadata) | 获取当前应用的元数据信息。从API version 20开始支持。 |
| [OH\_NativeBundle\_GetAbilityResourceInfo](/ref/ability-api/ability-c/ability-headerfile/capi-native-interface-bundle-h/capi-native-interface-bundle-h#oh_nativebundle_getabilityresourceinfo) | 获取支持打开特定文件类型的组件资源信息列表。从API version 21开始支持。 |

## 开发步骤

****1. 创建工程****

![](../../../images/27372c4f/zh-cn_image_0000002552799738.png)
...
关于包管理NDK接口说明，可参考[Native\_Bundle模块介绍](/ref/ability-api/ability-c/ability-module/capi-native-bundle/capi-native-bundle)。
