...
64后缀相关接口属于新增接口，新接口支持打开更大的rawfile文件(超过2G建议使用)，具体请参考：[Rawfile接口介绍](/ref/localization-api/localization-c/localization-module/capi-rawfile/capi-rawfile)。64相关的开发步骤和非64一致，将非64接口替换为64接口即可，例如：OH\_ResourceManager\_OpenRawFile替换为OH\_ResourceManager\_OpenRawFile64。
...
详细的接口说明请参考[rawfile](/ref/localization-api/localization-c/localization-module/capi-rawfile/capi-rawfile)。
...
![](../../../images/b58bcbe2/zh-cn_image_0000002552799738.png)
...
2. 资源获取包括获取本应用包资源、应用内跨包资源、跨应用包资源。
   ...
   Context的更多使用信息请参考[应用上下文Context](/ability-kit/stage-model-development/stage-model-application-components/application-context-stage)。
