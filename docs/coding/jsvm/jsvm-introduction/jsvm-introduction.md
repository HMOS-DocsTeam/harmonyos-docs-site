...
![](../../../images/3d00a054/caution_3.0-zh-cn.png) 

JSVM-API仅支持JS与C/C++的交互，如果需要实现ArkTS与C/C++的交互，请参考[Node-API简介](/coding/using-napi-interaction-with-cpp/napi-introduction)

## JSVM-API的组成架构

****图1**** JSVM-API的组成架构

![](../../../images/bb20e055/zh-cn_image_0000002583439419.png)
...
![](../../../images/7cb798a6/zh-cn_image_0000002552959374.png)
