...
其中使用到的JSVM-API可以参考 [JSVM数据类型与接口说明](/coding/jsvm/jsvm-data-types-interfaces)，这里仅展示调用的步骤。

外层跨语言交互的部分可以参考 [使用JSVM-API实现JS与C/C++语言交互开发流程](/coding/jsvm/use-jsvm-process)。
