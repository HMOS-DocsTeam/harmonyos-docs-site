...
JSVM，即标准JS引擎，是严格遵守ECMAScript规范的JavaScript代码执行引擎。详情参考：[JSVM](/ref/common-basic-c/common-basic-module/capi-jsvm/capi-jsvm)。
...
JSVM-API接口开发流程参考[使用JSVM-API实现JS与C/C++语言交互开发流程](/coding/jsvm/use-jsvm-process)，本文仅对接口对应C++相关代码进行展示。
...
1. Chrome浏览器中打开 chrome://inspect/#devices，勾选以下内容：
   ...
   ![](../../../../images/ef03f134/zh-cn_image_0000002552799726.png)
...
3. 点击Port forwarding按钮，左侧输入开发者个人计算机侧端口，右侧输入端侧端口号，点击done。如下图所示：
   ...
   ![](../../../../images/a8a253b5/zh-cn_image_0000002583439421.png)
4. 点击Configure按钮，输入开发者个人计算机侧的端口号，如localhost:9227。如下图所示：

   ![](../../../../images/596efc11/zh-cn_image_0000002552959376.png)
5. 稍等片刻，会在target下出现调试的内容，点击inspect即可调试。如下图所示：

   ![](../../../../images/1b7ed6a2/zh-cn_image_0000002583479377.png)
