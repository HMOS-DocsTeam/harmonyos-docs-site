...
具体见[创建NDK工程](/create-with-ndk)

## Native侧方法的实现

参考[使用Node-API实现跨语言交互开发流程](/coding/using-napi-interaction-with-cpp/use-napi-process#native侧方法的实现)，以下代码提供了“使用JSVM-API实现JS与C/C++语言交互开发流程”Native侧方法实现的一个demo。
