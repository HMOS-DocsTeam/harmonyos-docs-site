...
![](../../../../../images/2596da50/note_3.0-zh-cn.png) 

- 针对数组内的数据修改，请使用splice方法生效数据绑定变更。
- hml文件中的js表达式不支持ES6语法。

![](../../../../../images/976e921e/zh-cn_image_0000002583438121.png)
...
![](../../../../../images/5c0752da/zh-cn_image_0000002552958076.gif)
...
- 绑定并阻止冒泡事件向上冒泡：grab:\{event\}.bubble。grab:\{event\}等价于grab:\{event\}.bubble。
  ...
  ![](../../../../../images/ca4cca59/note_3.0-zh-cn.png) 
  ...
  详细冒泡事件说明参见[通用事件](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-events/js-components-common-events)章节。
- 示例
...
![](../../../../../images/0e86f752/note_3.0-zh-cn.png) 
...
![](../../../../../images/cf68ff6e/zh-cn_image_0000002552798428.gif)
...
![](../../../../../images/b674a79d/note_3.0-zh-cn.png) 

禁止在同一个元素上同时设置for和if属性。

![](../../../../../images/60c0ccad/zh-cn_image_0000002583438123.gif)
...
![](../../../../../images/b379978d/zh-cn_image_0000002552958078.png)

## 模板引用

HML可以通过element引用模板文件，详细介绍可参考[自定义组件的基本用法](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-custom-comp/js-components-custom-basic-usage/js-components-custom-basic-usage)章节。
