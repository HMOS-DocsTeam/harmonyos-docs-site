...
使用OffscreenCanvas在离屏Canvas画布组件上进行绘制，绘制对象可以是矩形、文本、图片等。 离屏，即GPU在当前缓冲区以外新开辟的一个缓冲区。具体请参考[OffscreenCanvasRenderingContext2D对象](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-canvas-comp/js-offscreencanvasrenderingcontext2d/js-offscreencanvasrenderingcontext2d)。
...
![](../../../../../images/039eea73/zh-cn_image_0000002552958136.gif)
...
![](../../../../../images/cfc8e366/zh-cn_image_0000002583478137.gif)
