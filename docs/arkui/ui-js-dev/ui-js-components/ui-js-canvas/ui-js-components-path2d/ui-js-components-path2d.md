...
路径对象，支持通过对象的接口进行路径的描述，并通过Canvas的[stroke](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d#stroke-1)接口进行绘制。具体请参考[Path2D对象](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-canvas-comp/js-components-canvas-path2d/js-components-canvas-path2d)。
...
![](../../../../../images/bee2a463/zh-cn_image_0000002552798486.png)
...
![](../../../../../images/c7c38d19/zh-cn_image_0000002583438181.gif)
