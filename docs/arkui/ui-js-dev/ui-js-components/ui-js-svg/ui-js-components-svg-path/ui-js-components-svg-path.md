...
[svg](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-svg-comp/js-components-svg/js-components-svg)组件绘制路径时，通过Path中的M（起点）、H（水平线）、a（绘制弧形到指定位置）路径控制指令，并填充颜色实现饼状图效果。
...
![](../../../../../images/3605d557/zh-cn_image_0000002583478141.png)

![](../../../../../images/c0dfcb4f/note_3.0-zh-cn.png) 
