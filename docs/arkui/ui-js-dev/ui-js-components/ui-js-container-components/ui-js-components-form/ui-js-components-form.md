...
form是一个表单容器，支持容器内[Input](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-input/js-components-basic-input)组件内容的提交和重置。具体用法请参考[form API](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-container-comp/js-components-container-form/js-components-container-form)。
...
![](../../../../../images/d7c58a93/zh-cn_image_0000002552798440.png)

## 实现表单缩放

为form组件添加click-effect属性，实现点击表单后的缩放效果，click-effect枚举值请参考[通用属性](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-universal-comp-inform/js-components-common-attributes/js-components-common-attributes)。
...
![](../../../../../images/5db51d00/zh-cn_image_0000002583438135.gif)
...
![](../../../../../images/7e58c038/zh-cn_image_0000002552958090.gif)

## 场景示例

在本场景中，开发者可以选择相应选项并提交或重置数据。

创建[Input](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-input/js-components-basic-input)组件，分别设置type属性为checkbox（多选框）和radio（单选框），再使用form组件的onsubmit和onreset事件实现表单数据的提交与重置。
...
![](../../../../../images/2a373986/zh-cn_image_0000002583478091.gif)
