...
栅格布局容器根节点，使用grid-row与grid-col进行栅格布局。API具体描述请参考[grid-container](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-grid-comp/js-components-grid-container/js-components-grid-container)。

## 创建grid-container组件

在pages/index目录下的hml文件中创建一个grid-container组件，并添加[grid-row](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-grid-comp/js-components-grid-row/js-components-grid-row)子组件。
...
![](../../../../images/521194bb/zh-cn_image_0000002552798488.png)

![](../../../../images/d52bb6c2/note_3.0-zh-cn.png) 
...
![](../../../../images/8715ba80/zh-cn_image_0000002583438183.gif)

## 添加grid-col

创建grid-container组件并添加grid-row，在grid-row组件内添加[grid-col](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-grid-comp/js-components-grid-col/js-components-grid-col)组件形成布局。
...
![](../../../../images/944907b9/zh-cn_image_0000002552958138.png)

![](../../../../images/57fb59c0/note_3.0-zh-cn.png) 
...
![](../../../../images/e68c027f/zh-cn_image_0000002583478139.gif)
