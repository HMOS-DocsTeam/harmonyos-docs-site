...
text是文本组件，用于呈现一段文本信息。具体用法请参考[text](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-text/js-components-basic-text)的API文档。
...
![](../../../../../images/0a005a4d/zh-cn_image_0000002552958098.png)
...
- 添加文本样式
  ...
  ![](../../../../../images/20d7d916/zh-cn_image_0000002583478099.png)
- 添加划线
  ...
  ![](../../../../../images/c3c28365/zh-cn_image_0000002552798450.png)
- 隐藏文本内容
  ...
  ![](../../../../../images/8d72a9ad/note_3.0-zh-cn.png) 

  - text-overflow样式需配合max-lines样式使用，在设置了最大行数的情况下才会生效。
  - max-lines属性设置文本最多可以展示的行数。

  ​ ![](../../../../../images/3b7800e6/zh-cn_image_0000002583438145.png)
- text组件支持[span](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-span/js-components-basic-span)子组件
  ...
  ![](../../../../../images/437fc95b/zh-cn_image_0000002552958100.png)

  ![](../../../../../images/f0805152/note_3.0-zh-cn.png) 
...
![](../../../../../images/331ae5df/zh-cn_image_0000002583478101.gif)
