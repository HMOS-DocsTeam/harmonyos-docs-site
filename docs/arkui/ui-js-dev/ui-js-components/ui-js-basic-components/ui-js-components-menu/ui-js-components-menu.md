...
提供菜单组件，作为临时性弹出窗口，用于展示用户可执行的操作，具体用法请参考[menu](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-menu/js-components-basic-menu)。
...
![](../../../../../images/6aa1cecb/zh-cn_image_0000002583478123.png)

![](../../../../../images/3712059b/note_3.0-zh-cn.png) 

- menu仅支持[option](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-basic-comp/js-components-basic-option/js-components-basic-option)子组件。
...
![](../../../../../images/d3e52dde/zh-cn_image_0000002552798474.png)
...
![](../../../../../images/43a015b6/zh-cn_image_0000002583438169.gif)
