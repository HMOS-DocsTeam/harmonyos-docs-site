...
在svg的子组件[animate](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-svg-comp/js-components-svg-animate/js-components-svg-animate)中，通过attributeName设置需要进行动效的属性，from设置开始值，to设置结束值。
...
![](../../../../../images/e6b8edf9/zh-cn_image_0000002552958146.gif)

![](../../../../../images/dba7d08b/note_3.0-zh-cn.png) 

在设置动画变化值时，如果已经设置了values属性，则from和to都失效。

## 路径动画

在svg的子组件[animateMotion](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-svg-comp/js-components-svg-animatemotion/js-components-svg-animatemotion)中，通过path设置动画变化的路径。
...
![](../../../../../images/3956eea0/zh-cn_image_0000002583478147.gif)

## animateTransform动画

在svg的子组件[animateTransform](/ref/arkui-api/arkui-js-comp/arkui-js-full-comp/js-full-svg-comp/js-components-svg-animatetransform/js-components-svg-animatetransform)中，通过attributeName绑定transform属性，type设置动画类型，from设置开始值，to设置结束值。
...
![](../../../../../images/d13cca77/zh-cn_image_0000002552798498.gif)
