...
![](../../../../../../images/dbc211a0/zh-cn_image_0000002552798500.gif)

![](../../../../../../images/62c883d4/note_3.0-zh-cn.png) 
...
animator支持事件和接口，可以通过添加frame、cancel、repeat、finish事件和调用update、play、pause、cancel、reverse、finish接口自定义动画效果。animator支持的事件和接口具体见动画中的[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)。
...
![](../../../../../../images/32baa299/zh-cn_image_0000002583438195.gif)

![](../../../../../../images/c7224e85/note_3.0-zh-cn.png) 

在调用[reset](/ref/arkui-api/arkui-arkts/ui/js-apis-animator/js-apis-animator#reset9)接口的过程中可以使用这个接口更新动画参数，入参与[createAnimator](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#createanimator)一致。
