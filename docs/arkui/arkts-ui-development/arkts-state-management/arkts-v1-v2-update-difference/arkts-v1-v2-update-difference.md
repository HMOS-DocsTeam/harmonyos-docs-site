...
V1的@Watch和V2的@Monitor详细差异参考[@Watch与@Monitor的对比](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v2/arkts-v2-manage-data-object-state/arkts-new-monitor#monitor与watch对比)。下面通过例子介绍两者差异。
...
![](../../../../images/cad57730/zh-cn_image_0000002552797942.png)
...
步骤1：事件触发修改V2状态变量， 抛[Promise](/arkts/arkts-concurrency/async-concurrency-overview#promise)异步任务；
