...
为了获取状态管理框架代理前的原始对象，开发者可以使用[getTarget接口](/ref/arkui-api/arkui-arkts/ui/js-apis-statemanagement/js-apis-statemanagement#gettarget)。

在阅读本文档前，建议提前阅读：[@Observed](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-component-state-management/arkts-observed-and-objectlink)、[@ObservedV2](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v2/arkts-v2-manage-data-object-state/arkts-new-observedv2-and-trace)。

![](../../../../../images/ed1a2048/note_3.0-zh-cn.png) 
...
- 使用getTarget接口需要导入UIUtils工具。
  ...
  ```
- 状态管理V1中，会给@Observed装饰的类对象以及使用状态变量装饰器如[@State](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-component-state-management/arkts-state)装饰的class、Date、Map、Set、Array添加一层代理用于观测一层属性或API调用产生的变化。
- 状态管理V2中，会给使用状态变量装饰器如[@Trace](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v2/arkts-v2-manage-data-object-state/arkts-new-observedv2-and-trace)、[@Local](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v2/arkts-v2-manage-component-state/arkts-new-local)装饰的Date、Map、Set、Array添加一层代理用于观测API调用产生的变化。
...
【2】状态变量装饰器装饰的复杂类型对象。使用@State、[@Prop](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-v1/arkts-v1-component-state-management/arkts-prop)等状态变量装饰器装饰Class、Map、Set、Date、Array时，会添加代理。若该对象已经是代理对象，则不会重复创建代理。
...
| 影响接口名 | 影响结果 |
| --- | --- |
| [napi\_get\_property\_names](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_get_property_names) | 返回值为"\_\_ob\_name"，"\_\_ob\_age"。 |
| [napi\_set\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_set_property) | 使用"name"，"\_\_ob\_name"均能赋值成功。 |
| [napi\_get\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_get_property) | 使用"name"，"\_\_ob\_name"均能获取到值。 |
| [napi\_has\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_has_property) | 使用"name"，"\_\_ob\_name"均返回true。 |
| [napi\_delete\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_delete_property) | 删除属性时需要加上"\_\_ob\_"前缀才能删除成功。 |
| [napi\_has\_own\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_has_own_property) | 使用"name"，"\_\_ob\_name"均返回true。 |
| [napi\_set\_named\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_set_named_property) | 使用"name"，"\_\_ob\_name"均能赋值成功。 |
| [napi\_get\_named\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_get_named_property) | 使用"name"，"\_\_ob\_name"均能获取到值。 |
| [napi\_has\_named\_property](/coding/using-napi-interaction-with-cpp/napi-use/use-napi-about-property#napi_has_named_property) | 使用"name"，"\_\_ob\_name"均返回true。 |
