...
在阅读本文档前，需要开发者对状态管理框架有基本的了解。建议提前阅读：[状态管理概述](/arkui/arkts-ui-development/arkts-state-management/arkts-state-management-overview)。

LocalStorage还提供了API接口，可以让开发者通过接口在自定义组件外手动触发Storage对应key的增删改查，建议配合[LocalStorage API文档](/ref/arkui-api/arkui-declarative-comp/state-management-and-rendering-control/ts-state-management/ts-state-management#localstorage9)阅读。最佳实践请参考[状态管理最佳实践](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-status-management)。

![](../../../../../../images/7d6b1ff4/note_3.0-zh-cn.png) 
...
- 应用程序可以创建多个LocalStorage实例，LocalStorage实例可以在页面内共享，也可以通过[getSharedLocalStorage](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getsharedlocalstorage12)接口，实现跨页面、跨[UIAbility](/ability-kit/stage-model-development/stage-model-application-components/uiability/uiability-overview)实例共享。
- 组件树的根节点，即被[@Entry](/ref/arkui-api/arkui-declarative-comp/custom-comp/arkts-extend-component-decorator/ts-universal-entry/ts-universal-entry#entry)装饰的[@Component](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-create-custom-components#component)，可以被分配一个LocalStorage实例，此组件的所有子组件实例将自动获得对该LocalStorage实例的访问权限。
...
![](../../../../../../images/11648171/note_3.0-zh-cn.png) 
...
![](../../../../../../images/956298be/zh-cn_image_0000002583437655.png)
...
![](../../../../../../images/68e028a5/zh-cn_image_0000002552957610.png)

****图2**** LocalStorage与@LocalStorageProp数据同步图示

## @LocalStorageLink

![](../../../../../../images/3d59bc6d/note_3.0-zh-cn.png) 
...
![](../../../../../../images/885a741c/zh-cn_image_0000002583477611.png)
...
![](../../../../../../images/f55865c0/zh-cn_image_0000002552797962.png)
...
4. LocalStorage是页面级存储，[getSharedLocalStorage](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getsharedlocalstorage12)接口仅能获取当前Stage通过[windowStage.loadContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#loadcontent9)传入的LocalStorage实例，否则返回undefined。例子可见[将LocalStorage实例从UIAbility共享到一个或多个页面](#将localstorage实例从uiability共享到一个或多个页面)。
...
上面的实例中，LocalStorage的实例仅仅在一个@Entry装饰的组件和其所属的子组件（一个页面）中共享，如果希望其在多个页面中共享，可以在所属UIAbility中创建LocalStorage实例，并调用windowStage.[loadContent](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#loadcontent9)。
...
![](../../../../../../images/58cd027f/note_3.0-zh-cn.png) 
...
![](../../../../../../images/d21ce6c0/note_3.0-zh-cn.png) 
...
![](../../../../../../images/07e63744/note_3.0-zh-cn.png) 
...
可以通过传递不同的LocalStorage实例给自定义组件，从而实现在[Navigation](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation)跳转到不同的页面时，绑定不同的LocalStorage实例，显示对应绑定的值。
...
![](../../../../../../images/c062ad04/note_3.0-zh-cn.png) 
...
![](../../../../../../images/99100b0d/note_3.0-zh-cn.png) 
...
![](../../../../../../images/bdb1b4bf/note_3.0-zh-cn.png) 
