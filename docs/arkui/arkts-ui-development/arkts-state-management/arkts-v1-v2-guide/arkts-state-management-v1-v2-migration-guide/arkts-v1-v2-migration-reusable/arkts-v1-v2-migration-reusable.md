...
| V1装饰器名称 | V2装饰器名称 |
| --- | --- |
| [@Reusable](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable) | [@ReusableV2](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-new-reusablev2) |
...
- 涉及组件内状态变量的迁移可参考[组件内状态变量迁移指导](/arkui/arkts-ui-development/arkts-state-management/arkts-v1-v2-guide/arkts-state-management-v1-v2-migration-guide/arkts-v1-v2-migration-inner-component)。

### aboutToRecycle与aboutToReuse迁移

****迁移规则****

- [aboutToRecycle](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-lifecycle/ts-custom-component-lifecycle#abouttorecycle10)生命周期无需改动，可保留原实现。
- [aboutToReuse](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-lifecycle/ts-custom-component-lifecycle#abouttoreuse18)生命周期在组件复用V2中进行了优化，去除了参数的同时，在复用前会自动重置各状态变量（详情参考[复用前的组件内状态变量重置](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-new-reusablev2#复用前的组件内状态变量重置)），无需开发者在aboutToReuse中手动赋值回初始值。
...
在组件复用V1中，使用[reuseId](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/other-property/ts-universal-attributes-reuse-id/ts-universal-attributes-reuse-id#reuseid)属性标记组件的复用组。迁移到组件复用V2后，需更换使用[reuse](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/other-property/ts-universal-attributes-reuse/ts-universal-attributes-reuse#reuse)属性。
...
组件复用V1中，当开发者打开复用组件的冻结开关freezeWhenInactive时，才会冻结复用池中的组件，详细规则参考[自定义组件冻结功能](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-freeze/arkts-custom-components-freeze)。而在组件复用V2中，会自动开启冻结，详细规则参考[复用阶段的冻结](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-new-reusablev2#复用阶段的冻结)。

### LazyForEach->Repeat

****迁移规则****

组件复用V1中，经常使用LazyForEach配合组件复用实现高性能懒加载。在组件复用V2中，推荐使用[Repeat](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat)替代[LazyForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-lazyforeach)。Repeat自身能够对组件进行复用，相比LazyForEach具有更简洁的API以及更好的性能。由LazyForEach迁移至Repeat可参考[LazyForEach迁移Repeat](/arkui/arkts-ui-development/arkts-state-management/arkts-v1-v2-guide/arkts-state-management-v1-v2-migration-guide/arkts-v1-v2-migration-rendering-control-repeat#lazyforeach迁移repeat)。

## @Reusable->@ReusableV2迁移示例

### if使用场景

@Reusable使用示例请参考[动态布局更新](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#动态布局更新)。
...
![](../../../../../../images/4cd948b2/zh-cn_image_0000002552797974.gif)

### 列表滚动-Repeat使用场景

@Reusable使用示例请参考[列表滚动配合LazyForEach使用](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#列表滚动配合lazyforeach使用)。
...
![](../../../../../../images/2be51cf5/zh-cn_image_0000002583437669.gif)

### 列表滚动-if使用场景

@Reusable使用示例请参考[列表滚动-if使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#列表滚动-if使用场景)。
...
![](../../../../../../images/26612fa3/zh-cn_image_0000002552957624.gif)

### 列表滚动-Repeat全量加载使用场景

状态管理V2推荐使用[Repeat全量加载模式](/arkui/arkts-ui-development/arkts-rendering-control/arkts-new-rendering-control-repeat#懒加载能力说明)替代[ForEach](/arkui/arkts-ui-development/arkts-rendering-control/arkts-rendering-control-foreach)实现循环渲染。

@Reusable使用示例请参考[列表滚动-ForEach使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#列表滚动-foreach使用场景)。
...
![](../../../../../../images/0c83e1ce/zh-cn_image_0000002583477625.gif)

### Grid使用场景

@Reusable使用示例请参考[Grid使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#grid使用场景)。
...
![](../../../../../../images/1ee27792/zh-cn_image_0000002552797976.png)

### WaterFlow使用场景

@Reusable使用示例请参考[WaterFlow使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#waterflow使用场景)。
...
![](../../../../../../images/892123b8/zh-cn_image_0000002583437671.gif)

### Swiper使用场景

@Reusable使用示例请参考[Swiper使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#swiper使用场景)。
...
![](../../../../../../images/06b20905/zh-cn_image_0000002552957626.gif)

### 列表滚动-ListItemGroup使用场景

@Reusable使用示例请参考[列表滚动-ListItemGroup使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#列表滚动-listitemgroup使用场景)。
...
![](../../../../../../images/e82c022f/zh-cn_image_0000002583477627.gif)

### 多种条目类型使用场景

@Reusable使用示例请参考[多种条目类型使用场景](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-custom-components/arkts-component-reusable/arkts-reusable#多种条目类型使用场景)。
...
![](../../../../../../images/16db6395/zh-cn_image_0000002552797978.png)

****组合型****

复用组件间存在多种差异，但通常具备共同的子组件。将三种复用组件以组合型方式转换为[@Builder](/arkui/arkts-ui-development/arkts-ui-paradigm-basic-syntax/arkts-extend-components/arkts-builder)函数后，内部的共享子组件将统一置于父组件MyComponentV2之下。复用这些子组件时，缓存池在父组件层面实现共享，减少组件创建过程中的资源消耗。
...
![](../../../../../../images/99f62d17/zh-cn_image_0000002583437673.png)
