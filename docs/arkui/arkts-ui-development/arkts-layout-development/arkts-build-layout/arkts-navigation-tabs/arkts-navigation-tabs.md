...
当页面信息较多时，为了让用户能够聚焦于当前显示的内容，需要对页面内容进行分类，提高页面空间利用率。[Tabs](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs)组件可以在一个页面内快速实现视图内容的切换，一方面提升查找信息的效率，另一方面精简用户单次获取到的信息量。

## 基本布局

Tabs组件的页面组成包含两个部分，分别是[TabContent](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabcontent/ts-container-tabcontent)和[TabBar](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabcontent/ts-container-tabcontent#tabbar)。TabContent是内容页，TabBar是导航页签栏，页面结构如下图所示，根据不同的导航类型，布局会有区别，可以分为底部导航、顶部导航、侧边导航，其导航栏分别位于底部、顶部和侧边。

****图1**** Tabs组件布局示意图

![](../../../../../images/4de5ec82/zh-cn_image_0000002583477747.png)

![](../../../../../images/db46bbfb/note_3.0-zh-cn.png) 
...
![](../../../../../images/1fc7a3c2/zh-cn_image_0000002552798098.png)
...
![](../../../../../images/4da46366/zh-cn_image_0000002583437793.gif)
...
底部导航栏可通过设置TabContent的[BottomTabBarStyle](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabcontent/ts-container-tabcontent#bottomtabbarstyle9)来实现底部页签样式，详细示例请参考：[示例9（设置底部页签使用symbol图标）](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabcontent/ts-container-tabcontent#示例9设置底部页签使用symbol图标)。
...
![](../../../../../images/b4e8a5a1/zh-cn_image_0000002552957748.gif)
...
![](../../../../../images/633aee78/zh-cn_image_0000002583477749.png)

实现侧边导航栏需要将Tabs的[vertical](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#vertical)属性设置为true，vertical默认值为false，表明内容页和导航栏垂直方向排列。
...
![](../../../../../images/c88c8bef/note_3.0-zh-cn.png) 

- vertical为false时，tabbar的宽度默认为撑满屏幕的宽度，需要设置[barWidth](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#barwidth)为合适值。
- vertical为true时，tabbar的高度默认为实际内容的高度，需要设置[barHeight](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#barheight)为合适值。
...
![](../../../../../images/28286348/zh-cn_image_0000002552798100.gif)
...
![](../../../../../images/5cfeba7d/zh-cn_image_0000002583437795.gif)

Tabs的[barMode](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#barmode10)属性用于控制导航栏是否可以滚动，默认值为BarMode.Fixed。
...
![](../../../../../images/b0a969ab/zh-cn_image_0000002552957750.gif)
...
![](../../../../../images/6537c44d/zh-cn_image_0000002583477751.png)
...
![](../../../../../images/34cc7bd2/zh-cn_image_0000002552798102.gif)

从API version 18开始，支持使用Tabs提供的[onSelected](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#onselected18)事件方法，监听索引index的变化，并将选中元素的index值传递给selectIndex，实现页签的切换。
...
![](../../../../../images/f1505464/zh-cn_image_0000002583437797.gif)

若希望不滑动内容页和点击页签也能实现内容页和页签的切换，可以将currentIndex传给Tabs的index参数，通过改变currentIndex来实现跳转至指定索引值对应的TabContent内容。也可以使用[TabsController](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#tabscontroller)，TabsController是Tabs组件的控制器，用于控制Tabs组件进行内容页切换。通过TabsController的changeIndex方法来实现跳转至指定索引值对应的TabContent内容。
...
![](../../../../../images/56e81a7f/zh-cn_image_0000002552957752.gif)

开发者可以通过Tabs组件的[onContentWillChange](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#oncontentwillchange12)接口，设置自定义拦截回调函数。拦截回调函数在下一个页面即将展示时被调用，如果回调返回true，新页面可以展示；如果回调返回false，新页面不会展示，仍显示原来页面。
...
![](../../../../../images/5d44a450/zh-cn_image_0000002583477753.gif)
...
![](../../../../../images/b8d14f6e/note_3.0-zh-cn.png) 

弹窗只适用于底部页签BottomTabBarStyle。

****图14**** 在适老化场景下通过长按底部页签显示适老化弹窗。

![](../../../../../images/d4c0dcc5/zh-cn_image_0000002552798104.gif)
...
从API version 19开始，开发者可以通过[cachedMaxCount](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#cachedmaxcount19)接口，设置子组件的最大缓存个数和缓存模式。默认情况下Tabs创建时会一次性预加载所有TabContent，而且已加载的页面不会释放，可能会带来性能内存问题。此时可以设置[cachedMaxCount](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#cachedmaxcount19)属性控制缓存的页面数量，设置此属性后不会进行页面预加载，使用懒加载机制(仅切换到页面时才加载)，当切换页面时根据所设置的[TabsCacheMode](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-container-tabs/ts-container-tabs#tabscachemode19枚举说明)决定保留缓存或者释放页面。

![](../../../../../images/5b093b8b/note_3.0-zh-cn.png) 
...
![](../../../../../images/54c5a85d/zh-cn_image_0000002583437799.gif)
...
1. 如图16所示，使用默认翻页动画，CACHE\_BOTH\_SIDE模式，n设置为2，点击TabBar切换到yellow页，TabContent1~3被缓存。再切换到red页，TabContent1、2释放，TabContent3~5被缓存。
   ...
   ****图16**** 默认翻页动画，CACHE\_BOTH\_SIDE模式示意图
   ...
   ![](../../../../../images/ec6dee85/zh-cn_image_0000002552957754.png)
2. 如图17所示，使用默认翻页动画，CACHE\_LATEST\_SWITCHED模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存，TabContent2释放。再切换到red页，TabContent1、3、5被缓存，TabContent4释放。
   ...
   ****图17**** 默认翻页动画，CACHE\_LATEST\_SWITCHED模式示意图
   ...
   ![](../../../../../images/e1a77f0d/zh-cn_image_0000002583477755.png)
3. 如图18所示，关闭翻页动画，CACHE\_BOTH\_SIDE模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存。再切换到red页，TabContent3、5被缓存，TabContent1释放。
   ...
   ****图18**** 关闭翻页动画，CACHE\_BOTH\_SIDE模式示意图
   ...
   ![](../../../../../images/a479ba74/zh-cn_image_0000002552798106.png)
4. 如图19所示，关闭翻页动画，CACHE\_LATEST\_SWITCHED模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存。再切换到red页，TabContent1、3、5被缓存。
   ...
   ****图19**** 关闭翻页动画，CACHE\_LATEST\_SWITCHED模式示意图
   ...
   ![](../../../../../images/3cbcbe26/zh-cn_image_0000002583437801.png)
