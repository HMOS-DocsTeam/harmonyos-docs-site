...
![](../../../../../images/5afa2e65/note_3.0-zh-cn.png) 

多态样式仅支持通用属性。如果多态样式不生效，则该属性可能为组件的私有属性，例如：[fontColor](/ref/arkui-api/arkui-declarative-comp/buttons-and-selections/ts-basic-components-button/ts-basic-components-button#fontcolor)、[TextInput](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput)组件的[backgroundColor](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-background/ts-universal-attributes-background#backgroundcolor)等。此时，可以通过[attributeModifier](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/attribute-modifier-property/ts-universal-attributes-attribute-modifier/ts-universal-attributes-attribute-modifier#attributemodifier)动态设置组件属性来解决此问题。
...
![](../../../../../images/ee4e2aa7/note_3.0-zh-cn.png) 
...
![](../../../../../images/39203cc7/zh-cn_image_0000002583477585.gif)
...
![](../../../../../images/5aefa0a2/zh-cn_image_0000002552797936.gif)
...
![](../../../../../images/f91dd218/zh-cn_image_0000002583437631.gif)
