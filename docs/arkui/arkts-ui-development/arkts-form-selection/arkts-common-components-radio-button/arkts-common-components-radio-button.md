...
Radio是单选框组件，通常用于提供相应的用户交互选择项，同一组的Radio中只有一个可以被选中。具体用法请参考[Radio](/ref/arkui-api/arkui-declarative-comp/buttons-and-selections/ts-basic-components-radio/ts-basic-components-radio)。

## 创建单选框

Radio通过调用[RadioOptions](/ref/arkui-api/arkui-declarative-comp/buttons-and-selections/ts-basic-components-radio/ts-basic-components-radio#radiooptions对象说明)来创建，以RadioOptions中的value和group为例：
...
![](../../../../images/76703ab1/zh-cn_image_0000002583437929.png)

## 添加事件

除支持[通用事件](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/ts-component-general-events)外，Radio还用于选中后触发某些操作，可以绑定onChange事件来响应选中操作后的自定义行为。
...
![](../../../../images/fa2e533c/zh-cn_image_0000002552957884.gif)
