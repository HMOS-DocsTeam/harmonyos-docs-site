...
单击作为常用的手势，可以方便地使用[onClick](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click#onclick)接口实现。尽管被称为事件，它实际上是基本手势类型，等同于将count配置为1的TapGesture，即单击手势。
...
点击手势支持单次点击和多次点击，参数定义参考[TapGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-tapgesture/ts-basic-gestures-tapgesture)。
...
![](../../../../../images/733f098f/zh-cn_image_0000002583477957.gif)
...
长按手势用于触发长按手势事件，参数定义参考[LongPressGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-longpressgesture/ts-basic-gestures-longpressgesture)。
...
![](../../../../../images/802fa0d0/zh-cn_image_0000002552798308.gif)
...
滑动手势用于触发滑动手势事件，滑动达到最小滑动距离（默认值为5vp）时滑动手势识别成功，参数定义参考[PanGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-pangesture/ts-basic-gestures-pangesture)。
...
![](../../../../../images/2a1aaba8/zh-cn_image_0000002583438003.gif)

![](../../../../../images/cefc38aa/note_3.0-zh-cn.png) 
...
捏合手势用于触发捏合手势事件，参数定义参考[PinchGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-pinchgesture/ts-basic-gestures-pinchgesture)。
...
![](../../../../../images/44e1f516/zh-cn_image_0000002552957958.png)
...
旋转手势用于触发旋转手势事件，参数定义参考[RotationGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-rotationgesture/ts-basic-gestures-rotationgesture)。
...
![](../../../../../images/b2d5772d/zh-cn_image_0000002583477959.png)
...
快滑手势用于触发快滑事件，当滑动速度大于100vp/s时可以识别成功，参数定义参考[SwipeGesture](/ref/arkui-api/arkui-declarative-comp/gesture-handling/basic-gestures/ts-basic-gestures-swipegesture/ts-basic-gestures-swipegesture)。
...
![](../../../../../images/64b63196/zh-cn_image_0000002552798310.gif)

![](../../../../../images/082c197d/note_3.0-zh-cn.png) 
