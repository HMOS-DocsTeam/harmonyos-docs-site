...
![](../../../../../images/ed8fbbef/note_3.0-zh-cn.png) 
...
对于绑定了长按手势的组件，可以设置触发长按的最短时间[duration](/ref/arkui-api/arkui-declarative-comp/gesture-handling/gesture-binding/ts-gesturehandler/ts-gesturehandler#longpressgesturehandleroptions)。触发长按时，系统将优先响应触发长按时间最短的组件，忽略priorityGesture设置。
