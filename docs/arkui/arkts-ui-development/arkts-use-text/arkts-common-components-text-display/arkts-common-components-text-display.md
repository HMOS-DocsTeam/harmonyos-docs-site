...
具体用法请参考[Text](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text)和[Span](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-span/ts-basic-components-span)组件的API文档。

常见问题请参考[文本显示（Text/Span）常见问题](/arkui/ui-debug-optimize/ui-development-faq/arkts-text-faq#文本显示textspan常见问题)。
...
![](../../../../images/444d0eb0/zh-cn_image_0000002583477791.png)
...
- 创建Span。
  ...
  ![](../../../../images/6daf2c12/zh-cn_image_0000002583437837.png)
- 设置文本装饰线及颜色。

  通过[decoration](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-span/ts-basic-components-span#decoration)设置文本装饰线及颜色。
  ...
  ![](../../../../images/a0d5af25/zh-cn_image_0000002552957792.png)
- 通过[textCase](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-span/ts-basic-components-span#textcase)设置文字一直保持大写或者小写状态。
  ...
  ![](../../../../images/d58f735e/zh-cn_image_0000002583477793.png)
- 添加事件。

  由于Span组件无尺寸信息，仅支持添加点击事件[onClick](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click#onclick)、悬浮事件[onHover](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-hover/ts-universal-events-hover#onhover)。
  ...
  ![](../../../../images/9fc306b2/zh-cn_image_0000002552798144.gif)
...
- 通过[textAlign](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textalign)属性设置文本对齐样式。
  ...
  ![](../../../../images/4b0ce22c/zh-cn_image_0000002583437839.png)
- 通过[textOverflow](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textoverflow)属性控制文本超长处理，textOverflow需配合[maxLines](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#maxlines)一起使用（默认情况下文本自动折行）。从API version 18开始，文本超长时设置跑马灯的方式展示时，支持设置跑马灯的配置项，比如开关、步长、循环次数、方向等。
  ...
  ![](../../../../images/460ad5ee/zh-cn_image_0000002552957794.gif)
- 通过[lineHeight](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#lineheight)属性设置文本行高。
  ...
  ![](../../../../images/2ac1a6d5/zh-cn_image_0000002583477795.png)
- 通过[decoration](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#decoration)属性设置文本装饰线样式、颜色及其粗细。
  ...
  ![](../../../../images/3edf506a/zh-cn_image_0000002552798146.jpg)
- 通过[baselineOffset](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#baselineoffset)属性设置文本基线的偏移量。
  ...
  ![](../../../../images/83855eb7/zh-cn_image_0000002583437841.png)
- 通过[letterSpacing](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#letterspacing)属性设置文本字符间距。
  ...
  ![](../../../../images/ba484927/zh-cn_image_0000002552957796.png)
- 通过[minFontSize](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#minfontsize)与[maxFontSize](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#maxfontsize)自适应字体大小。

  minFontSize用于设置文本的最小显示字号，maxFontSize用于设置文本的最大显示字号。这两个属性必须同时设置才能生效，并且需要与[maxLines](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#maxlines)属性或布局大小限制配合使用，单独设置任一属性将不会产生效果。
  ...
  ![](../../../../images/24945c49/zh-cn_image_0000002583477797.png)
- 通过[textCase](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textcase)属性设置文本大小写。
  ...
  ![](../../../../images/a75f391c/zh-cn_image_0000002552798148.png)
- 通过[copyOption](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#copyoption9)属性设置文本是否可复制粘贴。
  ...
  ![](../../../../images/710028fb/zh-cn_image_0000002583437843.png)
- 通过[fontFamily](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#fontfamily)属性设置字体列表。应用当前支持'HarmonyOS Sans'字体和[注册自定义字体](/ref/arkui-api/arkui-arkts/ui/js-apis-font/js-apis-font)。
  ...
  ![](../../../../images/1d8f9ddd/zh-cn_image_0000002552957798.png)
- 从API version 20开始，支持通过[contentTransition](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#contenttransition20)属性设置数字翻牌效果。
  ...
  ![](../../../../images/dee0897d/zh-cn_image_0000002583477799.gif)
- 从API version 20开始，支持通过[optimizeTrailingSpace](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#optimizetrailingspace20)设置是否在文本布局过程中优化每行末尾的空格，可解决行尾空格影响对齐显示效果问题。
  ...
  ![](../../../../images/7707a4af/zh-cn_image_0000002552798150.jpg)
- 从API version 20开始，支持通过[lineSpacing](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#linespacing20)设置文本的行间距。当不配置[LineSpacingOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#linespacingoptions20对象说明)时，首行上方和尾行下方默认会有行间距，当onlyBetweenLines设置为true时，行间距仅适用于行与行之间，首行上方无额外的行间距。
  ...
  ![](../../../../images/da12dbed/zh-cn_image_0000002583437845.jpg)
- 从API version 20开始，支持通过[enableAutoSpacing](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#enableautospacing20)设置是否开启中文与西文的自动间距。
  ...
  ![](../../../../images/87c39fcc/zh-cn_image_0000002552957800.gif)
- 从API version 20开始，支持通过[shaderStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#shaderstyle20)设置渐变色。
  ...
  ![](../../../../images/783bc908/zh-cn_image_0000002583477801.png)

## 添加事件

Text组件可以添加通用事件，可以绑定[onClick](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/interaction-events/ts-universal-events-click/ts-universal-events-click#onclick)、[onTouch](/ref/arkui-api/arkui-declarative-comp/ts-component-general-events/basic-raw-input-event/ts-universal-events-touch/ts-universal-events-touch#ontouch)等事件来响应操作。
...
![](../../../../images/5e2dba51/zh-cn_image_0000002552798152.gif)

## 设置垂直居中

从API version 20开始，Text组件支持通过[textVerticalAlign](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textverticalalign20)属性实现文本段落在垂直方向的对齐。
...
- 以下示例展示了如何通过textVerticalAlign属性设置文本垂直居中对齐效果。
  ...
  ![](../../../../images/18fe7706/zh-cn_image_0000002583437847.png)
...
- 设置Text被选中时，会弹出包含复制、翻译、搜索的菜单。
  ...
  Text组件需要设置[copyOption](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#copyoption9)属性才可以被选中。
  ...
  ![](../../../../images/75f0c1b6/zh-cn_image_0000002552957802.jpg)
- Text组件通过设置[bindSelectionMenu](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#bindselectionmenu11)属性绑定自定义选择菜单。
  ...
  ![](../../../../images/7e719ac1/zh-cn_image_0000002583477803.gif)
- Text组件通过设置[editMenuOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#editmenuoptions12)属性扩展自定义选择菜单，可以设置扩展项的文本内容、图标以及回调方法。
  ...
  ![](../../../../images/c19d849f/zh-cn_image_0000002552798154.gif)
...
- 在Text组件区域外点击空白处，前提是Text组件设置[selection](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#selection11)属性，具体示例如下：
...
![](../../../../images/f6c7b020/zh-cn_image_0000002583437849.gif)

### 屏蔽系统菜单回调和自定义扩展菜单

从API version 12开始，支持通过[editMenuOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#editmenuoptions12)屏蔽系统菜单回调和自定义扩展菜单项。
...
![](../../../../images/e0c28bdb/zh-cn_image_0000002552957804.gif)

### 屏蔽系统服务类菜单

- 从API version 20开始，支持通过[disableSystemServiceMenuItems](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-textmenucontroller/arkts-apis-uicontext-textmenucontroller#disablesystemservicemenuitems20)屏蔽文本选择菜单内所有系统服务菜单项。
  ...
  ![](../../../../images/7bbb9a99/zh-cn_image_0000002583477805.jpg)
- 从API version 20开始，支持通过[disableMenuItems](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-textmenucontroller/arkts-apis-uicontext-textmenucontroller#disablemenuitems20)屏蔽文本选择菜单内指定的系统服务菜单项。
  ...
  ![](../../../../images/561f8b8e/zh-cn_image_0000002552798156.jpg)

### 默认菜单支持自定义刷新能力

从API version 20开始，当文本选择区域变化后显示菜单之前触发[onPrepareMenu](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#属性-1)回调，可在该回调中进行菜单数据设置。
...
![](../../../../images/61583c50/zh-cn_image_0000002583437851.gif)

## 设置AI菜单

Text组件通过[enableDataDetector](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#enabledatadetector11)和[dataDetectorConfig](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#datadetectorconfig11)属性实现AI菜单的显示。AI菜单的表现形式包括：单击AI实体（指可被识别的内容，包括地址、邮箱等）弹出菜单的实体识别选项，选中文本后，文本选择菜单与鼠标右键菜单中显示的实体识别选项。

![](../../../../images/29818d6b/note_3.0-zh-cn.png) 

从API version 20开始，支持在文本选择菜单与鼠标右键菜单中显示实体识别选项。当[enableDataDetector](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#enabledatadetector11)设置为true，且[copyOption](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#copyoption9)设置为CopyOptions.LocalDevice时，该功能生效。菜单选项包括[TextMenuItemId](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#textmenuitemid12)中的url(打开链接)、email(新建邮件)、phoneNumber(呼叫)、address(导航至该位置)、dateTime(新建日程提醒)。

该功能生效时，需选中范围内，包括一个完整的AI实体，才能展示对应的选项。

- 如果需要单击AI实体弹出菜单的实体识别选项，可以配置[enableDataDetector](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#enabledatadetector11)为true。
- 如果在单击的交互方式之外，还需要文本选择菜单与鼠标右键菜单中显示的实体识别选项，可以配置[enableDataDetector](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#enabledatadetector11)为true，且[copyOption](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#copyoption9)设置为CopyOptions.LocalDevice，具体示例如下所示：
  ...
  ```
- 如果需要调整识别出的样式，可以通过[dataDetectorConfig](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#datadetectorconfig11)实现，具体可以参考[TextDataDetectorConfig](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#textdatadetectorconfig11对象说明)配置项。
- 如果需要调整菜单的位置，可以通过[editMenuOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#editmenuoptions12)实现，具体可以参考示例[文本扩展自定义菜单](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#示例12文本扩展自定义菜单)。

  ![](../../../../images/a736419d/zh-cn_image_0000002552957806.png)

![](../../../../images/936c6c23/zh-cn_image_0000002583477807.png)

## 实现热搜榜

该示例通过[maxLines](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#maxlines)、[textOverflow](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textoverflow)、[textAlign](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textalign)、[constraintSize](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#constraintsize)属性展示了热搜榜的效果。
...
![](../../../../images/da7bdb60/zh-cn_image_0000002552798158.png)
