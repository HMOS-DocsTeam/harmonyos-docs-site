...
通过设置[Text](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text)组件[textVerticalAlign](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#textverticalalign20)属性和设置[ImageSpan](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-imagespan/ts-basic-components-imagespan)组件[verticalAlign](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-imagespan/ts-basic-components-imagespan#verticalalign)为ImageSpanAlignment.FOLLOW\_PARAGRAPH，实现商品价格优惠信息展示的应用场景。
...
![](../../../../images/38b5891f/zh-cn_image_0000002583437895.png)

## 使用属性字符串实现图文混排

通过[ImageAttachment](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#imageattachment)添加图片，[TextStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-universal-styled-string/ts-universal-styled-string#textstyle)设置多种文本样式，实现商品详情信息展示的应用场景。
...
![](../../../../images/738f171b/zh-cn_image_0000002552957850.png)
