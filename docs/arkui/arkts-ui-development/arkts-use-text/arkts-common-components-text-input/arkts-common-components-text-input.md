...
TextInput、TextArea是输入框组件，用于响应用户输入，比如评论区的输入、聊天框的输入、表格的输入等，也可以结合其它组件构建功能页面，例如登录注册页面。具体用法请参考[TextInput](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput)和[TextArea](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textarea/ts-basic-components-textarea)组件的API文档。Search是特殊的输入框组件，称为搜索框，默认样式包含搜索图标。具体用法请参考[Search](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-search/ts-basic-components-search)组件的API文档。

![](../../../../images/e8a402c7/note_3.0-zh-cn.png) 

仅支持单文本样式，若需实现富文本样式，建议使用[RichEditor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-richeditor/ts-basic-components-richeditor)组件。
...
- 单行输入框。
  ...
  ![](../../../../images/78dfd140/zh-cn_image_0000002583437853.png)
- 多行输入框。
  ...
  ![](../../../../images/71b019db/zh-cn_image_0000002552957808.png)
- 多行输入框文字超出一行时会自动折行。
  ...
  ![](../../../../images/92b3336e/zh-cn_image_0000002583477809.png)
- 搜索框。
...
![](../../../../images/5b034eb6/zh-cn_image_0000002583437855.png)
...
![](../../../../images/068b9f70/zh-cn_image_0000002552957810.png)
...
![](../../../../images/b1ea2150/zh-cn_image_0000002583477811.png)
...
![](../../../../images/49d072eb/zh-cn_image_0000002552798162.png)
...
![](../../../../images/f59e2a8a/zh-cn_image_0000002583437857.png)
...
![](../../../../images/561d6e86/zh-cn_image_0000002552957812.png)
...
![](../../../../images/a3a4db86/zh-cn_image_0000002583477813.png)

## 设置输入框多态样式

TextInput、TextArea支持设置输入框多态样式，通过[style](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textarea/ts-basic-components-textarea#style10)属性进行设置。下面以多行输入框TextArea为例进行说明。
...
![](../../../../images/ffd39995/zh-cn_image_0000002552798164.gif)
...
![](../../../../images/a4fc402e/zh-cn_image_0000002583437859.gif)
...
- 设置无输入时的提示文本。
  ...
  ![](../../../../images/d381aa8f/zh-cn_image_0000002552957814.png)
- 设置输入框当前的文本内容。
  ...
  ![](../../../../images/8e2fb5ae/zh-cn_image_0000002583477815.png)
- 添加backgroundColor改变输入框的背景颜色。
  ...
  ![](../../../../images/9ebd56d0/zh-cn_image_0000002552798166.png)

  更丰富的样式可以结合[通用属性](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/ts-component-general-attributes)实现。

## 添加事件

文本框主要用于获取用户输入的信息，并将信息处理成数据进行上传，绑定[onChange](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onchange)事件可以获取输入框内改变的文本内容，绑定[onSubmit](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onsubmit)事件可以获取回车提交的文本信息，绑定[onTextSelectionChange](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ontextselectionchange10)事件可以获取文本选中时手柄的位置信息或者编辑时光标的位置信息等等。用户也可以使用通用事件进行相应的交互操作。

![](../../../../images/880e84e9/note_3.0-zh-cn.png) 

在密码模式下，设置[showPassword](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#showpassword12)属性时，在[onSecurityStateChange](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onsecuritystatechange12)回调中，建议增加状态同步，具体详见如下示例。

[onWillInsert](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onwillinsert12)、[onDidInsert](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ondidinsert12)、[onWillDelete](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onwilldelete12)、[onDidDelete](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ondiddelete12)回调仅支持系统输入法的场景。

[onWillChange](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onwillchange15)的回调时序晚于[onWillInsert](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onwillinsert12)、[onWillDelete](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#onwilldelete12)，早于[onDidInsert](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ondidinsert12)、[onDidDelete](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ondiddelete12)。
...
![](../../../../images/b531c239/zh-cn_image_0000002583437861.gif)
...
![](../../../../images/8506492c/zh-cn_image_0000002552957816.jpg)
...
![](../../../../images/304e5c16/zh-cn_image_0000002583477817.jpg)

## 禁用系统服务类菜单

从API version 20开始，支持使用[disableSystemServiceMenuItems](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-textmenucontroller/arkts-apis-uicontext-textmenucontroller#disablesystemservicemenuitems20)方法屏蔽文本选择菜单中的所有系统服务菜单项。
...
![](../../../../images/00bdcbc8/zh-cn_image_0000002552798168.gif)

从API version 20开始，支持使用[disableMenuItems](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-textmenucontroller/arkts-apis-uicontext-textmenucontroller#disablemenuitems20)方法屏蔽文本选择菜单中指定的系统服务菜单项。
...
![](../../../../images/2d2ea8f5/zh-cn_image_0000002583437863.png)

## 自动填充

输入框可以通过[contentType](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#contenttype12)属性设置自动填充类型。

支持的类型请参考[ContentType](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#contenttype12枚举说明)。
...
- 设置省略属性。
  ...
  输入框可以通过[ellipsisMode](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#ellipsismode18)属性设置省略位置。

  ellipsisMode属性需要配合[textOverflow](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#textoverflow12)属性设置为TextOverflow.Ellipsis使用，单独设置ellipsisMode属性不生效。
  ...
  ![](../../../../images/b41e6831/zh-cn_image_0000002552957818.jpg)
- 设置文本描边属性。

  从API version 20开始，输入框可以通过[strokeWidth](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#strokewidth20)和[strokeColor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textinput/ts-basic-components-textinput#strokecolor20)属性设置文本的描边宽度及颜色。
  ...
  ![](../../../../images/06fd0280/zh-cn_image_0000002583477819.jpg)

## 设置文本行间距

从API version 20开始，支持通过[lineSpacing](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text#linespacing20)设置文本的行间距。如果不配置[LineSpacingOptions](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-text-common/ts-text-common#linespacingoptions20对象说明)时，首行上方和尾行下方默认会有行间距。如果onlyBetweenLines设置为true时，行间距仅适用于行与行之间，首行上方无额外行间距。
...
![](../../../../images/ab36eb14/zh-cn_image_0000002552798170.jpg)

## 键盘避让

键盘抬起后，具有滚动能力的容器组件在横竖屏切换时，才会生效键盘避让，若希望无滚动能力的容器组件也生效键盘避让，建议在组件外嵌套一层具有滚动能力的容器组件，比如[Scroll](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-scroll/ts-container-scroll)、[List](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-list/ts-container-list)、[Grid](/ref/arkui-api/arkui-declarative-comp/scroll-and-swipe/ts-container-grid/ts-container-grid)。
...
![](../../../../images/c23294a2/zh-cn_image_0000002583437865.gif)

## 光标避让

[keyBoardAvoidMode](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-e/arkts-apis-uicontext-e#keyboardavoidmode11)枚举中的OFFSET和RESIZE在键盘抬起后，不支持二次避让。如果想要支持光标位置在点击或者通过接口设置变化后发生二次避让，可以考虑使用OFFSET\_WITH\_CARET和RESIZE\_CARET替换原有的OFFSET和RESIZE模式。
...
![](../../../../images/1cba8dd6/zh-cn_image_0000002552957820.gif)
...
设置[minLines](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-textarea/ts-basic-components-textarea#minlines20)（从API version 20开始），或者设置height为"auto"，并使用[constraintSize](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/layout-property/ts-universal-attributes-size/ts-universal-attributes-size#constraintsize)自行计算高度。
...
![](../../../../images/7324e0a3/zh-cn_image_0000002583477821.gif)
