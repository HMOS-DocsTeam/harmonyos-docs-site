...
![](../../../../images/ff222f46/zh-cn_image_0000002552957834.png)

## 添加到文本中

[SymbolSpan](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan)可作为[Text](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-text/ts-basic-components-text)的子组件用于显示图标小符号。可以在一个Text组件内添加多个SymbolSpan，从而展示一串连续的图标。
...
- 创建SymbolSpan。
  ...
  ![](../../../../images/701fe1b5/zh-cn_image_0000002583477835.png)
- 通过[fontSize](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan#fontsize)属性设置SymbolSpan的大小。
  ...
  ![](../../../../images/12a2fe0e/zh-cn_image_0000002552798186.png)
- 通过[fontWeight](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan#fontweight)属性设置SymbolSpan组件的粗细。
  ...
  ![](../../../../images/ad14a1da/zh-cn_image_0000002583437881.png)
- 通过[fontColor](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan#fontcolor)属性设置SymbolSpan的颜色。
  ...
  ![](../../../../images/6b4481fa/zh-cn_image_0000002552957836.png)
- 通过[renderingStrategy](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan#renderingstrategy)属性设置SymbolSpan的渲染策略。
  ...
  ![](../../../../images/0ed2d317/zh-cn_image_0000002583477837.png)
- 通过[effectStrategy](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolspan/ts-basic-components-symbolspan#effectstrategy)属性设置SymbolSpan的动效策略。
  ...
  ![](../../../../images/cc5d4c9e/zh-cn_image_0000002552798188.gif)
- SymbolSpan不支持通用事件。
...
关于effectStrategy属性与symbolEffect属性的多种动态属性使用及生效原则，详情请参阅[SymbolGlyph.symbolEffect](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#symboleffect12-1)属性的说明。
...
- 通过设置SymbolEffect属性，可以同时配置SymbolGlyph的动效策略和播放状态。
  ...
  ![](../../../../images/66f3561e/zh-cn_image_0000002583437883.gif)
- 通过设置SymbolEffect属性，可以同时指定SymbolGlyph的动画效果策略及其播放触发条件。
  ...
  ![](../../../../images/1b08c8c3/zh-cn_image_0000002552957838.gif)
- 从API version 20开始，支持通过设置SymbolEffect属性为[ReplaceSymbolEffect](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#replacesymboleffect12)，设置[ReplaceEffectType](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#replaceeffecttype20枚举说明)为ReplaceEffectType.SLASH\_OVERLAY，可以指定SymbolGlyph的禁用动画效果及其播放触发条件。
  ...
  ![](../../../../images/e9cfb852/zh-cn_image_0000002583477839.gif)
- 从API version 20开始，支持通过设置SymbolEffect属性为[ReplaceSymbolEffect](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#replacesymboleffect12)，设置[ReplaceEffectType](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#replaceeffecttype20枚举说明)为ReplaceEffectType.CROSS\_FADE，可以指定SymbolGlyph的快速替换动画效果及其播放触发条件。
  ...
  ![](../../../../images/fae90ec0/zh-cn_image_0000002552798190.gif)

## 设置阴影和渐变色

- 从API version 20开始，支持通过[symbolShadow](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#symbolshadow20)接口实现了symbolGlyph组件显示阴影效果。
  ...
  ![](../../../../images/19a94252/zh-cn_image_0000002583437885.gif)
- 从API version 20开始，支持通过[shaderStyle](/ref/arkui-api/arkui-declarative-comp/text-and-input/ts-basic-components-symbolglyph/ts-basic-components-symbolglyph#shaderstyle20)接口实现了symbolGlyph组件显示渐变色效果。
...
![](../../../../images/2f1ca9f6/zh-cn_image_0000002583477841.gif)
...
![](../../../../images/c703be17/zh-cn_image_0000002552798192.gif)
