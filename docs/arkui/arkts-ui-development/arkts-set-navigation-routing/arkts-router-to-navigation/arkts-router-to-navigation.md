...
鉴于组件导航（[Navigation](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation)）支持更丰富的动效、一次开发多端部署能力和更灵活的栈操作。本文主要从页面跳转、动效和生命周期等方面介绍如何从Router切换到Navigation。
...
而基于Navigation的路由页面分为导航页和子页，导航页又叫[Navbar](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navbar12)，是Navigation包含的子组件，子页是[NavDestination](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination)包含的子组件。
...
Router通过@ohos.router模块提供的方法来操作页面，建议使用[UIContext](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext)中的[getRouter](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-uicontext/arkts-apis-uicontext-uicontext#getrouter)获取[Router](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-router/arkts-apis-uicontext-router)对象。
...
Navigation通过导航控制器对象[NavPathStack](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#navpathstack10)提供的方法来操作页面，需要创建一个栈对象并传入Navigation中。
...
****方式二****：子页面通过[OnReady](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navdestination/ts-basic-components-navdestination#onready11)回调获取。
...
****方式四****：通过自定义组件查询接口获取，参考[queryNavigationInfo](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-api/ts-custom-component-api#querynavigationinfo12)。
...
![](../../../../images/036ad218/note_3.0-zh-cn.png) 
...
Router页面[生命周期](/arkui/arkts-ui-development/arkts-set-navigation-routing/arkts-routing#生命周期)为@Entry页面中的通用方法，主要有如下四个生命周期：
...
![](../../../../images/03f5069b/zh-cn_image_0000002552957692.png)
...
其中Router自定义页面转场通过通用方法pageTransition()实现，具体可参考Router[页面转场动画](/arkui/arkts-ui-development/arkts-use-animation/arkts-animation-transition/arkts-page-transition-animation)。
...
[Router共享元素转场动画](/ref/arkui-api/arkui-declarative-comp/animation/ts-transition-animation-shared-elements/ts-transition-animation-shared-elements)。
...
Router可以通过observer实现注册监听，接口定义请参考Router无感监听[uiObserver.on('routerPageUpdate')](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-observer/js-apis-arkui-observer#uiobserveronrouterpageupdate11)。
...
Router可以通过[queryRouterPageInfo](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-api/ts-custom-component-api#queryrouterpageinfo12)接口查询当前自定义组件所在的Page页面的信息，其返回值包含如下几个属性，其中pageId是页面的唯一标识符：
...
Navigation也可以通过[queryNavDestinationInfo](/ref/arkui-api/arkui-declarative-comp/custom-comp/ts-custom-component-api/ts-custom-component-api#querynavdestinationinfo)接口查询当前自定义组件所在的NavDestination的信息，其返回值包含如下几个属性，其中navDestinationId是页面的唯一标识符：
...
Navigation提供了[setInterception](/ref/arkui-api/arkui-declarative-comp/navigation-and-switching/ts-basic-components-navigation/ts-basic-components-navigation#setinterception12)方法，用于设置Navigation页面跳转拦截回调。具体可以参考文档：Navigation[路由拦截](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-jump#路由拦截)
