...
顶部窗口控制条是应用窗口处于智慧多窗模式下，应用顶部的操作横条 ![](../../../../../images/9b7185ff/zh-cn_image_0000002583478199.png) 。

顶部窗口控制条示意图如下所示：

![](../../../../../images/ebd13ad5/zh-cn_image_0000002552798550.png)

顶部横条的避让可通过以下两种方式适配：

- 使用窗口的避让能力：通过[setWindowLayoutFullScreen](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#setwindowlayoutfullscreen9)设置窗口布局是否为沉浸式布局。
  ...
  ![](../../../../../images/983e97b3/zh-cn_image_0000002583438245.png)
  ...
  ![](../../../../../images/bc45704c/zh-cn_image_0000002552958200.gif)
- 应用主动避让：应用不使用窗口避让能力（即设置窗口为沉浸式布局）。首次通过[getWindowAvoidArea](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#getwindowavoidarea9)接口可获取屏幕顶部需要规避的矩阵区域topRect，获取到该值后应用可对应做布局避让，并且注册[on('avoidAreaChange')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onavoidareachange9)监听系统避让区域变化以进行布局的动态调整。
  ...
  ![](../../../../../images/da24512b/zh-cn_image_0000002583478201.gif)
