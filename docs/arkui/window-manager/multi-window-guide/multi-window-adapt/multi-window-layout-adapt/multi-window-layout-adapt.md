...
![](../../../../../images/b7d17ad4/note_3.0-zh-cn.png) 
...
![](../../../../../images/dd60f9ec/zh-cn_image_0000002583438243.jpg)
...
主要可以通过窗口的[on('windowSizeChange')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onwindowsizechange7)方法实现对窗口尺寸大小变化的监听。再根据窗口的尺寸变化，更新调整自身应用布局以实现适配。
...
![](../../../../../images/577c3fa1/zh-cn_image_0000002552958198.gif)
