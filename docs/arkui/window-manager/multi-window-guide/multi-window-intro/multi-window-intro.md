...
- 竖向悬浮窗：一般用于新闻资讯、社交以及购物类应用等场景。
  ...
  ![](../../../../images/9fb0a71d/zh-cn_image_0000002583478187.png)
- 横向悬浮窗：主要用于横向游戏和视频全屏播放的场景。

  ![](../../../../images/235e7fdc/zh-cn_image_0000002552798538.jpg)
...
- 手势触发：应用全屏时从屏幕底部向上滑至右上方热区，松手后可开启悬浮窗模式。
  ...
  ![](../../../../images/4ab58786/zh-cn_image_0000002583438233.jpg)
- 通知消息下拉触发：在系统接收到通知消息未收起时，可直接下拉此通知消息开启悬浮窗模式。

  ![](../../../../images/2a437ee6/zh-cn_image_0000002552958188.png)
- 侧边Dock触发：侧滑调出侧边Dock栏，点击Dock上的应用，支持悬浮窗的应用以悬浮窗模式开启。

  ![](../../../../images/039dc3c7/zh-cn_image_0000002583478189.png)
- 分屏切换悬浮窗：分屏时，按住分屏应用顶部横条，拖拽到相应的热区，应用从分屏切换到悬浮窗模式。

  ![](../../../../images/9fc9e781/zh-cn_image_0000002552798540.png)

****悬浮窗的恢复方式主要有以下两种：****

- 多任务中心中恢复：对于已开启悬浮窗模式的应用，在进入多任务中心时，悬浮窗应用同全屏应用一起显示在多任务中心，用户选择点击悬浮窗应用卡片时可恢复悬浮窗模式。

  ![](../../../../images/41fbfec0/zh-cn_image_0000002583438235.png)
- 侧边条恢复：对于已开启悬浮窗模式的应用，其最小化后会暂存在屏幕上的侧边条中，点击或者长按侧边条可展开任务选择界面，选择点击侧边条中悬浮窗应用卡片时可恢复悬浮窗模式。

  ![](../../../../images/84a46bd2/zh-cn_image_0000002552958190.png)

### 适配注意事项

针对在Tablet设备上运行的PC应用，不支持悬浮窗。

当应用module.json5配置文件中的设备类型[deviceTypes标签](/development-fundamentals/application-configuration-file-stage/module-configuration-file#devicetypes标签)包含"2in1"且不包含"phone"时，系统判定其为PC应用。
...
- 分屏通过手势触发：应用全屏时，从屏幕底部向上滑至左上方热区，进入待分屏状态，点击桌面另一个支持分屏的应用图标或卡片，可形成分屏。
  ...
  ![](../../../../images/49a7fdc8/zh-cn_image_0000002583478191.png)
- 应用自主启动分屏：除了通过手势触发分屏之外，应用可以自主选择启动分屏，具体步骤可见[应用内分屏](/arkui/window-manager/multi-window-guide/multi-window-adapt/multi-window-support#应用内分屏)。
- 侧边Dock栏触发：长按Dock栏中的应用图标并拖出，和前台支持分屏的全屏应用形成分屏。

  ![](../../../../images/65e56e0e/zh-cn_image_0000002552798542.png)
- 悬浮窗切分屏：按住悬浮窗顶部横条，拖到相应热区，悬浮窗和前台全屏应用形成分屏。

  ![](../../../../images/40e14785/zh-cn_image_0000002583438237.png)
...
- 双折叠设备全景多窗窗口档位及窗口宽高比：
  ...
  ![](../../../../images/492cee38/zh-cn_image_0000002552958192.jpg)
- 三折叠与Tablet设备全景多窗窗口档位及窗口宽高比：

  ![](../../../../images/0c73e87f/zh-cn_image_0000002583478193.jpg)
- 窗口状态分为平铺和侧身两种状态：

  ![](../../../../images/c2c33ed6/zh-cn_image_0000002552798544.png)
...
- 全景多窗通过手势触发：
  ...
  ![](../../../../images/a87c849d/zh-cn_image_0000002583438239.png)

  应用分屏时，从屏幕底部向上滑至上方中间热区，点击桌面另一个支持全景多窗的应用图标或卡片，可形成全景多窗。

  ![](../../../../images/c00eb04c/zh-cn_image_0000002552958194.png)

  应用分屏时，从屏幕底部向上滑至左上方热区，点击桌面另一个支持全景多窗的应用图标或卡片，可形成三小窗全景多窗。

  ![](../../../../images/0e532f62/zh-cn_image_0000002583478195.png)
- 全景多窗通过顶部横条触发：

  应用全屏时，点击全屏应用顶部横条，选择“全景多窗”，点击桌面另一个支持全景多窗的应用图标或卡片，可形成全景多窗。

  ![](../../../../images/69a3189d/zh-cn_image_0000002552798546.png)

  应用分屏时，点击分屏应用顶部横条，选择“增加窗口”，点击桌面另一个支持全景多窗的应用图标或卡片，可形成全景多窗。

  ![](../../../../images/4da8f2e3/zh-cn_image_0000002583438241.png)
- 全景多窗通过分屏拖拽触发：应用分屏时，调节分屏比例到相应热区，进入全景多窗。

  ![](../../../../images/15030879/zh-cn_image_0000002552958196.png)

### 适配注意事项

全景多窗侧身窗口为不可见窗口，可以通过监听[on('windowVisibilityChange')](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-window/arkts-apis-window-window/arkts-apis-window-window#onwindowvisibilitychange11)感知应用是否处于侧身。
