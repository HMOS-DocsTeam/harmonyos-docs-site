...
![](../../../../images/f205c915/note_3.0-zh-cn.png) 
...
Node-API模块注册，具体使用请参考[Native API在应用工程中的使用指导](/coding/using-napi-interaction-with-cpp/napi-guidelines)。
...
示例中的视频播放需要使用AVPlayer，具体实现可参考[视频播放](/media-kit/media-kit-dev--arkts/media-playback-arkts/video-playback)。
...
![](../../../../images/d12eeccb/zh-cn_image_0000002583478181.gif)
