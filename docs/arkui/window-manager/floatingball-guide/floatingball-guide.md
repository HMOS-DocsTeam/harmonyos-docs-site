...
![](../../../images/65275458/note_3.0-zh-cn.png) 
...
- 基于安全考虑，仅允许应用在前台时启动闪控球，并且需要具有[ohos.permission.USE\_FLOAT\_BALL](/system-security/access-control/app-permission-mgmt/app-permissions/restricted-permissions#ohospermissionuse_float_ball)权限，具体可见[申请受限权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl#)。
...
以下是闪控球功能的常用接口，更多接口及使用参考[@ohos.window.floatingBall (闪控球窗口)](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball) 。
...
- 拖动闪控球：可以手动拖拽闪控球改变位置，拖拽时自动避让状态栏、固定态软键盘（改变软键盘为固定态或者悬浮态的详细介绍请参见[输入法服务](/ref/ime-api/ime-arkts/js-apis-inputmethodengine/js-apis-inputmethodengine#changeflag10)）、导航条等其他组件，设备处于横屏场景时不会自动避让输入法。拖拽松手时闪控球自动吸附在最近的侧边，拖拽到垃圾桶区域（底部中部区域）松手即可删除。
- 闪控球位置记忆：关闭闪控球会记录当前位置，下一次打开功能时自动展示在上次关闭时的位置。旋转屏幕或重启设备会恢复到默认位置，默认位置位于屏幕右上侧。

## 闪控球规格与样式布局

目前支持四种闪控球模板布局，具体可见闪控球模板类型枚举[FloatingBallTemplate](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#floatingballtemplate)。
...
![](../../../images/eb02ebe1/zh-cn_image_0000002552798532.png)

****图2**** 静态布局-超长文本标题

![](../../../images/7d164c38/zh-cn_image_0000002583438227.png)

****图3**** 普通文本布局

![](../../../images/dcee0d72/zh-cn_image_0000002552958182.png)

****图4**** 普通文本布局-超长文本内容

![](../../../images/3c291393/zh-cn_image_0000002583478183.png)

****图5**** 强调文本布局

![](../../../images/9d9746f8/zh-cn_image_0000002552798534.png)

****图6**** 强调文本布局-超长文本内容

![](../../../images/4401d5bf/zh-cn_image_0000002583438229.png)

****图7**** 强调文本布局-图标

![](../../../images/4212587d/zh-cn_image_0000002552958184.png)

****图8**** 强调文本布局-图标和超长文本内容

![](../../../images/2e677188/zh-cn_image_0000002583478185.png)

****图9**** 纯文本布局

![](../../../images/c8cc6140/zh-cn_image_0000002552798536.png)

****图10**** 纯文本布局-超长文本标题

![](../../../images/73b6e99c/zh-cn_image_0000002583438231.png)

当有两个应用启动了闪控球后，闪控球将合并展示，如下图所示。整体高度为76vp。

****图11**** 闪控球上下合并展示

![](../../../images/1a24cd79/zh-cn_image_0000002552958186.png)

## 开发步骤

1. 导入模块并声明闪控球控制器。
2. 使用[create()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#floatingballcreate)接口创建闪控球控制器实例后注册点击事件回调和状态变化事件回调，通过[startFloatingBall()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#startfloatingball)接口启动闪控球。
3. 通过[updateFloatingBall()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#updatefloatingball)更新闪控球信息，以此控制闪控球展示的内容。
4. 通过[stopFloatingBall()](/ref/arkui-api/arkui-arkts/window-manager-api/js-apis-floatingball/js-apis-floatingball#stopfloatingball)停止闪控球。当不再需要显示闪控球时，可根据业务需要关闭闪控球。
