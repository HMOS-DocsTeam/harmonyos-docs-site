...
从API version 9开始，可以使用[getInspectorTree](/ref/arkui-api/arkui-declarative-comp/ts-component-general-attributes/basic-property/ts-universal-attributes-component-id/ts-universal-attributes-component-id#getinspectortree9)接口获取组件树及其属性。

****单个节点****

从API version 10开始，可以使用[getRectangleById](/ref/arkui-api/arkui-arkts/ui/js-apis-arkui-uicontext/arkts-apis-uicontext-componentutils/arkts-apis-uicontext-componentutils#getrectanglebyid)接口获取组件的大小、位置、平移、缩放、旋转及仿射矩阵等属性信息。
