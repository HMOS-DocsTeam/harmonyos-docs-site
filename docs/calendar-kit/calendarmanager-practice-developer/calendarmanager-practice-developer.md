...
通过日历服务，开发者可将带有时间属性的事件作为日程写入，并支持通过“[一键服务](/calendar-kit/calendar-service)”功能快速跳转，帮助用户快速直达对应服务，并完成各类信息的归一化管理。各典型场景选择适用的模板，并按照模板格式填写各个字段信息，确保用户体验完整、一致。
...
![](../../images/6fa58dd6/zh-cn_image_0000002552958822.png)

## 开发准备

请参考日程管理前三步的[开发步骤](/calendar-kit/calendarmanager-calendar-developer#开发步骤)：

1. 导入相关依赖。
2. 申请权限。使用Calendar Kit时，需要在module.json5中声明申请读写日历日程所需的权限：ohos.permission.READ\_CALENDAR和ohos.permission.WRITE\_CALENDAR。具体指导可见[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。
...
| 场景类型 | [ServiceType取值](/ref/calendar-api/calendar-arkts/js-apis-calendarmanager/js-apis-calendarmanager#servicetype) | 按钮显示内容 |
| --- | --- | --- |
| 会议 | 'Meeting' | 加入会议 |
| 追剧 | 'Watching' | 立即观看 |
| 还款 | 'Repayment' | 马上还款 |
...
![](../../images/c7330396/zh-cn_image_0000002583478823.png)
...
| 地点 | [location](/ref/calendar-api/calendar-arkts/js-apis-calendarmanager/js-apis-calendarmanager#location) | 酒店的地理位置 |
| 开始时间 | startTime | 入住时间 |
| 结束时间 | endTime | 离店时间 |
...
![](../../images/d7470dc2/zh-cn_image_0000002552799174.png)
...
![](../../images/64987a6c/zh-cn_image_0000002583438869.png)
...
![](../../images/b1c7a0ff/zh-cn_image_0000002552958824.png)
...
![](../../images/dc97ca73/zh-cn_image_0000002583478825.png)
...
![](../../images/91f0e3fd/zh-cn_image_0000002552799176.png)
...
![](../../images/6cfb1816/zh-cn_image_0000002583438871.png)
...
![](../../images/7843982c/zh-cn_image_0000002552958826.png)
...
![](../../images/a86ab9d9/zh-cn_image_0000002583478827.png)
