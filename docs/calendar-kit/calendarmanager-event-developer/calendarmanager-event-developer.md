...
Calendar Kit中的日程[Event](/ref/calendar-api/calendar-arkts/js-apis-calendarmanager/js-apis-calendarmanager#event)归属于某个对应的日历账户[Calendar](/ref/calendar-api/calendar-arkts/js-apis-calendarmanager/js-apis-calendarmanager#calendar)，一个日历账户下可以有多个日程，一个日程只属于一个Calendar。
...
以下是日程管理的相关接口，更多详细接口及使用请参考[@ohos.calendarManager](/ref/calendar-api/calendar-arkts/js-apis-calendarmanager/js-apis-calendarmanager)。
