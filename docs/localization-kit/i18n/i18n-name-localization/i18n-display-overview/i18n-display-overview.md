...
2. [本地化语言与地区名称](/localization-kit/i18n/i18n-name-localization/i18n-language-region-display)：采用i18n.System.getDisplayLanguage和i18n.System.getDisplayCountry接口实现本地化表示语言和地区。
