...
度量衡包括长度单位、面积单位、体积单位和容量单位等，通过[I18NUtil](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n#i18nutil9)类的[unitConvert](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n#unitconvert9)接口实现度量衡转换和格式化。
