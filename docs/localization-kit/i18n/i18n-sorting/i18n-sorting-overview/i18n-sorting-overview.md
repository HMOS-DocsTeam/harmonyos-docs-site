...
多语言排序分为[按本地习惯排序](/localization-kit/i18n/i18n-sorting/i18n-sorting-local)和[创建索引](/localization-kit/i18n/i18n-sorting/i18n-sorting-index)两种方式，具体使用场景和开发步骤请参考对应章节。
