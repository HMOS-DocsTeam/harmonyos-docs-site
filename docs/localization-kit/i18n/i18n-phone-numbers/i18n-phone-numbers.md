...
电话号码格式化通过[PhoneNumberFormat](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n#phonenumberformat8)的[format](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n#format8)接口实现。
