...
从API version 20开始，时区模块还可用于获取时区跳变时间点和偏移量等，时区的跳变逻辑参考[夏令时跳变](/localization-kit/i18n/i18n-time-zone-dst/i18n-dst-transition)。

## 接口说明

时区模块关键接口如下表所示，具体API说明详见[国际化-I18n](/ref/localization-api/localization-arkts/js-apis-i18n/js-apis-i18n)。
