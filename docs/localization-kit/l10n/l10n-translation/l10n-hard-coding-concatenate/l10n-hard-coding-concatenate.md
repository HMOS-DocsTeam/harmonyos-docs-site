...
![](../../../../images/d39b44a4/zh-cn_image_0000002552958322.png)

## 约束与限制

1. 避免使用硬编码，将需要翻译的字符串提取到资源文件中，与代码分离，然后使用相关的接口加载，具体请参考[提供多语言资源](/localization-kit/l10n/l10n-multilingual-resources)。
