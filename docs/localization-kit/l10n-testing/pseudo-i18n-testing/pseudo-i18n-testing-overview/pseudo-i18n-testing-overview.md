...
伪本地化测试包括[翻译伪本地化](/localization-kit/l10n-testing/pseudo-i18n-testing/pseudo-i18n-testing-translation)和[界面镜像伪本地化](/localization-kit/l10n-testing/pseudo-i18n-testing/pseudo-i18n-testing-mirror)。
