...
- ****Model****：选择代码续写的模型，模型内容请参考：[模型（Model）配置](/ide-agent/ide-agent-model)。
- ****Prompt format****：提示词格式，此处列出了主流的FIM提示词格式，并自动与模型选项联动。设置时需要选择与模型匹配的提示词格式，续写才能正常工作，开发者可在模型官网或者模型技术报告获取提示词格式。

![](../../images/d4c48b59/zh-cn_image_0000002530913706.png)
...
![](../../images/a1b26604/zh-cn_image_0000002530913702.png)
...
![](../../images/46bdafc5/zh-cn_image_0000002530753714.png)
...
![](../../images/8638b4b1/zh-cn_image_0000002530913708.png)
...
![](../../images/80453a1f/zh-cn_image_0000002561753647.png)
...
![](../../images/fd098536/zh-cn_image_0000002530753712.png)
...
![](../../images/0c4f186d/zh-cn_image_0000002530753710.png)
