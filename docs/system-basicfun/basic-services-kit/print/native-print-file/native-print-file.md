...
![](../../../../images/02c16c9d/note_3.0-zh-cn.png) 

使用打印服务，需[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)：ohos.permission.PRINT。

当不再使用打印服务时，调用OH\_Print\_Release()释放打印客户端资源并取消事件订阅。

c++接口需要在NDK工程中使用，请参考[NDK开发导读](/ndk-development-overview)。
