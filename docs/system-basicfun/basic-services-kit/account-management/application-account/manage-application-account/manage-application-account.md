...
应用开发者可以使用[@ohos.account.appAccount](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount)管理本应用的账号数据。
...
1. 调用[createAccount](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#createaccount9)接口，根据名称和选项创建应用账号。
...
调用[getAllAccounts](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#getallaccounts9)接口查询账号列表。
...
1. 调用[getCredential](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#getcredential9)接口，获取账号的凭据。
...
1. 调用[setCredential](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#setcredential9)接口，设置账号的凭据。
...
1. 调用[setCustomData](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#setcustomdata9)接口，设置账号的自定义数据。
...
1. 调用[getCustomData](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#getcustomdata9)接口，获取账号的自定义数据。
...
1. 调用[setAuthToken](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#setauthtoken9)接口，设置指定授权类型的授权令牌。
...
1. 调用[getAuthToken](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#getauthtoken9)接口，获取指定授权类型的授权令牌。
...
指定要删除的账号名称，调用[removeAccount](/ref/system-basicfun-api/basic-services-api/basic-services-arkts/account-management-arkts/js-apis-appaccount/js-apis-appaccount#removeaccount9)接口删除账号。
