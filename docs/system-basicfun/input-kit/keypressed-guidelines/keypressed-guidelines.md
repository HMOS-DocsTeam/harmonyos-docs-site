...
按键按下事件常用接口如下表所示，接口详细介绍请参考[@ohos.multimodalInput.inputConsumer](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputconsumer/js-apis-inputconsumer)。
...
应用开启时调用[on](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputconsumer/js-apis-inputconsumer#inputconsumeronkeypressed16)方法订阅按键按下事件，应用关闭时再用[off](/ref/system-basicfun-api/input-api/input-arkts/js-apis-inputconsumer/js-apis-inputconsumer#inputconsumeroffkeypressed16)方法取消订阅按键按下事件。
