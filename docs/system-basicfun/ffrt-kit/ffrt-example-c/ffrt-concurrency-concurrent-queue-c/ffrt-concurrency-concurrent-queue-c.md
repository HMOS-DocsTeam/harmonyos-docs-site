...
![](../../../../images/f102f4fd/note_3.0-zh-cn.png) 

ffrt\_queue\_submit\_h\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_alloc_auto_managed_function_storage_base)函数查看如何构造任务结构体。
...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_queue\_create](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_queue_t) | 创建队列。 |
| [ffrt\_queue\_destroy](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_queue_t) | 销毁队列。 |
| [ffrt\_task\_attr\_set\_queue\_priority](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_task_attr_t) | 设置队列任务优先级。 |
| [ffrt\_queue\_attr\_set\_max\_concurrency](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_queue_attr_t) | 设置并发队列的并发度。 |
| [ffrt\_queue\_submit\_h\_f](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_queue_t) | 向队列提交一个任务。  ****说明****：从API version 20开始，支持该接口。 |

![](../../../../images/1c591194/note_3.0-zh-cn.png) 
