...
![](../../../../images/5cbff065/note_3.0-zh-cn.png) 
...
![](../../../../images/7582f787/note_3.0-zh-cn.png) 
...
![](../../../../images/7ac141c9/zh-cn_image_0000002583438503.png)
...
![](../../../../images/fb5a6402/zh-cn_image_0000002552958458.png)
...
![](../../../../images/98de2d0a/note_3.0-zh-cn.png) 

ffrt\_submit\_h\_f和ffrt\_submit\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_alloc_auto_managed_function_storage_base)函数查看如何构造任务结构体。
...
![](../../../../images/4cbabfe2/note_3.0-zh-cn.png) 

ffrt\_submit\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_alloc_auto_managed_function_storage_base)函数查看如何构造任务结构体。

各个任务在FFRT内部形成了一棵调用树：

![](../../../../images/fd96adcd/zh-cn_image_0000002583478459.png)
...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_submit\_f](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_submit_f) | 提交任务调度执行。  ****说明****：从API version 20开始，支持该接口。 |
| [ffrt\_submit\_h\_f](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_submit_h_f) | 提交任务调度执行并返回任务句柄。  ****说明****：从API version 20开始，支持该接口。 |
| [ffrt\_wait\_deps](/system-basicfun/ffrt-kit/ffrt-api-guideline-c#ffrt_wait_deps) | 等待依赖的任务完成。 |

![](../../../../images/4890f153/note_3.0-zh-cn.png) 

- 如何使用FFRT C++ API详见：[FFRT C++接口三方库使用指导](/system-basicfun/ffrt-kit/ffrt-development-guideline#using-ffrt-c-api-1)。
