...
3. 点击左侧工具栏中![](../../images/9beb7abb/zh-cn_image_0000002530753756.png "点击放大")，即可开始录屏。

   ![](../../images/09f3101e/zh-cn_image_0000002561753699.png)
4. 录屏时，需要先选择录屏文件的保存路径，开发者可使用默认路径或[设置自定义路径](#section89111791511)。

   ![](../../images/55007896/zh-cn_image_0000002530753762.png)
5. 路径选择完毕后，点击****Start Recording****开始录屏。

   ![](../../images/db8f3709/zh-cn_image_0000002561833673.png "点击放大")
6. 录制完操作流程之后，点击****Stop Recording****结束录屏。

   ![](../../images/994b0060/zh-cn_image_0000002561753689.png "点击放大")
7. 结束录屏后，录屏文件将会保存到之前选择的路径下，可以选择调用系统播放器播放视频文件或打开文件所在的文件夹。

   ![](../../images/262dc489/zh-cn_image_0000002530913752.png "点击放大")

## 设置录屏自定义路径

1. 点击DevEco Studio底部****Log****页签，选择****HiLog >**** ****Settings**** ****>**** ****Record Screen****选项。

   ![](../../images/561d7c7a/zh-cn_image_0000002561753693.png)
2. 在弹出的界面选择自定义路径，当设置好路径并勾选“Use the selected path and auto-generated file name as defaults and don't ask again”选项后，录屏时将自动使用此时设置的路径以及以录屏时的时间戳构造的文件名作为录屏文件的保存地址及文件名。
   ...
   ![](../../images/bf584c49/zh-cn_image_0000002530753752.png)

## 通过命令行方式录屏

hdc是可以用于调试的命令行工具，通过该工具可以实现录屏功能。更多关于命令行工具hdc的说明请参见[hdc工具使用指导](/system-debug-optimize/debugging-commands/hdc)。
...
3. 获取录屏文件位置，记录为\{RecordFile\}。
   ...
   - 如果查询的结果中包含uri字段，则返回值第三行对应的录屏文件路径不允许直接下载。
     ...
     ![](../../images/aa8c114d/zh-cn_image_0000002561753695.png)
     ...
     ![](../../images/c7779497/zh-cn_image_0000002530913756.png)
   - 如果查询结果不包含uri字段，则返回值第二行即为录屏文件路径\{RecordFile\}。

     ![](../../images/f49a548a/zh-cn_image_0000002530753758.png)
