...
1. 在使用文本转语音时，将实现文本转语音相关的类添加至工程。
   ...
   ```
2. 调用createEngine接口，创建[TextToSpeechEngine](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#texttospeechengine)实例。

   createEngine接口提供了两种调用形式，当前以其中一种作为示例，其他方式可参考[API参考](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech)。
   ...
   ```
3. 得到[TextToSpeechEngine](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#texttospeechengine)实例对象后，实例化[SpeakParams](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#speakparams)对象、[SpeakListener](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#speaklistener)对象，并传入待合成及播报的文本originalText，调用[speak](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#speak)接口进行播报。
   ...
   ```
4. （可选）当需要停止合成及播报时，可调用[stop](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#stop)接口。

   ```
   ttsEngine.stop();
   ```
5. （可选）当需要查询文本转语音服务是否处于忙碌状态时，可调用[isBusy](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#isbusy)接口。

   ```
   ttsEngine.isBusy();
   ```
6. （可选）当需要查询支持的语种音色信息时，可调用[listVoices](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech#listvoices)接口。

   listVoices接口提供了两种调用形式，当前以其中一种作为示例，其他方式可参考[API参考](/ref/core-speech-api/core-speech-arkts/hms-ai-texttospeech/hms-ai-texttospeech)。
...
![](../../images/4465a787/note_3.0-zh-cn.png) 
