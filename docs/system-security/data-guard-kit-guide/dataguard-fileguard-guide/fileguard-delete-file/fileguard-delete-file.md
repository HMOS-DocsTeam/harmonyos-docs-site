...
| 接口名 | 描述 |
| --- | --- |
| [deleteFile](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#deletefile)(path: string, callback: AsyncCallback&lt;void&gt;): void | 使用Callback方式删除指定路径下的文件。 |
| [deleteFile](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#deletefile-1)(path: string): Promise&lt;void&gt; | 使用Promise方式删除指定路径下的文件。 |
...
1. 导入模块。
   ...
   ```
2. 初始化[FileGuard](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#fileguard)对象guard，调用接口deleteFile，删除扫描范围内的文件。
