...
| 接口名 | 描述 |
| --- | --- |
| [updatePolicy](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#updatepolicy)(policy: string, callback: AsyncCallback&lt;void&gt;): void | 使用Callback方式更新安全管控策略。 |
| [updatePolicy](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#updatepolicy-1)(policy: string): Promise&lt;void&gt; | 使用Promise方式更新安全管控策略。 |
...
1. 导入模块。
   ...
   ```
2. 初始化[FileGuard](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#fileguard)对象guard，调用接口updatePolicy，更新安全管控策略。
