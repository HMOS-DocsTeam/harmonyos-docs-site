...
| 接口名 | 描述 |
| --- | --- |
| [setKiaFilelist](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#setkiafilelist)(filelist: string, callback: AsyncCallback&lt;void&gt;): void | 使用Callback方式设置KIA文件列表。 |
| [setKiaFilelist](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#setkiafilelist-1)(filelist: string): Promise&lt;void&gt; | 使用Promise方式设置KIA文件列表。 |
...
1. 导入模块。
   ...
   ```
2. 初始化[FileGuard](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-fileguard/dataguard-fileguard#fileguard)对象guard，将KIA文件列表对象转为字符串，调用接口setKiaFilelist，设置KIA文件列表。
