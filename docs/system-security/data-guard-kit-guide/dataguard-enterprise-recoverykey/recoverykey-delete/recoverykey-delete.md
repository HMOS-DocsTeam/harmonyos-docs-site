...
| 接口名 | 描述 |
| --- | --- |
| [deleteEnterpriseRecoveryKey](/ref/system-security-api/data-guard-api/data-guard-arkts/dataguard-recoverykey/dataguard-recoverykey#deleteenterpriserecoverykey)(userId: number, signature: Uint8Array): Promise&lt;number&gt; | 使用Promise方式删除企业恢复密钥相关数据。 |
