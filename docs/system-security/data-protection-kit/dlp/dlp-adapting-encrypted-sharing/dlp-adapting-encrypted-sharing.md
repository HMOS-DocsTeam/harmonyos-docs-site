...
1. 配置[DocumentSelectOptions](/ref/core-file-api/core-file-arkts/js-apis-file-picker/js-apis-file-picker#documentselectoptions)参数，在文件Picker底部显示“加密分享”按钮。
2. 通过[DocumentViewPicker](/ref/core-file-api/core-file-arkts/js-apis-file-picker/js-apis-file-picker#documentviewpicker)获取文件URI。
...
2. 构造[want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)参数。
3. 通过[startAbility](/ref/ability-api/ability-arkts/ability-api-interface-depend/ability-arkts-application/js-apis-inner-application-uiabilitycontext/js-apis-inner-application-uiabilitycontext#startability-2)将[want](/ref/ability-api/ability-arkts/both-models/js-apis-app-ability-want/js-apis-app-ability-want)参数传入，使用系统统一打开能力进行打开。
