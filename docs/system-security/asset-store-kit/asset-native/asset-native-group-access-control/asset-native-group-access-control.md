...
- [新增关键资产(C/C++)](/system-security/asset-store-kit/asset-native/asset-native-add)
- [删除关键资产(C/C++)](/system-security/asset-store-kit/asset-native/asset-native-remove)
- [更新关键资产(C/C++)](/system-security/asset-store-kit/asset-native/asset-native-update)
- [查询关键资产(C/C++)](/system-security/asset-store-kit/asset-native/asset-native-query)
