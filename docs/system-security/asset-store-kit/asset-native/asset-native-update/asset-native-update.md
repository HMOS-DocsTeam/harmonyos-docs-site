...
开发者可以查阅API文档，获取关键资产更新接口的详细说明：[OH\_Asset\_Update](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-api-h/capi-asset-api-h#oh_asset_update)。

在更新关键资产时，关键资产属性的内容参数如下表所示：

![](../../../../images/3629657f/caution_3.0-zh-cn.png) 
...
![](../../../../images/c25a478b/note_3.0-zh-cn.png) 

在更新前，需确保已有关键资产，可参考[指南文档](/system-security/asset-store-kit/asset-native/asset-native-add)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

更新别名是demo\_alias的关键资产，将关键资产明文更新为demo\_pwd\_new，附属信息更新成demo\_label\_new。

在指定群组中更新一条关键资产的示例代码详见[更新群组关键资产](/system-security/asset-store-kit/asset-native/asset-native-group-access-control#更新群组关键资产)。
