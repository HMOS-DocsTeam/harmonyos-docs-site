...
开发者可以查阅API文档，获取关键资产查询接口的详细说明：[OH\_Asset\_Query](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-api-h/capi-asset-api-h#oh_asset_query)。

在查询关键资产时，关键资产属性的内容参数如下表所示：

![](../../../../images/876932a3/caution_3.0-zh-cn.png) 
...
| ASSET\_TAG\_ACCESSIBILITY | 类型为uint32\_t，取值范围详见[Asset\_Accessibility](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-type-h/capi-asset-type-h#asset_accessibility)。 | 可选 | 基于锁屏状态的访问控制。 |
...
| ASSET\_TAG\_AUTH\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_AuthType](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-type-h/capi-asset-type-h#asset_authtype)。 | 可选 | 访问关键资产所需的用户认证类型。 |
| ASSET\_TAG\_SYNC\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_SyncType](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-type-h/capi-asset-type-h#asset_synctype)。 | 可选 | 关键资产支持的同步类型。 |
...
| ASSET\_TAG\_RETURN\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_ReturnType](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-type-h/capi-asset-type-h#asset_returntype)。 | 可选 | 关键资产查询返回的结果类型。 |
...
![](../../../../images/37696144/note_3.0-zh-cn.png) 

在查询前，需确保已有关键资产，可参考[指南文档](/system-security/asset-store-kit/asset-native/asset-native-add)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

### 查询单条关键资产明文

查询别名是demo\_alias的关键资产明文。

在指定群组中查询一条关键资产明文的示例代码详见[查询单条群组关键资产明文](/system-security/asset-store-kit/asset-native/asset-native-group-access-control#查询单条群组关键资产明文)。
...
在指定群组中查询一条关键资产属性的示例代码详见[查询单条群组关键资产属性](/system-security/asset-store-kit/asset-native/asset-native-group-access-control#查询单条群组关键资产属性)。
