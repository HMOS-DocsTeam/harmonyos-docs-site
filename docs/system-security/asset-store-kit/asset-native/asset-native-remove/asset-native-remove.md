...
开发者可以查阅API文档，获取关键资产删除接口的详细说明：[OH\_Asset\_Remove](/ref/system-security-api/asset-store-api/asset-store-c/asset-store-headerfile/capi-asset-api-h/capi-asset-api-h#oh_asset_remove)。

在删除关键资产时，关键资产属性的内容参数如下表所示：

![](../../../../images/3cd749f7/caution_3.0-zh-cn.png) 
...
![](../../../../images/61905157/note_3.0-zh-cn.png) 

在删除前，需确保已有关键资产，可参考[指南文档](/system-security/asset-store-kit/asset-native/asset-native-add)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

删除别名是demo\_alias的关键资产。

在指定群组中删除一条关键资产的示例代码详见[删除群组关键资产](/system-security/asset-store-kit/asset-native/asset-native-group-access-control#删除群组关键资产)。
