...
开发者可以查阅API文档，获取关键资产查询接口的详细说明：[query(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetquery)、同步接口[querySync(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetquerysync12)。

在查询关键资产时，关键资产属性的内容（AssetMap）参数如下表所示：

![](../../../../images/ee9c4856/caution_3.0-zh-cn.png) 
...
| RETURN\_TYPE | 类型为number，取值范围详见[ReturnType](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#returntype)。 | 可选 | 关键资产查询返回的结果类型。 |
...
![](../../../../images/5a8ecbe7/note_3.0-zh-cn.png) 
...
在指定群组中查询一条关键资产明文的使用示例详见[查询单条群组关键资产明文](/system-security/asset-store-kit/asset-arkts/asset-js-group-access-control#查询单条群组关键资产明文)，在指定群组中查询一条关键资产属性的使用示例详见[查询单条群组关键资产属性](/system-security/asset-store-kit/asset-arkts/asset-js-group-access-control#查询单条群组关键资产属性)。

在查询前，需确保已有关键资产，可参考[指南文档](/system-security/asset-store-kit/asset-arkts/asset-js-add)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。
