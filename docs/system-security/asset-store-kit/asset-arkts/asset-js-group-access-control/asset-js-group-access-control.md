...
- [新增关键资产(ArkTS)](/system-security/asset-store-kit/asset-arkts/asset-js-add)
- [删除关键资产(ArkTS)](/system-security/asset-store-kit/asset-arkts/asset-js-remove)
- [更新关键资产(ArkTS)](/system-security/asset-store-kit/asset-arkts/asset-js-update)
- [查询关键资产(ArkTS)](/system-security/asset-store-kit/asset-arkts/asset-js-query)
