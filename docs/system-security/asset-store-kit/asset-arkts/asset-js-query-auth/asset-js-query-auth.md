...
| 异步接口 | 同步接口 | 说明 |
| --- | --- | --- |
| [preQuery(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetprequery) | [preQuerySync(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetprequerysync12) | 查询预处理。 |
| [query(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetquery) | [querySync(query: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetquerysync12) | 查询关键资产。 |
| [postQuery(handle: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetpostquery) | [postQuerySync(handle: AssetMap)](/ref/system-security-api/asset-store-api/asset-store-arkts/js-apis-asset/js-apis-asset#assetpostquerysync12) | 查询后置处理。 |

查询需要用户认证的关键资产时，关键资产属性的内容（AssetMap）参数如下表所示：

![](../../../../images/ad80e085/caution_3.0-zh-cn.png) 
...
![](../../../../images/4f7ef400/note_3.0-zh-cn.png) 
...
在查询前，需确保已有需要用户认证的关键资产，可参考[指南文档](/system-security/asset-store-kit/asset-arkts/asset-js-add)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

查询别名是demo\_alias且需要用户认证的关键资产。示例中引入的@ohos.userIAM.userAuth用法详见userAuth文档中的[start](/ref/system-security-api/user-authentication-api/user-authentication-arkts/js-apis-useriam-userauth/js-apis-useriam-userauth#start10)接口。
