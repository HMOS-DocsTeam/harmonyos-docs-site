...
![](../../../../../images/0736703e/zh-cn_image_0000002552958362.png)

应用触发修改密码或使用已经保存过的账号手动登录时，均会触发密码更新功能。

登录的布局介绍请参考[账号密码登录](/system-security/passwordvault/passwordvault-apps/passwordvault-autosave/passwordvault-save-acc-password#账号密码登录)，以下仅介绍修改账号密码的标准适配场景。

****触发条件及注意事项同[账号密码保存](/system-security/passwordvault/passwordvault-apps/passwordvault-autosave/passwordvault-save-acc-password)功能。****

## 修改账号密码

![](../../../../../images/69357f81/zh-cn_image_0000002583478363.png)
