...
![](../../../../../images/8b044405/zh-cn_image_0000002583478361.png)
...
3. 密码保险箱的自动保存功能只适用于用户名和密码保存场景，在界面中必须同时存在用户名和密码的TextInput输入框组件。具体类型请参考[输入框类型说明](/system-security/passwordvault/passwordvault-apps/passwordvault-quick-adaptation#约束与限制)。
...
5. 页面跳转时触发保存功能。
6. 在只有type为InputType.USER\_NAME和InputType.Password的两个TextInput组件时，如果使用[账号密码填充-修改密码](/system-security/passwordvault/passwordvault-apps/passwordvault-autofill/passwordvault-autofill-acc-password#修改密码)自动填充了用户名和密码并没有修改，则不会触发保存和更新功能。

## 账号密码登录

![](../../../../../images/7902487c/zh-cn_image_0000002552798712.png)
...
![](../../../../../images/e36b6624/zh-cn_image_0000002583438407.png)
