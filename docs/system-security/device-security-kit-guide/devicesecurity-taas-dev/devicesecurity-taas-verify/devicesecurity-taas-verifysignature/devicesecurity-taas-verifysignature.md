...
如果需要在端侧校验安全图像数据或安全地理位置数据签名的有效性，可以使用[Crypto Architecture Kit](/system-security/crypto-architecture-kit/crypto-architecture-kit-intro)，使用方法请参考“[使用ECDSA密钥对签名验签](/system-security/crypto-architecture-kit/crypto-sign-sig-verify/crypto-sign-sig-verify-dev/crypto-ecdsa-sign-sig-verify)”章节。

![](../../../../../images/a3bc0d67/note_3.0-zh-cn.png) 

推荐开发者在服务器端完成安全图像或安全地理位置的签名验证，请参考“[Device Certificate Kit 设备真实性证明服务器端开发](/system-security/huks-kit/huks-local-key-management/device-attestation/device-attestation-guidelines/device-attestation-servers)”。
...
![](../../../../../images/8e29b23e/zh-cn_image_0000002583478389.png)
...
![](../../../../../images/513d1999/zh-cn_image_0000002552798740.jpg)
...
安全地理位置数据的结构请参考[TrustedAppService（可信应用服务）](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-taas-api/devicesecurity-taas-api)。
...
在安全摄像头场景和安全地理位置场景中，由于使用的是相同的证明密钥，因此签名验证的流程是一致的。结合“[安全摄像头场景](/system-security/device-security-kit-guide/devicesecurity-taas-dev/devicesecurity-taas-securecamera)”和“[安全地理位置场景](/system-security/device-security-kit-guide/devicesecurity-taas-dev/devicesecurity-taas-securelocation)”中获取到的原始数据和签名结果，验证签名的参考代码（不含异常处理逻辑，由开发者根据业务场景实现）如下：
