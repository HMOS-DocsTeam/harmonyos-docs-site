...
![](../../../images/27d63564/zh-cn_image_0000002583438425.jpg)
...
| 场景 | 国家/地区 |
| --- | --- |
| 应用设备状态检测 | 请参见[支持的国家/地区](/system-security/device-security-kit-guide/devicesecurity-appendix/devicesecurity-appendix-region)。 |
| 安全检测-系统完整性检测 | 只支持中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。 |
| 安全检测-URL检测 | 只支持中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。 |
| 安全检测-本地系统完整性检测 | 请参见[支持的国家/地区](/system-security/device-security-kit-guide/devicesecurity-appendix/devicesecurity-appendix-region)。 |
