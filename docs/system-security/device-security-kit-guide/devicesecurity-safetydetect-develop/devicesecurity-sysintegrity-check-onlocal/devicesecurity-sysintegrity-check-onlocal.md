...
![](../../../../images/8d5bb601/note_3.0-zh-cn.png) 
...
![](../../../../images/f2e489fb/zh-cn_image_0000002583478387.png)
...
![](../../../../images/c840f1a0/note_3.0-zh-cn.png) 
...
以下是系统完整性检测相关接口，包括ArkTS API，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrityonlocal)。

| 接口名 | 描述 |
| --- | --- |
| [checkSysIntegrityOnLocal](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrityonlocal)(): Promise&lt;string&gt; | 检测系统完整性 |

## 开发步骤

![](../../../../images/e0745ff1/note_3.0-zh-cn.png) 
...
3. 开发者应用可以根据检测结果进行业务处理，当本地系统完整性检测结果为false时，您可以根据自身功能对安全的要求决定是否提醒用户。
   ...
   ![](../../../../images/3bde9868/note_3.0-zh-cn.png) 
