...
![](../../../../images/4a4f7ea4/zh-cn_image_0000002552798736.png)
...
1. 开发者应用获取nonce。
   ...
   ![](../../../../images/d9b46c23/note_3.0-zh-cn.png) 
...
3. 当开发者应用发起业务请求时，在您的应用服务器中验证系统完整性增强检测结果。
   ...
   ![](../../../../images/518ddc6b/note_3.0-zh-cn.png) 
...
以下是系统完整性增强检测相关接口，包括ArkTS API，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrityenhanced)。

| 接口名 | 描述 |
| --- | --- |
| [checkSysIntegrityEnhanced](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrityenhanced)(req: [SysIntegrityRequest](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#sysintegrityrequest)): Promise&lt;[SysIntegrityResponse](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#sysintegrityresponse)&gt; | 增强检测系统完整性 |

## 开发步骤

![](../../../../images/46e20665/note_3.0-zh-cn.png) 

请确保已打开“[安全检测服务](/system-security/device-security-kit-guide/devicesecurity-prepare/devicesecurity-deviceverify-activateservice)”开关并[申请Profile](https://developer.huawei.com/consumer/cn/doc/app/agc-help-profile-0000002270709473)。
...
2. 调用接口获取系统完整性检测结果。
   ...
   ![](../../../../images/83e0ad38/caution_3.0-zh-cn.png) 
...
3. 在您的应用服务器中验证检测结果。
   ...
   ****JWS的Header字段如下****：
   ...
   ![](../../../../images/4c1ab459/note_3.0-zh-cn.png) 
   ...
   ****JWS的Payload字段如下****：
   ...
   ![](../../../../images/74cda308/note_3.0-zh-cn.png) 
   ...
   6. 从payload中获取完整性验证结果，当检测结果中basicIntegrity为false，detail字段会列出检测结果为false的原因，您可以根据自身功能对安全的要求决定是否提醒用户。
      ...
      ![](../../../../images/d0dfb8dd/caution_3.0-zh-cn.png) 
