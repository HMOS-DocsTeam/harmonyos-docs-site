...
![](../../../../images/eb8fe777/zh-cn_image_0000002583438431.png)
...
1. 开发者应用获取nonce。
   ...
   ![](../../../../images/b9721409/note_3.0-zh-cn.png) 
...
3. 当开发者应用发起业务请求时，在您的应用服务器中验证系统完整性检测结果。
   ...
   ![](../../../../images/22a28e22/note_3.0-zh-cn.png) 
...
以下是系统完整性检测相关接口，包括ArkTS API，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrity)。

| 接口名 | 描述 |
| --- | --- |
| [checkSysIntegrity](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#checksysintegrity)(req: [SysIntegrityRequest](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#sysintegrityrequest)): Promise&lt;[SysIntegrityResponse](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-safetydetectenhanced-api/devicesecurity-safetydetectenhanced-api#sysintegrityresponse)&gt; | 检测系统完整性 |

## 开发步骤

![](../../../../images/4dc9eb8c/note_3.0-zh-cn.png) 
...
2. 调用接口获取系统完整性检测结果。
   ...
   ![](../../../../images/f79195d8/caution_3.0-zh-cn.png) 
...
3. 在您的应用服务器中验证检测结果。
   ...
   ****JWS的Header字段如下****：
   ...
   ![](../../../../images/88dfe85d/note_3.0-zh-cn.png) 
   ...
   ****JWS的Payload字段如下****：
   ...
   ![](../../../../images/41e45a3e/note_3.0-zh-cn.png) 
   ...
   ![](../../../../images/ec18ab1c/caution_3.0-zh-cn.png) 
