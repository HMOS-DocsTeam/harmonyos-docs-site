...
在开通Device Security服务前，请先参考“[应用开发准备](/application-dev-overview)”完成基本准备工作，再继续进行以下开发活动。

![](../../../../images/38e5866b/note_3.0-zh-cn.png) 
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站，选择开发与服务。
   ...
   ![](../../../../images/c2abdbe4/zh-cn_image_0000002552958380.png)
2. 在项目列表中找到需要开通Device Security服务的项目。

   ![](../../../../images/1362cbf6/zh-cn_image_0000002583478381.png)
3. 选择“开放能力管理”Tab页，找到需要使用的功能，点击左侧的按钮，开通相应的功能。

   - ****应用设备状态检测****：勾选“应用设备状态检测”并点击“保存”，接入“应用设备状态检测”。

     ![](../../../../images/a4982710/zh-cn_image_0000002552798732.png)
   - ****安全检测****：勾选“安全检测服务”并点击“保存”，接入“安全检测服务”。

     ![](../../../../images/6d71b260/zh-cn_image_0000002583438427.png)
   - ****可信应用服务****：勾选“可信应用服务”并点击“保存”，接入“可信应用服务”。

     ![](../../../../images/87fc9f7f/note_3.0-zh-cn.png) 
     ...
     ![](../../../../images/f8920d99/zh-cn_image_0000002552958382.png)
   - ****业务风险检测-涉诈剧本检测****：点击“涉诈剧本检测”右侧申请按钮，接入“涉诈剧本检测”，审核通过后勾选对应服务并点击“保存”该服务配置。
     ...
     ![](../../../../images/490beb67/zh-cn_image_0000002583478383.png)

     ③ 参考“申请原因”中的模板，提供申请必需的相关信息，包含Developer ID、公司名称、应用名称、使用场景、使用该服务的合法基础（应用使用该服务时需在其隐私声明中进行个人数据声明及用途说明，详细参考[个人数据处理说明](/system-security/device-security-kit-guide/devicesecurity-personal-data)，并将合法基础的相关证明上传至申请附件），然后点击“提交”按钮。

     ![](../../../../images/c692bada/zh-cn_image_0000002552798734.png)

     ![](../../../../images/6e74c236/note_3.0-zh-cn.png) 
   ...
   - ****数字盾服务****：点击“数字盾服务”右侧申请按钮，接入“数字盾服务”，审核通过后勾选对应服务并点击“保存”该服务配置。
     ...
     ![](../../../../images/547f6a84/zh-cn_image_0000002583438429.png)

     ![](../../../../images/dcf4b7a5/note_3.0-zh-cn.png) 
...
4. 申请Profile（.p7b）文件，具体操作请参见[申请调试Profile](https://developer.huawei.com/consumer/cn/doc/app/agc-help-debug-profile-0000002248181278)。
   ...
   ![](../../../../images/6e3304eb/note_3.0-zh-cn.png) 
