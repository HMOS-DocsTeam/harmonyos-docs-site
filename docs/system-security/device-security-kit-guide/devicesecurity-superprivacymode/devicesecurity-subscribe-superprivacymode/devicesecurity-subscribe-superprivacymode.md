...
![](../../../../images/ddeed2f5/zh-cn_image_0000002552958406.png)
...
以下是超级隐私模式状态改变订阅与取消订阅接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api)。

| 接口名 | 描述 |
| --- | --- |
| on(type: 'superPrivacyModeChange', callback: Callback&lt;[SuperPrivacyMode](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api#superprivacymode)&gt;): void | 订阅超级隐私模式状态改变事件 |
| off(type: 'superPrivacyModeChange', callback?: Callback&lt;[SuperPrivacyMode](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api#superprivacymode)&gt;): void | 取消订阅超级隐私模式状态改变事件 |
