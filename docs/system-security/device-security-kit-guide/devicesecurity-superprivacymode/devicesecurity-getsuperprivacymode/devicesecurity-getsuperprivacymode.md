...
![](../../../../images/02b4e91b/zh-cn_image_0000002583438451.png)
...
以下是超级隐私模式状态查询接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api)。

| 接口名 | 描述 |
| --- | --- |
| [getSuperPrivacyMode](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api#getsuperprivacymode)() : Promise&lt;[SuperPrivacyMode](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-superprivacymode-api/devicesecurity-superprivacymode-api#superprivacymode)&gt; | 查询当前超级隐私模式状态 |
