...
![](../../../../images/da3fa73a/zh-cn_image_0000002583478403.png)
...
以下是获取诈骗通话记录相关接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-antifraudpicker-api/devicesecurity-antifraudpicker-api)。
...
![](../../../../images/ae9bd0bb/note_3.0-zh-cn.png) 

- 在开发准备过程中，需要申请权限：ohos.permission.USE\_FRAUD\_CALL\_LOG\_PICKER。
- 只允许清单内的应用申请该权限，申请方式请参考：[申请使用受限权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl)
