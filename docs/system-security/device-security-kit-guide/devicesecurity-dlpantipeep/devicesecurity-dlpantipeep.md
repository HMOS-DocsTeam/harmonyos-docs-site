...
![](../../../images/29c90693/zh-cn_image_0000002583438449.jpg)
...
以下是获取防窥状态信息相关接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-dlpantipeep-api/devicesecurity-dlpantipeep-api)。
...
![](../../../images/270ec6e3/note_3.0-zh-cn.png) 

- 在开发准备过程中，需要申请权限：ohos.permission.DLP\_GET\_HIDE\_STATUS；用于获取当前应用使用过程中被非机主本人窥视屏幕相关状态信息。
- 面向合作企业开放，仅在允许名单内的固定应用可申请该权限，申请方式请参考：[申请使用受限权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl)
