...
![](../../../images/419dc9c7/zh-cn_image_0000002552958404.png)

![](../../../images/03982d04/zh-cn_image_0000002583478405.png)

![](../../../images/9d563ead/zh-cn_image_0000002552798756.png)
...
以下是病毒防护服务管理的相关接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-c/devicesecurity-capi-index/devicesecurity-capi-securityantivirus/devicesecurity-capi-securityantivirus)。
...
![](../../../images/c6fad2c8/note_3.0-zh-cn.png) 
...
- 只允许名单内的应用申请该权限，申请方式请参考：[申请使用企业类应用可用权限](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-enterprise-apps)，[申请使用仅MDM应用可用权限](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-mdm-apps)
...
4. 零信任应用执行接口调用，查询当前所有在HarmonyOS安全防护服务中注册的三方EDR应用信息，需要ohos.permission.MANAGE\_ANTIVIRUS权限。
   ...
   ![](../../../images/13f9f2e7/caution_3.0-zh-cn.png) 
...
5. MDM应用执行接口调用，实现HarmonyOS安全防护服务的启停，需要ohos.permission.MANAGE\_PREINSTALLED\_ANTIVIRUS权限。
   ...
   ![](../../../images/df294431/caution_3.0-zh-cn.png) 
