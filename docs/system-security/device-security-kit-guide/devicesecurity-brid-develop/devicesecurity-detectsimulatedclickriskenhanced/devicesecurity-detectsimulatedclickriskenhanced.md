...
![](../../../../images/f9c75a63/zh-cn_image_0000002583438447.png)
...
1. 开发者应用获取nonce。
   ...
   ![](../../../../images/9450347c/note_3.0-zh-cn.png) 
...
以下是模拟点击增强检测相关接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-brid-api/devicesecurity-brid-api)。
...
3. 在开发者应用服务器中验证模拟点击增强检测结果。
   ...
   5. 从payload中获取模拟点击增强检测结果，格式和样例摘录如下：
      ...
      ****Header字段****
      ...
      ![](../../../../images/3db38b7a/note_3.0-zh-cn.png) 
      ...
      ****Payload字段****：
      ...
      ![](../../../../images/863619ac/note_3.0-zh-cn.png) 
