...
![](../../../../images/cfc95bdb/zh-cn_image_0000002583478401.png)
...
1. 开发者应用获取nonce。
   ...
   ![](../../../../images/226da095/note_3.0-zh-cn.png) 
...
以下是涉诈剧本检测相关接口，包括ArkTS API，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-brid-api/devicesecurity-brid-api)。
...
![](../../../../images/995659e0/note_3.0-zh-cn.png) 

请确保已打开“[涉诈剧本检测](/system-security/device-security-kit-guide/devicesecurity-prepare/devicesecurity-deviceverify-activateservice)”开关并[申请Profile](https://developer.huawei.com/consumer/cn/doc/app/agc-help-debug-profile-0000002248181278)。
...
3. 在开发者应用服务器中验证检测结果。
   ...
   5. 从payload中获取涉诈剧本检测结果，格式和样例摘录如下：
      ...
      ****Header字段如下：****
      ...
      ![](../../../../images/d0908cb0/note_3.0-zh-cn.png) 
      ...
      ****Payload字段如下：****
      ...
      ![](../../../../images/f18b64df/note_3.0-zh-cn.png) 
