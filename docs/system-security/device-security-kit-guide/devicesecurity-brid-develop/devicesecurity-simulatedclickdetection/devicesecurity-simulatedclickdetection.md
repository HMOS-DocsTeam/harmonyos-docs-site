...
![](../../../../images/0553ac28/zh-cn_image_0000002552798752.png)
...
以下是模拟点击检测相关接口，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-brid-api/devicesecurity-brid-api)。
...
3. 开发者应用可以根据模拟点击检测结果进行业务处理。
   ...
   ![](../../../../images/9cef72b5/note_3.0-zh-cn.png) 
