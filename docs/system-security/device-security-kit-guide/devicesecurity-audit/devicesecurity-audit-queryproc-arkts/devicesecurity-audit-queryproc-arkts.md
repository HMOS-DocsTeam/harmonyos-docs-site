...
![](../../../../images/df724061/zh-cn_image_0000002583438445.png)
...
接口如下表，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-securityaudit-api/devicesecurity-securityaudit-api#queryallprocesses)。
...
![](../../../../images/642c3477/note_3.0-zh-cn.png) 
