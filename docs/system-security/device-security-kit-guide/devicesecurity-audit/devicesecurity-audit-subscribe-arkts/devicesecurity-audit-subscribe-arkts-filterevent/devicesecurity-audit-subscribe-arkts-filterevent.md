...
![](../../../../../images/d8d05f37/zh-cn_image_0000002583478399.png)
...
7. 当开发者应用不需要使用当前实例时，开发者可以删除实例。
   ...
   ![](../../../../../images/81299954/note_3.0-zh-cn.png) 
...
更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-securityaudit-api/devicesecurity-securityaudit-api#newclient)。
...
![](../../../../../images/03c61dbe/note_3.0-zh-cn.png) 

- 在开发准备过程中，需要申请权限：ohos.permission.QUERY\_AUDIT\_EVENT。
- 只允许清单内的企业类应用申请该权限，申请方式请参考：[申请使用企业类应用可用权限](/system-security/access-control/app-permission-mgmt/app-permissions/permissions-for-enterprise-apps)。
