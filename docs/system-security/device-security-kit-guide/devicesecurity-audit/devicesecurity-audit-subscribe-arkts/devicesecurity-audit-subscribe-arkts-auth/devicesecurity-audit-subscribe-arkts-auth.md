...
title: "订阅阻断类事件"
sidebar_position: 2
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-audit-subscribe-arkts-auth
kit: system/security
...
![](../../../../../images/d511f859/zh-cn_image_0000002552798750.png)
...
8. 当业务结束时，开发者可以删除步骤1中创建的实例。
   ...
   ![](../../../../../images/ebd981c7/note_3.0-zh-cn.png) 
...
更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-arktsapi/devicesecurity-securityaudit-api/devicesecurity-securityaudit-api#newauthclient)。
...
![](../../../../../images/09eed907/note_3.0-zh-cn.png) 
