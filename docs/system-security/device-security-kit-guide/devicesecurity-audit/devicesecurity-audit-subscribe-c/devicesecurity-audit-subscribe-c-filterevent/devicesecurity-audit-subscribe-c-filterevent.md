...
![](../../../../../images/d91d8a43/zh-cn_image_0000002583478399.png)
...
7. 当开发者应用不需要使用当前实例时，开发者可以删除实例。
   ...
   ![](../../../../../images/00a47bb1/note_3.0-zh-cn.png) 
...
接口如下表，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-c/devicesecurity-capi-index/devicesecurity-capi-securityaudit/devicesecurity-capi-securityaudit#hms_securityaudit_newclient)。
...
![](../../../../../images/7cf2f4a9/note_3.0-zh-cn.png) 
