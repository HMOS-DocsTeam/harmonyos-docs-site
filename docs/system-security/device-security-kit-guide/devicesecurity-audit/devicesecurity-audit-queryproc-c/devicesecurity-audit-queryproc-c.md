...
![](../../../../images/59030dcd/zh-cn_image_0000002552958400.png)
...
接口如下表，更多接口及使用方法请参见[API参考](/ref/system-security-api/device-security-api/devicesecurity-c/devicesecurity-capi-index/devicesecurity-capi-securityaudit/devicesecurity-capi-securityaudit#hms_securityaudit_queryallprocesses)。
...
![](../../../../images/2247cca6/note_3.0-zh-cn.png) 
...
3. 开发者根据实际场景，获取单个或所有应用进程信息。
   ...
   ![](../../../../images/b708c983/note_3.0-zh-cn.png) 
