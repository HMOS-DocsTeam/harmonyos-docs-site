...
![](../../../../images/296988a8/note_3.0-zh-cn.png) 
...
详细接口说明可参考[@ohos.security.certManagerDialog (证书管理对话框模块)](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-certmanagerdialog/js-apis-certmanagerdialog)。
