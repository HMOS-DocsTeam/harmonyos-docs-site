...
![](../../../images/610d4024/zh-cn_image_0000002583478377.png)

### 与相关Kit的关系

证书算法库的功能使用时，涉及公钥的生成和获取，这部分依赖[Crypto Architecture Kit](/system-security/crypto-architecture-kit/crypto-architecture-kit-intro)加解密算法框架服务的能力。
...
证书管理的功能使用时，涉及凭据的安装和使用，这部分依赖[Universal Keystore Kit](/system-security/huks-kit/huks-overview)密钥管理服务的能力。
