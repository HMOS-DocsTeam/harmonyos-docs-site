...
1. 导入[证书算法库框架模块](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert)。
   ...
   ```
2. 签名的开发步骤查看[CMS签名](/system-security/device-certificate-kit/certificate-framework/create-cms-sign-object)。
...
5. 调用[cmsParser.verifySignedData](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#verifysigneddata22)进行验签。
