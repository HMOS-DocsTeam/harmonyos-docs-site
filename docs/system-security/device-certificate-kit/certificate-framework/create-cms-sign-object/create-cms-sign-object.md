...
3. 调用[cmsGenerator.addSigner](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#addsigner18)添加签名者信息。
4. 调用[cmsGenerator.addCert](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#addcert18)添加证书。
5. 调用[cmsGenerator.doFinal](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#dofinal18)获取Cms最终签名数据。
