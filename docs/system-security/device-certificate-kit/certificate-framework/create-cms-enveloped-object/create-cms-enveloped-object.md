...
1. 导入[证书算法库框架模块](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert)。
   ...
   ```
2. 调用[cert.createCmsGenerator](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#certcreatecmsgenerator18)创建cmsGenerator对象。
3. 调用[cmsGenerator.setRecipientEncryptionAlgorithm](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#setrecipientencryptionalgorithm22)设置加密算法。
4. 调用[cmsGenerator.addRecipientInfo](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#addrecipientinfo22)添加接收者信息。
5. 调用[cmsGenerator.doFinal](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#dofinal18)获取CMS最终封装数据。
6. 调用[cmsGenerator.getEncryptedContentData](/ref/system-security-api/device-certificate-api/device-certificate-arkts/js-apis-cert/js-apis-cert#getencryptedcontentdata22)获取CMS封装密文数据。
