...
![](../../../../images/e24bf859/zh-cn_image_0000002552958418.png)

## 示例

具体参数、使用方式等信息，请参考对应的[@ohos.userIAM.userAuthIcon (嵌入式用户身份认证控件)](/ref/system-security-api/user-authentication-api/user-authentication-comp/ohos-useriam-userauthicon/ohos-useriam-userauthicon)。
