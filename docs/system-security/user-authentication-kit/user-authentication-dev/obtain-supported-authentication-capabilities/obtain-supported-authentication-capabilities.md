...
具体参数、返回值、错误码等描述，请参考对应的[userAuth.getAvailableStatus](/ref/system-security-api/user-authentication-api/user-authentication-arkts/js-apis-useriam-userauth/js-apis-useriam-userauth#userauthgetavailablestatus9)。
