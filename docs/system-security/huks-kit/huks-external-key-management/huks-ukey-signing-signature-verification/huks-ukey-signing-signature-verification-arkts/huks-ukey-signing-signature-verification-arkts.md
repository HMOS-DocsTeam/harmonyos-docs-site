...
2. 指定待签名的明文数据。
3. 获取属性参数[HuksOptions](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksoptions)，包括两个字段properties和inData。inData传入明文数据，properties传入算法参数配置。
...
2. 获取待验证的签名。
3. 获取属性参数[HuksOptions](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksoptions)，包括两个字段properties和inData。inData传入签名signature，properties传入算法参数配置。
4. 调用[initSession](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksinitsession9)初始化密钥会话，并获取会话的句柄handle。
