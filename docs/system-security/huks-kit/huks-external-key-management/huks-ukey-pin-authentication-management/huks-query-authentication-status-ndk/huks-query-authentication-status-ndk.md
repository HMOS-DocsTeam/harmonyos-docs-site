...
2. 调用[OH\_Huks\_InitExternalCryptoParamSet](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-external-crypto-api-h/capi-native-huks-external-crypto-api-h#oh_huks_initexternalcryptoparamset)指定参数配置。
3. 调用[OH\_Huks\_GetUkeyPinAuthState](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-external-crypto-api-h/capi-native-huks-external-crypto-api-h#oh_huks_getukeypinauthstate)获取PIN码认证状态。
