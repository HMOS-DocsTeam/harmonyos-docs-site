...
![](../../../../../images/b8531a38/note_3.0-zh-cn.png) 

1. Provider名称建议包含厂商信息，全局唯一。
2. Provider名称长度最大为128字节。
3. Provider注册和注销有权限管控，需申请[ohos.permission.CRYPTO\_EXTENSION\_REGISTER](/system-security/access-control/app-permission-mgmt/app-permissions/restricted-permissions#ohospermissioncrypto_extension_register)权限。
