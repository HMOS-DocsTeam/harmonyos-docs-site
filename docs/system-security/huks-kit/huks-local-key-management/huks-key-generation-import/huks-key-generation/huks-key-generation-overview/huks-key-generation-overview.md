...
![](../../../../../../images/9b0c88b8/note_3.0-zh-cn.png) 

- 密钥别名长度最大为128字节。
- 密钥别名中禁止包含个人数据等敏感信息。不建议包含加密算法、密钥长度、加密模式等信息。
- 使用当前业务已有的密钥别名作为生成的密钥别名默认会把现有密钥覆盖，可以使用[HUKS\_TAG\_KEY\_OVERRIDE](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukstag)指定当密钥别名冲突时返回错误。
...
![](../../../../../../images/98779fcb/note_3.0-zh-cn.png) 
...
![](../../../../../../images/d616acc5/note_3.0-zh-cn.png) 
