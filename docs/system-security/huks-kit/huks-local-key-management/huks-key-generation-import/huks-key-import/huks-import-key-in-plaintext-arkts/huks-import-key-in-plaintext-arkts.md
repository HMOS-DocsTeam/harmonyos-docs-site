...
分别以导入AES256、RSA2048和X25519密钥为例。具体的场景介绍及支持的算法规格，请参考[密钥导入支持的算法](/system-security/huks-kit/huks-local-key-management/huks-key-generation-import/huks-key-import/huks-key-import-overview#支持的算法)。
...
2. 封装密钥属性集和密钥材料。
   ...
   - 密钥属性集同样与密钥生成中指定的密钥属性一致，须包含[HuksKeyAlg](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukskeyalg)、[HuksKeySize](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukskeysize)、[HuksKeyPurpose](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukskeypurpose)属性。
   - 密钥材料须符合[HUKS密钥材料格式](/system-security/huks-kit/huks-local-key-management/huks-concepts#密钥材料格式)，并以Uint8Array形式赋值给[HuksOptions](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksoptions)的inData字段。
3. 调用[huks.importKeyItem](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksimportkeyitem9)，传入密钥别名和密钥属性集，即可导入密钥。

   HuksParam和HuksOptions的含义参考：[HuksParam](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksparam) 和 [HuksOptions](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksoptions)
...
调用[huks.isKeyItemExist](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksiskeyitemexist9)验证密钥是否存在，如密钥存在即表示密钥导入成功。
