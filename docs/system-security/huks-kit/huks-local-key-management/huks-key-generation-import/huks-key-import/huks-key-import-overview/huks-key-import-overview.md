...
![](../../../../../../images/5520649a/note_3.0-zh-cn.png) 
...
- 不推荐使用该方式导入的密钥类型：对称密钥、非对称密钥对。
  ...
  ![](../../../../../../images/cdf40fe4/note_3.0-zh-cn.png) 
...
![](../../../../../../images/cdfeebc4/zh-cn_image_0000002552798762.png)
...
导出密钥接口返回的[公钥明文材料是按照****X.509****格式封装](/system-security/huks-kit/huks-local-key-management/huks-concepts#公钥材料格式)，导入加密密钥接口中的密钥材料需满足****LengthData-Data****的格式封装，形如：[(Lengthpart1Datapart1)……(LengthpartnDatapartn)]。

![](../../../../../../images/7e46a55e/note_3.0-zh-cn.png) 

1. 安全导入密钥时，协商算法支持ECDH和X25519，协商后的Shared\_Key使用AES-GCM算法加密Caller\_Kek。对应算法套件定义见[HuksUnwrapSuite](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksunwrapsuite9)。
2. 安全导入不支持X.509格式。
...
从API 23开始支持[数字信封](/system-security/huks-kit/huks-local-key-management/huks-key-generation-import/huks-key-import/huks-key-import-overview#数字信封导入)特性。
...
![](../../../../../../images/7d633f5d/zh-cn_image_0000002583438457.png)
...
导出密钥接口返回的[公钥材料格式](/system-security/huks-kit/huks-local-key-management/huks-concepts#公钥材料格式)按照X.509格式封装，导入加密密钥接口返回的密钥材料按照****LengthData-Data****的格式封装，分别是[(LengthEncSm4DataEncSm4)(LengthEncImpKeyDataEncImpKey)]。

![](../../../../../../images/e4cf2d54/note_3.0-zh-cn.png) 
...
![](../../../../../../images/bb60dffc/note_3.0-zh-cn.png) 
...
| --- | --- | --- |
| 对称密钥 | - | 密钥字节数据 |
| 非对称密钥-密钥对 | - | [密钥对材料格式](/system-security/huks-kit/huks-local-key-management/huks-concepts#密钥对材料格式) |
| 非对称密钥-公钥 | ED25519、X25519 | 密钥字节数据，参考[导入X25519密钥公钥](/system-security/huks-kit/huks-local-key-management/huks-key-generation-import/huks-key-import/huks-import-key-in-plaintext-arkts#导入x25519密钥公钥) |
