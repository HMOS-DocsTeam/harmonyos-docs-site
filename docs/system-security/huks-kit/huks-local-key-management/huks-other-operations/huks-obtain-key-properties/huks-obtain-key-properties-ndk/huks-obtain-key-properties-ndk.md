...
![](../../../../../../images/34b702cc/note_3.0-zh-cn.png) 
...
1. 构造对应参数。
   ...
   - paramSetOut：用于放置获取到的参数集结果，为[OH\_Huks\_ParamSet](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-struct/capi-hukstypeapi-oh-huks-paramset/capi-hukstypeapi-oh-huks-paramset)类型对象，需要业务提前申请好内存，需申请足够容纳获取到的密钥属性集的内存大小。
