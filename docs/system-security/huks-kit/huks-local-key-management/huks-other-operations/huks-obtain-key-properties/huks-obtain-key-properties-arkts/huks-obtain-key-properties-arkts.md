...
![](../../../../../../images/50d1ee95/note_3.0-zh-cn.png) 
...
2. 调用接口[getKeyItemProperties](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksgetkeyitemproperties9)，传入参数keyAlias和options。options为预留参数，当前可传入空。
3. 返回值为[HuksReturnResult](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksreturnresult9)类型对象，获取的属性集在properties字段中。
