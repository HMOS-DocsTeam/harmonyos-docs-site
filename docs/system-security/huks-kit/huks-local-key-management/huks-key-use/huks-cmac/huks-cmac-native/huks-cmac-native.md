...
![](../../../../../../images/b8578f22/note_3.0-zh-cn.png) 
...
1. 获取生成密钥算法参数配置。
2. 调用[OH\_Huks\_GenerateKeyItem](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-api-h/capi-native-huks-api-h#oh_huks_generatekeyitem)生成密钥，支持的规格是128比特长度的密钥。
...
1. 调用[OH\_Huks\_InitParamSet](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-param-h/capi-native-huks-param-h#oh_huks_initparamset)获取算法参数配置。
2. 调用[OH\_Huks\_InitSession](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-api-h/capi-native-huks-api-h#oh_huks_initsession)和[OH\_Huks\_FinishSession](/ref/system-security-api/universal-keystore-api/universal-keystore-c/universal-keystore-headerfile/capi-native-huks-api-h/capi-native-huks-api-h#oh_huks_finishsession)计算MAC值。
