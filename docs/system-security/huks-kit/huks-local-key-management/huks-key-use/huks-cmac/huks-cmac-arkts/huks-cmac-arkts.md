...
![](../../../../../../images/76073bf6/note_3.0-zh-cn.png) 
...
1. 获取生成密钥算法参数配置。
2. 调用[generateKeyItem](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksgeneratekeyitem9)生成密钥，支持的规格是128比特长度的密钥。
...
3. 调用[finishSession](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksfinishsession9)结束密钥会话，获取MAC数据。
