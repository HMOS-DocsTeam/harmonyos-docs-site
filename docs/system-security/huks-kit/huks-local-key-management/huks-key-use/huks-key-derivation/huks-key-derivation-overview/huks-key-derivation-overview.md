...
![](../../../../../../images/c156be07/note_3.0-zh-cn.png) 
...
派生密钥是业务基于三段式得到密钥会话结果，业务可决定派生密钥是否由HUKS管理（即密钥不出[TEE](/system-security/huks-kit/huks-local-key-management/huks-concepts#可信执行环境tee)）亦或是业务独立管理。

![](../../../../../../images/c07d5de1/note_3.0-zh-cn.png) 

PBKDF2/HKDF仅支持HUKS托管密钥的派生，不支持直接基于非HUKS托管的密钥进行派生，如：用户的口令，密钥托管参考[密钥导入](/system-security/huks-kit/huks-local-key-management/huks-key-generation-import/huks-key-import/huks-key-import-overview)。
