...
以AES128、RSA2048、SM2和DES64为例，完成加解密。具体的场景介绍及支持的算法规格，请参考[加解密支持的算法](/system-security/huks-kit/huks-local-key-management/huks-key-use/huks-encryption-decryption/huks-encryption-decryption-overview#支持的算法)。
...
1. 获取密钥别名。
2. 获取待加密的数据。
3. 使用[HuksParam](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksparam)设置加密算法参数配置。
   ...
   详细规格请参考[加密/解密介绍及算法规格](/system-security/huks-kit/huks-local-key-management/huks-key-use/huks-encryption-decryption/huks-encryption-decryption-overview)。
...
5. 调用[finishSession](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksfinishsession9)结束密钥会话，获取加密后的密文。

****解密****

1. 获取密钥别名。
2. 获取待解密的密文。
3. 使用[HuksParam](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksparam)设置解密算法参数配置。
   ...
   详细规格请参考[加密/解密介绍及算法规格](/system-security/huks-kit/huks-local-key-management/huks-key-use/huks-encryption-decryption/huks-encryption-decryption-overview)。
4. 调用[initSession](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksinitsession9)初始化密钥会话，并获取会话的句柄handle。
5. 调用[finishSession](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksfinishsession9)结束密钥会话，获取解密后的数据。
