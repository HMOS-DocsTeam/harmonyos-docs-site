...
2. 初始化参数集。
   ...
   [HuksOptions](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksoptions)中的properties字段中的参数必须包含[HUKS\_TAG\_ATTESTATION\_CHALLENGE](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukstag)属性,可选参数包含[HUKS\_TAG\_ATTESTATION\_ID\_VERSION\_INFO](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukstag)，[HUKS\_TAG\_ATTESTATION\_ID\_ALIAS](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#hukstag)属性。
3. 生成非对称密钥，具体请参考[密钥生成](/system-security/huks-kit/huks-local-key-management/huks-key-generation-import/huks-key-generation/huks-key-generation-overview)。
4. 将密钥别名与参数集作为参数传入[anonAttestKeyItem](/ref/system-security-api/universal-keystore-api/universal-keystore-arkts/js-apis-huks/js-apis-huks#huksanonattestkeyitem11)方法中，即可证明密钥。
