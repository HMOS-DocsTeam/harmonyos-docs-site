...
![](../../../images/2600d86a/zh-cn_image_0000002583438453.png)
...
| 接口名 | 描述 |
| --- | --- |
| [generateAppSecureKey](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#generateappsecurekey)(keyType: [KeyType](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#keytype)): Promise&lt;Uint8Array&gt; | 生成应用密钥。 |
| [generateAuthKey](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#generateauthkey)(keyAlias: string, keyType: [KeyType](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#keytype)): Promise&lt;[SignedResult](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#signedresult)&gt; | 生成认证密钥。 |
| [generateChallengeSync](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#generatechallengesync)(keyAlias: string): Uint8Array | 生成Challenge。 |
| [signWithAuthKeySync](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#signwithauthkeysync)(keyAlias: string, authToken: Uint8Array, info: string): [SignedResult](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#signedresult) | 使用认证密钥对业务数据签名。 |
| [deleteAuthKey](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-soter-api/onlineauthentication-soter-api#deleteauthkey)(keyAlias: string): Promise&lt;void&gt; | 删除认证密钥。 |
