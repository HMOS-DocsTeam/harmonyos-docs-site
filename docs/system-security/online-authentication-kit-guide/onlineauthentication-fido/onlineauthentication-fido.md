...
![](../../../images/295f050c/zh-cn_image_0000002583478407.png)
...
| 接口名 | 描述 |
| --- | --- |
| [discover](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#discover)(context: common.Context): Promise&lt;[DiscoveryData](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#discoverydata)&gt; | 发现设备的认证能力，返回当前设备软件支持的认证器数据。 |
| [checkPolicy](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#checkpolicy)(context: common.Context, uafRequest: [UAFMessage](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#uafmessage)): Promise&lt;void&gt; | 检测用户策略的开启状态。 |
| [processUAFOperation](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#processuafoperation)(context: common.Context, uafRequest: [UAFMessage](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#uafmessage), channelBindings?: [ChannelBinding](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#channelbinding)): Promise&lt;[UAFMessage](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#uafmessage)&gt; | 用户UAF操作接口，处理UAF协议消息。 |
| [notifyUAFResult](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#notifyuafresult)(context: common.Context, uafResponse: [UAFMessage](/ref/system-security-api/online-authentication-api/onlineauthentication_arkts/onlineauthentication-fido-api/onlineauthentication-fido-api#uafmessage)): Promise&lt;void&gt; | 开通结果通知接口。 |
