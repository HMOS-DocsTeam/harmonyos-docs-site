...
![](../../../../images/d91383b5/note_3.0-zh-cn.png) 
...
2. （可选）调用[OH\_CryptoRand\_SetSeed](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-rand-h/capi-crypto-rand-h#oh_cryptorand_setseed)，为随机数生成器设置种子。
3. 调用[OH\_CryptoRand\_GenerateRandom](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-rand-h/capi-crypto-rand-h#oh_cryptorand_generaterandom)，生成指定长度的安全随机数。指定字节长度范围为1~INT\_MAX。
4. 调用[OH\_CryptoRand\_GetAlgoName](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-rand-h/capi-crypto-rand-h#oh_cryptorand_getalgoname)，获取随机数生成器使用的算法名称。
