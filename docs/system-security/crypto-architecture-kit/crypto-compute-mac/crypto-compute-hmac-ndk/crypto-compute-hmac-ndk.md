...
2. 调用[OH\_CryptoMac\_Create](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-mac-h/capi-crypto-mac-h#oh_cryptomac_create)，指定字符串参数'HMAC'，创建MAC算法为HMAC的MAC生成器。
3. 调用[OH\_CryptoMac\_SetParam](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-mac-h/capi-crypto-mac-h#oh_cryptomac_setparam)，指定参数CRYPTO\_MAC\_DIGEST\_NAME\_STR，设置摘要算法名称。
