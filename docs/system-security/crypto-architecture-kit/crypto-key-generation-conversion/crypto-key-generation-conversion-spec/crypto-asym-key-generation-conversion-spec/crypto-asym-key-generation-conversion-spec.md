...
![](../../../../../images/3a64fc5e/note_3.0-zh-cn.png) 
...
![](../../../../../images/015a0db3/caution_3.0-zh-cn.png) 
...
![](../../../../../images/009ccce9/caution_3.0-zh-cn.png) 
...
![](../../../../../images/e440d311/note_3.0-zh-cn.png) 

- 当前ECC只支持Fp域，因此fieldType固定为"Fp"。fieldType和p构成了属性field，当前field只支持[ECFieldFp](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#ecfieldfp10)。
- g和pk为ECC曲线上的点，属于[Point](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#point10)类型，需要指定具体的X和Y坐标。

### 使用曲线名生成密钥参数

从API版本11开始，支持使用曲线名来生成ECC公共密钥参数。

![](../../../../../images/05e2a866/note_3.0-zh-cn.png) 
...
![](../../../../../images/1ef5f25d/caution_3.0-zh-cn.png) 
...
![](../../../../../images/ff0f68bc/note_3.0-zh-cn.png) 
...
![](../../../../../images/a556574c/note_3.0-zh-cn.png) 

- 当前SM2只支持Fp域，因此fieldType固定为"Fp"。fieldType和p构成了属性field，当前field只支持[ECFieldFp](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#ecfieldfp10)。
- g和pk为SM2曲线上的点，属于[Point](/ref/system-security-api/crypto-architecture-api/crypto-architecture-arkts/js-apis-cryptoframework/js-apis-cryptoframework#point10)类型，需要指定具体X，Y坐标。

### 使用曲线名生成密钥参数

从API版本11开始，支持使用曲线名称生成SM2公钥参数。

![](../../../../../images/a73bff55/note_3.0-zh-cn.png) 
...
![](../../../../../images/2ced1b05/note_3.0-zh-cn.png) 
...
![](../../../../../images/a91bf724/note_3.0-zh-cn.png) 
...
![](../../../../../images/579ddf81/caution_3.0-zh-cn.png) 
