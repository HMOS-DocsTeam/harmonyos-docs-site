...
1. 指定uint8\_t类型的ECC非压缩点数据，调用[OH\_CryptoEcPoint\_Create](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-asym-key-h/capi-crypto-asym-key-h#oh_cryptoecpoint_create)，构造[OH\_CryptoEcPoint](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-struct/capi-cryptoasymkeyapi-oh-cryptoecpoint/capi-cryptoasymkeyapi-oh-cryptoecpoint)对象，用于生成点数据。
2. 调用[OH\_CryptoEcPoint\_Encode](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-asym-key-h/capi-crypto-asym-key-h#oh_cryptoecpoint_encode)，获取压缩点数据。
...
1. 指定uint8\_t类型的ECC压缩点数据，调用[OH\_CryptoEcPoint\_Create](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-asym-key-h/capi-crypto-asym-key-h#oh_cryptoecpoint_create)，构造[OH\_CryptoEcPoint](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-struct/capi-cryptoasymkeyapi-oh-cryptoecpoint/capi-cryptoasymkeyapi-oh-cryptoecpoint)对象，用于生成点数据。
2. 调用[OH\_CryptoEcPoint\_Encode](/ref/system-security-api/crypto-architecture-api/crypto-architecture-c/crypto-architecture-headerfile/capi-crypto-asym-key-h/capi-crypto-asym-key-h#oh_cryptoecpoint_encode)，获取非压缩点数据。
