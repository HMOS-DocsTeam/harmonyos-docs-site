...
当前仅少量符合特殊场景的应用可在通过审批后，使用受限权限，其申请方式请参考：[申请使用受限权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl)。

![](../../../../../images/a0e5d5e9/note_3.0-zh-cn.png) 
...
![](../../../../../images/6a242036/note_3.0-zh-cn.png) 
...
****其他场景下的使用方案：**** 使用“联系人Picker”访问联系人数据，使用方式请参考：[使用Picker选择联系人](/contacts-kit/contacts-intro#使用picker选择联系人)。
...
****其他场景下的使用方案：**** 使用“AudioPicker”访问用户音频文件，使用方式请参考：[选择音频类文件（FilePicker）](/core-file-kit/user-files/select-save-user-file/select-user-file#选择音频类文件)。
...
****其他场景下的使用方案：**** 使用“AudioPicker”保存用户音频文件，使用方式请参考：[保存音频类文件（FilePicker）](/core-file-kit/user-files/select-save-user-file/save-user-file#保存音频类文件)。
...
****其他场景下的使用方案：**** 使用“PhotoViewPicker”访问用户图片或视频，使用方式请参考：[使用Picker选择媒体库资源](/medialibrary-kit/photoaccesshelper-photoviewpicker)。
...
****其他场景下的使用方案：**** 使用安全控件或授权弹窗的方式，将用户指定的媒体资源保存到图库中，使用方式请参考：[保存媒体库资源](/medialibrary-kit/photoaccesshelper-savebutton)。
...
- PC/2in1设备上的应用均可申请。
  ...
  ![](../../../../../images/9c713f1d/note_3.0-zh-cn.png) 
...
****其他场景下的使用方案：**** 使用“粘贴控件”读取剪贴板数据，使用方式请参考：[使用粘贴控件](/system-security/access-control/security-components/pastebutton)。
...
![](../../../../../images/5d9e2eab/note_3.0-zh-cn.png) 

该权限级别发生变更，API 12后仍需采用[受限权限申请方式](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions-in-acl)申请使用该权限。
...
通过BLE扫描、BR扫描或连接监听获取到对端蓝牙设备MAC对应的虚拟地址，申请该权限且调用[access.addPersistentDeviceId](/ref/system-network-api/connectivity-api/connectivity-arkts/js-apis-bluetooth-access/js-apis-bluetooth-access#accessaddpersistentdeviceid16)方法后，可保持该虚拟地址长时间存储，即使是开/关/重启蓝牙也不发生变化。
...
****携带额外数据****：是，配置方法请见[Driver Development Kit开发指导](/system-hardware/driver-development-kit/development-of-basic-drivers/externaldevice-guidelines#应用签名)。
