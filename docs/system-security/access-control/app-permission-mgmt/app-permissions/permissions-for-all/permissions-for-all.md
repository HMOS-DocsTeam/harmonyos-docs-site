...
以下权限的授权方式均为[system\_grant](/system-security/access-control/app-permission-mgmt/app-permission-mgmt-overview#system_grant系统授权)，申请方式请参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。
