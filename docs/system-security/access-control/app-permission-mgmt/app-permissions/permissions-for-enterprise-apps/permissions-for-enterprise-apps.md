...
企业类应用可参考[声明权限](/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)，申请以下权限。

![](../../../../../images/17d639e7/caution_3.0-zh-cn.png) 

以下权限不支持自动签名，因此在调试和发布阶段，均需参照[手动签名](/ide-signing#section297715173233)的步骤，完成手动签名。
