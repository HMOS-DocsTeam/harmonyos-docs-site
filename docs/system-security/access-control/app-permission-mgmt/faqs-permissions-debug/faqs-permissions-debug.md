...
以[tcpdump工具](https://gitcode.host/OpenHarmonyToolkitsPlaza/tcpdump)为例，使用[二进制签名工具](/system-debug-optimize/debugging-commands/binary-sign-tool)签名时在module.json文件中配置ohos.permission.kernel.NET\_RAW权限。
...
以[lldb高性能调试器](/debugging-profiling/debug-lldb)为例，使用[二进制签名工具](/system-debug-optimize/debugging-commands/binary-sign-tool)签名时在module.json文件中配置ohos.permission.kernel.DEBUGGER权限。
