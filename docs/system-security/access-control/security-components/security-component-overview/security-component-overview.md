...
- [粘贴控件（PasteButton）](/system-security/access-control/security-components/pastebutton)

  该控件对应剪贴板读取特权。应用集成粘贴控件后，用户点击该控件，应用读取剪贴板数据时不会弹窗提示，进入后台10秒后应用权限被回收。

  建议使用场景：粘贴控件可以用于任何应用需要读取剪贴板的场景，避免弹窗提示对用户造成干扰。
- [保存控件（SaveButton）](/system-security/access-control/security-components/savebutton)
...
![](../../../../images/9b453ebb/zh-cn_image_0000002583478359.png)
...
![](../../../../images/b6ac38b2/note_3.0-zh-cn.png) 
