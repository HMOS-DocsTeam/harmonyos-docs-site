...
![](../../../../images/efcc168e/zh-cn_image_0000002552798710.gif)
...
2. 添加输入框和粘贴控件。
   ...
   当前示例使用了默认参数。具体详情，请参见[PasteButton控件](/ref/arkui-api/arkui-declarative-comp/arkui-security/ts-security-components-pastebutton/ts-security-components-pastebutton)。此外，所有安全控件均继承了[安全控件通用属性](/ref/arkui-api/arkui-declarative-comp/arkui-security/ts-securitycomponent-attributes/ts-securitycomponent-attributes)，可用于自定义样式。
