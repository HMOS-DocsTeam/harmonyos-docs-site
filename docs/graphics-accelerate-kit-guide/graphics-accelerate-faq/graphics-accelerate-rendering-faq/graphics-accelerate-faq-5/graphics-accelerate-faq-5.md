...
为解决此问题，需要通过[HMS\_ABR\_GetScaledTexture\_GLES](/ref/graphics-accelerate-api/graphics_accelerate_c_api/index/x_graphics_accelerate/x_graphics_accelerate#hms_abr_getscaledtexture_gles)接口获取到ABR自适应缩放后的GLES纹理索引。
