...
- 在游戏资源包下载的[onDownloadContentRequest](/ref/graphics-accelerate-api/graphics-accelerate-arkts/graphics-accelerate-extensionability/graphics-accelerate-extensionability#ondownloadcontentrequest)生命周期函数中：
  ...
  4. 把需要下载的资源列表信息转换成游戏资源包下载的[AssetDownloadConfig](/ref/graphics-accelerate-api/graphics-accelerate-arkts/graphics-accelerate-assetdownloadmanager/graphics-accelerate-assetdownloadmanager#assetdownloadconfig)对象返回给系统。
  5. 把catalog.json，catalog.hash以及GroupData.json文件存放在Addressables目标目录下，目录地址参考如下：
     ...
     ```
- 在游戏资源包下载的[onBackgroundDownloadSucceeded](/ref/graphics-accelerate-api/graphics-accelerate-arkts/graphics-accelerate-extensionability/graphics-accelerate-extensionability#onbackgrounddownloadsucceeded)生命周期函数中：
