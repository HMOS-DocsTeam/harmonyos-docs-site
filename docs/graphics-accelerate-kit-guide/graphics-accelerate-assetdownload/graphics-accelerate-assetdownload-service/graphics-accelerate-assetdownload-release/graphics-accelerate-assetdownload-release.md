...
- 已准备好游戏资源包并加密，且自行保证游戏资源包的可用性。资源包支持的格式请参见[上传至华为CDN的资源包文件支持哪些格式类型](/graphics-accelerate-kit-guide/graphics-accelerate-faq/graphics-accelerate-assetdownload-faq/graphics-accelerate-assetdownload-faq-1)。
...
![](../../../../images/8709e165/note_3.0-zh-cn.png) 

- 若列表中有“审核中”、“预上线”、“已发布”、“任务暂停”中的任一状态任务，将无法点击“申请”，需要终止该任务后才能申请。
- 资源包下载任务的状态说明请参见[下载任务状态说明](#下载任务状态说明)。

![](../../../../images/db7db009/zh-cn_image_0000002552799070.png)

## 创建下载任务

### 资源包下载方式一：使用三方CDN

![](../../../../images/05e7c47a/note_3.0-zh-cn.png) 

已提前将资源包上传至三方CDN服务器。

在“资源包后台下载申请”页面填写资源包信息后，点击“提交申请”，提交资源包下载任务。若暂不提交该任务，点击“保存草稿”，允许继续编辑后再提交申请。

![](../../../../images/6150584e/zh-cn_image_0000002583438765.png)
...
![](../../../../images/d8460a05/note_3.0-zh-cn.png) 
...
![](../../../../images/f24fd156/zh-cn_image_0000002552958720.png)
...
5. ****上传资源包****。在“上传资源包”栏点击“选择文件”，上传提前准备好的游戏资源包。
   ...
   ![](../../../../images/ba891ca0/note_3.0-zh-cn.png) 
...
6. （可选）填写hotversion。开发者可以通过hotversion版本号指定下一级文件的存储路径。
   ...
   ![](../../../../images/84934bd4/zh-cn_image_0000002583478721.png)
...
1. 在任务列表中找到“草稿”状态的任务，点击“操作”列中的“编辑”进入申请详情页。
   ...
   ![](../../../../images/b9c1e024/zh-cn_image_0000002552799072.png)
2. 在申请页填写资源包信息，填写要求请参见[创建下载任务](#创建下载任务)。完成后，点击“提交申请”提交资源包下载任务，当前任务状态变更为“预上线”。

   ![](../../../../images/742a303a/zh-cn_image_0000002583438767.png)
...
![](../../../../images/77868dd6/zh-cn_image_0000002552958722.png "点击放大")
...
1. 输入如下命令行，获取测试设备的设备号。
   ...
   ![](../../../../images/6c426e4d/zh-cn_image_0000002583478723.png)
2. 在AppGallery Connect页面点击“测试设备”后的“编辑”。

   ![](../../../../images/232f040f/zh-cn_image_0000002552799074.png)
3. 在输入框中最多添加10台测试设备的设备号，且使用英文逗号（,）间隔开，完成后点击“保存”。

   ![](../../../../images/eca27d72/zh-cn_image_0000002583438769.png)
...
3. 验证以上两个场景是否触发系统后台下载资源包：查看测试设备的通知栏出现下载任务，则系统后台下载资源包功能验证通过。
   ...
   ![](../../../../images/641f1343/zh-cn_image_0000002552958724.png "点击放大")

## 发布下载任务

1. 在任务列表找到“预上线”状态的任务，点击“操作”列中的“发布”。

   ![](../../../../images/9377f7db/zh-cn_image_0000002583478725.png)

   在弹出的提示窗中点击“确认”。

   ![](../../../../images/34755421/zh-cn_image_0000002552799076.png)
...
2. 若需要终止已发布的任务，可以在任务列表中主动点击“终止”。
   ...
   ![](../../../../images/be6d46d0/zh-cn_image_0000002583438771.png)
