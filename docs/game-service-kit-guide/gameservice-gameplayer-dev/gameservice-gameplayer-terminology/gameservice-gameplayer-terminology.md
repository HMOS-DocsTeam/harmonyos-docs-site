...
![](../../../images/b367c3d6/note_3.0-zh-cn.png) 

玩家标识严格区分大小写，例如gamePlayerId=xxx和gamePlayerId=XXX表示两个不同的玩家。

| 系统 | 名称 | 组成 | 说明 |
| --- | --- | --- | --- |
| HarmonyOS 5.0及以上系统 | gamePlayerId | 根据[配置APP ID映射关系](/game-service-kit-guide/gameservice-gameplayer-dev/gameservice-gameplayer-gamelogin/gameservice-gameplayer-network/gameservice-gameplayer-huawei#配置app-id映射关系)时的选择openId或playerId。 | 用于华为账号登录的玩家标识。  不同游戏下，同一玩家的gamePlayerId不同。 |
