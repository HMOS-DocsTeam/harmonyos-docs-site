...
2. 在“项目设置”页面，选择“开放能力管理”页签，开始为游戏申请近场快传开放能力。
   ...
   ![](../../../images/8c9e4bb8/zh-cn_image_0000002583478901.png)
3. 搜索“近场快传”，点击对应能力后面的“申请”，打开“新建业务申请”窗口。

   ![](../../../images/7e727a71/zh-cn_image_0000002552799252.png)
4. 在“新建业务申请”窗口填写申请信息，然后点击“提交”。

   ![](../../../images/54b57cf2/zh-cn_image_0000002583438947.png)
...
5. 进入互动中心页面，可以看到申请已提交的消息。
   ...
   ![](../../../images/711120d6/zh-cn_image_0000002552958902.png)

   返回“开放能力管理”页面，近场快传显示“申请中”，1-3个工作日反馈申请结果。

   ![](../../../images/b4a97bf8/zh-cn_image_0000002583478903.png)
6. 申请审批通过后，互动中心将会发送通知给您，同时近场快传的能力开关会为您自动开启，“申请中”也会变为置灰显示的“申请”。至此，游戏已成功开启近场快传开放能力。

   ![](../../../images/bb8744d5/zh-cn_image_0000002552799254.png)

## 生成签名证书

数字证书和Profile文件等签名信息可以确保游戏的完整性，请参见[配置签名信息](/application-dev-overview#section42841246144813)完成配置。
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)平台，在“开发与服务”中选择目标应用，获取“项目设置 > 常规 > 应用”的****APP ID****。
   ...
   ![](../../../images/7a93e3f4/zh-cn_image_0000002583438949.png)
