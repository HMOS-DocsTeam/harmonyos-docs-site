...
![](../../images/550498b3/zh-cn_image_0000002552799658.png)
...
3. 通过图库获取图片资源，将图片转换为[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，并添加初始化和释放方法。
   ...
   ```
4. 实现人脸比对功能。实例化[VisionInfo](/ref/core-vision-api/core-vision-arkts/core-vision-facecomparator-api/core-vision-facecomparator-api#visioninfo)对象，传入两张图片的[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，调用[faceComparator.compareFaces](/ref/core-vision-api/core-vision-arkts/core-vision-facecomparator-api/core-vision-facecomparator-api#facecomparatorcomparefaces)方法进行人脸比对。
