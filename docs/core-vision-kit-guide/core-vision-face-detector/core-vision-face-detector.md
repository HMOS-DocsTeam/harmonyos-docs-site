...
![](../../images/e8ce45db/zh-cn_image_0000002552959306.png)
...
![](../../images/0de00ad2/zh-cn_image_0000002583479307.png)
...
2. 简单配置页面的布局，并在Button组件添加点击事件，拉起图库，选择图片。
   ...
   ```
3. 通过图库获取图片资源，将图片转换为[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。
   ...
   ```
4. 实例化[VisionInfo](/ref/core-vision-api/core-vision-arkts/core-vision-face-detector-api/core-vision-face-detector-api#visioninfo)对象，并传入待检测图片的[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，实现人脸检测功能。
