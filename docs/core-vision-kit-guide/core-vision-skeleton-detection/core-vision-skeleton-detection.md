...
![](../../images/7137468f/zh-cn_image_0000002583479309.png)
...
3. 通过图库获取图片资源，将图片转换为[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。
   ...
   ```
4. 实例化Request对象，并传入待检测图片的[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，实现骨骼点检测功能。
