...
![](../../images/b31255c7/zh-cn_image_0000002583439353.png)
...
1. 引用相关类添加至工程。
   ...
   ```
2. 准备预处理的图片资源，将图片转换为[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，并添加初始化和释放方法。
   ...
   ```
3. 实例化待分割的入参项[VisionInfo](/ref/core-vision-api/core-vision-arkts/core-vision-subjectsegmentation-api/core-vision-subjectsegmentation-api#visioninfo)，并传入待检测图片的[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。
   ...
   ```
4. 配置通用文本识别的配置项[SegmentationConfig](/ref/core-vision-api/core-vision-arkts/core-vision-subjectsegmentation-api/core-vision-subjectsegmentation-api#segmentationconfig)，包括最大分割主体个数、是否输出每个主体的分割信息，以及是否输出分割后的前景图。
   ...
   ```
5. 调用subjectSegmentation的[subjectSegmentation.doSegmentation](/ref/core-vision-api/core-vision-arkts/core-vision-subjectsegmentation-api/core-vision-subjectsegmentation-api#subjectsegmentationdosegmentation)接口，实现主体分割。
