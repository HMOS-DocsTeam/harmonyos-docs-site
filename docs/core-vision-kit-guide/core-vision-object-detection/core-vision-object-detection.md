...
![](../../images/b7d8d728/zh-cn_image_0000002552959308.png)
...
3. 通过图库获取图片资源，将图片转换为[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)。
   ...
   ```
4. 实例化Request对象，并传入待检测图片的[PixelMap](/ref/image-api/image-arkts/js-apis-image/arkts-apis-image-pixelmap/arkts-apis-image-pixelmap)，调用多目标识别的实现多目标识别功能。
