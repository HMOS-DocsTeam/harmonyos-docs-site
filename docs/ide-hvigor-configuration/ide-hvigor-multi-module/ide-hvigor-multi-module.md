...
Hvigor支持在[hvigorconfig.ts脚本](/ide-hvigor/ide-hvigor-life-cycle#section810245135914)中动态添加或排除某个模块，具体API及示例可参考[HvigorConfig](/ide-build-expanding/ide-hvigor-apis/ide-hvigor-api#section7253174081515)。
...
更多构建HAR/HSP包命令，可参考[命令行工具](/ide-hvigor-commandline#section9580122622012)章节。
