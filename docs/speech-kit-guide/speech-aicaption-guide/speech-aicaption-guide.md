...
本章节将向您介绍如何使用AI字幕组件[AICaptionComponent](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent)和[AICaptionController](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent#aicaptioncontroller)展示AI字幕，效果如下图所示。

![](../../images/7a5ae06a/zh-cn_image_0000002583439397.jpg)

## 接口说明

AI字幕功能主要由[AICaptionComponent](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent)提供，更多接口及使用方法请参见[API参考](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent)。

| 接口 | 描述 |
| --- | --- |
| [AICaptionComponent](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent) | AI字幕组件。 |
| [AICaptionOptions](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent#aicaptionoptions) | AI字幕初始化参数。 |
| [AICaptionController](/ref/speech-api/speech-arkts-component/speech-aicaptioncomponent/speech-aicaptioncomponent#aicaptioncontroller) | AI字幕组件的控制器，是AI字幕组件的主要功能入口类，用来操作AI字幕。它所承载的工作包括：写音频数据、获取音频流信息等。 |
