...
JS卡片是使用类Web范式（HML+CSS+JSON）开发页面的卡片，现在已经支持FA模型和Stage模型两种[应用模型](/ability-kit/application-models)。开发指导请参见[JS卡片开发指导（Stage模型）](/form-kit/form-js-ui/js-ui-widget-development)和[JS卡片开发指导（FA模型）](/form-kit/form-js-ui/widget-development-fa)。在开发新卡片时，推荐采用ArkTS声明式来构建UI，声明式和类web范式差异点可参考[ArkUI简介](/arkui/arkui-overview)。
...
![](../../../images/5378b109/zh-cn_image_0000002583438359.png)
...
![](../../../images/b1fde63c/note_3.0-zh-cn.png) 
