...
FormProvider类有如下API接口，具体的API介绍详见[@ohos.app.form.formProvider (formProvider)](/ref/form-api/form-arkts/js-apis-app-form-formprovider/js-apis-app-form-formprovider)。
...
FormBindingData类有如下API接口，具体的API介绍详见[@ohos.app.form.formBindingData (卡片数据绑定类)](/ref/form-api/form-arkts/js-apis-app-form-formbindingdata/js-apis-app-form-formbindingdata)。
...
FA卡片开发，即基于[FA模型](/ability-kit/fa-model-development/fa-model-development-overview)的卡片提供方开发，主要涉及如下关键步骤：
...
创建FA模型的卡片，需实现卡片的生命周期接口。先参考[DevEco Studio开发服务卡片指南](/ide-project/ide-module-management/ide-service-widget)生成服务卡片模板。
...
![](../../../images/801563a5/note_3.0-zh-cn.png) 
...
具体的持久化方法可以参考[应用数据持久化概述](/arkdata/app-data-persistence/app-data-persistence-overview)。
...
![](../../../images/2f52d74a/zh-cn_image_0000002583478315.png)

![](../../../images/f7303834/note_3.0-zh-cn.png) 
