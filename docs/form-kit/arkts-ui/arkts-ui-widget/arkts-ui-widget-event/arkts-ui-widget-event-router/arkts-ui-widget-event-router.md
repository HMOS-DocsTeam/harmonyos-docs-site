...
在动态卡片中使用[postCardAction](/ref/arkui-api/arkui-arkts/ui/js-apis-postcardaction/js-apis-postcardaction#postcardaction-1)接口的router能力，能够快速拉起动态卡片提供方应用的指定UIAbility(页面)，因此UIAbility较多的应用往往会通过卡片提供不同的跳转按钮，实现一键直达的效果。例如相机卡片，卡片上提供拍照、录像等按钮，点击不同按钮将拉起相机应用的不同UIAbility，从而提升用户的体验。

![](../../../../../images/8866be71/zh-cn_image_0000002552958296.png)

![](../../../../../images/d51f1333/note_3.0-zh-cn.png) 
...
![](../../../../../images/66848b34/zh-cn_image_0000002583478297.gif)
