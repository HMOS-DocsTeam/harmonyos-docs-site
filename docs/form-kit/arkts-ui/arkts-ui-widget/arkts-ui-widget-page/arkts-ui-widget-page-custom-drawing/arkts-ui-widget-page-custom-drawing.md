...
ArkTS卡片开放了自定义绘制的能力，在卡片上可以通过[Canvas](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-components-canvas-canvas/ts-components-canvas-canvas)组件创建一块画布，然后通过[CanvasRenderingContext2D](/ref/arkui-api/arkui-declarative-comp/canvas-drawing/ts-canvasrenderingcontext2d/ts-canvasrenderingcontext2d)对象在画布上进行自定义图形的绘制，如下示例代码实现了在画布的中心绘制了一个笑脸。
...
![](../../../../../images/31f6af48/zh-cn_image_0000002583478293.jpeg)
