...
2. 通过[openFormManager](/ref/form-api/form-arkts/js-apis-app-form-formprovider/js-apis-app-form-formprovider#formprovideropenformmanager18)方法在应用内添加拉起卡片管理页面入口。
...
3. 用户可在卡片管理页面，点击“添加至桌面”或者“添加至负一屏”，此时在桌面或者负一屏即可看到新添加的卡片。结果示例如下。
   ...
   ![](../../../../../images/a2b1eec5/zh-cn_image_0000002552958300.gif)
