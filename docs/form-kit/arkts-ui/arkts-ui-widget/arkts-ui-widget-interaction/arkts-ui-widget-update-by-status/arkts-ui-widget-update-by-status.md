...
![](../../../../../images/f37a042f/note_3.0-zh-cn.png) 

通过本地数据库进行卡片信息的持久化时，建议先在[****onAddForm****](/ref/form-api/form-arkts/js-apis-app-form-formextensionability/js-apis-app-form-formextensionability#formextensionabilityonaddform)生命周期进行卡片信息持久化；同时需要在卡片销毁(****[onRemoveForm](/ref/form-api/form-arkts/js-apis-app-form-formextensionability/js-apis-app-form-formextensionability#formextensionabilityonremoveform)****)时删除当前卡片存储的持久化信息，避免反复添加删除卡片导致数据库文件持续变大。
