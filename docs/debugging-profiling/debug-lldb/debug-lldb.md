...
![](../../images/94884402/notice_3.0-zh-cn.png) 
...
- 远程调试（****主要调试方式****）
  ...
  - 一键调试：
    ...
    - 下载DevEco Studio，根据IDE的调试方法即可进行一键调试：[通过DevEco Studio调试](/debugging-profiling/debug-performance-profiling-overview)。
  ...
  - 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用****lldb.exe****, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](../../images/d339f933/zh-cn_image_0000002583479389.png)
  - 设备状态与调试支持矩阵（分三种情况）：
...
![](../../images/7e05f56a/note_3.0-zh-cn.png) 
...
![](../../images/c7af2dde/note_3.0-zh-cn.png) 

步骤attach应用和设置断点可以调换顺序执行。

## 使用指导-远程调试

![](../../images/f7e1e9d6/note_3.0-zh-cn.png) 
...
![](../../images/1bb980f7/note_3.0-zh-cn.png) 
...
![](../../images/0acdc7d7/note_3.0-zh-cn.png) 
