...
![](../../images/123dcc11/zh-cn_image_0000002583479351.png)
...
以下为Neural Network Runtime开发流程中的常用接口，具体可见[NeuralNetworkRuntime](/ref/neural-network-runtime-api/neural-network-runtime-c/neural-network-runtime-module/capi-neuralnetworkruntime/capi-neuralnetworkruntime)。
...
4. 检查模型缓存（可选）。
   ...
   ![](../../images/b2ae63f6/note_3.0-zh-cn.png) 
